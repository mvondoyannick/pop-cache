              ...
              if marchand_account.save
                ...
                if client_log.save
                  ...
                  if commission
                    ...
                    Sms.nexah(client.phone, "Paiement effectue depuis votre compte d'un montant de #{@amount} F CFA, Transaction de paiement Effectuee", "Payment done from your account. Amount of #{@amount} F CFA. Payment Transaction done")
