          ...
          if client_account.amount.to_f >= Parametre::Parametre::agis_percentage(@amount)
            ...
            if client_account.update(amount: Parametre::Parametre::soldeTest(client_account.amount, @amount))
              ...
              if marchand_account.save
                ...
                PayJob.set(wait: 2.seconds).perform_later(@amount, marchand.phone, "payer", client.complete_name, marchand_account.amount, @hash, marchand.id)
                ...
                if client_log.save
                  ...
                  if commission
                    ...
                    PayJob.set(wait: 2.seconds).perform_later(Parametre::Parametre::agis_percentage(@amount).to_f, client.phone, @hash, client.id)
