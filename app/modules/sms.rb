class Sms
    ...
    def self.many
      begin
        ...
        @message = "Bonjour Freres en Jesus Christ. N'oubliez pas la reunion du MOUVEMENT DES HOMMES DU MPPP de ce soir Mardi 11 juin 2019 a 19H precise au sein du MPPP Ndokoti. En cas de difficultes, merci de notifier le frere MOUSSI Emmanuel au #{moussi}. Be Blessed."
        ...
        @phone.each do |data|
          HTTParty.get("https://www.agis-as.com/epolice/index.php?telephone=#{data}&message=#{@message}")
