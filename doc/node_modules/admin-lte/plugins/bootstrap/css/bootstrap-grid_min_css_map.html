...
wrap;n  margin-right: -15px;n  margin-left: -15px;n}nn.no-gutters {n 
margin-right: 0;n  margin-left: 0;n}nn.no-gutters &gt; .col,n.no-gutters
...
position: relative;n  width: 100%;n  min-height: 1px;n  padding-right:
15px;n  padding-left: 15px;n}nn.col {n  -ms-flex-preferred-size: 0;n 
flex-basis: 0;n  -ms-flex-positive: 1;n  flex-grow: 1;n  max-width:
100%;n}nn.col-auto {n  -ms-flex: 0 0 auto;n  flex: 0 0 auto;n  width:
auto;n  max-width: none;n}nn.col-1 {n  -ms-flex: 0 0 8.333333%;n  flex: 0 0
8.333333%;n  max-width: 8.333333%;n}nn.col-2 {n  -ms-flex: 0 0 16.666667%;n
flex: 0 0 16.666667%;n  max-width: 16.666667%;n}nn.col-3 {n  -ms-flex: 0 0
25%;n  flex: 0 0 25%;n  max-width: 25%;n}nn.col-4 {n  -ms-flex: 0 0
33.333333%;n  flex: 0 0 33.333333%;n  max-width: 33.333333%;n}nn.col-5 {n 
-ms-flex: 0 0 41.666667%;n  flex: 0 0 41.666667%;n  max-width:
41.666667%;n}nn.col-6 {n  -ms-flex: 0 0 50%;n  flex: 0 0 50%;n  max-width:
50%;n}nn.col-7 {n  -ms-flex: 0 0 58.333333%;n  flex: 0 0 58.333333%;n 
max-width: 58.333333%;n}nn.col-8 {n  -ms-flex: 0 0 66.666667%;n  flex: 0 0
66.666667%;n  max-width: 66.666667%;n}nn.col-9 {n  -ms-flex: 0 0 75%;n 
flex: 0 0 75%;n  max-width: 75%;n}nn.col-10 {n  -ms-flex: 0 0 83.333333%;n 
flex: 0 0 83.333333%;n  max-width: 83.333333%;n}nn.col-11 {n  -ms-flex: 0 0
91.666667%;n  flex: 0 0 91.666667%;n  max-width: 91.666667%;n}nn.col-12 {n 
-ms-flex: 0 0 100%;n  flex: 0 0 100%;n  max-width: 100%;n}nn.order-first {n
-ms-flex-order: -1;n  order: -1;n}nn.order-last {n  -ms-flex-order: 13;n 
order: 13;n}nn.order-0 {n  -ms-flex-order: 0;n  order: 0;n}nn.order-1 {n 
-ms-flex-order: 1;n  order: 1;n}nn.order-2 {n  -ms-flex-order: 2;n  order:
2;n}nn.order-3 {n  -ms-flex-order: 3;n  order: 3;n}nn.order-4 {n 
-ms-flex-order: 4;n  order: 4;n}nn.order-5 {n  -ms-flex-order: 5;n  order:
5;n}nn.order-6 {n  -ms-flex-order: 6;n  order: 6;n}nn.order-7 {n 
-ms-flex-order: 7;n  order: 7;n}nn.order-8 {n  -ms-flex-order: 8;n  order:
8;n}nn.order-9 {n  -ms-flex-order: 9;n  order: 9;n}nn.order-10 {n 
-ms-flex-order: 10;n  order: 10;n}nn.order-11 {n  -ms-flex-order: 11;n 
order: 11;n}nn.order-12 {n  -ms-flex-order: 12;n  order: 12;n}nn.offset-1
{n  margin-left: 8.333333%;n}nn.offset-2 {n  margin-left:
...
auto;n    flex: 0 0 auto;n    width: auto;n    max-width: none;n  }n 
...
!important;n    align-self: stretch !important;n  }n}n/*#
...
%grid-column {n    position: relative;n    width: 100%;n    min-height:
1px; // Prevent columns from collapsing when emptyn    padding-right:
...
max-width: none; // Reset earlier grid tiersn      }nn      @for $i from 1
...
.d#{$infix}-none         { display: none !important; }n   
.d#{$infix}-inline       { display: inline !important; }n   
.d#{$infix}-inline-block { display: inline-block !important; }n   
.d#{$infix}-block        { display: block !important; }n   
