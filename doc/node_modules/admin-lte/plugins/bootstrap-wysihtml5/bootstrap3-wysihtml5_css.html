...
<title>bootstrap3-wysihtml5.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.css">

<p>ul.wysihtml5-toolbar {</p>
...
<p>ul.wysihtml5-toolbar::after {</p>
...
<p>ul.wysihtml5-toolbar &gt; li {</p>

<pre>float: left;
display: list-item;
list-style: none;
margin: 0 5px 10px 0;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command=bold">a</a> {</p>

<pre>font-weight: bold;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command=italic">a</a> {</p>

<pre>font-style: italic;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command=underline">a</a> {</p>

<pre>text-decoration: underline;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar a.btn.wysihtml5-command-active {</p>
...
<p>ul.wysihtml5-commands-disabled .dropdown-menu {</p>

<pre>display: none !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar div.wysihtml5-colors {</p>
...
<p>ul.wysihtml5-toolbar a.wysihtml5-colors-title {</p>

<pre>padding-left: 70px;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="black"">div</a>
{</p>

<pre>background: black !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a
href="data-wysihtml5-command-value="silver"">div</a> {</p>

<pre>background: silver !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="gray"">div</a>
{</p>

<pre>background: gray !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a
href="data-wysihtml5-command-value="maroon"">div</a> {</p>

<pre>background: maroon !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="red"">div</a> {</p>

<pre>background: red !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a
href="data-wysihtml5-command-value="purple"">div</a> {</p>

<pre>background: purple !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="green"">div</a>
{</p>

<pre>background: green !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="olive"">div</a>
{</p>

<pre>background: olive !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="navy"">div</a>
{</p>

<pre>background: navy !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a href="data-wysihtml5-command-value="blue"">div</a>
{</p>

<pre>background: blue !important;</pre>

<p>}</p>

<p>ul.wysihtml5-toolbar <a
href="data-wysihtml5-command-value="orange"">div</a> {</p>

<pre>background: orange !important;</pre>

<p>}</p>

<p>.glyphicon-quote:before {</p>
...
<p>.glyphicon-quote:after {</p>

<pre>content: &quot;\0000a0&quot;;</pre>
