...
<title>bootstrap-colorpicker.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/colorpicker/bootstrap-colorpicker.css">
...
<pre>!
 ...
 http://www.apache.org/licenses/LICENSE-2.0.txt</pre>

<p>.colorpicker-saturation {</p>

<pre>float: left;
width: 100px;
height: 100px;
cursor: crosshair;
background-image: url(&quot;img/saturation.png&quot;);</pre>

<p>}</p>

<p>.colorpicker-saturation i {</p>
...
<p>.colorpicker-saturation i b {</p>
...
<p>.colorpicker-hue, .colorpicker-alpha {</p>
...
<p>.colorpicker-hue i, .colorpicker-alpha i {</p>
...
<pre>background-image: url(&quot;img/hue.png&quot;);</pre>

<p>}</p>

<p>.colorpicker-alpha {</p>

<pre>display: none;
background-image: url(&quot;img/alpha.png&quot;);</pre>
...
<p>.colorpicker:before, .colorpicker:after {</p>
...
<p>.colorpicker:after {</p>

<pre>clear: both;</pre>

<p>}</p>

<p>.colorpicker:before {</p>
...
<p>.colorpicker.colorpicker-with-alpha {</p>

<pre>min-width: 140px;</pre>

<p>}</p>

<p>.colorpicker.colorpicker-with-alpha .colorpicker-alpha {</p>
...
<p>.colorpicker-color div {</p>

<pre>height: 10px;</pre>

<p>}</p>

<p>.colorpicker-element .input-group-addon i {</p>
...
<p>.colorpicker.colorpicker-inline {</p>
...
<p>.colorpicker.colorpicker-horizontal {</p>
...
<p>.colorpicker.colorpicker-horizontal .colorpicker-saturation {</p>

<pre>margin-bottom: 4px;</pre>

<p>}</p>

<p>.colorpicker.colorpicker-horizontal .colorpicker-color {</p>

<pre>width: 100px;</pre>

<p>}</p>

<p>.colorpicker.colorpicker-horizontal .colorpicker-hue,
.colorpicker.colorpicker-horizontal .colorpicker-alpha {</p>
...
margin-bottom: 4px;
margin-left: 0;
cursor: col-resize;</pre>

<p>}</p>

<p>.colorpicker.colorpicker-horizontal .colorpicker-hue i,
.colorpicker.colorpicker-horizontal .colorpicker-alpha i {</p>
...
<p>.colorpicker.colorpicker-horizontal .colorpicker-hue {</p>

<pre>background-image: url(&quot;img/hue-horizontal.png&quot;);</pre>

<p>}</p>

<p>.colorpicker.colorpicker-horizontal .colorpicker-alpha {</p>

<pre>background-image: url(&quot;img/alpha-horizontal.png&quot;);</pre>

<p>}</p>

<p>.colorpicker.colorpicker-hidden {</p>

<pre>display: none;</pre>

<p>}</p>

<p>.colorpicker.colorpicker-visible {</p>

<pre>display: block;</pre>

<p>}</p>

<p>.colorpicker-inline.colorpicker-visible {</p>
