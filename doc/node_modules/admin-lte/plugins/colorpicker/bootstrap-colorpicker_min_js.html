...
<title>bootstrap-colorpicker.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/colorpicker/bootstrap-colorpicker.min.js">
...
c=this,d=!1;return a.each(this.stringParsers,function(a,e){var <a
href="f">f=e.re.exec(b),g=f&&e.parse.apply(c,</a>),h=e.format||“rgba”;return
...
e,f,g,h,i,j,k,l;switch(a&amp;&amp;void 0===b&amp;&amp;void
...
0&gt;c?c+=1:c&gt;1&amp;&amp;(c-=1),1&gt;6*c?a+(b-a)*c*6:1&gt;2*c?b:2&gt;3*c?a+(b-a)*(2/3-c)*6:a},HSLtoRGB:function(a,b,c,d){0&gt;b&amp;&amp;(b=0);var
e;e=.5&gt;=c?c*(1+b):c+b-c*b;var <a
href="j,k,l,this._sanitizeNumber(d)">f=2*c-e,g=a+1/3,h=a,i=a-1/3,j=Math.round(255*this.HueToRGB(f,e,g)),k=Math.round(255*this.HueToRGB(f,e,h)),l=Math.round(255*this.HueToRGB(f,e,i));return</a>},toString:function(a){switch(a=a||“rgba”){case“rgb”:var
b=this.toRGB();return“rgb(”<code>b.r</code>“,”<code>b.g</code>“,”<code>b.b</code>“)”;case“rgba”:var
b=this.toRGB();return“rgba(”<code>b.r</code>“,”<code>b.g</code>“,”<code>b.b</code>“,”<code>b.a</code>“)”;case“hsl”:var
c=this.toHSL();return“hsl(”+Math.round(360*c.h)+“,”+Math.round(100*c.s)+“%,”+Math.round(100*c.l)+“%)”;case“hsla”:var
c=this.toHSL();return“hsla(”+Math.round(360*c.h)+“,”+Math.round(100*c.s)+“%,”+Math.round(100*c.l)+“%,”<code>c.a</code>“)”;case“hex”:return
this.toHex();default:return!1}},<a
href="a-fA-F0-9">stringParsers:[{re:/#(</a>{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,format:“hex”,parse:function(a){<a
href="1">return[parseInt(a</a>,<a href="2">16),parseInt(a</a>,<a
href="3">16),parseInt(a</a>,16),1]}},{<a href="a-fA-F0-9">re:/#(</a>)([<a
href="a-fA-F0-9">a-fA-F0-9])(</a>)/,format:“hex”,parse:function(a){<a
href="1">return[parseInt(a</a>+<a href="1">a</a>,<a
href="2">16),parseInt(a</a>+<a href="2">a</a>,<a
href="3">16),parseInt(a</a>+<a
href="3">a</a>,16),1]}},{re:/rgb(s*(d{1,3})s*,s*(d{1,3})s*,s*(d{1,3})s*?)/,format:“rgb”,parse:function(a){<a
href="1">return[a</a>,<a href="2">a</a>,<a
href="3">a</a>,1]}},{re:/rgb(s*(d+(?:.d+)?)%s*,s*(d+(?:.d+)?)%s*,s*(d+(?:.d+)?)%s*?)/,format:“rgb”,parse:function(a){<a
href="1">return[2.55*a</a>,<a href="2">2.55*a</a>,<a
href="3">2.55*a</a>,1]}},{re:/rgba(s*(d{1,3})s*,s*(d{1,3})s*,s*(d{1,3})s*(?:,s*(d+(?:.d+)?)s*)?)/,format:“rgba”,parse:function(a){<a
href="1">return[a</a>,<a href="2">a</a>,<a href="3">a</a>,<a
href="4">a</a>]}},{re:/rgba(s*(d+(?:.d+)?)%s*,s*(d+(?:.d+)?)%s*,s*(d+(?:.d+)?)%s*(?:,s*(d+(?:.d+)?)s*)?)/,format:“rgba”,parse:function(a){<a
href="1">return[2.55*a</a>,<a href="2">2.55*a</a>,<a href="3">2.55*a</a>,<a
href="4">a</a>]}},{re:/hsl(s*(d+(?:.d+)?)s*,s*(d+(?:.d+)?)%s*,s*(d+(?:.d+)?)%s*?)/,format:“hsl”,parse:function(a){<a
href="1">return[a</a>/<a href="2">360,a</a>/<a href="3">100,a</a>/<a
href="4">100,a</a>]}},{re:/hsla(s*(d+(?:.d+)?)s*,s*(d+(?:.d+)?)%s*,s*(d+(?:.d+)?)%s*(?:,s*(d+(?:.d+)?)s*)?)/,format:“hsla”,parse:function(a){<a
href="1">return[a</a>/<a href="2">360,a</a>/<a href="3">100,a</a>/<a
href="4">100,a</a>]}},{<a
href="a-z">re:/^(</a>{3,})$/,format:“alias”,parse:function(a){var <a
href="0">b=this.colorNameToHex(a</a>)||“#<a
href="0">000000”,c=this.stringParsers</a>.<a
href="0">re.exec(b),d=c&&this.stringParsers</a>.<a
href="c">parse.apply(this,</a>);return d}}],colorNameToHex:function(a){var
...
<a href="a.toLowerCase()">b</a>?<a href="a.toLowerCase()">b</a>:!1}};var
...
class=“colorpicker-saturation”&gt;&lt;/div&gt;&lt;div
class=“colorpicker-hue”&gt;&lt;/div&gt;&lt;div
class=“colorpicker-alpha”&gt;&lt;/div&gt;&lt;div
class=“colorpicker-color”&gt;&lt;div
/&gt;&lt;/div&gt;&lt;/div&gt;&#39;},d=function(d,e){this.element=a(d).addClass(“colorpicker-element”),this.options=a.extend({},c,this.element.data(),e),this.component=this.options.component,this.component=this.component!==!1?this.element.find(this.component):!1,this.component&amp;&amp;0===this.component.length&amp;&amp;(this.component=!1),this.container=this.options.container===!0?this.element:this.options.container,this.container=this.container!==!1?a(this.container):!1,this.input=this.element.is(“input”)?this.element:this.options.input?this.element.find(this.options.input):!1,this.input&amp;&amp;0===this.input.length&amp;&amp;(this.input=!1),this.color=new
...
0)},hide:function(){this.picker.addClass(“colorpicker-hidden”).removeClass(“colorpicker-visible”),a(window).off(“resize.colorpicker”,this.reposition),a(document).off({“mousedown.colorpicker”:this.hide}),this.update(),this.element.trigger({type:“hidePicker”,color:this.color})},updateData:function(a){return
...
this.hasInput()?(this.input.prop(“disabled”,!0),!0):!1},enable:function(){return
...
<a
href="0">f=d.offset();this.currentSlider.guide=d.find(“i”)</a>.style,this.currentSlider.left=b.pageX-f.left,this.currentSlider.top=b.pageY-f.top,this.mousePointer={left:b.pageX,top:b.pageY},a(document).on({“mousemove.colorpicker”:a.proxy(this.mousemove,this),“mouseup.colorpicker”:a.proxy(this.mouseup,this)}).trigger(“mousemove”)}return!1},mousemove:function(a){a.stopPropagation(),a.preventDefault();var
...
<a
href="this.currentSlider.callLeft">this.currentSlider.guide.left=b+“px”,this.currentSlider.guide.top=c+“px”,this.currentSlider.callLeft&&this.color</a>.<a
href="this.currentSlider.callTop">call(this.color,b/100),this.currentSlider.callTop&&this.color</a>.call(this.color,c/100),this.update(!0),this.element.trigger({type:“changeColor”,color:this.color}),!1},mouseup:function(b){return
...
if(40===a.keyCode)this.color.value.a&gt;0&amp;&amp;(this.color.value.a=Math.round(100*(this.color.value.a-.01))/100),this.update(!0);else{var
c=this.input.val();this.color=new
b©,this.getValue(!1)!==!1&amp;&amp;(this.updateData(),this.updateComponent(),this.updatePicker())}this.element.trigger({type:“changeColor”,color:this.color,value:c})}},a.colorpicker=d,a.fn.colorpicker=function(b){return
this.each(function(){var
c=a(this),e=c.data(“colorpicker”),f=“object”==typeof
b?b:{};e||“string”==typeof b?“string”==typeof <a
href="b">b&&e</a>.apply(e,Array.prototype.slice.call(arguments,1)):c.data(“colorpicker”,new
d(this,f))})},a.fn.colorpicker.constructor=d}(window.jQuery);</p>
</main>
