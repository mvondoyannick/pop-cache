...
<title>ion.rangeSlider.skinNice.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/ionslider/ion.rangeSlider.skinNice.css">

<pre>Ion.RangeSlider, Nice Skin</pre>

<p>// css version 1.8.5 // by Denis Ineshin | ionden.com //
===================================================================================================================</p>
...
<p>.irs-line-mid, .irs-line-left, .irs-line-right, .irs-diapason, .irs-slider
{</p>

<pre>background: url(img/sprite-skin-nice.png) repeat-x;</pre>
...
<pre>height: 8px; top: 25px;
background-position: 0 -60px;</pre>

<p>}</p>

<p>.irs-slider {</p>

<pre>width: 22px; height: 22px;
top: 17px;
background-position: 0 -90px;</pre>

<p>} irs-active-slider, .irs-slider:hover {</p>

<pre>background-position: 0 -120px;</pre>
...
<p>} .lt-ie9 .irs-min, .lt-ie9 .irs-max {</p>

<pre>background: #ccc;</pre>

<p>}</p>

<p>.irs-from, .irs-to, .irs-single {</p>
...
<p>} .lt-ie9 .irs-from, .lt-ie9 .irs-to, .lt-ie9 .irs-single {</p>

<pre>background: #999;</pre>

<p>}</p>

<p>.irs-grid-pol {</p>

<pre>background: #99a4ac;</pre>

<p>} .irs-grid-text {</p>

<pre>color: #99a4ac;</pre>
