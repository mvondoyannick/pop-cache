...
<title>ion.rangeSlider.skinFlat.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/ionslider/ion.rangeSlider.skinFlat.css">

<pre>Ion.RangeSlider, Flat UI Skin</pre>
...
<pre>background: url(img/sprite-skin-flat.png) repeat-x;</pre>
...
<p>} .irs-from:after, .irs-to:after, .irs-single:after {</p>

<pre>position: absolute; display: block; content: &quot;&quot;;
bottom: -6px; left: 50%;
width: 0; height: 0;
margin-left: -3px;
overflow: hidden;
border: 3px solid transparent;
border-top-color: #ed5565;</pre>

<p>}</p>

<p>.irs-grid-pol {</p>

<pre>background: #e1e4e9;</pre>
