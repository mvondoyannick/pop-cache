...
<title>morris.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/morris/morris.min.js">

<pre class="ruby"><span class="ruby-ivar">@license</span>
</pre>

<p>morris.js v0.5.0 Copyright 2014 Olly Smith All rights reserved. Licensed
under the BSD-2-Clause <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a>.</p>

<p>(function(){var a,b,c,d,e=[].slice,f=function(a,b){return function(){return
a.apply(b,arguments)}},g={}.hasOwnProperty,h=function(a,b){function
c(){this.constructor=a}for(var d in <a href="d">b)g.call(b,d)&&(a</a>=<a
href="d">b</a>);return c.prototype=b.prototype,a.prototype=new
c,a.__super__=b.prototype,a},i=[].indexOf||function(a){for(var
b=0,c=this.length;c&gt;b;b++)if(b in <a href="b">this&&this</a>===a)return
b;return-1};b=window.Morris={},a=jQuery,b.EventEmitter=function(){function
a(){}return a.prototype.on=function(a,b){return
null==this.handlers&amp;&amp;(this.handlers={}),<a
href="a">null==this.handlers</a>&amp;&amp;(<a
href="a">this.handlers</a>=[]),<a
href="a">this.handlers</a>.push(b),this},a.prototype.fire=function(){var <a
href="0">a,b,c,d,f,g,h;if(c=arguments</a>,<a
href="c">a=2<=arguments.length?e.call(arguments,1):[],null!=this.handlers&&null!=this.handlers</a>){<a
href="c">for(g=this.handlers</a>,<a
href="d">h=[],d=0,f=g.length;f>d;d++)b=g</a>,h.push(b.apply(null,a));return
h}},a}(),b.commas=function(a){var b,c,d,e;return
null!=a?(d=0&gt;a?“-”:“”,b=Math.abs(a),c=Math.floor(b).toFixed(0),d+=c.replace(/(?=(?:d{3})+$)(?!^)/g,“,”),e=b.toString(),e.length&gt;c.length&amp;&amp;(d+=e.slice(c.length)),d):“-”},b.pad2=function(a){return(10&gt;a?“0”:“”)+a},b.Grid=function©{function
...
<a
href="0">Raphael(this.el</a>),this.elementWidth=null,this.elementHeight=null,this.dirty=!1,this.selectFrom=null,this.init&amp;&amp;this.init(),this.setData(this.options.data),this.el.bind(“mousemove”,function(a){var
b,d,e,f,g;return <a
href="c.hitTest(Math.min(g,c.selectFrom))">d=c.el.offset(),g=a.pageX-d.left,c.selectFrom?(b=c.data</a>.<a
href="c.hitTest(Math.max(g,c.selectFrom))">_x,e=c.data</a>._x,f=e-b,c.selectionRect.attr({x:b,width:f})):c.fire(“hovermove”,g,a.pageY-d.top)}),this.el.bind(“mouseleave”,function(){return
c.selectFrom&amp;&amp;(c.selectionRect.hide(),c.selectFrom=null),c.fire(“hoverout”)}),this.el.bind(“touchstart
touchmove touchend”,function(a){var b,d;return <a
href="0">d=a.originalEvent.touches</a>||<a
href="0">a.originalEvent.changedTouches</a>,b=c.el.offset(),c.fire(“hovermove”,d.pageX-b.left,d.pageY-b.top)}),this.el.bind(“click”,function(a){var
b;return
...
null!=c.timeoutId&amp;&amp;window.clearTimeout(c.timeoutId),c.timeoutId=window.setTimeout(c.resizeHandler,100)}),this.el.css(“-webkit-tap-highlight-color”,“rgba(0,0,0,0)”),this.postInit&amp;&amp;this.postInit()}return
...
<a
href=""#666633","#999966","#cc6666","#663333"">0”,goals:[],goalStrokeWidth:1,goalLineColors:</a>,<a
href=""#005a04","#ccffbb","#3a5f0b","#005502"">events:[],eventStrokeWidth:1,eventLineColors:</a>,rangeSelect:null,rangeSelectColor:“#eef”,resize:!1},d.prototype.setData=function(a,c){var
...
0):(o=this.cumulative?0:null,p=this.cumulative?0:null,this.options.goals.length&gt;0&amp;&amp;(h=Math.min.apply(Math,this.options.goals),g=Math.max.apply(Math,this.options.goals),p=null!=p?Math.min(p,h):h,o=null!=o?Math.max(o,g):g),this.data=function(){var
<a href="f">c,d,g;for(g=[],f=c=0,d=a.length;d>c;f=++c)j=a</a>,i={src:j},<a
href="this.options.xkey">i.label=j</a>,this.options.parseTime?(i.x=b.parseDate(i.label),this.options.dateFormat?i.label=this.options.dateFormat(i.x):“number”==typeof
i.label&amp;&amp;(i.label=new
Date(i.label).toString())):(i.x=f,this.options.xLabelFormat&amp;&amp;(i.label=this.options.xLabelFormat(i))),l=0,i.y=function(){var
<a
href="e">a,b,c,d;for(c=this.options.ykeys,d=[],e=a=0,b=c.length;b>a;e=++a)n=c</a>,<a
href="n">q=j</a>,“string”==typeof
...
g}.call(this),this.options.parseTime&amp;&amp;(this.data=this.data.sort(function(a,b){return(a.x&gt;b.x)-(b.x&gt;a.x)})),<a
href="0">this.xmin=this.data</a>.<a
href="this.data.length-1">x,this.xmax=this.data</a>.x,this.events=[],this.options.events.length&gt;0&amp;&amp;(this.events=this.options.parseTime?function(){var
<a
href="a">a,c,e,f;for(e=this.options.events,f=[],a=0,c=e.length;c>a;a++)d=e</a>,f.push(b.parseDate(d));return
f}.<a
href="0">call(this):this.options.events,this.xmax=Math.max(this.xmax,Math.max.apply(Math,this.events)),this.xmin=Math.min(this.xmin,Math.min.apply(Math,this.events))),this.xmin===this.xmax&&(this.xmin-=1,this.xmax+=1),this.ymin=this.yboundary(“min”,p),this.ymax=this.yboundary(“max”,o),this.ymin===this.ymax&&(p&&(this.ymin-=1),this.ymax+=1),((r=this.options.axes)===!0||“both”===r||“y”===r||this.options.grid===!0)&&(this.options.ymax===this.gridDefaults.ymax&&this.options.ymin===this.gridDefaults.ymin?(this.grid=this.autoGridLines(this.ymin,this.ymax,this.options.numLines),this.ymin=Math.min(this.ymin,this.grid</a>),<a
href="this.grid.length-1">this.ymax=Math.max(this.ymax,this.grid</a>)):(k=(this.ymax-this.ymin)/(this.options.numLines-1),this.grid=function(){var
a,b,c,d;for(d=[],m=a=b=this.ymin,c=this.ymax;k&gt;0?c&gt;=a:a&gt;=c;m=a+=k)d.push(m);return
d}.call(this))),this.dirty=!0,c?this.redraw():void
0)},d.prototype.yboundary=function(a,b){var c,d;return <a
href=""y"+a">c=this.options</a>,“string”==typeof <a
href="a">c?“auto”===c.slice(0,4)?c.length>5?(d=parseInt(c.slice(5),10),null==b?d:Math</a>(b,d)):null!=b?b:0:parseInt(c,10):c},d.prototype.autoGridLines=function(a,b,c){var
...
e=this.el.width(),c=this.el.height(),(this.elementWidth!==e||this.elementHeight!==c||this.dirty)&amp;&amp;(this.elementWidth=e,this.elementHeight=c,this.dirty=!1,this.left=this.options.padding,this.right=this.elementWidth-this.options.padding,this.top=this.options.padding,this.bottom=this.elementHeight-this.options.padding,((g=this.options.axes)===!0||“both”===g||“y”===g)&amp;&amp;(f=function(){var
<a
href="a">a,c,d,e;for(d=this.grid,e=[],a=0,c=d.length;c>a;a++)b=d</a>,e.push(this.measureText(this.yAxisFormat(b)).width);return
e}.call(this),this.left+=Math.max.apply(Math,f)),((h=this.options.axes)===!0||“both”===h||“x”===h)&amp;&amp;(a=function(){var
<a
href="d">a,b,c;for(c=[],d=a=0,b=this.data.length;b>=0?b>a:a>b;d=b>=0?++a:–a)c.push(this.measureText(this.data</a>.text,-this.options.xLabelAngle).height);return
...
0},d.prototype.transY=function(a){return
this.bottom-(a-this.ymin)*this.dy},d.prototype.transX=function(a){return
...
a,b,c,d,e,f,g,h;if(this.options.grid!==!1||(e=this.options.axes)===!0||“both”===e||“y”===e){<a
href="c">for(f=this.grid,h=[],c=0,d=f.length;d>c;c++)a=f</a>,b=this.transY(a),((g=this.options.axes)===!0||“both”===g||“y”===g)&amp;&amp;this.drawYAxisLabel(this.left-this.options.padding/2,b,this.yAxisFormat(a)),this.options.grid?h.push(this.drawGridLine(“M”<code>this.left</code>“,”<code>b</code>“H”+(this.left+this.width))):h.push(void
0);return h}},d.prototype.drawGoals=function(){var <a
href="c">a,b,c,d,e,f,g;for(f=this.options.goals,g=[],c=d=0,e=f.length;e>d;c=++d)b=f</a>,<a
href="c%this.options.goalLineColors.length">a=this.options.goalLineColors</a>,g.push(this.drawGoal(b,a));return
g},d.prototype.drawEvents=function(){var <a
href="c">a,b,c,d,e,f,g;for(f=this.events,g=[],c=d=0,e=f.length;e>d;c=++d)b=f</a>,<a
href="c%this.options.eventLineColors.length">a=this.options.eventLineColors</a>,g.push(this.drawEvent(b,a));return
g},d.prototype.drawGoal=function(a,b){return
this.raphael.path(“M”<code>this.left</code>“,”+this.transY(a)+“H”+this.right).attr(“stroke”,b).attr(“stroke-width”,this.options.goalStrokeWidth)},d.prototype.drawEvent=function(a,b){return
this.raphael.path(“M”+this.transX(a)+“,”<code>this.bottom</code>“V”+this.top).attr(“stroke”,b).attr(“stroke-width”,this.options.eventStrokeWidth)},d.prototype.drawYAxisLabel=function(a,b,c){return
...
b,c;return
this.selectFrom?(c=Math.min(this.selectFrom,a),b=Math.max(this.selectFrom,a),this.options.rangeSelect.call(this.el,{<a
href="this.hitTest(c)">start:this.data</a>.<a
href="this.hitTest(b)">x,end:this.data</a>.x}),this.selectFrom=null):void
0},d.prototype.resizeHandler=function(){return
this.timeoutId=null,this.raphael.setSize(this.el.width(),this.el.height()),this.redraw()},d}(b.EventEmitter),b.parseDate=function(a){var
b,c,d,e,f,g,h,i,j,k,l;return“number”==typeof a?a:(c=a.match(/^(d+)
Q(d)$/),e=a.match(/^(d+)-(d+)$/),f=a.match(/^(d+)-(d+)-(d+)$/),h=a.match(/^(d+)
W(d+)$/),i=a.match(/^(d+)-(d+)-(d+)[ <a
href="+-">T](d+):(d+)(Z|(</a>)(dd):?(dd))?$/),j=a.match(/^(d+)-(d+)-(d+)[
<a href="+-">T](d+):(d+):(d+(.d+)?)(Z|(</a>)(dd):?(dd))?$/),c?new <a
href="1">Date(parseInt(c</a>,<a
href="2">10),3*parseInt(c</a>,10)-1,1).getTime():e?new <a
href="1">Date(parseInt(e</a>,<a
href="2">10),parseInt(e</a>,10)-1,1).getTime():f?new <a
href="1">Date(parseInt(f</a>,<a href="2">10),parseInt(f</a>,<a
href="3">10)-1,parseInt(f</a>,10)).getTime():h?(k=new <a
href="1">Date(parseInt(h</a>,<a
href="2">10),0,1),4!==k.getDay()&&k.setMonth(0,1+(4-k.getDay()+7)%7),k.getTime()+6048e5*parseInt(h</a>,<a
href="6">10)):i?i</a>?(<a href="6">g=0,“Z”!==i</a>&amp;&amp;(<a
href="8">g=60*parseInt(i</a>,<a href="9">10)+parseInt(i</a>,<a
href="7">10),“+”===i</a>&amp;&amp;(<a
href="1">g=0-g)),Date.UTC(parseInt(i</a>,<a href="2">10),parseInt(i</a>,<a
href="3">10)-1,parseInt(i</a>,<a href="4">10),parseInt(i</a>,<a
href="5">10),parseInt(i</a>,10)+g)):new <a href="1">Date(parseInt(i</a>,<a
href="2">10),parseInt(i</a>,<a href="3">10)-1,parseInt(i</a>,<a
href="4">10),parseInt(i</a>,<a href="5">10),parseInt(i</a>,<a
href="6">10)).getTime():j?(l=parseFloat(j</a>),<a
href="8">b=Math.floor(l),d=Math.round(1e3*(l-b)),j</a>?(<a
href="8">g=0,“Z”!==j</a>&amp;&amp;(<a href="10">g=60*parseInt(j</a>,<a
href="11">10)+parseInt(j</a>,<a href="9">10),“+”===j</a>&amp;&amp;(<a
href="1">g=0-g)),Date.UTC(parseInt(j</a>,<a href="2">10),parseInt(j</a>,<a
href="3">10)-1,parseInt(j</a>,<a href="4">10),parseInt(j</a>,<a
href="5">10),parseInt(j</a>,10)+g,b,d)):new <a
href="1">Date(parseInt(j</a>,<a href="2">10),parseInt(j</a>,<a
href="3">10)-1,parseInt(j</a>,<a href="4">10),parseInt(j</a>,<a
href="5">10),parseInt(j</a>,10),b,d).getTime()):new
Date(parseInt(a,10),0,1).getTime())},b.Hover=function(){function
c©{null==c&amp;&amp;(c={}),this.options=a.extend({},b.Hover.defaults,c),this.el=a(“&lt;div
<a
href=""class"">class=‘”+this.options</a>+“&#39;&gt;&lt;/div&gt;”),this.el.hide(),this.options.parent.append(this.el)}return
...
g=this.options.parent.innerWidth(),f=this.options.parent.innerHeight(),d=this.el.outerWidth(),c=this.el.outerHeight(),e=Math.min(Math.max(0,a-d/2),g-d),null!=b?(h=b-c-10,0&gt;h&amp;&amp;(h=b+10,h+c&gt;f&amp;&amp;(h=f/2-c/2))):h=f/2-c/2,this.el.css({left:e+“px”,top:parseInt(h)+“px”})},c.prototype.show=function(){return
...
0},c.prototype.defaults={<a
href=""#0b62a4","#7A92A3","#4da74d","#afd8f8","#edc240","#cb4b4b","#9440ed"">lineWidth:3,pointSize:4,lineColors:</a>,<a
href="1">pointStrokeWidths:</a>,<a
href=""#ffffff"">pointStrokeColors:</a>,pointFillColors:[],smooth:!0,xLabels:“auto”,xLabelFormat:null,xLabelMargin:24,hideHover:!1},c.prototype.calc=function(){return
this.calcPoints(),this.generatePaths()},c.prototype.calcPoints=function(){var
<a
href="c">a,b,c,d,e,f;for(e=this.data,f=[],c=0,d=e.length;d>c;c++)a=e</a>,a._x=this.transX(a.x),a._y=function(){var
<a
href="c">c,d,e,f;for(e=a.y,f=[],c=0,d=e.length;d>c;c++)b=e</a>,null!=b?f.push(this.transY(b)):f.push(b);return
f}.<a
href="this.bottom">call(this),f.push(a._ymax=Math.min.apply(Math,</a>.concat(function(){var
<a
href="c">c,d,e,f;for(e=a._y,f=[],c=0,d=e.length;d>c;c++)b=e</a>,null!=b&amp;&amp;f.push(b);return
f}())));return f},c.prototype.hitTest=function(a){var
b,c,d,e,f;if(0===this.data.length)return <a
href="b">null;for(f=this.data.slice(1),b=d=0,e=f.length;e>d&&(c=f</a>,!(<a
href="b">a<(c._x+this.data</a>._x)/2));b=++d);return
b},c.prototype.onGridClick=function(a,b){var c;return <a
href="c">c=this.hitTest(a),this.fire(“click”,c,this.data</a>.src,a,b)},c.prototype.onHoverMove=function(a){var
b;return
b=this.hitTest(a),this.displayHoverForRow(b)},c.prototype.onHoverOut=function(){return
...
<a href="a">b,c,d,e,f,g,h;for(d=this.data</a>,b=“&lt;div <a
href="c">class=’morris-hover-row-label’>”d.label“</div>”,h=d.y,c=f=0,g=h.length;g>f;c=++f)e=h</a>,b+=“&lt;div
class=&#39;morris-hover-point&#39; style=&#39;color:
”+this.colorFor(d,c,“label”)+“&#39;&gt;n  ”+<a
href="c">this.options.labels</a>+“:n 
”+this.yLabelFormat(e)+“n&lt;/div&gt;”;return“function”==typeof <a
href="b,d._x,d._ymax">this.options.hoverCallback&&(b=this.options.hoverCallback(a,this.options,b,d.src)),</a>},c.prototype.generatePaths=function(){var
...
<a
href="c">this.options.smooth?this.options.smooth:(h=this.options.ykeys</a>,i.call(this.options.smooth,h)&gt;=0),a=function(){var
<a
href="a">a,b,e,f;for(e=this.data,f=[],a=0,b=e.length;b>a;a++)d=e</a>,void
<a href="c">0!==d._y</a>&amp;&amp;f.push({<a
href="c">x:d._x,y:d._y</a>});return
...
c,d,g,i,j;return
c=l.drawXAxisLabel(l.transX(b),h,a),j=c.getBBox(),c.transform(“r”+-l.options.xLabelAngle),d=c.getBBox(),c.transform(“t0,”<code>d.height/2</code>“…”),0!==l.options.xLabelAngle&amp;&amp;(i=-.5*j.width*Math.cos(l.options.xLabelAngle*Math.PI/180),c.transform(“t”<code>i</code>“,0…”)),d=c.getBBox(),(null==f||f&gt;=d.x+d.width||null!=e&amp;&amp;e&gt;=d.x)&amp;&amp;d.x&gt;=0&amp;&amp;d.x+d.width&lt;l.el.width()?(0!==l.options.xLabelAngle&amp;&amp;(g=1.25*l.options.gridTextSize/Math.sin(l.options.xLabelAngle*Math.PI/180),e=d.x-g),f=d.x-l.options.xLabelMargin):c.remove()},<a
href="0">d=this.options.parseTime?1===this.data.length&&“auto”===this.options.xLabels?[[this.data</a>.<a
href="0">label,this.data</a>.x]]:b.labelSeries(this.xmin,this.xmax,this.width,this.options.xLabels,this.options.xLabelFormat):function(){var
<a href="a">a,b,c,d;for(c=this.data,d=[],a=0,b=c.length;b>a;a++)g=c</a>,<a
href="g.label,g.x">d.push(</a>);return d}.<a
href="i">call(this),d.reverse(),k=[],i=0,j=d.length;j>i;i++)c=d</a>,<a
href="0">k.push(a(c</a>,<a href="1">c</a>));return
k},c.prototype.drawSeries=function(){var <a
href="">a,b,c,d,e,f;for(this.seriesPoints=[],a=b=d=this.options.ykeys.length-1;0>=d?0>=b:b>=0;a=0>=d?++b:–b)this._drawLineFor(a);for(f=</a>,a=c=e=this.options.ykeys.length-1;0&gt;=e?0&gt;=c:c&gt;=0;a=0&gt;=e?++c:–c)f.push(this._drawPointFor(a));return
f},c.prototype._drawPointFor=function(a){var <a
href="a">b,c,d,e,f,g;for(this.seriesPoints</a>=[],<a
href="d">f=this.data,g=[],d=0,e=f.length;e>d;d++)c=f</a>,<a
href="a">b=null,null!=c._y</a>&amp;&amp;(<a
href="a">b=this.drawLinePoint(c._x,c._y</a>,<a
href="a">this.colorFor(c,a,“point”),a)),g.push(this.seriesPoints</a>.push(b));return
g},c.prototype._drawLineFor=function(a){var b;return <a
href="a">b=this.paths</a>,null!==b?this.drawLinePath(b,this.colorFor(null,a,“line”),a):void
0},c.createPath=function(a,c,d){var
e,f,g,h,i,j,k,l,m,n,o,p,q,r;for(k=“”,c&amp;&amp;(g=b.Line.gradients(a)),l={y:null},<a
href="h">h=q=0,r=a.length;r>q;h=++q)e=a</a>,<a
href="h">null!=e.y&&(null!=l.y?c?(f=g</a>,<a href="h-1">j=g</a>,<a
href="h">i=(e.x-l.x)/4,m=l.x+i,o=Math.min(d,l.y+i*j),n=e.x-i,p=Math.min(d,e.y-i*f),k+=“C”m“,”o“,”n“,”p“,”e.x“,”+e.y):k+=“L”e.x“,”+e.y:c&&null==g</a>||(k+=“M”<code>e.x</code>“,”+e.y)),l=e;return
k},c.gradients=function(a){var
b,c,d,e,f,g,h,i;for(c=function(a,b){return(a.y-b.y)/(a.x-b.x)},<a
href="d">i=[],d=g=0,h=a.length;h>g;d=++g)b=a</a>,<a
href="d+1">null!=b.y?(e=a</a>||{y:null},<a
href="d-1">f=a</a>||{y:null},null!=f.y&amp;&amp;null!=e.y?i.push(c(f,e)):null!=f.y?i.push(c(f,b)):null!=e.y?i.push(c(b,e)):i.push(null)):i.push(null);return
i},c.prototype.hilight=function(a){var <a
href="b">b,c,d,e,f;if(null!==this.prevHilight&&this.prevHilight!==a)for(b=c=0,e=this.seriesPoints.length-1;e>=0?e>=c:c>=e;b=e>=0?++c:–c)this.seriesPoints</a>[<a
href="b">this.prevHilight]&&this.seriesPoints</a>[<a
href="b">this.prevHilight].animate(this.pointShrinkSeries(b));if(null!==a&&this.prevHilight!==a)for(b=d=0,f=this.seriesPoints.length-1;f>=0?f>=d:d>=f;b=f>=0?++d:–d)this.seriesPoints</a>[<a
href="b">a]&&this.seriesPoints</a>[a].animate(this.pointGrowSeries(b));return
this.prevHilight=a},c.prototype.colorFor=function(a,b,c){return“function”==typeof
<a
href="b%this.options.pointFillColors.length">this.options.lineColors?this.options.lineColors.call(this,a,b,c):“point”===c?this.options.pointFillColors</a>||<a
href="b%this.options.lineColors.length">this.options.lineColors</a>:<a
href="b%this.options.lineColors.length">this.options.lineColors</a>},c.prototype.drawXAxisLabel=function(a,b,c){return
...
this.raphael.path(a).attr(“stroke”,b).attr(“stroke-width”,this.lineWidthForSeries©)},c.prototype.drawLinePoint=function(a,b,c,d){return
...
<a
href="a%this.options.pointStrokeWidths.length">this.options.pointStrokeWidths</a>},c.prototype.pointStrokeColorForSeries=function(a){return
<a
href="a%this.options.pointStrokeColors.length">this.options.pointStrokeColors</a>},c.prototype.lineWidthForSeries=function(a){return
this.options.lineWidth instanceof <a
href="a%this.options.lineWidth.length">Array?this.options.lineWidth</a>:this.options.lineWidth},c.prototype.pointSizeForSeries=function(a){return
this.options.pointSize instanceof <a
href="a%this.options.pointSize.length">Array?this.options.pointSize</a>:this.options.pointSize},c.prototype.pointGrowSeries=function(a){return
Raphael.animation({r:this.pointSizeForSeries(a)+3},25,“linear”)},c.prototype.pointShrinkSeries=function(a){return
Raphael.animation({r:this.pointSizeForSeries(a)},25,“linear”)},c}(b.Grid),b.labelSeries=function(c,d,e,f,g){var
h,i,j,k,l,m,n,o,p,q,r;if(j=200*(d-c)/e,i=new <a
href="f">Date©,n=b.LABEL_SPECS</a>,void <a
href="p">0===n)for(r=b.AUTO_LABEL_ORDER,p=0,q=r.length;q>p;p++)if(k=r</a>,<a
href="k">m=b.LABEL_SPECS</a>,j&gt;=m.span){n=m;break}for(void
0===n&amp;&amp;(n=b.LABEL_SPECS.second),g&amp;&amp;(n=a.extend({},n,{fmt:g})),<a
href="n.fmt(h),o">h=n.start(i),l=[];(o=h.getTime())<=d;)o>=c&&l.push(</a>),n.incr(h);return
...
new
Date(a.getFullYear(),a.getMonth(),a.getDate(),a.getHours(),a.getMinutes())},fmt:function(a){return“”+b.pad2(a.getHours())+“:”+b.pad2(a.getMinutes())+“:”+b.pad2(a.getSeconds())},incr:function(b){return
...
Date(a.getFullYear(),a.getMonth(),a.getDate())},fmt:function(a){return“”+a.getFullYear()+“-”+b.pad2(a.getMonth()<code>1)</code>“-”+b.pad2(a.getDate())},incr:function(a){return
a.setDate(a.getDate()+7)}},day:{span:864e5,start:function(a){return new
Date(a.getFullYear(),a.getMonth(),a.getDate())},fmt:function(a){return“”+a.getFullYear()+“-”+b.pad2(a.getMonth()<code>1)</code>“-”+b.pad2(a.getDate())},incr:function(a){return
a.setDate(a.getDate()+1)}},hour:c(60),“30min”:c(30),“15min”:c(15),“10min”:c(10),“5min”:c(5),minute:c(1),“30sec”:d(30),“15sec”:d(15),“10sec”:d(10),“5sec”:d(5),second:d(1)},<a
href=""decade","year","month","week","day","hour","30min","15min","10min","5min","minute","30sec","15sec","10sec","5sec","second"">b.AUTO_LABEL_ORDER=</a>,b.Area=function©{function
d©{var f;return this instanceof
...
0):new b.Area©}var e;return
h(d,c),e={fillOpacity:“auto”,behaveLikeLine:!1},d.prototype.calcPoints=function(){var
<a
href="d">a,b,c,d,e,f,g;for(f=this.data,g=[],d=0,e=f.length;e>d;d++)a=f</a>,a._x=this.transX(a.x),b=0,a._y=function(){var
<a
href="d">d,e,f,g;for(f=a.y,g=[],d=0,e=f.length;e>d;d++)c=f</a>,this.options.behaveLikeLine?g.push(this.transY©):(b+=c||0,g.push(this.transY(b)));return
g}.call(this),g.push(a._ymax=Math.max.apply(Math,a._y));return
g},d.prototype.drawSeries=function(){var <a
href="">a,b,c,d,e,f,g,h;for(this.seriesPoints=[],b=this.options.behaveLikeLine?function(){f=</a>;for(var
...
g}.<a
href="c">apply(this),h=[],c=0,d=b.length;d>c;c++)a=b</a>,this._drawFillFor(a),this._drawLineFor(a),h.push(this._drawPointFor(a));return
h},d.prototype._drawFillFor=function(a){var b;return <a
href="a">b=this.paths</a>,null!==b?(b+=“L”+this.transX(this.xmax)+“,”<code>this.bottom</code>“L”+this.transX(this.xmin)+“,”<code>this.bottom</code>“Z”,this.drawFilledPath(b,this.fillForSeries(a))):void
0},d.prototype.fillForSeries=function(a){var b;return <a
href="a">b=Raphael.rgb2hsl(this.colorFor(this.data</a>,a,“line”)),Raphael.hsl(b.h,this.options.behaveLikeLine?.9*b.s:.75*b.s,Math.min(.98,this.options.behaveLikeLine?1.2*b.l:1.25*b.l))},d.prototype.drawFilledPath=function(a,b){return
this.raphael.path(a).attr(“fill”,b).attr(“fill-opacity”,this.options.fillOpacity).attr(“stroke”,“none”)},d}(b.Line),b.Bar=function©{function
d©{return
...
0):new b.Bar©}return h(d,c),d.prototype.init=function(){return
this.cumulative=this.options.stacked,“always”!==this.options.hideHover?(this.hover=new
b.Hover({parent:this.el}),this.on(“hovermove”,this.onHoverMove),this.on(“hoverout”,this.onHoverOut),this.on(“gridclick”,this.onGridClick)):void
0},d.prototype.defaults={<a
href=""#0b62a4","#7a92a3","#4da74d","#afd8f8","#edc240","#cb4b4b","#9440ed"">barSizeRatio:.75,barGap:3,barColors:</a>,<a
href="0,0,0,0">barOpacity:1,barRadius:</a>,xLabelMargin:50},d.prototype.calc=function(){var
a;return
this.calcBars(),this.options.hideHover===!1?(a=this.hover).update.apply(a,this.hoverContentForRow(this.data.length-1)):void
0},d.prototype.calcBars=function(){var <a
href="a">a,b,c,d,e,f,g;for(f=this.data,g=[],a=d=0,e=f.length;e>d;a=++d)b=f</a>,b._x=this.left+this.width*(a+.5)/this.data.length,g.push(b._y=function(){var
<a
href="a">a,d,e,f;for(e=b.y,f=[],a=0,d=e.length;d>a;a++)c=e</a>,null!=c?f.push(this.transY©):f.push(null);return
...
<a
href="this.data.length-1-a">a,b,c,d,e,f,g,h,i,j,k,l,m;for(j=this.bottom+(this.options.xAxisLabelTopPadding||this.options.padding/2),g=null,f=null,m=[],a=k=0,l=this.data.length;l>=0?l>k:k>l;a=l>=0?++k:–k)h=this.data</a>,b=this.drawXAxisLabel(h._x,j,h.label),i=b.getBBox(),b.transform(“r”+-this.options.xLabelAngle),c=b.getBBox(),b.transform(“t0,”<code>c.height/2</code>“…”),0!==this.options.xLabelAngle&amp;&amp;(e=-.5*i.width*Math.cos(this.options.xLabelAngle*Math.PI/180),b.transform(“t”<code>e</code>“,0…”)),(null==g||g&gt;=c.x+c.width||null!=f&amp;&amp;f&gt;=c.x)&amp;&amp;c.x&gt;=0&amp;&amp;c.x+c.width&lt;this.el.width()?(0!==this.options.xLabelAngle&amp;&amp;(d=1.25*this.options.gridTextSize/Math.sin(this.options.xLabelAngle*Math.PI/180),f=c.x-d),m.push(g=c.x-this.options.xLabelMargin)):m.push(b.remove());return
m},d.prototype.drawSeries=function(){var
...
<a
href="d">h,l,p,q;for(p=this.data,q=[],d=h=0,l=p.length;l>h;d=++h)i=p</a>,e=0,q.push(function(){var
<a
href="j">h,l,p,q;for(p=i._y,q=[],j=h=0,l=p.length;l>h;j=++h)n=p</a>,null!==n?(o?(m=Math.min(n,o),b=Math.max(n,o)):(m=n,b=this.bottom),f=this.left+d*c+g,this.options.stacked||(f+=j*(a+this.options.barGap)),k=b-m,this.options.verticalGridCondition&amp;&amp;this.options.verticalGridCondition(i.x)&amp;&amp;this.drawBar(this.left+d*c,this.top,c,Math.abs(this.top-this.bottom),this.options.verticalGridColor,this.options.verticalGridOpacity,this.options.barRadius),this.options.stacked&amp;&amp;(m-=e),this.drawBar(f,m,a,k,this.colorFor(i,j,“bar”),this.options.barOpacity,this.options.barRadius),q.push(e+=k)):q.push(null);return
q}.call(this));return
q}.call(this)},d.prototype.colorFor=function(a,b,c){var
d,e;return“function”==typeof this.options.barColors?(d={<a
href="b">x:a.x,y:a.y</a>,label:a.label},e={<a
href="b">index:b,key:this.options.ykeys</a>,<a
href="b">label:this.options.labels</a>},<a
href="b%this.options.barColors.length">this.options.barColors.call(this,d,e,c)):this.options.barColors</a>},d.prototype.hitTest=function(a){return
...
c;return <a
href="c">c=this.hitTest(a),this.fire(“click”,c,this.data</a>.src,a,b)},d.prototype.onHoverMove=function(a){var
b,c;return
...
0},d.prototype.hoverContentForRow=function(a){var <a
href="a">b,c,d,e,f,g,h,i;for(d=this.data</a>,b=“&lt;div <a
href="c">class=‘morris-hover-row-label’>”d.label“</div>”,i=d.y,c=g=0,h=i.length;h>g;c=++g)f=i</a>,b+=“&lt;div
class=&#39;morris-hover-point&#39; style=&#39;color:
”+this.colorFor(d,c,“label”)+“&#39;&gt;n  ”+<a
href="c">this.options.labels</a>+“:n 
”+this.yLabelFormat(f)+“n&lt;/div&gt;”;return“function”==typeof <a
href="b,e">this.options.hoverCallback&&(b=this.options.hoverCallback(a,this.options,b,d.src)),e=this.left+(a+.5)*this.width/this.data.length,</a>},d.prototype.drawXAxisLabel=function(a,b,c){var
d;return
d=this.raphael.text(a,b,c).attr(“font-size”,this.options.gridTextSize).attr(“font-family”,this.options.gridTextFamily).attr(“font-weight”,this.options.gridTextWeight).attr(“fill”,this.options.gridTextColor)},d.prototype.drawBar=function(a,b,c,d,e,f,g){var
h,i;return
...
<a href="0,0,0,0">null==e&&(e=</a>),[“<a href="0">M”,a,e</a>+<a
href="0">b,“Q”,a,b,a+e</a>,<a href="1">b,“L”,a+c-e</a>,<a
href="1">b,“Q”,a+c,b,a+c,b+e</a>,“<a href="2">L”,a+c,b+d-e</a>,“<a
href="2">Q”,a+c,b+d,a+c-e</a>,<a href="3">b+d,“L”,a+e</a>,<a
href="3">b+d,“Q”,a,b+d,a,b+d-e</a>,“Z”]},d}(b.Grid),b.Donut=function©{function
d©{this.resizeHandler=f(this.resizeHandler,this),this.select=f(this.select,this),this.click=f(this.click,this);var
d=this;if(!(this instanceof b.Donut))return new
b.Donut©;if(this.options=a.extend({},this.defaults,c),this.el=“string”==typeof
...
0!==c.data&amp;&amp;0!==c.data.length&amp;&amp;(this.raphael=new <a
href="0">Raphael(this.el</a>),this.options.resize&amp;&amp;a(window).bind(“resize”,function(){return
...
h(d,c),d.prototype.defaults={<a
href=""#0B62A4","#3980B5","#679DC6","#95BBD7","#B0CCE1","#095791","#095085","#083E67","#052C48","#042135"">colors:</a>,backgroundColor:“#FFFFFF”,labelColor:“#000000”,formatter:b.commas,resize:!1},d.prototype.redraw=function(){var
<a
href="o">a,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x;for(this.raphael.clear(),c=this.el.width()/2,d=this.el.height()/2,n=(Math.min(c,d)-10)/3,l=0,u=this.values,o=0,r=u.length;r>o;o++)m=u</a>,<a
href="e">l+=m;for(i=5/(2*n),a=1.9999*Math.PI-i*this.data.length,g=0,f=0,this.segments=[],v=this.values,e=p=0,s=v.length;s>p;e=++p)m=v</a>,j=g+i+a*(m/l),k=new
<a href="e">b.DonutSegment(c,d,2*n,n,g,j,this.data</a>.<a
href="f%this.options.colors.length">color||this.options.colors</a>,<a
href="q">this.options.backgroundColor,f,this.raphael),k.render(),this.segments.push(k),k.on(“hover”,this.select),k.on(“click”,this.click),g=j,f+=1;for(this.text1=this.drawEmptyDonutLabel(c,d-10,this.options.labelColor,15,800),this.text2=this.drawEmptyDonutLabel(c,d+10,this.options.labelColor,14),h=Math.max.apply(Math,this.values),f=0,w=this.values,x=[],q=0,t=w.length;t>q;q++){if(m=w</a>,m===h){this.select(f);
break}x.push(f+=1)}return x},d.prototype.setData=function(a){var b;return
this.data=a,this.values=function(){var <a
href="a">a,c,d,e;for(d=this.data,e=[],a=0,c=d.length;c>a;a++)b=d</a>,e.push(parseFloat(b.value));return
e}.call(this),this.redraw()},d.prototype.click=function(a){return <a
href="a">this.fire(“click”,a,this.data</a>)},d.prototype.select=function(a){var
<a
href="e">b,c,d,e,f,g;for(g=this.segments,e=0,f=g.length;f>e;e++)c=g</a>,c.deselect();return
<a href="a">d=this.segments</a>,<a
href="a">d.select(),b=this.data</a>,this.setLabels(b.label,this.options.formatter(b.value,b))},d.prototype.setLabels=function(a,b){var
c,d,e,f,g,h,i,j;return
c=2*(Math.min(this.el.width()/2,this.el.height()/2)-10)/3,f=1.8*c,e=c/2,d=c/3,this.text1.attr({text:a,transform:“”}),g=this.text1.getBBox(),h=Math.min(f/g.width,e/g.height),this.text1.attr({transform:“S”<code>h</code>“,”<code>h</code>“,”+(g.x+g.width/2)+“,”+(g.y+g.height)}),this.text2.attr({text:b,transform:“”}),i=this.text2.getBBox(),j=Math.min(f/i.width,d/i.height),this.text2.attr({transform:“S”<code>j</code>“,”<code>j</code>“,”+(i.x+i.width/2)+“,”+i.y})},d.prototype.drawEmptyDonutLabel=function(a,b,c,d,e){var
f;return
...
h(b,a),b.prototype.calcArcPoints=function(a){<a
href="this.cx+a*this.sin_p0,this.cy+a*this.cos_p0,this.cx+a*this.sin_p1,this.cy+a*this.cos_p1">return</a>},b.prototype.calcSegment=function(a,b){var
c,d,e,f,g,h,i,j,k,l;return <a href="0">k=this.calcArcPoints(a),c=k</a>,<a
href="1">e=k</a>,<a href="2">d=k</a>,<a href="3">f=k</a>,<a
href="0">l=this.calcArcPoints(b),g=l</a>,<a href="1">i=l</a>,<a
href="2">h=l</a>,<a
href="3">j=l</a>,“M”<code>c</code>“,”<code>e</code>(“A”<code>a</code>“,”<code>a</code>“,0,”<code>this.is_long</code>“,0,”<code>d</code>“,”<code>f)</code>(“L”<code>h</code>“,”<code>j)</code>(“A”<code>b</code>“,”<code>b</code>“,0,”<code>this.is_long</code>“,1,”<code>g</code>“,”<code>i)</code>“Z”},b.prototype.calcArc=function(a){var
b,c,d,e,f;return <a href="0">f=this.calcArcPoints(a),b=f</a>,<a
href="1">d=f</a>,<a href="2">c=f</a>,<a
href="3">e=f</a>,“M”<code>b</code>“,”<code>d</code>(“A”<code>a</code>“,”<code>a</code>“,0,”<code>this.is_long</code>“,0,”<code>c</code>“,”+e)},b.prototype.render=function(){var
a=this;return
...
this.raphael.path(a).attr({fill:b,stroke:c,“stroke-width”:3}).hover(d).click(e)},b.prototype.select=function(){return
this.selected?void
...
0},b}(b.EventEmitter)}).call(this);</p>
</main>
