...
<title>fastclick.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/fastclick/fastclick.min.js">

<p>!function e(t,n,r){function i(s,a){<a href="s">if(!n</a>){<a
href="s">if(!t</a>){var c=“function”==typeof
require&amp;&amp;require;if(!a&amp;&amp;c)return c(s,!0);if(o)return
o(s,!0);var l=new Error(“Cannot find module
&#39;”<code>s</code>“&#39;”);throw l.code=“MODULE_NOT_FOUND”,l}var <a
href="s">u=n</a>={exports:{}};<a
href="s">t</a>[0].call(u.exports,function(e){var <a href="s">n=t</a>[<a
href="e">1]</a>;return i(n?n:e)},u,u.exports,e,t,n,r)}return <a
href="s">n</a>.exports}for(var o=“function”==typeof <a
href="s">require&&require,s=0;s<r.length;s++)i(r</a>);return
i}({1:[function(e,t){!function(){“use strict”;function e(t,n){function
i(e,t){return function(){return e.apply(t,arguments)}}var
o;if(n=n||{},this.trackingClick=!1,this.trackingClickStart=0,this.targetElement=null,this.touchStartX=0,this.touchStartY=0,this.lastTouchIdentifier=0,this.touchBoundary=n.touchBoundary||10,this.layer=t,this.tapDelay=n.tapDelay||200,this.tapTimeout=n.tapTimeout||700,!e.notNeeded(t)){for(var
<a
href=""onMouse","onClick","onTouchStart","onTouchMove","onTouchEnd","onTouchCancel"">s=</a>,<a
href="c">a=this,c=0,l=s.length;l>c;c++)a[s</a>]=<a
href="c">i(a[s</a>],a);r&amp;&amp;(t.addEventListener(“mouseover”,this.onMouse,!0),t.addEventListener(“mousedown”,this.onMouse,!0),t.addEventListener(“mouseup”,this.onMouse,!0)),t.addEventListener(“click”,this.onClick,!0),t.addEventListener(“touchstart”,this.onTouchStart,!1),t.addEventListener(“touchmove”,this.onTouchMove,!1),t.addEventListener(“touchend”,this.onTouchEnd,!1),t.addEventListener(“touchcancel”,this.onTouchCancel,!1),Event.prototype.stopImmediatePropagation||(t.removeEventListener=function(e,n,r){var
i=Node.prototype.removeEventListener;“click”===e?i.call(t,e,n.hijacked||n,r):i.call(t,e,n,r)},t.addEventListener=function(e,n,r){var
i=Node.prototype.addEventListener;“click”===e?i.call(t,e,n.hijacked||(n.hijacked=function(e){e.propagationStopped||n(e)}),r):i.call(t,e,n,r)}),“function”==typeof
t.onclick&amp;&amp;(o=t.onclick,t.addEventListener(“click”,function(e){o(e)},!1),t.onclick=null)}}var
n=navigator.userAgent.indexOf(“Windows
Phone”)&gt;=0,r=navigator.userAgent.indexOf(“Android”)&gt;0&amp;&amp;!n,i=/iP(ad|hone|od)/.test(navigator.userAgent)&amp;&amp;!n,o=i&amp;&amp;/OS
4_d(_d)?/.test(navigator.userAgent),s=i&amp;&amp;/OS
[6-7]_d/.test(navigator.userAgent),a=navigator.userAgent.indexOf(“BB10”)&gt;0;e.prototype.needsClick=function(e){switch(e.nodeName.toLowerCase()){case“button”:case“select”:case“textarea”:if(e.disabled)return!0;break;case“input”:if(i&amp;&amp;“file”===e.type||e.disabled)return!0;break;case“label”:case“iframe”:case“video”:return!0}return/bneedsclickb/.test(e.className)},e.prototype.needsFocus=function(e){switch(e.nodeName.toLowerCase()){case“textarea”:return!0;case“select”:return!r;case“input”:switch(e.type){case“button”:case“checkbox”:case“file”:case“image”:case“radio”:case“submit”:return!1}return!e.disabled&amp;&amp;!e.readOnly;default:return/bneedsfocusb/.test(e.className)}},e.prototype.sendClick=function(e,t){var
<a
href="0">n,r;document.activeElement&&document.activeElement!==e&&document.activeElement.blur(),r=t.changedTouches</a>,n=document.createEvent(“MouseEvents”),n.initMouseEvent(this.determineEventType(e),!0,!0,window,1,r.screenX,r.screenY,r.clientX,r.clientY,!1,!1,!1,!1,0,null),n.forwardedTouchEvent=!0,e.dispatchEvent(n)},e.prototype.determineEventType=function(e){return
r&amp;&amp;“select”===e.tagName.toLowerCase()?“mousedown”:“click”},e.prototype.focus=function(e){var
t;i&amp;&amp;e.setSelectionRange&amp;&amp;0!==e.type.indexOf(“date”)&amp;&amp;“time”!==e.type&amp;&amp;“month”!==e.type?(t=e.value.length,e.setSelectionRange(t,t)):e.focus()},e.prototype.updateScrollParent=function(e){var
t,n;if(t=e.fastClickScrollParent,!t||!t.contains(e)){n=e;do{if(n.scrollHeight&gt;n.offsetHeight){t=n,e.fastClickScrollParent=n;break}n=n.parentElement}while(n)}t&amp;&amp;(t.fastClickLastScrollTop=t.scrollTop)},e.prototype.getTargetElementFromEventTarget=function(e){return
e.nodeType===Node.TEXT_NODE?e.parentNode:e},e.prototype.onTouchStart=function(e){var
<a
href="0">t,n,r;if(e.targetTouches.length>1)return!0;if(t=this.getTargetElementFromEventTarget(e.target),n=e.targetTouches</a>,i){if(r=window.getSelection(),r.rangeCount&amp;&amp;!r.isCollapsed)return!0;if(!o){if(n.identifier&amp;&amp;n.identifier===this.lastTouchIdentifier)return
e.preventDefault(),!1;this.lastTouchIdentifier=n.identifier,this.updateScrollParent(t)}}return
this.trackingClick=!0,this.trackingClickStart=e.timeStamp,this.targetElement=t,this.touchStartX=n.pageX,this.touchStartY=n.pageY,e.timeStamp-this.lastClickTime&lt;this.tapDelay&amp;&amp;e.preventDefault(),!0},e.prototype.touchHasMoved=function(e){var
<a href="0">t=e.changedTouches</a>,n=this.touchBoundary;return
Math.abs(t.pageX-this.touchStartX)&gt;n||Math.abs(t.pageY-this.touchStartY)&gt;n?!0:!1},e.prototype.onTouchMove=function(e){return
this.trackingClick?((this.targetElement!==this.getTargetElementFromEventTarget(e.target)||this.touchHasMoved(e))&amp;&amp;(this.trackingClick=!1,this.targetElement=null),!0):!0},e.prototype.findControl=function(e){return
void
0!==e.control?e.control:e.htmlFor?document.getElementById(e.htmlFor):e.querySelector(“button,
<a href="type=hidden">input:not(</a>), keygen, meter, output, progress,
select, textarea”)},e.prototype.onTouchEnd=function(e){var
t,n,a,c,l,u=this.targetElement;if(!this.trackingClick)return!0;if(e.timeStamp-this.lastClickTime&lt;this.tapDelay)return
<a
href="0">this.cancelNextClick=!0,!0;if(e.timeStamp-this.trackingClickStart>this.tapTimeout)return!0;if(this.cancelNextClick=!1,this.lastClickTime=e.timeStamp,n=this.trackingClickStart,this.trackingClick=!1,this.trackingClickStart=0,s&&(l=e.changedTouches</a>,u=document.elementFromPoint(l.pageX-window.pageXOffset,l.pageY-window.pageYOffset)||u,u.fastClickScrollParent=this.targetElement.fastClickScrollParent),a=u.tagName.toLowerCase(),“label”===a){if(t=this.findControl(u)){if(this.focus(u),r)return!1;u=t}}else
if(this.needsFocus(u))return
e.timeStamp-n&gt;100||i&amp;&amp;window.top!==window&amp;&amp;“input”===a?(this.targetElement=null,!1):(this.focus(u),this.sendClick(u,e),i&amp;&amp;“select”===a||(this.targetElement=null,e.preventDefault()),!1);return
i&amp;&amp;!o&amp;&amp;(c=u.fastClickScrollParent,c&amp;&amp;c.fastClickLastScrollTop!==c.scrollTop)?!0:(this.needsClick(u)||(e.preventDefault(),this.sendClick(u,e)),!1)},e.prototype.onTouchCancel=function(){this.trackingClick=!1,this.targetElement=null},e.prototype.onMouse=function(e){return
this.targetElement?e.forwardedTouchEvent?!0:e.cancelable&amp;&amp;(!this.needsClick(this.targetElement)||this.cancelNextClick)?(e.stopImmediatePropagation?e.stopImmediatePropagation():e.propagationStopped=!0,e.stopPropagation(),e.preventDefault(),!1):!0:!0},e.prototype.onClick=function(e){var
t;return
this.trackingClick?(this.targetElement=null,this.trackingClick=!1,!0):“submit”===e.target.type&amp;&amp;0===e.detail?!0:(t=this.onMouse(e),t||(this.targetElement=null),t)},e.prototype.destroy=function(){var
e=this.layer;r&amp;&amp;(e.removeEventListener(“mouseover”,this.onMouse,!0),e.removeEventListener(“mousedown”,this.onMouse,!0),e.removeEventListener(“mouseup”,this.onMouse,!0)),e.removeEventListener(“click”,this.onClick,!0),e.removeEventListener(“touchstart”,this.onTouchStart,!1),e.removeEventListener(“touchmove”,this.onTouchMove,!1),e.removeEventListener(“touchend”,this.onTouchEnd,!1),e.removeEventListener(“touchcancel”,this.onTouchCancel,!1)},e.notNeeded=function(e){var
t,n,i,o;if(“undefined”==typeof <a
href="0-9">window.ontouchstart)return!0;if(n=+(/Chrome/(</a>+)/.<a
href=",0">exec(navigator.userAgent)||</a>)[1]){<a
href="name=viewport">if(!r)return!0;if(t=document.querySelector(“meta</a>”)){if(-1!==t.content.indexOf(“user-scalable=no”))return!0;if(n&gt;31&amp;&amp;document.documentElement.scrollWidth&lt;=window.outerWidth)return!0}}<a
href="0-9">if(a&&(i=navigator.userAgent.match(/Version/(</a>*).([<a
href="1">0-9]*)/),i</a>&gt;=<a href="2">10&&i</a>&gt;=<a
href="name=viewport">3&&(t=document.querySelector(“meta</a>”)))){if(-1!==t.content.indexOf(“user-scalable=no”))return!0;if(document.documentElement.scrollWidth&lt;=window.outerWidth)return!0}<a
href="0-9">return“none”===e.style.msTouchAction||“manipulation”===e.style.touchAction?!0:(o=+(/Firefox/(</a>+)/.<a
href=",0">exec(navigator.userAgent)||</a>)[<a
href="name=viewport">1],o>=27&&(t=document.querySelector(“meta</a>”),t&amp;&amp;(-1!==t.content.indexOf(“user-scalable=no”)||document.documentElement.scrollWidth&lt;=window.outerWidth))?!0:“none”===e.style.touchAction||“manipulation”===e.style.touchAction?!0:!1)},e.attach=function(t,n){return
new e(t,n)},“function”==typeof define&amp;&amp;“object”==typeof
define.amd&amp;&amp;define.amd?define(function(){return
e}):“undefined”!=typeof
t&amp;&amp;t.exports?(t.exports=e.attach,t.exports.FastClick=e):window.FastClick=e}()},{}],<a
href="function(e){window.Origami={fastclick:e("./bower_components/fastclick/lib/fastclick.js")}},{"./bower_components/fastclick/lib/fastclick.js":1}">2:</a>},{},[2]);;(function()
{function trigger(){document.dispatchEvent(new
CustomEvent(&#39;o.load&#39;))};document.addEventListener(&#39;load&#39;,trigger);if
(document.readyState===&#39;ready&#39;) trigger();}());(function()
{function trigger(){document.dispatchEvent(new
CustomEvent(&#39;o.DOMContentLoaded&#39;))};document.addEventListener(&#39;DOMContentLoaded&#39;,trigger);if
(document.readyState===&#39;interactive&#39;) trigger();}())</p>
</main>
