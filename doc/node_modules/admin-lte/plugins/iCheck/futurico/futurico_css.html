...
<title>futurico.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/iCheck/futurico/futurico.css">

<pre class="ruby"><span class="ruby-identifier">iCheck</span> <span class="ruby-identifier">plugin</span> <span class="ruby-constant">Futurico</span> <span class="ruby-identifier">skin</span>
</pre>
<hr>

<p>.icheckbox_futurico, .iradio_futurico {</p>
...
<p>.icheckbox_futurico {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_futurico.checked {
...
<pre>background-position: -72px 0;</pre>

<p>}</p>

<pre> .iradio_futurico.checked {
