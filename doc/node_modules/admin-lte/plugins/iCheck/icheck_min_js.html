...
<title>icheck.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/iCheck/icheck.min.js">

<pre>! iCheck v1.0.1 by Damir Sultanov, http://git.io/arlzeA, MIT Licensed</pre>

<p>(function(h){function F(a,b,d){var <a
href="0">c=a</a>,e=/er/.test(d)?m:/bl/.test(d)?s:l,f=d==H?{<a
href="l">checked:c</a>,<a
href="s">disabled:c</a>,indeterminate:“true”==a.attr(m)||“false”==a.attr(w)}:<a
href="e">c</a>;if(/^(ch|di|in)/.test(d)&amp;&amp;!f)D(a,e);else
if(/^(un|en|de)/.test(d)&amp;&amp;f)t(a,e);else if(d==H)for(e in <a
href="e">f)f</a>?D(a,e,!0):t(a,e,!0);else if(!b||“toggle”==d){<a
href="p">if(!b)a</a>(“<a
href="n">ifClicked”);f?c</a>!==u&amp;&amp;t(a,e):D(a,e)}}function
D(a,b,d){var <a href="0">c=a</a>,<a
href="n">e=a.parent(),f=b==l,A=b==m,B=b==s,K=A?w:f?E:“enabled”,p=k(a,K+x(c</a>)),<a
href="n">N=k(a,b+x(c</a>));<a href="b">if(!0!==c</a>){if(!d&amp;&amp; <a
href="n">b==l&&c</a>==u&amp;&amp;c.name){var <a
href="name="'c.name'"">C=a.closest(“form”),r=‘input</a>&#39;,r=C.length?C.find®:h®;r.each(function(){this!==c&amp;&amp;h(this).data(q)&amp;&amp;t(h(this),b)})}<a
href="b">A?(c</a>=!<a href="l">0,c</a>&amp;&amp;<a
href="b">t(a,l,“force”)):(d||(c</a>=!<a
href="m">0),f&&c</a>&amp;&amp;t(a,m,!1));L(a,f,b,d)}<a
href="s">c</a>&amp;&amp;<a
href="v">k(a,y,!0)&&e.find(“.”+I).css(y,“default”);e</a>(<a
href="z">N||k(a,b)||“”);B?e.attr(“aria-disabled”,“true”):e.attr(“aria-checked”,A?“mixed”:“true”);e</a>(p||k(a,K)||“”)}function
t(a,b,d){var <a href="0">c=a</a>,<a
href="n">e=a.parent(),f=b==l,h=b==m,q=b==s,p=h?w:f?E:“enabled”,t=k(a,p+x(c</a>)),
<a href="n">u=k(a,b+x(c</a>));<a href="b">if(!1!==c</a>){<a
href="b">if(h||!d||“force”==d)c</a>=!1;L(a,f,p,d)}!<a
href="s">c</a>&amp;&amp;<a
href="z">k(a,y,!0)&&e.find(“.”+I).css(y,“pointer”);e</a>(<a
href="v">u||k(a,b)||“”);q?e.attr(“aria-disabled”,“false”):e.attr(“aria-checked”,“false”);e</a>(t||k(a,p)||“”)}function
M(a,b){if(a.data(q)){<a
href="p">a.parent().html(a.attr(“style”,a.data(q).s||“”));if(b)a</a>(<a
href="0">b);a.off(“.i”).unwrap();h(G+’[for=“‘+a</a>.id+&#39;”]&#39;).add(a.closest(G)).off(“.i”)}}function
k(a,b,d){if(a.data(q))return <a
href="b+(d?"":"Class")">a.data(q).o</a>}function x(a){return
a.charAt(0).toUpperCase()+ a.slice(1)}function L(a,b,d,c){if(!c){<a
href="p">if(b)a</a>(“<a href="p">ifToggled”);a</a>(“<a
href="p">ifChanged”)</a>(“if”+x(d))}}var
q=“iCheck”,I=q+“-helper”,u=“radio”,l=“checked”,E=“un”+l,s=“disabled”,w=“determinate”,m=“in”+w,H=“update”,n=“type”,v=“addClass”,z=“removeClass”,p=“trigger”,G=“label”,y=“cursor”,J=/ipad|iphone|ipod|android|blackberry|windows
phone|opera <a
href="q">mini|silk/i.test(navigator.userAgent);h.fn</a>=function(a,b){var
<a href="type="checkbox"">d=’input</a>, <a
href="type="'u'"">input</a>&#39;,c=h(),e=function(a){a.each(function(){var
a=h(this);c=a.is(d)?
c.add(a):c.add(a.find(d))})};if(/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(a))return
a=a.toLowerCase(),e(this),c.each(function(){var
c=h(this);“destroy”==a?M(c,“ifDestroyed”):F(c,!0,a);h.isFunction(b)&amp;&amp;b()});if(“object”!=typeof
a&amp;&amp;a)return this;var
f=h.extend({checkedClass:l,disabledClass:s,indeterminateClass:m,labelHover:!0,aria:!1},a),k=f.handle,B=f.hoverClass||“hover”,x=f.focusClass||“focus”,w=f.activeClass||“active”,y=!!f.labelHover,C=f.labelHoverClass||
“<a
href="type="'k'"">hover”,r=(“”+f.increaseArea).replace(“%”,“”)|0;if(“checkbox”==k||k==u)d=‘input</a>&#39;;-50&gt;r&amp;&amp;(r=-50);e(this);return
c.each(function(){var a=h(this);M(a);var
c=this,b=c.id,e=-r+“%”,d=100+2*r+“%”,d={position:“absolute”,top:e,left:e,display:“block”,width:d,height:d,margin:0,padding:0,background:“#fff”,border:0,opacity:0},e=J?{position:“absolute”,visibility:“hidden”}:r?d:{position:“absolute”,opacity:0},<a
href="n">k=“checkbox”==c</a>?<a
href="for="'b'"">f.checkboxClass||“icheckbox”:f.radioClass||“i”+u,m=h(G+’</a>&#39;).add(a.closest(G)),
A=!!f.aria,E=q+“-”+Math.random().toString(36).replace(“0.”,“”),g=&#39;&lt;div
class=“&#39;<code>k</code>&#39;” &#39;+(<a href="n">A?‘role=“’+c</a>+&#39;”
&#39;:“”);m.length&amp;&amp;A&amp;&amp;m.each(function(){g+=&#39;aria-labelledby=“&#39;;this.id?g+=this.id:(this.id=E,g+=E);g+=&#39;”&#39;});<a
href="p">g=a.wrap(g+“/>”)</a>(“ifCreated”).parent().append(f.insert);d=h(&#39;&lt;ins
class=“&#39;<code>I</code>&#39;”/&gt;&#39;).css(d).appendTo(g);a.data(q,{o:f,s:a.attr(“style”)}).<a
href="v">css(e);f.inheritClass&&g</a>(c.className||“”);f.inheritID&amp;&amp;b&amp;&amp;g.attr(“id”,q+“-”+b);“static”==g.css(“position”)&amp;&amp;g.css(“position”,“relative”);F(a,!0,H);
if(m.length)m.on(“click.i mouseover.i mouseout.i touchbegin.i
touchend.i”,function(b){var <a href="n">d=b</a>,<a
href="s">e=h(this);if(!c</a>){if(“click”==d){if(h(b.target).is(“a”))return;F(a,!1,!0)}else
<a href="z">y&&(/ut|nd/.test(d)?(g</a>(<a href="z">B),e</a>(<a
href="v">C)):(g</a>(<a href="v">B),e</a>(C)));if(J)b.stopPropagation();else
return!1}});a.on(“click.i focus.i blur.i keyup.i keydown.i
keypress.i”,function(b){var <a
href="n">d=b</a>;b=b.keyCode;if(“click”==d)return!1;if(“keydown”==d&amp;&amp;32==b)return
<a href="n">c</a>==<a href="l">u&&c</a>||(<a href="l">c</a>?<a
href="n">t(a,l):D(a,l)),!1;if(“keyup”==d&&c</a>==<a
href="l">u)!c</a>&amp;&amp;D(a,l);else if(/us|ur/.test(d))g[“blur”==
d?z:v](x)});d.on(“click mousedown mouseup mouseover mouseout touchbegin.i
touchend.i”,function(b){var <a href="n">d=b</a>,<a
href="s">e=/wn|up/.test(d)?w:B;if(!c</a>){if(“click”==d)F(a,!1,!0);else{<a
href="v">if(/wn|er|in/.test(d))g</a>(e);else <a href="z">g</a>(e+“ ”+<a
href="/ut|nd/.test(d)?z:v">w);if(m.length&&y&&e==B)m</a>(C)}if(J)b.stopPropagation();else
return!1}})})}})(window.jQuery||window.Zepto);</p>
</main>
