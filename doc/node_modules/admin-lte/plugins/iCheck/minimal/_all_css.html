...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/iCheck/minimal/_all.css">

<pre class="ruby"><span class="ruby-identifier">red</span>
</pre>

<p>.icheckbox_minimal-red, .iradio_minimal-red {</p>
...
<p>.icheckbox_minimal-red {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-red.hover {
...
<p>.iradio_minimal-red {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre> .iradio_minimal-red.hover {
...
<p>/* green */ .icheckbox_minimal-green, .iradio_minimal-green {</p>
...
<p>.icheckbox_minimal-green {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-green.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-green {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-green.hover {
    background-position: -120px 0;
}
...
<p>/* blue */ .icheckbox_minimal-blue, .iradio_minimal-blue {</p>
...
<p>.icheckbox_minimal-blue {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-blue.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-blue {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-blue.hover {
    background-position: -120px 0;
}
...
<p>/* aero */ .icheckbox_minimal-aero, .iradio_minimal-aero {</p>
...
<p>.icheckbox_minimal-aero {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-aero.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-aero {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-aero.hover {
    background-position: -120px 0;
}
...
<p>/* grey */ .icheckbox_minimal-grey, .iradio_minimal-grey {</p>
...
<p>.icheckbox_minimal-grey {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-grey.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-grey {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-grey.hover {
    background-position: -120px 0;
}
...
<p>/* orange */ .icheckbox_minimal-orange, .iradio_minimal-orange {</p>
...
<p>.icheckbox_minimal-orange {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-orange.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-orange {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-orange.hover {
    background-position: -120px 0;
}
...
<p>/* yellow */ .icheckbox_minimal-yellow, .iradio_minimal-yellow {</p>
...
<p>.icheckbox_minimal-yellow {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-yellow.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-yellow {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-yellow.hover {
    background-position: -120px 0;
}
...
<p>/* pink */ .icheckbox_minimal-pink, .iradio_minimal-pink {</p>
...
<p>.icheckbox_minimal-pink {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-pink.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-pink {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-pink.hover {
    background-position: -120px 0;
}
...
<p>/* purple */ .icheckbox_minimal-purple, .iradio_minimal-purple {</p>
...
<p>.icheckbox_minimal-purple {</p>

<pre>background-position: 0 0;</pre>

<p>}</p>

<pre>.icheckbox_minimal-purple.hover {
    background-position: -20px 0;
}
...
<p>.iradio_minimal-purple {</p>

<pre>background-position: -100px 0;</pre>

<p>}</p>

<pre>.iradio_minimal-purple.hover {
    background-position: -120px 0;
}
