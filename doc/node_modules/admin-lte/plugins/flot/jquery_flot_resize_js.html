...
<title>jquery.flot.resize.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.resize.js">

<pre>Flot plugin for automatically redrawing plots as the placeholder resizes.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>It works by listening for changes on the placeholder div (through the
jQuery resize event plugin) - if the size changes, it will redraw the plot.</p>

<p>There are no options. If you need to disable the plugin for some plots, you
can just fix the size of their placeholders.</p>

<p>/* Inline dependency:</p>

<pre> jQuery resize event - v1.1 - 3/14/2010
...
<p>(function($,t,n){function p(){for(var n=r.length-1;n&gt;=0;n–){var <a
href="n">o=$(r</a>);<a href="0">if(o</a>==t||o.is(“:visible”)){var <a
href="f">h=o.width(),d=o.height(),v=o.data(a);!v||h===v.w&&d===v.h?i</a>=<a
href="l">i</a>:(<a href="f">i</a>=<a href="c">i</a>,<a
href="v.w=h,v.h=d">o.trigger(u,</a>))}else
v=o.data(a),v.w=0,v.h=0}s!==null&amp;&amp;(s=t.requestAnimationFrame(p))}var
<a
href="l">r=[],i=$.resize=$.extend($.resize,{}),s,o=“setTimeout”,u=“resize”,a=u+“-special-event”,f=“delay”,l=“pendingDelay”,c=“activeDelay”,h=“throttleWindow”;i</a>=<a
href="c">250,i</a>=<a href="f">20,i</a>=<a href="l">i</a>,<a
href="h">i</a>=!<a href="u">0,$.event.special</a>={setup:function(){<a
href="h">if(!i</a>&amp;&amp;<a href="o">this</a>)return!1;var
t=$(this);r.push(this),t.data(a,{w:t.width(),h:t.height()}),r.length===1&amp;&amp;(s=n,p())},teardown:function(){<a
href="h">if(!i</a>&amp;&amp;<a href="o">this</a>)return!1;var
t=$(this);for(var <a
href="n">n=r.length-1;n>=0;n–)if(r</a>==this){r.splice(n,1);break}t.removeData(a),r.length||(cancelAnimationFrame(s),s=null)},add:function(t){function
s(t,i,s){var
o=$(this),u=o.data(a);u.w=i!==n?i:o.width(),u.h=s!==n?s:o.height(),r.apply(this,arguments)}<a
href="h">if(!i</a>&amp;&amp;<a href="o">this</a>)return!1;var
r;if($.isFunction(t))return
r=t,s;r=t.handler,t.handler=s}},t.requestAnimationFrame||(t.requestAnimationFrame=function(){return
t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||t.oRequestAnimationFrame||t.msRequestAnimationFrame||function(e,n){return
<a
href="f">t.setTimeout(e,i</a>)}}()),t.cancelAnimationFrame||(t.cancelAnimationFrame=function(){return
t.webkitCancelRequestAnimationFrame||t.mozCancelRequestAnimationFrame||t.oCancelRequestAnimationFrame||t.msCancelRequestAnimationFrame||clearTimeout}())})(jQuery,this);</p>

<p>(function ($) {</p>

<pre>var options = { }; // no options
