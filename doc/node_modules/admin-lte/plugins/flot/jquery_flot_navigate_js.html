...
<title>jquery.flot.navigate.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.navigate.js">

<pre>Flot plugin for adding the ability to pan and zoom the plot.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>The default behaviour is double click and scrollwheel up/down to zoom in,
drag to pan. The plugin defines plot.zoom({ center }), plot.zoomOut() and
plot.pan( offset ) so you easily can add custom controls. It also fires
“plotpan” and “plotzoom” events, useful for synchronizing plots.</p>

<p>The plugin supports these options:</p>
...
<p>“interactive” enables the built-in drag/click behaviour. If you enable
interactive for pan, then you&#39;ll have a basic plot that supports moving
around; the same for zoom.</p>

<p>“amount” specifies the default amount to zoom in (so 1.5 = 150%) relative
to the current viewport.</p>

<p>“cursor” is a standard CSS mouse cursor string used for visual feedback to
the user when dragging.</p>

<p>“frameRate” specifies the maximum number of times per second the plot will
update itself while the user is panning around on it (set to null to
disable intermediate pans, the plot will then not update until the mouse
button is released).</p>

<p>“zoomRange” is the interval in which zooming can happen, e.g. with
zoomRange:</p>
<dl class="rdoc-list label-list"><dt>1, 100
<dd>
<p>the zoom will never scale the axis so that the difference between min</p>
</dd></dl>

<p>and max is smaller than 1 or larger than 100. You can set either end to
null to ignore, e.g. [1, null]. If you set zoomRange to false, zooming on
that axis will be disabled.</p>

<p>“panRange” confines the panning to stay within a range, e.g. with panRange:</p>
<dl class="rdoc-list label-list"><dt>-10, 20
<dd>
<p>panning stops at -10 in one end and at 20 in the other. Either can</p>
</dd></dl>

<p>be null, e.g. [-10, null]. If you set panRange to false, panning on that
axis will be disabled.</p>
...
plot.pan({ left: -100, top: 20 })</pre>

<p>Here, “center” specifies where the center of the zooming should happen.
Note that this is defined in pixel space, not the space of the data points
(you can use the p2c helpers on the axes in Flot to help you convert
between these).</p>

<p>“amount” is the amount to zoom the viewport relative to the current range,
so 1 is 100% (i.e. no change), 1.5 is 150% (zoom in), 0.7 is 70% (zoom
out). You can set the default in the options.</p>

<p>// First two dependencies, jquery.event.drag.js and //
jquery.mousewheel.js, we put them inline here to save people the // effort
of downloading them.</p>

<p>/* jquery.event.drag.js ~ v1.5 ~ Copyright © 2008, Three Dub Media (<a
href="http://threedubmedia.com">threedubmedia.com</a>) Licensed under the
MIT <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a> ~
<a
href="http://threedubmedia.googlecode.com/files/MIT-LICENSE.txt">threedubmedia.googlecode.com/files/MIT-LICENSE.txt</a></p>
...
this.unbind(“mousewheel”,a)}})})(jQuery);</p>
