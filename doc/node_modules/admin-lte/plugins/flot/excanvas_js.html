...
<title>excanvas.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/excanvas.js">

<p>// Copyright 2006 Google Inc. // // Licensed under the Apache <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a>,
Version 2.0 (the “License”); // you may not use this file except in
compliance with the <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a>. //
You may obtain a copy of the <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a> at
// //   <a
href="http://www.apache.org/licenses/LICENSE-2.0">www.apache.org/licenses/LICENSE-2.0</a>
// // Unless required by applicable law or agreed to in writing, software
// distributed under the <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a> is
distributed on an “AS IS” BASIS, // WITHOUT WARRANTIES OR CONDITIONS OF ANY
KIND, either express or implied. // See the <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a> for
the specific language governing permissions and // limitations under the <a
href="../datatables/extensions/ColReorder/License_txt.html">License</a>.</p>

<p>// Known Issues: // // * Patterns only support repeat. // * Radial gradient
are not implemented. The VML version of these look very //   different from
the canvas one. // * Clipping paths are not implemented. // * Coordsize.
The width and height attribute have higher priority than the //   width and
height style values which isn&#39;t correct. // * Painting mode isn&#39;t
implemented. // * Canvas width/height should is using content-box by
default. IE in //   Quirks mode will draw the canvas using border-box.
Either change your //   doctype to HTML5 //   (<a
href="http://www.whatwg.org/specs/web-apps/current-work/#the-doctype">www.whatwg.org/specs/web-apps/current-work/#the-doctype</a>)
//   or use Box Sizing Behavior from WebFX //   (<a
href="http://webfx.eae.net/dhtml/boxsizing/boxsizing.html">webfx.eae.net/dhtml/boxsizing/boxsizing.html</a>)
// * Non uniform scaling does not correctly scale strokes. // * Filling
very large shapes (above 5000 points) is buggy. // * Optimize. There is
always room for speed improvements.</p>

<p>// Only add this code if we do not already have a canvas implementation if
(!document.createElement(&#39;canvas&#39;).getContext) {</p>

<p>(function() {</p>

<pre>// alias some functions to make (compiled) code shorter
var m = Math;
var mr = m.round;
var ms = m.sin;
var mc = m.cos;
...
DOMException = DOMException_;</pre>
