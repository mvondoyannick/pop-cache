...
<title>jquery.flot.pie.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.pie.js">

<pre>Flot plugin for rendering pie charts.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>The plugin assumes that each series has a single data value, and that each
value is a positive integer or zero.  Negative numbers don&#39;t make sense
for a pie chart, and have unpredictable results.  The values do NOT need to
be passed in as percentages; the plugin will calculate the total and
per-slice percentages internally.</p>

<pre>Created by Brian Medendorp

Updated with contributions from btburnett3, Anthony Aragues and Xavi Ivars</pre>
...
<p>More detail and specific examples can be found in the included HTML file.</p>

<p>(function($) {</p>

<pre>// Maximum redraw attempts when fitting labels within the plot
