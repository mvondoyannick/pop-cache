...
<title>jquery.flot.selection.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.selection.js">

<pre>Flot plugin for selecting regions of a plot.</pre>
...
<pre>mode: null or &quot;x&quot; or &quot;y&quot; or &quot;xy&quot;,
color: color,
shape: &quot;round&quot; or &quot;miter&quot; or &quot;bevel&quot;,
minSize: number of pixels</pre>

<p>}</p>

<p>Selection support is enabled by setting the mode to one of “x”, “y” or
“xy”. In “x” mode, the user will only be able to specify the x range,
similarly for “y” mode. For “xy”, the selection becomes a rectangle where
both ranges can be specified. “color” is color of the selection (if you
need to change the color later on, you can get to it with
plot.getOptions().selection.color). “shape” is the shape of the corners of
the selection.</p>

<p>“minSize” is the minimum size a selection can be in pixels. This value can
be customized to determine the smallest size a selection can be and still
have the selection rectangle be displayed. When customizing this value, the
fact that it refers to pixels, not axis units must be taken into account.
Thus, for example, if there is a bar graph in time mode with BarWidth set
to 1 minute, setting “minSize” to 1 will not make the minimum selection
size 1 minute, but rather 1 pixel. Note also that setting “minSize” to 0
will prevent “plotunselected” events from being fired when the user clicks
the mouse without dragging.</p>

<p>When selection support is enabled, a “plotselected” event will be emitted
on the DOM element you passed into the plot function. The event handler
gets a parameter with the ranges selected on the axes, like this:</p>
...
<p>The “plotselected” event is only fired when the user has finished making
the selection. A “plotselecting” event is fired during the process with the
same parameters as the “plotselected” event, in case you want to know
what&#39;s happening while it&#39;s happening,</p>

<p>A “plotunselected” event with no arguments is emitted when the user clicks
the mouse to remove the selection. As stated above, setting “minSize” to 0
will destroy this behavior.</p>

<p>The plugin allso adds the following methods to the plot object:</p>
<ul><li>
<p>setSelection( ranges, preventEvent )</p>

<p>Set the selection rectangle. The passed in ranges is on the same form as
returned in the “plotselected” event. If the selection mode is “x”, you
should put in either an xaxis range, if the mode is “y” you need to put in
an yaxis range and both xaxis and yaxis if the selection mode is “xy”, like
this:</p>

<pre class="ruby"><span class="ruby-identifier">setSelection</span>({ <span class="ruby-value">xaxis:</span> { <span class="ruby-value">from:</span> <span class="ruby-value">0</span>, <span class="ruby-value">to:</span> <span class="ruby-value">10</span> }, <span class="ruby-value">yaxis:</span> { <span class="ruby-value">from:</span> <span class="ruby-value">40</span>, <span class="ruby-value">to:</span> <span class="ruby-value">60</span> } });
</pre>

<p>setSelection will trigger the “plotselected” event when called. If you
don&#39;t want that to happen, e.g. if you&#39;re inside a “plotselected”
handler, pass true as the second parameter. If you are using multiple axes,
you can specify the ranges on any of those, e.g. as x2axis/x3axis/… instead
of xaxis, the plugin picks the first one it sees.</p>
</li><li>
<p>clearSelection( preventEvent )</p>

<p>Clear the selection rectangle. Pass in true to avoid getting a
“plotunselected” event.</p>
</li><li>
<p>getSelection()</p>

<p>Returns the current selection in the same format as the “plotselected”
event. If there&#39;s currently no selection, the function returns null.</p>
</li></ul>

<p>(function ($) {</p>

<pre>function init(plot) {
    var selection = {
