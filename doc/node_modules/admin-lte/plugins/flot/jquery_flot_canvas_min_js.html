...
<title>jquery.flot.canvas.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.canvas.min.js">

<p>(function($){var options={canvas:true};var render,getTextInfo,addText;var
hasOwnProperty=Object.prototype.hasOwnProperty;function
init(plot,classes){var
Canvas=classes.Canvas;if(render==null){getTextInfo=Canvas.prototype.getTextInfo,addText=Canvas.prototype.addText,render=Canvas.prototype.render}Canvas.prototype.render=function(){if(!plot.getOptions().canvas){return
render.call(this)}var
context=this.context,cache=this._textCache;context.save();context.textBaseline=“middle”;for(var
layerKey in cache){if(hasOwnProperty.call(cache,layerKey)){var <a
href="layerKey">layerCache=cache</a>;for(var styleKey in
layerCache){if(hasOwnProperty.call(layerCache,styleKey)){var <a
href="styleKey">styleCache=layerCache</a>,updateStyles=true;for(var key in
styleCache){if(hasOwnProperty.call(styleCache,key)){var <a
href="key">info=styleCache</a>,positions=info.positions,lines=info.lines;if(updateStyles){context.fillStyle=info.font.color;context.font=info.font.definition;updateStyles=false}for(var
<a
href="i">i=0,position;position=positions</a>;i++){if(position.active){for(var
<a href="j">j=0,line;line=position.lines</a>;j++){<a
href="j">context.fillText(lines</a>.<a href="0">text,line</a>,<a
href="1">line</a>)}}else{positions.splice(i–,1)}}if(positions.length==0){delete
<a
href="key">styleCache</a>}}}}}}}context.restore()};Canvas.prototype.getTextInfo=function(layer,text,font,angle,width){if(!plot.getOptions().canvas){return
getTextInfo.call(this,layer,text,font,angle,width)}var
textStyle,layerCache,styleCache,info;text=“”+text;if(typeof
font===“object”){textStyle=font.style+“ ”<code>font.variant</code>“
”<code>font.weight</code>“ ”<code>font.size</code>“px
”+font.family}else{textStyle=font}<a
href="layer">layerCache=this._textCache</a>;if(layerCache==null){<a
href="layer">layerCache=this._textCache</a>={}}<a
href="textStyle">styleCache=layerCache</a>;if(styleCache==null){<a
href="textStyle">styleCache=layerCache</a>={}}<a
href="text">info=styleCache</a>;if(info==null){var
context=this.context;if(typeof font!==“object”){var
element=$(“&lt;div&gt;&amp;nbsp;&lt;/div&gt;”).css(“position”,“absolute”).addClass(typeof
font===“string”?font:null).appendTo(this.getTextLayer(layer));font={lineHeight:element.height(),style:element.css(“font-style”),variant:element.css(“font-variant”),weight:element.css(“font-weight”),family:element.css(“font-family”),color:element.css(“color”)};font.size=element.css(“line-height”,1).height();element.remove()}textStyle=font.style+“
”<code>font.variant</code>“ ”<code>font.weight</code>“
”<code>font.size</code>“px ”+<a
href="text">font.family;info=styleCache</a>={<a
href="">width:0,height:0,positions:[],lines:</a>,font:{definition:textStyle,color:font.color}};context.save();context.font=textStyle;var
lines=(text+“”).replace(/&lt;br ?/?&gt;|rn|r/g,“n”).split(“n”);for(var
i=0;i&lt;lines.length;++i){var <a
href="i">lineText=lines</a>,measured=context.measureText(lineText);info.width=Math.max(measured.width,info.width);info.height+=font.lineHeight;info.lines.push({text:lineText,width:measured.width,height:font.lineHeight})}context.restore()}return
info};Canvas.prototype.addText=function(layer,x,y,text,font,angle,width,halign,valign){if(!plot.getOptions().canvas){return
addText.call(this,layer,x,y,text,font,angle,width,halign,valign)}var
info=this.getTextInfo(layer,text,font,angle,width),positions=info.positions,lines=info.lines;y+=info.height/lines.length/2;if(valign==“middle”){y=Math.round(y-info.height/2)}else
if(valign==“bottom”){y=Math.round(y-info.height)}else{y=Math.round(y)}<a
href="0">if(!!(window.opera&&window.opera.version().split(“.”)</a>&lt;12)){y-=2}for(var
<a
href="i">i=0,position;position=positions</a>;i++){if(position.x==x&amp;&amp;position.y==y){position.active=true;return}}position={active:true,lines:[],x:x,y:y};positions.push(position);for(var
<a href="i">i=0,line;line=lines</a>;i++){if(halign==“center”){<a
href="Math.round(x-line.width/2),y">position.lines.push(</a>)}else
if(halign==“right”){<a
href="Math.round(x-line.width),y">position.lines.push(</a>)}else{<a
href="Math.round(x),y">position.lines.push(</a>)}y+=line.height}}}$.plot.plugins.push({init:init,options:options,name:“canvas”,version:“1.0”})})(jQuery);</p>
</main>
