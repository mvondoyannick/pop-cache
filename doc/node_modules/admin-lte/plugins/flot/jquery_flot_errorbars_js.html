...
<title>jquery.flot.errorbars.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.errorbars.js">

<pre>Flot plugin for plotting error bars.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>Error bars are used to show standard deviation and other statistical
properties in a plot.</p>

<pre>Created by Rui Pereira  -  rui (dot) pereira (at) gmail (dot) com</pre>

<p>This plugin allows you to plot error-bars over points. Set “errorbars”
inside the points series to the axis name over which there will be error
values in your data array (<strong>even</strong> if you do not intend to
plot them later, by setting “show: null” on xerr/yerr).</p>
...
<p>Each data point array is expected to be of the type:</p>

<pre class="ruby"><span class="ruby-string">&quot;x&quot;</span>  [ <span class="ruby-identifier">x</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">xerr</span> ]
<span class="ruby-string">&quot;y&quot;</span>  [ <span class="ruby-identifier">x</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">yerr</span> ]
<span class="ruby-string">&quot;xy&quot;</span> [ <span class="ruby-identifier">x</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">xerr</span>, <span class="ruby-identifier">yerr</span> ]
</pre>

<p>Where xerr becomes xerr_lower,xerr_upper for the asymmetric error case, and
equivalently for yerr. Eg., a datapoint for the “xy” case with symmetric
error-bars on X and asymmetric on Y would be:</p>

<pre class="ruby">[ <span class="ruby-identifier">x</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">xerr</span>, <span class="ruby-identifier">yerr_lower</span>, <span class="ruby-identifier">yerr_upper</span> ]
</pre>

<p>By default no end caps are drawn. Setting upperCap and/or lowerCap to “-”
will draw a small cap perpendicular to the error bar. They can also be set
to a user-defined drawing function, with (ctx, x, y, radius) as parameters,
as eg.</p>

<pre class="ruby"><span class="ruby-identifier">function</span> <span class="ruby-identifier">drawSemiCircle</span>( <span class="ruby-identifier">ctx</span>, <span class="ruby-identifier">x</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">radius</span> ) {
        <span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">beginPath</span>();
        <span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">arc</span>( <span class="ruby-identifier">x</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">radius</span>, <span class="ruby-value">0</span>, <span class="ruby-constant">Math</span>.<span class="ruby-constant">PI</span>, <span class="ruby-keyword">false</span> );
        <span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">moveTo</span>( <span class="ruby-identifier">x</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">radius</span>, <span class="ruby-identifier">y</span> );
        <span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">lineTo</span>( <span class="ruby-identifier">x</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">radius</span>, <span class="ruby-identifier">y</span> );
        <span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">stroke</span>();
}
</pre>

<p>Color and radius both default to the same ones of the points series if not
set. The independent radius parameter on xerr/yerr is useful for the case
when we may want to add error-bars to a line, without showing the
interconnecting points (with radius: 0), and still showing end caps on the
error-bars. shadowSize and lineWidth are derived as well from the points
series.</p>
