...
<title>jquery.flot.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.js">

<pre>Javascript plotting library for jQuery, version 0.8.2.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>// first an inline dependency, jquery.colorhelpers.js, we inline it here //
for convenience</p>

<p>/* Plugin for jQuery for working with colors.</p>
...
<p>(function($){$.color={};$.color.make=function(r,g,b,a){var
o={};o.r=r||0;o.g=g||0;o.b=b||0;o.a=a!=null?a:1;o.add=function(c,d){for(var
<a href="c.charAt(i)">i=0;i<c.length;++i)o</a>+=d;return
o.normalize()};o.scale=function(c,f){for(var <a
href="c.charAt(i)">i=0;i<c.length;++i)o</a>*=f;return
o.normalize()};o.toString=function(){if(o.a&gt;=1){<a
href="o.r,o.g,o.b">return“rgb(”+</a>.join(“,”)+“)”}else{<a
href="o.r,o.g,o.b,o.a">return“rgba(”+</a>.join(“,”)+“)”}};o.normalize=function(){function
clamp(min,value,max){return
value&lt;min?min:value&gt;max?max:value}o.r=clamp(0,parseInt(o.r),255);o.g=clamp(0,parseInt(o.g),255);o.b=clamp(0,parseInt(o.b),255);o.a=clamp(0,o.a,1);return
o};o.clone=function(){return $.color.make(o.r,o.b,o.g,o.a)};return
o.normalize()};$.color.extract=function(elem,css){var
c;do{c=elem.css(css).toLowerCase();if(c!=“”&amp;&amp;c!=“transparent”)break;elem=elem.parent()}while(elem.length&amp;&amp;!$.nodeName(elem.get(0),“body”));if(c==“rgba(0,
0, 0, 0)”)c=“transparent”;return
$.color.parse©};$.color.parse=function(str){var <a
href="0-9">res,m=$.color.make;if(res=/rgb(s*(</a>{1,3})<a
href=“0-9”>s*,s*(</a>{1,3})<a
href=“0-9”>s*,s*(</a>{1,3})s*)/.exec(str))return <a
href="1">m(parseInt(res</a>,<a href="2">10),parseInt(res</a>,<a
href="3">10),parseInt(res</a>,<a
href="0-9">10));if(res=/rgba(s*(</a>{1,3})<a href=“0-9”>s*,s*(</a>{1,3})<a
href=“0-9”>s*,s*(</a>{1,3})<a
href=“0-9”>s*,s*(</a>+(?:.[0-9]+)?)s*)/.exec(str))return <a
href="1">m(parseInt(res</a>,<a href="2">10),parseInt(res</a>,<a
href="3">10),parseInt(res</a>,<a href="4">10),parseFloat(res</a>));<a
href="0-9">if(res=/rgb(s*(</a>+(?:.[<a
href="0-9">0-9]+)?)%s*,s*(</a>+(?:.[<a
href="0-9">0-9]+)?)%s*,s*(</a>+(?:.[0-9]+)?)%s*)/.exec(str))return <a
href="1">m(parseFloat(res</a>)*<a href="2">2.55,parseFloat(res</a>)*<a
href="3">2.55,parseFloat(res</a>)*<a
href="0-9">2.55);if(res=/rgba(s*(</a>+(?:.[<a
href="0-9">0-9]+)?)%s*,s*(</a>+(?:.[<a
href="0-9">0-9]+)?)%s*,s*(</a>+(?:.[<a
href="0-9">0-9]+)?)%s*,s*(</a>+(?:.[0-9]+)?)s*)/.exec(str))return <a
href="1">m(parseFloat(res</a>)*<a href="2">2.55,parseFloat(res</a>)*<a
href="3">2.55,parseFloat(res</a>)*<a href="4">2.55,parseFloat(res</a>));<a
href="a-fA-F0-9">if(res=/#(</a>{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(str))return
<a href="1">m(parseInt(res</a>,<a href="2">16),parseInt(res</a>,<a
href="3">16),parseInt(res</a>,<a href="a-fA-F0-9">16));if(res=/#(</a>)([<a
href="a-fA-F0-9">a-fA-F0-9])(</a>)/.exec(str))return <a
href="1">m(parseInt(res</a>+<a href="1">res</a>,<a
href="2">16),parseInt(res</a>+<a href="2">res</a>,<a
href="3">16),parseInt(res</a>+<a href="3">res</a>,16));var
name=$.trim(str).toLowerCase();if(name==“transparent”)return
m(255,255,255,0);else{<a href="name">res=lookupColors</a>||[0,0,0];return
<a href="0">m(res</a>,<a href="1">res</a>,<a href="2">res</a>)}};var
lookupColors={<a href="0,255,255">aqua:</a>,<a
href="240,255,255">azure:</a>,<a href="245,245,220">beige:</a>,<a
href="0,0,0">black:</a>,<a href="0,0,255">blue:</a>,<a
href="165,42,42">brown:</a>,<a href="0,255,255">cyan:</a>,<a
href="0,0,139">darkblue:</a>,<a href="0,139,139">darkcyan:</a>,<a
href="169,169,169">darkgrey:</a>,<a href="0,100,0">darkgreen:</a>,<a
href="189,183,107">darkkhaki:</a>,<a href="139,0,139">darkmagenta:</a>,<a
href="85,107,47">darkolivegreen:</a>,<a href="255,140,0">darkorange:</a>,<a
href="153,50,204">darkorchid:</a>,<a href="139,0,0">darkred:</a>,<a
href="233,150,122">darksalmon:</a>,<a href="148,0,211">darkviolet:</a>,<a
href="255,0,255">fuchsia:</a>,<a href="255,215,0">gold:</a>,<a
href="0,128,0">green:</a>,<a href="75,0,130">indigo:</a>,<a
href="240,230,140">khaki:</a>,<a href="173,216,230">lightblue:</a>,<a
href="224,255,255">lightcyan:</a>,<a href="144,238,144">lightgreen:</a>,<a
...
href="0,0,128">navy:</a>,<a href="128,128,0">olive:</a>,<a
href="255,165,0">orange:</a>,<a href="255,192,203">pink:</a>,<a
href="128,0,128">purple:</a>,<a href="128,0,128">violet:</a>,<a
href="255,0,0">red:</a>,<a href="192,192,192">silver:</a>,<a
href="255,255,255">white:</a>,<a href="255,255,0">yellow:</a>}})(jQuery);</p>

<p>// the actual Flot code (function($) {</p>

<pre>    // Cache the prototype hasOwnProperty for faster access
