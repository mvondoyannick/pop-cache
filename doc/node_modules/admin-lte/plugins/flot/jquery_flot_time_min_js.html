...
<title>jquery.flot.time.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.time.min.js">

<p>(function($){var
options={xaxis:{timezone:null,timeformat:null,twelveHourClock:false,monthNames:null}};function
floorInBase(n,base){return base*Math.floor(n/base)}function
formatDate(d,fmt,monthNames,dayNames){if(typeof
d.strftime==“function”){return d.strftime(fmt)}var
leftPad=function(n,pad){n=“”+n;pad=“”+(pad==null?“0”:pad);return
n.length==1?pad+n:n};var r=[];var escape=false;var hours=d.getHours();var
isAM=hours&lt;12;if(monthNames==null){<a
href=""Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"">monthNames=</a>}if(dayNames==null){<a
href=""Sun","Mon","Tue","Wed","Thu","Fri","Sat"">dayNames=</a>}var
hours12;if(hours&gt;12){hours12=hours-12}else
if(hours==0){hours12=12}else{hours12=hours}for(var
i=0;i&lt;fmt.length;++i){var c=fmt.charAt(i);if(escape){switch©{<a
href="d.getDay()">case“a”:c=“”+dayNames</a>;<a
href="d.getMonth()">break;case“b”:c=“”+monthNames</a>;break;case“d”:c=leftPad(d.getDate());break;case“e”:c=leftPad(d.getDate(),“
”);break;case“h”:case“H”:c=leftPad(hours);break;case“I”:c=leftPad(hours12);break;case“l”:c=leftPad(hours12,“
”);break;case“m”:c=leftPad(d.getMonth()+1);break;case“M”:c=leftPad(d.getMinutes());break;case“q”:c=“”+(Math.floor(d.getMonth()/3)+1);break;case“S”:c=leftPad(d.getSeconds());break;case“y”:c=leftPad(d.getFullYear()%100);break;case“Y”:c=“”+d.getFullYear();break;case“p”:c=isAM?“”+“am”:“”+“pm”;break;case“P”:c=isAM?“”+“AM”:“”+“PM”;break;case“w”:c=“”+d.getDay();break}r.push©;escape=false}else{if(c==“%”){escape=true}else{r.push©}}}return
r.join(“”)}function makeUtcWrapper(d){function
addProxyMethod(sourceObj,sourceMethod,targetObj,targetMethod){<a
href="sourceMethod">sourceObj</a>=function(){return <a
href="targetMethod">targetObj</a>.apply(targetObj,arguments)}}var
utc={date:d};if(d.strftime!=undefined){addProxyMethod(utc,“strftime”,d,“strftime”)}addProxyMethod(utc,“getTime”,d,“getTime”);addProxyMethod(utc,“setTime”,d,“setTime”);var
<a
href=""Date","Day","FullYear","Hours","Milliseconds","Minutes","Month","Seconds"">props=</a>;for(var
p=0;p&lt;props.length;p++){<a
href="p">addProxyMethod(utc,“get”+props</a>,<a
href="p">d,“getUTC”+props</a>);<a
href="p">addProxyMethod(utc,“set”+props</a>,<a
href="p">d,“setUTC”+props</a>)}return utc}function
dateGenerator(ts,opts){if(opts.timezone==“browser”){return new
Date(ts)}else if(!opts.timezone||opts.timezone==“utc”){return
makeUtcWrapper(new Date(ts))}else if(typeof
timezoneJS!=“undefined”&amp;&amp;typeof timezoneJS.Date!=“undefined”){var
d=new timezoneJS.Date;d.setTimezone(opts.timezone);d.setTime(ts);return
d}else{return makeUtcWrapper(new Date(ts))}}var
timeUnitSize={second:1e3,minute:60*1e3,hour:60*60*1e3,day:24*60*60*1e3,month:30*24*60*60*1e3,quarter:3*30*24*60*60*1e3,year:365.2425*24*60*60*1e3};var
<a href="1,"second"">baseSpec=[</a>,[<a
href="5,"second"">2,“second”],</a>,[<a
href="30,"second"">10,“second”],</a>,[<a
href="2,"minute"">1,“minute”],</a>,[<a
href="10,"minute"">5,“minute”],</a>,[<a
href="1,"hour"">30,“minute”],</a>,[<a href="4,"hour"">2,“hour”],</a>,[<a
href="12,"hour"">8,“hour”],</a>,[<a href="2,"day"">1,“day”],</a>,[<a
href=".25,"month"">3,“day”],</a>,[.<a
href="1,"month"">5,“month”],</a>,[2,“month”]];var <a
href="3,"month"">specMonths=baseSpec.concat([</a>,[<a
href="1,"year"">6,“month”],</a>]);var <a
href="1,"quarter"">specQuarters=baseSpec.concat([</a>,[<a
href="1,"year"">2,“quarter”],</a>]);function
init(plot){plot.hooks.processOptions.push(function(plot,options){$.each(plot.getAxes(),function(axisName,axis){var
opts=axis.options;if(opts.mode==“time”){axis.tickGenerator=function(axis){var
ticks=[];var d=dateGenerator(axis.min,opts);var minSize=0;var <a
href="1">spec=opts.tickSize&&opts.tickSize</a>===“<a
href="1">quarter”||opts.minTickSize&&opts.minTickSize</a>===“quarter”?specQuarters:specMonths;if(opts.minTickSize!=null){if(typeof
opts.tickSize==“number”){minSize=opts.tickSize}else{<a
href="0">minSize=opts.minTickSize</a>*<a
href="1">timeUnitSize[opts.minTickSize</a>]}}for(var
i=0;i&lt;spec.length-1;++i){<a href="i">if(axis.delta<(spec</a>[<a
href="i">0]*timeUnitSize[spec</a>[<a href="i+1">1]]+spec</a>[<a
href="i+1">0]*timeUnitSize[spec</a>[<a href="i">1]])/2&&spec</a>[<a
href="i">0]*timeUnitSize[spec</a>[1]]&gt;=minSize){break}}var <a
href="i">size=spec</a>[0];var <a
href="i">unit=spec</a>[1];if(unit==“year”){<a
href="1">if(opts.minTickSize!=null&&opts.minTickSize</a>==“year”){<a
href="0">size=Math.floor(opts.minTickSize</a>)}else{var
magn=Math.pow(10,Math.floor(Math.log(axis.delta/timeUnitSize.year)/Math.LN10));var
norm=axis.delta/timeUnitSize.year/magn;if(norm&lt;1.5){size=1}else
if(norm&lt;3){size=2}else
if(norm&lt;7.5){size=5}else{size=10}size*=magn}if(size&lt;1){size=1}}<a
href="size,unit">axis.tickSize=opts.tickSize||</a>;var <a
href="0">tickSize=axis.tickSize</a>;<a href="1">unit=axis.tickSize</a>;var
<a
href="unit">step=tickSize*timeUnitSize</a>;if(unit==“second”){d.setSeconds(floorInBase(d.getSeconds(),tickSize))}else
if(unit==“minute”){d.setMinutes(floorInBase(d.getMinutes(),tickSize))}else
if(unit==“hour”){d.setHours(floorInBase(d.getHours(),tickSize))}else
if(unit==“month”){d.setMonth(floorInBase(d.getMonth(),tickSize))}else
if(unit==“quarter”){d.setMonth(3*floorInBase(d.getMonth()/3,tickSize))}else
if(unit==“year”){d.setFullYear(floorInBase(d.getFullYear(),tickSize))}d.setMilliseconds(0);if(step&gt;=timeUnitSize.minute){d.setSeconds(0)}if(step&gt;=timeUnitSize.hour){d.setMinutes(0)}if(step&gt;=timeUnitSize.day){d.setHours(0)}if(step&gt;=timeUnitSize.day*4){d.setDate(1)}if(step&gt;=timeUnitSize.month*2){d.setMonth(floorInBase(d.getMonth(),3))}if(step&gt;=timeUnitSize.quarter*2){d.setMonth(floorInBase(d.getMonth(),6))}if(step&gt;=timeUnitSize.year){d.setMonth(0)}var
carry=0;var v=Number.NaN;var
prev;do{prev=v;v=d.getTime();ticks.push(v);if(unit==“month”||unit==“quarter”){if(tickSize&lt;1){d.setDate(1);var
start=d.getTime();d.setMonth(d.getMonth()+(unit==“quarter”?3:1));var
end=d.getTime();d.setTime(v+carry*timeUnitSize.hour+(end-start)*tickSize);carry=d.getHours();d.setHours(0)}else{d.setMonth(d.getMonth()+tickSize*(unit==“quarter”?3:1))}}else
if(unit==“year”){d.setFullYear(d.getFullYear()+tickSize)}else{d.setTime(v+step)}}while(v&lt;axis.max&amp;&amp;v!=prev);return
ticks};axis.tickFormatter=function(v,axis){var
d=dateGenerator(v,axis.options);if(opts.timeformat!=null){return
formatDate(d,opts.timeformat,opts.monthNames,opts.dayNames)}var <a
href="1">useQuarters=axis.options.tickSize&&axis.options.tickSize</a>==“<a
href="1">quarter”||axis.options.minTickSize&&axis.options.minTickSize</a>==“quarter”;var
<a href="0">t=axis.tickSize</a>*<a
href="1">timeUnitSize[axis.tickSize</a>];var span=axis.max-axis.min;var
suffix=opts.twelveHourClock?“ %p”:“”;var
hourCode=opts.twelveHourClock?“%I”:“%H”;var
fmt;if(t&lt;timeUnitSize.minute){fmt=hourCode+“:%M:%S”+suffix}else
if(t&lt;timeUnitSize.day){if(span&lt;2*timeUnitSize.day){fmt=hourCode+“:%M”+suffix}else{fmt=“%b
%d ”<code>hourCode</code>“:%M”+suffix}}else
if(t&lt;timeUnitSize.month){fmt=“%b %d”}else
if(useQuarters&amp;&amp;t&lt;timeUnitSize.quarter||!useQuarters&amp;&amp;t&lt;timeUnitSize.year){if(span&lt;timeUnitSize.year){fmt=“%b”}else{fmt=“%b
%Y”}}else
if(useQuarters&amp;&amp;t&lt;timeUnitSize.year){if(span&lt;timeUnitSize.year){fmt=“Q%q”}else{fmt=“Q%q
%Y”}}else{fmt=“%Y”}var
rt=formatDate(d,fmt,opts.monthNames,opts.dayNames);return
rt}}})})}$.plot.plugins.push({init:init,options:options,name:“time”,version:“1.0”});$.plot.formatDate=formatDate})(jQuery);</p>
</main>
