...
<title>jquery.flot.symbol.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.symbol.js">

<pre>Flot plugin that adds some extra symbols for plotting points.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>The symbols are accessed as strings through the standard symbol options:</p>
...
<pre>function processRawData(plot, series, datapoints) {
