...
<title>jquery.flot.threshold.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.threshold.js">

<pre>Flot plugin for thresholding data.</pre>
...
<p>It can also be applied to a single series, like this:</p>
...
<p>An array can be passed for multiple thresholding, like this:</p>
...
<p>These multiple threshold objects can be passed in any order since they are
sorted by the processing function.</p>

<p>The data points below “below” are drawn with the specified color. This
makes it easy to mark points below 0, e.g. for budget data.</p>

<p>Internally, the plugin works by splitting the data into two series, above
and below the threshold. The extra series below the threshold will have its
label cleared and the special “originSeries” attribute set to the original
series. You may need to check for this in hover events.</p>
