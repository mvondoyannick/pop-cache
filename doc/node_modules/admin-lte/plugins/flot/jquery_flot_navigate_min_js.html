...
<title>jquery.flot.navigate.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.navigate.min.js">

<p>(function(a){function e(h){var
k,j=this,l=h.data||{};if(l.elem)j=h.dragTarget=l.elem,h.dragProxy=d.proxy||j,h.cursorOffsetX=l.pageX-l.left,h.cursorOffsetY=l.pageY-l.top,h.offsetX=h.pageX-h.cursorOffsetX,h.offsetY=h.pageY-h.cursorOffsetY;else
if(d.dragging||l.which&gt;0&amp;&amp;h.which!=l.which||a(h.target).is(l.not))return;switch(h.type){case“mousedown”:return
a.extend(l,a(j).offset(),{elem:j,target:h.target,pageX:h.pageX,pageY:h.pageY}),b.add(document,“mousemove
<a
href="0">mouseup”,e,l),i(j,!1),d.dragging=null,!1;case!d.dragging&&“mousemove”:if(g(h.pageX-l.pageX)+g(h.pageY-l.pageY)<l.distance)break;h.target=l.target,k=f(h,"dragstart",j),k!==!1&&(d.dragging=j,d.proxy=h.dragProxy=a(k||j)</a>);case“mousemove”:if(d.dragging){if(k=f(h,“drag”,j),c.drop&amp;&amp;(c.drop.allowed=k!==!1,c.drop.handler(h)),k!==!1)break;h.type=“mouseup”}case“mouseup”:b.remove(document,“mousemove
mouseup”,e),d.dragging&amp;&amp;(c.drop&amp;&amp;c.drop.handler(h),f(h,“dragend”,j)),i(j,!0),d.dragging=d.proxy=l.elem=!1}return!0}function
f(b,c,d){b.type=c;var e=a.event.dispatch.call(d,b);return
e===!1?!1:e||b.result}function g(a){return Math.pow(a,2)}function
h(){return d.dragging===!1}function
i(a,b){a&amp;&amp;(a.unselectable=b?“off”:“on”,a.onselectstart=function(){return
b},a.style&amp;&amp;(a.style.MozUserSelect=b?“”:“none”))}a.fn.drag=function(a,b,c){return
b&amp;&amp;this.bind(“dragstart”,a),c&amp;&amp;this.bind(“dragend”,c),a?this.bind(“drag”,b?b:a):this.trigger(“drag”)};var
b=a.event,c=b.special,d=c.drag={not:“:input”,distance:0,which:1,dragging:!1,setup:function©{c=a.extend({distance:d.distance,which:d.which,not:d.not},c||{}),c.distance=g(c.distance),b.add(this,“mousedown”,e,c),this.attachEvent&amp;&amp;this.attachEvent(“ondragstart”,h)},teardown:function(){b.remove(this,“mousedown”,e),this===d.dragging&amp;&amp;(d.dragging=d.proxy=!1),i(this,!0),this.detachEvent&amp;&amp;this.detachEvent(“ondragstart”,h)}};c.dragstart=c.dragend={setup:function(){},teardown:function(){}}})(jQuery);(function(d){function
e(a){var
b=a||window.event,c=[].slice.call(arguments,1),f=0,e=0,g=0,a=d.event.fix(b);a.type=“mousewheel”;b.wheelDelta&amp;&amp;(f=b.wheelDelta/120);b.detail&amp;&amp;(f=-b.detail/3);g=f;void
0!==b.axis&amp;&amp;b.axis===b.HORIZONTAL_AXIS&amp;&amp;(g=0,e=-1*f);void
0!==b.wheelDeltaY&amp;&amp;(g=b.wheelDeltaY/120);void
0!==b.wheelDeltaX&amp;&amp;(e=-1*b.wheelDeltaX/120);c.unshift(a,f,e,g);return(d.event.dispatch||d.event.handle).apply(this,c)}var
<a href=""DOMMouseScroll","mousewheel"">c=</a>;if(d.event.fixHooks)for(var
<a
href="--h">h=c.length;h;)d.event.fixHooks[c</a>]=d.event.mouseHooks;d.event.special.mousewheel={setup:function(){if(this.addEventListener)for(var
<a href="--a">a=c.length;a;)this.addEventListener(c</a>,e,!1);else
this.onmousewheel=e},teardown:function(){if(this.removeEventListener)for(var
<a href="--a">a=c.length;a;)this.removeEventListener(c</a>,e,!1);else
this.onmousewheel=null}};d.fn.extend({mousewheel:function(a){return
a?this.bind(“mousewheel”,a):this.trigger(“mousewheel”)},unmousewheel:function(a){return
this.unbind(“mousewheel”,a)}})})(jQuery);(function($){var
options={xaxis:{zoomRange:null,panRange:null},zoom:{interactive:false,trigger:“dblclick”,amount:1.5},pan:{interactive:false,cursor:“move”,frameRate:20}};function
init(plot){function onZoomClick(e,zoomOut){var
c=plot.offset();c.left=e.pageX-c.left;c.top=e.pageY-c.top;if(zoomOut)plot.zoomOut({center:c});else
plot.zoom({center:c})}function
onMouseWheel(e,delta){e.preventDefault();onZoomClick(e,delta&lt;0);return
false}var
prevCursor=“default”,prevPageX=0,prevPageY=0,panTimeout=null;function
onDragStart(e){if(e.which!=1)return false;var
c=plot.getPlaceholder().css(“cursor”);if©prevCursor=c;plot.getPlaceholder().css(“cursor”,plot.getOptions().pan.cursor);prevPageX=e.pageX;prevPageY=e.pageY}function
onDrag(e){var
frameRate=plot.getOptions().pan.frameRate;if(panTimeout||!frameRate)return;panTimeout=setTimeout(function(){plot.pan({left:prevPageX-e.pageX,top:prevPageY-e.pageY});prevPageX=e.pageX;prevPageY=e.pageY;panTimeout=null},1/frameRate*1e3)}function
onDragEnd(e){if(panTimeout){clearTimeout(panTimeout);panTimeout=null}plot.getPlaceholder().css(“cursor”,prevCursor);plot.pan({left:prevPageX-e.pageX,top:prevPageY-e.pageY})}function
bindEvents(plot,eventHolder){var
o=plot.getOptions();if(o.zoom.interactive){<a
href="o.zoom.trigger">eventHolder</a>(onZoomClick);eventHolder.mousewheel(onMouseWheel)}if(o.pan.interactive){eventHolder.bind(“dragstart”,{distance:10},onDragStart);eventHolder.bind(“drag”,onDrag);eventHolder.bind(“dragend”,onDragEnd)}}plot.zoomOut=function(args){if(!args)args={};if(!args.amount)args.amount=plot.getOptions().zoom.amount;args.amount=1/args.amount;plot.zoom(args)};plot.zoom=function(args){if(!args)args={};var
c=args.center,amount=args.amount||plot.getOptions().zoom.amount,w=plot.width(),h=plot.height();if(!c)c={left:w/2,top:h/2};var
xf=c.left/w,yf=c.top/h,minmax={x:{min:c.left-xf*w/amount,max:c.left+(1-xf)*w/amount},y:{min:c.top-yf*h/amount,max:c.top+(1-yf)*h/amount}};$.each(plot.getAxes(),function(_,axis){var
<a href="axis.direction">opts=axis.options,min=minmax</a>.<a
href="axis.direction">min,max=minmax</a>.max,zr=opts.zoomRange,pr=opts.panRange;if(zr===false)return;min=axis.c2p(min);max=axis.c2p(max);if(min&gt;max){var
tmp=min;min=max;max=tmp}if(pr){<a href="0">if(pr</a>!=<a
href="0">null&&min<pr</a>){<a href="0">min=pr</a>}<a href="1">if(pr</a>!=<a
href="1">null&&max>pr</a>){<a href="1">max=pr</a>}}var <a
href="0">range=max-min;if(zr&&(zr</a>!=<a href="0">null&&range<zr</a>||<a
href="1">zr</a>!=<a
href="1">null&&range>zr</a>))return;opts.min=min;opts.max=max});<a
href="plot,args">plot.setupGrid();plot.draw();if(!args.preventEvent)plot.getPlaceholder().trigger(“plotzoom”,</a>)};plot.pan=function(args){var
delta={x:+args.left,y:+args.top};if(isNaN(delta.x))delta.x=0;if(isNaN(delta.y))delta.y=0;$.each(plot.getAxes(),function(_,axis){var
<a
href="axis.direction">opts=axis.options,min,max,d=delta</a>;min=axis.c2p(axis.p2c(axis.min)+d),max=axis.c2p(axis.p2c(axis.max)+d);var
pr=opts.panRange;if(pr===false)return;if(pr){<a href="0">if(pr</a>!=<a
href="0">null&&pr</a>&gt;min){<a href="0">d=pr</a>-min;min+=d;max+=d}<a
href="1">if(pr</a>!=<a href="1">null&&pr</a>&lt;max){<a
href="1">d=pr</a>-max;min+=d;max+=d}}opts.min=min;opts.max=max});<a
href="plot,args">plot.setupGrid();plot.draw();if(!args.preventEvent)plot.getPlaceholder().trigger(“plotpan”,</a>)};function
