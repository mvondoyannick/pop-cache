...
<title>jquery.flot.time.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.time.js">

<pre>Pretty handling of time axes.</pre>

<p>Copyright © 2007-2013 IOLA and Ole Laursen. Licensed under the MIT license.</p>

<p>Set axis.mode to “time” to enable. See the section “Time series data” in
API.txt for details.</p>
...
// select time zone strategy.  This returns a date-like object tied to the
    ...
    $.plot.formatDate = formatDate;</pre>
