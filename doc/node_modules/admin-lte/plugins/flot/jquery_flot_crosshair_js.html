...
<title>jquery.flot.crosshair.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.crosshair.js">

<pre>Flot plugin for showing crosshairs when the mouse hovers over the plot.</pre>
...
<p>Set the mode to one of “x”, “y” or “xy”. The “x” mode enables a vertical
crosshair that lets you trace the values on the x axis, “y” enables a
horizontal crosshair and “xy” enables them both. “color” is the color of
the crosshair (default is “rgba(170, 0, 0, 0.80)”), “lineWidth” is the
width of the drawn lines (default is 1).</p>

<p>The plugin also adds four public methods:</p>

<pre>- setCrosshair( pos )
...
- unlockCrosshair()
  ...
  Free the crosshair to move again after locking it.</pre>
