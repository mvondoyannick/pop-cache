...
<title>jquery.flot.symbol.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/flot/jquery.flot.symbol.min.js">

<p>(function($){function processRawData(plot,series,datapoints){var
...
<a href="s">s=series.points.symbol;if(handlers</a>)<a
href="s">series.points.symbol=handlers</a>}function
init(plot){plot.hooks.processDatapoints.push(processRawData)}$.plot.plugins.push({init:init,name:“symbols”,version:“1.0”})})(jQuery);</p>
</main>
