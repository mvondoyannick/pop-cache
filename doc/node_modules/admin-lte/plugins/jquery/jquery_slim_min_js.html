...
<title>jquery.slim.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/jquery/jquery.slim.min.js">

<pre>! jQuery v3.3.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector | (c) JS Foundation and other contributors | jquery.org/license</pre>
...
t.nodeType},v=function e(t){return
null!=t&amp;&amp;t===t.window},y={type:!0,src:!0,noModule:!0};function
m(e,t,n){var i,o=(t=t||r).createElement(“script”);if(o.text=e,n)for(i in <a
href="i">y)n</a>&amp;&amp;(<a href="i">o</a>=<a
href="i">n</a>);t.head.appendChild(o).parentNode.removeChild(o)}function
b(e){return null==e?e+“”:“object”==typeof e||“function”==typeof <a
href="c.call(e)">e?l</a>||“object”:typeof e}var x=“3.3.1
...
new w.fn.init(e,t)},<a
href="\s\uFEFF\xA0">C=/^</a>+|[suFEFFxA0]+$/g;w.fn=w.prototype={jquery:x,constructor:w,length:0,toArray:function(){return
...
<a
href="0">e,t,n,r,i,o,a=arguments</a>||{},u=1,s=arguments.length,l=!1;for(“boolean”==typeof
<a href="u">a&&(l=a,a=arguments</a>||{},u++),“object”==typeof
a||g(a)||(a={}),<a
href="u">u===s&&(a=this,u–);u<s;u++)if(null!=(e=arguments</a>))for(t in <a
...
a},w.extend({expando:“jQuery”+(x+Math.random()).replace(/D/g,“”),isReady:!0,error:function(e){throw
...
n,r=0;if(T(e)){<a href="r">for(n=e.length;r<n;r++)if(!1===t.call(e</a>,<a
...
null!=e&amp;&amp;(T(Object(e))?w.merge(n,“string”==typeof <a
href="e">e?</a>:e):u.call(n,e)),n},inArray:function(e,t,n){return
null==t?-1:s.call(t,e,n)},merge:function(e,t){for(var <a
href="i++">n=+t.length,r=0,i=e.length;r<n;r++)e</a>=<a
href="r">t</a>;return e.length=i,e},grep:function(e,t,n){for(var <a
href="o">r,i=[],o=0,a=e.length,u=!n;o<a;o++)(r=!t(e</a>,<a
href="o">o))!==u&&i.push(e</a>);return i},map:function(e,t,n){var <a
href="o">r,i,o=0,u=[];if(T(e))for(r=e.length;o<r;o++)null!=(i=t(e</a>,o,n))&amp;&amp;u.push(i);else
for(o in <a href="o">e)null!=(i=t(e</a>,o,n))&amp;&amp;u.push(i);return
a.apply([],u)},guid:1,support:h}),“function”==typeof <a
...
”<code>t</code>“]”]=t.toLowerCase()});function T(e){var
t=!!e&amp;&amp;“length”in
e&amp;&amp;e.length,n=b(e);return!g(e)&amp;&amp;!v(e)&amp;&amp;(“array”===n||0===t||“number”==typeof
t&amp;&amp;t&gt;0&amp;&amp;t-1 in e)}var E=function(e){var
t,n,r,i,o,a,u,s,l,c,f,d,p,h,g,v,y,m,b,x=“sizzle”+1*new
...
href="\\x20\\t\\r\\n\\f">H=“checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped”,I=“</a>”,<a
href="\\w-">R=“(?:\\.|</a>|[^<a
href=”*^$|!~“>0-\xa0])+”,B=“\[”I“*(”R“)(?:”I“*(</a>?=)”<code>I"*(?:'((?:\\.|[^\\']</code>)*)&#39;|&quot;((?:\\.|[^\\&quot;])*)&quot;|(“<code>R"))|)"I"*\]",M=":("R")(?:\((('((?:\\.|[^\\']</code>)*)&#39;|&quot;((?:\\.|[^\\&quot;])*)&quot;)|((?:\\.|[^\\()[\]]|”<code>B</code>“)*)|.*)\)|)”,W=new
RegExp(I+“+”,“g”),$=new <a
href="^\\\\">RegExp(“^”I“+|((?:^|</a>)(?:\\.)*)”<code>I</code>“+$”,“g”),F=new
RegExp(“^”<code>I</code>“*,”<code>I</code>“*”),z=new <a
href=">+~“>RegExp(”^“I”*(</a>|“<code>I</code>”)“<code>I</code>”*“),_=new <a
href="^\\">RegExp(”=“I”*(</a>&#39;&quot;]*?)“<code>I</code>”*\]“,”g“),U=new
RegExp(M),V=new RegExp(”^“<code>R</code>”$“),X={ID:new
RegExp(”^#(“<code>R</code>”)“),CLASS:new
RegExp(”^\.(“<code>R</code>”)“),TAG:new <a
href="*">RegExp(”^(“R”|</a>)“),ATTR:new RegExp(”^“+B),PSEUDO:new
RegExp(”^“+M),CHILD:new <a
href="+-">RegExp(”^:(only|first|last|nth|nth-last)-(child|of-type)(?:\(“I”*(even|odd|((</a>|)(\<a
href="+-">d*)n|)“I”*(?:(</a>|)“<code>I</code>”*(\d+)|))“<code>I</code>”*\)|)“,”i“),bool:new
RegExp(”^(?:“<code>H</code>”)$“,”i“),needsContext:new <a
href=">+~”>RegExp(“^”I“*</a>|:(<a
href="^-">even|odd|eq|gt|lt|nth|first|last)(?:\(”I“*((?:-\d)?\d*)”I“*\)|)(?=</a>|$)”,“i”)},<a
href="^{">Q=/^(?:input|select|textarea|button)$/i,Y=/^hd$/i,G=/^</a>+{s*[native
w/,K=/^(?:#([w-]+)|(<a href=“w-”>w+)|.(</a>+))$/,<a
href="+~">J=/</a>/,Z=new <a
href="\\da-f">RegExp(“\\(</a>{1,6}”<code>I</code>“?|(”<code>I</code>“)|.)”,“ig”),ee=function(e,t,n){var
r=“0x”+t-65536;return
...
”:“\”+e},re=function(){d()},ie=me(function(e){return!0===e.disabled&amp;&amp;(“form”in
e||“label”in e)},{dir:“parentNode”,next:“legend”});try{<a
href="w.childNodes.length">q.apply(S=O.call(w.childNodes),w.childNodes),S</a>.nodeType}catch(e){q={apply:S.length?function(e,t){j.apply(e,O.call(t))}:function(e,t){var
...
r;if(!i&amp;&amp;((t?t.ownerDocument||t:w)!==p&amp;&amp;d(t),t=t||p,g)){<a
href="1">if(11!==C&&(f=K.exec(e)))if(o=f</a>){if(9===C){if(!(l=t.getElementById(o)))return
r;if(l.id===o)return r.push(l),r}else
if(m&amp;&amp;(l=m.getElementById(o))&amp;&amp;b(t,l)&amp;&amp;l.id===o)return
r.push(l),r}else{<a href="2">if(f</a>)return <a
href="3">q.apply(r,t.getElementsByTagName(e)),r;if((o=f</a>)&amp;&amp;n.getElementsByClassName&amp;&amp;t.getElementsByClassName)return
q.apply(r,t.getElementsByClassName(o)),r}if(n.qsa&amp;&amp;!k[e+“
”]&amp;&amp;(!v||!v.test(e))){if(1!==C)m=t,y=e;else
if(“object”!==t.nodeName.toLowerCase()){(<a
href="u">c=t.getAttribute(“id”))?c=c.replace(te,ne):t.setAttribute(“id”,c=x),u=(h=a(e)).length;while(u–)h</a>=“#”<code>c</code>“
”+<a
href="u">ye(h</a>);y=h.join(“,”),m=J.test(e)&amp;&amp;ge(t.parentNode)||t}if(y)try{return
q.apply(r,m.querySelectorAll(y)),r}catch(e){}finally{c===x&amp;&amp;t.removeAttribute(“id”)}}}return
s(e.replace($,“$1”),t,r,i)}function ae(){var e=[];function t(n,i){return
e.push(n+“ ”)&gt;r.cacheLength&amp;&amp;delete <a
href="e.shift()">t</a>,t[n+“ ”]=i}return t}function ue(e){return <a
href="x">e</a>=!0,e}function se(e){var
...
t&amp;&amp;t.disabled===e}}function he(e){return ue(function(t){return
t=+t,ue(function(n,r){var <a
...
href="">y=[],v=</a>,(n.qsa=G.test(p.querySelectorAll))&amp;&amp;(se(function(e){h.appendChild(e).innerHTML=“&lt;a
id=&#39;”<code>x</code>“&#39;&gt;&lt;/a&gt;&lt;select
id=&#39;”<code>x</code>“-r\&#39; msallowcapture=&#39;&#39;&gt;&lt;option <a
href="msallowcapture^=''">selected=”></option></select>”,e.querySelectorAll(“</a>”).<a
href="*^$">length&&v.push(“</a>=”<code>I"*(?:''|\"\")"),e.querySelectorAll("[selected]</code>“).<a
href="id~="x"-">length||v.push(”\[“I”*(?:value|“H”)“),e.querySelectorAll(”</a>“).<a
href="+~">length||v.push(”~=“),e.querySelectorAll(”:checked“).length||v.push(”:checked“),e.querySelectorAll(”a#“x”+*“).length||v.push(”.#.+</a>“)}),se(function(e){e.innerHTML=”&lt;a
href=&#39;&#39; disabled=&#39;disabled&#39;&gt;&lt;/a&gt;&lt;select
disabled=&#39;disabled&#39;&gt;&lt;option/&gt;&lt;/select&gt;“;var <a
href="name=d">t=p.createElement(”input“);t.setAttribute(”type“,”hidden“),e.appendChild(t).setAttribute(”name“,”D“),e.querySelectorAll(”</a>“).<a
href="*^$|!~">length&&v.push(”name“I”*</a>?=“),2!==e.querySelectorAll(”:enabled“).length&amp;&amp;v.push(”:enabled“,”:disabled“),h.appendChild(e).disabled=!0,2!==e.querySelectorAll(”:disabled“).length&amp;&amp;v.push(”:enabled“,”:disabled“),e.querySelectorAll(”*,:x“),v.push(”,.*:“)})),(n.matchesSelector=G.test(m=h.matches||h.webkitMatchesSelector||h.mozMatchesSelector||h.oMatchesSelector||h.msMatchesSelector))&amp;&amp;se(function(e){<a
href="s!=''">n.disconnectedMatch=m.call(e,”*“),m.call(e,”</a>:x“),y.push(”!=“,M)}),v=v.length&amp;&amp;new
...
e===r||!(!r||1!==r.nodeType||!(n.contains?n.contains®:e.compareDocumentPosition&amp;&amp;16&amp;e.compareDocumentPosition®))}:function(e,t){if(t)while(t=t.parentNode)if(t===e)return!0;return!1},A=t?function(e,t){if(e===t)return
...
href="t">u=</a>;if(!i||!o)return
e===p?-1:t===p?1:i?-1:o?1:c?P(c,e)-P(c,t):0;if(i===o)return <a
href="r">ce(e,t);n=e;while(n=n.parentNode)a.unshift(n);n=t;while(n=n.parentNode)u.unshift(n);while(a</a>===<a
href="r">u</a>)r++;return <a href="r">r?ce(a</a>,<a href="r">u</a>):<a
href="r">a</a>===<a
href="r">w?-1:u</a>===w?1:0},p):p},oe.matches=function(e,t){return
...
r}catch(e){}return <a
href="e">oe(t,p,null,</a>).length&gt;0},oe.contains=function(e,t){return(e.ownerDocument||e)!==p&amp;&amp;d(e),b(e,t)},oe.attr=function(e,t){(e.ownerDocument||e)!==p&amp;&amp;d(e);var
<a
href="t.toLowerCase()">i=r.attrHandle</a>,o=i&amp;&amp;D.call(r.attrHandle,t.toLowerCase())?i(e,t,!g):void
0;return void
...
href="o++">t,r=[],i=0,o=0;if(f=!n.detectDuplicates,c=!n.sortStable&&e.slice(0),e.sort(A),f){while(t=e</a>)<a
href="o">t===e</a>&amp;&amp;(<a
...
href="0">X.CHILD.test(e</a>)?<a href="3">null:(e</a>?<a href="2">e</a>=<a
href="4">e</a>||<a href="5">e</a>||”“:<a
href="0">n&&U.test(n)&&(t=a(n,!0))&&(t=n.indexOf(”)“,n.length-t)-n.length)&&(e</a>=<a
href="0">e</a>.<a
...
RegExp(”(^|“<code>I</code>”)“<code>e</code>”(“<code>I</code>”|$)“))&amp;&amp;E(e,function(e){return
...
l,c,f,d,p,h,g=o!==a?”nextSibling“:”previousSibling“,v=t.parentNode,y=u&amp;&amp;t.nodeName.toLowerCase(),m=!s&amp;&amp;!u,b=!1;if(v){if(o){while(g){<a
href="g">d=t;while(d=d</a>)if(u?d.nodeName.toLowerCase()===y:1===d.nodeType)return!1;h=g=”only“===e&amp;&amp;!h&amp;&amp;”nextSibling“}return!0}<a
href="a?v.firstChild:v.lastChild">if(h=</a>,a&amp;&amp;m){<a
href="x">b=(p=(l=(c=(f=(d=v)</a>||(<a href="x">d</a>={}))[<a
href="d.uniqueID">d.uniqueID]||(f</a>={}))[<a href="0">e]||[])</a>===<a
href="1">C&&l</a>)&amp;&amp;<a href="2">l</a>,<a
href="p">d=p&&v.childNodes</a>;<a
href="g">while(d=++p&&d&&d</a>||(b=p=0)||h.pop())if(1===d.nodeType&amp;&amp;++b&amp;&amp;d===t){<a
href="e">c</a>=[C,p,b];break}}else <a
href="x">if(m&&(b=p=(l=(c=(f=(d=t)</a>||(<a href="x">d</a>={}))[<a
href="d.uniqueID">d.uniqueID]||(f</a>={}))[<a href="0">e]||[])</a>===<a
href="1">C&&l</a>),!<a href="g">1===b)while(d=++p&&d&&d</a>||(<a
href="x">b=p=0)||h.pop())if((u?d.nodeName.toLowerCase()===y:1===d.nodeType)&&++b&&(m&&((c=(f=d</a>||(<a
href="x">d</a>={}))[<a href="d.uniqueID">d.uniqueID]||(f</a>={}))[<a
href="C,b">e]=</a>),d===t))break;return(b-=i)===r||b%r==0&amp;&amp;b/r&gt;=0}}},PSEUDO:function(e,t){var
<a href="e">n,i=r.pseudos</a>||<a
href="e.toLowerCase()">r.setFilters</a>||oe.error(”unsupported pseudo:
“+e);return <a href="x">i</a>?<a
href="e,e,"",t">i(t):i.length>1?(n=</a>,r.setFilters.hasOwnProperty(e.toLowerCase())?ue(function(e,n){var
<a href="a">r,o=i(e,t),a=o.length;while(a–)e[r=P(e,o</a>)]=!(<a
href="r">n</a>=<a href="a">o</a>)}):function(e){return
i(e,0,n)}):i}},pseudos:{not:ue(function(e){var <a
href="">t=[],n=</a>,r=u(e.replace($,”$1“));return <a
href="x">r</a>?ue(function(e,t,n,i){var <a
href="u">o,a=r(e,null,i,[]),u=e.length;while(u–)(o=a</a>)&amp;&amp;(<a
href="u">e</a>=!(<a href="u">t</a>=o))}):function(e,i,o){return <a
href="0">t</a>=<a
href="0">e,r(t,null,o,n),t</a>=null,!n.pop()}}),has:ue(function(e){return
function(t){return oe(e,t).length&gt;0}}),contains:ue(function(e){return
e=e.replace(Z,ee),function(t){return(t.textContent||t.innerText||i(t)).indexOf(e)&gt;-1}}),lang:ue(function(e){return
V.test(e||”“)||oe.error(”unsupported lang:
...
href="t">r.pseudos</a>=de(t);function
ve(){}ve.prototype=r.filters=r.pseudos,r.setFilters=new
ve,a=oe.tokenize=function(e,t){var n,i,o,a,u,s,l,c=N[e+” “];if©return <a
href="0">t?0:c.slice(0);u=e,s=[],l=r.preFilter;while(u){n&&!(i=F.exec(u))||(i&&(u=u.slice(i</a>.<a
href="0">length)||u),s.push(o=[])),n=!1,(i=z.exec(u))&&(n=i.shift(),o.push({value:n,type:i</a>.replace($,”
“)}),u=u.slice(n.length));for(a in <a href="a">r.filter)!(i=X</a>.<a
href="a">exec(u))||l</a>&amp;&amp;!(<a
href="a">i=l</a>(i))||(n=i.shift(),o.push({value:n,type:a,matches:i}),u=u.slice(n.length));if(!n)break}return
t?u.length:u?oe.error(e):N(e,s).slice(0)};function ye(e){for(var <a
href="t">t=0,n=e.length,r=”“;t<n;t++)r+=e</a>.value;return r}function
me(e,t,n){var
r=t.dir,i=t.next,o=i||r,a=n&amp;&amp;”parentNode“===o,u=T++;return
t.first?function(t,n,i){<a
href="r">while(t=t</a>)if(1===t.nodeType||a)return
e(t,n,i);return!1}:function(t,n,s){var <a href="C,u">l,c,f,d=</a>;if(s){<a
href="r">while(t=t</a>)if((1===t.nodeType||a)&amp;&amp;e(t,n,s))return!0}else
<a href="r">while(t=t</a>)<a href="x">if(1===t.nodeType||a)if(f=t</a>||(<a
href="x">t</a>={}),<a href="t.uniqueID">c=f</a>||(<a
href="t.uniqueID">f</a>={}),<a
href="r">i&&i===t.nodeName.toLowerCase())t=t</a>||t;else{<a
href="o">if((l=c</a>)&amp;&amp;<a href="0">l</a>===<a
href="1">C&&l</a>===u)return <a href="2">d</a>=<a href="2">l</a>;<a
href="o">if(c</a>=<a href="2">d,d</a>=e(t,n,s))return!0}return!1}}function
be(e){return e.length&gt;1?function(t,n,r){var <a
href="i">i=e.length;while(i–)if(!e</a>(t,n,r))return!1;return!0}:<a
href="0">e</a>}function xe(e,t,n){for(var <a
href="r">r=0,i=t.length;r<i;r++)oe(e,t</a>,n);return n}function
we(e,t,n,r,i){for(var <a
href="u">o,a=[],u=0,s=e.length,l=null!=t;u<s;u++)(o=e</a>)&amp;&amp;(n&amp;&amp;!n(o,r,i)||(a.push(o),l&amp;&amp;t.push(u)));return
a}function Ce(e,t,n,r,i,o){return <a href="x">r&&!r</a>&amp;&amp;(<a
href="x">r=Ce®),i&&!i</a>&amp;&amp;(i=Ce(i,o)),ue(function(o,a,u,s){var <a
href="">l,c,f,d=[],p=</a>,<a
href="u">h=a.length,g=o||xe(t||”*“,u.nodeType?</a>:<a
href="">u,[]),v=!e||!o&&t?g:we(g,d,e,u,s),y=n?i||(o?e:h||r)?</a>:a:v;if(n&amp;&amp;n(v,y,u,s),r){<a
href="c">l=we(y,p),r(l,[],u,s),c=l.length;while(c–)(f=l</a>)&amp;&amp;(<a
href="c">y[p</a>]=!(<a href="c">v[p</a>]=f))}if(o){if(i||e){if(i){<a
href="c">l=[],c=y.length;while(c–)(f=y</a>)&amp;&amp;<a
href="c">l.push(v</a>=<a
href="c">f);i(null,y=[],l,s)}c=y.length;while(c–)(f=y</a>)&amp;&amp;(<a
href="c">l=i?P(o,f):d</a>)&gt;-<a href="l">1&&(o</a>=!(<a
href="l">a</a>=f))}}else
y=we(y===a?y.splice(h,y.length):y),i?i(null,a,y,s):q.apply(a,y)})}function
Te(e){for(var <a
href="0">t,n,i,o=e.length,a=r.relative[e</a>.type],u=a||r.relative[”
...
t=null,i}];<a href="s">s<o;s++)if(n=r.relative[e</a>.<a
href="me(be(d),n)">type])d=</a>;else{<a href="s">if((n=r.filter[e</a>.<a
href="s">type].apply(null,e</a>.<a href="x">matches))</a>){<a
href="i">for(i=++s;i<o;i++)if(r.relative[e</a>.type])break;return
Ce(s&gt;1&amp;&amp;be(d),s&gt;1&amp;&amp;ye(e.slice(0,s-1).concat({value:”
“===<a
href="s-2">e</a>.type?”*“:”“})).replace($,”$1“),n,s&lt;i&amp;&amp;Te(e.slice(s,i)),i&lt;o&amp;&amp;Te(e=e.slice(i)),i&lt;o&amp;&amp;ye(e))}d.push(n)}return
be(d)}function Ee(e,t){var
n=t.length&gt;0,i=e.length&gt;0,o=function(o,a,u,s,c){var <a
href="">f,h,v,y=0,m=”0“,b=o&&[],x=</a>,<a
href="m">w=l,T=o||i&&r.find.TAG(”*“,c),E=C+=null==w?1:Math.random()||.1,N=T.length;for(c&&(l=a===p||a||c);m!==N&&null!=(f=T</a>);m++){if(i&amp;&amp;f){<a
href="h++">h=0,a||f.ownerDocument===p||(d(f),u=!g);while(v=e</a>)if(v(f,a||p,u)){s.push(f);break}c&amp;&amp;(C=E)}n&amp;&amp;((f=!v&amp;&amp;f)&amp;&amp;y–,o&amp;&amp;b.push(f))}if(y+=m,n&amp;&amp;m!==y){<a
href="h++">h=0;while(v=t</a>)v(b,x,a,u);if(o){<a
href="m">if(y>0)while(m–)b</a>||<a href="m">x</a>||(<a
href="m">x</a>=L.call(s));x=we(x)}q.apply(s,x),c&amp;&amp;!o&amp;&amp;x.length&gt;0&amp;&amp;y+t.length&gt;1&amp;&amp;oe.uniqueSort(s)}return
c&amp;&amp;(C=E,l=w),b};return n?ue(o):o}return
u=oe.compile=function(e,t){var <a href="">n,r=[],i=</a>,o=k[e+”
“];if(!o){<a
href="n">t||(t=a(e)),n=t.length;while(n–)(o=Te(t</a>))[x]?r.push(o):i.push(o);(o=k(e,Ee(i,r))).selector=e}return
o},s=oe.select=function(e,t,n,i){var o,s,l,c,f,d=”function“==typeof <a
href="0">e&&e,p=!i&&a(e=d.selector||e);if(n=n||[],1===p.length){if((s=p</a>=<a
href="0">p</a>.<a href="0">slice(0)).length>2&&”ID“===(l=s</a>).<a
href="1">type&&9===t.nodeType&&g&&r.relative[s</a>.type]){<a
href="0">if(!(t=(r.find.ID(l.matches</a>.<a
href="0">replace(Z,ee),t)||[])</a>))return
n;d&amp;&amp;(t=t.parentNode),e=e.slice(s.shift().value.length)}o=X.needsContext.test(e)?0:s.length;while(o–){<a
href="o">if(l=s</a>,<a href="c=l.type">r.relative</a>)<a
href="c">break;if((f=r.find</a>)&amp;&amp;(<a href="0">i=f(l.matches</a>.<a
href="0">replace(Z,ee),J.test(s</a>.type)&amp;&amp;ge(t.parentNode)||t))){if(s.splice(o,1),!(e=i.length&amp;&amp;ye(s)))return
...
null==e.getAttribute(”disabled“)})||le(H,function(e,t,n){var <a
...
N=function(e,t,n){var r=[],i=void <a
...
s.call(t,e)&gt;-1!==n}):w.filter(t,e,n)}w.filter=function(e,t,n){var <a
...
e&amp;&amp;A.test(e)?w(e):e||[],!1).length}});var <a
href="\w\W">j,q=/^(?:s*(<</a>+&gt;)[^&gt;]*|#([w-]+))$/;(w.fn.init=function(e,t,n){var
i,o;if(!e)return this;if(n=n||j,”string“==typeof e){<a
href="0">if(!(i=”<"===e</a>&amp;&amp;“&gt;”===<a
href="e.length-1">e</a>&amp;&amp;<a href="null,e,null">e.length>=3?</a>:<a
href="1">q.exec(e))||!i</a>&amp;&amp;<a
...
href="1">t&&t.nodeType?t.ownerDocument||t:r,!0)),S.test(i</a>)&amp;&amp;w.isPlainObject(t))for(i
...
0!==n.ready?n.ready(e):e(w):w.makeArray(e,this)}).prototype=w.fn,j=w®;var
...
href="r">e&&w(e);if(!A.test(e))for(;r<i;r++)for(n=this</a>;n&amp;&amp;n!==t;n=n.parentNode)if(n.nodeType&lt;11&amp;&amp;(a?a.index(n)&gt;-1:1===n.nodeType&amp;&amp;w.find.matchesSelector(n,e))){o.push(n);break}return
this.pushStack(o.length&gt;1?w.uniqueSort(o):o)},index:function(e){return
e?“string”==typeof <a href="0">e?s.call(w(e),this</a>):<a
href="0">s.call(this,e.jquery?e</a>:<a href="0">e):this</a>&amp;&amp;<a
...
H(e,t){<a href="t">while((e=e</a>)&amp;&amp;1!==e.nodeType);return
...
k(e.firstChild)},contents:function(e){return <a
href="e">D(e,“iframe”)?e.contentDocument:(D(e,“template”)&&(e=e.content||e),w.merge([],e.childNodes))}},function(e,t){w.fn</a>=function(n,r){var
i=w.map(this,t,n);return“Until”!==e.slice(-5)&amp;&amp;(r=n),r&amp;&amp;“string”==typeof
<a
href="e">r&&(i=w.filter(r,i)),this.length>1&&(P</a>||w.uniqueSort(i),O.test(e)&amp;&amp;i.reverse()),this.pushStack(i)}});var
<a href="^\x20\t\r\n\f">I=/</a>+/g;function R(e){var t={};return <a
href="n">w.each(e.match(I)||[],function(e,n){t</a>=!0}),t}w.Callbacks=function(e){e=“string”==typeof
e?R(e):w.extend({},e);var <a
href="">t,n,r,i,o=[],a=</a>,u=-1,s=function(){for(i=i||e.once,r=t=!0;a.length;u=-1){<a
href="u">n=a.shift();while(++u<o.length)!1===o</a>.<a
href="0">apply(n</a>,<a
href="1">n</a>)&amp;&amp;e.stopOnFalse&amp;&amp;(u=o.length,n=!1)}e.memory||(n=!1),t=!1,i&amp;&amp;(o=n?[]:“”)},l={add:function(){return
o&amp;&amp;(n&amp;&amp;!t&amp;&amp;(u=o.length-1,a.push(n)),function
t(n){w.each(n,function(n,r){g®?e.unique&amp;&amp;l.has®||o.push®:r&amp;&amp;r.length&amp;&amp;“string”!==b®&amp;&amp;t®})}(arguments),n&amp;&amp;!t&amp;&amp;s()),this},remove:function(){return
w.each(arguments,function(e,t){var
n;while((n=w.inArray(t,o,n))&gt;-1)o.splice(n,1),n&lt;=u&amp;&amp;u–}),this},has:function(e){return
...
<a
href="">i||(n=[e,(n=n||</a>).slice?n.slice():n],a.push(n),t||s()),this},fire:function(){return
l.fireWith(this,arguments),this},fired:function(){return!!r}};return
l};function B(e){return e}function M(e){throw e}function W(e,t,n,r){var
...
u=this,s=arguments,l=function(){var
e,l;if(!(t&lt;o)){if((e=r.apply(u,s))===n.promise())throw new
...
<a
href="e">0,s=</a>),(i||n.resolveWith)(u,s))}},c=i?l:function(){try{l()}catch(e){w.Deferred.exceptionHook&amp;&amp;w.Deferred.exceptionHook(e,c.stackTrace),t+1&gt;=o&amp;&amp;(r!==M&amp;&amp;(u=void
<a
href="e">0,s=</a>),n.rejectWith(u,s))}};t?c():(w.Deferred.getStackHook&amp;&amp;(c.stackTrace=w.Deferred.getStackHook()),e.setTimeout©)}}return
w.Deferred(function(e){<a href="0">n</a>[<a
href="1">3].add(a(0,e,g(i)?i:B,e.notifyWith)),n</a>[<a
href="2">3].add(a(0,e,g(t)?t:B)),n</a>[3].add(a(0,e,g®?r:M))}).promise()},promise:function(e){return
null!=e?w.extend(e,i):i}},o={};return w.each(n,function(e,t){var <a
href="2">a=t</a>,<a href="5">u=t</a>;<a
href="1">i[t</a>]=a.add,u&amp;&amp;a.add(function(){r=u},<a
...
href="n">if(t<=1&&(W(e,a.done(u(n)).resolve,a.reject,!t),"pending"===a.state()||g(i</a>&amp;&amp;<a
href="n">i</a>.then)))return <a
href="n">a.then();while(n–)W(i</a>,u(n),a.reject);return a.promise()}});var
...
u=0,s=e.length,l=null==n;if(“object”===b(n)){i=!0;for(u in <a
href="u">n)_(e,t,u,n</a>,!0,o,a)}else if(void
0!==r&amp;&amp;(i=!0,g®||(a=!0),l&amp;&amp;(a?(t.call(e,r),t=null):(l=t,t=function(e,t,n){return
l.call(w(e),n)})),<a href="u">t))for(;u<s;u++)t(e</a>,<a
href="u">n,a?r:r.call(e</a>,<a href="u">u,t(e</a>,n)));return <a
href="0">i?e:l?t.call(e):s?t(e</a>,n):o},<a
href="a-z">U=/^-ms-/,V=/-(</a>)/g;function X(e,t){return
t.toUpperCase()}function Q(e){return e.replace(U,“ms-”).replace(V,X)}var
...
r,i=this.cache(e);if(“string”==typeof <a href="Q(t)">t)i</a>=n;else for(r
in <a href="Q(r)">t)i</a>=<a href="r">t</a>;return
i},get:function(e,t){return void <a
href="this.expando">0===t?this.cache(e):e</a>&amp;&amp;<a
href="this.expando">e</a>[Q(t)]},access:function(e,t,n){return void
...
0!==t){n=(t=Array.isArray(t)?t.map(Q):(t=Q(t))in <a
href="t">r?</a>:t.match(I)||[]).length;while(n–)delete <a
href="n">r[t</a>]}(void <a
...
0!==t&amp;&amp;!w.isEmptyObject(t)}};var K=new G,J=new
G,Z=/^(?:{[wW]*}|[[<a href=“A-Z”>wW]*])$/,ee=/</a>/g;function
te(e){return“true”===e||“false”!==e&amp;&amp;(“null”===e?null:e===<code>e</code>“”?+e:Z.test(e)?JSON.parse(e):e)}function
ne(e,t,n){var r;if(void
0===n&amp;&amp;1===e.nodeType)if(r=“data-”+t.replace(ee,“-$&amp;”).toLowerCase(),“string”==typeof(n=e.getAttribute®)){try{n=te(n)}catch(e){}J.set(e,t,n)}else
...
0===e){if(this.length&amp;&amp;(i=J.get(o),1===o.nodeType&amp;&amp;!K.get(o,“hasDataAttrs”))){<a
href="n">n=a.length;while(n–)a</a>&amp;&amp;<a href="n">0===(r=a</a>.<a
href="r">name).indexOf(“data-”)&&(r=Q(r.slice(5)),ne(o,r,i</a>));K.set(o,“hasDataAttrs”,!0)}return
i}return“object”==typeof
e?this.each(function(){J.set(this,e)}):_(this,function(t){var
n;if(o&amp;&amp;void 0===t){if(void 0!==(n=J.get(o,e)))return n;if(void
0!==(n=ne(o,e)))return n}else
this.each(function(){J.set(this,e,t)})},null,t,arguments.length&gt;1,null,!0)},removeData:function(e){return
...
n=t+“queueHooks”;return K.get(e,n)||K.access(e,n,{empty:w.Callbacks(“once
memory”).add(function(){<a
href="t+"queue",n">K.remove(e,</a>)})})}}),w.fn.extend({queue:function(e,t){var
...
n,r=1,i=w.Deferred(),o=this,a=this.length,u=function(){–<a
href="o">r||i.resolveWith(o,</a>)};“string”!=typeof e&amp;&amp;(t=e,e=void
<a
href="a">0),e=e||“fx”;while(a–)(n=K.get(o</a>,e+“queueHooks”))&amp;&amp;n.empty&amp;&amp;(r++,n.empty.add(u));return
u(),i.promise(t)}});var <a href="+-">re=/</a>?(?:<a
href=“eE”>d*.|)d+(?:</a>[+-]?d+|)/.source,ie=new <a
href="+-">RegExp(“^(?:(</a>)=|)(”<code>re")([a-z%]</code>*)$“,”<a
href=""Top","Right","Bottom","Left"">i“),oe=</a>,ae=function(e,t){return”none“===(e=t||e).style.display||”“===e.style.display&amp;&amp;w.contains(e.ownerDocument,e)&amp;&amp;”none“===w.css(e,”display“)},ue=function(e,t,n,r){var
i,o,a={};for(o in <a href="o">t)a</a>=<a href="o">e.style</a>,<a
href="o">e.style</a>=<a href="o">t</a>;i=n.apply(e,r||[]);for(o in <a
href="o">t)e.style</a>=<a href="o">a</a>;return i};function se(e,t,n,r){var
i,o,a=20,u=r?function(){return r.cur()}:function(){return w.css(e,t,”“)},<a
href="3">s=u(),l=n&&n</a>||(<a href="t">w.cssNumber</a>?”“:”<a
href="t">px“),c=(w.cssNumber</a>||”<a
href="3">px“!==l&&+s)&&ie.exec(w.css(e,t));if(c&&c</a>!==l){<a
href="3">s/=2,l=l||c</a>,c=+s||1;while(a–)w.style(e,t,c+l),(1-o)*(1-(o=u()/s||.5))&lt;=0&amp;&amp;(a=0),c/=o;c*=2,w.style(e,t,c+l),n=n||[]}return
<a href="1">n&&(c=+c||+s||0,i=n</a>?<a href="1">c+(n</a>+<a
href="2">1)*n</a>:+<a
...
href="o">K.get(r,”display“)||null,i</a>||(<a
href="o">r.style.display=”“)),”“===r.style.display&&ae®&&(i</a>=<a
href="o">ce®)):”none“!==n&&(i</a>=”<a
href="o">none“,K.set(r,”display“,n)));for(o=0;o<a;o++)null!=i</a>&amp;&amp;(<a
...
<a
href="a-z">de=/^(?:checkbox|radio)$/i,pe=/<(</a>[^/0&gt;x20trnf]+)/i,he=/^$|^module$|/(?:java|ecma)script/i,ge={option:[1,”&lt;select
<a
...
href="e">0===t||t&&D(e,t)?w.merge(</a>,n):n}function ye(e,t){for(var <a
href="n">n=0,r=e.length;n<r;n++)K.set(e</a>,”<a
href="n">globalEval“,!t||K.get(t</a>,”globalEval“))}var
me=/&lt;|&amp;#?w+;/;function be(e,t,n,r,i){for(var <a
href="p">o,a,u,s,l,c,f=t.createDocumentFragment(),d=[],p=0,h=e.length;p<h;p++)if((o=e</a>)||<a
href="o">0===o)if(”object“===b(o))w.merge(d,o.nodeType?</a>:o);else
if(me.test(o)){<a
href=""",""">a=a||f.appendChild(t.createElement(”div“)),u=(pe.exec(o)||</a>)[<a
href="u">1].toLowerCase(),s=ge</a>||<a
href="1">ge._default,a.innerHTML=s</a>+<a
href="2">w.htmlPrefilter(o)+s</a>,<a
href="0">c=s</a>;while(c–)a=a.lastChild;w.merge(d,a.childNodes),(a=f.firstChild).textContent=”“}else
<a
href="p++">d.push(t.createTextNode(o));f.textContent=”“,p=0;while(o=d</a>)if(r&amp;&amp;w.inArray(o,r)&gt;-1)i&amp;&amp;i.push(o);else
if(l=w.contains(o.ownerDocument,o),a=ve(f.appendChild(o),”script“),l&amp;&amp;ye(a),n){<a
...
<a
href="^.">xe=r.documentElement,we=/^key/,Ce=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,Te=/^(</a>*)(?:.(.+)|)/;function
Ee(){return!0}function Ne(){return!1}function ke(){try{return
r.activeElement}catch(e){}}function Ae(e,t,n,r,i,o){var
a,u;if(”object“==typeof t){”string“!=typeof n&amp;&amp;(r=r||n,n=void
0);for(u in <a href="u">t)Ae(e,u,n,r,t</a>,o);return
e}if(null==r&amp;&amp;null==i?(i=n,r=n=void
0):null==i&amp;&amp;(”string“==typeof n?(i=r,r=void 0):(i=r,r=n,n=void
0)),!1===i)i=Ne;else if(!i)return e;return
...
0}),<a href="""">l=(t=(t||”“).match(I)||</a>).<a
href="l">length;while(l–)p=g=(u=Te.exec(t</a>)||[])[<a
href="2">1],h=(u</a>||”“).<a
href="p">split(”.“).sort(),p&&(f=w.event.special</a>||{},<a
href="p">p=(i?f.delegateType:f.bindType)||p,f=w.event.special</a>||{},c=w.extend({type:p,origType:g,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&amp;&amp;w.expr.match.needsContext.test(i),namespace:h.join(”.“)},<a
href="p">o),(d=s</a>)||((<a href="p">d=s</a>=[]).<a
href="p">delegateCount=0,f.setup&&!1!==f.setup.call(e,r,h,a)||e.addEventListener&&e.addEventListener(p,a)),f.add&&(f.add.call(e,c),c.handler.guid||(c.handler.guid=n.guid)),i?d.splice(d.delegateCount++,0,c):d.push©,w.event.global</a>=!0)}},remove:function(e,t,n,r,i){var
o,a,u,s,l,c,f,d,p,h,g,v=K.hasData(e)&amp;&amp;K.get(e);if(v&amp;&amp;(s=v.events)){<a
href="""">l=(t=(t||”“).match(I)||</a>).<a
href="l">length;while(l–)if(u=Te.exec(t</a>)||[],<a href="1">p=g=u</a>,<a
href="2">h=(u</a>||”“).split(”.“).sort(),p){<a
href="p">f=w.event.special</a>||{},<a
href="p=(r?f.delegateType:f.bindType)||p">d=s</a>||[],<a
href="2">u=u</a>&amp;&amp;new <a
href="o">RegExp(”(^|\.)“+h.join(”\.(?:.*\.|)“)+”(\.|$)“),a=o=d.length;while(o–)c=d</a>,!i&amp;&amp;g!==c.origType||n&amp;&amp;n.guid!==c.guid||u&amp;&amp;!u.test(c.namespace)||r&amp;&amp;r!==c.selector&amp;&amp;(”**“!==r||!c.selector)||(d.splice(o,1),c.selector&amp;&amp;d.delegateCount–,f.remove&amp;&amp;f.remove.call(e,c));a&amp;&amp;!d.length&amp;&amp;(f.teardown&amp;&amp;!1!==f.teardown.call(e,h,v.handle)||w.removeEvent(e,p,v.handle),delete
<a href="p">s</a>)}else for(p in <a
href="l">s)w.event.remove(e,p+t</a>,n,r,!0);w.isEmptyObject(s)&amp;&amp;K.remove(e,”handle
events“)}},dispatch:function(e){var t=w.event.fix(e),n,r,i,o,a,u,s=new
Array(arguments.length),l=(K.get(this,”events“)||{})[<a
href="t.type">t.type]||[],c=w.event.special</a>||{};<a
href="0">for(s</a>=<a href="n">t,n=1;n<arguments.length;n++)s</a>=<a
href="n">arguments</a>;if(t.delegateTarget=this,!c.preDispatch||!1!==c.preDispatch.call(this,t)){<a
href="n++">u=w.event.handlers.call(this,t,l),n=0;while((o=u</a>)&amp;&amp;!t.isPropagationStopped()){<a
...
<a
href="a.origType">0!==(i=((w.event.special</a>||{}).handle||a.handler).apply(o.elem,s))&amp;&amp;!1===(t.result=i)&amp;&amp;(t.preventDefault(),t.stopPropagation()))}return
c.postDispatch&amp;&amp;c.postDispatch.call(this,t),t.result}},handlers:function(e,t){var
<a
href="">n,r,i,o,a,u=[],s=t.delegateCount,l=e.target;if(s&&l.nodeType&&!(”click“===e.type&&e.button>=1))for(;l!==this;l=l.parentNode||this)if(1===l.nodeType&&(”click“!==e.type||!0!==l.disabled)){for(o=</a>,a={},n=0;n&lt;s;n++)void
<a href="n">0===a[i=(r=t</a>).selector+” “]&amp;&amp;(<a href="i">a</a>=<a
href="l">r.needsContext?w(i,this).index(l)>-1:w.find(i,this,null,</a>).<a
href="i">length),a</a>&amp;&amp;o.push®;o.length&amp;&amp;u.push({elem:l,handlers:o})}return
l=this,s&lt;t.length&amp;&amp;u.push({elem:l,handlers:t.slice(s)}),u},addProp:function(e,t){Object.defineProperty(w.Event.prototype,e,{enumerable:!0,configurable:!0,get:g(t)?function(){if(this.originalEvent)return
...
w.Event(e)},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==ke()&amp;&amp;this.focus)return
this.focus(),!1},delegateType:”focusin“},blur:{trigger:function(){if(this===ke()&amp;&amp;this.blur)return
...
<a
href="w.expando">0===e.defaultPrevented&&!1===e.returnValue?Ee:Ne,this.target=e.target&&3===e.target.nodeType?e.target.parentNode:e.target,this.currentTarget=e.currentTarget,this.relatedTarget=e.relatedTarget):this.type=e,t&&w.extend(this,t),this.timeStamp=e&&e.timeStamp||Date.now(),this</a>=!0},w.Event.prototype={constructor:w.Event,isDefaultPrevented:Ne,isPropagationStopped:Ne,isImmediatePropagationStopped:Ne,isSimulated:!1,preventDefault:function(){var
...
0!==t&amp;&amp;Ce.test(e.type)?1&amp;t?1:2&amp;t?3:4&amp;t?2:0:e.which}},w.event.addProp),w.each({mouseenter:”mouseover“,mouseleave:”mouseout“,pointerenter:”pointerover“,pointerleave:”pointerout“},function(e,t){<a
...
<a
href="a-z">De=/<(?!area|br|col|embed|hr|img|input|link|meta|param)((</a>[^/<a
href=”^>“>0>x20trnf]*)</a>*)/&gt;/<a
href="^=">gi,Se=/<script|<style|<link/i,Le=/checked\s*(?:</a>|=<a
href=”|–)|(?:">s*.checked.)/i,je=/^s*<!(?:\[CDATA\</a>]|–)&gt;s*$/g;function
qe(e,t){return <a
href="0">D(e,“table”)&&D(11!==t.nodeType?t:t.firstChild,“tr”)?w(e).children(“tbody”)</a>||e:e}function
Oe(e){return e.type=(null!==e.getAttribute(“type”))+“/”+e.type,e}function
...
href="i">length;n<r;n++)w.event.add(t,i,l</a>[n])}J.hasData(e)&amp;&amp;(u=J.access(e),s=w.extend({},u),J.set(t,s))}}function
Ie(e,t){var
...
href="0">i,o,u,s,l,c,f=0,d=e.length,p=d-1,v=t</a>,y=g(v);if(y||d&gt;1&amp;&amp;“string”==typeof
v&amp;&amp;!h.checkClone&amp;&amp;Le.test(v))return e.each(function(i){var
<a href="0">o=e.eq(i);y&&(t</a>=v.call(this,i,o.html())),Re(o,t,n,r)});<a
href="0">if(d&&(i=be(t,e</a>.ownerDocument,!1,e,r),o=i.firstChild,1===i.childNodes.length&amp;&amp;(i=o),o||r)){<a
href="f">for(s=(u=w.map(ve(i,“script”),Oe)).length;f<d;f++)l=i,f!==p&&(l=w.clone(l,!0,!0),s&&w.merge(u,ve(l,"script"))),n.call(e</a>,<a
href="u.length-1">l,f);if(s)for(c=u</a>.<a
href="f">ownerDocument,w.map(u,Pe),f=0;f<s;f++)l=u</a>,he.test(l.type||“”)&amp;&amp;!K.access(l,“globalEval”)&amp;&amp;w.contains(c,l)&amp;&amp;(l.src&amp;&amp;“module”!==(l.type||“”).toLowerCase()?w._evalUrl&amp;&amp;w._evalUrl(l.src):m(l.textContent.replace(je,“”),c,l))}return
e}function Be(e,t,n){for(var <a
href="o">r,i=t?w.filter(t,e):e,o=0;null!=(r=i</a>);o++)n||1!==r.nodeType||w.cleanData(ve®),r.parentNode&amp;&amp;(n&amp;&amp;w.contains(r.ownerDocument,r)&amp;&amp;ye(ve(r,“script”)),r.parentNode.removeChild®);return
e}w.extend({htmlPrefilter:function(e){return
e.replace(De,“&lt;$1&gt;&lt;/$2&gt;”)},clone:function(e,t,n){var <a
href="r">r,i,o,a,u=e.cloneNode(!0),s=w.contains(e.ownerDocument,e);if(!(h.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||w.isXMLDoc(e)))for(a=ve(u),r=0,i=(o=ve(e)).length;r<i;r++)Ie(o</a>,<a
href="r">a</a>);<a
href="r">if(t)if(n)for(o=o||ve(e),a=a||ve(u),r=0,i=o.length;r<i;r++)He(o</a>,<a
href="r">a</a>);else
He(e,u);return(a=ve(u,“script”)).length&gt;0&amp;&amp;ye(a,!s&amp;&amp;ve(e,“script”)),u},cleanData:function(e){for(var
t,n,r,i=w.event.special,o=0;void <a href="o">0!==(n=e</a>);o++)if(Y(n)){<a
href="K.expando">if(t=n</a>){if(t.events)for(r in <a
href="r">t.events)i</a>?<a
href="K.expando">w.event.remove(n,r):w.removeEvent(n,r,t.handle);n</a>=void
0}<a href="J.expando">n</a>&amp;&amp;(<a href="J.expando">n</a>=void
0)}}}),w.fn.extend({detach:function(e){return
Be(this,e,!0)},remove:function(e){return
Be(this,e)},text:function(e){return _(this,function(e){return void
...
<a
href="t">e,t=0;null!=(e=this</a>);t++)1===e.nodeType&amp;&amp;(w.cleanData(ve(e,!1)),e.textContent=“”);return
this},clone:function(e,t){return
e=null!=e&amp;&amp;e,t=null==t?e:t,this.map(function(){return
w.clone(this,e,t)})},html:function(e){return _(this,function(e){var <a
href="0">t=this</a>||{},n=0,r=this.length;if(void
0===e&amp;&amp;1===t.nodeType)return t.innerHTML;if(“string”==typeof <a
href=""",""">e&&!Se.test(e)&&!ge[(pe.exec(e)||</a>)[1].toLowerCase()]){e=w.htmlPrefilter(e);try{<a
href="n">for(;n<r;n++)1===(t=this</a>||{}).nodeType&amp;&amp;(w.cleanData(ve(t,!1)),t.innerHTML=e);t=0}catch(e){}}t&amp;&amp;this.empty().append(e)},null,e,arguments.length)},replaceWith:function(){var
e=[];return Re(this,arguments,function(t){var
n=this.parentNode;w.inArray(this,e)&lt;0&amp;&amp;(w.cleanData(ve(this)),n&amp;&amp;n.replaceChild(t,this))},e)}}),w.each({appendTo:“append”,prependTo:“prepend”,insertBefore:“before”,insertAfter:“after”,replaceAll:“replaceWith”},function(e,t){<a
href="e">w.fn</a>=function(e){for(var <a
href="a">n,r=[],i=w(e),o=i.length-1,a=0;a<=o;a++)n=a===o?this:this.clone(!0),w(i</a>)[t](n),u.apply(r,n.get());return
this.pushStack®}});var Me=new <a
href="a-z%">RegExp(“^(”re“)(?!px)</a>+$”,“i”),We=function(t){var
n=t.ownerDocument.defaultView;return
n&amp;&amp;n.opener||(n=e),n.getComputedStyle(t)},$e=new
RegExp(oe.join(“|”),“i”);!function(){function
t(){if©{l.style.cssText=“position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0”,c.style.cssText=“position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%”,xe.appendChild(l).appendChild©;var
t=e.getComputedStyle©;i=“1%”!==t.top,s=12===n(t.marginLeft),c.style.right=“60%”,u=36===n(t.right),o=36===n(t.width),c.style.position=“absolute”,a=36===c.offsetWidth||“absolute”,xe.removeChild(l),c=null}}function
n(e){return Math.round(parseFloat(e))}var
i,o,a,u,s,l=r.createElement(“div”),c=r.createElement(“div”);c.style&amp;&amp;(c.style.backgroundClip=“content-box”,c.cloneNode(!0).style.backgroundClip=“”,h.clearCloneStyle=“content-box”===c.style.backgroundClip,w.extend(h,{boxSizingReliable:function(){return
t(),o},pixelBoxStyles:function(){return
t(),u},pixelPosition:function(){return
t(),i},reliableMarginLeft:function(){return
t(),s},scrollboxSize:function(){return t(),a}}))}();function Fe(e,t,n){var
<a
href="t">r,i,o,a,u=e.style;return(n=n||We(e))&&(“”!==(a=n.getPropertyValue(t)||n</a>)||w.contains(e.ownerDocument,e)||(a=w.style(e,t)),!h.pixelBoxStyles()&amp;&amp;Me.test(a)&amp;&amp;$e.test(t)&amp;&amp;(r=u.width,i=u.minWidth,o=u.maxWidth,u.minWidth=u.maxWidth=u.width=a,a=n.width,u.width=r,u.minWidth=i,u.maxWidth=o)),void
0!==a?a+“”:a}function
ze(e,t){return{get:function(){if(!e())return(this.get=t).apply(this,arguments);delete
this.get}}}var <a
href="ea">_e=/^(none|table(?!-c</a>).+)/,Ue=/^–/,Ve={position:“absolute”,visibility:“hidden”,display:“block”},Xe={letterSpacing:“0”,fontWeight:“400”},<a
href=""Webkit","Moz","ms"">Qe=</a>,Ye=r.createElement(“div”).style;function
Ge(e){if(e in Ye)return e;var <a href="0">t=e</a>.<a
href="n">toUpperCase()+e.slice(1),n=Qe.length;while(n–)if((e=Qe</a>+t)in
Ye)return e}function Ke(e){var <a href="e">t=w.cssProps</a>;return <a
href="e">t||(t=w.cssProps</a>=Ge(e)||e),t}function Je(e,t,n){var
r=ie.exec(t);return <a href="2">r?Math.max(0,r</a>-(<a
href="3">n||0))+(r</a>||“px”):t}function Ze(e,t,n,r,i,o){var
a=“width”===t?1:0,u=0,s=0;if(n===(r?“border”:“content”))return <a
href="a">0;for(;a<4;a+=2)"margin"===n&&(s+=w.css(e,n+oe</a>,!<a
href="a">0,i)),r?(“content”===n&&(s-=w.css(e,“padding”+oe</a>,!<a
href="a">0,i)),“margin”!==n&&(s-=w.css(e,“border”+oe</a>+“<a
href="a">Width”,!0,i))):(s+=w.css(e,“padding”+oe</a>,!<a
href="a">0,i),“padding”!==n?s+=w.css(e,“border”+oe</a>+“<a
href="a">Width”,!0,i):u+=w.css(e,“border”+oe</a>+“<a
href="0">Width”,!0,i));return!r&&o>=0&&(s+=Math.max(0,Math.ceil(e[“offset”+t</a>.toUpperCase()+t.slice(1)]-o-s-u-.5))),s}function
et(e,t,n){var
...
<a
href="t">i,o,a,u=Q(t),s=Ue.test(t),l=e.style;if(s||(t=Ke(u)),a=w.cssHooks</a>||<a
href="u">w.cssHooks</a>,void 0===n)return a&amp;&amp;“get”in
a&amp;&amp;void <a
href="t">0!==(i=a.get(e,!1,r))?i:l</a>;“string”==(o=typeof <a
href="1">n)&&(i=ie.exec(n))&&i</a>&amp;&amp;(<a
href="3">n=se(e,t,i),o=“number”),null!=n&&n===n&&(“number”===o&&(n+=i&&i</a>||(<a
href="u">w.cssNumber</a>?“”:“<a
href="t">px”)),h.clearCloneStyle||“”!==n||0!==t.indexOf(“background”)||(l</a>=“inherit”),a&amp;&amp;“set”in
a&amp;&amp;void <a
href="t">0===(n=a.set(e,n,r))||(s?l.setProperty(t,n):l</a>=n))}},css:function(e,t,n,r){var
i,o,a,u=Q(t);return <a href="t">Ue.test(t)||(t=Ke(u)),(a=w.cssHooks</a>||<a
href="u">w.cssHooks</a>)&amp;&amp;“get”in a&amp;&amp;(i=a.get(e,!0,n)),void
0===i&amp;&amp;(i=Fe(e,t,r)),“normal”===i&amp;&amp;t in <a
href="t">Xe&&(i=Xe</a>),“”===n||n?(o=parseFloat(i),!0===n||isFinite(o)?o||0:i):i}}),<a
href=""height","width"">w.each(</a>,function(e,t){<a
href="t">w.cssHooks</a>={get:function(e,n,r){if(n)return!_e.test(w.css(e,“display”))||e.getClientRects().length&amp;&amp;e.getBoundingClientRect().width?et(e,t,r):ue(e,Ve,function(){return
et(e,t,r)})},set:function(e,n,r){var
i,o=We(e),a=“border-box”===w.css(e,“boxSizing”,!1,o),u=r&amp;&amp;Ze(e,t,r,a,o);return
<a
href="0">a&&h.scrollboxSize()===o.position&&(u-=Math.ceil(e[“offset”+t</a>.<a
href="t">toUpperCase()+t.slice(1)]-parseFloat(o</a>)-<a
href="3">Ze(e,t,“border”,!1,o)-.5)),u&&(i=ie.exec(n))&&“px”!==(i</a>||“<a
href="t">px”)&&(e.style</a>=n,n=w.css(e,t)),Je(e,n,u)}}}),w.cssHooks.marginLeft=ze(h.reliableMarginLeft,function(e,t){if(t)return(parseFloat(Fe(e,“marginLeft”))||e.getBoundingClientRect().left-ue(e,{marginLeft:0},function(){return
...
href="e+t">margin”!==e&&(w.cssHooks</a>.set=Je)}),w.fn.extend({css:function(e,t){return
_(this,function(e,t,n){var r,i,o={},a=0;if(Array.isArray(t)){<a
href="a">for(r=We(e),i=t.length;a<i;a++)o[t</a>]=<a
href="a">w.css(e,t</a>,!1,r);return o}return void
0!==n?w.style(e,t,n):w.css(e,t)},e,t,arguments.length&gt;1)}}),w.fn.delay=function(t,n){return
<a
...
<a
href="t.toLowerCase()">e.getAttribute?w.prop(e,t,n):(1===o&&w.isXMLDoc(e)||(i=w.attrHooks</a>||(w.expr.match.bool.test(t)?tt:void
...
<a
href="r++">n,r=0,i=t&&t.match(I);if(i&&1===e.nodeType)while(n=i</a>)e.removeAttribute(n)}}),tt={set:function(e,t,n){return!1===t?w.removeAttr(e,n):e.setAttribute(n,n),n}},w.each(w.expr.match.bool.source.match(/w+/g),function(e,t){var
<a href="t">n=nt</a>||<a href="t">w.find.attr;nt</a>=function(e,t,r){var
i,o,a=t.toLowerCase();return <a href="a">r||(o=nt</a>,<a href="a">nt</a>=<a
href="a">i,i=null!=n(e,t,r)?a:null,nt</a>=o),i}});var
...
ot(e){return(e.match(I)||[]).join(“ ”)}function at(e){return
e.getAttribute&amp;&amp;e.getAttribute(“class”)||“”}function ut(e){return
Array.isArray(e)?e:“string”==typeof <a
href="">e?e.match(I)||[]:</a>}w.fn.extend({addClass:function(e){var
t,n,r,i,o,a,u,s=0;if(g(e))return
this.each(function(t){w(this).addClass(e.call(this,t,at(this)))});<a
href="s++">if((t=ut(e)).length)while(n=this</a>)if(i=at(n),r=1===n.nodeType&amp;&amp;“
”+ot(i)+“ ”){<a href="a++">a=0;while(o=t</a>)r.indexOf(“ ”<code>o</code>“
”)&lt;0&amp;&amp;(r+=o+“
”);i!==(u=ot®)&amp;&amp;n.setAttribute(“class”,u)}return
this},removeClass:function(e){var t,n,r,i,o,a,u,s=0;if(g(e))return
this.each(function(t){w(this).removeClass(e.call(this,t,at(this)))});if(!arguments.length)return
<a
href="s++">this.attr(“class”,“”);if((t=ut(e)).length)while(n=this</a>)if(i=at(n),r=1===n.nodeType&amp;&amp;“
”+ot(i)+“ ”){<a href="a++">a=0;while(o=t</a>)while(r.indexOf(“
...
t,i,o,a;if®{<a
href="i++">i=0,o=w(this),a=ut(e);while(t=a</a>)o.hasClass(t)?o.removeClass(t):o.addClass(t)}else
void
...
href="r++">while(n=this</a>)if(1===n.nodeType&amp;&amp;(“ ”+ot(at(n))+“
”).indexOf(t)&gt;-1)return!0;return!1}});var
st=/r/g;w.fn.extend({val:function(e){var <a
...
null!=t?t:ot(w.text(e))}},select:{get:function(e){var <a
href="r">t,n,r,i=e.options,o=e.selectedIndex,a=“select-one”===e.type,u=a?null:[],s=a?o+1:i.length;for(r=o<0?s:a?o:0;r<s;r++)if(((n=i</a>).selected||r===o)&amp;&amp;!n.disabled&amp;&amp;(!n.parentNode.disabled||!D(n.parentNode,“optgroup”))){if(t=w(n).val(),a)return
t;u.push(t)}return u},set:function(e,t){var <a
...
<a href="i||r">a,u,s,l,c,d,p,h,y=</a>,<a
href="w.expando">m=f.call(t,“type”)?t.type:t,b=f.call(t,“namespace”)?t.namespace.split(“.”):[];if(u=h=s=i=i||r,3!==i.nodeType&&8!==i.nodeType&&!lt.test(m+w.event.triggered)&&(m.indexOf(“.”)>-1&&(m=(b=m.split(“.”)).shift(),b.sort()),c=m.indexOf(“:”)<0&&"on"+m,t=t</a>?t:new
w.Event(m,“object”==typeof
t&amp;&amp;t),t.isTrigger=o?2:3,t.namespace=b.join(“.”),t.rnamespace=t.namespace?new
RegExp(“(^|\.)”+b.join(“\.(?:.*\.|)”)+“(\.|$)”):null,t.result=void <a
href="t">0,t.target||(t.target=i),n=null==n?</a>:<a
href="t">w.makeArray(n,</a>),<a
href="m">p=w.event.special</a>||{},o||!p.trigger||!1!==p.trigger.apply(i,n))){if(!o&amp;&amp;!p.noBubble&amp;&amp;!v(i)){for(l=p.delegateType||m,lt.test(l+m)||(u=u.parentNode);u;u=u.parentNode)y.push(u),s=u;s===(i.ownerDocument||r)&amp;&amp;y.push(s.defaultView||s.parentWindow||e)}<a
href="a++">a=0;while((u=y</a>)&amp;&amp;!t.isPropagationStopped())h=u,t.type=a&gt;1?l:p.bindType||m,(d=(K.get(u,“events”)||{})[<a
href="c">t.type]&&K.get(u,“handle”))&&d.apply(u,n),(d=c&&u</a>)&amp;&amp;d.apply&amp;&amp;Y(u)&amp;&amp;(t.result=d.apply(u,n),!1===t.result&amp;&amp;t.preventDefault());return
<a
href="m">t.type=m,o||t.isDefaultPrevented()||p._default&&!1!==p._default.apply(y.pop(),n)||!Y(i)||c&&g(i</a>)&amp;&amp;!<a
href="c">v(i)&&((s=i</a>)&amp;&amp;(<a href="c">i</a>=<a
href="m">null),w.event.triggered=m,t.isPropagationStopped()&&h.addEventListener(m,ct),i</a>(),t.isPropagationStopped()&amp;&amp;h.removeEventListener(m,ct),w.event.triggered=void
<a href="c">0,s&&(i</a>=s)),t.result}},simulate:function(e,t,n){var
r=w.extend(new
...
<a
href="\">ft=/</a>$/,dt=/r?n/g,pt=/^(?:submit|button|image|reset|file)$/i,ht=/^(?:input|select|textarea|keygen)/i;function
gt(e,t,n,r){var
i;if(Array.isArray(t))w.each(t,function(t,i){n||ft.test(e)?r(e,i):gt(e+“[”+(“object”==typeof
i&amp;&amp;null!=i?t:“”)+“]”,i,n,r)});else
if(n||“object”!==b(t))r(e,t);else for(i in <a href=""i"">t)gt(e+“</a>”,<a
...
for(n in <a href="n">e)gt(n,e</a>,t,i);return
...
n=w(this).val();return
null==n?null:Array.isArray(n)?w.map(n,function(e){return{name:t.name,value:e.replace(dt,“rn”)}}):{name:t.name,value:n.replace(dt,“rn”)}}).get()}}),w.fn.extend({wrapAll:function(e){var
...
href="1">t||(h.createHTMLDocument?((i=(t=r.implementation.createHTMLDocument(“”)).createElement(“base”)).href=r.location.href,t.head.appendChild(i)):t=r),o=S.exec(e),a=!n&&[],o?[t.createElement(o</a>)]:(<a
href="e">o=be(</a>,t,a),a&amp;&amp;a.length&amp;&amp;w(a).remove(),w.merge([],o.childNodes))},w.offset={setOffset:function(e,t,n){var
...
o;if(v(e)?o=e:9===e.nodeType&amp;&amp;(o=e.defaultView),void 0===i)return
...
href="t">w.cssHooks</a>=ze(h.pixelPosition,function(e,n){if(n)return <a
href="t">n=Fe(e,t),Me.test(n)?w(e).position()</a>+“px”:n})}),w.each({Height:“height”,Width:“width”},function(e,t){w.each({padding:“inner”+e,content:t,“”:“outer”+e},function(n,r){<a
href="r">w.fn</a>=function(i,o){var
a=arguments.length&amp;&amp;(n||“boolean”!=typeof
i),u=n||(!0===i||!0===o?“margin”:“border”);return
_(this,function(t,n,i){var o;return <a
href=""inner"+e">v(t)?0===r.indexOf(“outer”)?t</a>:<a
...
0===i?w.css(t,n,u):w.style(t,n,i,u)},t,a?i:void 0,a)}})}),w.each(“blur
...
w});var vt=e.jQuery,yt=e.$;return w.noConflict=function(t){return
e.$===w&amp;&amp;(e.$=yt),t&amp;&amp;e.jQuery===w&amp;&amp;(e.jQuery=vt),w},t||(e.jQuery=e.$=w),w});</p>
</main>
