...
<title>jquery.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/jquery/jquery.js">
...
<p>// Pass this if window is not defined yet } )( typeof window !==
“undefined” ? window : this, function( window, noGlobal ) {</p>

<p>// Edge &lt;= 12 - 13+, Firefox &lt;=18 - 45+, IE 10 - 11, Safari 5.1 - 9+,
iOS 6 - 9.1 // throw exceptions when non-strict code (e.g., ASP.NET 4.5)
accesses strict mode // arguments.callee.caller (trac-13335). But as of
jQuery 3.0 (2016), strict mode should be common // enough that all such
attempts are guarded in a try block. “use strict”;</p>

<p>var arr = [];</p>

<p>var document = window.document;</p>

<p>var getProto = Object.getPrototypeOf;</p>

<p>var slice = arr.slice;</p>

<p>var concat = arr.concat;</p>

<p>var push = arr.push;</p>

<p>var indexOf = arr.indexOf;</p>
...
<p>var fnToString = hasOwn.toString;</p>

<p>var ObjectFunctionString = fnToString.call( <a
href="../../../../Object.html">Object</a> );</p>

<p>var support = {};</p>

<p>var isFunction = function isFunction( obj ) {</p>

<pre>    // Support: Chrome &lt;=57, Firefox &lt;=52
...
<p>var isWindow = function isWindow( obj ) {</p>

<pre>        return obj != null &amp;&amp; obj === obj.window;
};
...
<pre class="ruby"><span class="ruby-identifier">global</span> <span class="ruby-constant">Symbol</span>
</pre>

<p>// Defining this global in .eslintrc.json would create a danger of using
the global // unguarded in another place, it seems safer to define global
only for this module</p>
...
<p>if ( typeof Symbol === “function” ) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">fn</span>[ <span class="ruby-constant">Symbol</span>.<span class="ruby-identifier">iterator</span> ] = <span class="ruby-identifier">arr</span>[ <span class="ruby-constant">Symbol</span>.<span class="ruby-identifier">iterator</span> ];
</pre>
...
Symbol”.split( “ ” ), function( i, name ) {</p>
...
<pre>// Support: real iOS 8.2 only (not reproducible in simulator)
...
<pre> Sizzle CSS Selector Engine v2.3.3
 https://sizzlejs.com/
...
<pre>var m, i, elem, nid, match, groups, newSelector,
...
<pre>var el = document.createElement(&quot;fieldset&quot;);
...
<pre> Returns a function to use in pseudos for :enabled/:disabled
 @param {Boolean} disabled true for :disabled; false for :enabled
/</pre>

<p>function createDisabledPseudo( disabled ) {</p>

<pre>// Known :disabled false positives: fieldset[disabled] &gt; legend:nth-of-type(n+2) :can-disable
...
<pre>return context &amp;&amp; typeof context.getElementsByTagName !== &quot;undefined&quot; &amp;&amp; context;</pre>
...
<p>Sizzle.escape = function( sel ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (<span class="ruby-identifier">sel</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;&quot;</span>).<span class="ruby-identifier">replace</span>( <span class="ruby-identifier">rcssescape</span>, <span class="ruby-identifier">fcssescape</span> );
</pre>
...
<p>// Support: Chrome 14-35+ // Always assume duplicates if they aren&#39;t
...
assert(function( el ) {</p>

<pre>// Should return 1, but returns 4 (following)
return el.compareDocumentPosition( document.createElement(&quot;fieldset&quot;) ) &amp; 1;</pre>

<p>});</p>

<p>// Support: IE&lt;8 // Prevent attribute/property “interpolation” // <a
href="https://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx">msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx</a>
if ( !assert(function( el ) {</p>

<pre class="ruby"><span class="ruby-identifier">el</span>.<span class="ruby-identifier">innerHTML</span> = <span class="ruby-string">&quot;&lt;a href=&#39;#&#39;&gt;&lt;/a&gt;&quot;</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">el</span>.<span class="ruby-identifier">firstChild</span>.<span class="ruby-identifier">getAttribute</span>(<span class="ruby-string">&quot;href&quot;</span>) <span class="ruby-operator">===</span> <span class="ruby-string">&quot;#&quot;</span> ;
</pre>
...
if ( !support.attributes || !assert(function( el ) {</p>

<pre class="ruby"><span class="ruby-identifier">el</span>.<span class="ruby-identifier">innerHTML</span> = <span class="ruby-string">&quot;&lt;input/&gt;&quot;</span>;
<span class="ruby-identifier">el</span>.<span class="ruby-identifier">firstChild</span>.<span class="ruby-identifier">setAttribute</span>( <span class="ruby-string">&quot;value&quot;</span>, <span class="ruby-string">&quot;&quot;</span> );
<span class="ruby-keyword">return</span> <span class="ruby-identifier">el</span>.<span class="ruby-identifier">firstChild</span>.<span class="ruby-identifier">getAttribute</span>( <span class="ruby-string">&quot;value&quot;</span> ) <span class="ruby-operator">===</span> <span class="ruby-string">&quot;&quot;</span>;
</pre>
...
getAttribute lies if ( !assert(function( el ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">el</span>.<span class="ruby-identifier">getAttribute</span>(<span class="ruby-string">&quot;disabled&quot;</span>) <span class="ruby-operator">==</span> <span class="ruby-identifier">null</span>;
</pre>
...
<p>jQuery.find = Sizzle; jQuery.expr = Sizzle.selectors;</p>

<p>// Deprecated jQuery.expr[ “:” ] = jQuery.expr.pseudos; jQuery.uniqueSort =
jQuery.unique = Sizzle.uniqueSort; jQuery.text = Sizzle.getText;
jQuery.isXMLDoc = Sizzle.isXML; jQuery.contains = Sizzle.contains;
jQuery.escapeSelector = Sizzle.escape;</p>

<p>var dir = function( elem, dir, until ) {</p>
...
<p>var siblings = function( n, elem ) {</p>
...
<p>function nodeName( elem, name ) {</p>
...
return jQuery.filter( qualifier, elements, not );</pre>
...
<pre>// A simple way to check for HTML strings
...
<pre>while ( ( cur = cur[ dir ] ) &amp;&amp; cur.nodeType !== 1 ) {}
return cur;</pre>
...
<p>} ); var rnothtmlwhite = ( /[^x20trnf]+/g );</p>

<p>// Convert String-formatted options into Object-formatted ones function
createOptions( options ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">object</span> = {};
<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">each</span>( <span class="ruby-identifier">options</span>.<span class="ruby-identifier">match</span>( <span class="ruby-identifier">rnothtmlwhite</span> ) <span class="ruby-operator">||</span> [], <span class="ruby-identifier">function</span>( <span class="ruby-identifier">_</span>, <span class="ruby-identifier">flag</span> ) {
...
<p>function Identity( v ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">v</span>;
</pre>

<p>} function Thrower( ex ) {</p>

<pre class="ruby"><span class="ruby-identifier">throw</span> <span class="ruby-identifier">ex</span>;
</pre>

<p>}</p>

<p>function adoptValue( value, resolve, reject, noValue ) {</p>
...
<p>// These usually indicate a programmer mistake during development, // warn
about them ASAP rather than swallowing them by default. var rerrorNames =
/^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;</p>

<p>jQuery.Deferred.exceptionHook = function( error, stack ) {</p>

<pre>// Support: IE 8 - 9 only
...
<p>jQuery.readyException = function( error ) {</p>

<pre class="ruby"><span class="ruby-identifier">window</span>.<span class="ruby-identifier">setTimeout</span>( <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">throw</span> <span class="ruby-identifier">error</span>;
} );
</pre>

<p>};</p>

<p>// The deferred used on DOM ready var readyList = jQuery.Deferred();</p>
...
<p>jQuery.ready.then = readyList.then;</p>

<p>// The ready event handler and self cleanup method function completed() {</p>

<pre class="ruby"><span class="ruby-identifier">document</span>.<span class="ruby-identifier">removeEventListener</span>( <span class="ruby-string">&quot;DOMContentLoaded&quot;</span>, <span class="ruby-identifier">completed</span> );
<span class="ruby-identifier">window</span>.<span class="ruby-identifier">removeEventListener</span>( <span class="ruby-string">&quot;load&quot;</span>, <span class="ruby-identifier">completed</span> );
<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">ready</span>();
</pre>

<p>}</p>

<p>// Catch cases where $(document).ready() is called // after the browser
event has already occurred. // Support: IE &lt;=9 - 10 only // Older IE
sometimes signals “interactive” too soon if ( document.readyState ===
“complete” ||</p>

<pre>( document.readyState !== &quot;loading&quot; &amp;&amp; !document.documentElement.doScroll ) ) {

// Handle it asynchronously to allow scripts the opportunity to delay ready
window.setTimeout( jQuery.ready );</pre>

<p>} else {</p>

<pre>// Use the handy event callback
document.addEventListener( &quot;DOMContentLoaded&quot;, completed );

// A fallback to window.onload, that will always work
window.addEventListener( &quot;load&quot;, completed );</pre>
...
function( elems, fn, key, value, chainable, emptyGet, raw ) {</p>
...
return len ? fn( elems[ 0 ], key ) : emptyGet;</pre>

<p>};</p>

<p>// Matches dashed string for camelizing var rmsPrefix = /^-ms-/,</p>

<pre>rdashAlpha = /-([a-z])/g;</pre>

<p>// Used by camelCase as callback to replace() function fcamelCase( all,
letter ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">letter</span>.<span class="ruby-identifier">toUpperCase</span>();
</pre>

<p>}</p>

<p>// Convert dashed to camelCase; used by the css and data modules //
Support: IE &lt;=9 - 11, Edge 12 - 15 // Microsoft forgot to hump their
vendor prefix (#9572) function camelCase( string ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">string</span>.<span class="ruby-identifier">replace</span>( <span class="ruby-identifier">rmsPrefix</span>, <span class="ruby-string">&quot;ms-&quot;</span> ).<span class="ruby-identifier">replace</span>( <span class="ruby-identifier">rdashAlpha</span>, <span class="ruby-identifier">fcamelCase</span> );
</pre>

<p>} var acceptData = function( owner ) {</p>
...
//  - Object
//    - Any
return owner.nodeType === 1 || owner.nodeType === 9 || !( +owner.nodeType );</pre>

<p>};</p>

<p>function Data() {</p>

<pre>this.expando = jQuery.expando + Data.uid++;</pre>
...
<p>}; var dataPriv = new Data();</p>

<p>var dataUser = new Data();</p>

<p>//      Implementation Summary // //      1. Enforce API surface and
semantic compatibility with 1.9.x branch //      2. Improve the
module&#39;s maintainability by reducing the storage //              paths
to a single mechanism. //      3. Use the same single mechanism to support
“private” and “user” data. //      4. <em>Never</em> expose “private” data
to user code (TODO: Drop _data, _removeData) //      5. Avoid exposing
implementation details on user objects (eg. expando properties) //      6.
Provide a clear path for implementation upgrade to WeakMap in 2014</p>

<p>var rbrace = /^(?:{[wW]*}|[[wW]*])$/,</p>

<pre>rmultiDash = /[A-Z]/g;</pre>

<p>function getData( data ) {</p>
...
<p>var rcssNum = new RegExp( “^(?:([+-])=|)(” + pnum + “)([a-z%]*)$”, “i” );</p>

<p>var cssExpand = [ “Top”, “Right”, “Bottom”, “Left” ];</p>

<p>var isHiddenWithinTree = function( elem, el ) {</p>

<pre>        // isHiddenWithinTree might be called from jQuery#filter function;
...
<p>var swap = function( elem, options, callback, args ) {</p>
...
<p>function adjustCSS( elem, prop, valueParts, tween ) {</p>

<pre>var adjusted, scale,
        maxIterations = 20,
        currentValue = tween ?
                function() {
                        return tween.cur();
...
<p>var defaultDisplayMap = {};</p>

<p>function getDefaultDisplay( elem ) {</p>
...
<p>var rtagName = ( /&lt;([<a href="^\/\0>x20trnf“>a-z]</a>+)/i );</p>

<p>var rscriptType = ( /^$|^module$|/(?:java|ecma)script/i );</p>

<p>// We have to close these tags to support XHTML (#13200) var wrapMap = {</p>

<pre>// Support: IE &lt;=9 only
...
<p>// Support: IE &lt;=9 only wrapMap.optgroup = wrapMap.option;</p>

<p>wrapMap.tbody = wrapMap.tfoot = wrapMap.colgroup = wrapMap.caption =
wrapMap.thead; wrapMap.th = wrapMap.td;</p>

<p>function getAll( context, tag ) {</p>

<pre>// Support: IE &lt;=9 - 11 only
...
<p>function buildFragment( elems, context, scripts, selection, ignored ) {</p>

<pre>var elem, tmp, tag, wrap, contains, j,
...
support.noCloneChecked = !!div.cloneNode( true ).lastChild.defaultValue;</pre>

<p>} )(); var documentElement = document.documentElement;</p>

<p>var</p>

<pre class="ruby"><span class="ruby-identifier">rkeyEvent</span> = <span class="ruby-regexp">/^key/</span>,
<span class="ruby-identifier">rmouseEvent</span> = <span class="ruby-regexp">/^(?:mouse|pointer|contextmenu|drag|drop)|click/</span>,
...
<p>// Support: IE &lt;=9 only // See #13393 for more info function
safeActiveElement() {</p>
...
<p>function on( elem, types, selector, data, fn, one ) {</p>
...
<p>jQuery.removeEvent = function( elem, type, handle ) {</p>

<pre>// This &quot;if&quot; is needed for plain objects
...
Language Binding // <a
href="https://www.w3.org/TR/2003/WD-DOM-Level-3-Events-20030331/ecma-script-binding.html">www.w3.org/TR/2003/WD-DOM-Level-3-Events-20030331/ecma-script-binding.html</a>
jQuery.Event.prototype = {</p>

<pre>constructor: jQuery.Event,
...
<p>// Includes all common event props including KeyEvent and MouseEvent
specific props jQuery.each( {</p>
...
<p>}, jQuery.event.addProp );</p>

<p>// Create mouseenter/leave events using mouseover/out and event-time checks
// so that event delegation works in jQuery. // Do the same for
pointerenter/pointerleave and pointerover/pointerout // // Support: Safari
7 only // Safari sends mouseenter too often; see: // <a
href="https://bugs.chromium.org/p/chromium/issues/detail?id=470258">bugs.chromium.org/p/chromium/issues/detail?id=470258</a>
...
<pre>on: function( types, selector, data, fn ) {
...
rcleanScript = /^\s*&lt;!(?:\[CDATA\[|--)|(?:\]\]|--)&gt;\s*$/g;</pre>

<p>// Prefer a tbody over its parent table for containing new rows function
manipulationTarget( elem, content ) {</p>

<pre>if ( nodeName( elem, &quot;table&quot; ) &amp;&amp;
...
<pre>elem.type = ( elem.getAttribute( &quot;type&quot; ) !== null ) + &quot;/&quot; + elem.type;
return elem;</pre>

<p>} function restoreScript( elem ) {</p>

<pre>if ( ( elem.type || &quot;&quot; ).slice( 0, 5 ) === &quot;true/&quot; ) {
...
<pre>var i, l, type, pdataOld, pdataCur, udataOld, udataCur, events;
...
<p>// Fix IE bugs, see support tests function fixInput( src, dest ) {</p>

<pre>var nodeName = dest.nodeName.toLowerCase();
...
<p>function domManip( collection, args, callback, ignored ) {</p>

<pre>// Flatten any nested arrays
...
<p>function remove( elem, selector, keepData ) {</p>
...
<pre>htmlPrefilter: function( html ) {
...
<p>} ); var rnumnonpx = new RegExp( “^(” + pnum + “)(?!<a
href="a-z%">px)</a>+$”, “i” );</p>

<p>var getStyles = function( elem ) {</p>

<pre>        // Support: IE &lt;=11 only, Firefox &lt;=30 (#15098, #14150)
...
<p>var rboxStyle = new RegExp( cssExpand.join( “|” ), “i” );</p>

<p>( function() {</p>

<pre>// Executing both pixelPosition &amp; boxSizingReliable tests require only one layout
...
<p>function curCSS( elem, name, computed ) {</p>

<pre>var width, minWidth, maxWidth, ret,
...
<pre>// Swappable if display is none or starts with table
...
emptyStyle = document.createElement( &quot;div&quot; ).style;</pre>

<p>// Return a css property mapped to a potentially vendor prefixed property
function vendorPropName( name ) {</p>
...
<p>// Return a property mapped along what jQuery.cssProps suggests or to // a
vendor prefixed property. function finalPropName( name ) {</p>

<pre>var ret = jQuery.cssProps[ name ];
if ( !ret ) {
...
<pre>// Any relative (+/-) values have already been
...
<p>function boxModelAdjustment( elem, dimension, box, isBorderBox, styles,
computedVal ) {</p>

<pre>var i = dimension === &quot;width&quot; ? 1 : 0,
        extra = 0,
        delta = 0;
...
<p>function getWidthOrHeight( elem, dimension, extra ) {</p>

<pre>// Start with computed style
...
<p>jQuery.each( [ “height”, “width” ], function( i, dimension ) {</p>

<pre>jQuery.cssHooks[ dimension ] = {
...
<p>jQuery.cssHooks.marginLeft = addGetHookIf( support.reliableMarginLeft,</p>
...
<p>// Support: IE &lt;=9 only // Panic based approach to setting things on
disconnected nodes Tween.propHooks.scrollTop = Tween.propHooks.scrollLeft =
{</p>
...
<pre class="ruby"><span class="ruby-identifier">fxNow</span>, <span class="ruby-identifier">inProgress</span>,
<span class="ruby-identifier">rfxtypes</span> = <span class="ruby-regexp">/^(?:toggle|show|hide)$/</span>,
<span class="ruby-identifier">rrun</span> = <span class="ruby-regexp">/queueHooks$/</span>;
</pre>
...
<span class="ruby-keyword">return</span> ( <span class="ruby-identifier">fxNow</span> = <span class="ruby-constant">Date</span>.<span class="ruby-identifier">now</span>() );
</pre>
...
<pre>var prop, value, toggle, hooks, oldfire, propTween, restoreDisplay, display,
...
<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">timers</span>.<span class="ruby-identifier">push</span>( <span class="ruby-identifier">timer</span> );
<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">fx</span>.<span class="ruby-identifier">start</span>();
</pre>

<p>};</p>

<p>jQuery.fx.interval = 13; jQuery.fx.start = function() {</p>
...
<pre class="ruby"><span class="ruby-identifier">inProgress</span> = <span class="ruby-identifier">null</span>;
</pre>
...
href="https://web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay">web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay</a>/
...
<p>// Hooks for boolean attributes boolHook = {</p>
...
<p>jQuery.each( jQuery.expr.match.bool.source.match( /w+/g ), function( i,
name ) {</p>
...
<p>var rfocusable = /^(?:input|select|textarea|button)$/i,</p>
...
<pre>prop: function( elem, name, value ) {
        var ret, hooks,
                nType = elem.nodeType;
...
<p>// Support: IE &lt;=11 only // Accessing the selectedIndex property //
forces the browser to respect setting selected // on the option // The
getter ensures a default option is selected // when in an optgroup //
eslint rule “no-unused-expressions” is disabled for this code // since it
considers such accessions noop if ( !support.optSelected ) {</p>
...
<pre>// Strip and collapse whitespace according to HTML spec
...
<p>function getClass( elem ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getAttribute</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getAttribute</span>( <span class="ruby-string">&quot;class&quot;</span> ) <span class="ruby-operator">||</span> <span class="ruby-string">&quot;&quot;</span>;
</pre>

<p>}</p>

<p>function classesToArray( value ) {</p>
...
<p>support.focusin = “onfocusin” in window;</p>

<p>var rfocusMorph = /^(?:focusinfocus|focusoutblur)$/,</p>

<pre class="ruby"><span class="ruby-identifier">stopPropagationCallback</span> = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">e</span> ) {
        <span class="ruby-identifier">e</span>.<span class="ruby-identifier">stopPropagation</span>();
};
</pre>

<p>jQuery.extend( jQuery.event, {</p>

<pre>trigger: function( event, data, elem, onlyHandlers ) {
...
<pre>trigger: function( type, data ) {
        return this.each( function() {
...
<p>// Support: Firefox &lt;=44 // Firefox doesn&#39;t have focus(in | out)
events // Related ticket - <a
href="https://bugzilla.mozilla.org/show_bug.cgi?id=687787">bugzilla.mozilla.org/show_bug.cgi?id=687787</a>
// // Support: Chrome &lt;=48 - 49, Safari &lt;=9.0 - 9.1 // focus(in |
out) events fire after focus &amp; blur events, // which is spec violation
- <a
href="http://www.w3.org/TR/DOM-Level-3-Events/#events-focusevent-event-order">www.w3.org/TR/DOM-Level-3-Events/#events-focusevent-event-order</a>
// Related ticket - <a
href="https://bugs.chromium.org/p/chromium/issues/detail?id=449857">bugs.chromium.org/p/chromium/issues/detail?id=449857</a>
if ( !support.focusin ) {</p>
...
<p>} var location = window.location;</p>

<p>var nonce = Date.now();</p>
...
/
     ...
     originAnchor.href = location.href;</pre>
...
<pre>var ct, type, finalDataType, firstDataType,
        contents = s.contents,
...
<p>jQuery.expr.pseudos.hidden = function( elem ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">expr</span>.<span class="ruby-identifier">pseudos</span>.<span class="ruby-identifier">visible</span>( <span class="ruby-identifier">elem</span> );
</pre>

<p>}; jQuery.expr.pseudos.visible = function( elem ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-operator">!</span>( <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">offsetWidth</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">offsetHeight</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getClientRects</span>().<span class="ruby-identifier">length</span> );
</pre>

<p>};</p>

<p>jQuery.ajaxSettings.xhr = function() {</p>
...
<p>var xhrSuccessStatus = {</p>

<pre>        // File protocol always yields status code 0, assume 200
        0: 200,
...
xhrSupported = jQuery.ajaxSettings.xhr();</pre>

<p>support.cors = !!xhrSupported &amp;&amp; ( “withCredentials” in
xhrSupported ); support.ajax = xhrSupported = !!xhrSupported;</p>

<p>jQuery.ajaxTransport( function( options ) {</p>

<pre>var callback, errorCallback;
...
<p>// Prevent auto-execution of scripts when no explicit dataType was provided
(See gh-2432) jQuery.ajaxPrefilter( function( s ) {</p>

<pre>if ( s.crossDomain ) {
...
<p>// Handle cache&#39;s special case and crossDomain jQuery.ajaxPrefilter(
“script”, function( s ) {</p>
...
<p>// Bind script tag hack transport jQuery.ajaxTransport( “script”, function(
s ) {</p>
...
<p>// Support: Safari 8 only // In Safari 8 documents created via
document.implementation.createHTMLDocument // collapse sibling forms: the
second one becomes a child of the first one. // Because of that, this
security measure has to be disabled in Safari 8. // <a
href="https://bugs.webkit.org/show_bug.cgi?id=137337">bugs.webkit.org/show_bug.cgi?id=137337</a>
support.createHTMLDocument = ( function() {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">body</span> = <span class="ruby-identifier">document</span>.<span class="ruby-identifier">implementation</span>.<span class="ruby-identifier">createHTMLDocument</span>( <span class="ruby-string">&quot;&quot;</span> ).<span class="ruby-identifier">body</span>;
<span class="ruby-identifier">body</span>.<span class="ruby-identifier">innerHTML</span> = <span class="ruby-string">&quot;&lt;form&gt;&lt;/form&gt;&lt;form&gt;&lt;/form&gt;&quot;</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">body</span>.<span class="ruby-identifier">childNodes</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">===</span> <span class="ruby-value">2</span>;
</pre>

<p>} )();</p>

<p>// Argument “data” should be string of html // context (optional): If
specified, the fragment will be created in this context, // defaults to
document // keepScripts (optional): If true, will include scripts passed in
the html string jQuery.parseHTML = function( data, context, keepScripts ) {</p>

<pre>if ( typeof data !== &quot;string&quot; ) {
        return [];
}
...
<pre>var selector, type, response,
        self = this,
        off = url.indexOf( &quot; &quot; );
...
<p>jQuery.expr.pseudos.animated = function( elem ) {</p>
...
<pre>// offset() relates an element&#39;s border box to the document origin
...
<p>// Support: Safari &lt;=7 - 9.1, Chrome &lt;=37 - 49 // Add the top/left
cssHooks using jQuery.fn.position // Webkit bug: <a
href="https://bugs.webkit.org/show_bug.cgi?id=29084">bugs.webkit.org/show_bug.cgi?id=29084</a>
// Blink bug: <a
href="https://bugs.chromium.org/p/chromium/issues/detail?id=589347">bugs.chromium.org/p/chromium/issues/detail?id=589347</a>
// getComputedStyle returns percent when specified for
top/left/bottom/right; // rather than make the css module depend on the
offset module, just check for it here jQuery.each( [ “top”, “left” ],
function( i, prop ) {</p>
...
<pre>jQuery.each( { padding: &quot;inner&quot; + name, content: type, &quot;&quot;: &quot;outer&quot; + name },
...
<p>jQuery.each( ( “blur focus focusin focusout resize scroll click dblclick ”
+</p>
...
<pre>bind: function( types, data, fn ) {
...
arguments. // jQuery.proxy is deprecated to promote standards (specifically
Function#bind) // However, it is not slated for removal any time soon
jQuery.proxy = function( fn, context ) {</p>

<pre>var tmp, args, proxy;
...
<p>jQuery.holdReady = function( hold ) {</p>
...
<p>}; jQuery.isArray = Array.isArray; jQuery.parseJSON = JSON.parse;
jQuery.nodeName = nodeName; jQuery.isFunction = isFunction; jQuery.isWindow
= isWindow; jQuery.camelCase = camelCase; jQuery.type = toType;</p>

<p>jQuery.now = Date.now;</p>

<p>jQuery.isNumeric = function( obj ) {</p>

<pre>// As of jQuery 3.0, isNumeric is limited to
...
// and CommonJS for browser emulators (#13566) if ( !noGlobal ) {</p>
