...
<title>daterangepicker-bs3.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/daterangepicker/daterangepicker-bs3.css">
...
<p>.daterangepicker.opensleft .ranges, .daterangepicker.opensleft .calendar {</p>
...
<p>.daterangepicker.opensright .ranges, .daterangepicker.opensright .calendar,
...
<p>.daterangepicker.single .ranges, .daterangepicker.single .calendar {</p>

<pre>float: none;</pre>

<p>}</p>

<p>.daterangepicker .ranges {</p>
...
<p>.daterangepicker .ranges .range_inputs&gt;div {</p>

<pre>float: left;</pre>

<p>}</p>

<p>.daterangepicker .ranges .range_inputs&gt;div:nth-child(2) {</p>

<pre>padding-left: 11px;</pre>

<p>}</p>

<p>.daterangepicker .calendar {</p>
...
<p>.daterangepicker.show-calendar .calendar {</p>

<pre>display: block;</pre>

<p>}</p>

<p>.daterangepicker .calendar.single .calendar-date {</p>

<pre>border: none;</pre>

<p>}</p>

<p>.daterangepicker .calendar th, .daterangepicker .calendar td {</p>
...
<p>.daterangepicker .daterangepicker_start_input label, .daterangepicker
.daterangepicker_end_input label {</p>
...
<p>.daterangepicker .ranges input {</p>

<pre>font-size: 11px;</pre>

<p>}</p>

<p>.daterangepicker .ranges .input-mini {</p>
...
<p>.daterangepicker .ranges li.active, .daterangepicker .ranges li:hover {</p>
...
<p>.daterangepicker .calendar-date {</p>
...
<p>.daterangepicker .calendar-time {</p>
...
<p>.daterangepicker.opensleft:before {</p>
...
<p>.daterangepicker.opensleft:after {</p>
...
<p>.daterangepicker.openscenter:before {</p>
...
<p>.daterangepicker.openscenter:after {</p>
...
<p>.daterangepicker.opensright:before {</p>
...
<p>.daterangepicker.opensright:after {</p>
...
<p>.daterangepicker.dropup{</p>

<pre>margin-top: -5px;</pre>

<p>} .daterangepicker.dropup:before{</p>

<pre>top: initial;
bottom:-7px;
border-bottom: initial;
border-top: 7px solid #ccc;</pre>

<p>} .daterangepicker.dropup:after{</p>
...
<p>.daterangepicker td, .daterangepicker th {</p>
...
<p>.daterangepicker td.off {</p>

<pre>color: #999;</pre>

<p>}</p>

<p>.daterangepicker td.disabled, .daterangepicker option.disabled {</p>

<pre>color: #999;</pre>

<p>}</p>

<p>.daterangepicker td.available:hover, .daterangepicker th.available:hover {</p>

<pre>background: #eee;</pre>

<p>}</p>

<p>.daterangepicker td.in-range {</p>

<pre>background: #ebf4f8;
...
<p>.daterangepicker td.start-date {</p>

<pre>-webkit-border-radius: 4px 0 0 4px;
-moz-border-radius: 4px 0 0 4px;
border-radius: 4px 0 0 4px;</pre>

<p>}</p>

<p>.daterangepicker td.end-date {</p>

<pre>-webkit-border-radius: 0 4px 4px 0;
-moz-border-radius: 0 4px 4px 0;
border-radius: 0 4px 4px 0;</pre>

<p>}</p>

<p>.daterangepicker td.start-date.end-date {</p>
...
<p>.daterangepicker td.active, .daterangepicker td.active:hover {</p>

<pre>background-color: #357ebd;
border-color: #3071a9;
color: #fff;</pre>

<p>}</p>

<p>.daterangepicker td.week, .daterangepicker th.week {</p>
...
<p>.daterangepicker select.monthselect, .daterangepicker select.yearselect {</p>
...
<p>.daterangepicker select.monthselect {</p>
...
<p>.daterangepicker select.yearselect {</p>

<pre>width: 40%;</pre>

<p>}</p>

<p>.daterangepicker select.hourselect, .daterangepicker select.minuteselect,
.daterangepicker select.secondselect, .daterangepicker select.ampmselect {</p>
...
<p>.daterangepicker_start_input {</p>

<pre>float: left;</pre>

<p>}</p>

<p>.daterangepicker_end_input {</p>

<pre>float: left; 
padding-left: 11px</pre>

<p>}</p>

<p>.daterangepicker th.month {</p>
