...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/chart.js/docs/charts/bar.html">
...
&lt;td&gt;Manually set width of each bar in pixels. If not set, the base
sample widths are calculated automatically so that they take the full
available widths without overlap. Then, the bars are sized using
<code>barPercentage</code> and <code>categoryPercentage</code>.&lt;/td&gt;
...
middle of the bars. This is set to true for a bar chart while false for
other charts by default.&lt;/p&gt; &lt;p&gt;This setting applies to the
axis configuration. If axes are added to the chart, this setting will need
to be set for each new axis.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;options = {</p>
