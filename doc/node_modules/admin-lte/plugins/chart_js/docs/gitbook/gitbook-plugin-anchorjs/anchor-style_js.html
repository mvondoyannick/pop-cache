...
<title>anchor-style.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/chart.js/docs/gitbook/gitbook-plugin-anchorjs/anchor-style.js">

<p>gitbook.events.bind(&#39;start&#39;, function(e, config) {</p>

<pre class="ruby"><span class="ruby-identifier">anchors</span>.<span class="ruby-identifier">options</span> = <span class="ruby-identifier">config</span>.<span class="ruby-identifier">anchorjs</span> <span class="ruby-operator">||</span> {};
</pre>

<p>});</p>

<p>gitbook.events.bind(&#39;page.change&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">anchors</span>.<span class="ruby-identifier">add</span>(<span class="ruby-identifier">anchors</span>.<span class="ruby-identifier">options</span>.<span class="ruby-identifier">selector</span> <span class="ruby-operator">||</span> <span class="ruby-string">&#39;h2,h3,h4,h5&#39;</span>);
</pre>
