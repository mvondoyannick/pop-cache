...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/chart.js/docs/search_plus_index.json">
...
href="../../datatables/extensions/ColReorder/License_txt.html">License</a>
...
and possible version compatability issues.
...
ES6 Modules import Chart from &#39;chart.js&#39;; var myChart = new
Chart(ctx, {…}); Script Tag var myChart = new Chart(ctx, {…}); Common JS
var Chart = require(&#39;chart.js&#39;); var myChart = new Chart(ctx, {…});
Require JS <a href="'path/to/chartjs/dist/Chart.js'">require(</a>,
function(Chart){ var myChart = new Chart(ctx, {…}); }); Important:
RequireJS can not load CommonJS module as is, so be sure to require one of
the built UMD files instead (i.e. dist/Chart.js, dist/Chart.min.js, etc.).
...
onResize Function null Called when a resize occurs. Gets passed two
arguments: the chart instance and the new size. Important Note Detecting
when the canvas size changes can not be done directly from the CANVAS
element. Chart.js uses its parent container to update the canvas render and
display sizes. However, this method requires the container to be relatively
positioned and dedicated to the chart canvas only. Responsiveness can then
be achieved by setting relative values for the container size (example):
The chart can also be programmatically resized by modifying the container
size: chart.canvas.parentNode.style.height = &#39;128px&#39;; Printing
Resizeable Charts CSS media queries allow changing styles when printing a
page. The CSS applied from these media queries may cause charts to need to
resize. However, the resize won&#39;t happen automatically. To support
resizing charts when printing, one needs to hook the onbeforeprint event
and manually trigger resizing of each chart. function beforePrintHandler ()
{ for (var id in Chart.instances) { <a
href="id">Chart.instances</a>.resize() } }
...
or <a href="../../../../../Object.html">Object</a> 0 The padding to add
inside the chart. more… Padding If this value is a number, it is applied to
all sides of the chart (left, top, right, bottom). If this value is an
object, the left property defines the left padding. Similarly the right,
top, and bottom properties can also be specified. Lets say you wanted to
add 50px of padding to the left side of the chart canvas, you would do: let
chart = new Chart(ctx, { type: &#39;line&#39;, data: data, options: {
...
Configuration The chart legend displays data about the datasets that area
...
tooltipModel.caretX + &#39;px&#39;; tooltipEl.style.top = position.top +
...
&#39;px&#39;; } } } }); See samples for examples on how to get started with
custom tooltips. Tooltip Model The tooltip model contains parameters that
can be used to render the tooltip. { // The items that we are rendering in
the tooltip. See Tooltip Item Interface section dataPoints: TooltipItem[],
// Positioning xPadding: Number, yPadding: Number, xAlign: String, yAlign:
String, // X and Y properties are the top left of the tooltip x: Number, y:
Number, width: Number, height: Number, // Where the tooltip points to
caretX: Number, caretY: Number, // Body // The body lines that need to be
rendered // Each object contains 3 parameters // before: String[] // lines
of text before the line with the color square // lines: String[], // lines
of text to render as the main item with color square // after: String[], //
lines of text to render after the main lines body: Object[], // lines of
text that appear after the title but before the body beforeBody: String[],
// line of text that appear after the body and before the footer afterBody:
String[], bodyFontColor: Color, _bodyFontFamily: String, _bodyFontStyle:
String, _bodyAlign: String, bodyFontSize: Number, bodySpacing: Number, //
Title // lines of text that form the title title: String[], titleFontColor:
Color, _titleFontFamily: String, _titleFontStyle: String, titleFontSize:
Number, _titleAlign: String, titleSpacing: Number, titleMarginBottom:
Number, // Footer // lines of text that form the footer footer: String[],
...
Number 3 Point radius. pointStyle String circle Point style.
backgroundColor Color &#39;rgba(0,0,0,0.1)&#39; Point fill color.
borderWidth Number 1 Point stroke width. borderColor Color
&#39;rgba(0,0,0,0.1)&#39; Point stroke color. hitRadius Number 1 Extra
radius added to point radius for hit detection. hoverRadius Number 4 Point
radius when hovered. hoverBorderWidth Number 1 Stroke width when hovered.
Point Styles The following values are supported: &#39;circle&#39;
&#39;cross&#39; &#39;crossRot&#39; &#39;dash&#39; &#39;line&#39;
&#39;rect&#39; &#39;rectRounded&#39; &#39;rectRot&#39; &#39;star&#39;
&#39;triangle&#39; If the value is an image, that image is drawn on the
canvas using drawImage. Line Configuration Line elements are used to
represent the line in a line chart. Global line options:
Chart.defaults.global.elements.line Name Type Default Description tension
Number 0.4 Bézier curve tension (0 for no Bézier curves). backgroundColor
Color &#39;rgba(0,0,0,0.1)&#39; Line fill color. borderWidth Number 3 Line
stroke width. borderColor Color &#39;rgba(0,0,0,0.1)&#39; Line stroke
color. borderCapStyle String &#39;butt&#39; Line cap style (see MDN).
borderDash Array [] Line dash (see MDN). borderDashOffset Number 0 Line
dash offset (see MDN). borderJoinStyle String &#39;miter Line join style
(see MDN). capBezierPoints Boolean true true to keep Bézier control inside
the chart, false for no restriction. fill Boolean/String true Fill
location: &#39;zero&#39;, &#39;top&#39;, &#39;bottom&#39;, true (eq.
&#39;zero&#39;) or false (no fill). stepped Boolean false true to show the
line as a stepped line (tension will be ignored). Rectangle Configuration
Rectangle elements are used to represent the bars in a bar chart. Global
rectangle options: Chart.defaults.global.elements.rectangle Name Type
Default Description backgroundColor Color &#39;rgba(0,0,0,0.1)&#39; Bar
fill color. borderWidth Number 0 Bar stroke width. borderColor Color
&#39;rgba(0,0,0,0.1)&#39; Bar stroke color. borderSkipped String
&#39;bottom&#39; Skipped (excluded) border: &#39;bottom&#39;,
&#39;left&#39;, &#39;top&#39; or &#39;right&#39;. Arc Configuration Arcs
are used in the polar area, doughnut and pie charts. Global arc options:
Chart.defaults.global.elements.arc. Name Type Default Description
backgroundColor Color &#39;rgba(0,0,0,0.1)&#39; Arc fill color. borderColor
Color &#39;#fff&#39; Arc stroke color. borderWidth Number 2 Arc stroke
width.
”},“charts/”:{“url”:“charts/”,“title”:“Charts”,“keywords”:“”,“body”:“Charts
Chart.js comes with built-in chart types: line bar radar polar area
doughnut and pie bubble Area charts can be built from a line or radar chart
using the dataset fill option. To create a new chart type, see the
developer notes
...
category should be within the sample width. more… barThickness Number
Manually set width of each bar in pixels. If not set, the base sample
widths are calculated automatically so that they take the full available
widths without overlap. Then, the bars are sized using barPercentage and
categoryPercentage. maxBarThickness Number Set this to ensure that bars are
not sized thicker than this. gridLines.offsetGridLines Boolean true If
true, the bars for a particular data point fall between the grid lines. The
grid line will move to the left by one half of the tick interval. If false,
the grid line will go right down the middle of the bars. more…
offsetGridLines If true, the bars for a particular data point fall between
the grid lines. The grid line will move to the left by one half of the tick
interval, which is the space between the grid lines. If false, the grid
line will go right down the middle of the bars. This is set to true for a
bar chart while false for other charts by default. This setting applies to
the axis configuration. If axes are added to the chart, this setting will
need to be set for each new axis. options = { scales: { xAxes: [{
gridLines: { offsetGridLines: true } }] } } Default Options It is common to
want to apply a configuration setting to all created bar charts. The global
bar chart settings are stored in Chart.defaults.bar. Changing the global
options only affects charts created after the change. Existing charts are
not changed. barPercentage vs categoryPercentage The following shows the
relationship between the bar percentage option and the category percentage
option. // categoryPercentage: 1.0 // barPercentage: 1.0 Bar: | 1.0 | 1.0 |
Category: | 1.0 | Sample: |===========| // categoryPercentage: 1.0 //
barPercentage: 0.5 Bar: |.5| |.5| Category: | 1.0 | Sample:
...
point is not rendered. pointStyle <a
href="">String/String[]/Image/Image</a> Style of the point. more…
pointHitRadius Number/Number[] The pixel size of the non-displayed point
that reacts to mouse events. pointHoverBackgroundColor Color/Color[] Point
background color when hovered. pointHoverBorderColor Color/Color[] Point
border color when hovered. pointHoverBorderWidth Number/Number[] Border
width of point when hovered. pointHoverRadius Number/Number[] The radius of
the point when hovered. pointStyle The style of point. Options are:
&#39;circle&#39; &#39;cross&#39; &#39;crossRot&#39; &#39;dash&#39;.
&#39;line&#39; &#39;rect&#39; &#39;rectRounded&#39; &#39;rectRot&#39;
&#39;star&#39; &#39;triangle&#39; If the option is an image, that image is
drawn on the canvas using drawImage. Configuration Options Unlike other
charts, the radar chart has no chart specific options. Scale Options The
radar chart supports only a single scale. The options for this scale are
defined in the scale property. options = { scale: { // Hides the scale
display: false } }; Default Options It is common to want to apply a
configuration setting to all created radar charts. The global radar chart
settings are stored in Chart.defaults.radar. Changing the global options
only affects charts created after the change. Existing charts are not
changed. Data Structure The data property of a dataset for a radar chart is
specified as a an array of numbers. Each point in the data array
corresponds to the label at the same index on the x axis. data: [20, 10]
For a radar chart, to provide context of what each point means, we include
an array of strings that show around each point in the chart. data: {
labels: [&#39;Running&#39;, &#39;Swimming&#39;, &#39;Eating&#39;,
&#39;Cycling&#39;], datasets: [{ data: [20, 10, 4, 2] }] }
...
pointStyle String Yes Yes circle radius Number Yes Yes 3 Labeling label
defines the text associated to the dataset and which appears in the legend
and tooltips. Styling The style of each bubble can be controlled with the
following properties: Name Description backgroundColor bubble background
color borderColor bubble border color borderWidth bubble border width (in
pixels) pointStyle bubble shape style radius bubble radius (in pixels) All
...
callbacks <a href="../../../../../Object.html">Object</a> Callback
functions to hook into the axis lifecycle. more… weight Number 0 The weight
used to sort the axis. Higher weights are further away from the chart area.
...
the axis is scaled to fit into the chart area. This is set to true in the
bar chart by default. id String The ID is used to link datasets and scale
axes together. more… gridLines <a
...
Number <a href="../../../../../User.html">User</a> defined maximum number
for the scale, overrides maximum value from data. more… maxTicksLimit
Number 11 Maximum number of ticks and gridlines to show. stepSize Number <a
...
calculating the minimum data value. more… Axis Range Settings Given the
number of axis range settings, it is important to understand how they all
interact with each other. The suggestedMax and suggestedMin settings only
change the data values that are used to scale the axis. These are useful
for extending the range of the axis while maintaining the auto fit
...
chart = new Chart(ctx, { type: &#39;line&#39;, data: { datasets: [{ label:
&#39;First dataset&#39;, data: [0, 20, 40, 50] }], labels:
[&#39;January&#39;, &#39;February&#39;, &#39;March&#39;, &#39;April&#39;]
}, options: { scales: { yAxes: [{ ticks: { suggestedMin: 50, suggestedMax:
100 } }] } } }); In contrast to the suggested* settings, the min and max
settings set explicit ends to the axes. When these are set, some data
points may not be visible. Step Size If set, the scale ticks will be
enumerated by multiple of stepSize, having one tick per increment. If not
set, the ticks are labeled automatically using the nice numbers algorithm.
This example sets up a chart with a y axis that creates ticks at 0, 0.5, 1,
1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5. let options = { scales: { yAxes: [{ ticks:
{ max: 5, min: 0, stepSize: 0.5 } }] } };
...
href="../../../../../User.html">User</a> defined minimum number for the
scale, overrides minimum value from data. max Number <a
href="../../../../../User.html">User</a> defined maximum number for the
scale, overrides maximum value from data.
...
points may additionally be specified via the t attribute when using the
time scale. data: [{ x: new Date(), y: 1 }, { t: new Date(), y: 10 }] Date
Formats When providing data for the time scale, Chart.js supports all of
the formats that Moment.js accepts. See Moment.js docs for details.
...
href="../../../../../Object.html">Object</a> Sets how different time units
are displayed. more… time.isoWeekday Boolean false If true and the unit is
set to &#39;week&#39;, then the first day of the week will be Monday.
...
Display Formats The following display formats are used to configure how
different time units are formed into strings for the axis tick marks. See
moment.js for the allowable format strings. Name Default Example
millisecond &#39;h:mm:ss.SSS a&#39; 11:20:01.123 AM second &#39;h:mm:ss
a&#39; 11:20:01 AM minute &#39;h:mm a&#39; 11:20 AM hour &#39;hA&#39; 11AM
day &#39;MMM D&#39; Sep 4 week &#39;ll&#39; Sep 4 2015 month &#39;MMM
YYYY&#39; Sep 2015 quarter &#39;[Q]Q - YYYY&#39; Q3 - 2015 year
&#39;YYYY&#39; 2015 For example, to set the display format for the
...
href="../../../../../Object.html">Object</a> Angle line configuration.
more… gridLines <a href="../../../../../Object.html">Object</a> Grid line
configuration. more… pointLabels <a
href="../../../../../Object.html">Object</a> Point label configuration.
more… ticks <a href="../../../../../Object.html">Object</a> Tick
configuration. more… Tick Options The following options are provided by the
linear scale. They are all located in the ticks sub options. The common
tick configuration options are supported by this axis. Name Type Default
...
more… max Number <a href="../../../../../User.html">User</a> defined
maximum number for the scale, overrides maximum value from data. more…
maxTicksLimit Number 11 Maximum number of ticks and gridlines to show.
stepSize Number <a href="../../../../../User.html">User</a> defined fixed
step size for the scale. more… suggestedMax Number Adjustment used when
calculating the maximum data value. more… suggestedMin Number Adjustment
used when calculating the minimum data value. more… showLabelBackdrop
Boolean true If true, draw a background behind the tick labels Axis Range
...
setting, it is ignored. let chart = new Chart(ctx, { type: &#39;radar&#39;,
data: { datasets: [{ label: &#39;First dataset&#39;, data: [0, 20, 40, 50]
}], labels: [&#39;January&#39;, &#39;February&#39;, &#39;March&#39;,
&#39;April&#39;] }, options: { scale: { ticks: { suggestedMin: 50,
suggestedMax: 100 } } } }); In contrast to the suggested* settings, the min
and max settings set explicit ends to the axes. When these are set, some
data points may not be visible. Step Size If set, the scale ticks will be
enumerated by multiple of stepSize, having one tick per increment. If not
set, the ticks are labeled automatically using the nice numbers algorithm.
This example sets up a chart with a y axis that creates ticks at 0, 0.5, 1,
1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5. let options = { scales: { yAxes: [{ ticks:
{ max: 5, min: 0, stepSize: 0.5 } }] } }; Angle Line Options The following
options are used to configure angled lines that radiate from the center of
the chart to the point labels. They can be found in the angleLines sub
options. Note that these options only apply if angleLines.display is true.
Name Type Default Description display Boolean true if true, angle lines are
shown color Color rgba(0, 0, 0, 0.1) Color of angled lines lineWidth Number
1 Width of angled lines Point Label Options The following options are used
to configure the point labels that are shown on the perimeter of the scale.
They can be found in the pointLabels sub options. Note that these options
only apply if pointLabels.display is true. Name Type Default Description
callback Function Callback function to transform data labels to point
labels. The default implementation simply returns the current string.
fontColor Color/Color[] &#39;#666&#39; Font color for point labels.
fontFamily String "&#39;Helvetica Neue&#39;, &#39;Helvetica&#39;,
&#39;Arial&#39;, sans-serif&quot; Font family to use when rendering labels.
fontSize Number 10 font size in pixels fontStyle String &#39;normal&#39;
...
grid lines for this axis. color Color/Color[] &#39;rgba(0, 0, 0, 0.1)&#39;
The color of the grid lines. If specified as an array, the first color
applies to the first grid line, the second to the second grid line and so
on. borderDash Number[] [] Length and spacing of dashes on grid lines. See
MDN borderDashOffset Number 0 Offset for line dashes. See MDN lineWidth
Number/Number[] 1 Stroke width of grid lines. drawBorder Boolean true If
...
between labels. This is set to true in the bar chart by default. Tick
Configuration The tick configuration is nested under the scale
configuration in the ticks key. It defines options for the tick marks that
are generated by the axis. Name Type Default Description callback Function
Returns the string representation of the tick value as it should be
displayed on the chart. See callback. display Boolean true If true, show
...
gulp docs // build the documentation in ./dist/docs More information can be
found in gulpfile.js. Bugs and Issues Please report these on the GitHub
page - at github.com/chartjs/Chart.js. Please do not use issues for support
requests. For help using Chart.js, please take a look at the chartjs tag on
Stack Overflow. Well structured, detailed bug reports are hugely valuable
for the project. Guidelines for reporting bugs: Check the issue search to
see if it has already been reported Isolate the problem to a simple test
case Please include a demonstration of the bug on a website such as JS Bin,
JS Fiddle, or Codepen. (Template) Please provide any additional details
associated with the bug, if it&#39;s browser or screen density specific, or
only happens with a certain configuration or data.
...
bar chart. chartjs-plugin-waterfall - Enables easy use of waterfall charts.
...
vue-chartjs Java Chart.java GWT (Google Web toolkit) Charba Ember.js
ember-cli-chart
