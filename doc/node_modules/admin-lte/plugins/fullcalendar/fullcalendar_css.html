...
<title>fullcalendar.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/fullcalendar/fullcalendar.css">
...
<p>body .fc {    extra precedence to overcome jqui</p>
...
<p>.fc-unthemed th, .fc-unthemed td, .fc-unthemed hr, .fc-unthemed thead,
.fc-unthemed tbody, .fc-unthemed .fc-row, .fc-unthemed .fc-popover {</p>

<pre>border-color: #ddd;</pre>

<p>}</p>

<p>.fc-unthemed .fc-popover {</p>

<pre>background-color: #fff;</pre>

<p>}</p>

<p>.fc-unthemed hr, .fc-unthemed .fc-popover .fc-header {</p>

<pre>background: #eee;</pre>

<p>}</p>

<p>.fc-unthemed .fc-popover .fc-header .fc-close {</p>

<pre>color: #666;</pre>

<p>}</p>

<p>.fc-unthemed .fc-today {</p>

<pre>background: #fcf8e3;</pre>

<p>}</p>

<p>.fc-highlight { /* when user is selecting cells */</p>

<pre>background: #bce8f1;
opacity: .3;
filter: alpha(opacity=30); /* for IE */</pre>

<p>}</p>

<p>.fc-bgevent { /* default look for background events */</p>

<pre>background: rgb(143, 223, 130);
opacity: .3;
filter: alpha(opacity=30); /* for IE */</pre>

<p>}</p>

<p>.fc-nonbusiness { /* default look for non-business-hours areas */</p>

<pre>/* will inherit .fc-bgevent&#39;s styles */
background: #ccc;</pre>

<p>}</p>

<p>/* Icons (inline elements with styled text that mock arrow icons)
————————————————————————————————–*/</p>
...
<p>.fc-icon-left-single-arrow:after {</p>
...
<p>.fc-icon-right-single-arrow:after {</p>
...
<p>.fc-icon-left-double-arrow:after {</p>

<pre>content: &quot;\000AB&quot;;</pre>

<p>}</p>

<p>.fc-icon-right-double-arrow:after {</p>

<pre>content: &quot;\000BB&quot;;</pre>

<p>}</p>

<p>.fc-icon-x:after {</p>

<pre>content: &quot;\000D7&quot;;</pre>

<p>}</p>

<p>/* Buttons (styled &lt;button&gt; tags, normalized to work cross-browser)
————————————————————————————————–*/</p>

<p>.fc button {</p>

<pre>/* force height to include the border and padding */
...
<p>/* Firefox has an annoying inner border */ .fc button::-moz-focus-inner {
margin: 0; padding: 0; }</p>

<p>.fc-state-default { /* non-theme */</p>

<pre>border: 1px solid;</pre>

<p>}</p>

<p>.fc-state-default.fc-corner-left { /* non-theme */</p>
...
<p>.fc-state-default.fc-corner-right { /* non-theme */</p>
...
<p>/* icons in buttons */</p>

<p>.fc button .fc-icon { /* non-theme */</p>
...
box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 1px 2px rgba(0, 0, 0, 0.05);</pre>

<p>}</p>

<p>.fc-state-hover, .fc-state-down, .fc-state-active, .fc-state-disabled {</p>

<pre>color: #333333;
background-color: #e6e6e6;</pre>
...
-webkit-transition: background-position 0.1s linear;
   -moz-transition: background-position 0.1s linear;
     -o-transition: background-position 0.1s linear;
        transition: background-position 0.1s linear;</pre>

<p>}</p>

<p>.fc-state-down, .fc-state-active {</p>

<pre>background-color: #cccccc;
background-image: none;
box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.15), 0 1px 2px rgba(0, 0, 0, 0.05);</pre>

<p>}</p>

<p>.fc-state-disabled {</p>
...
<p>/* every button that is not first in a button group should scootch over one
pixel and cover the previous button&#39;s border…</p>

<pre>/</pre>

<p>.fc .fc-button-group &gt; * { /* extra precedence b/c buttons have margin
set to zero */</p>

<pre>float: left;
margin: 0 0 0 -1px;</pre>

<p>}</p>

<p>.fc .fc-button-group &gt; :first-child { /* same */</p>
...
box-shadow: 0 2px 6px rgba(0,0,0,.15);</pre>

<p>}</p>

<p>.fc-popover .fc-header {</p>

<pre>padding: 2px 4px;</pre>

<p>}</p>

<p>.fc-popover .fc-header .fc-title {</p>

<pre>margin: 0 2px;</pre>

<p>}</p>

<p>.fc-popover .fc-header .fc-close {</p>

<pre>cursor: pointer;</pre>

<p>}</p>

<p>.fc-ltr .fc-popover .fc-header .fc-title, .fc-rtl .fc-popover .fc-header
.fc-close {</p>
...
<p>.fc-rtl .fc-popover .fc-header .fc-title, .fc-ltr .fc-popover .fc-header
.fc-close {</p>
...
<p>.fc-popover &gt; .ui-widget-header + .ui-widget-content {</p>

<pre>border-top: 0; /* where they meet, let the header have the border */</pre>

<p>}</p>

<p>/* Misc Reusable Components ————————————————————————————————–*/</p>
...
<p>.fc-bg, .fc-bgevent-skeleton, .fc-highlight-skeleton, .fc-helper-skeleton {</p>

<pre>/* these element should always cling to top-left/right corners */
position: absolute;
top: 0;
left: 0;
right: 0;</pre>
...
<pre>bottom: 0; /* strech bg to bottom edge */</pre>

<p>}</p>

<p>.fc-bg table {</p>

<pre>height: 100%; /* strech bg to bottom edge */</pre>
...
border-spacing: 0;
font-size: 1em; /* normalize cross-browser */</pre>
...
<pre>border-style: double; /* overcome neighboring borders */</pre>

<p>}</p>

<p>/* Fake Table Rows ————————————————————————————————–*/</p>

<p>.fc .fc-row { /* extra precedence to overcome themes w/ .ui-widget-content
forcing a 1px border */</p>

<pre>/* no visible border by default. but make available if need be (scrollbar width compensation) */
border-style: solid;
border-width: 0;</pre>
...
<pre>/* don&#39;t put left/right border on anything within a fake row.
   the outer tbody will worry about this */
border-left: 0 hidden transparent;
border-right: 0 hidden transparent;

/* no bottom borders on rows */
border-bottom: 0 hidden transparent;</pre>

<p>}</p>

<p>.fc-row:first-child table {</p>

<pre>border-top: 0 hidden transparent; /* no top border on first row */</pre>

<p>}</p>

<p>/* Day Row (used within the header and the DayGrid)
————————————————————————————————–*/</p>
...
<p>/* highlighting cells &amp; background event skeleton */</p>

<p>.fc-row .fc-bgevent-skeleton, .fc-row .fc-highlight-skeleton {</p>

<pre>bottom: 0; /* stretch skeleton to bottom of row */</pre>

<p>}</p>

<p>.fc-row .fc-bgevent-skeleton table, .fc-row .fc-highlight-skeleton table {</p>

<pre>height: 100%; /* stretch skeleton to bottom of row */</pre>

<p>}</p>

<p>.fc-row .fc-highlight-skeleton td, .fc-row .fc-bgevent-skeleton td {</p>

<pre>border-color: transparent;</pre>

<p>}</p>

<p>.fc-row .fc-bgevent-skeleton {</p>

<pre>z-index: 2;</pre>

<p>}</p>

<p>.fc-row .fc-highlight-skeleton {</p>

<pre>z-index: 3;</pre>

<p>}</p>

<p>/* row content (which contains day/week numbers and events) as well as
“helper” (which contains temporary rendered events).</p>

<pre>/</pre>

<p>.fc-row .fc-content-skeleton {</p>

<pre>position: relative;
z-index: 4;
padding-bottom: 2px; /* matches the space above the events */</pre>

<p>}</p>

<p>.fc-row .fc-helper-skeleton {</p>

<pre>z-index: 5;</pre>

<p>}</p>

<p>.fc-row .fc-content-skeleton td, .fc-row .fc-helper-skeleton td {</p>

<pre>/* see-through to the background below */
...
<p>.fc-row .fc-content-skeleton tbody td, /* cells with events inside (so NOT
the day number cell) */ .fc-row .fc-helper-skeleton tbody td {</p>

<pre>/* don&#39;t put a border between event cells */
border-top: 0;</pre>

<p>}</p>

<p>/* Scrolling Container ————————————————————————————————–*/</p>

<p>.fc-scroller { /* this class goes on elements for guaranteed vertical
scrollbars */</p>
...
<p>.fc-scroller &gt; * { /* we expect an immediate inner element */</p>

<pre>position: relative; /* re-scope all positions */
width: 100%; /* hack to force re-sizing this inner element when scrollbars appear/disappear */
overflow: hidden; /* don&#39;t let negative margins or absolute positioning create further scroll */</pre>

<p>}</p>

<p>/* Global Event Styles ————————————————————————————————–*/</p>

<p>.fc-event {</p>

<pre>position: relative; /* for resize handle and other inner positioning */
...
font-weight: normal; /* undo jqui&#39;s ui-widget-header bold */</pre>

<p>}</p>

<p>/* overpower some of bootstrap&#39;s and jqui&#39;s styles on &lt;a&gt;
tags */ .fc-event, .fc-event:hover, .ui-widget .fc-event {</p>

<pre>color: #fff; /* default TEXT color */
text-decoration: none; /* if &lt;a&gt; has an href */</pre>

<p>}</p>

<p>.<a href="href">fc-event</a>, .fc-event.fc-draggable {</p>

<pre>cursor: pointer; /* give events with links and draggable events a hand mouse pointer */</pre>

<p>}</p>

<p>.fc-not-allowed, /* causes a “warning” cursor. applied on body */
.fc-not-allowed .fc-event { /* to override an event&#39;s custom cursor */</p>
...
<p>We use the full “fc-day-grid-event” class instead of using descendants
because the event won&#39;t be a descendant of the grid when it is being
dragged.</p>

<pre>/</pre>

<p>.fc-day-grid-event {</p>

<pre>margin: 1px 2px 0; /* spacing between events and edges */
padding: 0 1px;</pre>

<p>}</p>

<p>/* events that are continuing to/from another week. kill rounded corners
and butt up against edge */</p>

<p>.fc-ltr .fc-day-grid-event.fc-not-start, .fc-rtl
.fc-day-grid-event.fc-not-end {</p>
...
<p>.fc-ltr .fc-day-grid-event.fc-not-end, .fc-rtl
.fc-day-grid-event.fc-not-start {</p>
...
<p>.fc-day-grid-event &gt; .fc-content { /* force events to be one-line tall
*/</p>
...
<p>.fc-day-grid-event .fc-time {</p>

<pre>font-weight: bold;</pre>

<p>}</p>

<p>/* resize handle (outside of fc-content, so can go outside of bounds) */</p>

<p>.fc-day-grid-event .fc-resizer {</p>
...
<p>.fc-ltr .fc-day-grid-event .fc-resizer {</p>
...
<p>.fc-rtl .fc-day-grid-event .fc-resizer {</p>
...
<p>/* “more” link that represents hidden events */</p>
...
<p>.fc-limited { /* rows and cells that are hidden because of a “more” link */</p>

<pre>display: none;</pre>

<p>}</p>

<p>/* popover that appears when “more” link is clicked */</p>

<p>.fc-day-grid .fc-row {</p>

<pre>z-index: 1; /* make the &quot;more&quot; popover one higher than this */</pre>
...
<p>.fc-more-popover .fc-event-container {</p>
...
margin-bottom: 1em;</pre>

<p>}</p>

<p>.fc-toolbar .fc-left {</p>

<pre>float: left;</pre>

<p>}</p>

<p>.fc-toolbar .fc-right {</p>

<pre>float: right;</pre>

<p>}</p>

<p>.fc-toolbar .fc-center {</p>

<pre>display: inline-block;</pre>

<p>}</p>

<p>/* the things within each left/right/center section */ .fc .fc-toolbar &gt;
* &gt; * { /* extra precedence to override button border margins */</p>

<pre>float: left;
margin-left: .75em;</pre>

<p>}</p>

<p>/* the first thing within each left/center/right section */ .fc .fc-toolbar
&gt; * &gt; :first-child { /* extra precedence to override button border
margins */</p>
...
<p>/* button layering (for border precedence) */</p>

<p>.fc-toolbar button {</p>

<pre>position: relative;</pre>

<p>}</p>

<p>.fc-toolbar .fc-state-hover, .fc-toolbar .ui-state-hover {</p>

<pre>z-index: 2;</pre>

<p>}</p>

<p>.fc-toolbar .fc-state-down {</p>

<pre>z-index: 3;</pre>

<p>}</p>

<p>.fc-toolbar .fc-state-active, .fc-toolbar .ui-state-active {</p>

<pre>z-index: 4;</pre>

<p>}</p>

<p>.fc-toolbar button:focus {</p>
...
<p>/* undo twitter bootstrap&#39;s box-sizing rules. normalizes positioning
techniques */ /* don&#39;t do this for the toolbar because we&#39;ll want
bootstrap to style those buttons as some pt */ .fc-view-container *,
.fc-view-container *:before, .fc-view-container *:after {</p>
...
<p>.fc-view, /* scope positioning and z-index&#39;s for everything within the
view */ .fc-view &gt; table { /* so dragged elements can be above the
view&#39;s main element */</p>
...
<p>/* day row structure */</p>

<p>.fc-basicWeek-view .fc-content-skeleton, .fc-basicDay-view
.fc-content-skeleton {</p>

<pre>/* we are sure there are no day numbers in these views, so... */
padding-top: 1px; /* add a pixel to make sure there are 2px padding above events */
padding-bottom: 1em; /* ensure a space at bottom of cell for user selecting/clicking */</pre>

<p>}</p>

<p>.fc-basic-view tbody .fc-row {</p>

<pre>min-height: 4em; /* ensure that all rows are at least this tall */</pre>

<p>}</p>

<p>/* a “rigid” row will take up a constant amount of height because
content-skeleton is absolute */</p>
...
<p>.fc-row.fc-rigid .fc-content-skeleton {</p>
...
<p>/* week and day number styling */</p>

<p>.fc-basic-view .fc-week-number, .fc-basic-view .fc-day-number {</p>

<pre>padding: 0 2px;</pre>

<p>}</p>

<p>.fc-basic-view td.fc-week-number span, .fc-basic-view td.fc-day-number {</p>
...
<p>.fc-basic-view .fc-week-number {</p>

<pre>text-align: center;</pre>

<p>}</p>

<p>.fc-basic-view .fc-week-number span {</p>

<pre>/* work around the way we do column resizing and ensure a minimum width */
display: inline-block;
min-width: 1.25em;</pre>

<p>}</p>

<p>.fc-ltr .fc-basic-view .fc-day-number {</p>

<pre>text-align: right;</pre>

<p>}</p>

<p>.fc-rtl .fc-basic-view .fc-day-number {</p>

<pre>text-align: left;</pre>

<p>}</p>

<p>.fc-day-number.fc-other-month {</p>

<pre>opacity: 0.3;
filter: alpha(opacity=30); /* for IE */
/* opacity with small font can sometimes look too faded
   might want to set the &#39;color&#39; property instead
   making day-numbers bold also fixes the problem */</pre>

<p>}</p>

<p>/* AgendaView all-day area ————————————————————————————————–*/</p>

<p>.fc-agenda-view .fc-day-grid {</p>

<pre>position: relative;
z-index: 2; /* so the &quot;more..&quot; popover will be over the time grid */</pre>

<p>}</p>

<p>.fc-agenda-view .fc-day-grid .fc-row {</p>

<pre>min-height: 3em; /* all-day section will never get shorter than this */</pre>

<p>}</p>

<p>.fc-agenda-view .fc-day-grid .fc-row .fc-content-skeleton {</p>

<pre>padding-top: 1px; /* add a pixel to make sure there are 2px padding above events */
padding-bottom: 1em; /* give space underneath events for clicking/selecting days */</pre>

<p>}</p>

<p>/* TimeGrid axis running down the side (for both the all-day area and the
slot area) ————————————————————————————————–*/</p>

<p>.fc .fc-axis { /* .fc to overcome default cell styles */</p>
...
<p>.ui-widget td.fc-axis {</p>

<pre>font-weight: normal; /* overcome jqui theme making it bold */</pre>

<p>}</p>

<p>/* TimeGrid Structure ————————————————————————————————–*/</p>

<p>.fc-time-grid-container, /* so scroll container&#39;s z-index is below
all-day */ .fc-time-grid { /* so slats/bg/content/etc positions get scoped
within here */</p>
...
<pre>min-height: 100%; /* so if height setting is &#39;auto&#39;, .fc-bg stretches to fill height */</pre>

<p>}</p>

<p>.fc-time-grid table { /* don&#39;t put outer borders on
slats/bg/content/etc */</p>

<pre>border: 0 hidden transparent;</pre>

<p>}</p>

<p>.fc-time-grid &gt; .fc-bg {</p>

<pre>z-index: 1;</pre>

<p>}</p>

<p>.fc-time-grid .fc-slats, .fc-time-grid &gt; hr { /* the &lt;hr&gt;
AgendaView injects when grid is shorter than scroller */</p>
...
<p>.fc-time-grid .fc-bgevent-skeleton, .fc-time-grid .fc-content-skeleton {</p>
...
<p>.fc-time-grid .fc-bgevent-skeleton {</p>

<pre>z-index: 3;</pre>

<p>}</p>

<p>.fc-time-grid .fc-highlight-skeleton {</p>

<pre>z-index: 4;</pre>

<p>}</p>

<p>.fc-time-grid .fc-content-skeleton {</p>

<pre>z-index: 5;</pre>

<p>}</p>

<p>.fc-time-grid .fc-helper-skeleton {</p>

<pre>z-index: 6;</pre>

<p>}</p>

<p>/* TimeGrid Slats (lines that run horizontally)
————————————————————————————————–*/</p>

<p>.fc-slats td {</p>

<pre>height: 1.5em;
border-bottom: 0; /* each cell is responsible for its top border */</pre>

<p>}</p>

<p>.fc-slats .fc-minor td {</p>

<pre>border-top-style: dotted;</pre>

<p>}</p>

<p>.fc-slats .ui-widget-content { /* for jqui theme */</p>

<pre>background: none; /* see through to fc-bg */</pre>

<p>}</p>

<p>/* TimeGrid Highlighting Slots ————————————————————————————————–*/</p>

<p>.fc-time-grid .fc-highlight-container { /* a div within a cell within the
fc-highlight-skeleton */</p>

<pre>position: relative; /* scopes the left/right of the fc-highlight to be in the column */</pre>

<p>}</p>

<p>.fc-time-grid .fc-highlight {</p>

<pre>position: absolute;
left: 0;
right: 0;
/* top and bottom will be in by JS */</pre>

<p>}</p>

<p>/* TimeGrid Event Containment ————————————————————————————————–*/</p>

<p>.fc-time-grid .fc-event-container, /* a div within a cell within the
fc-content-skeleton */ .fc-time-grid .fc-bgevent-container { /* a div
within a cell within the fc-bgevent-skeleton */</p>

<pre>position: relative;</pre>

<p>}</p>

<p>.fc-ltr .fc-time-grid .fc-event-container { /* space on the sides of events
for LTR (default) */</p>

<pre>margin: 0 2.5% 0 2px;</pre>

<p>}</p>

<p>.fc-rtl .fc-time-grid .fc-event-container { /* space on the sides of events
for RTL */</p>

<pre>margin: 0 2px 0 2.5%;</pre>

<p>}</p>

<p>.fc-time-grid .fc-event, .fc-time-grid .fc-bgevent {</p>

<pre>position: absolute;
z-index: 1; /* scope inner z-index&#39;s */</pre>

<p>}</p>

<p>.fc-time-grid .fc-bgevent {</p>

<pre>/* background events always span full width */
left: 0;
right: 0;</pre>

<p>}</p>

<p>/* TimeGrid Event Styling</p>
<hr>

<p>We use the full “fc-time-grid-event” class instead of using descendants
because the event won&#39;t be a descendant of the grid when it is being
dragged.</p>

<pre>/</pre>

<p>.fc-time-grid-event.fc-not-start { /* events that are continuing from
another day */</p>

<pre>/* replace space made by the top border with padding */
border-top-width: 0;
padding-top: 1px;
...
<p>.fc-time-grid-event.fc-not-end {</p>
...
<p>.fc-time-grid-event {</p>

<pre>overflow: hidden; /* don&#39;t let the bg flow over rounded corners */</pre>

<p>}</p>

<p>.fc-time-grid-event &gt; .fc-content { /* contains the time and title, but
no bg and resizer */</p>

<pre>position: relative;
z-index: 2; /* above the bg */</pre>

<p>}</p>

<p>.fc-time-grid-event .fc-time, .fc-time-grid-event .fc-title {</p>

<pre>padding: 0 1px;</pre>

<p>}</p>

<p>.fc-time-grid-event .fc-time {</p>
...
<p>.fc-time-grid-event .fc-bg {</p>

<pre>z-index: 1;
background: #fff;
opacity: .25;
filter: alpha(opacity=25); /* for IE */</pre>

<p>}</p>

<p>/* short mode, where time and title are on the same line */</p>

<p>.fc-time-grid-event.fc-short .fc-content {</p>

<pre>/* don&#39;t wrap to second line (now that contents will be inline) */
white-space: nowrap;</pre>

<p>}</p>

<p>.fc-time-grid-event.fc-short .fc-time, .fc-time-grid-event.fc-short
.fc-title {</p>

<pre>/* put the time and title on the same line */
display: inline-block;
vertical-align: top;</pre>

<p>}</p>

<p>.fc-time-grid-event.fc-short .fc-time span {</p>

<pre>display: none; /* don&#39;t display the full time text... */</pre>

<p>}</p>

<p>.fc-time-grid-event.fc-short .fc-time:before {</p>

<pre>content: attr(data-start); /* ...instead, display only the start time */</pre>

<p>}</p>

<p>.fc-time-grid-event.fc-short .fc-time:after {</p>

<pre>content: &quot;\000A0-\000A0&quot;; /* seperate with a dash, wrapped in nbsp&#39;s */</pre>

<p>}</p>

<p>.fc-time-grid-event.fc-short .fc-title {</p>

<pre>font-size: .85em; /* make the title text the same size as the time */
padding: 0; /* undo padding from above */</pre>

<p>}</p>

<p>/* resizer */</p>

<p>.fc-time-grid-event .fc-resizer {</p>
...
<p>.fc-time-grid-event .fc-resizer:after {</p>
