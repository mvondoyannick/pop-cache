...
<title>fullcalendar.print.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/fullcalendar/fullcalendar.print.css">
...
<p>.fc-event .fc-resizer {</p>

<pre>display: none;</pre>

<p>}</p>

<p>/* Table &amp; Day-Row Restyling ————————————————————————————————–*/</p>

<p>th, td, hr, thead, tbody, .fc-row {</p>

<pre>border-color: #ccc !important;
background: #fff !important;</pre>

<p>}</p>

<p>/* kill the overlaid, absolutely-positioned common components */ .fc-bg,
.fc-bgevent-skeleton, .fc-highlight-skeleton, .fc-helper-skeleton {</p>

<pre>display: none;</pre>

<p>}</p>

<p>/* don&#39;t force a min-height on rows (for DayGrid) */ .fc tbody .fc-row
{</p>

<pre>height: auto !important; /* undo height that JS set in distributeHeight */
min-height: 0 !important; /* undo the min-height from each view&#39;s specific stylesheet */</pre>

<p>}</p>

<p>.fc tbody .fc-row .fc-content-skeleton {</p>

<pre>position: static; /* undo .fc-rigid */
padding-bottom: 0 !important; /* use a more border-friendly method for this... */</pre>

<p>}</p>

<p>.fc tbody .fc-row .fc-content-skeleton tbody tr:last-child td { /* only
works in newer browsers */</p>

<pre>padding-bottom: 1em; /* ...gives space within the skeleton. also ensures min height in a way */</pre>

<p>}</p>

<p>.fc tbody .fc-row .fc-content-skeleton table {</p>

<pre>/* provides a min-height for the row, but only effective for IE, which exaggerates this value,
   making it look more like 3em. for other browers, it will already be this tall */
height: 1em;</pre>

<p>}</p>

<p>/* Undo month-view event limiting. Display all events and hide the “more”
links ————————————————————————————————–*/</p>

<p>.fc-more-cell, .fc-more {</p>

<pre>display: none !important;</pre>

<p>}</p>

<p>.fc tr.fc-limited {</p>

<pre>display: table-row !important;</pre>

<p>}</p>

<p>.fc td.fc-limited {</p>
...
<pre>display: none; /* never display the &quot;more..&quot; popover in print mode */</pre>

<p>}</p>

<p>/* TimeGrid Restyling ————————————————————————————————–*/</p>

<p>/* undo the min-height 100% trick used to fill the container&#39;s height
*/ .fc-time-grid {</p>

<pre>min-height: 0 !important;</pre>

<p>}</p>

<p>/* don&#39;t display the side axis at all (“all-day” and time cells) */
.fc-agenda-view .fc-axis {</p>

<pre>display: none;</pre>

<p>}</p>

<p>/* don&#39;t display the horizontal lines */ .fc-slats, .fc-time-grid hr {
/* this hr is used when height is underused and needs to be filled */</p>

<pre>display: none !important; /* important overrides inline declaration */</pre>

<p>}</p>

<p>/* let the container that holds the events be naturally positioned and
create real height */ .fc-time-grid .fc-content-skeleton {</p>

<pre>position: static;</pre>

<p>}</p>

<p>/* in case there are no events, we still want some height */ .fc-time-grid
.fc-content-skeleton table {</p>

<pre>height: 4em;</pre>

<p>}</p>

<p>/* kill the horizontal spacing made by the event container. event margins
will be done below */ .fc-time-grid .fc-event-container {</p>

<pre>margin: 0 !important;</pre>

<p>}</p>

<p>/* TimeGrid <strong>Event</strong> Restyling
————————————————————————————————–*/</p>

<p>/* naturally position events, vertically stacking them */ .fc-time-grid
.fc-event {</p>

<pre>position: static !important;
margin: 3px 2px !important;</pre>

<p>}</p>

<p>/* for events that continue to a future day, give the bottom border back */
.fc-time-grid .fc-event.fc-not-end {</p>

<pre>border-bottom-width: 1px !important;</pre>

<p>}</p>

<p>/* indicate the event continues via “…” text */ .fc-time-grid
.fc-event.fc-not-end:after {</p>

<pre>content: &quot;...&quot;;</pre>

<p>}</p>

<p>/* for events that are continuations from previous days, give the top
border back */ .fc-time-grid .fc-event.fc-not-start {</p>

<pre>border-top-width: 1px !important;</pre>

<p>}</p>

<p>/* indicate the event is a continuation via “…” text */ .fc-time-grid
.fc-event.fc-not-start:before {</p>
...
<p>/* undo a previous declaration and let the time text span to a second line
*/ .fc-time-grid .fc-event .fc-time {</p>

<pre>white-space: normal !important;</pre>

<p>}</p>

<p>/* hide the the time that is normally displayed… */ .fc-time-grid .fc-event
.fc-time span {</p>
...
<p>/* …replace it with a more verbose version (includes AM/PM) stored in an
html attribute */ .fc-time-grid .fc-event .fc-time:after {</p>

<pre>content: attr(data-full);</pre>

<p>}</p>

<p>/* Vertical Scroller &amp; Containers ————————————————————————————————–*/</p>

<p>/* kill the scrollbars and allow natural height */ .fc-scroller,
.fc-day-grid-container,    /* these divs might be assigned height, which we
need to cleared */ .fc-time-grid-container {  /* */</p>
...
<p>/* kill the horizontal border/padding used to compensate for scrollbars */
.fc-row {</p>
...
<p>.fc-button-group, .fc button {</p>

<pre>display: none; /* don&#39;t display any button-related controls */</pre>
