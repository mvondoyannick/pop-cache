...
<title>jquery.dataTables.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/jquery.dataTables.css">

<pre class="ruby"><span class="ruby-constant">Table</span> <span class="ruby-identifier">styles</span>
</pre>
...
<p>} table.dataTable thead th, table.dataTable tfoot th {</p>

<pre>font-weight: bold;</pre>

<p>} table.dataTable thead th, table.dataTable thead td {</p>

<pre>padding: 10px 18px;
border-bottom: 1px solid #111;</pre>

<p>} table.dataTable thead th:active, table.dataTable thead td:active {</p>

<pre>outline: none;</pre>

<p>} table.dataTable tfoot th, table.dataTable tfoot td {</p>

<pre>padding: 10px 18px 6px 18px;
border-top: 1px solid #111;</pre>

<p>} table.dataTable thead .sorting, table.dataTable thead .sorting_asc,
table.dataTable thead .sorting_desc {</p>

<pre>cursor: pointer;
 cursor: hand;</pre>

<p>} table.dataTable thead .sorting, table.dataTable thead .sorting_asc,
table.dataTable thead .sorting_desc, table.dataTable thead
.sorting_asc_disabled, table.dataTable thead .sorting_desc_disabled {</p>

<pre>background-repeat: no-repeat;
background-position: center right;</pre>

<p>} table.dataTable thead .sorting {</p>

<pre>background-image: url(&quot;images/sort_both.png&quot;);</pre>

<p>} table.dataTable thead .sorting_asc {</p>

<pre>background-image: url(&quot;images/sort_asc.png&quot;);</pre>

<p>} table.dataTable thead .sorting_desc {</p>

<pre>background-image: url(&quot;images/sort_desc.png&quot;);</pre>

<p>} table.dataTable thead .sorting_asc_disabled {</p>

<pre>background-image: url(&quot;images/sort_asc_disabled.png&quot;);</pre>

<p>} table.dataTable thead .sorting_desc_disabled {</p>

<pre>background-image: url(&quot;images/sort_desc_disabled.png&quot;);</pre>

<p>} table.dataTable tbody tr {</p>

<pre>background-color: #ffffff;</pre>

<p>} table.dataTable tbody tr.selected {</p>

<pre>background-color: #B0BED9;</pre>

<p>} table.dataTable tbody th, table.dataTable tbody td {</p>

<pre>padding: 8px 10px;</pre>

<p>} table.dataTable.row-border tbody th, table.dataTable.row-border tbody td,
table.dataTable.display tbody th, table.dataTable.display tbody td {</p>

<pre>border-top: 1px solid #ddd;</pre>

<p>} table.dataTable.row-border tbody tr:first-child th,
table.dataTable.row-border tbody tr:first-child td, table.dataTable.display
tbody tr:first-child th, table.dataTable.display tbody tr:first-child td {</p>

<pre>border-top: none;</pre>

<p>} table.dataTable.cell-border tbody th, table.dataTable.cell-border tbody
td {</p>

<pre>border-top: 1px solid #ddd;
border-right: 1px solid #ddd;</pre>

<p>} table.dataTable.cell-border tbody tr th:first-child,
table.dataTable.cell-border tbody tr td:first-child {</p>

<pre>border-left: 1px solid #ddd;</pre>

<p>} table.dataTable.cell-border tbody tr:first-child th,
table.dataTable.cell-border tbody tr:first-child td {</p>

<pre>border-top: none;</pre>

<p>} table.dataTable.stripe tbody tr.odd, table.dataTable.display tbody tr.odd
{</p>

<pre>background-color: #f9f9f9;</pre>

<p>} table.dataTable.stripe tbody tr.odd.selected, table.dataTable.display
tbody tr.odd.selected {</p>

<pre>background-color: #abb9d3;</pre>

<p>} table.dataTable.hover tbody tr:hover, table.dataTable.display tbody
tr:hover {</p>

<pre>background-color: whitesmoke;</pre>

<p>} table.dataTable.hover tbody tr:hover.selected, table.dataTable.display
tbody tr:hover.selected {</p>

<pre>background-color: #a9b7d1;</pre>

<p>} table.dataTable.order-column tbody tr &gt; .sorting_1,
table.dataTable.order-column tbody tr &gt; .sorting_2,
table.dataTable.order-column tbody tr &gt; .sorting_3,
table.dataTable.display tbody tr &gt; .sorting_1, table.dataTable.display
tbody tr &gt; .sorting_2, table.dataTable.display tbody tr &gt; .sorting_3
{</p>

<pre>background-color: #f9f9f9;</pre>

<p>} table.dataTable.order-column tbody tr.selected &gt; .sorting_1,
table.dataTable.order-column tbody tr.selected &gt; .sorting_2,
table.dataTable.order-column tbody tr.selected &gt; .sorting_3,
table.dataTable.display tbody tr.selected &gt; .sorting_1,
table.dataTable.display tbody tr.selected &gt; .sorting_2,
table.dataTable.display tbody tr.selected &gt; .sorting_3 {</p>

<pre>background-color: #acbad4;</pre>

<p>} table.dataTable.display tbody tr.odd &gt; .sorting_1,
table.dataTable.order-column.stripe tbody tr.odd &gt; .sorting_1 {</p>

<pre>background-color: #f1f1f1;</pre>

<p>} table.dataTable.display tbody tr.odd &gt; .sorting_2,
table.dataTable.order-column.stripe tbody tr.odd &gt; .sorting_2 {</p>

<pre>background-color: #f3f3f3;</pre>

<p>} table.dataTable.display tbody tr.odd &gt; .sorting_3,
table.dataTable.order-column.stripe tbody tr.odd &gt; .sorting_3 {</p>

<pre>background-color: whitesmoke;</pre>

<p>} table.dataTable.display tbody tr.odd.selected &gt; .sorting_1,
table.dataTable.order-column.stripe tbody tr.odd.selected &gt; .sorting_1 {</p>

<pre>background-color: #a6b3cd;</pre>

<p>} table.dataTable.display tbody tr.odd.selected &gt; .sorting_2,
table.dataTable.order-column.stripe tbody tr.odd.selected &gt; .sorting_2 {</p>

<pre>background-color: #a7b5ce;</pre>

<p>} table.dataTable.display tbody tr.odd.selected &gt; .sorting_3,
table.dataTable.order-column.stripe tbody tr.odd.selected &gt; .sorting_3 {</p>

<pre>background-color: #a9b6d0;</pre>

<p>} table.dataTable.display tbody tr.even &gt; .sorting_1,
table.dataTable.order-column.stripe tbody tr.even &gt; .sorting_1 {</p>

<pre>background-color: #f9f9f9;</pre>

<p>} table.dataTable.display tbody tr.even &gt; .sorting_2,
table.dataTable.order-column.stripe tbody tr.even &gt; .sorting_2 {</p>

<pre>background-color: #fbfbfb;</pre>

<p>} table.dataTable.display tbody tr.even &gt; .sorting_3,
table.dataTable.order-column.stripe tbody tr.even &gt; .sorting_3 {</p>

<pre>background-color: #fdfdfd;</pre>

<p>} table.dataTable.display tbody tr.even.selected &gt; .sorting_1,
table.dataTable.order-column.stripe tbody tr.even.selected &gt; .sorting_1
{</p>

<pre>background-color: #acbad4;</pre>

<p>} table.dataTable.display tbody tr.even.selected &gt; .sorting_2,
table.dataTable.order-column.stripe tbody tr.even.selected &gt; .sorting_2
{</p>

<pre>background-color: #adbbd6;</pre>

<p>} table.dataTable.display tbody tr.even.selected &gt; .sorting_3,
table.dataTable.order-column.stripe tbody tr.even.selected &gt; .sorting_3
{</p>

<pre>background-color: #afbdd8;</pre>

<p>} table.dataTable.display tbody tr:hover &gt; .sorting_1,
table.dataTable.order-column.hover tbody tr:hover &gt; .sorting_1 {</p>

<pre>background-color: #eaeaea;</pre>

<p>} table.dataTable.display tbody tr:hover &gt; .sorting_2,
table.dataTable.order-column.hover tbody tr:hover &gt; .sorting_2 {</p>

<pre>background-color: #ebebeb;</pre>

<p>} table.dataTable.display tbody tr:hover &gt; .sorting_3,
table.dataTable.order-column.hover tbody tr:hover &gt; .sorting_3 {</p>

<pre>background-color: #eeeeee;</pre>

<p>} table.dataTable.display tbody tr:hover.selected &gt; .sorting_1,
table.dataTable.order-column.hover tbody tr:hover.selected &gt; .sorting_1
{</p>

<pre>background-color: #a1aec7;</pre>

<p>} table.dataTable.display tbody tr:hover.selected &gt; .sorting_2,
table.dataTable.order-column.hover tbody tr:hover.selected &gt; .sorting_2
{</p>

<pre>background-color: #a2afc8;</pre>

<p>} table.dataTable.display tbody tr:hover.selected &gt; .sorting_3,
table.dataTable.order-column.hover tbody tr:hover.selected &gt; .sorting_3
{</p>

<pre>background-color: #a4b2cb;</pre>

<p>} table.dataTable.no-footer {</p>

<pre>border-bottom: 1px solid #111;</pre>

<p>} table.dataTable.nowrap th, table.dataTable.nowrap td {</p>

<pre>white-space: nowrap;</pre>

<p>} table.dataTable.compact thead th, table.dataTable.compact thead td {</p>

<pre>padding: 4px 17px 4px 4px;</pre>

<p>} table.dataTable.compact tfoot th, table.dataTable.compact tfoot td {</p>

<pre>padding: 4px;</pre>

<p>} table.dataTable.compact tbody th, table.dataTable.compact tbody td {</p>

<pre>padding: 4px;</pre>

<p>} table.dataTable th.dt-left, table.dataTable td.dt-left {</p>

<pre>text-align: left;</pre>

<p>} table.dataTable th.dt-center, table.dataTable td.dt-center,
table.dataTable td.dataTables_empty {</p>

<pre>text-align: center;</pre>

<p>} table.dataTable th.dt-right, table.dataTable td.dt-right {</p>

<pre>text-align: right;</pre>

<p>} table.dataTable th.dt-justify, table.dataTable td.dt-justify {</p>

<pre>text-align: justify;</pre>

<p>} table.dataTable th.dt-nowrap, table.dataTable td.dt-nowrap {</p>

<pre>white-space: nowrap;</pre>

<p>} table.dataTable thead th.dt-head-left, table.dataTable thead
td.dt-head-left, table.dataTable tfoot th.dt-head-left, table.dataTable
tfoot td.dt-head-left {</p>

<pre>text-align: left;</pre>

<p>} table.dataTable thead th.dt-head-center, table.dataTable thead
td.dt-head-center, table.dataTable tfoot th.dt-head-center, table.dataTable
tfoot td.dt-head-center {</p>

<pre>text-align: center;</pre>

<p>} table.dataTable thead th.dt-head-right, table.dataTable thead
td.dt-head-right, table.dataTable tfoot th.dt-head-right, table.dataTable
tfoot td.dt-head-right {</p>

<pre>text-align: right;</pre>

<p>} table.dataTable thead th.dt-head-justify, table.dataTable thead
td.dt-head-justify, table.dataTable tfoot th.dt-head-justify,
table.dataTable tfoot td.dt-head-justify {</p>

<pre>text-align: justify;</pre>

<p>} table.dataTable thead th.dt-head-nowrap, table.dataTable thead
td.dt-head-nowrap, table.dataTable tfoot th.dt-head-nowrap, table.dataTable
tfoot td.dt-head-nowrap {</p>

<pre>white-space: nowrap;</pre>

<p>} table.dataTable tbody th.dt-body-left, table.dataTable tbody
td.dt-body-left {</p>

<pre>text-align: left;</pre>

<p>} table.dataTable tbody th.dt-body-center, table.dataTable tbody
td.dt-body-center {</p>

<pre>text-align: center;</pre>

<p>} table.dataTable tbody th.dt-body-right, table.dataTable tbody
td.dt-body-right {</p>

<pre>text-align: right;</pre>

<p>} table.dataTable tbody th.dt-body-justify, table.dataTable tbody
td.dt-body-justify {</p>

<pre>text-align: justify;</pre>

<p>} table.dataTable tbody th.dt-body-nowrap, table.dataTable tbody
td.dt-body-nowrap {</p>
...
<p>table.dataTable, table.dataTable th, table.dataTable td {</p>
...
<pre> Control feature layout
/</pre>

<p>.dataTables_wrapper {</p>
...
<p>} .dataTables_wrapper .dataTables_length {</p>

<pre>float: left;</pre>

<p>} .dataTables_wrapper .dataTables_filter {</p>

<pre>float: right;
text-align: right;</pre>

<p>} .dataTables_wrapper .dataTables_filter input {</p>

<pre>margin-left: 0.5em;</pre>

<p>} .dataTables_wrapper .dataTables_info {</p>

<pre>clear: both;
float: left;
padding-top: 0.755em;</pre>

<p>} .dataTables_wrapper .dataTables_paginate {</p>

<pre>float: right;
text-align: right;
padding-top: 0.25em;</pre>

<p>} .dataTables_wrapper .dataTables_paginate .paginate_button {</p>
...
<p>} .dataTables_wrapper .dataTables_paginate .paginate_button.current,
.dataTables_wrapper .dataTables_paginate .paginate_button.current:hover {</p>
...
<p>} .dataTables_wrapper .dataTables_paginate .paginate_button.disabled,
.dataTables_wrapper .dataTables_paginate .paginate_button.disabled:hover,
.dataTables_wrapper .dataTables_paginate .paginate_button.disabled:active {</p>
...
<p>} .dataTables_wrapper .dataTables_paginate .paginate_button:hover {</p>
...
<p>} .dataTables_wrapper .dataTables_paginate .paginate_button:active {</p>
...
/* W3C */
box-shadow: inset 0 0 3px #111;</pre>

<p>} .dataTables_wrapper .dataTables_paginate .ellipsis {</p>

<pre>padding: 0 1em;</pre>

<p>} .dataTables_wrapper .dataTables_processing {</p>
...
<p>} .dataTables_wrapper .dataTables_length, .dataTables_wrapper
...
<p>} .dataTables_wrapper .dataTables_scroll {</p>

<pre>clear: both;</pre>

<p>} .dataTables_wrapper .dataTables_scroll div.dataTables_scrollBody {</p>

<pre> margin-top: -1px;
-webkit-overflow-scrolling: touch;</pre>

<p>} .dataTables_wrapper .dataTables_scroll div.dataTables_scrollBody th &gt;
div.dataTables_sizing, .dataTables_wrapper .dataTables_scroll
div.dataTables_scrollBody td &gt; div.dataTables_sizing {</p>

<pre>height: 0;
overflow: hidden;
margin: 0 !important;
padding: 0 !important;</pre>

<p>} .dataTables_wrapper.no-footer .dataTables_scrollBody {</p>

<pre>border-bottom: 1px solid #111;</pre>

<p>} .dataTables_wrapper.no-footer div.dataTables_scrollHead table,
.dataTables_wrapper.no-footer div.dataTables_scrollBody table {</p>

<pre>border-bottom: none;</pre>

<p>} .dataTables_wrapper:after {</p>
...
<pre>.dataTables_wrapper .dataTables_info,
...
<pre>.dataTables_wrapper .dataTables_length,
