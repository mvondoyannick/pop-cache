...
<title>dataTables.responsive.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Responsive/css/dataTables.responsive.css">

<p>table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr &gt;
td:first-child, table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr
&gt; th:first-child {</p>
...
<p>} table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr &gt;
td:first-child:before, table.dataTable.dtr-inline.collapsed &gt; tbody &gt;
tr &gt; th:first-child:before {</p>
...
content: &#39;+&#39;;
background-color: #31b131;</pre>

<p>} table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr &gt;
td:first-child.dataTables_empty:before,
table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr &gt;
th:first-child.dataTables_empty:before {</p>

<pre>display: none;</pre>

<p>} table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr.parent &gt;
td:first-child:before, table.dataTable.dtr-inline.collapsed &gt; tbody &gt;
tr.parent &gt; th:first-child:before {</p>

<pre>content: &#39;-&#39;;
background-color: #d33333;</pre>

<p>} table.dataTable.dtr-inline.collapsed &gt; tbody &gt; tr.child td:before {</p>

<pre>display: none;</pre>

<p>} table.dataTable.dtr-inline.collapsed.compact &gt; tbody &gt; tr &gt;
td:first-child, table.dataTable.dtr-inline.collapsed.compact &gt; tbody
&gt; tr &gt; th:first-child {</p>

<pre>padding-left: 27px;</pre>

<p>} table.dataTable.dtr-inline.collapsed.compact &gt; tbody &gt; tr &gt;
td:first-child:before, table.dataTable.dtr-inline.collapsed.compact &gt;
tbody &gt; tr &gt; th:first-child:before {</p>
...
width: 14px;
border-radius: 14px;
line-height: 12px;</pre>

<p>} table.dataTable.dtr-column &gt; tbody &gt; tr &gt; td.control,
table.dataTable.dtr-column &gt; tbody &gt; tr &gt; th.control {</p>

<pre>position: relative;
cursor: pointer;</pre>

<p>} table.dataTable.dtr-column &gt; tbody &gt; tr &gt; td.control:before,
table.dataTable.dtr-column &gt; tbody &gt; tr &gt; th.control:before {</p>
...
<p>} table.dataTable.dtr-column &gt; tbody &gt; tr.parent td.control:before,
table.dataTable.dtr-column &gt; tbody &gt; tr.parent th.control:before {</p>

<pre>content: &#39;-&#39;;
background-color: #d33333;</pre>

<p>} table.dataTable &gt; tbody &gt; tr.child {</p>

<pre>padding: 0.5em 1em;</pre>

<p>} table.dataTable &gt; tbody &gt; tr.child:hover {</p>

<pre>background: transparent !important;</pre>

<p>} table.dataTable &gt; tbody &gt; tr.child ul {</p>
...
<p>} table.dataTable &gt; tbody &gt; tr.child ul li {</p>

<pre>border-bottom: 1px solid #efefef;
padding: 0.5em 0;</pre>

<p>} table.dataTable &gt; tbody &gt; tr.child ul li:first-child {</p>

<pre>padding-top: 0;</pre>

<p>} table.dataTable &gt; tbody &gt; tr.child ul li:last-child {</p>

<pre>border-bottom: none;</pre>

<p>} table.dataTable &gt; tbody &gt; tr.child span.dtr-title {</p>
