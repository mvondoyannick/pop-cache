...
<title>dataTables.responsive.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Responsive/css/dataTables.responsive.scss">

<p>// // Mixins // @mixin control() {</p>
...
<p>// // Table styles // table.dataTable {</p>

<pre>// Styling for the `inline` type
