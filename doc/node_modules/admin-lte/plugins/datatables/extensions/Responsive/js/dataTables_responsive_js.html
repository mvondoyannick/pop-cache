...
<title>dataTables.responsive.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Responsive/js/dataTables.responsive.js">

<pre>! Responsive 1.0.6
 2014-2015 SpryMedia Ltd - datatables.net/license</pre>

<p>/**</p>

<pre> @summary     Responsive
...
<pre> Responsive is a plug-in for the DataTables library that makes use of
...
<p>var Responsive = function ( settings, opts ) {</p>

<pre>// Sanity check that we are using DataTables 1.10 or newer
...
this._constructor();</pre>

<p>};</p>

<p>Responsive.prototype = {</p>
...
<pre> List of default breakpoints. Each item in the array is an object with two
 properties:
...
<pre>{ name: &#39;desktop&#39;,  width: Infinity },
{ name: &#39;tablet-l&#39;, width: 1024 },
{ name: &#39;tablet-p&#39;, width: 768 },
{ name: &#39;mobile-l&#39;, width: 480 },
{ name: &#39;mobile-p&#39;, width: 320 }</pre>

<p>];</p>

<p>/**</p>

<pre> Responsive default settings for initialisation
...
<p>var <a href="../../../../../../../Api.html">Api</a> = $.fn.dataTable.Api;</p>

<p>// Doesn&#39;t do anything - work around for a bug in DT… Not documented
Api.register( &#39;responsive()&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>;
</pre>

<p>} );</p>

<p>Api.register( &#39;responsive.index()&#39;, function ( li ) {</p>
...
<p>Api.register( &#39;responsive.rebuild()&#39;, function () {</p>

<pre>return this.iterator( &#39;table&#39;, function ( ctx ) {
        if ( ctx._responsive ) {
...
<p>Api.register( &#39;responsive.recalc()&#39;, function () {</p>
...
<p>Responsive.version = &#39;1.0.6&#39;;</p>

<p>$.fn.dataTable.Responsive = Responsive; $.fn.DataTable.Responsive =
Responsive;</p>

<p>// Attach a listener to the document which listens for DataTables
initialisation // events so we can automatically initialise $(document).on(
&#39;init.dt.dtr&#39;, function (e, settings, json) {</p>

<pre>if ( e.namespace !== &#39;dt&#39; ) {
        return;
}
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.Responsive ) {</p>
