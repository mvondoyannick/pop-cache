...
<title>dataTables.responsive.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js">

<pre> !
Responsive 1.0.6
2014-2015 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(n,p){var o=function(e,k){var
h=function(d,a){if(!k.versionCheck||!k.versionCheck(“1.10.1”))throw“DataTables
Responsive requires DataTables 1.10.1 or newer”;this.s={dt:new <a
href="0">k.Api(d),columns:[]};this.s.dt.settings()</a>.responsive||(a&amp;&amp;“string”===typeof
a.details&amp;&amp;(a.details={type:a.details}),this.c=e.extend(!0,{},h.defaults,k.defaults.responsive,a),d.responsive=this,this._constructor())};h.prototype={_constructor:function(){var
<a
href="0">d=this,a=this.s.dt;a.settings()</a>._responsive=this;e(n).on(“resize.dtr
orientationchange.dtr”, <a
href="0">a.settings()</a>.oApi._fnThrottle(function(){d._resize()}));a.on(“destroy.dtr”,function(){e(n).off(“resize.dtr
orientationchange.dtr
draw.dtr”)});this.c.breakpoints.sort(function(a,c){return
a.width&lt;c.width?1:a.width&gt;c.width?-1:0});this._classLogic();this._resizeAuto();var
c=this.c.details;c.type&amp;&amp;(d._detailsInit(),this._detailsVis(),a.on(“column-visibility.dtr”,function(){d._detailsVis()}),a.on(“draw.dtr”,function(){a.rows({page:“current”}).iterator(“row”,function(b,c){var
f=a.row©;if(f.child.isShown()){var i=
d.c.details.renderer(a,c);f.child(i,“child”).show()}})}),e(a.table().node()).addClass(“dtr-”+c.type));this._resize()},_columnsVisiblity:function(d){var
a=this.s.dt,c=this.s.columns,b,g,f=e.map(c,function(a){return
a.auto&amp;&amp;null===a.minWidth?!1:!0===a.auto?“-”:-1!==e.inArray(d,a.includeIn)}),<a
href="b">i=0;b=0;for(g=f.length;b<g;b++)!0===f</a>&amp;&amp;(<a
href="b">i+=c</a>.<a href="0">minWidth);b=a.settings()</a>.<a
href="b">oScroll;b=b.sY||b.sX?b.iBarWidth:0;a=a.table().container().offsetWidth-b-i;b=0;for(g=f.length;b<g;b++)c</a>.<a
href="b">control&&(a-=c</a>.minWidth); <a
href="b">i=!1;b=0;for(g=f.length;b<g;b++)"-"===f</a>&amp;&amp;!<a
href="b">c</a>.<a href="b">control&&(i||0>a-c</a>.<a
href="b">minWidth?(i=!0,f</a>=!<a href="b">1):f</a>=!<a
href="b">0,a-=c</a>.<a
href="b">minWidth);a=!1;b=0;for(g=c.length;b<g;b++)if(!c</a>.<a
href="b">control&&!c</a>.<a href="b">never&&!f</a>){a=!0;break}<a
href="b">b=0;for(g=c.length;b<g;b++)c</a>.<a href="b">control&&(f</a>=<a
href="0">a);-1===e.inArray(!0,f)&&(f</a>=!0);return
f},_classLogic:function(){var
d=this,a=this.c.breakpoints,c=this.s.dt.columns().eq(0).map(function(a){a=this.column(a).header().className;return{className:a,includeIn:[],auto:!1,control:!1,never:a.match(/bneverb/)?
!0:!1}}),b=function(a,b){var <a
href="a">d=c</a>.includeIn;-1===e.inArray(b,d)&amp;&amp;d.push(b)},g=function(f,g,e,j){if(e)if(“max-”===e){<a
href="g">j=d._find(g).width;g=0;for(e=a.length;g<e;g++)a</a>.<a
href="g">width<=j&&b(f,a</a>.name)}else if(“min-”===e){<a
href="g">j=d._find(g).width;g=0;for(e=a.length;g<e;g++)a</a>.<a
href="g">width>=j&&b(f,a</a>.name)}else{if(“not-”===e){<a
href="g">g=0;for(e=a.length;g<e;g++)-1===a</a>.<a
href="g">name.indexOf(j)&&b(f,a</a>.name)}}else <a
href="f">c</a>.includeIn.push(g)};c.each(function(b,c){for(var
d=b.className.split(“ ”),j=!1,h=0,k=d.length;h&lt;k;h++){var <a
href="h">l=e.trim(d</a>);
if(“all”===l){j=!0;b.includeIn=e.map(a,function(a){return
a.name});return}if(“none”===l||“never”===l){j=!0;return}if(“control”===l){j=!0;b.control=!0;return}e.each(a,function(a,b){var
<a
href="0">d=b.name.split(“-”),e=l.match(RegExp(“(min\-|max\-|not\-)?(”+d</a>+“)(\-[<a
href="2">_a-zA-Z0-9])?”));e&&(j=!0,e</a>===<a href="0">d</a>&amp;&amp;<a
href="3">e</a>===“-”+<a href="1">d</a>?<a href="1">g(c,b.name,e</a>,<a
href="2">e</a>+<a href="3">e</a>):<a href="2">e</a>===<a
href="0">d</a>&amp;&amp;!<a href="3">e</a>&amp;&amp;<a
href="1">g(c,b.name,e</a>,<a
href="2">e</a>))})}j||(b.auto=!0)});this.s.columns=c},_detailsInit:function(){var
d=this,a=this.s.dt,c=this.c.details;“inline”===c.type&amp;&amp;
(c.target=“td:first-child”);var
...
b===“number”){var
c=b&lt;0?a.columns().eq(0).length+b:b;if(a.cell(this).index().column!==c)return}c=a.row(e(this).closest(“tr”));if(c.child.isShown()){c.child(false);e(c.node()).removeClass(“parent”)}else{var
<a
href="0">f=d.c.details.renderer(a,c</a>);c.child(f,“child”).show();e(c.node()).addClass(“parent”)}}})},
_detailsVis:function(){var
d=this,a=this.s.dt,c=a.columns().indexes().filter(function(b){var
c=a.column(b);return
c.visible()?null:e(c.header()).hasClass(“never”)?null:b}),<a
href="0">b=!0;if(0===c.length||1===c.length&&this.s.columns[c</a>].control)b=!1;b?a.rows({page:“current”}).eq(0).each(function(b){b=a.row(b);if(b.child()){var
<a
href="0">c=d.c.details.renderer(a,b</a>);!1===c?b.child.hide():b.child(c,“child”).show()}}):a.rows({page:“current”}).eq(0).each(function(b){a.row(b).child.hide()})},_find:function(d){for(var
a= <a
href="c">this.c.breakpoints,c=0,b=a.length;c<b;c++)if(a</a>.name===d)return
<a href="c">a</a>},_resize:function(){var <a
href="0">d=this.s.dt,a=e(n).width(),c=this.c.breakpoints,b=c</a>.<a
href="f">name,g=this.s.columns,f;for(f=c.length-1;0<=f;f--)if(a<=c</a>.width){<a
href="f">b=c</a>.name;break}var <a
href="f">i=this._columnsVisiblity(b),c=!1;f=0;for(a=g.length;f<a;f++)if(!1===i</a>&amp;&amp;!<a
href="f">g</a>.never){c=!0;break}e(d.table().node()).toggleClass(“collapsed”,c);d.columns().eq(0).each(function(a,b){<a
href="b">d.column(a).visible(i</a>)})},_resizeAuto:function(){var
d=this.s.dt,a=this.s.columns;
if(this.c.auto&amp;&amp;-1!==e.inArray(!0,e.map(a,function(a){return
a.auto}))){d.table().node();var
c=d.table().node().cloneNode(!1),b=e(d.table().header().cloneNode(!1)).appendTo©,g=e(d.table().body().cloneNode(!1)).appendTo©;e(d.table().footer()).clone(!1).appendTo©;d.rows({page:“current”}).indexes().flatten().each(function(a){var
b=d.row(a).node().cloneNode(!0);d.columns(“:hidden”).flatten().length&amp;&amp;e(b).append(d.cells(a,“:hidden”).nodes().to$().clone());e(b).appendTo(g)});var
f=d.columns().header().to$().clone(!1);
e(“&lt;tr/&gt;”).append(f).appendTo(b);“inline”===this.c.details.type&amp;&amp;e©.addClass(“dtr-inline
collapsed”);c=e(“&lt;div/&gt;”).css({width:1,height:1,overflow:“hidden”}).append©;c.find(“th.never,
td.never”).remove();c.insertBefore(d.table().node());d.columns().eq(0).each(function(b){<a
href="b">a</a>.<a href="b">minWidth=f</a>.offsetWidth||0});c.remove()}}};<a
href="{name:"desktop",width:Infinity},{name:"tablet-l",width:1024},{name:"tablet-p",width:768},{name:"mobile-l",width:480},{name:"mobile-p",width:320}">h.breakpoints=</a>;h.defaults={breakpoints:h.breakpoints,
auto:!0,details:{renderer:function(d,a){var
c=d.cells(a,“:hidden”).eq(0).map(function(a){var
c=e(d.column(a.column).header()),a=d.cell(a).index();if(c.hasClass(“control”)||c.hasClass(“never”))return“”;var
<a
href="0">f=d.settings()</a>,f=f.oApi._fnGetCellData(f,a.row,a.column,“display”);(c=c.text())&amp;&amp;(c+=“:”);return&#39;&lt;li
data-dtr-index=“&#39;<code>a.column</code>&#39;”&gt;&lt;span
class=“dtr-title”&gt;&#39;<code>c</code>&#39;&lt;/span&gt; &lt;span
class=“dtr-data”&gt;&#39;<code>f</code>“&lt;/span&gt;&lt;/li&gt;”}).toArray().join(“”);return
c?e(&#39;&lt;ul
data-dtr-index=“&#39;<code>a</code>&#39;”/&gt;&#39;).append©:!1},target:0,
type:“inline”}};var
m=e.fn.dataTable.Api;m.register(“responsive()”,function(){return
this});m.register(“responsive.index()”,function(d){d=e(d);return{column:d.data(“dtr-index”),row:d.parent().data(“dtr-index”)}});m.register(“responsive.rebuild()”,function(){return
this.iterator(“table”,function(d){d._responsive&amp;&amp;d._responsive._classLogic()})});m.register(“responsive.recalc()”,function(){return
this.iterator(“table”,function(d){d._responsive&amp;&amp;(d._responsive._resizeAuto(),d._responsive._resize())})});
h.version=“1.0.6”;e.fn.dataTable.Responsive=h;e.fn.DataTable.Responsive=h;e(p).on(“init.dt.dtr”,function(d,a){if(“dt”===d.namespace&amp;&amp;(e(a.nTable).hasClass(“responsive”)||e(a.nTable).hasClass(“dt-responsive”)||a.oInit.responsive||k.defaults.responsive)){var
c=a.oInit.responsive;!1!==c&amp;&amp;new
h(a,e.isPlainObject©?c:{})}});return h};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,o):“object”===typeof
exports?o(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.Responsive&amp;&amp;
o(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
