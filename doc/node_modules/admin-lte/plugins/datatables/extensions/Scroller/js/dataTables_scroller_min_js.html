...
<title>dataTables.scroller.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Scroller/js/dataTables.scroller.min.js">

<pre> !
Scroller 1.2.2
©2011-2014 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(m,n,k){var l=function(e){var g=function(a,b){!this instanceof
g?alert(“Scroller warning: Scroller must be initialised with the
&#39;new&#39; keyword.”):(“undefined”==typeof
...
this.dom={force:n.createElement(“div”),scroller:null,table:null,loader:null},this.s.dt.oScroller=this,this._fnConstruct())};g.prototype={fnRowToPixels:function(a,b,c){a=c?this._domain(“virtualToPhysical”,a*this.s.heights.row):this.s.baseScrollTop+(a-this.s.baseRowTop)*this.s.heights.row;return
b||b===k?parseInt(a,10):a},fnPixelsToRow:function(a,b,c){var
d=a-this.s.baseScrollTop,a=c?this._domain(“physicalToVirtual”,a)/this.s.heights.row:d/this.s.heights.row+this.s.baseRowTop;return
b||b===k?parseInt(a, 10):a},fnScrollToRow:function(a,b){var
c=this,d=!1,f=this.fnRowToPixels(a),h=a-(this.s.displayBuffer-1)/2*this.s.viewportRows;0&gt;h&amp;&amp;(h=0);if((f&gt;this.s.redrawBottom||f&lt;this.s.redrawTop)&amp;&amp;this.s.dt._iDisplayStart!==h)d=!0,f=this.fnRowToPixels(a,!1,!0);“undefined”==typeof
b||b?(this.s.ani=d,e(this.dom.scroller).animate({scrollTop:f},function(){setTimeout(function(){c.s.ani=!1},25)})):e(this.dom.scroller).scrollTop(f)},fnMeasure:function(a){this.s.autoHeight&amp;&amp;this._fnCalcRowHeight();var
b=this.s.heights;
b.viewport=e(this.dom.scroller).height();this.s.viewportRows=parseInt(b.viewport/b.row,10)+1;this.s.dt._iDisplayLength=this.s.viewportRows*this.s.displayBuffer;(a===k||a)&amp;&amp;this.s.dt.oInstance.fnDraw()},_fnConstruct:function(){var
a=this;if(this.s.dt.oFeatures.bPaginate){<a
href="0">this.dom.force.style.position=“absolute”;this.dom.force.style.top=“0px”;this.dom.force.style.left=“0px”;this.dom.force.style.width=“1px”;this.dom.scroller=e(“div.”+this.s.dt.oClasses.sScrollBody,this.s.dt.nTableWrapper)</a>;this.dom.scroller.appendChild(this.dom.force);
<a
href="0">this.dom.scroller.style.position=“relative”;this.dom.table=e(“>table”,this.dom.scroller)</a>;this.dom.table.style.position=“absolute”;this.dom.table.style.top=“0px”;this.dom.table.style.left=“0px”;e(this.s.dt.nTableWrapper).addClass(“DTS”);this.s.loadingIndicator&amp;&amp;(this.dom.loader=e(&#39;&lt;div
class=“DTS_Loading”&gt;&#39;<code>this.s.dt.oLanguage.sLoadingRecords</code>“&lt;/div&gt;”).css(“display”,“none”),e(this.dom.scroller.parentNode).css(“position”,“relative”).append(this.dom.loader));this.s.heights.row&amp;&amp;“auto”!=this.s.heights.row&amp;&amp;
(this.s.autoHeight=!1);this.fnMeasure(!1);this.s.ingnoreScroll=!0;this.s.stateSaveThrottle=this.s.dt.oApi._fnThrottle(function(){a.s.dt.oApi._fnSaveState(a.s.dt)},500);e(this.dom.scroller).on(“scroll.DTS”,function(){a._fnScroll.call(a)});e(this.dom.scroller).on(“touchstart.DTS”,function(){a._fnScroll.call(a)});this.s.dt.aoDrawCallback.push({fn:function(){a.s.dt.bInitialised&amp;&amp;a._fnDrawCallback.call(a)},sName:“Scroller”});e(m).on(“resize.DTS”,function(){a.fnMeasure(false);a._fnInfo()});var
b=!0;this.s.dt.oApi._fnCallbackReg(this.s.dt,
...
scroll.DTS”);e(a.s.dt.nTableWrapper).removeClass(“DTS”);
e(“div.DTS_Loading”,a.dom.scroller.parentNode).remove();a.dom.table.style.position=“”;a.dom.table.style.top=“”;a.dom.table.style.left=“”}})}else
this.s.dt.oApi._fnLog(this.s.dt,0,“Pagination must be enabled for
Scroller”)},_fnScroll:function(){var
a=this,b=this.s.heights,c=this.dom.scroller.scrollTop,d;if(!this.s.skip&amp;&amp;!this.s.ingnoreScroll)if(this.s.dt.bFiltered||this.s.dt.bSorted)this.s.lastScrollTop=0;else{this._fnInfo();clearTimeout(this.s.stateTO);this.s.stateTO=setTimeout(function(){a.s.dt.oApi._fnSaveState(a.s.dt)},
250);if(c&lt;this.s.redrawTop||c&gt;this.s.redrawBottom){var
f=Math.ceil((this.s.displayBuffer-1)/2*this.s.viewportRows);Math.abs(c-this.s.lastScrollTop)&gt;b.viewport||this.s.ani?(d=parseInt(this._domain(“physicalToVirtual”,c)/b.row,10)-f,this.s.topRowFloat=this._domain(“physicalToVirtual”,c)/b.row):(d=this.fnPixelsToRow©-f,this.s.topRowFloat=this.fnPixelsToRow(c,!1));0&gt;=d?d=0:d+this.s.dt._iDisplayLength&gt;this.s.dt.fnRecordsDisplay()?(d=this.s.dt.fnRecordsDisplay()-this.s.dt._iDisplayLength,0&gt;d&amp;&amp;(d=0)):
...
“block”),this.s.loaderVisible=!0}this.s.lastScrollTop=c;this.s.stateSaveThrottle()}},_domain:function(a,b){var
c=this.s.heights,d;if(c.virtual===c.scroll){d=(c.virtual-c.viewport)/(c.scroll-c.viewport);if(“virtualToPhysical”===a)return
b/d;if(“physicalToVirtual”===a)return b*d}var
e=(c.scroll-c.viewport)/2,h=(c.virtual-c.viewport)/2;d=h/(e*e);if(“virtualToPhysical”===a){if(b&lt;h)return
Math.pow(b/d,0.5);b=2*h-b;return
0&gt;b?c.scroll:2*e-Math.pow(b/d,0.5)}if(“physicalToVirtual”===a){if(b&lt;e)return
b*b* d;b=2*e-b;return
0&gt;b?c.virtual:2*h-b*b*d}},_fnDrawCallback:function(){var
...
var
j=c-(this.s.topRowFloat-f)*b.row;0===f?j=0:f+h&gt;=g&amp;&amp;(j=b.scroll-d);this.dom.table.style.top=j+“px”;this.s.tableTop=j;this.s.tableBottom=d+this.s.tableTop;d=(c-this.s.tableTop)*this.s.boundaryScale;this.s.redrawTop=c-d;this.s.redrawBottom=c+d;this.s.skip=!1;this.s.dt.oFeatures.bStateSave&amp;&amp;null!==this.s.dt.oLoadedState&amp;&amp;“undefined”!=typeof
...
setTimeout(function(){e(a.dom.scroller).scrollTop(a.s.dt.oLoadedState.iScroller);a.s.redrawTop=a.s.dt.oLoadedState.iScroller-b.viewport/2;setTimeout(function(){a.s.ingnoreScroll=!1},0)},0):a.s.ingnoreScroll=!1;setTimeout(function(){a._fnInfo.call(a)},0);this.dom.loader&amp;&amp;this.s.loaderVisible&amp;&amp;(this.dom.loader.css(“display”,“none”),this.s.loaderVisible=!1)},_fnScrollForce:function(){var
a=this.s.heights;a.virtual=a.row*this.s.dt.fnRecordsDisplay();a.scroll=a.virtual;1E6&lt;a.scroll&amp;&amp;(a.scroll=1E6);this.dom.force.style.height=
a.scroll+“px”},_fnCalcRowHeight:function(){var
a=this.s.dt,b=a.nTable,c=b.cloneNode(!1),d=e(“&lt;tbody/&gt;”).appendTo©,f=e(&#39;&lt;div
class=“&#39;<code>a.oClasses.sWrapper</code>&#39; DTS”&gt;&lt;div
class=“&#39;<code>a.oClasses.sScrollWrapper</code>&#39;”&gt;&lt;div
class=“&#39;<code>a.oClasses.sScrollBody</code>&#39;”&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&#39;);for(e(“tbody
tr:lt(4)”,b).clone().appendTo(d);3&gt;e(“tr”,d).length;)d.append(“&lt;tr&gt;&lt;td&gt;&amp;nbsp;&lt;/td&gt;&lt;/tr&gt;”);e(“div.”+a.oClasses.sScrollBody,f).append©;a._bInitComplete?a=b.parentNode:(this.s.dt.nHolding||(this.s.dt.nHolding=e(“&lt;div&gt;&lt;/div&gt;”).insertBefore(this.s.dt.nTable)),
a=this.s.dt.nHolding);f.appendTo(a);this.s.heights.row=e(“tr”,d).eq(1).outerHeight();f.remove()},_fnInfo:function(){if(this.s.dt.oFeatures.bInfo){var
a=this.s.dt,b=a.oLanguage,c=this.dom.scroller.scrollTop,d=Math.floor(this.fnPixelsToRow(c,!1,this.s.ani)+1),f=a.fnRecordsTotal(),h=a.fnRecordsDisplay(),c=Math.ceil(this.fnPixelsToRow(c+this.s.heights.viewport,!1,this.s.ani)),c=h&lt;c?h:c,g=a.fnFormatNumber(d),j=a.fnFormatNumber©,i=a.fnFormatNumber(f),k=a.fnFormatNumber(h),g=0===a.fnRecordsDisplay()&amp;&amp;
a.fnRecordsDisplay()==a.fnRecordsTotal()?b.sInfoEmpty+b.sInfoPostFix:0===a.fnRecordsDisplay()?b.sInfoEmpty+“
”+b.sInfoFiltered.replace(“<em>MAX</em>”,i)+b.sInfoPostFix:a.fnRecordsDisplay()==a.fnRecordsTotal()?b.sInfo.replace(“<em>START</em>”,g).replace(“<em>END</em>”,j).replace(“<em>MAX</em>”,i).replace(“<em>TOTAL</em>”,k)+b.sInfoPostFix:b.sInfo.replace(“<em>START</em>”,g).replace(“<em>END</em>”,j).replace(“<em>MAX</em>”,i).replace(“<em>TOTAL</em>”,k)+“
”+b.sInfoFiltered.replace(“<em>MAX</em>”,a.fnFormatNumber(a.fnRecordsTotal()))+b.sInfoPostFix;(b=b.fnInfoCallback)&amp;&amp;
(g=b.call(a.oInstance,a,d,c,f,h,g));a=a.aanFeatures.i;if(“undefined”!=typeof
a){<a
href="d">d=0;for(f=a.length;d<f;d++)e(a</a>).html(g)}}}};g.defaults={trace:!1,rowHeight:“auto”,serverWait:200,displayBuffer:9,boundaryScale:0.5,loadingIndicator:!1};g.oDefaults=g.defaults;g.version=“1.2.2”;“function”==typeof
e.fn.dataTable&amp;&amp;“function”==typeof
...
b=a.oInit;return(new g(a,b.scroller||
b.oScroller||{})).dom.wrapper},cFeature:“S”,sFeature:“Scroller”}):alert(“Warning:
Scroller requires DataTables 1.9.0 or greater - <a
href="www.datatables.net/download");e.fn.dataTable.Scroller=g;e.fn.DataTable.Scroller=g;if(e.fn.dataTable.Api){var">www.datatables.net/download”);e.fn.dataTable.Scroller=g;e.fn.DataTable.Scroller=g;if(e.fn.dataTable.Api){var</a>
i=e.fn.dataTable.Api;i.register(“scroller()”,function(){return
this});i.register(“scroller().rowToPixels()”,function(a,b,c){var <a
href="0">d=this.context;if(d.length&&d</a>.oScroller)return <a
href="0">d</a>.oScroller.fnRowToPixels(a,b,c)});i.register(“scroller().pixelsToRow()”,function(a,
b,c){var <a href="0">d=this.context;if(d.length&&d</a>.oScroller)return <a
href="0">d</a>.oScroller.fnPixelsToRow(a,b,c)});i.register(“scroller().scrollToRow()”,function(a,b){this.iterator(“table”,function©{c.oScroller&amp;&amp;c.oScroller.fnScrollToRow(a,b)});return
this});i.register(“scroller().measure()”,function(a){this.iterator(“table”,function(b){b.oScroller&amp;&amp;b.oScroller.fnMeasure(a)});return
this})}return g};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,l):“object”===typeof
exports?l(require(“jquery”),
require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.Scroller&amp;&amp;l(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
