...
<title>dataTables.scroller.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Scroller/js/dataTables.scroller.js">
...
<pre> Scroller is a virtual rendering plug-in for DataTables which allows large
...
<p>var Scroller = function ( oDTSettings, oOpts ) {</p>

<pre>     /* Sanity check - you just know it will happen   
...
/
     ...
     /* Let&#39;s do it */
     this._fnConstruct();</pre>

<p>};</p>

<p>Scroller.prototype = /** @lends Scroller.prototype */{</p>
...
<pre> Scroller default settings for initialisation
  @namespace
  @name Scroller.defaults
  @static
/</pre>

<p>Scroller.defaults = /** @lends Scroller.defaults */{</p>
...
/
     &quot;loadingIndicator&quot;: false</pre>

<p>};</p>

<p>Scroller.oDefaults = Scroller.defaults;</p>
...
<pre class="ruby"><span class="ruby-identifier">alert</span>( <span class="ruby-string">&quot;Warning: Scroller requires DataTables 1.9.0 or greater - www.datatables.net/download&quot;</span>);
</pre>

<p>}</p>

<p>// Attach Scroller to DataTables so it can be accessed as an
&#39;extra&#39; $.fn.dataTable.Scroller = Scroller; $.fn.DataTable.Scroller
= Scroller;</p>

<p>// DataTables 1.10 API method aliases if ( $.fn.dataTable.Api ) {</p>

<pre>var Api = $.fn.dataTable.Api;
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.Scroller ) {</p>
