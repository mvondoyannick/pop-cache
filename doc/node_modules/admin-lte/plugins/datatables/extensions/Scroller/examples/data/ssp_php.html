...
<title>ssp.php - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Scroller/examples/data/ssp.php">

<p>&lt;?php</p>

<pre>DataTables example server-side processing script.
...
@license MIT - http://datatables.net/license_mit</pre>

<p>/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
* *</p>

<pre> Easy set variables
/</pre>

<p>// DB table to use $table = &#39;massive&#39;;</p>

<p>// Table&#39;s primary key $primaryKey = &#39;id&#39;;</p>

<p>// Array of database columns which should be read and sent back to
DataTables. // The `db` parameter represents the column name in the
database, while the `dt` // parameter represents the DataTables column
identifier. In this case simple // indexes $columns = array(</p>

<pre>array( &#39;db&#39; =&gt; &#39;id&#39;,         &#39;dt&#39; =&gt; 0 ),
array( &#39;db&#39; =&gt; &#39;firstname&#39;,  &#39;dt&#39; =&gt; 1 ),
array( &#39;db&#39; =&gt; &#39;surname&#39;,    &#39;dt&#39; =&gt; 2 ),
array( &#39;db&#39; =&gt; &#39;zip&#39;,        &#39;dt&#39; =&gt; 3 ),
array( &#39;db&#39; =&gt; &#39;country&#39;,    &#39;dt&#39; =&gt; 4 )</pre>

<p>);</p>

<p>// SQL server connection information $sql_details = array(</p>
...
<pre> If you just want to use the basic configuration for DataTables with PHP
 server-side, there is no need to edit below this line.
/</pre>

<p>require( &#39;../../../../examples/server_side/scripts/ssp.class.php&#39;
);</p>

<p>echo json_encode(</p>

<pre class="ruby"><span class="ruby-constant">SSP</span><span class="ruby-operator">::</span><span class="ruby-identifier">simple</span>( <span class="ruby-identifier">$_GET</span>, <span class="ruby-identifier">$sql_details</span>, <span class="ruby-identifier">$table</span>, <span class="ruby-identifier">$primaryKey</span>, <span class="ruby-identifier">$columns</span> )
</pre>
