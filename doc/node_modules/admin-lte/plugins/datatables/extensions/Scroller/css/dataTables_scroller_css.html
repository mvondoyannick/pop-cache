...
<title>dataTables.scroller.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/Scroller/css/dataTables.scroller.css">

<pre>Namespace: DTS (DataTables Scroller)</pre>

<p>div.DTS tbody th, div.DTS tbody td {</p>

<pre>white-space: nowrap;</pre>

<p>}</p>

<p>div.DTS tbody tr.even {</p>

<pre>background-color: white;</pre>

<p>}</p>

<p>div.DTS div.DTS_Loading {</p>
...
<p>div.DTS div.dataTables_scrollHead, div.DTS div.dataTables_scrollFoot {</p>

<pre>background-color: white;</pre>

<p>}</p>

<p>div.DTS div.dataTables_scrollBody {</p>

<pre>z-index: 2;</pre>

<p>}</p>

<p>div.DTS div.dataTables_scroll {</p>

<pre>background: url(&#39;../images/loading-background.png&#39;) repeat 0 0;</pre>
