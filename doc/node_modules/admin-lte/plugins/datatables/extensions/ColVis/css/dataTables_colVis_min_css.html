...
<title>dataTables.colVis.min.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColVis/css/dataTables.colVis.min.css">

<p>div.ColVis{float:right;margin-bottom:1em}button.ColVis_Button,ul.ColVis_collection
li{position:relative;float:left;margin-right:3px;padding:5px 8px;border:1px
solid #999;cursor:pointer;*cursor:hand;font-size:0.88em;color:black
!important;white-space:nowrap;-webkit-border-radius:2px;-moz-border-radius:2px;-ms-border-radius:2px;-o-border-radius:2px;border-radius:2px;-webkit-box-shadow:1px
...
)}.ColVis_Button:hover,ul.ColVis_collection li:hover{border:1px solid
#666;text-decoration:none !important;-webkit-box-shadow:1px 1px 3px
...
)}button.ColVis_Button{height:30px;padding:3px
8px}button.ColVis_Button::-moz-focus-inner{border:none
!important;padding:0}button.ColVis_Button:active{outline:none}div.ColVis_collectionBackground{position:fixed;top:0;left:0;height:100%;width:100%;background-color:black;z-index:1100}ul.ColVis_collection{list-style:none;width:150px;padding:8px
8px 4px 8px;margin:0;border:1px solid ccc;border:1px solid
...
rgba(0,0,0,0.3);-ms-box-shadow:3px 3px 5px
rgba(0,0,0,0.3);-o-box-shadow:3px 3px 5px rgba(0,0,0,0.3);box-shadow:3px
3px 5px rgba(0,0,0,0.3)}ul.ColVis_collection
li{position:relative;height:auto;left:0;right:0;padding:0.5em;display:block;float:none;margin-bottom:4px;-webkit-box-shadow:1px
1px 3px #999;-moz-box-shadow:1px 1px 3px #999;-ms-box-shadow:1px 1px 3px
#999;-o-box-shadow:1px 1px 3px #999;box-shadow:1px 1px 3px
#999}ul.ColVis_collection li{text-align:left}ul.ColVis_collection
li.ColVis_Button:hover{border:1px solid
#999;background-color:#f0f0f0}ul.ColVis_collection li
span{display:inline-block;padding-left:0.5em;cursor:pointer}ul.ColVis_collection
li.ColVis_Special{border-color:#555;background:#ededed;background:-webkit-linear-gradient(top,
ededed 0%, d6d6d6 77%, e8e8e8 100%);background:-moz-linear-gradient(top,
ededed 0%, d6d6d6 77%, e8e8e8 100%);background:-ms-linear-gradient(top,
ededed 0%, d6d6d6 77%, e8e8e8 100%);background:-o-linear-gradient(top,
ededed 0%, d6d6d6 77%, e8e8e8 100%);background:linear-gradient(to bottom,
ededed 0%, d6d6d6 77%, e8e8e8
100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=&#39;#ededed&#39;,
endColorstr=&#39;#e8e8e8&#39;,GradientType=0 )}ul.ColVis_collection
li.ColVis_Special:hover{background:#e2e2e2;background:-webkit-linear-gradient(top,
d0d0d0 0%, d5d5d5 89%, e2e2e2 100%);background:-moz-linear-gradient(top,
d0d0d0 0%, d5d5d5 89%, e2e2e2 100%);background:-ms-linear-gradient(top,
d0d0d0 0%, d5d5d5 89%, e2e2e2 100%);background:-o-linear-gradient(top,
d0d0d0 0%, d5d5d5 89%, e2e2e2 100%);background:linear-gradient(top, d0d0d0
0%, d5d5d5 89%, e2e2e2
100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=&#39;#f3f3f3&#39;,
endColorstr=&#39;#e2e2e2&#39;,GradientType=0
)}span.ColVis_radio{display:inline-block;width:20px}div.ColVis_catcher{position:absolute;z-index:1101}.disabled{color:#999}</p>
</main>
