...
<title>dataTables.colVis.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColVis/js/dataTables.colVis.js">
...
<pre> ColVis provides column visibility control for DataTables
...
<p>var ColVis = function( oDTSettings, oInit ) {</p>
...
<pre>Static object methods
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */</pre>

<p>/**</p>

<pre> Rebuild the collection for a given table, or all tables if no parameter given
...
<p>ColVis.fnRebuild = function ( oTable ) {</p>
...
<pre>Static object properties
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */</pre>

<p>/**</p>

<pre> Collection of all ColVis instances
...
<p>ColVis.prototype.CLASS = “ColVis”;</p>
...
<p>ColVis.VERSION = “1.1.2”; ColVis.prototype.VERSION = ColVis.VERSION;</p>
...
$.fn.dataTableExt.fnVersionCheck(&#39;1.7.0&#39;) )</pre>
...
<pre class="ruby"><span class="ruby-identifier">alert</span>( <span class="ruby-string">&quot;Warning: ColVis requires DataTables 1.7 or greater - www.datatables.net/download&quot;</span>);
</pre>

<p>}</p>

<p>// Make ColVis accessible from the DataTables instance
$.fn.dataTable.ColVis = ColVis; $.fn.DataTable.ColVis = ColVis;</p>

<p>return ColVis; }; // /factory</p>
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.ColVis ) {</p>
