...
<title>dataTables.colVis.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColVis/js/dataTables.colVis.min.js">

<pre> !
ColVis 1.1.2
©2010-2015 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(j,i,k){j=function(d){var
e=function(a,b){(!this.CLASS||“ColVis”!=this.CLASS)&amp;&amp;alert(“Warning:
ColVis must be initialised with the keyword
&#39;new&#39;”);“undefined”==typeof b&amp;&amp;(b={});var
c=d.fn.dataTable.camelToHungarian;c&amp;&amp;(c(e.defaults,e.defaults,!0),c(e.defaults,b));this.s={<a
href="">dt:null,oInit:b,hidden:!0,abOriginal:[]};this.dom={wrapper:null,button:null,collection:null,background:null,catcher:null,buttons:</a>,groupButtons:[],restore:null};e.aInstances.push(this);this.s.dt=d.fn.dataTable.Api?(new
<a href="0">d.fn.dataTable.Api(a)).settings()</a>:
...
ui-state-default”}).append(“&lt;span&gt;”<code>this.s.buttonText</code>“&lt;/span&gt;”).bind(“mouseover”==this.s.activate?“mouseover”:“click”,function(a){a.preventDefault();b._fnCollectionShow()}).<a
href="0">appendTo(this.dom.wrapper)</a>;this.dom.catcher=this._fnDomCatcher();this.dom.collection=this._fnDomCollection();
<a
href="c">this.dom.background=this._fnDomBackground();this._fnAddGroups();this._fnAddButtons();c=0;for(f=this.s.dt.aoColumns.length;c<f;c++)this.s.abOriginal.push(this.s.dt.aoColumns</a>.bVisible);this.s.dt.aoDrawCallback.push({fn:function(){b._fnDrawCallback.call(b)},sName:“ColVis”});d(this.s.dt.oInstance).bind(“column-reorder.dt”,function(a,d,e){<a
href="c">c=0;for(f=b.s.aiExclude.length;c<f;c++)b.s.aiExclude</a>=<a
href="c">e.aiInvertMapping[b.s.aiExclude</a>];<a
href="0">a=b.s.abOriginal.splice(e.iFrom,1)</a>;b.s.abOriginal.splice(e.iTo,0,a);
...
a=this.s.groups,b=this.s.aoGroups;if(a)for(var <a
href="c">c=0,f=a.length;c<f;c++)if(a</a>.<a href="c">title&&(b</a>.<a
href="c">sTitle=a</a>.<a href="c">title),a</a>.<a href="c">columns)b</a>.<a
href="c">aiColumns=a</a>.columns},_fnDrawCallback:function(){for(var a= <a
href="g">this.s.dt.aoColumns,b=this.dom.buttons,c=this.s.aoGroups,f,g=0,h=b.length;g<h;g++)f=b</a>,<a
href="f.__columnIdx">f.__columnIdx!==k&&d(“input”,f).prop(“checked”,a</a>.bVisible);b=0;for(f=c.length;b&lt;f;b++){a:{for(var
<a href="b">g=c</a>.<a
href="h">aiColumns,h=0,e=g.length;h<e;h++)if(!1===a[g</a>].bVisible){g=!1;break
a}g=!0}<a href="b">if(g)d(“input”,this.dom.groupButtons</a>).<a
href="b">prop(“checked”,!0),d(“input”,this.dom.groupButtons</a>).prop(“indeterminate”,!1);else{a:{<a
href="b">g=c</a>.<a
href="h">aiColumns;h=0;for(e=g.length;h<e;h++)if(!0===a[g</a>].bVisible){g=!1;break
a}g=!0}g? (<a href="b">d(“input”,this.dom.groupButtons</a>).<a
href="b">prop(“checked”,!1),d(“input”,this.dom.groupButtons</a>).<a
href="b">prop(“indeterminate”,!1)):d(“input”,this.dom.groupButtons</a>).prop(“indeterminate”,!0)}}},_fnAddGroups:function(){var
...
c=
0,f=b.length;c&lt;f;c++)-1===d.inArray(c,this.s.aiExclude)&amp;&amp;(a=this._fnDomColumnButton©,a.__columnIdx=c,this.dom.buttons.push(a));“alpha”===this.s.order&amp;&amp;this.dom.buttons.sort(function(a,c){var
<a href="a.__columnIdx">d=b</a>.<a
href="c.__columnIdx">sTitle,f=b</a>.sTitle;return
...
a=this;return d(&#39;&lt;li class=“ColVis_Special
&#39;+(this.s.dt.bJUI?”ui-button
ui-state-default“:”“)+&#39;”&gt;&#39;<code>this.s.restore</code>“&lt;/li&gt;”).click(function(){for(var
<a
href="b">b=0,c=a.s.abOriginal.length;b<c;b++)a.s.dt.oInstance.fnSetColumnVis(b,a.s.abOriginal</a>,!1);a._fnAdjustOpenRows();a.s.dt.oInstance.fnAdjustColumnSizing(!1);a.s.dt.oInstance.fnDraw(!1)})[0]},
_fnDomShowXButton:function(a,b){var c=this;return d(&#39;&lt;li
class=“ColVis_Special &#39;+(this.s.dt.bJUI?”ui-button
ui-state-default“:”“)+&#39;”&gt;&#39;<code>a</code>“&lt;/li&gt;”).click(function(){for(var
...
<a href="a">b=this,c=this.s.aoGroups</a>;return d(&#39;&lt;li
class=“ColVis_Special &#39;+(this.s.dt.bJUI?”ui-button ui-state-default“:
”“)+&#39;”&gt;&lt;label&gt;&lt;input type=“checkbox”
/&gt;&lt;span&gt;&#39;<code>c.sTitle</code>“&lt;/span&gt;&lt;/label&gt;&lt;/li&gt;”).click(function(a){var
<a
href="a">g=!d(“input”,this).is(“:checked”);“li”!==a.target.nodeName.toLowerCase()&&(g=!g);for(a=0;a<c.aiColumns.length;a++)b.s.dt.oInstance.fnSetColumnVis(c.aiColumns</a>,g)})[0]},_fnDomColumnButton:function(a){var
<a
href="a">b=this,c=this.s.dt.aoColumns</a>,f=this.s.dt,c=null===this.s.fnLabel?c.sTitle:this.s.fnLabel(a,c.sTitle,c.nTh);return
d(“&lt;li ”+(f.bJUI?&#39;class=“ui-button
ui-state-default”&#39;:“”)+&#39;&gt;&lt;label&gt;&lt;input type=“checkbox”
/&gt;&lt;span&gt;&#39;+
c+“&lt;/span&gt;&lt;/label&gt;&lt;/li&gt;”).click(function©{var
...
<a
href="a">a=0,b=this.s.dt.oInstance.length;a<b;a++)if(this.s.dt.oInstance</a>==this.s.dt.nTable)return
...
null)});return <a href="0">b</a>},_fnCollectionShow:function(){var
a=this,b;b=d(this.dom.button).offset();var
c=this.dom.collection,f=this.dom.background,e=parseInt(b.left,10),h=parseInt(b.top+d(this.dom.button).outerHeight(),10);this.s.bCssPosition||(c.style.top=h+“px”,c.style.left=e+“px”);d©.css({display:“block”,opacity:0});f.style.bottom=“0px”;f.style.right=“0px”;h=this.dom.catcher.style;h.height=d(this.dom.button).outerHeight()+“px”;h.width=d(this.dom.button).outerWidth()+“px”;h.top=b.top+“px”;h.left=e+
“px”;i.body.appendChild(f);i.body.appendChild©;i.body.appendChild(this.dom.catcher);d©.animate({opacity:1},a.s.iOverlayFade);d(f).animate({opacity:0.1},a.s.iOverlayFade,“linear”,function(){d.browser&amp;&amp;(d.browser.msie&amp;&amp;d.browser.version==“6.0”)&amp;&amp;a._fnDrawCallback()});this.s.bCssPosition||(b=“left”==this.s.sAlign?e:e-d©.outerWidth()+d(this.dom.button).outerWidth(),c.style.left=b+“px”,f=d©.outerWidth(),d©.outerHeight(),e=d(i).width(),b+f&gt;e&amp;&amp;(c.style.left=e-f+“px”));this.s.hidden=!1},_fnCollectionHide:function(){var
a=
...
<a
href="c">a=this.s.dt.aoOpenRows,b=this.s.dt.oApi._fnVisbleColumns(this.s.dt),c=0,d=a.length;c<d;c++)a</a>.<a
href="0">nTr.getElementsByTagName(“td”)</a>.colSpan=b}};e.fnRebuild=
function(a){var b=null;“undefined”!=typeof
a&amp;&amp;(b=d.fn.dataTable.Api?(new
d.fn.dataTable.Api(a)).table().node():a.fnSettings().nTable);for(var
c=0,f=e.aInstances.length;c&lt;f;c++)(“undefined”==typeof <a
href="c">a||b==e.aInstances</a>.<a
href="c">s.dt.nTable)&&e.aInstances</a>.fnRebuild()};e.defaults={active:“click”,buttonText:“Show
...
ColVis requires DataTables 1.7 or greater - <a
href="www.datatables.net/download");d.fn.dataTable.ColVis=e;return">www.datatables.net/download”);d.fn.dataTable.ColVis=e;return</a>
d.fn.DataTable.ColVis= e};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,j):“object”===typeof
exports?j(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.ColVis&amp;&amp;j(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
