...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-ColVis">ColVis</a>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColVis/Readme.md">

<h1 id="label-ColVis">ColVis<span><a href="#label-ColVis">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>ColVis adds a button to the toolbars around DataTables which gives the end
user of the table the ability to dynamically change the visibility of the
columns in the table:</p>
<ul><li>
<p>Dynamically show and hide columns in a table</p>
</li><li>
<p>Very easy integration with DataTables</p>
</li><li>
<p>Ability to exclude columns from being either hidden or shown</p>
</li><li>
<p>Save saving integration with DataTables</p>
</li></ul>

<h1 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>To use ColVis, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped ColVis package into a <code>extensions</code> directory
in the DataTables package. This will allow the pages in the examples to
operate correctly. To see the examples running, open the
...
<p>ColVis is initialised using the <code>C</code> option that it adds to
...
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/colvis">datatables.net/extensions/colvis</a>/</p>
</li><li>
...
<p>If you fancy getting involved with the development of ColVis and help make
it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/ColVis">github.com/DataTables/ColVis</a></p>
</main>
