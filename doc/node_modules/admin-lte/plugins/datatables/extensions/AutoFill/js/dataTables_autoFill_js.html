...
<title>dataTables.autoFill.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/AutoFill/js/dataTables.autoFill.js">
...
<pre> AutoFill provides Excel like auto-fill features for a DataTable
...
<p>var AutoFill = function( oDT, oConfig ) {</p>

<pre>     /* Sanity check that we are a new instance   
...
<p>// Alias for access DataTable.AutoFill = AutoFill; DataTable.AutoFill =
AutoFill;</p>
...
<pre> AutoFill version
  @constant  version
  @type      String
  @default   See code
/</pre>

<p>AutoFill.version = “1.2.1”;</p>

<p>/**</p>

<pre> AutoFill defaults
  @namespace
/</pre>

<p>AutoFill.defaults = {</p>
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.AutoFill ) {</p>
