...
<title>dataTables.autoFill.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/AutoFill/js/dataTables.autoFill.min.js">

<pre> !
AutoFill 1.2.1
©2008-2014 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(o,j,m){var l=function(c,k){var h=function(d,b){if(!(this
instanceof h))throw“Warning: AutoFill must be initialised with the keyword
&#39;new&#39;”;if(!c.fn.dataTableExt.fnVersionCheck(“1.7.0”))throw“Warning:
AutoFill requires DataTables 1.7 or
greater”;this.c={};this.s={filler:{height:0,width:0},border:{width:2},drag:{startX:-1,startY:-1,startTd:null,endTd:null,dragging:!1},screen:{interval:null,y:0,height:0,scrollTop:0},scroller:{top:0,bottom:0},columns:[]};this.dom={table:null,filler:null,borderTop:null,
borderRight:null,borderBottom:null,borderLeft:null,currentTarget:null};this.fnSettings=function(){return
this.s};this._fnInit(d,b);return
this};h.prototype={_fnInit:function(d,b){var a=this;this.s.dt=k.Api?(new <a
href="0">k.Api(d)).settings()</a>:d.fnSettings();this.s.init=b||{};this.dom.table=this.s.dt.nTable;c.extend(!0,this.c,h.defaults,b);this._initColumns();var
e=c(“&lt;div/&gt;”,{“class”:“AutoFill_filler”}).<a
href="0">appendTo(“body”);this.dom.filler=e</a>;<a
href="0">this.s.filler.height=e.height();this.s.filler.width=e.width();e</a>.style.display=
“none”;var
g,f=j.body;“”!==a.s.dt.oScroll.sY&amp;&amp;(a.s.dt.nTable.parentNode.style.position=“relative”,f=a.s.dt.nTable.parentNode);g=c(“&lt;div/&gt;”,{“class”:“AutoFill_border”});<a
href="0">this.dom.borderTop=g.clone().appendTo(f)</a>;<a
href="0">this.dom.borderRight=g.clone().appendTo(f)</a>;<a
href="0">this.dom.borderBottom=g.clone().appendTo(f)</a>;<a
href="0">this.dom.borderLeft=g.clone().appendTo(f)</a>;e.on(“mousedown.DTAF”,function(b){this.onselectstart=function(){return
false};a._fnFillerDragStart.call(a,b);return
false});c(“tbody”,this.dom.table).on(“mouseover.DTAF mouseout.DTAF”,
“&gt;tr&gt;td,
&gt;tr&gt;th”,function(b){a._fnFillerDisplay.call(a,b)});c(this.dom.table).on(“destroy.dt.DTAF”,function(){e.off(“mousedown.DTAF”).remove();c(“tbody”,this.dom.table).off(“mouseover.DTAF
mouseout.DTAF”)})},_initColumns:function(){var <a
href="b">d=this,b,a,e=this.s.dt,g=this.s.init;b=0;for(a=e.aoColumns.length;b<a;b++)this.s.columns</a>=c.extend(!0,{},h.defaults.column);e.oApi._fnApplyColumnDefs(e,g.aoColumnDefs||g.columnDefs,g.aoColumns||g.columns,function(a,b){d._fnColumnOptions(a,b)});b=0;for(a=e.aoColumns.length;b&lt;
<a
href="b">a;b++)if(e=this.s.columns</a>,e.read||(e.read=this._fnReadCell),e.write||(e.read=this._fnWriteCell),!e.step)e.read=this._fnStep},_fnColumnOptions:function(d,b){var
<a href="d">a=this.s.columns</a>,c=function(c,d){<a href="0">b[d</a>]!==<a
href="c">m&&(a</a>=<a href="0">b[d</a>]);<a href="1">b[d</a>]!==<a
href="c">m&&(a</a>=<a href="1">b[d</a>])};<a
href=""bEnable","enable"">c(“enable”,</a>);<a
href=""fnRead","read"">c(“read”,</a>);<a
href=""fnWrite","write"">c(“write”,</a>);<a
href=""fnStep","step"">c(“step”,</a>);<a
href=""bIncrement","increment"">c(“increment”,</a>)},_fnTargetCoords:function(d){var
<a
href="0">b=c(d).parents(“tr”)</a>,a=this.s.dt.oInstance.fnGetPosition(d);
return{<a
href="0">x:c(“td”,b).index(d),y:c(“tr”,b.parentNode).index(b),row:a</a>,<a
href="2">column:a</a>}},_fnUpdateBorder:function(d,b){var
a=this.s.border.width,e=c(d).offset(),g=c(b).offset(),f=e.left-a,i=g.left+c(b).outerWidth(),n=e.top-a,h=g.top+c(b).outerHeight(),j=g.left+c(b).outerWidth()-e.left+2*a,k=g.top+c(b).outerHeight()-e.top+2*a;e.left&gt;g.left&amp;&amp;(f=g.left-a,i=e.left+c(d).outerWidth(),j=e.left+c(d).outerWidth()-g.left+2*a);“”!==this.s.dt.oScroll.sY&amp;&amp;(a=c(this.s.dt.nTable.parentNode).offset(),e=c(this.s.dt.nTable.parentNode).scrollTop(),
...
“px”},_fnFillerDragStart:function(d){var
b=this,a=this.dom.currentTarget;this.s.drag.dragging=!0;b.dom.borderTop.style.display=“block”;b.dom.borderRight.style.display=“block”;b.dom.borderBottom.style.display=“block”;b.dom.borderLeft.style.display=“block”;var
e=this._fnTargetCoords(a);this.s.drag.startX=e.x;this.s.drag.startY=e.y;this.s.drag.startTd=a;this.s.drag.endTd=a;this._fnUpdateBorder(a,a);c(j).bind(“mousemove.AutoFill”,function(a){b._fnFillerDragMove.call(b,a)});c(j).bind(“mouseup.AutoFill”,
...
a=c(j).scrollTop();b.s.screen.y=b.s.screen.y+(a-b.s.screen.scrollTop);b.s.screen.height-b.s.screen.y+a&lt;50?c(“html,
body”).animate({scrollTop:a+
50},240,“linear”):b.s.screen.y-a&lt;50&amp;&amp;c(“html,
...
b= <a
href="0">this._fnTargetCoords(d.target);“y”==this.c.mode&&b.x!=this.s.drag.startX&&(d.target=c(“tbody>tr:eq(”b.y“)>td:eq(”this.s.drag.startX“)”,this.dom.table)</a>);“<a
href="0">x”==this.c.mode&&b.y!=this.s.drag.startY&&(d.target=c(“tbody>tr:eq(”this.s.drag.startY“)>td:eq(”b.x“)”,this.dom.table)</a>);“<a
href="0">either”==this.c.mode&&(b.x!=this.s.drag.startX?d.target=c(“tbody>tr:eq(”this.s.drag.startY“)>td:eq(”b.x“)”,this.dom.table)</a>:b.y!=this.s.drag.startY&amp;&amp;(d.target=c(“tbody&gt;tr:eq(”<code>b.y</code>“)&gt;td:eq(”<code>this.s.drag.startX</code>
“)”,<a
href="0">this.dom.table)</a>));“both”!==this.c.mode&amp;&amp;(b=this._fnTargetCoords(d.target));var
a=this.s.drag;a.endTd=d.target;b.y&gt;=this.s.drag.startY?this._fnUpdateBorder(a.startTd,a.endTd):this._fnUpdateBorder(a.endTd,a.startTd);this._fnFillerPosition(d.target)}this.s.screen.y=d.pageY;this.s.screen.scrollTop=c(j).scrollTop();“”!==this.s.dt.oScroll.sY&amp;&amp;(this.s.scroller.scrollTop=c(this.s.dt.nTable.parentNode).scrollTop(),this.s.scroller.top=c(this.s.dt.nTable.parentNode).offset().top,this.s.scroller.bottom=
this.s.scroller.top+c(this.s.dt.nTable.parentNode).height())},_fnFillerFinish:function(){var
d=this,b,a;c(j).unbind(“mousemove.AutoFill
mouseup.AutoFill”);this.dom.borderTop.style.display=“none”;this.dom.borderRight.style.display=“none”;this.dom.borderBottom.style.display=“none”;this.dom.borderLeft.style.display=“none”;this.s.drag.dragging=!1;clearInterval(this.s.screen.interval);var
e=[],g=this.dom.table,f=this._fnTargetCoords(this.s.drag.startTd),i=this._fnTargetCoords(this.s.drag.endTd),h=function(a){return
d.s.dt.oApi._fnVisibleToColumnIndex(d.s.dt,
a)};if(f.y&lt;=i.y)for(b=f.y;b&lt;=i.y;b++)if(f.x&lt;=i.x)for(a=f.x;a&lt;=i.x;a++)e.push({<a
href="0">node:c(“tbody>tr:eq(”b“)>td:eq(”a“)”,g)</a>,x:a-f.x,y:b-f.y,colIdx:h(a)});else
for(a=f.x;a&gt;=i.x;a–)e.push({<a
href="0">node:c(“tbody>tr:eq(”b“)>td:eq(”a“)”,g)</a>,x:a-f.x,y:b-f.y,colIdx:h(a)});else
for(b=f.y;b&gt;=i.y;b–)if(f.x&lt;=i.x)for(a=f.x;a&lt;=i.x;a++)e.push({<a
href="0">node:c(“tbody>tr:eq(”b“)>td:eq(”a“)”,g)</a>,x:a-f.x,y:b-f.y,colIdx:h(a)});else
for(a=f.x;a&gt;=i.x;a–)e.push({<a
href="0">node:c(“tbody>tr:eq(”b“)>td:eq(”a“)”,g)</a>,x:f.x-a,y:f.y-
b,colIdx:h(a)});if(!(1&gt;=e.length)){var
g=[],m;b=0;for(a=e.length;b&lt;a;b++){var <a href="b">f=e</a>,<a
href="f.colIdx">i=this.s.columns</a>,h=i.read.call(i,f.node),l=i.step.call(i,f.node,h,m,b,f.x,f.y);i.write.call(i,f.node,l);m=l;g.push({cell:f,colIdx:f.colIdx,newValue:l,oldValue:h})}null!==this.c.complete&amp;&amp;this.c.complete.call(this,g);k.Api?(new
k.Api(this.s.dt)).draw(!1):this.s.dt.oInstance.fnDraw()}},_fnFillerDisplay:function(d){var
b=this.dom.filler;if(!this.s.drag.dragging){var
a=“td”==d.target.nodeName.toLowerCase()? <a
href="0">d.target:c(d.target).parents(“td”)</a>,<a
href="e">e=this._fnTargetCoords(a).column;if(this.s.columns</a>.enable)if(“mouseover”==d.type)this.dom.currentTarget=a,this._fnFillerPosition(a),b.style.display=“block”;else{if(!d.relatedTarget||!d.relatedTarget.className.match(/AutoFill/))b.style.display=“none”}else
b.style.display=“none”}},_fnFillerPosition:function(d){var
b=c(d).offset(),a=this.dom.filler;a.style.top=b.top-this.s.filler.height/2-1+c(d).outerHeight()+“px”;a.style.left=b.left-this.s.filler.width/2-1+c(d).outerWidth()+
“px”}};k.AutoFill=h;k.AutoFill=h;h.version=“1.2.1”;h.defaults={mode:“y”,complete:null,column:{enable:!0,increment:!0,read:function(d){return
c(d).html()},write:function(d,b){var
a=c(d).parents(“table”);if(k.Api)a.DataTable().cell(d).data(b);else{var <a
href="0">a=a.dataTable(),e=a.fnGetPosition(d);a.fnUpdate(b,e</a>,<a
href="2">e</a>,!1)}},step:function(c,b,a,e,g,f){<a
href="1">c=/(-?d+)/;return(e=this.increment&&a?a.match©:null)?a.replace(c,parseInt(e</a>,10)+(0&gt;g||0&gt;f?-1:1)):a===m?b:a}}};return
h};“function”===typeof define&amp;&amp;define.amd? <a
href=""jquery","datatables"">define(</a>,l):“object”===typeof
exports?l(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.AutoFill&amp;&amp;l(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
