...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/AutoFill/Readme.txt">

<p># AutoFill</p>

<p>AutoFill gives an Excel like option to a DataTable to click and drag over
multiple cells, filling in information over the selected cells and
incrementing numbers as needed. Key features include:</p>
<ul><li>
<p>Click and drag cell content insertion</p>
</li><li>
<p>Automatic incrementing of numeric information</p>
</li><li>
<p>Enable and disable on any column</p>
</li><li>
<p>Detailed callback functions for customisation</p>
</li><li>
<p>Support for both DataTables and browser window scrolling</p>
</li></ul>

<p># Installation</p>

<p>To use AutoFill, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped AutoFill package into a `extensions` directory in the
...
<p>AutoFill is initialised using the `$.fn.dataTable.AutoFill` constructor.
For example:</p>

<p>“`js $(document).ready( function () {</p>

<pre>var table = $(&#39;#example&#39;).dataTable();
new $.fn.dataTable.AutoFill( table );</pre>
...
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/autofill">datatables.net/extensions/autofill</a>/</p>
</li><li>
...
<p>If you fancy getting involved with the development of AutoFill and help
make it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/AutoFill">github.com/DataTables/AutoFill</a></p>
</main>
