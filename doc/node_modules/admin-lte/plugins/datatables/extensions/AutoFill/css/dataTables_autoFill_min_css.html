...
<title>dataTables.autoFill.min.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/AutoFill/css/dataTables.autoFill.min.css">

<p>div.AutoFill_filler{display:none;position:absolute;height:14px;width:14px;background:url(../images/filler.png)
no-repeat center
...
0px 5px #76b4ff;-moz-box-shadow:0px 0px 5px #76b4ff;-webkit-box-shadow:0px
0px 5px #76b4ff}</p>
</main>
