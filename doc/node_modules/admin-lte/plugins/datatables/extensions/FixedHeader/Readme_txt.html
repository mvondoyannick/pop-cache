...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedHeader/Readme.txt">

<p># FixedHeader</p>

<p>At times it can be useful to ensure that column titles will remain always
visible on a table, even when a user scrolls down a table. The FixedHeader
plug-in for DataTables will float the &#39;thead&#39; element above the
table at all times to help address this issue. The column titles also
remain click-able to perform sorting. Key features include:</p>
<ul><li>
<p>Fix the header to the top of the window</p>
</li><li>
<p>Ability to fix the footer and left / right columns as well</p>
</li><li>
<p>z-Index ordering options</p>
</li></ul>

<p># Installation</p>

<p>To use FixedHeader, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped FixedHeader package into a `extensions` directory in the
...
<p>FixedHeader is initialised using the `$.fn.dataTable.FixedHeader()` object.
For example:</p>

<p>“`js $(document).ready( function () {</p>

<pre>var table = $(&#39;#example&#39;).dataTable();
new $.fn.dataTable.FixedHeader( table );</pre>
...
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/FixedHeader">datatables.net/extensions/FixedHeader</a>/</p>
</li><li>
...
<p>If you fancy getting involved with the development of FixedHeader and help
make it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/FixedHeader">github.com/DataTables/FixedHeader</a></p>
</main>
