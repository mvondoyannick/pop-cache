...
<title>dataTables.fixedHeader.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedHeader/js/dataTables.fixedHeader.js">

<pre>! FixedHeader 2.1.2
...
<p>/* Global scope for FixedColumns for backwards compatibility - will be
removed</p>

<pre> in future. Not documented in 1.1.x.
/</pre>

<p>/* Global scope for FixedColumns</p>
...
<p>FixedHeader = function ( mTable, oInit ) {</p>
...
/
     ...
     /* Let&#39;s do it */
     this.fnInit( dt, oInit );</pre>

<p>};</p>

<p>/*</p>

<pre> Variable: FixedHeader
 Purpose:  Prototype for FixedHeader
 Scope:    global
/</pre>

<p>FixedHeader.prototype = {</p>
...
<pre> Static properties and methods
...
<pre> Variable: afnScroll
 Purpose:  Array of functions that are to be used for the scrolling components
 Scope:    FixedHeader
/</pre>

<p>FixedHeader.afnScroll = [];</p>

<p>/*</p>

<pre> Function: fnMeasure
 Purpose:  Update the measurements for the window and document
 Returns:  -
 Inputs:   -
/</pre>

<p>FixedHeader.fnMeasure = function () {</p>
...
oWin.iScrollBottom = oDoc.iHeight - oWin.iScrollTop - oWin.iHeight;</pre>

<p>};</p>

<p>FixedHeader.version = “2.1.2”;</p>

<p>/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
* * * * * * * * * * *</p>

<pre> Global processing
/</pre>

<p>/*</p>

<pre> Just one &#39;scroll&#39; event handler in FixedHeader, which calls the required components. This is
 done as an optimisation, to reduce calculation and proagation time
/</pre>

<p>$(window).scroll( function () {</p>

<pre>FixedHeader.fnMeasure();
...
<p>$.fn.dataTable.FixedHeader = FixedHeader; $.fn.DataTable.FixedHeader =
FixedHeader;</p>

<p>return FixedHeader; }; // /factory</p>
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.FixedHeader ) {</p>
