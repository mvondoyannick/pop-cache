...
<title>dataTables.fixedHeader.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedHeader/js/dataTables.fixedHeader.min.js">

<pre> !
FixedHeader 2.1.2
©2010-2014 SpryMedia Ltd - datatables.net/license</pre>

<p>var FixedHeader; (function(j,k,h){var
l=function(e){FixedHeader=function(a,b){if(!this instanceof
FixedHeader)alert(“FixedHeader warning: FixedHeader must be initialised
with the &#39;new&#39; keyword.”);else{var
c={aoCache:[],oSides:{top:!0,bottom:!1,left:0,right:0},oZIndexes:{top:104,bottom:103,left:102,right:101},oCloneOnDraw:{top:!1,bottom:!1,left:!0,right:!0},oMes:{iTableWidth:0,iTableHeight:0,iTableLeft:0,iTableRight:0,iTableTop:0,iTableBottom:0},oOffset:{top:0},nTable:null,bFooter:!1,bInitComplete:!1};this.fnGetSettings=
function(){return
c};this.fnUpdate=function(){this._fnUpdateClones();this._fnUpdatePositions()};this.fnPosition=function(){this._fnUpdatePositions()};var
d=e.fn.dataTable.Api?(new <a
href="0">e.fn.dataTable.Api(a)).settings()</a>:a.fnSettings();d._oPluginFixedHeader=this;this.fnInit(d,b)}};FixedHeader.prototype={fnInit:function(a,b){var
c=this.fnGetSettings(),d=this;this.fnInitSettings(c,b);“”!==a.oScroll.sX||“”!==a.oScroll.sY?alert(“FixedHeader
2 is not supported with DataTables&#39; scrolling mode at this time”):
...
FixedHeader.fnMeasure(),d._fnUpdateClones(),d._fnUpdatePositions(),c.bInitComplete=!0)},fnInitSettings:function(a,b){if(b!==h&amp;&amp;(b.top!==h&amp;&amp;(a.oSides.top=b.top),b.bottom!==h&amp;&amp;(a.oSides.bottom=b.bottom),“boolean”==typeof
b.left?a.oSides.left=b.left?1:0:b.left!==h&amp;&amp;(a.oSides.left=b.left),“boolean”==typeof
b.right?a.oSides.right=b.right?1:0:b.right!==h&amp;&amp;(a.oSides.right=b.right),b.zTop!==h&amp;&amp;(a.oZIndexes.top=b.zTop),b.zBottom!==h&amp;&amp;(a.oZIndexes.bottom=b.zBottom),b.zLeft!==h&amp;&amp;(a.oZIndexes.left=b.zLeft),b.zRight!==
...
f=this.fnGetSettings(),g;“absolute”!=e(f.nTable.parentNode).css(“position”)&amp;&amp;(f.nTable.parentNode.style.position=“relative”);g=f.nTable.cloneNode(!1);
g.removeAttribute(“id”);var
i=k.createElement(“div”);i.style.position=“absolute”;i.style.top=“0px”;i.style.left=“0px”;i.className+=“
FixedHeader_Cloned ”<code>a</code>“
...
_fnMeasure:function(){var
a=this.fnGetSettings(),b=a.oMes,c=e(a.nTable),d=c.offset(),f=this._fnSumScroll(a.nTable.parentNode,“scrollTop”);this._fnSumScroll(a.nTable.parentNode,“scrollLeft”);b.iTableWidth=c.outerWidth();b.iTableHeight=c.outerHeight();b.iTableLeft=d.left+a.nTable.parentNode.scrollLeft;b.iTableTop=d.top+f;b.iTableRight=b.iTableLeft+b.iTableWidth;b.iTableRight=FixedHeader.oDoc.iWidth-b.iTableLeft-b.iTableWidth;b.iTableBottom=FixedHeader.oDoc.iHeight-b.iTableTop-b.iTableHeight},_fnSumScroll:function(a,
b){for(var <a href="b">c=a</a>;(<a
href="b">a=a.parentNode)&&!(“HTML”==a.nodeName||“BODY”==a.nodeName);)c=a</a>;return
c},_fnUpdatePositions:function(){var
a=this.fnGetSettings();this._fnMeasure();for(var <a
href="b">b=0,c=a.aoCache.length;b<c;b++)"fixedHeader"==a.aoCache</a>.<a
href="b">sType?this._fnScrollFixedHeader(a.aoCache</a>):“<a
href="b">fixedFooter”==a.aoCache</a>.<a
href="b">sType?this._fnScrollFixedFooter(a.aoCache</a>):“<a
href="b">fixedLeft”==a.aoCache</a>.<a
href="b">sType?this._fnScrollHorizontalLeft(a.aoCache</a>):<a
href="b">this._fnScrollHorizontalRight(a.aoCache</a>)},_fnUpdateClones:function(a){var
b= this.fnGetSettings();a&amp;&amp;(b.bInitComplete=!1);for(var <a
href="c">c=0,d=b.aoCache.length;c<d;c++)b.aoCache</a>.<a
href="c">fnClone.call(this,b.aoCache</a>);a&amp;&amp;(b.bInitComplete=!0)},_fnScrollHorizontalRight:function(a){var
b=this.fnGetSettings().oMes,c=FixedHeader.oWin,d=FixedHeader.oDoc,f=a.nWrapper,g=e(f).outerWidth();c.iScrollRight&lt;b.iTableRight?(this._fnUpdateCache(a,“sPosition”,“absolute”,“position”,f.style),this._fnUpdateCache(a,“sTop”,b.iTableTop+“px”,“top”,f.style),this._fnUpdateCache(a,“sLeft”,b.iTableLeft+b.iTableWidth-
g+“px”,“left”,f.style)):b.iTableLeft&lt;d.iWidth-c.iScrollRight-g?(this._fnUpdateCache(a,“sPosition”,“fixed”,“position”,f.style),this._fnUpdateCache(a,“sTop”,b.iTableTop-c.iScrollTop+“px”,“top”,f.style),this._fnUpdateCache(a,“sLeft”,c.iWidth-g+“px”,“left”,f.style)):(this._fnUpdateCache(a,“sPosition”,“absolute”,“position”,f.style),this._fnUpdateCache(a,“sTop”,b.iTableTop+“px”,“top”,f.style),this._fnUpdateCache(a,“sLeft”,b.iTableLeft+“px”,“left”,f.style))},_fnScrollHorizontalLeft:function(a){var
b=this.fnGetSettings().oMes,
...
(this._fnUpdateCache(a,“sPosition”,“absolute”,“position”,d.style),this._fnUpdateCache(a,“sTop”,b.iTableTop+“px”,“top”,d.style),this._fnUpdateCache(a,“sLeft”,b.iTableLeft+b.iTableWidth-f+“px”,“left”,d.style))},_fnScrollFixedFooter:function(a){var
b=this.fnGetSettings(),c=b.oMes,d=FixedHeader.oWin,f=a.nWrapper,b=e(“thead”,b.nTable).outerHeight(),g=e(f).outerHeight();d.iScrollBottom&lt;c.iTableBottom?(this._fnUpdateCache(a,“sPosition”,“absolute”,“position”,f.style),this._fnUpdateCache(a,“sTop”,c.iTableTop+
...
“sLeft”,c.iTableLeft+“px”,“left”,f.style))},_fnScrollFixedHeader:function(a){for(var
<a
href="h">b=this.fnGetSettings(),c=b.oMes,d=FixedHeader.oWin,e=a.nWrapper,g=0,i=b.nTable.getElementsByTagName(“tbody”),h=0;h<i.length;++h)g+=i</a>.offsetHeight;c.iTableTop&gt;d.iScrollTop+b.oOffset.top?(this._fnUpdateCache(a,“sPosition”,“absolute”,“position”,e.style),this._fnUpdateCache(a,“sTop”,c.iTableTop+“px”,“top”,e.style),this._fnUpdateCache(a,“sLeft”,c.iTableLeft+“px”,“left”,e.style)):d.iScrollTop+b.oOffset.top&gt;c.iTableTop+
...
href="b">a</a>!=<a href="d">c&&(e</a>=<a
href="b">c,a</a>=c)},_fnClassUpdate:function(a,b){var c=this;
if(“TR”===a.nodeName.toUpperCase()||“TH”===a.nodeName.toUpperCase()||“TD”===a.nodeName.toUpperCase()||“SPAN”===a.nodeName.toUpperCase())b.className=a.className;e(a).children().each(function(d){<a
href="d">c._fnClassUpdate(e(a).children()</a>,<a
href="d">e(b).children()</a>)})},_fnCloneThead:function(a){var <a
href="0">b=this.fnGetSettings(),c=a.nNode;if(b.bInitComplete&&!b.oCloneOnDraw.top)this._fnClassUpdate(e(“thead”,b.nTable)</a>,<a
href="0">e(“thead”,c)</a>);else{var
d=e(b.nTable).outerWidth();a.nWrapper.style.width=d+“px”;for(c.style.width=d+
“px”;0&lt;c.childNodes.length;)e(“thead <a
href="0">th”,c).unbind(“click”),c.removeChild(c.childNodes</a>);<a
href="0">a=e(“thead”,b.nTable).clone(!0)</a>;c.appendChild(a);var <a
href="">f=[],g=</a>;e(“thead&gt;tr
th”,b.nTable).each(function(){f.push(e(this).width())});e(“thead&gt;tr
td”,b.nTable).each(function(){g.push(e(this).width())});e(“thead&gt;tr
th”,b.nTable).each(function(a){e(“thead&gt;tr <a
href="a">th:eq(”a“)”,c).width(f</a>);<a
href="a">e(this).width(f</a>)});e(“thead&gt;tr
td”,b.nTable).each(function(a){e(“thead&gt;tr <a
href="a">td:eq(”a“)”,c).width(g</a>);<a href="a">e(this).width(g</a>)});
e(“th.sorting, th.sorting_desc,
th.sorting_asc”,c).bind(“click”,function(){this.blur()})}},_fnCloneTfoot:function(a){var
<a
href="0">b=this.fnGetSettings(),c=a.nNode;for(a.nWrapper.style.width=e(b.nTable).outerWidth()+“px”;0<c.childNodes.length;)c.removeChild(c.childNodes</a>);<a
href="0">a=e(“tfoot”,b.nTable).clone(!0)</a>;c.appendChild(a);e(“tfoot:eq(0)&gt;tr
th”,b.nTable).each(function(a){e(“tfoot:eq(0)&gt;tr
th:eq(”<code>a</code>“)”,c).width(e(this).width())});e(“tfoot:eq(0)&gt;tr
td”,b.nTable).each(function(a){e(“tfoot:eq(0)&gt;tr td:eq(”+
a+“)”,c).width(e(this).width())})},_fnCloneTLeft:function(a){for(var <a
href="0">b=this.fnGetSettings(),c=a.nNode,d=e(“tbody”,b.nTable)</a>;<a
href="0">0<c.childNodes.length;)c.removeChild(c.childNodes</a>);<a
href="0">c.appendChild(e(“thead”,b.nTable).clone(!0)</a>);<a
href="0">c.appendChild(e(“tbody”,b.nTable).clone(!0)</a>);<a
href="0">b.bFooter&&c.appendChild(e(“tfoot”,b.nTable).clone(!0)</a>);var
f=“gt(”+(a.iCells-1)+“)”;e(“thead
tr”,c).each(function(){e(“th:”+f,this).remove()});e(“tfoot
tr”,c).each(function(){e(“th:”+f,this).remove()});e(“tbody
tr”,c).each(function(){e(“td:”+
f,this).remove()});this.fnEqualiseHeights(“thead”,d.parentNode,c);this.fnEqualiseHeights(“tbody”,d.parentNode,c);this.fnEqualiseHeights(“tfoot”,d.parentNode,c);for(var
g=d=0;g&lt;a.iCells;g++)d+=e(“thead tr
th:eq(”<code>g</code>“)”,b.nTable).outerWidth();c.style.width=d+“px”;a.nWrapper.style.width=d+“px”},_fnCloneTRight:function(a){for(var
<a
href="0">b=this.fnGetSettings(),c=e(“tbody”,b.nTable)</a>,d=a.nNode,f=e(“tbody
tr:eq(0) <a
href="0">td”,b.nTable).length;0<d.childNodes.length;)d.removeChild(d.childNodes</a>);d.appendChild(e(“thead”,
<a href="0">b.nTable).clone(!0)</a>);<a
href="0">d.appendChild(e(“tbody”,b.nTable).clone(!0)</a>);<a
href="0">b.bFooter&&d.appendChild(e(“tfoot”,b.nTable).clone(!0)</a>);e(“thead
tr th:lt(”+(f-a.iCells)+“)”,d).remove();e(“tfoot tr
th:lt(”+(f-a.iCells)+“)”,d).remove();e(“tbody
tr”,d).each(function(){e(“td:lt(”+(f-a.iCells)+“)”,this).remove()});this.fnEqualiseHeights(“thead”,c.parentNode,d);this.fnEqualiseHeights(“tbody”,c.parentNode,d);this.fnEqualiseHeights(“tfoot”,c.parentNode,d);for(var
g=c=0;g&lt;a.iCells;g++)c+=e(“thead tr th:eq(”+(f-
1-g)+“)”,b.nTable).outerWidth();d.style.width=c+“px”;a.nWrapper.style.width=c+“px”},fnEqualiseHeights:function(a,b,c){var
d=e(a+“ tr”,b),f;e(a+“
tr”,c).each(function(a){f=d.eq(a).css(“height”);“Microsoft Internet
Explorer”==navigator.appName&amp;&amp;(f=parseInt(f,10)+1);e(this).css(“height”,f);d.eq(a).css(“height”,f)})}};FixedHeader.oWin={iScrollTop:0,iScrollRight:0,iScrollBottom:0,iScrollLeft:0,iHeight:0,iWidth:0};FixedHeader.oDoc={iHeight:0,iWidth:0};FixedHeader.afnScroll=[];FixedHeader.fnMeasure=function(){var
a=
...
<a
href="a">a=0,b=FixedHeader.afnScroll.length;a<b;a++)FixedHeader.afnScroll</a>()});e.fn.dataTable.FixedHeader=FixedHeader;return
e.fn.DataTable.FixedHeader= FixedHeader};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,l):“object”===typeof
exports?l(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.FixedHeader&amp;&amp;l(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
