...
<title>dataTables.fixedColumns.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedColumns/js/dataTables.fixedColumns.js">

<pre>! FixedColumns 3.0.4
...
<pre> When making use of DataTables&#39; x-axis scrolling feature, you may wish to
...
<p>var FixedColumns = function ( dt, init ) {</p>
...
<p>FixedColumns.prototype = /** @lends FixedColumns.prototype */{</p>
...
<pre> FixedColumns default settings for initialisation
  @name FixedColumns.defaults
  @namespace
  @static
/</pre>

<p>FixedColumns.defaults = /** @lends FixedColumns.defaults */{</p>
...
<p>FixedColumns.version = “3.0.4”;</p>

<p>/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
* * * * * * * * * * *</p>

<pre>Fired events (for documentation)
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */</pre>

<p>/**</p>

<pre> Event fired whenever FixedColumns redraws the fixed columns (i.e. clones the table elements from the main DataTable). This will occur whenever the DataTable that the FixedColumns instance is attached does its own draw.
...
<p>// Make FixedColumns accessible from the DataTables instance
$.fn.dataTable.FixedColumns = FixedColumns; $.fn.DataTable.FixedColumns =
FixedColumns;</p>

<p>return FixedColumns; }; // /factory</p>
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.FixedColumns ) {</p>
