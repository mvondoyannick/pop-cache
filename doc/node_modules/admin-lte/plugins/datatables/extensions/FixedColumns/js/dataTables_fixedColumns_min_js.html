...
<title>dataTables.fixedColumns.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedColumns/js/dataTables.fixedColumns.min.js">

<pre> !
FixedColumns 3.0.4
©2010-2014 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(r,s,t){var p=function(d){var j=function(a,b){var c=this;if(this
instanceof j){“undefined”==typeof b&amp;&amp;(b={});var
g=d.fn.dataTable.camelToHungarian;g&amp;&amp;(g(j.defaults,j.defaults,!0),g(j.defaults,b));g=d.fn.dataTable.Api?(new
<a href="0">d.fn.dataTable.Api(a)).settings()</a>:a.fnSettings();this.s={<a
href="">dt:g,iTableColumns:g.aoColumns.length,aiOuterWidths:[],aiInnerWidths:</a>};this.dom={scroller:null,header:null,body:null,footer:null,grid:{wrapper:null,dt:null,left:{wrapper:null,head:null,body:null,foot:null},right:{wrapper:null,
head:null,body:null,foot:null}},clone:{left:{header:null,body:null,footer:null},right:{header:null,body:null,footer:null}}};g._oFixedColumns=this;g._bInitComplete?this._fnConstruct(b):g.oApi._fnCallbackReg(g,“aoInitComplete”,function(){c._fnConstruct(b)},“FixedColumns”)}else
alert(“FixedColumns warning: FixedColumns must be initialised with the
&#39;new&#39;
...
<a
href="a">a=d(a).index(),b.fnGetPosition(d(“tr”,this.s.dt.nTBody)</a>);var
<a
href="a">c=d(a).index(),a=d(a.parentNode).index();return[b.fnGetPosition(d(“tr”,this.s.dt.nTBody)</a>),c,b.oApi._fnVisibleToColumnIndex(this.s.dt,c)]}return
b.fnGetPosition(a)},_fnConstruct:function(a){var
b=this;if(“function”!=typeof this.s.dt.oInstance.fnVersionCheck||
!0!==this.s.dt.oInstance.fnVersionCheck(“1.8.0”))alert(“FixedColumns
”<code>j.VERSION</code>“ required DataTables 1.8.0 or later. Please upgrade
your DataTables installation”);else
...
<a href="0">a.sScrollWrapper)</a>;<a
href="0">this.dom.scroller=d(“div.”+a.sScrollBody,this.dom.grid.dt)</a>;this._fnColCalc();this._fnGridSetup();var
...
g=“onwheel”in
s.createElement(“div”)?“wheel.DTFC”:“mousewheel.DTFC”;if(0&lt;b.s.iLeftColumns)d(b.dom.grid.left.liner).on(“mouseover.DTFC
touchstart.DTFC”,
...
b.dom.grid.right.liner.scrollTop,0&lt;b.s.iLeftColumns&amp;&amp;(b.dom.grid.left.liner.scrollTop=b.dom.grid.right.liner.scrollTop))}).on(g,function(a){b.dom.scroller.scrollLeft-=“wheel”===a.type?-a.originalEvent.deltaX:a.originalEvent.wheelDeltaX});d®.on(“resize.DTFC”,function(){b._fnGridLayout.call(b)});var
f=!0,e=d(this.s.dt.nTable);e.on(“draw.dt.DTFC”,function(){b._fnDraw.call(b,f);f=!1}).on(“column-sizing.dt.DTFC”,function(){b._fnColCalc();b._fnGridLayout(b)}).on(“column-visibility.dt.DTFC”,function(){b._fnColCalc();
...
mouseover.DTFC”);d®.off(“resize.DTFC”);d(b.dom.grid.left.liner).off(“scroll.DTFC
mouseover.DTFC
”+g);d(b.dom.grid.left.wrapper).remove();d(b.dom.grid.right.liner).off(“scroll.DTFC
mouseover.DTFC
”+g);d(b.dom.grid.right.wrapper).remove()});this._fnGridLayout();this.s.dt.oInstance.fnDraw(!1)}},_fnColCalc:function(){var
a=this,b=0,c=0;this.s.aiInnerWidths=
[];this.s.aiOuterWidths=[];d.each(this.s.dt.aoColumns,function(g,f){var
...
h?1:parseInt(h,10));a.s.aiOuterWidths.push(i);a.s.aiInnerWidths.push(e.width());g&lt;a.s.iLeftColumns&amp;&amp;(b+=i);a.s.iTableColumns-a.s.iRightColumns&lt;=
g&amp;&amp;(c+=i)}else
...
clear:both;”&gt;&lt;div class=“DTFC_LeftWrapper” style=“position:absolute;
top:0; left:0;”&gt;&lt;div class=“DTFC_LeftHeadWrapper”
style=“position:relative; top:0; left:0;
overflow:hidden;”&gt;&lt;/div&gt;&lt;div class=“DTFC_LeftBodyWrapper”
style=“position:relative; top:0; left:0; overflow:hidden;”&gt;&lt;div
class=“DTFC_LeftBodyLiner” style=“position:relative; top:0; left:0;
overflow-y:scroll;”&gt;&lt;/div&gt;&lt;/div&gt;&lt;div
class=“DTFC_LeftFootWrapper” style=“position:relative; top:0; left:0;
overflow:hidden;”&gt;&lt;/div&gt;&lt;/div&gt;&lt;div
class=“DTFC_RightWrapper” style=“position:absolute; top:0;
left:0;”&gt;&lt;div class=“DTFC_RightHeadWrapper” style=“position:relative;
top:0; left:0;”&gt;&lt;div class=“DTFC_RightHeadBlocker DTFC_Blocker”
style=“position:absolute; top:0;
bottom:0;”&gt;&lt;/div&gt;&lt;/div&gt;&lt;div class=“DTFC_RightBodyWrapper”
style=“position:relative; top:0; left:0; overflow:hidden;”&gt;&lt;div
class=“DTFC_RightBodyLiner” style=“position:relative; top:0; left:0;
overflow-y:scroll;”&gt;&lt;/div&gt;&lt;/div&gt;&lt;div
class=“DTFC_RightFootWrapper” style=“position:relative; top:0;
left:0;”&gt;&lt;div class=“DTFC_RightFootBlocker DTFC_Blocker”
style=“position:absolute; top:0; <a
href="0">bottom:0;”></div></div></div></div>‘)</a>, <a
href="0">g=c.childNodes</a>,<a href="1">f=c.childNodes</a>;<a
href="0">this.dom.grid.dt.parentNode.insertBefore(c,this.dom.grid.dt);c.appendChild(this.dom.grid.dt);this.dom.grid.wrapper=c;0<this.s.iLeftColumns&&(this.dom.grid.left.wrapper=g,this.dom.grid.left.head=g.childNodes</a>,<a
href="1">this.dom.grid.left.body=g.childNodes</a>,<a
href="0">this.dom.grid.left.liner=d(“div.DTFC_LeftBodyLiner”,c)</a>,<a
href="0">c.appendChild(g));0<this.s.iRightColumns&&(this.dom.grid.right.wrapper=f,this.dom.grid.right.head=f.childNodes</a>,<a
href="1">this.dom.grid.right.body=f.childNodes</a>,this.dom.grid.right.liner=
<a href="0">d(“div.DTFC_RightBodyLiner”,c)</a>,<a
href="0">b=d(“div.DTFC_RightHeadBlocker”,c)</a>,<a
href="0">b.style.width=a.bar+“px”,b.style.right=-a.bar+“px”,this.dom.grid.right.headBlock=b,b=d(“div.DTFC_RightFootBlocker”,c)</a>,<a
href="2">b.style.width=a.bar+“px”,b.style.right=-a.bar+“px”,this.dom.grid.right.footBlock=b,c.appendChild(f));if(this.s.dt.nTFoot&&(this.dom.footer=this.s.dt.nTFoot.parentNode,0<this.s.iLeftColumns&&(this.dom.grid.left.foot=g.childNodes</a>),<a
href="2">0<this.s.iRightColumns))this.dom.grid.right.foot=f.childNodes</a>},_fnGridLayout:function(){var
a=
...
this.s.iRightColumns)){var <a
href="b">b,c=[];for(b=this.s.iTableColumns-this.s.iRightColumns;b<this.s.iTableColumns;b++)this.s.dt.aoColumns</a>.bVisible&amp;&amp;c.push(b);this._fnClone(this.dom.clone.right,this.dom.grid.right,c,a)}},_fnCloneLeft:function(a){if(!(0&gt;=this.s.iLeftColumns)){var
<a
href="b">b,c=[];for(b=0;b<this.s.iLeftColumns;b++)this.s.dt.aoColumns</a>.bVisible&amp;&amp;c.push(b);this._fnClone(this.dom.clone.left,this.dom.grid.left,c,a)}},_fnCopyLayout:function(a,b){for(var
<a href="">c=[],g=</a>,f=[],e=0,h=a.length;e&lt;h;e++){var i=[]; <a
href="e">i.nTr=d(a</a>.<a href="0">nTr).clone(!0,!0)</a>;for(var
k=0,j=this.s.iTableColumns;k&lt;j;k++)if(-1!==d.inArray(k,b)){var <a
href="e">m=d.inArray(a</a>[<a href="e">k].cell,f);-1===m?(m=d(a</a>[<a
href="0">k].cell).clone(!0,!0)</a>,<a
href="e">g.push(m),f.push(a</a>[k].cell),i.push({<a
href="e">cell:m,unique:a</a>[k].unique})):i.push({<a href="m">cell:g</a>,<a
href="e">unique:a</a>[k].unique})}c.push(i)}return
c},_fnClone:function(a,b,c,g){var
f=this,e,h,i,k,j,m,o,n,q,l=this.s.dt;if(g){<a
href="0">null!==a.header&&a.header.parentNode.removeChild(a.header);a.header=d(this.dom.header).clone(!0,!0)</a>;a.header.className+=
“ <a
href="0">DTFC_Cloned”;a.header.style.width=“100%”;b.head.appendChild(a.header);n=this._fnCopyLayout(l.aoHeader,c);k=d(“>thead”,a.header);k.empty();e=0;for(h=n.length;e<h;e++)k</a>.<a
href="e">appendChild(n</a>.nTr);l.oApi._fnDrawHead(l,n,!0)}else{<a
href="0">n=this._fnCopyLayout(l.aoHeader,c);q=[];l.oApi._fnDetectHeader(q,d(“>thead”,a.header)</a>);e=0;for(h=n.length;e&lt;h;e++){<a
href="e">i=0;for(k=n</a>.<a href="e">length;i<k;i++)q</a>[<a
href="e">i].cell.className=n</a>[<a
href="e">i].cell.className,d(“span.DataTables_sort_icon”,q</a>[i].cell).each(function(){this.className=d(“span.DataTables_sort_icon”,
<a href="e">n</a>[<a href="0">i].cell)</a>.className})}}<a
href="0">this._fnEqualiseHeights(“thead”,this.dom.header,a.header);“auto”==this.s.sHeightMatch&&d(“>tbody>tr”,f.dom.body).css(“height”,“auto”);null!==a.body&&(a.body.parentNode.removeChild(a.body),a.body=null);a.body=d(this.dom.body).clone(!0)</a>;a.body.className+=“
...
a.body).remove();var <a
href="0">p=d(“tbody”,a.body)</a>;d(p).empty();if(0&lt;l.aiDisplay.length){<a
href="0">h=d(“>thead>tr”,a.body)</a>;<a
href="o">for(o=0;o<c.length;o++)j=c</a>,<a href="j">m=d(l.aoColumns</a>.<a
href="0">nTh).clone(!0)</a>,<a
href="j">m.innerHTML=“”,k=m.style,k.paddingTop=“0”,k.paddingBottom=“0”,k.borderTopWidth=“0”,k.borderBottomWidth=“0”,k.height=0,k.width=f.s.aiInnerWidths</a>+“px”,h.appendChild(m);d(“&gt;tbody&gt;tr”,f.dom.body).each(function(a){var
b=this.cloneNode(false);b.removeAttribute(“id”);a=f.s.dt.aoData[f.s.dt.oFeatures.bServerSide===false?f.s.dt.aiDisplay[f.s.dt._iDisplayStart+
a]:a].anCells||d(this).children(“td, th”);for(o=0;o&lt;c.length;o++){<a
href="o">j=c</a>;if(a.length&gt;0){<a href="j">m=d(a</a>).<a
href="0">clone(true,true)</a>;b.appendChild(m)}}p.appendChild(b)})}else
d(“&gt;tbody&gt;tr”,f.dom.body).each(function(){m=this.cloneNode(true);m.className=m.className+“
DTFC_NoData”;d(“td”,m).html(“”);p.appendChild(m)});a.body.style.width=“100%”;a.body.style.margin=“0”;a.body.style.padding=“0”;l.oScroller!==t&amp;&amp;(h=l.oScroller.dom.force,b.forcer?b.forcer.style.height=h.style.height:(b.forcer=h.cloneNode(!0),b.liner.appendChild(b.forcer)));
b.liner.appendChild(a.body);this._fnEqualiseHeights(“tbody”,f.dom.body,a.body);if(null!==l.nTFoot){if(g){<a
href="0">null!==a.footer&&a.footer.parentNode.removeChild(a.footer);a.footer=d(this.dom.footer).clone(!0,!0)</a>;a.footer.className+=“
<a
href="0">DTFC_Cloned”;a.footer.style.width=“100%”;b.foot.appendChild(a.footer);n=this._fnCopyLayout(l.aoFooter,c);b=d(“>tfoot”,a.footer);b.empty();e=0;for(h=n.length;e<h;e++)b</a>.<a
href="e">appendChild(n</a>.nTr);l.oApi._fnDrawHead(l,n,!0)}else{n=this._fnCopyLayout(l.aoFooter,c);b=[];l.oApi._fnDetectHeader(b,
<a href="0">d(“>tfoot”,a.footer)</a>);e=0;for(h=n.length;e&lt;h;e++){<a
href="e">i=0;for(k=n</a>.<a href="e">length;i<k;i++)b</a>[<a
href="e">i].cell.className=n</a>[i].cell.className}}this._fnEqualiseHeights(“tfoot”,this.dom.footer,a.footer)}<a
href="0">b=l.oApi._fnGetUniqueThs(l,d(“>thead”,a.header)</a>);d(b).each(function(a){<a
href="a">j=c</a>;<a
href="j">this.style.width=f.s.aiInnerWidths</a>+“px”});<a
href="0">null!==f.s.dt.nTFoot&&(b=l.oApi._fnGetUniqueThs(l,d(“>tfoot”,a.footer)</a>),d(b).each(function(a){<a
href="a">j=c</a>;<a
href="j">this.style.width=f.s.aiInnerWidths</a>+“px”}))},_fnGetTrNodes:function(a){for(var
b= [],<a
href="c">c=0,d=a.childNodes.length;c<d;c++)"TR"==a.childNodes</a>.<a
href="c">nodeName.toUpperCase()&&b.push(a.childNodes</a>);return
b},_fnEqualiseHeights:function(a,b,c){if(!(“none”==this.s.sHeightMatch&amp;&amp;“thead”!==a&amp;&amp;“tfoot”!==a)){var
<a href="0">g,f,e=b.getElementsByTagName(a)</a>,<a
href="0">c=c.getElementsByTagName(a)</a>,a=d(“&gt;”<code>a</code>“&gt;tr:eq(0)”,b).children(“:first”);a.outerHeight();a.height();for(var
<a
href="c">e=this._fnGetTrNodes(e),b=this._fnGetTrNodes©,h=[],c=0,a=b.length;c<a;c++)g=e</a>.<a
href="c">offsetHeight,f=b</a>.offsetHeight,g=f&gt;g?f:g,“semiauto”==this.s.sHeightMatch&amp;&amp;
(<a href="c">e</a>.<a
href="c">_DTTC_iHeight=g),h.push(g);c=0;for(a=b.length;c<a;c++)b</a>.<a
href="c">style.height=h</a>+“<a href="c">px”,e</a>.<a
href="c">style.height=h</a>+“px”}}};j.defaults={iLeftColumns:1,iRightColumns:0,fnDrawCallback:null,sHeightMatch:“semiauto”};j.version=“3.0.4”;d.fn.dataTable.FixedColumns=j;return
d.fn.DataTable.FixedColumns=j};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,p):“object”===typeof
exports?p(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.FixedColumns&amp;&amp;p(jQuery,jQuery.fn.dataTable)})(window,
document);</p>
</main>
