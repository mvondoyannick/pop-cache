...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-FixedColumns">FixedColumns</a>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedColumns/Readme.md">

<h1 id="label-FixedColumns">FixedColumns<span><a href="#label-FixedColumns">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>When making use of DataTables&#39; x-axis scrolling feature
(<code>scrollX</code>), you may wish to fix the left or right most columns
in place. This plug-in for DataTables provides exactly this option (for
non-scrolling tables, please use the FixedHeader plug-in, which can fix
headers, footers and columns). Key features include:</p>
<ul><li>
<p>Freezes the left most column to the side of the table</p>
</li><li>
<p>Option to freeze two or more columns</p>
</li><li>
<p>Full integration with DataTables&#39; scrolling options</p>
</li></ul>

<h1 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>To use FixedColumns, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped FixedColumns package into a <code>extensions</code>
directory in the DataTables package. This will allow the pages in the
examples to operate correctly. To see the examples running, open the
...
<code>$.fn.dataTable.FixedColumns()</code> constructor. For example:</p>
...
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/FixedColumns">datatables.net/extensions/FixedColumns</a>/</p>
</li><li>
...
<p>If you fancy getting involved with the development of FixedColumns and help
make it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/FixedColumns">github.com/DataTables/FixedColumns</a></p>
</main>
