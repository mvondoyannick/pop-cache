...
<title>dataTables.fixedColumns.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/FixedColumns/css/dataTables.fixedColumns.css">

<pre>Block out what is behind the fixed column&#39;s header and footer</pre>

<p>table.DTFC_Cloned thead, table.DTFC_Cloned tfoot {</p>

<pre>background-color: white;</pre>

<p>}</p>

<p>/* Block out the gap above the scrollbar on the right, when there is a
fixed</p>

<pre> right column
/</pre>

<p>div.DTFC_Blocker {</p>

<pre>background-color: white;</pre>

<p>}</p>

<p>div.DTFC_LeftWrapper table.dataTable, div.DTFC_RightWrapper table.dataTable
{</p>
...
<p>div.DTFC_LeftWrapper table.dataTable.no-footer, div.DTFC_RightWrapper
table.dataTable.no-footer {</p>
