...
<title>dataTables.colReorder.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js">

<pre> !
ColReorder 1.1.3
©2010-2014 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(o,r,s){function p(d){for(var <a
href="a">f=[],a=0,b=d.length;a<b;a++)f[d</a>]=a;return f}function
l(d,f,a){<a href="0">f=d.splice(f,1)</a>;d.splice(a,0,f)}function
q(d,f,a){for(var <a
href="e">b=[],e=0,h=d.childNodes.length;e<h;e++)1==d.childNodes</a>.<a
href="e">nodeType&&b.push(d.childNodes</a>);<a href="f">f=b</a>;<a
href="a">null!==a?d.insertBefore(f,b</a>):d.appendChild(f)}o=function(d){d.fn.dataTableExt.oApi.fnColReorder=function(a,b,e){var
h=d.fn.dataTable.Api?!0:!1,c,g,f,m,n=a.aoColumns.length,i,j;i=function(a,b,c){<a
href="b">if(a</a>){var <a href="b">e=a</a>.split(“.”),d=e.shift(); <a
href="b">isNaN(1*d)||(a</a>=<a
href="1*d">c</a>+“.”+e.join(“.”))}};if(b!=e)if(0&gt;b||b&gt;=n)this.oApi._fnLog(a,1,“ColReorder
&#39;from&#39; index is out of bounds: ”+b);else
if(0&gt;e||e&gt;=n)this.oApi._fnLog(a,1,“ColReorder &#39;to&#39; index is
out of bounds: ”+e);else{<a
href="c">f=[];c=0;for(g=n;c<g;c++)f</a>=c;l(f,b,e);var <a
href="c">k=p(f);c=0;for(g=a.aaSorting.length;c<g;c++)a.aaSorting</a>[<a
href="c">0]=k[a.aaSorting</a>[0]];if(null!==a.aaSortingFixed){<a
href="c">c=0;for(g=a.aaSortingFixed.length;c<g;c++)a.aaSortingFixed</a>[<a
href="c">0]=k[a.aaSortingFixed</a>[0]]}c=0;for(g=n;c&lt;g;c++){<a
href="c">j=a.aoColumns</a>; <a
href="f">f=0;for(m=j.aDataSort.length;f<m;f++)j.aDataSort</a>=<a
href="f">k[j.aDataSort</a>];<a
href="j.idx">h&&(j.idx=k</a>)}h&amp;&amp;d.each(a.aLastSort,function(b,c){<a
href="b">a.aLastSort</a>.<a href="c.src">src=k</a>});<a
href="c">c=0;for(g=n;c<g;c++)j=a.aoColumns</a>,“number”==typeof <a
href="j.mData">j.mData?(j.mData=k</a>,a.oApi._fnColumnOptions(a,c,{})):d.isPlainObject(j.mData)&amp;&amp;(i(j.mData,“_”,k),i(j.mData,“filter”,k),i(j.mData,“sort”,k),i(j.mData,“type”,k),a.oApi._fnColumnOptions(a,c,{}));<a
href="b">if(a.aoColumns</a>.bVisible){f=this.oApi._fnColumnIndexToVisible(a,b);m=null;for(c=e&lt;b?e:e+1;null===
<a
href="c">m&&c<n;)m=this.oApi._fnColumnIndexToVisible(a,c),c++;i=a.nTHead.getElementsByTagName("tr");c=0;for(g=i.length;c<g;c++)q(i</a>,f,m);if(null!==a.nTFoot){<a
href="c">i=a.nTFoot.getElementsByTagName(“tr”);c=0;for(g=i.length;c<g;c++)q(i</a>,f,m)}<a
href="c">c=0;for(g=a.aoData.length;c<g;c++)null!==a.aoData</a>.<a
href="c">nTr&&q(a.aoData</a>.nTr,f,m)}<a
href="c">l(a.aoColumns,b,e);l(a.aoPreSearchCols,b,e);c=0;for(g=a.aoData.length;c<g;c++)i=a.aoData</a>,h?(i.anCells&amp;&amp;l(i.anCells,b,e),“dom”!==i.src&amp;&amp;d.isArray(i._aData)&amp;&amp;l(i._aData,b,e)):(d.isArray(i._aData)&amp;&amp;
<a
href="c">l(i._aData,b,e),l(i._anHidden,b,e));c=0;for(g=a.aoHeader.length;c<g;c++)l(a.aoHeader</a>,b,e);if(null!==a.aoFooter){<a
href="c">c=0;for(g=a.aoFooter.length;c<g;c++)l(a.aoFooter</a>,b,e)}h&amp;&amp;(new
<a
href="c">d.fn.dataTable.Api(a)).rows().invalidate();c=0;for(g=n;c<g;c++)d(a.aoColumns</a>.<a
href="c">nTh).off(“click.DT”),this.oApi._fnSortAttachListener(a,a.aoColumns</a>.<a
href="a,{iFrom:b,iTo:e,aiInvertMapping:k}">nTh,c);d(a.oInstance).trigger(“column-reorder”,</a>)}};var
f=function(a,b){var e;d.fn.dataTable.Api?e=(new <a
href="0">d.fn.dataTable.Api(a)).settings()</a>:
a.fnSettings?e=a.fnSettings():“string”===typeof <a
href="0">a?d.fn.dataTable.fnIsDataTable(d(a)</a>)&amp;&amp;(e=d(a).eq(0).dataTable().fnSettings()):a.nodeName&amp;&amp;“table”===a.nodeName.toLowerCase()?d.fn.dataTable.fnIsDataTable(a.nodeName)&amp;&amp;(e=d(a.nodeName).dataTable().fnSettings()):a
instanceof <a
href="0">jQuery?d.fn.dataTable.fnIsDataTable(a</a>)&amp;&amp;(e=a.eq(0).dataTable().fnSettings()):e=a;if(e._colReorder)throw“ColReorder
already initialised on table #”+e.nTable.id;var
h=d.fn.dataTable.camelToHungarian;h&amp;&amp;(h(f.defaults,f.defaults,
!0),h(f.defaults,b||{}));this.s={dt:null,init:d.extend(!0,{},f.defaults,b),fixed:0,fixedRight:0,reorderCallback:null,mouse:{startX:-1,startY:-1,offsetX:-1,offsetY:-1,target:-1,targetIndex:-1,fromIndex:-1},aoTargets:[]};this.dom={drag:null,pointer:null};this.s.dt=e;this.s.dt._colReorder=this;this._fnConstruct();e.oApi._fnCallbackReg(e,“aoDestroyCallback”,d.proxy(this._fnDestroy,this),“ColReorder”);return
this};f.prototype={fnReset:function(){for(var <a
href="b">a=[],b=0,e=this.s.dt.aoColumns.length;b<e;b++)a.push(this.s.dt.aoColumns</a>._ColReorder_iOrigCol);
this._fnOrderColumns(a);return this},fnGetCurrentOrder:function(){return
this.fnOrder()},fnOrder:function(a){if(a===s){for(var <a
href="b">a=[],b=0,e=this.s.dt.aoColumns.length;b<e;b++)a.push(this.s.dt.aoColumns</a>._ColReorder_iOrigCol);return
a}this._fnOrderColumns(p(a));return this},_fnConstruct:function(){var
a=this,b=this.s.dt.aoColumns.length,e;this.s.init.iFixedColumns&amp;&amp;(this.s.fixed=this.s.init.iFixedColumns);this.s.fixedRight=this.s.init.iFixedColumnsRight?this.s.init.iFixedColumnsRight:0;this.s.init.fnReorderCallback&amp;&amp;
(<a
href="e">this.s.reorderCallback=this.s.init.fnReorderCallback);for(e=0;e<b;e++)e>this.s.fixed-1&&e<b-this.s.fixedRight&&this._fnMouseListener(e,this.s.dt.aoColumns</a>.<a
href="e">nTh),this.s.dt.aoColumns</a>._ColReorder_iOrigCol=e;this.s.dt.oApi._fnCallbackReg(this.s.dt,“aoStateSaveParams”,function(b,c){a._fnStateSave.call(a,c)},“ColReorder_State”);var
d=null;this.s.init.aiOrder&amp;&amp;(d=this.s.init.aiOrder.slice());this.s.dt.oLoadedState&amp;&amp;(“undefined”!=typeof
this.s.dt.oLoadedState.ColReorder&amp;&amp;this.s.dt.oLoadedState.ColReorder.length==
this.s.dt.aoColumns.length)&amp;&amp;(d=this.s.dt.oLoadedState.ColReorder);if(d)if(a.s.dt._bInitComplete)b=p(d),a._fnOrderColumns.call(a,b);else{var
c=!1;this.s.dt.aoDrawCallback.push({fn:function(){if(!a.s.dt._bInitComplete&amp;&amp;!c){c=true;var
b=p(d);a._fnOrderColumns.call(a,b)}},sName:“ColReorder_Pre”})}else
this._fnSetColumnIndexes()},_fnOrderColumns:function(a){if(a.length!=this.s.dt.aoColumns.length)this.s.dt.oInstance.oApi._fnLog(this.s.dt,1,“ColReorder
- array reorder does not match known number of columns. Skipping.”);
else{for(var b=0,e=a.length;b&lt;e;b++){var
h=d.inArray(b,a);b!=h&amp;&amp;(l(a,h,b),this.s.dt.oInstance.fnColReorder(h,b))}(“”!==this.s.dt.oScroll.sX||“”!==this.s.dt.oScroll.sY)&amp;&amp;this.s.dt.oInstance.fnAdjustColumnSizing(!1);this.s.dt.oInstance.oApi._fnSaveState(this.s.dt);this._fnSetColumnIndexes();null!==this.s.reorderCallback&amp;&amp;this.s.reorderCallback.call(this)}},_fnStateSave:function(a){var
<a
href="b">b,e,h,c=this.s.dt.aoColumns;a.ColReorder=[];if(a.aaSorting){for(b=0;b<a.aaSorting.length;b++)a.aaSorting</a>[<a
href="b">0]=c[a.aaSorting</a>[0]]._ColReorder_iOrigCol; var <a
href="b">f=d.extend(!0,[],a.aoSearchCols);b=0;for(e=c.length;b<e;b++)h=c</a>.<a
href="h">_ColReorder_iOrigCol,a.aoSearchCols</a>=<a href="b">f</a>,<a
href="h">a.abVisCols</a>=<a
href="b">c</a>.bVisible,a.ColReorder.push(h)}else if(a.order){<a
href="b">for(b=0;b<a.order.length;b++)a.order</a>[<a
href="b">0]=c[a.order</a>[<a
href="b">0]]._ColReorder_iOrigCol;f=d.extend(!0,[],a.columns);b=0;for(e=c.length;b<e;b++)h=c</a>.<a
href="h">_ColReorder_iOrigCol,a.columns</a>=<a
href="b">f</a>,a.ColReorder.push(h)}},_fnMouseListener:function(a,b){var
e=this;d(b).on(“mousedown.ColReorder”,function(a){a.preventDefault();e._fnMouseDown.call(e,
a,b)})},_fnMouseDown:function(a,b){var e=this,f=d(a.target).closest(“th, <a
href="c">td”).offset(),c=parseInt(d(b).attr(“data-column-index”),10);c!==s&&(this.s.mouse.startX=a.pageX,this.s.mouse.startY=a.pageY,this.s.mouse.offsetX=a.pageX-f.left,this.s.mouse.offsetY=a.pageY-f.top,this.s.mouse.target=this.s.dt.aoColumns</a>.nTh,this.s.mouse.targetIndex=c,this.s.mouse.fromIndex=c,this._fnRegions(),d®.on(“mousemove.ColReorder”,function(a){e._fnMouseMove.call(e,a)}).on(“mouseup.ColReorder”,function(a){e._fnMouseUp.call(e,
a)}))},_fnMouseMove:function(a){if(null===this.dom.drag){if(5&gt;Math.pow(Math.pow(a.pageX-this.s.mouse.startX,2)+Math.pow(a.pageY-this.s.mouse.startY,2),0.5))return;this._fnCreateDragNode()}this.dom.drag.css({left:a.pageX-this.s.mouse.offsetX,top:a.pageY-this.s.mouse.offsetY});for(var
<a
href="d-1">b=!1,e=this.s.mouse.toIndex,d=1,c=this.s.aoTargets.length;d<c;d++)if(a.pageX<this.s.aoTargets</a>.<a
href="d">x+(this.s.aoTargets</a>.<a
href="d-1">x-this.s.aoTargets</a>.x)/2){<a
href="d-1">this.dom.pointer.css(“left”,this.s.aoTargets</a>.x);this.s.mouse.toIndex=
<a href="d-1">this.s.aoTargets</a>.to;b=!0;break}<a
href="this.s.aoTargets.length-1">b||(this.dom.pointer.css(“left”,this.s.aoTargets</a>.<a
href="this.s.aoTargets.length-1">x),this.s.mouse.toIndex=this.s.aoTargets</a>.to);this.s.init.bRealtime&amp;&amp;e!==this.s.mouse.toIndex&amp;&amp;(this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex,this.s.mouse.toIndex),this.s.mouse.fromIndex=this.s.mouse.toIndex,this._fnRegions())},_fnMouseUp:function(){d®.off(“mousemove.ColReorder
mouseup.ColReorder”);null!==this.dom.drag&amp;&amp;(this.dom.drag.remove(),this.dom.pointer.remove(),
this.dom.drag=null,this.dom.pointer=null,this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex,this.s.mouse.toIndex),this._fnSetColumnIndexes(),(“”!==this.s.dt.oScroll.sX||“”!==this.s.dt.oScroll.sY)&amp;&amp;this.s.dt.oInstance.fnAdjustColumnSizing(!1),this.s.dt.oInstance.oApi._fnSaveState(this.s.dt),null!==this.s.reorderCallback&amp;&amp;this.s.reorderCallback.call(this))},_fnRegions:function(){var
a=this.s.dt.aoColumns;this.s.aoTargets.splice(0,this.s.aoTargets.length);this.s.aoTargets.push({x:d(this.s.dt.nTable).offset().left,
to:0});for(var <a
href="e">b=0,e=0,f=a.length;e<f;e++)e!=this.s.mouse.fromIndex&&b++,a</a>.bVisible&amp;&amp;this.s.aoTargets.push({<a
href="e">x:d(a</a>.<a
href="e">nTh).offset().left+d(a</a>.nTh).outerWidth(),to:b});0!==this.s.fixedRight&amp;&amp;this.s.aoTargets.splice(this.s.aoTargets.length-this.s.fixedRight);0!==this.s.fixed&amp;&amp;this.s.aoTargets.splice(0,this.s.fixed)},_fnCreateDragNode:function(){var
<a
href="this.s.mouse.targetIndex">a=“”!==this.s.dt.oScroll.sX||“”!==this.s.dt.oScroll.sY,b=this.s.dt.aoColumns</a>.nTh,e=b.parentNode,f=e.parentNode,c=f.parentNode,
<a
href="0">g=d(b).clone();this.dom.drag=d(c.cloneNode(!1)).addClass(“DTCR_clonedTable”).append(d(f.cloneNode(!1)).append(d(e.cloneNode(!1)).append(g</a>))).css({position:“absolute”,top:0,left:0,width:d(b).outerWidth(),height:d(b).outerHeight()}).appendTo(“body”);this.dom.pointer=d(“&lt;div&gt;&lt;/div&gt;”).addClass(“DTCR_pointer”).css({position:“absolute”,top:a?d(“div.dataTables_scroll”,this.s.dt.nTableWrapper).offset().top:d(this.s.dt.nTable).offset().top,height:a?d(“div.dataTables_scroll”,this.s.dt.nTableWrapper).height():
d(this.s.dt.nTable).height()}).appendTo(“body”)},_fnDestroy:function(){var
<a
href="a">a,b;a=0;for(b=this.s.dt.aoDrawCallback.length;a<b;a++)if("ColReorder_Pre"===this.s.dt.aoDrawCallback</a>.sName){this.s.dt.aoDrawCallback.splice(a,1);break}d(this.s.dt.nTHead).find(“*”).off(“.ColReorder”);d.each(this.s.dt.aoColumns,function(a,b){d(b.nTh).removeAttr(“data-column-index”)});this.s=this.s.dt._colReorder=null},_fnSetColumnIndexes:function(){d.each(this.s.dt.aoColumns,function(a,b){d(b.nTh).attr(“data-column-index”,
a)})}};f.defaults={aiOrder:null,bRealtime:!1,iFixedColumns:0,iFixedColumnsRight:0,fnReorderCallback:null};f.version=“1.1.3”;d.fn.dataTable.ColReorder=f;d.fn.DataTable.ColReorder=f;“function”==typeof
d.fn.dataTable&amp;&amp;“function”==typeof
d.fn.dataTableExt.fnVersionCheck&amp;&amp;d.fn.dataTableExt.fnVersionCheck(“1.9.3”)?d.fn.dataTableExt.aoFeatures.push({fnInit:function(a){var
b=a.oInstance;a._colReorder?b.oApi._fnLog(a,1,“ColReorder attempted to
initialise twice. Ignoring second”):(b=a.oInit,new f(a,b.colReorder||
b.oColReorder||{}));return
null},cFeature:“R”,sFeature:“ColReorder”}):alert(“Warning: ColReorder
requires DataTables 1.9.3 or greater - <a
href="www.datatables.net/download");d.fn.dataTable.Api&&(d.fn.dataTable.Api.register("colReorder.reset()",function(){return">www.datatables.net/download”);d.fn.dataTable.Api&&(d.fn.dataTable.Api.register(“colReorder.reset()”,function(){return</a>
this.iterator(“table”,function(a){a._colReorder.fnReset()})}),d.fn.dataTable.Api.register(“colReorder.order()”,function(a){return
a?this.iterator(“table”,function(b){b._colReorder.fnOrder(a)}):<a
href="0">this.context.length?this.context</a>._colReorder.fnOrder():
null}));return f};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,o):“object”===typeof
exports?o(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.ColReorder&amp;&amp;o(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
