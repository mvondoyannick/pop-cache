...
<title>dataTables.colReorder.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.js">

<pre>! ColReorder 1.1.3
...
<pre> Switch the key value pairing of an index array to be value key (i.e. the old value is now the
...
<p>function fnInvertKeyValues( aIn ) {</p>
...
<pre> Modify an array by switching the position of two elements
...
<p>function fnArraySwitch( aArray, iFrom, iTo ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">mStore</span> = <span class="ruby-identifier">aArray</span>.<span class="ruby-identifier">splice</span>( <span class="ruby-identifier">iFrom</span>, <span class="ruby-value">1</span> )[<span class="ruby-value">0</span>];
<span class="ruby-identifier">aArray</span>.<span class="ruby-identifier">splice</span>( <span class="ruby-identifier">iTo</span>, <span class="ruby-value">0</span>, <span class="ruby-identifier">mStore</span> );
</pre>
...
<pre> Switch the positions of nodes in a parent node (note this is specifically designed for
...
<p>function fnDomSwitch( nParent, iFrom, iTo ) {</p>
...
<pre> Plug-in for DataTables which will reorder the internal column structure by taking the column
...
<p>$.fn.dataTableExt.oApi.fnColReorder = function ( oSettings, iFrom, iTo ) {</p>

<pre>     var v110 = $.fn.dataTable.Api ? true : false;
...
<pre> ColReorder provides column visibility control for DataTables
 @class ColReorder
 @constructor
...
<p>var ColReorder = function( dt, opts ) {</p>
...
<pre>Static parameters
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */</pre>

<p>/**</p>

<pre> ColReorder default settings for initialisation
  @namespace
  @static
/</pre>

<p>ColReorder.defaults = {</p>
...
<pre> ColReorder version
  @constant  version
  @type      String
  @default   As code
/</pre>

<p>ColReorder.version = “1.1.3”;</p>

<p>/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
* * * * * * * * * * *</p>

<pre>DataTables interfaces
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */</pre>

<p>// Expose $.fn.dataTable.ColReorder = ColReorder; $.fn.DataTable.ColReorder
= ColReorder;</p>

<p>// Register a new feature with DataTables if ( typeof $.fn.dataTable ==
“function” &amp;&amp;</p>

<pre>typeof $.fn.dataTableExt.fnVersionCheck == &quot;function&quot; &amp;&amp;
$.fn.dataTableExt.fnVersionCheck(&#39;1.9.3&#39;) )</pre>
...
<pre class="ruby"><span class="ruby-identifier">alert</span>( <span class="ruby-string">&quot;Warning: ColReorder requires DataTables 1.9.3 or greater - www.datatables.net/download&quot;</span>);
</pre>

<p>}</p>

<p>// API augmentation if ( $.fn.dataTable.Api ) {</p>

<pre>$.fn.dataTable.Api.register( &#39;colReorder.reset()&#39;, function () {
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.ColReorder ) {</p>
