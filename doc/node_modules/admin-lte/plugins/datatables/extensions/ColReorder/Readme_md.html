...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-ColReorder">ColReorder</a>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/ColReorder/Readme.md">

<h1 id="label-ColReorder">ColReorder<span><a href="#label-ColReorder">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>ColReorder adds the ability for the end user to click and drag column
headers to reorder a table as they see fit, to DataTables. Key features
include:</p>
<ul><li>
<p>Very easy integration with DataTables</p>
</li><li>
<p>Tight integration with all other DataTables plug-ins</p>
</li><li>
<p>The ability to exclude the first (or more) column from being movable</p>
</li><li>
<p>Predefine a column order</p>
</li><li>
<p>Save staving integration with DataTables</p>
</li></ul>

<h1 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>To use ColReorder, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped ColReorder package into a <code>extensions</code>
...
<p>ColReorder is initialised using the <code>$.fn.dataTable.ColReorder</code>
...
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/colreorder">datatables.net/extensions/colreorder</a>/</p>
</li><li>
...
<p>If you fancy getting involved with the development of ColReorder and help
make it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/ColReorder">github.com/DataTables/ColReorder</a></p>
</main>
