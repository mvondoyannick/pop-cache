...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/KeyTable/Readme.txt">

<p># KeyTable</p>

<p>KeyTable provides enhanced accessibility and navigation options for
DataTables enhanced tables, by allowing Excel like cell navigation on any
table. Events (focus, blur, action etc) can be assigned to individual
cells, columns, rows or all cells to allow advanced interaction options..
Key features include:</p>
<ul><li>
<p>Easy to use spreadsheet like interaction</p>
</li><li>
<p>Fully integrated with DataTables</p>
</li><li>
<p>Wide range of supported events</p>
</li></ul>

<p># Installation</p>

<p>To use KeyTable, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped KeyTable package into a `extensions` directory in the
...
<p>KeyTable is initialised using the `C` option that it adds to
DataTables&#39; `dom` option. For example:</p>

<p>“`js $(document).ready( function () {</p>

<pre>var table = $(&#39;#example&#39;).DataTable();
new $.fn.dataTable.KeyTable( table );</pre>
...
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/keytable">datatables.net/extensions/keytable</a>/</p>
</li><li>
...
<p>If you fancy getting involved with the development of KeyTable and help
make it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/KeyTable">github.com/DataTables/KeyTable</a></p>
</main>
