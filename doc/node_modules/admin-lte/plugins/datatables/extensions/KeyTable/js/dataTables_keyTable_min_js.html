...
<title>dataTables.keyTable.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/KeyTable/js/dataTables.keyTable.min.js">

<pre> !
KeyTable 1.2.1
©2010-2014 SpryMedia Ltd - datatables.net/license</pre>

<p>var KeyTable; (function(F,n,K){var
A=function(d){KeyTable=function(j){function A(a){return
function(e,c,p){(null===e||“number”==typeof
e)&amp;&amp;(null===c||“number”==typeof c)&amp;&amp;“function”==typeof <a
href="a">p?k</a>.push({x:e,y:c,fn:p}):“object”==typeof
e&amp;&amp;“function”==typeof <a href="a">c?(e=E(e),k</a>.push({<a
href="0">x:e</a>,<a href="1">y:e</a>,fn:c})):alert(“Unhandable event type
was added: x”<code>e</code>“  y:”<code>c</code>“  z:”+p)}}function
L(a){return function(e,c,p){(null===e||“number”==typeof
e)&amp;&amp;(null===c||“number”==typeof c)?“function”==typeof
p?B(a,e,c,p):B(a,e,c):“object”== typeof e?(e=E(e),“function”==typeof <a
href="0">c?B(a,e</a>,<a href="1">e</a>,<a href="0">c):B(a,e</a>,<a
href="1">e</a>)):alert(“Unhandable event type was removed:
x”<code>e</code>“  y:”<code>c</code>“  z:”+p)}}function B(a,e,c,p){for(var
<a href="a">h=0,b=0,d=k</a>.length;b&lt;d-h;b++)if(“undefined”!=typeof <a
href="a">p)k</a>[<a href="a">b-h].x==e&&(k</a>[<a
href="a">b-h].y==c&&k</a>[<a
href="a">b-h].fn==p)&&(k</a>.splice(b-h,1),h++);else <a
href="a">if(k</a>[<a href="a">b-h].x==e&&k</a>[b-h].y==c)return <a
href="a">k</a>.splice(b,1),1;return h}function C(a,e,c){for(var <a
href="a">p=0,a=k</a>,<a href="b">b=0;b<a.length;b++)if(a</a>.<a
href="b">x==e&&a</a>.<a href="b">y==c||null===a</a>.<a href="b">x&&a</a>.<a
href="b">y==c||a</a>.<a href="b">x==e&&null===a</a>.y|| <a
href="b">null===a</a>.<a href="b">x&&null===a</a>.<a
href="b">y)a</a>.fn(w(e,c),e,c),p++;return p}function
q(a,e){if(t!=a){“undefined”==typeof
e&amp;&amp;(e=!0);null!==t&amp;&amp;G(t);d(a).addClass(x);d(a).parent().addClass(x);var
c;if(i){c=i;for(var <a
href="1">b=H(a)</a>,h=o;b&gt;=c.fnDisplayEnd();)0&lt;=c._iDisplayLength?c._iDisplayStart+c._iDisplayLength&lt;c.fnRecordsDisplay()&amp;&amp;(c._iDisplayStart+=c._iDisplayLength):c._iDisplayStart=0,i.oApi._fnCalculateEnd©;for(;b&lt;c._iDisplayStart;)c._iDisplayStart=0&lt;=c._iDisplayLength?c._iDisplayStart-c._iDisplayLength:0,0&gt;c._iDisplayStart&amp;&amp;
(c._iDisplayStart=0),i.oApi._fnCalculateEnd©;i.oApi._fnDraw©;o=h}<a
href="0">b=E(a);t=a;l=b</a>;<a href="1">g=b</a>;var
r,j,k,m,f;if(e){r=d(F).height();b=d(F).width();j=d(n).scrollTop();h=d(n).scrollLeft();k=a.offsetHeight;m=a.offsetWidth;f=a;var
q=0,s=0;if(f.offsetParent){q=f.offsetLeft;s=f.offsetTop;for(f=f.offsetParent;f;)q+=f.offsetLeft,s+=f.offsetTop,f=f.offsetParent}<a
href="q,s">f=</a>;if(i&amp;&amp;“undefined”!=typeof <a
href="1">c.oScroll&&(“”!==c.oScroll.sX||“”!==c.oScroll.sY))f</a>-=<a
href="0">d(c.nTable.parentNode).scrollTop(),f</a>-=d(c.nTable.parentNode).scrollLeft();
<a href="1">f</a>+<a href="1">k>j+r?(r=f</a>+<a
href="1">k-r,n.documentElement.scrollTop=r,n.body.scrollTop=r):f</a>&lt;<a
href="1">j&&(r=f</a>,<a
href="0">n.documentElement.scrollTop=r,n.body.scrollTop=r);f</a>+<a
href="0">m>h+b?(b=f</a>+<a
href="0">m-b,n.documentElement.scrollLeft=b,n.body.scrollLeft=b):f</a>&lt;<a
href="0">h&&(b=f</a>,n.documentElement.scrollLeft=b,n.body.scrollLeft=b)}if(i&amp;&amp;“undefined”!=typeof
...
a.offsetTop+k-r:a.offsetTop&lt;j&amp;&amp;(c.scrollTop=a.offsetTop),a.offsetLeft+m&gt;b+h)?c.scrollLeft=a.offsetLeft+m-b:a.offsetLeft&lt;h&amp;&amp;(c.scrollLeft=a.offsetLeft);o||(o=!0);C(“focus”,l,g)}}function
y(){G(t);t=g=l=null;o=!1}function
G(a){d(a).removeClass(x);d(a).parent().removeClass(x);C(“blur”,l,g)}function
I(){for(var a=this;“TD”!=a.nodeName;)a=a.parentNode;q(a);o||(o=!0)}function
w(a,b){return i?“undefined”!=typeof <a
href="b">i.aoData[i.aiDisplay</a>]?<a href="b">i.aoData[i.aiDisplay</a>].<a
href="a">nTr.getElementsByTagName(“td”)</a>:null:d(“tr:eq(”+ <a
href="0">b+“)>td:eq(”a“)”,z)</a>}function E(a){return <a
href="d("td",a.parentNode).index(a),d("tr",a.parentNode.parentNode).index(a.parentNode)+i._iDisplayStart">i?</a>:[d(“td”,a.parentNode).index(a),d(“tr”,a.parentNode.parentNode).index(a.parentNode)]}function
H(a){for(var b=0,c=i.aiDisplay.length;b&lt;c;b++)for(var <a
href="b">d=i.aoData[i.aiDisplay</a>].<a
href="h">nTr.getElementsByTagName(“td”),h=0,g=d.length;h<g;h++)if(d</a>==<a
href="h,b">a)return</a>;return
null}this.block=!1;this.event={remove:{}};this.fnGetCurrentPosition=function(){<a
href="l,g">return</a>};this.fnGetCurrentData= function(){return
t.innerHTML};this.fnGetCurrentTD=function(){return
t};this.fnSetPosition=function(a,b){“object”==typeof
a&amp;&amp;a.nodeName?q(a):q(w(a,b))};this.fnBlur=function(){y()};var
z=null,t=null,l=null,g=null,J=null,x=“focus”,o=!1,k={<a
href="">action:[],esc:</a>,<a
href="">focus:[],blur:</a>},i=null,D,s,u=!1,m;for(m in <a
href="m">k)m&&(this.event</a>=<a
href="m">A(m),this.event.remove</a>=L(m));var <a
href="0">v;j===K?(m=d(“table.KeyTable”)</a>,v=null):d.isPlainObject(j)?(m=j.table,v=j.datatable):(v=(new
<a href="0">d.fn.dataTable.Api(j)).settings()</a>,m=v.nTable);var b=
j,J=this;“undefined”==typeof b&amp;&amp;(b={});“undefined”==typeof <a
href="0,0">b.focus&&(b.focus=</a>);b.table=m;d(b.table).addClass(“KeyTable”);“undefined”!=typeof
b.focusClass&amp;&amp;(x=b.focusClass);“undefined”!=typeof
v&amp;&amp;(i=v);“undefined”==typeof
b.initScroll&amp;&amp;(b.initScroll=!0);“undefined”==typeof <a
href="0">b.form&&(b.form=!1);D=b.form;z=b.table.getElementsByTagName(“tbody”)</a>;D?(j=n.createElement(“div”),s=n.createElement(“input”),j.style.height=“1px”,j.style.width=“0px”,j.style.overflow=“hidden”,“undefined”!=typeof
b.tabIndex&amp;&amp;
(s.tabIndex=b.tabIndex),j.appendChild(s),b.table.parentNode.insertBefore(j,b.table.nextSibling),d(s).focus(function(){if(!u){o=true;u=false;typeof
<a
href="0">b.focus.nodeName!=“undefined”?q(b.focus,b.initScroll):q(w(b.focus</a>,<a
href="1">b.focus</a>),b.initScroll);setTimeout(function(){s.blur()},0)}}),o=!1):(“undefined”!=typeof
<a href="0">b.focus.nodeName?q(b.focus,b.initScroll):q(w(b.focus</a>,<a
href="1">b.focus</a>),b.initScroll),o||(o=!0));d(n).bind(“keydown”,function(a){if(J.block||!o||a.metaKey||a.altKey||a.ctrlKey)return
true;var <a
href="0">b;b=z.getElementsByTagName(“tr”)</a>.getElementsByTagName(“td”).length;
var c;if(i){c=i.aiDisplay.length;var <a
href="0">d=H(t);if(d===null)return;l=d</a>;<a href="1">g=d</a>}else
c=z.getElementsByTagName(“tr”).length;d=a.keyCode==9&amp;&amp;a.shiftKey?-1:a.keyCode;switch(d){case
13:a.preventDefault();a.stopPropagation();C(“action”,l,g);return true;case
27:if(!C(“esc”,l,g)){y();return}a=l;b=g;break;case -1:case
37:if(l&gt;0){a=l-1;b=g}else
if(g&gt;0){a=b-1;b=g-1}else{if(d==-1&amp;&amp;D){u=true;s.focus();setTimeout(function(){u=false},0);o=false;y();return
true}return false}break;case 38:if(g&gt;0){a=l;b=g-1}else return false;
break;case 36:a=l;b=0;break;case
33:a=l;b=g-10;b&lt;0&amp;&amp;(b=0);break;case 9:case
39:if(l&lt;b-1){a=l+1;b=g}else
if(g&lt;c-1){a=0;b=g+1}else{if(d==9&amp;&amp;D){u=true;s.focus();setTimeout(function(){u=false},0);o=false;y();return
true}return false}break;case 40:if(g&lt;c-1){a=l;b=g+1}else return
false;break;case 35:a=l;b=c-1;break;case
34:a=l;b=g+10;b&gt;c-1&amp;&amp;(b=c-1);break;default:return
true}q(w(a,b));return false});if(i)d(i.nTable).on(“click”,“td”,I);else
d(z).on(“click”,“td”,I);d(n).click(function(a){for(var a=a.target,
d=false;a;){if(a==b.table){d=true;break}a=a.parentNode}d||y()})};KeyTable.version=“1.2.1”;d.fn.dataTable.KeyTable=KeyTable;return
d.fn.DataTable.KeyTable=KeyTable};“function”===typeof <a
href=""jquery","datatables"">define&&define.amd?define(</a>,A):“object”===typeof
exports?A(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.KeyTable&amp;&amp;A(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
