...
<title>dataTables.keyTable.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/KeyTable/js/dataTables.keyTable.js">
...
<p>// Global scope for KeyTable for backwards compatibility. Will be removed
in 1.3 var KeyTable;</p>

<p>(function(window, document, undefined) {</p>

<p>var factory = function( $, DataTable ) { “use strict”;</p>

<p>KeyTable = function ( oInit ) {</p>
...
/
 ...
 /
     ...
     _fnInit( table, datatable, oInit, this );</pre>

<p>};</p>

<p>KeyTable.version = “1.2.1”;</p>

<p>$.fn.dataTable.KeyTable = KeyTable; $.fn.DataTable.KeyTable = KeyTable;</p>

<p>return KeyTable; }; // /factory</p>
...
<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.KeyTable ) {</p>
