...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-TableTools">TableTools</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-Basic+usage">Basic usage</a>
    <li><a href="#label-Documentation+-2F+support">Documentation / support</a>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/TableTools/Readme.md">

<h1 id="label-TableTools">TableTools<span><a href="#label-TableTools">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>TableTools is a plug-in for the DataTables HTML table enhancer, which adds
a highly customisable button toolbar to a DataTable. Key features include:</p>
<ul><li>
<p>Copy to clipboard</p>
</li><li>
<p>Save table data as CSV, XLS or PDF files</p>
</li><li>
<p>Print view for clean printing</p>
</li><li>
<p>Row selection options</p>
</li><li>
<p>Easy use predefined buttons</p>
</li><li>
<p>Simple customisation of buttons</p>
</li><li>
<p>Well defined API for advanced control</p>
</li></ul>

<h1 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>To use TableTools, first download DataTables ( <a
href="http://datatables.net/download">datatables.net/download</a> ) and
place the unzipped TableTools package into a <code>extensions</code>
directory in the DataTables package (in DataTables 1.9- use the
<code>extras</code> directory). This will allow the pages in the examples
to operate correctly. To see the examples running, open the
<code>examples</code> directory in your web-browser.</p>

<h1 id="label-Basic+usage">Basic usage<span><a href="#label-Basic+usage">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>TableTools is initialised using the <code>T</code> option that it adds to
DataTables&#39; <code>dom</code> option. For example:</p>
...
<h1 id="label-Documentation+-2F+support">Documentation / support<span><a href="#label-Documentation+-2F+support">&para;</a> <a href="#top">&uarr;</a></span></h1>
<ul><li>
<p>Documentation: <a
href="http://datatables.net/extensions/tabletools">datatables.net/extensions/tabletools</a>/</p>
</li><li>
<p>DataTables support forums: <a
href="http://datatables.net/forums">datatables.net/forums</a></p>
</li></ul>

<h1 id="label-GitHub">GitHub<span><a href="#label-GitHub">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>If you fancy getting involved with the development of TableTools and help
make it better, please refer to its GitHub repo: <a
href="https://github.com/DataTables/TableTools">github.com/DataTables/TableTools</a></p>
</main>
