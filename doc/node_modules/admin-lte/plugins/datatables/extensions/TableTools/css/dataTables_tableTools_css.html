...
<title>dataTables.tableTools.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/TableTools/css/dataTables.tableTools.css">

<pre> File:        TableTools.css
...
<p>button.DTTT_button, div.DTTT_button, a.DTTT_button {</p>
...
cursor: hand;
      ...
      filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=&#39;#ffffff&#39;, endColorstr=&#39;#f9f9f9&#39;,GradientType=0 ); /* IE6-9 */</pre>

<p>}</p>

<p>/* Buttons are cunning border-box sizing - we can&#39;t just use that for A
and DIV due to IE6/7 */ button.DTTT_button {</p>
...
<p>.DTTT_button embed {</p>

<pre>outline: none;</pre>

<p>}</p>

<p>button.DTTT_button:hover:not(.DTTT_disabled),
div.DTTT_button:hover:not(.DTTT_disabled),
a.DTTT_button:hover:not(.DTTT_disabled) {</p>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=&#39;#f3f3f3&#39;, endColorstr=&#39;#f4f4f4&#39;,GradientType=0 ); /* IE6-9 */</pre>

<p>}</p>

<p>button.DTTT_button:focus, div.DTTT_button:focus, a.DTTT_button:focus {</p>

<pre>border: 1px solid #426c9e;
...
filter: progid:DXImageTransform.Microsoft.gradient(GradientType=0,StartColorStr=&#39;#a3d0ef&#39;, EndColorStr=&#39;#a3d0ef&#39;);</pre>

<p>}</p>

<p>button.DTTT_button:active:not(.DTTT_disabled),
div.DTTT_button:active:not(.DTTT_disabled),
a.DTTT_button:active:not(.DTTT_disabled) {</p>

<pre>-webkit-box-shadow: inset 1px 1px 3px #999999;
-moz-box-shadow: inset 1px 1px 3px #999999;
box-shadow: inset 1px 1px 3px #999999;</pre>

<p>}</p>

<p>button.DTTT_disabled, div.DTTT_disabled, a.DTTT_disabled {</p>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=&#39;#ffffff&#39;, endColorstr=&#39;#fafafa&#39;,GradientType=0 ); /* IE6-9 */</pre>
...
If you want images - comment this back in</pre>

<p>a.DTTT_button_csv, a.DTTT_button_xls, a.DTTT_button_copy,
a.DTTT_button_pdf, a.DTTT_button_print {</p>

<pre>padding-right: 0px;</pre>

<p>}</p>

<p>a.DTTT_button_csv span, a.DTTT_button_xls span, a.DTTT_button_copy span,
a.DTTT_button_pdf span, a.DTTT_button_print span {</p>

<pre>display: inline-block;
height: 24px;
line-height: 24px;
padding-right: 30px;</pre>

<p>}</p>

<p>a.DTTT_button_csv span { background: url(../images/csv.png) no-repeat
bottom right; } a.DTTT_button_csv:hover span { background:
url(../images/csv_hover.png) no-repeat center right; }</p>

<p>a.DTTT_button_xls span { background: url(../images/xls.png) no-repeat
center right; } a.DTTT_button_xls:hover span { background: f0f0f0
url(../images/xls_hover.png) no-repeat center right; }</p>

<p>a.DTTT_button_copy span { background: url(../images/copy.png) no-repeat
center right; } a.DTTT_button_copy:hover span { background: f0f0f0
url(../images/copy_hover.png) no-repeat center right; }</p>

<p>a.DTTT_button_pdf span { background: url(../images/pdf.png) no-repeat
center right; } a.DTTT_button_pdf:hover span { background: f0f0f0
url(../images/pdf_hover.png) no-repeat center right; }</p>

<p>a.DTTT_button_print span { background: url(../images/print.png) no-repeat
center right; } a.DTTT_button_print:hover span { background: f0f0f0
url(../images/print_hover.png) no-repeat center right; }</p>

<pre>/</pre>

<p>button.DTTT_button_collection span {</p>

<pre>padding-right: 17px;
background: url(../images/collection.png) no-repeat center right;</pre>

<p>}</p>

<p>button.DTTT_button_collection:hover span {</p>

<pre>padding-right: 17px;
background: #f0f0f0 url(../images/collection_hover.png) no-repeat center right;</pre>
...
<p>table.DTTT_selectable tbody tr {</p>
...
<p>table.dataTable tr.DTTT_selected.odd {</p>

<pre>background-color: #9FAFD1;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.odd td.sorting_1 {</p>

<pre>background-color: #9FAFD1;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.odd td.sorting_2 {</p>

<pre>background-color: #9FAFD1;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.odd td.sorting_3 {</p>

<pre>background-color: #9FAFD1;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.even {</p>

<pre>background-color: #B0BED9;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.even td.sorting_1 {</p>

<pre>background-color: #B0BED9;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.even td.sorting_2 {</p>

<pre>background-color: #B0BED9;</pre>

<p>}</p>

<p>table.dataTable tr.DTTT_selected.even td.sorting_3 {</p>
   ...
   -moz-box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3);
    -ms-box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3);
     -o-box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3);
        box-shadow: 3px 3px 5px rgba(0, 0, 0, 0.3);</pre>

<p>}</p>

<p>div.DTTT_collection_background {</p>
...
<p>div.DTTT_collection button.DTTT_button, div.DTTT_collection
div.DTTT_button, div.DTTT_collection a.DTTT_button {</p>
...
-webkit-box-shadow: 1px 1px 3px #999;
   -moz-box-shadow: 1px 1px 3px #999;
    -ms-box-shadow: 1px 1px 3px #999;
     -o-box-shadow: 1px 1px 3px #999;
        box-shadow: 1px 1px 3px #999;</pre>
   ...
   -moz-box-shadow: 0 3px 7px rgba(0, 0, 0, 0.5);
    -ms-box-shadow: 0 3px 7px rgba(0, 0, 0, 0.5);
     -o-box-shadow: 0 3px 7px rgba(0, 0, 0, 0.5);
        box-shadow: 0 3px 7px rgba(0, 0, 0, 0.5);</pre>

<p>}</p>

<p>.DTTT_print_info h6 {</p>
