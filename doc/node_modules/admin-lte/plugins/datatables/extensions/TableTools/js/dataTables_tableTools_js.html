...
<title>dataTables.tableTools.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.js">

<pre>! TableTools 2.2.4
...
<p>/* Global scope for TableTools for backwards compatibility.</p>

<pre> Will be removed in 2.3
/</pre>
...
<p>var factory = function( $, DataTable ) { “use strict”;</p>

<p>//include ZeroClipboard.js /* ZeroClipboard 1.0.4</p>

<pre> Author: Joseph Huckaby
/</pre>

<p>var ZeroClipboard_TableTools = {</p>

<pre>version: &quot;1.0.4-TableTools2&quot;,
...
<p>ZeroClipboard_TableTools.Client.prototype = {</p>

<pre>id: 0, // unique ID for us
...
<p>// For the Flash binding to work, ZeroClipboard_TableTools must be on the
global // object list window.ZeroClipboard_TableTools =
ZeroClipboard_TableTools; //include TableTools.js /* TableTools</p>

<pre> 2009-2015 SpryMedia Ltd - datatables.net/license
/</pre>

<p>/*globals TableTools,ZeroClipboard_TableTools</p>

<p>(function($, window, document) {</p>

<p>/**</p>

<pre> TableTools provides flexible buttons and other tools for a DataTables enhanced table
 @class TableTools
 @constructor
...
<p>TableTools = function( oDT, oOpts ) {</p>

<pre>     /* Santiy check that we are a new instance */
...
<pre>Static variables
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */</pre>

<p>/**</p>

<pre> Store of all instances that have been created of TableTools, so one can look up other (when
...
<p>TableTools._aInstances = [];</p>

<p>/**</p>

<pre> Store of all listeners and their callback functions
  @property _aListeners
  @type        Array
  @default  []
/</pre>

<p>TableTools._aListeners = [];</p>
...
<pre> Get an array of all the master instances
  @method  fnGetMasters
  @returns {Array} List of master TableTools instances
  @static
/</pre>

<p>TableTools.fnGetMasters = function () {</p>
...
<pre> Get the master instance for a table node (or id if a string is given)
  @method  fnGetInstance
  @returns {Object} ID of table OR table node, for which we want the TableTools instance
  @static
/</pre>

<p>TableTools.fnGetInstance = function ( node ) {</p>

<pre>if ( typeof node != &#39;object&#39; )
{
...
<pre> Add a listener for a specific event
...
<p>TableTools._fnEventListen = function ( that, type, fn ) {</p>

<pre class="ruby"><span class="ruby-constant">TableTools</span>.<span class="ruby-identifier">_aListeners</span>.<span class="ruby-identifier">push</span>( {
        <span class="ruby-value">&quot;that&quot;:</span> <span class="ruby-identifier">that</span>,
        <span class="ruby-value">&quot;type&quot;:</span> <span class="ruby-identifier">type</span>,
        <span class="ruby-value">&quot;fn&quot;:</span> <span class="ruby-identifier">fn</span>
} );
</pre>
...
<pre> An event has occurred - look up every listener and fire it off. We check that the event we are
...
<p>TableTools._fnEventDispatch = function ( that, type, node, selected ) {</p>

<pre>var listeners = TableTools._aListeners;
...
&quot;fnComplete&quot;: null,
&quot;fnInit&quot;: null,
&quot;fnCellRender&quot;: null</pre>

<p>};</p>

<p>/**</p>

<pre> @namespace Default button configurations
/</pre>

<p>TableTools.BUTTONS = {</p>

<pre>&quot;csv&quot;: $.extend( {}, TableTools.buttonBase, {
        &quot;sAction&quot;: &quot;flash_save&quot;,
...
<p>// Alias to match the other plug-ins styling TableTools.buttons =
TableTools.BUTTONS;</p>

<p>/**</p>

<pre> @namespace Classes used by TableTools - allows the styles to be override easily.
   Note that when TableTools initialises it will take a copy of the classes object
   and will use its internal copy for the remainder of its run time.
/</pre>

<p>TableTools.classes = {</p>

<pre>&quot;container&quot;: &quot;DTTT_container&quot;,
&quot;buttons&quot;: {
        &quot;normal&quot;: &quot;DTTT_button&quot;,
...
<pre> @namespace ThemeRoller classes - built in for compatibility with DataTables&#39; 
   bJQueryUI option.
/</pre>

<p>TableTools.classes_themeroller = {</p>

<pre>&quot;container&quot;: &quot;DTTT_container ui-buttonset ui-buttonset-multi&quot;,
&quot;buttons&quot;: {
...
<pre> @namespace TableTools default settings for initialisation
/</pre>

<p>TableTools.DEFAULTS = {</p>

<pre>&quot;sSwfPath&quot;:        &quot;../swf/copy_csv_xls_pdf.swf&quot;,
&quot;sRowSelect&quot;:      &quot;none&quot;,
&quot;sRowSelector&quot;:    &quot;tr&quot;,
&quot;sSelectedClass&quot;:  null,
&quot;fnPreRowSelect&quot;:  null,
...
<p>// Alias to match the other plug-ins TableTools.defaults =
TableTools.DEFAULTS;</p>

<p>/**</p>

<pre> Name of this class
  @constant CLASS
  @type        String
  @default  TableTools
/</pre>

<p>TableTools.prototype.CLASS = “TableTools”;</p>

<p>/**</p>

<pre> TableTools version
  @constant  VERSION
  @type         String
  @default   See code
/</pre>

<p>TableTools.version = “2.2.4”;</p>

<p>// DataTables 1.10 API //  // This will be extended in a big way in in
TableTools 3 to provide API methods // such as rows().select() and
rows.selected() etc, but for the moment the // tabletools() method simply
returns the instance.</p>

<p>if ( $.fn.dataTable.Api ) {</p>

<pre>$.fn.dataTable.Api.register( &#39;tabletools()&#39;, function () {
        var tt = null;
...
<pre> Register a new feature with DataTables
/</pre>

<p>if ( typeof $.fn.dataTable == “function” &amp;&amp;</p>

<pre>typeof $.fn.dataTableExt.fnVersionCheck == &quot;function&quot; &amp;&amp;
$.fn.dataTableExt.fnVersionCheck(&#39;1.9.0&#39;) )</pre>

<p>{</p>

<pre>$.fn.dataTableExt.aoFeatures.push( {
...
<pre class="ruby"><span class="ruby-identifier">alert</span>( <span class="ruby-string">&quot;Warning: TableTools requires DataTables 1.9.0 or newer - www.datatables.net/download&quot;</span>);
</pre>

<p>}</p>

<p>$.fn.DataTable.TableTools = TableTools;</p>
...
<pre class="ruby"><span class="ruby-identifier">alert</span>( <span class="ruby-string">&quot;Warning: TableTools 2 requires DataTables 1.9.0 or newer - www.datatables.net/download&quot;</span>);
</pre>

<p>}</p>

<p>$.fn.dataTable.TableTools = TableTools; $.fn.DataTable.TableTools =
TableTools;</p>

<p>return TableTools; }; // /factory</p>

<p>// Define as an AMD module if possible if ( typeof define ===
&#39;function&#39; &amp;&amp; define.amd ) {</p>

<pre class="ruby"><span class="ruby-identifier">define</span>( [<span class="ruby-string">&#39;jquery&#39;</span>, <span class="ruby-string">&#39;datatables&#39;</span>], <span class="ruby-identifier">factory</span> );
</pre>

<p>} else if ( typeof exports === &#39;object&#39; ) {</p>

<pre>// Node/CommonJS
factory( require(&#39;jquery&#39;), require(&#39;datatables&#39;) );</pre>

<p>} else if ( jQuery &amp;&amp; !jQuery.fn.dataTable.TableTools ) {</p>

<pre>// Otherwise simply initialise as normal, stopping multiple evaluation
factory( jQuery, jQuery.fn.dataTable );</pre>
