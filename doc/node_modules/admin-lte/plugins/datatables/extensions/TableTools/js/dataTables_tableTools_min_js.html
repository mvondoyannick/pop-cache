...
<title>dataTables.tableTools.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js">
...
ZeroClipboard 1.0.4
Author: Joseph Huckaby - MIT licensed</pre>

<p>var TableTools; (function(n,k,q){var p=function(m,p){var
...
”+a},a.removeClass=function(a){this.className=this.className.replace(RegExp(“\s*”<code>a</code>“\s*”),“
”).replace(/^s+/,“”).replace(/s+$/,“”)},a.hasClass=function(a){return!!this.className.match(RegExp(“\s*”<code>a</code>
“\s*”))});return
a},setMoviePath:function(a){this.moviePath=a},dispatch:function(a,b,c){(<a
href="a">a=this.clients</a>)&amp;&amp;a.receiveEvent(b,c)},register:function(a,b){<a
href="a">this.clients</a>=b},getDOMObjectPosition:function(a){var
...
<a
href="0">0!==a.height&&(this.sized=!0,b=this.div.childNodes</a>,b.width=a.width,b.height=a.height)},getHTML:function(a,b){var
c=“”,d=“id=”<code>this.id</code>“&amp;width=”<code>a</code>“&amp;height=”+b;if(navigator.userAgent.match(/MSIE/))var
f=location.href.match(/^https/i)?“<a
href="https://":"http://",c=c+('<object">”:“http://”,c=c+(‘<object</a>
classid=“clsid:D27CDB6E-AE6D-11cf-96B8-444553540000”
codebase=“&#39;<code>f</code>&#39;download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0”
width=“&#39;<code>a</code>&#39;” height=“&#39;<code>b</code>&#39;”
id=“&#39;<code>this.movieId</code>&#39;” align=“middle”&gt;&lt;param
name=“allowScriptAccess” value=“always” /&gt;&lt;param
name=“allowFullScreen” value=“false” /&gt;&lt;param name=“movie”
value=“&#39;+ g.moviePath+&#39;” /&gt;&lt;param name=“loop” value=“false”
/&gt;&lt;param name=“menu” value=“false” /&gt;&lt;param name=“quality”
value=“best” /&gt;&lt;param name=“bgcolor” value=“#ffffff” /&gt;&lt;param
name=“flashvars” value=“&#39;<code>d</code>&#39;”/&gt;&lt;param
name=“wmode” value=“transparent”/&gt;&lt;/object&gt;&#39;);else
c+=&#39;&lt;embed id=“&#39;<code>this.movieId</code>&#39;”
src=“&#39;<code>g.moviePath</code>&#39;” loop=“false” menu=“false”
quality=“best” bgcolor=“#ffffff” width=“&#39;<code>a</code>&#39;”
height=“&#39;<code>b</code>&#39;”
name=“&#39;<code>this.movieId</code>&#39;” align=“middle”
allowScriptAccess=“always” allowFullScreen=“false”
type=“application/x-shockwave-flash” pluginspage=“<a
href="http://www.macromedia.com/go/getflashplayer">www.macromedia.com/go/getflashplayer</a>”
flashvars=“&#39;+ d+&#39;” wmode=“transparent” /&gt;&#39;;return
...
<a
href="0">a=k.getElementsByTagName(“body”)</a>;try{a.removeChild(this.div)}catch(b){}this.div=this.domElement=null}},reposition:function(a){a&amp;&amp;((this.domElement=g.$(a))||this.hide());if(this.domElement&amp;&amp;this.div){var
a=g.getDOMObjectPosition(this.domElement),b=this.div.style;b.left=“”<code>a.left</code>
“px”;b.top=“”<code>a.top</code>“px”}},clearText:function(){this.clipText=“”;this.ready&amp;&amp;this.movie.clearText()},appendText:function(a){this.clipText+=a;this.ready&amp;&amp;this.movie.appendText(a)},setText:function(a){this.clipText=a;this.ready&amp;&amp;this.movie.setText(a)},setCharSet:function(a){this.charSet=a;this.ready&amp;&amp;this.movie.setCharSet(a)},setBomInc:function(a){this.incBom=a;this.ready&amp;&amp;this.movie.setBomInc(a)},setFileName:function(a){this.fileName=a;this.ready&amp;&amp;this.movie.setFileName(a)},setAction:function(a){this.action=
a;this.ready&amp;&amp;this.movie.setAction(a)},addEventListener:function(a,b){<a
href="a">a=a.toString().toLowerCase().replace(/^on/,“”);this.handlers</a>||(<a
href="a">this.handlers</a>=[]);<a
href="a">this.handlers</a>.push(b)},setHandCursor:function(a){this.handCursorEnabled=a;this.ready&amp;&amp;this.movie.setHandCursor(a)},setCSSEffects:function(a){this.cssEffects=!!a},receiveEvent:function(a,b){var
...
“mouseup”:this.domElement&amp;&amp;this.cssEffects&amp;&amp;(this.domElement.removeClass(“active”),this.recoverActive=!1)}<a
href="a">if(this.handlers</a>)for(var <a
href="a">d=0,f=this.handlers</a>.length;d&lt; f;d++){var <a
href="a">e=this.handlers</a>[d];if(“function”==typeof e)e(this,b);else
if(“object”==typeof <a href="0">e&&2==e.length)e</a>[<a
href="1">e</a>](this,b);else if(“string”==typeof <a
href="e">e)n</a>(this,b)}}};n.ZeroClipboard_TableTools=g;var
e=jQuery;TableTools=function(a,b){!this instanceof
TableTools&amp;&amp;alert(“Warning: TableTools must be initialised with the
keyword &#39;new&#39;”);this.s={that:this,dt:e.fn.dataTable.Api?(new <a
href="0">e.fn.dataTable.Api(a)).settings()</a>:a.fnSettings(),print:{saveStart:-1,saveLength:-1,saveScroll:-1,funcEnd:function(){}},
buttonCounter:0,select:{<a
href="">type:“”,selected:[],preRowSelect:null,postSelected:null,postDeselected:null,all:!1,selectedClass:“”},custom:{},swfPath:“”,buttonSet:</a>,master:!1,tags:{}};this.dom={container:null,table:null,print:{hidden:[],message:null},collection:{collection:null,background:null}};this.classes=e.extend(!0,{},TableTools.classes);this.s.dt.bJUI&amp;&amp;e.extend(!0,this.classes,TableTools.classes_themeroller);this.fnSettings=function(){return
this.s};“undefined”==typeof
b&amp;&amp;(b={});TableTools._aInstances.push(this);
this._fnConstruct(b);return
this};TableTools.prototype={fnGetSelected:function(a){var <a
href="a">b=[],c=this.s.dt.aoData,d=this.s.dt.aiDisplay,f;if(a){a=0;for(f=d.length;a<f;a++)c[d</a>].<a
href="a">_DTTT_selected&&b.push(c[d</a>].nTr)}else{<a
href="a">a=0;for(f=c.length;a<f;a++)c</a>.<a
href="a">_DTTT_selected&&b.push(c</a>.nTr)}return
b},fnGetSelectedData:function(){var <a
href="c">a=[],b=this.s.dt.aoData,c,d;c=0;for(d=b.length;c<d;c++)b</a>._DTTT_selected&amp;&amp;a.push(this.s.dt.oInstance.fnGetData©);return
a},fnGetSelectedIndexes:function(a){var b=[],c=this.s.dt.aoData,
d=this.s.dt.aiDisplay,f;if(a){<a
href="a">a=0;for(f=d.length;a<f;a++)c[d</a>].<a
href="a">_DTTT_selected&&b.push(d</a>)}else{<a
href="a">a=0;for(f=c.length;a<f;a++)c</a>._DTTT_selected&amp;&amp;b.push(a)}return
b},fnIsSelected:function(a){<a
href="a">a=this.s.dt.oInstance.fnGetPosition(a);return!0===this.s.dt.aoData</a>._DTTT_selected?!0:!1},fnSelectAll:function(a){this._fnRowSelect(a?this.s.dt.aiDisplay:this.s.dt.aoData)},fnSelectNone:function(a){this._fnRowDeselect(this.fnGetSelectedIndexes(a))},fnSelect:function(a){“single”==this.s.select.type&amp;&amp;this.fnSelectNone();
this._fnRowSelect(a)},fnDeselect:function(a){this._fnRowDeselect(a)},fnGetTitle:function(a){var
b=“”;“undefined”!=typeof <a
href="0">a.sTitle&&“”!==a.sTitle?b=a.sTitle:(a=k.getElementsByTagName(“title”),0<a.length&&(b=a</a>.innerHTML));return
4&gt;“¡”.toString().length?b.replace(/[^a-zA-Z0-9_u00A1-uFFFF.,-_
!()]/g,“”):b.replace(/[^a-zA-Z0-9_.,-_
!()]/g,“”)},fnCalcColRatios:function(a){var <a
href="e">b=this.s.dt.aoColumns,a=this._fnColumnTargets(a.mColumns),c=[],d=0,f=0,e,i;e=0;for(i=a.length;e<i;e++)a</a>&amp;&amp;(<a
href="e">d=b</a>.nTh.offsetWidth, <a
href="e">f+=d,c.push(d));e=0;for(i=c.length;e<i;e++)c</a>/=f;return
c.join(“t”)},fnGetTableData:function(a){if(this.s.dt)return
this._fnGetDataTablesData(a)},fnSetText:function(a,b){this._fnFlashSetText(a,b)},fnResizeButtons:function(){for(var
a in g.clients)if(a){var <a href="a">b=g.clients</a>;“undefined”!=typeof
b.domElement&amp;&amp;b.domElement.parentNode&amp;&amp;b.positionElement()}},fnResizeRequired:function(){for(var
a in g.clients)if(a){var <a href="a">b=g.clients</a>;if(“undefined”!=typeof
...
“none”!=this.s.select.type&amp;&amp;this._fnRowSelectConfig();this._fnButtonDefinations(this.s.buttonSet,this.dom.container);this.s.dt.aoDestroyCallback.push({sName:“TableTools”,fn:function(){e(b.s.dt.nTBody).off(“click.DTTT_Select”,b.s.custom.sRowSelector).off(“mousedown.DTTT_Select”,“tr”).off(“mouseup.DTTT_Select”,“tr”);e(b.dom.container).empty();var
...
(this.s.master=!0,this.s.dt._TableToolsInit=!0);this.dom.table=this.s.dt.nTable;this.s.custom=e.extend({},TableTools.DEFAULTS,a);this.s.swfPath=this.s.custom.sSwfPath;“undefined”!=typeof
...
this.s.tags=this.s.custom.oTags;this.s.buttonSet=this.s.custom.aButtons},_fnButtonDefinations:function(a,b){for(var
c,d=0,f=a.length;d&lt;f;d++){if(“string”==typeof <a
href="d">a</a>){if(“undefined”==typeof <a
href="d">TableTools.BUTTONS[a</a>]){alert(“TableTools: Warning - unknown
button type: ”+<a href="d">a</a>);continue}c=e.extend({},<a
href="d">TableTools.BUTTONS[a</a>],!0)}else{if(“undefined”==typeof <a
href="d">TableTools.BUTTONS[a</a>.sExtends]){alert(“TableTools: Warning -
unknown button type: ”+<a
href="d">a</a>.sExtends);continue}c=e.extend({},<a
href="d">TableTools.BUTTONS[a</a>.sExtends], !<a
href="d">0);c=e.extend(c,a</a>,!0)}(c=this._fnCreateButton(c,e(b).hasClass(this.classes.collection.container)))&amp;&amp;b.appendChild©}},_fnCreateButton:function(a,b){var
c=this._fnButtonBase(a,b);if(a.sAction.match(/flash/)){if(!this._fnHasFlash())return!1;this._fnFlashConfig(c,a)}else“text”==a.sAction?this._fnTextConfig(c,a):“div”==a.sAction?this._fnTextConfig(c,a):“collection”==a.sAction&amp;&amp;(this._fnTextConfig(c,a),this._fnCollectionConfig(c,a));if(-1!==this.s.dt.iTabIndex)e©.attr(“tabindex”,this.s.dt.iTabIndex).attr(“aria-controls”,
this.s.dt.sTableId).on(“keyup.DTTT”,function(a){13===a.keyCode&amp;&amp;(a.stopPropagation(),e(this).trigger(“click”))}).on(“mousedown.DTTT”,function(b){a.sAction.match(/flash/)||b.preventDefault()});return
c},_fnButtonBase:function(a,b){var
c,d,f;b?(c=a.sTag&amp;&amp;“default”!==a.sTag?a.sTag:this.s.tags.collection.button,d=a.sLinerTag&amp;&amp;“default”!==a.sLinerTag?a.sLiner:this.s.tags.collection.liner,f=this.classes.collection.buttons.normal):(c=a.sTag&amp;&amp;“default”!==a.sTag?a.sTag:this.s.tags.button,d=a.sLinerTag&amp;&amp;“default”!==
a.sLinerTag?a.sLiner:this.s.tags.liner,f=this.classes.buttons.normal);c=k.createElement©;d=k.createElement(d);var
e=this._fnGetMasterSettings();c.className=f+“
”+a.sButtonClass;c.setAttribute(“id”,“ToolTables_”<code>this.s.dt.sInstance</code>“_”+e.buttonCounter);c.appendChild(d);d.innerHTML=a.sButtonText;e.buttonCounter++;return
c},_fnGetMasterSettings:function(){if(this.s.master)return this.s;for(var
<a
href="b">a=TableTools._aInstances,b=0,c=a.length;b<c;b++)if(this.dom.table==a</a>.s.dt.nTable)return
<a href="b">a</a>.s},_fnCollectionConfig:function(a, b){var
c=k.createElement(this.s.tags.collection.container);c.style.display=“none”;c.className=this.classes.collection.container;b._collection=c;k.body.appendChild©;this._fnButtonDefinations(b.aButtons,c)},_fnCollectionShow:function(a,b){var
...
a=
this,b=this.s.dt;e(b.nTable).addClass(this.classes.select.table);“os”===this.s.select.type&amp;&amp;(e(b.nTBody).on(“mousedown.DTTT_Select”,“tr”,function(a){if(a.shiftKey)e(b.nTBody).css(“-moz-user-select”,“none”).one(“selectstart.DTTT_Select”,“tr”,function(){return!1})}),e(b.nTBody).on(“mouseup.DTTT_Select”,“tr”,function(){e(b.nTBody).css(“-moz-user-select”,“”)}));e(b.nTBody).on(“click.DTTT_Select”,this.s.custom.sRowSelector,function©{var
<a
href="0">d=this.nodeName.toLowerCase()===“tr”?this:e(this).parents(“tr”)</a>,
f=a.s.select,j=a.s.dt.oInstance.fnGetPosition(d);if(d.parentNode==b.nTBody&amp;&amp;b.oInstance.fnGetData(d)!==null){if(f.type==“os”)if(c.ctrlKey||c.metaKey)a.fnIsSelected(d)?a._fnRowDeselect(d,c):a._fnRowSelect(d,c);else
if(c.shiftKey){var
...
g=o,o=h,h=g;i.splice(o+1,i.length);i.splice(0,h)}if(a.fnIsSelected(d)){i.splice(e.inArray(j,i),1);a._fnRowDeselect(i,
c)}else a._fnRowSelect(i,c)}else
...
f.type==“multi”&amp;&amp;a._fnRowSelect(d,c);f.lastRow=j}});b.oApi._fnCallbackReg(b,“aoRowCreatedCallback”,function(c,d,f){<a
href="f">b.aoData</a>._DTTT_selected&amp;&amp;e©.addClass(a.classes.select.row)},“TableTools-SelectAll”)}},_fnRowSelect:function(a,b){var
c= <a
href="f">this._fnSelectData(a),d=[],f,j;f=0;for(j=c.length;f<j;f++)c</a>.<a
href="f">nTr&&d.push(c</a>.nTr);if(null===this.s.select.preRowSelect||this.s.select.preRowSelect.call(this,b,d,!0)){<a
href="f">f=0;for(j=c.length;f<j;f++)c</a>.<a
href="f">_DTTT_selected=!0,c</a>.<a
href="f">nTr&&e(c</a>.nTr).addClass(this.classes.select.row);null!==this.s.select.postSelected&amp;&amp;this.s.select.postSelected.call(this,d);TableTools._fnEventDispatch(this,“select”,d,!0)}},_fnRowDeselect:function(a,b){var
<a
href="f">c=this._fnSelectData(a),d=[],f,j;f=0;for(j=c.length;f<j;f++)c</a>.nTr&amp;&amp;
<a
href="f">d.push(c</a>.nTr);if(null===this.s.select.preRowSelect||this.s.select.preRowSelect.call(this,b,d,!1)){<a
href="f">f=0;for(j=c.length;f<j;f++)c</a>.<a
href="f">_DTTT_selected=!1,c</a>.<a
href="f">nTr&&e(c</a>.nTr).removeClass(this.classes.select.row);null!==this.s.select.postDeselected&amp;&amp;this.s.select.postDeselected.call(this,d);TableTools._fnEventDispatch(this,“select”,d,!1)}},_fnSelectData:function(a){var
<a
href="c">b=[],c,d,f;if(a.nodeName)c=this.s.dt.oInstance.fnGetPosition(a),b.push(this.s.dt.aoData</a>);else
if(“undefined”!==typeof a.length){d= <a
href="d">0;for(f=a.length;d<f;d++)a</a>.<a
href="d">nodeName?(c=this.s.dt.oInstance.fnGetPosition(a</a>),<a
href="c">b.push(this.s.dt.aoData</a>)):“number”===typeof <a
href="d">a</a>?<a href="d">b.push(this.s.dt.aoData[a</a>]):<a
href="d">b.push(a</a>)}else“number”===typeof <a
href="a">a?b.push(this.s.dt.aoData</a>):b.push(a);return
b},_fnTextConfig:function(a,b){var
c=this;null!==b.fnInit&amp;&amp;b.fnInit.call(this,a,b);“”!==b.sToolTip&amp;&amp;(a.title=b.sToolTip);e(a).hover(function(){b.fnMouseover!==null&amp;&amp;b.fnMouseover.call(this,a,b,null)},function(){b.fnMouseout!==null&amp;&amp;b.fnMouseout.call(this,
a,b,null)});null!==b.fnSelect&amp;&amp;TableTools._fnEventListen(this,“select”,function(d){b.fnSelect.call(c,a,b,d)});e(a).click(function(d){b.fnClick!==null&amp;&amp;b.fnClick.call(c,a,b,null,d);b.fnComplete!==null&amp;&amp;b.fnComplete.call(c,a,b,null,null);c._fnCollectionHide(a,b)})},_fnHasFlash:function(){try{if(new
ActiveXObject(“ShockwaveFlash.ShockwaveFlash”))return!0}catch(a){<a
href=""application/x-shockwave-flash"">if(navigator.mimeTypes&&navigator.mimeTypes</a>!==<a
href=""application/x-shockwave-flash"">q&&navigator.mimeTypes</a>.enabledPlugin)return!0}return!1},
...
a,b,d)});d.addEventListener(“mouseOut”,function(){b.fnMouseout!==null&amp;&amp;b.fnMouseout.call(c,a,b,d)});d.addEventListener(“mouseDown”,function(){b.fnClick!==null&amp;&amp;b.fnClick.call(c,a,b,d)});d.addEventListener(“complete”,function(f,e){b.fnComplete!==null&amp;&amp;b.fnComplete.call(c,a,b,d,e);c._fnCollectionHide(a,b)});null!==b.fnSelect&amp;&amp;TableTools._fnEventListen(this,“select”,function(d){b.fnSelect.call(c,a,b,d)});this._fnFlashGlue(d,a,b.sToolTip)},_fnFlashGlue:function(a,b,c){var
d=this,f=b.getAttribute(“id”);
k.getElementById(f)?a.glue(b,c):setTimeout(function(){d._fnFlashGlue(a,b,c)},100)},_fnFlashSetText:function(a,b){var
c=this._fnChunkData(b,8192);a.clearText();for(var <a
href="d">d=0,f=c.length;d<f;d++)a.appendText(c</a>)},_fnColumnTargets:function(a){var
b=[],c=this.s.dt,d,f=c.aoColumns;d=f.length;if(“function”==typeof
a){a=a.call(this,c);for(c=0;c&lt;d;c++)b.push(-1!==e.inArray(c,a)?!0:!1)}else
if(“object”==typeof a){<a
href="c">for(c=0;c<d;c++)b.push(!1);c=0;for(d=a.length;c<d;c++)b[a</a>]=!0}else
if(“visible”==a)for(c=0;c&lt; <a
href="c">d;c++)b.push(f</a>.bVisible?!0:!1);else <a
href="c">if(“hidden”==a)for(c=0;c<d;c++)b.push(f</a>.bVisible?!1:!0);else
<a
href="c">if(“sortable”==a)for(c=0;c<d;c++)b.push(f</a>.bSortable?!0:!1);else
for(c=0;c&lt;d;c++)b.push(!0);return
b},_fnNewline:function(a){return“auto”==a.sNewLine?navigator.userAgent.match(/Windows/)?“rn”:“n”:a.sNewLine},_fnGetDataTablesData:function(a){var
b,c,d,f,j,i=[],h=“”,g=this.s.dt,k,l=RegExp(a.sFieldBoundary,“g”),n=this._fnColumnTargets(a.mColumns);d=“undefined”!=typeof
a.bSelectedOnly?a.bSelectedOnly: !1;if(a.bHeader){<a
href="b">j=[];b=0;for(c=g.aoColumns.length;b<c;b++)n</a>&amp;&amp;(<a
href="b">h=g.aoColumns</a>.sTitle.replace(/n/g,“
”).replace(/&lt;.*?&gt;/g,“”).replace(/^s+|s+$/g,“”),h=this._fnHtmlDecode(h),j.push(this._fnBoundData(h,a.sFieldBoundary,l)));i.push(j.join(a.sFieldSeperator))}d=!0;var
...
g.oInstance.fnGetPosition(b)}).get(); d=0;for(f=m.length;d&lt;f;d++){<a
href="d">k=g.aoData[m</a>].<a
href="b">nTr;j=[];b=0;for(c=g.aoColumns.length;b<c;b++)n</a>&amp;&amp;(<a
href="d">h=g.oApi._fnGetCellData(g,m</a>,<a
href="d">b,“display”),a.fnCellRender?h=a.fnCellRender(h,b,k,m</a>)+“”:“string”==typeof
h?(h=h.replace(/n/g,“ ”),<a
href="^"">h=h.replace(/<img.*?\s+alt\s*=\s*(?:"(</a>+)“|&#39;([^&#39;]+)&#39;|([^s&gt;]+)).*?&gt;/gi,”$1$2$3“),h=h.replace(/&lt;.*?&gt;/g,”“)):h+=”“,h=h.replace(/^s+/,”“).replace(/s+$/,”“),h=this._fnHtmlDecode(h),j.push(this._fnBoundData(h,a.sFieldBoundary,l)));i.push(j.join(a.sFieldSeperator));a.bOpenRows&amp;&amp;
(b=e.grep(g.aoOpenRows,function(a){return a.nParent===k}),<a
href="0">1===b.length&&(h=this._fnBoundData(e(”td“,b</a>.nTr).html(),a.sFieldBoundary,l),i.push(h)))}if(a.bFooter&amp;&amp;null!==g.nTFoot){<a
href="b">j=[];b=0;for(c=g.aoColumns.length;b<c;b++)n</a>&amp;&amp;<a
href="b">null!==g.aoColumns</a>.<a
href="b">nTf&&(h=g.aoColumns</a>.nTf.innerHTML.replace(/n/g,”
“).replace(/&lt;.*?&gt;/g,”“),h=this._fnHtmlDecode(h),j.push(this._fnBoundData(h,a.sFieldBoundary,l)));i.push(j.join(a.sFieldSeperator))}return
i.join(this._fnNewline(a))},_fnBoundData:function(a,b,c){return”“===
b?a:b+a.replace(c,b+b)+b},_fnChunkData:function(a,b){for(var
...
b=k.createElement(”div“);return <a
href="^\s">a.replace(/&(</a>*?);/g,function(a,d){if(”#“===a.substr(1,1))return
String.fromCharCode(Number(d.substr(1)));b.innerHTML=a;return <a
href="0">b.childNodes</a>.nodeValue})},_fnPrintStart:function(a){var
b=this,c=this.s.dt;this._fnPrintHideNodes(c.nTable);this.s.print.saveStart=
c._iDisplayStart;this.s.print.saveLength=c._iDisplayLength;a.bShowAll&amp;&amp;(c._iDisplayStart=0,c._iDisplayLength=-1,c.oApi._fnCalculateEnd&amp;&amp;c.oApi._fnCalculateEnd©,c.oApi._fnDraw©);if(”“!==c.oScroll.sX||”“!==c.oScroll.sY)this._fnPrintScrollStart©,e(this.s.dt.nTable).bind(”draw.DTTT_Print“,function(){b._fnPrintScrollStart©});var
d=c.aanFeatures,f;for(f in
d)if(”i“!=f&amp;&amp;”t“!=f&amp;&amp;1==f.length)for(var <a
href="f">g=0,i=d</a>.length;g&lt;i;g++)this.dom.print.hidden.push({<a
href="f">node:d</a>[g],display:”block“}),<a
href="f">d</a>[g].style.display=
”none“;e(k.body).addClass(this.classes.print.body);”“!==a.sInfo&amp;&amp;this.fnInfo(a.sInfo,3E3);a.sMessage&amp;&amp;e(”&lt;div/&gt;“).addClass(this.classes.print.message).html(a.sMessage).prependTo(”body“);this.s.print.saveScroll=e(n).scrollTop();n.scrollTo(0,0);e(k).bind(”keydown.DTTT“,function(a){if(a.keyCode==27){a.preventDefault();b._fnPrintEnd.call(b,a)}})},_fnPrintEnd:function(){var
a=this.s.dt,b=this.s.print;this._fnPrintShowNodes();if(”“!==a.oScroll.sX||”“!==a.oScroll.sY)e(this.s.dt.nTable).unbind(”draw.DTTT_Print“),
this._fnPrintScrollEnd();n.scrollTo(0,b.saveScroll);e(”div.“+this.classes.print.message).remove();e(k.body).removeClass(”DTTT_Print“);a._iDisplayStart=b.saveStart;a._iDisplayLength=b.saveLength;a.oApi._fnCalculateEnd&amp;&amp;a.oApi._fnCalculateEnd(a);a.oApi._fnDraw(a);e(k).unbind(”keydown.DTTT“)},_fnPrintScrollStart:function(){var
<a
href="0">a=this.s.dt;a.nScrollHead.getElementsByTagName(”div“)</a>.getElementsByTagName(”table“);var
<a
href="0">b=a.nTable.parentNode,c;c=a.nTable.getElementsByTagName(”thead“);0<c.length&&a.nTable.removeChild(c</a>);
<a
href="0">null!==a.nTFoot&&(c=a.nTable.getElementsByTagName(”tfoot“),0<c.length&&a.nTable.removeChild(c</a>));<a
href="0">c=a.nTHead.cloneNode(!0);a.nTable.insertBefore(c,a.nTable.childNodes</a>);<a
href="1">null!==a.nTFoot&&(c=a.nTFoot.cloneNode(!0),a.nTable.insertBefore(c,a.nTable.childNodes</a>));”“!==a.oScroll.sX&amp;&amp;(a.nTable.style.width=e(a.nTable).outerWidth()+”px“,b.style.width=e(a.nTable).outerWidth()+”px“,b.style.overflow=”visible“);”“!==a.oScroll.sY&amp;&amp;(b.style.height=e(a.nTable).outerHeight()+”px“,b.style.overflow=”visible“)},
...
<a href="b">a=this.dom.print.hidden,b=0,c=a.length;b<c;b++)a</a>.<a
href="b">node.style.display=a</a>.display;a.splice(0,a.length)},_fnPrintHideNodes:function(a){for(var
b=this.dom.print.hidden,c=a.parentNode,d=c.childNodes,f=0,g=d.length;f&lt;
<a href="f">g;f++)if(d</a>!=<a href="f">a&&1==d</a>.nodeType){var <a
href="f">i=e(d</a>).css(”display“);”none“!=i&amp;&amp;(b.push({<a
href="f">node:d</a>,display:i}),<a
href="f">d</a>.style.display=”none“)}”BODY“!=c.nodeName.toUpperCase()&amp;&amp;this._fnPrintHideNodes©}};<a
href="">TableTools._aInstances=[];TableTools._aListeners=</a>;TableTools.fnGetMasters=function(){for(var
<a
href="b">a=[],b=0,c=TableTools._aInstances.length;b<c;b++)TableTools._aInstances</a>.<a
href="b">s.master&&a.push(TableTools._aInstances</a>);return
a};TableTools.fnGetInstance=function(a){”object“!=typeof
a&amp;&amp;(a=k.getElementById(a)); for(var <a
href="b">b=0,c=TableTools._aInstances.length;b<c;b++)if(TableTools._aInstances</a>.<a
href="b">s.master&&TableTools._aInstances</a>.dom.table==a)return <a
href="b">TableTools._aInstances</a>;return
...
<a
href="e">f=TableTools._aListeners,e=0,g=f.length;e<g;e++)a.dom.table==f</a>.<a
href="e">that.dom.table&&f</a>.<a
href="e">type==b&&f</a>.fn(c,d)};TableTools.buttonBase={sAction:”text“,sTag:”default“,sLinerTag:”default“,
sButtonClass:”DTTT_button_text“,sButtonText:”Button
text“,sTitle:”“,sToolTip:”“,sCharSet:”utf8“,bBomInc:!1,sFileName:”*.csv“,sFieldBoundary:”“,sFieldSeperator:”t“,sNewLine:”auto“,mColumns:”all“,bHeader:!0,bFooter:!0,bOpenRows:!1,bSelectedOnly:!1,oSelectorOpts:q,fnMouseover:null,fnMouseout:null,fnClick:null,fnSelect:null,fnComplete:null,fnInit:null,fnCellRender:null};TableTools.BUTTONS={csv:e.extend({},TableTools.buttonBase,{sAction:”flash_save“,sButtonClass:”DTTT_button_csv“,sButtonText:”CSV“,sFieldBoundary:&#39;”&#39;,
...
d){a=d.split(“n”).length;b.bHeader&amp;&amp;a–;null!==this.s.dt.nTFoot&amp;&amp;b.bFooter&amp;&amp;a–;this.fnInfo(“&lt;h6&gt;Table
copied&lt;/h6&gt;&lt;p&gt;Copied ”<code>a</code>“ row”+(1==a?“”:“s”)+“ to
the
clipboard.&lt;/p&gt;”,1500)}}),pdf:e.extend({},TableTools.buttonBase,{sAction:“flash_pdf”,sNewLine:“n”,sFileName:“*.pdf”,sButtonClass:“DTTT_button_pdf”,sButtonText:“PDF”,sPdfOrientation:“portrait”,sPdfSize:“A4”,sPdfMessage:“”,fnClick:function(a,b,c){this.fnSetText(c,“title:”+this.fnGetTitle(b)+“nmessage:”<code>b.sPdfMessage</code>“ncolWidth:”+this.fnCalcColRatios(b)+
“norientation:”<code>b.sPdfOrientation</code>“nsize:”<code>b.sPdfSize</code>“n–/TableToolsOpts–n”+this.fnGetTableData(b))}}),print:e.extend({},TableTools.buttonBase,{sInfo:“&lt;h6&gt;Print
view&lt;/h6&gt;&lt;p&gt;Please use your browser&#39;s print function to
print this table. Press escape when
finished.&lt;/p&gt;”,sMessage:null,bShowAll:!0,sToolTip:“View print
view”,sButtonClass:“DTTT_button_print”,sButtonText:“Print”,fnClick:function(a,b){this.fnPrint(!0,b)}}),text:e.extend({},TableTools.buttonBase),select:e.extend({},TableTools.buttonBase,
{sButtonText:“Select
...
button”,fnSelect:function(a){1==this.fnGetSelected().length?e(a).removeClass(this.classes.buttons.disabled):e(a).addClass(this.classes.buttons.disabled)},fnInit:function(a){e(a).addClass(this.classes.buttons.disabled)}}),
select_all:e.extend({},TableTools.buttonBase,{sButtonText:“Select
all”,fnClick:function(){this.fnSelectAll()},fnSelect:function(a){this.fnGetSelected().length==this.s.dt.fnRecordsDisplay()?e(a).addClass(this.classes.buttons.disabled):e(a).removeClass(this.classes.buttons.disabled)}}),select_none:e.extend({},TableTools.buttonBase,{sButtonText:“Deselect
all”,fnClick:function(){this.fnSelectNone()},fnSelect:function(a){0!==this.fnGetSelected().length?e(a).removeClass(this.classes.buttons.disabled):e(a).addClass(this.classes.buttons.disabled)},
fnInit:function(a){e(a).addClass(this.classes.buttons.disabled)}}),ajax:e.extend({},TableTools.buttonBase,{sAjaxUrl:“/xhr.php”,sButtonText:“Ajax
button”,fnClick:function(a,b){var c=this.fnGetTableData(b);e.ajax({<a
href="{name:"tableData",value:c}">url:b.sAjaxUrl,data:</a>,success:b.fnAjaxComplete,dataType:“json”,type:“POST”,cache:!1,error:function(){alert(“Error
detected when sending table data to
server”)}})},fnAjaxComplete:function(){alert(“Ajax
complete”)}}),div:e.extend({},TableTools.buttonBase,{sAction:“div”,
sTag:“div”,sButtonClass:“DTTT_nonbutton”,sButtonText:“Text
button”}),collection:e.extend({},TableTools.buttonBase,{sAction:“collection”,sButtonClass:“DTTT_button_collection”,sButtonText:“Collection”,fnClick:function(a,b){this._fnCollectionShow(a,b)}})};TableTools.buttons=TableTools.BUTTONS;TableTools.classes={container:“DTTT_container”,buttons:{normal:“DTTT_button”,disabled:“DTTT_disabled”},collection:{container:“DTTT_collection”,background:“DTTT_collection_background”,buttons:{normal:“DTTT_button”,
disabled:“DTTT_disabled”}},select:{table:“DTTT_selectable”,row:“DTTT_selected
...
ui-buttonset-multi”}};TableTools.DEFAULTS={sSwfPath:“../swf/copy_csv_xls_pdf.swf”,sRowSelect:“none”,sRowSelector:“tr”,sSelectedClass:null,
<a
href=""copy","csv","xls","pdf","print"">fnPreRowSelect:null,fnRowSelected:null,fnRowDeselected:null,aButtons:</a>,oTags:{container:“div”,button:“a”,liner:“span”,collection:{container:“div”,button:“a”,liner:“span”}}};TableTools.defaults=TableTools.DEFAULTS;TableTools.prototype.CLASS=“TableTools”;TableTools.version=“2.2.4”;e.fn.dataTable.Api&amp;&amp;e.fn.dataTable.Api.register(“tabletools()”,function(){var
<a
href="0">a=null;0<this.context.length&&(a=TableTools.fnGetInstance(this.context</a>.nTable));return
...
TableTools requires DataTables 1.9.0 or newer - <a
href="www.datatables.net/download");e.fn.DataTable.TableTools=TableTools;"function"==typeof">www.datatables.net/download”);e.fn.DataTable.TableTools=TableTools;“function”==typeof</a>
m.fn.dataTable&amp;&amp;“function”==typeof
m.fn.dataTableExt.fnVersionCheck&amp;&amp;
m.fn.dataTableExt.fnVersionCheck(“1.9.0”)?m.fn.dataTableExt.aoFeatures.push({fnInit:function(a){a=new
...
TableTools 2 requires DataTables 1.9.0 or newer - <a
href="www.datatables.net/download");m.fn.dataTable.TableTools=TableTools;return">www.datatables.net/download”);m.fn.dataTable.TableTools=TableTools;return</a>
m.fn.DataTable.TableTools=TableTools};“function”===typeof
define&amp;&amp;define.amd?define([“jquery”,
“datatables”],p):“object”===typeof
exports?p(require(“jquery”),require(“datatables”)):jQuery&amp;&amp;!jQuery.fn.dataTable.TableTools&amp;&amp;p(jQuery,jQuery.fn.dataTable)})(window,document);</p>
</main>
