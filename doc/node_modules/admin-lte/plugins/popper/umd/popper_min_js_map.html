...
<title>popper.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/popper/umd/popper.min.js.map">

<p>{“<a
href=""../../src/utils/isFunction.js","../../src/utils/getStyleComputedProperty.js","../../src/utils/getParentNode.js","../../src/utils/getScrollParent.js","../../src/utils/isIE.js","../../src/utils/getOffsetParent.js","../../src/utils/isOffsetContainer.js","../../src/utils/getRoot.js","../../src/utils/findCommonOffsetParent.js","../../src/utils/getScroll.js","../../src/utils/includeScroll.js","../../src/utils/getBordersSize.js","../../src/utils/getWindowSizes.js","../../src/utils/getClientRect.js","../../src/utils/getBoundingClientRect.js","../../src/utils/getOffsetRectRelativeToArbitraryNode.js","../../src/utils/getViewportOffsetRectRelativeToArtbitraryNode.js","../../src/utils/isFixed.js","../../src/utils/getFixedPositionOffsetParent.js","../../src/utils/getBoundaries.js","../../src/utils/computeAutoPlacement.js","../../src/utils/getReferenceOffsets.js","../../src/utils/getOuterSizes.js","../../src/utils/getOppositePlacement.js","../../src/utils/getPopperOffsets.js","../../src/utils/find.js","../../src/utils/findIndex.js","../../src/utils/runModifiers.js","../../src/methods/update.js","../../src/utils/isModifierEnabled.js","../../src/utils/getSupportedPropertyName.js","../../src/methods/destroy.js","../../src/utils/getWindow.js","../../src/utils/setupEventListeners.js","../../src/methods/enableEventListeners.js","../../src/utils/removeEventListeners.js","../../src/methods/disableEventListeners.js","../../src/utils/isNumeric.js","../../src/utils/setStyles.js","../../src/utils/setAttributes.js","../../src/utils/isModifierRequired.js","../../src/utils/getOppositeVariation.js","../../src/utils/clockwise.js","../../src/modifiers/offset.js","../../src/utils/debounce.js","../../src/modifiers/arrow.js","../../src/modifiers/computeStyle.js","../../src/utils/isBrowser.js","../../src/modifiers/flip.js","../../src/index.js","../../src/methods/defaults.js","../../src/modifiers/index.js","../../src/modifiers/shift.js","../../src/modifiers/preventOverflow.js","../../src/modifiers/keepTogether.js","../../src/modifiers/inner.js","../../src/modifiers/hide.js","../../src/modifiers/applyStyle.js"">version”:3,“file”:“popper.min.js”,“sources”:</a>,“sourcesContent”:[“
n * Check if the given variable is a functionn * @methodn * @memberof
Popper.Utilsn * @argument {Any} functionToCheck - variable to checkn *
@returns {Boolean} answer to: is a function?n   nexport default function
isFunction(functionToCheck) {n  const getType = {};n  return (n   
functionToCheck &amp;&amp;n    getType.toString.call(functionToCheck) ===
&#39;[object Function]&#39;n  );n}n”,“   n * Get CSS computed property of
the given elementn * @methodn * @memberof Popper.Utilsn * @argument
{Eement} elementn * @argument {String} propertyn   nexport default function
getStyleComputedProperty(element, property) {n  if (element.nodeType !== 1)
{n    return [];n  }n  // NOTE: 1 DOM access heren  const css =
getComputedStyle(element, null);n  return property ? <a
href="property">css</a> : css;n}n”,“/**n * Returns the parentNode or the
host of the elementn * @methodn * @memberof Popper.Utilsn * @argument
{Element} elementn * @returns {Element} parentn */nexport default function
getParentNode(element) {n  if (element.nodeName === &#39;HTML&#39;) {n   
return element;n  }n  return element.parentNode ||
element.host;n}n”,“import getStyleComputedProperty from
&#39;./getStyleComputedProperty&#39;;nimport getParentNode from
&#39;./getParentNode&#39;;nn/**n * Returns the scrolling parent of the
given elementn * @methodn * @memberof Popper.Utilsn * @argument {Element}
elementn * @returns {Element} scroll parentn */nexport default function
getScrollParent(element) {n  // Return body, `getScroll` will take care to
get the correct `scrollTop` from itn  if (!element) {n    return
document.bodyn  }nn  switch (element.nodeName) {n    case &#39;HTML&#39;:n 
case &#39;BODY&#39;:n      return element.ownerDocument.bodyn    case
&#39;#document&#39;:n      return element.bodyn  }nn  // Firefox want us to
check `-x` and `-y` variations as welln  const { overflow, overflowX,
overflowY } = getStyleComputedProperty(element);n  if
(/(auto|scroll|overlay)/.test(overflow + overflowY + overflowX)) {n   
return element;n  }nn  return
getScrollParent(getParentNode(element));n}n”,“import isBrowser from
&#39;./isBrowser&#39;;nnconst isIE11 = isBrowser &amp;&amp;
!!(window.MSInputMethodContext &amp;&amp; document.documentMode);nconst
isIE10 = isBrowser &amp;&amp; /MSIE 10/.test(navigator.userAgent);nn/**n *
Determines if the browser is Internet Explorern * @methodn * @memberof
Popper.Utilsn * @param {Number} version to checkn * @returns {Boolean}
isIEn */nexport default function isIE(version) {n  if (version === 11) {n  
return isIE11;n  }n  if (version === 10) {n    return isIE10;n  }n  return
isIE11 || isIE10;n}n”,“import getStyleComputedProperty from
&#39;./getStyleComputedProperty&#39;;nimport isIE from
&#39;./isIE&#39;;n/**n * Returns the offset parent of the given elementn *
@methodn * @memberof Popper.Utilsn * @argument {Element} elementn *
@returns {Element} offset parentn */nexport default function
getOffsetParent(element) {n  if (!element) {n    return
document.documentElement;n  }nn  const noOffsetParent = isIE(10) ?
document.body : null;nn  // NOTE: 1 DOM access heren  let offsetParent =
...
element.nextElementSibling).offsetParent;n  }nn  const nodeName =
...
offsetParent is present, I hate this job…n  if (n    [&#39;TD&#39;,
&#39;TABLE&#39;].indexOf(offsetParent.nodeName) !== -1 &amp;&amp;n   
getStyleComputedProperty(offsetParent, &#39;position&#39;) ===
&#39;static&#39;n  ) {n    return getOffsetParent(offsetParent);n  }nn 
return offsetParent;n}n”,“import getOffsetParent from
&#39;./getOffsetParent&#39;;nnexport default function
isOffsetContainer(element) {n  const { nodeName } = element;n  if (nodeName
=== &#39;BODY&#39;) {n    return false;n  }n  return (n    nodeName ===
&#39;HTML&#39; || getOffsetParent(element.firstElementChild) === elementn 
);n}n”,“/**n * Finds the root node (document, shadowDOM root) of the given
elementn * @methodn * @memberof Popper.Utilsn * @argument {Element} noden *
@returns {Element} root noden */nexport default function getRoot(node) {n 
if (node.parentNode !== null) {n    return getRoot(node.parentNode);n  }nn 
return node;n}n”,“import isOffsetContainer from
&#39;./isOffsetContainer&#39;;nimport getRoot from
&#39;./getRoot&#39;;nimport getOffsetParent from
&#39;./getOffsetParent&#39;;nn/**n * Finds the offset parent common to the
two provided nodesn * @methodn * @memberof Popper.Utilsn * @argument
{Element} element1n * @argument {Element} element2n * @returns {Element}
common offset parentn */nexport default function
findCommonOffsetParent(element1, element2) {n  // This check is needed to
avoid errors in case one of the elements isn&#39;t defined for any reasonn 
if (!element1 || !element1.nodeType || !element2 || !element2.nodeType) {n 
return document.documentElement;n  }nn  // Here we make sure to give as
"start&quot; the element that comes first in the DOMn  const order =n   
element1.compareDocumentPosition(element2) &amp;n   
Node.DOCUMENT_POSITION_FOLLOWING;n  const start = order ? element1 :
element2;n  const end = order ? element2 : element1;nn  // Get common
ancestor containern  const range = document.createRange();n 
range.setStart(start, 0);n  range.setEnd(end, 0);n  const {
commonAncestorContainer } = range;nn  // Both nodes are inside documentn 
if (n    (element1 !== commonAncestorContainer &amp;&amp;n      element2
!== commonAncestorContainer) ||n    start.contains(end)n  ) {n    if
...
inside shadowDOM, find which onen  const element1root = getRoot(element1);n
if (element1root.host) {n    return
findCommonOffsetParent(element1root.host, element2);n  } else {n    return
findCommonOffsetParent(element1, getRoot(element2).host);n  }n}n”,“/**n *
...
scrolled pixelsn */nexport default function getScroll(element, side =
&#39;top&#39;) {n  const upperSide = side === &#39;top&#39; ?
&#39;scrollTop&#39; : &#39;scrollLeft&#39;;n  const nodeName =
element.nodeName;nn  if (nodeName === &#39;BODY&#39; || nodeName ===
&#39;HTML&#39;) {n    const html = element.ownerDocument.documentElement;n 
const scrollingElement = element.ownerDocument.scrollingElement || html;n  
return <a href="upperSide">scrollingElement</a>;n  }nn  return <a
href="upperSide">element</a>;n}n”,“import getScroll from
&#39;./getScroll&#39;;nn/*n * Sum or subtract the element scroll values
...
objectn */nexport default function includeScroll(rect, element, subtract =
false) {n  const scrollTop = getScroll(element, &#39;top&#39;);n  const
scrollLeft = getScroll(element, &#39;left&#39;);n  const modifier =
subtract ? -1 : 1;n  rect.top += scrollTop * modifier;n  rect.bottom +=
scrollTop * modifier;n  rect.left += scrollLeft * modifier;n  rect.right +=
scrollLeft * modifier;n  return rect;n}n”,“/*n * Helper to detect borders
of a given elementn * @methodn * @memberof Popper.Utilsn * @param
{CSSStyleDeclaration} stylesn * Result of `getStyleComputedProperty` on the
given elementn * @param {String} axis - `x` or `y`n * @return {number}
borders - The borders size of the given axisn */nnexport default function
getBordersSize(styles, axis) {n  const sideA = axis === &#39;x&#39; ?
&#39;Left&#39; : &#39;Top&#39;;n  const sideB = sideA === &#39;Left&#39; ?
&#39;Right&#39; : &#39;Bottom&#39;;nn  return (n    <a
href="`border${sideA}Width`">parseFloat(styles</a>, 10) +n    <a
href="`border${sideB}Width`">parseFloat(styles</a>, 10)n  );n}n”,“import
isIE from &#39;./isIE&#39;;nnfunction getSize(axis, body, html,
computedStyle) {n  return Math.max(n    <a
href="`offset${axis}`">body</a>,n    <a href="`scroll${axis}`">body</a>,n  
<a href="`client${axis}`">html</a>,n    <a
href="`offset${axis}`">html</a>,n    <a href="`scroll${axis}`">html</a>,n  
isIE(10)n      ? <a href="`offset${axis}`">html</a> +n       
computedStyle[`margin${axis === &#39;Height&#39; ? &#39;Top&#39; :
&#39;Left&#39;}`] +n        computedStyle[`margin${axis ===
&#39;Height&#39; ? &#39;Bottom&#39; : &#39;Right&#39;}`]n      : 0n 
);n}nnexport default function getWindowSizes() {n  const body =
document.body;n  const html = document.documentElement;n  const
computedStyle = isIE(10) &amp;&amp; getComputedStyle(html);nn  return {n   
height: getSize(&#39;Height&#39;, body, html, computedStyle),n    width:
getSize(&#39;Width&#39;, body, html, computedStyle),n  };n}n”,“/**n * Given
element offsets, generate an output similar to getBoundingClientRectn *
@methodn * @memberof Popper.Utilsn * @argument {Object} offsetsn * @returns
{Object} ClientRect like outputn */nexport default function
getClientRect(offsets) {n  return {n    …offsets,n    right: offsets.left +
offsets.width,n    bottom: offsets.top + offsets.height,n  };n}n”,“import
getStyleComputedProperty from &#39;./getStyleComputedProperty&#39;;nimport
getBordersSize from &#39;./getBordersSize&#39;;nimport getWindowSizes from
&#39;./getWindowSizes&#39;;nimport getScroll from
&#39;./getScroll&#39;;nimport getClientRect from
&#39;./getClientRect&#39;;nimport isIE from &#39;./isIE&#39;;nn/**n * Get
bounding client rect of given elementn * @methodn * @memberof Popper.Utilsn
* @param {HTMLElement} elementn * @return {Object} client rectn */nexport
default function getBoundingClientRect(element) {n  let rect = {};nn  //
IE10 10 FIX: Please, don&#39;t ask, the element isn&#39;tn  // considered
in DOM in some circumstances…n  // This isn&#39;t reproducible in IE10
compatibility mode of IE11n  try {n    if (isIE(10)) {n      rect =
element.getBoundingClientRect();n      const scrollTop = getScroll(element,
&#39;top&#39;);n      const scrollLeft = getScroll(element,
&#39;left&#39;);n      rect.top += scrollTop;n      rect.left +=
scrollLeft;n      rect.bottom += scrollTop;n      rect.right +=
scrollLeft;n    }n    else {n      rect = element.getBoundingClientRect();n
}n  }n  catch(e){}nn  const result = {n    left: rect.left,n    top:
rect.top,n    width: rect.right - rect.left,n    height: rect.bottom -
rect.top,n  };nn  // subtract scrollbar size from sizesn  const sizes =
element.nodeName === &#39;HTML&#39; ? getWindowSizes() : {};n  const width
=n    sizes.width || element.clientWidth || result.right - result.left;n 
const height =n    sizes.height || element.clientHeight || result.bottom -
result.top;nn  let horizScrollbar = element.offsetWidth - width;n  let
vertScrollbar = element.offsetHeight - height;nn  // if an hypothetical
scrollbar is detected, we must be sure it&#39;s not a `border`n  // we make
this check conditional for performance reasonsn  if (horizScrollbar ||
vertScrollbar) {n    const styles = getStyleComputedProperty(element);n   
horizScrollbar -= getBordersSize(styles, &#39;x&#39;);n    vertScrollbar -=
getBordersSize(styles, &#39;y&#39;);nn    result.width -= horizScrollbar;n 
result.height -= vertScrollbar;n  }nn  return
getClientRect(result);n}n”,“import getStyleComputedProperty from
&#39;./getStyleComputedProperty&#39;;nimport includeScroll from
&#39;./includeScroll&#39;;nimport getScrollParent from
&#39;./getScrollParent&#39;;nimport getBoundingClientRect from
&#39;./getBoundingClientRect&#39;;nimport runIsIE from
&#39;./isIE&#39;;nimport getClientRect from
&#39;./getClientRect&#39;;nnexport default function
getOffsetRectRelativeToArbitraryNode(children, parent, fixedPosition =
false) {n  const isIE10 = runIsIE(10);n  const isHTML = parent.nodeName ===
&#39;HTML&#39;;n  const childrenRect = getBoundingClientRect(children);n 
const parentRect = getBoundingClientRect(parent);n  const scrollParent =
getScrollParent(children);nn  const styles =
getStyleComputedProperty(parent);n  const borderTopWidth =
parseFloat(styles.borderTopWidth, 10);n  const borderLeftWidth =
...
&amp;&amp; parent.nodeName === &#39;HTML&#39;) {n    parentRect.top =
Math.max(parentRect.top, 0);n    parentRect.left =
Math.max(parentRect.left, 0);n  }n  let offsets = getClientRect({n    top:
childrenRect.top - parentRect.top - borderTopWidth,n    left:
childrenRect.left - parentRect.left - borderLeftWidth,n    width:
childrenRect.width,n    height: childrenRect.height,n  });n 
offsets.marginTop = 0;n  offsets.marginLeft = 0;nn  // Subtract margins of
documentElement in case it&#39;s being used as parentn  // we do this only
on HTML because it&#39;s the only element that behavesn  // differently
when margins are applied to it. The margins are included inn  // the box of
the documentElement, in the other cases not.n  if (!isIE10 &amp;&amp;
isHTML) {n    const marginTop = parseFloat(styles.marginTop, 10);n    const
marginLeft = parseFloat(styles.marginLeft, 10);nn    offsets.top -=
borderTopWidth - marginTop;n    offsets.bottom -= borderTopWidth -
marginTop;n    offsets.left -= borderLeftWidth - marginLeft;n   
offsets.right -= borderLeftWidth - marginLeft;nn    // Attach marginTop and
marginLeft because in some circumstances we may need themn   
offsets.marginTop = marginTop;n    offsets.marginLeft = marginLeft;n  }nn 
if (n    isIE10 &amp;&amp; !fixedPositionn      ?
parent.contains(scrollParent)n      : parent === scrollParent &amp;&amp;
scrollParent.nodeName !== &#39;BODY&#39;n  ) {n    offsets =
includeScroll(offsets, parent);n  }nn  return offsets;n}n”,“import
getOffsetRectRelativeToArbitraryNode from
&#39;./getOffsetRectRelativeToArbitraryNode&#39;;nimport getScroll from
&#39;./getScroll&#39;;nimport getClientRect from
&#39;./getClientRect&#39;;nnexport default function
getViewportOffsetRectRelativeToArtbitraryNode(element, excludeScroll =
false) {n  const html = element.ownerDocument.documentElement;n  const
relativeOffset = getOffsetRectRelativeToArbitraryNode(element, html);n 
const width = Math.max(html.clientWidth, window.innerWidth || 0);n  const
height = Math.max(html.clientHeight, window.innerHeight || 0);nn  const
scrollTop = !excludeScroll ? getScroll(html) : 0;n  const scrollLeft =
!excludeScroll ? getScroll(html, &#39;left&#39;) : 0;nn  const offset = {n 
top: scrollTop - relativeOffset.top + relativeOffset.marginTop,n    left:
scrollLeft - relativeOffset.left + relativeOffset.marginLeft,n    width,n  
height,n  };nn  return getClientRect(offset);n}n”,“import
getStyleComputedProperty from &#39;./getStyleComputedProperty&#39;;nimport
getParentNode from &#39;./getParentNode&#39;;nn/**n * Check if the given
element is fixed or is inside a fixed parentn * @methodn * @memberof
Popper.Utilsn * @argument {Element} elementn * @argument {Element}
customContainern * @returns {Boolean} answer to "isFixed?&quot;n */nexport
default function isFixed(element) {n  const nodeName = element.nodeName;n 
if (nodeName === &#39;BODY&#39; || nodeName === &#39;HTML&#39;) {n   
return false;n  }n  if (getStyleComputedProperty(element,
&#39;position&#39;) === &#39;fixed&#39;) {n    return true;n  }n  return
isFixed(getParentNode(element));n}n”,“import getStyleComputedProperty from
&#39;./getStyleComputedProperty&#39;;nimport isIE from
&#39;./isIE&#39;;n/**n * Finds the first parent of an element that has a
transformed property definedn * @methodn * @memberof Popper.Utilsn *
@argument {Element} elementn * @returns {Element} first transformed parent
or documentElementn */nnexport default function
getFixedPositionOffsetParent(element) {n  // This check is needed to avoid
errors in case one of the elements isn&#39;t defined for any reasonn   if
(!element || !element.parentElement || isIE()) {n    return
document.documentElement;n  }n  let el = element.parentElement;n  while (el
&amp;&amp; getStyleComputedProperty(el, &#39;transform&#39;) ===
&#39;none&#39;) {n    el = el.parentElement;n  }n  return el ||
document.documentElement;nn}n”,“import getScrollParent from
&#39;./getScrollParent&#39;;nimport getParentNode from
&#39;./getParentNode&#39;;nimport findCommonOffsetParent from
&#39;./findCommonOffsetParent&#39;;nimport
getOffsetRectRelativeToArbitraryNode from
&#39;./getOffsetRectRelativeToArbitraryNode&#39;;nimport
getViewportOffsetRectRelativeToArtbitraryNode from
&#39;./getViewportOffsetRectRelativeToArtbitraryNode&#39;;nimport
getWindowSizes from &#39;./getWindowSizes&#39;;nimport isFixed from
&#39;./isFixed&#39;;nimport getFixedPositionOffsetParent from
&#39;./getFixedPositionOffsetParent&#39;;nn/**n * Computed the boundaries
limits and return themn * @methodn * @memberof Popper.Utilsn * @param
{HTMLElement} poppern * @param {HTMLElement} referencen * @param {number}
paddingn * @param {HTMLElement} boundariesElement - Element used to define
the boundariesn * @param {Boolean} fixedPosition - Is in fixed position
moden * @returns {Object} Coordinates of the boundariesn */nexport default
function getBoundaries(n  popper,n  reference,n  padding,n 
boundariesElement,n  fixedPosition = falsen) {n  // NOTE: 1 DOM access
herenn  let boundaries = { top: 0, left: 0 };n  const offsetParent =
...
fixedPosition);n  }nn  else {n    // Handle other cases based on DOM
element used as boundariesn    let boundariesNode;n    if
...
boundariesElement;n    }nn    const offsets =
getOffsetRectRelativeToArbitraryNode(n      boundariesNode,n     
offsetParent,n      fixedPositionn    );nn    // In case of HTML, we need a
different computationn    if (boundariesNode.nodeName === &#39;HTML&#39;
&amp;&amp; !isFixed(offsetParent)) {n      const { height, width } =
getWindowSizes();n      boundaries.top += offsets.top - offsets.marginTop;n
boundaries.bottom = height + offsets.top;n      boundaries.left +=
offsets.left - offsets.marginLeft;n      boundaries.right = width +
offsets.left;n    } else {n      // for all the other DOM elements, this
one is goodn      boundaries = offsets;n    }n  }nn  // Add paddingsn 
boundaries.left += padding;n  boundaries.top += padding;n  boundaries.right
-= padding;n  boundaries.bottom -= padding;nn  return
boundaries;n}n”,“import getBoundaries from
&#39;../utils/getBoundaries&#39;;nnfunction getArea({ width, height }) {n 
...
modifiedn */nexport default function computeAutoPlacement(n  placement,n 
refRect,n  popper,n  reference,n  boundariesElement,n  padding = 0n) {n  if
(placement.indexOf(&#39;auto&#39;) === -1) {n    return placement;n  }nn 
const boundaries = getBoundaries(n    popper,n    reference,n    padding,n 
boundariesElementn  );nn  const rects = {n    top: {n      width:
boundaries.width,n      height: refRect.top - boundaries.top,n    },n   
right: {n      width: boundaries.right - refRect.right,n      height:
boundaries.height,n    },n    bottom: {n      width: boundaries.width,n    
height: boundaries.bottom - refRect.bottom,n    },n    left: {n      width:
refRect.left - boundaries.left,n      height: boundaries.height,n    },n 
};nn  const sortedAreas = Object.keys(rects)n    .map(key =&gt; ({n     
key,n      …<a href="key">rects</a>,n      area: <a
href="key">getArea(rects</a>),n    }))n    .sort((a, b) =&gt; b.area -
a.area);nn  const filteredAreas = sortedAreas.filter(n    ({ width, height
}) =&gt;n      width &gt;= popper.clientWidth &amp;&amp; height &gt;=
popper.clientHeightn  );nn  const computedPlacement = filteredAreas.length
&gt; 0n    ? <a href="0">filteredAreas</a>.keyn    : <a
href="0">sortedAreas</a>.key;nn  const variation = <a
href="1">placement.split(‘-’)</a>;nn  return computedPlacement + (variation
? `-${variation}` : &#39;&#39;);n}n”,“import findCommonOffsetParent from
&#39;./findCommonOffsetParent&#39;;nimport
getOffsetRectRelativeToArbitraryNode from
&#39;./getOffsetRectRelativeToArbitraryNode&#39;;nimport
getFixedPositionOffsetParent from
&#39;./getFixedPositionOffsetParent&#39;;nn/**n * Get offsets to the
reference elementn * @methodn * @memberof Popper.Utilsn * @param {Object}
staten * @param {Element} popper - the popper elementn * @param {Element}
reference - the reference element (the popper will be relative to this)n *
@param {Element} fixedPosition - is in fixed position moden * @returns
{Object} An object containing the offsets which will be applied to the
poppern */nexport default function getReferenceOffsets(state, popper,
reference, fixedPosition = null) {n  const commonOffsetParent =
fixedPosition ? getFixedPositionOffsetParent(popper) :
findCommonOffsetParent(popper, reference);n  return
getOffsetRectRelativeToArbitraryNode(reference, commonOffsetParent,
fixedPosition);n}n”,“/**n * Get the outer sizes of the given element
(offset size + margins)n * @methodn * @memberof Popper.Utilsn * @argument
{Element} elementn * @returns {Object} object containing width and height
propertiesn */nexport default function getOuterSizes(element) {n  const
styles = getComputedStyle(element);n  const x =
parseFloat(styles.marginTop) + parseFloat(styles.marginBottom);n  const y =
parseFloat(styles.marginLeft) + parseFloat(styles.marginRight);n  const
result = {n    width: element.offsetWidth + y,n    height:
element.offsetHeight + x,n  };n  return result;n}n”,“/**n * Get the
opposite placement of the given onen * @methodn * @memberof Popper.Utilsn *
@argument {String} placementn * @returns {String} flipped placementn
*/nexport default function getOppositePlacement(placement) {n  const hash =
{ left: &#39;right&#39;, right: &#39;left&#39;, bottom: &#39;top&#39;, top:
&#39;bottom&#39; };n  return placement.replace(/left|right|bottom|top/g,
matched =&gt; <a href="matched">hash</a>);n}n”,“import getOuterSizes from
&#39;./getOuterSizes&#39;;nimport getOppositePlacement from
&#39;./getOppositePlacement&#39;;nn/**n * Get offsets to the poppern *
@methodn * @memberof Popper.Utilsn * @param {Object} position - CSS
position the Popper will get appliedn * @param {HTMLElement} popper - the
popper elementn * @param {Object} referenceOffsets - the reference offsets
(the popper will be relative to this)n * @param {String} placement - one of
the valid placement optionsn * @returns {Object} popperOffsets - An object
containing the offsets which will be applied to the poppern */nexport
default function getPopperOffsets(popper, referenceOffsets, placement) {n 
placement = <a href="0">placement.split(‘-’)</a>;nn  // Get popper node
sizesn  const popperRect = getOuterSizes(popper);nn  // Add position, width
and height to our offsets objectn  const popperOffsets = {n    width:
popperRect.width,n    height: popperRect.height,n  };nn  // depending by
the popper placement we have to compute its offsets slightly differentlyn 
const isHoriz = [&#39;right&#39;, &#39;left&#39;].indexOf(placement) !==
-1;n  const mainSide = isHoriz ? &#39;top&#39; : &#39;left&#39;;n  const
secondarySide = isHoriz ? &#39;left&#39; : &#39;top&#39;;n  const
measurement = isHoriz ? &#39;height&#39; : &#39;width&#39;;n  const
secondaryMeasurement = !isHoriz ? &#39;height&#39; : &#39;width&#39;;nn  <a
href="mainSide">popperOffsets</a> =n    <a
href="mainSide">referenceOffsets</a> +n    <a
href="measurement">referenceOffsets</a> / 2 -n    <a
href="measurement">popperRect</a> / 2;n  if (placement === secondarySide)
{n    <a href="secondarySide">popperOffsets</a> =n      <a
href="secondarySide">referenceOffsets</a> - <a
href="secondaryMeasurement">popperRect</a>;n  } else {n    <a
href="secondarySide">popperOffsets</a> =n      <a
href="getOppositePlacement(secondarySide)">referenceOffsets</a>;n  }nn 
return popperOffsets;n}n”,“/**n * Mimics the `find` method of Arrayn *
@methodn * @memberof Popper.Utilsn * @argument {Array} arrn * @argument
propn * @argument valuen * @returns index or -1n */nexport default function
find(arr, check) {n  // use native find if supportedn  if
(Array.prototype.find) {n    return arr.find(check);n  }nn  // use `filter`
to obtain the same behavior of `find`n  return <a
href="0">arr.filter(check)</a>;n}n”,“import find from
&#39;./find&#39;;nn/**n * Return the index of the matching objectn *
@methodn * @memberof Popper.Utilsn * @argument {Array} arrn * @argument
propn * @argument valuen * @returns index or -1n */nexport default function
findIndex(arr, prop, value) {n  // use native findIndex if supportedn  if
(Array.prototype.findIndex) {n    return arr.findIndex(cur =&gt; <a
href="prop">cur</a> === value);n  }nn  // use `find` + `indexOf` if
`findIndex` isn&#39;t supportedn  const match = find(arr, obj =&gt; <a
href="prop">obj</a> === value);n  return arr.indexOf(match);n}n”,“import
isFunction from &#39;./isFunction&#39;;nimport findIndex from
&#39;./findIndex&#39;;nimport getClientRect from
&#39;../utils/getClientRect&#39;;nn/**n * Loop trough the list of modifiers
and run them in order,n * each of them will then edit the data object.n *
@methodn * @memberof Popper.Utilsn * @param {dataObject} datan * @param
{Array} modifiersn * @param {String} ends - Optional modifier name used as
stoppern * @returns {dataObject}n */nexport default function
runModifiers(modifiers, data, ends) {n  const modifiersToRun = ends ===
undefinedn    ? modifiersn    : modifiers.slice(0, findIndex(modifiers,
&#39;name&#39;, ends));nn  modifiersToRun.forEach(modifier =&gt; {n    if
(<a href="'function'">modifier</a>) { // eslint-disable-line dot-notationn 
console.warn(&#39;`modifier.function` is deprecated, use
`modifier.fn`!&#39;);n    }n    const fn = <a
href="'function'">modifier</a> || modifier.fn; // eslint-disable-line
dot-notationn    if (modifier.enabled &amp;&amp; isFunction(fn)) {n      //
Add properties to offsets to make them a complete clientRect objectn     
// we do this before each modifier to make sure the previous one
doesn&#39;tn      // mess with these valuesn      data.offsets.popper =
getClientRect(data.offsets.popper);n      data.offsets.reference =
getClientRect(data.offsets.reference);nn      data = fn(data, modifier);n  
}n  });nn  return data;n}n”,“import computeAutoPlacement from
&#39;../utils/computeAutoPlacement&#39;;nimport getReferenceOffsets from
&#39;../utils/getReferenceOffsets&#39;;nimport getPopperOffsets from
&#39;../utils/getPopperOffsets&#39;;nimport runModifiers from
&#39;../utils/runModifiers&#39;;nn/**n * Updates the position of the
popper, computing the new offsets and applyingn * the new style.&lt;br
/&gt;n * Prefer `scheduleUpdate` over `update` because of performance
reasons.n * @methodn * @memberof Poppern */nexport default function
update() {n  // if popper is destroyed, don&#39;t perform any further
updaten  if (this.state.isDestroyed) {n    return;n  }nn  let data = {n   
instance: this,n    styles: {},n    arrowStyles: {},n    attributes: {},n  
flipped: false,n    offsets: {},n  };nn  // compute reference element
offsetsn  data.offsets.reference = getReferenceOffsets(n    this.state,n   
this.popper,n    this.reference,n    this.options.positionFixedn  );nn  //
compute auto placement, store placement inside the data object,n  //
modifiers will be able to edit `placement` if neededn  // and refer to
originalPlacement to know the original valuen  data.placement =
computeAutoPlacement(n    this.options.placement,n   
data.offsets.reference,n    this.popper,n    this.reference,n   
this.options.modifiers.flip.boundariesElement,n   
this.options.modifiers.flip.paddingn  );nn  // store the computed placement
...
offsetsn  data.offsets.popper = getPopperOffsets(n    this.popper,n   
data.offsets.reference,n    data.placementn  );nn 
data.offsets.popper.position = this.options.positionFixedn    ?
&#39;fixed&#39;n    : &#39;absolute&#39;;nn  // run the modifiersn  data =
runModifiers(this.modifiers, data);nn  // the first `update` will call
`onCreate` callbackn  // the other ones will call `onUpdate` callbackn  if
(!this.state.isCreated) {n    this.state.isCreated = true;n   
this.options.onCreate(data);n  } else {n    this.options.onUpdate(data);n 
}n}n”,“/**n * Helper used to know if the given modifier is enabled.n *
@methodn * @memberof Popper.Utilsn * @returns {Boolean}n */nexport default
function isModifierEnabled(modifiers, modifierName) {n  return
modifiers.some(n    ({ name, enabled }) =&gt; enabled &amp;&amp; name ===
modifierNamen  );n}n”,“/**n * Get the prefixed supported property namen *
@methodn * @memberof Popper.Utilsn * @argument {String} property
(camelCase)n * @returns {String} prefixed property (camelCase or
PascalCase, depending on the vendor prefix)n */nexport default function
getSupportedPropertyName(property) {n  const prefixes = [false,
&#39;ms&#39;, &#39;Webkit&#39;, &#39;Moz&#39;, &#39;O&#39;];n  const
upperProp = property.charAt(0).toUpperCase() + property.slice(1);nn  for
(let i = 0; i &lt; prefixes.length; i++) {n    const prefix = <a
href="i">prefixes</a>;n    const toCheck = prefix ? `${prefix}${upperProp}`
: property;n    if (typeof <a href="toCheck">document.body.style</a> !==
&#39;undefined&#39;) {n      return toCheck;n    }n  }n  return
null;n}n”,“import isModifierEnabled from
&#39;../utils/isModifierEnabled&#39;;nimport getSupportedPropertyName from
&#39;../utils/getSupportedPropertyName&#39;;nn/**n * Destroy the poppern *
@methodn * @memberof Poppern */nexport default function destroy() {n 
this.state.isDestroyed = true;nn  // touch DOM only if `applyStyle`
modifier is enabledn  if (isModifierEnabled(this.modifiers,
&#39;applyStyle&#39;)) {n   
this.popper.removeAttribute(&#39;x-placement&#39;);n   
this.popper.style.position = &#39;&#39;;n    this.popper.style.top =
&#39;&#39;;n    this.popper.style.left = &#39;&#39;;n   
this.popper.style.right = &#39;&#39;;n    this.popper.style.bottom =
&#39;&#39;;n    this.popper.style.willChange = &#39;&#39;;n    <a
href="getSupportedPropertyName('transform')">this.popper.style</a> =
&#39;&#39;;n  }nn  this.disableEventListeners();nn  // remove the popper if
user explicity asked for the deletion on destroyn  // do not use `remove`
because IE11 doesn&#39;t support itn  if (this.options.removeOnDestroy) {n 
this.popper.parentNode.removeChild(this.popper);n  }n  return
this;n}n”,“/**n * Get the window associated with the elementn * @argument
{Element} elementn * @returns {Window}n */nexport default function
getWindow(element) {n  const ownerDocument = element.ownerDocument;n 
return ownerDocument ? ownerDocument.defaultView : window;n}n”,“import
getScrollParent from &#39;./getScrollParent&#39;;nimport getWindow from
&#39;./getWindow&#39;;nnfunction attachToScrollParents(scrollParent, event,
callback, scrollParents) {n  const isBody = scrollParent.nodeName ===
&#39;BODY&#39;;n  const target = isBody ?
scrollParent.ownerDocument.defaultView : scrollParent;n 
target.addEventListener(event, callback, { passive: true });nn  if
(!isBody) {n    attachToScrollParents(n     
getScrollParent(target.parentNode),n      event,n      callback,n     
scrollParentsn    );n  }n  scrollParents.push(target);n}nn/**n * Setup
needed event listeners used to update the popper positionn * @methodn *
@memberof Popper.Utilsn * @privaten */nexport default function
setupEventListeners(n  reference,n  options,n  state,n  updateBoundn) {n 
// Resize event listener on windown  state.updateBound = updateBound;n 
getWindow(reference).addEventListener(&#39;resize&#39;, state.updateBound,
{ passive: true });nn  // Scroll event listener on scroll parentsn  const
scrollElement = getScrollParent(reference);n  attachToScrollParents(n   
scrollElement,n    &#39;scroll&#39;,n    state.updateBound,n   
state.scrollParentsn  );n  state.scrollElement = scrollElement;n 
state.eventsEnabled = true;nn  return state;n}n”,“import
setupEventListeners from &#39;../utils/setupEventListeners&#39;;nn/**n * It
will add resize/scroll events and start recalculatingn * position of the
popper element when they are triggered.n * @methodn * @memberof Poppern
*/nexport default function enableEventListeners() {n  if
(!this.state.eventsEnabled) {n    this.state = setupEventListeners(n     
this.reference,n      this.options,n      this.state,n     
this.scheduleUpdaten    );n  }n}n”,“import getWindow from
&#39;./getWindow&#39;;nn/**n * Remove event listeners used to update the
popper positionn * @methodn * @memberof Popper.Utilsn * @privaten */nexport
default function removeEventListeners(reference, state) {n  // Remove
resize event listener on windown 
getWindow(reference).removeEventListener(&#39;resize&#39;,
state.updateBound);nn  // Remove scroll event listener on scroll parentsn 
state.scrollParents.forEach(target =&gt; {n   
target.removeEventListener(&#39;scroll&#39;, state.updateBound);n  });nn 
// Reset staten  state.updateBound = null;n  state.scrollParents = [];n 
state.scrollElement = null;n  state.eventsEnabled = false;n  return
state;n}n”,“import removeEventListeners from
&#39;../utils/removeEventListeners&#39;;nn/**n * It will remove
resize/scroll events and won&#39;t recalculate popper positionn * when they
are triggered. It also won&#39;t trigger onUpdate callback anymore,n *
unless you call `update` method manually.n * @methodn * @memberof Poppern
*/nexport default function disableEventListeners() {n  if
(this.state.eventsEnabled) {n   
cancelAnimationFrame(this.scheduleUpdate);n    this.state =
removeEventListeners(this.reference, this.state);n  }n}n”,“/**n * Tells if
a given input is a numbern * @methodn * @memberof Popper.Utilsn * @param
{*} input to checkn * @return {Boolean}n */nexport default function
isNumeric(n) {n  return n !== &#39;&#39; &amp;&amp; !isNaN(parseFloat(n))
&amp;&amp; isFinite(n);n}n”,“import isNumeric from
&#39;./isNumeric&#39;;nn/**n * Set the style to the given poppern *
@methodn * @memberof Popper.Utilsn * @argument {Element} element - Element
to apply the style ton * @argument {Object} stylesn * <a
href="../../../../../Object.html">Object</a> with a list of properties and
values which will be applied to the elementn */nexport default function
setStyles(element, styles) {n  Object.keys(styles).forEach(prop =&gt; {n   
let unit = &#39;&#39;;n    // add unit if the value is numeric and is one
of the followingn    if (n      [&#39;width&#39;, &#39;height&#39;,
&#39;top&#39;, &#39;right&#39;, &#39;bottom&#39;,
&#39;left&#39;].indexOf(prop) !==n        -1 &amp;&amp;n      <a
href="prop">isNumeric(styles</a>)n    ) {n      unit = &#39;px&#39;;n    }n
<a href="prop">element.style</a> = <a href="prop">styles</a> + unit;n 
});n}n”,“/**n * Set the attributes to the given poppern * @methodn *
@memberof Popper.Utilsn * @argument {Element} element - Element to apply
the attributes ton * @argument {Object} stylesn * <a
href="../../../../../Object.html">Object</a> with a list of properties and
values which will be applied to the elementn */nexport default function
setAttributes(element, attributes) {n 
Object.keys(attributes).forEach(function(prop) {n    const value = <a
href="prop">attributes</a>;n    if (value !== false) {n     
element.setAttribute(prop, <a href="prop">attributes</a>);n    } else {n   
element.removeAttribute(prop);n    }n  });n}n”,“import find from
&#39;./find&#39;;nn/**n * Helper used to know if the given modifier depends
from another one.&lt;br /&gt;n * It checks if the needed modifier is listed
and enabled.n * @methodn * @memberof Popper.Utilsn * @param {Array}
modifiers - list of modifiersn * @param {String} requestingName - name of
requesting modifiern * @param {String} requestedName - name of requested
modifiern * @returns {Boolean}n */nexport default function
isModifierRequired(n  modifiers,n  requestingName,n  requestedNamen) {n 
const requesting = find(modifiers, ({ name }) =&gt; name ===
requestingName);nn  const isRequired =n    !!requesting &amp;&amp;n   
modifiers.some(modifier =&gt; {n      return (n        modifier.name ===
requestedName &amp;&amp;n        modifier.enabled &amp;&amp;n       
modifier.order &lt; requesting.ordern      );n    });nn  if (!isRequired)
{n    const requesting = `\`${requestingName}\“;n    const requested =
`\`${requestedName}\“;n    console.warn(n      `${requested} modifier is
required by ${requesting} modifier in order to work, be sure to include it
before ${requesting}!`n    );n  }n  return isRequired;n}n”,“/**n * Get the
opposite placement variation of the given onen * @methodn * @memberof
Popper.Utilsn * @argument {String} placement variationn * @returns {String}
flipped placement variationn */nexport default function
getOppositeVariation(variation) {n  if (variation === &#39;end&#39;) {n   
return &#39;start&#39;;n  } else if (variation === &#39;start&#39;) {n   
return &#39;end&#39;;n  }n  return variation;n}n”,“import placements from
&#39;../methods/placements&#39;;nn// Get rid of `auto` `auto-start` and
`auto-end`nconst validPlacements = placements.slice(3);nn/**n * Given an
initial placement, returns all the subsequent placementsn * clockwise (or
counter-clockwise).n *n * @methodn * @memberof Popper.Utilsn * @argument
{String} placement - A valid placement (it accepts variations)n * @argument
{Boolean} counter - Set to true to walk the placements counterclockwisen *
@returns {Array} placements including their variationsn */nexport default
function clockwise(placement, counter = false) {n  const index =
validPlacements.indexOf(placement);n  const arr = validPlacementsn   
.slice(index + 1)n    .concat(validPlacements.slice(0, index));n  return
counter ? arr.reverse() : arr;n}n”,“import isNumeric from
&#39;../utils/isNumeric&#39;;nimport getClientRect from
&#39;../utils/getClientRect&#39;;nimport find from
&#39;../utils/find&#39;;nn/**n * Converts a string containing value + unit
into a px value numbern * @functionn * @memberof {modifiers~offset}n *
@privaten * @argument {String} str - Value + unit stringn * @argument
{String} measurement - `height` or `width`n * @argument {Object}
popperOffsetsn * @argument {Object} referenceOffsetsn * @returns
{Number|String}n * Value in pixels, or original string if no values were
extractedn */nexport function toValue(str, measurement, popperOffsets,
referenceOffsets) {n  // separate value from unitn  const split =
str.match(/((?:\-|+)?\d*\.?\d*)(.*)/);n  const value = +<a
href="1">split</a>;n  const unit = <a href="2">split</a>;nn  // If it&#39;s
not a number it&#39;s an operator, I guessn  if (!value) {n    return str;n
}nn  if (unit.indexOf(&#39;%&#39;) === 0) {n    let element;n    switch
(unit) {n      case &#39;%p&#39;:n        element = popperOffsets;n       
break;n      case &#39;%&#39;:n      case &#39;%r&#39;:n      default:n    
element = referenceOffsets;n    }nn    const rect =
getClientRect(element);n    return <a href="measurement">rect</a> / 100 *
value;n  } else if (unit === &#39;vh&#39; || unit === &#39;vw&#39;) {n   
// if is a vh or vw, we calculate the size based on the viewportn    let
size;n    if (unit === &#39;vh&#39;) {n      size = Math.max(n       
document.documentElement.clientHeight,n        window.innerHeight || 0n    
);n    } else {n      size = Math.max(n       
document.documentElement.clientWidth,n        window.innerWidth || 0n     
);n    }n    return size / 100 * value;n  } else {n    // if is an explicit
pixel unit, we get rid of the unit and keep the valuen    // if is an
implicit unit, it&#39;s px, and we return just the valuen    return value;n
}n}nn/**n * Parse an `offset` string to extrapolate `x` and `y` numeric
offsets.n * @functionn * @memberof {modifiers~offset}n * @privaten *
@argument {String} offsetn * @argument {Object} popperOffsetsn * @argument
{Object} referenceOffsetsn * @argument {String} basePlacementn * @returns
{Array} a two cells array with x and y offsets in numbersn */nexport
function parseOffset(n  offset,n  popperOffsets,n  referenceOffsets,n 
basePlacementn) {n  const offsets = [0, 0];nn  // Use height if placement
is left or right and index is 0 otherwise use widthn  // in this way the
first offset will use an axis and the second onen  // will use the other
onen  const useHeight = [&#39;right&#39;,
&#39;left&#39;].indexOf(basePlacement) !== -1;nn  // Split the offset
string to obtain a list of values and operandsn  // The regex addresses
values with the plus or minus sign in front (+10, -20, etc)n  const
fragments = offset.split(/(+|\-)/).map(frag =&gt; frag.trim());nn  //
Detect if the offset string contains a pair of values or a single onen  //
they could be separated by comma or spacen  const divider =
fragments.indexOf(n    find(fragments, frag =&gt; frag.search(/,|\s/) !==
-1)n  );nn  if (<a href="divider">fragments</a> &amp;&amp; <a
href="divider">fragments</a>.indexOf(&#39;,&#39;) === -1) {n   
console.warn(n      &#39;Offsets separated by white space(s) are
deprecated, use a comma (,) instead.&#39;n    );n  }nn  // If divider is
found, we divide the list of values and operands to dividen  // them by
ofset X and Y.n  const splitRegex = /\s*,\s*|\s+/;n  let ops = divider !==
-1n    ? [n        fragmentsn          .slice(0, divider)n          .<a
href="divider">concat([fragments</a>.<a href="0">split(splitRegex)</a>]),n 
[<a href="divider">fragments</a>.<a
href="1">split(splitRegex)</a>].concat(n          fragments.slice(divider +
1)n        ),n      ]n    : [fragments];nn  // Convert the values with
units to absolute pixels to allow our computationsn  ops = ops.map((op,
index) =&gt; {n    // Most of the units rely on the orientation of the
poppern    const measurement = (index === 1 ? !useHeight : useHeight)n     
? &#39;height&#39;n      : &#39;width&#39;;n    let mergeWithPrevious =
false;n    return (n      opn        // This aggregates any `+` or `-` sign
that aren&#39;t considered operatorsn        // e.g.: 10 + +5 =&gt; [10, +,
+5]n        .reduce((a, b) =&gt; {n          if (a[a.length - 1] ===
&#39;&#39; &amp;&amp; [&#39;+&#39;, &#39;-&#39;].indexOf(b) !== -1) {n     
a[a.length - 1] = b;n            mergeWithPrevious = true;n           
return a;n          } else if (mergeWithPrevious) {n            a[a.length
- 1] += b;n            mergeWithPrevious = false;n            return a;n   
} else {n            return a.concat(b);n          }n        }, [])n       
// Here we convert the string values into number values (in px)n       
.map(str =&gt; toValue(str, measurement, popperOffsets, referenceOffsets))n
);n  });nn  // Loop trough the offsets arrays and execute the operationsn 
ops.forEach((op, index) =&gt; {n    op.forEach((frag, index2) =&gt; {n     
if (isNumeric(frag)) {n        <a href="index">offsets</a> += frag *
(op[index2 - 1] === &#39;-&#39; ? -1 : 1);n      }n    });n  });n  return
offsets;n}nn/**n * @functionn * @memberof Modifiersn * @argument {Object}
data - The data object generated by update methodn * @argument {Object}
options - Modifiers configuration and optionsn * @argument {Number|String}
options.offset=0n * The offset value as described in the modifier
descriptionn * @returns {Object} The data object, properly modifiedn
*/nexport default function offset(data, { offset }) {n  const { placement,
offsets: { popper, reference } } = data;n  const basePlacement = <a
href="0">placement.split(‘-’)</a>;nn  let offsets;n  if
(isNumeric(+offset)) {n    offsets = [+offset, 0];n  } else {n    offsets =
parseOffset(offset, popper, reference, basePlacement);n  }nn  if
(basePlacement === &#39;left&#39;) {n    popper.top += <a
href="0">offsets</a>;n    popper.left -= <a href="1">offsets</a>;n  } else
if (basePlacement === &#39;right&#39;) {n    popper.top += <a
href="0">offsets</a>;n    popper.left += <a href="1">offsets</a>;n  } else
if (basePlacement === &#39;top&#39;) {n    popper.left += <a
href="0">offsets</a>;n    popper.top -= <a href="1">offsets</a>;n  } else
if (basePlacement === &#39;bottom&#39;) {n    popper.left += <a
href="0">offsets</a>;n    popper.top += <a href="1">offsets</a>;n  }nn 
data.popper = popper;n  return data;n}n”,“import isBrowser from
&#39;./isBrowser&#39;;nnconst longerTimeoutBrowsers = [&#39;Edge&#39;,
&#39;Trident&#39;, &#39;Firefox&#39;];nlet timeoutDuration = 0;nfor (let i
= 0; i &lt; longerTimeoutBrowsers.length; i += 1) {n  if (isBrowser
&amp;&amp; <a
href="i">navigator.userAgent.indexOf(longerTimeoutBrowsers</a>) &gt;= 0) {n
timeoutDuration = 1;n    break;n  }n}nnexport function
microtaskDebounce(fn) {n  let called = falsen  return () =&gt; {n    if
(called) {n      returnn    }n    called = truen   
window.Promise.resolve().then(() =&gt; {n      called = falsen      fn()n  
})n  }n}nnexport function taskDebounce(fn) {n  let scheduled = false;n 
return () =&gt; {n    if (!scheduled) {n      scheduled = true;n     
setTimeout(() =&gt; {n        scheduled = false;n        fn();n      },
timeoutDuration);n    }n  };n}nnconst supportsMicroTasks = isBrowser
&amp;&amp; window.Promisennn/*<strong>n</strong> Create a debounced version
of a method, that&#39;s asynchronously deferredn* but called in the minimum
time possible.n*n* @methodn* @memberof Popper.Utilsn* @argument {Function}
fnn* @returns {Function}n*/nexport default (supportsMicroTasksn  ?
microtaskDebouncen  : taskDebounce);n”,“import getClientRect from
&#39;../utils/getClientRect&#39;;nimport getOuterSizes from
&#39;../utils/getOuterSizes&#39;;nimport isModifierRequired from
&#39;../utils/isModifierRequired&#39;;nimport getStyleComputedProperty from
&#39;../utils/getStyleComputedProperty&#39;;nn/**n * @functionn * @memberof
Modifiersn * @argument {Object} data - The data object generated by update
methodn * @argument {Object} options - Modifiers configuration and optionsn
* @returns {Object} The data object, properly modifiedn */nexport default
function arrow(data, options) {n  // arrow depends on keepTogether in order
to workn  if (!isModifierRequired(data.instance.modifiers, &#39;arrow&#39;,
&#39;keepTogether&#39;)) {n    return data;n  }nn  let arrowElement =
options.element;nn  // if arrowElement is a string, suppose it&#39;s a CSS
selectorn  if (typeof arrowElement === &#39;string&#39;) {n    arrowElement
= data.instance.popper.querySelector(arrowElement);nn    // if arrowElement
is not found, don&#39;t run the modifiern    if (!arrowElement) {n     
return data;n    }n  } else {n    // if the arrowElement isn&#39;t a query
selector we must check that then    // provided DOM node is child of its
popper noden    if (!data.instance.popper.contains(arrowElement)) {n     
console.warn(n        &#39;WARNING: `arrow.element` must be child of its
popper element!&#39;n      );n      return data;n    }n  }nn  const
placement = <a href="0">data.placement.split(‘-’)</a>;n  const { popper,
reference } = data.offsets;n  const isVertical = [&#39;left&#39;,
&#39;right&#39;].indexOf(placement) !== -1;nn  const len = isVertical ?
&#39;height&#39; : &#39;width&#39;;n  const sideCapitalized = isVertical ?
&#39;Top&#39; : &#39;Left&#39;;n  const side =
sideCapitalized.toLowerCase();n  const altSide = isVertical ?
&#39;left&#39; : &#39;top&#39;;n  const opSide = isVertical ?
&#39;bottom&#39; : &#39;right&#39;;n  const arrowElementSize = <a
href="len">getOuterSizes(arrowElement)</a>;nn  //n  // extends keepTogether
behavior making sure the popper and itsn  // reference have enough pixels
in conjuctionn  //nn  // top/left siden  if (<a href="opSide">reference</a>
- arrowElementSize &lt; <a href="side">popper</a>) {n    <a
href="side">data.offsets.popper</a> -=n      <a href="side">popper</a> -
(<a href="opSide">reference</a> - arrowElementSize);n  }n  // bottom/right
siden  if (<a href="side">reference</a> + arrowElementSize &gt; <a
href="opSide">popper</a>) {n    <a href="side">data.offsets.popper</a> +=n 
<a href="side">reference</a> + arrowElementSize - <a
href="opSide">popper</a>;n  }n  data.offsets.popper =
getClientRect(data.offsets.popper);nn  // compute center of the poppern 
const center = <a href="side">reference</a> + <a href="len">reference</a> /
2 - arrowElementSize / 2;nn  // Compute the sideValue using the updated
popper offsetsn  // take popper margin in account because we don&#39;t have
this info availablen  const css =
getStyleComputedProperty(data.instance.popper);n  const popperMarginSide =
<a href="`margin${sideCapitalized}`">parseFloat(css</a>, 10);n  const
popperBorderSide = <a
href="`border${sideCapitalized}Width`">parseFloat(css</a>, 10);n  let
sideValue =n    center - <a href="side">data.offsets.popper</a> -
popperMarginSide - popperBorderSide;nn  // prevent arrowElement from being
placed not contiguously to its poppern  sideValue = <a
href="len">Math.max(Math.min(popper</a> - arrowElementSize, sideValue),
0);nn  data.arrowElement = arrowElement;n  data.offsets.arrow = {n   
[side]: Math.round(sideValue),n    [altSide]: &#39;&#39;, // make sure to
unset any eventual altSide value from the DOM noden  };nn  return
data;n}n”,“import getSupportedPropertyName from
&#39;../utils/getSupportedPropertyName&#39;;nimport find from
&#39;../utils/find&#39;;nimport getOffsetParent from
&#39;../utils/getOffsetParent&#39;;nimport getBoundingClientRect from
&#39;../utils/getBoundingClientRect&#39;;nn/**n * @functionn * @memberof
...
optionsn * @returns {Object} The data object, properly modifiedn */nexport
default function computeStyle(data, options) {n  const { x, y } = options;n
const { popper } = data.offsets;nn  // Remove this legacy support in
Popper.js v2n  const legacyGpuAccelerationOption = find(n   
data.instance.modifiers,n    modifier =&gt; modifier.name ===
&#39;applyStyle&#39;n  ).gpuAcceleration;n  if (legacyGpuAccelerationOption
!== undefined) {n    console.warn(n      &#39;WARNING: `gpuAcceleration`
option moved to `computeStyle` modifier and will not be supported in future
versions of Popper.js!&#39;n    );n  }n  const gpuAcceleration =n   
legacyGpuAccelerationOption !== undefinedn      ?
legacyGpuAccelerationOptionn      : options.gpuAcceleration;nn  const
offsetParent = getOffsetParent(data.instance.popper);n  const
offsetParentRect = getBoundingClientRect(offsetParent);nn  // Stylesn 
const styles = {n    position: popper.position,n  };nn  // Avoid blurry
text by using full pixel integers.n  // For pixel-perfect positioning,
top/bottom prefers roundedn  // values, while left/right prefers floored
values.n  const offsets = {n    left: Math.floor(popper.left),n    top:
Math.round(popper.top),n    bottom: Math.round(popper.bottom),n    right:
Math.floor(popper.right),n  };nn  const sideA = x === &#39;bottom&#39; ?
&#39;top&#39; : &#39;bottom&#39;;n  const sideB = y === &#39;right&#39; ?
&#39;left&#39; : &#39;right&#39;;nn  // if gpuAcceleration is set to `true`
and transform is supported,n  //  we use `translate3d` to apply the
position to the popper wen  // automatically use the supported prefixed
version if neededn  const prefixedProperty =
getSupportedPropertyName(&#39;transform&#39;);nn  // now, let&#39;s make a
step back and look at this code closely (wtf?)n  // If the content of the
popper grows once it&#39;s been positioned, itn  // may happen that the
popper gets misplaced because of the new contentn  // overflowing its
reference elementn  // To avoid this problem, we provide two options (x and
y), which allown  // the consumer to define the offset origin.n  // If we
position a popper on top of a reference element, we can setn  // `x` to
`top` to make the popper grow towards its top instead ofn  // its bottom.n 
let left, top;n  if (sideA === &#39;bottom&#39;) {n    top =
-offsetParentRect.height + offsets.bottom;n  } else {n    top =
offsets.top;n  }n  if (sideB === &#39;right&#39;) {n    left =
-offsetParentRect.width + offsets.right;n  } else {n    left =
offsets.left;n  }n  if (gpuAcceleration &amp;&amp; prefixedProperty) {n   
<a href="prefixedProperty">styles</a> = `translate3d(${left}px, ${top}px,
0)`;n    <a href="sideA">styles</a> = 0;n    <a href="sideB">styles</a> =
0;n    styles.willChange = &#39;transform&#39;;n  } else {n    //
othwerise, we use the standard `top`, `left`, `bottom` and `right`
propertiesn    const invertTop = sideA === &#39;bottom&#39; ? -1 : 1;n   
const invertLeft = sideB === &#39;right&#39; ? -1 : 1;n    <a
href="sideA">styles</a> = top * invertTop;n    <a href="sideB">styles</a> =
left * invertLeft;n    styles.willChange = `${sideA}, ${sideB}`;n  }nn  //
Attributesn  const attributes = {n    &#39;x-placement&#39;:
data.placement,n  };nn  // Update `data` attributes, styles and
arrowStylesn  data.attributes = { …attributes, …data.attributes };n 
data.styles = { …styles, …data.styles };n  data.arrowStyles = {
…data.offsets.arrow, …data.arrowStyles };nn  return data;n}n”,“export
default typeof window !== &#39;undefined&#39; &amp;&amp; typeof document
!== &#39;undefined&#39;;n”,“import getOppositePlacement from
&#39;../utils/getOppositePlacement&#39;;nimport getOppositeVariation from
&#39;../utils/getOppositeVariation&#39;;nimport getPopperOffsets from
&#39;../utils/getPopperOffsets&#39;;nimport runModifiers from
&#39;../utils/runModifiers&#39;;nimport getBoundaries from
&#39;../utils/getBoundaries&#39;;nimport isModifierEnabled from
&#39;../utils/isModifierEnabled&#39;;nimport clockwise from
&#39;../utils/clockwise&#39;;nnconst BEHAVIORS = {n  FLIP: &#39;flip&#39;,n
CLOCKWISE: &#39;clockwise&#39;,n  COUNTERCLOCKWISE:
&#39;counterclockwise&#39;,n};nn/**n * @functionn * @memberof Modifiersn *
...
@returns {Object} The data object, properly modifiedn */nexport default
function flip(data, options) {n  // if `inner` modifier is enabled, we
can&#39;t use the `flip` modifiern  if
(isModifierEnabled(data.instance.modifiers, &#39;inner&#39;)) {n    return
data;n  }nn  if (data.flipped &amp;&amp; data.placement ===
data.originalPlacement) {n    // seems like flip is trying to loop,
probably there&#39;s not enough space on any of the flippable sidesn   
return data;n  }nn  const boundaries = getBoundaries(n   
data.instance.popper,n    data.instance.reference,n    options.padding,n   
options.boundariesElement,n    data.positionFixedn  );nn  let placement =
<a href="0">data.placement.split(‘-’)</a>;n  let placementOpposite =
getOppositePlacement(placement);n  let variation = <a
href="1">data.placement.split(‘-’)</a> || &#39;&#39;;nn  let flipOrder =
[];nn  switch (options.behavior) {n    case BEHAVIORS.FLIP:n      flipOrder
= [placement, placementOpposite];n      break;n    case
BEHAVIORS.CLOCKWISE:n      flipOrder = clockwise(placement);n      break;n 
case BEHAVIORS.COUNTERCLOCKWISE:n      flipOrder = clockwise(placement,
true);n      break;n    default:n      flipOrder = options.behavior;n  }nn 
flipOrder.forEach((step, index) =&gt; {n    if (placement !== step ||
flipOrder.length === index + 1) {n      return data;n    }nn    placement =
<a href="0">data.placement.split(‘-’)</a>;n    placementOpposite =
getOppositePlacement(placement);nn    const popperOffsets =
data.offsets.popper;n    const refOffsets = data.offsets.reference;nn    //
using floor because the reference offsets may contain decimals we are not
going to consider heren    const floor = Math.floor;n    const overlapsRef
=n      (placement === &#39;left&#39; &amp;&amp;n       
floor(popperOffsets.right) &gt; floor(refOffsets.left)) ||n      (placement
=== &#39;right&#39; &amp;&amp;n        floor(popperOffsets.left) &lt;
floor(refOffsets.right)) ||n      (placement === &#39;top&#39; &amp;&amp;n 
floor(popperOffsets.bottom) &gt; floor(refOffsets.top)) ||n      (placement
=== &#39;bottom&#39; &amp;&amp;n        floor(popperOffsets.top) &lt;
floor(refOffsets.bottom));nn    const overflowsLeft =
floor(popperOffsets.left) &lt; floor(boundaries.left);n    const
overflowsRight = floor(popperOffsets.right) &gt; floor(boundaries.right);n 
const overflowsTop = floor(popperOffsets.top) &lt; floor(boundaries.top);n 
const overflowsBottom =n      floor(popperOffsets.bottom) &gt;
floor(boundaries.bottom);nn    const overflowsBoundaries =n      (placement
=== &#39;left&#39; &amp;&amp; overflowsLeft) ||n      (placement ===
&#39;right&#39; &amp;&amp; overflowsRight) ||n      (placement ===
&#39;top&#39; &amp;&amp; overflowsTop) ||n      (placement ===
&#39;bottom&#39; &amp;&amp; overflowsBottom);nn    // flip the variation if
requiredn    const isVertical = [&#39;top&#39;,
&#39;bottom&#39;].indexOf(placement) !== -1;n    const flippedVariation =n 
!!options.flipVariations &amp;&amp;n      ((isVertical &amp;&amp; variation
=== &#39;start&#39; &amp;&amp; overflowsLeft) ||n        (isVertical
&amp;&amp; variation === &#39;end&#39; &amp;&amp; overflowsRight) ||n      
(!isVertical &amp;&amp; variation === &#39;start&#39; &amp;&amp;
overflowsTop) ||n        (!isVertical &amp;&amp; variation ===
&#39;end&#39; &amp;&amp; overflowsBottom));nn    if (overlapsRef ||
...
+ (variation ? &#39;-&#39; + variation : &#39;&#39;);nn      // this object
contains `position`, we want to preserve it along withn      // any
additional property we may add in the futuren      data.offsets.popper = {n
…data.offsets.popper,n        …getPopperOffsets(n         
data.instance.popper,n          data.offsets.reference,n         
data.placementn        ),n      };nn      data =
runModifiers(data.instance.modifiers, data, &#39;flip&#39;);n    }n  });n 
return data;n}n”,“// Utilsnimport debounce from
&#39;./utils/debounce&#39;;nimport isFunction from
&#39;./utils/isFunction&#39;;nn// Methodsnimport update from
&#39;./methods/update&#39;;nimport destroy from
&#39;./methods/destroy&#39;;nimport enableEventListeners from
&#39;./methods/enableEventListeners&#39;;nimport disableEventListeners from
&#39;./methods/disableEventListeners&#39;;nimport Defaults from
&#39;./methods/defaults&#39;;nimport placements from
&#39;./methods/placements&#39;;nnexport default class Popper {n  /**n   *
Create a new Popper.js instancen   * @class Poppern   * @param
...
instance - The generated Popper.js instancen   */n  constructor(reference,
popper, options = {}) {n    // make update() debounced, so that it only
runs at most once-per-tickn    this.update =
debounce(this.update.bind(this));nn    // with {} we create a new object
with the options inside itn    this.options = { …Popper.Defaults, …options
};nn    // init staten    this.state = {n      isDestroyed: false,n     
isCreated: false,n      scrollParents: [],n    };nn    // get reference and
popper elements (allow jQuery wrappers)n    this.reference = reference
&amp;&amp; reference.jquery ? <a href="0">reference</a> : reference;n   
this.popper = popper &amp;&amp; popper.jquery ? <a href="0">popper</a> :
popper;nn    // Deep merge modifiers optionsn    this.options.modifiers =
{};n    Object.keys({n      …Popper.Defaults.modifiers,n     
…options.modifiers,n    }).forEach(name =&gt; {n      <a
href="name">this.options.modifiers</a> = {n        // If it&#39;s a
built-in modifier, use it as basen        …(<a
href="name">Popper.Defaults.modifiers</a> || {}),n        // If there are
custom options, override and merge with default onesn       
…(options.modifiers ? <a href="name">options.modifiers</a> : {}),n      };n
});nn    // Refactoring modifiers&#39; list (Object =&gt; Array)n   
this.modifiers = Object.keys(this.options.modifiers)n      .map(name =&gt;
({n        name,n        …<a href="name">this.options.modifiers</a>,n     
}))n      // sort the modifiers by ordern      .sort((a, b) =&gt; a.order -
b.order);nn    // modifiers have the ability to execute arbitrary code when
Popper.js get initedn    // such code is executed in the same order of its
modifiern    // they could add new properties to their options
configurationn    // BE AWARE: don&#39;t add options to
`options.modifiers.name` but to `modifierOptions`!n   
this.modifiers.forEach(modifierOptions =&gt; {n      if
(modifierOptions.enabled &amp;&amp; isFunction(modifierOptions.onLoad)) {n 
modifierOptions.onLoad(n          this.reference,n          this.popper,n  
this.options,n          modifierOptions,n          this.staten        );n  
}n    });nn    // fire the first update to position the popper in the right
placen    this.update();nn    const eventsEnabled =
this.options.eventsEnabled;n    if (eventsEnabled) {n      // setup event
listeners, they will take care of update the position in specific
situationsn      this.enableEventListeners();n    }nn   
this.state.eventsEnabled = eventsEnabled;n  }nn  // We can&#39;t use class
properties because they don&#39;t get listed in then  // class prototype
and break stuff like Sinon stubsn  update() {n    return
update.call(this);n  }n  destroy() {n    return destroy.call(this);n  }n 
enableEventListeners() {n    return enableEventListeners.call(this);n  }n 
disableEventListeners() {n    return disableEventListeners.call(this);n 
}nn  /**n   * Schedule an update, it will run on the next UI update
availablen   * @method scheduleUpdaten   * @memberof Poppern   */n 
scheduleUpdate = () =&gt; requestAnimationFrame(this.update);nn  /**n   *
Collection of utilities useful when writing custom modifiers.n   * Starting
from version 1.7, this method is available only if youn   * include
`popper-utils.js` before `popper.js`.n   *n   *
*<strong>DEPRECATION</strong>*: This way to access PopperUtils is
deprecatedn   * and will be removed in v2! Use the PopperUtils module
directly instead.n   * Due to the high instability of the methods contained
in Utils, we can&#39;tn   * guarantee them to follow semver. Use them at
your own risk!n   * @staticn   * @privaten   * @type {Object}n   *
@deprecated since version 1.8n   * @member Utilsn   * @memberof Poppern  
*/n  static Utils = (typeof window !== &#39;undefined&#39; ? window :
global).PopperUtils;nn  static placements = placements;nn  static Defaults
= Defaults;n}nn/**n * The `referenceObject` is an object that provides an
interface compatible with Popper.jsn * and lets you use it as replacement
of a real DOM node.&lt;br /&gt;n * You can use this method to position a
popper relatively to a set of coordinatesn * in case you don&#39;t have a
DOM node to use as reference.n *n * “`n * new Popper(referenceObject,
popperNode);n * “`n *n * NB: This feature isn&#39;t supported in Internet
Explorer 10n * @name referenceObjectn * @property {Function}
data.getBoundingClientRectn * A function that returns a set of coordinates
compatible with the native `getBoundingClientRect` method.n * @property
{number} data.clientWidthn * An ES6 getter that will return the width of
the virtual reference element.n * @property {number} data.clientHeightn *
An ES6 getter that will return the height of the virtual reference
element.n */n”,“import modifiers from &#39;../modifiers/index&#39;;nn/**n *
Default options provided to Popper.js constructor.&lt;br /&gt;n * These can
be overriden using the `options` argument of Popper.js.&lt;br /&gt;n * To
override an option, simply pass as 3rd argument an object with the samen *
structure of this object, example:n * “`n * new Popper(ref, pop, {n *  
modifiers: {n *     preventOverflow: { enabled: false }n *   }n * })n * “`n
* @type {Object}n * @staticn * @memberof Poppern */nexport default {n  /**n
* Popper&#39;s placementn   * @prop {Popper.placements}
placement=&#39;bottom&#39;n   */n  placement: &#39;bottom&#39;,nn  /**n   *
...
created.&lt;br /&gt;n   * By default, is set to no-op.&lt;br /&gt;n   *
Access Popper.js instance with `data.instance`.n   * @prop {onCreate}n  
*/n  onCreate: () =&gt; {},nn  /**n   * Callback called when the popper is
updated, this callback is not calledn   * on the initialization/creation of
the popper, but only on subsequentn   * updates.&lt;br /&gt;n   * By
default, is set to no-op.&lt;br /&gt;n   * Access Popper.js instance with
`data.instance`.n   * @prop {onUpdate}n   */n  onUpdate: () =&gt; {},nn 
/**n   * List of modifiers used to modify the offsets before they are
applied to the popper.n   * They provide most of the functionalities of
Popper.jsn   * @prop {modifiers}n   */n  modifiers,n};nn/**n * @callback
onCreaten * @param {dataObject} datan */nn/**n * @callback onUpdaten *
@param {dataObject} datan */n”,“import applyStyle, { applyStyleOnLoad }
from &#39;./applyStyle&#39;;nimport computeStyle from
&#39;./computeStyle&#39;;nimport arrow from &#39;./arrow&#39;;nimport flip
from &#39;./flip&#39;;nimport keepTogether from
&#39;./keepTogether&#39;;nimport offset from &#39;./offset&#39;;nimport
preventOverflow from &#39;./preventOverflow&#39;;nimport shift from
&#39;./shift&#39;;nimport hide from &#39;./hide&#39;;nimport inner from
&#39;./inner&#39;;nn/**n * Modifier function, each modifier can have a
function of this type assignedn * to its `fn` property.&lt;br /&gt;n *
These functions will be called on each update, this means that you mustn *
make sure they are performant enough to avoid performance bottlenecks.n *n
* @function ModifierFnn * @argument {dataObject} data - The data object
generated by `update` methodn * @argument {Object} options - Modifiers
configuration and optionsn * @returns {dataObject} The data object,
properly modifiedn */nn/**n * Modifiers are plugins used to alter the
behavior of your poppers.&lt;br /&gt;n * Popper.js uses a set of 9
modifiers to provide all the basic functionalitiesn * needed by the
library.n *n * Usually you don&#39;t want to override the `order`, `fn` and
`onLoad` props.n * All the other properties are configurations that could
be tweaked.n * @namespace modifiersn */nexport default {n  /**n   *
Modifier used to shift the popper on the start or end of its referencen   *
element.&lt;br /&gt;n   * It will read the variation of the `placement`
property.&lt;br /&gt;n   * It can be one either `-end` or `-start`.n   *
@memberof modifiersn   * @innern   */n  shift: {n    /** @prop {number}
order=100 - Index used to define the order of execution */n    order: 100,n
/** @prop {Boolean} enabled=true - Whether the modifier is enabled or not
*/n    enabled: true,n    /** @prop {ModifierFn} */n    fn: shift,n  },nn 
/**n   * The `offset` modifier can shift your popper on both its axis.n  
*n   * It accepts the following units:n   * - `px` or unitless, interpreted
as pixelsn   * - `%` or `%r`, percentage relative to the length of the
reference elementn   * - `%p`, percentage relative to the length of the
popper elementn   * - `vw`, CSS viewport width unitn   * - `vh`, CSS
viewport height unitn   *n   * For length is intended the main axis
relative to the placement of the popper.&lt;br /&gt;n   * This means that
if the placement is `top` or `bottom`, the length will be then   * `width`.
In case of `left` or `right`, it will be the height.n   *n   * You can
provide a single value (as `Number` or `String`), or a pair of valuesn   *
as `String` divided by a comma or one (or more) white spaces.&lt;br /&gt;n 
* The latter is a deprecated method because it leads to confusion and will
ben   * removed in v2.&lt;br /&gt;n   * Additionally, it accepts additions
and subtractions between different units.n   * Note that multiplications
and divisions aren&#39;t supported.n   *n   * Valid examples are:n   * “`n 
* 10n   * &#39;10%&#39;n   * &#39;10, 10&#39;n   * &#39;10%, 10&#39;n   *
&#39;10 + 10%&#39;n   * &#39;10 - 5vh + 3%&#39;n   * &#39;-10px + 5vh, 5px
- 6%&#39;n   * “`n   * &gt; *<strong>NB</strong>*: If you desire to apply
...
modifier.n   * &gt; More on this [reading this issue](<a
href="https://github.com/FezVrasta/popper.js/issues/373)\n">github.com/FezVrasta/popper.js/issues/373)n</a>
*n   * @memberof modifiersn   * @innern   */n  offset: {n    /** @prop
{number} order=200 - Index used to define the order of execution */n   
order: 200,n    /** @prop {Boolean} enabled=true - Whether the modifier is
enabled or not */n    enabled: true,n    /** @prop {ModifierFn} */n    fn:
offset,n    /** @prop {Number|String} offset=0n     * The offset value as
described in the modifier descriptionn     */n    offset: 0,n  },nn  /**n  
* Modifier used to prevent the popper from being positioned outside the
boundary.n   *n   * An scenario exists where the reference itself is not
within the boundaries.&lt;br /&gt;n   * We can say it has "escaped the
boundaries&quot; — or just "escaped&quot;.&lt;br /&gt;n   * In this case we
need to decide whether the popper should either:n   *n   * - detach from
the reference and remain "trapped&quot; in the boundaries, orn   * - if it
should ignore the boundary and "escape with its reference&quot;n   *n   *
When `escapeWithReference` is set to`true` and reference is completelyn   *
outside its boundaries, the popper will overflow (or completely leave)n   *
the boundaries in order to remain attached to the edge of the reference.n  
*n   * @memberof modifiersn   * @innern   */n  preventOverflow: {n    /**
@prop {number} order=300 - Index used to define the order of execution */n 
order: 300,n    /** @prop {Boolean} enabled=true - Whether the modifier is
enabled or not */n    enabled: true,n    /** @prop {ModifierFn} */n    fn:
preventOverflow,n    /**n     * @prop {Array} [<a
href="'left','right','top','bottom'">priority=</a>]n     * Popper will try
to prevent overflow following these priorities by default,n     * then, it
could overflow on the left and on top of the `boundariesElement`n     */n  
priority: [&#39;left&#39;, &#39;right&#39;, &#39;top&#39;,
&#39;bottom&#39;],n    /**n     * @prop {number} padding=5n     * Amount of
pixel used to define a minimum distance between the boundariesn     * and
the popper this makes sure the popper has always a little paddingn     *
...
&#39;scrollParent&#39;,n  },nn  /**n   * Modifier used to make sure the
reference and its popper stay near eachothersn   * without leaving any gap
between the two. Expecially useful when the arrow isn   * enabled and you
want to assure it to point to its reference element.n   * It cares only
about the first axis, you can still have poppers with marginn   * between
the popper and its reference element.n   * @memberof modifiersn   * @innern
*/n  keepTogether: {n    /** @prop {number} order=400 - Index used to
define the order of execution */n    order: 400,n    /** @prop {Boolean}
enabled=true - Whether the modifier is enabled or not */n    enabled:
true,n    /** @prop {ModifierFn} */n    fn: keepTogether,n  },nn  /**n   *
This modifier is used to move the `arrowElement` of the popper to maken   *
sure it is positioned between the reference element and its popper
element.n   * It will read the outer size of the `arrowElement` node to
detect how manyn   * pixels of conjuction are needed.n   *n   * It has no
effect if no `arrowElement` is provided.n   * @memberof modifiersn   *
@innern   */n  arrow: {n    /** @prop {number} order=500 - Index used to
define the order of execution */n    order: 500,n    /** @prop {Boolean}
enabled=true - Whether the modifier is enabled or not */n    enabled:
true,n    /** @prop {ModifierFn} */n    fn: arrow,n    /** @prop
{String|HTMLElement} <a href="x-arrow">element=‘</a>&#39; - Selector or
node used as arrow */n    element: &#39;[x-arrow]&#39;,n  },nn  /**n   *
Modifier used to flip the popper&#39;s placement when it starts to overlap
itsn   * reference element.n   *n   * Requires the `preventOverflow`
modifier before it in order to work.n   *n   * *<strong>NOTE:</strong>*
this modifier will interrupt the current update cycle and willn   * restart
it if it detects the need to flip the placement.n   * @memberof modifiersn 
* @innern   */n  flip: {n    /** @prop {number} order=600 - Index used to
define the order of execution */n    order: 600,n    /** @prop {Boolean}
enabled=true - Whether the modifier is enabled or not */n    enabled:
true,n    /** @prop {ModifierFn} */n    fn: flip,n    /**n     * @prop
{String|Array} behavior=&#39;flip&#39;n     * The behavior used to change
the popper&#39;s placement. It can be one ofn     * `flip`, `clockwise`,
`counterclockwise` or an array with a list of validn     * placements (with
optional variations).n     */n    behavior: &#39;flip&#39;,n    /**n     *
@prop {number} padding=5n     * The popper will flip if it hits the edges
of the `boundariesElement`n     */n    padding: 5,n    /**n     * @prop
{String|HTMLElement} boundariesElement=&#39;viewport&#39;n     * The
element which will define the boundaries of the popper position,n     * the
popper will never be placed outside of the defined boundariesn     *
(except if keepTogether is enabled)n     */n    boundariesElement:
&#39;viewport&#39;,n  },nn  /**n   * Modifier used to make the popper flow
toward the inner of the reference element.n   * By default, when this
modifier is disabled, the popper will be placed outsiden   * the reference
element.n   * @memberof modifiersn   * @innern   */n  inner: {n    /**
@prop {number} order=700 - Index used to define the order of execution */n 
order: 700,n    /** @prop {Boolean} enabled=false - Whether the modifier is
enabled or not */n    enabled: false,n    /** @prop {ModifierFn} */n    fn:
inner,n  },nn  /**n   * Modifier used to hide the popper when its reference
element is outside of then   * popper boundaries. It will set a
`x-out-of-boundaries` attribute which cann   * be used to hide with a CSS
selector the popper when its reference isn   * out of boundaries.n   *n   *
Requires the `preventOverflow` modifier before it in order to work.n   *
@memberof modifiersn   * @innern   */n  hide: {n    /** @prop {number}
order=800 - Index used to define the order of execution */n    order: 800,n
/** @prop {Boolean} enabled=true - Whether the modifier is enabled or not
*/n    enabled: true,n    /** @prop {ModifierFn} */n    fn: hide,n  },nn 
/**n   * Computes the style that will be applied to the popper element to
getsn   * properly positioned.n   *n   * Note that this modifier will not
touch the DOM, it just prepares the stylesn   * so that `applyStyle`
modifier can apply it. This separation is usefuln   * in case you need to
replace `applyStyle` with a custom implementation.n   *n   * This modifier
has `850` as `order` value to maintain backward compatibilityn   * with
...
/**n     * @prop {string} [x=&#39;bottom&#39;]n     * Where to anchor the X
axis (`bottom` or `top`). AKA X offset origin.n     * Change this if your
popper should grow in a direction different from `bottom`n     */n    x:
&#39;bottom&#39;,n    /**n     * @prop {string} [x=&#39;left&#39;]n     *
Where to anchor the Y axis (`left` or `right`). AKA Y offset origin.n     *
Change this if your popper should grow in a direction different from
`right`n     */n    y: &#39;right&#39;,n  },nn  /**n   * Applies the
computed styles to the popper element.n   *n   * All the DOM manipulations
are limited to this modifier. This is useful in casen   * you want to
integrate Popper.js inside a framework or view library and youn   * want to
delegate all the DOM manipulations to it.n   *n   * Note that if you
disable this modifier, you must make sure the popper elementn   * has its
position set to `absolute` before Popper.js can do its work!n   *n   * Just
disable this modifier and define you own to achieve the desired effect.n  
*n   * @memberof modifiersn   * @innern   */n  applyStyle: {n    /** @prop
{number} order=900 - Index used to define the order of execution */n   
order: 900,n    /** @prop {Boolean} enabled=true - Whether the modifier is
enabled or not */n    enabled: true,n    /** @prop {ModifierFn} */n    fn:
applyStyle,n    /** @prop {Function} */n    onLoad: applyStyleOnLoad,n   
/**n     * @deprecated since version 1.10.0, the property moved to
`computeStyle` modifiern     * @prop {Boolean} gpuAcceleration=truen     *
If true, it uses the CSS 3d transformation to position the popper.n     *
Otherwise, it will use the `top` and `left` properties.n     */n   
gpuAcceleration: undefined,n  },n};nn/**n * The `dataObject` is an object
containing all the informations used by Popper.jsn * this object get passed
to modifiers and to the `onCreate` and `onUpdate` callbacks.n * @name
dataObjectn * @property {Object} data.instance The Popper.js instancen *
@property {String} data.placement Placement applied to poppern * @property
{String} data.originalPlacement Placement originally defined on initn *
@property {Boolean} data.flipped True if popper has been flipped by flip
modifiern * @property {Boolean} data.hide True if the reference element is
out of boundaries, useful to know when to hide the popper.n * @property
...
of them will be different from 0n */n”,“/**n * @functionn * @memberof
Modifiersn * @argument {Object} data - The data object generated by
`update` methodn * @argument {Object} options - Modifiers configuration and
optionsn * @returns {Object} The data object, properly modifiedn */nexport
default function shift(data) {n  const placement = data.placement;n  const
basePlacement = <a href="0">placement.split(’-‘)</a>;n  const
shiftvariation = <a href="1">placement.split(’-‘)</a>;nn  // if shift
shiftvariation is specified, run the modifiern  if (shiftvariation) {n   
const { reference, popper } = data.offsets;n    const isVertical =
[&#39;bottom&#39;, &#39;top&#39;].indexOf(basePlacement) !== -1;n    const
side = isVertical ? &#39;left&#39; : &#39;top&#39;;n    const measurement =
isVertical ? &#39;width&#39; : &#39;height&#39;;nn    const shiftOffsets =
{n      start: { [side]: <a href="side">reference</a> },n      end: {n     
[side]: <a href="side">reference</a> + <a href="measurement">reference</a>
- <a href="measurement">popper</a>,n      },n    };nn   
data.offsets.popper = { …popper, …<a href="shiftvariation">shiftOffsets</a>
};n  }nn  return data;n}n”,“import getOffsetParent from
&#39;../utils/getOffsetParent&#39;;nimport getBoundaries from
&#39;../utils/getBoundaries&#39;;nimport getSupportedPropertyName from
&#39;../utils/getSupportedPropertyName&#39;;nn/**n * @functionn * @memberof
Modifiersn * @argument {Object} data - The data object generated by
`update` methodn * @argument {Object} options - Modifiers configuration and
optionsn * @returns {Object} The data object, properly modifiedn */nexport
default function preventOverflow(data, options) {n  let boundariesElement
=n    options.boundariesElement || getOffsetParent(data.instance.popper);nn
...
getOffsetParent(boundariesElement);n  }nn  // NOTE: DOM access heren  //
resets the popper&#39;s position so that the document size can be
calculated excludingn  // the size of the popper element itselfn  const
transformProp = getSupportedPropertyName(&#39;transform&#39;);n  const
popperStyles = data.instance.popper.style; // assignment to help
minificationn  const { top, left, [transformProp]: transform } =
popperStyles;n  popperStyles.top = &#39;&#39;;n  popperStyles.left =
&#39;&#39;;n  <a href="transformProp">popperStyles</a> = &#39;&#39;;nn 
const boundaries = getBoundaries(n    data.instance.popper,n   
data.instance.reference,n    options.padding,n    boundariesElement,n   
data.positionFixedn  );nn  // NOTE: DOM access heren  // restores the
original style properties after the offsets have been computedn 
popperStyles.top = top;n  popperStyles.left = left;n  <a
href="transformProp">popperStyles</a> = transform;nn  options.boundaries =
boundaries;nn  const order = options.priority;n  let popper =
data.offsets.popper;nn  const check = {n    primary(placement) {n      let
value = <a href="placement">popper</a>;n      if (n        <a
href="placement">popper</a> &lt; <a href="placement">boundaries</a>
&amp;&amp;n        !options.escapeWithReferencen      ) {n        value =
<a href="placement">Math.max(popper</a>, <a
href="placement">boundaries</a>);n      }n      return { [placement]: value
};n    },n    secondary(placement) {n      const mainSide = placement ===
&#39;right&#39; ? &#39;left&#39; : &#39;top&#39;;n      let value = <a
href="mainSide">popper</a>;n      if (n        <a
href="placement">popper</a> &gt; <a href="placement">boundaries</a>
&amp;&amp;n        !options.escapeWithReferencen      ) {n        value =
Math.min(n          <a href="mainSide">popper</a>,n          <a
href="placement">boundaries</a> -n            (placement ===
&#39;right&#39; ? popper.width : popper.height)n        );n      }n     
return { [mainSide]: value };n    },n  };nn  order.forEach(placement =&gt;
{n    const side =n      [&#39;left&#39;, &#39;top&#39;].indexOf(placement)
!== -1 ? &#39;primary&#39; : &#39;secondary&#39;;n    popper = { …popper,
…<a href="side">check</a>(placement) };n  });nn  data.offsets.popper =
popper;nn  return data;n}n”,“/**n * @functionn * @memberof Modifiersn *
@argument {Object} data - The data object generated by update methodn *
@argument {Object} options - Modifiers configuration and optionsn *
@returns {Object} The data object, properly modifiedn */nexport default
function keepTogether(data) {n  const { popper, reference } =
data.offsets;n  const placement = <a
href="0">data.placement.split(’-‘)</a>;n  const floor = Math.floor;n  const
isVertical = [&#39;top&#39;, &#39;bottom&#39;].indexOf(placement) !== -1;n 
const side = isVertical ? &#39;right&#39; : &#39;bottom&#39;;n  const
opSide = isVertical ? &#39;left&#39; : &#39;top&#39;;n  const measurement =
isVertical ? &#39;width&#39; : &#39;height&#39;;nn  if (<a
href="side">popper</a> &lt; <a href="opSide">floor(reference</a>)) {n    <a
href="opSide">data.offsets.popper</a> =n      <a
href="opSide">floor(reference</a>) - <a href="measurement">popper</a>;n  }n
if (<a href="opSide">popper</a> &gt; <a href="side">floor(reference</a>))
{n    <a href="opSide">data.offsets.popper</a> = <a
href="side">floor(reference</a>);n  }nn  return data;n}n”,“import
getClientRect from &#39;../utils/getClientRect&#39;;nimport
getOppositePlacement from &#39;../utils/getOppositePlacement&#39;;nn/**n *
@functionn * @memberof Modifiersn * @argument {Object} data - The data
object generated by `update` methodn * @argument {Object} options -
Modifiers configuration and optionsn * @returns {Object} The data object,
properly modifiedn */nexport default function inner(data) {n  const
placement = data.placement;n  const basePlacement = <a
href="0">placement.split(’-‘)</a>;n  const { popper, reference } =
data.offsets;n  const isHoriz = [&#39;left&#39;,
&#39;right&#39;].indexOf(basePlacement) !== -1;nn  const subtractLength =
[&#39;top&#39;, &#39;left&#39;].indexOf(basePlacement) === -1;nn 
popper[isHoriz ? &#39;left&#39; : &#39;top&#39;] =n    <a
href="basePlacement">reference</a> -n    (subtractLength ? popper[isHoriz ?
&#39;width&#39; : &#39;height&#39;] : 0);nn  data.placement =
getOppositePlacement(placement);n  data.offsets.popper =
getClientRect(popper);nn  return data;n}n”,“import isModifierRequired from
&#39;../utils/isModifierRequired&#39;;nimport find from
&#39;../utils/find&#39;;nn/**n * @functionn * @memberof Modifiersn *
@argument {Object} data - The data object generated by update methodn *
@argument {Object} options - Modifiers configuration and optionsn *
@returns {Object} The data object, properly modifiedn */nexport default
function hide(data) {n  if (!isModifierRequired(data.instance.modifiers,
&#39;hide&#39;, &#39;preventOverflow&#39;)) {n    return data;n  }nn  const
refRect = data.offsets.reference;n  const bound = find(n   
data.instance.modifiers,n    modifier =&gt; modifier.name ===
&#39;preventOverflow&#39;n  ).boundaries;nn  if (n    refRect.bottom &lt;
bound.top ||n    refRect.left &gt; bound.right ||n    refRect.top &gt;
bound.bottom ||n    refRect.right &lt; bound.leftn  ) {n    // Avoid
unnecessary DOM access if visibility hasn&#39;t changedn    if (data.hide
=== true) {n      return data;n    }nn    data.hide = true;n    <a
href="'x-out-of-boundaries'">data.attributes</a> = &#39;&#39;;n  } else {n 
// Avoid unnecessary DOM access if visibility hasn&#39;t changedn    if
(data.hide === false) {n      return data;n    }nn    data.hide = false;n  
<a href="'x-out-of-boundaries'">data.attributes</a> = false;n  }nn  return
data;n}n”,“import setStyles from &#39;../utils/setStyles&#39;;nimport
setAttributes from &#39;../utils/setAttributes&#39;;nimport
getReferenceOffsets from &#39;../utils/getReferenceOffsets&#39;;nimport
computeAutoPlacement from &#39;../utils/computeAutoPlacement&#39;;nn/**n *
@functionn * @memberof Modifiersn * @argument {Object} data - The data
object generated by `update` methodn * @argument {Object} data.styles -
List of style properties - values to apply to popper elementn * @argument
{Object} data.attributes - List of attribute properties - values to apply
to popper elementn * @argument {Object} options - Modifiers configuration
and optionsn * @returns {Object} The same data objectn */nexport default
function applyStyle(data) {n  // any property present in `data.styles` will
be applied to the popper,n  // in this way we can make the 3rd party
modifiers add custom styles to itn  // Be aware, modifiers could override
the properties defined in the previousn  // lines of this modifier!n 
setStyles(data.instance.popper, data.styles);nn  // any property present in
`data.attributes` will be applied to the popper,n  // they will be set as
HTML attributes of the elementn  setAttributes(data.instance.popper,
data.attributes);nn  // if arrowElement is defined and arrowStyles has some
propertiesn  if (data.arrowElement &amp;&amp;
Object.keys(data.arrowStyles).length) {n    setStyles(data.arrowElement,
data.arrowStyles);n  }nn  return data;n}nn/**n * Set the x-placement
attribute before everything else because it could be usedn * to add margins
to the popper margins needs to be calculated to get then * correct popper
offsets.n * @methodn * @memberof Popper.modifiersn * @param {HTMLElement}
reference - The reference element used to position the poppern * @param
{HTMLElement} popper - The HTML element used as poppern * @param {Object}
options - Popper.js optionsn */nexport function applyStyleOnLoad(n 
reference,n  popper,n  options,n  modifierOptions,n  staten) {n  // compute
reference element offsetsn  const referenceOffsets =
getReferenceOffsets(state, popper, reference, options.positionFixed);nn  //
compute auto placement, store placement inside the data object,n  //
modifiers will be able to edit `placement` if neededn  // and refer to
originalPlacement to know the original valuen  const placement =
computeAutoPlacement(n    options.placement,n    referenceOffsets,n   
popper,n    reference,n    options.modifiers.flip.boundariesElement,n   
options.modifiers.flip.paddingn  );nn 
popper.setAttribute(&#39;x-placement&#39;, placement);nn  // Apply
`position` to popper before anything else becausen  // without the position
applied we can&#39;t guarantee correct computationsn  setStyles(popper, {
position: options.positionFixed ? &#39;fixed&#39; : &#39;absolute&#39;
});nn  return options;n}<a
href=”“functionToCheck”,“getType”,“toString”,“call”,“element”,“nodeType”,“css”,“getComputedStyle”,“property”,“nodeName”,“parentNode”,“host”,“document”,“body”,“ownerDocument”,“getStyleComputedProperty”,“overflow”,“overflowX”,“overflowY”,“test”,“getScrollParent”,“getParentNode”,“version”,“isIE11”,“documentElement”,“noOffsetParent”,“isIE”,“offsetParent”,“nextElementSibling”,“indexOf”,“getOffsetParent”,“firstElementChild”,“node”,“getRoot”,“element1”,“element2”,“order”,“compareDocumentPosition”,“Node”,“DOCUMENT_POSITION_FOLLOWING”,“start”,“end”,“range”,“createRange”,“setStart”,“setEnd”,“commonAncestorContainer”,“contains”,“isOffsetContainer”,“element1root”,“findCommonOffsetParent”,“side”,“upperSide”,“html”,“scrollingElement”,“subtract”,“scrollTop”,“getScroll”,“scrollLeft”,“modifier”,“top”,“bottom”,“left”,“right”,“sideA”,“axis”,“sideB”,“parseFloat”,“styles”,“Math”,“computedStyle”,“getSize”,“offsets”,“width”,“height”,“rect”,“getBoundingClientRect”,“result”,“sizes”,“getWindowSizes”,“clientWidth”,“clientHeight”,“horizScrollbar”,“offsetWidth”,“vertScrollbar”,“offsetHeight”,“getBordersSize”,“getClientRect”,“fixedPosition”,“isIE10”,“runIsIE”,“isHTML”,“parent”,“childrenRect”,“parentRect”,“scrollParent”,“borderTopWidth”,“borderLeftWidth”,“marginTop”,“marginLeft”,“includeScroll”,“excludeScroll”,“relativeOffset”,“getOffsetRectRelativeToArbitraryNode”,“window”,“innerWidth”,“innerHeight”,“offset”,“isFixed”,“parentElement”,“el”,“boundaries”,“getFixedPositionOffsetParent”,“boundariesElement”,“getViewportOffsetRectRelativeToArtbitraryNode”,“boundariesNode”,“popper”,“padding”,“placement”,“getBoundaries”,“rects”,“refRect”,“sortedAreas”,“Object”,“keys”,“map”,“getArea”,“sort”,“b”,“area”,“a”,“filteredAreas”,“filter”,“computedPlacement”,“length”,“key”,“variation”,“split”,“commonOffsetParent”,“x”,“marginBottom”,“y”,“marginRight”,“hash”,“replace”,“popperRect”,“getOuterSizes”,“popperOffsets”,“isHoriz”,“mainSide”,“secondarySide”,“measurement”,“secondaryMeasurement”,“referenceOffsets”,“getOppositePlacement”,“Array”,“prototype”,“find”,“arr”,“findIndex”,“cur”,“match”,“obj”,“modifiersToRun”,“ends”,“modifiers”,“slice”,“forEach”,“warn”,“fn”,“enabled”,“isFunction”,“data”,“reference”,“state”,“isDestroyed”,“getReferenceOffsets”,“options”,“positionFixed”,“computeAutoPlacement”,“flip”,“originalPlacement”,“getPopperOffsets”,“position”,“runModifiers”,“isCreated”,“onUpdate”,“onCreate”,“some”,“name”,“prefixes”,“upperProp”,“charAt”,“toUpperCase”,“i”,“prefix”,“toCheck”,“style”,“isModifierEnabled”,“removeAttribute”,“willChange”,“getSupportedPropertyName”,“disableEventListeners”,“removeOnDestroy”,“removeChild”,“defaultView”,“isBody”,“target”,“addEventListener”,“passive”,“push”,“updateBound”,“scrollElement”,“scrollParents”,“eventsEnabled”,“setupEventListeners”,“scheduleUpdate”,“removeEventListener”,“removeEventListeners”,“n”,“isNaN”,“isFinite”,“unit”,“isNumeric”,“value”,“attributes”,“setAttribute”,“requesting”,“isRequired”,“requested”,“counter”,“index”,“validPlacements”,“concat”,“reverse”,“str”,“size”,“useHeight”,“fragments”,“frag”,“trim”,“divider”,“search”,“splitRegex”,“ops”,“mergeWithPrevious”,“op”,“reduce”,“toValue”,“index2”,“basePlacement”,“parseOffset”,“min”,“round”,“floor”,“max”,“timeoutDuration”,“longerTimeoutBrowsers”,“isBrowser”,“navigator”,“userAgent”,“supportsMicroTasks”,“Promise”,“called”,“resolve”,“then”,“scheduled”,“MSInputMethodContext”,“documentMode”,“placements”,“BEHAVIORS”,“Popper”,“requestAnimationFrame”,“update”,“debounce”,“bind”,“Defaults”,“jquery”,“modifierOptions”,“onLoad”,“enableEventListeners”,“destroy”,“Utils”,“global”,“PopperUtils”,“shiftvariation”,“isVertical”,“shiftOffsets”,“instance”,“transformProp”,“popperStyles”,“transform”,“priority”,“check”,“escapeWithReference”,“opSide”,“isModifierRequired”,“arrowElement”,“querySelector”,“len”,“sideCapitalized”,“toLowerCase”,“altSide”,“arrowElementSize”,“center”,“popperMarginSide”,“popperBorderSide”,“sideValue”,“arrow”,“flipped”,“placementOpposite”,“flipOrder”,“behavior”,“FLIP”,“CLOCKWISE”,“clockwise”,“COUNTERCLOCKWISE”,“refOffsets”,“overlapsRef”,“overflowsLeft”,“overflowsRight”,“overflowsTop”,“overflowsBottom”,“overflowsBoundaries”,“flippedVariation”,“flipVariations”,“get