...
&amp;&amp; window.Promisennn   n* Create a debounced version of a method,
that&#39;s asynchronously deferredn* but called in the minimum time
possible.n*n* @methodn* @memberof Popper.Utilsn* @argument {Function} fnn*
@returns {Function}n  nexport default (supportsMicroTasksn  ?
microtaskDebouncen  : taskDebounce);n”,“   n * Check if the given variable
is a functionn * @methodn * @memberof Popper.Utilsn * @argument {Any}
functionToCheck - variable to checkn * @returns {Boolean} answer to: is a
function?n   nexport default function isFunction(functionToCheck) {n  const
getType = {};n  return (n    functionToCheck &amp;&amp;n   
getType.toString.call(functionToCheck) === &#39;[object Function]&#39;n 
);n}n”,“/**n * Get CSS computed property of the given elementn * @methodn *
@memberof Popper.Utilsn * @argument {Eement} elementn * @argument {String}
propertyn */nexport default function getStyleComputedProperty(element,
property) {n  if (element.nodeType !== 1) {n    return [];n  }n  // NOTE: 1
DOM access heren  const css = getComputedStyle(element, null);n  return
property ? <a href="property">css</a> : css;n}n”,“/**n * Returns the
parentNode or the host of the elementn * @methodn * @memberof Popper.Utilsn
* @argument {Element} elementn * @returns {Element} parentn */nexport
default function getParentNode(element) {n  if (element.nodeName ===
&#39;HTML&#39;) {n    return element;n  }n  return element.parentNode ||
...
element.removeAttribute(prop);n    }n  });n}n”,“import setStyles from
&#39;../utils/setStyles&#39;;nimport setAttributes from
&#39;../utils/setAttributes&#39;;nimport getReferenceOffsets from
&#39;../utils/getReferenceOffsets&#39;;nimport computeAutoPlacement from
&#39;../utils/computeAutoPlacement&#39;;nn/**n * @functionn * @memberof
Modifiersn * @argument {Object} data - The data object generated by
`update` methodn * @argument {Object} data.styles - List of style
properties - values to apply to popper elementn * @argument {Object}
data.attributes - List of attribute properties - values to apply to popper
elementn * @argument {Object} options - Modifiers configuration and
optionsn * @returns {Object} The same data objectn */nexport default
...
});nn  return options;n}n”,“import getSupportedPropertyName from
...
…data.offsets.arrow, …data.arrowStyles };nn  return data;n}n”,“import find
from &#39;./find&#39;;nn/**n * Helper used to know if the given modifier
depends from another one.&lt;br /&gt;n * It checks if the needed modifier
is listed and enabled.n * @methodn * @memberof Popper.Utilsn * @param
{Array} modifiers - list of modifiersn * @param {String} requestingName -
name of requesting modifiern * @param {String} requestedName - name of
requested modifiern * @returns {Boolean}n */nexport default function
...
before ${requesting}!`n    );n  }n  return isRequired;n}n”,“import
getClientRect from &#39;../utils/getClientRect&#39;;nimport getOuterSizes
from &#39;../utils/getOuterSizes&#39;;nimport isModifierRequired from
...
data;n}n”,“/**n * Get the opposite placement variation of the given onen *
@methodn * @memberof Popper.Utilsn * @argument {String} placement
variationn * @returns {String} flipped placement variationn */nexport
default function getOppositeVariation(variation) {n  if (variation ===
&#39;end&#39;) {n    return &#39;start&#39;;n  } else if (variation ===
&#39;start&#39;) {n    return &#39;end&#39;;n  }n  return
variation;n}n”,“/**n * List of accepted placements to use as values of the
`placement` option.&lt;br /&gt;n * Valid placements are:n * - `auto`n * -
`top`n * - `right`n * - `bottom`n * - `left`n *n * Each placement can have
a variation from this list:n * - `-start`n * - `-end`n *n * Variations are
interpreted easily if you think of them as the left to rightn * written
languages. Horizontally (`top` and `bottom`), `start` is left and `end`n *
is right.&lt;br /&gt;n * Vertically (`left` and `right`), `start` is top
and `end` is bottom.n *n * Some valid examples are:n * - `top-end` (on top
of reference, right aligned)n * - `right-start` (on right of reference, top
aligned)n * - `bottom` (on bottom, centered)n * - `auto-right` (on the side
with more space available, alignment depends by placement)n *n * @staticn *
@type {Array}n * @enum {String}n * @readonlyn * @method placementsn *
@memberof Poppern */nexport default [n  &#39;auto-start&#39;,n 
&#39;auto&#39;,n  &#39;auto-end&#39;,n  &#39;top-start&#39;,n 
&#39;top&#39;,n  &#39;top-end&#39;,n  &#39;right-start&#39;,n 
&#39;right&#39;,n  &#39;right-end&#39;,n  &#39;bottom-end&#39;,n 
&#39;bottom&#39;,n  &#39;bottom-start&#39;,n  &#39;left-end&#39;,n 
&#39;left&#39;,n  &#39;left-start&#39;,n];n”,“import placements from
...
counter ? arr.reverse() : arr;n}n”,“import getOppositePlacement from
...
return data;n}n”,“/**n * @functionn * @memberof Modifiersn * @argument
...
The data object, properly modifiedn */nexport default function
keepTogether(data) {n  const { popper, reference } = data.offsets;n  const
placement = <a href="0">data.placement.split(‘-’)</a>;n  const floor =
Math.floor;n  const isVertical = [&#39;top&#39;,
&#39;bottom&#39;].indexOf(placement) !== -1;n  const side = isVertical ?
&#39;right&#39; : &#39;bottom&#39;;n  const opSide = isVertical ?
&#39;left&#39; : &#39;top&#39;;n  const measurement = isVertical ?
&#39;width&#39; : &#39;height&#39;;nn  if (<a href="side">popper</a> &lt;
<a href="opSide">floor(reference</a>)) {n    <a
...
href="side">floor(reference</a>);n  }nn  return data;n}n”,“import isNumeric
from &#39;../utils/isNumeric&#39;;nimport getClientRect from
...
data.popper = popper;n  return data;n}n”,“import getOffsetParent from
...
@argument {Object} options - Modifiers configuration and optionsn *
@returns {Object} The data object, properly modifiedn */nexport default
function shift(data) {n  const placement = data.placement;n  const
...
};n  }nn  return data;n}n”,“import isModifierRequired from
...
data;n}n”,“import getClientRect from
&#39;../utils/getClientRect&#39;;nimport getOppositePlacement from
&#39;../utils/getOppositePlacement&#39;;nn/**n * @functionn * @memberof
Modifiersn * @argument {Object} data - The data object generated by
`update` methodn * @argument {Object} options - Modifiers configuration and
optionsn * @returns {Object} The data object, properly modifiedn */nexport
default function inner(data) {n  const placement = data.placement;n  const
basePlacement = <a href="0">placement.split(‘-’)</a>;n  const { popper,
reference } = data.offsets;n  const isHoriz = [&#39;left&#39;,
...
getClientRect(popper);nn  return data;n}n”,“import applyStyle, {
applyStyleOnLoad } from &#39;./applyStyle&#39;;nimport computeStyle from
...
of them will be different from 0n */n”,“import modifiers from
&#39;../modifiers/index&#39;;nn/**n * Default options provided to Popper.js
constructor.&lt;br /&gt;n * These can be overriden using the `options`
argument of Popper.js.&lt;br /&gt;n * To override an option, simply pass as
3rd argument an object with the samen * structure of this object, example:n
...
* @prop {Popper.placements} placement=&#39;bottom&#39;n   */n  placement:
&#39;bottom&#39;,nn  /**n   * Set this to true if you want popper to
position it self in &#39;fixed&#39; moden   * @prop {Boolean}
positionFixed=falsen   */n  positionFixed: false,nn  /**n   * Whether
events (resize, scroll) are initially enabledn   * @prop {Boolean}
eventsEnabled=truen   */n  eventsEnabled: true,nn  /**n   * Set to true if
you want to automatically remove the popper whenn   * you call the
`destroy` method.n   * @prop {Boolean} removeOnDestroy=falsen   */n 
removeOnDestroy: false,nn  /**n   * Callback called when the popper is
...
@param {dataObject} datan */n”,“// Utilsnimport debounce from
...
element.n */<a
href=”“window”,“document”,“timeoutDuration”,“i”,“longerTimeoutBrowsers”,“length”,“isBrowser”,“navigator”,“userAgent”,“indexOf”,“called”,“Promise”,“resolve”,“then”,“scheduled”,“supportsMicroTasks”,“functionToCheck”,“getType”,“toString”,“call”,“element”,“nodeType”,“css”,“getComputedStyle”,“property”,“nodeName”,“parentNode”,“host”,“body”,“ownerDocument”,“overflow”,“overflowX”,“overflowY”,“getStyleComputedProperty”,“test”,“getScrollParent”,“getParentNode”,“isIE11”,“MSInputMethodContext”,“documentMode”,“isIE10”,“version”,“documentElement”,“noOffsetParent”,“isIE”,“offsetParent”,“nextElementSibling”,“getOffsetParent”,“firstElementChild”,“node”,“getRoot”,“element1”,“element2”,“order”,“compareDocumentPosition”,“Node”,“DOCUMENT_POSITION_FOLLOWING”,“start”,“end”,“range”,“createRange”,“setStart”,“setEnd”,“commonAncestorContainer”,“contains”,“isOffsetContainer”,“element1root”,“findCommonOffsetParent”,“side”,“upperSide”,“html”,“scrollingElement”,“subtract”,“scrollTop”,“getScroll”,“scrollLeft”,“modifier”,“top”,“bottom”,“left”,“right”,“sideA”,“axis”,“sideB”,“parseFloat”,“styles”,“Math”,“max”,“computedStyle”,“getSize”,“offsets”,“width”,“height”,“rect”,“getBoundingClientRect”,“result”,“sizes”,“getWindowSizes”,“clientWidth”,“clientHeight”,“horizScrollbar”,“offsetWidth”,“vertScrollbar”,“offsetHeight”,“getBordersSize”,“getClientRect”,“fixedPosition”,“runIsIE”,“isHTML”,“parent”,“childrenRect”,“parentRect”,“scrollParent”,“borderTopWidth”,“borderLeftWidth”,“marginTop”,“marginLeft”,“includeScroll”,“excludeScroll”,“relativeOffset”,“getOffsetRectRelativeToArbitraryNode”,“innerWidth”,“innerHeight”,“offset”,“isFixed”,“parentElement”,“el”,“boundaries”,“getFixedPositionOffsetParent”,“boundariesElement”,“getViewportOffsetRectRelativeToArtbitraryNode”,“boundariesNode”,“popper”,“padding”,“placement”,“getBoundaries”,“rects”,“refRect”,“sortedAreas”,“Object”,“keys”,“map”,“key”,“getArea”,“sort”,“b”,“area”,“a”,“filteredAreas”,“filter”,“computedPlacement”,“variation”,“split”,“commonOffsetParent”,“x”,“marginBottom”,“y”,“marginRight”,“hash”,“replace”,“matched”,“popperRect”,“getOuterSizes”,“popperOffsets”,“isHoriz”,“mainSide”,“secondarySide”,“measurement”,“secondaryMeasurement”,“referenceOffsets”,“getOppositePlacement”,“Array”,“prototype”,“find”,“arr”,“findIndex”,“cur”,“match”,“obj”,“modifiersToRun”,“ends”,“modifiers”,“slice”,“forEach”,“warn”,“fn”,“enabled”,“isFunction”,“data”,“reference”,“state”,“isDestroyed”,“getReferenceOffsets”,“options”,“positionFixed”,“computeAutoPlacement”,“flip”,“originalPlacement”,“getPopperOffsets”,“position”,“runModifiers”,“isCreated”,“onUpdate”,“onCreate”,“some”,“name”,“prefixes”,“upperProp”,“charAt”,“toUpperCase”,“prefix”,“toCheck”,“style”,“isModifierEnabled”,“removeAttribute”,“willChange”,“getSupportedPropertyName”,“disableEventListeners”,“removeOnDestroy”,“removeChild”,“defaultView”,“isBody”,“target”,“addEventListener”,“passive”,“push”,“updateBound”,“scrollElement”,“scrollParents”,“eventsEnabled”,“setupEventListeners”,“scheduleUpdate”,“removeEventListener”,“removeEventListeners”,“n”,“isNaN”,“isFinite”,“prop”,“unit”,“isNumeric”,“value”,“attributes”,“setAttribute”,“instance”,“arrowElement”,“arrowStyles”,“round”,“floor”,“legacyGpuAccelerationOption”,“gpuAcceleration”,“offsetParentRect”,“prefixedProperty”,“invertTop”,“invertLeft”,“arrow”,“requesting”,“isRequired”,“requested”,“isModifierRequired”,“querySelector”,“isVertical”,“len”,“sideCapitalized”,“toLowerCase”,“altSide”,“opSide”,“arrowElementSize”,“center”,“popperMarginSide”,“popperBorderSide”,“sideValue”,“min”,“validPlacements”,“placements”,“counter”,“index”,“concat”,“reverse”,“BEHAVIORS”,“flipped”,“placementOpposite”,“flipOrder”,“behavior”,“FLIP”,“CLOCKWISE”,“clockwise”,“COUNTERCLOCKWISE”,“refOffsets”,“overlapsRef”,“overflowsLeft”,“overflowsRight”,“overflowsTop”,“overflowsBottom”,“overflowsBoundaries”,“flippedVariation”,“flipVariations”,“getOppositeVariation”,“str”,“size”,“useHeight”,“fragments”,“frag”,“trim”,“divider”,“search”,“splitRegex”,“ops”,“mergeWithPrevious”,“op”,“reduce”,“toValue”,“index2”,“basePlacement”,“parseOffset”,“transformProp”,“popperStyles”,“priority”,“check”,“escapeWithReference”,“shiftvariation”,“shiftOffsets”,“bound”,“hide”,“subtractLength”,“requestAnimationFrame”,“update”,“debounce”,“bind”,“Popper”,“Defaults”,“jquery”,“modifierOptions”,“onLoad”,“enableEventListeners”,“destroy”,“Utils”,“global”,“PopperUtils”“>n”],“names”:</a>,“mappings”:“;;;GAAA,MAAiC,WAAlB,QAAOA,OAAP,EAAqD,WAApB,QAAOC,SAAvD,sCCGA,GAAIC,GAAkB,CAAtB,CACA,IAAK,GAAIC,GAAI,CAAb,CAAgBA,EAAIC,EAAsBC,MAA1C,CAAkDF,GAAK,CAAvD,IACMG,GAAsE,CAAzDC,YAAUC,SAAVD,CAAoBE,OAApBF,CAA4BH,IAA5BG,EAA4D,GACzD,CADyD,OAM/E,aAAsC,IAChCG,YACG,IAAM,SAAA,QAKJC,QAAQC,UAAUC,KAAK,IAAM,KAAA,IAApC,EALW,CAAb,EAYF,aAAiC,IAC3BC,YACG,IAAM,SAAA,YAGE,IAAM,KAAA,