...
<title>select2.full.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/select2/select2.full.js">
...
<pre>!
 ...
 https://github.com/select2/select2/blob/master/LICENSE.md</pre>
...
<pre>// This is needed so we can catch the AMD loader configuration and use it
...
<pre>// Restore the Select2 AMD loader so it can be used
// Needed mostly in the language files, where the loader is not inserted
if (jQuery &amp;&amp; jQuery.fn &amp;&amp; jQuery.fn.select2 &amp;&amp; jQuery.fn.select2.amd) {
  var S2 = jQuery.fn.select2.amd;
}</pre>

<p>var S2;(function () { if (!S2 || !S2.requirejs) { if (!S2) { S2 = {}; }
else { require = S2; }</p>

<pre> @license almond 0.2.9 Copyright (c) 2011-2014, The Dojo Foundation All Rights Reserved.
 Available via the MIT or new BSD license.
 see: http://github.com/jrburke/almond for details
/</pre>

<p>//Going sloppy to avoid &#39;use strict&#39; string cost, but strict
practices should //be followed. /*jslint sloppy: true</p>

<p>/*global setTimeout: false */</p>

<p>var requirejs, require, define; (function (undef) {</p>

<pre>var main, req, makeMap, handlers,
    defined = {},
    waiting = {},
    config = {},
    defining = {},
...
<p>S2.requirejs = requirejs;S2.require = require;S2.define = define; } }());
S2.define(“almond”, function(){});</p>

<p>/* global jQuery:false, $:false */ S2.define(&#39;jquery&#39;,[],function
() {</p>
...
<p>S2.define(&#39;select2/utils&#39;,[</p>

<pre class="ruby"><span class="ruby-string">&#39;jquery&#39;</span>
</pre>
...
<pre>function Results ($element, options, dataAdapter) {
...
<p>S2.define(&#39;select2/keys&#39;,[</p>

<p>], function () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-constant">KEYS</span> = {
  <span class="ruby-value">BACKSPACE:</span> <span class="ruby-value">8</span>,
  <span class="ruby-value">TAB:</span> <span class="ruby-value">9</span>,
  <span class="ruby-value">ENTER:</span> <span class="ruby-value">13</span>,
  <span class="ruby-value">SHIFT:</span> <span class="ruby-value">16</span>,
  <span class="ruby-value">CTRL:</span> <span class="ruby-value">17</span>,
  <span class="ruby-value">ALT:</span> <span class="ruby-value">18</span>,
  <span class="ruby-value">ESC:</span> <span class="ruby-value">27</span>,
  <span class="ruby-value">SPACE:</span> <span class="ruby-value">32</span>,
  <span class="ruby-value">PAGE_UP:</span> <span class="ruby-value">33</span>,
  <span class="ruby-value">PAGE_DOWN:</span> <span class="ruby-value">34</span>,
  <span class="ruby-value">END:</span> <span class="ruby-value">35</span>,
  <span class="ruby-value">HOME:</span> <span class="ruby-value">36</span>,
  <span class="ruby-value">LEFT:</span> <span class="ruby-value">37</span>,
  <span class="ruby-value">UP:</span> <span class="ruby-value">38</span>,
  <span class="ruby-value">RIGHT:</span> <span class="ruby-value">39</span>,
  <span class="ruby-value">DOWN:</span> <span class="ruby-value">40</span>,
  <span class="ruby-value">DELETE:</span> <span class="ruby-value">46</span>
};

<span class="ruby-keyword">return</span> <span class="ruby-constant">KEYS</span>;
</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/base&#39;,[</p>

<pre>&#39;jquery&#39;,
&#39;../utils&#39;,
&#39;../keys&#39;</pre>

<p>], function ($, Utils, KEYS) {</p>

<pre>function BaseSelection ($element, options) {
  this.$element = $element;
  this.options = options;
...
return BaseSelection;</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/single&#39;,[</p>
...
<p>], function ($, BaseSelection, Utils, KEYS) {</p>

<pre>function SingleSelection () {
...
return SingleSelection;</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/multiple&#39;,[</p>

<pre>&#39;jquery&#39;,
&#39;./base&#39;,
&#39;../utils&#39;</pre>

<p>], function ($, BaseSelection, Utils) {</p>

<pre>function MultipleSelection ($element, options) {
...
return MultipleSelection;</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/placeholder&#39;,[</p>

<pre class="ruby"><span class="ruby-string">&#39;../utils&#39;</span>
</pre>

<p>], function (Utils) {</p>

<pre>function Placeholder (decorated, $element, options) {
...
return Placeholder;</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/allowClear&#39;,[</p>
...
return AllowClear;</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/search&#39;,[</p>
...
<pre>function Search (decorated, $element, options) {
  decorated.call(this, $element, options);
}
...
<p>S2.define(&#39;select2/selection/eventRelay&#39;,[</p>
...
return EventRelay;</pre>

<p>});</p>

<p>S2.define(&#39;select2/translation&#39;,[</p>

<pre>&#39;jquery&#39;,
&#39;require&#39;</pre>

<p>], function ($, require) {</p>

<pre>function Translation (dict) {
  this.dict = dict || {};
}
...
return Translation;</pre>

<p>});</p>

<p>S2.define(&#39;select2/diacritics&#39;,[</p>

<p>], function () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">diacritics</span> = {
  <span class="ruby-value">&#39;\u24B6&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\uFF21&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u00C0&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u00C1&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u00C2&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EA6&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EA4&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EAA&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EA8&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u00C3&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u0100&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u0102&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EB0&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EAE&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EB4&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EB2&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u0226&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u01E0&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u00C4&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u01DE&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EA2&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u00C5&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u01FA&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u01CD&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u0200&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u0202&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EA0&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EAC&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1EB6&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u1E00&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u0104&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u023A&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\u2C6F&#39;:</span> <span class="ruby-string">&#39;A&#39;</span>,
  <span class="ruby-value">&#39;\uA732&#39;:</span> <span class="ruby-string">&#39;AA&#39;</span>,
  <span class="ruby-value">&#39;\u00C6&#39;:</span> <span class="ruby-string">&#39;AE&#39;</span>,
  <span class="ruby-value">&#39;\u01FC&#39;:</span> <span class="ruby-string">&#39;AE&#39;</span>,
  <span class="ruby-value">&#39;\u01E2&#39;:</span> <span class="ruby-string">&#39;AE&#39;</span>,
  <span class="ruby-value">&#39;\uA734&#39;:</span> <span class="ruby-string">&#39;AO&#39;</span>,
  <span class="ruby-value">&#39;\uA736&#39;:</span> <span class="ruby-string">&#39;AU&#39;</span>,
  <span class="ruby-value">&#39;\uA738&#39;:</span> <span class="ruby-string">&#39;AV&#39;</span>,
  <span class="ruby-value">&#39;\uA73A&#39;:</span> <span class="ruby-string">&#39;AV&#39;</span>,
  <span class="ruby-value">&#39;\uA73C&#39;:</span> <span class="ruby-string">&#39;AY&#39;</span>,
  <span class="ruby-value">&#39;\u24B7&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\uFF22&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u1E02&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u1E04&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u1E06&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u0243&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u0182&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u0181&#39;:</span> <span class="ruby-string">&#39;B&#39;</span>,
  <span class="ruby-value">&#39;\u24B8&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\uFF23&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u0106&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u0108&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u010A&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u010C&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u00C7&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u1E08&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u0187&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u023B&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\uA73E&#39;:</span> <span class="ruby-string">&#39;C&#39;</span>,
  <span class="ruby-value">&#39;\u24B9&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\uFF24&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u1E0A&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u010E&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u1E0C&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u1E10&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u1E12&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u1E0E&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u0110&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u018B&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u018A&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u0189&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\uA779&#39;:</span> <span class="ruby-string">&#39;D&#39;</span>,
  <span class="ruby-value">&#39;\u01F1&#39;:</span> <span class="ruby-string">&#39;DZ&#39;</span>,
  <span class="ruby-value">&#39;\u01C4&#39;:</span> <span class="ruby-string">&#39;DZ&#39;</span>,
  <span class="ruby-value">&#39;\u01F2&#39;:</span> <span class="ruby-string">&#39;Dz&#39;</span>,
  <span class="ruby-value">&#39;\u01C5&#39;:</span> <span class="ruby-string">&#39;Dz&#39;</span>,
  <span class="ruby-value">&#39;\u24BA&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\uFF25&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u00C8&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u00C9&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u00CA&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EC0&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EBE&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EC4&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EC2&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EBC&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0112&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1E14&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1E16&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0114&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0116&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u00CB&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EBA&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u011A&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0204&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0206&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EB8&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1EC6&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0228&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1E1C&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0118&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1E18&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u1E1A&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u0190&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u018E&#39;:</span> <span class="ruby-string">&#39;E&#39;</span>,
  <span class="ruby-value">&#39;\u24BB&#39;:</span> <span class="ruby-string">&#39;F&#39;</span>,
  <span class="ruby-value">&#39;\uFF26&#39;:</span> <span class="ruby-string">&#39;F&#39;</span>,
  <span class="ruby-value">&#39;\u1E1E&#39;:</span> <span class="ruby-string">&#39;F&#39;</span>,
  <span class="ruby-value">&#39;\u0191&#39;:</span> <span class="ruby-string">&#39;F&#39;</span>,
  <span class="ruby-value">&#39;\uA77B&#39;:</span> <span class="ruby-string">&#39;F&#39;</span>,
  <span class="ruby-value">&#39;\u24BC&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\uFF27&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u01F4&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u011C&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u1E20&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u011E&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u0120&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u01E6&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u0122&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u01E4&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u0193&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\uA7A0&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\uA77D&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\uA77E&#39;:</span> <span class="ruby-string">&#39;G&#39;</span>,
  <span class="ruby-value">&#39;\u24BD&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\uFF28&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u0124&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u1E22&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u1E26&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u021E&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u1E24&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u1E28&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u1E2A&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u0126&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u2C67&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u2C75&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\uA78D&#39;:</span> <span class="ruby-string">&#39;H&#39;</span>,
  <span class="ruby-value">&#39;\u24BE&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\uFF29&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u00CC&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u00CD&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u00CE&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u0128&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u012A&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u012C&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u0130&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u00CF&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u1E2E&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u1EC8&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u01CF&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u0208&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u020A&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u1ECA&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u012E&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u1E2C&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u0197&#39;:</span> <span class="ruby-string">&#39;I&#39;</span>,
  <span class="ruby-value">&#39;\u24BF&#39;:</span> <span class="ruby-string">&#39;J&#39;</span>,
  <span class="ruby-value">&#39;\uFF2A&#39;:</span> <span class="ruby-string">&#39;J&#39;</span>,
  <span class="ruby-value">&#39;\u0134&#39;:</span> <span class="ruby-string">&#39;J&#39;</span>,
  <span class="ruby-value">&#39;\u0248&#39;:</span> <span class="ruby-string">&#39;J&#39;</span>,
  <span class="ruby-value">&#39;\u24C0&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\uFF2B&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u1E30&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u01E8&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u1E32&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u0136&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u1E34&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u0198&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u2C69&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\uA740&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\uA742&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\uA744&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\uA7A2&#39;:</span> <span class="ruby-string">&#39;K&#39;</span>,
  <span class="ruby-value">&#39;\u24C1&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\uFF2C&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u013F&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u0139&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u013D&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u1E36&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u1E38&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u013B&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u1E3C&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u1E3A&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u0141&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u023D&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u2C62&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u2C60&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\uA748&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\uA746&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\uA780&#39;:</span> <span class="ruby-string">&#39;L&#39;</span>,
  <span class="ruby-value">&#39;\u01C7&#39;:</span> <span class="ruby-string">&#39;LJ&#39;</span>,
  <span class="ruby-value">&#39;\u01C8&#39;:</span> <span class="ruby-string">&#39;Lj&#39;</span>,
  <span class="ruby-value">&#39;\u24C2&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\uFF2D&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\u1E3E&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\u1E40&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\u1E42&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\u2C6E&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\u019C&#39;:</span> <span class="ruby-string">&#39;M&#39;</span>,
  <span class="ruby-value">&#39;\u24C3&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\uFF2E&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u01F8&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u0143&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u00D1&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u1E44&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u0147&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u1E46&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u0145&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u1E4A&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u1E48&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u0220&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u019D&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\uA790&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\uA7A4&#39;:</span> <span class="ruby-string">&#39;N&#39;</span>,
  <span class="ruby-value">&#39;\u01CA&#39;:</span> <span class="ruby-string">&#39;NJ&#39;</span>,
  <span class="ruby-value">&#39;\u01CB&#39;:</span> <span class="ruby-string">&#39;Nj&#39;</span>,
  <span class="ruby-value">&#39;\u24C4&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\uFF2F&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u00D2&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u00D3&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u00D4&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ED2&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ED0&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ED6&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ED4&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u00D5&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1E4C&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u022C&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1E4E&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u014C&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1E50&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1E52&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u014E&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u022E&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u0230&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u00D6&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u022A&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ECE&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u0150&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u01D1&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u020C&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u020E&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u01A0&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1EDC&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1EDA&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1EE0&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1EDE&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1EE2&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ECC&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u1ED8&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u01EA&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u01EC&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u00D8&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u01FE&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u0186&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u019F&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\uA74A&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\uA74C&#39;:</span> <span class="ruby-string">&#39;O&#39;</span>,
  <span class="ruby-value">&#39;\u01A2&#39;:</span> <span class="ruby-string">&#39;OI&#39;</span>,
  <span class="ruby-value">&#39;\uA74E&#39;:</span> <span class="ruby-string">&#39;OO&#39;</span>,
  <span class="ruby-value">&#39;\u0222&#39;:</span> <span class="ruby-string">&#39;OU&#39;</span>,
  <span class="ruby-value">&#39;\u24C5&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\uFF30&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\u1E54&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\u1E56&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\u01A4&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\u2C63&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\uA750&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\uA752&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\uA754&#39;:</span> <span class="ruby-string">&#39;P&#39;</span>,
  <span class="ruby-value">&#39;\u24C6&#39;:</span> <span class="ruby-string">&#39;Q&#39;</span>,
  <span class="ruby-value">&#39;\uFF31&#39;:</span> <span class="ruby-string">&#39;Q&#39;</span>,
  <span class="ruby-value">&#39;\uA756&#39;:</span> <span class="ruby-string">&#39;Q&#39;</span>,
  <span class="ruby-value">&#39;\uA758&#39;:</span> <span class="ruby-string">&#39;Q&#39;</span>,
  <span class="ruby-value">&#39;\u024A&#39;:</span> <span class="ruby-string">&#39;Q&#39;</span>,
  <span class="ruby-value">&#39;\u24C7&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\uFF32&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u0154&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u1E58&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u0158&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u0210&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u0212&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u1E5A&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u1E5C&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u0156&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u1E5E&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u024C&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u2C64&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\uA75A&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\uA7A6&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\uA782&#39;:</span> <span class="ruby-string">&#39;R&#39;</span>,
  <span class="ruby-value">&#39;\u24C8&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\uFF33&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u1E9E&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u015A&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u1E64&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u015C&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u1E60&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u0160&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u1E66&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u1E62&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u1E68&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u0218&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u015E&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u2C7E&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\uA7A8&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\uA784&#39;:</span> <span class="ruby-string">&#39;S&#39;</span>,
  <span class="ruby-value">&#39;\u24C9&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\uFF34&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u1E6A&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u0164&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u1E6C&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u021A&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u0162&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u1E70&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u1E6E&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u0166&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u01AC&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u01AE&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\u023E&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\uA786&#39;:</span> <span class="ruby-string">&#39;T&#39;</span>,
  <span class="ruby-value">&#39;\uA728&#39;:</span> <span class="ruby-string">&#39;TZ&#39;</span>,
  <span class="ruby-value">&#39;\u24CA&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\uFF35&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u00D9&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u00DA&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u00DB&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u0168&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1E78&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u016A&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1E7A&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u016C&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u00DC&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u01DB&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u01D7&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u01D5&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u01D9&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EE6&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u016E&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u0170&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u01D3&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u0214&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u0216&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u01AF&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EEA&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EE8&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EEE&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EEC&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EF0&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1EE4&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1E72&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u0172&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1E76&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u1E74&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u0244&#39;:</span> <span class="ruby-string">&#39;U&#39;</span>,
  <span class="ruby-value">&#39;\u24CB&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\uFF36&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\u1E7C&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\u1E7E&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\u01B2&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\uA75E&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\u0245&#39;:</span> <span class="ruby-string">&#39;V&#39;</span>,
  <span class="ruby-value">&#39;\uA760&#39;:</span> <span class="ruby-string">&#39;VY&#39;</span>,
  <span class="ruby-value">&#39;\u24CC&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\uFF37&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u1E80&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u1E82&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u0174&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u1E86&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u1E84&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u1E88&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u2C72&#39;:</span> <span class="ruby-string">&#39;W&#39;</span>,
  <span class="ruby-value">&#39;\u24CD&#39;:</span> <span class="ruby-string">&#39;X&#39;</span>,
  <span class="ruby-value">&#39;\uFF38&#39;:</span> <span class="ruby-string">&#39;X&#39;</span>,
  <span class="ruby-value">&#39;\u1E8A&#39;:</span> <span class="ruby-string">&#39;X&#39;</span>,
  <span class="ruby-value">&#39;\u1E8C&#39;:</span> <span class="ruby-string">&#39;X&#39;</span>,
  <span class="ruby-value">&#39;\u24CE&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\uFF39&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u1EF2&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u00DD&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u0176&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u1EF8&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u0232&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u1E8E&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u0178&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u1EF6&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u1EF4&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u01B3&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u024E&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u1EFE&#39;:</span> <span class="ruby-string">&#39;Y&#39;</span>,
  <span class="ruby-value">&#39;\u24CF&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\uFF3A&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u0179&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u1E90&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u017B&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u017D&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u1E92&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u1E94&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u01B5&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u0224&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u2C7F&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u2C6B&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\uA762&#39;:</span> <span class="ruby-string">&#39;Z&#39;</span>,
  <span class="ruby-value">&#39;\u24D0&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  <span class="ruby-value">&#39;\uFF41&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  <span class="ruby-value">&#39;\u1E9A&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  <span class="ruby-value">&#39;\u00E0&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  <span class="ruby-value">&#39;\u00E1&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  <span class="ruby-value">&#39;\u00E2&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  <span class="ruby-value">&#39;\u1EA7&#39;:</span> <span class="ruby-string">&#39;a&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u023C&#39;:</span> <span class="ruby-string">&#39;c&#39;</span>,
  <span class="ruby-value">&#39;\uA73F&#39;:</span> <span class="ruby-string">&#39;c&#39;</span>,
  <span class="ruby-value">&#39;\u2184&#39;:</span> <span class="ruby-string">&#39;c&#39;</span>,
  <span class="ruby-value">&#39;\u24D3&#39;:</span> <span class="ruby-string">&#39;d&#39;</span>,
  <span class="ruby-value">&#39;\uFF44&#39;:</span> <span class="ruby-string">&#39;d&#39;</span>,
  <span class="ruby-value">&#39;\u1E0B&#39;:</span> <span class="ruby-string">&#39;d&#39;</span>,
  <span class="ruby-value">&#39;\u010F&#39;:</span> <span class="ruby-string">&#39;d&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u1E19&#39;:</span> <span class="ruby-string">&#39;e&#39;</span>,
  <span class="ruby-value">&#39;\u1E1B&#39;:</span> <span class="ruby-string">&#39;e&#39;</span>,
  <span class="ruby-value">&#39;\u0247&#39;:</span> <span class="ruby-string">&#39;e&#39;</span>,
  <span class="ruby-value">&#39;\u025B&#39;:</span> <span class="ruby-string">&#39;e&#39;</span>,
  <span class="ruby-value">&#39;\u01DD&#39;:</span> <span class="ruby-string">&#39;e&#39;</span>,
  <span class="ruby-value">&#39;\u24D5&#39;:</span> <span class="ruby-string">&#39;f&#39;</span>,
  <span class="ruby-value">&#39;\uFF46&#39;:</span> <span class="ruby-string">&#39;f&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u1E29&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u1E2B&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u1E96&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u0127&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u2C68&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u2C76&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u0265&#39;:</span> <span class="ruby-string">&#39;h&#39;</span>,
  <span class="ruby-value">&#39;\u0195&#39;:</span> <span class="ruby-string">&#39;hv&#39;</span>,
  <span class="ruby-value">&#39;\u24D8&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  <span class="ruby-value">&#39;\uFF49&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  <span class="ruby-value">&#39;\u00EC&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  <span class="ruby-value">&#39;\u00ED&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u1E2D&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  <span class="ruby-value">&#39;\u0268&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  <span class="ruby-value">&#39;\u0131&#39;:</span> <span class="ruby-string">&#39;i&#39;</span>,
  <span class="ruby-value">&#39;\u24D9&#39;:</span> <span class="ruby-string">&#39;j&#39;</span>,
  <span class="ruby-value">&#39;\uFF4A&#39;:</span> <span class="ruby-string">&#39;j&#39;</span>,
  <span class="ruby-value">&#39;\u0135&#39;:</span> <span class="ruby-string">&#39;j&#39;</span>,
  <span class="ruby-value">&#39;\u01F0&#39;:</span> <span class="ruby-string">&#39;j&#39;</span>,
  <span class="ruby-value">&#39;\u0249&#39;:</span> <span class="ruby-string">&#39;j&#39;</span>,
  <span class="ruby-value">&#39;\u24DA&#39;:</span> <span class="ruby-string">&#39;k&#39;</span>,
  <span class="ruby-value">&#39;\uFF4B&#39;:</span> <span class="ruby-string">&#39;k&#39;</span>,
  <span class="ruby-value">&#39;\u1E31&#39;:</span> <span class="ruby-string">&#39;k&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u1E3D&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  <span class="ruby-value">&#39;\u1E3B&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  <span class="ruby-value">&#39;\u017F&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  <span class="ruby-value">&#39;\u0142&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  <span class="ruby-value">&#39;\u019A&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  <span class="ruby-value">&#39;\u026B&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  <span class="ruby-value">&#39;\u2C61&#39;:</span> <span class="ruby-string">&#39;l&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u019E&#39;:</span> <span class="ruby-string">&#39;n&#39;</span>,
  <span class="ruby-value">&#39;\u0272&#39;:</span> <span class="ruby-string">&#39;n&#39;</span>,
  <span class="ruby-value">&#39;\u0149&#39;:</span> <span class="ruby-string">&#39;n&#39;</span>,
  <span class="ruby-value">&#39;\uA791&#39;:</span> <span class="ruby-string">&#39;n&#39;</span>,
  <span class="ruby-value">&#39;\uA7A5&#39;:</span> <span class="ruby-string">&#39;n&#39;</span>,
  <span class="ruby-value">&#39;\u01CC&#39;:</span> <span class="ruby-string">&#39;nj&#39;</span>,
  <span class="ruby-value">&#39;\u24DE&#39;:</span> <span class="ruby-string">&#39;o&#39;</span>,
  ...
  <span class="ruby-value">&#39;\uA7A9&#39;:</span> <span class="ruby-string">&#39;s&#39;</span>,
  <span class="ruby-value">&#39;\uA785&#39;:</span> <span class="ruby-string">&#39;s&#39;</span>,
  <span class="ruby-value">&#39;\u1E9B&#39;:</span> <span class="ruby-string">&#39;s&#39;</span>,
  <span class="ruby-value">&#39;\u24E3&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\uFF54&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\u1E6B&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\u1E97&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\u0165&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\u1E6D&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\u021B&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  <span class="ruby-value">&#39;\u0163&#39;:</span> <span class="ruby-string">&#39;t&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u1E87&#39;:</span> <span class="ruby-string">&#39;w&#39;</span>,
  <span class="ruby-value">&#39;\u1E85&#39;:</span> <span class="ruby-string">&#39;w&#39;</span>,
  <span class="ruby-value">&#39;\u1E98&#39;:</span> <span class="ruby-string">&#39;w&#39;</span>,
  <span class="ruby-value">&#39;\u1E89&#39;:</span> <span class="ruby-string">&#39;w&#39;</span>,
  <span class="ruby-value">&#39;\u2C73&#39;:</span> <span class="ruby-string">&#39;w&#39;</span>,
  <span class="ruby-value">&#39;\u24E7&#39;:</span> <span class="ruby-string">&#39;x&#39;</span>,
  <span class="ruby-value">&#39;\uFF58&#39;:</span> <span class="ruby-string">&#39;x&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u00FF&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  <span class="ruby-value">&#39;\u1EF7&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  <span class="ruby-value">&#39;\u1E99&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  <span class="ruby-value">&#39;\u1EF5&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  <span class="ruby-value">&#39;\u01B4&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  <span class="ruby-value">&#39;\u024F&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  <span class="ruby-value">&#39;\u1EFF&#39;:</span> <span class="ruby-string">&#39;y&#39;</span>,
  ...
  <span class="ruby-value">&#39;\u2C6C&#39;:</span> <span class="ruby-string">&#39;z&#39;</span>,
  <span class="ruby-value">&#39;\uA763&#39;:</span> <span class="ruby-string">&#39;z&#39;</span>,
  <span class="ruby-value">&#39;\u0386&#39;:</span> <span class="ruby-string">&#39;\u0391&#39;</span>,
  <span class="ruby-value">&#39;\u0388&#39;:</span> <span class="ruby-string">&#39;\u0395&#39;</span>,
  <span class="ruby-value">&#39;\u0389&#39;:</span> <span class="ruby-string">&#39;\u0397&#39;</span>,
  <span class="ruby-value">&#39;\u038A&#39;:</span> <span class="ruby-string">&#39;\u0399&#39;</span>,
  <span class="ruby-value">&#39;\u03AA&#39;:</span> <span class="ruby-string">&#39;\u0399&#39;</span>,
  <span class="ruby-value">&#39;\u038C&#39;:</span> <span class="ruby-string">&#39;\u039F&#39;</span>,
  <span class="ruby-value">&#39;\u038E&#39;:</span> <span class="ruby-string">&#39;\u03A5&#39;</span>,
  <span class="ruby-value">&#39;\u03AB&#39;:</span> <span class="ruby-string">&#39;\u03A5&#39;</span>,
  <span class="ruby-value">&#39;\u038F&#39;:</span> <span class="ruby-string">&#39;\u03A9&#39;</span>,
  <span class="ruby-value">&#39;\u03AC&#39;:</span> <span class="ruby-string">&#39;\u03B1&#39;</span>,
  <span class="ruby-value">&#39;\u03AD&#39;:</span> <span class="ruby-string">&#39;\u03B5&#39;</span>,
  <span class="ruby-value">&#39;\u03AE&#39;:</span> <span class="ruby-string">&#39;\u03B7&#39;</span>,
  <span class="ruby-value">&#39;\u03AF&#39;:</span> <span class="ruby-string">&#39;\u03B9&#39;</span>,
  <span class="ruby-value">&#39;\u03CA&#39;:</span> <span class="ruby-string">&#39;\u03B9&#39;</span>,
  <span class="ruby-value">&#39;\u0390&#39;:</span> <span class="ruby-string">&#39;\u03B9&#39;</span>,
  <span class="ruby-value">&#39;\u03CC&#39;:</span> <span class="ruby-string">&#39;\u03BF&#39;</span>,
  <span class="ruby-value">&#39;\u03CD&#39;:</span> <span class="ruby-string">&#39;\u03C5&#39;</span>,
  <span class="ruby-value">&#39;\u03CB&#39;:</span> <span class="ruby-string">&#39;\u03C5&#39;</span>,
  <span class="ruby-value">&#39;\u03B0&#39;:</span> <span class="ruby-string">&#39;\u03C5&#39;</span>,
  <span class="ruby-value">&#39;\u03C9&#39;:</span> <span class="ruby-string">&#39;\u03C9&#39;</span>,
  <span class="ruby-value">&#39;\u03C2&#39;:</span> <span class="ruby-string">&#39;\u03C3&#39;</span>
};

<span class="ruby-keyword">return</span> <span class="ruby-identifier">diacritics</span>;
</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/base&#39;,[</p>
...
<pre>function BaseAdapter ($element, options) {
...
return BaseAdapter;</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/select&#39;,[</p>

<pre>&#39;./base&#39;,
&#39;../utils&#39;,
&#39;jquery&#39;</pre>

<p>], function (BaseAdapter, Utils, $) {</p>

<pre>function SelectAdapter ($element, options) {
  this.$element = $element;
  this.options = options;
...
return SelectAdapter;</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/array&#39;,[</p>

<pre>&#39;./select&#39;,
&#39;../utils&#39;,
&#39;jquery&#39;</pre>

<p>], function (SelectAdapter, Utils, $) {</p>

<pre>function ArrayAdapter ($element, options) {
...
return ArrayAdapter;</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/ajax&#39;,[</p>

<pre>&#39;./array&#39;,
&#39;../utils&#39;,
&#39;jquery&#39;</pre>

<p>], function (ArrayAdapter, Utils, $) {</p>

<pre>function AjaxAdapter ($element, options) {
...
return AjaxAdapter;</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/tags&#39;,[</p>
...
<pre>function Tags (decorated, $element, options) {
...
<p>S2.define(&#39;select2/data/tokenizer&#39;,[</p>
...
<pre>function Tokenizer (decorated, $element, options) {
...
<p>S2.define(&#39;select2/data/minimumInputLength&#39;,[</p>

<p>], function () {</p>

<pre>function MinimumInputLength (decorated, $e, options) {
...
return MinimumInputLength;</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/maximumInputLength&#39;,[</p>

<p>], function () {</p>

<pre>function MaximumInputLength (decorated, $e, options) {
...
return MaximumInputLength;</pre>

<p>});</p>

<p>S2.define(&#39;select2/data/maximumSelectionLength&#39;,[</p>

<p>], function (){</p>

<pre>function MaximumSelectionLength (decorated, $e, options) {
...
return MaximumSelectionLength;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown&#39;,[</p>
...
<pre>function Dropdown ($element, options) {
  this.$element = $element;
  this.options = options;
...
<p>S2.define(&#39;select2/dropdown/search&#39;,[</p>
...
<p>S2.define(&#39;select2/dropdown/hidePlaceholder&#39;,[</p>

<p>], function () {</p>

<pre>function HidePlaceholder (decorated, $element, options, dataAdapter) {
  this.placeholder = this.normalizePlaceholder(options.get(&#39;placeholder&#39;));
...
return HidePlaceholder;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown/infiniteScroll&#39;,[</p>
...
<pre>function InfiniteScroll (decorated, $element, options, dataAdapter) {
  this.lastParams = {};
...
return InfiniteScroll;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown/attachBody&#39;,[</p>
...
<pre>function AttachBody (decorated, $element, options) {
...
return AttachBody;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown/minimumResultsForSearch&#39;,[</p>

<p>], function () {</p>

<pre>function countResults (data) {
  var count = 0;
...
return MinimumResultsForSearch;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown/selectOnClose&#39;,[</p>

<p>], function () {</p>

<pre>function SelectOnClose () { }
...
return SelectOnClose;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown/closeOnSelect&#39;,[</p>

<p>], function () {</p>

<pre>function CloseOnSelect () { }
...
return CloseOnSelect;</pre>

<p>});</p>

<p>S2.define(&#39;select2/i18n/en&#39;,[],function () {</p>
...
<p>S2.define(&#39;select2/defaults&#39;,[</p>
...
<p>], function (require, $, Defaults, Utils) {</p>

<pre>function Options (options, $element) {
  this.options = options;
...
<p>], function ($, Options, Utils, KEYS) {</p>

<pre>var Select2 = function ($element, options) {
...
<p>S2.define(&#39;select2/compat/utils&#39;,[</p>
...
<pre>function syncCssClasses ($dest, $src, adapter) {
...
<p>S2.define(&#39;select2/compat/containerCss&#39;,[</p>

<pre>&#39;jquery&#39;,
&#39;./utils&#39;</pre>

<p>], function ($, CompatUtils) {</p>

<pre>// No-op CSS adapter that discards all classes by default
...
return ContainerCSS;</pre>

<p>});</p>

<p>S2.define(&#39;select2/compat/dropdownCss&#39;,[</p>
...
return DropdownCSS;</pre>

<p>});</p>

<p>S2.define(&#39;select2/compat/initSelection&#39;,[</p>
...
<pre>function InitSelection (decorated, $element, options) {
...
return InitSelection;</pre>

<p>});</p>

<p>S2.define(&#39;select2/compat/inputData&#39;,[</p>
...
<pre>function InputData (decorated, $element, options) {
  this._currentData = [];
...
return InputData;</pre>

<p>});</p>

<p>S2.define(&#39;select2/compat/matcher&#39;,[</p>
...
<pre>function oldMatcher (matcher) {
...
return oldMatcher;</pre>

<p>});</p>

<p>S2.define(&#39;select2/compat/query&#39;,[</p>

<p>], function () {</p>

<pre>function Query (decorated, $element, options) {
  if (options.get(&#39;debug&#39;) &amp;&amp; window.console &amp;&amp; console.warn) {
    console.warn(
...
<p>S2.define(&#39;select2/dropdown/attachContainer&#39;,[</p>

<p>], function () {</p>

<pre>function AttachContainer (decorated, $element, options) {
  decorated.call(this, $element, options);
}
...
return AttachContainer;</pre>

<p>});</p>

<p>S2.define(&#39;select2/dropdown/stopPropagation&#39;,[</p>

<p>], function () {</p>

<pre>function StopPropagation () { }
...
return StopPropagation;</pre>

<p>});</p>

<p>S2.define(&#39;select2/selection/stopPropagation&#39;,[</p>
...
<p>S2.define(&#39;jquery.select2&#39;,[</p>

<pre>&#39;jquery&#39;,
&#39;require&#39;,

&#39;./select2/core&#39;,
&#39;./select2/defaults&#39;</pre>

<p>], function ($, require, Select2, Defaults) {</p>

<pre>// Force jQuery.mousewheel to be loaded if it hasn&#39;t already
...
<pre>if ( typeof S2.define === &#39;function&#39; &amp;&amp; S2.define.amd ) {
    // AMD. Register as an anonymous module.
...
<pre>var toFix  = [&#39;wheel&#39;, &#39;mousewheel&#39;, &#39;DOMMouseScroll&#39;, &#39;MozMousePixelScroll&#39;],
...
<pre>// Return the AMD loader configuration so it can be used outside of this file
return {
  define: S2.define,
  require: S2.require
};</pre>
...
<pre>// Autoload the jQuery bindings
