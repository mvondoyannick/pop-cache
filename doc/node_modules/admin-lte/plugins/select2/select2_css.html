...
<title>select2.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/select2/select2.css">
...
<p>.select2-container–open .select2-dropdown {</p>

<pre>left: 0; }</pre>

<p>.select2-container–open .select2-dropdown–above {</p>

<pre>border-bottom: none;
border-bottom-left-radius: 0;
border-bottom-right-radius: 0; }</pre>

<p>.select2-container–open .select2-dropdown–below {</p>

<pre>border-top: none;
border-top-left-radius: 0;
border-top-right-radius: 0; }</pre>

<p>.select2-search–dropdown {</p>
...
filter: alpha(opacity=0); }</pre>

<p>.select2-hidden-accessible {</p>
...
<p>.select2-container–default .select2-selection–single {</p>
...
<p>.<a href="dir="rtl"">select2-container–default</a>
.select2-selection–single .select2-selection__clear {</p>

<pre>float: left; }</pre>

<p>.<a href="dir="rtl"">select2-container–default</a>
.select2-selection–single .select2-selection__arrow {</p>

<pre>left: 1px;
right: auto; }</pre>

<p>.select2-container–default.select2-container–disabled
...
<p>.select2-container–default.select2-container–open .select2-selection–single
.select2-selection__arrow b {</p>

<pre>border-color: transparent transparent #888 transparent;
border-width: 0 4px 5px 4px; }</pre>
...
<p>.<a href="dir="rtl"">select2-container–default</a>
.select2-selection–multiple .select2-selection__choice, .<a
href="dir="rtl"">select2-container–default</a> .select2-selection–multiple
.select2-selection__placeholder {</p>

<pre>float: right; }</pre>

<p>.<a href="dir="rtl"">select2-container–default</a>
.select2-selection–multiple .select2-selection__choice {</p>

<pre>margin-left: 5px;
margin-right: auto; }</pre>

<p>.<a href="dir="rtl"">select2-container–default</a>
.select2-selection–multiple .select2-selection__choice__remove {</p>
...
<p>.select2-container–default.select2-container–open.select2-container–above
...
<p>.select2-container–default.select2-container–open.select2-container–below
.select2-selection–single,
.select2-container–default.select2-container–open.select2-container–below
.select2-selection–multiple {</p>

<pre>border-bottom-left-radius: 0;
border-bottom-right-radius: 0; }</pre>

<p>.select2-container–default .select2-search–dropdown .select2-search__field
{</p>

<pre>border: 1px solid #aaa; }</pre>

<p>.select2-container–default .select2-search–inline .select2-search__field {</p>

<pre>background: transparent;
border: none;
outline: 0; }</pre>

<p>.select2-container–default .select2-results &gt; .select2-results__options
{</p>
...
href="role=group">select2-results__option</a> {</p>
...
<p>.select2-container–default .select2-results__option
...
<pre>background-color: #5897fb;
color: white; }</pre>

<p>.select2-container–default .select2-results__group {</p>

<pre>cursor: default;
display: block;
padding: 6px; }</pre>

<p>.select2-container–classic .select2-selection–single {</p>
...
<p>.<a href="dir="rtl"">select2-container–classic</a>
.select2-selection–single .select2-selection__clear {</p>
...
<p>.select2-container–classic.select2-container–open .select2-selection–single
{</p>

<pre>border: 1px solid #5897fb; }
...
<p>.select2-container–classic.select2-container–open.select2-container–above
.select2-selection–single {</p>
...
background-repeat: repeat-x;
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=&#39;#ffffff&#39;, endColorstr=&#39;#eeeeee&#39;, GradientType=0); }</pre>

<p>.select2-container–classic.select2-container–open.select2-container–below
.select2-selection–single {</p>
...
background-repeat: repeat-x;
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=&#39;#eeeeee&#39;, endColorstr=&#39;#ffffff&#39;, GradientType=0); }</pre>

<p>.select2-container–classic .select2-selection–multiple {</p>
...
<p>.select2-container–classic.select2-container–open
.select2-selection–multiple {</p>

<pre>border: 1px solid #5897fb; }</pre>
...
<p>.select2-container–classic .select2-search–dropdown .select2-search__field
{</p>

<pre>border: 1px solid #aaa;
outline: 0; }</pre>

<p>.select2-container–classic .select2-search–inline .select2-search__field {</p>

<pre>outline: 0; }</pre>

<p>.select2-container–classic .select2-dropdown {</p>

<pre>background-color: white;
border: 1px solid transparent; }</pre>

<p>.select2-container–classic .select2-dropdown–above {</p>

<pre>border-bottom: none; }</pre>

<p>.select2-container–classic .select2-dropdown–below {</p>

<pre>border-top: none; }</pre>

<p>.select2-container–classic .select2-results &gt; .select2-results__options
{</p>

<pre>max-height: 200px;
overflow-y: auto; }</pre>

<p>.select2-container–classic .<a
href="role=group">select2-results__option</a> {</p>
...
<pre>background-color: #3875d7;
color: white; }</pre>

<p>.select2-container–classic .select2-results__group {</p>

<pre>cursor: default;
display: block;
padding: 6px; }</pre>

<p>.select2-container–classic.select2-container–open .select2-dropdown {</p>

<pre>border-color: #5897fb; }</pre>
</main>
