...
<title>jquery.inputmask.regex.extensions.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/plugins/input-mask/jquery.inputmask.regex.extensions.js">

<p>Input Mask plugin extensions <a
href="http://github.com/RobinHerbots/jquery.inputmask">github.com/RobinHerbots/jquery.inputmask</a>
Copyright © 2010 - 2014 Robin Herbots Licensed under the MIT license (<a
href="http://www.opensource.org/licenses/mit-license.php">www.opensource.org/licenses/mit-license.php</a>)
Version: 0.0.0</p>

<p>Regex extensions on the jquery.inputmask base Allows for using regular
expressions as a mask</p>

<p>(function ($) {</p>

<pre>$.extend($.inputmask.defaults.aliases, { // $(selector).inputmask(&quot;Regex&quot;, { regex: &quot;[0-9]*&quot;}
    &#39;Regex&#39;: {
        mask: &quot;r&quot;,
        greedy: false,
        repeat: &quot;*&quot;,
