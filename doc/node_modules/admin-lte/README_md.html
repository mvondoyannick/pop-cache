...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Looking+for+Premium+Templates-3F">Looking for Premium Templates?</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-Download-3A">Download:</a>
    <li><a href="#label-Using+The+Command+Line-3A">Using The Command Line:</a>
    <li><a href="#label-Documentation">Documentation</a>
    <li><a href="#label-Browser+Support">Browser Support</a>
    <li><a href="#label-Contribution">Contribution</a>
    <li><a href="#label-Contribution+Requirements-3A">Contribution Requirements:</a>
    <li><a href="#label-License">License</a>
    <li><a href="#label-Legacy+Releases">Legacy Releases</a>
    <li><a href="#label-Change+log">Change log</a>
    <li><a href="#label-Image+Credits">Image Credits</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/admin-lte/README.md">

<h1 id="label-Introduction">Introduction<span><a href="#label-Introduction">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><strong>AdminLTE</strong> is a fully responsive administration template.
Based on <strong><a href="https://getbootstrap.com">Bootstrap
4</a></strong> framework. Highly customizable and easy to use. Fits many
screen resolutions from small mobile devices to large desktops.</p>

<p><strong>Download &amp; Preview on <a
href="https://adminlte.io">AdminLTE.io</a></strong></p>

<h2 id="label-Looking+for+Premium+Templates-3F">Looking for Premium Templates?<span><a href="#label-Looking+for+Premium+Templates-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>AdminLTE.io just opened a new premium templates page. Hand picked to insure
the best quality and the most affordable prices. Visit <a
href="https://adminlte.io/premium">adminlte.io/premium</a> for more
information.</p>

<p><img src="https://adminlte.io/AdminLTE3.png"></p>

<p><strong>AdminLTE</strong> has been carefully coded with clear comments in
all of its JS, SCSS and HTML files. SCSS has been used to increase code
customizability.</p>
...
<h4 id="label-Download-3A">Download:<span><a href="#label-Download-3A">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Download from Github or <a href="https://adminlte.io">visit AdminLTE.io</a>
and download the latest release.</p>

<h4 id="label-Using+The+Command+Line-3A">Using The Command Line:<span><a href="#label-Using+The+Command+Line-3A">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p><strong>NPM</strong> <code>bash npm install admin-lte </code></p>

<p><strong>Github</strong></p>
<ul><li>
<p>Clone to your machine <code> git clone
https://github.com/almasaeed2010/AdminLTE.git </code></p>
</li></ul>

<h2 id="label-Documentation">Documentation<span><a href="#label-Documentation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Visit the <a
href="https://adminlte.io/themes/AdminLTE/documentation/index.html">online
documentation</a> for the most updated guide. Information will be added on
a weekly basis.</p>
...
<h2 id="label-Contribution">Contribution<span><a href="#label-Contribution">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Contribution are always <strong>welcome and recommended</strong>! Here is
how:</p>
<ul><li>
<p>Fork the repository (<a
href="https://help.github.com/articles/fork-a-repo/">here is the
guide</a>).</p>
</li><li>
<p>Clone to your machine <code>git clone
https://github.com/YOUR_USERNAME/AdminLTE.git</code></p>
</li><li>
...
<h4 id="label-Contribution+Requirements-3A">Contribution Requirements:<span><a href="#label-Contribution+Requirements-3A">&para;</a> <a href="#top">&uarr;</a></span></h4>
<ul><li>
<p>When you contribute, you agree to give a non-exclusive license to
AdminLTE.io to use that contribution in any context as we (AdminLTE.io) see
appropriate.</p>
</li><li>
<p>If you use content provided by another party, it must be appropriately
licensed using an <a href="http://opensource.org/licenses">open source</a>
license.</p>
</li><li>
<p>Contributions are only accepted through Github pull requests.</p>
</li><li>
<p>Finally, contributed code must work in all supported browsers (see above
for browser support).</p>
</li></ul>

<h2 id="label-License"><a href="plugins/datatables/extensions/ColReorder/License_txt.html">License</a><span><a href="#label-License">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>AdminLTE is an open source project by <a
href="https://adminlte.io">AdminLTE.io</a> that is licensed under <a
href="http://opensource.org/licenses/MIT">MIT</a>. AdminLTE.io reserves the
right to change the license of future releases.</p>

<h2 id="label-Legacy+Releases">Legacy Releases<span><a href="#label-Legacy+Releases">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p><a
href="https://github.com/almasaeed2010/AdminLTE/releases/tag/v2.4.3">AdminLTE
2</a></p>
</li><li>
<p><a
href="https://github.com/almasaeed2010/AdminLTE/releases/tag/1.3.1">AdminLTE
1</a></p>
</li></ul>

<h2 id="label-Change+log">Change log<span><a href="#label-Change+log">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Visit the <a
href="https://github.com/almasaeed2010/AdminLTE/releases">releases</a> page
to view the changelog</p>

<h2 id="label-Image+Credits">Image Credits<span><a href="#label-Image+Credits">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><a
href="http://www.pixeden.com/psd-web-elements/flat-responsive-showcase-psd">Pixeden</a></p>

<p><a
href="http://www.graphicsfuel.com/2013/02/13-high-resolution-blur-backgrounds/">Graphicsfuel</a></p>

<p><a href="http://pickaface.net/">Pickaface</a></p>

<p><a href="https://unsplash.com/">Unsplash</a></p>

<p><a href="http://uifaces.com/">Uifaces</a></p>
</main>
