...
<title>index3.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/index3.html">
...
<p>&lt;/head&gt; &lt;!– BODY TAG OPTIONS:</p>

<h6 id="label-"><span><a href="#label-">&para;</a> <a href="#top">&uarr;</a></span></h6>

<p>Apply one or more of the following classes to to the body tag to get the
desired effect |———————————————————| |LAYOUT OPTIONS | sidebar-collapse    
| |               | sidebar-mini                            |
|———————————————————| –&gt; &lt;body class=“hold-transition
sidebar-mini”&gt; &lt;div class=“wrapper”&gt;</p>
...
src=“dist/js/pages/dashboard3.js”&gt;&lt;/script&gt; &lt;/body&gt;
&lt;/html&gt;</p>
</main>
