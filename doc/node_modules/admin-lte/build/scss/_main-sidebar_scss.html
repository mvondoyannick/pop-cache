...
<title>_main-sidebar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_main-sidebar.scss">
...
<pre>z-index: $zindex-main-sidebar;
height: 100vh;
...
<pre>padding-bottom: $sidebar-padding-y;
...
<p>// Sidebar user panel .user-panel {</p>
...
<p>// Sidebar navigation menu .nav-sidebar {</p>
...
<p>// Sidebar variants @each $name, $color in $theme-colors {</p>

<pre>.sidebar-dark-#{$name} {
