...
<title>_sidebar-mini.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_sidebar-mini.scss">

<pre>Component: Sidebar Mini</pre>

<p>// Add sidebar-mini class to the body tag to activate this feature
.sidebar-mini {</p>

<pre>// Sidebar mini should work only on large devices
...
<pre>@include transition(margin-left $transition-speed linear, opacity .5s ease)</pre>
