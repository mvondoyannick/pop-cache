...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_buttons.scss">
...
<p>// Button color variations .btn-default {</p>
...
<p>// Application buttons .btn-app {</p>

<pre>@include border-radius(3px);
position: relative;
padding: 15px 5px;
