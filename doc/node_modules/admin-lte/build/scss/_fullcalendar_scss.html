...
<title>_fullcalendar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_fullcalendar.scss">

<pre>Plugin: Full Calendar
---------------------</pre>

<p>//Fullcalendar buttons .fc-button {</p>
...
<p>// Calendar title .fc-header-title h2 {</p>
...
<p>// Calendar table header cells .fc-widget-header {</p>
...
<pre>@include box-shadow($card-shadow);
