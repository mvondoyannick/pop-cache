...
<title>_progress-bars.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_progress-bars.scss">

<pre>Component: Progress Bar
-----------------------</pre>

<p>//General CSS .progress {</p>

<pre>@include box-shadow(none);
@include border-radius($progress-bar-border-radius);</pre>

<p>}</p>

<p>.progress-group {</p>

<pre class="ruby"><span class="ruby-ivar">@extend</span> .<span class="ruby-identifier">mb</span><span class="ruby-value">-2</span>;
</pre>

<p>}</p>

<p>// size variation .progress-sm {</p>
...
<p>// Vertical bars .progress.vertical {</p>
...
<p>// Remove margins from progress bars when put in a table .table {</p>
