...
<title>_select2.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_select2.scss">

<pre>Plugin: Select2
---------------</pre>

<p>//Signle select .select2-container–default, .select2-selection {</p>

<pre>&amp;.select2-container--focus,
&amp;:focus,
&amp;:active {
  outline: none;
}
...
<pre>border-color: theme-color(&quot;primary&quot;);</pre>

<p>}</p>

<p>.select2-dropdown {</p>

<pre>border: 1px solid $gray-x-light;
//border-radius: $input-radius;</pre>
...
<pre>background-color: theme-color(&quot;primary&quot;);
color: white;</pre>
...
<p>.select2-dropdown, .select2-search–inline {</p>

<pre>.select2-search__field {
  border: 1px solid $gray-x-light;
  &amp;:focus {
    outline: none;
...
<p>//Multiple select .select2-container–default {</p>

<pre>.select2-selection--multiple {
  border: 1px solid $gray-x-light;
  //border-radius: $input-radius;
  &amp;:focus {
