...
<title>_bootstrap-variables.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_bootstrap-variables.scss">
...
<p>// stylelint-disable $white:    ffffff !default; $gray-100: f8f9fa
!default; $gray-200: e9ecef !default; $gray-300: dee2e6 !default;
$gray-400: ced4da !default; $gray-500: adb5bd !default; $gray-600: #6c757d
!default; $gray-700: #495057 !default; $gray-800: #343a40 !default;
$gray-900: #212529 !default; $black:    #000 !default;</p>

<p>$grays: () !default; $grays: map-merge((</p>
...
<p>$colors: () !default; $colors: map-merge((</p>
...
<p>$theme-colors: () !default; $theme-colors: map-merge((</p>
...
<p>), $theme-colors); // stylelint-enable</p>
...
contrast function. $yiq-text-dark: #1F2D3D !default; $yiq-text-light:
$white !default;</p>

<p>// Options // // Quickly modify global styling by enabling or disabling
optional features.</p>

<p>$enable-caret:              true !default; $enable-rounded:            true
!default; $enable-shadows:            true !default; $enable-gradients:    
false !default; $enable-transitions:        true !default;
$enable-hover-media-query:  false !default; // Deprecated, no longer
affects any compiled CSS $enable-grid-classes:       true !default;
$enable-print-styles:       true !default;</p>
...
<p>// stylelint-disable $spacer: 1rem !default; $spacers: () !default;
$spacers: map-merge((</p>
...
darken($link-color, 15%) !default; $link-hover-decoration:     none
!default;</p>
...
@include _assert-starts-at-zero($grid-breakpoints);</p>
...
“Segoe UI Symbol” !default; $font-family-monospace:       SFMono-Regular,
Menlo, Monaco, Consolas, “Liberation Mono”, “Courier New”, monospace
!default; $font-family-base:            $font-family-sans-serif !default;
// stylelint-enable value-keyword-case</p>
...
<p>$font-weight-light:           300 !default; $font-weight-normal:         
400 !default; $font-weight-bold:            700 !default;</p>
...
<p>$headings-margin-bottom:      ($spacer / 2) !default;
$headings-font-family:        inherit !default; $headings-font-weight:     
500 !default; $headings-line-height:        1.2 !default; $headings-color: 
inherit !default;</p>
...
<p>$blockquote-small-color:      $gray-600 !default; $blockquote-font-size:   
($font-size-base * 1.25) !default;</p>
...
<p>$table-bg:                    transparent !default; $table-accent-bg:      
rgba($black, .05) !default; $table-hover-bg:              rgba($black,
.075) !default; $table-active-bg:             $table-hover-bg !default;</p>
...
<p>$table-dark-bg:               $gray-900 !default; $table-dark-accent-bg:   
rgba($white, .05) !default; $table-dark-hover-bg:         rgba($white,
.075) !default; $table-dark-border-color:     lighten($gray-900, 7.5%)
!default; $table-dark-color:            $body-bg !default;</p>
...
.75rem !default; $input-btn-line-height:       $line-height-base !default;</p>
...
.5rem !default; $input-btn-line-height-sm:    $line-height-sm !default;</p>

<p>$input-btn-padding-y-lg:      .5rem !default; $input-btn-padding-x-lg:     
1rem !default; $input-btn-line-height-lg:    $line-height-lg !default;</p>
...
$btn-disabled-opacity:        .65 !default; $btn-active-box-shadow:      
inset 0 3px 5px rgba($black, .125) !default;</p>
...
$input-box-shadow:                      inset 0 0 0 rgba($black, 0)
!default;</p>
...
<p>$input-placeholder-color:               $gray-600 !default;</p>

<p>$input-height-border:                   $input-border-width * 2 !default;</p>

<p>$input-height-inner:                    ($font-size-base *
$input-btn-line-height) + ($input-btn-padding-y * 2) !default;
$input-height:                          calc(#{$input-height-inner} +
#{$input-height-border}) !default;</p>

<p>$input-height-inner-sm:                 ($font-size-sm *
$input-btn-line-height-sm) + ($input-btn-padding-y-sm * 2) !default;
$input-height-sm:                       calc(#{$input-height-inner-sm} +
#{$input-height-border}) !default;</p>

<p>$input-height-inner-lg:                 ($font-size-lg *
$input-btn-line-height-lg) + ($input-btn-padding-y-lg * 2) !default;
...
<p>$form-group-margin-bottom:              1rem !default;</p>

<p>$input-group-addon-color:               $input-color !default;
$input-group-addon-bg:                  $gray-200 !default;
$input-group-addon-border-color:        $input-border-color !default;</p>

<p>$custom-control-gutter:                 1.5rem !default;
$custom-control-spacer-x:               1rem !default;</p>

<p>$custom-control-indicator-size:         1rem !default;
$custom-control-indicator-bg:           $gray-300 !default;
$custom-control-indicator-bg-size:      50% 50% !default;
$custom-control-indicator-box-shadow:   inset 0 .25rem .25rem rgba($black,
.1) !default;</p>

<p>$custom-control-indicator-disabled-bg:          $gray-200 !default;
$custom-control-label-disabled-color:           $gray-600 !default;</p>
...
$custom-control-indicator-checked-box-shadow:   none !default;</p>

<p>$custom-control-indicator-focus-box-shadow:     0 0 0 1px $body-bg,
$input-btn-focus-box-shadow !default;</p>
...
$custom-control-indicator-active-box-shadow:    none !default;</p>
...
$custom-checkbox-indicator-indeterminate-box-shadow: none !default;</p>
...
<p>$custom-select-padding-y:           .375rem !default;
$custom-select-padding-x:          .75rem !default; $custom-select-height: 
$input-height !default; $custom-select-indicator-padding:   1rem !default;
// Extra padding to account for the presence of the background-image based
indicator $custom-select-line-height:         $input-btn-line-height
!default; $custom-select-color:               $input-color !default;
$custom-select-disabled-color:      $gray-600 !default; $custom-select-bg: 
$white !default; $custom-select-disabled-bg:         $gray-200 !default;
...
3h4z&#39;/%3E%3C/svg%3E”), “#”, “%23”) !default;
$custom-select-border-width:        $input-btn-border-width !default;
$custom-select-border-color:        $input-border-color !default;
$custom-select-border-radius:       $border-radius !default;</p>

<p>$custom-select-focus-border-color:  $input-focus-border-color !default;
$custom-select-focus-box-shadow:    inset 0 1px 2px rgba($black, .075), 0 0
5px rgba($custom-select-focus-border-color, .5) !default;</p>

<p>$custom-select-font-size-sm:        75% !default; $custom-select-height-sm:
$input-height-sm !default;</p>

<p>$custom-select-font-size-lg:        125% !default;
$custom-select-height-lg:           $input-height-lg !default;</p>

<p>$custom-file-height:                $input-height !default;
$custom-file-focus-border-color:    $input-focus-border-color !default;
$custom-file-focus-box-shadow:      $input-btn-focus-box-shadow !default;</p>

<p>$custom-file-padding-y:             $input-btn-padding-y !default;
$custom-file-padding-x:             $input-btn-padding-x !default;
$custom-file-line-height:           $input-btn-line-height !default;
$custom-file-color:                 $input-color !default; $custom-file-bg:
$input-bg !default; $custom-file-border-width:         
$input-btn-border-width !default; $custom-file-border-color:         
$input-border-color !default; $custom-file-border-radius:        
$input-border-radius !default; $custom-file-box-shadow:           
$input-box-shadow !default; $custom-file-button-color:         
$custom-file-color !default; $custom-file-button-bg:            
$input-group-addon-bg !default; $custom-file-text: (</p>

<pre>en: &quot;Browse&quot;</pre>

<p>) !default;</p>

<p>// Form validation $form-feedback-margin-top:         
$form-text-margin-top !default; $form-feedback-font-size:          
$small-font-size !default; $form-feedback-valid-color:        
theme-color(“success”) !default; $form-feedback-invalid-color:      
theme-color(“danger”) !default;</p>
...
$dropdown-item-padding-x:           1rem !default;</p>
...
$navbar-padding-x:                  ($spacer / 2) !default;</p>

<p>$navbar-nav-link-padding-x:         1rem !default;</p>
...
<p>$navbar-dark-color:                 rgba($white, .75) !default;
$navbar-dark-hover-color:           rgba($white, 1) !default;
$navbar-dark-active-color:          $white !default;
$navbar-dark-disabled-color:        rgba($white, .25) !default;
$navbar-dark-toggler-icon-bg:      
str-replace(url(“data:image/svg+xml;charset=utf8,%3Csvg viewBox=&#39;0 0 30
30&#39; xmlns=&#39;<a
...
<p>$pagination-focus-box-shadow:       $input-btn-focus-box-shadow !default;</p>
...
<p>$jumbotron-padding:                 2rem !default; $jumbotron-bg:          
$gray-200 !default;</p>

<p>// Cards</p>

<p>$card-spacer-y:                     .75rem !default; $card-spacer-x:       
1.25rem !default; $card-border-width:                 0 !default;
//$border-width !default; $card-border-radius:               
$border-radius !default; $card-border-color:                 rgba($black,
.125) !default; $card-inner-border-radius:         
calc(#{$card-border-radius} - #{$card-border-width}) !default;
$card-cap-bg:                       rgba($black, .03) !default; $card-bg:  
$white !default;</p>
...
<p>$tooltip-font-size:           $font-size-sm !default; $tooltip-max-width:  
200px !default; $tooltip-color:               $white !default; $tooltip-bg:
$black !default; $tooltip-border-radius:        $border-radius !default;
...
<p>// Padding applied to the modal body $modal-inner-padding:         1rem
!default;</p>

<p>$modal-dialog-margin:         .5rem !default; $modal-dialog-margin-y-sm-up:
1.75rem !default;</p>

<p>$modal-title-line-height:           $line-height-base !default;</p>

<p>$modal-content-bg:               $white !default;
$modal-content-border-color:     rgba($black, .2) !default;
$modal-content-border-width:     $border-width !default;
$modal-content-box-shadow-xs:    0 .25rem .5rem rgba($black, .5) !default;
$modal-content-box-shadow-sm-up: 0 .5rem 1rem rgba($black, .5) !default;</p>

<p>$modal-backdrop-bg:           $black !default; $modal-backdrop-opacity:    
.5 !default; $modal-header-border-color:   $gray-200 !default;
$modal-footer-border-color:   $modal-header-border-color !default;
$modal-header-border-width:   $modal-content-border-width !default;
$modal-footer-border-width:   $modal-header-border-width !default;
$modal-header-padding:        1rem !default;</p>

<p>$modal-lg:                          800px !default; $modal-md:             
500px !default; $modal-sm:                          300px !default;</p>

<p>$modal-transition:                  transform .3s ease-out !default;</p>
...
$breadcrumb-divider:                “/” !default;</p>

<p>// Carousel</p>

<p>$carousel-control-color:            $white !default;
$carousel-control-width:            15% !default;
$carousel-control-opacity:          .5 !default;</p>

<p>$carousel-indicator-width:          30px !default;
$carousel-indicator-height:         3px !default;
$carousel-indicator-spacer:         3px !default;
$carousel-indicator-active-bg:      $white !default;</p>
...
<p>$carousel-transition:               transform .6s ease !default;</p>
...
<p>// Printing $print-page-size:                   a3 !default;
