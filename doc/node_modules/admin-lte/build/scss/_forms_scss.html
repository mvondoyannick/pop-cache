...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_forms.scss">
...
<pre class="ruby"><span class="ruby-identifier">button</span> <span class="ruby-identifier">groups</span>
</pre>
...
<pre>line-height: $input-height;</pre>
...
<pre>line-height: $input-height-lg;</pre>
...
<pre>line-height: $input-height-sm;</pre>

<p>}</p>

<p>label:not(.form-check-label, .custom-file-label) {</p>

<pre>font-weight: $font-weight-bold;</pre>
