...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_dropdown.scss">

<pre>Component: Dropdown menus
-------------------------</pre>

<p>// General Dropdown Rules //.dropdown-item { //  &amp;:first-of-type { //  
@include border-top-radius($border-radius); //  } //  &amp;:last-of-type {
//    @include border-bottom-radius($border-radius); //  } //}</p>

<p>.dropdown-item-title {</p>

<pre>font-size: $font-size-base;
margin: 0;</pre>

<p>}</p>

<p>// Dropdown Sizes .dropdown-menu-lg {</p>
...
<p>// Dropdown header and footer .dropdown-footer, .dropdown-header {</p>
...
<pre>  Add fade animation to dropdown menus by appending
the class .animated-dropdown-menu to the .dropdown-menu ul (or ol)</pre>

<p>.open:not(.dropup) &gt; .animated-dropdown-menu {</p>

<pre>backface-visibility: visible !important;
@include animation(flipInX .7s both);</pre>
...
<p>/* Fix dropdown menu in navbars */ .navbar-custom-menu &gt; .navbar-nav {</p>
...
<p>@include media-breakpoint-down(sm) {</p>
