...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_layout.scss">
...
<p>.content-wrapper, .main-footer, .main-header {</p>
...
<pre>padding: $main-footer-padding;
color: #555;
border-top: $main-footer-border-top;
background: $main-footer-bg;</pre>

<p>}</p>

<p>.content-header {</p>

<pre>padding: 15px $content-padding-x;
