...
<title>_control-sidebar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_control-sidebar.scss">

<pre>Component: Control sidebar. By default, this is the right sidebar.</pre>
...
<p>// Control sidebar open state .control-sidebar-open {</p>

<pre>@include media-breakpoint-up(md) {
  .control-sidebar {
    &amp;,
    &amp;:before {
      right: 0;
...
<p>// Control sidebar slide over content state .control-sidebar-slide-open {</p>
...
<p>// Dark skin .control-sidebar-dark {</p>
...
<p>// Light skin .control-sidebar-light {</p>

<pre>color: lighten($sidebar-light-color, 10%);
