...
<title>_social-widgets.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_social-widgets.scss">

<pre>Component: Social Widgets
-------------------------</pre>

<p>//General widget style .card-widget {</p>
...
<p>//User Widget Style 1 .widget-user {</p>

<pre>//User name container
.widget-user-header {
  padding: 1rem;
  height: 120px;
  @if $enable-rounded {
...
<p>//User Widget Style 2 .widget-user-2 {</p>
