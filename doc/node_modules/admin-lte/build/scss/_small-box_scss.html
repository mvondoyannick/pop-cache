...
<title>_small-box.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_small-box.scss">
...
<pre>@include border-radius($border-radius);
...
<pre>// No need for icons on very small devices
.small-box {
  text-align: center;
  .icon {
    display: none;
