...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_mixins.scss">

<p>// AdminLTE mixins // ===============</p>

<p>// Changes the color and the hovering properties of the navbar @mixin
navbar-variant($color, $font-color: rgba(255, 255, 255, 0.8), $hover-color:
f6f6f6, $hover-bg: rgba(0, 0, 0, 0.1)) {</p>
...
<p>// Logo color variation @mixin logo-variant($bg-color, $color: fff,
$border-bottom-color: transparent, $border-bottom-width: 0) {</p>

<pre>background-color: $bg-color;
color: $color;
...
<p>// Box solid color variantion creator @mixin box-solid-variant($color,
$text-color: fff) {</p>
...
<p>// Direct Chat Variant @mixin direct-chat-variant($bg-color, $color: fff) {</p>

<pre>.right &gt; .direct-chat-text {
  background: $bg-color;
...
<p>@mixin translate($x, $y) {</p>

<pre>-webkit-transform: translate($x, $y);
-ms-transform: translate($x, $y); // IE9 only
transform: translate($x, $y);</pre>

<p>}</p>

<p>// Different radius each side @mixin border-radius-sides($top-left,
$top-right, $bottom-left, $bottom-right) {</p>

<pre>border-radius: $top-left $top-right $bottom-left $bottom-right;</pre>

<p>}</p>

<p>@mixin calc($property, $expression) {</p>

<pre class="ruby"><span class="ruby-comment">#{$property}: -webkit-calc(#{$expression});</span>
<span class="ruby-comment">#{$property}: calc(#{$expression});</span>
</pre>

<p>}</p>

<p>@mixin rotate($value) {</p>

<pre>-ms-transform: rotate($value);
transform: rotate($value);</pre>

<p>}</p>

<p>@mixin animation($animation) {</p>

<pre>animation: $animation;</pre>

<p>}</p>

<p>// Gradient background @mixin gradient($color: #F5F5F5, $start: #EEE,
$stop: #FFF) {</p>
...
background: -o-linear-gradient($stop, $start);</pre>

<p>}</p>

<p>// Skins Mixins</p>

<p>// Dark Sidebar Mixin @mixin skin-dark-sidebar($link-hover-border-color) {</p>

<pre>// Sidebar background color
...
<p>// Light Sidebar Mixin @mixin skin-light-sidebar($link-hover-border-color)
{</p>
