...
<title>_main-header.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_main-header.scss">
...
<pre>z-index: $zindex-main-header;
...
<p>// Add this class to images within a nav-link .navbar-img {</p>

<pre>height: $main-header-height / 2;
width: auto;</pre>

<p>}</p>

<p>// Navbar badge .navbar-badge {</p>
