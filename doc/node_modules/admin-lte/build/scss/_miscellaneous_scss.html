...
<title>_miscellaneous.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_miscellaneous.scss">
...
<pre>color: theme-color(primary) !important;</pre>
...
<p>// Description Blocks .description-block {</p>
...
<p>// Background colors @each $name, $color in $theme-colors {</p>
...
<pre>color: #000;
background-color: $gray-500;</pre>

<p>}</p>

<p>.bg-gray-light {</p>

<pre>background-color: lighten($gray-200, 3%);
color: color-yiq(lighten($gray-200, 3%)) !important;</pre>
...
color: color-yiq($black) !important;</pre>
...
color: color-yiq($white) !important;</pre>

<p>}</p>

<p>// Disabled! [class^=“bg-”].disabled {</p>
...
<p>// Hide elements by display none only .hide {</p>

<pre>display: none !important;</pre>

<p>}</p>

<p>// Remove borders .no-border {</p>

<pre>border: 0 !important;</pre>

<p>}</p>

<p>// Remove box shadow .no-shadow {</p>

<pre>box-shadow: none !important;</pre>

<p>}</p>

<p>// Unstyled List .list-unstyled {</p>
...
<p>// Remove border radius .flat {</p>

<pre>@include border-radius(0 !important);</pre>

<p>}</p>

<p>// _fix for sparkline tooltip .jqstooltip {</p>
...
<p>// Gradient Background colors @each $name, $color in $theme-colors {</p>

<pre>.bg-#{$name}-gradient {
...
<p>// Description Block Extension .description-block {</p>

<pre>.description-icon {
  font-size: 16px;
}</pre>

<p>}</p>

<p>// List utility classes .list-header {</p>
...
<p>// <a href="../../../../User.html">User</a> block .user-block {</p>
...
<p>// Image sizes .img-sm, .img-md, .img-lg {</p>
...
<p>// Image bordered .img-bordered {</p>

<pre>border: 3px solid $gray-500;
padding: 3px;</pre>
...
<pre>border: 2px solid $gray-500;
padding: 2px;</pre>

<p>}</p>

<p>// Rounded and Circle Images .img-rounded {</p>

<pre>@include border-radius($border-radius)</pre>

<p>}</p>

<p>.img-circle {</p>

<pre>@include border-radius(50%);</pre>

<p>}</p>

<p>// Image sizes .img-size-64, .img-size-50, .img-size-32 {</p>
...
<p>// Block sizes .size-32, .size-40, .size-50 {</p>
...
<p>// General attachemnt block .attachment-block {</p>

<pre>border: 1px solid $card-border-color;
padding: 5px;
margin-bottom: 10px;
background: #f7f7f7;
