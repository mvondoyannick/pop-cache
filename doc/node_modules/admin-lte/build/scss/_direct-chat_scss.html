...
<title>_direct-chat.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_direct-chat.scss">
...
<p>//Direct chat contacts pane .direct-chat-contacts-open {</p>

<pre>.direct-chat-contacts {
  @include translate(0, 0);
}</pre>
...
<p>//Contacts list – for displaying contacts in direct chat contacts pane
.contacts-list {</p>

<pre>@extend .list-unstyled;
&gt; li {
  @include clearfix();
...
<pre>font-size: $font-size-sm;</pre>
...
<p>//Direct Chat Variants .direct-chat-danger {</p>

<pre>@include direct-chat-variant(theme-color(&quot;danger&quot;));</pre>

<p>}</p>

<p>.direct-chat-primary {</p>

<pre>@include direct-chat-variant(theme-color(&quot;primary&quot;));</pre>

<p>}</p>

<p>.direct-chat-warning {</p>

<pre>@include direct-chat-variant(theme-color(&quot;warning&quot;));</pre>

<p>}</p>

<p>.direct-chat-info {</p>

<pre>@include direct-chat-variant(theme-color(&quot;info&quot;));</pre>

<p>}</p>

<p>.direct-chat-success {</p>

<pre>@include direct-chat-variant(theme-color(&quot;success&quot;));</pre>
