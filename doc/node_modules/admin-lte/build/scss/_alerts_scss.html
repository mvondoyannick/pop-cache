...
<title>_alerts.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_alerts.scss">
...
<p>//Alert Variants .alert-success {</p>

<pre>@extend .bg-success;
border-color: darken(theme-color(&quot;success&quot;), 5%);</pre>

<p>}</p>

<p>.alert-danger, .alert-error {</p>

<pre>@extend .bg-danger;
border-color: darken(theme-color(&quot;danger&quot;), 5%);</pre>

<p>}</p>

<p>.alert-warning {</p>

<pre>@extend .bg-warning;
border-color: darken(theme-color(&quot;warning&quot;), 5%);</pre>
...
<pre>@extend .bg-info;
border-color: darken(theme-color(&quot;info&quot;), 5%);</pre>
