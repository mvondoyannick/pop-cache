...
<title>_mailbox.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/build/scss/_mailbox.scss">

<pre>Page: Mailbox
-------------</pre>

<p>.mailbox-messages {</p>
...
<pre>border-bottom: 1px solid $card-border-color;
padding: 10px;
h3 {
  font-size: 20px;
  margin: 0;
...
<p>.mailbox-attachment-close {</p>

<pre class="ruby"><span class="ruby-ivar">@extend</span> .<span class="ruby-identifier">close</span>;
</pre>
