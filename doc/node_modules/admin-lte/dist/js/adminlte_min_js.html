...
<title>adminlte.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/adminlte.min.js">

<pre>!
 AdminLTE v3.0.0-alpha.2 (https://adminlte.io)
 Copyright 2014-2018 Abdullah Almsaeed &lt;abdullah@almsaeedstudio.com&gt;
 Licensed under MIT (https://github.com/almasaeed2010/AdminLTE/blob/master/LICENSE)</pre>

<p>!function(e,t){“object”==typeof exports&amp;&amp;“undefined”!=typeof
module?t(exports):“function”==typeof <a
href=""exports"">define&&define.amd?define(</a>,t):t(e.adminlte={})}(this,function(e){“use
strict”;var
i,t,o,n,r,a,s,c,f,l,u,d,h,p,_,g,y,m,v,C,D,E,A,O,w,b,L,S,j,T,I,Q,R,P,x,B,M,k,H,N,Y,U,V,G,W,X,z,F,q,J,K,Z,$,ee,te,ne=“function”==typeof
...
e},ie=function(e,t){if(!(e instanceof t))throw new TypeError(“Cannot call a
class as a function”)},<a
href="t">oe=(i=jQuery,t=“ControlSidebar”,o=“lte.control.sidebar”,n=i.fn</a>,<a
href="data-widget="control-sidebar"">r=“.control-sidebar”,a=‘</a>&#39;,s=“.main-header”,c=“control-sidebar-open”,f=“control-sidebar-slide-open”,l={slide:!0},u=function(){function
n(e,t){ie(this,n),this._element=e,this._config=this._getConfig(t)}return
n.prototype.show=function(){this._config.slide?i(“body”).removeClass(f):i(“body”).removeClass©},n.prototype.collapse=function(){this._config.slide?i(“body”).addClass(f):i(“body”).addClass©},n.prototype.toggle=function(){this._setMargin(),i(“body”).hasClass©||i(“body”).hasClass(f)?this.show():this.collapse()},n.prototype._getConfig=function(e){return
i.extend({},l,e)},n.prototype._setMargin=function(){i®.css({top:i(s).outerHeight()})},n._jQueryInterface=function(t){return
this.each(function(){var e=i(this).data(o);if(e||(e=new <a
href="t">n(this,i(this).data()),i(this).data(o,e)),“undefined”===e</a>)throw
new Error(t+“ is not a <a
href="t">function”);e</a>()})},n}(),i(document).on(“click”,a,function(e){e.preventDefault(),u._jQueryInterface.call(i(this),“toggle”)}),<a
href="t">i.fn</a>=<a href="t">u._jQueryInterface,i.fn</a>.<a
href="t">Constructor=u,i.fn</a>.noConflict=function(){return <a
href="t">i.fn</a>=n,u._jQueryInterface},<a
href="h">u),re=(d=jQuery,h=“Layout”,p=“lte.layout”,_=d.fn</a>,g=“.main-sidebar”,y=“.main-header”,m=“.content-wrapper”,v=“.main-footer”,C=“hold-transition”,D=function(){function
n(e){ie(this,n),this._element=e,this._init()}return
n.prototype.fixLayoutHeight=function(){var
e={window:d(window).height(),header:d(y).outerHeight(),footer:d(v).outerHeight(),sidebar:d(g).height()},t=this._max(e);d(m).css(“min-height”,t-e.header),d(g).css(“min-height”,t-e.header)},n.prototype._init=function(){var
e=this;d(“body”).removeClass(C),this.fixLayoutHeight(),d(g).on(“collapsed.lte.treeview
expanded.lte.treeview collapsed.lte.pushmenu
expanded.lte.pushmenu”,function(){e.fixLayoutHeight()}),d(window).resize(function(){e.fixLayoutHeight()}),d(“body,
html”).css(“height”,“auto”)},n.prototype._max=function(t){var n=0;return
Object.keys(t).forEach(function(e){<a href="e">t</a>&gt;<a
href="e">n&&(n=t</a>)}),n},n._jQueryInterface=function(t){return
this.each(function(){var e=d(this).data(p);e||(e=new <a
href="t">n(this),d(this).data(p,e)),t&&e</a>()})},n}(),d(window).on(“load”,function(){D._jQueryInterface.call(d(“body”))}),<a
href="h">d.fn</a>=<a href="h">D._jQueryInterface,d.fn</a>.<a
href="h">Constructor=D,d.fn</a>.noConflict=function(){return <a
href="h">d.fn</a>=_,D._jQueryInterface},<a
href="A">D),ae=(E=jQuery,A=“PushMenu”,w=“.”+(O=“lte.pushmenu”),b=E.fn</a>,L={COLLAPSED:“collapsed”+w,SHOWN:“shown”+w},S={screenCollapseSize:768},j={<a
href="data-widget="pushmenu"">TOGGLE_BUTTON:’</a>&#39;,SIDEBAR_MINI:“.sidebar-mini”,SIDEBAR_COLLAPSED:“.sidebar-collapse”,BODY:“body”,OVERLAY:“#sidebar-overlay”,WRAPPER:“.wrapper”},T=“sidebar-collapse”,I=“sidebar-open”,Q=function(){function
n(e,t){ie(this,n),this._element=e,this._options=E.extend({},S,t),E(j.OVERLAY).length||this._addOverlay()}return
n.prototype.show=function(){E(j.BODY).addClass(I).removeClass(T);var
e=E.Event(L.SHOWN);E(this._element).trigger(e)},n.prototype.collapse=function(){E(j.BODY).removeClass(I).addClass(T);var
e=E.Event(L.COLLAPSED);E(this._element).trigger(e)},n.prototype.toggle=function(){(E(window).width()&gt;=this._options.screenCollapseSize?!E(j.BODY).hasClass(T):E(j.BODY).hasClass(I))?this.collapse():this.show()},n.prototype._addOverlay=function(){var
e=this,t=E(“&lt;div
/&gt;”,{id:“sidebar-overlay”});t.on(“click”,function(){e.collapse()}),E(j.WRAPPER).append(t)},n._jQueryInterface=function(t){return
this.each(function(){var e=E(this).data(O);e||(e=new <a
href="t">n(this),E(this).data(O,e)),t&&e</a>()})},n}(),E(document).on(“click”,j.TOGGLE_BUTTON,function(e){e.preventDefault();var
t=e.currentTarget;“pushmenu”!==E(t).data(“widget”)&amp;&amp;(t=E(t).closest(j.TOGGLE_BUTTON)),Q._jQueryInterface.call(E(t),“toggle”)}),<a
href="A">E.fn</a>=<a href="A">Q._jQueryInterface,E.fn</a>.<a
href="A">Constructor=Q,E.fn</a>.noConflict=function(){return <a
href="A">E.fn</a>=b,Q._jQueryInterface},<a
href="P">Q),se=(R=jQuery,P=“Treeview”,B=“.”+(x=“lte.treeview”),M=R.fn</a>,k={SELECTED:“selected”+B,EXPANDED:“expanded”+B,COLLAPSED:“collapsed”+B,LOAD_DATA_API:“load”+B},H=“.nav-item”,N=“.nav-treeview”,Y=“.menu-open”,V=“menu-open”,G={<a
href="data-widget="treeview"">trigger:(U=‘</a>&#39;)+“
”+“.nav-link”,animationSpeed:300,accordion:!0},W=function(){function
i(e,t){ie(this,i),this._config=t,this._element=e}return
i.prototype.init=function(){this._setupListeners()},i.prototype.expand=function(e,t){var
n=this,i=R.Event(k.EXPANDED);if(this._config.accordion){var
o=t.siblings(Y).first(),r=o.find(N).first();this.collapse(r,o)}e.slideDown(this._config.animationSpeed,function(){t.addClass(V),R(n._element).trigger(i)})},i.prototype.collapse=function(e,t){var
n=this,i=R.Event(k.COLLAPSED);e.slideUp(this._config.animationSpeed,function(){t.removeClass(V),R(n._element).trigger(i),e.find(Y+“
&gt;
”+N).slideUp(),e.find(Y).removeClass(V)})},i.prototype.toggle=function(e){var
t=R(e.currentTarget),n=t.next();if(n.is(N)){e.preventDefault();var
i=t.parents(H).first();i.hasClass(V)?this.collapse(R(n),i):this.expand(R(n),i)}},i.prototype._setupListeners=function(){var
t=this;R(document).on(“click”,this._config.trigger,function(e){t.toggle(e)})},i._jQueryInterface=function(n){return
this.each(function(){var
e=R(this).data(x),t=R.extend({},G,R(this).data());e||(e=new <a
href="n">i(R(this),t),R(this).data(x,e)),“init”===n&&e</a>()})},i}(),R(window).on(k.LOAD_DATA_API,function(){R(U).each(function(){W._jQueryInterface.call(R(this),“init”)})}),<a
href="P">R.fn</a>=<a href="P">W._jQueryInterface,R.fn</a>.<a
href="P">Constructor=W,R.fn</a>.noConflict=function(){return <a
href="P">R.fn</a>=M,W._jQueryInterface},<a
href="z">W),ce=(X=jQuery,z=“Widget”,q=“.”+(F=“lte.widget”),J=X.fn</a>,K={EXPANDED:“expanded”+q,COLLAPSED:“collapsed”+q,REMOVED:“removed”+q},$=“collapsed-card”,ee={animationSpeed:“normal”,collapseTrigger:(Z={<a
href="data-widget="remove"">DATA_REMOVE:’</a>&#39;,<a
href="data-widget="collapse"">DATA_COLLAPSE:‘</a>&#39;,CARD:“.card”,CARD_HEADER:“.card-header”,CARD_BODY:“.card-body”,CARD_FOOTER:“.card-footer”,COLLAPSED:“.collapsed-card”}).DATA_COLLAPSE,removeTrigger:Z.DATA_REMOVE},te=function(){function
n(e,t){ie(this,n),this._element=e,this._parent=e.parents(Z.CARD).first(),this._settings=X.extend({},ee,t)}return
n.prototype.collapse=function(){var
e=this;this._parent.children(Z.CARD_BODY+“,
”+Z.CARD_FOOTER).slideUp(this._settings.animationSpeed,function(){e._parent.addClass($)});var
t=X.Event(K.COLLAPSED);this._element.trigger(t,this._parent)},n.prototype.expand=function(){var
e=this;this._parent.children(Z.CARD_BODY+“,
”+Z.CARD_FOOTER).slideDown(this._settings.animationSpeed,function(){e._parent.removeClass($)});var
t=X.Event(K.EXPANDED);this._element.trigger(t,this._parent)},n.prototype.remove=function(){this._parent.slideUp();var
e=X.Event(K.REMOVED);this._element.trigger(e,this._parent)},n.prototype.toggle=function(){this._parent.hasClass($)?this.expand():this.collapse()},n.prototype._init=function(e){var
t=this;this._parent=e,X(this).find(this._settings.collapseTrigger).click(function(){t.toggle()}),X(this).find(this._settings.removeTrigger).click(function(){t.remove()})},n._jQueryInterface=function(t){return
this.each(function(){var e=X(this).data(F);e||(e=new
n(X(this),e),X(this).data(F,“string”==typeof t?e:t)),“string”==typeof <a
href="t">t&&t.match(/remove|toggle/)?e</a>():“object”===(“undefined”==typeof
t?“undefined”:ne(t))&amp;&amp;e._init(X(this))})},n}(),X(document).on(“click”,Z.DATA_COLLAPSE,function(e){e&amp;&amp;e.preventDefault(),te._jQueryInterface.call(X(this),“toggle”)}),X(document).on(“click”,Z.DATA_REMOVE,function(e){e&amp;&amp;e.preventDefault(),te._jQueryInterface.call(X(this),“remove”)}),<a
href="z">X.fn</a>=<a href="z">te._jQueryInterface,X.fn</a>.<a
href="z">Constructor=te,X.fn</a>.noConflict=function(){return <a
href="z">X.fn</a>=J,te._jQueryInterface},te);e.ControlSidebar=oe,e.Layout=re,e.PushMenu=ae,e.Treeview=se,e.Widget=ce,Object.defineProperty(e,“__esModule”,{value:!0})});
//# sourceMappingURL=adminlte.min.js.map</p>
</main>
