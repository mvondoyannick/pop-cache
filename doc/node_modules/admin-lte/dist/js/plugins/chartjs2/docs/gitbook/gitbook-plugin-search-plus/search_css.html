...
<title>search.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/gitbook/gitbook-plugin-search-plus/search.css">

<pre>This CSS only styled the search results section, not the search input
It defines the basic interraction to hide content when displaying results, etc</pre>

<p>book-search-input {</p>

<pre>background: inherit;</pre>

<p>} book-search-results .search-results {</p>

<pre>display: none;</pre>

<p>} book-search-results .search-results ul.search-results-list {</p>

<pre>list-style-type: none;
padding-left: 0;</pre>

<p>} book-search-results .search-results ul.search-results-list li {</p>

<pre>margin-bottom: 1.5rem;
padding-bottom: 0.5rem;
   Highlight results</pre>

<p>} book-search-results .search-results ul.search-results-list li p em {</p>

<pre>background-color: rgba(255, 220, 0, 0.4);
font-style: normal;</pre>

<p>} book-search-results .search-results .no-results {</p>

<pre>display: none;</pre>

<p>} book-search-results.open .search-results {</p>

<pre>display: block;</pre>

<p>} book-search-results.open .search-noresults {</p>

<pre>display: none;</pre>

<p>} book-search-results.no-results .search-results .has-results {</p>

<pre>display: none;</pre>

<p>} book-search-results.no-results .search-results .no-results {</p>

<pre>display: block;</pre>

<p>} book-search-results span.search-highlight-keyword {</p>

<pre>background: #ff0;</pre>

<p>} book-search-results.search-plus .search-results .has-results
