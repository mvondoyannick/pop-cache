...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/getting-started/installation.html">
...
href=“../developers/contributing.html#building-chartjs”&gt;build&lt;/a&gt;
...
&lt;p&gt;Chart.js provides two different builds that are available for your
use.&lt;/p&gt; &lt;h2 id=“stand-alone-build”&gt;Stand-Alone
Build&lt;/h2&gt; &lt;p&gt;Files:&lt;/p&gt; &lt;ul&gt;
&lt;li&gt;<code>dist/Chart.js</code>&lt;/li&gt;
&lt;li&gt;<code>dist/Chart.min.js</code>&lt;/li&gt; &lt;/ul&gt;
&lt;p&gt;This version only includes Chart.js. If this version is used and
you require the use of the time axis, &lt;a href=“<a
href="http://momentjs.com">momentjs.com</a>/”
target=“_blank”&gt;Moment.js&lt;/a&gt; will need to be included before
Chart.js.&lt;/p&gt; &lt;h2 id=“bundled-build”&gt;Bundled Build&lt;/h2&gt;
&lt;p&gt;Files:&lt;/p&gt; &lt;ul&gt;
&lt;li&gt;<code>dist/Chart.bundle.js</code>&lt;/li&gt;
&lt;li&gt;<code>dist/Chart.bundle.min.js</code>&lt;/li&gt; &lt;/ul&gt;
&lt;p&gt;The bundled version includes Moment.js built into the same file.
This version should be used if you wish to use time axes and want a single
file to include. Do not use this build if your application already includes
Moment.js. If you do, Moment.js will be included twice, increasing the page
load time and potentially introducing version issues.&lt;/p&gt;</p>
