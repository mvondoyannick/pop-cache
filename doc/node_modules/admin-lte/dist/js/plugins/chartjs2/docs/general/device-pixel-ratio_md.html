...
<title>device-pixel-ratio - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Device+Pixel+Ratio">Device Pixel Ratio</a>
...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/general/device-pixel-ratio.md">

<h1 id="label-Device+Pixel+Ratio">Device Pixel Ratio<span><a href="#label-Device+Pixel+Ratio">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>By default the chart&#39;s canvas will use a 1:1 pixel ratio, unless the
physical display has a higher pixel ratio (e.g. Retina displays).</p>

<p>For applications where a chart will be converted to a bitmap, or printed to
a higher DPI medium it can be desirable to render the chart at a higher
resolution than the default.</p>

<p>Setting <code>devicePixelRatio</code> to a value other than 1 will force
the canvas size to be scaled by that amount, relative to the container
size. There should be no visible difference on screen; the difference will
only be visible when the image is zoomed or printed.</p>
...
<code>devicePixelRatio</code> | <code>Number</code> |
window.devicePixelRatio | Override the window&#39;s default
devicePixelRatio.</p>
</main>
