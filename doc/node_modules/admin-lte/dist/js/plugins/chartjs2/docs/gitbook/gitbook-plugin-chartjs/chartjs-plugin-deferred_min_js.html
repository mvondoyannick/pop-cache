...
<title>chartjs-plugin-deferred.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/gitbook/gitbook-plugin-chartjs/chartjs-plugin-deferred.min.js">
...
<pre>!
 ...
 https://github.com/chartjs/chartjs-plugin-deferred/blob/master/LICENSE.md</pre>

<p>“use strict”;!function(){function e(e,t){var n=parseInt(e,10);return
isNaN(n)?0:“string”==typeof
e&amp;&amp;e.indexOf(“%”)!==-1?n/100*t:n}function t(t){var <a
href="s">n=t</a>,r=t.chart.canvas;if(null===r.offsetParent)return!1;var
a=r.getBoundingClientRect(),f=e(n.yOffset||0,a.height),d=e(n.xOffset||0,a.width);return
a.right-d&gt;=0&amp;&amp;a.bottom-f&gt;=0&amp;&amp;a.left+d&lt;=window.innerWidth&amp;&amp;a.top+f&lt;=window.innerHeight}function
n(e){var
t=l.Deferred.defaults,n=e.options.deferred,r=o.getValueOrDefault;return
void 0===n?n={}:“boolean”==typeof
n&amp;&amp;(n={enabled:n}),{enabled:r(n.enabled,t.enabled),xOffset:r(n.xOffset,t.xOffset),yOffset:r(n.yOffset,t.yOffset),delay:r(n.delay,t.delay),appeared:!1,delayed:!1,loaded:!1,elements:[]}}function
r(e){var <a
href="i">n=e.target,r=n</a>;r.ticking||(r.ticking=!0,l.platform.defer(function(){var
<a href="n">e,n,a=r.instances.slice(),f=a.length;for(n=0;n<f;++n)e=a</a>,<a
href="s">t(e)&&(d(e),e</a>.appeared=!0,e.update());r.ticking=!1}))}function
a(e){var t=e.nodeType;if(t===Node.ELEMENT_NODE){var
n=o.getStyle(e,“overflow-x”),r=o.getStyle(e,“overflow-y”);return“auto”===n||“scroll”===n||“auto”===r||“scroll”===r}return
e.nodeType===Node.DOCUMENT_NODE}function f(e){for(var <a
href="i">t,n,f=e.chart.canvas,d=f.parentElement;d;)a(d)&&(t=d</a>||(<a
href="i">d</a>={}),<a
href="s">n=t.instances||(t.instances=[]),0===n.length&&d.addEventListener(“scroll”,r,{passive:!0}),n.push(e),e</a>.elements.push(d)),d=d.parentElement||d.ownerDocument}function
d(e){<a href="s">e</a>.elements.forEach(function(t){var <a
href="i">n=t</a>.instances;n.splice(n.indexOf(e),1),n.length||(o.removeEvent(t,“scroll”,r),delete
<a href="i">t</a>)}),<a href="s">e</a>.elements=[]}var
l=window.Chart,o=l.helpers,i=“_chartjs_deferred”,s=“_deferred_model”;l.Deferred=l.Deferred||{},l.Deferred.defaults={enabled:!0,xOffset:0,yOffset:0,delay:0},l.platform=o.extend(l.platform||{},{defer:function(e,t,n){var
r=function(){e.call(n)};t?window.setTimeout(r,t):o.requestAnimFrame.call(window,r)}}),l.plugins.register({beforeInit:function(e){var
<a
href="s">t=e</a>=n(e);t.enabled&amp;&amp;f(e)},beforeDatasetsUpdate:function(e){var
<a
href="s">n=e</a>;if(!n.enabled)return!0;if(!n.loaded){if(!n.appeared&amp;&amp;!t(e))return!1;if(n.appeared=!0,n.loaded=!0,d(e),n.delay&gt;0)return
n.delayed=!0,l.platform.defer(function(){n.delayed=!1,e.update()},n.delay),!1}return!n.delayed&amp;&amp;void
0}})}();</p>
</main>
