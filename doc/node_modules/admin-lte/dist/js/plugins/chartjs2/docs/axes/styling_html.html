...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/axes/styling.html">
...
be shifted to be between labels. This is set to <code>true</code> in the
bar chart by default.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt; &lt;/table&gt;
&lt;h2 id=“tick-configuration”&gt;Tick Configuration&lt;/h2&gt;
&lt;p&gt;The tick configuration is nested under the scale configuration in
the <code>ticks</code> key. It defines options for the tick marks that are
generated by the axis.&lt;/p&gt; &lt;table&gt; &lt;thead&gt; &lt;tr&gt;
...
Ommited options are inherited from options above.&lt;/td&gt; &lt;/tr&gt;
