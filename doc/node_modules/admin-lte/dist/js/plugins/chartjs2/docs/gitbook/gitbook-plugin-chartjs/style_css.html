...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/gitbook/gitbook-plugin-chartjs/style.css">

<p>.chartjs-wrapper canvas {</p>

<pre>-webkit-user-select: none;
