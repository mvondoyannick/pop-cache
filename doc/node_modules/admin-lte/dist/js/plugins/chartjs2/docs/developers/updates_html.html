...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/developers/updates.html">
...
they&amp;apos;ve been created. When the chart data is changed, Chart.js
will animate to the new data values. &lt;/p&gt; &lt;h2
...
<p>} &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“preventing-animations”&gt;Preventing
Animations&lt;/h2&gt; &lt;p&gt;Sometimes when a chart updates, you may not
want an animation. To achieve this you can call <code>update</code> with a
duration of <code>0</code>. This will render the chart synchronously and
without an animation.&lt;/p&gt;</p>
