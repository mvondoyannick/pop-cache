...
<title>jquery.mark.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/gitbook/gitbook-plugin-search-plus/jquery.mark.min.js">

<pre>!***************************************************
 mark.js v8.8.0
 https://github.com/julmot/mark.js
 Copyright (c) 2014–2017, Julian Motz
 Released under the MIT license https://git.io/vwTVl</pre>

<p>“use strict”;function _classCallCheck(a,b){if(!(a instanceof b))throw new
TypeError(“Cannot call a class as a function”)}var
_extends=Object.assign||function(a){for(var
b=1;b&lt;arguments.length;b++){var <a href="b">c=arguments</a>;for(var d in
<a href="d">c)Object.prototype.hasOwnProperty.call(c,d)&&(a</a>=<a
href="d">c</a>)}return a},_createClass=function(){function a(a,b){for(var
c=0;c&lt;b.length;c++){var <a
href="c">d=b</a>;d.enumerable=d.enumerable||!1,d.configurable=!0,“value”in
d&amp;&amp;(d.writable=!0),Object.defineProperty(a,d.key,d)}}return
function(b,c,d){return
c&amp;&amp;a(b.prototype,c),d&amp;&amp;a(b,d),b}}(),_typeof=“function”==typeof
Symbol&amp;&amp;“symbol”==typeof Symbol.iterator?function(a){return typeof
a}:function(a){return a&amp;&amp;“function”==typeof
Symbol&amp;&amp;a.constructor===Symbol&amp;&amp;a!==Symbol.prototype?“symbol”:typeof
a};!function(a,b,c){“function”==typeof <a
href=""jquery"">define&&define.amd?define(</a>,function(d){return
a(b,c,d)}):“object”===(“undefined”==typeof
module?“undefined”:_typeof(module))&amp;&amp;module.exports?module.exports=a(b,c,require(“jquery”)):a(b,c,jQuery)}(function(a,b,c){var
d=function(){function
c(b){_classCallCheck(this,c),this.ctx=b,this.ie=!1;var
d=a.navigator.userAgent;(d.indexOf(“MSIE”)&gt;-1||d.indexOf(“Trident”)&gt;-1)&amp;&amp;(this.ie=!0)}return
_createClass(c,[{key:“log”,value:function a(b){var
c=arguments.length&gt;1&amp;&amp;void <a href="1">0!==arguments</a>?<a
href="1">arguments</a>:“debug”,a=this.opt.log;this.opt.debug&amp;&amp;“object”===(“undefined”==typeof
a?“undefined”:_typeof(a))&amp;&amp;“function”==typeof <a
href="c">a</a>&amp;&amp;<a href="c">a</a>(“mark.js:
”+b)}},{key:“escapeStr”,value:function(a){return <a
href="\">a.replace(/[-</a>/{}()*+?.\^$|]/g,“\$&amp;”)}},{key:“createRegExp”,value:function(a){return
a=this.escapeStr(a),Object.keys(this.opt.synonyms).length&amp;&amp;(a=this.createSynonymsRegExp(a)),this.opt.ignoreJoiners&amp;&amp;(a=this.setupIgnoreJoinersRegExp(a)),this.opt.diacritics&amp;&amp;(a=this.createDiacriticsRegExp(a)),a=this.createMergedBlanksRegExp(a),this.opt.ignoreJoiners&amp;&amp;(a=this.createIgnoreJoinersRegExp(a)),a=this.createAccuracyRegExp(a)}},{key:“createSynonymsRegExp”,value:function(a){var
b=this.opt.synonyms,c=this.opt.caseSensitive?“”:“i”;for(var d in
b)if(b.hasOwnProperty(d)){var <a
href="d">e=b</a>,f=this.escapeStr(d),g=this.escapeStr(e);a=a.replace(new
RegExp(“(”<code>f</code>“|”<code>g</code>“)”,“gm”+c),“(”<code>f</code>“|”<code>g</code>“)”)}return
a}},{key:“setupIgnoreJoinersRegExp”,value:function(a){return <a
href="^(|)\\">a.replace(/</a>/g,function(a,b,c){var <a
href="(|)\\">d=c.charAt(b+1);return/</a>/.test(d)||“”===d?a:a+“0”})}},{key:“createIgnoreJoinersRegExp”,value:function(a){return
<a
href="\\u00ad|\\u200b|\\u200c|\\u200d">a.split(“0”).join(“</a>?”)}},{key:“createDiacriticsRegExp”,value:function(a){var
<a
href=""aàáâãäåāąă","AÀÁÂÃÄÅĀĄĂ","cçćč","CÇĆČ","dđď","DĐĎ","eèéêëěēę","EÈÉÊËĚĒĘ","iìíîïī","IÌÍÎÏĪ","lł","LŁ","nñňń","NÑŇŃ","oòóôõöøō","OÒÓÔÕÖØŌ","rř","RŘ","sšśșş","SŠŚȘŞ","tťțţ","TŤȚŢ","uùúûüůū","UÙÚÛÜŮŪ","yÿý","YŸÝ","zžżź","ZŽŻŹ"">b=this.opt.caseSensitive?“”:“i”,c=this.opt.caseSensitive?</a>:[“aÀÁÂÃÄÅàáâãäåĀāąĄăĂ”,“cÇçćĆčČ”,“dđĐďĎ”,“eÈÉÊËèéêëěĚĒēęĘ”,“iÌÍÎÏìíîïĪī”,“lłŁ”,“nÑñňŇńŃ”,“oÒÓÔÕÖØòóôõöøŌō”,“rřŘ”,“sŠšśŚșȘşŞ”,“tťŤțȚţŢ”,“uÙÚÛÜùúûüůŮŪū”,“yŸÿýÝ”,“zŽžżŻźŹ”],d=[];return
a.split(“”).forEach(function(e){c.every(function©{if(c.indexOf(e)!==-1){if(d.indexOf©&gt;-1)return!1;a=a.replace(new
<a href=""c"">RegExp(“</a>”,“<a
href=""c"">gm”+b),“</a>”),d.push©}return!0})}),a}},{key:“createMergedBlanksRegExp”,value:function(a){return
<a href="\s">a.replace(/</a>+/<a
href="\\s">gim,“</a>+”)}},{key:“createAccuracyRegExp”,value:function(a){var
b=this,c=this.opt.accuracy,d=“string”==typeof
c?c:c.value,e=“string”==typeof <a
href="^\\s"f"">c?[]:c.limiters,f=“”;switch(e.forEach(function(a){f+=“|”+b.escapeStr(a)}),d){case“partially”:default:return“()(”a“)”;case“complementary”:return“()(</a>*”<code>a"[^\s"f"]</code>*)“;case”exactly“:return”(^|\s“<code>f</code>”)(“<code>a</code>”)(?=$|\s“<code>f</code>”)“}}},{key:”getSeparatedKeywords“,value:function(a){var
b=this,c=[];return a.forEach(function(a){b.opt.separateWordSearch?a.split(”
“).forEach(function(a){a.trim()&amp;&amp;c.indexOf(a)===-1&amp;&amp;c.push(a)}):a.trim()&amp;&amp;c.indexOf(a)===-1&amp;&amp;c.push(a)}),{keywords:c.sort(function(a,b){return
b.length-a.length}),length:c.length}}},{key:”getTextNodes“,value:function(a){var
b=this,c=”“,d=[];this.iterator.forEachNode(NodeFilter.SHOW_TEXT,function(a){d.push({start:c.length,end:(c+=a.textContent).length,node:a})},function(a){return
b.matchesExclude(a.parentNode)?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT},function(){a({value:c,nodes:d})})}},{key:”matchesExclude“,value:function(a){return
<a
href=""script","style","title","head","html"">e.matches(a,this.opt.exclude.concat(</a>))}},{key:”wrapRangeInTextNode“,value:function(a,c,d){var
e=this.opt.element?this.opt.element:”mark“,f=a.splitText©,g=f.splitText(d-c),h=b.createElement(e);return
h.setAttribute(”data-markjs“,”true“),this.opt.className&amp;&amp;h.setAttribute(”class“,this.opt.className),h.textContent=f.textContent,f.parentNode.replaceChild(h,f),g}},{key:”wrapRangeInMappedTextNode“,value:function(a,b,c,d,e){var
f=this;a.nodes.every(function(g,h){var <a
href="h+1">i=a.nodes</a>;if(”undefined“==typeof i||i.start&gt;b){var
j=function(){if(!d(g.node))return{v:!1};var
i=b-g.start,j=(c&gt;g.end?g.end:c)-g.start,k=a.value.substr(0,g.start),l=a.value.substr(j+g.start);return
g.node=f.wrapRangeInTextNode(g.node,i,j),a.value=k+l,a.nodes.forEach(function(b,c){<a
href="c">c>=h&&(a.nodes</a>.<a href="c">start>0&&c!==h&&(a.nodes</a>.<a
href="c">start-=j),a.nodes</a>.end-=j)}),c-=j,e(g.node.previousSibling,g.start),c&gt;g.end?void(b=g.end):{v:!1}}();if(”object“===(”undefined“==typeof
j?”undefined“:_typeof(j)))return
j.v}return!0})}},{key:”wrapMatches“,value:function(a,b,c,d,e){var
f=this,g=0===b?0:b+1;this.getTextNodes(function(b){b.nodes.forEach(function(b){b=b.node;for(var
e=void <a href="g">0;null!==(e=a.exec(b.textContent))&&”“!==e</a>;)<a
href="g">if(c(e</a>,b)){var h=e.index;if(0!==g)for(var <a
href="i">i=1;i<g;i++)h+=e</a>.<a
href="g">length;b=f.wrapRangeInTextNode(b,h,h+e</a>.length),d(b.previousSibling),a.lastIndex=0}}),e()})}},{key:”wrapMatchesAcrossElements“,value:function(a,b,c,d,e){var
f=this,g=0===b?0:b+1;this.getTextNodes(function(b){for(var h=void <a
href="g">0;null!==(h=a.exec(b.value))&&”“!==h</a>;){var
i=h.index;if(0!==g)for(var <a href="j">j=1;j<g;j++)i+=h</a>.length;var <a
href="g">k=i+h</a>.length;f.wrapRangeInMappedTextNode(b,i,k,function(a){return
<a
href="g">c(h</a>,a)},function(b,c){a.lastIndex=c,d(b)})}e()})}},{key:”unwrapMatches“,value:function(a){for(var
c=a.parentNode,d=b.createDocumentFragment();a.firstChild;)d.appendChild(a.removeChild(a.firstChild));c.replaceChild(d,a),this.ie?this.normalizeTextNode©:c.normalize()}},{key:”normalizeTextNode“,value:function(a){if(a){if(3===a.nodeType)for(;a.nextSibling&amp;&amp;3===a.nextSibling.nodeType;)a.nodeValue+=a.nextSibling.nodeValue,a.parentNode.removeChild(a.nextSibling);else
this.normalizeTextNode(a.firstChild);this.normalizeTextNode(a.nextSibling)}}},{key:”markRegExp“,value:function(a,b){var
c=this;this.opt=b,this.log(&#39;Searching with expression
”&#39;<code>a</code>&#39;“&#39;);var
d=0,e=”wrapMatches“,f=function(a){d++,c.opt.each(a)};<a
href="e">this.opt.acrossElements&&(e=”wrapMatchesAcrossElements“),this</a>(a,this.opt.ignoreGroups,function(a,b){return
c.opt.filter(b,a,d)},f,function(){0===d&amp;&amp;c.opt.noMatch(a),c.opt.done(d)})}},{key:”mark“,value:function(a,b){var
c=this;this.opt=b;var
d=0,e=”wrapMatches“,f=this.getSeparatedKeywords(”string“==typeof <a
href="a">a?</a>:a),g=f.keywords,h=f.length,i=this.opt.caseSensitive?”“:”i“,j=function
a(b){var f=new RegExp(c.createRegExp(b),”gm“+i),j=0;c.log(&#39;Searching
with expression ”&#39;<code>f'"'),c[e]</code>(f,1,function(a,e){return
c.opt.filter(e,b,d,j)},function(a){j++,d++,c.opt.each(a)},function(){<a
href="h-1">0===j&&c.opt.noMatch(b),g</a>===<a
href="g.indexOf(b)+1">b?c.opt.done(d):a(g</a>)})};<a
href="0">this.opt.acrossElements&&(e=“wrapMatchesAcrossElements”),0===h?this.opt.done(d):j(g</a>)}},{key:“unmark”,value:function(a){var
b=this;this.opt=a;var <a
href="data-markjs">c=this.opt.element?this.opt.element:“*”;c+=“</a>”,this.opt.className&amp;&amp;(c+=“.”+this.opt.className),this.log(&#39;Removal
selector
“&#39;<code>c</code>&#39;”&#39;),this.iterator.forEachNode(NodeFilter.SHOW_ELEMENT,function(a){b.unwrapMatches(a)},function(a){var
d=e.matches(a,c),f=b.matchesExclude(a);return!d||f?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT},this.opt.done)}},{key:“opt”,set:function(b){this._opt=_extends({},{element:“”,className:“”,exclude:[],iframes:!1,iframesTimeout:5e3,separateWordSearch:!0,diacritics:!0,synonyms:{},accuracy:“partially”,acrossElements:!1,caseSensitive:!1,ignoreJoiners:!1,ignoreGroups:0,each:function(){},noMatch:function(){},filter:function(){return!0},done:function(){},debug:!1,log:a.console},b)},get:function(){return
this._opt}},{key:“iterator”,get:function(){return
this._iterator||(this._iterator=new
e(this.ctx,this.opt.iframes,this.opt.exclude,this.opt.iframesTimeout)),this._iterator}}]),c}(),e=function(){function
a(b){var c=!(arguments.length&gt;1&amp;&amp;void <a
href="1">0!==arguments</a>)||<a
href="1">arguments</a>,d=arguments.length&gt;2&amp;&amp;void <a
href="2">0!==arguments</a>?<a
href="2">arguments</a>:[],e=arguments.length&gt;3&amp;&amp;void <a
href="3">0!==arguments</a>?<a
href="3">arguments</a>:5e3;_classCallCheck(this,a),this.ctx=b,this.iframes=c,this.exclude=d,this.iframesTimeout=e}return
_createClass(a,[{key:“getContexts”,value:function(){var a=void
0,c=[];return a=“undefined”!=typeof
this.ctx&amp;&amp;this.ctx?NodeList.prototype.isPrototypeOf(this.ctx)?Array.prototype.slice.call(this.ctx):Array.isArray(this.ctx)?this.ctx:“string”==typeof
<a
href="this.ctx">this.ctx?Array.prototype.slice.call(b.querySelectorAll(this.ctx)):</a>:[],a.forEach(function(a){var
b=c.filter(function(b){return
b.contains(a)}).length&gt;0;c.indexOf(a)!==-1||b||c.push(a)}),c}},{key:“getIframeContents”,value:function(a,b){var
c=arguments.length&gt;2&amp;&amp;void <a href="2">0!==arguments</a>?<a
href="2">arguments</a>:function(){},d=void 0;try{var
e=a.contentWindow;if(d=e.document,!e||!d)throw new Error(“iframe
inaccessible”)}catch(a){c()}d&amp;&amp;b(d)}},{key:“isIframeBlank”,value:function(a){var
b=“about:blank”,c=a.getAttribute(“src”).trim(),d=a.contentWindow.location.href;return
d===b&amp;&amp;c!==b&amp;&amp;c}},{key:“observeIframeLoad”,value:function(a,b,c){var
d=this,e=!1,f=null,g=function
g(){if(!e){e=!0,clearTimeout(f);try{d.isIframeBlank(a)||(a.removeEventListener(“load”,g),d.getIframeContents(a,b,c))}catch(a){c()}}};a.addEventListener(“load”,g),f=setTimeout(g,this.iframesTimeout)}},{key:“onIframeReady”,value:function(a,b,c){try{“complete”===a.contentWindow.document.readyState?this.isIframeBlank(a)?this.observeIframeLoad(a,b,c):this.getIframeContents(a,b,c):this.observeIframeLoad(a,b,c)}catch(a){c()}}},{key:“waitForIframes”,value:function(a,b){var
c=this,d=0;this.forEachIframe(a,function(){return!0},function(a){d++,c.waitForIframes(a.querySelector(“html”),function(){–d||b()})},function(a){a||b()})}},{key:“forEachIframe”,value:function(b,c,d){var
e=this,f=arguments.length&gt;3&amp;&amp;void <a
href="3">0!==arguments</a>?<a
href="3">arguments</a>:function(){},g=b.querySelectorAll(“iframe”),h=g.length,i=0;g=Array.prototype.slice.call(g);var
j=function(){–h&lt;=0&amp;&amp;f(i)};h||j(),g.forEach(function(b){a.matches(b,e.exclude)?j():e.onIframeReady(b,function(a){c(b)&amp;&amp;(i++,d(a)),j()},j)})}},{key:“createIterator”,value:function(a,c,d){return
b.createNodeIterator(a,c,d,!1)}},{key:“createInstanceOnIframe”,value:function(b){return
new
a(b.querySelector(“html”),this.iframes)}},{key:“compareNodeIframe”,value:function(a,b,c){var
d=a.compareDocumentPosition©,e=Node.DOCUMENT_POSITION_PRECEDING;if(d&amp;e){if(null===b)return!0;var
f=b.compareDocumentPosition©,g=Node.DOCUMENT_POSITION_FOLLOWING;if(f&amp;g)return!0}return!1}},{key:“getIteratorNode”,value:function(a){var
b=a.previousNode(),c=void 0;return
c=null===b?a.nextNode():a.nextNode()&amp;&amp;a.nextNode(),{prevNode:b,node:c}}},{key:“checkIframeFilter”,value:function(a,b,c,d){var
e=!1,f=!1;return
d.forEach(function(a,b){a.val===c&amp;&amp;(e=b,f=a.handled)}),<a
href="e">this.compareNodeIframe(a,b,c)?(e!==!1||f?e===!1||f||(d</a>.handled=!0):d.push({val:c,handled:!0}),!0):(e===!1&amp;&amp;d.push({val:c,handled:!1}),!1)}},{key:“handleOpenIframes”,value:function(a,b,c,d){var
e=this;a.forEach(function(a){a.handled||e.getIframeContents(a.val,function(a){e.createInstanceOnIframe(a).forEachNode(b,c,d)})})}},{key:“iterateThroughNodes”,value:function(a,b,c,d,e){for(var
<a href="">f=this,g=this.createIterator(b,a,d),h=[],i=</a>,j=void 0,k=void
0,l=function(){var a=f.getIteratorNode(g);return
k=a.prevNode,j=a.node};l();)this.iframes&amp;&amp;this.forEachIframe(b,function(a){return
f.checkIframeFilter(j,k,a,h)},function(b){f.createInstanceOnIframe(b).forEachNode(a,c,d)}),i.push(j);i.forEach(function(a){c(a)}),this.iframes&amp;&amp;this.handleOpenIframes(h,a,c,d),e()}},{key:“forEachNode”,value:function(a,b,c){var
d=this,e=arguments.length&gt;3&amp;&amp;void <a
href="3">0!==arguments</a>?<a
href="3">arguments</a>:function(){},f=this.getContexts(),g=f.length;g||e(),f.forEach(function(f){var
h=function(){d.iterateThroughNodes(a,f,b,c,function(){–g&lt;=0&amp;&amp;e()})};d.iframes?d.waitForIframes(f,h):h()})}}],[{key:“matches”,value:function(a,b){var
c=“string”==typeof <a
href="b">b?</a>:b,d=a.matches||a.matchesSelector||a.msMatchesSelector||a.mozMatchesSelector||a.oMatchesSelector||a.webkitMatchesSelector;if(d){var
e=!1;return
c.every(function(b){return!d.call(a,b)||(e=!0,!1)}),e}return!1}}]),a}();return
c.fn.mark=function(a,b){return new
d(this.get()).mark(a,b),this},c.fn.markRegExp=function(a,b){return new
d(this.get()).markRegExp(a,b),this},c.fn.unmark=function(a){return new
d(this.get()).unmark(a),this},c},window,document);</p>
</main>
