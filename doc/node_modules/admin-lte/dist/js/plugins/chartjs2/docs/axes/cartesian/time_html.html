...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/axes/cartesian/time.html">
...
<code>t</code> attribute when using the time scale.&lt;/p&gt;
&lt;pre&gt;&lt;code&gt;data: [{</p>
...
custom format to be used by moment to parse the date. &lt;/p&gt;
&lt;p&gt;If this is a function, it must return a moment.js object given the
appropriate data value.&lt;/p&gt;</p>
