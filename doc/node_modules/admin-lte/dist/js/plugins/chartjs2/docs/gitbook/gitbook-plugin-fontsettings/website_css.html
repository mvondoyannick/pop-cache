...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/plugins/chartjs2/docs/gitbook/gitbook-plugin-fontsettings/website.css">

<pre class="ruby"><span class="ruby-constant">Theme</span> <span class="ruby-value">1</span>
</pre>

<p>.color-theme-1 .dropdown-menu {</p>

<pre>background-color: #111111;
border-color: #7e888b;</pre>

<p>} .color-theme-1 .dropdown-menu .dropdown-caret .caret-inner {</p>

<pre>border-bottom: 9px solid #111111;</pre>

<p>} .color-theme-1 .dropdown-menu .buttons {</p>

<pre>border-color: #7e888b;</pre>

<p>} .color-theme-1 .dropdown-menu .button {</p>

<pre>color: #afa790;</pre>

<p>} .color-theme-1 .dropdown-menu .button:hover {</p>

<pre>color: #73553c;</pre>
...
<p>.color-theme-2 .dropdown-menu {</p>

<pre>background-color: #2d3143;
border-color: #272a3a;</pre>

<p>} .color-theme-2 .dropdown-menu .dropdown-caret .caret-inner {</p>

<pre>border-bottom: 9px solid #2d3143;</pre>

<p>} .color-theme-2 .dropdown-menu .buttons {</p>

<pre>border-color: #272a3a;</pre>

<p>} .color-theme-2 .dropdown-menu .button {</p>

<pre>color: #62677f;</pre>

<p>} .color-theme-2 .dropdown-menu .button:hover {</p>

<pre>color: #f4f4f5;</pre>

<p>} .book .book-header .font-settings .font-enlarge {</p>

<pre>line-height: 30px;
font-size: 1.4em;</pre>

<p>} .book .book-header .font-settings .font-reduce {</p>

<pre>line-height: 30px;
font-size: 1em;</pre>

<p>} .book.color-theme-1 .book-body {</p>

<pre>color: #704214;
background: #f3eacb;</pre>

<p>} .book.color-theme-1 .book-body .page-wrapper .page-inner section {</p>

<pre>background: #f3eacb;</pre>

<p>} .book.color-theme-2 .book-body {</p>

<pre>color: #bdcadb;
background: #1c1f2b;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section {</p>

<pre>background: #1c1f2b;</pre>

<p>} .book.font-size-0 .book-body .page-inner section {</p>

<pre>font-size: 1.2rem;</pre>

<p>} .book.font-size-1 .book-body .page-inner section {</p>

<pre>font-size: 1.4rem;</pre>

<p>} .book.font-size-2 .book-body .page-inner section {</p>

<pre>font-size: 1.6rem;</pre>

<p>} .book.font-size-3 .book-body .page-inner section {</p>

<pre>font-size: 2.2rem;</pre>

<p>} .book.font-size-4 .book-body .page-inner section {</p>

<pre>font-size: 4rem;</pre>

<p>} .book.font-family-0 {</p>

<pre>font-family: Georgia, serif;</pre>

<p>} .book.font-family-1 {</p>

<pre>font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;</pre>

<p>} .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal {</p>

<pre>color: #704214;</pre>

<p>} .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal a
{</p>

<pre>color: inherit;</pre>

<p>} .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
h1, .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
h2, .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
h3, .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
h4, .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
h5, .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
h6 {</p>
...
<pre>background-color: inherit;</pre>
...
<p>} .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
table th, .book.color-theme-1 .book-body .page-wrapper .page-inner
section.normal table td {</p>

<pre>border-color: #f5d06c;</pre>
...
border-color: #444444;</pre>

<p>} .book.color-theme-1 .book-body .page-wrapper .page-inner section.normal
table tr:nth-child(2n) {</p>

<pre>background-color: #fbeecb;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal {</p>

<pre>color: #bdcadb;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal a
{</p>

<pre>color: #3eb1d0;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h1, .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h2, .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h3, .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h4, .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h5, .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h6 {</p>

<pre>color: #fffffa;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h1, .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h2 {</p>

<pre>border-color: #373b4e;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
h6 {</p>

<pre>color: #373b4e;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
hr {</p>

<pre>background-color: #373b4e;</pre>
...
<pre>color: #9dbed8;
background: #2d3143;
border-color: #2d3143;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
.highlight {</p>

<pre>background-color: #282a39;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
table th, .book.color-theme-2 .book-body .page-wrapper .page-inner
section.normal table td {</p>

<pre>border-color: #3b3f54;</pre>
...
border-color: #3b3f54;</pre>

<p>} .book.color-theme-2 .book-body .page-wrapper .page-inner section.normal
table tr:nth-child(2n) {</p>

<pre>background-color: #35394b;</pre>

<p>} .book.color-theme-1 .book-header {</p>

<pre>color: #afa790;
background: transparent;</pre>

<p>} .book.color-theme-1 .book-header .btn {</p>

<pre>color: #afa790;</pre>

<p>} .book.color-theme-1 .book-header .btn:hover {</p>

<pre>color: #73553c;
background: none;</pre>

<p>} .book.color-theme-1 .book-header h1 {</p>

<pre>color: #704214;</pre>

<p>} .book.color-theme-2 .book-header {</p>

<pre>color: #7e888b;
background: transparent;</pre>

<p>} .book.color-theme-2 .book-header .btn {</p>

<pre>color: #3b3f54;</pre>

<p>} .book.color-theme-2 .book-header .btn:hover {</p>

<pre>color: #fffff5;
background: none;</pre>

<p>} .book.color-theme-2 .book-header h1 {</p>

<pre>color: #bdcadb;</pre>

<p>} .book.color-theme-1 .book-body .navigation {</p>

<pre>color: #afa790;</pre>

<p>} .book.color-theme-1 .book-body .navigation:hover {</p>

<pre>color: #73553c;</pre>

<p>} .book.color-theme-2 .book-body .navigation {</p>

<pre>color: #383f52;</pre>

<p>} .book.color-theme-2 .book-body .navigation:hover {</p>

<pre>color: #fffff5;</pre>
...
<p>.book.color-theme-1 .book-summary {</p>

<pre>color: #afa790;
background: #111111;
border-right: 1px solid rgba(0, 0, 0, 0.07);</pre>

<p>} .book.color-theme-1 .book-summary .book-search {</p>

<pre>background: transparent;</pre>

<p>} .book.color-theme-1 .book-summary .book-search input, .book.color-theme-1
.book-summary .book-search input:focus {</p>

<pre>border: 1px solid transparent;</pre>

<p>} .book.color-theme-1 .book-summary ul.summary li.divider {</p>

<pre>background: #7e888b;
box-shadow: none;</pre>

<p>} .book.color-theme-1 .book-summary ul.summary li i.fa-check {</p>

<pre>color: #33cc33;</pre>

<p>} .book.color-theme-1 .book-summary ul.summary li.done &gt; a {</p>

<pre>color: #877f6a;</pre>

<p>} .book.color-theme-1 .book-summary ul.summary li a, .book.color-theme-1
.book-summary ul.summary li span {</p>

<pre>color: #877f6a;
background: transparent;
font-weight: normal;</pre>

<p>} .book.color-theme-1 .book-summary ul.summary li.active &gt; a,
.book.color-theme-1 .book-summary ul.summary li a:hover {</p>
...
<p>.book.color-theme-2 .book-summary {</p>

<pre>color: #bcc1d2;
background: #2d3143;
border-right: none;</pre>

<p>} .book.color-theme-2 .book-summary .book-search {</p>

<pre>background: transparent;</pre>

<p>} .book.color-theme-2 .book-summary .book-search input, .book.color-theme-2
.book-summary .book-search input:focus {</p>

<pre>border: 1px solid transparent;</pre>

<p>} .book.color-theme-2 .book-summary ul.summary li.divider {</p>

<pre>background: #272a3a;
box-shadow: none;</pre>

<p>} .book.color-theme-2 .book-summary ul.summary li i.fa-check {</p>

<pre>color: #33cc33;</pre>

<p>} .book.color-theme-2 .book-summary ul.summary li.done &gt; a {</p>

<pre>color: #62687f;</pre>

<p>} .book.color-theme-2 .book-summary ul.summary li a, .book.color-theme-2
.book-summary ul.summary li span {</p>
...
<p>} .book.color-theme-2 .book-summary ul.summary li.active &gt; a,
.book.color-theme-2 .book-summary ul.summary li a:hover {</p>
