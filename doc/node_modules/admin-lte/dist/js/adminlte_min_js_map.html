...
<title>adminlte.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/admin-lte/dist/js/adminlte.min.js.map">

<p>{“<a
href=""../../build/js/ControlSidebar.js","../../build/js/Layout.js","../../build/js/PushMenu.js","../../build/js/Treeview.js","../../build/js/Widget.js"">version”:3,“sources”:</a>,“<a
href=""$","NAME","DATA_KEY","JQUERY_NO_CONFLICT","Selector","ClassName","Default","ControlSidebar","Layout","EVENT_KEY","Event","PushMenu","Treeview","Widget","jQuery","fn","element","config","_element","_config","this","_getConfig","show","slide","removeClass","collapse","addClass","toggle","_setMargin","hasClass","extend","css","outerHeight","_jQueryInterface","operation","each","data","Error","document","on","event","preventDefault","call","Constructor","noConflict","_init","fixLayoutHeight","heights","window","height","max","_max","header","resize","numbers","keys","forEach","key","options","_options","OVERLAY","length","_addOverlay","BODY","shownEvent","SHOWN","trigger","collapsedEvent","COLLAPSED","width","screenCollapseSize","overlay","WRAPPER","append","TOGGLE_BUTTON","button","currentTarget","closest","init","_setupListeners","expand","treeviewMenu","parentLi","expandedEvent","EXPANDED","accordion","openMenuLi","siblings","first","openTreeview","find","slideDown","animationSpeed","_this","slideUp","_this2","$relativeTarget","next","is","parents","LOAD_DATA_API","DATA_COLLAPSE","DATA_REMOVE","settings","_parent","CARD","_settings","children","CARD_BODY","CARD_FOOTER","collapsed","expanded","remove","removed","REMOVED","card","collapseTrigger","click","removeTrigger","match","_typeof"">names”:</a>,“mappings”:“;;;;;+LAOyBA,EAMjBC,EACAC,EAEAC,EAOAC,EAAAA,EAAAA,EAMAC,EAAAA,EAKAC,EASAC,ECpCSP,EAMTC,EACAC,EAEAC,EAMAC,EAAAA,EAAAA,EAAAA,EAWAC,EAWAG,ECrCWR,EAMXC,EACAC,EACAO,EACAN,EAEAO,EAKAJ,EAIAF,EASAC,EAAAA,EAYAM,ECzCWX,EAMXC,EACAC,EACAO,EACAN,EAEAO,EAOAN,EAAAA,EAAAA,EAAAA,EAQAC,EAOAC,EAUAM,EC3CSZ,EAMTC,EACAC,EACAO,EACAN,EAEAO,EAMAN,EAUAC,EAIAC,GAMAO,gTJrCFN,IAAmBP,EAoItBc,OA9HKb,EAAqB,iBACrBC,EAAqB,sBAErBC,EAAqBH,EAAEe,GAAGd,GAO1BG,EACa,mBADbA,EAEa,kCAFbA,EAGa,eAGbC,EACmB,uBADnBA,EAEmB,6BAGnBC,EAAU,QACP,GAQHC,EApCuB,sBAqCfS,EAASC,mBACdC,SAAWF,OACXG,QAAWC,KAAKC,WAAWJ,sBAKlCK,KA5C2B,WA8CrBF,KAAKD,QAAQI,QACb,QAAQC,YAAYnB,KAEpB,QAAQmB,YAAYnB,gBAI1BoB,SArD2B,WAuDrBL,KAAKD,QAAQI,QACb,QAAQG,SAASrB,KAEjB,QAAQqB,SAASrB,gBAIvBsB,OA9D2B,gBA+DpBC,aAEc5B,EAAE,QAAQ6B,SAASxB,IAAmCL,EAAE,QACxE6B,SAASxB,QAG
G,EAASwG,UAAlC,KAAgDxG,EAASyG,aACtDf,QAAQ1E,KAAKsF,UAAUd,eAAgB,aACjCY,QAAQ9E,SAASrB,SAGpByG,EAAY9G,EAAEU,MAAMA,EAAM0D,gBAE3BlD,SAASgD,QAAQ4C,EAAW1F,KAAKoF,sBAGxCxB,OAvDmB,2BAwDZwB,QAAQG,SAAYvG,EAASwG,UAAlC,KAAgDxG,EAASyG,aACtDlB,UAAUvE,KAAKsF,UAAUd,eAAgB,aACnCY,QAAQhF,YAAYnB,SAGvB0G,EAAW/G,EAAEU,MAAMA,EAAM0E,eAE1BlE,SAASgD,QAAQ6C,EAAU3F,KAAKoF,sBAGvCQ,OAlEmB,gBAmEZR,QAAQV,cAEPmB,EAAUjH,EAAEU,MAAMA,EAAMwG,cAEzBhG,SAASgD,QAAQ+C,EAAS7F,KAAKoF,sBAGtC7E,OA1EmB,WA2EbP,KAAKoF,QAAQ3E,SAASxB,QACnB2E,cAIFvD,wBAKPoB,MArFmB,SAqFbsE,mBACCX,QAAUW,IAEb/F,MAAMsE,KAAKtE,KAAKsF,UAAUU,iBAAiBC,MAAM,aAC5C1F,aAGLP,MAAMsE,KAAKtE,KAAKsF,UAAUY,eAAeD,MAAM,aAC1CL,cAMF/E,iBAnGY,SAmGKhB,UACfG,KAAKe,KAAK,eACXC,EAAOpC,EAAEoB,MAAMgB,KAAKlC,GAEnBkC,MACI,IAAIvB,EAAOb,EAAEoB,MAAOgB,KACzBhB,MAAMgB,KAAKlC,EAA4B,iBAAXe,EAAsBmB,EAAOnB,IAGvC,iBAAXA,GAAuBA,EAAOsG,MAAM,mBACxCtG,KACsB,YAAlB,oBAAOA,EAAP,YAAAuG,GAAOvG,OACX4B,MAAM7C,EAAEoB,YA/GA,KA0HnBkB,UAAUC,GAAG,QAASnC,EAASiG,cAAe,SAAU7D,GACpDA,KACIC,oBAGDR,iBAAiBS,KAAK1C,EAAEoB,MAAO,cAGtCkB,UAAUC,GAAG,QAASnC,EAASkG,YAAa,SAAU9D,GAClDA,KACIC,oBAGDR,iBAAiBS,KAAK1C,EAAEoB,MAAO,cAQtCL,GAAGd,GAAQY,GAAOoB,mBAClBlB,GAAGd,GAAM0C,YAAc9B,KACvBE,GAAGd,GAAM2C,WAAc,oBACrB7B,GAAGd,GAAQE,EACNU,GAAOoB,kBAGTpB”,“sourcesContent”:[“
n * ——————————————–n * AdminLTE ControlSidebar.jsn * <a
href="../../plugins/datatables/extensions/ColReorder/License_txt.html">License</a>
MITn * ——————————————–n   nnconst ControlSidebar = (($) =&gt; {n     n   *
Constantsn   * ====================================================n     nn
const NAME               = &#39;ControlSidebar&#39;n  const DATA_KEY       
= &#39;lte.control.sidebar&#39;n  const EVENT_KEY          =
`.${DATA_KEY}`n  const JQUERY_NO_CONFLICT = $.<a href="NAME">fn</a>n  const
DATA_API_KEY       = &#39;.data-api&#39;nn  const Event = {n   
CLICK_DATA_API: `click${EVENT_KEY}${DATA_API_KEY}`n  }nn  const Selector =
{n    CONTROL_SIDEBAR: &#39;.control-sidebar&#39;,n    DATA_TOGGLE    :
&#39;[data-widget=&quot;control-sidebar&quot;]&#39;,n    MAIN_HEADER    :
&#39;.main-header&#39;n  }nn  const ClassName = {n    CONTROL_SIDEBAR_OPEN
: &#39;control-sidebar-open&#39;,n    CONTROL_SIDEBAR_SLIDE:
&#39;control-sidebar-slide-open&#39;n  }nn  const Default = {n    slide:
truen  }nn  /**n   * Class Definitionn   *
====================================================n   */nn  class
ControlSidebar {n    constructor(element, config) {n      this._element =
elementn      this._config  = this._getConfig(config)n    }nn    //
Publicnn    show() {n      // Show the control sidebarn      if
(this._config.slide) {n       
$(&#39;body&#39;).removeClass(ClassName.CONTROL_SIDEBAR_SLIDE)n      } else
{n        $(&#39;body&#39;).removeClass(ClassName.CONTROL_SIDEBAR_OPEN)n   
}n    }nn    collapse() {n      // Collapse the control sidebarn      if
(this._config.slide) {n       
$(&#39;body&#39;).addClass(ClassName.CONTROL_SIDEBAR_SLIDE)n      } else {n
$(&#39;body&#39;).addClass(ClassName.CONTROL_SIDEBAR_OPEN)n      }n    }nn 
toggle() {n      this._setMargin()nn      const shouldOpen =
$(&#39;body&#39;).hasClass(ClassName.CONTROL_SIDEBAR_OPEN) ||
$(&#39;body&#39;)n        .hasClass(ClassName.CONTROL_SIDEBAR_SLIDE)n     
if (shouldOpen) {n        // Open the control sidebarn        this.show()n 
} else {n        // Close the control sidebarn        this.collapse()n     
}n    }nn    // Privatenn    _getConfig(config) {n      return $.extend({},
Default, config)n    }nn    _setMargin() {n     
$(Selector.CONTROL_SIDEBAR).css({n        top:
$(Selector.MAIN_HEADER).outerHeight()n      })n    }nn    // Staticnn   
static _jQueryInterface(operation) {n      return this.each(function () {n 
let data = $(this).data(DATA_KEY)nn        if (!data) {n          data =
new ControlSidebar(this, $(this).data())n          $(this).data(DATA_KEY,
data)n        }nn        if (<a href="operation">data</a> ===
&#39;undefined&#39;) {n          throw new Error(`${operation} is not a
function`)n        }nn        <a href="operation">data</a>()n      })n   
}n  }nn  /**n   *n   * Data <a href="../../../../Api.html">Api</a>
implementationn   * ====================================================n  
*/n  $(document).on(&#39;click&#39;, Selector.DATA_TOGGLE, function (event)
{n    event.preventDefault()nn   
ControlSidebar._jQueryInterface.call($(this), &#39;toggle&#39;)n  })nn 
/**n   * jQuery APIn   *
====================================================n   */nn  $.<a
href="NAME">fn</a> = ControlSidebar._jQueryInterfacen  $.<a
href="NAME">fn</a>.Constructor = ControlSidebarn  $.<a
href="NAME">fn</a>.noConflict  = function () {n    $.<a href="NAME">fn</a>
= JQUERY_NO_CONFLICTn    return ControlSidebar._jQueryInterfacen  }nn 
return ControlSidebarn})(jQuery)nnexport default ControlSidebarn”,“/**n *
——————————————–n * AdminLTE Layout.jsn * <a
href="../../plugins/datatables/extensions/ColReorder/License_txt.html">License</a>
MITn * ——————————————–n */nnconst Layout = (($) =&gt; {n  /**n   *
Constantsn   * ====================================================n   */nn
const NAME               = &#39;Layout&#39;n  const DATA_KEY           =
&#39;lte.layout&#39;n  const EVENT_KEY          = `.${DATA_KEY}`n  const
JQUERY_NO_CONFLICT = $.<a href="NAME">fn</a>nn  const Event = {n   
SIDEBAR: &#39;sidebar&#39;n  }nn  const Selector = {n    SIDEBAR        :
&#39;.main-sidebar&#39;,n    HEADER         : &#39;.main-header&#39;,n   
CONTENT        : &#39;.content-wrapper&#39;,n    CONTENT_HEADER :
&#39;.content-header&#39;,n    WRAPPER        : &#39;.wrapper&#39;,n   
CONTROL_SIDEBAR: &#39;.control-sidebar&#39;,n    LAYOUT_FIXED   :
&#39;.layout-fixed&#39;,n    FOOTER         : &#39;.main-footer&#39;n  }nn 
const ClassName = {n    HOLD        : &#39;hold-transition&#39;,n   
SIDEBAR     : &#39;main-sidebar&#39;,n    LAYOUT_FIXED:
&#39;layout-fixed&#39;n  }nn  /**n   * Class Definitionn   *
====================================================n   */nn  class Layout
{n    constructor(element) {n      this._element = elementnn     
this._init()n    }nn    // Publicnn    fixLayoutHeight() {n      const
heights = {n        window : $(window).height(),n        header :
$(Selector.HEADER).outerHeight(),n        footer :
$(Selector.FOOTER).outerHeight(),n        sidebar:
$(Selector.SIDEBAR).height()n      }n      const max     =
this._max(heights)nn      $(Selector.CONTENT).css(&#39;min-height&#39;, max
- (heights.header))n      $(Selector.SIDEBAR).css(&#39;min-height&#39;, max
- heights.header)n    }nn    // Privatenn    _init() {n      // Enable
transitionsn      $(&#39;body&#39;).removeClass(ClassName.HOLD)nn      //
Activate layout height watchern      this.fixLayoutHeight()n     
$(Selector.SIDEBAR)n        .on(&#39;collapsed.lte.treeview
expanded.lte.treeview collapsed.lte.pushmenu expanded.lte.pushmenu&#39;, ()
=&gt; {n          this.fixLayoutHeight()n        })nn     
$(window).resize(() =&gt; {n        this.fixLayoutHeight()n      })nn     
$(&#39;body, html&#39;).css(&#39;height&#39;, &#39;auto&#39;)n    }nn   
_max(numbers) {n      // Calculate the maximum number in a listn      let
max = 0nn      Object.keys(numbers).forEach((key) =&gt; {n        if (<a
href="key">numbers</a> &gt; max) {n          max = <a
href="key">numbers</a>n        }n      })nn      return maxn    }nn    //
Staticnn    static _jQueryInterface(operation) {n      return
this.each(function () {n        let data = $(this)n         
.data(DATA_KEY)nn        if (!data) {n          data = new Layout(this)n   
$(this).data(DATA_KEY, data)n        }nn        if (operation) {n         
<a href="operation">data</a>()n        }n      })n    }n  }nn  /**n   *
Data APIn   * ====================================================n   */n 
$(window).on(&#39;load&#39;, () =&gt; {n   
Layout._jQueryInterface.call($(&#39;body&#39;))n  })nn  /**n   * jQuery
APIn   * ====================================================n   */nn  $.<a
href="NAME">fn</a> = Layout._jQueryInterfacen  $.<a
href="NAME">fn</a>.Constructor = Layoutn  $.<a
href="NAME">fn</a>.noConflict  = function () {n    $.<a href="NAME">fn</a>
= JQUERY_NO_CONFLICTn    return Layout._jQueryInterfacen  }nn  return
Layoutn})(jQuery)nnexport default Layoutn”,“/**n * ——————————————–n *
AdminLTE PushMenu.jsn * <a
href="../../plugins/datatables/extensions/ColReorder/License_txt.html">License</a>
MITn * ——————————————–n */nnconst PushMenu = (($) =&gt; {n  /**n   *
Constantsn   * ====================================================n   */nn
const NAME               = &#39;PushMenu&#39;n  const DATA_KEY           =
&#39;lte.pushmenu&#39;n  const EVENT_KEY          = `.${DATA_KEY}`n  const
JQUERY_NO_CONFLICT = $.<a href="NAME">fn</a>nn  const Event = {n   
COLLAPSED: `collapsed${EVENT_KEY}`,n    SHOWN    : `shown${EVENT_KEY}`n 
}nn  const Default = {n    screenCollapseSize: 768n  }nn  const Selector =
{n    TOGGLE_BUTTON    : &#39;[data-widget=&quot;pushmenu&quot;]&#39;,n   
SIDEBAR_MINI     : &#39;.sidebar-mini&#39;,n    SIDEBAR_COLLAPSED:
&#39;.sidebar-collapse&#39;,n    BODY             : &#39;body&#39;,n   
OVERLAY          : &#39;#sidebar-overlay&#39;,n    WRAPPER          :
&#39;.wrapper&#39;n  }nn  const ClassName = {n    SIDEBAR_OPEN:
&#39;sidebar-open&#39;,n    COLLAPSED   : &#39;sidebar-collapse&#39;,n   
OPEN        : &#39;sidebar-open&#39;,n    SIDEBAR_MINI:
&#39;sidebar-mini&#39;n  }nn  /**n   * Class Definitionn   *
====================================================n   */nn  class
PushMenu {n    constructor(element, options) {n      this._element =
elementn      this._options = $.extend({}, Default, options)nn      if
(!$(Selector.OVERLAY).length) {n        this._addOverlay()n      }n    }nn 
// Publicnn    show() {n     
$(Selector.BODY).addClass(ClassName.OPEN).removeClass(ClassName.COLLAPSED)nn
const shownEvent = $.Event(Event.SHOWN)n     
$(this._element).trigger(shownEvent)n    }nn    collapse() {n     
$(Selector.BODY).removeClass(ClassName.OPEN).addClass(ClassName.COLLAPSED)nn
const collapsedEvent = $.Event(Event.COLLAPSED)n     
$(this._element).trigger(collapsedEvent)n    }nn    toggle() {n      let
isShownn      if ($(window).width() &gt;= this._options.screenCollapseSize)
{n        isShown = !$(Selector.BODY).hasClass(ClassName.COLLAPSED)n      }
else {n        isShown = $(Selector.BODY).hasClass(ClassName.OPEN)n     
}nn      if (isShown) {n        this.collapse()n      } else {n       
this.show()n      }n    }nn    // Privaten    _addOverlay() {n      const
overlay = $(&#39;&lt;div /&gt;&#39;, {n        id:
&#39;sidebar-overlay&#39;n      })nn      overlay.on(&#39;click&#39;, ()
=&gt; {n        this.collapse()n      })nn     
$(Selector.WRAPPER).append(overlay)n    }nn    // Staticnn    static
_jQueryInterface(operation) {n      return this.each(function () {n       
let data = $(this).data(DATA_KEY)nn        if (!data) {n          data =
new PushMenu(this)n          $(this).data(DATA_KEY, data)n        }nn      
if (operation) {n          <a href="operation">data</a>()n        }n     
})n    }n  }nn  /**n   * Data APIn   *
====================================================n   */nn 
$(document).on(&#39;click&#39;, Selector.TOGGLE_BUTTON, (event) =&gt; {n   
event.preventDefault()nn    let button = event.currentTargetnn    if
($(button).data(&#39;widget&#39;) !== &#39;pushmenu&#39;) {n      button =
$(button).closest(Selector.TOGGLE_BUTTON)n    }nn   
PushMenu._jQueryInterface.call($(button), &#39;toggle&#39;)n  })nn  /**n  
* jQuery APIn   * ====================================================n  
*/nn  $.<a href="NAME">fn</a> = PushMenu._jQueryInterfacen  $.<a
href="NAME">fn</a>.Constructor = PushMenun  $.<a
href="NAME">fn</a>.noConflict  = function () {n    $.<a href="NAME">fn</a>
= JQUERY_NO_CONFLICTn    return PushMenu._jQueryInterfacen  }nn  return
PushMenun})(jQuery)nnexport default PushMenun”,“/**n * ——————————————–n *
AdminLTE Treeview.jsn * <a
href="../../plugins/datatables/extensions/ColReorder/License_txt.html">License</a>
MITn * ——————————————–n */nnconst Treeview = (($) =&gt; {n  /**n   *
Constantsn   * ====================================================n   */nn
const NAME               = &#39;Treeview&#39;n  const DATA_KEY           =
&#39;lte.treeview&#39;n  const EVENT_KEY          = `.${DATA_KEY}`n  const
JQUERY_NO_CONFLICT = $.<a href="NAME">fn</a>nn  const Event = {n   
SELECTED     : `selected${EVENT_KEY}`,n    EXPANDED     :
`expanded${EVENT_KEY}`,n    COLLAPSED    : `collapsed${EVENT_KEY}`,n   
LOAD_DATA_API: `load${EVENT_KEY}`n  }nn  const Selector = {n    LI         
: &#39;.nav-item&#39;,n    LINK         : &#39;.nav-link&#39;,n   
TREEVIEW_MENU: &#39;.nav-treeview&#39;,n    OPEN         :
&#39;.menu-open&#39;,n    DATA_WIDGET  :
&#39;[data-widget=&quot;treeview&quot;]&#39;n  }nn  const ClassName = {n   
LI           : &#39;nav-item&#39;,n    LINK         : &#39;nav-link&#39;,n 
TREEVIEW_MENU: &#39;nav-treeview&#39;,n    OPEN         :
&#39;menu-open&#39;n  }nn  const Default = {n    trigger       :
`${Selector.DATA_WIDGET} ${Selector.LINK}`,n    animationSpeed: 300,n   
accordion     : truen  }nn  /**n   * Class Definitionn   *
====================================================n   */n  class Treeview
{n    constructor(element, config) {n      this._config  = confign     
this._element = elementn    }nn    // Publicnn    init() {n     
this._setupListeners()n    }nn    expand(treeviewMenu, parentLi) {n     
const expandedEvent = $.Event(Event.EXPANDED)nn      if
(this._config.accordion) {n        const openMenuLi   =
parentLi.siblings(Selector.OPEN).first()n        const openTreeview =
openMenuLi.find(Selector.TREEVIEW_MENU).first()n       
this.collapse(openTreeview, openMenuLi)n      }nn     
treeviewMenu.slideDown(this._config.animationSpeed, () =&gt; {n       
parentLi.addClass(ClassName.OPEN)n       
$(this._element).trigger(expandedEvent)n      })n    }nn   
collapse(treeviewMenu, parentLi) {n      const collapsedEvent =
$.Event(Event.COLLAPSED)nn     
treeviewMenu.slideUp(this._config.animationSpeed, () =&gt; {n       
parentLi.removeClass(ClassName.OPEN)n       
$(this._element).trigger(collapsedEvent)n       
treeviewMenu.find(`${Selector.OPEN} &gt;
${Selector.TREEVIEW_MENU}`).slideUp()n       
treeviewMenu.find(Selector.OPEN).removeClass(ClassName.OPEN)n      })n   
}nn    toggle(event) {n      const $relativeTarget =
$(event.currentTarget)n      const treeviewMenu    =
$relativeTarget.next()nn      if (!treeviewMenu.is(Selector.TREEVIEW_MENU))
{n        returnn      }nn      event.preventDefault()nn      const
parentLi = $relativeTarget.parents(Selector.LI).first()n      const isOpen 
= parentLi.hasClass(ClassName.OPEN)nn      if (isOpen) {n       
this.collapse($(treeviewMenu), parentLi)n      } else {n       
this.expand($(treeviewMenu), parentLi)n      }n    }nn    // Privatenn   
_setupListeners() {n      $(document).on(&#39;click&#39;,
this._config.trigger, (event) =&gt; {n        this.toggle(event)n      })n 
}nn    // Staticnn    static _jQueryInterface(config) {n      return
this.each(function () {n        let data      = $(this).data(DATA_KEY)n    
const _config = $.extend({}, Default, $(this).data())nn        if (!data)
{n          data = new Treeview($(this), _config)n         
$(this).data(DATA_KEY, data)n        }nn        if (config ===
&#39;init&#39;) {n          <a href="config">data</a>()n        }n      })n
}n  }nn  /**n   * Data APIn   *
====================================================n   */nn 
$(window).on(Event.LOAD_DATA_API, () =&gt; {n   
$(Selector.DATA_WIDGET).each(function () {n     
Treeview._jQueryInterface.call($(this), &#39;init&#39;)n    })n  })nn  /**n
* jQuery APIn   * ====================================================n  
*/nn  $.<a href="NAME">fn</a> = Treeview._jQueryInterfacen  $.<a
href="NAME">fn</a>.Constructor = Treeviewn  $.<a
href="NAME">fn</a>.noConflict  = function () {n    $.<a href="NAME">fn</a>
= JQUERY_NO_CONFLICTn    return Treeview._jQueryInterfacen  }nn  return
Treeviewn})(jQuery)nnexport default Treeviewn”,“/**n * ——————————————–n *
AdminLTE Widget.jsn * <a
href="../../plugins/datatables/extensions/ColReorder/License_txt.html">License</a>
MITn * ——————————————–n */nnconst Widget = (($) =&gt; {n  /**n   *
Constantsn   * ====================================================n   */nn
const NAME               = &#39;Widget&#39;n  const DATA_KEY           =
&#39;lte.widget&#39;n  const EVENT_KEY          = `.${DATA_KEY}`n  const
JQUERY_NO_CONFLICT = $.<a href="NAME">fn</a>nn  const Event = {n   
EXPANDED : `expanded${EVENT_KEY}`,n    COLLAPSED: `collapsed${EVENT_KEY}`,n
REMOVED  : `removed${EVENT_KEY}`n  }nn  const Selector = {n    DATA_REMOVE 
: &#39;[data-widget=&quot;remove&quot;]&#39;,n    DATA_COLLAPSE:
&#39;[data-widget=&quot;collapse&quot;]&#39;,n    CARD         :
&#39;.card&#39;,n    CARD_HEADER  : &#39;.card-header&#39;,n    CARD_BODY  
: &#39;.card-body&#39;,n    CARD_FOOTER  : &#39;.card-footer&#39;,n   
COLLAPSED    : &#39;.collapsed-card&#39;n  }nn  const ClassName = {n   
COLLAPSED: &#39;collapsed-card&#39;n  }nn  const Default = {n   
animationSpeed : &#39;normal&#39;,n    collapseTrigger:
Selector.DATA_COLLAPSE,n    removeTrigger  : Selector.DATA_REMOVEn  }nn 
class Widget {n    constructor(element, settings) {n      this._element  =
elementn      this._parent   = element.parents(Selector.CARD).first()n     
this._settings = $.extend({}, Default, settings)n    }nn    collapse() {n  
this._parent.children(`${Selector.CARD_BODY}, ${Selector.CARD_FOOTER}`)n   
.slideUp(this._settings.animationSpeed, () =&gt; {n         
this._parent.addClass(ClassName.COLLAPSED)n        })nn      const
collapsed = $.Event(Event.COLLAPSED)nn     
this._element.trigger(collapsed, this._parent)n    }nn    expand() {n     
this._parent.children(`${Selector.CARD_BODY}, ${Selector.CARD_FOOTER}`)n   
.slideDown(this._settings.animationSpeed, () =&gt; {n         
this._parent.removeClass(ClassName.COLLAPSED)n        })nn      const
expanded = $.Event(Event.EXPANDED)nn      this._element.trigger(expanded,
this._parent)n    }nn    remove() {n      this._parent.slideUp()nn     
const removed = $.Event(Event.REMOVED)nn     
this._element.trigger(removed, this._parent)n    }nn    toggle() {n      if
(this._parent.hasClass(ClassName.COLLAPSED)) {n        this.expand()n      
returnn      }nn      this.collapse()n    }nn    // Privatenn   
_init(card) {n      this._parent = cardnn     
$(this).find(this._settings.collapseTrigger).click(() =&gt; {n       
this.toggle()n      })nn     
$(this).find(this._settings.removeTrigger).click(() =&gt; {n       
this.remove()n      })n    }nn    // Staticnn    static
_jQueryInterface(config) {n      return this.each(function () {n        let
data = $(this).data(DATA_KEY)nn        if (!data) {n          data = new
Widget($(this), data)n          $(this).data(DATA_KEY, typeof config ===
&#39;string&#39; ? data : config)n        }nn        if (typeof config ===
&#39;string&#39; &amp;&amp; config.match(/remove|toggle/)) {n          <a
href="config">data</a>()n        } else if (typeof config ===
&#39;object&#39;) {n          data._init($(this))n        }n      })n    }n
}nn  /**n   * Data APIn   *
====================================================n   */nn 
$(document).on(&#39;click&#39;, Selector.DATA_COLLAPSE, function (event) {n
if (event) {n      event.preventDefault()n    }nn   
Widget._jQueryInterface.call($(this), &#39;toggle&#39;)n  })nn 
$(document).on(&#39;click&#39;, Selector.DATA_REMOVE, function (event) {n  
if (event) {n      event.preventDefault()n    }nn   
Widget._jQueryInterface.call($(this), &#39;remove&#39;)n  })nn  /**n   *
jQuery APIn   * ====================================================n  
*/nn  $.<a href="NAME">fn</a> = Widget._jQueryInterfacen  $.<a
href="NAME">fn</a>.Constructor = Widgetn  $.<a
href="NAME">fn</a>.noConflict  = function () {n    $.<a href="NAME">fn</a>
= JQUERY_NO_CONFLICTn    return Widget._jQueryInterfacen  }nn  return
Widgetn})(jQuery)nnexport default Widgetn”]}</p>
</main>
