...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-chartjs-color">chartjs-color</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-Setters">Setters</a>
    <li><a href="#label-Getters">Getters</a>
    <li><a href="#label-CSS+Strings">CSS Strings</a>
    <li><a href="#label-Luminosity">Luminosity</a>
    <li><a href="#label-Manipulation">Manipulation</a>
    <li><a href="#label-Clone">Clone</a>
    <li><a href="#label-Propers">Propers</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chartjs-color/README.md">

<h1 id="label-chartjs-color">chartjs-color<span><a href="#label-chartjs-color">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://npmjs.com/package/chartjs-color"><img
src="https://img.shields.io/npm/v/chartjs-color.svg?style=flat-square"></a>
<a href="https://travis-ci.org/chartjs/chartjs-color"><img
src="https://img.shields.io/travis/chartjs/chartjs-color.svg?style=flat-square"></a></p>

<blockquote>
<p>JavaScript library for color conversion and manipulation with support for
CSS color strings.</p>
</blockquote>

<pre>var color = Color(&quot;#7743CE&quot;);

color.alpha(0.5).lighten(0.5);

console.log(color.hslString());  // &quot;hsla(262, 59%, 81%, 0.5)&quot;</pre>

<h2 id="label-Install">Install<span><a href="#label-Install">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>$ npm install color</pre>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-constant">Color</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&quot;color&quot;</span>)
</pre>

<h3 id="label-Setters">Setters<span><a href="#label-Setters">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">color</span> = <span class="ruby-constant">Color</span>(<span class="ruby-string">&quot;rgb(255, 255, 255)&quot;</span>)
<span class="ruby-identifier">var</span> <span class="ruby-identifier">color</span> = <span class="ruby-constant">Color</span>({<span class="ruby-value">r:</span> <span class="ruby-value">255</span>, <span class="ruby-value">g:</span> <span class="ruby-value">255</span>, <span class="ruby-value">b:</span> <span class="ruby-value">255</span>})
<span class="ruby-identifier">var</span> <span class="ruby-identifier">color</span> = <span class="ruby-constant">Color</span>().<span class="ruby-identifier">rgb</span>(<span class="ruby-value">255</span>, <span class="ruby-value">255</span>, <span class="ruby-value">255</span>)
<span class="ruby-identifier">var</span> <span class="ruby-identifier">color</span> = <span class="ruby-constant">Color</span>().<span class="ruby-identifier">rgb</span>([<span class="ruby-value">255</span>, <span class="ruby-value">255</span>, <span class="ruby-value">255</span>])
</pre>

<p>Pass any valid CSS color string into <code>Color()</code> or a hash of
values. Also load in color values with <code>rgb()</code>,
<code>hsl()</code>, <code>hsv()</code>, <code>hwb()</code>, and
<code>cmyk()</code>.</p>

<pre class="ruby"><span class="ruby-identifier">color</span>.<span class="ruby-identifier">red</span>(<span class="ruby-value">120</span>)
</pre>

<p>Set the values for individual channels with <code>alpha</code>,
<code>red</code>, <code>green</code>, <code>blue</code>, <code>hue</code>,
<code>saturation</code> (hsl), <code>saturationv</code> (hsv),
<code>lightness</code>, <code>whiteness</code>, <code>blackness</code>,
<code>cyan</code>, <code>magenta</code>, <code>yellow</code>,
<code>black</code></p>

<h3 id="label-Getters">Getters<span><a href="#label-Getters">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>color.rgb()       // {r: 255, g: 255, b: 255}</pre>

<p>Get a hash of the rgb values with <code>rgb()</code>, similarly for
<code>hsl()</code>, <code>hsv()</code>, and <code>cmyk()</code></p>

<pre>color.rgbArray()  // [255, 255, 255]</pre>

<p>Get an array of the values with <code>rgbArray()</code>,
<code>hslArray()</code>, <code>hsvArray()</code>, and
<code>cmykArray()</code>.</p>

<pre>color.red()       // 255</pre>

<p>Get the value for an individual channel.</p>

<h3 id="label-CSS+Strings">CSS Strings<span><a href="#label-CSS+Strings">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>color.hslString()  // &quot;hsl(320, 50%, 100%)&quot;</pre>

<p>Different CSS String formats for the color are on <code>hexString</code>,
<code>rgbString</code>, <code>percentString</code>, <code>hslString</code>,
<code>hwbString</code>, and <code>keyword</code> (undefined if it&#39;s not
a keyword color). <code>&quot;rgba&quot;</code> and
<code>&quot;hsla&quot;</code> are used if the current alpha value of the
color isn&#39;t <code>1</code>.</p>

<h3 id="label-Luminosity">Luminosity<span><a href="#label-Luminosity">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>color.luminosity();  // 0.412</pre>

<p>The <a href="http://www.w3.org/TR/WCAG20/#relativeluminancedef">WCAG
luminosity</a> of the color. 0 is black, 1 is white.</p>

<pre>color.contrast(Color(&quot;blue&quot;))  // 12</pre>

<p>The <a href="http://www.w3.org/TR/WCAG20/#contrast-ratiodef">WCAG contrast
ratio</a> to another color, from 1 (same color) to 21 (contrast b/w white
and black).</p>

<pre>color.light();  // true
color.dark();   // false</pre>

<p>Get whether the color is “light” or “dark”, useful for deciding text color.</p>

<h3 id="label-Manipulation">Manipulation<span><a href="#label-Manipulation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>color.negate()         // rgb(0, 100, 255) -&gt; rgb(255, 155, 0)
...
// chaining
color.green(100).greyscale().lighten(0.6)</pre>

<h3 id="label-Clone">Clone<span><a href="#label-Clone">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>You can can create a copy of an existing color object using
<code>clone()</code>:</p>

<pre>color.clone() // -&gt; New color object</pre>

<p>And more to come…</p>

<h2 id="label-Propers">Propers<span><a href="#label-Propers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The API was inspired by <a
href="https://github.com/brehaut/color-js">color-js</a>. Manipulation
functions by CSS tools like Sass, LESS, and Stylus.</p>
</main>
