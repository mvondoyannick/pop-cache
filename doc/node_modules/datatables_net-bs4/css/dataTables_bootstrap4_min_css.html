...
<title>dataTables.bootstrap4.min.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css">

<p>table.dataTable{clear:both;margin-top:6px !important;margin-bottom:6px
...
thead&gt;tr&gt;th.sorting_desc,table.dataTable
thead&gt;tr&gt;th.sorting,table.dataTable
...
thead&gt;tr&gt;td:active{outline:none}table.dataTable thead
...
thead
.sorting_desc_disabled{cursor:pointer;position:relative}table.dataTable
thead .sorting:before,table.dataTable thead .sorting:after,table.dataTable
thead .sorting_asc:before,table.dataTable thead
.sorting_asc:after,table.dataTable thead
.sorting_desc:before,table.dataTable thead
.sorting_desc:after,table.dataTable thead
...
.sorting_desc_disabled:after{position:absolute;bottom:0.9em;display:block;opacity:0.3}table.dataTable
thead .sorting:before,table.dataTable thead
.sorting_asc:before,table.dataTable thead
.sorting_desc:before,table.dataTable thead
.sorting_asc_disabled:before,table.dataTable thead
.sorting_desc_disabled:before{right:1em;content:“2191”}table.dataTable
thead .sorting:after,table.dataTable thead
.sorting_asc:after,table.dataTable thead
.sorting_desc:after,table.dataTable thead
.sorting_asc_disabled:after,table.dataTable thead
.sorting_desc_disabled:after{right:0.5em;content:“2193”}table.dataTable
thead .sorting_asc:before,table.dataTable thead
.sorting_desc:after{opacity:1}table.dataTable thead
.sorting_asc_disabled:before,table.dataTable thead
...
!important}div.dataTables_scrollBody table thead
.sorting:before,div.dataTables_scrollBody table thead
.sorting_asc:before,div.dataTables_scrollBody table thead
.sorting_desc:before,div.dataTables_scrollBody table thead
.sorting:after,div.dataTables_scrollBody table thead
.sorting_asc:after,div.dataTables_scrollBody table thead
.sorting_desc:after{display:none}div.dataTables_scrollBody table tbody
tr:first-child th,div.dataTables_scrollBody table tbody tr:first-child
td{border-top:none}div.dataTables_scrollFoot&gt;.dataTables_scrollFootInner{box-sizing:content-box}div.dataTables_scrollFoot&gt;.dataTables_scrollFootInner&gt;table{margin-top:0
!important;border-top:none}@media screen and (max-width:
767px){div.dataTables_wrapper div.dataTables_length,div.dataTables_wrapper
div.dataTables_filter,div.dataTables_wrapper
div.dataTables_info,div.dataTables_wrapper
div.dataTables_paginate{text-align:center}}table.dataTable.table-sm&gt;thead&gt;tr&gt;th{padding-right:20px}table.dataTable.table-sm
.sorting:before,table.dataTable.table-sm
.sorting_asc:before,table.dataTable.table-sm
.sorting_desc:before{top:5px;right:0.85em}table.dataTable.table-sm
.sorting:after,table.dataTable.table-sm
.sorting_asc:after,table.dataTable.table-sm
.sorting_desc:after{top:5px}table.table-bordered.dataTable
...
table.table-bordered{border-bottom-width:0}div.table-responsive&gt;div.dataTables_wrapper&gt;div.row{margin:0}<a
href="class^="col-"">div.table-responsive>div.dataTables_wrapper>div.row>div</a>:first-child{padding-left:0}<a
href="class^="col-"">div.table-responsive>div.dataTables_wrapper>div.row>div</a>:last-child{padding-right:0}</p>
</main>
