...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-DataTables+for+jQuery+with+styling+for+Bootstrap+4">DataTables for jQuery with styling for <a href="http://getbootstrap.com/">Bootstrap 4</a></a>
    ...
    <li><a href="#label-Bug+-2F+Support">Bug / Support</a>
...
<main role="main" aria-label="Page node_modules/datatables.net-bs4/Readme.md">

<h1 id="label-DataTables+for+jQuery+with+styling+for+Bootstrap+4">DataTables for jQuery with styling for <a href="http://getbootstrap.com/">Bootstrap 4</a><span><a href="#label-DataTables+for+jQuery+with+styling+for+Bootstrap+4">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>This package contains distribution files required to style <a
href="https://datatables.net">DataTables library</a> for <a
href="http://jquery.com/">jQuery</a> with styling for <a
href="http://getbootstrap.com/">Bootstrap 4</a>.</p>

<p>DataTables is a table enhancing library which adds features such as paging,
ordering, search, scrolling and many more to a static HTML page. A
comprehensive API is also available that can be used to manipulate the
table. Please refer to the <a href="//datatables.net">DataTables
web-site</a> for a full range of documentation and examples.</p>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Browser">Browser<span><a href="#label-Browser">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>For inclusion of this library using a standard <code>&lt;script&gt;</code>
tag, rather than using this package, it is recommended that you use the <a
href="//datatables.net/download">DataTables download builder</a> which can
create CDN or locally hosted packages for you, will all dependencies
satisfied.</p>

<h3 id="label-npm">npm<span><a href="#label-npm">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">datatables</span>.<span class="ruby-identifier">net</span><span class="ruby-operator">-</span><span class="ruby-identifier">bs4</span>
</pre>

<pre>var $ = require( &#39;jquery&#39; );
require( &#39;datatables.net-bs4&#39; )( $ );</pre>

<h3 id="label-bower">bower<span><a href="#label-bower">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>bower install --save datatables.net-bs4</pre>
...
enhance and customise your table even further.</p>

<h2 id="label-Bug+-2F+Support">Bug / Support<span><a href="#label-Bug+-2F+Support">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Support for DataTables is available through the <a
href="//datatables.net/forums">DataTables forums</a> and <a
href="//datatables.net/support">commercial support options</a> are
available.</p>

<h3 id="label-Contributing">Contributing<span><a href="#label-Contributing">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you are thinking of contributing code to DataTables, first of all, thank
you! All fixes, patches and enhancements to DataTables are very warmly
welcomed. This repository is a distribution repo, so patches and issues
sent to this repo will not be accepted. Instead, please direct pull
requests to the <a
href="http://github.com/DataTables/DataTablesSrc">DataTables/DataTablesSrc</a>.
For issues / bugs, please direct your questions to the <a
href="//datatables.net/forums">DataTables forums</a>.</p>
...
<p>This software is released under the <a href="//datatables.net/license">MIT
license</a>. You are free to use, modify and distribute this software, but
all copyright information must remain.</p>
</main>
