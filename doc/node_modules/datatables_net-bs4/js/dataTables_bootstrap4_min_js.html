...
<title>dataTables.bootstrap4.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/datatables.net-bs4/js/dataTables.bootstrap4.min.js">

<pre> !
DataTables Bootstrap 4 integration
©2011-2017 SpryMedia Ltd - datatables.net/license</pre>

<p>(function(b){“function”===typeof <a
href=""jquery","datatables.net"">define&&define.amd?define(</a>,function(a){return
...
f=b.fn.dataTable;b.extend(!0,f.defaults,{dom:“&lt;&#39;row&#39;&lt;&#39;col-sm-12
col-md-6&#39;l&gt;&lt;&#39;col-sm-12
col-md-6&#39;f&gt;&gt;&lt;&#39;row&#39;&lt;&#39;col-sm-12&#39;tr&gt;&gt;&lt;&#39;row&#39;&lt;&#39;col-sm-12
col-md-5&#39;i&gt;&lt;&#39;col-sm-12 col-md-7&#39;p&gt;&gt;”,
renderer:“bootstrap”});b.extend(f.ext.classes,{sWrapper:“dataTables_wrapper
dt-bootstrap4”,sFilterInput:“form-control
form-control-sm”,sLengthSelect:“custom-select custom-select-sm form-control
form-control-sm”,sProcessing:“dataTables_processing
card”,sPageButton:“paginate_button
page-item”});f.ext.renderer.pageButton.bootstrap=function(a,h,r,s,j,n){var
o=new
f.Api(a),t=a.oClasses,k=a.oLanguage.oPaginate,u=a.oLanguage.oAria.paginate||{},e,g,p=0,q=function(d,f){var
l,h,i,c,m=function(a){a.preventDefault();
!b(a.currentTarget).hasClass(“disabled”)&amp;&amp;o.page()!=a.data.action&amp;&amp;o.page(a.data.action).draw(“page”)};<a
href="l">l=0;for(h=f.length;l<h;l++)if(c=f</a>,b.isArray©)q(d,c);else{g=e=“”;switch©{case
...
disabled”);break;default:e=c+1,g=j===c?“active”:“”}e&amp;&amp;(i=b(“&lt;li&gt;”,
{“class”:t.sPageButton+“ ”+g,id:0===r&amp;&amp;“string”===typeof
c?a.sTableId+“_”+c:null}).append(b(“&lt;a&gt;”,{<a
href="c">href:“#”,“aria-controls”:a.sTableId,“aria-label”:u</a>,“data-dt-idx”:p,tabindex:a.iTabIndex,“class”:“page-link”}).html(e)).appendTo(d),a.oApi._fnBindAction(i,{action:c},m),p++)}},i;try{i=b(h).find(d.activeElement).data(“dt-idx”)}catch(v){}q(b(h).empty().html(&#39;&lt;ul
<a
href="data-dt-idx="i"">class=“pagination”/>‘).children(“ul”),s);i!==m&&b(h).find(“</a>”).focus()};return
f});</p>
</main>
