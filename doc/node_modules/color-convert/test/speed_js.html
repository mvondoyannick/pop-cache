...
<title>speed.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/color-convert/test/speed.js">

<p>var convert = require(“../index”);</p>

<p>var converter = convert();</p>

<p>var times = 10000;</p>

<p>console.time(“cached”); converter.rgb(10, 2, 30); for(var i = 0; i &lt;
times; i++) {</p>

<pre class="ruby"><span class="ruby-identifier">converter</span>.<span class="ruby-identifier">hsv</span>();
<span class="ruby-identifier">converter</span>.<span class="ruby-identifier">hsl</span>();
<span class="ruby-identifier">converter</span>.<span class="ruby-identifier">cmyk</span>();
</pre>

<p>} console.timeEnd(“cached”);</p>

<p>console.time(“uncached”); for(var i = 0; i &lt; times; i++) {</p>

<pre class="ruby"><span class="ruby-identifier">convert</span>.<span class="ruby-identifier">rgb2hsl</span>(<span class="ruby-value">10</span>, <span class="ruby-value">2</span>, <span class="ruby-value">30</span>);
<span class="ruby-identifier">convert</span>.<span class="ruby-identifier">rgb2hsv</span>(<span class="ruby-value">10</span>, <span class="ruby-value">2</span>, <span class="ruby-value">30</span>);
<span class="ruby-identifier">convert</span>.<span class="ruby-identifier">rgb2cmyk</span>(<span class="ruby-value">10</span>, <span class="ruby-value">2</span>, <span class="ruby-value">30</span>);
</pre>

<p>} console.timeEnd(“uncached”);</p>
</main>
