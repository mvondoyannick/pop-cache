...
<main role="main" aria-label="Page node_modules/color-convert/test/basic.js">

<p>var convert = require(“../index”),</p>

<pre class="ruby"><span class="ruby-identifier">assert</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&quot;assert&quot;</span>);
</pre>

<p>assert.deepEqual(convert.rgb2hsl([140, 200, 100]), [96, 48, 59]);
assert.deepEqual(convert.rgb2hsv([140, 200, 100]), [96, 50, 78]);
assert.deepEqual(convert.rgb2hwb([140, 200, 100]), [96, 39, 22]);
assert.deepEqual(convert.rgb2cmyk([140, 200, 100]), [30, 0, 50, 22]); <a
href="0,0,0,1">assert.deepEqual(convert.rgb2cmyk(</a>), [0,0,0,100]);
...
assert.deepEqual(convert.rgb2lch([92, 191, 84]), [70, 67, 138]);</p>

<p>assert.deepEqual(convert.hsl2rgb([96, 48, 59]), [140, 201, 100]);
assert.deepEqual(convert.hsl2hsv([96, 48, 59]), [96, 50, 79]); //
colorpicker says [96,50,79] assert.deepEqual(convert.hsl2hwb([96, 48, 59]),
[96, 39, 21]); // computer round to 21, should be 22
assert.deepEqual(convert.hsl2cmyk([96, 48, 59]), [30, 0, 50, 21]);
assert.deepEqual(convert.hsl2keyword([240, 100, 50]), “blue”);</p>

<p>assert.deepEqual(convert.hsv2rgb([96, 50, 78]), [139, 199, 99]);
assert.deepEqual(convert.hsv2hsl([96, 50, 78]), [96, 47, 59]); <a
href="0,0,0">assert.deepEqual(convert.hsv2hsl(</a>), [0,0,0]);
assert.deepEqual(convert.hsv2hwb([96, 50, 78]), [96, 39, 22]);
assert.deepEqual(convert.hsv2cmyk([96, 50, 78]), [30, 0, 50, 22]);
assert.deepEqual(convert.hsv2keyword([240, 100, 100]), “blue”);</p>

<p>assert.deepEqual(convert.cmyk2rgb([30, 0, 50, 22]), [139, 199, 99]);
...
assert.deepEqual(convert.cmyk2keyword([100, 100, 0, 0]), “blue”);</p>

<p>assert.deepEqual(convert.keyword2rgb(“blue”), [0, 0, 255]);
...
assert.deepEqual(convert.keyword2xyz(“blue”), [18, 7, 95]);</p>

<p>assert.deepEqual(convert.xyz2rgb([25, 40, 15]), [97, 190, 85]);
assert.deepEqual(convert.xyz2rgb([50, 100, 100]), [0, 255, 241]);
assert.deepEqual(convert.xyz2lab([25, 40, 15]), [69, -48, 44]);
assert.deepEqual(convert.xyz2lch([25, 40, 15]), [69, 65, 137]);</p>

<p>assert.deepEqual(convert.lab2xyz([69, -48, 44]), [25, 39, 15]);
assert.deepEqual(convert.lab2rgb([75, 20, -30]), [194, 175, 240]);
assert.deepEqual(convert.lab2lch([69, -48, 44]), [69, 65, 137]);</p>

<p>assert.deepEqual(convert.lch2lab([69, 65, 137]), [69, -48, 44]);
assert.deepEqual(convert.lch2xyz([69, 65, 137]), [25, 39, 15]);
assert.deepEqual(convert.lch2rgb([69, 65, 137]), [98, 188, 83]);</p>

<p>// non-array arguments assert.deepEqual(convert.hsl2rgb(96, 48, 59), [140,
201, 100]);</p>

<p>// raw functions function round(vals) {</p>

<pre>for (var i = 0; i &lt; vals.length; i++)
  vals[i] = vals[i].toFixed(1);
return vals;</pre>

<p>}</p>

<p>assert.deepEqual(round(convert.hsl2rgbRaw([96, 48, 59])), [140.4, 200.6,
100.3]); assert.deepEqual(round(convert.rgb2hslRaw([140, 200, 100])), [96,
47.6, 58.8]);</p>

<p>assert.deepEqual(round(convert.hsv2rgbRaw([96, 50, 78])), [139.2, 198.9,
99.5]); assert.deepEqual(round(convert.rgb2hsvRaw([140, 200, 100])), [96,
50, 78.4]);</p>

<p>assert.deepEqual(round(convert.hwb2rgbRaw([96, 39, 22])), [139.2, 198.9,
99.5]); assert.deepEqual(round(convert.rgb2hwbRaw([140, 200, 100])), [96,
39.2, 21.6]);</p>

<p>assert.deepEqual(round(convert.cmyk2rgbRaw([30, 0, 50, 22])), [139.2,
198.9, 99.5]); assert.deepEqual(round(convert.rgb2cmykRaw([140, 200,
100])), [30, 0, 50, 21.6]);</p>

<p>assert.deepEqual(round(convert.keyword2rgbRaw(“blue”)), [0, 0, 255]);
assert.deepEqual(convert.rgb2keywordRaw([255, 228, 196]), “bisque”);</p>

<p>assert.deepEqual(round(convert.hsv2hslRaw([96, 50, 78])), [96, 47, 58.5]);
assert.deepEqual(round(convert.hsl2hsvRaw([96, 48, 59])), [96, 50, 78.7]);</p>

<p>assert.deepEqual(round(convert.hsl2hsvRaw([96, 48, 59])), [96, 50, 78.7]);</p>

<p>assert.deepEqual(round(convert.xyz2rgbRaw([25, 40, 15])), [97.4, 189.9,
85]); assert.deepEqual(round(convert.rgb2xyzRaw([92, 191, 84])), [24.6,
40.2, 14.8]);</p>

<p>assert.deepEqual(round(convert.rgb2labRaw([92, 191, 84])), [69.6, -50.1,
44.6]);</p>

<p>// hashed var val = [140, 200, 100]; <a
href=""rgb"">assert.deepEqual(convert</a>[“hsl”](val),
convert.rgb2hsl(val)); <a
href=""rgb"">assert.deepEqual(convert</a>[“hsv”](val),
convert.rgb2hsv(val)); <a
href=""rgb"">assert.deepEqual(convert</a>[“hwb”](val),
convert.rgb2hwb(val)); <a
href=""rgb"">assert.deepEqual(convert</a>[“cmyk”](val),
convert.rgb2cmyk(val)); <a
href=""rgb"">assert.deepEqual(convert</a>[“xyz”](val),
convert.rgb2xyz(val)); <a
href=""rgb"">assert.deepEqual(convert</a>[“lab”](val),
convert.rgb2lab(val)); <a
href=""rgb"">assert.deepEqual(convert</a>[“keyword”]([255, 228, 196]),
“bisque”);</p>

<p>val = [96, 48, 59]; <a
href=""hsl"">assert.deepEqual(convert</a>[“rgb”](val),
convert.hsl2rgb(val)); <a
href=""hsl"">assert.deepEqual(convert</a>[“hsv”](val),
convert.hsl2hsv(val)); <a
href=""hsl"">assert.deepEqual(convert</a>[“hwb”](val),
convert.hsl2hwb(val)); <a
href=""hsl"">assert.deepEqual(convert</a>[“cmyk”](val),
convert.hsl2cmyk(val)); <a
href=""hsl"">assert.deepEqual(convert</a>[“keyword”](val),
convert.hsl2keyword(val  ));</p>

<p>val = [96, 50, 78]; <a
href=""hsv"">assert.deepEqual(convert</a>[“rgb”](val),
convert.hsv2rgb(val)); <a
href=""hsv"">assert.deepEqual(convert</a>[“hsl”](val),
convert.hsv2hsl(val)); <a
href=""hsv"">assert.deepEqual(convert</a>[“hwb”](val),
convert.hsv2hwb(val)); <a
href=""hsv"">assert.deepEqual(convert</a>[“cmyk”](val),
convert.hsv2cmyk(val)); <a
href=""hsv"">assert.deepEqual(convert</a>[“keyword”](val),
convert.hsv2keyword(val));</p>

<p>val = [30, 0, 50, 22]; <a
href=""cmyk"">assert.deepEqual(convert</a>[“rgb”](val),
convert.cmyk2rgb(val)); <a
href=""cmyk"">assert.deepEqual(convert</a>[“hsl”](val),
convert.cmyk2hsl(val)); <a
href=""cmyk"">assert.deepEqual(convert</a>[“hsv”](val),
convert.cmyk2hsv(val)); <a
href=""cmyk"">assert.deepEqual(convert</a>[“hwb”](val),
convert.cmyk2hwb(val)); <a
href=""cmyk"">assert.deepEqual(convert</a>[“keyword”](val),
convert.cmyk2keyword(val));</p>

<p>val = “blue”; <a href=""keyword"">assert.deepEqual(convert</a>[“rgb”](val),
convert.keyword2rgb(val)); <a
href=""keyword"">assert.deepEqual(convert</a>[“hsl”](val),
convert.keyword2hsl(val)); <a
href=""keyword"">assert.deepEqual(convert</a>[“hsv”](val),
convert.keyword2hsv(val)); <a
href=""keyword"">assert.deepEqual(convert</a>[“hwb”](val),
convert.keyword2hwb(val)); <a
href=""keyword"">assert.deepEqual(convert</a>[“cmyk”](val),
convert.keyword2cmyk(val)); <a
href=""keyword"">assert.deepEqual(convert</a>[“lab”](val),
convert.keyword2lab(val)); <a
href=""keyword"">assert.deepEqual(convert</a>[“xyz”](val),
convert.keyword2xyz(val));</p>

<p>val = [25, 40, 15] <a
href=""xyz"">assert.deepEqual(convert</a>[“rgb”](val),
convert.xyz2rgb(val)); <a
href=""xyz"">assert.deepEqual(convert</a>[“lab”](val),
convert.xyz2lab(val));</p>

<p>val = [69, -48, 44]; <a
href=""lab"">assert.deepEqual(convert</a>[“xyz”](val), [25, 39, 15]);</p>

<p>// converter var converter = convert();</p>

<p>var vals = [140, 200, 100]; converter.rgb(140, 200, 100);</p>

<p>assert.deepEqual(converter.hsl(), convert.rgb2hsl(vals));
...
assert.deepEqual(converter.rgb([255, 228, 196]).keyword(), “bisque”);</p>

<p>vals = [96, 48, 59]; converter.hsl(vals); assert.deepEqual(converter.rgb(),
convert.hsl2rgb(vals)); assert.deepEqual(converter.hsv(),
convert.hsl2hsv(vals)); assert.deepEqual(converter.cmyk(),
convert.hsl2cmyk(vals)); assert.deepEqual(converter.keyword(),
convert.hsl2keyword(vals));</p>

<p>// hwb // <a
href="http://dev.w3.org/csswg/css-color/#hwb-examples">dev.w3.org/csswg/css-color/#hwb-examples</a></p>

<p>// all extrem value should give black, white or grey for(var angle = 0;
angle &lt;= 360; angle ++) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">deepEqual</span>(<span class="ruby-identifier">convert</span>.<span class="ruby-identifier">hwb2rgb</span>([<span class="ruby-identifier">angle</span>, <span class="ruby-value">0</span>, <span class="ruby-value">100</span>]), [<span class="ruby-value">0</span>, <span class="ruby-value">0</span>, <span class="ruby-value">0</span>]);
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">deepEqual</span>(<span class="ruby-identifier">convert</span>.<span class="ruby-identifier">hwb2rgb</span>([<span class="ruby-identifier">angle</span>, <span class="ruby-value">100</span>, <span class="ruby-value">0</span>]), [<span class="ruby-value">255</span>, <span class="ruby-value">255</span>, <span class="ruby-value">255</span>]);
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">deepEqual</span>(<span class="ruby-identifier">convert</span>.<span class="ruby-identifier">hwb2rgb</span>([<span class="ruby-identifier">angle</span>, <span class="ruby-value">100</span>, <span class="ruby-value">100</span>]), [<span class="ruby-value">128</span>, <span class="ruby-value">128</span>, <span class="ruby-value">128</span>]);
</pre>

<p>}</p>

<p>assert.deepEqual(convert.hwb2rgb([0, 0, 0]), [255,0,0]);
assert.deepEqual(convert.hwb2rgb([0, 20, 40]), [153, 51, 51]);
assert.deepEqual(convert.hwb2rgb([0, 40, 40]), [153, 102, 102]);
assert.deepEqual(convert.hwb2rgb([0, 40, 20]), [204, 102, 102]);</p>

<p>assert.deepEqual(convert.hwb2rgb([120, 0, 0]), [0,255,0]);
assert.deepEqual(convert.hwb2rgb([120, 20, 40]), [51, 153, 51]);
assert.deepEqual(convert.hwb2rgb([120, 40, 40]), [102, 153, 102]);
assert.deepEqual(convert.hwb2rgb([120, 40, 20]), [102, 204, 102]);</p>

<p>assert.deepEqual(convert.hwb2rgb([240, 0, 0]), [0,0,255]);
assert.deepEqual(convert.hwb2rgb([240, 20, 40]), [51, 51, 153]);
assert.deepEqual(convert.hwb2rgb([240, 40, 40]), [102, 102, 153]);
assert.deepEqual(convert.hwb2rgb([240, 40, 20]), [102, 102, 204]);</p>

<p>// black should always stay black val = [0, 0, 0];
...
assert.deepEqual(convert.hsl2cmyk(val), [0, 0, 0, 100]);</p>
</main>
