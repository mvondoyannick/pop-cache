...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-color-convert+rdoc-image-3Ahttps-3A-2F-2Ftravis-ci.org-2Fharthur-2Fcolor-convert.svg-3Fbranch-3Dmaster">color-convert <a href="https://travis-ci.org/harthur/color-convert"><img src="https://travis-ci.org/harthur/color-convert.svg?branch=master"></a></a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-API">API</a>
    <li><a href="#label-Plain+functions">Plain functions</a>
    <li><a href="#label-Unrounded">Unrounded</a>
    <li><a href="#label-Hash">Hash</a>
    <li><a href="#label-Other+spaces">Other spaces</a>
...
<h1 id="label-color-convert+rdoc-image-3Ahttps-3A-2F-2Ftravis-ci.org-2Fharthur-2Fcolor-convert.svg-3Fbranch-3Dmaster">color-convert <a href="https://travis-ci.org/harthur/color-convert"><img src="https://travis-ci.org/harthur/color-convert.svg?branch=master"></a><span><a href="#label-color-convert+rdoc-image-3Ahttps-3A-2F-2Ftravis-ci.org-2Fharthur-2Fcolor-convert.svg-3Fbranch-3Dmaster">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Color-convert is a color conversion library for JavaScript and node. It
converts all ways between <code>rgb</code>, <code>hsl</code>,
<code>hsv</code>, <code>hwb</code>, <code>cmyk</code>, and CSS keywords:</p>

<pre>var converter = require(&quot;color-convert&quot;)();

converter.rgb(140, 200, 100).hsl()   // [96, 48, 59]

converter.keyword(&quot;blue&quot;).rgb()      // [0, 0, 255]</pre>

<h1 id="label-Install">Install<span><a href="#label-Install">&para;</a> <a href="#top">&uarr;</a></span></h1>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">color</span><span class="ruby-operator">-</span><span class="ruby-identifier">convert</span>
</pre>

<h1 id="label-API">API<span><a href="#label-API">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Color-convert exports a converter object with getter/setter methods for
each color space. It caches conversions:</p>

<pre>var converter = require(&quot;color-convert&quot;)();

converter.rgb(140, 200, 100).hsl()   // [96, 48, 59]

converter.rgb([140, 200, 100])       // args can be an array</pre>

<h3 id="label-Plain+functions">Plain functions<span><a href="#label-Plain+functions">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Get direct conversion functions with no fancy objects:</p>

<pre class="ruby"><span class="ruby-identifier">require</span>(<span class="ruby-string">&quot;color-convert&quot;</span>).<span class="ruby-identifier">rgb2hsl</span>([<span class="ruby-value">140</span>, <span class="ruby-value">200</span>, <span class="ruby-value">100</span>]);   <span class="ruby-regexp">//</span> [<span class="ruby-value">96</span>, <span class="ruby-value">48</span>, <span class="ruby-value">59</span>]
</pre>

<h3 id="label-Unrounded">Unrounded<span><a href="#label-Unrounded">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To get the unrounded conversion, append <code>Raw</code> to the function
name:</p>

<pre class="ruby"><span class="ruby-identifier">convert</span>.<span class="ruby-identifier">rgb2hslRaw</span>([<span class="ruby-value">140</span>, <span class="ruby-value">200</span>, <span class="ruby-value">100</span>]);   <span class="ruby-regexp">//</span> [<span class="ruby-value">95.99999999999999</span>, <span class="ruby-value">47.619047619047606</span>, <span class="ruby-value">58.82352941176471</span>]
</pre>

<h3 id="label-Hash">Hash<span><a href="#label-Hash">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>There&#39;s also a hash of the conversion functions keyed first by the
“from” color space, then by the “to” color space:</p>

<pre>convert[&quot;hsl&quot;][&quot;hsv&quot;]([160, 0, 20]) == convert.hsl2hsv([160, 0, 20])</pre>

<h3 id="label-Other+spaces">Other spaces<span><a href="#label-Other+spaces">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>There are some conversions from rgb (sRGB) to XYZ and LAB too, available as
<code>rgb2xyz()</code>, <code>rgb2lab()</code>, <code>xyz2rgb()</code>, and
<code>xyz2lab()</code>.</p>

<h1 id="label-Contribute">Contribute<span><a href="#label-Contribute">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Please fork, add conversions, figure out color profile stuff for XYZ, LAB,
etc. This is meant to be a basic library that can be used by other
libraries to wrap color calculations in some cool way.</p>
</main>
