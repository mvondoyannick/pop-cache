...
<title>mixins.less - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/font-awesome/less/mixins.less">
...
<p>.fa-icon-rotate(@degrees, @rotation) {</p>

<pre>-ms-filter: &quot;progid:DXImageTransform.Microsoft.BasicImage(rotation=@{rotation})&quot;;
-webkit-transform: rotate(@degrees);
    -ms-transform: rotate(@degrees);
        transform: rotate(@degrees);</pre>

<p>}</p>

<p>.fa-icon-flip(@horiz, @vert, @rotation) {</p>

<pre>-ms-filter: &quot;progid:DXImageTransform.Microsoft.BasicImage(rotation=@{rotation}, mirror=1)&quot;;
-webkit-transform: scale(@horiz, @vert);
    -ms-transform: scale(@horiz, @vert);
        transform: scale(@horiz, @vert);</pre>

<p>}</p>

<p>// Only display content to screen readers. A la Bootstrap 4. // // See: <a
href="http://a11yproject.com/posts/how-to-hide-content">a11yproject.com/posts/how-to-hide-content</a>/</p>
...
<p>// Use in conjunction with .sr-only to only display content when it&#39;s
focused. // // Useful for “Skip to main content” links; see <a
href="http://www.w3.org/TR/2013/NOTE-WCAG20-TECHS-20130905/G1">www.w3.org/TR/2013/NOTE-WCAG20-TECHS-20130905/G1</a>
// // Credit: HTML5 Boilerplate</p>

<p>.sr-only-focusable() {</p>
