...
<main role="main" aria-label="Page node_modules/font-awesome/less/variables.less">

<p>// Variables // ————————–</p>

<p>@fa-font-path:        “../fonts”; @fa-font-size-base:   14px;
@fa-line-height-base: 1; //@fa-font-path:       
“//netdna.bootstrapcdn.com/font-awesome/4.7.0/fonts”; // for referencing
Bootstrap CDN font files directly @fa-css-prefix:       fa; @fa-version:   
“4.7.0”; @fa-border-color:     eee; @fa-inverse:          fff;
@fa-li-width:         (30em / 14);</p>
