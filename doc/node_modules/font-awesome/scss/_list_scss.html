...
<title>_list.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/font-awesome/scss/_list.scss">

<p>// List Icons // ————————-</p>

<p>.#{$fa-css-prefix}-ul {</p>

<pre>padding-left: 0;
margin-left: $fa-li-width;
list-style-type: none;
&gt; li { position: relative; }</pre>

<p>} .#{$fa-css-prefix}-li {</p>
