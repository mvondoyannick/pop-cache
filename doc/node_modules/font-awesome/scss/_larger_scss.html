...
<title>_larger.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/font-awesome/scss/_larger.scss">

<p>// Icon Sizes // ————————-</p>

<pre>makes the font 33% larger relative to the icon container</pre>

<p>.#{$fa-css-prefix}-lg {</p>

<pre>font-size: (4em / 3);
line-height: (3em / 4);
vertical-align: -15%;</pre>

<p>} .#{$fa-css-prefix}-2x { font-size: 2em; } .#{$fa-css-prefix}-3x {
font-size: 3em; } .#{$fa-css-prefix}-4x { font-size: 4em; }
.#{$fa-css-prefix}-5x { font-size: 5em; }</p>
</main>
