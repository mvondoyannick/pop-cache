...
<title>_stacked.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/font-awesome/scss/_stacked.scss">

<p>// Stacked Icons // ————————-</p>

<p>.#{$fa-css-prefix}-stack {</p>
...
<p>} .#{$fa-css-prefix}-stack-1x, .#{$fa-css-prefix}-stack-2x {</p>
...
<p>} .#{$fa-css-prefix}-stack-1x { line-height: inherit; }
.#{$fa-css-prefix}-stack-2x { font-size: 2em; } .#{$fa-css-prefix}-inverse
{ color: $fa-inverse; }</p>
</main>
