...
<main role="main" aria-label="Page node_modules/font-awesome/scss/_mixins.scss">
...
<p>@mixin fa-icon-rotate($degrees, $rotation) {</p>
...
<p>@mixin fa-icon-flip($horiz, $vert, $rotation) {</p>
