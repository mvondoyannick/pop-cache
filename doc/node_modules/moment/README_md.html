...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Port+to+ECMAScript+6+-28version+2.10.0-29">Port to ECMAScript 6 (version 2.10.0)</a>
    <li><a href="#label-Upgrading+to+2.0.0">Upgrading to 2.0.0</a>
    <li><a href="#label-Changelog"><a href="https://github.com/moment/moment/blob/develop/CHANGELOG.md">Changelog</a></a>
    <li><a href="#label-Contributing+rdoc-image-3Ahttps-3A-2F-2Fwww.codetriage.com-2Fmoment-2Fmoment-2Fbadges-2Fusers.svg"><a href="https://github.com/moment/moment/blob/develop/CONTRIBUTING.md">Contributing</a> <a href="https://www.codetriage.com/moment/moment"><img src="https://www.codetriage.com/moment/moment/badges/users.svg"></a></a>
...
<main role="main" aria-label="Page node_modules/moment/README.md">

<p><a
href="https://gitter.im/moment/moment?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"><img
src="https://badges.gitter.im/Join%20Chat.svg"></a></p>

<p><a href="https://npmjs.org/package/moment"><img
src="http://img.shields.io/npm/v/moment.svg?style=flat"></a> <a
href="https://npmcharts.com/compare/moment?minimal=true"><img
src="http://img.shields.io/npm/dm/moment.svg?style=flat"></a> <a
href="LICENSE"><img
src="http://img.shields.io/badge/license-MIT-blue.svg?style=flat"></a> <a
href="http://travis-ci.org/moment/moment"><img
src="http://img.shields.io/travis/moment/moment/develop.svg?style=flat"></a>
<a href="https://coveralls.io/r/moment/moment?branch=develop"><img
src="https://coveralls.io/repos/moment/moment/badge.svg?branch=develop"></a>
<a
href="https://app.fossa.io/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fmoment%2Fmoment?ref=badge_shield"><img
src="https://app.fossa.io/api/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fmoment%2Fmoment.svg?type=shield"></a>
<a
href="https://dependabot.com/compatibility-score.html?dependency-name=moment&package-manager=npm_and_yarn&version-scheme=semver"><img
src="https://api.dependabot.com/badges/compatibility_score?dependency-name=moment&package-manager=npm_and_yarn&version-scheme=semver"></a></p>

<p>A lightweight JavaScript date library for parsing, validating,
manipulating, and formatting dates.</p>

<p><strong><a href="http://momentjs.com/docs/">Documentation</a></strong></p>

<h2 id="label-Port+to+ECMAScript+6+-28version+2.10.0-29">Port to ECMAScript 6 (version 2.10.0)<span><a href="#label-Port+to+ECMAScript+6+-28version+2.10.0-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Moment 2.10.0 does not bring any new features, but the code is now written
in ECMAScript 6 modules and placed inside <code>src/</code>. Previously
<code>moment.js</code>, <code>locale/*.js</code> and
<code>test/moment/*.js</code>, <code>test/locale/*.js</code> contained the
source of the project. Now the source is in <code>src/</code>, temporary
build (ECMAScript 5) files are placed under <code>build/umd/</code> (for
running tests during development), and the <code>moment.js</code> and
...
<code>grunt transpile update-index</code>, so <code>moment.js</code> and
<code>locales/*.js</code> are synced with <code>src/*</code>. We might
place that in a commit hook in the future.</p>

<h2 id="label-Upgrading+to+2.0.0">Upgrading to 2.0.0<span><a href="#label-Upgrading+to+2.0.0">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>There are a number of small backwards incompatible changes with version
2.0.0. <a
href="https://gist.github.com/timrwood/e72f2eef320ed9e37c51#backwards-incompatible-changes">See
the full descriptions here</a></p>
<ul><li>
<p>Changed language ordinal method to return the number + ordinal instead of
just the ordinal.</p>
</li><li>
<p>Changed two digit year parsing cutoff to match strptime.</p>
</li><li>
<p>Removed <code>moment#sod</code> and <code>moment#eod</code> in favor of
<code>moment#startOf</code> and <code>moment#endOf</code>.</p>
</li><li>
<p>Removed <code>moment.humanizeDuration()</code> in favor of
<code>moment.duration().humanize()</code>.</p>
</li><li>
<p>Removed the lang data objects from the top level namespace.</p>
</li><li>
<p>Duplicate <code>Date</code> passed to <code>moment()</code> instead of
referencing it.</p>
</li></ul>

<h2 id="label-Changelog"><a href="https://github.com/moment/moment/blob/develop/CHANGELOG.md">Changelog</a><span><a href="#label-Changelog">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Contributing+rdoc-image-3Ahttps-3A-2F-2Fwww.codetriage.com-2Fmoment-2Fmoment-2Fbadges-2Fusers.svg"><a href="https://github.com/moment/moment/blob/develop/CONTRIBUTING.md">Contributing</a> <a href="https://www.codetriage.com/moment/moment"><img src="https://www.codetriage.com/moment/moment/badges/users.svg"></a><span><a href="#label-Contributing+rdoc-image-3Ahttps-3A-2F-2Fwww.codetriage.com-2Fmoment-2Fmoment-2Fbadges-2Fusers.svg">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>We&#39;re looking for co-maintainers! If you want to become a master of
time please write to <a href="https://github.com/ichernev">ichernev</a>.</p>

<p>In addition to contributing code, you can help to triage issues. This can
include reproducing bug reports, or asking for vital information such as
version numbers or reproduction instructions. If you would like to start
triaging issues, one easy way to get started is to <a
href="https://www.codetriage.com/moment/moment">subscribe to moment/moment
on CodeTriage</a>.</p>
...
<p>Moment.js is freely distributable under the terms of the <a
href="https://github.com/moment/moment/blob/develop/LICENSE">MIT
license</a>.</p>

<p><a
href="https://app.fossa.io/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fmoment%2Fmoment?ref=badge_large"><img
src="https://app.fossa.io/api/projects/git%2Bhttps%3A%2F%2Fgithub.com%2Fmoment%2Fmoment.svg?type=large"></a></p>
</main>
