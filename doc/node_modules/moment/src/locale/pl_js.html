...
<main role="main" aria-label="Page node_modules/moment/src/locale/pl.js">

<p>//! moment.js locale configuration //! locale : Polish [pl] //! author :
Rafal Hirsz : <a href="https://github.com/evoL">github.com/evoL</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var monthsNominative =
&#39;styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień&#39;.split(&#39;_&#39;),</p>

<pre class="ruby"><span class="ruby-identifier">monthsSubjective</span> = <span class="ruby-string">&#39;stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia&#39;</span>.<span class="ruby-identifier">split</span>(<span class="ruby-string">&#39;_&#39;</span>);
</pre>

<p>function plural(n) {</p>

<pre>return (n % 10 &lt; 5) &amp;&amp; (n % 10 &gt; 1) &amp;&amp; ((~~(n / 10) % 10) !== 1);</pre>

<p>} function translate(number, withoutSuffix, key) {</p>
...
<p>export default moment.defineLocale(&#39;pl&#39;, {</p>

<pre>months : function (momentToFormat, format) {
    if (!momentToFormat) {
