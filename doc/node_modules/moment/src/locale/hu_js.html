...
<main role="main" aria-label="Page node_modules/moment/src/locale/hu.js">

<p>//! moment.js locale configuration //! locale : Hungarian [hu] //! author :
Adam Brunner : <a
href="https://github.com/adambrunner">github.com/adambrunner</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var weekEndings = &#39;vasárnap hétfőn kedden szerdán csütörtökön pénteken
szombaton&#39;.split(&#39; &#39;); function translate(number,
withoutSuffix, key, isFuture) {</p>
...
<p>} function week(isFuture) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (<span class="ruby-identifier">isFuture</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&#39;[múlt] &#39;</span>) <span class="ruby-operator">+</span> <span class="ruby-string">&#39;[&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">weekEndings</span>[<span class="ruby-identifier">this</span>.<span class="ruby-identifier">day</span>()] <span class="ruby-operator">+</span> <span class="ruby-string">&#39;] LT[-kor]&#39;</span>;
</pre>

<p>}</p>

<p>export default moment.defineLocale(&#39;hu&#39;, {</p>

<pre>months : &#39;január_február_március_április_május_június_július_augusztus_szeptember_október_november_december&#39;.split(&#39;_&#39;),
