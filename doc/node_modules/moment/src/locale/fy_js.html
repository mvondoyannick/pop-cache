...
<title>fy.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/locale/fy.js">

<p>//! moment.js locale configuration //! locale : Frisian [fy] //! author :
Robin van der Vliet : <a
href="https://github.com/robin0van0der0v">github.com/robin0van0der0v</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var monthsShortWithDots =
&#39;jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.&#39;.split(&#39;_&#39;),</p>

<pre class="ruby"><span class="ruby-identifier">monthsShortWithoutDots</span> = <span class="ruby-string">&#39;jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des&#39;</span>.<span class="ruby-identifier">split</span>(<span class="ruby-string">&#39;_&#39;</span>);
</pre>

<p>export default moment.defineLocale(&#39;fy&#39;, {</p>

<pre>months : &#39;jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber&#39;.split(&#39;_&#39;),
