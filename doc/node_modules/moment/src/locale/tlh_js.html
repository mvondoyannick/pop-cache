...
<title>tlh.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/locale/tlh.js">

<p>//! moment.js locale configuration //! locale : Klingon [tlh] //! author :
Dominika Kruk : <a
href="https://github.com/amaranthrose">github.com/amaranthrose</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var numbersNouns =
&#39;pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut&#39;.split(&#39;_&#39;);</p>

<p>function translateFuture(output) {</p>
...
<p>function translatePast(output) {</p>
...
<p>function translate(number, withoutSuffix, string, isFuture) {</p>

<pre>var numberNoun = numberAsNoun(number);
switch (string) {
    case &#39;ss&#39;:
...
<p>function numberAsNoun(number) {</p>

<pre>var hundred = Math.floor((number % 1000) / 100),
...
return (word === &#39;&#39;) ? &#39;pagh&#39; : word;</pre>

<p>}</p>

<p>export default moment.defineLocale(&#39;tlh&#39;, {</p>

<pre>months : &#39;tera’ jar wa’_tera’ jar cha’_tera’ jar wej_tera’ jar loS_tera’ jar vagh_tera’ jar jav_tera’ jar Soch_tera’ jar chorgh_tera’ jar Hut_tera’ jar wa’maH_tera’ jar wa’maH wa’_tera’ jar wa’maH cha’&#39;.split(&#39;_&#39;),
