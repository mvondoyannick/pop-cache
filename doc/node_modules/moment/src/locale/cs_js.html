...
<main role="main" aria-label="Page node_modules/moment/src/locale/cs.js">

<p>//! moment.js locale configuration //! locale : Czech [cs] //! author :
petrbela : <a href="https://github.com/petrbela">github.com/petrbela</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var months =
&#39;leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec&#39;.split(&#39;_&#39;),</p>

<pre class="ruby"><span class="ruby-identifier">monthsShort</span> = <span class="ruby-string">&#39;led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro&#39;</span>.<span class="ruby-identifier">split</span>(<span class="ruby-string">&#39;_&#39;</span>);
</pre>

<p>var monthsParse = [/^led/i, /^úno/i, /^bře/i, /^dub/i, /^kvě/i,
/^(čvn|červen$|června)/i, /^(čvc|červenec|července)/i, /^srp/i, /^zář/i,
/^říj/i, /^lis/i, /^pro/i]; // NOTE: &#39;červen&#39; is substring of
&#39;červenec&#39;; therefore &#39;červenec&#39; must precede
&#39;červen&#39; in the regex to be fully matched. // Otherwise parser
matches &#39;1. červenec&#39; as &#39;1. červen&#39; + &#39;ec&#39;. var
monthsRegex =
/^(leden|únor|březen|duben|květen|červenec|července|červen|června|srpen|září|říjen|listopad|prosinec|led|úno|bře|dub|kvě|čvn|čvc|srp|zář|říj|lis|pro)/i;</p>

<p>function plural(n) {</p>

<pre>return (n &gt; 1) &amp;&amp; (n &lt; 5) &amp;&amp; (~~(n / 10) !== 1);</pre>

<p>} function translate(number, withoutSuffix, key, isFuture) {</p>

<pre>var result = number + &#39; &#39;;
switch (key) {
...
<p>export default moment.defineLocale(&#39;cs&#39;, {</p>
