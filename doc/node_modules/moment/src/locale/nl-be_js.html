...
<title>nl-be.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/locale/nl-be.js">

<p>//! moment.js locale configuration //! locale : Dutch (Belgium) [nl-be] //!
author : Joris Röling : <a
href="https://github.com/jorisroling">github.com/jorisroling</a> //! author
: Jacob Middag : <a
href="https://github.com/middagj">github.com/middagj</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var monthsShortWithDots =
&#39;jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.&#39;.split(&#39;_&#39;),</p>

<pre class="ruby"><span class="ruby-identifier">monthsShortWithoutDots</span> = <span class="ruby-string">&#39;jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec&#39;</span>.<span class="ruby-identifier">split</span>(<span class="ruby-string">&#39;_&#39;</span>);
</pre>

<p>var monthsParse = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i,
/^<a href="i.">jun</a>?$/i, /^<a href="i.">jul</a>?$/i, /^aug/i, /^sep/i,
/^okt/i, /^nov/i, /^dec/i]; var monthsRegex = /^(<a
href="nl">januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december|jan.?|feb.?|mrt.?|apr.?|ju</a>.?|aug.?|sep.?|okt.?|nov.?|dec.?)/i;</p>

<p>export default moment.defineLocale(&#39;nl-be&#39;, {</p>

<pre>months : &#39;januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december&#39;.split(&#39;_&#39;),
