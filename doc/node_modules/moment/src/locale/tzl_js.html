...
<title>tzl.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/locale/tzl.js">

<p>//! moment.js locale configuration //! locale : Talossan [tzl] //! author :
Robin van der Vliet : <a
href="https://github.com/robin0van0der0v">github.com/robin0van0der0v</a>
//! author : Iustì Canun</p>

<p>import moment from &#39;../moment&#39;;</p>

<p>// After the year there should be a slash and the amount of years since
December 26, 1979 in Roman numerals. // This is currently too difficult
(maybe even impossible) to add. export default
moment.defineLocale(&#39;tzl&#39;, {</p>

<pre>months : &#39;Januar_Fevraglh_Març_Avrïu_Mai_Gün_Julia_Guscht_Setemvar_Listopäts_Noemvar_Zecemvar&#39;.split(&#39;_&#39;),
...
<p>function processRelativeTime(number, withoutSuffix, key, isFuture) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">format</span> = {
    <span class="ruby-value">&#39;s&#39;:</span> [<span class="ruby-string">&#39;viensas secunds&#39;</span>, <span class="ruby-string">&#39;\&#39;iensas secunds&#39;</span>],
    <span class="ruby-value">&#39;ss&#39;:</span> [<span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; secunds&#39;</span>, <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; secunds&#39;</span>],
    <span class="ruby-value">&#39;m&#39;:</span> [<span class="ruby-string">&#39;\&#39;n míut&#39;</span>, <span class="ruby-string">&#39;\&#39;iens míut&#39;</span>],
    <span class="ruby-value">&#39;mm&#39;:</span> [<span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; míuts&#39;</span>, <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; míuts&#39;</span>],
    <span class="ruby-value">&#39;h&#39;:</span> [<span class="ruby-string">&#39;\&#39;n þora&#39;</span>, <span class="ruby-string">&#39;\&#39;iensa þora&#39;</span>],
    <span class="ruby-value">&#39;hh&#39;:</span> [<span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; þoras&#39;</span>, <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; þoras&#39;</span>],
    <span class="ruby-value">&#39;d&#39;:</span> [<span class="ruby-string">&#39;\&#39;n ziua&#39;</span>, <span class="ruby-string">&#39;\&#39;iensa ziua&#39;</span>],
    <span class="ruby-value">&#39;dd&#39;:</span> [<span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; ziuas&#39;</span>, <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; ziuas&#39;</span>],
    <span class="ruby-value">&#39;M&#39;:</span> [<span class="ruby-string">&#39;\&#39;n mes&#39;</span>, <span class="ruby-string">&#39;\&#39;iens mes&#39;</span>],
    <span class="ruby-value">&#39;MM&#39;:</span> [<span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; mesen&#39;</span>, <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; mesen&#39;</span>],
    <span class="ruby-value">&#39;y&#39;:</span> [<span class="ruby-string">&#39;\&#39;n ar&#39;</span>, <span class="ruby-string">&#39;\&#39;iens ar&#39;</span>],
    <span class="ruby-value">&#39;yy&#39;:</span> [<span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; ars&#39;</span>, <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">number</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; ars&#39;</span>]
};
<span class="ruby-keyword">return</span> <span class="ruby-identifier">isFuture</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">format</span>[<span class="ruby-identifier">key</span>][<span class="ruby-value">0</span>] <span class="ruby-operator">:</span> (<span class="ruby-identifier">withoutSuffix</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">format</span>[<span class="ruby-identifier">key</span>][<span class="ruby-value">0</span>] <span class="ruby-operator">:</span> <span class="ruby-identifier">format</span>[<span class="ruby-identifier">key</span>][<span class="ruby-value">1</span>]);
</pre>
