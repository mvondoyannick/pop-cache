...
<title>ru.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/locale/ru.js">

<p>//! moment.js locale configuration //! locale : Russian [ru] //! author :
Viktorminator : <a
href="https://github.com/Viktorminator">github.com/Viktorminator</a> //!
Author : Menelion Elensúle : <a
href="https://github.com/Oire">github.com/Oire</a> //! author : Коренберг
Марк : <a href="https://github.com/socketpair">github.com/socketpair</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>function plural(word, num) {</p>

<pre>var forms = word.split(&#39;_&#39;);
return num % 10 === 1 &amp;&amp; num % 100 !== 11 ? forms[0] : (num % 10 &gt;= 2 &amp;&amp; num % 10 &lt;= 4 &amp;&amp; (num % 100 &lt; 10 || num % 100 &gt;= 20) ? forms[1] : forms[2]);</pre>
...
<p>} var monthsParse = [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^<a
href="йя">ма</a>/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i,
/^дек/i];</p>

<p>// <a
href="http://new.gramota.ru/spravka/rules/139-prop">new.gramota.ru/spravka/rules/139-prop</a>
: § 103 // Сокращения месяцев: <a
href="http://new.gramota.ru/spravka/buro/search-answer?s=242637">new.gramota.ru/spravka/buro/search-answer?s=242637</a>
// CLDR data:          <a
href="http://www.unicode.org/cldr/charts/28/summary/ru.html#1753">www.unicode.org/cldr/charts/28/summary/ru.html#1753</a>
export default moment.defineLocale(&#39;ru&#39;, {</p>
