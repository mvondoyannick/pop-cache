...
<title>lb.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/locale/lb.js">

<p>//! moment.js locale configuration //! locale : Luxembourgish [lb] //!
author : mweimerskirch : <a
href="https://github.com/mweimerskirch">github.com/mweimerskirch</a> //!
author : David Raison : <a
href="https://github.com/kwisatz">github.com/kwisatz</a></p>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">format</span> = {
    <span class="ruby-value">&#39;m&#39;:</span> [<span class="ruby-string">&#39;eng Minutt&#39;</span>, <span class="ruby-string">&#39;enger Minutt&#39;</span>],
    <span class="ruby-value">&#39;h&#39;:</span> [<span class="ruby-string">&#39;eng Stonn&#39;</span>, <span class="ruby-string">&#39;enger Stonn&#39;</span>],
    <span class="ruby-value">&#39;d&#39;:</span> [<span class="ruby-string">&#39;een Dag&#39;</span>, <span class="ruby-string">&#39;engem Dag&#39;</span>],
    <span class="ruby-value">&#39;M&#39;:</span> [<span class="ruby-string">&#39;ee Mount&#39;</span>, <span class="ruby-string">&#39;engem Mount&#39;</span>],
    <span class="ruby-value">&#39;y&#39;:</span> [<span class="ruby-string">&#39;ee Joer&#39;</span>, <span class="ruby-string">&#39;engem Joer&#39;</span>]
};
...
<p>} function processFutureTime(string) {</p>

<pre>var number = string.substr(0, string.indexOf(&#39; &#39;));
if (eifelerRegelAppliesToNumber(number)) {
    return &#39;a &#39; + string;
}
return &#39;an &#39; + string;</pre>

<p>} function processPastTime(string) {</p>

<pre>var number = string.substr(0, string.indexOf(&#39; &#39;));
if (eifelerRegelAppliesToNumber(number)) {
    return &#39;viru &#39; + string;
}
return &#39;virun &#39; + string;</pre>

<p>}</p>

<pre>Returns true if the word before the given number loses the &#39;-n&#39; ending.
e.g. &#39;an 10 Deeg&#39; but &#39;a 5 Deeg&#39;

@param number {integer}
@returns {boolean}</pre>

<p>function eifelerRegelAppliesToNumber(number) {</p>

<pre>number = parseInt(number, 10);
if (isNaN(number)) {
    return false;
}
if (number &lt; 0) {
...
<p>export default moment.defineLocale(&#39;lb&#39;, {</p>

<pre>months: &#39;Januar_Februar_Mäerz_Abrëll_Mee_Juni_Juli_August_September_Oktober_November_Dezember&#39;.split(&#39;_&#39;),
