...
<main role="main" aria-label="Page node_modules/moment/src/locale/lv.js">

<p>//! moment.js locale configuration //! locale : Latvian [lv] //! author :
Kristaps Karlsons : <a
href="https://github.com/skakri">github.com/skakri</a> //! author : Jānis
Elmeris : <a href="https://github.com/JanisE">github.com/JanisE</a></p>

<p>import moment from &#39;../moment&#39;;</p>

<p>var units = {</p>

<pre>&#39;ss&#39;: &#39;sekundes_sekundēm_sekunde_sekundes&#39;.split(&#39;_&#39;),
...
&#39;yy&#39;: &#39;gada_gadiem_gads_gadi&#39;.split(&#39;_&#39;)</pre>

<p>};</p>

<pre>@param withoutSuffix boolean true = a length of time; false = before/after a period of time.</pre>

<p>function format(forms, number, withoutSuffix) {</p>

<pre>if (withoutSuffix) {
...
<p>} function relativeTimeWithPlural(number, withoutSuffix, key) {</p>
...
<p>} function relativeTimeWithSingular(number, withoutSuffix, key) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">format</span>(<span class="ruby-identifier">units</span>[<span class="ruby-identifier">key</span>], <span class="ruby-identifier">number</span>, <span class="ruby-identifier">withoutSuffix</span>);
</pre>

<p>} function relativeSeconds(number, withoutSuffix) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">withoutSuffix</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;dažas sekundes&#39;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&#39;dažām sekundēm&#39;</span>;
</pre>

<p>}</p>

<p>export default moment.defineLocale(&#39;lv&#39;, {</p>

<pre>months : &#39;janvāris_februāris_marts_aprīlis_maijs_jūnijs_jūlijs_augusts_septembris_oktobris_novembris_decembris&#39;.split(&#39;_&#39;),
