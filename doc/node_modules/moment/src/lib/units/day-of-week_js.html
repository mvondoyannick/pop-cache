...
<title>day-of-week.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/day-of-week.js">

<p>import { addFormatToken } from &#39;../format/format&#39;; import {
addUnitAlias } from &#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match1to2, matchWord,
regexEscape } from &#39;../parse/regex&#39;; import { addWeekParseToken }
from &#39;../parse/token&#39;; import toInt from &#39;../utils/to-int&#39;;
import isArray from &#39;../utils/is-array&#39;; import indexOf from
&#39;../utils/index-of&#39;; import hasOwnProp from
&#39;../utils/has-own-prop&#39;; import { createUTC } from
&#39;../create/utc&#39;; import getParsingFlags from
&#39;../create/parsing-flags&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;d&#39;, 0, &#39;do&#39;, &#39;day&#39;);</p>

<p>addFormatToken(&#39;dd&#39;, 0, 0, function (format) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">weekdaysMin</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">format</span>);
</pre>

<p>});</p>

<p>addFormatToken(&#39;ddd&#39;, 0, 0, function (format) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">weekdaysShort</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">format</span>);
</pre>

<p>});</p>

<p>addFormatToken(&#39;dddd&#39;, 0, 0, function (format) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">weekdays</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">format</span>);
</pre>

<p>});</p>

<p>addFormatToken(&#39;e&#39;, 0, 0, &#39;weekday&#39;);
addFormatToken(&#39;E&#39;, 0, 0, &#39;isoWeekday&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;day&#39;, &#39;d&#39;); addUnitAlias(&#39;weekday&#39;,
&#39;e&#39;); addUnitAlias(&#39;isoWeekday&#39;, &#39;E&#39;);</p>

<p>// PRIORITY addUnitPriority(&#39;day&#39;, 11);
addUnitPriority(&#39;weekday&#39;, 11);
addUnitPriority(&#39;isoWeekday&#39;, 11);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;d&#39;,    match1to2); addRegexToken(&#39;e&#39;,   
match1to2); addRegexToken(&#39;E&#39;,    match1to2);
addRegexToken(&#39;dd&#39;,   function (isStrict, locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">weekdaysMinRegex</span>(<span class="ruby-identifier">isStrict</span>);
</pre>

<p>}); addRegexToken(&#39;ddd&#39;,   function (isStrict, locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">weekdaysShortRegex</span>(<span class="ruby-identifier">isStrict</span>);
</pre>

<p>}); addRegexToken(&#39;dddd&#39;,   function (isStrict, locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">weekdaysRegex</span>(<span class="ruby-identifier">isStrict</span>);
</pre>

<p>});</p>

<p>addWeekParseToken([&#39;dd&#39;, &#39;ddd&#39;, &#39;dddd&#39;], function
(input, week, config, token) {</p>

<pre>var weekday = config._locale.weekdaysParse(input, token, config._strict);
...
<p>addWeekParseToken([&#39;d&#39;, &#39;e&#39;, &#39;E&#39;], function (input,
week, config, token) {</p>

<pre class="ruby"><span class="ruby-identifier">week</span>[<span class="ruby-identifier">token</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
</pre>
...
<p>function parseWeekday(input, locale) {</p>

<pre>if (typeof input !== &#39;string&#39;) {
    return input;
}
...
<p>function parseIsoWeekday(input, locale) {</p>

<pre>if (typeof input === &#39;string&#39;) {
    return locale.weekdaysParse(input) % 7 || 7;
}
return isNaN(input) ? null : input;</pre>

<p>}</p>

<p>// LOCALES function shiftWeekdays (ws, n) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">ws</span>.<span class="ruby-identifier">slice</span>(<span class="ruby-identifier">n</span>, <span class="ruby-value">7</span>).<span class="ruby-identifier">concat</span>(<span class="ruby-identifier">ws</span>.<span class="ruby-identifier">slice</span>(<span class="ruby-value">0</span>, <span class="ruby-identifier">n</span>));
</pre>

<p>}</p>

<p>export var defaultLocaleWeekdays =
&#39;Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday&#39;.split(&#39;_&#39;);
export function localeWeekdays (m, format) {</p>

<pre>var weekdays = isArray(this._weekdays) ? this._weekdays :
    this._weekdays[(m &amp;&amp; m !== true &amp;&amp; this._weekdays.isFormat.test(format)) ? &#39;format&#39; : &#39;standalone&#39;];
return (m === true) ? shiftWeekdays(weekdays, this._week.dow)
    : (m) ? weekdays[m.day()] : weekdays;</pre>

<p>}</p>

<p>export var defaultLocaleWeekdaysShort =
&#39;Sun_Mon_Tue_Wed_Thu_Fri_Sat&#39;.split(&#39;_&#39;); export function
localeWeekdaysShort (m) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (<span class="ruby-identifier">m</span> <span class="ruby-operator">===</span> <span class="ruby-keyword">true</span>) <span class="ruby-operator">?</span> <span class="ruby-identifier">shiftWeekdays</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_weekdaysShort</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">dow</span>)
    <span class="ruby-operator">:</span> (<span class="ruby-identifier">m</span>) <span class="ruby-operator">?</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_weekdaysShort</span>[<span class="ruby-identifier">m</span>.<span class="ruby-identifier">day</span>()] <span class="ruby-operator">:</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_weekdaysShort</span>;
</pre>

<p>}</p>

<p>export var defaultLocaleWeekdaysMin =
&#39;Su_Mo_Tu_We_Th_Fr_Sa&#39;.split(&#39;_&#39;); export function
localeWeekdaysMin (m) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (<span class="ruby-identifier">m</span> <span class="ruby-operator">===</span> <span class="ruby-keyword">true</span>) <span class="ruby-operator">?</span> <span class="ruby-identifier">shiftWeekdays</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_weekdaysMin</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">dow</span>)
    <span class="ruby-operator">:</span> (<span class="ruby-identifier">m</span>) <span class="ruby-operator">?</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_weekdaysMin</span>[<span class="ruby-identifier">m</span>.<span class="ruby-identifier">day</span>()] <span class="ruby-operator">:</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_weekdaysMin</span>;
</pre>

<p>}</p>

<p>function handleStrictParse(weekdayName, format, strict) {</p>

<pre>var i, ii, mom, llc = weekdayName.toLocaleLowerCase();
...
<p>export function localeWeekdaysParse (weekdayName, format, strict) {</p>
...
<p>export function getSetDayOfWeek (input) {</p>
...
<p>export function getSetLocaleDayOfWeek (input) {</p>

<pre>if (!this.isValid()) {
    return input != null ? this : NaN;
}
var weekday = (this.day() + 7 - this.localeData()._week.dow) % 7;
return input == null ? weekday : this.add(input - weekday, &#39;d&#39;);</pre>

<p>}</p>

<p>export function getSetISODayOfWeek (input) {</p>
...
<p>var defaultWeekdaysRegex = matchWord; export function weekdaysRegex
(isStrict) {</p>

<pre>if (this._weekdaysParseExact) {
...
<p>var defaultWeekdaysShortRegex = matchWord; export function
weekdaysShortRegex (isStrict) {</p>
...
<p>var defaultWeekdaysMinRegex = matchWord; export function weekdaysMinRegex
(isStrict) {</p>
...
<p>function computeWeekdaysParse () {</p>

<pre>function cmpLenRev(a, b) {
...
this._weekdaysMinStrictRegex = new RegExp(&#39;^(&#39; + minPieces.join(&#39;|&#39;) + &#39;)&#39;, &#39;i&#39;);</pre>
