...
<title>day-of-month.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/day-of-month.js">
...
&#39;../parse/token&#39;; import { DATE } from &#39;./constants&#39;;
import toInt from &#39;../utils/to-int&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;D&#39;, [&#39;DD&#39;, 2], &#39;Do&#39;,
&#39;date&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;date&#39;, &#39;D&#39;);</p>

<p>// PRIORITY addUnitPriority(&#39;date&#39;, 9);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;D&#39;,  match1to2); addRegexToken(&#39;DD&#39;,
match1to2, match2); addRegexToken(&#39;Do&#39;, function (isStrict, locale)
{</p>

<pre>// TODO: Remove &quot;ordinalParse&quot; fallback in next major release.
return isStrict ?
  (locale._dayOfMonthOrdinalParse || locale._ordinalParse) :
  locale._dayOfMonthOrdinalParseLenient;</pre>

<p>});</p>

<p>addParseToken([&#39;D&#39;, &#39;DD&#39;], DATE);
addParseToken(&#39;Do&#39;, function (input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">DATE</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>.<span class="ruby-identifier">match</span>(<span class="ruby-identifier">match1to2</span>)[<span class="ruby-value">0</span>]);
</pre>
...
<p>export var getSetDayOfMonth = makeGetSet(&#39;Date&#39;, true);</p>
</main>
