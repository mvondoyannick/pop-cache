...
<title>week-year.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/week-year.js">

<p>import { addFormatToken } from &#39;../format/format&#39;; import {
addUnitAlias } from &#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match1to2, match1to4,
match1to6, match2, match4, match6, matchSigned } from
&#39;../parse/regex&#39;; import { addWeekParseToken } from
&#39;../parse/token&#39;; import { weekOfYear, weeksInYear,
dayOfYearFromWeeks } from &#39;./week-calendar-utils&#39;; import toInt
from &#39;../utils/to-int&#39;; import { hooks } from
&#39;../utils/hooks&#39;; import { createLocal } from
&#39;../create/local&#39;; import { createUTCDate } from
&#39;../create/date-from-array&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(0, [&#39;gg&#39;, 2], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">weekYear</span>() <span class="ruby-operator">%</span> <span class="ruby-value">100</span>;
</pre>
...
<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isoWeekYear</span>() <span class="ruby-operator">%</span> <span class="ruby-value">100</span>;
</pre>

<p>});</p>

<p>function addWeekYearFormatToken (token, getter) {</p>

<pre class="ruby"><span class="ruby-identifier">addFormatToken</span>(<span class="ruby-value">0</span>, [<span class="ruby-identifier">token</span>, <span class="ruby-identifier">token</span>.<span class="ruby-identifier">length</span>], <span class="ruby-value">0</span>, <span class="ruby-identifier">getter</span>);
</pre>

<p>}</p>

<p>addWeekYearFormatToken(&#39;gggg&#39;,     &#39;weekYear&#39;);
addWeekYearFormatToken(&#39;ggggg&#39;,    &#39;weekYear&#39;);
addWeekYearFormatToken(&#39;GGGG&#39;,  &#39;isoWeekYear&#39;);
addWeekYearFormatToken(&#39;GGGGG&#39;, &#39;isoWeekYear&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;weekYear&#39;, &#39;gg&#39;);
addUnitAlias(&#39;isoWeekYear&#39;, &#39;GG&#39;);</p>

<p>// PRIORITY</p>

<p>addUnitPriority(&#39;weekYear&#39;, 1);
addUnitPriority(&#39;isoWeekYear&#39;, 1);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;G&#39;,      matchSigned); addRegexToken(&#39;g&#39;,   
matchSigned); addRegexToken(&#39;GG&#39;,     match1to2, match2);
addRegexToken(&#39;gg&#39;,     match1to2, match2);
addRegexToken(&#39;GGGG&#39;,   match1to4, match4);
addRegexToken(&#39;gggg&#39;,   match1to4, match4);
addRegexToken(&#39;GGGGG&#39;,  match1to6, match6);
addRegexToken(&#39;ggggg&#39;,  match1to6, match6);</p>

<p>addWeekParseToken([&#39;gggg&#39;, &#39;ggggg&#39;, &#39;GGGG&#39;,
&#39;GGGGG&#39;], function (input, week, config, token) {</p>

<pre class="ruby"><span class="ruby-identifier">week</span>[<span class="ruby-identifier">token</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-value">0</span>, <span class="ruby-value">2</span>)] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
</pre>

<p>});</p>

<p>addWeekParseToken([&#39;gg&#39;, &#39;GG&#39;], function (input, week,
config, token) {</p>

<pre class="ruby"><span class="ruby-identifier">week</span>[<span class="ruby-identifier">token</span>] = <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">parseTwoDigitYear</span>(<span class="ruby-identifier">input</span>);
</pre>
...
<p>export function getSetWeekYear (input) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">getSetWeekYearHelper</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">this</span>,
        <span class="ruby-identifier">input</span>,
        <span class="ruby-identifier">this</span>.<span class="ruby-identifier">week</span>(),
        <span class="ruby-identifier">this</span>.<span class="ruby-identifier">weekday</span>(),
        <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">dow</span>,
        <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">doy</span>);
</pre>

<p>}</p>

<p>export function getSetISOWeekYear (input) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">getSetWeekYearHelper</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">this</span>,
        <span class="ruby-identifier">input</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isoWeek</span>(), <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isoWeekday</span>(), <span class="ruby-value">1</span>, <span class="ruby-value">4</span>);
</pre>

<p>}</p>

<p>export function getISOWeeksInYear () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">weeksInYear</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>(), <span class="ruby-value">1</span>, <span class="ruby-value">4</span>);
</pre>

<p>}</p>

<p>export function getWeeksInYear () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">weekInfo</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">_week</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">weeksInYear</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>(), <span class="ruby-identifier">weekInfo</span>.<span class="ruby-identifier">dow</span>, <span class="ruby-identifier">weekInfo</span>.<span class="ruby-identifier">doy</span>);
</pre>

<p>}</p>

<p>function getSetWeekYearHelper(input, week, weekday, dow, doy) {</p>
...
<p>function setWeekAll(weekYear, week, weekday, dow, doy) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">dayOfYearData</span> = <span class="ruby-identifier">dayOfYearFromWeeks</span>(<span class="ruby-identifier">weekYear</span>, <span class="ruby-identifier">week</span>, <span class="ruby-identifier">weekday</span>, <span class="ruby-identifier">dow</span>, <span class="ruby-identifier">doy</span>),
    <span class="ruby-identifier">date</span> = <span class="ruby-identifier">createUTCDate</span>(<span class="ruby-identifier">dayOfYearData</span>.<span class="ruby-identifier">year</span>, <span class="ruby-value">0</span>, <span class="ruby-identifier">dayOfYearData</span>.<span class="ruby-identifier">dayOfYear</span>);

<span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>(<span class="ruby-identifier">date</span>.<span class="ruby-identifier">getUTCFullYear</span>());
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">month</span>(<span class="ruby-identifier">date</span>.<span class="ruby-identifier">getUTCMonth</span>());
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">date</span>(<span class="ruby-identifier">date</span>.<span class="ruby-identifier">getUTCDate</span>());
