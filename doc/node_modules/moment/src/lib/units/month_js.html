...
<title>month.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/month.js">

<p>import { get } from &#39;../moment/get-set&#39;; import hasOwnProp from
&#39;../utils/has-own-prop&#39;; import { addFormatToken } from
&#39;../format/format&#39;; import { addUnitAlias } from
&#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match1to2, match2,
matchWord, regexEscape } from &#39;../parse/regex&#39;; import {
addParseToken } from &#39;../parse/token&#39;; import { hooks } from
&#39;../utils/hooks&#39;; import { MONTH } from &#39;./constants&#39;;
import toInt from &#39;../utils/to-int&#39;; import isArray from
&#39;../utils/is-array&#39;; import isNumber from
&#39;../utils/is-number&#39;; import mod from &#39;../utils/mod&#39;;
import indexOf from &#39;../utils/index-of&#39;; import { createUTC } from
&#39;../create/utc&#39;; import getParsingFlags from
&#39;../create/parsing-flags&#39;; import { isLeapYear } from
&#39;../units/year&#39;;</p>

<p>export function daysInMonth(year, month) {</p>

<pre>if (isNaN(year) || isNaN(month)) {
    return NaN;
}
var modMonth = mod(month, 12);
year += (month - modMonth) / 12;
return modMonth === 1 ? (isLeapYear(year) ? 29 : 28) : (31 - modMonth % 7 % 2);</pre>

<p>}</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;M&#39;, [&#39;MM&#39;, 2], &#39;Mo&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">month</span>() <span class="ruby-operator">+</span> <span class="ruby-value">1</span>;
</pre>

<p>});</p>

<p>addFormatToken(&#39;MMM&#39;, 0, 0, function (format) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">monthsShort</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">format</span>);
</pre>

<p>});</p>

<p>addFormatToken(&#39;MMMM&#39;, 0, 0, function (format) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">months</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">format</span>);
</pre>
...
<p>addUnitAlias(&#39;month&#39;, &#39;M&#39;);</p>

<p>// PRIORITY</p>

<p>addUnitPriority(&#39;month&#39;, 8);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;M&#39;,    match1to2); addRegexToken(&#39;MM&#39;,  
match1to2, match2); addRegexToken(&#39;MMM&#39;,  function (isStrict,
locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">monthsShortRegex</span>(<span class="ruby-identifier">isStrict</span>);
</pre>

<p>}); addRegexToken(&#39;MMMM&#39;, function (isStrict, locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">monthsRegex</span>(<span class="ruby-identifier">isStrict</span>);
</pre>

<p>});</p>

<p>addParseToken([&#39;M&#39;, &#39;MM&#39;], function (input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">MONTH</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>) <span class="ruby-operator">-</span> <span class="ruby-value">1</span>;
</pre>

<p>});</p>

<p>addParseToken([&#39;MMM&#39;, &#39;MMMM&#39;], function (input, array,
config, token) {</p>

<pre>var month = config._locale.monthsParse(input, token, config._strict);
...
<p>var MONTHS_IN_FORMAT = /<a href="oD">D</a>?([[^[]]*]|s)+MMMM?/; export var
defaultLocaleMonths =
&#39;January_February_March_April_May_June_July_August_September_October_November_December&#39;.split(&#39;_&#39;);
export function localeMonths (m, format) {</p>
...
return isArray(this._months) ? this._months[m.month()] :
    this._months[(this._months.isFormat || MONTHS_IN_FORMAT).test(format) ? &#39;format&#39; : &#39;standalone&#39;][m.month()];</pre>

<p>}</p>

<p>export var defaultLocaleMonthsShort =
&#39;Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec&#39;.split(&#39;_&#39;);
export function localeMonthsShort (m, format) {</p>
...
return isArray(this._monthsShort) ? this._monthsShort[m.month()] :
    this._monthsShort[MONTHS_IN_FORMAT.test(format) ? &#39;format&#39; : &#39;standalone&#39;][m.month()];</pre>

<p>}</p>

<p>function handleStrictParse(monthName, format, strict) {</p>

<pre>var i, ii, mom, llc = monthName.toLocaleLowerCase();
...
<p>export function localeMonthsParse (monthName, format, strict) {</p>
...
<p>export function setMonth (mom, value) {</p>
...
<p>export function getSetMonth (value) {</p>
...
<p>export function getDaysInMonth () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">daysInMonth</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>(), <span class="ruby-identifier">this</span>.<span class="ruby-identifier">month</span>());
</pre>

<p>}</p>

<p>var defaultMonthsShortRegex = matchWord; export function monthsShortRegex
(isStrict) {</p>

<pre>if (this._monthsParseExact) {
...
<p>var defaultMonthsRegex = matchWord; export function monthsRegex (isStrict)
{</p>
...
<p>function computeMonthsParse () {</p>
...
this._monthsShortStrictRegex = new RegExp(&#39;^(&#39; + shortPieces.join(&#39;|&#39;) + &#39;)&#39;, &#39;i&#39;);</pre>
