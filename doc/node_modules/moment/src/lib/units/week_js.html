...
<title>week.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/week.js">

<p>import { addFormatToken } from &#39;../format/format&#39;; import {
addUnitAlias } from &#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match1to2, match2 } from
&#39;../parse/regex&#39;; import { addWeekParseToken } from
&#39;../parse/token&#39;; import toInt from &#39;../utils/to-int&#39;;
import { createLocal } from &#39;../create/local&#39;; import { weekOfYear
} from &#39;./week-calendar-utils&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;w&#39;, [&#39;ww&#39;, 2], &#39;wo&#39;,
&#39;week&#39;); addFormatToken(&#39;W&#39;, [&#39;WW&#39;, 2],
&#39;Wo&#39;, &#39;isoWeek&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;week&#39;, &#39;w&#39;); addUnitAlias(&#39;isoWeek&#39;,
&#39;W&#39;);</p>

<p>// PRIORITIES</p>

<p>addUnitPriority(&#39;week&#39;, 5); addUnitPriority(&#39;isoWeek&#39;, 5);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;w&#39;,  match1to2); addRegexToken(&#39;ww&#39;,
match1to2, match2); addRegexToken(&#39;W&#39;,  match1to2);
addRegexToken(&#39;WW&#39;, match1to2, match2);</p>

<p>addWeekParseToken([&#39;w&#39;, &#39;ww&#39;, &#39;W&#39;, &#39;WW&#39;],
function (input, week, config, token) {</p>

<pre class="ruby"><span class="ruby-identifier">week</span>[<span class="ruby-identifier">token</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-value">0</span>, <span class="ruby-value">1</span>)] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
</pre>
...
<p>export function localeWeek (mom) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">weekOfYear</span>(<span class="ruby-identifier">mom</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">dow</span>, <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">doy</span>).<span class="ruby-identifier">week</span>;
</pre>

<p>}</p>

<p>export var defaultLocaleWeek = {</p>

<pre>dow : 0, // Sunday is the first day of the week.
doy : 6  // The week that contains Jan 6th is the first week of the year.</pre>

<p>};</p>

<p>export function localeFirstDayOfWeek () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">dow</span>;
</pre>

<p>}</p>

<p>export function localeFirstDayOfYear () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_week</span>.<span class="ruby-identifier">doy</span>;
</pre>
...
<p>export function getSetWeek (input) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">week</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">localeData</span>().<span class="ruby-identifier">week</span>(<span class="ruby-identifier">this</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">input</span> <span class="ruby-operator">==</span> <span class="ruby-identifier">null</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">week</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">add</span>((<span class="ruby-identifier">input</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">week</span>) <span class="ruby-operator">*</span> <span class="ruby-value">7</span>, <span class="ruby-string">&#39;d&#39;</span>);
</pre>

<p>}</p>

<p>export function getSetISOWeek (input) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">week</span> = <span class="ruby-identifier">weekOfYear</span>(<span class="ruby-identifier">this</span>, <span class="ruby-value">1</span>, <span class="ruby-value">4</span>).<span class="ruby-identifier">week</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">input</span> <span class="ruby-operator">==</span> <span class="ruby-identifier">null</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">week</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">add</span>((<span class="ruby-identifier">input</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">week</span>) <span class="ruby-operator">*</span> <span class="ruby-value">7</span>, <span class="ruby-string">&#39;d&#39;</span>);
</pre>
