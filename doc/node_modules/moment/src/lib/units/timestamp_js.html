...
<title>timestamp.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/timestamp.js">

<p>import { addFormatToken } from &#39;../format/format&#39;; import {
addRegexToken, matchTimestamp, matchSigned } from &#39;../parse/regex&#39;;
import { addParseToken } from &#39;../parse/token&#39;; import toInt from
&#39;../utils/to-int&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;X&#39;, 0, 0, &#39;unix&#39;);
addFormatToken(&#39;x&#39;, 0, 0, &#39;valueOf&#39;);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;x&#39;, matchSigned); addRegexToken(&#39;X&#39;,
matchTimestamp); addParseToken(&#39;X&#39;, function (input, array, config)
{</p>

<pre class="ruby"><span class="ruby-identifier">config</span>.<span class="ruby-identifier">_d</span> = <span class="ruby-identifier">new</span> <span class="ruby-constant">Date</span>(<span class="ruby-identifier">parseFloat</span>(<span class="ruby-identifier">input</span>, <span class="ruby-value">10</span>) <span class="ruby-operator">*</span> <span class="ruby-value">1000</span>);
</pre>

<p>}); addParseToken(&#39;x&#39;, function (input, array, config) {</p>

<pre class="ruby"><span class="ruby-identifier">config</span>.<span class="ruby-identifier">_d</span> = <span class="ruby-identifier">new</span> <span class="ruby-constant">Date</span>(<span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>));
</pre>
