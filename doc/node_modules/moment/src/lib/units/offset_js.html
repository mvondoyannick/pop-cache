...
<title>offset.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/offset.js">

<p>import zeroFill from &#39;../utils/zero-fill&#39;; import { createDuration
} from &#39;../duration/create&#39;; import { addSubtract } from
&#39;../moment/add-subtract&#39;; import { isMoment, copyConfig } from
&#39;../moment/constructor&#39;; import { addFormatToken } from
&#39;../format/format&#39;; import { addRegexToken, matchOffset,
matchShortOffset } from &#39;../parse/regex&#39;; import { addParseToken }
from &#39;../parse/token&#39;; import { createLocal } from
&#39;../create/local&#39;; import { prepareConfig } from
&#39;../create/from-anything&#39;; import { createUTC } from
&#39;../create/utc&#39;; import isDate from &#39;../utils/is-date&#39;;
import toInt from &#39;../utils/to-int&#39;; import isUndefined from
&#39;../utils/is-undefined&#39;; import compareArrays from
&#39;../utils/compare-arrays&#39;; import { hooks } from
&#39;../utils/hooks&#39;;</p>

<p>// FORMATTING</p>

<p>function offset (token, separator) {</p>
...
<p>offset(&#39;Z&#39;, &#39;:&#39;); offset(&#39;ZZ&#39;, &#39;&#39;);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;Z&#39;,  matchShortOffset); addRegexToken(&#39;ZZ&#39;,
matchShortOffset); addParseToken([&#39;Z&#39;, &#39;ZZ&#39;], function
(input, array, config) {</p>

<pre class="ruby"><span class="ruby-identifier">config</span>.<span class="ruby-identifier">_useUTC</span> = <span class="ruby-keyword">true</span>;
<span class="ruby-identifier">config</span>.<span class="ruby-identifier">_tzm</span> = <span class="ruby-identifier">offsetFromString</span>(<span class="ruby-identifier">matchShortOffset</span>, <span class="ruby-identifier">input</span>);
</pre>
...
<p>// timezone chunker // &#39;+10:00&#39; &gt; [&#39;10&#39;,  &#39;00&#39;]
// &#39;-1530&#39;  &gt; [&#39;-15&#39;, &#39;30&#39;] var chunkOffset =
/([+-]|dd)/gi;</p>

<p>function offsetFromString(matcher, string) {</p>

<pre>var matches = (string || &#39;&#39;).match(matcher);
...
return minutes === 0 ?
  0 :
  parts[0] === &#39;+&#39; ? minutes : -minutes;</pre>

<p>}</p>

<p>// Return a moment from input, that is local/utc/zone equivalent to model.
export function cloneWithOffset(input, model) {</p>
...
<p>function getDateOffset (m) {</p>

<pre>// On Firefox.24 Date#getTimezoneOffset returns a floating point.
// https://github.com/moment/moment/pull/1871
return -Math.round(m._d.getTimezoneOffset() / 15) * 15;</pre>

<p>}</p>

<p>// HOOKS</p>

<p>// This function will be called whenever a moment is mutated. // It is
intended to keep the offset in sync with the timezone. hooks.updateOffset =
function () {};</p>
...
+0200, so we adjust the time as needed, to be valid. // // Keeping the time
actually adds/subtracts (one hour) // from the actual represented time.
That is why we call updateOffset // a second time. In case it wants us to
change the offset again // _changeInProgress == true case, then we have to
adjust, because // there is no such time in the given timezone. export
function getSetOffset (input, keepLocalTime, keepMinutes) {</p>

<pre>var offset = this._offset || 0,
    localAdjust;
if (!this.isValid()) {
...
<p>export function getSetZone (input, keepLocalTime) {</p>
...
<p>export function setOffsetToUTC (keepLocalTime) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">utcOffset</span>(<span class="ruby-value">0</span>, <span class="ruby-identifier">keepLocalTime</span>);
</pre>

<p>}</p>

<p>export function setOffsetToLocal (keepLocalTime) {</p>
...
<p>export function setOffsetToParsedOffset () {</p>

<pre>if (this._tzm != null) {
...
<p>export function hasAlignedHourOffset (input) {</p>
...
return (this.utcOffset() - input) % 60 === 0;</pre>

<p>}</p>

<p>export function isDaylightSavingTime () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (
    <span class="ruby-identifier">this</span>.<span class="ruby-identifier">utcOffset</span>() <span class="ruby-operator">&gt;</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">clone</span>().<span class="ruby-identifier">month</span>(<span class="ruby-value">0</span>).<span class="ruby-identifier">utcOffset</span>() <span class="ruby-operator">||</span>
    <span class="ruby-identifier">this</span>.<span class="ruby-identifier">utcOffset</span>() <span class="ruby-operator">&gt;</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">clone</span>().<span class="ruby-identifier">month</span>(<span class="ruby-value">5</span>).<span class="ruby-identifier">utcOffset</span>()
);
</pre>

<p>}</p>

<p>export function isDaylightSavingTimeShifted () {</p>

<pre>if (!isUndefined(this._isDSTShifted)) {
...
return this._isDSTShifted;</pre>

<p>}</p>

<p>export function isLocal () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isValid</span>() <span class="ruby-operator">?</span> <span class="ruby-operator">!</span><span class="ruby-identifier">this</span>.<span class="ruby-identifier">_isUTC</span> <span class="ruby-operator">:</span> <span class="ruby-keyword">false</span>;
</pre>

<p>}</p>

<p>export function isUtcOffset () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isValid</span>() <span class="ruby-operator">?</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_isUTC</span> <span class="ruby-operator">:</span> <span class="ruby-keyword">false</span>;
</pre>

<p>}</p>

<p>export function isUtc () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isValid</span>() <span class="ruby-operator">?</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_isUTC</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_offset</span> <span class="ruby-operator">===</span> <span class="ruby-value">0</span> <span class="ruby-operator">:</span> <span class="ruby-keyword">false</span>;
</pre>
