...
<title>quarter.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/quarter.js">

<p>import { addFormatToken } from &#39;../format/format&#39;; import {
addUnitAlias } from &#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match1 } from
&#39;../parse/regex&#39;; import { addParseToken } from
&#39;../parse/token&#39;; import { MONTH } from &#39;./constants&#39;;
import toInt from &#39;../utils/to-int&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;Q&#39;, 0, &#39;Qo&#39;, &#39;quarter&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;quarter&#39;, &#39;Q&#39;);</p>

<p>// PRIORITY</p>

<p>addUnitPriority(&#39;quarter&#39;, 7);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;Q&#39;, match1); addParseToken(&#39;Q&#39;, function
(input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">MONTH</span>] = (<span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>) <span class="ruby-operator">-</span> <span class="ruby-value">1</span>) <span class="ruby-operator">*</span> <span class="ruby-value">3</span>;
</pre>
...
<p>export function getSetQuarter (input) {</p>
