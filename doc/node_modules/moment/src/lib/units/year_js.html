...
<title>year.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/year.js">
...
&#39;../parse/regex&#39;; import { addParseToken } from
&#39;../parse/token&#39;; import { hooks } from &#39;../utils/hooks&#39;;
import { YEAR } from &#39;./constants&#39;; import toInt from
&#39;../utils/to-int&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;Y&#39;, 0, 0, function () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">y</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>();
<span class="ruby-keyword">return</span> <span class="ruby-identifier">y</span> <span class="ruby-operator">&lt;=</span> <span class="ruby-value">9999</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">y</span> <span class="ruby-operator">:</span> <span class="ruby-string">&#39;+&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">y</span>;
</pre>

<p>});</p>

<p>addFormatToken(0, [&#39;YY&#39;, 2], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>() <span class="ruby-operator">%</span> <span class="ruby-value">100</span>;
</pre>

<p>});</p>

<p>addFormatToken(0, [&#39;YYYY&#39;,   4],       0, &#39;year&#39;);
addFormatToken(0, [&#39;YYYYY&#39;,  5],       0, &#39;year&#39;);
addFormatToken(0, [&#39;YYYYYY&#39;, 6, true], 0, &#39;year&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;year&#39;, &#39;y&#39;);</p>

<p>// PRIORITIES</p>

<p>addUnitPriority(&#39;year&#39;, 1);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;Y&#39;,      matchSigned); addRegexToken(&#39;YY&#39;,  
match1to2, match2); addRegexToken(&#39;YYYY&#39;,   match1to4, match4);
addRegexToken(&#39;YYYYY&#39;,  match1to6, match6);
addRegexToken(&#39;YYYYYY&#39;, match1to6, match6);</p>

<p>addParseToken([&#39;YYYYY&#39;, &#39;YYYYYY&#39;], YEAR);
addParseToken(&#39;YYYY&#39;, function (input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">YEAR</span>] = <span class="ruby-identifier">input</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">===</span> <span class="ruby-value">2</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">parseTwoDigitYear</span>(<span class="ruby-identifier">input</span>) <span class="ruby-operator">:</span> <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
</pre>

<p>}); addParseToken(&#39;YY&#39;, function (input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">YEAR</span>] = <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">parseTwoDigitYear</span>(<span class="ruby-identifier">input</span>);
</pre>

<p>}); addParseToken(&#39;Y&#39;, function (input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">YEAR</span>] = <span class="ruby-identifier">parseInt</span>(<span class="ruby-identifier">input</span>, <span class="ruby-value">10</span>);
</pre>
...
<p>export function daysInYear(year) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">isLeapYear</span>(<span class="ruby-identifier">year</span>) <span class="ruby-operator">?</span> <span class="ruby-value">366</span> <span class="ruby-operator">:</span> <span class="ruby-value">365</span>;
</pre>

<p>}</p>

<p>export function isLeapYear(year) {</p>

<pre>return (year % 4 === 0 &amp;&amp; year % 100 !== 0) || year % 400 === 0;</pre>

<p>}</p>

<p>// HOOKS</p>

<p>hooks.parseTwoDigitYear = function (input) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>) <span class="ruby-operator">+</span> (<span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>) <span class="ruby-operator">&gt;</span> <span class="ruby-value">68</span> <span class="ruby-operator">?</span> <span class="ruby-value">1900</span> <span class="ruby-operator">:</span> <span class="ruby-value">2000</span>);
</pre>
...
<p>export var getSetYear = makeGetSet(&#39;FullYear&#39;, true);</p>

<p>export function getIsLeapYear () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">isLeapYear</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">year</span>());
</pre>
