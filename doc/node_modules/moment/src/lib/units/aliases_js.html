...
<title>aliases.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/aliases.js">

<p>import hasOwnProp from &#39;../utils/has-own-prop&#39;;</p>

<p>var aliases = {};</p>

<p>export function addUnitAlias (unit, shorthand) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">lowerCase</span> = <span class="ruby-identifier">unit</span>.<span class="ruby-identifier">toLowerCase</span>();
<span class="ruby-identifier">aliases</span>[<span class="ruby-identifier">lowerCase</span>] = <span class="ruby-identifier">aliases</span>[<span class="ruby-identifier">lowerCase</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;s&#39;</span>] = <span class="ruby-identifier">aliases</span>[<span class="ruby-identifier">shorthand</span>] = <span class="ruby-identifier">unit</span>;
</pre>

<p>}</p>

<p>export function normalizeUnits(units) {</p>
...
<p>export function normalizeObjectUnits(inputObject) {</p>

<pre>var normalizedInput = {},
    normalizedProp,
    prop;
