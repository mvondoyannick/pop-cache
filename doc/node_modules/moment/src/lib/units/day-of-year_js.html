...
<title>day-of-year.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/day-of-year.js">

<p>import { addFormatToken } from &#39;../format/format&#39;; import {
addUnitAlias } from &#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match3, match1to3 } from
&#39;../parse/regex&#39;; import { daysInYear } from &#39;./year&#39;;
import { createUTCDate } from &#39;../create/date-from-array&#39;; import {
addParseToken } from &#39;../parse/token&#39;; import toInt from
&#39;../utils/to-int&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;DDD&#39;, [&#39;DDDD&#39;, 3], &#39;DDDo&#39;,
&#39;dayOfYear&#39;);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;dayOfYear&#39;, &#39;DDD&#39;);</p>

<p>// PRIORITY addUnitPriority(&#39;dayOfYear&#39;, 4);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;DDD&#39;,  match1to3); addRegexToken(&#39;DDDD&#39;,
match3); addParseToken([&#39;DDD&#39;, &#39;DDDD&#39;], function (input,
array, config) {</p>

<pre class="ruby"><span class="ruby-identifier">config</span>.<span class="ruby-identifier">_dayOfYear</span> = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
</pre>
...
<p>export function getSetDayOfYear (input) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">dayOfYear</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">round</span>((<span class="ruby-identifier">this</span>.<span class="ruby-identifier">clone</span>().<span class="ruby-identifier">startOf</span>(<span class="ruby-string">&#39;day&#39;</span>) <span class="ruby-operator">-</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">clone</span>().<span class="ruby-identifier">startOf</span>(<span class="ruby-string">&#39;year&#39;</span>)) <span class="ruby-operator">/</span> <span class="ruby-value">864e5</span>) <span class="ruby-operator">+</span> <span class="ruby-value">1</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">input</span> <span class="ruby-operator">==</span> <span class="ruby-identifier">null</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">dayOfYear</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">add</span>((<span class="ruby-identifier">input</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">dayOfYear</span>), <span class="ruby-string">&#39;d&#39;</span>);
</pre>
