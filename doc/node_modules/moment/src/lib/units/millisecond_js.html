...
<title>millisecond.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/millisecond.js">
...
&#39;./priorities&#39;; import { addRegexToken, match1, match2, match3,
match1to3, matchUnsigned } from &#39;../parse/regex&#39;; import {
addParseToken } from &#39;../parse/token&#39;; import { MILLISECOND } from
&#39;./constants&#39;; import toInt from &#39;../utils/to-int&#39;;</p>

<p>// FORMATTING</p>

<p>addFormatToken(&#39;S&#39;, 0, 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-operator">~</span><span class="ruby-operator">~</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">/</span> <span class="ruby-value">100</span>);
</pre>

<p>});</p>

<p>addFormatToken(0, [&#39;SS&#39;, 2], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-operator">~</span><span class="ruby-operator">~</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">/</span> <span class="ruby-value">10</span>);
</pre>

<p>});</p>

<p>addFormatToken(0, [&#39;SSS&#39;, 3], 0, &#39;millisecond&#39;);
addFormatToken(0, [&#39;SSSS&#39;, 4], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">*</span> <span class="ruby-value">10</span>;
</pre>

<p>}); addFormatToken(0, [&#39;SSSSS&#39;, 5], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">*</span> <span class="ruby-value">100</span>;
</pre>

<p>}); addFormatToken(0, [&#39;SSSSSS&#39;, 6], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">*</span> <span class="ruby-value">1000</span>;
</pre>

<p>}); addFormatToken(0, [&#39;SSSSSSS&#39;, 7], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">*</span> <span class="ruby-value">10000</span>;
</pre>

<p>}); addFormatToken(0, [&#39;SSSSSSSS&#39;, 8], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">*</span> <span class="ruby-value">100000</span>;
</pre>

<p>}); addFormatToken(0, [&#39;SSSSSSSSS&#39;, 9], 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">millisecond</span>() <span class="ruby-operator">*</span> <span class="ruby-value">1000000</span>;
</pre>
...
<p>addUnitAlias(&#39;millisecond&#39;, &#39;ms&#39;);</p>

<p>// PRIORITY</p>

<p>addUnitPriority(&#39;millisecond&#39;, 16);</p>

<p>// PARSING</p>

<p>addRegexToken(&#39;S&#39;,    match1to3, match1);
addRegexToken(&#39;SS&#39;,   match1to3, match2);
addRegexToken(&#39;SSS&#39;,  match1to3, match3);</p>

<p>var token; for (token = &#39;SSSS&#39;; token.length &lt;= 9; token +=
&#39;S&#39;) {</p>

<pre class="ruby"><span class="ruby-identifier">addRegexToken</span>(<span class="ruby-identifier">token</span>, <span class="ruby-identifier">matchUnsigned</span>);
</pre>

<p>}</p>

<p>function parseMs(input, array) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">MILLISECOND</span>] = <span class="ruby-identifier">toInt</span>((<span class="ruby-string">&#39;0.&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">input</span>) <span class="ruby-operator">*</span> <span class="ruby-value">1000</span>);
</pre>

<p>}</p>

<p>for (token = &#39;S&#39;; token.length &lt;= 9; token += &#39;S&#39;) {</p>

<pre class="ruby"><span class="ruby-identifier">addParseToken</span>(<span class="ruby-identifier">token</span>, <span class="ruby-identifier">parseMs</span>);
</pre>

<p>} // MOMENTS</p>

<p>export var getSetMillisecond = makeGetSet(&#39;Milliseconds&#39;, false);</p>
</main>
