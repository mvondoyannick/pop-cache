...
<title>hour.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/hour.js">

<p>import { makeGetSet } from &#39;../moment/get-set&#39;; import {
addFormatToken } from &#39;../format/format&#39;; import { addUnitAlias }
from &#39;./aliases&#39;; import { addUnitPriority } from
&#39;./priorities&#39;; import { addRegexToken, match1to2, match2,
match3to4, match5to6 } from &#39;../parse/regex&#39;; import {
addParseToken } from &#39;../parse/token&#39;; import { HOUR, MINUTE,
SECOND } from &#39;./constants&#39;; import toInt from
&#39;../utils/to-int&#39;; import zeroFill from
&#39;../utils/zero-fill&#39;; import getParsingFlags from
&#39;../create/parsing-flags&#39;;</p>

<p>// FORMATTING</p>

<p>function hFormat() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">hours</span>() <span class="ruby-operator">%</span> <span class="ruby-value">12</span> <span class="ruby-operator">||</span> <span class="ruby-value">12</span>;
</pre>

<p>}</p>

<p>function kFormat() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">hours</span>() <span class="ruby-operator">||</span> <span class="ruby-value">24</span>;
</pre>

<p>}</p>

<p>addFormatToken(&#39;H&#39;, [&#39;HH&#39;, 2], 0, &#39;hour&#39;);
addFormatToken(&#39;h&#39;, [&#39;hh&#39;, 2], 0, hFormat);
addFormatToken(&#39;k&#39;, [&#39;kk&#39;, 2], 0, kFormat);</p>

<p>addFormatToken(&#39;hmm&#39;, 0, 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">hFormat</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">this</span>) <span class="ruby-operator">+</span> <span class="ruby-identifier">zeroFill</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">minutes</span>(), <span class="ruby-value">2</span>);
</pre>

<p>});</p>

<p>addFormatToken(&#39;hmmss&#39;, 0, 0, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-string">&#39;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">hFormat</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">this</span>) <span class="ruby-operator">+</span> <span class="ruby-identifier">zeroFill</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">minutes</span>(), <span class="ruby-value">2</span>) <span class="ruby-operator">+</span>
    <span class="ruby-identifier">zeroFill</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">seconds</span>(), <span class="ruby-value">2</span>);
</pre>
...
<p>function meridiem (token, lowercase) {</p>

<pre>addFormatToken(token, 0, 0, function () {
    return this.localeData().meridiem(this.hours(), this.minutes(), lowercase);
});</pre>

<p>}</p>

<p>meridiem(&#39;a&#39;, true); meridiem(&#39;A&#39;, false);</p>

<p>// ALIASES</p>

<p>addUnitAlias(&#39;hour&#39;, &#39;h&#39;);</p>

<p>// PRIORITY addUnitPriority(&#39;hour&#39;, 13);</p>

<p>// PARSING</p>

<p>function matchMeridiem (isStrict, locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">_meridiemParse</span>;
</pre>

<p>}</p>

<p>addRegexToken(&#39;a&#39;,  matchMeridiem); addRegexToken(&#39;A&#39;, 
matchMeridiem); addRegexToken(&#39;H&#39;,  match1to2);
addRegexToken(&#39;h&#39;,  match1to2); addRegexToken(&#39;k&#39;, 
match1to2); addRegexToken(&#39;HH&#39;, match1to2, match2);
addRegexToken(&#39;hh&#39;, match1to2, match2); addRegexToken(&#39;kk&#39;,
match1to2, match2);</p>

<p>addRegexToken(&#39;hmm&#39;, match3to4); addRegexToken(&#39;hmmss&#39;,
match5to6); addRegexToken(&#39;Hmm&#39;, match3to4);
addRegexToken(&#39;Hmmss&#39;, match5to6);</p>

<p>addParseToken([&#39;H&#39;, &#39;HH&#39;], HOUR);
addParseToken([&#39;k&#39;, &#39;kk&#39;], function (input, array, config)
{</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">kInput</span> = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
<span class="ruby-identifier">array</span>[<span class="ruby-constant">HOUR</span>] = <span class="ruby-identifier">kInput</span> <span class="ruby-operator">===</span> <span class="ruby-value">24</span> <span class="ruby-operator">?</span> <span class="ruby-value">0</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">kInput</span>;
</pre>

<p>}); addParseToken([&#39;a&#39;, &#39;A&#39;], function (input, array,
config) {</p>

<pre class="ruby"><span class="ruby-identifier">config</span>.<span class="ruby-identifier">_isPm</span> = <span class="ruby-identifier">config</span>.<span class="ruby-identifier">_locale</span>.<span class="ruby-identifier">isPM</span>(<span class="ruby-identifier">input</span>);
<span class="ruby-identifier">config</span>.<span class="ruby-identifier">_meridiem</span> = <span class="ruby-identifier">input</span>;
</pre>

<p>}); addParseToken([&#39;h&#39;, &#39;hh&#39;], function (input, array,
config) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>[<span class="ruby-constant">HOUR</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>);
<span class="ruby-identifier">getParsingFlags</span>(<span class="ruby-identifier">config</span>).<span class="ruby-identifier">bigHour</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>}); addParseToken(&#39;hmm&#39;, function (input, array, config) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">pos</span> = <span class="ruby-identifier">input</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">-</span> <span class="ruby-value">2</span>;
<span class="ruby-identifier">array</span>[<span class="ruby-constant">HOUR</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-value">0</span>, <span class="ruby-identifier">pos</span>));
<span class="ruby-identifier">array</span>[<span class="ruby-constant">MINUTE</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-identifier">pos</span>));
<span class="ruby-identifier">getParsingFlags</span>(<span class="ruby-identifier">config</span>).<span class="ruby-identifier">bigHour</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>}); addParseToken(&#39;hmmss&#39;, function (input, array, config) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">pos1</span> = <span class="ruby-identifier">input</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">-</span> <span class="ruby-value">4</span>;
<span class="ruby-identifier">var</span> <span class="ruby-identifier">pos2</span> = <span class="ruby-identifier">input</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">-</span> <span class="ruby-value">2</span>;
<span class="ruby-identifier">array</span>[<span class="ruby-constant">HOUR</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-value">0</span>, <span class="ruby-identifier">pos1</span>));
<span class="ruby-identifier">array</span>[<span class="ruby-constant">MINUTE</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-identifier">pos1</span>, <span class="ruby-value">2</span>));
<span class="ruby-identifier">array</span>[<span class="ruby-constant">SECOND</span>] = <span class="ruby-identifier">toInt</span>(<span class="ruby-identifier">input</span>.<span class="ruby-identifier">substr</span>(<span class="ruby-identifier">pos2</span>));
<span class="ruby-identifier">getParsingFlags</span>(<span class="ruby-identifier">config</span>).<span class="ruby-identifier">bigHour</span> = <span class="ruby-keyword">true</span>;
</pre>
...
<p>export function localeIsPM (input) {</p>

<pre>// IE8 Quirks Mode &amp; IE7 Standards Mode do not allow accessing strings like arrays
// Using charAt should be more compatible.
return ((input + &#39;&#39;).toLowerCase().charAt(0) === &#39;p&#39;);</pre>

<p>}</p>

<p>export var defaultLocaleMeridiemParse = /[ap].?m?.?/i; export function
localeMeridiem (hours, minutes, isLower) {</p>
...
this rule. export var getSetHour = makeGetSet(&#39;Hours&#39;, true);</p>
</main>
