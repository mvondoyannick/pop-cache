...
<title>week-calendar-utils.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/units/week-calendar-utils.js">

<p>import { daysInYear } from &#39;./year&#39;; import { createLocal } from
&#39;../create/local&#39;; import { createUTCDate } from
&#39;../create/date-from-array&#39;;</p>

<p>// start-of-first-week - start-of-year function firstWeekOffset(year, dow,
doy) {</p>

<pre>var // first-week day -- which january is always in the first week (4 for iso, 1 for other)
    fwd = 7 + dow - doy,
    // first-week day local weekday -- which local weekday is fwd
    fwdlw = (7 + createUTCDate(year, 0, fwd).getUTCDay() - dow) % 7;

return -fwdlw + fwd - 1;</pre>

<p>}</p>

<p>// <a
href="https://en.wikipedia.org/wiki/ISO_week_date#Calculating_a_date_given_the_year.2C_week_number_and_weekday">en.wikipedia.org/wiki/ISO_week_date#Calculating_a_date_given_the_year.2C_week_number_and_weekday</a>
export function dayOfYearFromWeeks(year, week, weekday, dow, doy) {</p>

<pre>var localWeekday = (7 + weekday - dow) % 7,
...
<p>export function weekOfYear(mom, dow, doy) {</p>

<pre>var weekOffset = firstWeekOffset(mom.year(), dow, doy),
...
<p>export function weeksInYear(year, dow, doy) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">weekOffset</span> = <span class="ruby-identifier">firstWeekOffset</span>(<span class="ruby-identifier">year</span>, <span class="ruby-identifier">dow</span>, <span class="ruby-identifier">doy</span>),
    <span class="ruby-identifier">weekOffsetNext</span> = <span class="ruby-identifier">firstWeekOffset</span>(<span class="ruby-identifier">year</span> <span class="ruby-operator">+</span> <span class="ruby-value">1</span>, <span class="ruby-identifier">dow</span>, <span class="ruby-identifier">doy</span>);
<span class="ruby-keyword">return</span> (<span class="ruby-identifier">daysInYear</span>(<span class="ruby-identifier">year</span>) <span class="ruby-operator">-</span> <span class="ruby-identifier">weekOffset</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">weekOffsetNext</span>) <span class="ruby-operator">/</span> <span class="ruby-value">7</span>;
</pre>
