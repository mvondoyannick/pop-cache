...
<main role="main" aria-label="Page node_modules/moment/src/lib/format/format.js">

<p>import zeroFill from &#39;../utils/zero-fill&#39;; import isFunction from
&#39;../utils/is-function&#39;;</p>

<p>export var formattingTokens = /([[^[]*])|(\)?([<a
href="o|w">Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w</a>?|<a
href="o|W">W</a>?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g;</p>

<p>var localFormattingTokens = /([[^[]*])|(\)?(LTS|LT|LL?L?L?|l{1,4})/g;</p>

<p>var formatFunctions = {};</p>

<p>export var formatTokenFunctions = {};</p>

<p>// token:    &#39;M&#39; // padded:   [&#39;MM&#39;, 2] // ordinal: 
&#39;Mo&#39; // callback: function () { this.month() + 1 } export function
addFormatToken (token, padded, ordinal, callback) {</p>

<pre>var func = callback;
...
<p>function removeFormattingTokens(input) {</p>

<pre>if (input.match(/\[[\s\S]/)) {
    return input.replace(/^\[|\]$/g, &#39;&#39;);
}
return input.replace(/\\/g, &#39;&#39;);</pre>

<p>}</p>

<p>function makeFormatFunction(format) {</p>

<pre>var array = format.match(formattingTokens), i, length;
...
<p>// format date using native date object export function formatMoment(m,
format) {</p>
...
return formatFunctions[format](m);</pre>

<p>}</p>

<p>export function expandFormat(format, locale) {</p>
