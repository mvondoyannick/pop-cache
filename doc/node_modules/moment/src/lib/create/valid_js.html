...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/valid.js">

<p>import extend from &#39;../utils/extend&#39;; import { createUTC } from
&#39;./utc&#39;; import getParsingFlags from
&#39;../create/parsing-flags&#39;; import some from
&#39;../utils/some&#39;;</p>

<p>export function isValid(m) {</p>

<pre>if (m._isValid == null) {
...
return m._isValid;</pre>

<p>}</p>

<p>export function createInvalid (flags) {</p>

<pre>var m = createUTC(NaN);
if (flags != null) {
