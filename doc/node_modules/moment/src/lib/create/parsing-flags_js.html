...
<title>parsing-flags.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/parsing-flags.js">

<p>function defaultParsingFlags() {</p>

<pre>// We need to deep clone this object.
return {
    empty           : false,
    unusedTokens    : [],
    unusedInput     : [],
...
<p>export default function getParsingFlags(m) {</p>
