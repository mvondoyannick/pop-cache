...
<title>from-array.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/from-array.js">

<p>import { hooks } from &#39;../utils/hooks&#39;; import { createDate,
createUTCDate } from &#39;./date-from-array&#39;; import { daysInYear }
from &#39;../units/year&#39;; import { weekOfYear, weeksInYear,
dayOfYearFromWeeks } from &#39;../units/week-calendar-utils&#39;; import {
YEAR, MONTH, DATE, HOUR, MINUTE, SECOND, MILLISECOND } from
&#39;../units/constants&#39;; import { createLocal } from
&#39;./local&#39;; import defaults from &#39;../utils/defaults&#39;; import
getParsingFlags from &#39;./parsing-flags&#39;;</p>

<p>function currentDateArray(config) {</p>

<pre>// hooks is actually the exported moment object
var nowValue = new Date(hooks.now());
if (config._useUTC) {
    return [nowValue.getUTCFullYear(), nowValue.getUTCMonth(), nowValue.getUTCDate()];
}
return [nowValue.getFullYear(), nowValue.getMonth(), nowValue.getDate()];</pre>

<p>}</p>

<p>// convert an array to a date. // the array should mirror the parameters
below // note: all values past the year are optional and will default to
the lowest possible value. // [year, month, day , hour, minute, second,
millisecond] export function configFromArray (config) {</p>

<pre>var i, date, input = [], currentDate, expectedWeekday, yearToUse;
...
<p>function dayOfYearFromWeekInfo(config) {</p>

<pre>var w, weekYear, week, weekday, dow, doy, temp, weekdayOverflow;
