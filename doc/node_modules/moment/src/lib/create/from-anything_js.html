...
<title>from-anything.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/from-anything.js">

<p>import isArray from &#39;../utils/is-array&#39;; import isObject from
&#39;../utils/is-object&#39;; import isObjectEmpty from
&#39;../utils/is-object-empty&#39;; import isUndefined from
&#39;../utils/is-undefined&#39;; import isNumber from
&#39;../utils/is-number&#39;; import isDate from
&#39;../utils/is-date&#39;; import map from &#39;../utils/map&#39;; import
{ createInvalid } from &#39;./valid&#39;; import { Moment, isMoment } from
&#39;../moment/constructor&#39;; import { getLocale } from
&#39;../locale/locales&#39;; import { hooks } from
&#39;../utils/hooks&#39;; import checkOverflow from
&#39;./check-overflow&#39;; import { isValid } from &#39;./valid&#39;;</p>

<p>import { configFromStringAndArray }  from
&#39;./from-string-and-array&#39;; import { configFromStringAndFormat }
from &#39;./from-string-and-format&#39;; import { configFromString }       
from &#39;./from-string&#39;; import { configFromArray }           from
&#39;./from-array&#39;; import { configFromObject }          from
&#39;./from-object&#39;;</p>

<p>function createFromConfig (config) {</p>

<pre>var res = new Moment(checkOverflow(prepareConfig(config)));
if (res._nextDay) {
...
<p>export function prepareConfig (config) {</p>

<pre>var input = config._i,
    format = config._f;
...
<p>function configFromInput(config) {</p>
...
<p>export function createLocalOrUTC (input, format, locale, strict, isUTC) {</p>
