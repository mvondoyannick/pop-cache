...
<title>date-from-array.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/date-from-array.js">

<p>export function createDate (y, m, d, h, M, s, ms) {</p>

<pre>// can&#39;t just apply() to create a date:
...
<p>export function createUTCDate (y) {</p>
