...
<title>local.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/local.js">

<p>import { createLocalOrUTC } from &#39;./from-anything&#39;;</p>

<p>export function createLocal (input, format, locale, strict) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">createLocalOrUTC</span>(<span class="ruby-identifier">input</span>, <span class="ruby-identifier">format</span>, <span class="ruby-identifier">locale</span>, <span class="ruby-identifier">strict</span>, <span class="ruby-keyword">false</span>);
</pre>
