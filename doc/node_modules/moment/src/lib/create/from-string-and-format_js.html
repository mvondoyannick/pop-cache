...
<title>from-string-and-format.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/from-string-and-format.js">

<p>import { configFromISO, configFromRFC2822 } from &#39;./from-string&#39;;
import { configFromArray } from &#39;./from-array&#39;; import {
getParseRegexForToken }   from &#39;../parse/regex&#39;; import {
addTimeToArrayFromToken } from &#39;../parse/token&#39;; import {
expandFormat, formatTokenFunctions, formattingTokens } from
&#39;../format/format&#39;; import checkOverflow from
&#39;./check-overflow&#39;; import { HOUR } from
&#39;../units/constants&#39;; import { hooks } from
&#39;../utils/hooks&#39;; import getParsingFlags from
&#39;./parsing-flags&#39;;</p>

<p>// constant that refers to the ISO standard hooks.ISO_8601 = function ()
{};</p>

<p>// constant that refers to the RFC 2822 form hooks.RFC_2822 = function ()
{};</p>

<p>// date from string and format string export function
configFromStringAndFormat(config) {</p>

<pre>// TODO: Move this to another part of the creation flow to prevent circular deps
...
checkOverflow(config);</pre>

<p>}</p>

<p>function meridiemFixWrap (locale, hour, meridiem) {</p>
