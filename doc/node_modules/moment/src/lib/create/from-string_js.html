...
<title>from-string.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/create/from-string.js">

<p>import { configFromStringAndFormat } from
&#39;./from-string-and-format&#39;; import { createUTCDate } from
&#39;./date-from-array&#39;; import { configFromArray } from
&#39;./from-array&#39;; import { hooks } from &#39;../utils/hooks&#39;;
import { deprecate } from &#39;../utils/deprecate&#39;; import
getParsingFlags from &#39;./parsing-flags&#39;; import
{defaultLocaleMonthsShort} from &#39;../units/month&#39;; import
{defaultLocaleWeekdaysShort} from &#39;../units/day-of-week&#39;;</p>

<p>// iso 8601 regex // 0000-00-00 0000-W00 or 0000-W00-0 + T + 00 or 00:00 or
00:00:00 or 00:00:00.000 + +00:00 or +0000 or +00) var extendedIsoRegex =
/^<a href=“+-”>s*((?:</a>d{6}|d{4})-(?:dd-dd|Wdd-d|Wdd|ddd|dd))(?:(T| )(<a
href=“.,”>dd(?::dd(?::dd(?:</a><a
href=“+-”>d+)?)?)?)(</a>dd(?::?dd)?|s*Z)?)?$/; var basicIsoRegex = /^<a
href=“+-”>s*((?:</a>d{6}|d{4})(?:dddd|Wddd|Wdd|ddd|dd))(?:(T| )(<a
href=“.,”>dd(?:dd(?:dd(?:</a><a
href=“+-”>d+)?)?)?)(</a>dd(?::?dd)?|s*Z)?)?$/;</p>

<p>var tzRegex = /<a href="+-">Z|</a>dd(?::?dd)?/;</p>

<p>var isoDates = [</p>

<pre>[&#39;YYYYYY-MM-DD&#39;, /[+-]\d{6}-\d\d-\d\d/],
...
<p>// iso time formats and regexes var isoTimes = [</p>

<pre>[&#39;HH:mm:ss.SSSS&#39;, /\d\d:\d\d:\d\d\.\d+/],
...
<p>var aspNetJsonRegex = /^/?Date((-?d+)/i;</p>

<p>// date from iso format export function configFromISO(config) {</p>
...
<p>// RFC 2822 regex: For details see <a
href="https://tools.ietf.org/html/rfc2822#section-3.3">tools.ietf.org/html/rfc2822#section-3.3</a>
var rfc2822 =
/^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?s)?(d{1,2})s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)s(d{2,4})<a
href=“ECMP”>s(dd):(dd)(?::(dd))?s(?:(UT|GMT|</a>[<a
href="Zz">SD]T)|(</a>)|([+-]d{4}))$/;</p>

<p>function extractFromRFC2822Strings(yearStr, monthStr, dayStr, hourStr,
minuteStr, secondStr) {</p>
...
<p>function untruncateYear(yearStr) {</p>

<pre>var year = parseInt(yearStr, 10);
if (year &lt;= 49) {
    return 2000 + year;
} else if (year &lt;= 999) {
    return 1900 + year;
...
<p>function preprocessRFC2822(s) {</p>

<pre>// Remove comments and folding whitespace and replace multiple-spaces with a single space
return s.replace(/\([^)]*\)|[\n\t]/g, &#39; &#39;).replace(/(\s\s+)/g, &#39; &#39;).replace(/^\s\s*/, &#39;&#39;).replace(/\s\s*$/, &#39;&#39;);</pre>

<p>}</p>

<p>function checkWeekday(weekdayStr, parsedInput, config) {</p>
...
<p>function calculateOffset(obsOffset, militaryOffset, numOffset) {</p>
...
<p>// date and time from ref 2822 format export function
configFromRFC2822(config) {</p>

<pre>var match = rfc2822.exec(preprocessRFC2822(config._i));
if (match) {
...
<p>// date from iso format or fallback export function
configFromString(config) {</p>

<pre>var matched = aspNetJsonRegex.exec(config._i);
...
hooks.createFromInputFallback(config);</pre>

<p>}</p>

<p>hooks.createFromInputFallback = deprecate(</p>

<pre>&#39;value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), &#39; +
