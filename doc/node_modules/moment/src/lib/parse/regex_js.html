...
<title>regex.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/parse/regex.js">

<p>export var match1         = /d/;            //       0 - 9 export var
match2         = /dd/;          //      00 - 99 export var match3         =
/d{3}/;         //     000 - 999 export var match4         = /d{4}/;       
//    0000 - 9999 export var match6         = /[+-]?d{6}/;    // -999999 -
999999 export var match1to2      = /dd?/;         //       0 - 99 export
var match3to4      = /dddd?/;     //     999 - 9999 export var match5to6   
= /dddddd?/; //   99999 - 999999 export var match1to3      = /d{1,3}/;     
//       0 - 999 export var match1to4      = /d{1,4}/;       //       0 -
9999 export var match1to6      = /[+-]?d{1,6}/;  // -999999 - 999999</p>

<p>export var matchUnsigned  = /d+/;           //       0 - inf export var
matchSigned    = /[+-]?d+/;      //    -inf - inf</p>

<p>export var matchOffset    = /<a href="+-">Z|</a>dd:?dd/gi; // +00:00 -00:00
+0000 -0000 or Z export var matchShortOffset = /<a
href="+-">Z|</a>dd(?::?dd)?/gi; // +00 -00 +00:00 -00:00 +0000 -0000 or Z</p>

<p>export var matchTimestamp = /[+-]?d+(.d{1,3})?/; // 123456789 123456789.123</p>

<p>// any word (or two) characters or numbers including two/three word month
in arabic. // includes scottish gaelic two word and hyphenated months
export var matchWord = /[0-9]<a
href="'a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF">0,256</a>{1,256}|[u0600-u06FF/]{1,256}(<a
href=“u0600-u06FF”>s*?</a>{1,256}){1,2}/i;</p>

<p>import hasOwnProp from &#39;../utils/has-own-prop&#39;; import isFunction
from &#39;../utils/is-function&#39;;</p>

<p>var regexes = {};</p>

<p>export function addRegexToken (token, regex, strictRegex) {</p>

<pre>regexes[token] = isFunction(regex) ? regex : function (isStrict, localeData) {
    return (isStrict &amp;&amp; strictRegex) ? strictRegex : regex;
};</pre>

<p>}</p>

<p>export function getParseRegexForToken (token, config) {</p>

<pre>if (!hasOwnProp(regexes, token)) {
    return new RegExp(unescapeFormat(token));
}

return regexes[token](config._strict, config._locale);</pre>

<p>}</p>

<p>// Code from <a
href="http://stackoverflow.com/questions/3561493/is-there-a-regexp-escape-function-in-javascript">stackoverflow.com/questions/3561493/is-there-a-regexp-escape-function-in-javascript</a>
function unescapeFormat(s) {</p>

<pre>return regexEscape(s.replace(&#39;\\&#39;, &#39;&#39;).replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (matched, p1, p2, p3, p4) {
    return p1 || p2 || p3 || p4;
}));</pre>

<p>}</p>

<p>export function regexEscape(s) {</p>

<pre>return s.replace(/[-\/\\^$*+?.()|[\]{}]/g, &#39;\\$&amp;&#39;);</pre>
