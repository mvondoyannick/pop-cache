...
<title>token.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/parse/token.js">

<p>import hasOwnProp from &#39;../utils/has-own-prop&#39;; import isNumber
from &#39;../utils/is-number&#39;; import toInt from
&#39;../utils/to-int&#39;;</p>

<p>var tokens = {};</p>

<p>export function addParseToken (token, callback) {</p>

<pre>var i, func = callback;
...
<p>export function addWeekParseToken (token, callback) {</p>

<pre>addParseToken(token, function (input, array, config, token) {
    config._w = config._w || {};
...
<p>export function addTimeToArrayFromToken(token, input, config) {</p>

<pre>if (input != null &amp;&amp; hasOwnProp(tokens, token)) {
