...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/moment.js">

<p>import { createLocal } from &#39;../create/local&#39;; import { createUTC }
from &#39;../create/utc&#39;; import { createInvalid } from
&#39;../create/valid&#39;; import { isMoment } from
&#39;./constructor&#39;; import { min, max } from &#39;./min-max&#39;;
import { now } from &#39;./now&#39;; import momentPrototype from
&#39;./prototype&#39;;</p>

<p>function createUnix (input) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">createLocal</span>(<span class="ruby-identifier">input</span> <span class="ruby-operator">*</span> <span class="ruby-value">1000</span>);
</pre>

<p>}</p>

<p>function createInZone () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">createLocal</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">null</span>, <span class="ruby-identifier">arguments</span>).<span class="ruby-identifier">parseZone</span>();
</pre>
