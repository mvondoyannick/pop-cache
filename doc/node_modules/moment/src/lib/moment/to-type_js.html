...
<title>to-type.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/to-type.js">

<p>export function valueOf () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_d</span>.<span class="ruby-identifier">valueOf</span>() <span class="ruby-operator">-</span> ((<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_offset</span> <span class="ruby-operator">||</span> <span class="ruby-value">0</span>) <span class="ruby-operator">*</span> <span class="ruby-value">60000</span>);
</pre>

<p>}</p>

<p>export function unix () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">floor</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">valueOf</span>() <span class="ruby-operator">/</span> <span class="ruby-value">1000</span>);
</pre>

<p>}</p>

<p>export function toDate () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">new</span> <span class="ruby-constant">Date</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">valueOf</span>());
</pre>

<p>}</p>

<p>export function toArray () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">m</span> = <span class="ruby-identifier">this</span>;
...
<p>export function toObject () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">m</span> = <span class="ruby-identifier">this</span>;
<span class="ruby-keyword">return</span> {
    <span class="ruby-value">years:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">year</span>(),
    <span class="ruby-value">months:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">month</span>(),
    <span class="ruby-value">date:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">date</span>(),
    <span class="ruby-value">hours:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">hours</span>(),
    <span class="ruby-value">minutes:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">minutes</span>(),
    <span class="ruby-value">seconds:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">seconds</span>(),
    <span class="ruby-value">milliseconds:</span> <span class="ruby-identifier">m</span>.<span class="ruby-identifier">milliseconds</span>()
};
</pre>

<p>}</p>

<p>export function toJSON () {</p>

<pre>// new Date(NaN).toJSON() === null
return this.isValid() ? this.toISOString() : null;</pre>
