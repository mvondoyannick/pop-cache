...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/add-subtract.js">

<p>import { get, set } from &#39;./get-set&#39;; import { setMonth } from
&#39;../units/month&#39;; import { createDuration } from
&#39;../duration/create&#39;; import { deprecateSimple } from
&#39;../utils/deprecate&#39;; import { hooks } from
&#39;../utils/hooks&#39;; import absRound from
&#39;../utils/abs-round&#39;;</p>

<p>// TODO: remove &#39;name&#39; arg after deprecation is removed function
createAdder(direction, name) {</p>

<pre>return function (val, period) {
    var dur, tmp;
...
<p>export function addSubtract (mom, duration, isAdding, updateOffset) {</p>

<pre>var milliseconds = duration._milliseconds,
...
<p>export var add      = createAdder(1, &#39;add&#39;); export var subtract =
createAdder(-1, &#39;subtract&#39;);</p>
</main>
