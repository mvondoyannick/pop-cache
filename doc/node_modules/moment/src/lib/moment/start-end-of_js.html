...
<title>start-end-of.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/start-end-of.js">

<p>import { normalizeUnits } from &#39;../units/aliases&#39;; import { hooks }
from &#39;../utils/hooks&#39;;</p>

<p>var MS_PER_SECOND = 1000; var MS_PER_MINUTE = 60 * MS_PER_SECOND; var
MS_PER_HOUR = 60 * MS_PER_MINUTE; var MS_PER_400_YEARS = (365 * 400 + 97) *
24 * MS_PER_HOUR;</p>

<p>// actual modulo - handles negative numbers (for dates before 1970):
function mod(dividend, divisor) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (<span class="ruby-identifier">dividend</span> <span class="ruby-operator">%</span> <span class="ruby-identifier">divisor</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">divisor</span>) <span class="ruby-operator">%</span> <span class="ruby-identifier">divisor</span>;
</pre>

<p>}</p>

<p>function localStartOfDate(y, m, d) {</p>

<pre>// the date constructor remaps years 0-99 to 1900-1999
if (y &lt; 100 &amp;&amp; y &gt;= 0) {
...
<p>function utcStartOfDate(y, m, d) {</p>

<pre>// Date.UTC remaps years 0-99 to 1900-1999
if (y &lt; 100 &amp;&amp; y &gt;= 0) {
    // preserve leap years using a full 400 year cycle, then reset
...
<p>export function startOf (units) {</p>
...
<p>export function endOf (units) {</p>
