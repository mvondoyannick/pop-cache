...
<title>locale.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/locale.js">

<p>import { getLocale } from &#39;../locale/locales&#39;; import { deprecate }
from &#39;../utils/deprecate&#39;;</p>

<p>// If passed a locale key, it will set the locale for this // instance. 
Otherwise, it will return the locale configuration // variables for this
instance. export function locale (key) {</p>

<pre>var newLocaleData;
...
<p>export var lang = deprecate(</p>

<pre>&#39;moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.&#39;,
function (key) {
    if (key === undefined) {
...
<p>export function localeData () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_locale</span>;
</pre>
