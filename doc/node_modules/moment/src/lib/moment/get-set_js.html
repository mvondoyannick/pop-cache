...
<title>get-set.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/get-set.js">

<p>import { normalizeUnits, normalizeObjectUnits } from
&#39;../units/aliases&#39;; import { getPrioritizedUnits } from
&#39;../units/priorities&#39;; import { hooks } from
&#39;../utils/hooks&#39;; import isFunction from
&#39;../utils/is-function&#39;; import { daysInMonth } from
&#39;../units/month&#39;; import { isLeapYear } from
&#39;../units/year&#39;;</p>

<p>export function makeGetSet (unit, keepTime) {</p>

<pre>return function (value) {
    if (value != null) {
        set(this, unit, value);
...
<p>export function get (mom, unit) {</p>

<pre>return mom.isValid() ?
    mom._d[&#39;get&#39; + (mom._isUTC ? &#39;UTC&#39; : &#39;&#39;) + unit]() : NaN;</pre>

<p>}</p>

<p>export function set (mom, unit, value) {</p>

<pre>if (mom.isValid() &amp;&amp; !isNaN(value)) {
...
<p>export function stringGet (units) {</p>
...
<p>export function stringSet (units, value) {</p>

<pre>if (typeof units === &#39;object&#39;) {
