...
<title>to.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/to.js">
...
<p>export function to (time, withoutSuffix) {</p>
...
<p>export function toNow (withoutSuffix) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">to</span>(<span class="ruby-identifier">createLocal</span>(), <span class="ruby-identifier">withoutSuffix</span>);
</pre>
