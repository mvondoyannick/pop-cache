...
<title>format.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/format.js">

<p>import { formatMoment } from &#39;../format/format&#39;; import { hooks }
from &#39;../utils/hooks&#39;; import isFunction from
&#39;../utils/is-function&#39;;</p>

<p>hooks.defaultFormat = &#39;YYYY-MM-DDTHH:mm:ssZ&#39;;
hooks.defaultFormatUtc = &#39;<a href="Z">YYYY-MM-DDTHH:mm:ss</a>&#39;;</p>

<p>export function toString () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">clone</span>().<span class="ruby-identifier">locale</span>(<span class="ruby-string">&#39;en&#39;</span>).<span class="ruby-identifier">format</span>(<span class="ruby-string">&#39;ddd MMM DD YYYY HH:mm:ss [GMT]ZZ&#39;</span>);
</pre>

<p>}</p>

<p>export function toISOString(keepOffset) {</p>
...
return formatMoment(m, utc ? &#39;YYYY-MM-DD[T]HH:mm:ss.SSS[Z]&#39; : &#39;YYYY-MM-DD[T]HH:mm:ss.SSSZ&#39;);</pre>

<p>}</p>

<pre>Return a human readable representation of a moment that can
also be evaluated to get a new moment which is the same

@link https://nodejs.org/dist/latest/docs/api/util.html#util_custom_inspect_function_on_objects</pre>

<p>export function inspect () {</p>
...
return this.format(prefix + year + datetime + suffix);</pre>

<p>}</p>

<p>export function format (inputString) {</p>

<pre>if (!inputString) {
    inputString = this.isUtc() ? hooks.defaultFormatUtc : hooks.defaultFormat;
}
var output = formatMoment(this, inputString);
return this.localeData().postformat(output);</pre>
