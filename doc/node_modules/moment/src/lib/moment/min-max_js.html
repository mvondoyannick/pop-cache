...
<title>min-max.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/min-max.js">

<p>import { deprecate } from &#39;../utils/deprecate&#39;; import isArray from
&#39;../utils/is-array&#39;; import { createLocal } from
&#39;../create/local&#39;; import { createInvalid } from
&#39;../create/valid&#39;;</p>

<p>export var prototypeMin = deprecate(</p>

<pre>&#39;moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/&#39;,
function () {
...
<p>export var prototypeMax = deprecate(</p>

<pre>&#39;moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/&#39;,
function () {
    var other = createLocal.apply(null, arguments);
    if (this.isValid() &amp;&amp; other.isValid()) {
        return other &gt; this ? this : other;
...
<p>// Pick a moment m from moments so that <a href="fn">m</a>(other) is true
for all // other. This relies on the function fn to be transitive. // //
moments should either be an array of moment objects or an array, whose //
first element is an array of moment objects. function pickBy(fn, moments) {</p>
...
<p>// TODO: Use [].sort instead? export function min () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">args</span> = [].<span class="ruby-identifier">slice</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">arguments</span>, <span class="ruby-value">0</span>);

<span class="ruby-keyword">return</span> <span class="ruby-identifier">pickBy</span>(<span class="ruby-string">&#39;isBefore&#39;</span>, <span class="ruby-identifier">args</span>);
</pre>

<p>}</p>

<p>export function max () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">args</span> = [].<span class="ruby-identifier">slice</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">arguments</span>, <span class="ruby-value">0</span>);

<span class="ruby-keyword">return</span> <span class="ruby-identifier">pickBy</span>(<span class="ruby-string">&#39;isAfter&#39;</span>, <span class="ruby-identifier">args</span>);
</pre>
