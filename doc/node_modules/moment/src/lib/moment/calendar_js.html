...
<title>calendar.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/calendar.js">

<p>import { createLocal } from &#39;../create/local&#39;; import {
cloneWithOffset } from &#39;../units/offset&#39;; import isFunction from
&#39;../utils/is-function&#39;; import { hooks } from
&#39;../utils/hooks&#39;;</p>

<p>export function getCalendarFormat(myMoment, now) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">diff</span> = <span class="ruby-identifier">myMoment</span>.<span class="ruby-identifier">diff</span>(<span class="ruby-identifier">now</span>, <span class="ruby-string">&#39;days&#39;</span>, <span class="ruby-keyword">true</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">diff</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">-6</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;sameElse&#39;</span> <span class="ruby-operator">:</span>
        <span class="ruby-identifier">diff</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">-1</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;lastWeek&#39;</span> <span class="ruby-operator">:</span>
        <span class="ruby-identifier">diff</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">0</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;lastDay&#39;</span> <span class="ruby-operator">:</span>
        <span class="ruby-identifier">diff</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">1</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;sameDay&#39;</span> <span class="ruby-operator">:</span>
        <span class="ruby-identifier">diff</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">2</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;nextDay&#39;</span> <span class="ruby-operator">:</span>
        <span class="ruby-identifier">diff</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">7</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;nextWeek&#39;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&#39;sameElse&#39;</span>;
</pre>

<p>}</p>

<p>export function calendar (time, formats) {</p>

<pre>// We want to compare the start of today, vs this.
...
return this.format(output || this.localeData().calendar(format, this, createLocal(now)));</pre>
