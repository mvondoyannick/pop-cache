...
<title>diff.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/diff.js">

<p>import absFloor from &#39;../utils/abs-floor&#39;; import { cloneWithOffset
} from &#39;../units/offset&#39;; import { normalizeUnits } from
&#39;../units/aliases&#39;;</p>

<p>export function diff (input, units, asFloat) {</p>
...
return asFloat ? output : absFloor(output);</pre>

<p>}</p>

<p>function monthDiff (a, b) {</p>

<pre>// difference in months
...
return -(wholeMonthDiff + adjust) || 0;</pre>
