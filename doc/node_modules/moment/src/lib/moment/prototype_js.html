...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/prototype.js">

<p>import { Moment } from &#39;./constructor&#39;;</p>

<p>var proto = Moment.prototype;</p>

<p>import { add, subtract } from &#39;./add-subtract&#39;; import { calendar,
getCalendarFormat } from &#39;./calendar&#39;; import { clone } from
&#39;./clone&#39;; import { isBefore, isBetween, isSame, isAfter,
isSameOrAfter, isSameOrBefore } from &#39;./compare&#39;; import { diff }
from &#39;./diff&#39;; import { format, toString, toISOString, inspect }
from &#39;./format&#39;; import { from, fromNow } from &#39;./from&#39;;
import { to, toNow } from &#39;./to&#39;; import { stringGet, stringSet }
from &#39;./get-set&#39;; import { locale, localeData, lang } from
&#39;./locale&#39;; import { prototypeMin, prototypeMax } from
&#39;./min-max&#39;; import { startOf, endOf } from
&#39;./start-end-of&#39;; import { valueOf, toDate, toArray, toObject,
toJSON, unix } from &#39;./to-type&#39;; import { isValid, parsingFlags,
invalidAt } from &#39;./valid&#39;; import { creationData } from
&#39;./creation-data&#39;;</p>

<p>proto.add               = add; proto.calendar          = calendar;
proto.clone             = clone; proto.diff              = diff;
proto.endOf             = endOf; proto.format            = format;
proto.from              = from; proto.fromNow           = fromNow; proto.to
= to; proto.toNow             = toNow; proto.get               = stringGet;
proto.invalidAt         = invalidAt; proto.isAfter           = isAfter;
proto.isBefore          = isBefore; proto.isBetween         = isBetween;
proto.isSame            = isSame; proto.isSameOrAfter     = isSameOrAfter;
proto.isSameOrBefore    = isSameOrBefore; proto.isValid           =
isValid; proto.lang              = lang; proto.locale            = locale;
proto.localeData        = localeData; proto.max               =
prototypeMax; proto.min               = prototypeMin; proto.parsingFlags   
= parsingFlags; proto.set               = stringSet; proto.startOf         
= startOf; proto.subtract          = subtract; proto.toArray           =
toArray; proto.toObject          = toObject; proto.toDate            =
toDate; proto.toISOString       = toISOString; proto.inspect           =
inspect; proto.toJSON            = toJSON; proto.toString          =
toString; proto.unix              = unix; proto.valueOf           =
valueOf; proto.creationData      = creationData;</p>

<p>// Year import { getSetYear, getIsLeapYear } from &#39;../units/year&#39;;
proto.year       = getSetYear; proto.isLeapYear = getIsLeapYear;</p>

<p>// Week Year import { getSetWeekYear, getSetISOWeekYear, getWeeksInYear,
getISOWeeksInYear } from &#39;../units/week-year&#39;; proto.weekYear    =
getSetWeekYear; proto.isoWeekYear = getSetISOWeekYear;</p>

<p>// Quarter import { getSetQuarter } from &#39;../units/quarter&#39;;
proto.quarter = proto.quarters = getSetQuarter;</p>

<p>// Month import { getSetMonth, getDaysInMonth } from
&#39;../units/month&#39;; proto.month       = getSetMonth;
proto.daysInMonth = getDaysInMonth;</p>

<p>// Week import { getSetWeek, getSetISOWeek } from &#39;../units/week&#39;;
proto.week           = proto.weeks        = getSetWeek; proto.isoWeek      
= proto.isoWeeks     = getSetISOWeek; proto.weeksInYear    =
getWeeksInYear; proto.isoWeeksInYear = getISOWeeksInYear;</p>

<p>// Day import { getSetDayOfMonth } from &#39;../units/day-of-month&#39;;
import { getSetDayOfWeek, getSetISODayOfWeek, getSetLocaleDayOfWeek } from
&#39;../units/day-of-week&#39;; import { getSetDayOfYear } from
&#39;../units/day-of-year&#39;; proto.date       = getSetDayOfMonth;
proto.day        = proto.days             = getSetDayOfWeek; proto.weekday 
= getSetLocaleDayOfWeek; proto.isoWeekday = getSetISODayOfWeek;
proto.dayOfYear  = getSetDayOfYear;</p>

<p>// Hour import { getSetHour } from &#39;../units/hour&#39;; proto.hour =
proto.hours = getSetHour;</p>

<p>// Minute import { getSetMinute } from &#39;../units/minute&#39;;
proto.minute = proto.minutes = getSetMinute;</p>

<p>// Second import { getSetSecond } from &#39;../units/second&#39;;
proto.second = proto.seconds = getSetSecond;</p>

<p>// Millisecond import { getSetMillisecond } from
&#39;../units/millisecond&#39;; proto.millisecond = proto.milliseconds =
getSetMillisecond;</p>
...
<p>} from &#39;../units/offset&#39;; proto.utcOffset            =
getSetOffset; proto.utc                  = setOffsetToUTC; proto.local     
= setOffsetToLocal; proto.parseZone            = setOffsetToParsedOffset;
proto.hasAlignedHourOffset = hasAlignedHourOffset; proto.isDST             
= isDaylightSavingTime; proto.isLocal              = isLocal;
proto.isUtcOffset          = isUtcOffset; proto.isUtc                =
isUtc; proto.isUTC                = isUtc;</p>

<p>// Timezone import { getZoneAbbr, getZoneName } from
&#39;../units/timezone&#39;; proto.zoneAbbr = getZoneAbbr; proto.zoneName =
getZoneName;</p>

<p>// Deprecations import { deprecate } from &#39;../utils/deprecate&#39;;
proto.dates  = deprecate(&#39;dates accessor is deprecated. Use date
instead.&#39;, getSetDayOfMonth); proto.months = deprecate(&#39;months
accessor is deprecated. Use month instead&#39;, getSetMonth); proto.years 
= deprecate(&#39;years accessor is deprecated. Use year instead&#39;,
getSetYear); proto.zone   = deprecate(&#39;moment().zone is deprecated, use
moment().utcOffset instead. <a
href="http://momentjs.com/guides/#/warnings/zone">momentjs.com/guides/#/warnings/zone</a>/&#39;,
getSetZone); proto.isDSTShifted = deprecate(&#39;isDSTShifted is
deprecated. See <a
href="http://momentjs.com/guides/#/warnings/dst-shifted">momentjs.com/guides/#/warnings/dst-shifted</a>/
for more information&#39;, isDaylightSavingTimeShifted);</p>

<p>export default proto;</p>
</main>
