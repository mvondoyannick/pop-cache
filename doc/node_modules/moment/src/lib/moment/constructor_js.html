...
<title>constructor.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/constructor.js">

<p>import { hooks } from &#39;../utils/hooks&#39;; import hasOwnProp from
&#39;../utils/has-own-prop&#39;; import isUndefined from
&#39;../utils/is-undefined&#39;; import getParsingFlags from
&#39;../create/parsing-flags&#39;;</p>

<p>// Plugins that add properties should also add the key here (null value),
// so we can properly clone ourselves. var momentProperties =
hooks.momentProperties = [];</p>

<p>export function copyConfig(to, from) {</p>
...
<p>var updateInProgress = false;</p>

<p>// Moment prototype object export function Moment(config) {</p>

<pre>copyConfig(this, config);
...
<p>export function isMoment (obj) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">obj</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Moment</span> <span class="ruby-operator">||</span> (<span class="ruby-identifier">obj</span> <span class="ruby-operator">!=</span> <span class="ruby-identifier">null</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">obj</span>.<span class="ruby-identifier">_isAMomentObject</span> <span class="ruby-operator">!=</span> <span class="ruby-identifier">null</span>);
</pre>
