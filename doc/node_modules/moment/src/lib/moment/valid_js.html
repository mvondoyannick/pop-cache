...
<title>valid.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/valid.js">

<p>import { isValid as _isValid } from &#39;../create/valid&#39;; import
extend from &#39;../utils/extend&#39;; import getParsingFlags from
&#39;../create/parsing-flags&#39;;</p>

<p>export function isValid () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">_isValid</span>(<span class="ruby-identifier">this</span>);
</pre>

<p>}</p>

<p>export function parsingFlags () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">extend</span>({}, <span class="ruby-identifier">getParsingFlags</span>(<span class="ruby-identifier">this</span>));
</pre>

<p>}</p>

<p>export function invalidAt () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">getParsingFlags</span>(<span class="ruby-identifier">this</span>).<span class="ruby-identifier">overflow</span>;
</pre>
