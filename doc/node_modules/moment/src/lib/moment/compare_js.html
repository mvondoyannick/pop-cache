...
<title>compare.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/compare.js">

<p>import { isMoment } from &#39;./constructor&#39;; import { normalizeUnits }
from &#39;../units/aliases&#39;; import { createLocal } from
&#39;../create/local&#39;;</p>

<p>export function isAfter (input, units) {</p>

<pre>var localInput = isMoment(input) ? input : createLocal(input);
...
<p>export function isBefore (input, units) {</p>
...
<p>export function isBetween (from, to, units, inclusivity) {</p>

<pre>var localFrom = isMoment(from) ? from : createLocal(from),
...
return (inclusivity[0] === &#39;(&#39; ? this.isAfter(localFrom, units) : !this.isBefore(localFrom, units)) &amp;&amp;
    (inclusivity[1] === &#39;)&#39; ? this.isBefore(localTo, units) : !this.isAfter(localTo, units));</pre>

<p>}</p>

<p>export function isSame (input, units) {</p>
...
<p>export function isSameOrAfter (input, units) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isSame</span>(<span class="ruby-identifier">input</span>, <span class="ruby-identifier">units</span>) <span class="ruby-operator">||</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">isAfter</span>(<span class="ruby-identifier">input</span>, <span class="ruby-identifier">units</span>);
</pre>

<p>}</p>

<p>export function isSameOrBefore (input, units) {</p>
