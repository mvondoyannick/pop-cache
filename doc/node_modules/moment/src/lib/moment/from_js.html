...
<title>from.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/moment/from.js">

<p>import { createDuration } from &#39;../duration/create&#39;; import {
createLocal } from &#39;../create/local&#39;; import { isMoment } from
&#39;../moment/constructor&#39;;</p>

<p>export function from (time, withoutSuffix) {</p>
...
<p>export function fromNow (withoutSuffix) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">from</span>(<span class="ruby-identifier">createLocal</span>(), <span class="ruby-identifier">withoutSuffix</span>);
</pre>
