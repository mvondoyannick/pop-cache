...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/abs.js">

<p>var mathAbs = Math.abs;</p>

<p>export function abs () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">data</span>           = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_data</span>;

<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_milliseconds</span> = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_milliseconds</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_days</span>         = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_days</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_months</span>       = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">_months</span>);

<span class="ruby-identifier">data</span>.<span class="ruby-identifier">milliseconds</span>  = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">milliseconds</span>);
<span class="ruby-identifier">data</span>.<span class="ruby-identifier">seconds</span>       = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">seconds</span>);
<span class="ruby-identifier">data</span>.<span class="ruby-identifier">minutes</span>       = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">minutes</span>);
<span class="ruby-identifier">data</span>.<span class="ruby-identifier">hours</span>         = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">hours</span>);
<span class="ruby-identifier">data</span>.<span class="ruby-identifier">months</span>        = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">months</span>);
<span class="ruby-identifier">data</span>.<span class="ruby-identifier">years</span>         = <span class="ruby-identifier">mathAbs</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">years</span>);
