...
<title>create.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/create.js">

<p>import { Duration, isDuration } from &#39;./constructor&#39;; import
isNumber from &#39;../utils/is-number&#39;; import toInt from
&#39;../utils/to-int&#39;; import absRound from
&#39;../utils/abs-round&#39;; import hasOwnProp from
&#39;../utils/has-own-prop&#39;; import { DATE, HOUR, MINUTE, SECOND,
MILLISECOND } from &#39;../units/constants&#39;; import { cloneWithOffset }
from &#39;../units/offset&#39;; import { createLocal } from
&#39;../create/local&#39;; import { createInvalid as invalid } from
&#39;./valid&#39;;</p>

<p>// ASP.NET json date format regex var aspNetRegex = /^(-|+)?(?:(d*)[.
])?(d+):(d+)(?::(d+)(.d*)?)?$/;</p>

<p>// from <a
href="http://docs.closure-library.googlecode.com/git/closure_goog_date_date.js.source.html">docs.closure-library.googlecode.com/git/closure_goog_date_date.js.source.html</a>
// somewhat more in line with 4.4.3.2 2004 spec, but allows decimal
anywhere // and further modified to allow for strings containing both week
and day var isoRegex = /^(-|+)?<a href="-+">P(?:(</a>?[<a
href="-+">0-9,.]*)Y)?(?:(</a>?[<a href="-+">0-9,.]*)M)?(?:(</a>?[<a
href="-+">0-9,.]*)W)?(?:(</a>?[<a href="-+">0-9,.]*)D)?(?:T(?:(</a>?[<a
href="-+">0-9,.]*)H)?(?:(</a>?[<a
href="-+">0-9,.]*)M)?(?:(</a>?[0-9,.]*)S)?)?$/;</p>

<p>export function createDuration (input, key) {</p>

<pre>var duration = input,
...
<p>createDuration.fn = Duration.prototype; createDuration.invalid = invalid;</p>

<p>function parseIso (inp, sign) {</p>

<pre>// We&#39;d normally use ~~inp for this, but unfortunately it also
// converts floats to ints.
// inp may be undefined, so careful calling replace on it.
var res = inp &amp;&amp; parseFloat(inp.replace(&#39;,&#39;, &#39;.&#39;));
// apply sign while we&#39;re at it
return (isNaN(res) ? 0 : res) * sign;</pre>

<p>}</p>

<p>function positiveMomentsDifference(base, other) {</p>
...
<p>function momentsDifference(base, other) {</p>
