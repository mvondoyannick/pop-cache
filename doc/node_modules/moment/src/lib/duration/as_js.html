...
<title>as.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/as.js">

<p>import { daysToMonths, monthsToDays } from &#39;./bubble&#39;; import {
normalizeUnits } from &#39;../units/aliases&#39;; import toInt from
&#39;../utils/to-int&#39;;</p>

<p>export function as (units) {</p>
...
<p>// TODO: Use this.as(&#39;ms&#39;)? export function valueOf () {</p>
...
<p>export var asMilliseconds = makeAs(&#39;ms&#39;); export var asSeconds     
= makeAs(&#39;s&#39;); export var asMinutes      = makeAs(&#39;m&#39;);
export var asHours        = makeAs(&#39;h&#39;); export var asDays        
= makeAs(&#39;d&#39;); export var asWeeks        = makeAs(&#39;w&#39;);
export var asMonths       = makeAs(&#39;M&#39;); export var asQuarters    
= makeAs(&#39;Q&#39;); export var asYears        = makeAs(&#39;y&#39;);</p>
</main>
