...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/get.js">

<p>import { normalizeUnits } from &#39;../units/aliases&#39;; import absFloor
from &#39;../utils/abs-floor&#39;;</p>

<p>export function get (units) {</p>

<pre>units = normalizeUnits(units);
return this.isValid() ? this[units + &#39;s&#39;]() : NaN;</pre>

<p>}</p>

<p>function makeGetter(name) {</p>
...
<p>export var milliseconds = makeGetter(&#39;milliseconds&#39;); export var
seconds      = makeGetter(&#39;seconds&#39;); export var minutes      =
makeGetter(&#39;minutes&#39;); export var hours        =
makeGetter(&#39;hours&#39;); export var days         =
makeGetter(&#39;days&#39;); export var months       =
makeGetter(&#39;months&#39;); export var years        =
makeGetter(&#39;years&#39;);</p>

<p>export function weeks () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">absFloor</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">days</span>() <span class="ruby-operator">/</span> <span class="ruby-value">7</span>);
</pre>
