...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/valid.js">

<p>import toInt from &#39;../utils/to-int&#39;; import indexOf from
&#39;../utils/index-of&#39;; import {Duration} from
&#39;./constructor&#39;; import {createDuration} from &#39;./create&#39;;</p>

<p>var ordering = [&#39;year&#39;, &#39;quarter&#39;, &#39;month&#39;,
&#39;week&#39;, &#39;day&#39;, &#39;hour&#39;, &#39;minute&#39;,
&#39;second&#39;, &#39;millisecond&#39;];</p>

<p>export default function isDurationValid(m) {</p>

<pre>for (var key in m) {
...
<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_isValid</span>;
</pre>

<p>}</p>

<p>export function createInvalid() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">createDuration</span>(<span class="ruby-constant">NaN</span>);
</pre>
