...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/prototype.js">

<p>import { Duration } from &#39;./constructor&#39;;</p>

<p>var proto = Duration.prototype;</p>

<p>import { abs } from &#39;./abs&#39;; import { add, subtract } from
&#39;./add-subtract&#39;; import { as, asMilliseconds, asSeconds,
asMinutes, asHours, asDays, asWeeks, asMonths, asQuarters, asYears, valueOf
} from &#39;./as&#39;; import { bubble } from &#39;./bubble&#39;; import {
clone } from &#39;./clone&#39;; import { get, milliseconds, seconds,
minutes, hours, days, months, years, weeks } from &#39;./get&#39;; import {
humanize } from &#39;./humanize&#39;; import { toISOString } from
&#39;./iso-string&#39;; import { lang, locale, localeData } from
&#39;../moment/locale&#39;; import { isValid } from &#39;./valid&#39;;</p>

<p>proto.isValid        = isValid; proto.abs            = abs; proto.add      
= add; proto.subtract       = subtract; proto.as             = as;
proto.asMilliseconds = asMilliseconds; proto.asSeconds      = asSeconds;
proto.asMinutes      = asMinutes; proto.asHours        = asHours;
proto.asDays         = asDays; proto.asWeeks        = asWeeks;
proto.asMonths       = asMonths; proto.asQuarters     = asQuarters;
proto.asYears        = asYears; proto.valueOf        = valueOf;
proto._bubble        = bubble; proto.clone          = clone; proto.get     
= get; proto.milliseconds   = milliseconds; proto.seconds        = seconds;
proto.minutes        = minutes; proto.hours          = hours; proto.days   
= days; proto.weeks          = weeks; proto.months         = months;
proto.years          = years; proto.humanize       = humanize;
proto.toISOString    = toISOString; proto.toString       = toISOString;
proto.toJSON         = toISOString; proto.locale         = locale;
proto.localeData     = localeData;</p>

<p>// Deprecations import { deprecate } from &#39;../utils/deprecate&#39;;</p>

<p>proto.toIsoString = deprecate(&#39;toIsoString() is deprecated. Please use
toISOString() instead (notice the capitals)&#39;, toISOString); proto.lang
= lang;</p>
</main>
