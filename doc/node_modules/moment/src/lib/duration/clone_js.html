...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/clone.js">

<p>import { createDuration } from &#39;./create&#39;;</p>

<p>export function clone () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">createDuration</span>(<span class="ruby-identifier">this</span>);
</pre>
