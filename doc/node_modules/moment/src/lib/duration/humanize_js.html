...
<title>humanize.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/humanize.js">

<p>import { createDuration } from &#39;./create&#39;;</p>

<p>var round = Math.round; var thresholds = {</p>

<pre>ss: 44,         // a few seconds to seconds
s : 45,         // seconds to minute
m : 45,         // minutes to hour
h : 22,         // hours to day
d : 26,         // days to month
M : 11          // months to year</pre>

<p>};</p>

<p>// helper function for moment.fn.from, moment.fn.fromNow, and
moment.duration.fn.humanize function substituteTimeAgo(string, number,
withoutSuffix, isFuture, locale) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">locale</span>.<span class="ruby-identifier">relativeTime</span>(<span class="ruby-identifier">number</span> <span class="ruby-operator">||</span> <span class="ruby-value">1</span>, <span class="ruby-operator">!</span><span class="ruby-operator">!</span><span class="ruby-identifier">withoutSuffix</span>, <span class="ruby-identifier">string</span>, <span class="ruby-identifier">isFuture</span>);
</pre>

<p>}</p>

<p>function relativeTime (posNegDuration, withoutSuffix, locale) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">duration</span> = <span class="ruby-identifier">createDuration</span>(<span class="ruby-identifier">posNegDuration</span>).<span class="ruby-identifier">abs</span>();
<span class="ruby-identifier">var</span> <span class="ruby-identifier">seconds</span>  = <span class="ruby-identifier">round</span>(<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">as</span>(<span class="ruby-string">&#39;s&#39;</span>));
<span class="ruby-identifier">var</span> <span class="ruby-identifier">minutes</span>  = <span class="ruby-identifier">round</span>(<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">as</span>(<span class="ruby-string">&#39;m&#39;</span>));
<span class="ruby-identifier">var</span> <span class="ruby-identifier">hours</span>    = <span class="ruby-identifier">round</span>(<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">as</span>(<span class="ruby-string">&#39;h&#39;</span>));
<span class="ruby-identifier">var</span> <span class="ruby-identifier">days</span>     = <span class="ruby-identifier">round</span>(<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">as</span>(<span class="ruby-string">&#39;d&#39;</span>));
<span class="ruby-identifier">var</span> <span class="ruby-identifier">months</span>   = <span class="ruby-identifier">round</span>(<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">as</span>(<span class="ruby-string">&#39;M&#39;</span>));
<span class="ruby-identifier">var</span> <span class="ruby-identifier">years</span>    = <span class="ruby-identifier">round</span>(<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">as</span>(<span class="ruby-string">&#39;y&#39;</span>));

<span class="ruby-identifier">var</span> <span class="ruby-identifier">a</span> = <span class="ruby-identifier">seconds</span> <span class="ruby-operator">&lt;=</span> <span class="ruby-identifier">thresholds</span>.<span class="ruby-identifier">ss</span> <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;s&#39;</span>, <span class="ruby-identifier">seconds</span>]  <span class="ruby-operator">||</span>
        <span class="ruby-identifier">seconds</span> <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">thresholds</span>.<span class="ruby-identifier">s</span>   <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;ss&#39;</span>, <span class="ruby-identifier">seconds</span>] <span class="ruby-operator">||</span>
        <span class="ruby-identifier">minutes</span> <span class="ruby-operator">&lt;=</span> <span class="ruby-value">1</span>             <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;m&#39;</span>]           <span class="ruby-operator">||</span>
        <span class="ruby-identifier">minutes</span> <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">thresholds</span>.<span class="ruby-identifier">m</span>   <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;mm&#39;</span>, <span class="ruby-identifier">minutes</span>] <span class="ruby-operator">||</span>
        <span class="ruby-identifier">hours</span>   <span class="ruby-operator">&lt;=</span> <span class="ruby-value">1</span>             <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;h&#39;</span>]           <span class="ruby-operator">||</span>
        <span class="ruby-identifier">hours</span>   <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">thresholds</span>.<span class="ruby-identifier">h</span>   <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;hh&#39;</span>, <span class="ruby-identifier">hours</span>]   <span class="ruby-operator">||</span>
        <span class="ruby-identifier">days</span>    <span class="ruby-operator">&lt;=</span> <span class="ruby-value">1</span>             <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;d&#39;</span>]           <span class="ruby-operator">||</span>
        <span class="ruby-identifier">days</span>    <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">thresholds</span>.<span class="ruby-identifier">d</span>   <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;dd&#39;</span>, <span class="ruby-identifier">days</span>]    <span class="ruby-operator">||</span>
        <span class="ruby-identifier">months</span>  <span class="ruby-operator">&lt;=</span> <span class="ruby-value">1</span>             <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;M&#39;</span>]           <span class="ruby-operator">||</span>
        <span class="ruby-identifier">months</span>  <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">thresholds</span>.<span class="ruby-constant">M</span>   <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;MM&#39;</span>, <span class="ruby-identifier">months</span>]  <span class="ruby-operator">||</span>
        <span class="ruby-identifier">years</span>   <span class="ruby-operator">&lt;=</span> <span class="ruby-value">1</span>             <span class="ruby-operator">&amp;&amp;</span> [<span class="ruby-string">&#39;y&#39;</span>]           <span class="ruby-operator">||</span> [<span class="ruby-string">&#39;yy&#39;</span>, <span class="ruby-identifier">years</span>];

<span class="ruby-identifier">a</span>[<span class="ruby-value">2</span>] = <span class="ruby-identifier">withoutSuffix</span>;
<span class="ruby-identifier">a</span>[<span class="ruby-value">3</span>] = <span class="ruby-operator">+</span><span class="ruby-identifier">posNegDuration</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0</span>;
<span class="ruby-identifier">a</span>[<span class="ruby-value">4</span>] = <span class="ruby-identifier">locale</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">substituteTimeAgo</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">null</span>, <span class="ruby-identifier">a</span>);
</pre>

<p>}</p>

<p>// This function allows you to set the rounding function for relative time
strings export function getSetRelativeTimeRounding (roundingFunction) {</p>

<pre>if (roundingFunction === undefined) {
    return round;
}
...
<p>// This function allows you to set a threshold for relative time strings
export function getSetRelativeTimeThreshold (threshold, limit) {</p>

<pre>if (thresholds[threshold] === undefined) {
    return false;
}
if (limit === undefined) {
...
<p>export function humanize (withSuffix) {</p>
...
return locale.postformat(output);</pre>
