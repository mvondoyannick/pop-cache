...
<title>add-subtract.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/add-subtract.js">

<p>import { createDuration } from &#39;./create&#39;;</p>

<p>function addSubtract (duration, input, value, direction) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">other</span> = <span class="ruby-identifier">createDuration</span>(<span class="ruby-identifier">input</span>, <span class="ruby-identifier">value</span>);

<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">_milliseconds</span> <span class="ruby-operator">+=</span> <span class="ruby-identifier">direction</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">other</span>.<span class="ruby-identifier">_milliseconds</span>;
<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">_days</span>         <span class="ruby-operator">+=</span> <span class="ruby-identifier">direction</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">other</span>.<span class="ruby-identifier">_days</span>;
<span class="ruby-identifier">duration</span>.<span class="ruby-identifier">_months</span>       <span class="ruby-operator">+=</span> <span class="ruby-identifier">direction</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">other</span>.<span class="ruby-identifier">_months</span>;

<span class="ruby-keyword">return</span> <span class="ruby-identifier">duration</span>.<span class="ruby-identifier">_bubble</span>();
</pre>

<p>}</p>

<p>// supports only 2.0-style add(1, &#39;s&#39;) or add(duration) export
function add (input, value) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">addSubtract</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">input</span>, <span class="ruby-identifier">value</span>, <span class="ruby-value">1</span>);
</pre>

<p>}</p>

<p>// supports only 2.0-style subtract(1, &#39;s&#39;) or subtract(duration)
export function subtract (input, value) {</p>
