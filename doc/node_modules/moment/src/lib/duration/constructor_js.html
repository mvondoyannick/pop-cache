...
<main role="main" aria-label="Page node_modules/moment/src/lib/duration/constructor.js">

<p>import { normalizeObjectUnits } from &#39;../units/aliases&#39;; import {
getLocale } from &#39;../locale/locales&#39;; import isDurationValid from
&#39;./valid.js&#39;;</p>

<p>export function Duration (duration) {</p>

<pre>var normalizedInput = normalizeObjectUnits(duration),
...
<p>export function isDuration (obj) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">obj</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Duration</span>;
</pre>
