...
<title>ordinal.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/locale/ordinal.js">

<p>export var defaultOrdinal = &#39;%d&#39;; export var
defaultDayOfMonthOrdinalParse = /d{1,2}/;</p>

<p>export function ordinal (number) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_ordinal</span>.<span class="ruby-identifier">replace</span>(<span class="ruby-string">&#39;%d&#39;</span>, <span class="ruby-identifier">number</span>);
</pre>
