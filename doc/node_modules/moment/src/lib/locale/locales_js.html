...
<title>locales.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/locale/locales.js">

<p>import isArray from &#39;../utils/is-array&#39;; import hasOwnProp from
&#39;../utils/has-own-prop&#39;; import isUndefined from
&#39;../utils/is-undefined&#39;; import compareArrays from
&#39;../utils/compare-arrays&#39;; import { deprecateSimple } from
&#39;../utils/deprecate&#39;; import { mergeConfigs } from &#39;./set&#39;;
import { Locale } from &#39;./constructor&#39;; import keys from
&#39;../utils/keys&#39;;</p>

<p>import { baseConfig } from &#39;./base-config&#39;;</p>

<p>// internal storage for locale config files var locales = {}; var
localeFamilies = {}; var globalLocale;</p>

<p>function normalizeLocale(key) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">key</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">key</span>.<span class="ruby-identifier">toLowerCase</span>().<span class="ruby-identifier">replace</span>(<span class="ruby-string">&#39;_&#39;</span>, <span class="ruby-string">&#39;-&#39;</span>) <span class="ruby-operator">:</span> <span class="ruby-identifier">key</span>;
</pre>

<p>}</p>

<p>// pick the locale from the array // try [&#39;en-au&#39;, &#39;en-gb&#39;]
as &#39;en-au&#39;, &#39;en-gb&#39;, &#39;en&#39;, as in move through the
list trying each // substring from most specific to least, but move to the
next array item if it&#39;s a more specific variant than the current root
function chooseLocale(names) {</p>

<pre>var i = 0, j, next, locale, split;
...
return globalLocale;</pre>

<p>}</p>

<p>function loadLocale(name) {</p>

<pre>var oldLocale = null;
...
return locales[name];</pre>

<p>}</p>

<p>// This function will load locale and then set the global locale.  If // no
arguments are passed in, it will simply return the current global // locale
key. export function getSetGlobalLocale (key, values) {</p>
...
return globalLocale._abbr;</pre>

<p>}</p>

<p>export function defineLocale (name, config) {</p>
...
<p>export function updateLocale(name, config) {</p>
...
<p>// returns locale data export function getLocale (key) {</p>
...
return chooseLocale(key);</pre>

<p>}</p>

<p>export function listLocales() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">keys</span>(<span class="ruby-identifier">locales</span>);
</pre>
