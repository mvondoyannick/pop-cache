...
<main role="main" aria-label="Page node_modules/moment/src/lib/locale/prototype.js">

<p>import { Locale } from &#39;./constructor&#39;;</p>

<p>var proto = Locale.prototype;</p>

<p>import { calendar } from &#39;./calendar&#39;; import { longDateFormat }
from &#39;./formats&#39;; import { invalidDate } from &#39;./invalid&#39;;
import { ordinal } from &#39;./ordinal&#39;; import { preParsePostFormat }
from &#39;./pre-post-format&#39;; import { relativeTime, pastFuture } from
&#39;./relative&#39;; import { set } from &#39;./set&#39;;</p>

<p>proto.calendar        = calendar; proto.longDateFormat  = longDateFormat;
proto.invalidDate     = invalidDate; proto.ordinal         = ordinal;
proto.preparse        = preParsePostFormat; proto.postformat      =
preParsePostFormat; proto.relativeTime    = relativeTime; proto.pastFuture 
= pastFuture; proto.set             = set;</p>

<p>// Month import {</p>

<pre>localeMonthsParse,
localeMonths,
localeMonthsShort,
monthsRegex,
monthsShortRegex</pre>

<p>} from &#39;../units/month&#39;;</p>

<p>proto.months            =        localeMonths; proto.monthsShort       =   
localeMonthsShort; proto.monthsParse       =        localeMonthsParse;
proto.monthsRegex       = monthsRegex; proto.monthsShortRegex  =
monthsShortRegex;</p>

<p>// Week import { localeWeek, localeFirstDayOfYear, localeFirstDayOfWeek }
from &#39;../units/week&#39;; proto.week = localeWeek; proto.firstDayOfYear
= localeFirstDayOfYear; proto.firstDayOfWeek = localeFirstDayOfWeek;</p>

<p>// Day of Week import {</p>

<pre>localeWeekdaysParse,
localeWeekdays,
localeWeekdaysMin,
localeWeekdaysShort,
...
weekdaysRegex,
weekdaysShortRegex,
weekdaysMinRegex</pre>

<p>} from &#39;../units/day-of-week&#39;;</p>

<p>proto.weekdays       =        localeWeekdays; proto.weekdaysMin    =       
localeWeekdaysMin; proto.weekdaysShort  =        localeWeekdaysShort;
proto.weekdaysParse  =        localeWeekdaysParse;</p>

<p>proto.weekdaysRegex       =        weekdaysRegex; proto.weekdaysShortRegex 
=        weekdaysShortRegex; proto.weekdaysMinRegex    =       
weekdaysMinRegex;</p>

<p>// Hours import { localeIsPM, localeMeridiem } from
&#39;../units/hour&#39;;</p>

<p>proto.isPM = localeIsPM; proto.meridiem = localeMeridiem;</p>
</main>
