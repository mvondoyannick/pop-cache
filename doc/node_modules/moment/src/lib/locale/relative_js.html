...
<title>relative.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/locale/relative.js">

<p>export var defaultRelativeTime = {</p>
...
<p>import isFunction from &#39;../utils/is-function&#39;;</p>

<p>export function relativeTime (number, withoutSuffix, string, isFuture) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">output</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_relativeTime</span>[<span class="ruby-identifier">string</span>];
<span class="ruby-keyword">return</span> (<span class="ruby-identifier">isFunction</span>(<span class="ruby-identifier">output</span>)) <span class="ruby-operator">?</span>
    <span class="ruby-identifier">output</span>(<span class="ruby-identifier">number</span>, <span class="ruby-identifier">withoutSuffix</span>, <span class="ruby-identifier">string</span>, <span class="ruby-identifier">isFuture</span>) <span class="ruby-operator">:</span>
    <span class="ruby-identifier">output</span>.<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/%d/i</span>, <span class="ruby-identifier">number</span>);
</pre>

<p>}</p>

<p>export function pastFuture (diff, output) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">format</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_relativeTime</span>[<span class="ruby-identifier">diff</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0</span> <span class="ruby-operator">?</span> <span class="ruby-string">&#39;future&#39;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&#39;past&#39;</span>];
<span class="ruby-keyword">return</span> <span class="ruby-identifier">isFunction</span>(<span class="ruby-identifier">format</span>) <span class="ruby-operator">?</span> <span class="ruby-identifier">format</span>(<span class="ruby-identifier">output</span>) <span class="ruby-operator">:</span> <span class="ruby-identifier">format</span>.<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/%s/i</span>, <span class="ruby-identifier">output</span>);
</pre>
