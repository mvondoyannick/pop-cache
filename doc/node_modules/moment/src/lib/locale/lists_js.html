...
<title>lists.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/locale/lists.js">

<p>import isNumber from &#39;../utils/is-number&#39;; import { getLocale }
from &#39;./locales&#39;; import { createUTC } from
&#39;../create/utc&#39;;</p>

<p>function get (format, index, field, setter) {</p>

<pre>var locale = getLocale();
var utc = createUTC().set(setter, index);
return locale[field](utc, format);</pre>

<p>}</p>

<p>function listMonthsImpl (format, index, field) {</p>

<pre>if (isNumber(format)) {
    index = format;
    format = undefined;
}
...
<p>// () // (5) // (fmt, 5) // (fmt) // (true) // (true, 5) // (true, fmt, 5)
// (true, fmt) function listWeekdaysImpl (localeSorted, format, index,
field) {</p>

<pre>if (typeof localeSorted === &#39;boolean&#39;) {
    if (isNumber(format)) {
        index = format;
        format = undefined;
    }
...
<p>export function listMonths (format, index) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">listMonthsImpl</span>(<span class="ruby-identifier">format</span>, <span class="ruby-identifier">index</span>, <span class="ruby-string">&#39;months&#39;</span>);
</pre>

<p>}</p>

<p>export function listMonthsShort (format, index) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">listMonthsImpl</span>(<span class="ruby-identifier">format</span>, <span class="ruby-identifier">index</span>, <span class="ruby-string">&#39;monthsShort&#39;</span>);
</pre>

<p>}</p>

<p>export function listWeekdays (localeSorted, format, index) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">listWeekdaysImpl</span>(<span class="ruby-identifier">localeSorted</span>, <span class="ruby-identifier">format</span>, <span class="ruby-identifier">index</span>, <span class="ruby-string">&#39;weekdays&#39;</span>);
</pre>

<p>}</p>

<p>export function listWeekdaysShort (localeSorted, format, index) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">listWeekdaysImpl</span>(<span class="ruby-identifier">localeSorted</span>, <span class="ruby-identifier">format</span>, <span class="ruby-identifier">index</span>, <span class="ruby-string">&#39;weekdaysShort&#39;</span>);
</pre>

<p>}</p>

<p>export function listWeekdaysMin (localeSorted, format, index) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">listWeekdaysImpl</span>(<span class="ruby-identifier">localeSorted</span>, <span class="ruby-identifier">format</span>, <span class="ruby-identifier">index</span>, <span class="ruby-string">&#39;weekdaysMin&#39;</span>);
</pre>
