...
<main role="main" aria-label="Page node_modules/moment/src/lib/utils/some.js">

<p>var some; if (Array.prototype.some) {</p>

<pre class="ruby"><span class="ruby-identifier">some</span> = <span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>.<span class="ruby-identifier">some</span>;
</pre>

<p>} else {</p>

<pre>some = function (fun) {
    var t = Object(this);
    var len = t.length &gt;&gt;&gt; 0;
