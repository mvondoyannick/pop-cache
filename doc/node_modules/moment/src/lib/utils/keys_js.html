...
<title>keys.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/utils/keys.js">

<p>import hasOwnProp from &#39;./has-own-prop&#39;;</p>

<p>var keys;</p>

<p>if (Object.keys) {</p>

<pre class="ruby"><span class="ruby-identifier">keys</span> = <span class="ruby-constant">Object</span>.<span class="ruby-identifier">keys</span>;
</pre>

<p>} else {</p>

<pre>keys = function (obj) {
    var i, res = [];
    for (i in obj) {
        if (hasOwnProp(obj, i)) {
            res.push(i);
