...
<title>hooks.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/utils/hooks.js">

<p>export { hooks, setHookCallback };</p>

<p>var hookCallback;</p>

<p>function hooks () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">hookCallback</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">null</span>, <span class="ruby-identifier">arguments</span>);
</pre>

<p>}</p>

<p>// This is done to register the method called with moment() // without
creating circular dependencies. function setHookCallback (callback) {</p>

<pre class="ruby"><span class="ruby-identifier">hookCallback</span> = <span class="ruby-identifier">callback</span>;
</pre>
