...
<main role="main" aria-label="Page node_modules/moment/src/lib/utils/mod.js">

<p>export default function mod(n, x) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> ((<span class="ruby-identifier">n</span> <span class="ruby-operator">%</span> <span class="ruby-identifier">x</span>) <span class="ruby-operator">+</span> <span class="ruby-identifier">x</span>) <span class="ruby-operator">%</span> <span class="ruby-identifier">x</span>;
</pre>
