...
<title>deprecate.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/utils/deprecate.js">

<p>import extend from &#39;./extend&#39;; import { hooks } from
&#39;./hooks&#39;; import isUndefined from &#39;./is-undefined&#39;;</p>

<p>function warn(msg) {</p>

<pre>if (hooks.suppressDeprecationWarnings === false &amp;&amp;
...
<p>export function deprecate(msg, fn) {</p>

<pre>var firstTime = true;
...
<p>var deprecations = {};</p>

<p>export function deprecateSimple(name, msg) {</p>

<pre>if (hooks.deprecationHandler != null) {
...
<p>hooks.suppressDeprecationWarnings = false; hooks.deprecationHandler = null;</p>
</main>
