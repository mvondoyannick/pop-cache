...
<title>compare-arrays.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/lib/utils/compare-arrays.js">

<p>import toInt from &#39;./to-int&#39;;</p>

<p>// compare two arrays, return the number of differences export default
function compareArrays(array1, array2, dontConvert) {</p>

<pre>var len = Math.min(array1.length, array2.length),
