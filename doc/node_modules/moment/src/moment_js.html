...
<title>moment.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/moment/src/moment.js">

<p>//! moment.js //! version : 2.24.0 //! authors : Tim Wood, Iskren Chernev,
Moment.js contributors //! license : MIT //! momentjs.com</p>

<p>import { hooks as moment, setHookCallback } from
&#39;./lib/utils/hooks&#39;;</p>

<p>moment.version = &#39;2.24.0&#39;;</p>
...
createInZone    as parseZone</pre>

<p>} from &#39;./lib/moment/moment&#39;;</p>

<p>import {</p>

<pre class="ruby"><span class="ruby-identifier">getCalendarFormat</span>
</pre>

<p>} from &#39;./lib/moment/calendar&#39;;</p>
...
listWeekdaysShort  as weekdaysShort</pre>

<p>} from &#39;./lib/locale/locale&#39;;</p>
...
getSetRelativeTimeThreshold as relativeTimeThreshold</pre>

<p>} from &#39;./lib/duration/duration&#39;;</p>

<p>import { normalizeUnits } from &#39;./lib/units/units&#39;;</p>

<p>import isDate from &#39;./lib/utils/is-date&#39;;</p>

<p>setHookCallback(local);</p>

<p>moment.fn                    = fn; moment.min                   = min;
moment.max                   = max; moment.now                   = now;
moment.utc                   = utc; moment.unix                  = unix;
moment.months                = months; moment.isDate                =
isDate; moment.locale                = locale; moment.invalid              
= invalid; moment.duration              = duration; moment.isMoment        
= isMoment; moment.weekdays              = weekdays; moment.parseZone      
= parseZone; moment.localeData            = localeData; moment.isDuration  
= isDuration; moment.monthsShort           = monthsShort;
moment.weekdaysMin           = weekdaysMin; moment.defineLocale          =
defineLocale; moment.updateLocale          = updateLocale; moment.locales  
= locales; moment.weekdaysShort         = weekdaysShort;
moment.normalizeUnits        = normalizeUnits; moment.relativeTimeRounding 
= relativeTimeRounding; moment.relativeTimeThreshold =
relativeTimeThreshold; moment.calendarFormat        = getCalendarFormat;
moment.prototype             = fn;</p>

<p>// currently HTML5 input type only supports 24-hour formats
moment.HTML5_FMT = {</p>

<pre>DATETIME_LOCAL: &#39;YYYY-MM-DDTHH:mm&#39;,             // &lt;input type=&quot;datetime-local&quot; /&gt;
...
MONTH: &#39;YYYY-MM&#39;                                // &lt;input type=&quot;month&quot; /&gt;</pre>

<p>};</p>

<p>export default moment;</p>
</main>
