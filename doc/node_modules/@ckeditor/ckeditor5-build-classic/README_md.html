...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-CKEditor+5+classic+editor+build">CKEditor 5 classic editor build</a>
...
<main role="main" aria-label="Page node_modules/@ckeditor/ckeditor5-build-classic/README.md">

<h1 id="label-CKEditor+5+classic+editor+build">CKEditor 5 classic editor build<span><a href="#label-CKEditor+5+classic+editor+build">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a
href="https://gitter.im/ckeditor/ckeditor5?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"><img
src="https://badges.gitter.im/ckeditor/ckeditor5.svg"></a> <a
href="https://www.npmjs.com/package/@ckeditor/ckeditor5-build-classic"><img
src="https://badge.fury.io/js/%40ckeditor%2Fckeditor5-build-classic.svg"></a>
<a href="https://david-dm.org/ckeditor/ckeditor5-build-classic"><img
src="https://david-dm.org/ckeditor/ckeditor5-build-classic/status.svg"></a>
<a
href="https://david-dm.org/ckeditor/ckeditor5-build-classic?type=dev"><img
src="https://david-dm.org/ckeditor/ckeditor5-build-classic/dev-status.svg"></a></p>

<p>The classic editor build for CKEditor 5. Read more about the <a
href="https://docs.ckeditor.com/ckeditor5/latest/builds/guides/overview.html#classic-editor">classic
editor build</a> and see the <a
href="https://docs.ckeditor.com/ckeditor5/latest/examples/builds/classic-editor.html">demo</a>.</p>
...
<ul><li>
<p><a
href="https://docs.ckeditor.com/ckeditor5/latest/builds/guides/integration/installation.html">Installation</a>
for how to install this package and what it contains.</p>
</li><li>
<p><a
href="https://docs.ckeditor.com/ckeditor5/latest/builds/guides/integration/basic-api.html">Basic
API</a> for how to create an editor and interact with it.</p>
</li><li>
<p><a
href="https://docs.ckeditor.com/ckeditor5/latest/builds/guides/integration/configuration.html">Configuration</a>
for how to configure the editor.</p>
</li><li>
<p><a
href="https://docs.ckeditor.com/ckeditor5/latest/builds/guides/development/custom-builds.html">Creating
custom builds</a> for how to customize the build (configure and rebuild the
editor bundle).</p>
</li></ul>
...
<pre>npm install --save @ckeditor/ckeditor5-build-classic</pre>
...
<p>Or in your JavaScript application:</p>

<pre>import ClassicEditor from &#39;@ckeditor/ckeditor5-build-classic&#39;;
...
<p><strong>Note:</strong> If you are planning to integrate CKEditor 5 deep
into your application, it is actually more convenient and recommended to
install and import the source modules directly (like it happens in
<code>ckeditor.js</code>). Read more in the <a
href="https://docs.ckeditor.com/ckeditor5/latest/builds/guides/integration/advanced-setup.html">Advanced
setup guide</a>.</p>
...
<p>Licensed under the GPL, LGPL and MPL licenses, at your choice. For full
details about the license, please check the <code>LICENSE.md</code> file.</p>
</main>
