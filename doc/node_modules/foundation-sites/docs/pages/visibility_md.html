...
<title>visibility - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+show"> - show</a>
    <li><a href="#label-Show+by+Screen+Size">Show by Screen Size</a>
    <li><a href="#label-Hide+by+Screen+Size">Hide by Screen Size</a>
    <li><a href="#label-Generic+Hide+Classes">Generic Hide Classes</a>
    <li><a href="#label-Orientation+Detection">Orientation Detection</a>
    <li><a href="#label-Accessibility">Accessibility</a>
    <li><a href="#label-Show+for+Screen+Readers+Only">Show for Screen Readers Only</a>
    <li><a href="#label-Hide+for+Screen+Readers+Only">Hide for Screen Readers Only</a>
    <li><a href="#label-Creating+Skip+Links">Creating Skip Links</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/visibility.md">

<p>— title: Visibility Classes description: Visibility classes let you show or
hide elements based on screen size or device orientation. You can also use
visibility classes to control which elements users see depending on their
browsing environment. video: &#39;j__6VmFdSnc&#39; sass:
scss/components/_visibility.scss tags:  - hide</p>

<h2 id="label-+-+show"> - show<span><a href="#label-+-+show">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-Show+by+Screen+Size">Show by Screen Size<span><a href="#label-Show+by+Screen+Size">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>In this example, we use the <code>.show</code> visibility classes to show
certain strings of text based on the device on which users view a page. If
their browser meets the class&#39;s conditions, the element will be shown.
If not, it will be hidden.</p>

<pre>&lt;p&gt;You are on a small screen or larger.&lt;/p&gt;
&lt;p class=&quot;show-for-medium&quot;&gt;You are on a medium screen or larger.&lt;/p&gt;
&lt;p class=&quot;show-for-large&quot;&gt;You are on a large screen or larger.&lt;/p&gt;</pre>

<p>These classes automatically hide the element on screen sizes <em>below</em>
what&#39;s specified in the class. So <code>.show-for-medium</code> will
hide the element on small, and show it on medium and larger.</p>

<p>A separate set of classes allow you to show content <em>only</em> on a
certain screen size. Just add <code>-only</code> to the end of the class.</p>
<div class="primary callout">
  <p>Don't see any text below the code sample? You must be on an *extra* large screen.</p>
</div>
<pre>&lt;p class=&quot;show-for-small-only&quot;&gt;You are &lt;em&gt;definitely&lt;/em&gt; on a small screen.&lt;/p&gt;
&lt;p class=&quot;show-for-medium-only&quot;&gt;You are &lt;em&gt;definitely&lt;/em&gt; on a medium screen.&lt;/p&gt;
&lt;p class=&quot;show-for-large-only&quot;&gt;You are &lt;em&gt;definitely&lt;/em&gt; on a large screen.&lt;/p&gt;</pre>
<hr>

<h2 id="label-Hide+by+Screen+Size">Hide by Screen Size<span><a href="#label-Hide+by+Screen+Size">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>This example shows the opposite: It uses the <code>.hide</code> visibility
classes to state which elements should disappear based on the device&#39;s
screen size.</p>
<div class="primary callout">
...
<pre>&lt;p class=&quot;hide-for-medium&quot;&gt;You are &lt;em&gt;not&lt;/em&gt; on a medium screen or larger.&lt;/p&gt;
&lt;p class=&quot;hide-for-large&quot;&gt;You are &lt;em&gt;not&lt;/em&gt; on a large screen or larger.&lt;/p&gt;</pre>
<p class="show-for-large">If you're reading this, you're on a large screen, and can't see either of the above examples.</p>
<p>Like with <code>.show</code>, these classes also have <code>-only</code>
versions.</p>

<pre>&lt;p class=&quot;hide-for-small-only&quot;&gt;You are &lt;em&gt;definitely not&lt;/em&gt; on a small screen.&lt;/p&gt;
&lt;p class=&quot;hide-for-medium-only&quot;&gt;You are &lt;em&gt;definitely not&lt;/em&gt; on a medium screen.&lt;/p&gt;
&lt;p class=&quot;hide-for-large-only&quot;&gt;You are &lt;em&gt;definitely not&lt;/em&gt; on a large screen.&lt;/p&gt;</pre>

<h3 id="label-Generic+Hide+Classes">Generic Hide Classes<span><a href="#label-Generic+Hide+Classes">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>And if you really just need something hidden no matter what, there are
classes for that as well. The <code>.hide</code> and
<code>.invisible</code> classes respectively set <code>display: none</code>
and <code>visibility: hidden</code> on an element. Note that both of these
classes hide content from screen readers.</p>

<pre>&lt;p class=&quot;hide&quot;&gt;Can&#39;t touch this.&lt;/p&gt;
&lt;p class=&quot;invisible&quot;&gt;Can sort of touch this.&lt;/p&gt;</pre>
<hr>

<h2 id="label-Orientation+Detection">Orientation Detection<span><a href="#label-Orientation+Detection">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>This straightforward example shows how two strings of text determine
whether or not an element is visible in different orientations. This will
change on mobile devices when you rotate the device. On desktop, the
orientation is almost always reported as landscape.</p>

<pre>&lt;p class=&quot;show-for-landscape&quot;&gt;You are in landscape orientation.&lt;/p&gt;
&lt;p class=&quot;show-for-portrait&quot;&gt;You are in portrait orientation.&lt;/p&gt;</pre>
<hr>

<h2 id="label-Accessibility">Accessibility<span><a href="#label-Accessibility">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Adding <code>display: none</code> to an element will prevent screen readers
from reading it. However, there are techniques to hide content while still
making it readable by screen readers.</p>

<h3 id="label-Show+for+Screen+Readers+Only">Show for Screen Readers Only<span><a href="#label-Show+for+Screen+Readers+Only">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To visually hide content, while still allowing assistive technology to read
it, add the class show-for-sr.</p>

<pre>&lt;p class=&quot;show-for-sr&quot;&gt;This text can only be read by a screen reader.&lt;/p&gt;
&lt;p&gt;There&#39;s a line of text above this one, you just can&#39;t see it.&lt;/p&gt;</pre>

<h3 id="label-Hide+for+Screen+Readers+Only">Hide for Screen Readers Only<span><a href="#label-Hide+for+Screen+Readers+Only">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To hide text from assistive technology, while still keeping it visible, add
the attribute <code>aria-hidden=&quot;true&quot;</code>. This doesn&#39;t
affect how the element looks, but screen readers will skip over it.</p>
<div class="primary callout">
...
<pre>&lt;p aria-hidden=&quot;true&quot;&gt;This text can be seen, but won&#39;t be read by a screen reader.&lt;/p&gt;</pre>

<h3 id="label-Creating+Skip+Links">Creating Skip Links<span><a href="#label-Creating+Skip+Links">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If your site has a lot of navigation, a screen reader will have to read
through the entire navigation to get to your site&#39;s content. To remedy
this, you can add a <em>skip link</em> at the very top of your page, which
will send the user farther down the page, past the navigation when clicked
on.</p>

<p>Use the class <code>.show-on-focus</code> to hide an element, except when
it has focus. Adding <code>tabindex=&quot;-1&quot;</code> to the target
element makes it focusable. (Or set it to <code>0</code> if the user should
be able to tab to that element as well. See also <a
href="https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex">the
MDN docs on tabindex</a>.)</p>

<pre>&lt;p&gt;&lt;a class=&quot;show-on-focus&quot; href=&quot;#mainContent&quot;&gt;Skip to Content&lt;/a&gt;&lt;/p&gt;
