...
<title>abide - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+validation"> - validation</a>
    <li><a href="#label-Abide+Demo">Abide Demo</a>
    <li><a href="#label-Form+Errors">Form Errors</a>
    <li><a href="#label-Initial+State">Initial State</a>
    <li><a href="#label-Error+State">Error State</a>
    <li><a href="#label-Ignored+Inputs">Ignored Inputs</a>
    <li><a href="#label-Event+Listener">Event Listener</a>
    <li><a href="#label-Builtin+Patterns+and+Validators">Builtin Patterns and Validators</a>
    <li><a href="#label-Adding+Custom+Pattern+and+Validator">Adding Custom Pattern and Validator</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/abide.md">

<p>— title: Abide description: Abide is a form validation library that extends
the HTML5 validation API with custom validators. sass:
scss/forms/_error.scss js: js/foundation.abide.js video:
&#39;4bN0qr5pxjs&#39; tags:  - forms</p>

<h2 id="label-+-+validation"> - validation<span><a href="#label-+-+validation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Abide+Demo">Abide Demo<span><a href="#label-Abide+Demo">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<code>time</code>, <code>url</code> and <code>week</code>. Note the use of
the novalidate attribute to disable any browser validation that could
conflict with Abide.</p>
<p>
...
&lt;/form&gt;</pre>
<hr>
<p>&nbsp;</p><div class="alert callout">
  <p><i class="fi-alert"></i> There are some errors in your form.</p>
</div>
<p>&lt;label class=“is-invalid-label”&gt;  Required Thing  &lt;input
type=“text” class=“is-invalid-input” aria-describedby=“exemple2Error”
data-invalid aria-invalid=“true”&gt;  &lt;span class=“form-error
is-visible” id=“exemple2Error”&gt;  Yo, you had better fill this out. 
&lt;/span&gt; &lt;/label&gt;</p>

<p>&lt;label class=“is-invalid-label”&gt;  Required Thing  &lt;textarea
type=“text” class=“is-invalid-input” data-invalid
aria-invalid=“true”&gt;&lt;/textarea&gt; &lt;/label&gt;</p>
<hr>

<h3 id="label-Form+Errors">Form Errors<span><a href="#label-Form+Errors">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Abide automatically detects Form Errors of an input by their class
(<code>.form-error</code> by default, see the
<code>formErrorSelector</code> option) when they are siblings of the input
or inside the same parent.</p>

<p>When the Form Errors cannot be placed next to its field, like in an Input
Group, the relation can be declared with <code>[data-form-error-for]</code>
attribute.</p>
...
<h2 id="label-Initial+State">Initial State<span><a href="#label-Initial+State">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-Error+State">Error State<span><a href="#label-Error+State">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-Ignored+Inputs">Ignored Inputs<span><a href="#label-Ignored+Inputs">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-Event+Listener">Event Listener<span><a href="#label-Event+Listener">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Setup event listener after foundation is initialized (especially for
formvalid/forminvalid). Easier to chain via document selector. 
valid.zf.abide and invalid.zf.abide are field level events, triggered in
validateInput function  ev.target is the DOM field element,  elem is jQuery
selector for field element  formvalid.zf.abide and forminvalid.zf.abide are
form events, triggered in validateForm function  ev.target is the DOM form
element,  frm is jQuery selector for form element</p>
...
<h2 id="label-Builtin+Patterns+and+Validators">Builtin Patterns and Validators<span><a href="#label-Builtin+Patterns+and+Validators">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following patterns and validators are already built in:</p>

<p><code>alpha</code>, <code>alpha_numeric</code>, <code>card</code>,
<code>color</code> <code>cvv</code>, <code>date</code>,
<code>dateISO</code>, <code>datetime</code>, <code>day_month_year</code>,
<code>domain</code>, <code>email</code>, <code>integer</code>,
<code>month_day_year</code>, <code>number</code>, <code>time</code>,
<code>url</code></p>

<p>Apart from these standard patterns, we have a <code>website</code> pattern
too which is basically a combo of both <code>domain</code> and
<code>url</code> pattern and we recommend you to use this
<code>website</code> pattern for validating websites.</p>

<p>They are defined by regular expressions as you can see below. Note, that
the patterns that relate to text such as <code>alpha</code> and
<code>alpha_numeric</code> do not consider special characters from other
languages. You need to add these special characters yourself to the regular
expressions. For instance, for the German language you need to add:</p>

<pre>alpha : /^[a-zäöüßA-ZÄÖÜ]+$/,
alpha_numeric : /^[a-zäöüßA-ZÄÖÜ0-9]+$/,</pre>

<p>Then you need to customize the builtin patterns as explained in the next
section. Otherwise Abide will produce an error if a special character is
input in your text field which is validated with
<code>pattern=&quot;alpha&quot;</code> or
<code>pattern=&quot;alpha_numeric&quot;</code>.</p>

<p>Here are the definitions of the builtin patterns:</p>
...
<h2 id="label-Adding+Custom+Pattern+and+Validator">Adding Custom Pattern and Validator<span><a href="#label-Adding+Custom+Pattern+and+Validator">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Override builtin patterns and validators before foundation is initialized 
Add new patterns and validators before or after foundation is initialized</p>

<pre>function myCustomValidator(
...
$(document).foundation();</pre>

<pre>&lt;input id=&quot;phone&quot; type=&quot;text&quot; pattern=&quot;dashes_only&quot; required &gt;
&lt;input id=&quot;min&quot; type=&quot;number&quot; required &gt;
&lt;input id=&quot;max&quot; type=&quot;number&quot; data-validator=&quot;greater_than&quot; data-greater-than=&quot;min&quot; required&gt;</pre>

<h2 id="label-Accessibility">Accessibility<span><a href="#label-Accessibility">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>By default, Abide will add some accessibility attributes to your form
elements. It is highly recommended to keep this option active as it improve
the usability of your forms for disabled people. <a
href="accessibility.html">Lean more about Accessibility in Foundation</a>.</p>

<p>However, if you think the attributes added by Abide are not correct, you
can disable it by setting <code>a11yAttributes</code> (or
<code>[data-a11y-attributes]</code>) to <code>false</code>.</p>
</main>
