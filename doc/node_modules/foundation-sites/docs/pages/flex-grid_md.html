...
<title>flex-grid - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+tpmQcZSPw4Q">video: tpmQcZSPw4Q</a>
    <li><a href="#label-Browser+support">Browser support</a>
    <li><a href="#label-Importing">Importing</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Advanced+Sizing">Advanced Sizing</a>
    <li><a href="#label-Responsive+Adjustments">Responsive Adjustments</a>
    <li><a href="#label-Automatic+Stacking">Automatic Stacking</a>
    <li><a href="#label-Column+Alignment">Column Alignment</a>
    <li><a href="#label-Horizontal+Alignment">Horizontal Alignment</a>
    <li><a href="#label-Vertical+Alignment">Vertical Alignment</a>
    <li><a href="#label-Vertical+Alignment+of+child+columns+-28individually-29">Vertical Alignment of child columns (individually)</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/flex-grid.md">

<p>— title: Flex Grid description: New in Foundation 6 is a Flexbox-powered
grid, which you can use instead of the traditional float grid. sass:
scss/grid/_flex-grid.scss</p>

<h2 id="label-video-3A+tpmQcZSPw4Q">video: tpmQcZSPw4Q<span><a href="#label-video-3A+tpmQcZSPw4Q">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>The flex grid works very similarly to the standard float grid, but includes
a number of useful features only possible with flexbox, like horizontal and
vertical alignment, automatic sizing, and easier source ordering.</p>
<hr>

<h2 id="label-Browser+support">Browser support<span><a href="#label-Browser+support">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The flex grid is only supported in Chrome, Firefox, Safari 6+, IE10+, iOS
7+, and Android 4.4+. Flexbox is supported in Android 2, but not reliably
enough for use with this grid. (<a
href="http://caniuse.com/#feat=flexbox">View flexbox browser support.</a>)
We recommend only using the flex grid on projects that can live with purely
cutting-edge browser support.</p>
...
<p>To use the Flex Grid in Foundation v6.4+, you need to: * In CDN link or
package managers: import <code>foundation-flex.css</code> in place of
<code>foundation.css</code>. * In Sass: set <code>$xy-grid</code> to
<code>false</code>.</p>

<p>If you&#39;re using the Sass version of Foundation, you can enable a
framework-wide flexbox mode, and add exports for the flex grid and flexbox
helper classes. <a href="flexbox.html#enabling-flexbox-mode">Learn more
about enabling flexbox mode.</a></p>

<p>You can manually generate the Flex Grid with: “`scss @import
&#39;foundation&#39;;</p>

<p>// @include foundation-grid; @include foundation-flex-classes; @include
foundation-flex-grid; “`</p>
...
<p>The structure of the flex grid is identical to that of the float grid. Rows
use the class <code>.row</code>, and columns use the class
<code>.column</code> (or <code>.columns</code>). Basic percentage-based
sizing can also be done using the same grid classes you&#39;re used to:
<code>.small-6</code>, <code>.medium-12</code>, and so on.</p>
<p>
...
<h2 id="label-Advanced+Sizing">Advanced Sizing<span><a href="#label-Advanced+Sizing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If no sizing class is added to the column, it will simply expand to fill
the leftover space. We call this an <em>expand behavior</em>.</p>
<p>
...
<p>A column can also be made to <em>shrink</em>, by adding the
<code>.shrink</code> class. This means it will only take up the horizontal
space its contents need.</p>
<p>
...
<p>Columns in a flex grid will not wrap if not given an explicit size—this is
what allows the magical auto-sizing to work. To make columns stack on
smaller screens, add the class <code>.small-12</code> manually.</p>

<p>To switch back to the expand behavior from a percentage or shrink behavior,
use the classes <code>.medium-expand</code> or <code>.large-expand</code>.
In the below example, the columns stack on small screens, and become
...
<h3 id="label-Automatic+Stacking">Automatic Stacking<span><a href="#label-Automatic+Stacking">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>We have a few shorthand classes for the above behavior. Use the
<code>.[size]-unstack</code> classes to stack all columns in the row by
default, and then unstack them on a larger screen size, making each one
equal-width.</p>
<div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;row medium-unstack&quot;&gt;
...
<h2 id="label-Column+Alignment">Column Alignment<span><a href="#label-Column+Alignment">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Columns in a flex grid can be aligned across the horizontal or vertical
axis of their parent row.</p>

<h3 id="label-Horizontal+Alignment">Horizontal Alignment<span><a href="#label-Horizontal+Alignment">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Columns can be aligned the same way you would align text in a paragraph. By
default, all columns align to the left (or the right in RTL), but this can
be overridden with by adding the <code>.align-[dir]</code> class to the
flex row.</p>
<p>
...
<p>You might be wondering what the difference between
<code>.align-justify</code> and <code>.align-spaced</code> is. A justified
grid (<code>justify-content: space-between</code>) evenly distributes the
space <em>between</em> each column. The first and last columns pin to the
edge of the grid.</p>

<p>A spaced grid (<code>justify-content: space-around</code>) evenly
distributes the space <em>around</em> each column. This means there will
always be space to the left of the first column, and to the right of the
last column.</p>

<p>The horizontal alignment classes are shorthands for the
<code>justify-content</code> CSS property. <a
href="https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content">Learn
more about justify-content</a>.</p>
<hr>

<h3 id="label-Vertical+Alignment">Vertical Alignment<span><a href="#label-Vertical+Alignment">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>By default, all columns in a flex grid stretch to be equal height. This
behavior can be changed with another set of alignment classes. That&#39;s
right, <em>middle alignment in CSS</em>!</p>

<p>Your options for vertical alignment are <code>top</code>,
<code>middle</code>, <code>bottom</code>, and <code>stretch</code>. Note
that we use the word <em>middle</em> for vertical alignment, and
<em>center</em> for horizontal alignment.</p>

<p>Applying a vertical alignment class to the flex row will affect every
column directly inside it.</p>
<p>
  <a class="" data-open-video="13:32"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p><div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;row align-middle&quot;&gt;
...
<h3 id="label-Vertical+Alignment+of+child+columns+-28individually-29">Vertical Alignment of child columns (individually)<span><a href="#label-Vertical+Alignment+of+child+columns+-28individually-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Similar alignment classes can also be applied to individual columns, which
use the format <code>.align-self-*</code> instead of <code>.align-*</code>.</p>
<a class="" data-open-video="13:32"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="callout warning">
...
<h2 id="label-Collapse-2FUncollapse+Rows">Collapse/Uncollapse Rows<span><a href="#label-Collapse-2FUncollapse+Rows">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>The <code>.is-collapse-child</code> class removes negative margins from
nested row under collapsed parent.</p>
<div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;row small-collapse medium-uncollapse&quot;&gt;
...
<h2 id="label-Offsets">Offsets<span><a href="#label-Offsets">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Offsets work identically to the float grid, by applying
<code>margin-left</code> to a column.</p>
<div class="docs-codepen-container">
...
<h2 id="label-Block+Grids">Block Grids<span><a href="#label-Block+Grids">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To define column widths at the row-level, instead of the individual column
level, add the class <code>.[size]-up-[n]</code> to a row, where
<code>[n]</code> is the number of columns to display per row, and
<code>[size]</code> is the breakpoint at which to apply the effect.</p>
<a class="" data-open-video="27:19"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="callout primary">
...
<pre>&lt;div class=&quot;row small-up-1 medium-up-2 large-up-3&quot;&gt;
