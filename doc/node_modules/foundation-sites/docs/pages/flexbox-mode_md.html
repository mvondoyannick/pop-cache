...
<title>flexbox-mode - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Flexbox+Mode">Flexbox Mode</a>
    <li><a href="#label-Enabling+Flexbox+Mode">Enabling Flexbox Mode</a>
    <li><a href="#label-Supported+Components">Supported Components</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/flexbox-mode.md">

<p>— title: Flexbox Mode description: For browsers with cutting-edge support,
some of Foundation&#39;s key components can be converted to flexbox. video:
&#39;KxafSdyTCIg&#39; sass:  - scss/components/_flex.scss</p>
...
<h2 id="label-Flexbox+Mode">Flexbox Mode<span><a href="#label-Flexbox+Mode">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation components use a combination of floats, vertical alignment,
table cells, and various other CSS hacks to get layouts looking right.
These days though, there&#39;s a better way… if you are happy with the
below browser support!</p>

<p>Enabling <strong>flexbox mode</strong> replaces those hacks with flexbox
properties, streamlining how layouts are made, and making sizing and
alignment of elements much easier.</p>

<p>Flexbox mode is only supported in these browsers:</p>
<ul><li>
<p>The latest Chrome and Firefox</p>
</li><li>
<p>Safari 6+</p>
</li><li>
<p>IE/Edge 10+</p>
...
<h2 id="label-Enabling+Flexbox+Mode">Enabling Flexbox Mode<span><a href="#label-Enabling+Flexbox+Mode">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
download of Foundation&lt;/a&gt; with flexbox mode enabled. If you&#39;re
using the Sass version of Foundation, you can enable flexbox mode two ways:</p>

<p>If you use the <code>foundation-everything()</code> mixin in your main Sass
file, pass in the parameter <code>true</code> to enable flexbox mode.</p>

<pre>@include foundation-everything(true);</pre>

<p>If you included each component manually (like our starter projects do),
open your settings file (basic template: scss/_settings.scss, ZURB
template: src/assets/scss/_settings.scss) and set
<code>$global-flexbox</code> to <code>true</code>, and remove the
<code>@include</code> for the float grid and replace it with the one for
the flex grid, along with the helper classes (basic template:
scss/app.scss, ZURB template: src/assets/scss/app.scss):</p>

<pre>$global-flexbox: true;

// @include foundation-grid;
@include foundation-flex-grid;
@include foundation-flex-classes;</pre>
<hr>

<h2 id="label-Supported+Components">Supported Components<span><a href="#label-Supported+Components">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Besides the flex grid, these components have flexbox modes:</p>
<ul><li>
<p><a href="button-group.html">Button group</a></p>
</li><li>
<p><a href="forms.html#inline-labels-and-buttons">Input group - (Forms)</a></p>
</li><li>
<p><a href="menu.html">Menu</a></p>
</li><li>
<p><a href="top-bar.html">Top bar</a></p>
</li><li>
<p><a href="media-object.html">Media object</a></p>
</li><li>
<p><a href="off-canvas.html#title-bar">Title bar</a></p>
</li><li>
<p><a href="card.html">Card</a></p>
</li></ul>

<p>In general, all of the components work exactly the same. However, a few of
them require slight changes to CSS classes used to work properly. Refer to
the documentation for each to find out what&#39;s different.</p>
</main>
