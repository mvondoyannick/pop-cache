...
<title>float-classes - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-27VEzXdMmqhAY-27">video: &#39;VEzXdMmqhAY&#39;</a>
    <li><a href="#label-Float+Left-2FRight">Float Left/Right</a>
    <li><a href="#label-Float+Center">Float Center</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/float-classes.md">

<p>— title: Float Classes description: Foundation includes a handful of
helpful float classes to add common positioning behaviors to elements.</p>

<h2 id="label-video-3A+-27VEzXdMmqhAY-27">video: &#39;VEzXdMmqhAY&#39;<span><a href="#label-video-3A+-27VEzXdMmqhAY-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Float+Left-2FRight">Float Left/Right<span><a href="#label-Float+Left-2FRight">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can change the float behavior of an element by adding the
<code>.float-left</code> or <code>.float-right</code> classes to an
element. To clear floats, add the class <code>.clearfix</code> to the
parent element.</p>
...
<h2 id="label-Float+Center">Float Center<span><a href="#label-Float+Center">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Okay, it&#39;s not <em>really</em> a float, but you can add the
<code>.float-center</code> class to an element to engage the automatic
margin centering trick. Note that this will only work on elements with an
absolute width, which means not a percentage or <code>auto</code> width.</p>

<pre>&lt;img src=&quot;assets/img/generic/voyager.jpg&quot; class=&quot;float-center&quot;&gt;</pre>
</main>
