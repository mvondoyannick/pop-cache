...
<title>javascript-utilities - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-27h83jR82cjWM-27">video: &#39;h83jR82cjWM&#39;</a>
    <li><a href="#label-Installing">Installing</a>
    <li><a href="#label-Box">Box</a>
    <li><a href="#label-Keyboard">Keyboard</a>
    <li><a href="#label-MediaQuery">MediaQuery</a>
    <li><a href="#label-Motion+-26+Move">Motion &amp; Move</a>
    <li><a href="#label-Timer">Timer</a>
    <li><a href="#label-ImageLoader">ImageLoader</a>
    <li><a href="#label-Touch">Touch</a>
    <li><a href="#label-Triggers">Triggers</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/javascript-utilities.md">

<p>— title: JavaScript Utilities description: Our JavaScript Utility Libraries
are easy to use and super helpful.</p>

<h2 id="label-video-3A+-27h83jR82cjWM-27">video: &#39;h83jR82cjWM&#39;<span><a href="#label-video-3A+-27h83jR82cjWM-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Installing">Installing<span><a href="#label-Installing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>See our <a href="javascript.html">JavaScript</a> and <a
href="installation.html">Installation</a> pages on how to install our files
in your project.</p>

<h2 id="label-Box">Box<span><a href="#label-Box">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.box.js</code></p>

<p>One of the useful libraries is <code>Foundation.Box</code>, and it has a
couple methods designed to make your life easier. You can pass either
jQuery objects or plain JavaScript elements to both.</p>

<pre class="ruby">
<span class="ruby-identifier">var</span> <span class="ruby-identifier">dims</span> = <span class="ruby-constant">Foundation</span>.<span class="ruby-constant">Box</span>.<span class="ruby-constant">GetDimensions</span>(<span class="ruby-identifier">element</span>);
</pre>

<p>Will return an object that contains the dimensions of <code>element</code>.
The object return looks like:</p>
...
<p>Also included is the <code>ImNotTouchingYou</code> function. It returns a
boolean based on whether the passed <code>element</code> is colliding with
the edge of the window (default), or a parent element. The remaining two
options are booleans for limiting collision detection to only one axis.
“`js</p>

<p>var clear = Foundation.Box.ImNotTouchingYou(element [, parent,
leftAndRightOnly, topAndBottomOnly]); “`</p>

<h2 id="label-Keyboard">Keyboard<span><a href="#label-Keyboard">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.keyboard.js</code></p>

<p>Another quite useful library, <code>Foundation.Keyboard</code> has several
methods to make keyboard event interaction easier for all. Shout out to <a
href="http://www.mariusolbertz.de">Marius Olbertz</a> of Germany who
conceived and coded this library.</p>

<p>Ever wanted a handy list of common keycodes and the keys they represent?
Use <code>Foundation.Keyboard.keys</code>. This is an object containing
key/value pairs of the most frequently used keys in our framework.</p>

<p>Want to manage your own keyboard inputs? No problem! Within your
<code>.on(&#39;key**&#39;)</code> callback, call
<code>Foundation.Keyboard.parseKey(event)</code> to get a string of what
key was pressed, e.g. <code>&#39;TAB&#39;</code> or
<code>&#39;ALT_X&#39;</code>. (You can also use this function outside of
the Foundation components, in your own JavaScript code!)</p>

<p>What if you want to know if there&#39;s focusable elements somewhere on a
page? Instead of writing your own function and selector from scratch, just
use: <code>js var focusable =
Foundation.Keyboard.findFocusable($(&#39;#content&#39;)); </code></p>

<p>The Keyboard utility also provides functions to trap the keyboard focus
inside a given element. This is quite useful for modals in terms of
accessibility. When the focus is trapped, pressing tab while the last
focusable element inside the given container is selected will focus the
first element and vice versa. “`js // Trap focus to given element
Foundation.Keyboard.trapFocus($(&#39;#content&#39;));</p>

<p>// Release focus from given element
Foundation.Keyboard.releaseFocus($(&#39;#content&#39;)); “`</p>

<p>The real gem of this library, however, is the <code>handleKey</code>
function. Any plugin that is registered with the utility can call on this
method to manage keyboard inputs. <code>js
Foundation.Keyboard.register(&#39;pluginName&#39;, {   &#39;TAB&#39;:
&#39;next&#39; }); ...//in event callback
Foundation.Keyboard.handleKey(event, &#39;pluginName&#39;, {   next:
function(){     //do stuff   } }); </code> There are also the functions
<code>handled</code> and <code>unhandled</code>, where you can place any
code that shall always be executed after the key event has been handled (or
not).</p>

<p>If you want to use your own key bindings, simply call the
<code>Foundation.Keyboard.register</code> function. It even works after
Foundation has already initialized.</p>

<h2 id="label-MediaQuery">MediaQuery<span><a href="#label-MediaQuery">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.mediaQuery.js</code></p>

<p>The media query library used by Foundation has two publicly accessible
functions and two properties: “`js</p>

<p>Foundation.MediaQuery.get(&#39;medium&#39;); // returns the minimum pixel
value for the <code>medium</code> breakpoint.
Foundation.MediaQuery.atLeast(&#39;large&#39;); // returns a boolean if the
current screen size is, you guessed it, at least <code>large</code>.
Foundation.MediaQuery.queries; // an array of media queries Foundation uses
for breakpoints. Foundation.MediaQuery.current; // a string of the current
breakpoint size. “`</p>

<p>Also included is an event emitter for breakpoint changes. You can hook into
this event with: “`js</p>

<p>$(window).on(&#39;changed.zf.mediaquery&#39;, function(event, newSize,
oldSize){}); “`</p>

<h2 id="label-Motion+-26+Move">Motion &amp; Move<span><a href="#label-Motion+-26+Move">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.motion.js</code></p>

<p>Two handy utilities, one little file.</p>

<p><code>Foundation.Motion</code> is the same JavaScript used by the <a
href="https://github.com/zurb/motion-ui/">Motion-UI</a> library, and is
included in Foundation 6. See the GitHub page for more details.</p>

<p><code>Foundation.Move</code> is a simple helper function for utilizing
browsers&#39; <code>requestAnimationFrame</code> method for hardware
acceleration. Invoke like so: <code>js Foundation.Move(durationInMS,
$element, function(){   //animation logic }); </code> When the animation is
complete, your jQuery element will fire <code>finished.zf.animate</code>.</p>

<h2 id="label-Timer">Timer<span><a href="#label-Timer">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.timer.js</code></p>

<pre>
var timer = new Foundation.Timer($element, {duration: ms, infinite: bool}, callback);
// includes: timer.start(), timer.pause(), timer.restart()</pre>

<p>Similar to <code>setInterval</code>, except you can pause and resume where
you left off.</p>

<h2 id="label-ImageLoader">ImageLoader<span><a href="#label-ImageLoader">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.imageLoader.js</code></p>

<pre class="ruby"><span class="ruby-constant">Foundation</span>.<span class="ruby-identifier">onImagesLoaded</span>(<span class="ruby-identifier">$images</span>, <span class="ruby-identifier">callback</span>);
</pre>

<p>This will execute your callback function after all the images in your
jQuery collection have loaded.</p>

<h2 id="label-Touch">Touch<span><a href="#label-Touch">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.touch.js</code></p>

<p>Allows you to add <code>swipe*</code> and pseudo-drag events to elements.</p>

<pre>$(&#39;selector&#39;).addTouch().on(&#39;mousemove&#39;, handleDrag);
// Binds elements to touch events. Used in the Slider plugin for mobile devices.
$(&#39;selector&#39;).on(&#39;swipeleft&#39;, handleLeftSwipe);
// Binds elements to swipe events. Used in the Orbit plugin for mobile devices.</pre>

<h2 id="label-Triggers">Triggers<span><a href="#label-Triggers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>js/foundation.util.triggers.js</code></p>

<p>Provides a number of event listeners and triggers your script can hook
into. Most are self-explanatory, and used in many Foundation plugins.
<code>html &lt;button data-open=&quot;someId&quot;&gt;I open
something!&lt;/button&gt; &lt;button data-close=&quot;someId&quot;&gt;I
close something!&lt;/button&gt; &lt;button
data-toggle=&quot;someId&quot;&gt;I toggle something!&lt;/button&gt;
</code> <code>js // Add the data-open/close/toggle=&quot;idOfElement&quot;
tag to your markup. // When a click event is triggered on that element,
these are the non-bubbling events directed at your element. // If you
don&#39;t use an `id` selector, an event will be triggered that bubbles up
to window. $(&#39;selector&#39;).on(&#39;open.zf.trigger&#39;, handleOpen);
$(&#39;selector&#39;).on(&#39;close.zf.trigger&#39;, handleClose);
$(&#39;selector&#39;).on(&#39;toggle.zf.trigger&#39;, handleToggle);
</code> Besides these useful click triggers, there are also other listeners
for you to tap into. Need to know when the window has been resized, but
only when it&#39;s done resizing? How about a debounced scroll event? Add
this markup and JavaScript and you&#39;re good to go!</p>

<pre>&lt;div data-scroll=&quot;someId&quot;&gt;...&lt;/div&gt;
&lt;div data-resize=&quot;someId&quot;&gt;...&lt;/div&gt;</pre>

<pre>$(&#39;#someId&#39;).on(&#39;scrollme.zf.trigger&#39;, handleScroll);
$(&#39;#someId&#39;).on(&#39;resizeme.zf.trigger&#39;, handleResize);</pre>

<h2 id="label-Miscellaneous">Miscellaneous<span><a href="#label-Miscellaneous">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation includes a couple useful features in the core library that are
used in many places, that you can tap into.</p>

<p><code>Foundation.GetYoDigits([number, namespace])</code> returns a base-36,
pseudo-random string with a hyphenated namespace (if you include one). Both
arguments are optional; by default, it will return a string six characters
long.</p>

<p><code>Foundation.getFnName(fn)</code> returns a string representation of a
named function. Seems small, but believe us—it&#39;s useful.</p>

<p><code>Foundation.transitionend()</code> is a function&lt;span data-tooltip
title=“Goodbye ZURB, I&#39;ll miss you”&gt; &lt;/span&gt; that returns the
string of the properly vendor-prefixed version of
<code>transitionend</code> events. Most browsers don&#39;t require a prefix
these days, but for those that do, we&#39;ve got you covered. But IE 9
doesn&#39;t support transitions?? Quite right you are! In that case, our
plugins that use transitions will simply snap to whatever location or
visibility state they were headed to, and this function will fire a
<code>transitionend</code> event manually on the element you passed. It
still gives the desired results, and allows Motion-UI to work in IE 9.</p>
</main>
