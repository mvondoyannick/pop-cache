...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-sass-3A+scss-2Fcomponents-2F_table.scss">sass: scss/components/_table.scss</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Hover+State">Hover State</a>
    <li><a href="#label-Stripes">Stripes</a>
    <li><a href="#label-Stacked+Table">Stacked Table</a>
    <li><a href="#label-Scrolling+Table">Scrolling Table</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/table.md">

<p>— title: Tables description: Okay, they&#39;re not the sexiest things ever,
but tables get the job done (for tabular data, of course). They have
responsive modifiers to help solve some of your layout issues based on your
tables needs. video: &#39;-Omv7c3Qg4s&#39;</p>

<h2 id="label-sass-3A+scss-2Fcomponents-2F_table.scss">sass: scss/components/_table.scss<span><a href="#label-sass-3A+scss-2Fcomponents-2F_table.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>No bells or whistles here, just a straight up table for all of your basic
table needs.</p>
<p>
...
<h2 id="label-Hover+State">Hover State<span><a href="#label-Hover+State">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Need to spiff up the table just a tad? Just add the class
<code>.hover</code> to lightly darken the table rows on hover.</p>
<p>
...
<h2 id="label-Stripes">Stripes<span><a href="#label-Stripes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>By default, table rows are striped. There&#39;s an <code>.unstriped</code>
class to remove the stripes. If you change <code>$table-is-striped</code>
to <code>false</code> to remove stripes from all tables, use the
<code>.striped</code> class to add stripes.</p>
<p>
...
<h2 id="label-Stacked+Table">Stacked Table<span><a href="#label-Stacked+Table">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-Scrolling+Table">Scrolling Table<span><a href="#label-Scrolling+Table">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Got a lot of tubular tabular data? Add a wrapper element with the class
<code>.table-scroll</code> around your table to enable horizontal
scrolling.</p>
<p>
