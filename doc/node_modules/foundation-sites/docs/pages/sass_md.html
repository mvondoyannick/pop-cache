...
<title>sass - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+mYiyunVQdMY">video: mYiyunVQdMY</a>
    <li><a href="#label-Compatibility">Compatibility</a>
    <li><a href="#label-Autoprefixer+Required">Autoprefixer Required</a>
    <li><a href="#label-Loading+the+Framework">Loading the Framework</a>
    <li><a href="#label-Compiling+Manually">Compiling Manually</a>
    <li><a href="#label-Using+Compiled+CSS">Using Compiled CSS</a>
    <li><a href="#label-Adjusting+CSS+Output">Adjusting CSS Output</a>
    <li><a href="#label-The+Settings+File">The Settings File</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/sass.md">

<p>— title: Sass description: Foundation is written in Sass, which allows us
to make the codebase customizable and flexible.</p>

<h2 id="label-video-3A+mYiyunVQdMY">video: mYiyunVQdMY<span><a href="#label-video-3A+mYiyunVQdMY">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>&lt;img src=“assets/img/logos/sass-logo.svg” alt=“Sass logo”
class=“float-right” style=“width: 150px; height: 150px; margin-left:
1rem;”&gt;</p>

<p><strong>Foundation for Sites can be compiled with Ruby Sass and
libsass.</strong> We tend to stick to the latest versions of both compilers
when possible. Our documentation and starter project are compiled with <a
href="https://github.com/sass/node-sass">node-sass</a>, a Node port of
libsass. We recommend these versions of either compiler:</p>
<ul><li>
<p>Ruby Sass <strong>3.4+</strong></p>
</li><li>
<p>node-sass <strong>3.4.2+</strong> (libsass <strong>3.3.2</strong>)</p>
</li></ul>

<h3 id="label-Autoprefixer+Required">Autoprefixer Required<span><a href="#label-Autoprefixer+Required">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>We don&#39;t include vendor prefixes in our Sass files—instead, we let <a
href="https://github.com/postcss/autoprefixer">Autoprefixer</a> handle it
for us. Our build process uses <a
href="https://github.com/sindresorhus/gulp-autoprefixer">gulp-autoprefixer</a>,
but there are <a href="https://github.com/postcss/autoprefixer#usage">other
versions</a> that work with Grunt, Rails, Brunch, and more.</p>

<p>To get the proper browser support, use these Autoprefixer settings:</p>

<pre class="ruby"><span class="ruby-identifier">autoprefixer</span>({
  <span class="ruby-value">browsers:</span> [<span class="ruby-string">&#39;last 2 versions&#39;</span>, <span class="ruby-string">&#39;ie &gt;= 9&#39;</span>, <span class="ruby-string">&#39;android &gt;= 4.4&#39;</span>, <span class="ruby-string">&#39;ios &gt;= 7&#39;</span>]
});
</pre>
<hr>

<h2 id="label-Loading+the+Framework">Loading the Framework<span><a href="#label-Loading+the+Framework">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you&#39;re using the CLI to create a project, the Sass compilation
process is already set up for you. If not, you can compile our Sass files
yourself, or drop in a pre-built CSS file.</p>

<p>To get started, first install the framework files using Bower or npm.</p>

<pre>npm install foundation-sites --save
bower install foundation-sites --save</pre>

<h3 id="label-Compiling+Manually">Compiling Manually<span><a href="#label-Compiling+Manually">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Next, add the framework files as an import path. How you do this depends on
your build process, but the path is the same regardless:
<code>packages_folder/foundation-sites/scss</code></p>

<p>Here&#39;s an example using grunt-contrib-sass:</p>

<pre class="ruby"><span class="ruby-identifier">grunt</span>.<span class="ruby-identifier">initConfig</span>({
  <span class="ruby-value">sass:</span> {
    <span class="ruby-value">dist:</span> {
      <span class="ruby-value">options:</span> {
        <span class="ruby-value">loadPath:</span> [<span class="ruby-string">&#39;node_modules/foundation-sites/scss&#39;</span>]
      }
    }
  }
});
...
<p>If you&#39;re using Compass, open your project&#39;s <code>config.rb</code>
and add the import path there:</p>

<pre class="ruby"><span class="ruby-identifier">add_import_path</span> <span class="ruby-string">&quot;node_modules/foundation-sites/scss&quot;</span>
</pre>

<p>Finally, add an <code>@import</code> statement to the top of your primary
Sass file. Refer to <a href="#adjusting-css-output">Adjusting CSS
Output</a> below to learn how to control the CSS output of the framework.</p>

<pre>@import &#39;foundation&#39;;</pre>

<p>You&#39;re also going to want a settings file for your project, which will
allow you to modify the default styles of Foundation. <strong><a
href="https://raw.githubusercontent.com/zurb/foundation-sites/master/scss/settings/_settings.scss">Download
the latest settings file here</a></strong>, add it to your project as
<code>_settings.scss</code>, then import it <em>before</em> Foundation
itself.</p>
<div class="callout">
...
<h3 id="label-Using+Compiled+CSS">Using Compiled CSS<span><a href="#label-Using+Compiled+CSS">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The Foundation for Sites npm and Bower packages include pre-compiled CSS
files, in minified (compressed) and unminified flavors. If you&#39;re
interested in editing the framework CSS directly, use the unminified file.
For production, use the minified version.</p>

<pre>&lt;link rel=&quot;stylesheet&quot; href=&quot;node_modules/foundation-sites/dist/css/foundation-sites.css&quot;&gt;

&lt;link rel=&quot;stylesheet&quot; href=&quot;node_modules/foundation-sites/dist/css/foundation-sites.min.css&quot;&gt;</pre>
<hr>

<h2 id="label-Adjusting+CSS+Output">Adjusting CSS Output<span><a href="#label-Adjusting+CSS+Output">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation outputs many classes for its various components. These help
developers get up and running quickly. However, when you move to
production, you may wish to build your grid semantically, replace our
pre-built classes with your own, or remove components entirely.</p>

<p>Each component has an <strong>export mixin</strong> which prints out the
CSS for that component. If you&#39;re cool with having everything, you just
need one line of code:</p>

<pre>@include foundation-everything;</pre>

<p>Our <a href="starter-projects.html">starter projects</a> include the full
list of imports, making it easy to comment out the components you don&#39;t
need. A full list is also included below.</p>
...
// @include foundation-prototype-classes;</pre>
<hr>

<h2 id="label-The+Settings+File">The Settings File<span><a href="#label-The+Settings+File">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>All Foundation projects include a settings file, named
<code>_settings.scss</code>. If you&#39;re using the CLI to create a
Foundation for Sites project, you can find the settings file under scss/
(basic template) or src/assets/scss/ (ZURB template). If you&#39;re
installing the framework standalone using Bower or npm, there&#39;s a
settings file included in those packages, which you can move into your own
Sass files to work with.</p>

<p>Every component includes a set of variables that modify core structural or
visual styles. If there&#39;s something you can&#39;t customize with a
variable, you can just write your own CSS to add it.</p>
...
<p>Here&#39;s an example set of settings variables. These change the default
styling of <a href="button.html">buttons</a>:</p>

<pre>// Default padding for button.
...
$button-opacity-disabled: 0.25 !default;</pre>
</main>
