...
<title>motion-ui - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+docs-3A+https-3A-2F-2Fgithub.com-2Fzurb-2Fmotion-ui-2Ftree-2Fmaster-2Fdocs"> docs: <a href="https://github.com/zurb/motion-ui/tree/master/docs">github.com/zurb/motion-ui/tree/master/docs</a></a>
    <li><a href="#label-Installing">Installing</a>
    <li><a href="#label-Usage+in+Components">Usage in Components</a>
    <li><a href="#label-Built-in+Transitions">Built-in Transitions</a>
    <li><a href="#label-Custom+Transitions">Custom Transitions</a>
    <li><a href="#label-Animation">Animation</a>
    <li><a href="#label-JavaScript+Reference">JavaScript Reference</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/motion-ui.md">

<p>— title: Motion UI description: A Sass library for creating flexible UI
transitions and animations. library:  github: <a
href="https://github.com/zurb/motion-ui">github.com/zurb/motion-ui</a></p>

<h2 id="label-+docs-3A+https-3A-2F-2Fgithub.com-2Fzurb-2Fmotion-ui-2Ftree-2Fmaster-2Fdocs"> docs: <a href="https://github.com/zurb/motion-ui/tree/master/docs">github.com/zurb/motion-ui/tree/master/docs</a><span><a href="#label-+docs-3A+https-3A-2F-2Fgithub.com-2Fzurb-2Fmotion-ui-2Ftree-2Fmaster-2Fdocs">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Motion UI is a standalone library that powers the transition effects used
in a number of Foundation components, including <a
href="toggler.html">Toggler</a>, <a href="reveal.html">Reveal</a>, and <a
href="orbit.html">Orbit</a>.</p>
...
<p><strong>Motion UI is already included in both <a
href="starter-projects.html">starter projects</a>.</strong> If you want to
add it to an existing project, follow these steps.</p>

<p>First, install the library with npm or Bower.</p>

<pre>npm install motion-ui --save-dev
  bower install motion-ui --save-dev</pre>

<p>Next, add the path <code>[modules_folder]/motion-ui/src</code> to your Sass
compiler&#39;s import path list. Here&#39;s what you would add in Compass,
via <code>config.rb</code>:</p>

<pre class="ruby"><span class="ruby-identifier">add_import_path</span> <span class="ruby-string">&#39;node_modules/motion-ui/src&#39;</span>
</pre>

<p>Here&#39;s how it works using gulp-sass:</p>

<pre class="ruby"><span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;./src/scss/app.scss&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sass</span>({
    <span class="ruby-value">includePaths:</span> [<span class="ruby-string">&#39;node_modules/motion-ui/src&#39;</span>]
  }));
</pre>

<p>Finally, import the library into your Sass file and include the mixins.</p>

<pre>@import &#39;motion-ui&#39;
@include motion-ui-transitions;
@include motion-ui-animations;</pre>

<p>Or, another way to start using Motion UI is through a CDN.</p>

<pre>&lt;!-- Insert this within your head tag and after foundation.css --&gt;
&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdn.jsdelivr.net/npm/motion-ui@1.2.3/dist/motion-ui.min.css&quot; /&gt;</pre>
<hr>

<h2 id="label-Usage+in+Components">Usage in Components<span><a href="#label-Usage+in+Components">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Various Foundation components provide options for to use Motion UI
animations when changing state. Here are the options for each plugin that
support Motion UI: - <a href="orbit.html">Orbit</a>:
<code>data-animate</code> - <a href="reveal.html">Reveal</a>:
<code>data-animation-in</code>, <code>data-animation-out</code> - <a
href="toggler.html">Toggler</a>: <code>data-animate</code> - <a
href="responsive-navigation.html">Responsive Toggler</a>:
<code>data-animate</code></p>

<p>For example, here are two instances of Toggler—one using fade classes
(<code>.fade-in</code> and <code>.fade-out</code>), and one using slide
classes (<code>.slide-in-down</code> and <code>.slide-out-up</code>). See
all available classes in <a href="#built-in-transitions">build-in
transitions</a> below.</p>

<pre>&lt;div data-toggler data-animate=&quot;fade-in fade-out&quot; class=&quot;callout secondary&quot;&gt;
...
data-toggle=“motion-example-1”&gt;Fade&lt;/button&gt;&lt;button
type=“button” class=“button”
data-toggle=“motion-example-2”&gt;Slide&lt;/button&gt; &lt;div
class=“grid-x grid-margin-x”&gt;  &lt;div class=“cell small-6”&gt;  &lt;div
data-toggler data-animate=“fade-in fade-out” class=“callout secondary ease”
id=“motion-example-1”&gt;  &lt;p&gt;This panel
&lt;strong&gt;fades&lt;/strong&gt;.&lt;/p&gt;  &lt;/div&gt;  &lt;/div&gt; 
&lt;div class=“cell small-6”&gt;  &lt;div data-toggler
data-animate=“slide-in-down slide-out-up” class=“callout secondary ease”
id=“motion-example-2”&gt;  &lt;p&gt;This panel
&lt;strong&gt;slides&lt;/strong&gt;.&lt;/p&gt;  &lt;/div&gt;  &lt;/div&gt;
&lt;/div&gt;</p>
<hr>

<h2 id="label-Built-in+Transitions">Built-in Transitions<span><a href="#label-Built-in+Transitions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Motion UI includes more than two dozen built-in transition classes. They
can be enabled by adding this line to your Sass file, after you&#39;ve
imported the library:</p>

<pre>@include motion-ui-transitions;</pre>
<div>
...
<h2 id="label-Custom+Transitions">Custom Transitions<span><a href="#label-Custom+Transitions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Custom transition classes can be made using Motion UI&#39;s mixin library.
Here&#39;s an example of a custom hinge. <strong>Refer to <a
href="https://github.com/zurb/motion-ui/blob/master/docs/transitions.md">Motion
UI’s transition documentation</a> to learn more.</strong></p>

<pre>@include mui-hinge(
  $state: in,
  $from: top,
...
<h2 id="label-Animation">Animation<span><a href="#label-Animation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can use the same five transition effects to create CSS animations as
well. The library also allows you to create series effects, with animations
on multiple elements happening in a queue. <strong>Refer to <a
href="https://github.com/zurb/motion-ui/blob/master/docs/animations.md">Motion
UI’s animation documentation</a> to learn more.</strong></p>

<p>&lt;button type=“button” class=“button” data-docs-example-series&gt;Play
Animation&lt;/button&gt; &lt;div class=“grid-x grid-margin-x”
id=“series-example”&gt;  &lt;div class=“cell small-4”&gt;  &lt;img
class=“thumbnail” src= “assets/img/generic/square-1.jpg”
id=“series-example-1”&gt;  &lt;/div&gt;  &lt;div class=“cell small-4”&gt; 
&lt;img class=“thumbnail” src= “assets/img/generic/square-2.jpg”
id=“series-example-2”&gt;  &lt;/div&gt;  &lt;div class=“cell small-4”&gt; 
&lt;img class=“thumbnail” src= “assets/img/generic/square-3.jpg”
id=“series-example-3”&gt;  &lt;/div&gt; &lt;/div&gt;</p>
<hr>

<h2 id="label-JavaScript+Reference">JavaScript Reference<span><a href="#label-JavaScript+Reference">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Motion UI includes a tiny JavaScript utility that will work anywhere as
long as jQuery is loaded. However, Foundation 6 includes a customized
version of this code that is included in
<code>js/foundation.util.motion.js</code>. If you are using the Foundation
version of this utility, and you wish to animate your own elements, trigger
it this way:</p>

<pre>var elem = $(&#39;#elem-to-animate&#39;);

Foundation.Motion.animateIn(elem, animationClass [, callback]);
Foundation.Motion.animateOut(elem, animationClass [, callback]);</pre>

<p>The callback is optional in this case, and will fire when the animation is
complete. &lt;div class=“callout primary”&gt;  &lt;p&gt;Please note that
the duration/animation speed for Motion UI animations are controlled via
Sass mixin variables. The JavaScript handles the addition and removal of
classes and event listener/callback firing only.  <br>  If you are
individually including your <code>&lt;script&gt;</code> tags, make sure you
are including the <code>js/foundation.util.motion.js</code> path. 
&lt;/p&gt; &lt;/div&gt;</p>
</main>
