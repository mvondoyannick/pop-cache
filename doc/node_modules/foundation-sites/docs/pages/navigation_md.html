...
<title>navigation - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-description-3A+Foundation+is+bundled+with+many+simple+navigation+patterns-2C+which+can+be+combined+to+form+more+complex-2C+robust+responsive+navigation+solutions.">description: Foundation is bundled with many simple navigation patterns, which can be combined to form more complex, robust responsive navigation solutions.</a>
    <li><a href="#label-Basics-3A+Menu">Basics: Menu</a>
    <li><a href="#label-Top+Bar">Top Bar</a>
    <li><a href="#label-Menu+Plugins">Menu Plugins</a>
    ...
    <li><a href="#label-Responsive+Navigation">Responsive Navigation</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/navigation.md">

<p>— title: Navigation</p>

<h2 id="label-description-3A+Foundation+is+bundled+with+many+simple+navigation+patterns-2C+which+can+be+combined+to+form+more+complex-2C+robust+responsive+navigation+solutions.">description: Foundation is bundled with many simple navigation patterns, which can be combined to form more complex, robust responsive navigation solutions.<span><a href="#label-description-3A+Foundation+is+bundled+with+many+simple+navigation+patterns-2C+which+can+be+combined+to+form+more+complex-2C+robust+responsive+navigation+solutions.">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics-3A+Menu">Basics: Menu<span><a href="#label-Basics-3A+Menu">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The Menu is an all-purpose navigation component. It can be aligned
horizontally or vertically, can be nested, and supports icons. <a
href="menu.html">Learn more about the Menu.</a></p>

<p>All menus use the <code>ul &gt; li &gt; a</code> pattern. The markup is a
little strict, but this makes it easy to attach a navigation plugin to any
menu, as you&#39;ll see below.</p>
...
<p>To nest menus, add a new <code>&lt;ul&gt;</code> inside of an
<code>&lt;li&gt;</code>, <em>after</em> the <code>&lt;a&gt;</code> inside.</p>
...
<p>Top bar is a simple wrapper around these menu patterns. It supports a
left-hand and right-hand section, which collapse on top of each other on
small screens. <a href="top-bar.html">Learn more about the top bar.</a></p>
<div class="top-bar">
...
<h2 id="label-Menu+Plugins">Menu Plugins<span><a href="#label-Menu+Plugins">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The basic Menu can be enhanced with one of three <strong>Menu
plugins</strong>. All three use the exact same markup to create a different
style of multi-tier navigation.</p>

<h3 id="label-Dropdown+Menu">Dropdown Menu<span><a href="#label-Dropdown+Menu">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The dropdown menu plugin (<code>data-dropdown-menu</code>) converts a
nested menu into a series of dropdown menus. The nested menus can be opened
through hover, click, or keyboard. <a href="dropdown-menu.html">Learn more
about the dropdown menu.</a></p>
<ul class="dropdown menu" data-dropdown-menu>
...
<h3 id="label-Drilldown+Menu">Drilldown Menu<span><a href="#label-Drilldown+Menu">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The drilldown menu plugin (<code>data-drilldown</code>) converts a nested
menu into a series of sliding menus. Clicking an item slides the next level
menu into view. <a href="drilldown-menu.html">Learn more about the
drilldown menu.</a></p>
...
<h3 id="label-Accordion+Menu">Accordion Menu<span><a href="#label-Accordion+Menu">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The accordion menu plugin (<code>data-accordion-menu</code>) converts a
nested menu into a series of collapsed accordions. Clicking an item slides
down the nested menu. <a href="accordion-menu.html">Learn more about the
accordion menu.</a></p>
...
<h2 id="label-Responsive+Navigation">Responsive Navigation<span><a href="#label-Responsive+Navigation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Each of the above three patterns has a use in a specific context. But some
patterns only work at certain screen sizes. For example, dropdown menus
don&#39;t work as well on smaller screens, but the same navigation items
might work better as a drilldown or an accordion menu at that screen size.</p>

<p>Our responsive menu plugin (<code>data-responsive-menu</code>) allows you
to take a Menu, and assign different navigation patterns to it at different
screen sizes. In the below example, a drilldown menu changes to a dropdown
menu at larger screen sizes. <a
href="responsive-navigation.html#responsive-menu">Learn more about the
responsive Menu plugin.</a></p>
...
<p>In other situations, you may wish to always display a menu on a larger
screen, but hide that same menu behind a click toggle on smaller screens.
You can do this with the responsive toggle plugin
(<code>data-responsive-toggle</code>). This plugin works with any
container, not just a menu. <a
href="responsive-navigation.html#responsive-toggle">Learn more about the
responsive toggle plugin.</a></p>

<p>To see the below example in action, scale your browser down. The top bar
will be replaced by a smaller title bar. Clicking the icon inside the title
bar reveals the top bar.</p>
<div class="title-bar" data-responsive-toggle="example-menu" data-hide-for="medium">
  <button class="menu-icon" type="button" data-toggle></button>
  <div class="title-bar-title">Menu</div>
</div><div class="top-bar" id="example-menu">
  <div class="top-bar-left">
    <ul class="dropdown menu" data-dropdown-menu>
      <li class="menu-text">Site Title</li>
      <li class="has-submenu">
