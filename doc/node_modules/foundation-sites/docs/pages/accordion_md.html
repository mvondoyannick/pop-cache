...
<title>accordion - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-27y_BX7saf65Q-27">video: &#39;y_BX7saf65Q&#39;</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Advanced+Options">Advanced Options</a>
    <li><a href="#label-Multi-expand">Multi-expand</a>
    <li><a href="#label-All+Closed">All Closed</a>
    <li><a href="#label-Disabled">Disabled</a>
    <li><a href="#label-Accordion+and+URLs">Accordion and URLs</a>
    <li><a href="#label-Browser+history">Browser history</a>
    <li><a href="#label-Deep+linking">Deep linking</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/accordion.md">

<p>— title: Accordion description: Accordions are elements that help you
organize and navigate multiple documents in a single container. They can be
used for switching between items in the container. sass:
scss/components/_accordion.scss js: js/foundation.accordion.js</p>

<h2 id="label-video-3A+-27y_BX7saf65Q-27">video: &#39;y_BX7saf65Q&#39;<span><a href="#label-video-3A+-27y_BX7saf65Q-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The container for an accordion needs the class <code>.accordion</code>, and
the attribute <code>data-accordion</code>. Note that in these examples, we
use a <code>&lt;ul&gt;</code>, but you can use any element you want.</p>

<pre>&lt;ul class=&quot;accordion&quot; data-accordion&gt;&lt;/ul&gt;</pre>

<p>Inside the accordion, place a series of panes with the class
<code>.accordion-item</code> and the attribute
<code>data-accordion-item</code>. To mark which pane should be open by
default, add the class <code>.is-active</code> to that pane.</p>

<p>Each pane has a <strong>title</strong>, an <code>&lt;a&gt;</code> with the
class <code>.accordion-title</code>, and a <strong>content area</strong>,
an element with the class <code>.accordion-content</code> and the attribute
<code>data-tab-content</code>.</p>
<p>
...
<h3 id="label-Multi-expand">Multi-expand<span><a href="#label-Multi-expand">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>By default, only one pane of an accordion can be open at a time. This can
be changed by setting the <code>multiExpand</code> option to
<code>true</code>.</p>
<p>
...
<pre>&lt;ul class=&quot;accordion&quot; data-accordion data-multi-expand=&quot;true&quot;&gt;
  &lt;!-- ... --&gt;
&lt;/ul&gt;</pre>
...
<h3 id="label-All+Closed">All Closed<span><a href="#label-All+Closed">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>By default, at least one pane in an accordion must be open. This can be
changed by setting <code>allowAllClosed</code> option to <code>true</code>.</p>
<p>
...
<pre>&lt;ul class=&quot;accordion&quot; data-accordion data-allow-all-closed=&quot;true&quot;&gt;
  &lt;!-- ... --&gt;
&lt;/ul&gt;</pre>
...
<h3 id="label-Disabled">Disabled<span><a href="#label-Disabled">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>There may be times where you want to disable pane switching on an
accordion. This can be accomplished by setting the <code>disabled</code>
option.</p>
...
<pre>&lt;ul class=&quot;accordion&quot; data-accordion disabled&gt;
  &lt;li class=&quot;accordion-item is-active&quot; data-accordion-item&gt;
    &lt;a href=&quot;#&quot; class=&quot;accordion-title&quot;&gt;Accordion 1&lt;/a&gt;
    &lt;div class=&quot;accordion-content&quot; data-tab-content&gt;
...
<h2 id="label-Accordion+and+URLs">Accordion and URLs<span><a href="#label-Accordion+and+URLs">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Browser+history">Browser history<span><a href="#label-Browser+history">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>When the <code>data-deep-link</code> option is set to <code>true</code>,
the current state of the accordion is recorded by adding a hash with the
accordion panel ID to the browser URL when a accordion opens. By default,
accordion <em>replace</em> the browser history (using
<code>history.replaceState()</code>). Modify this behavior by using
attribute <code>data-update-history=&quot;true&quot;</code> to
<em>append</em> to the browser history (using
<code>history.pushState()</code>). In the latter case the browser back
button will track each click that opens a accordion panel.</p>

<p>By using deep linking (see below), the open state of a page&#39;s tabset
may be shared by copy-pasting the browser URL.</p>

<h3 id="label-Deep+linking">Deep linking<span><a href="#label-Deep+linking">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Add the attribute <code>data-deep-link=&quot;true&quot;</code> to a
accordion to: - modify the browser history when a accordion panel is
clicked - allow users to open a particular accordion panel at page load
with a hash-appended URL</p>

<pre>&lt;ul class=&quot;accordion&quot; data-accordion data-deep-link=&quot;true&quot; data-update-history=&quot;true&quot; data-deep-link-smudge=&quot;true&quot; data-deep-link-smudge-delay=&quot;500&quot; id=&quot;deeplinked-accordion&quot;&gt;
  &lt;li class=&quot;accordion-item is-active&quot; data-accordion-item&gt;
...
<p>For example, &lt;a target=“_blank” href=“#deeplink3”&gt;<a
href="http://example.com/#deeplink3</a">example.com/#deeplink3</a</a>&gt;
will open the third accordion panel at page load. This example will open a
new browser tab and scroll you to the open accordion panel.</p>

<p>When linking directly to a accordion panel, it might not be obvious that
the content appears within a accordion panel. An additional attribute
<code>data-deep-link-smudge</code> rolls the page up slightly after deep
linking (to a horizontal accordion) so that the accordion is at the top of
the viewport.</p>

<pre>&lt;ul class=&quot;accordion&quot; data-deep-link=&quot;true&quot; data-deep-link-smudge=&quot;true&quot; data-deep-link-smudge-delay=&quot;600&quot; data-accordion id=&quot;deeplinked-accordion-with-smudge&quot;&gt;</pre>
</main>
