...
<title>grid - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+block+grid"> - block grid</a>
    <li><a href="#label-Importing">Importing</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Small+Grids">Small Grids</a>
    <li><a href="#label-Medium+Grid">Medium Grid</a>
    <li><a href="#label-Advanced">Advanced</a>
    <li><a href="#label-Combined+Column-2FRow">Combined Column/Row</a>
    <li><a href="#label-Fluid+Row">Fluid Row</a>
    <li><a href="#label-Nesting">Nesting</a>
    <li><a href="#label-Offsets">Offsets</a>
    <li><a href="#label-Incomplete+Rows">Incomplete Rows</a>
    <li><a href="#label-Gutters">Gutters</a>
    <li><a href="#label-Responsive+Gutters">Responsive Gutters</a>
    <li><a href="#label-Static+Gutters">Static Gutters</a>
    <li><a href="#label-Collapse-2FUncollapse+Rows">Collapse/Uncollapse Rows</a>
    <li><a href="#label-Centered+Columns">Centered Columns</a>
    <li><a href="#label-Source+Ordering">Source Ordering</a>
    <li><a href="#label-Block+Grids">Block Grids</a>
    <li><a href="#label-Building+Semantically">Building Semantically</a>
    <li><a href="#label-Rows">Rows</a>
    <li><a href="#label-Columns">Columns</a>
    <li><a href="#label-Multiple+Grids">Multiple Grids</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/grid.md">

<p>— title: The Grid description: Create powerful multi-device layouts quickly
and easily with the default 12-column, nestable Foundation grid. If
you&#39;re familiar with grid systems, you&#39;ll feel right at home. If
not, you&#39;ll learn quickly. video: k1zizfK2xbQ sass:  - scss/grid/*.scss
- &#39;!scss/grid/_flex-grid.scss&#39; tags:</p>

<h2 id="label-+-+block+grid"> - block grid<span><a href="#label-+-+block+grid">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>To use the Float Grid in Foundation v6.4+, you need to: * In CDN link or
package managers: import <code>foundation-float.css</code> in place of
<code>foundation.css</code>. * In Sass: set both <code>$xy-grid</code> and
<code>$global-flexbox</code> to <code>false</code>.</p>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Start by adding an element with a class of <code>.row</code>. This will
create a horizontal block to contain vertical columns. Then add elements
with a <code>.column</code> class within that row. Specify the widths of
each column with the <code>.small-#</code>, <code>.medium-#</code>, and
<code>.large-#</code> classes.</p>

<p><strong>Foundation is mobile-first.</strong> Code for small screens first,
and larger devices will inherit those styles. Customize for larger screens
as necessary.</p>
<p>
...
<h3 id="label-Small+Grids">Small Grids<span><a href="#label-Small+Grids">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Small grids expand to large screens easier than large grids cram into small
screens.</p>
<p>
...
<h3 id="label-Medium+Grid">Medium Grid<span><a href="#label-Medium+Grid">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Medium sized screens will inherit styles from small, unless you specify a
different layout using the medium grid classes.</p>
<p>
...
<h2 id="label-Advanced">Advanced<span><a href="#label-Advanced">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Combined+Column-2FRow">Combined Column/Row<span><a href="#label-Combined+Column-2FRow">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you have just a single column, you can save some markup by combining the
<code>.row</code> and <code>.column</code> classes together on the same
element. You can still nest more grids inside this container like usual.</p>
...
<h3 id="label-Fluid+Row">Fluid Row<span><a href="#label-Fluid+Row">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Normally, a row is always 1200 pixels wide. Make a row completely fluid by
adding the <code>.expanded</code> class.</p>
<p>
...
<pre>&lt;div class=&quot;expanded row&quot;&gt;
&lt;/div&gt;</pre>
<hr>

<h3 id="label-Nesting">Nesting<span><a href="#label-Nesting">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>You can nest the grids indefinitely, though at a certain point it will get
absurd.</p>
<p>
...
<h3 id="label-Offsets">Offsets<span><a href="#label-Offsets">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Move blocks up to 11 columns to the right by using classes like
<code>.large-offset-1</code> and <code>.small-offset-3</code>.</p>
<p>
...
<h3 id="label-Incomplete+Rows">Incomplete Rows<span><a href="#label-Incomplete+Rows">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>In order to work around browsers&#39; different rounding behaviors,
Foundation will float the last column in a row to the right so the edge
aligns. If your row doesn&#39;t have a count that adds up to 12 columns,
you can tag the last column with a class of <code>.end</code> in order to
override that behavior. Alternatively, you can set the
<code>$grid-column-align-edge</code> variable to <code>false</code> to turn
off this behavior entirely.</p>
...
<h4 id="label-Responsive+Gutters">Responsive Gutters<span><a href="#label-Responsive+Gutters">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>The grid <em>gutter</em>—the space between two columns in a row, and the
space between the edge of a grid and the edge of the page—is responsive,
and becomes wider on larger screens.</p>

<p>Breakpoint | Gutter Size ———–|———— <code>small</code> | 20px
<code>medium</code> | 30px</p>

<p>If you&#39;re using the Sass version of Foundation, you can change these
defaults by editing the <code>$grid-column-gutter</code> variable map:</p>

<pre>$grid-column-gutter: (
  small: 20px,
  medium: 30px,
);</pre>

<p>To add more gutter definitions, add new lines to the map. The breakpoint
names used here must match a breakpoint name in your project&#39;s
<code>$breakpoints</code> map.</p>

<h4 id="label-Static+Gutters">Static Gutters<span><a href="#label-Static+Gutters">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>If you prefer using one gutter size for every breakpoint, just use a single
number for the <code>$grid-column-gutter</code> variable:</p>

<pre>$grid-column-gutter: 30px;</pre>

<p>You can also explicitly set the gutter size for a particular grid row by
adding the <code>.gutter-[size]</code> class. This is useful when your
using responsive gutters but specific components need static gutters.</p>

<pre>&lt;div class=&quot;row gutter-small&quot;&gt;
  &lt;div class=&quot;columns&quot;&gt;This grid always has small gutters&lt;/div&gt;
&lt;/div&gt;</pre>
<hr>

<h3 id="label-Collapse-2FUncollapse+Rows">Collapse/Uncollapse Rows<span><a href="#label-Collapse-2FUncollapse+Rows">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The <code>.collapse</code> class lets you remove column gutters (padding).</p>

<p>There are times when you won&#39;t want each media query to be collapsed or
uncollapsed. In this case, use the media query size you want and collapse
or uncollapse and add that to your row element. Example shows no gutter at
small media size and then adds the gutter to columns at medium.</p>
<div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;row medium-uncollapse large-collapse&quot;&gt;
  ...
  &lt;/div&gt;
&lt;/div&gt;</pre>
<p class="lead">Scale the browser down to a medium size to see the difference.</p><div class="row medium-uncollapse large-collapse">
  <div class="columns small-6">
...
<h3 id="label-Centered+Columns">Centered Columns<span><a href="#label-Centered+Columns">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Center your columns by adding a class of <code>.small-centered</code> to
your column. Large will inherit small centering by default, but you can
also center solely on large by applying a <code>.large-centered</code>
class. To uncenter on large screens, use <code>.large-uncentered</code>.</p>
<p>
...
<h3 id="label-Source+Ordering">Source Ordering<span><a href="#label-Source+Ordering">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Using these source ordering classes, you can shift columns around between
our breakpoints. This means if you place sub-navigation below main content
on small displays, you have the option to position the sub-navigation on
either the left or right of the page for large displays. Prefix push/pull
with the size of the device you want to apply the styles to.
<code>.medium-push-#</code>, <code>.large-push-#</code> is the syntax
you&#39;ll use. Use the number 0 instead to reset a push/pull, such as
<code>.medium-push-0</code> or <code>.large-pull-0</code>.</p>
<p>
...
<h3 id="label-Block+Grids">Block Grids<span><a href="#label-Block+Grids">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Block grids are a shorthand way to create equally-sized columns. Add a
class of the format <code>.[size]-up-[n]</code> to change the number of
columns within the row. By default, the max number of columns you can use
with block grid are 8. Adding the <code>.column-block</code> class to
columns will apply a bottom margin equal to the width of gutters.</p>
<p>
...
<pre>&lt;div class=&quot;row small-up-2 medium-up-3 large-up-4&quot;&gt;
...
<p>Our grid CSS is generated with a powerful set of Sass mixins, which you can
use in your own code to build a semantic grid.</p>

<h3 id="label-Rows">Rows<span><a href="#label-Rows">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>grid-row()</code> mixin to create a row.</p>
...
<h3 id="label-Columns">Columns<span><a href="#label-Columns">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>grid-column()</code> mixin to create a column. There are a
number of ways to define the width of the column.</p>
...
<p>The grid column calculator can also be accessed as a function. This gives
you the percentage value, without any of the grid column CSS.</p>

<pre>.main-content {
  width: grid-column(1 of 7);
}</pre>

<p>To center a column semantically. Use ´grid-column-position(center);´.</p>
...
<h3 id="label-Multiple+Grids">Multiple Grids<span><a href="#label-Multiple+Grids">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>By default, all grids use the number of columns set by the
<code>$grid-column-count</code> variable. However, this can be selectively
overridden within an instance of a row.</p>

<p>In this example, the grid is 16 columns instead of the normal 12. Any
references to column math inside the mixin will use the new column count.</p>
...
<p>You can also temporarily change the grid context without outputting any row
CSS, by using the <code>grid-context()</code> mixin.</p>

<pre>@include grid-context(7) {
  .sidebar {
    @include grid-column(4);
  }
}</pre>

<p>Every other grid feature, from sizing to offsets to source ordering, can
also be accessed with a mixin. Pair them with the <code>breakpoint()</code>
mixin to make your grid responsive.</p>
...
<p>Use the <code>grid-layout()</code> mixin to create your own block grid. By
default the mixin takes 3 parameters: - Number of columns - The child
element selector  - An optional padding value</p>

<p>The padding value can be set to <code>$grid-column-gutter</code> to use the
values from that map. This will then generate different paddings at
different breakpoints. Alternatively supply a numeric value (without a unit
type) to output a static rem value.</p>
