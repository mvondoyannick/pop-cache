...
<title>javascript - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-27Mf5ZZfKTe-I-27">video: &#39;Mf5ZZfKTe-I&#39;</a>
    <li><a href="#label-Installing">Installing</a>
    <li><a href="#label-Import+in+HTML">Import in HTML</a>
    <li><a href="#label-Import+in+JavaScript">Import in JavaScript</a>
    <li><a href="#label-Available+formats">Available formats</a>
    <li><a href="#label-Tree+Shaking">Tree Shaking</a>
    <li><a href="#label-Initializing">Initializing</a>
    <li><a href="#label-Using+Plugins">Using Plugins</a>
    <li><a href="#label-Configuring+Plugins">Configuring Plugins</a>
    <li><a href="#label-Adding+Plugins+After+Page+Load">Adding Plugins After Page Load</a>
    <li><a href="#label-Adding+Content+to+Plugins">Adding Content to Plugins</a>
    <li><a href="#label-Programmatic+Use">Programmatic Use</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/javascript.md">

<p>— title: JavaScript description: Our JavaScript is easy to set up and only
requires jQuery to get going.</p>

<h2 id="label-video-3A+-27Mf5ZZfKTe-I-27">video: &#39;Mf5ZZfKTe-I&#39;<span><a href="#label-video-3A+-27Mf5ZZfKTe-I-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Installing">Installing<span><a href="#label-Installing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can get the Foundation JavaScript files from a ZIP download, package
manager, or CDN. Check out the <a href="installation.html">Installation</a>
page to learn more.</p>

<p>Once you have the files, add links to jQuery and Foundation as
<code>&lt;script&gt;</code> tags at the bottom of your page, just before
the closing <code>&lt;body&gt;</code> tag.</p>

<pre>&lt;!-- jQuery must be imported before Foundation --&gt;
&lt;script src=&quot;js/jquery.min.js&quot;&gt;&lt;/script&gt;
&lt;!-- this will include every plugin and utility required by Foundation --&gt;
&lt;script src=&quot;js/foundation.min.js&quot;&gt;&lt;/script&gt;</pre>

<h3 id="label-Import+in+HTML">Import in HTML<span><a href="#label-Import+in+HTML">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>You can import in your HTML the complete Foundation library
<code>foundation.min.js</code> like above, but also each plugin
individually.</p>

<pre>&lt;!-- Example of selectively including files --&gt;
...
&lt;script src=&quot;js/foundation.accordion.min.js&quot;&gt;&lt;/script&gt;</pre>

<p>Know that they all require <code>foundation.core.js</code> to be loaded
<em>first</em>. Some plugins also require specific utility libraries that
ship with Foundation—refer to a plugin&#39;s documentation to find out
which plugins require what, and see the <a
href="javascript-utilities.html">JavaScript Utilities</a> page for more
information.</p>
...
<h3 id="label-Import+in+JavaScript">Import in JavaScript<span><a href="#label-Import+in+JavaScript">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>By default, Foundation is exported as <a
href="http://bob.yexley.net/umd-javascript-that-runs-anywhere/">UMD
modules</a>. This means that Foundation and its plugins can be imported and
used in any JavaScript environment.</p>

<p>For example with <a
href="https://github.com/lukehoban/es6features#readme">ES6</a> (the ESM
format): <code>js import Foundation from &#39;foundation-sites&#39;; const
$dropdown = new Foundation.Dropdown($(&#39;#mydropdown&#39;)); // Or import
{ Dropdown } from &#39;foundation-sites&#39;; const $dropdown = new
Dropdown($(&#39;#mydropdown&#39;)); </code></p>

<p>With <a href="http://requirejs.org/">RequireJs</a> (the AMD format):
<code>js define(['foundation'], function(Foundation) {   var $dropdown =
new Foundation.Dropdown($(&#39;#mydropdown&#39;)); }); </code></p>

<p>With <a
href="https://www.safaribooksonline.com/library/view/learning-javascript-design/9781449334840/ch11s03.html">Node.js</a>
(the CommonJs format): <code>js var Foundation =
require(&#39;foundation-sites&#39;); var $dropdown = new
Dropdown($(&#39;#mydropdown&#39;)); </code></p>

<h4 id="label-Available+formats">Available formats<span><a href="#label-Available+formats">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Foundation is provided in bundles of various module formats so you can pick
the one that matches the best your needs. If you don&#39;t know these terms
yet, take a look at this <a
href="https://www.jvandemo.com/a-10-minute-primer-to-javascript-modules-module-formats-module-loaders-and-module-bundlers/">10-minute
introduction to module formats in JavaScript</a>. You will find in the
<code>dist/js</code> folder the following bundles:</p>
<ul><li>
<p><code>foundation.js</code> &lt;span class=“label
secondary”&gt;UMD&lt;/span&gt; &lt;span
class=“label”&gt;Default&lt;/span&gt;<br>  Compatible with most
environments and tools (AMD, CJS, ESM…). It works almost everywhere by
checking the module format of your environments and then using it, which
makes the bundle a little heavier.</p>
</li><li>
<p><code>foundation.cjs.js</code> &lt;span class=“label
secondary”&gt;CommonJS&lt;/span&gt;<br>  Dedicated to Node.js and older
bundlers like Browserify or Webpack v1.</p>
</li><li>
<p><code>foundation.esm.js</code> &lt;span class=“label secondary”&gt;ES6
Modules&lt;/span&gt; (<code>module</code> in <code>package.json</code>)<br>
Everything is transpiled to ES5 but the modules. Dedicated to modern
bundlers, like Webpack 2+ or Rollup. They will automatically use this
bundle and parse the ES6 modules to remove the unused code (see <a
href="#tree-shaking">tree shaking</a> below).</p>
</li><li>
<p><code>foundation.es6.js</code> &lt;span class=“label
secondary”&gt;ES6&lt;/span&gt; (<code>esnext</code> in
<code>package.json</code>)<br>  Unlike the other bundles, this bundle is
not transpiled. It contains all the Foundation sources in ES6 in a single
file. Use it if you want to manually transpile it for your own targets.</p>
</li></ul>

<h4 id="label-Tree+Shaking">Tree Shaking<span><a href="#label-Tree+Shaking">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Many bundlers like Webpack, Rollup or Parcel support tree shaking. It
consists of the removing the unused code parts from your codebase or your
dependencies. Take a look at these articles to know how it works and how to
enable it: <a href="https://www.engineyard.com/blog/tree-shaking">How To
Clean Up Your JavaScript Build With Tree Shaking</a>, <a
href="https://advancedweb.hu/2017/02/07/treeshaking/">Why Webpack 2’s Tree
Shaking is not as effective as you think</a> and <a
href="https://developers.google.com/web/fundamentals/performance/optimizing-javascript/tree-shaking/">Reduce
JavaScript Payloads with Tree Shaking</a>.</p>

<p>As tree shaking is only available in ES6, we recommend to import plugins
like the following:</p>

<pre>// Only Dropdown and DropdownMenu will be included in your application.
import { Dropdown, DropdownMenu } from &#39;foundation-sites&#39;;</pre>

<p>Sadly, the “static analysis” promised by these bundlers to detect unused
code in dependencies does not always work. Depending on your build
environment, you may have to manually import the Foundation plugins to make
it work correctly:</p>

<pre>// /!\ Don&#39;t use this if tree shaking works with standard named imports.
// Only Dropdown and DropdownMenu will be included in your application.
import { Dropdown } from &#39;foundation-sites/js/foundation.dropdown&#39;;
import { DropdownMenu } from &#39;foundation-sites/js/foundation.dropdownMenu&#39;;</pre>
<hr>

<h2 id="label-Initializing">Initializing<span><a href="#label-Initializing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The <code>.foundation()</code> function on the jQuery object will kick off
every Foundation plugin at once.</p>

<pre>$(document).foundation();</pre>

<p>You can also selectively initialize plugins by calling the
<code>.foundation();</code> method on one or more elements with a plugin.</p>

<pre>$(&#39;#foo&#39;).foundation(); // initialize all plugins within the element `#foo`
$(&#39;.has-tip&#39;).foundation(); // initialize all tooltips on the page.</pre>
<hr>

<h2 id="label-Using+Plugins">Using Plugins<span><a href="#label-Using+Plugins">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Plugins are attached to HTML elements using data attributes. The data
attribute will match the name of the plugin. For example, adding
<code>data-accordion</code> to an element creates an accordion, while
adding <code>data-tooltip</code> creates a tooltip link.</p>

<pre>&lt;p&gt;&lt;span data-tooltip aria-haspopup=&quot;true&quot; class=&quot;has-tip&quot; tabindex=&quot;1&quot; title=&quot;Fancy word for a beetle.&quot;&gt;Scarabaeus&lt;/span&gt;&lt;/p&gt;</pre>
<div class="callout warning">
...
<h2 id="label-Configuring+Plugins">Configuring Plugins<span><a href="#label-Configuring+Plugins">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Each plugin has a set of configuration settings that customize how it
works. For example, you change how fast an <a
href="accordion.html">accordion</a> slides up and down, or if <a
href="tooltip.html">tooltips</a> should appear on touch devices.</p>

<p>Plugin settings can be changed globally by changing the
<code>DEFAULTS</code> property on the plugin.</p>

<pre class="ruby"><span class="ruby-constant">Foundation</span>.<span class="ruby-constant">Accordion</span>.<span class="ruby-identifier">defaults</span>.<span class="ruby-identifier">slideSpeed</span> = <span class="ruby-value">500</span>;
<span class="ruby-constant">Foundation</span>.<span class="ruby-constant">Accordion</span>.<span class="ruby-identifier">defaults</span>.<span class="ruby-identifier">multiExpand</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>An individual instance of a plugin can also have different settings. These
can be set in the HTML or in JavaScript. &lt;div class=“callout
warning”&gt;  &lt;p&gt;In the HTML, each setting can be defined as an
individual data attribute. Note that camelCased options are converted to
hyphenated words. In the below example, <code>multiExpand</code> becomes
<code>data-multi-expand</code>.&lt;/p&gt; &lt;/div&gt;</p>

<pre>&lt;div data-accordion data-slide-speed=&quot;500&quot; data-multi-expand=&quot;true&quot;&gt;&lt;/div&gt;</pre>

<p>Data options can also be set in bulk on one attribute,
<code>data-options</code>. Options are written with the format <code>key:
value;</code>, with a semicolon separating each option. The above example
can be written using <code>data-options</code> like so:</p>

<pre>&lt;div data-accordion data-options=&quot;slideSpeed: 500; multiExpand: true;&quot;&gt;&lt;/div&gt;</pre>

<p>There is one exception to this rule above, in the <a
href="sticky.html">Sticky</a> plugin. Because of the way you pass top and
bottom anchors to that plugin, you can&#39;t include them in your
<code>data-options</code> attribute. If you are using a single anchor or no
declared anchor at all, you can still use <code>data-options</code>, and
you can use it for all other options available.</p>
<hr>
<p>Setting options with JavaScript involves passing an object into the
constructor function, like this:</p>

<pre>var options = {multiExpand: true, allowAllClosed: false};
var accordion = new Foundation.Accordion($(&#39;#some-accordion&#39;), options);</pre>

<p>It&#39;s worth noting that options passed to plugins via JavaScript take
the highest precedence, and will overwrite any default values or options
applied via the <code>data-some-option</code> tag. This is also how the
<code>data-options=&quot;someOption:true;
someOtherOption:false&quot;</code> options are passed into constructor
functions. So, if you were to say: <code>html &lt;div data-accordion
data-slide-speed=&quot;500&quot;
data-options=&quot;slideSpeed:250;&quot;&gt;...&lt;/div&gt; </code> your
accordion element would have a slide speed of 250 milliseconds.</p>
<hr>

<h2 id="label-Adding+Plugins+After+Page+Load">Adding Plugins After Page Load<span><a href="#label-Adding+Plugins+After+Page+Load">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you add new HTML to the DOM, any plugins on those elements won&#39;t be
initialized by default. Re-call the <code>.foundation()</code> function to
check for new plugins.</p>

<pre>$.ajax(&#39;assets/partials/kitten-carousel.html&#39;, function(data) {
  $(&#39;#kitten-carousel&#39;).html(data).foundation();
});</pre>
<hr>

<h2 id="label-Adding+Content+to+Plugins">Adding Content to Plugins<span><a href="#label-Adding+Content+to+Plugins">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>In previous versions of Foundation, there was a method for plugins called
<code>reflow</code>, though it&#39;s inclusion on plugins wasn&#39;t
universal. For Foundation 6 we&#39;ve added a global <code>reInit</code>
method that will remove and reapply event listeners, update the
plugin&#39;s instance data for relevant information, like a new tab or
content pane being added, and reset any cached data the plugin may rely on.</p>

<p>This method can be called on a plugin class: <code>js
Foundation.reInit(&#39;tooltip&#39;); </code> an array of plugin classes:
<code>js Foundation.reInit([&#39;tooltip&#39;, &#39;accordion&#39;,
&#39;reveal&#39;]); </code> or an individual element or collection of
elements selected with jQuery: <code>js
Foundation.reInit($(&#39;#some-plugin&#39;));
Foundation.reInit($(&#39;.some-plugin-class&#39;)); </code></p>

<p>If passing strings, it is required to pass proper
&lt;strong&gt;camelCased&lt;/strong&gt; or
&lt;strong&gt;kebab-cased&lt;/strong&gt; plugin names. Passing
<code>DropdownMenu</code> or <code>dropdown-menu</code> are equivalent.</p>
<hr>

<h2 id="label-Programmatic+Use">Programmatic Use<span><a href="#label-Programmatic+Use">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Plugins can be created programmatically in JavaScript. Every plugin is a
class on the global <code>Foundation</code> object, with a constructor that
accepts two parameters: an element to attach to, and an object of options.</p>

<pre>var $accordion = new Foundation.Accordion($(&#39;#accordion&#39;), {
  slideSpeed: 500,
  multiExpand: true
});</pre>

<p>Most plugins have a public API that allows you to manipulate it through
JavaScript. Refer to a plugin&#39;s documentation to learn what functions
are available. Invoking methods is easy as pie:</p>

<pre>$(&#39;#reveal&#39;).foundation(&#39;open&#39;); //will open a Reveal modal with id `reveal`.

$(&#39;[data-tabs]&#39;).eq(0).foundation(&#39;selectTab&#39;, $(&#39;#example&#39;)); //will change the first Tabs on the page to whatever panel you choose.

$(&#39;.tooltip&#39;).foundation(&#39;_destroy&#39;); //will destroy all Tooltips on the page.</pre>

<p>You can use any jQuery selector you like, and if the selector encompasses
multiple plugins, they will all have the same the chosen method invoked.
You pass arguments just like you would any in other JavaScript
<code>function(comma, delimited, so, easy)</code>. We did make an effort to
reduce the number of public methods that require arguments, but check the
plugin&#39;s page to see if it requires additional information.</p>

<p>If you are creating your plugins programmatically, you can, of course,
invoke methods directly:</p>

<pre>var $modal = new Foundation.Reveal($(&#39;#some-modal&#39;), options);
$modal.open();</pre>
<div class="callout warning">
...
<h2 id="label-Events">Events<span><a href="#label-Events">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Every plugin fires DOM events when certain functions finish. For example,
you can listen for when tabs change, or an off-canvas menu opens, and
create a callback to respond to it.</p>

<pre>$(&#39;[data-tabs]&#39;).on(&#39;change.zf.tabs&#39;, function() {
  console.log(&#39;Those tabs sure did change!&#39;);
});</pre>

<p>Refer to each plugin&#39;s documentation to see a list of events it fires,
and when they fire.</p>
<div class="callout warning">
