...
<title>top-bar - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Advanced+Layout">Advanced Layout</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/top-bar.md">

<p>— title: Top Bar description: The new top bar is a simpler wrapper around
our flexible menu components. video: cxPwwixHEJg sass:
./scss/components/_top-bar.scss</p>
...
<p>A top bar (<code>.top-bar</code>) can have two sections: a left-hand
section (<code>.top-bar-left</code>) and a right-hand section
(<code>.top-bar-right</code>). On small screens, these sections stack on
top of each other.</p>

<p>In the below example, our top bar includes a <a
href="dropdown-menu.html">dropdown menu</a>, along with a text input field
and action button. The dropdown menu inherits the background color of the
top bar. If you&#39;re using the Sass version of Foundation, you can change
this with the <code>$topbar-submenu-background</code> variable.</p>
<p>
...
<pre>&lt;div class=&quot;title-bar&quot; data-responsive-toggle=&quot;responsive-menu&quot; data-hide-for=&quot;medium&quot;&gt;
...
<p>By default, the two sections of a top bar will stack on top of each other
on small screens. This can be changed by adding the class
<code>.stacked-for-medium</code> or <code>.stacked-for-large</code>.</p>
...
<pre>&lt;div class=&quot;top-bar stacked-for-medium&quot;&gt;
  &lt;!-- ... --&gt;
&lt;/div&gt;</pre>
