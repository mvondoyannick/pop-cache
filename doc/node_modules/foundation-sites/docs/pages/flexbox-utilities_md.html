...
<title>flexbox-utilities - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+scss-2Futil-2F_flex.scss"> - scss/util/_flex.scss</a>
    <li><a href="#label-Flexbox+Utilities">Flexbox Utilities</a>
    <li><a href="#label-Horizontal+Alignment">Horizontal Alignment</a>
    <li><a href="#label-Vertical+Alignment">Vertical Alignment</a>
    <li><a href="#label-Central+Alignment">Central Alignment</a>
    <li><a href="#label-Vanilla+Flexbox+Helper+Classes">Vanilla Flexbox Helper Classes</a>
    <li><a href="#label-Responsive+Classes">Responsive Classes</a>
    <li><a href="#label-Source+Ordering">Source Ordering</a>
    <li><a href="#label-Helper+Mixins">Helper Mixins</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/flexbox-utilities.md">

<p>— title: Flexbox Utilities description: Flexbox utility classes and mixins
to make working with flexbox easier. video: &#39;KxafSdyTCIg&#39; sass:  -
scss/xy-grid/*.scss  - scss/components/_flex.scss</p>

<h2 id="label-+-+scss-2Futil-2F_flex.scss"> - scss/util/_flex.scss<span><a href="#label-+-+scss-2Futil-2F_flex.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Flexbox+Utilities">Flexbox Utilities<span><a href="#label-Flexbox+Utilities">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Flexbox makes horizontal and vertical alignment painless, through the CSS
properties <a
href="https://developer.mozilla.org/en-US/docs/Web/CSS/align-items">align-items</a>,
<a
href="https://developer.mozilla.org/en-US/docs/Web/CSS/align-self">align-self</a>,
and <a
href="https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content">justify-content</a>.
Foundation includes a handful of classes for these properties, which work
with any flexbox-enabled component.</p>

<p>To understand how these classes work, you need to understand the
parent-child relationship created with flexbox. An element with
<code>display: flex</code> is a <em>flex parent</em>, and can horizontally
or vertically align its children. All immediate children of the flex parent
are <em>flex children</em>. A flex child can vertically align itself.</p>
...
<p>Here&#39;s a basic example: when using the grid, a <code>grid-x</code> or
<code>grid-y</code> is a flex parent, and a <code>cell</code> is a flex
child. Use <code>grid-margin-x</code> or <code>grid-padding-x</code> for
adding <a href="xy-grid.html#gutters">gutters</a></p>

<pre>&lt;div class=&quot;grid-x grid-padding-x&quot;&gt;
...
<p>Horizontal alignment classes are applied to flex parents. Left alignment is
the default, but you can use one of these classes to change this:</p>
<ul><li>
<p><code>.align-right</code></p>
</li><li>
<p><code>.align-center</code></p>
</li><li>
<p><code>.align-justify</code></p>
</li><li>
<p><code>.align-spaced</code></p>
</li></ul>
...
<pre>&lt;div class=&quot;grid-x grid-padding-x&quot;&gt; &lt;!-- Aligned to the left --&gt;
...
<p>Vertical alignment can be applied to a flex parent—which will align all the
children automatically—or to a flex child, which will align only that
element.</p>

<p>Stretch alignment is the default. To set parent alignment, use these
classes:</p>
<ul><li>
...
<pre>&lt;div class=&quot;grid-x grid-padding-x align-top&quot;&gt;
...
<pre>&lt;div class=&quot;grid-x grid-padding-x align-middle&quot;&gt;
...
<pre>&lt;div class=&quot;grid-x grid-padding-x align-bottom&quot;&gt;
...
<pre>&lt;div class=&quot;grid-x grid-padding-x align-stretch&quot;&gt;
  &lt;div class=&quot;cell small-4&quot;&gt;These cells have the same height&lt;/div&gt;
  &lt;div class=&quot;cell small-4&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatum, tempora. Impedit eius officia possimus laudantium? Molestiae eaque, sapiente atque doloremque placeat! In sint, fugiat saepe sunt dolore tempore amet cupiditate.&lt;/div&gt;
&lt;/div&gt;</pre>
<hr>

<p>To align an individual child, use the below classes. They use the same
alignment terms as the parent-level classes, but the classes start with
<code>.align-self-</code> instead of <code>.align-</code>.</p>
<ul><li>
<p><code>.align-self-top</code></p>
</li><li>
<p><code>.align-self-middle</code></p>
</li><li>
<p><code>.align-self-bottom</code></p>
</li><li>
...
<h3 id="label-Central+Alignment">Central Alignment<span><a href="#label-Central+Alignment">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Central alignment can be applied to a flex parent, which will centrally
align all children horizontally and vertically automatically. To set this
to your layout, simply use the class: <code>.align-center-middle</code>.</p>
<div class="primary callout">
...
<pre>&lt;div class=&quot;grid-x grid-padding-x align-center-middle text-center&quot; style=&quot;height: 200px;&quot;&gt;
  &lt;div class=&quot;cell small-4&quot;&gt;I am in the center-middle&lt;/div&gt;
  &lt;div class=&quot;cell small-4&quot;&gt;I am also centrally located&lt;/div&gt;
&lt;/div&gt;</pre>
<hr>

<h2 id="label-Vanilla+Flexbox+Helper+Classes">Vanilla Flexbox Helper Classes<span><a href="#label-Vanilla+Flexbox+Helper+Classes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation also includes some helper classes for quickly applying flex
container &amp; direction attributes to elements.</p>

<p>To make something a flex container, simply apply -
<code>.flex-container</code></p>

<p>And to change its flex direction from row to column you can use the helper
classes:</p>
<ul><li>
<p><code>.flex-dir-row</code> (default)</p>
</li><li>
<p><code>.flex-dir-row-reverse</code></p>
</li><li>
<p><code>.flex-dir-column</code></p>
</li><li>
<p><code>.flex-dir-column-reverse</code></p>
</li></ul>

<p>For children, there are 3 quick helper classes to apply the flex property.
These control how the containers take up space relative to their siblings:</p>
<ul><li>
<p><code>.flex-child-auto</code> (auto size flex child)</p>
</li><li>
<p><code>.flex-child-grow</code> (flex child that will grow to take up all
possible space)</p>
</li><li>
<p><code>.flex-child-shrink</code> (flex child that will shrink to minimum
possible space)</p>
</li></ul>
<div class="docs-codepen-container">
...
<h3 id="label-Responsive+Classes">Responsive Classes<span><a href="#label-Responsive+Classes">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>All of these helper classes come in responsive varieties, prefixed with all
of your named breakpoints.</p>

<p>These vanilla flexbox helper classes also have an optional mobile first
responsive classes so that setting a class will apply to the small
breakpoint and large unless overridden by a class for a larger breakpoint..
Example: <code>class=&quot;flex-child-shrink
large-flex-child-auto&quot;</code> will be shrink on the small and medium
breakpoints and then auto on large.</p>

<p>These optional responsive classes can be disabled by setting
<code>$flexbox-responsive-breakpoints</code> to <code>false</code>. See <a
href="#sass-variables">here</a></p>
<div class="docs-codepen-container">
...
<h2 id="label-Source+Ordering">Source Ordering<span><a href="#label-Source+Ordering">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Flexbox supports source ordering, making it easy to rearrange columns on
different screen sizes without weird relative positioning tricks.</p>
...
<p>Columns within a row will be sorted by their <code>order</code> property.
Lower numbers are placed first. If multiple columns have the same number,
they&#39;re sorted in the order they appear in the HTML.</p>

<p>We have a set of classes that make it easy to setup source ordering in your
HTML. They also come in responsive flavors, allowing you to reorder a grid
...
<h2 id="label-Helper+Mixins">Helper Mixins<span><a href="#label-Helper+Mixins">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you&#39;re using the Sass version of Foundation, you can access the
above helpers as mixins as well.</p>

<p>For parent-level alignment, use <code>flex-align()</code>. You can pass in
a horizontal alignment (<code>$x</code>), vertical alignment
...
<p>For child-level alignment, use <code>flex-align-self()</code>. You can pass
in any vertical alignment.</p>

<pre>.sidebar {
  @include flex-align-self(bottom);
}</pre>

<p>Interested in building your own flexbox-ey component? Use the
<code>flex()</code> mixin to get started.</p>
