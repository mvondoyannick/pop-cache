...
<title>accordion-menu - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+FXZIZ9N4aeI">video: FXZIZ9N4aeI</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Submenu+Toggle">Submenu Toggle</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/accordion-menu.md">

<p>— title: Accordion Menu sass: scss/components/_accordion-menu.scss js:
js/foundation.accordionMenu.js description: Change a basic vertical Menu
into a expandable accordion menu with the Accordion Menu plugin.</p>

<h2 id="label-video-3A+FXZIZ9N4aeI">video: FXZIZ9N4aeI<span><a href="#label-video-3A+FXZIZ9N4aeI">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Accordion menus follow the basic <a href="menu.html">Menu</a> syntax of
<code>&lt;ul&gt;</code>, <code>&lt;li&gt;</code>, and
<code>&lt;a&gt;</code>. To convert a basic menu into an accordion, add the
attribute <code>data-accordion-menu</code>. You probably also want it to be
vertical, so add the class <code>.vertical</code> as well.</p>

<p>Any <code>&lt;a&gt;</code> will behave like a standard link. However, any
<code>&lt;a&gt;</code> paired with a nested <code>&lt;ul&gt;</code> menu
will then slide that sub-menu up and down when clicked on.</p>
<a class="" data-open-video="1:03"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="primary callout">
...
<pre>&lt;ul class=&quot;vertical menu accordion-menu&quot; data-accordion-menu&gt;
  &lt;li&gt;
    &lt;a href=&quot;#&quot;&gt;Item 1&lt;/a&gt;
...
<h2 id="label-Submenu+Toggle">Submenu Toggle<span><a href="#label-Submenu+Toggle">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Accordion menus can have a separate submenu toggle. This allows the parent
item to have its own link, but still allows the submenu to be
opened/closed. You need to add the class <code>accordion-menu</code> as
well as the data attribute
<code>data-submenu-toggle=&quot;true&quot;</code> for this to work
correctly.</p>

<pre>&lt;ul class=&quot;vertical menu accordion-menu&quot; data-accordion-menu data-submenu-toggle=&quot;true&quot;&gt;
  &lt;li&gt;
