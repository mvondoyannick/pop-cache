...
<title>forms - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Form+Basics">Form Basics</a>
    <li><a href="#label-Text+Inputs">Text Inputs</a>
    <li><a href="#label-Number+Inputs">Number Inputs</a>
    <li><a href="#label-Text+Areas">Text Areas</a>
    <li><a href="#label-Select+Menus">Select Menus</a>
    <li><a href="#label-Checkboxes+and+Radio+Buttons">Checkboxes and Radio Buttons</a>
    <li><a href="#label-Fieldset+Styles">Fieldset Styles</a>
    <li><a href="#label-Help+Text+-28Accessibility-29">Help Text (Accessibility)</a>
    <li><a href="#label-Label+Positioning">Label Positioning</a>
    <li><a href="#label-Inline+Labels+and+Buttons">Inline Labels and Buttons</a>
    <li><a href="#label-File+Upload+Button">File Upload Button</a>
    <li><a href="#label-Custom+Controls+-28Accessibility-29">Custom Controls (Accessibility)</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/forms.md">

<p>— title: Forms description: We set out to create an easy, powerful and
versatile form layout system. A combination of form styles and the
Foundation grid means you can do almost anything. video:
&#39;pJDXFNJ2jkA&#39; sass:  - scss/forms/*.scss  -
&#39;!scss/forms/_error.scss&#39; tags:  - input  - select  - radio  -
checkbox</p>
...
<h2 id="label-Form+Basics">Form Basics<span><a href="#label-Form+Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Creating a form in Foundation is designed to be easy but extremely
flexible. Forms are built with a combination of standard form elements, as
well as grid rows and columns or cells.</p>
<hr>

<h4 id="label-Text+Inputs">Text Inputs<span><a href="#label-Text+Inputs">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>These input types create a text field: <code>text</code>,
<code>date</code>, <code>datetime</code>, <code>datetime-local</code>,
<code>email</code>, <code>month</code>, <code>number</code>,
<code>password</code>, <code>search</code>, <code>tel</code>,
<code>time</code>, <code>url</code>, and <code>week</code>.</p>
<p>
...
<h4 id="label-Number+Inputs">Number Inputs<span><a href="#label-Number+Inputs">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>In most desktop browsers, <code>&lt;input
type=&quot;number&quot;&gt;</code> elements will have up/down controls
inside them, which increment and decrement the number inside the field.
These are called <em>spin buttons</em>. You can disable them by setting the
<code>$input-number-spinners</code> Sass variable to <code>false</code>.</p>
...
<h4 id="label-Text+Areas">Text Areas<span><a href="#label-Text+Areas">&para;</a> <a href="#top">&uarr;</a></span></h4>
...
<h4 id="label-Select+Menus">Select Menus<span><a href="#label-Select+Menus">&para;</a> <a href="#top">&uarr;</a></span></h4>
...
<p>Add the <code>multiple</code> attribute to allow more than one option to be
selected. Hold down the Ctrl (windows) / Command (Mac) button to select
multiple options.</p>

<pre>&lt;label&gt;Multiple Select Menu
  &lt;select multiple&gt;
...
<h4 id="label-Checkboxes+and+Radio+Buttons">Checkboxes and Radio Buttons<span><a href="#label-Checkboxes+and+Radio+Buttons">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Use groups of checkboxes when the user may select multiple choices from a
list, and use radio buttons when the user must select just one choice.</p>

<p>Wrap a group of checkboxes or radio buttons in a
<code>&lt;fieldset&gt;</code> element, and give them a common label using
the <code>&lt;legend&gt;</code> element. Each individual control should
also have its own label, created using a typical
<code>&lt;label&gt;</code>.</p>
<p>
...
<h4 id="label-Fieldset+Styles">Fieldset Styles<span><a href="#label-Fieldset+Styles">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>To encourage their use as an accessibility tool, the
<code>&lt;fieldset&gt;</code> element is no longer styled by default. Those
styles are now contained in the <code>.fieldset</code> class.</p>
<p>
  <a class="" data-open-video="9:03"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p><div class="docs-codepen-container">
  <a class="codepen-logo-link" href="http://codepen.io/ZURBFoundation/pen/XREyxv?editors=1000" target="_blank"><img src="{{root}}assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
<pre>&lt;fieldset class=&quot;fieldset&quot;&gt;
  &lt;legend&gt;Check these out&lt;/legend&gt;
...
<h2 id="label-Help+Text+-28Accessibility-29">Help Text (Accessibility)<span><a href="#label-Help+Text+-28Accessibility-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Place help text below a field to clarify its purpose. Whenever you use help
text, give the text a unique ID, and add the attribute
<code>aria-describedby</code> to the input. Doing so associates the helper
text to the input. A screen reader then can read the helper text when the
user focusses on the input.</p>
<p>
...
&lt;/label&gt;
&lt;p class=&quot;help-text&quot; id=&quot;passwordHelpText&quot;&gt;Your password must have at least 10 characters, a number, and an Emoji.&lt;/p&gt;</pre>
<hr>

<h2 id="label-Label+Positioning">Label Positioning<span><a href="#label-Label+Positioning">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Sometimes you want a form with labels to the left of your inputs. Piece of
cake! You can put the label inside a different cell or column to the left
of the input. Then use the class <code>.text-right</code> or
<code>.float-right</code> (or add <code>text-align: right</code> yourself)
to realign the label.</p>
<a class="" data-open-video="12:00"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="warning callout">
  <p>In a <a href="rtl.html">right-to-left</a> environment, use <code>.float-left</code> instead.</p>
</div><div class="docs-video-codepen-container">
...
<p>Add the <code>.middle</code> class to vertically align the label with its
input.</p>
...
<h2 id="label-Inline+Labels+and+Buttons">Inline Labels and Buttons<span><a href="#label-Inline+Labels+and+Buttons">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To attach extra text or controls to the left or right of an input field,
wrap the elements in an <code>.input-group</code> container, then add these
classes to the elements inside:</p>
<ul><li>
<p><code>.input-group-field</code> on the text field.</p>
</li><li>
<p><code>.input-group-label</code> on a text label.</p>
</li><li>
<p><code>.input-group-button</code> on a button. <strong>Place the button
inside this wrapper.</strong></p>
</li></ul>
<a class="" data-open-video="14:53"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="primary callout">
...
<h2 id="label-File+Upload+Button">File Upload Button<span><a href="#label-File+Upload+Button">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Use <code>&lt;input type=&quot;file&quot;&gt;</code> to create a file
upload button. For security reasons, most browsers don&#39;t let you style
file inputs. To work around that, we can style a form label as a button,
and point it to the <code>&lt;input&gt;</code>. To properly mask the input,
the <code>.show-for-sr</code> class is added.</p>
<p>
...
<pre>&lt;label for=&quot;exampleFileUpload&quot; class=&quot;button&quot;&gt;Upload File&lt;/label&gt;
&lt;input type=&quot;file&quot; id=&quot;exampleFileUpload&quot; class=&quot;show-for-sr&quot;&gt;</pre>
<hr>

<h2 id="label-Custom+Controls+-28Accessibility-29">Custom Controls (Accessibility)<span><a href="#label-Custom+Controls+-28Accessibility-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Custom form controls, like date pickers, range sliders, or switches need
some extra attention to be made accessible. Our custom inputs, such as the
range slider and switch, do most of this work for you.</p>

<p>Custom inputs with labels or help text need the attributes
<code>aria-labelledby</code> and <code>aria-describedby</code> added to
them, so screen readers know how to describe the control.</p>

<pre>&lt;label id=&quot;ageLabel&quot;&gt;Age&lt;/label&gt;
&lt;div class=&quot;slider&quot; aria-labelledby=&quot;ageLabel&quot; aria-describedby=&quot;ageHelpText&quot; data-slider data-initial-start=&quot;50&quot; data-end=&quot;200&quot;&gt;
  ...
  &lt;input type=&quot;hidden&quot;&gt;
&lt;/div&gt;
&lt;p id=&quot;ageHelpText&quot;&gt;How old are you?&lt;/p&gt;</pre>
</main>
