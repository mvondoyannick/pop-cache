...
<title>xy-grid - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-sass-3A+scss-2Fxy-grid+.scss">sass: scss/xy-grid .scss</a>
    <li><a href="#label-XY+Grid+Basics">XY Grid Basics</a>
    <li><a href="#label-Browser+support">Browser support</a>
    <li><a href="#label-Importing">Importing</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Gutters">Gutters</a>
    <li><a href="#label-Grid+Container">Grid Container</a>
    <li><a href="#label-Grid+Container+Fluid">Grid Container Fluid</a>
    <li><a href="#label-Grid+Container+Full">Grid Container Full</a>
    <li><a href="#label-Auto+Sizing">Auto Sizing</a>
    <li><a href="#label-Responsive+Adjustments">Responsive Adjustments</a>
    <li><a href="#label-Collapse+Cells+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">Collapse Cells &lt;span class=“label secondary”&gt;X Grid only&lt;/span&gt;</a>
    <li><a href="#label-Offsets+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">Offsets &lt;span class=“label secondary”&gt;X Grid only&lt;/span&gt;</a>
    <li><a href="#label-Block+Grids+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">Block Grids &lt;span class=“label secondary”&gt;X Grid only&lt;/span&gt;</a>
    <li><a href="#label-Looking+for+Push-2FPull-3F">Looking for Push/Pull?</a>
    <li><a href="#label-Vertical+Grids">Vertical Grids</a>
    <li><a href="#label-Grid+Frame">Grid Frame</a>
    <li><a href="#label-Building+Semantically">Building Semantically</a>
    <li><a href="#label-Grid+Container">Grid Container</a>
    <li><a href="#label-Grids">Grids</a>
    <li><a href="#label-Gutters">Gutters</a>
    <li><a href="#label-Cells">Cells</a>
    <li><a href="#label-Responsive+Grids">Responsive Grids</a>
    <li><a href="#label-Custom+Block+Grid">Custom Block Grid</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/xy-grid.md">

<p>— title: XY Grid description: A fully reworked new grid system in v6.4
which has all the variety inbuilt in the form of multiple grid types which
includes margin grid, padding grid, frame grid, block grid and vertical
grid. video: tjjVKGeoi3A</p>

<h2 id="label-sass-3A+scss-2Fxy-grid+.scss">sass: scss/xy-grid .scss<span><a href="#label-sass-3A+scss-2Fxy-grid+.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-XY+Grid+Basics">XY Grid Basics<span><a href="#label-XY+Grid+Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The XY grid works very similarly to the standard float grid, but includes a
number of useful features only possible with Flexbox, like horizontal and
vertical alignment, automatic sizing and a full vertical grid.</p>
<hr>

<h2 id="label-Browser+support">Browser support<span><a href="#label-Browser+support">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The XY grid is supported in Chrome, Firefox, Safari 6+, IE10+, iOS 7+, and
Android 4.4+. Flexbox is supported in Android 2, but not reliably enough
for use with this grid. (<a href="http://caniuse.com/#feat=flexbox">View
Flexbox browser support.</a>) We recommend only using the XY grid on
projects that can live with purely cutting-edge browser support.</p>
<hr>

<h2 id="label-Importing">Importing<span><a href="#label-Importing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><em>XY grid is the default Foundation grid</em>*. It is present by default
in <code>foundation.css</code> of CDN link or package managers. In Sass, it
will be generated by default by <code>@include foundation-everything</code>
(unless <code>$flex</code> or <code>$xy-grid</code> are set to false).</p>

<p>If <code>$xy-grid</code> is set to false, the flex grid is used.<br> If
<code>$flex</code> is set to false, the float grid is used instead.</p>

<p>You can manually generate the XY Grid with: “`scss @import
&#39;foundation&#39;;</p>

<p>@include foundation-xy-grid-classes(  /* options  $base-grid: true, 
$margin-grid: true,  $padding-grid: true,  $block-grid: true,  $collapse:
true,  $offset: true,  $vertical-grid: true,  $frame-grid: true</p>
...
<p>The structure of XY grid uses <code>.grid-x</code>, <code>.grid-y</code>,
and <code>.cell</code> as its base. Without <a href="#gutters">defining a
gutter type</a> the cells will simply split up the space without any
gutters.</p>
<p>
...
</p><div class="docs-codepen-container">
...
<h2 id="label-Gutters">Gutters<span><a href="#label-Gutters">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The defining feature of the XY grid is the ability to use margin AND
padding grids in harmony. To define a grid type, simply set
<code>.grid-margin-x</code>/<code>.grid-margin-y</code> or
<code>.grid-padding-x</code>/<code>.grid-padding-y</code> on the grid.</p>
<p>
...
<pre>&lt;div class=&quot;grid-x grid-margin-x&quot;&gt;
  &lt;div class=&quot;cell medium-6 large-4&quot;&gt;12/6/4 cells&lt;/div&gt;
  &lt;div class=&quot;cell medium-6 large-8&quot;&gt;12/6/8 cells&lt;/div&gt;
&lt;/div&gt;
...
<h2 id="label-Grid+Container">Grid Container<span><a href="#label-Grid+Container">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The grid defaults to the full width of the available space. To contain it
horizontally use the <code>grid-container</code> class. The container will
be centered and have a max-width equal to your <code>$grid-container</code>
setting (1200px by default), along with padding on the left/right equal to
half your <code>$grid-container-padding</code> setting.</p>
...
<h3 id="label-Grid+Container+Fluid">Grid Container Fluid<span><a href="#label-Grid+Container+Fluid">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To stretch the content to the full width of the available space, simply add
the class <code>fluid</code> to your <code>grid-container</code>.</p>

<pre>&lt;div class=&quot;grid-container fluid&quot;&gt;
  &lt;div class=&quot;grid-x grid-margin-x&quot;&gt;
    &lt;div class=&quot;cell small-4&quot;&gt;cell&lt;/div&gt;
    &lt;div class=&quot;cell small-4&quot;&gt;cell&lt;/div&gt;
    &lt;div class=&quot;cell small-4&quot;&gt;cell&lt;/div&gt;
...
<h3 id="label-Grid+Container+Full">Grid Container Full<span><a href="#label-Grid+Container+Full">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To stretch the content to the full width of the available space and remove
grid container padding, simply add the class <code>full</code> to your
<code>grid-container</code>. Note that this variation is primarily for use
for the <code>grid-margin-x</code> - it works with
<code>grid-padding-x</code> too, but will work the same as
<code>.grid-container.fluid</code>.</p>
...
<pre>&lt;div class=&quot;grid-container full&quot;&gt;
  &lt;div class=&quot;grid-x grid-margin-x&quot;&gt;
    &lt;div class=&quot;cell small-4&quot;&gt;cell&lt;/div&gt;
    &lt;div class=&quot;cell small-4&quot;&gt;cell&lt;/div&gt;
    &lt;div class=&quot;cell small-4&quot;&gt;cell&lt;/div&gt;
...
<h2 id="label-Auto+Sizing">Auto Sizing<span><a href="#label-Auto+Sizing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If the class <code>.auto</code> or <code>.[size]-auto</code> is added to
the cell, it will take up the remaining space.</p>
...
<p>A cell can also be made to <em>shrink</em>, by adding the
<code>.shrink</code> or <code>.[size]-shrink</code> class. This means it
will only take up the space its contents need.</p>
...
<h2 id="label-Responsive+Adjustments">Responsive Adjustments<span><a href="#label-Responsive+Adjustments">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To switch back to the auto behavior from a percentage or shrink behavior,
use the classes <code>.[size]-auto</code> or <code>.[size]-shrink</code>.
In the below example, the cells stack on small screens, and become
even-width on large screens.</p>
...
<h2 id="label-Collapse+Cells+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">Collapse Cells &lt;span class=“label secondary”&gt;X Grid only&lt;/span&gt;<span><a href="#label-Collapse+Cells+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The <code>.[size]-[gutter-type]-collapse</code> class lets you remove cell
gutters.</p>

<p>There are times when you won&#39;t want each media query to be collapsed.
In this case, use the media query size you want and collapse and add that
to your grid element. Example shows gutters at small and no gutters on
medium and up.</p>

<pre>&lt;div class=&quot;grid-x grid-margin-x medium-margin-collapse&quot;&gt;
...
<h2 id="label-Offsets+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">Offsets &lt;span class=“label secondary”&gt;X Grid only&lt;/span&gt;<span><a href="#label-Offsets+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Offsets work by applying <code>margin-left</code> to a grid.</p>
...
<h2 id="label-Block+Grids+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">Block Grids &lt;span class=“label secondary”&gt;X Grid only&lt;/span&gt;<span><a href="#label-Block+Grids+-3Cspan+class-3D-22label+secondary-22-3EX+Grid+only-3C-2Fspan-3E">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To define cell widths within a direction-level, instead of the individual
cell level, add the class <code>.[size]-up-[n]</code> to a
<code>grid-x</code>, where <code>[n]</code> is the number of cells to
display per direction, and <code>[size]</code> is the breakpoint at which
to apply the effect.</p>
<div class="callout primary">This example uses padding grid but this can be used with margin grid too.</div><div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;grid-x grid-padding-x small-up-2 medium-up-4 large-up-6&quot;&gt;
...
<p>Block Grids are not available for the vertical grids. Use the <a
href="#vertical-grids">basic layout</a> with a size applied on each cell of
the grid instead.</p>
<hr>

<h2 id="label-Looking+for+Push-2FPull-3F">Looking for Push/Pull?<span><a href="#label-Looking+for+Push-2FPull-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Push and pull are a bit of a hack solution and was only necessary for Float
based grids. But for flexbox, this hack is not needed as <a
href="flexbox-utilities.html#source-ordering">source ordering</a> does this
with ease.</p>
<hr>

<h2 id="label-Vertical+Grids">Vertical Grids<span><a href="#label-Vertical+Grids">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The XY grid also supports vertical grids. Simply apply <code>.grid-y</code>
instead of <code>.grid-x</code>. The internal cells will shift
automatically to provide spacing vertically rather than horizontally.</p>

<p>You can also apply margin or padding with <code>.grid-margin-y</code> and
<code>.grid-padding-y</code> to apply spacing to the top and bottom of
cells.</p>
<p>
...
</div><div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;grid-y&quot; style=&quot;height: 500px;&quot;&gt;
...
<h2 id="label-Grid+Frame">Grid Frame<span><a href="#label-Grid+Frame">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The XY grid incorporates the grid frame from Foundation for Apps plus many
other useful features. To start, add <code>.grid-frame</code> to the grid.
This sets the grid to be 100vh (the full height of the browser window).</p>
...
<pre>&lt;div class=&quot;grid-y medium-grid-frame&quot;&gt;
...
<h2 id="label-Building+Semantically">Building Semantically<span><a href="#label-Building+Semantically">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>XY grid CSS is generated with a powerful set of Sass mixins, which you can
use in your own code to build a semantic grid.</p>

<h3 id="label-Grid+Container">Grid Container<span><a href="#label-Grid+Container">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>xy-grid-container()</code> mixin to create a grid container.
This contains the grid to the width specified in
<code>$grid-container</code>.</p>
...
<h3 id="label-Grids">Grids<span><a href="#label-Grids">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>xy-grid()</code> mixin to create a grid.</p>
...
<h3 id="label-Gutters">Gutters<span><a href="#label-Gutters">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>xy-gutters()</code> mixin to add gutters to an item. The
<code>xy-cell</code> mixin used this to output gutters, but you can use
this to add responsive gutters to anything you like. This is especially
powerful as you can specify where you want the gutters, like so:</p>
...
<h3 id="label-Cells">Cells<span><a href="#label-Cells">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>xy-cell()</code> mixin to create a cell. There are a number
of ways to define the size of a cell. <code>xy-cell</code> accepts a few
different keywords as well as specific sizes: <code>full</code> (full
width), <code>auto</code> (automatic width) and <code>shrink</code> (take
up only the space it needs).</p>
...
<p>The cell size calculator can also be accessed as a function. This gives you
the percentage value, without any of the grid cell CSS.</p>
...
<h3 id="label-Responsive+Grids">Responsive Grids<span><a href="#label-Responsive+Grids">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Pair <code>xy-cell</code> with the <code>breakpoint()</code> mixin to make
your grid responsive. Refer to the Sass documentation below to learn how
each mixin works and the available arguments.</p>
...
<h3 id="label-Custom+Block+Grid">Custom Block Grid<span><a href="#label-Custom+Block+Grid">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use the <code>xy-grid-layout()</code> mixin to create your own block grid.
By default the mixin takes 2 parameters: - number of columns - child
selector</p>

<p>Refer to the Sass documentation <a href="#xy-grid-layout">below</a> for the
...
<p>That outputs this CSS:</p>

<pre>.gallery &gt; .gallery-item {
