...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Installing+Foundation">Installing Foundation</a>
    <li><a href="#label-New+to+Foundation+for+Sites-3F">New to Foundation for Sites?</a>
    <li><a href="#label-Experienced+with+Foundation+for+Sites-3F">Experienced with Foundation for Sites?</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/index.md">

<p>— title: Welcome to Foundation 6 description: We built Foundation for Sites
to be the most advanced responsive front-end framework in the world. tags: 
- index  - home</p>

<p>video-hero: true</p>
<hr>

<h2 id="label-Installing+Foundation">Installing Foundation<span><a href="#label-Installing+Foundation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>There are a number of ways to install Foundation for Sites. Our
installation page will help you find the best option for you.</p>
<a href="installation.html" class="large button">Install Foundation for Sites</a><hr>

<h2 id="label-New+to+Foundation+for+Sites-3F">New to Foundation for Sites?<span><a href="#label-New+to+Foundation+for+Sites-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>With an easy to understand syntax and consistent structure, you&#39;ll
learn your way around Foundation in no time!</p>
...
<h2 id="label-Experienced+with+Foundation+for+Sites-3F">Experienced with Foundation for Sites?<span><a href="#label-Experienced+with+Foundation+for+Sites-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>
