...
<title>prototyping-utilities - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+scss-2Fprototype-2F-2A.scss"> - scss/prototype/*.scss</a>
    <li><a href="#label-Prototype+mode+is+disabled+by+default-21">Prototype mode is <strong>disabled by default!</strong></a>
    <li><a href="#label-Enabling+Prototype+Mode">Enabling Prototype Mode</a>
    <li><a href="#label-Responsive+breakpoints">Responsive breakpoints</a>
    <li><a href="#label-Component+Styling">Component Styling</a>
    <li><a href="#label-Buttons">Buttons</a>
    <li><a href="#label-Switches">Switches</a>
    <li><a href="#label-Cards">Cards</a>
    <li><a href="#label-Tables">Tables</a>
    <li><a href="#label-Images">Images</a>
    <li><a href="#label-Arrow+Utility">Arrow Utility</a>
    <li><a href="#label-Separator">Separator</a>
    <li><a href="#label-Font+Styling">Font Styling</a>
    <li><a href="#label-List+Styling">List Styling</a>
    <li><a href="#label-Unordered+Lists">Unordered Lists</a>
    <li><a href="#label-Ordered+Lists">Ordered Lists</a>
    <li><a href="#label-Text+Helpers">Text Helpers</a>
    <li><a href="#label-Image+Replacement+-28Text+Hide-29">Image Replacement (Text Hide)</a>
    <li><a href="#label-Text+Transformation">Text Transformation</a>
    <li><a href="#label-Text+Decoration">Text Decoration</a>
    <li><a href="#label-Text+Truncate">Text Truncate</a>
    <li><a href="#label-Text+No-wrap">Text No-wrap</a>
    <li><a href="#label-Text+Wrap">Text Wrap</a>
    <li><a href="#label-Margin+Helpers">Margin Helpers</a>
    <li><a href="#label-Margin+-28All+Sides-29">Margin (All Sides)</a>
    <li><a href="#label-Margin+Top">Margin Top</a>
    <li><a href="#label-Margin+Bottom">Margin Bottom</a>
    <li><a href="#label-Margin+Left">Margin Left</a>
    <li><a href="#label-Margin+Right">Margin Right</a>
    <li><a href="#label-Margin+Left+Right+-28Horizontal+Axis-29">Margin Left Right (Horizontal Axis)</a>
    <li><a href="#label-Margin+Top+Bottom+-28Vertical+Axis-29">Margin Top Bottom (Vertical Axis)</a>
    <li><a href="#label-Margin-3A+Usage+as+a+Mixin">Margin: Usage as a Mixin</a>
    <li><a href="#label-Padding+Helpers">Padding Helpers</a>
    <li><a href="#label-Padding+-28All+Sides-29">Padding (All Sides)</a>
    <li><a href="#label-Padding+Top">Padding Top</a>
    <li><a href="#label-Padding+Bottom">Padding Bottom</a>
    <li><a href="#label-Padding+Left">Padding Left</a>
    <li><a href="#label-Padding+Right">Padding Right</a>
    <li><a href="#label-Padding+Left+Right+-28Horizontal+Axis-29">Padding Left Right (Horizontal Axis)</a>
    <li><a href="#label-Padding+Top+Bottom+-28Vertical+Axis-29">Padding Top Bottom (Vertical Axis)</a>
    <li><a href="#label-Padding-3A+Usage+as+a+Mixin">Padding: Usage as a Mixin</a>
    <li><a href="#label-Sizing">Sizing</a>
    <li><a href="#label-Width">Width</a>
    <li><a href="#label-Height">Height</a>
    <li><a href="#label-Border+box">Border box</a>
    <li><a href="#label-Border+none">Border none</a>
    <li><a href="#label-Display+Classes">Display Classes</a>
    <li><a href="#label-Positioning">Positioning</a>
    <li><a href="#label-Positioning-3A+Usage+as+a+Mixin">Positioning: Usage as a Mixin</a>
    <li><a href="#label-Overflow">Overflow</a>
    <li><a href="#label-All+sides">All sides</a>
    <li><a href="#label-Horizontal+Axis">Horizontal Axis</a>
    <li><a href="#label-Vertical+Axis">Vertical Axis</a>
    <li><a href="#label-Sass+Mixin+Helpers">Sass Mixin Helpers</a>
    <li><a href="#label-Box+Mixin">Box Mixin</a>
    <li><a href="#label-Rotate+Mixin">Rotate Mixin</a>
    <li><a href="#label-Relational+Mixins+-28AKA-3A+nth-3Achild+mixins-29">Relational Mixins (AKA: nth:child mixins)</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/prototyping-utilities.md">

<p>— title: Prototyping Utilities description: Quickly prototype layouts and
UI with Foundation&#39;s Prototyping Utilities. These optional classes and
mixins are great for quickly turning sketches and mockups into coded
prototypes. video: Xhc_KUJMEuk sass:</p>

<h2 id="label-+-+scss-2Fprototype-2F-2A.scss"> - scss/prototype/*.scss<span><a href="#label-+-+scss-2Fprototype-2F-2A.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>
<h4><strong>Prototype to Production</strong></h4>
<p>Prototyping allows us to see problems more clearly—and often earlier—in the
development process. Designs in sketches or wireframes only get us so far
in understanding the behavior, feasibility, and cost (time or resources) of
implementation. Prototyping processes foster collaboration where designers
and developers work closely together find better solutions.</p>

<p>Sometimes prototype code is meant to be thrown away, and that&#39;s ok.
While in early stage development it&#39;s extremely valuable to get ideas
and interactions up and shared with stakeholders for scrutiny. This is how
ideas get fleshed out and improved. It&#39;s not code we&#39;re delivering,
it&#39;s a solution to a problem. Get the idea out, get feedback, iterate,
repeat. Then when all parties are satisfied the right approach is being
taken, go back to clean it up and refactor.</p>

<p>Foundation&#39;s Prototyping Utilities help you build coded prototypes from
scratch ultra-fast. This allows you to get to right answer faster through
feedback and experimentation. From positioning to visual styles, there are
a range of utilities to choose from. Every Utility has a mixin, so you can
use your own custom classes or swap classes for mixins in production for
cleaner markup.</p>

<h4 id="label-Prototype+mode+is+disabled+by+default-21">Prototype mode is <strong>disabled by default!</strong><span><a href="#label-Prototype+mode+is+disabled+by+default-21">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Not all projects require Prototyping Utilities and adding utility classes
like these increase your CSS file size especially if you&#39;re not using
all of them. For these reasons Prototype mode is <em>disabled by
default</em>.</p>
...
<h2 id="label-Enabling+Prototype+Mode">Enabling Prototype Mode<span><a href="#label-Enabling+Prototype+Mode">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>If you&#39;re using the CSS version of Foundation, you can generate a &lt;a
href=“<a
href="https://foundation.zurb.com/sites/download">custom”>foundation.zurb.com/sites/download“>custom</a>
download of Foundation&lt;/a&gt; with prototype mode enabled. If you&#39;re
using the Sass version of Foundation, you can enable prototype mode in two
ways:</p>

<p>If you use the <code>foundation-everything()</code> mixin in your main Sass
file, just pass in <code>$prototype: true</code> to enable the prototype
mode.</p>

<pre>@include foundation-everything($prototype: true);</pre>

<p>If you included each component manually (like our starter projects do),
open up your <code>app.scss</code> file and simply comment in:</p>

<pre>// @include foundation-prototype-classes;</pre>

<p>So it will look like:</p>

<pre>@include foundation-prototype-classes;</pre>

<p>You can instead import only the specific utility classes that you need. To
make it easy, the full list is included below:</p>

<pre>@include foundation-prototype-typescale;
...
@include foundation-prototype-spacing;</pre>

<p>Looking for more customization? Click here for the <a
href="#sass-reference">Sass Reference</a></p>
<hr>

<h2 id="label-Responsive+breakpoints">Responsive breakpoints<span><a href="#label-Responsive+breakpoints">&para;</a> <a href="#top">&uarr;</a></span></h2>
<div class="alert callout">
  <p>Responsive breakpoints is disabled by default.</p>
</div>
<p>These prototype classes also have an optional mobile first responsive
classes so that setting a class will apply to the small breakpoint and
large unless overridden by a class for a larger breakpoint. <br> You can
easily enable these classes by setting
<code>$global-prototype-breakpoints</code> to <code>true</code>.</p>

<pre>&lt;p class=&quot;medium-text-uppercase&quot;&gt;This text will be uppercase for medium and up.&lt;/p&gt;
&lt;p class=&quot;large-text-lowercase&quot;&gt;This text will be lowercase for large breakpoint.&lt;/p&gt;</pre>

<p>You can also customise things by choosing to add responsive breakpoints
only for specific prototype helpers that you would need as responsive
classes. <br> For example, text transformation classes have a breakpoint
variable <code>$prototype-transformation-breakpoints</code> which is set to
<code>$global-prototype-breakpoints</code> which is set to
<code>false</code> by default. For enabling responsive breakpoints for text
transformation classes, simply set:</p>

<pre>$prototype-transformation-breakpoints: true;</pre>
<hr>

<h2 id="label-Component+Styling">Component Styling<span><a href="#label-Component+Styling">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>These <code>.radius</code>, <code>.rounded</code>, <code>.bordered</code>
&amp; <code>.shadow</code> classes can be used independently or together to
style the component by rounding its corners, giving light borders, and
creating shadow to it respectively. Mostly used in buttons, cards, tables,
images and many more.</p>
<div class="primary callout">
...
<h4 id="label-Buttons">Buttons<span><a href="#label-Buttons">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;button type=&quot;button&quot; class=&quot;button radius bordered shadow primary&quot;&gt;Primary&lt;/button&gt;
...
&lt;button type=&quot;button&quot; class=&quot;button radius bordered shadow warning&quot;&gt;Warning&lt;/button&gt;</pre>

<h4 id="label-Switches">Switches<span><a href="#label-Switches">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Please note that you need to add <code>rounded</code> class with
<code>switch-paddle</code> and not <code>switch</code>.</p>

<pre>&lt;div class=&quot;switch&quot;&gt;
...
<pre>&lt;div class=&quot;radius bordered shadow card&quot;&gt;
...
<h4 id="label-Tables">Tables<span><a href="#label-Tables">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;table class=&quot;radius bordered shadow&quot;&gt;
        &lt;!-- My Table goes here --&gt;
&lt;/table&gt;</pre>
<div class="docs-code-live">
...
<h4 id="label-Images">Images<span><a href="#label-Images">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;img src=&quot;https://placehold.it/150x150&quot; class=&quot;radius&quot;&gt;</pre>
<div class="docs-code-live margin-bottom-1">
        <img src="https://placehold.it/150x150" class="radius">
</div><hr>

<h2 id="label-Arrow+Utility">Arrow Utility<span><a href="#label-Arrow+Utility">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Mostly used as dropdown arrows for navigation.</p>

<pre>&lt;div class=&quot;arrow-down&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;arrow-up&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;arrow-right&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;arrow-left&quot;&gt;&lt;/div&gt;</pre>
<div class="arrow-down display-inline-block margin-right-1"></div><div class="arrow-up display-inline-block margin-right-1"></div><div class="arrow-right display-inline-block margin-right-1"></div><div class="arrow-left display-inline-block"></div><hr>

<h2 id="label-Separator">Separator<span><a href="#label-Separator">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>This creates a tiny separator below the heading of an element and is
usually used within the heading of a section.</p>
<div class="primary callout">
...
<pre>&lt;h3 class=&quot;separator-left&quot;&gt;Lorem&lt;/h3&gt;
&lt;h3 class=&quot;separator-center&quot;&gt;Ipsum Dolor&lt;/h3&gt;
&lt;h3 class=&quot;separator-right&quot;&gt;Tempor&lt;/h3&gt;</pre>
<div class="docs-code-live">
        <div class="grid-x grid-margin-x">
...
<h2 id="label-Font+Styling">Font Styling<span><a href="#label-Font+Styling">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can use font styling to style your text. You can change the font
styling by adding <code>font-normal</code>, <code>font-bold</code>,
<code>font-italic</code> to an element. You can also wider the text of an
element with <code>font-wide</code>.</p>

<pre>&lt;p class=&quot;font-wide&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit.&lt;/p&gt;
...
&lt;p class=&quot;font-italic&quot;&gt;Lorem minus, placeat, cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.iure voluptas aliquam tempora neque?&lt;/p&gt;</pre>
<hr>

<h2 id="label-List+Styling">List Styling<span><a href="#label-List+Styling">&para;</a> <a href="#top">&uarr;</a></span></h2>
<div class="primary callout">
...
<h4 id="label-Unordered+Lists">Unordered Lists<span><a href="#label-Unordered+Lists">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;ul class=&quot;no-bullet&quot;&gt;&lt;/ul&gt;
&lt;ul class=&quot;list-disc&quot;&gt;&lt;/ul&gt;
&lt;ul class=&quot;list-circle&quot;&gt;&lt;/ul&gt;
&lt;ul class=&quot;list-square&quot;&gt;&lt;/ul&gt;</pre>

<h4 id="label-Ordered+Lists">Ordered Lists<span><a href="#label-Ordered+Lists">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;ol class=&quot;no-bullet&quot;&gt;&lt;/ol&gt;
...
&lt;ol class=&quot;list-upper-roman&quot;&gt;&lt;/ol&gt;</pre>
<hr>

<h2 id="label-Text+Helpers">Text Helpers<span><a href="#label-Text+Helpers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Image+Replacement+-28Text+Hide-29">Image Replacement (Text Hide)<span><a href="#label-Image+Replacement+-28Text+Hide-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>You can include an image with visually hidden helper text for the sake of
accessibility and improving SEO. The <code>.text-hide</code> class will
visually hide an element’s text within the context of an image.</p>

<pre>&lt;a href=&quot;#&quot; class=&quot;text-hide&quot;&gt;
...
<h3 id="label-Text+Transformation">Text Transformation<span><a href="#label-Text+Transformation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Text transformation lets you control the capitalization of text. You can
change the text transformation by adding <code>.text-uppercase</code>,
<code>text-lowercase</code>, <code>text-capitalize</code> to an element.</p>

<pre>&lt;p class=&quot;text-uppercase&quot;&gt;&lt;!-- Text here --&gt;&lt;/p&gt;
&lt;p class=&quot;text-lowercase&quot;&gt;&lt;!-- Text here --&gt;&lt;/p&gt;
&lt;p class=&quot;text-capitalize&quot;&gt;&lt;!-- Text here --&gt;&lt;/p&gt;</pre>
<p class="text-uppercase"><strong>This is a upper-cased text.</strong> Set in the year 0 F.E. ("Foundation Era"), The Psychohistorians opens on Trantor, the capital of the 12,000-year-old Galactic Empire. Though the empire appears stable and powerful, it is slowly decaying in ways that parallel the decline of the Western Roman Empire.</p><p class="text-lowercase"><strong>This is a lower-cased text.</strong> Set in the year 0 F.E. ("Foundation Era"), The Psychohistorians opens on Trantor, the capital of the 12,000-year-old Galactic Empire. Though the empire appears stable and powerful, it is slowly decaying in ways that parallel the decline of the Western Roman Empire.</p><p class="text-capitalize"><strong>This is a caPitAlized teXt.</strong> Set in the yEar 0 F.E. ("Foundation Era"), The PsychohisTorians opens on Trantor, the capital of the 12,000-year-old Galactic Empire. Though the empire appears stable and powerful, it is slowly decaying in ways that parallel the decline of the Western Roman Empire.</p><div class="callout primary">
...
<h3 id="label-Text+Decoration">Text Decoration<span><a href="#label-Text+Decoration">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Text Decoration can be used to underline, overline, or line-through a text.
You can change the text decoration by adding <code>.text-underline</code>,
<code>.text-overline</code>, or <code>.text-line-through</code> to an
element.</p>

<pre>&lt;p class=&quot;text-underline&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. &lt;/p&gt;
&lt;p class=&quot;text-overline&quot;&gt;Perspiciatis tempore cumque, magni aspernatur, quidem&lt;/p&gt;
&lt;p class=&quot;text-line-through&quot;&gt;Lorem minus, placeat, iure voluptas aliquam tempora neque?&lt;/p&gt;</pre>
<hr>

<h3 id="label-Text+Truncate">Text Truncate<span><a href="#label-Text+Truncate">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The <code>.text-truncate</code> class will truncate your text and display
an elipsis. This class works for a single line of text.</p>

<pre>&lt;p class=&quot;text-truncate&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam voluptatem similique officiis recusandae esse cum in totam quisquam perspiciatis quod! Magnam culpa vitae, tempore eos explicabo cupiditate. Deserunt, quisquam, quos!&lt;/p&gt;</pre>
<hr>

<h3 id="label-Text+No-wrap">Text No-wrap<span><a href="#label-Text+No-wrap">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you would like to prevent the text wrapping into the next line you can
utilize <code>.text-nowrap</code>. Please note that the text will continue
to be in same line unless the <code><br></code> tag is used.</p>

<pre>&lt;p class=&quot;text-nowrap&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam voluptatem similique officiis recusandae esse cum in totam quisquam perspiciatis quod! Magnam culpa vitae, tempore eos explicabo cupiditate. Deserunt, quisquam, quos!&lt;/p&gt;</pre>

<h3 id="label-Text+Wrap">Text Wrap<span><a href="#label-Text+Wrap">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To force text to wrap to the next line, you can use
<code>.text-wrap</code>.</p>

<pre>&lt;p class=&quot;text-wrap&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam voluptatem similique officiis recusandae esse cum in totam quisquam perspiciatis quod! Magnam culpa vitae, tempore eos explicabo cupiditate. Deserunt, quisquam, quos!&lt;/p&gt;</pre>
<hr>

<h2 id="label-Margin+Helpers">Margin Helpers<span><a href="#label-Margin+Helpers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Generate spacing around elements with these easy to use margin classes.</p>
<div class="primary callout">
...
<h4 id="label-Margin+-28All+Sides-29">Margin (All Sides)<span><a href="#label-Margin+-28All+Sides-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin+Top">Margin Top<span><a href="#label-Margin+Top">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-top-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-top-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-top-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-top-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin+Bottom">Margin Bottom<span><a href="#label-Margin+Bottom">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-bottom-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-bottom-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-bottom-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-bottom-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin+Left">Margin Left<span><a href="#label-Margin+Left">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-left-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-left-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-left-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-left-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin+Right">Margin Right<span><a href="#label-Margin+Right">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-right-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-right-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-right-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-right-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin+Left+Right+-28Horizontal+Axis-29">Margin Left Right (Horizontal Axis)<span><a href="#label-Margin+Left+Right+-28Horizontal+Axis-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-horizontal-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-horizontal-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-horizontal-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-horizontal-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin+Top+Bottom+-28Vertical+Axis-29">Margin Top Bottom (Vertical Axis)<span><a href="#label-Margin+Top+Bottom+-28Vertical+Axis-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;margin-vertical-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-vertical-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-vertical-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;margin-vertical-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Margin-3A+Usage+as+a+Mixin">Margin: Usage as a Mixin<span><a href="#label-Margin-3A+Usage+as+a+Mixin">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>.foo {
  @include margin(1, 0, 2, null);
}</pre>

<p>This above code will generate the below output</p>
...
<p>Note: The <code>margin-left</code> property wasn&#39;t printed as this
mixin also accept <code>null</code> as a value to reduce CSS output. <a
href="#margin">See Sass Reference here</a></p>
<hr>

<h2 id="label-Padding+Helpers">Padding Helpers<span><a href="#label-Padding+Helpers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Generate spaces around the content with these easy to use padding classes.</p>
<div class="primary callout">
...
<h4 id="label-Padding+-28All+Sides-29">Padding (All Sides)<span><a href="#label-Padding+-28All+Sides-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding+Top">Padding Top<span><a href="#label-Padding+Top">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-top-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-top-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-top-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-top-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding+Bottom">Padding Bottom<span><a href="#label-Padding+Bottom">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-bottom-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-bottom-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-bottom-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-bottom-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding+Left">Padding Left<span><a href="#label-Padding+Left">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-left-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-left-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-left-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-left-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding+Right">Padding Right<span><a href="#label-Padding+Right">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-right-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-right-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-right-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-right-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding+Left+Right+-28Horizontal+Axis-29">Padding Left Right (Horizontal Axis)<span><a href="#label-Padding+Left+Right+-28Horizontal+Axis-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-horizontal-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-horizontal-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-horizontal-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-horizontal-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding+Top+Bottom+-28Vertical+Axis-29">Padding Top Bottom (Vertical Axis)<span><a href="#label-Padding+Top+Bottom+-28Vertical+Axis-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;padding-vertical-0&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-vertical-1&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-vertical-2&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;padding-vertical-3&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Padding-3A+Usage+as+a+Mixin">Padding: Usage as a Mixin<span><a href="#label-Padding-3A+Usage+as+a+Mixin">&para;</a> <a href="#top">&uarr;</a></span></h4>
...
<p>Note: The <code>padding-left</code> property wasn&#39;t printed as this
mixin also accept <code>null</code> as a value to reduce CSS output. <a
href="#padding">See Sass Reference here</a></p>
<hr>

<h2 id="label-Sizing">Sizing<span><a href="#label-Sizing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>These width and height classes help you to easily make an element as wide
or as tall as needed relative to its parent. By default it supports
<code>25%</code>, <code>50%</code>, <code>75%</code> and <code>100%</code>.
You can add more sizes though, through Sass map variable.</p>

<h4 id="label-Width">Width<span><a href="#label-Width">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;width-25&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;width-50&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;width-75&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;width-100&quot;&gt;&lt;/div&gt;

&lt;div class=&quot;max-width-100&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Height">Height<span><a href="#label-Height">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;height-25&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;height-50&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;height-75&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;height-100&quot;&gt;&lt;/div&gt;

&lt;div class=&quot;max-height-100&quot;&gt;&lt;/div&gt;</pre>
<hr>

<h2 id="label-Border+box">Border box<span><a href="#label-Border+box">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Border box lets you only add the content, padding and border, but not the
margin within the width and height CSS properties.</p>

<pre>&lt;div class=&quot;border-box&quot;&gt;&lt;/div&gt;</pre>
<hr>

<h2 id="label-Border+none">Border none<span><a href="#label-Border+none">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Border none lets you quickly resets border to <code>none</code> for any
element.</p>

<pre>&lt;div class=&quot;callout primary border-none&quot;&gt;
  Hi! I am a callout with no Borders
&lt;/div&gt;</pre>
<hr>

<h2 id="label-Display+Classes">Display Classes<span><a href="#label-Display+Classes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Display classes allow you to change the display property of any element.</p>

<pre>&lt;div class=&quot;display-inline&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;display-inline-block&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;display-block&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;display-table&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;display-table-cell&quot;&gt;&lt;/div&gt;</pre>

<p>These cover some of the most used display types. There are many other
display values as specified by MDN <a
href="https://developer.mozilla.org/en-US/docs/Web/CSS/display">here</a>.
If you need some of those classes, then you can add them easily through
Sass variables with <code>$prototype-display</code>. Sass Reference <a
href="#sass-reference">here</a></p>
<div class="primary callout">
  <ul>
...
<h2 id="label-Positioning">Positioning<span><a href="#label-Positioning">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Positioning classes help you change an element&#39;s position value. By
default, an element&#39;s postion value is <code>static</code>.</p>

<pre>&lt;div class=&quot;position-relative&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;position-absolute&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;position-fixed&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;position-fixed-top&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;position-fixed-bottom&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;position-static&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Positioning-3A+Usage+as+a+Mixin">Positioning: Usage as a Mixin<span><a href="#label-Positioning-3A+Usage+as+a+Mixin">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>The position mixin can be used to set a position and to set the
<code>top</code> <code>right</code> <code>bottom</code> and/or
<code>left</code> property all in one.</p>
...
<p>See how the <code>left</code> offset wasn&#39;t printed as this mixin also
accepts <code>null</code> as a value. Sass Reference <a
href="#position">here</a></p>
<hr>

<h2 id="label-Overflow">Overflow<span><a href="#label-Overflow">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>These overflow classes helps you to clip content, render scrollbars or
simply just display the content when it overflows its block level
container.</p>

<h4 id="label-All+sides">All sides<span><a href="#label-All+sides">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;overflow-visible&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;overflow-hidden&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;overflow-scroll&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Horizontal+Axis">Horizontal Axis<span><a href="#label-Horizontal+Axis">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;overflow-x-visible&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;overflow-x-hidden&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;overflow-x-scroll&quot;&gt;&lt;/div&gt;</pre>

<h4 id="label-Vertical+Axis">Vertical Axis<span><a href="#label-Vertical+Axis">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;div class=&quot;overflow-y-visible&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;overflow-y-hidden&quot;&gt;&lt;/div&gt;
&lt;div class=&quot;overflow-y-scroll&quot;&gt;&lt;/div&gt;</pre>

<p>Note: Combining <code>overflow: hidden</code> in either the X or Y
direction with the <code>overflow: visible</code> in the opposite direction
does not work as expected in CSS spec. <a
href="https://stackoverflow.com/questions/6421966/css-overflow-x-visible-and-overflow-y-hidden-causing-scrollbar-issue#answer-6433475">More
info</a></p>
<hr>

<h2 id="label-Sass+Mixin+Helpers">Sass Mixin Helpers<span><a href="#label-Sass+Mixin+Helpers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>We also provides some extra utility mixins that you can use for your next
prototype project.</p>

<h3 id="label-Box+Mixin">Box Mixin<span><a href="#label-Box+Mixin">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>This mixin helps you to easily create a square, rectangle or a circle. Sass
Reference <a href="#box">here</a></p>
...
<h3 id="label-Rotate+Mixin">Rotate Mixin<span><a href="#label-Rotate+Mixin">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>These Rotate mixins lets you rotate an element to a certain degree.
Clockwise is the default direction but adding a <code>-</code> in front of
the degrees will make it counter-clockwise.</p>
...
<h3 id="label-Relational+Mixins+-28AKA-3A+nth-3Achild+mixins-29">Relational Mixins (AKA: nth:child mixins)<span><a href="#label-Relational+Mixins+-28AKA-3A+nth-3Achild+mixins-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>These relational mixins helps you to manage styling of :nth-child’ified
elements through easy Sass mixins.</p>

<pre>@include first($num) {} // applies style to first n children
...
@include number-between($num, $first, $last) {} // applies style to every n children from first child and last child</pre>
</main>
