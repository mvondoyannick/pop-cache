...
<title>global - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-sass-3A+scss-2F_global.scss">sass: scss/_global.scss</a>
    <li><a href="#label-Font+Sizing">Font Sizing</a>
    <li><a href="#label-Colors">Colors</a>
    <li><a href="#label-Changing+the+Color+Palette">Changing the Color Palette</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/global.md">

<p>— title: Global Styles description: Our global CSS includes helpful resets
to ensure consistent styling across browsers. video: &#39;nEgHk2wmMjU&#39;</p>

<h2 id="label-sass-3A+scss-2F_global.scss">sass: scss/_global.scss<span><a href="#label-sass-3A+scss-2F_global.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Font+Sizing">Font Sizing<span><a href="#label-Font+Sizing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The default font size is set to 100% of the browser style sheet, usually 16
pixels. This ensures compatibility with browser-based text zoom or user-set
defaults. If you&#39;re using the Sass version of Foundation, edit the
<code>$global-font-size</code> variable to change the base font size. This
can be a percentage value, or a pixel value.</p>
<hr>

<h2 id="label-Colors">Colors<span><a href="#label-Colors">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation has an accessible default color palette. The primary color is
used for interactive elements, such as links and buttons. The secondary,
success, warning, and alert colors are used to give more context to UI
...
<h3 id="label-Changing+the+Color+Palette">Changing the Color Palette<span><a href="#label-Changing+the+Color+Palette">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you&#39;re using the Sass version of Foundation, you can easily change
the color palette by editing the variables in your settings file.</p>

<p>The semantic colors (primary, secondary, success, warning, and alert) can
be changed in the <code>$foundation-palette</code> map. The keys in this
map are referenced by various settings to style components and output
alternate class names.</p>

<pre>$foundation-palette: (
  primary: #1779ba,
  secondary: #767676,
  success: #3adb76,
  warning: #ffae00,
...
<p>The named colors (white, light gray, medium gray, dark gray, and black) can
be changed in their respective variables</p>

<pre>$light-gray: #e6e6e6;
$medium-gray: #cacaca;
$dark-gray: #8a8a8a;
$black: #0a0a0a;
$white: #fefefe;</pre>

<p>The line <code>@include add-foundation-colors;</code> in your settings file
allows you to use the following Sass variables to reference <em>default
colors</em> from the palette:</p>
<ul><li>
<p><code>$primary-color</code></p>
</li><li>
<p><code>$secondary-color</code></p>
</li><li>
<p><code>$success-color</code></p>
</li><li>
<p><code>$warning-color</code></p>
</li><li>
<p><code>$alert-color</code></p>
</li></ul>

<p>You can also use Foundation&#39;s <code>get-color()</code> function to
reference <em>any color</em> from the palette. This function gives you
access to custom colors you&#39;ve added to the palette.</p>

<pre>// Create a variable for my custom color.
$custom-color: get-color(custom);</pre>
</main>
