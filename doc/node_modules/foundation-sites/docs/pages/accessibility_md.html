...
<title>accessibility - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-description-3A+Foundation+for+Sites+is+a+fully-accessible+framework.+Here+are+some+general+guidelines+to+keep+in+mind+as+you+make+your+pages+accessible.">description: Foundation for Sites is a fully-accessible framework. Here are some general guidelines to keep in mind as you make your pages accessible.</a>
    <li><a href="#label-Basic+Principles">Basic Principles</a>
    <li><a href="#label-Types+of+Disabilities">Types of Disabilities</a>
    <li><a href="#label-Visual">Visual</a>
    <li><a href="#label-Motor">Motor</a>
    <li><a href="#label-Auditory">Auditory</a>
    <li><a href="#label-Foundation+and+Accessibility">Foundation and Accessibility</a>
    <li><a href="#label-Learn+More">Learn More</a>
    <li><a href="#label-Resources">Resources</a>
    <li><a href="#label-Tools">Tools</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/accessibility.md">

<p>— title: Accessibility</p>

<h2 id="label-description-3A+Foundation+for+Sites+is+a+fully-accessible+framework.+Here+are+some+general+guidelines+to+keep+in+mind+as+you+make+your+pages+accessible.">description: Foundation for Sites is a fully-accessible framework. Here are some general guidelines to keep in mind as you make your pages accessible.<span><a href="#label-description-3A+Foundation+for+Sites+is+a+fully-accessible+framework.+Here+are+some+general+guidelines+to+keep+in+mind+as+you+make+your+pages+accessible.">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>In addition to the accessibility features built into Foundation&#39;s
components, be sure to follow best practices for making your site more
accessible.</p>
...
<h2 id="label-Basic+Principles">Basic Principles<span><a href="#label-Basic+Principles">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p><strong>Structure your document properly.</strong> Use the right HTML tags
for the job when marking up navigation, lists, links, controls, and so on.</p>
</li><li>
<p><strong>Label everything.</strong> If a control or form element has no text
label, add one. You can use the <a
href="visibility.html#accessibility">visibility classes</a> to hide labels
visually while maintaining accessibility. Use the <code>alt</code>
attribute on all images to describe what they are.</p>
</li><li>
<p><strong>Don&#39;t rely on purely visual cues.</strong> The content of a
page should make sense even if page is being read to the user, or if the
user is colorblind and can&#39;t make use of color-based labeling.</p>
</li><li>
<p><strong>Make everything usable on a keyboard and mouse.</strong> Lucky for
you, all of our components work with keyboards, mice, and touch screens out
of the box.</p>
</li></ul>
<hr>

<h2 id="label-Types+of+Disabilities">Types of Disabilities<span><a href="#label-Types+of+Disabilities">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Visual">Visual<span><a href="#label-Visual">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Visually-impaired users may have low vision or be completely blind. For low
vision users, proper typographic contrast is important, both size and
color. Foreground colors should stand out from background colors. You can
use tools to calculate the contrast ratio of your foreground and background
colors. The contrast ratio should at least be 1:4.5 for normal text and 3:1
for large text. Blind users consume the web by reading it using a <a
href="https://en.wikipedia.org/wiki/Screen_reader">screen reader</a>.
Screen readers read the content of a web page out loud, or write it out as
Braille, using certain cues from the HTML to infer meaning.</p>

<h3 id="label-Motor">Motor<span><a href="#label-Motor">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Users with motor disabilities may have trouble using a mouse, or don&#39;t
use a mouse at all. For this reason, it&#39;s very important that your site
is fully keyboard-accessible. Visually-impaired users also typically
navigate websites using only their keyboard.</p>

<p>When using only the keyboard, the &lt;kbd&gt;tab&lt;/kbd&gt; key is the
primary way to navigate through a page. However, most screen readers
include many shortcut keys to skip around a page. For example, a screen
reader can read every heading on a page, or every link, making it easier to
find the right content on the page.</p>

<p>More complex components like menus, tabs, or sliders can also typically be
used with arrow keys, not just the &lt;kbd&gt;tab&lt;/kbd&gt; keys. All of
our JavaScript plugins provide advanced keyboard support by default.</p>

<h3 id="label-Auditory">Auditory<span><a href="#label-Auditory">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If your site has video, provide captions so that users who are deaf or
hard-of-hearing can properly view the content.</p>
<hr>

<h2 id="label-Foundation+and+Accessibility">Foundation and Accessibility<span><a href="#label-Foundation+and+Accessibility">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>All of Foundation&#39;s components are keyboard-accessible and screen
reader-friendly. All of our code examples include the required
accessibility hooks, but there may be instances where you, as the
developer, need to fine-tune the specifics of how those hooks are used. Our
JavaScript plugins will automatically add many required attributes to the
HTML for you. Refer to each component&#39;s documentation to learn how to
ensure your markup is screen reader-friendly.</p>

<p>Foundation&#39;s CSS makes use of the library <a
href="https://github.com/ten1seven/what-input">what-input</a>, which can
detect the user&#39;s current input device and adjust CSS accordingly. We
use it to disable outlines for mouse users, but not keyboard users, who
need the outline to know what element on the page has focus.</p>

<p>If you&#39;re using the Sass version of Foundation, you can use this mixin
to enable the feature on your own components:</p>
...
<h2 id="label-Learn+More">Learn More<span><a href="#label-Learn+More">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Resources">Resources<span><a href="#label-Resources">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><a href="http://www.w3.org/TR/UNDERSTANDING-WCAG20/">WCAG 2.0 Guide</a></p>
</li><li>
<p><a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility">MDN
accessibility documentation</a></p>
</li><li>
<p><a href="http://www.w3.org/WAI/intro/accessibility.php">w3.org Introduction
to Accessibility</a></p>
</li><li>
<p><a href="http://www.section508.gov/">Section 508 government
requirements</a></p>
</li><li>
<p><a href="http://webaim.org/">WebAIM certification and training</a></p>
</li><li>
<p><a href="http://a11yproject.com/checklist.html">Web Accessibility
Checklist</a></p>
</li></ul>

<h3 id="label-Tools">Tools<span><a href="#label-Tools">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><a href="https://tenon.io/index.php">Tenon accessibility checker</a></p>
</li><li>
<p><a href="http://wave.webaim.org">WAVE Chrome plugin - free accessibility
checker</a></p>
</li><li>
<p><a href="http://webaim.org/resources/contrastchecker">Color Contrast
Checker</a></p>
</li><li>
<p><a href="http://www.chromevox.com">ChromeVox screen reader plugin for
Chrome</a></p>
</li><li>
<p><a href="http://www.freedomscientific.com/Products/Blindness/Jaws">JAWS
screen reader for Windows</a></p>
</li><li>
<p><a href="http://www.nvaccess.org/download/">NVDA screen reader for Windows
- Free</a></p>
</li></ul>
</main>
