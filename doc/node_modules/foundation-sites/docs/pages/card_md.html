...
<title>card - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Card+Divider">Card Divider</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/card.md">

<p>— title: Card description: Cards are a popular and flexible UI component.
video: &#39;OMwg8UsrLrM&#39; sass: scss/components/_card.scss tags:  - card</p>
...
<p>A card is just an element with a <code>.card</code> class applied. You can
put any kind of content inside. Make sure you wrap your content in a
<code>.card-section</code> element in order to achieve the traditional card
look.</p>

<p>A card container has no padding, allowing you to place full-bleed images
inside. Use the <code>.card-divider</code> and <code>.card-section</code>
classes to sub-divide a card.</p>
<p>
...
<pre>&lt;div class=&quot;card&quot; style=&quot;width: 300px;&quot;&gt;
...
<pre>&lt;div class=&quot;card-image&quot;&gt;
  &lt;img src=&quot;assets/img/generic/rectangle-1.jpg&quot;&gt;
&lt;/div&gt;</pre>
<hr>

<h3 id="label-Card+Divider">Card Divider<span><a href="#label-Card+Divider">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>You can also include a <code>.card-divider</code> element as a title,
footer or to break up content.</p>
<p>
...
<h3 id="label-Images">Images<span><a href="#label-Images">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Images play nicely with cards. Simply include one outside of the
<code>.card-section</code> element to span nicely to the edges. Or move the
image inside the <code>.card-section</code> to have padding around the
image.</p>
<p>
...
<p>You can either set the width of cards with custom css or add them into the
Foundation grid.</p>
<p>
