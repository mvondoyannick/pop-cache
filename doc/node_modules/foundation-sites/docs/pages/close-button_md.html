...
<title>close-button - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-sass-3A+scss-2Fcomponents-2F_close-button.scss">sass: scss/components/_close-button.scss</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/close-button.md">

<p>— title: Close Button description: The humble close button can be used
anywhere you need something to go away on click. video:
&#39;0cvJbo7ItpU&#39;</p>

<h2 id="label-sass-3A+scss-2Fcomponents-2F_close-button.scss">sass: scss/components/_close-button.scss<span><a href="#label-sass-3A+scss-2Fcomponents-2F_close-button.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A close button is a <code>&lt;button&gt;</code> element with the class
<code>.close-button</code>. We use the multiplication symbol
(<code>&amp;times;</code>) as the X icon. This icon is wrapped in a
<code>&lt;span&gt;</code> with the attribute
<code>aria-hidden=&quot;true&quot;</code>, so screen readers don&#39;t read
the X icon.</p>

<p>The button is also labeled with <code>aria-label</code> to clarify what the
button&#39;s purpose is.</p>
<p>
...
<p>The below example pairs the callout with the close button component and
<code>data-closable</code> attribute to create a dismissible alert box.</p>
<a class="" data-open-video="4:24"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="docs-codepen-container">
