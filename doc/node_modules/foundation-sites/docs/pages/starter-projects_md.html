...
<title>starter-projects - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-27lFrpnk0Oo_8-27">video: &#39;lFrpnk0Oo_8&#39;</a>
    <li><a href="#label-Basic+Template">Basic Template</a>
    <li><a href="#label-Download+the+template+with+Git">Download the template with Git</a>
    <li><a href="#label-Move+to+the+project+folder-2C+and+install+dependencies">Move to the project folder, and install dependencies</a>
    <li><a href="#label-Build+the+Sass+files">Build the Sass files</a>
    <li><a href="#label-ZURB+Template">ZURB Template</a>
    <li><a href="#label-Download+the+ZURB+template+with+Git">Download the ZURB template with Git</a>
    <li><a href="#label-Move+to+the+project+folder-2C+and+install+dependencies">Move to the project folder, and install dependencies</a>
    <li><a href="#label-Build+the+project">Build the project</a>
    <li><a href="#label-Features">Features</a>
    <li><a href="#label-Tutorials">Tutorials</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/starter-projects.md">

<p>— title: Starter Projects description: We have a few starter project
templates that can be installed with the Foundation CLI. You can also
download them manually!</p>

<h2 id="label-video-3A+-27lFrpnk0Oo_8-27">video: &#39;lFrpnk0Oo_8&#39;<span><a href="#label-video-3A+-27lFrpnk0Oo_8-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Our project templates give you a solid… <em>Foundation</em> on which to
start a new project. Both templates use the <a
href="http://gulpjs.com">Gulp</a> build system to automate the process of
compiling Sass, processing JavaScript, copying files, and more.</p>

<h2 id="label-Basic+Template">Basic Template<span><a href="#label-Basic+Template">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>Our basic project template is a lot like the Sass template from Foundation
5. The project has a flat directory structure and only compiles Sass.
It&#39;s great if you want to quickly put together a simple project and
only need to use Sass.</p>

<p>You can set up a basic project through the Foundation CLI with this
command:</p>

<pre>foundation new --framework sites --template basic</pre>

<p>You can manually install the template with:  “`bash</p>

<h1 id="label-Download+the+template+with+Git">Download the template with Git<span><a href="#label-Download+the+template+with+Git">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>git clone <a
href="https://github.com/zurb/foundation-sites-template">github.com/zurb/foundation-sites-template</a>
projectname</p>

<h1 id="label-Move+to+the+project+folder-2C+and+install+dependencies">Move to the project folder, and install dependencies<span><a href="#label-Move+to+the+project+folder-2C+and+install+dependencies">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>cd projectname npm install</p>

<h1 id="label-Build+the+Sass+files">Build the Sass files<span><a href="#label-Build+the+Sass+files">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>npm start “`</p>

<p>Your project will be recompiled every time you save a Sass file in `dist/.</p>
<hr>

<h2 id="label-ZURB+Template">ZURB Template<span><a href="#label-ZURB+Template">&para;</a> <a href="#top">&uarr;</a></span></h2>
<div class="responsive-embed widescreen mb1">
...
<p>The official ZURB Template includes not only Sass processing, but also
JavaScript processing, Handlebars templating, and image compression. We use
this exact template at ZURB for our client work!</p>

<p>You can set up an advanced project through the Foundation CLI with this
command:</p>

<pre>foundation new --framework sites --template zurb</pre>

<p>You can manually install the template with: “`bash</p>

<h1 id="label-Download+the+ZURB+template+with+Git">Download the ZURB template with Git<span><a href="#label-Download+the+ZURB+template+with+Git">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>git clone <a
href="https://github.com/zurb/foundation-zurb-template">github.com/zurb/foundation-zurb-template</a>
projectname</p>
...
<h1 id="label-Build+the+project">Build the project<span><a href="#label-Build+the+project">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>npm start “`</p>

<p>Once compiled, you project is viewable at: &lt;a class=“button primary”
href=“<a href="http://localhost:8000">localhost:8000</a>”
target=“_blank”&gt;<a
href="http://localhost:8000</a">localhost:8000</a</a>&gt;</p>

<p>The biggest difference between this and the basic template is the folder
structure. In the ZURB Template, your project has a <code>src/</code>
folder which contains your source files, and a separate <code>dist/</code>
folder with your finished website. As you work on your project, Gulp
continuously updates your <code>dist/</code> folder with new versions of
files. To compile a production build, run <code>npm run build</code>.</p>

<p>To override or add to the default styles of the ZURB Template, in your
project&#39;s <code>src/assets/scss/</code> folder  - Change Sass variables
in <code>_settings.scss</code>  - Add custom SCSS and css to new files in
the <code>components</code> folder then import those files at the bottom of
<code>app.scss</code></p>

<p>The <code>_settings.scss</code> and <code>app.scss</code> files are not
changed when upgrading an existing project. As a result, you must manually
edit your <code>_settings.scss</code> file to incorporate any Sass changes
found <a href="https://github.com/zurb/foundation-sites/releases">in the
release notes</a>.</p>
...
<ul><li>
<p><strong>Asset Copying</strong></p>
</li></ul>

<p>Gulp will copy anything out of the <code>src/assets</code> folder as-is to
the <code>assets</code> folder of your final project. Note that Sass files,
JavaScript files, and images are <em>not</em> <strong>part of this copying
process, as they have their own steps.</strong></p>
<ul><li>
<p><strong>Page Compilation</strong></p>
</li></ul>

<p>The <code>src/</code> directory includes three folders used to create HTML
pages: <code>pages/</code>, <code>layouts/</code>, and
<code>partials/</code>. A flat file compiler called <a
href="panini.html">Panini</a> is used to process your project&#39;s various
pages, inserting them into a common template, and injecting any HTML
partials. This is done with a templating language called <a
href="http://handlebarsjs.com/">Handlebars</a>.</p>

<p>Panini has a dedicated page here in the docs that explains its various
features. <strong><a href="panini.html">Learn more about
Panini.</a></strong></p>
<ul><li>
<p><strong>Sass Compilation</strong></p>
</li></ul>

<p>Sass is compiled to CSS using <a
href="http://sass-lang.com/libsass">Libsass</a> (via <a
href="https://github.com/sass/node-sass">node-sass</a>). The main Sass file
is under <code>src/assets/scss/app.scss</code>, and imports Foundation and
Motion UI. Any new Sass partials you create should be in this folder as
well.</p>

<p>The CSS is output in the <code>nested</code> style, which is readable like
normal CSS. A source map is also created, which can be read by developer
tools such as the Chrome Web Inspector. When building for production, the
CSS is also compressed with <a
href="https://github.com/jakubpawlowicz/clean-css/issues">clean-css</a>,
and pruned with <a href="https://github.com/giakki/uncss">UnCSS</a>. UnCSS
scans the HTML of your pages and removes any CSS classes you didn&#39;t
use.</p>
<ul><li>
<p><strong>JavaScript Compilation</strong></p>
</li></ul>

<p>JavaScript is transpiled using <a href="https://babeljs.io">Babel</a> (with
the <a href="https://babeljs.io/docs/plugins/#es2015">es2015 plugin</a>) so
you can use <a href="https://babeljs.io/learn-es2015/">ES2015 features</a>.
The main Js file is under <code>src/assets/js/app.js</code>, and imports
Foundation, jQuery and whatInput. You can import there installed packages
and custom files, they will be included in the build.</p>

<p>A source map is created that maps back to the original files. By default,
the bundled <code>app.js</code> is uncompressed. When building for
production, the file is run through <a
href="https://github.com/mishoo/UglifyJS">UglifyJS</a> for compression.</p>

<p>The whole bundling process is handled by <a
href="https://webpack.js.org">webpack</a>: it manages all assets and
dependencies for you and compiles them into one single file. If you&#39;re
unfamiliar with imports or module bundling, check out:  * <a
href="http://2ality.com/2014/09/es6-modules-final.html">What are ES6
imports</a>  * <a
href="https://medium.com/javascript-training/beginner-s-guide-to-webpack-b1f1a3638460">Beginner’s
guide to webpack</a>  * <a
href="https://medium.freecodecamp.org/javascript-modules-a-beginner-s-guide-783f7d7a5fcc">Beginner’s
guide to JavaScript Modules</a>.</p>
<ul><li>
<p><strong>Image Compression</strong></p>
</li></ul>

<p>By default, all images are copied as-is from <code>assets/img</code> to
your <code>dist</code> folder. When building for production, images are run
through <a
href="https://github.com/sindresorhus/gulp-imagemin">gulp-imagemin</a> for
compression. The plugin supports JPEG, PNG, SVG, and GIF files.</p>
<ul><li>
<p><strong>BrowserSync</strong></p>
</li></ul>

<p>The template creates a <a href="http://www.browsersync.io/">BrowserSync</a>
server, which is at <code>http://localhost:8000</code>. Load this URL to
see your compiled templates. While the server is running, any time you save
a file, any pages you have open will automatically refresh, allowing you to
see changes in real-time as you work.</p>
<ul><li>
<p><strong>Style Guide Creation</strong></p>
</li></ul>

<p>Under <code>src/styleguide</code> are two files to create a style guide for
your project. The style guide is generated using Style Sherpa, a small
plugin created by ZURB.</p>

<p>Style Sherpa has a dedicated page here in the docs that explains its
various features. <strong><a href="style-sherpa.html">Learn more about
Style Sherpa.</a></strong></p>

<h3 id="label-Tutorials">Tutorials<span><a href="#label-Tutorials">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><a
href="https://foundation.zurb.com/learn/foundation-6-zurb-stack-part-1.html">What
the ZURB Stack Does</a> via ZURB</p>
</li><li>
<p><a
href="https://foundation.zurb.com/learn/foundation-6-stack-file-structure.html">Overview
of Foundation’s ZURB Stack and File Structure</a> via ZURB</p>
</li><li>
<p><a
href="https://zendev.com/2017/09/05/front-end-development-kickstarter-zurb-template.html#scss">All
about the ZURB Template</a> via Kevin Ball</p>
</li></ul>
</main>
