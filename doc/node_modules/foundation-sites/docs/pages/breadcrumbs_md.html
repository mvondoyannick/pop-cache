...
<title>breadcrumbs - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/breadcrumbs.md">

<p>— title: Breadcrumbs description: Breadcrumbs come in handy to show a
navigation trail for users clicking through your site. video:
&#39;vQz-Kv5f_Ts&#39;</p>

<h2 id="label-sass-3A+scss-2Fcomponents-2F_breadcrumbs.scss">sass: scss/components/_breadcrumbs.scss<span><a href="#label-sass-3A+scss-2Fcomponents-2F_breadcrumbs.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To make a set of breadcrumb links, just add the class
<code>.breadcrumbs</code> to a <code>&lt;ul&gt;</code>, and then add links
inside of the <code>&lt;li&gt;</code> elements. The current page
doesn&#39;t require a link or a class, but you should add some explanatory
text for AT that indicates which item is the current page.</p>

<p>To mark a disabled item, add the class <code>.disabled</code> to the
<code>&lt;li&gt;</code>, and just use plain text instead of a link.</p>
<a class="" data-open-video="2:05"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="warning callout">
