...
<title>callout - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/callout.md">

<p>— title: Callout description: Callouts combine panels and alerts from
Foundation 5 into one generic container component. video: yQdu0oSuaCo sass:
scss/components/_callout.scss tags:  - panel</p>

<h2 id="label-+-+alert"> - alert<span><a href="#label-+-+alert">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A callout is just an element with a <code>.callout</code> class applied.
You can put any kind of content inside.</p>
<p>
...
<p>Callouts can be colored using the <code>.secondary</code>,
<code>.primary</code>, <code>.success</code>, <code>.warning</code>, or
<code>.alert</code> classes. Links inside the callout will be tinted to
match the color of the callout.</p>
<p>
...
<pre>&lt;div class=&quot;callout secondary&quot;&gt;
...
<p>Callouts can be sized using the <code>.small</code> and <code>.large</code>
classes. These will affect the padding around content to be smaller and
larger respectively.</p>
...
<h2 id="label-Making+Closable">Making Closable<span><a href="#label-Making+Closable">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Pair the callout with the <a href="close-button.html">close button</a>
component and <code>data-closable</code> attribute to create a dismissable
alert box.</p>
<a class="" data-open-video="4:47"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="callout primary">
...
<pre>&lt;div class=&quot;callout alert&quot; data-closable&gt;
