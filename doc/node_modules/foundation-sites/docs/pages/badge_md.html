...
<title>badge - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/badge.md">

<p>— title: Badge description: The badge is a basic component that displays a
number. It&#39;s useful for calling out a number of unread items. sass:
scss/components/_badge.scss</p>
...
<p>Add the <code>.badge</code> class to an element to create a badge. In the
...
<p>A badge will typically be describing another element on the page. To bind
the two elements together, give the badge a unique ID, and reference that
ID in an <code>aria-describedby</code> attribute on the main element.</p>

<pre>&lt;h1 aria-describedby=&quot;messageCount&quot;&gt;Unread Messages&lt;/h1&gt;
&lt;span class=&quot;badge&quot; id=&quot;messageCount&quot;&gt;1&lt;/span&gt;</pre>

<p>Finally, the content itself might need more context for users that use
screen readers. You can add extra text inside the badge using the
<code>.show-for-sr</code> class.</p>

<pre>&lt;span class=&quot;badge&quot; id=&quot;messageCount&quot;&gt;1 &lt;span class=&quot;show-for-sr&quot;&gt;unread message&lt;/span&gt;&lt;/span&gt;</pre>
<hr>
...
<pre>&lt;span class=&quot;badge primary&quot;&gt;1&lt;/span&gt;
&lt;span class=&quot;badge secondary&quot;&gt;2&lt;/span&gt;
&lt;span class=&quot;badge success&quot;&gt;3&lt;/span&gt;
&lt;span class=&quot;badge alert&quot;&gt;A&lt;/span&gt;
&lt;span class=&quot;badge warning&quot;&gt;B&lt;/span&gt;</pre>
<hr>
...
badge classes by editing the <code>$badge-palette</code> map in your
settings file. The badge palette defaults to
...
<pre>$badge-palette: map-remove($foundation-palette, (
    primary,
    secondary
)) !default;</pre>
...
<pre>$badge-palette: map-merge($foundation-palette, (
    purple: #bb00ff
)) !default;</pre>
...
<p>The text color for each badge class is determined by either
<code>$badge-color</code> or <code>$badge-color-alt</code>, whichever
...
<p>An icon can be used in place of text. We&#39;re using the <a
href="https://zurb.com/playground/foundation-icon-fonts-3">Foundation icon
...
<pre>&lt;span class=&quot;badge secondary&quot;&gt;&lt;i class=&quot;fi-share&quot;&gt;&lt;/i&gt;&lt;/span&gt;
&lt;span class=&quot;badge success&quot;&gt;&lt;i class=&quot;fi-check&quot;&gt;&lt;/i&gt;&lt;/span&gt;
&lt;span class=&quot;badge warning&quot;&gt;&lt;i class=&quot;fi-wrench&quot;&gt;&lt;/i&gt;&lt;/span&gt;</pre>
</main>
