...
<title>responsive-navigation - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+js-2Ffoundation.responsiveToggle.js"> - js/foundation.responsiveToggle.js</a>
    <li><a href="#label-Responsive+Menu">Responsive Menu</a>
    <li><a href="#label-Drilldown+Dropdown+Menu">Drilldown Dropdown Menu</a>
    <li><a href="#label-Accordion+Dropdown+Menu">Accordion Dropdown Menu</a>
    <li><a href="#label-Drilldown+Accordion+Menu">Drilldown Accordion Menu</a>
    <li><a href="#label-Responsive+Toggle">Responsive Toggle</a>
    <li><a href="#label-Responsive+Toggle+with+animation">Responsive Toggle with animation</a>
    <li><a href="#label-Preventing+FOUC">Preventing FOUC</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/responsive-navigation.md">

<p>— title: Responsive Navigation description: Our three Menu patterns form
like Voltron into one responsive Menu plugin, which allows you to switch
between patterns at different screen sizes. video: &#39;dmKun75_9oc&#39;
js:  - js/foundation.responsiveMenu.js</p>

<h2 id="label-+-+js-2Ffoundation.responsiveToggle.js"> - js/foundation.responsiveToggle.js<span><a href="#label-+-+js-2Ffoundation.responsiveToggle.js">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Responsive+Menu">Responsive Menu<span><a href="#label-Responsive+Menu">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The Menu has some responsive CSS classes built in, which allow you to
re-orient a menu on different screen sizes.</p>
<p>
...
<p>The Menu can be augmented with one of three different plugins—dropdown
menu, drilldown menu, or accordion menu. However, these patterns tend to
work best on specific screen sizes.</p>

<p>With our responsive Menu plugin, you can apply a default pattern to a Menu,
and then change that pattern on other screen sizes.</p>

<p>Some Menu Combination (but not limited) to are</p>
<ul><li>
<p><a href="#drilldown-dropdown-menu">Drilldown Dropdown Menu</a></p>
</li><li>
<p><a href="#accordion-dropdown-menu">Accordion Dropdown Menu</a></p>
</li><li>
<p><a href="#drilldown-accordion-menu">Drilldown Accordion Menu</a></p>
</li></ul>

<h4 id="label-Drilldown+Dropdown+Menu">Drilldown Dropdown Menu<span><a href="#label-Drilldown+Dropdown+Menu">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>A drilldown menu works well on mobile, but on larger screens, you may want
to convert that same menu into a dropdown. Here&#39;s an example that does
just that:</p>
<p>
...
<pre>&lt;ul class=&quot;vertical medium-horizontal menu&quot; data-responsive-menu=&quot;drilldown medium-dropdown&quot;&gt;
  &lt;li&gt;
    &lt;a href=&quot;#&quot;&gt;Item 1&lt;/a&gt;
...
<p><br> &lt;div class=“alert callout”&gt;  &lt;p&gt; 
&lt;strong&gt;Bug(v6.3.1):&lt;/strong&gt; There is a bug within
&lt;strong&gt;drilldown-dropdown menu&lt;/strong&gt; combo. If you set up a
responsive menu with drilldown on small, then dropdown for medium up, and
resize to small and then back to medium the dropdowns will not work. The
bug can be reproduced &lt;a href=“<a
href="http://codepen.io/IamManchanda/pen/mmGOgG?editors=1000">here</a">codepen.io/IamManchanda/pen/mmGOgG?editors=1000”>here</a</a>&gt;
<br>  &lt;strong&gt;Good News:&lt;/strong&gt; The Bug will be fixed with
the upcoming foundation release. If you are specifically using
&lt;strong&gt;v6.3.1&lt;/strong&gt;, we recommend to use this below patch
to fix this.  &lt;/p&gt; &lt;/div&gt;</p>

<pre>// Patch for a Bug in v6.3.1
$(window).on(&#39;changed.zf.mediaquery&#39;, function() {
  $(&#39;.is-dropdown-submenu.invisible&#39;).removeClass(&#39;invisible&#39;);
});</pre>

<h4 id="label-Accordion+Dropdown+Menu">Accordion Dropdown Menu<span><a href="#label-Accordion+Dropdown+Menu">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Same like drilldowns, an accordion menu works well on mobile, but on larger
screens, you may want to convert that same menu into a dropdown. Here&#39;s
an example for the same:</p>
...
<pre>&lt;ul class=&quot;vertical medium-horizontal menu&quot; data-responsive-menu=&quot;accordion medium-dropdown&quot;&gt;
  &lt;li&gt;
    &lt;a href=&quot;#&quot;&gt;Item 1&lt;/a&gt;
    &lt;ul class=&quot;vertical menu&quot;&gt;
      &lt;li&gt;
...
<h4 id="label-Drilldown+Accordion+Menu">Drilldown Accordion Menu<span><a href="#label-Drilldown+Accordion+Menu">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Just like foundation docs itself (see left sidenav), an accordion menu is
great for a sidenav of a website on desktop, but for mobile, You might need
Drilldown menu.</p>
<div class="docs-codepen-container">
...
<pre>&lt;ul class=&quot;vertical menu&quot; data-responsive-menu=&quot;drilldown medium-accordion&quot; style=&quot;max-width: 250px;&quot;&gt;
  &lt;li&gt;
    &lt;a href=&quot;#&quot;&gt;Item 1&lt;/a&gt;
    &lt;ul class=&quot;vertical menu&quot;&gt;
      &lt;li&gt;
...
<p>In Foundation 5, the top bar combined this menu toggling concept into one
plugin. We now have a separate, optional component you can use in tandem
with the responsive plugin. It&#39;s called the title bar, and it allows
you to quickly setup a menu toggle on mobile. The title bar hides itself on
larger screens.</p>

<p>To set it up, first give your menu a unique ID. (You don&#39;t even need to
use Menu! Any element will work.) Next, add a title bar with the class
<code>.title-bar</code> and the attribute
<code>data-responsive-toggle</code>. The value of
<code>data-responsive-toggle</code> should be the ID of the menu you&#39;re
toggling. Lastly, add <code>data-toggle</code> to the element that will
trigger the toggle. The value of <code>data-toggle</code> should also be
the ID of the menu you&#39;re toggling.</p>

<p>By default, the title bar will be visible on small screens, and the Menu
hides. At the medium breakpoint, the title bar disappears, and the menu is
always visible. This breakpoint can be changed with the
<code>data-hide-for</code> attribute in HTML, or the <code>hideFor</code>
setting in JavaScript.</p>
<a class="" data-open-video="5:05"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="primary callout show-for-medium">
...
<h2 id="label-Responsive+Toggle+with+animation">Responsive Toggle with animation<span><a href="#label-Responsive+Toggle+with+animation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To use animations from the Motion UI library, include the
<code>data-animate=&quot;someAnimationIn someAnimationOut&quot;</code>
attribute.</p>
...
<pre>&lt;div class=&quot;title-bar&quot; data-responsive-toggle=&quot;example-animated-menu&quot; data-hide-for=&quot;medium&quot;&gt;
...
<h3 id="label-Preventing+FOUC">Preventing FOUC<span><a href="#label-Preventing+FOUC">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Before the JavaScript on your page loads, you&#39;ll be able to see both
the mobile and desktop element at once for a brief second. This is known as
a <a href="https://en.wikipedia.org/wiki/Flash_of_unstyled_content">flash
of unstyled content</a>. There&#39;s not an easy way for the framework to
handle this for you, but you can add some extra CSS to account for it.</p>

<p>If we reference the above example, <code>.title-bar</code> is our mobile
element and <code>.top-bar</code> is our desktop element. So before the
JavaScript loads, we want only the right element for that screen size to be
visible.</p>
...
<p>If you&#39;re using Sass, you can write it like this:</p>
