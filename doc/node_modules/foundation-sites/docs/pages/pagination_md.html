...
<title>pagination - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-sass-3A+scss-2Fcomponents-2F_pagination.scss">sass: scss/components/_pagination.scss</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/pagination.md">

<p>— title: Pagination description: Pagination is a type of navigation that
lets users click through pages of search results, products, or other
related items. video: &#39;9gcGADHzz9o&#39;</p>

<h2 id="label-sass-3A+scss-2Fcomponents-2F_pagination.scss">sass: scss/components/_pagination.scss<span><a href="#label-sass-3A+scss-2Fcomponents-2F_pagination.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A pagination list is just a <code>&lt;ul&gt;</code> with the class
<code>.pagination</code>, and a series of
<code>&lt;li&gt;</code>/<code>&lt;a&gt;</code> pairs. Add the class
<code>.current</code> to an <code>&lt;li&gt;</code> to mark the current
page, or <code>.disabled</code> to add disabled styles to a link.</p>

<p>Note that the list is nested inside a <code>&lt;nav&gt;</code> with the
attributes <code>aria-label=&quot;Pagination&quot;</code>. This explains
the purpose of the component to assistive technologies.</p>

<p>Extra screen reader-only text should also be added to a pagination element.
In the below example, users reading the page will just see “Next” and
“Previous”, but screen readers will read it as “Next page” and “Previous
page”. Additionally, the text for the current page will read as “You&#39;re
on page one”.</p>
<p>
...
<p>The items in a pagination list are <code>display: inline-block</code>,
which makes centering them easy. Use our built-in <code>.text-center</code>
class, or add <code>text-align: center</code> in your CSS.</p>
<p>
