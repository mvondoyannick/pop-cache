...
<title>switch - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-sass-3A+scss-2Fcomponents-2F_switch.scss">sass: scss/components/_switch.scss</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Radio+Switch">Radio Switch</a>
    <li><a href="#label-Sizing+Classes">Sizing Classes</a>
    <li><a href="#label-Inner+Labels">Inner Labels</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/switch.md">

<p>— title: Switch description: Create pure CSS3 On/Off switches with animated
transitions. Now you can tell your users to flip the switch or switch off.
video: &#39;AEL2Mj0DT3o&#39;</p>

<h2 id="label-sass-3A+scss-2Fcomponents-2F_switch.scss">sass: scss/components/_switch.scss<span><a href="#label-sass-3A+scss-2Fcomponents-2F_switch.scss">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Add the <code>.switch</code> class to an element to create a switch. Inside
the switch, add an <code>&lt;input type=&quot;checkbox&quot;&gt;</code>
with the class <code>.switch-input</code>. Next to that, create a
<code>&lt;label&gt;</code> with the class <code>.switch-paddle</code>.</p>

<p>Give the <code>&lt;input&gt;</code> a unique ID and point the
<code>&lt;label&gt;</code> to it with the <code>for</code> attribute. This
makes the switch clickable.</p>
...
<h2 id="label-Radio+Switch">Radio Switch<span><a href="#label-Radio+Switch">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can also use <code>&lt;input type=&quot;radio&quot;&gt;</code> instead
of <code>checkbox</code> to create a series of options.</p>
<p>
...
<h2 id="label-Sizing+Classes">Sizing Classes<span><a href="#label-Sizing+Classes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Use the classes <code>.tiny</code>, <code>.small</code>, or
<code>.large</code> to change the switch size.</p>
<p>
...
<h2 id="label-Inner+Labels">Inner Labels<span><a href="#label-Inner+Labels">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can place active and inactive text inside of a switch. The active text
(<code>.switch-active</code>) only displays when the switch is on, and the
inactive text (<code>.switch-inactive</code>) only displays when the switch
is off.</p>

<p>Active/inactive text goes inside of the switch&#39;s
<code>&lt;label&gt;</code>.</p>
<div class="primary callout">
...
</div><a class="" data-open-video="8:07"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="primary callout">
