...
<title>button-group - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-flexbox-3A+true">flexbox: true</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Sizing">Sizing</a>
    <li><a href="#label-Coloring">Coloring</a>
    <li><a href="#label-Even-width+Group">Even-width Group</a>
    <li><a href="#label-Stacking">Stacking</a>
    <li><a href="#label-Split+Buttons">Split Buttons</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/button-group.md">

<p>— title: Button Group description: Button groups are containers for related
action items. They&#39;re great when you need to display a group of actions
in a bar. These build off the button styles and work perfectly with the
grid. video: PRjMAuvwX44 sass: scss/components/_button-group.scss tags:  -
split button</p>

<h2 id="label-flexbox-3A+true">flexbox: true<span><a href="#label-flexbox-3A+true">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Add the <code>.button-group</code> class to a container, and inside it
place any number of buttons. The buttons are separated by a small border.</p>
<p>
...
<p>Button groups can be sized with the same classes as standard buttons:
<code>.tiny</code>, <code>.small</code>, and <code>.large</code>.</p>
<p>
  <a class="" data-open-video="0:40"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p><div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;small button-group&quot;&gt;
...
<p>Buttons within a button group can be colored individually with the
<code>.secondary</code>, <code>.success</code>, <code>.warning</code>, and
<code>.alert</code> classes.</p>
<p>
  <a class="" data-open-video="0:40"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p><div class="docs-codepen-container">
...
<p>The entire group can also be colored using the same classes.</p>

<pre>&lt;div class=&quot;secondary button-group&quot;&gt;
...
<h2 id="label-Even-width+Group">Even-width Group<span><a href="#label-Even-width+Group">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Add the <code>.expanded</code> class to the container to make a full-width
button group. Each item will automatically size itself based on how many
buttons there are, up to a maximum of six.</p>
<p>
...
<pre>&lt;div class=&quot;expanded button-group&quot;&gt;
...
<h2 id="label-Stacking">Stacking<span><a href="#label-Stacking">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A button group can be made vertical with the <code>.stacked</code> class.
You can also use <code>.stacked-for-small</code> to only stack a button
group on small screens, or <code>.stacked-for-medium</code> to only stack
on small and medium screens.</p>
<p>
...
<pre>&lt;div class=&quot;stacked-for-small button-group&quot;&gt;
...
<h2 id="label-Split+Buttons">Split Buttons<span><a href="#label-Split+Buttons">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To build a split button, just create a button group with two buttons.</p>

<p>To create a button with only an arrow, add the class
<code>.arrow-only</code>. Note that the button still needs a label for
screen readers, which can be embedded inside the button with a
<code>.show-for-sr</code> element. In the example below, an assistive
device will read the arrow button as “Show menu”.</p>
<p>
