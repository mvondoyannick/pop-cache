...
<title>equalizer - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-js-3A+js-2Ffoundation.equalizer.js">js: js/foundation.equalizer.js</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Nesting">Nesting</a>
    <li><a href="#label-Equalize+By+Row">Equalize By Row</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/equalizer.md">

<p>— title: Equalizer description: Equalizer makes it dead simple to give
multiple items equal height. video: KbruAemirVQ</p>

<h2 id="label-js-3A+js-2Ffoundation.equalizer.js">js: js/foundation.equalizer.js<span><a href="#label-js-3A+js-2Ffoundation.equalizer.js">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To set up an Equalizer group, you need a container, which gets the
attribute <code>data-equalizer</code>, and then a series of child elements,
which get the attribute <code>data-equalizer-watch</code>. The child
elements will all be resized to have the same height.</p>
<p>
...
<h2 id="label-Nesting">Nesting<span><a href="#label-Nesting">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To use one Equalizer inside another, each container needs a unique ID,
assigned with the <code>data-equalizer</code> attribute. Each
<code>data-equalizer-watch</code> element should then have a value that
matches its parent.</p>

<p>In the below example, the first set of Equalizer elements have the value
<code>foo</code>, while the inside elements have the value
<code>bar</code>. In the live example, we&#39;ve also set the
<code>equalizeOn</code> option to &#39;medium&#39; for the parent elements,
and the child Equalizer contained in the first div equalizes on stack, and
maintains equal height.</p>
...
<pre>&lt;div class=&quot;grid-x&quot; data-equalizer=&quot;foo&quot;&gt;
...
<h2 id="label-Equalize+By+Row">Equalize By Row<span><a href="#label-Equalize+By+Row">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you have a gallery of items that wrap multiple times, Equalizer can be
configured to match each row&#39;s items in height. Works great with the
block grid!</p>
<a class="" data-open-video="4:24"><img src="{{root}}assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a><div class="callout primary">
...
<pre>&lt;div class=&quot;grid-x grid-padding-x small-up-1 medium-up-2 large-up-4&quot; data-equalizer data-equalize-by-row=&quot;true&quot;&gt;
