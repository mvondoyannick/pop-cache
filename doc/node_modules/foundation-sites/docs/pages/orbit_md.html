...
<title>orbit - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+carousel"> - carousel</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Wrapper">Wrapper</a>
    <li><a href="#label-Slide+Container">Slide Container</a>
    <li><a href="#label-Next-2FPrevious+Arrows">Next/Previous Arrows</a>
    <li><a href="#label-Bullets">Bullets</a>
    <li><a href="#label-Slide+Contents">Slide Contents</a>
    <li><a href="#label-Using+Animation">Using Animation</a>
    <li><a href="#label-Disabling+Animation">Disabling Animation</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/orbit.md">

<p>— title: Orbit description: An image and content carousel with animation
support and many customizable options. sass: scss/components/_orbit.scss
js: js/foundation.orbit.js mui: true video: l0bdHvBuylA tags:  - slider</p>

<h2 id="label-+-+carousel"> - carousel<span><a href="#label-+-+carousel">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Orbit doesn&#39;t automatically generate any HTML for you, giving you the
flexibility to move around the various pieces of the plugin. Here&#39;s a
complete example—we&#39;ll break down the individual pieces farther down.</p>
...
<pre>&lt;div class=&quot;orbit&quot; role=&quot;region&quot; aria-label=&quot;Favorite Space Pictures&quot; data-orbit&gt;
...
<p>The wrapper houses the entire carousel. We use the <code>aria-label</code>
attribute to label what the carousel is, for assistive technology.</p>

<pre>&lt;div class=&quot;orbit&quot; role=&quot;region&quot; aria-label=&quot;Favorite Space Pictures&quot; data-orbit&gt;
&lt;/div&gt;</pre>

<h3 id="label-Slide+Container">Slide Container<span><a href="#label-Slide+Container">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The slide container houses each individual slide. In our above markup
example, we also placed the buttons in here, so we can anchor them to the
center edge of the slide container. However, they can be moved anywhere
within the <code>data-orbit</code> wrapper.</p>

<p>Each slide is an <code>&lt;li&gt;</code> with the class
<code>.orbit-slide</code>. The first slide is marked with the
<code>.is-active</code> class to indicate it&#39;s the default. You can
place any HTML you want inside of the slide, but we have some premade
styles for image-based slides with a caption.</p>

<pre>&lt;ul class=&quot;orbit-container&quot;&gt;
...
<h3 id="label-Next-2FPrevious+Arrows">Next/Previous Arrows<span><a href="#label-Next-2FPrevious+Arrows">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Orbit controls use the class <code>.orbit-previous</code> and
<code>.orbit-next</code>. The below example has an important accessibility
hook: since we&#39;re using ASCII arrows for the carousel controls, we add
screen reader-only text (wrapped in the class <code>.show-for-sr</code>)
that explain what the controls do.</p>

<pre>&lt;button class=&quot;orbit-previous&quot;&gt;&lt;span class=&quot;show-for-sr&quot;&gt;Previous Slide&lt;/span&gt; &amp;#9664;&amp;#xFE0E;&lt;/button&gt;
&lt;button class=&quot;orbit-next&quot;&gt;&lt;span class=&quot;show-for-sr&quot;&gt;Next Slide&lt;/span&gt; &amp;#9654;&amp;#xFE0E;&lt;/button&gt;</pre>

<h3 id="label-Bullets">Bullets<span><a href="#label-Bullets">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The bullets serve two purposes: they mark the current slide, and can be
clicked on to navigate to another slide. Like with the controls, the
bullets also have screen reader-friendly labels.</p>

<pre>&lt;nav class=&quot;orbit-bullets&quot;&gt;
  &lt;button class=&quot;is-active&quot; data-slide=&quot;0&quot;&gt;&lt;span class=&quot;show-for-sr&quot;&gt;First slide details.&lt;/span&gt;&lt;span class=&quot;show-for-sr&quot;&gt;Current Slide&lt;/span&gt;&lt;/button&gt;
  &lt;button data-slide=&quot;1&quot;&gt;&lt;span class=&quot;show-for-sr&quot;&gt;Second slide details.&lt;/span&gt;&lt;/button&gt;
  &lt;button data-slide=&quot;2&quot;&gt;&lt;span class=&quot;show-for-sr&quot;&gt;Third slide details.&lt;/span&gt;&lt;/button&gt;
  &lt;button data-slide=&quot;3&quot;&gt;&lt;span class=&quot;show-for-sr&quot;&gt;Fourth slide details.&lt;/span&gt;&lt;/button&gt;
...
<h2 id="label-Slide+Contents">Slide Contents<span><a href="#label-Slide+Contents">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A carousel slide can contain images or HTML—you can even mix between slides
in one carousel!</p>
<p>
...
<h2 id="label-Using+Animation">Using Animation<span><a href="#label-Using+Animation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Orbit uses <a href="motion-ui.html">Motion UI</a> CSS classes to animate
slides around.</p>
...
<ul><li>
<p><code>data-anim-in-from-left</code>: transition to play when a slide comes
<em>in from the left</em>.</p>
</li><li>
<p><code>data-anim-in-from-right</code>: transition to play when a slide comes
<em>in from the right</em>.</p>
</li><li>
<p><code>data-anim-out-to-left</code>: transition to play when a slide comes
<em>out to the left</em>.</p>
</li><li>
<p><code>data-anim-out-to-right</code>: transition to play when a slide comes
<em>out to the right</em>.</p>
</li></ul>

<p>Since those option names are pretty <em>long</em>, you can also set them
all in one HTML attribute, using <code>data-options</code>:</p>
...
<pre>&lt;div class=&quot;orbit&quot; role=&quot;region&quot; aria-label=&quot;Favorite Space Pictures&quot; data-orbit data-options=&quot;animInFromLeft:fade-in; animInFromRight:fade-in; animOutToLeft:fade-out; animOutToRight:fade-out;&quot;&gt;
&lt;/div&gt;</pre>
...
<h3 id="label-Disabling+Animation">Disabling Animation<span><a href="#label-Disabling+Animation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To disable Motion UI, set the plugin option <code>useMUI</code> to
<code>false</code>. Written as an HTML attribute, that&#39;s
<code>data-use-m-u-i=&quot;false&quot;</code>.</p>
<div class="docs-codepen-container">
...
<pre>&lt;div class=&quot;orbit&quot; role=&quot;region&quot; aria-label=&quot;Favorite Space Pictures&quot; data-orbit data-use-m-u-i=&quot;false&quot;&gt;
&lt;/div&gt;</pre>
