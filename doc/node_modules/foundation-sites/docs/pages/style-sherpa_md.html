...
<title>style-sherpa - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-27paIqrjCm9_k-27">video: &#39;paIqrjCm9_k&#39;</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-Writing+Content">Writing Content</a>
    <li><a href="#label-Code+Samples">Code Samples</a>
    <li><a href="#label-Changing+the+Template">Changing the Template</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/style-sherpa.md">

<p>— title: Style Sherpa description: Bundled with the ZURB Template, Style
Sherpa makes it easy to create a style guide for your codebase, with just
two files. library:  github: <a
href="https://github.com/zurb/style-sherpa">github.com/zurb/style-sherpa</a>
docs: <a
href="https://github.com/zurb/style-sherpa">github.com/zurb/style-sherpa</a></p>

<h2 id="label-video-3A+-27paIqrjCm9_k-27">video: &#39;paIqrjCm9_k&#39;<span><a href="#label-video-3A+-27paIqrjCm9_k-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Style guides are a critical component of a CSS codebase, especially one
used by many people. It&#39;s important that everyone on a team knows how
to build a component. Style guides are that documentation. The docs
you&#39;re reading right now are a style guide of sorts, for the core
Foundation styles.</p>

<p><a href="https://github.com/zurb/style-sherpa">Style Sherpa</a> is a small
tool bundled with the <a href="starter-projects.html#zurb-template">ZURB
Template</a> that can generate a basic style guide for you quickly. The
style guide is created from a single Markdown file, which contains all of
the page content, and an HTML template, which defines the structure around
the content.</p>
<hr>
...
<p>The ZURB Template includes the folder <code>src/styleguide/</code>, which
contains both of the files you need to build your style guide. Like
everything else in the ZURB Template, just edit the files and your changes
will instantly be compiled</p>

<p>One is a Markdown file, <code>index.md</code>. This file contains the
contents of your style guide.</p>

<p>The other is a Handlebars template, <code>template.html</code>. The
contents of your style guide are inserted into this template as HTML. The
final file is included in the <code>dist/</code> folder of your project as
<code>styleguide.html</code>.</p>
<hr>

<h2 id="label-Writing+Content">Writing Content<span><a href="#label-Writing+Content">&para;</a> <a href="#top">&uarr;</a></span></h2>
<p>
...
<p>The style guide is divided into sections. Generally, each component in your
codebase—think buttons, panels, modals, form controls, and so on—will have
its own section.</p>
...
<p>To create a new section, add four line breaks and a new heading:</p>
...
Lorem ipsum dolor sit amet, `&lt;form&gt;` elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</pre>

<h3 id="label-Code+Samples">Code Samples<span><a href="#label-Code+Samples">&para;</a> <a href="#top">&uarr;</a></span></h3>
<p>
...
<p>A style guide should always have HTML examples, which explain how to build
something. To create a code block in Markdown, surround the code with three
backticks. You can also set the language of the code block after the first
set of backticks. Style Sherpa will color the syntax for you in the final
output.</p>
...
<p>You&#39;ll also want to show a live demo of the component below the code
sample, so developers can see both the HTML for an element, and what the
HTML looks live rendered in one place. Style Sherpa has a shortcut for
this: instead of setting <code>html</code> as the language in Markdown, set
it to <code>html_example</code>. This will print a code sample and a live
demo with the same code all in one go.</p>
...
<pre>&lt;button class=&quot;button&quot; type=&quot;button&quot;&gt;This is a button.&lt;/button&gt;</pre>
<hr>

<h2 id="label-Changing+the+Template">Changing the Template<span><a href="#label-Changing+the+Template">&para;</a> <a href="#top">&uarr;</a></span></h2>
<p>
...
<p>The ZURB Template includes a minimal boilerplate for your style guide, but
you&#39;re free to customize it however you want.</p>

<p>The boilerplate uses Foundation&#39;s Vertical Menu—one item is made for
each section. Here&#39;s what the Handlebars code looks like:</p>

<p>{{{{raw}}}} “`handlebars &lt;div class=“row”&gt;</p>

<p>&lt;div class=“large-3 medium-4 columns”&gt;  &lt;dl class=“vertical tabs”
data-tab&gt;  {{#each pages}}  &lt;dd{{#if @first}}
class=“active”{{/if}}&gt;&lt;a href=“#{{ anchor }}”&gt;{{ title
}}&lt;/a&gt;&lt;/dd&gt;  {{/each}}  &lt;/dl&gt;  &lt;/div&gt;</p>

<p>&lt;div class=“large-9 medium-8 columns”&gt;  &lt;div
class=“tabs-content”&gt;  {{#each pages}}  &lt;section class=“content {{#if
@first}}active{{/if}}” id=“{{ anchor }}”&gt;  {{ body }}  &lt;/section&gt; 
{{/each}}  &lt;/div&gt;  &lt;/div&gt;</p>

<p>&lt;/div&gt; “`</p>

<p>The template has access to a <code>pages</code> variable, which is an array
with the data for each page. When looping through <code>pages</code> using
<code>{{#each}}</code>, you have access to these variables:</p>
<ul><li>
<p><code>title</code>: The name of the section.</p>
</li><li>
<p><code>anchor</code>: The name of the section, formatted as a URL anchor.</p>
</li><li>
<p><code>body</code>: The content of the section.</p>
</li></ul>
