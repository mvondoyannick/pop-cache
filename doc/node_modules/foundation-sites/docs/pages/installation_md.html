...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-video-3A+-276KwsGcEHVTE-27">video: &#39;6KwsGcEHVTE&#39;</a>
    <li><a href="#label-Install+with+Package+Managers">Install with Package Managers</a>
    <li><a href="#label-Install+with+Foundation+CLI">Install with Foundation CLI</a>
    <li><a href="#label-Download">Download</a>
    <li><a href="#label-CDN+Links">CDN Links</a>
    <li><a href="#label-HTML+Starter+Template">HTML Starter Template</a>
    <li><a href="#label-Other+Integrations">Other Integrations</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/installation.md">

<p>— title: Installation description: There are many ways to install
Foundation, but if you&#39;re just getting started, we have a few
suggestions.</p>

<h2 id="label-video-3A+-276KwsGcEHVTE-27">video: &#39;6KwsGcEHVTE&#39;<span><a href="#label-video-3A+-276KwsGcEHVTE-27">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Install+with+Package+Managers">Install with Package Managers<span><a href="#label-Install+with+Package+Managers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation is available on npm, Bower, Meteor, and Composer. The package
includes all of the source Sass and JavaScript files, as well as compiled
CSS and JavaScript, in uncompressed and compressed flavors.</p>
...
<p>Here&#39;s what comes in the package.</p>

<pre>├─ scss       Source Sass files. Use this folder as a load path in Sass.
├─ js         Source JavaScript files. If you&#39;re using a build system, make sure `foundation.core.js` is loaded first.
└─ dist       Compiled files:
   ├─ css        * Compiled CSS files. Includes minified and unminified files.
   ├─ js         * Concatenated JavaScript files. Includes minified and unminified files.
   └─ plugins    * Standalone JavaScript plugins.</pre>
<hr>

<h2 id="label-Install+with+Foundation+CLI">Install with Foundation CLI<span><a href="#label-Install+with+Foundation+CLI">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Not a fan of GUIs? The Node-powered Foundation CLI can install the same
template projects for you.</p>

<p>Install Foundation CLI:</p>

<pre>npm install --global foundation-cli
# or sudo npm install --global foundation-cli</pre>
...
<pre class="ruby"><span class="ruby-identifier">foundation</span> <span class="ruby-identifier">new</span>
</pre>

<p>After you selected “Foundation for Sites”, Foundation CLI will ask you
which template you want to use. You can choose between:</p>
<div class="grid-x grid-margin-x">
...
<h2 id="label-CDN+Links">CDN Links<span><a href="#label-CDN+Links">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The folks at <a href="https://www.jsdelivr.com">jsDelivr</a> host the
compressed Foundation CSS and JavaScript for us. Just drop one of these
<code>&lt;script&gt;</code> tags into your HTML and you&#39;re set:</p>

<pre>&lt;!-- Compressed CSS --&gt;
&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdn.jsdelivr.net/npm/foundation-sites@6.5.3/dist/css/foundation.min.css&quot; integrity=&quot;sha256-xpOKVlYXzQ3P03j397+jWFZLMBXLES3IiryeClgU5og= sha384-gP4DhqyoT9b1vaikoHi9XQ8If7UNLO73JFOOlQV1RATrA7D0O7TjJZifac6NwPps sha512-AKwIib1E+xDeXe0tCgbc9uSvPwVYl6Awj7xl0FoaPFostZHOuDQ1abnDNCYtxL/HWEnVOMrFyf91TDgLPi9pNg==&quot; crossorigin=&quot;anonymous&quot;&gt;

&lt;!-- Compressed JavaScript --&gt;
&lt;script src=&quot;https://cdn.jsdelivr.net/npm/foundation-sites@6.5.3/dist/js/foundation.min.js&quot; integrity=&quot;sha256-/PFxCnsMh+nTuM0k3VJCRch1gwnCfKjaP8rJNq5SoBg= sha384-9ksAFjQjZnpqt6VtpjMjlp2S0qrGbcwF/rvrLUg2vciMhwc1UJJeAAOLuJ96w+Nj sha512-UMSn6RHqqJeJcIfV1eS2tPKCjzaHkU/KqgAnQ7Nzn0mLicFxaVhm9vq7zG5+0LALt15j1ljlg8Fp9PT1VGNmDw==&quot; crossorigin=&quot;anonymous&quot;&gt;&lt;/script&gt;</pre>

<p>From Foundation 6.4, flex is enabled by default and <strong>only the new XY
Grid is available</strong>. However, others CSS versions are available for
backward compatibility and the most common usage cases. For others uses and
advanced customization, we recommand to build Foundation with custom
settings (see others installation methods).</p>

<pre>&lt;!-- foundation-float.min.css: Compressed CSS with legacy Float Grid --&gt;
...
<h2 id="label-HTML+Starter+Template">HTML Starter Template<span><a href="#label-HTML+Starter+Template">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Start with this HTML template and adapt it to your needs. Be sure to
include the <code>.no-js</code> class on the <code>html</code> tag of your
template. Adding this class prevents <a
href="https://en.wikipedia.org/wiki/Flash_of_unstyled_content">flash of
unstyled content</a> for a number of foundation components.</p>
...
<h2 id="label-Other+Integrations">Other Integrations<span><a href="#label-Other+Integrations">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The Foundation community has helped us integrate the framework into Rails,
WordPress, Django, and more. Head to our <a
href="http://foundation.zurb.com/sites/resources">resources page</a> to
find even more ways to use Foundation.</p>
</main>
