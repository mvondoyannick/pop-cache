...
<title>slider - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+-+range"> - range</a>
    <li><a href="#label-Basics">Basics</a>
    <li><a href="#label-Vertical">Vertical</a>
    <li><a href="#label-Disabled">Disabled</a>
    <li><a href="#label-Two+Handles">Two Handles</a>
    <li><a href="#label-Data+Binding">Data Binding</a>
    <li><a href="#label-Native+Range+Slider">Native Range Slider</a>
    <li><a href="#label-Non-linear+value+translation">Non-linear value translation</a>
    <li><a href="#label-Reflow">Reflow</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/slider.md">

<p>— title: Slider description: This handy lil slider is perfect for setting
specific values within a range. sass: scss/components/_slider.scss js:
js/foundation.slider.js video: &#39;i_BTQiXBvhU&#39; tags:</p>

<h2 id="label-+-+range"> - range<span><a href="#label-+-+range">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h2 id="label-Basics">Basics<span><a href="#label-Basics">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Create a slider by adding the class <code>.slider</code> and the attribute
<code>data-slider</code> to a container element. You should also define
both a starting and maximum value for the slider.</p>

<p>Inside the container are three elements: - The handle
(<code>.slider-handle</code>), which the user drags. - The fill
(<code>.slider-fill</code>), which resizes dynamically based on where the
handle is. - A hidden <code>&lt;input&gt;</code>, which is where the value
of the slider is stored.</p>

<p>The <code>data-initial-start=&quot;&quot;</code> value is where along the
slider the handle starts. The <code>data-end=&quot;&quot;</code> is the
maximum value for the slider. In the below example, starting at 50 of 200
means the slider handle will start at 25% of the total.</p>
<p>
...
<h2 id="label-Vertical">Vertical<span><a href="#label-Vertical">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To get <em>vertical</em>, just add a <code>.vertical</code> class and
<code>data-vertical=&quot;true&quot;</code> the slider.</p>
<p>
...
<pre>&lt;div class=&quot;slider vertical&quot; data-slider data-initial-start=&quot;25&quot; data-end=&quot;200&quot; data-vertical=&quot;true&quot;&gt;
  &lt;span class=&quot;slider-handle&quot; data-slider-handle role=&quot;slider&quot; tabindex=&quot;1&quot;&gt;&lt;/span&gt;
  &lt;span class=&quot;slider-fill&quot; data-slider-fill&gt;&lt;/span&gt;
  &lt;input type=&quot;hidden&quot;&gt;
&lt;/div&gt;</pre>
...
<h2 id="label-Disabled">Disabled<span><a href="#label-Disabled">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Add the class <code>.disabled</code> to disable interaction with the
slider.</p>
...
<pre>&lt;div class=&quot;slider disabled&quot; data-slider data-initial-start=&quot;78&quot;&gt;
  &lt;span class=&quot;slider-handle&quot; data-slider-handle role=&quot;slider&quot; tabindex=&quot;1&quot;&gt;&lt;/span&gt;
  &lt;span class=&quot;slider-fill&quot; data-slider-fill&gt;&lt;/span&gt;
  &lt;input type=&quot;hidden&quot;&gt;
&lt;/div&gt;</pre>
...
<h2 id="label-Two+Handles">Two Handles<span><a href="#label-Two+Handles">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Two-handle sliders can be used to define a range of values, versus a single
value. To make a two-handle slider, add a second handle, and a second
<code>&lt;input&gt;</code>. This works with horizontal and vertical
sliders.</p>

<p>You can add IDs to the <code>&lt;input&gt;</code>s inside the sliders to
make it easier to access the values. If you don&#39;t, the plugin will add
an ID to each for you.</p>

<p>Note that the first handle manipulates the first
<code>&lt;input&gt;</code>, while the second handle manipulates the second
<code>&lt;input&gt;</code>.</p>
<p>
...
<pre>&lt;div class=&quot;slider&quot; data-slider data-initial-start=&quot;25&quot; data-initial-end=&quot;75&quot;&gt;
  &lt;span class=&quot;slider-handle&quot; data-slider-handle role=&quot;slider&quot; tabindex=&quot;1&quot;&gt;&lt;/span&gt;
  &lt;span class=&quot;slider-fill&quot; data-slider-fill&gt;&lt;/span&gt;
  &lt;span class=&quot;slider-handle&quot; data-slider-handle role=&quot;slider&quot; tabindex=&quot;1&quot;&gt;&lt;/span&gt;
  &lt;input type=&quot;hidden&quot;&gt;
...
<h2 id="label-Data+Binding">Data Binding<span><a href="#label-Data+Binding">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Data binding allows you to connect the slider to an external
<code>&lt;input&gt;</code> field. With data binding set up, dragging the
handle will change the value inside the text field, and editing the number
in the text field will move the slider in real-time.</p>

<p>To set it all up, create an <code>&lt;input&gt;</code> with an ID and add
<code>aria-controls=&quot;id&quot;</code> to the slider handle, where
<code>id</code> is the ID of the <code>&lt;input&gt;</code>.</p>
<p>
...
<h2 id="label-Native+Range+Slider">Native Range Slider<span><a href="#label-Native+Range+Slider">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>In Foundation 6.2, we introduced styles for <code>&lt;input
type=&quot;range&quot;&gt;</code>, the native HTML element for range
sliders. It&#39;s not supported in every browser, namely IE9 and some older
mobile browsers. <a href="http://caniuse.com/#feat=input-range">View
browser support for the range input type.</a></p>
<p>
...
<pre>&lt;input type=&quot;range&quot; min=&quot;1&quot; max=&quot;100&quot; step=&quot;1&quot;&gt;</pre>

<p>If you&#39;re using the Sass version of Foundation, add this line to your
main Sass file:</p>

<pre>@include foundation-range-input;</pre>

<p>It&#39;s possible to use both the JavaScript slider and the native slider
in the same codebase, as the CSS selectors used don&#39;t overlap.
Here&#39;s what&#39;s different about the native slider:</p>
<ul><li>
<p>Less markup: just write <code>&lt;input type=&quot;range&quot;&gt;</code>
and you&#39;re good.</p>
</li><li>
<p>No JavaScript is needed, which guarantees it runs faster in most browsers.</p>
</li><li>
<p>To disable the slider, add <code>disabled</code> as an attribute, instead
of a class.</p>
</li><li>
<p>No support for vertical orientation.</p>
</li><li>
<p>No support for two handles.</p>
</li></ul>
<hr>

<h2 id="label-Non-linear+value+translation">Non-linear value translation<span><a href="#label-Non-linear+value+translation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Sometimes not every value is of equal importance. In the example below, the
slider focusses on the higher numbers by adding a <code>log</code>-type
position value function. Alternatively there is also a
<code>pow</code>-type position value function available, making the reverse
possible.</p>
...
<h2 id="label-Reflow">Reflow<span><a href="#label-Reflow">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The slider takes into account the width of the handles when calculating how
to display itself. This means that if the slider is initially hidden, or
hidden while the value is adjusted, the resulting visual will be slightly
different because the width of the handle is indeterminate. If this is
problematic, you can use JavaScript to cause the slider to reflow at the
time that you change it from being hidden. Example:</p>

<pre>$(&#39;#my-slider&#39;).show();
$(&#39;#my-slider&#39;).foundation(&#39;_reflow&#39;);</pre>
</main>
