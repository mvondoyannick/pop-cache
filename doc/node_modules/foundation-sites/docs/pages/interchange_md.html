...
<title>interchange - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Use+with+Images">Use with Images</a>
    <li><a href="#label-Use+with+HTML">Use with HTML</a>
    <li><a href="#label-Use+with+Background+Images">Use with Background Images</a>
    <li><a href="#label-Named+Media+Queries">Named Media Queries</a>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/interchange.md">

<p>— title: Interchange description: Interchange uses media queries to
dynamically load responsive content that is appropriate for the user&#39;s
device. js: js/foundation.interchange.js video: &#39;1Nr12_1rUpo&#39;</p>
<hr>

<h2 id="label-Use+with+Images">Use with Images<span><a href="#label-Use+with+Images">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Bandwidth is precious on mobile networks, so it helps to serve users on
smaller screens a smaller image. Using Interchange, you can serve up
specific images for users depending on their screen size. CSS media queries
are used to determine what size the user&#39;s device is, and which image
should be served.</p>

<p>In the below example, we have three different sizes of image: one for small
screens, one for medium, and one for large. Use the below format to set up
a responsive image. The image will change automatically as the browser
resizes.</p>
<p>
...
<p>&lt;img data-interchange=“[assets/img/interchange/small.jpg, small],
[assets/img/interchange/medium.jpg, medium],
[assets/img/interchange/large.jpg, large]”&gt;</p>

<p>The image set is a comma-separated list of items with this format:</p>

<pre class="ruby">[<span class="ruby-identifier">image_path</span>, <span class="ruby-identifier">media_query</span>]
</pre>

<p><code>image_path</code> can be a relative or absolute path.
<code>media_query</code> can be any CSS media query, or a Foundation
breakpoint—see <a href="#named-media-queries">Named Media Queries</a>
below.</p>
...
<h2 id="label-Use+with+HTML">Use with HTML<span><a href="#label-Use+with+HTML">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Interchange can also swap in and out entire chunks of HTML. This allows you
to load in mobile-friendly components on small screens, or more advanced
versions on large screens.</p>

<p>In the below example, we&#39;ve applied <code>data-interchange</code> to a
<code>&lt;div&gt;</code> instead of an <code>&lt;img&gt;</code> element,
and the paths are to HTML files instead of images.</p>

<pre>&lt;div data-interchange=&quot;[assets/partials/interchange-default.html, small], [assets/partials/interchange-medium.html, medium], [assets/partials/interchange-large.html, large]&quot;&gt;&lt;/div&gt;</pre>
<div id="docs-example-interchange" data-interchange="[assets/partials/interchange-default.html, small], [assets/partials/interchange-medium.html, medium], [assets/partials/interchange-large.html, large]"></div><hr>

<h2 id="label-Use+with+Background+Images">Use with Background Images<span><a href="#label-Use+with+Background+Images">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>When using Interchange on a non-<code>&lt;img&gt;</code> element, you can
pass in an image path instead of an HTML path, and the element&#39;s
<code>background-image</code> property will be set to the path of the
matching rule.</p>

<pre>&lt;div data-interchange=&quot;[assets/img/interchange/small.jpg, small], [assets/img/interchange/medium.jpg, medium], [assets/img/interchange/large.jpg, large]&quot;&gt;&lt;/div&gt;</pre>
<hr>

<h2 id="label-Named+Media+Queries">Named Media Queries<span><a href="#label-Named+Media+Queries">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Interchange supports named queries as shorthands for full CSS media
queries. Any breakpoint defined in the <code>$breakpoints</code> variable
in your Sass will work, along with a few other keywords. <a
href="media-queries.html">Learn more about changing the default
breakpoints.</a></p>

<p>Query Name | Media Query ———–|———— small | <code>screen and (min-width:
0em)</code> medium | <code>only screen and (min-width: 40em)</code> large |
<code>only screen and (min-width: 64em)</code> xlarge | <code>only screen
and (min-width: 75em)</code> xxlarge | <code>only screen and (min-width:
90em)</code> portrait | <code>screen and (orientation: portrait)</code>
landscape | <code>screen and (orientation: landscape)</code> retina |
<code>only screen and (-webkit-min-device-pixel-ratio: 2), only screen and
...
(min-resolution: 2dppx)</code></p>

<p>To add your own named media queries, add them as properties to
<code>Foundation.Interchange.SPECIAL_QUERIES</code>.</p>

<pre class="ruby"><span class="ruby-constant">Foundation</span>.<span class="ruby-constant">Interchange</span>.<span class="ruby-constant">SPECIAL_QUERIES</span>[<span class="ruby-string">&#39;square&#39;</span>] = <span class="ruby-string">&#39;screen and (aspect-ratio: 1/1)&#39;</span>;
</pre>
<hr>

<h2 id="label-Programmatic+Use">Programmatic Use<span><a href="#label-Programmatic+Use">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>When using Interchange programmatically, you need to pass in your ruleset
in the <code>options</code> object, as well as the <em>container</em>
element, <em>not</em> the content elements, like so:</p>

<pre>var $photoFrame = $(&#39;#some-container&#39;);
