...
<title>off-canvas - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-flex-3A+true">flex: true</a>
    <li><a href="#label-Setup">Setup</a>
    <li><a href="#label-Wrapper">Wrapper</a>
    <li><a href="#label-Click+Triggers">Click Triggers</a>
    <li><a href="#label-Close+Button">Close Button</a>
    <li><a href="#label-Complete+Example">Complete Example</a>
    <li><a href="#label-Off-canvas+Position">Off-canvas Position</a>
    <li><a href="#label-Off-canvas+Directions">Off-canvas Directions</a>
    <li><a href="#label-Multiple+Panels">Multiple Panels</a>
    <li><a href="#label-Off-canvas+Transitions">Off-canvas Transitions</a>
    <li><a href="#label-Reveal+on+Larger+Screens">Reveal on Larger Screens</a>
    <li><a href="#label-Combining+with+Title+Bar">Combining with Title Bar</a>
    <li><a href="#label-Off-Canvas+-28Putting+it+all+together-29">Off-Canvas (Putting it all together)</a>
    <li><a href="#label-In-Canvas+to+Off-Canvas">In-Canvas to Off-Canvas</a>
    <li><a href="#label-Nested+Off-Canvas">Nested Off-Canvas</a>
    <li><a href="#label-Off-canvas+Sizes">Off-canvas Sizes</a>
    <li><a href="#label-Migrating+from+versions+prior+to+v6.4">Migrating from versions prior to v6.4</a>
    <li><a href="#label-Migrating+from+versions+prior+to+v6.3">Migrating from versions prior to v6.3</a>
    <li><a href="#label-Pre+6.3+Off-canvas+Setup">Pre 6.3 Off-canvas Setup</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/off-canvas.md">

<p>— title: Off-canvas description: Off-canvas panels are positioned outside
of the viewport and slide in when activated. Setting up an off-canvas
layout in Foundation is super easy. video: &#39;RK_k__4Y4TU&#39; sass:  -
scss/components/_off-canvas.scss  - scss/components/_title-bar.scss js:
js/foundation.offcanvas.js tags:  - navigation  - offcanvas  - off-canvas 
- nav  - title bar</p>

<h2 id="label-flex-3A+true">flex: true<span><a href="#label-flex-3A+true">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
data-toggle=“offCanvasLeft”&gt;Toggle Off-canvas&lt;/button&gt;</p>

<p>Foundation&#39;s Off-canvas is a well established mobile pattern for
navigation that can also be used to create a responsive sidebar. It can
open from any direction, left, right, top, and bottom. There are options to
allow the Off-canvas to push your page over or to overlap your page plus a
few other neat tricks.</p>

<h2 id="label-Setup">Setup<span><a href="#label-Setup">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Setting up the Off-canvas only requires two elements! To setup the
Off-canvas create an off-canvas container with the class
<code>.off-canvas</code> and the attribute <code>data-off-canvas</code>.
This is the container that holds your Off-canvas content.</p>

<p>The Off-canvas container also needs a positioning class to determine which
side of the viewport it opens from:</p>
<ul><li>
<p><code>.position-left</code></p>
</li><li>
<p><code>.position-right</code></p>
</li><li>
<p><code>.position-top</code></p>
</li><li>
<p><code>.position-bottom</code></p>
</li></ul>
<p>
...
<p>Also be sure the off-canvas panel has a unique ID so it can be targeted by
the click trigger.</p>

<p>Example:</p>

<pre>&lt;div class=&quot;off-canvas position-left&quot; id=&quot;offCanvas&quot; data-off-canvas&gt;
  &lt;!-- Your menu or Off-canvas content goes here --&gt;
&lt;/div&gt;</pre>

<p>Along with the Off-canvas container, the main content of your page will be
housed in its own container with the class <code>.off-canvas-content</code>
and attribute <code>data-off-canvas-content</code>. This is where your page
content lives.</p>

<pre>&lt;div class=&quot;off-canvas-content&quot; data-off-canvas-content&gt;
...
<h3 id="label-Wrapper">Wrapper<span><a href="#label-Wrapper">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>You can add an optional wrapper around off-canvas and the content. This
hides the vertical (on top/bottom off-canvas) or horizontal (on left/right
off-canvas) scrollbars the body will have. Simply add a container with the
class <code>.off-canvas-wrapper</code>.</p>
...
<h3 id="label-Click+Triggers">Click Triggers<span><a href="#label-Click+Triggers">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To create a click trigger that opens the panel, add the attribute
<code>data-open</code> or <code>data-toggle</code> to any element. That
element will then open or toggle the panel when clicked on. The value of
the data attribute should be the ID of the off-canvas.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="http://codepen.io/ZURBFoundation/pen/ZKjXvQ?editors=1000" target="_blank"><img src="{{root}}assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
<pre>&lt;button type=&quot;button&quot; class=&quot;button&quot; data-toggle=&quot;offCanvas&quot;&gt;Open Menu&lt;/button&gt;</pre>

<h3 id="label-Close+Button">Close Button<span><a href="#label-Close+Button">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Foundation&#39;s Close component can be used inside the off-canvas to close
it.</p>
<div class="docs-codepen-container">
...
<pre>&lt;button class=&quot;close-button&quot; aria-label=&quot;Close menu&quot; type=&quot;button&quot; data-close&gt;
  &lt;span aria-hidden=&quot;true&quot;&gt;&amp;times;&lt;/span&gt;
&lt;/button&gt;</pre>

<h3 id="label-Complete+Example">Complete Example<span><a href="#label-Complete+Example">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Here&#39;s a complete example that can be pasted into the
<code>&lt;body&gt;</code> tag of your page. It includes a close button and
basic menu styles.</p>
...
<h2 id="label-Off-canvas+Position">Off-canvas Position<span><a href="#label-Off-canvas+Position">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation&#39;s Off-canvas is set to <code>position: fixed</code> by
default using the <code>.off-canvas</code> class. This makes the off-canvas
panel sit in relation to the viewport, and is the desired behavior for most
users. However you can also set an off-canvas container to <code>position:
absolute</code> by using the alternative class
<code>.off-canvas-absolute</code>. Also be sure to use the
<code>.off-canvas-wrapper</code> when using this method.</p>

<pre>&lt;button type=&quot;button&quot; class=&quot;button&quot; data-toggle=&quot;offCanvasLeftSplit1&quot;&gt;Open Left&lt;/button&gt;
...
<h2 id="label-Off-canvas+Directions">Off-canvas Directions<span><a href="#label-Off-canvas+Directions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation&#39;s Off-canvas can open from any direction, left, right, top,
and bottom.</p>

<p>The Off-canvas container requires a positioning class to determine which
side of the viewport it opens from:</p>
<ul><li>
<p><code>.position-left</code></p>
</li><li>
...
<pre>&lt;button type=&quot;button&quot; class=&quot;button&quot; data-toggle=&quot;offCanvasLeft1&quot;&gt;Open Left&lt;/button&gt;
...
<h2 id="label-Multiple+Panels">Multiple Panels<span><a href="#label-Multiple+Panels">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A design can have multiple panels. Be sure that all panels come
<em>before</em> the <code>.off-canvas-content</code> wrapper—this is
required for the CSS to apply correctly.</p>
...
<p>&lt;button class=“button” type=“button” data-toggle=“offCanvasLeft”&gt;Open
Left Menu&lt;/button&gt; &lt;button class=“button” type=“button”
data-toggle=“offCanvasRight”&gt;Open Right Menu&lt;/button&gt;</p>
<hr>

<h2 id="label-Off-canvas+Transitions">Off-canvas Transitions<span><a href="#label-Off-canvas+Transitions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can switch the default transition of the off-canvas from pushing the
page over as it open to overlapping the page by adding the
<code>data-transition=&quot;overlap&quot;</code> to the
<code>.off-canvas</code>. There are 2 available transitions: push
(<code>data-transition=&quot;push&quot;</code>) which is the default, and
overlap (<code>data-transition=&quot;overlap&quot;</code>).</p>
<div class="primary callout">
...
<pre>&lt;div class=&quot;off-canvas position-left&quot; id=&quot;offCanvasLeftOverlap&quot; data-off-canvas data-transition=&quot;overlap&quot;&gt;
  &lt;!-- Your menu or Off-canvas content goes here --&gt;
&lt;/div&gt;
...
data-toggle=“offCanvasOverlap”&gt;Open Left with Overlap&lt;/button&gt;
&lt;button class=“button” type=“button”
data-toggle=“offCanvasRight”&gt;Open Right with Push&lt;/button&gt;</p>
...
<h2 id="label-Reveal+on+Larger+Screens">Reveal on Larger Screens<span><a href="#label-Reveal+on+Larger+Screens">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The left- and right-hand off-canvas panes can be set to be persistent on
larger screens like a sidebar. Add the class
<code>.reveal-for-medium</code> or <code>.reveal-for-large</code> to the
off-canvas menu. These classes determine what breakpoint the off-canvas
will default open.</p>

<p>The main content area (<code>.off-canvas-content</code>) will be padded to
the left or right equal to the width of the container.</p>
<div class="callout">
...
<pre>&lt;div class=&quot;off-canvas position-left reveal-for-large&quot; data-off-canvas&gt;
  &lt;!-- ... --&gt;
&lt;/div&gt;</pre>

<p>&lt;button type=“button” class=“button” data-docs-example-ofc&gt;Toggle
Reveal Class&lt;/button&gt;</p>
<hr>

<h2 id="label-Combining+with+Title+Bar">Combining with Title Bar<span><a href="#label-Combining+with+Title+Bar">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you need a simple bar to contain your hamburger icon/s and toggle the
off-canvas, <code>.title-bar</code> is here to help. It supports left- and
right-aligned sections. You can add your off-canvas toggle triggers here:</p>
...
<h4 id="label-Off-Canvas+-28Putting+it+all+together-29">Off-Canvas (Putting it all together)<span><a href="#label-Off-Canvas+-28Putting+it+all+together-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>For an example of off-canvas, checkout this top bar with off-canvas
navigation and dropdowns for submenus building block: <a
href="http://foundation.zurb.com/building-blocks/blocks/multilevel-offcanvas-menu.html">foundation.zurb.com/building-blocks/blocks/multilevel-offcanvas-menu.html</a></p>
<hr>

<h2 id="label-In-Canvas+to+Off-Canvas">In-Canvas to Off-Canvas<span><a href="#label-In-Canvas+to+Off-Canvas">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>With this feature you can have a standard page element move off-canvas at a
particular breakpoint. Use the new class
<code>.in-canvas-for-[BREAKPOINT]</code> for this. This differs from the
&lt;a href=“#reveal-on-larger-screens”&gt;Reveal on Larger
Screens&lt;/a&gt; feature it doesn&#39;t actually open the off-canvas for
specific screen sizes but overrides the off-canvas styles so it behaves as
a regular page element. This way you can place an element anywhere on the
page and move it into off-canvas for e.g. small screens.</p>

<pre>&lt;button type=&quot;button&quot; class=&quot;button hide-for-large&quot; data-toggle=&quot;inCanvasExample&quot;&gt;
...
<h2 id="label-Nested+Off-Canvas">Nested Off-Canvas<span><a href="#label-Nested+Off-Canvas">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>In v6.4 the off-canvas component has been heavily extended. Apart from the
&lt;a href=“#in-canvas”&gt;In-Canvas&lt;/a&gt; feature it is now possible
to nest the element in the content instead of using it only as a sibling.
This is handy if you want to use the same element e.g. for small screens as
off-canvas and for large screens as usual page element without duplicate
content.</p>

<p>Another improvement is the support of several off-canvas elements that
share the same position e.g. two elements with <code>position-left</code>.</p>

<p>Advanced off-canvas users may use the new <code>contentId</code> option to
bind an element to a content. This lets you place the element much more
flexibly as it may be a sibling of the content, a child or none of it.<br>
&lt;strong&gt;Important:&lt;/strong&gt; when using the
<code>contentId</code> on a nested element you must also use the new
<code>nested</code> option and tell the JavaScript it&#39;s nested!</p>
<div class="callout warning">
  <p>Please note that it's not possible to use the push transition for a nested off-canvas element.</p>
</div>
<pre>&lt;button type=&quot;button&quot; class=&quot;button&quot; data-toggle=&quot;offCanvasNestedPush&quot;&gt;
...
&lt;p&gt;Enim, repudiandae officia dolores temporibus soluta, ipsa saepe tempora ipsum laudantium in mollitia quidem, nisi magni provident hic architecto rem culpa beatae.&lt;/p&gt;</pre>
<hr>

<h2 id="label-Off-canvas+Sizes">Off-canvas Sizes<span><a href="#label-Off-canvas+Sizes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>In v6.4.2 the type of the off-canvas size variables has changed from number
to map. This lets you define breakpoint specific sizes instead of one value
for all. The map may contain every key that is defined in
<code>$breakpoint-classes</code>.</p>
...
<h2 id="label-Migrating+from+versions+prior+to+v6.4">Migrating from versions prior to v6.4<span><a href="#label-Migrating+from+versions+prior+to+v6.4">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you&#39;re upgrading from v6.3 there&#39;s nothing to do unless you
haven&#39;t changed the default value of <code>$offcanvas-shadow</code>.
Prior to v6.4 this variable was used for both, overlap and push off-canvas
elements. Now it&#39;s only used for the overlap element whereas the push
element uses two new variables:</p>
<ul><li>
<p><code>$offcanvas-inner-shadow-size</code> which is a number (mostly px)</p>
</li><li>
<p><code>$offcanvas-inner-shadow-color</code> which is a color (mostly rgba)</p>
</li></ul>

<p>So if you have changed the default off-canvas shadow you have to adjust the
value of these variables in your settings.</p>
<hr>

<h2 id="label-Migrating+from+versions+prior+to+v6.3">Migrating from versions prior to v6.3<span><a href="#label-Migrating+from+versions+prior+to+v6.3">&para;</a> <a href="#top">&uarr;</a></span></h2>
<div class="primary callout">
...
<p>The default off-canvas position has changed from absolute to fixed. This
will likely be the position you want since the menu is in view when opened
regardless of the scroll position. You can choose the off-canvas position
back to absolute using the built in classes:</p>
<ul><li>
<p><code>.is-overlay-absolute</code></p>
</li><li>
<p><code>.is-overlay-fixed</code></p>
</li></ul>

<p>Or in globally in the _settings.scss, set the
<code>$offcanvas-fixed-reveal</code> variable to
<code>false</code>.&lt;/p&gt;</p>
...
<h3 id="label-Pre+6.3+Off-canvas+Setup">Pre 6.3 Off-canvas Setup<span><a href="#label-Pre+6.3+Off-canvas+Setup">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To start, create two wrappers to house the page. These are necessary to
prevent the off-canvas panels from being visible when they&#39;re not open.
They also smooth out cross-browser bugs. - The outer wrapper has the class
<code>.off-canvas-wrapper</code>. - The inner wrapper has the class
<code>.off-canvas-wrapper-inner</code> and the attribute
<code>data-off-canvas-wrapper</code>.</p>
...
<p>Inside these wrappers, create an off-canvas panel with the class
<code>.off-canvas</code> and the attribute <code>data-off-canvas</code>.
The panel also needs a positioning class, which can be
<code>.position-left</code> or <code>.position-right</code>, and an
attribute set for the position, <code>data-position=&quot;left&quot;</code>
or <code>data-position=&quot;right&quot;</code>. Last, make sure the
off-canvas panel has a unique ID so it can be targeted.</p>

<p>Along with the panel, the main content of your page will be housed in its
own container with the class <code>.off-canvas-content</code> and attribute
<code>data-off-canvas-content</code>. You will be putting your actual page
content inside a class of <code>.off-canvas-content</code>.)</p>
