...
<title>panini - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-+docs-3A+https-3A-2F-2Fgithub.com-2Fzurb-2Fpanini"> docs: <a href="https://github.com/zurb/panini">github.com/zurb/panini</a></a>
    <li><a href="#label-Basics-3A+Templates+-26+Pages">Basics: Templates &amp; Pages</a>
    <li><a href="#label-Partials">Partials</a>
    <li><a href="#label-Page+Variables">Page Variables</a>
    <li><a href="#label-page">page</a>
    <li><a href="#label-root">root</a>
    <li><a href="#label-Helpers">Helpers</a>
    <li><a href="#label-ifequal">ifequal</a>
    <li><a href="#label-ifpage">ifpage</a>
    <li><a href="#label-unlesspage">unlesspage</a>
    <li><a href="#label-repeat">repeat</a>
    <li><a href="#label-markdown">markdown</a>
    <li><a href="#label-Custom+Helpers">Custom Helpers</a>
    <li><a href="#label-Custom+Data">Custom Data</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/pages/panini.md">

<p>— title: Panini description: A flat file compiler that powers our
prototyping template. Create pages with consistent layouts and reusable
partials with ease. video: &#39;t_ekdBMj4cc&#39; library:  github: <a
href="https://github.com/zurb/panini">github.com/zurb/panini</a></p>

<h2 id="label-+docs-3A+https-3A-2F-2Fgithub.com-2Fzurb-2Fpanini"> docs: <a href="https://github.com/zurb/panini">github.com/zurb/panini</a><span><a href="#label-+docs-3A+https-3A-2F-2Fgithub.com-2Fzurb-2Fpanini">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>{{{{raw}}}}</p>

<p>If you&#39;ve ever created a static site, maybe you had five pages that all
shared the same header and footer. You create your first page, and then
copy and paste the common elements to the next page. But now if you need to
make a change to the header, the change has to be made across multiple
files.</p>

<p>Panini is a flat file compiler that uses the concepts of templates, pages,
and partials—powered by the <a
href="http://handlebarsjs.com/">Handlebars</a> templating language—to
streamline the process of creating static prototypes.</p>

<p>Our <a href="starter-projects.html">prototyping template</a> uses Panini,
along with a host of other tools for processing Sass, JavaScript, and
images, to make creating static prototypes easy. It&#39;s already been
configured to utilize all of the features below, but if you want to learn
the specifics of how to configure the library, head over to the <a
href="https://github.com/zurb/panini">Panini GitHub page</a>.</p>
<hr>

<h2 id="label-Basics-3A+Templates+-26+Pages">Basics: Templates &amp; Pages<span><a href="#label-Basics-3A+Templates+-26+Pages">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A <strong>template</strong> is a common layout that every page in your
design shares. It&#39;s possible to have multiple templates, but generally
you&#39;ll only need one, and a page can only use one template. In the
prototyping template, the default layout is found under
<code>src/layouts/default.html</code>.</p>
...
<p>In the middle of the HTML is a bit of Handlebars code: <code>{{&gt;
body}}</code>. This is where the pages you write are injected when Panini
runs, giving you a series of complete HTML files at the end.</p>

<p>The <strong>pages</strong> make up the guts of your layouts. These files
will just have the middle section of the design, since the layout already
covers the top and bottom. The prototyping template includes one blank page
to get you started, under <code>src/pages/index.html</code>.</p>

<p>A basic page might look like this:</p>

<pre>&lt;h1&gt;Page Title&lt;/h1&gt;
&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium ducimus eligendi, reiciendis corporis quam facere quaerat qui, aspernatur molestiae velit, vero ea quisquam laborum corrupti repudiandae totam, at aliquam esse.&lt;/p&gt;</pre>

<p>Note that there&#39;s no <code>&lt;html&gt;</code> or
<code>&lt;body&gt;</code> tags, and no header or footer. This code will be
injected into the <code>{{&gt; body}}</code> declaration when Panini
assembles your pages.</p>

<p>In the prototyping template, these finished files are compiled into a
standalone folder called <code>dist</code> (short for “distribution”),
which also includes your processed CSS, JavaScript, and images. This folder
can easily be uploaded to any web server, or Notable&#39;s <a
href="http://zurb.com/notable/features/hosted">Hosted Prototypes</a>
service.</p>
<hr>

<h2 id="label-Partials">Partials<span><a href="#label-Partials">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Partials are a feature of Handlebars which allow you to inject HTML
anywhere in a page or layout. They&#39;re really useful when you need to
repeat certain chunks of code throughout your pages, or to keep individual
files from getting too cluttered with HTML.</p>

<p>Here&#39;s an example of a layout file that divides its key sections into
partials:</p>
...
<p>The <code>{{&gt; }}</code> syntax tells Handlebars to look for an HTML file
with that name, and inject it at that place. In this example, we have files
called <code>header.html</code>, <code>navigation.html</code>, and
<code>footer.html</code>. In the prototyping template, these files all
exist within <code>src/partials</code>.</p>
<hr>

<h2 id="label-Page+Variables">Page Variables<span><a href="#label-Page+Variables">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Pages have a few built-in variables, which can be used within the page
template itself, or within a layout or partial being used in tandem with
the page.</p>

<h3 id="label-page">page<span><a href="#label-page">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Prints the name of the current page, without its original file extension.
In the below example, if the page is <code>index.html</code>,
<code>{{page}}</code> will become <code>index</code>.</p>

<pre>&lt;p&gt;You are here: {{page}}&lt;/p&gt;</pre>

<h3 id="label-root">root<span><a href="#label-root">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Use <code>{{root}}</code> before a file path to make sure it works no
matter what folder the current page is in.</p>

<p>For example, a path to an external CSS file will need to be different if
the current page is at the root level of your site, or in a sub-folder.</p>

<p>Here&#39;s how you&#39;d use it with a <code>&lt;link&gt;</code> tag:</p>

<pre>&lt;link rel=&quot;stylesheet&quot; href=&quot;{{root}}assets/css/app.css&quot;&gt;</pre>

<p>If the page is <code>index.html</code>, the path will look like this:</p>

<pre>&lt;link rel=&quot;stylesheet&quot; href=&quot;assets/css/app.css&quot;&gt;</pre>

<p>If the page is <code>folder/page.html</code>, the path will look like this:</p>

<pre>&lt;link rel=&quot;stylesheet&quot; href=&quot;../assets/css/app.css&quot;&gt;</pre>

<p>The <code>../</code> is added only on pages in a sub-folder, so the CSS can
still be properly loaded.</p>
<hr>

<h2 id="label-Helpers">Helpers<span><a href="#label-Helpers">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Helpers are special functions that manipulate content on the page. In
addition to <a
href="http://handlebarsjs.com/builtin_helpers.html">Handlebars’s built-in
helpers</a>, Panini includes a few custom helpers and you can add your own.</p>

<h3 id="label-ifequal">ifequal<span><a href="#label-ifequal">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Displays the HTML inside the helper if the two values are equal.
<code>handlebars {{#ifequal foo bar}}   &lt;p&gt;foo and bar are
equal&lt;/p&gt; {{else}}   &lt;p&gt;foo and bar are not equal}}  
{{/ifequal}} </code></p>

<h3 id="label-ifpage">ifpage<span><a href="#label-ifpage">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Displays the HTML inside the helper only on specific pages. In the below
example, the HTML inside the helper will only show up on the
...
<p>You can also check for multiple pages. If <em>any</em> name in the list
matches the current page, the HTML will appear.</p>

<pre>{{#ifpage &#39;index&#39; &#39;about&#39;}}
  &lt;p&gt;This is definitely either the Index or About page.&lt;/p&gt;
{{/ifpage}}</pre>

<h3 id="label-unlesspage">unlesspage<span><a href="#label-unlesspage">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The opposite of <code>#ifpage</code>, <code>#unlesspage</code> will only
display the HTML inside of it if the current page is <em>not</em> in the
parameters.</p>

<pre>{{#unlesspage &#39;index&#39;}}
  &lt;p&gt;This is definitely &lt;em&gt;not&lt;/em&gt; the Index page.&lt;/p&gt;
{{/unlesspage}}</pre>

<h3 id="label-repeat">repeat<span><a href="#label-repeat">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Repeats the content inside of it <code>n</code> number of times. Use this
to easily print lots of duplicate HTML in a prototype.</p>
...
<h3 id="label-markdown">markdown<span><a href="#label-markdown">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Converts Markdown into HTML.</p>
...
<h3 id="label-Custom+Helpers">Custom Helpers<span><a href="#label-Custom+Helpers">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you don&#39;t see the right helper, you can write your own. Add a
javascript file to &#39;src/helpers&#39;, add <code>helpers:
&#39;src/helpers&#39;</code> to the Panini process in your
gulpfile.babel.js, restart npm, then call it in your templates.</p>

<pre>// Example file src/helpers/bold.js
...
<p>Then in your projects call your custom <code>{{#bold}}</code> helper</p>

<pre>{{#bold}}ideas{{/bold}}</pre>
<hr>

<h2 id="label-Custom+Data">Custom Data<span><a href="#label-Custom+Data">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Custom data can be added to your pages. This data can then be inserted into
your HTML through Handlebars. There are two ways to add data to a project.</p>

<p>To add variables to a specific page only, add it at the top of the
page&#39;s HTML as a <a href="http://jekyllrb.com/docs/frontmatter/">Front
Matter</a> block. Let&#39;s say the below content is inside
<code>src/pages/index.html</code>.</p>
...
&lt;!-- The rest of your HTML is down here. --&gt;</pre>

<p>Now, you can insert the values of these variables into the
<code>index.html</code> page, <em>or</em> the <code>default.html</code>
layout. To insert a variable, wrap the name of the variable in double curly
braces, like so:</p>

<pre>&lt;h1&gt;{{ title }}&lt;/h1&gt;</pre>

<p>Variables can also be added globally by creating an external JSON or YML
file, and adding it to the <code>src/data</code> folder in your project.
Let&#39;s create a file called <code>breakfast.yml</code>:</p>

<pre class="ruby"><span class="ruby-operator">-</span> <span class="ruby-identifier">eggs</span>
<span class="ruby-operator">-</span> <span class="ruby-identifier">bacon</span>
<span class="ruby-operator">-</span> <span class="ruby-identifier">toast</span>
</pre>

<p>Panini will load in the contents of this YML file as a variable called
<code>{{ breakfast }}</code>. Because it&#39;s an array, we can loop
through it using Handlebars&#39;s <code>{{#each}}</code> helper:</p>

<pre>&lt;ul class=&quot;breakfast-items&quot;&gt;
  {{#each breakfast}}
    &lt;li&gt;{{ this }}&lt;/li&gt;
  {{/each}}
&lt;/ul&gt;</pre>

<p>This code will print three <code>&lt;li&gt;</code>s, one for each item in
the file.</p>
