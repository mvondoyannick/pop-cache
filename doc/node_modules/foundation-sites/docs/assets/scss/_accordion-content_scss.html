...
<title>_accordion-content.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/_accordion-content.scss">

<p>.welcome-accordion {</p>

<pre>margin-top: 3rem;
margin-bottom: 3rem;</pre>

<p>}</p>

<p>.welcome-accordion-item {</p>
...
<p>.welcome-accordion-item:last-child {</p>
...
<pre>font-family: &quot;Proxima Nova&quot;, Helvetica, Arial, sans-serif;
margin-bottom: 2rem;</pre>

<p>}</p>

<p>.docs-component .accordion-content-item-divider {</p>

<pre>border-bottom: 1px dashed #e5e5e5;
margin-bottom: 0;</pre>

<p>}</p>

<p>.accordion-content-item-thumbnail {</p>
...
<p>.accordion-content-item-cta {</p>
...
<p>// Prevent FOUC on nav accordion .accordion-content.is-active {</p>
