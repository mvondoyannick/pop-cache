...
<title>_docs-footer.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/_docs-footer.scss">

<p>.footer-nav {</p>

<pre>@include flex-grid-row;
align-items: center;
...
<p>.footer-nav-left, .footer-nav-right {</p>

<pre>@include flex-grid-column(shrink);
color: $white;
...
<pre>@media screen and (min-width: 40em) and (max-width: 76.5em) {
  order: 3;
  display: flex;
  margin-left: 1rem;
}
...
<pre>color: darken($white, 20%);
font-size: 1rem;
padding-top: 1rem;</pre>

<p>}</p>

<p>.footer-nav-center {</p>

<pre>@include flex-grid-column;
...
<p>// contact .footer-contact {</p>

<pre>background-color: $foundation-dark;
...
<p>.homepage-section-title {</p>

<pre>font-size: 4.4rem;
font-weight: 800;
letter-spacing: -1px;
line-height: 1.1em;
margin-top: 0;
...
<p>.form-contact-form-button {</p>

<pre>margin-top: 1rem;</pre>

<p>}</p>

<p>.homepage-section-subtitle-divider {</p>

<pre>border-bottom: 2px solid $foundation-dark;
display: block;
margin-bottom: 2.5rem;
width: 4rem;
...
<p>.homepage-section-subtitle {</p>

<pre>color: $foundation-dark;
font-size: 1rem;
font-weight: 600;
letter-spacing: 1px;
...
<p>.home-form-submit-button {</p>

<pre>font-size: 1.25rem;
font-weight: 600;
background: $white;
color: $foundation-dark;</pre>

<p>}</p>

<p>// Responsive newsletter callout above the footer.</p>

<p>.newsletter-signup-inner {</p>
