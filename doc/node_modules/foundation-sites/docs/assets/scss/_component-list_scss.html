...
<title>_component-list.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/_component-list.scss">

<p>.docs-nav {</p>

<pre>padding-top: 1rem;
border-right: 1px solid #efefef;</pre>

<p>}</p>

<p>.docs-nav .docs-nav-category {</p>
...
<p>.docs-nav a:hover {</p>

<pre>background: none;</pre>

<p>}</p>

<p>.docs-nav a:focus {</p>

<pre>background: none;</pre>

<p>}</p>

<p>.docs-nav .current a {</p>
...
<p>.docs-nav-version-container {</p>
