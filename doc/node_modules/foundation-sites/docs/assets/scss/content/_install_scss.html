...
<title>_install.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/content/_install.scss">

<p>.docs-install-vendor-icon {</p>

<pre>min-height: rem-calc(64px);
max-width: rem-calc(64px);</pre>
