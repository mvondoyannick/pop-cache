...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/examples/_grid.scss">

<p>// Grid .row.display {</p>
...
<p>// Flex Grid [id^=“docs-flex”].docs-component .docs-code-live {</p>

<pre>@include foundation-flex-grid;
...
<p>// XY Grid &amp; Flexbox Utilities [id^=“docs-xy”].docs-component
.docs-code-live, [id^=“docs-flexbox-utilities”].docs-component
.docs-code-live {</p>
...
<p>$button-responsive-expanded: true;</p>
</main>
