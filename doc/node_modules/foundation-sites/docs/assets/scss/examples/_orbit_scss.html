...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/examples/_orbit.scss">

<p>// Examples for the Orbit documentation.</p>

<p>.docs-example-orbit-slide {</p>

<pre>padding: 2rem 4rem;
color: $white;
