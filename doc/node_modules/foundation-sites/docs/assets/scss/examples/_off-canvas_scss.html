...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/scss/examples/_off-canvas.scss">

<p>body &gt; .off-canvas {</p>

<pre>padding-top: 2rem;</pre>

<p>}</p>

<p>.docs-example-burger {</p>

<pre>@include hamburger;</pre>
