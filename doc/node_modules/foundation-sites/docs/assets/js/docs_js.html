...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/js/docs.js">

<p>$(document).foundation();</p>

<p>// [TODO] Remove this when possible $(function() {</p>
...
<pre>$(&#39;[data-docs-version]&#39;).text(&#39;v&#39; + Foundation.version);</pre>

<p>});</p>

<p>var ACCORDION_KEY = &#39;docs-accordion-expandall&#39;; var expandAccordion
= function($a) {</p>

<pre>$a.parent(&#39;.accordion&#39;).find(&#39;.accordion-item, .accordion-content&#39;).addClass(&#39;is-active&#39;);
$a.text(&#39;Collapse&#39;);
$a.data(&#39;expandAll&#39;, false);
if(localStorage) { localStorage.setItem(ACCORDION_KEY, &#39;true&#39;); }</pre>

<p>};</p>

<p>var contractAccordion = function($a) {</p>

<pre>$a.parent(&#39;.accordion&#39;).find(&#39;.accordion-item, .accordion-content&#39;).removeClass(&#39;is-active&#39;);
$a.text(&#39;Expand&#39;);
$a.data(&#39;expandAll&#39;, true);
if(localStorage) { localStorage.setItem(ACCORDION_KEY, &#39;false&#39;); }</pre>

<p>};</p>

<p>$(&#39;[data-expand-all]&#39;).on(&#39;click&#39;, function() {</p>
...
<p>if(localStorage.getItem(ACCORDION_KEY) === &#39;true&#39;) {</p>

<pre>expandAccordion($(&#39;[data-expand-all]&#39;));</pre>

<p>} else {</p>

<pre>$(&#39;[data-expand-all]&#39;).text(&#39;Expand&#39;);</pre>
