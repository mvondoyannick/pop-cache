...
<main role="main" aria-label="Page node_modules/foundation-sites/docs/assets/img/gulpfile.js">

<p>var $      = require(&#39;gulp-load-plugins&#39;)(); var argv   =
require(&#39;yargs&#39;).argv; var gulp   = require(&#39;gulp&#39;); var
rimraf = require(&#39;rimraf&#39;); var panini = require(&#39;panini&#39;);
var sequence = require(&#39;run-sequence&#39;);</p>

<p>// Check for –production flag var isProduction = !!(argv.production);</p>

<p>// File paths to various assets are defined here. var paths = {</p>
...
<p>// Delete the “dist” folder // This happens every time a build starts
gulp.task(&#39;clean&#39;, function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">rimraf</span>(<span class="ruby-string">&#39;./dist&#39;</span>, <span class="ruby-identifier">done</span>);
</pre>

<p>});</p>

<p>// Copy files out of the assets folder // This task skips over the “img”,
“js”, and “scss” folders, which are parsed separately
gulp.task(&#39;copy&#39;, function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-identifier">paths</span>.<span class="ruby-identifier">assets</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;./dist/assets&#39;</span>));
</pre>

<p>}); gulp.task(&#39;downloads&#39;, function(done){</p>

<pre class="ruby"><span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;src/downloads/**/*.*&#39;</span>)
    .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;./dist/downloads&#39;</span>));
    <span class="ruby-identifier">done</span>();
</pre>

<p>});</p>

<p>// Copy page templates into finished HTML files gulp.task(&#39;pages&#39;,
function() {</p>

<pre>gulp.src(&#39;./src/pages/**/*.html&#39;)
  .pipe(panini({
    root: &#39;./src/pages/&#39;,
    layouts: &#39;./src/layouts/&#39;,
...
<p>gulp.task(&#39;pages:reset&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">panini</span>.<span class="ruby-identifier">refresh</span>();
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">run</span>(<span class="ruby-string">&#39;pages&#39;</span>);
</pre>

<p>});</p>

<p>// Compile Sass into CSS // In production, the CSS is compressed
gulp.task(&#39;sass&#39;, function() {</p>

<pre>var uncss = $.if(isProduction, $.uncss({
  html: [&#39;src/**/*.html&#39;],
  ignore: [
    new RegExp(&#39;^meta\..*&#39;),
    new RegExp(&#39;^\.is-.*&#39;)
...
return gulp.src(&#39;./src/assets/scss/app.scss&#39;)
  ...
  // .pipe(uncss)
  .pipe(gulp.dest(&#39;./dist/assets/css&#39;));</pre>

<p>});</p>

<p>// Combine JavaScript into one file // In production, the file is minified
gulp.task(&#39;javascript&#39;, function() {</p>

<pre>var uglify = $.if(isProduction, $.uglify({
    mangle: false
  })
  .on(&#39;error&#39;, function (e) {
    console.log(e);
...
return gulp.src(paths.javascript)
  .pipe($.concat(&#39;app.js&#39;))
  .pipe(uglify)
  .pipe(gulp.dest(&#39;./dist/assets/js&#39;));</pre>

<p>});</p>

<p>// Compiles HTML templates into JST gulp.task(&#39;jst&#39;, function() {</p>

<pre>gulp.src(&#39;src/templates/*.html&#39;)
...
<p>// Copy images to the “dist” folder // In production, the images are
compressed gulp.task(&#39;images&#39;, function() {</p>

<pre>var imagemin = $.if(isProduction, $.imagemin({
  progressive: true
}));

return gulp.src(&#39;./src/assets/img/**/*&#39;)
  // .pipe(imagemin)
  .pipe(gulp.dest(&#39;./dist/assets/img&#39;));</pre>

<p>});</p>

<p>// Deploy to the live server gulp.task(&#39;deploy&#39;, [&#39;build&#39;],
function() {</p>

<pre>return gulp.src(&#39;./dist/**&#39;)
...
<p>// Build the “dist” folder by running all of the above tasks
gulp.task(&#39;build&#39;, function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">sequence</span>(<span class="ruby-string">&#39;clean&#39;</span>, [<span class="ruby-string">&#39;pages&#39;</span>, <span class="ruby-string">&#39;sass&#39;</span>, <span class="ruby-string">&#39;javascript&#39;</span>, <span class="ruby-string">&#39;images&#39;</span>, <span class="ruby-string">&#39;jst&#39;</span>, <span class="ruby-string">&#39;downloads&#39;</span>], <span class="ruby-identifier">done</span>);
</pre>

<p>});</p>

<p>// Start a server with LiveReload to preview the site in
gulp.task(&#39;server&#39;, [&#39;build&#39;], function() {</p>
...
<p>// Build the site, run the server, and watch for file changes
gulp.task(&#39;default&#39;, [&#39;build&#39;, &#39;server&#39;],
function() {</p>

<pre class="ruby"><span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>(<span class="ruby-identifier">paths</span>.<span class="ruby-identifier">assets</span>, [<span class="ruby-string">&#39;copy&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;./src/pages/**/*.html&#39;</span>], [<span class="ruby-string">&#39;pages&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;./src/{layouts,partials}/**/*.html&#39;</span>], [<span class="ruby-string">&#39;pages:reset&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;./src/assets/scss/**/*.scss&#39;</span>], [<span class="ruby-string">&#39;sass&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;./src/assets/js/**/*.js&#39;</span>], [<span class="ruby-string">&#39;javascript&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;node_modules/foundation-sites/dist/foundation.js&#39;</span>], [<span class="ruby-string">&#39;javascript&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;./src/assets/img/**/*&#39;</span>], [<span class="ruby-string">&#39;images&#39;</span>]);
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;./src/templates/**/*&#39;</span>], [<span class="ruby-string">&#39;jst&#39;</span>]);
</pre>
