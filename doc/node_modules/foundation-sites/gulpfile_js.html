...
<main role="main" aria-label="Page node_modules/foundation-sites/gulpfile.js">

<p>var gulp = require(&#39;gulp&#39;); var browser =
require(&#39;browser-sync&#39;); var requireDir =
require(&#39;require-dir&#39;); var forwardReference =
require(&#39;undertaker-forward-reference&#39;); var port =
process.env.SERVER_PORT || 3000;</p>

<p>// Make Gulp accepting reference to tasks that are not declared yet, like
in v3. gulp.registry(forwardReference());</p>

<p>requireDir(&#39;./gulp/tasks&#39;);</p>

<p>function browserReloadSync(done) {</p>

<pre class="ruby"><span class="ruby-identifier">browser</span>.<span class="ruby-identifier">reload</span>();
<span class="ruby-identifier">done</span>();
</pre>

<p>}</p>

<p>// Builds the documentation and framework files gulp.task(&#39;build&#39;,
gulp.series(&#39;clean&#39;, &#39;copy&#39;, &#39;sass&#39;,
&#39;javascript&#39;, &#39;lint:graceful&#39;, &#39;docs:all&#39;));</p>

<p>// Starts a BrowerSync instance gulp.task(&#39;serve&#39;,
gulp.series(&#39;build&#39;, function(done){</p>

<pre class="ruby"><span class="ruby-identifier">browser</span>.<span class="ruby-identifier">init</span>({<span class="ruby-value">server:</span> <span class="ruby-string">&#39;./_build&#39;</span>, <span class="ruby-value">port:</span> <span class="ruby-identifier">port</span>});
<span class="ruby-identifier">done</span>();
</pre>

<p>}));</p>

<p>// Watch files for changes gulp.task(&#39;watch&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>(<span class="ruby-string">&#39;docs     &#39;</span>, <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;docs&#39;</span>, <span class="ruby-identifier">browserReloadSync</span>));
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;docs/layout/*.html&#39;</span>, <span class="ruby-string">&#39;docs/partials/*{html,hbs}&#39;</span>, <span class="ruby-string">&#39;docs/assets/partials/*{html,hbs}&#39;</span>, <span class="ruby-string">&#39;node_modules/foundation-docs/templates/*{html,hbs}&#39;</span>], <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;docs:all&#39;</span>, <span class="ruby-identifier">browserReloadSync</span>));
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>(<span class="ruby-string">&#39;scss/   *&#39;</span>, <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;sass&#39;</span>, <span class="ruby-identifier">browserReloadSync</span>));
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;docs/assets/scss/   *&#39;</span>, <span class="ruby-string">&#39;node_modules/foundation-docs/scss/**/*&#39;</span>], <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;sass:docs&#39;</span>, <span class="ruby-identifier">browserReloadSync</span>));
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>(<span class="ruby-string">&#39;js/**/*&#39;</span>, <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;javascript:foundation&#39;</span>, <span class="ruby-identifier">browserReloadSync</span>));
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;docs/assets/js/**/*&#39;</span>, <span class="ruby-string">&#39;node_modules/foundation-docs/js/**/*&#39;</span>], <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;javascript:docs&#39;</span>, <span class="ruby-identifier">browserReloadSync</span>));
</pre>

<p>});</p>

<p>// Runs all of the above tasks and then waits for files to change
