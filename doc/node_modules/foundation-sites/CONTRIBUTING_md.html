...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Foundation+Contributing+Guidelines">Foundation Contributing Guidelines</a>
    <li><a href="#label-Issues">Issues</a>
    <li><a href="#label-Report+a+bug">Report a bug</a>
    <li><a href="#label-Request+for+a+new+feature">Request for a new feature</a>
    <li><a href="#label-Contributions">Contributions</a>
    <li><a href="#label-Git+Workflow">Git Workflow</a>
    <li><a href="#label-Coding+Standards">Coding Standards</a>
    <li><a href="#label-Core+Team">Core Team</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/CONTRIBUTING.md">

<h1 id="label-Foundation+Contributing+Guidelines">Foundation Contributing Guidelines<span><a href="#label-Foundation+Contributing+Guidelines">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Although Foundation was built and maintained by ZURB for years, it is today
a community project. Whether it’s bug fixing, feature development, or
contributions to the ecosystem, designers and developers from all over the
world help make Foundation the most advanced framework in the world.</p>

<h2 id="label-Issues">Issues<span><a href="#label-Issues">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>For <strong>bugs</strong>, <strong>feature requests</strong>,
<strong>incorrect documentation</strong> or any problem you have with
Foundation, you can open a new issue. If you need help to use Foundation,
the <a href="https://foundation.zurb.com/forum">Foundation Forum</a> would
be more appropriate. If you aren&#39;t sure if your issue is a bug or not,
don’t worry! Post your problem on GitHub and the team will help you along.</p>

<p>Every participant is expected to follow the project&#39;s <a
href="code-of-conduct.md">Code of Conduct</a> so please be courteous and
respectful.</p>

<h3 id="label-Report+a+bug">Report a bug<span><a href="#label-Report+a+bug">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ol><li>
<p><strong>Search for similar opened or closed issues</strong> (<a
href="https://github.com/zurb/foundation-sites/issues?utf8=%E2%9C%93&q=is%3Aissue">link</a>).
It is likely that someone else got the same problem as you before and
already reported it.</p>
</li><li>
<p><strong>Make sure of the following:</strong></p>
</li><li>
<p>[ ] There are no <a
href="https://github.com/zurb/foundation-sites/issues?utf8=%E2%9C%93&q=is%3Aissue">opened
or closed issues</a> similar to this bug</p>
</li><li>
<p>[ ] This is a bug and not a missing feature</p>
</li><li>
<p>[ ] This bug comes from Foundation and not the browser or an other library</p>
</li><li>
<p>[ ] This bug is still present in the latest Foundation release</p>
</li><li>
<p><strong>Prepare a test case with your bug</strong> (<a
href="https://codepen.io/ncoden/pen/dQmVgg">link</a>).  Trying to reproduce
a bug is often time-consuming. Please isolate your bug in a dedicated test
case. The simpler is the test case, the best it is.</p>
</li><li>
<p><strong>Create your issue</strong> (<a
href="https://github.com/zurb/foundation-sites/issues/new">link</a>). 
Please provide a complete description of your bug: What do you expect? What
happends instead? Which version of Foundation do you use, which ones are
affected by the bug? Keep in mind that someone will spend a lot of time to
understand your issue, make the task easy for him/her.</p>
</li></ol>

<h3 id="label-Request+for+a+new+feature">Request for a new feature<span><a href="#label-Request+for+a+new+feature">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ol><li>
<p><strong>Search for similar opened or closed issues</strong> (<a
href="https://github.com/zurb/foundation-sites/issues?utf8=%E2%9C%93&q=is%3Aissue">link</a>).
It is likely that someone else needed a similar feature as yours and
already requested it.</p>
</li><li>
<p><strong>Make sure of the following:</strong></p>
</li><li>
<p>[ ] There are no <a
href="https://github.com/zurb/foundation-sites/issues?utf8=%E2%9C%93&q=is%3Aissue">opened
or closed issues</a> similar to your request</p>
</li><li>
<p>[ ] This is a missing feature and not a bug</p>
</li><li>
<p><strong>Prepare a clear use case for the requested feature</strong>.  This
will help you to make sure that this is the feature you want, and us to
better understand your needs and how it would benefit to everyone the best
way.</p>
</li><li>
<p><strong>Create your issue</strong> (<a
href="https://github.com/zurb/foundation-sites/issues/new">link</a>). 
Please provide a complete description of the feature you want, the use case
you prepared will help you for that. After you created your issue, if you
feel ready, you can start working on a pull request (please tell us so).
See <a href="#contributions">Contributions</a> below.</p>
</li></ol>

<h2 id="label-Contributions">Contributions<span><a href="#label-Contributions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>All new features and bug fixes should be submitted as pull requests, so the
community can review and discuss them. The rule is the same for everyone,
for new contributors as for Core Team members.</p>

<p>Before working on a bug fix or a new feature, please make sure of the
following: * [ ] <strong>There is no similar pull request that was rejected
or is not merged yet</strong> (<a
href="https://github.com/zurb/foundation-sites/issues?utf8=%E2%9C%93&q=is%3Apr">link</a>).
Add a comment on this pull request otherwise. Explain us why this pull
request is urgent or important to you. * [ ] <strong>There is an open issue
related to this bug or feature</strong>.  Please create one otherwise. It
is often useful to talk about the bug fix or feature and the best way to
implement it before working on it. You can skip this step for obvious
changes (like typo in the documentation).</p>

<p>After you made these checks, please follow these advices to create your
pull requests: 1. <strong>Work on a dedicated Git branch</strong>.  So you
default <code>develop</code> branch stay clean and you can open multiple
Pull Requests at the same time for various issues. See (2) below for the
branch name format. 2. <strong>Use our standard format for branch, commit
and pull request names</strong>.  It must reference the related issue, be
written in the “imperative” form (like if it was completing <code>now the
software should...</code>) and be prefixed by a type (<code>feat</code> for
new feature, <code>fix</code> if you repair something, <code>docs</code>
for documentation, <code>refactor</code> for non-breaking code cleaning,
<code>style</code> for code formatting, <code>tests</code> for unit or
visual tests or <code>chore</code> for boring day-to-day tasks not
affecting the actual code. See the <a
href="https://gist.github.com/stephenparish/9941e89d80e2bc58a153">AngularJs
Git Commit Message Convention</a>). For example: <code>docs: improve
Dropdown usage example #123</code> for commit/pull request names and
<code>docs/dropdown-improve-usage-example-123</code> for the branch name.
3. <strong>Describe everything you did and why in your commit and pull
request body</strong>.  Even if you already mentionned it in the related
issue, please explain what you did and for which reasons. Give references
to related issues, comments, test cases or any useful resources. 4.
<strong>Provide a clear and readable code</strong>.  Make sure that the
code you changed is consistent across components and that anyone can easily
understand its behavior. Split it in abstract functions, avoid code
duplication and add comments when needed. You can open a “work-in-progress”
pull request (prefix it with “[WIP]”) if you need any help with that. 5.
<strong>Make sure that everything works and tests pass</strong>.  You must
absolutely check that everything still works after your changes. Please
also add tests for features you added or uncovered bugs you fixed. See the
<a href="https://github.com/zurb/foundation-sites#testing">Testing</a>
section. 6. <strong>Create your pull request</strong> (<a
href="https://github.com/zurb/foundation-sites/compare">link</a>).  Make
sure it targets the right branch: most often <code>develop</code>, unless
you provide a fix for an older version and it should be
<code>develop-v...</code>. Take a look at our <a href="#git-workflow">Git
Workflow</a> below.</p>

<p>When you submit a pull request, @mention a few people you’d like to help
you review it. Once those people have signed off on it, the pull request
can be merged! Core Team members will handle the merge itself.</p>

<h2 id="label-Git+Workflow">Git Workflow<span><a href="#label-Git+Workflow">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Foundation uses a Git workflow close to the the successful <a
href="http://nvie.com/posts/a-successful-git-branching-model/">GitFlow</a>
branching model, to which we added <code>develop-v...</code> and
<code>master-v...</code> branches to prepare and release patches for older
Foundation versions. Most of the time you will not have to care about this
workflow and can simply open your pull request on <code>develop</code>.</p>

<p>The workflow relies on three branches:</p>
<ul><li>
<p><strong><code>develop</code></strong></p>
</li></ul>

<p>Used to prepare the next minor/major version. It always contains all the
new features and bug fixes, and is the most up-to-date version of
Foundation. Almost every pull request should be opened on this branch
(fixes, features, documentation…). When a new version is released, it is
merged on <code>master</code>, a dedicated <code>develop-v...</code> branch
is created, and <code>develop</code> now targets the next version.</p>
<ul><li>
<p><strong><code>develop-&lt;version&gt;</code></strong></p>
</li></ul>

<p>Used to prepare patches for previous versions. For example:
<code>develop-v6.5</code> to prepare the <code>v6.5.1</code> release. When
a pull request for a bug fix is merged on <code>develop</code> and is
compatible with supported versions, its commits must be added on the
compatible <code>develop-v...</code> branches too. If a fix is not
compatible with <code>develop</code>, a pull request can be opened on the
latest compatible and supported <code>develop-v...</code> branch. When a
new patch is released, it is merged on <code>master-v...</code> and
<code>develop-v...</code> now targets the next patch for this minor
version.</p>
<ul><li>
<p><strong><code>master</code></strong></p>
</li></ul>

<p>The stable branch. It only contains the latest stable version released.
<strong>Do NOT open pull requests on it</strong>.</p>
<ul><li>
<p><strong><code>master-&lt;version&gt;</code></strong></p>
</li></ul>

<p>The stable branch for previous versions. For example:
<code>master-v6.5</code> for stable <code>v6.5.*</code> releases.
<strong>Do NOT open pull requests on it</strong>.</p>

<p>This git workflow was fully adopted as of <code>v6.5</code>, so
<code>v6.4</code> and previous versions are not supported.</p>

<h2 id="label-Coding+Standards">Coding Standards<span><a href="#label-Coding+Standards">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you aren&#39;t sure how a feature should be implemented, we recommend
checking out our <a
href="https://github.com/zurb/foundation-standards">standards document</a>,
which outlines every aspect of writing framework features, from Sass to
JavaScript.</p>

<h2 id="label-Core+Team">Core Team<span><a href="#label-Core+Team">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Want to help us making Foundation the best framework ever? The Core Team is
inviting active community members to join it. If you want to become a
contributor, engage the community on the Foundation Forum, help us close
issues on GitHub, and review pull requests from other contributors.</p>

<p>If you’ve made substantial contributions to a Foundation framework and
haven’t heard from us yet, you can reach out at foundation@zurb.com.</p>

<p>Contributors are expected to:</p>
<ul><li>
<p>Engage the community on GitHub by responding to and tagging issues.</p>
</li><li>
<p>Write pull requests to address bugs and feature requests.</p>
</li><li>
<p>Help in reviewing pull requests from users, contributors, and the Core
Team.</p>
</li><li>
<p>Follow the guidelines outlined in this document.</p>
</li></ul>

<p>Here are some example contributions from some of our awesome team members:</p>
<ul><li>
<p>Colin Marshall converted our Sass unit tests to a newer test runner called
True.</p>
</li><li>
<p>Andy Cochran reworked the CSS for button groups to fix issues with stacking
and border radii.</p>
</li><li>
<p>designerno1 developed the Equalize by Row feature for the Equalizer plugin.</p>
</li></ul>
</main>
