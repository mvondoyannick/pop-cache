...
<main role="main" aria-label="Page node_modules/foundation-sites/test/javascript/lib/utils.js">

<p>(function (global, $) {</p>

<pre>  Try to catch the `do` function every `interval` delay, until it succedes
