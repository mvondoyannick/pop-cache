...
<title>test_sass.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/test/sass/test_sass.js">

<p>var path = require(&#39;path&#39;); var sassTrue =
require(&#39;sass-true&#39;);</p>

<p>// Test Files var breakpointFile = path.join(__dirname,
&#39;_breakpoint.scss&#39;); var colorFile = path.join(__dirname,
&#39;_color.scss&#39;); var selectorFile = path.join(__dirname,
&#39;_selector.scss&#39;); var unitFile = path.join(__dirname,
&#39;_unit.scss&#39;); var valueFile = path.join(__dirname,
&#39;_value.scss&#39;); var componentsFile = path.join(__dirname,
&#39;_components.scss&#39;);</p>

<p>// Run Tests sassTrue.runSass({file: breakpointFile}, describe, it);
sassTrue.runSass({file: colorFile}, describe, it); sassTrue.runSass({file:
selectorFile}, describe, it); sassTrue.runSass({file: unitFile}, describe,
it); sassTrue.runSass({file: valueFile}, describe, it);
sassTrue.runSass({file: componentsFile}, describe, it);</p>
</main>
