...
<title>foundation.es6.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/foundation.es6.js">

<p>import $ from &#39;jquery&#39;;</p>

<p>// Core Foundation Utilities, utilized in a number of places.</p>
...
<pre>const didLoad = document.readyState === &#39;complete&#39;;
...
<p>function ignoreMousedisappear(handler, { ignoreLeaveWindow = false,
ignoreReappear = false } = {}) {</p>

<pre>return function leaveEventHandler(eLeave, ...rest) {
...
<p>// matchMedia() polyfill - Test a CSS media type/query in JS. // Authors
&amp; copyright© 2012: Scott Jehl, Paul Irish, Nicholas Zakas, David
Knight. MIT license /* eslint-disable */ window.matchMedia ||
(window.matchMedia = (function () {</p>

<pre>// For browsers that support matchMedium api such as IE 9 and webkit
...
<p>// Thank you: <a
href="https://github.com/sindresorhus/query-string">github.com/sindresorhus/query-string</a>
function parseStyleToObject(str) {</p>
...
<p>var FOUNDATION_VERSION = &#39;6.5.3&#39;;</p>

<p>// Global Foundation object // This is attached to the window, or used as a
module for AMD/Browserify var Foundation = {</p>
...
<p>window.Foundation = Foundation;</p>

<p>// Polyfill for requestAnimationFrame (function() {</p>

<pre>if (!Date.now || !window.Date.now)
...
<p>} // Polyfill to get the name of a function in IE9 function
functionName(fn) {</p>
...
<pre>if (&#39;true&#39; === str) return true;
else if (&#39;false&#39; === str) return false;
else if (!isNaN(str * 1)) return parseFloat(str);
return str;</pre>

<p>} // Convert PascalCase to kebab-case // Thank you: <a
href="http://stackoverflow.com/a/8955580">stackoverflow.com/a/8955580</a>
function hyphenate(str) {</p>
...
GetExplicitOffsets: GetExplicitOffsets</pre>

<p>};</p>

<p>/**</p>

<pre> Compares the dimensions of an element to a container and determines collision events with container.
 @function
...
return {top: topVal, left: leftVal};</pre>
...
<p>// Functions pulled out to be referenceable from internals function
findFocusable($element) {</p>

<pre>if(!$element) {return false; }
...
<pre>var key = keyCodes[event.which || event.keyCode] || String.fromCharCode(event.which).toUpperCase();
...
<p>const initClasses   = [&#39;mui-enter&#39;, &#39;mui-leave&#39;]; const
activeClasses = [&#39;mui-enter-active&#39;, &#39;mui-leave-active&#39;];</p>

<p>const Motion = {</p>

<pre>animateIn: function(element, animation, cb) {
...
<pre>if ($.spotSwipe.preventDefault) { e.preventDefault(); }
...
<p>const MutationObserver = (function () {</p>
...
<p>const triggers = (el, type) =&gt; {</p>

<pre>el.data(type).split(&#39; &#39;).forEach(id =&gt; {
...
clicked. Triggers.Initializers.addOpenListener = ($elem) =&gt; {</p>
...
allowing it to close a parent component.
Triggers.Initializers.addCloseListener = ($elem) =&gt; {</p>
...
<p>// Elements with [data-toggle] will toggle a plugin that supports it when
clicked. Triggers.Initializers.addToggleListener = ($elem) =&gt; {</p>
...
<p>// Elements with [data-closable] will respond to close.zf.trigger events.
Triggers.Initializers.addCloseableListener = ($elem) =&gt; {</p>
...
<p>// Elements with [data-toggle-focus] will respond to coming in and out of
focus Triggers.Initializers.addToggleFocusListener = ($elem) =&gt; {</p>
...
<p>// More Global/complex listeners and triggers Triggers.Listeners.Global  =
{</p>

<pre>resizeListener: function($nodes) {
...
<p>// Global, parses whole document. Triggers.Initializers.addClosemeListener
...
<pre>let timer, args = Array.prototype.slice.call(arguments, 3);
...
<pre>if(!MutationObserver){ return false; }
...
<p>// Abstract class for providing lifecycle hooks. Expect plugins to define
AT LEAST // {function} _setup (replaces previous constructor), //
{function} _destroy (replaces previous destroy) class Plugin {</p>

<pre>constructor(element, options) {
...
<p>class Abide extends Plugin {</p>
...
<p>class Accordion extends Plugin {</p>
...
<p>class AccordionMenu extends Plugin {</p>
...
<p>class Drilldown extends Plugin {</p>
...
<p>const POSITIONS = [&#39;left&#39;, &#39;right&#39;, &#39;top&#39;,
&#39;bottom&#39;]; const VERTICAL_ALIGNMENTS = [&#39;top&#39;,
&#39;bottom&#39;, &#39;center&#39;]; const HORIZONTAL_ALIGNMENTS =
[&#39;left&#39;, &#39;right&#39;, &#39;center&#39;];</p>

<p>const ALIGNMENTS = {</p>
...
<p>class Positionable extends Plugin {</p>
...
<p>class Dropdown extends Positionable {</p>
...
<p>class DropdownMenu extends Plugin {</p>
...
<p>class Equalizer extends Plugin {</p>
...
<p>class Interchange extends Plugin {</p>
...
<p>class SmoothScroll extends Plugin {</p>
...
<p>class Magellan extends Plugin {</p>
...
<p>class OffCanvas extends Plugin {</p>
...
<p>class Orbit extends Plugin {</p>
...
<pre>// import &quot;foundation.util.triggers.js&quot;;</pre>
...
<p>class ResponsiveMenu extends Plugin {</p>
...
<p>class ResponsiveToggle extends Plugin {</p>
...
<p>class Reveal extends Plugin {</p>
...
<p>class Slider extends Plugin {</p>
...
<p>class Sticky extends Plugin {</p>
...
<p>class Toggler extends Plugin {</p>
...
<p>class Tooltip extends Positionable {</p>
...
<p>// The plugin matches the plugin classes with these plugin instances. var
MenuPlugins$1 = {</p>
...
<p>class ResponsiveAccordionTabs extends Plugin{</p>
...
<p>Foundation.addToJquery($);</p>

<p>// Add Foundation Utils to Foundation global namespace for backwards //
compatibility. Foundation.rtl = rtl; Foundation.GetYoDigits = GetYoDigits;
Foundation.transitionend = transitionend; Foundation.RegExpEscape =
RegExpEscape; Foundation.onLoad = onLoad;</p>

<p>Foundation.Box = Box; Foundation.onImagesLoaded = onImagesLoaded;
Foundation.Keyboard = Keyboard; Foundation.MediaQuery = MediaQuery;
Foundation.Motion = Motion; Foundation.Move = Move; Foundation.Nest = Nest;
Foundation.Timer = Timer;</p>

<p>// Touch and Triggers previously were almost purely sede effect driven, //
so no need to add it to Foundation, just init them. Touch.init($);
Triggers.init($, Foundation); MediaQuery._init();</p>
...
ResponsiveAccordionTabs }; //# sourceMappingURL=foundation.es6.js.map</p>
</main>
