...
<title>foundation.cjs.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/foundation.cjs.js">

<p>&#39;use strict&#39;;</p>

<p>Object.defineProperty(exports, &#39;__esModule&#39;, { value: true });</p>

<p>function _interopDefault (ex) { return (ex &amp;&amp; (typeof ex ===
&#39;object&#39;) &amp;&amp; &#39;default&#39; in ex) ? <a
href="'default'">ex</a> : ex; }</p>

<p>var $ = _interopDefault(require(&#39;jquery&#39;));</p>

<p>function _typeof(obj) {</p>

<pre>if (typeof Symbol === &quot;function&quot; &amp;&amp; typeof Symbol.iterator === &quot;symbol&quot;) {
...
<p>function _defineProperties(target, props) {</p>

<pre>for (var i = 0; i &lt; props.length; i++) {
...
<p>function _createClass(Constructor, protoProps, staticProps) {</p>

<pre>if (protoProps) _defineProperties(Constructor.prototype, protoProps);
if (staticProps) _defineProperties(Constructor, staticProps);
return Constructor;</pre>

<p>}</p>

<p>function _inherits(subClass, superClass) {</p>

<pre>if (typeof superClass !== &quot;function&quot; &amp;&amp; superClass !== null) {
...
if (superClass) _setPrototypeOf(subClass, superClass);</pre>

<p>}</p>

<p>function _getPrototypeOf(o) {</p>

<pre>_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
  return o.__proto__ || Object.getPrototypeOf(o);
};
return _getPrototypeOf(o);</pre>

<p>}</p>

<p>function _setPrototypeOf(o, p) {</p>

<pre>_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
  o.__proto__ = p;
  return o;
};

return _setPrototypeOf(o, p);</pre>

<p>}</p>

<p>function _assertThisInitialized(self) {</p>
...
<p>function _possibleConstructorReturn(self, call) {</p>

<pre>if (call &amp;&amp; (typeof call === &quot;object&quot; || typeof call === &quot;function&quot;)) {
  return call;
}

return _assertThisInitialized(self);</pre>

<p>}</p>

<p>function _superPropBase(object, property) {</p>

<pre>while (!Object.prototype.hasOwnProperty.call(object, property)) {
...
<p>function _get(target, property, receiver) {</p>

<pre>if (typeof Reflect !== &quot;undefined&quot; &amp;&amp; Reflect.get) {
  _get = Reflect.get;
} else {
...
return _get(target, property, receiver || target);</pre>

<p>}</p>

<pre>Returns a boolean for RTL support</pre>

<p>function rtl() {</p>

<pre>return $(&#39;html&#39;).attr(&#39;dir&#39;) === &#39;rtl&#39;;</pre>

<p>}</p>

<pre> returns a random base-36 uid with namespacing
 @function
...
<p>function GetYoDigits(length, namespace) {</p>

<pre class="ruby"><span class="ruby-identifier">length</span> = <span class="ruby-identifier">length</span> <span class="ruby-operator">||</span> <span class="ruby-value">6</span>;
<span class="ruby-keyword">return</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">round</span>(<span class="ruby-constant">Math</span>.<span class="ruby-identifier">pow</span>(<span class="ruby-value">36</span>, <span class="ruby-identifier">length</span> <span class="ruby-operator">+</span> <span class="ruby-value">1</span>) <span class="ruby-operator">-</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">random</span>() <span class="ruby-operator">*</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">pow</span>(<span class="ruby-value">36</span>, <span class="ruby-identifier">length</span>)).<span class="ruby-identifier">toString</span>(<span class="ruby-value">36</span>).<span class="ruby-identifier">slice</span>(<span class="ruby-value">1</span>) <span class="ruby-operator">+</span> (<span class="ruby-identifier">namespace</span> <span class="ruby-operator">?</span> <span class="ruby-string">&quot;-&quot;</span>.<span class="ruby-identifier">concat</span>(<span class="ruby-identifier">namespace</span>) <span class="ruby-operator">:</span> <span class="ruby-string">&#39;&#39;</span>);
</pre>

<p>} /**</p>

<pre> Escape a string so it can be used as a regexp pattern
 @function
...
<p>function RegExpEscape(str) {</p>

<pre>return str.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, &#39;\\$&amp;&#39;);</pre>

<p>}</p>

<p>function transitionend($elem) {</p>
...
<pre> Return an event type to listen for window load.
...
<p>function onLoad($elem, handler) {</p>

<pre>var didLoad = document.readyState === &#39;complete&#39;;
...
<pre> Retuns an handler for the `mouseleave` that ignore disappeared mouses.
...
<p>function ignoreMousedisappear(handler) {</p>

<pre>var _ref = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : {},
...
<p>var foundation_core_utils = /*#__PURE__  Object.freeze({</p>
...
onLoad: onLoad,
ignoreMousedisappear: ignoreMousedisappear</pre>

<p>});</p>

<p>// Authors &amp; copyright© 2012: Scott Jehl, Paul Irish, Nicholas Zakas,
David Knight. MIT license</p>

<p>/* eslint-disable */</p>

<p>window.matchMedia || (window.matchMedia = function () {</p>

<pre>var styleMedia = window.styleMedia || window.media; // For those that don&#39;t support matchMedium
...
<p>}; // Thank you: <a
href="https://github.com/sindresorhus/query-string">github.com/sindresorhus/query-string</a></p>

<p>function parseStyleToObject(str) {</p>
...
return styleObject;</pre>

<p>}</p>

<p>var FOUNDATION_VERSION = &#39;6.5.3&#39;; // Global Foundation object //
This is attached to the window, or used as a module for AMD/Browserify</p>

<p>var Foundation = {</p>

<pre>version: FOUNDATION_VERSION,
...
<p>}; window.Foundation = Foundation; // Polyfill for requestAnimationFrame</p>

<p>(function () {</p>

<pre>if (!Date.now || !window.Date.now) window.Date.now = Date.now = function () {
...
<p>if (!Function.prototype.bind) {</p>
...
<p>} // Polyfill to get the name of a function in IE9</p>

<p>function functionName(fn) {</p>

<pre>if (typeof Function.prototype.name === &#39;undefined&#39;) {
...
<p>function parseValue(str) {</p>

<pre>if (&#39;true&#39; === str) return true;else if (&#39;false&#39; === str) return false;else if (!isNaN(str * 1)) return parseFloat(str);
return str;</pre>

<p>} // Convert PascalCase to kebab-case // Thank you: <a
href="http://stackoverflow.com/a/8955580">stackoverflow.com/a/8955580</a></p>

<p>function hyphenate(str) {</p>

<pre>return str.replace(/([a-z])([A-Z])/g, &#39;$1-$2&#39;).toLowerCase();</pre>

<p>}</p>

<p>var Box = {</p>

<pre>ImNotTouchingYou: ImNotTouchingYou,
...
<p>function ImNotTouchingYou(element, parent, lrOnly, tbOnly, ignoreBottom) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">OverlapArea</span>(<span class="ruby-identifier">element</span>, <span class="ruby-identifier">parent</span>, <span class="ruby-identifier">lrOnly</span>, <span class="ruby-identifier">tbOnly</span>, <span class="ruby-identifier">ignoreBottom</span>) <span class="ruby-operator">===</span> <span class="ruby-value">0</span>;
</pre>

<p>}</p>

<p>function OverlapArea(element, parent, lrOnly, tbOnly, ignoreBottom) {</p>

<pre>var eleDims = GetDimensions(element),
    topOver,
    bottomOver,
    leftOver,
    rightOver;
...
return Math.sqrt(topOver * topOver + bottomOver * bottomOver + leftOver * leftOver + rightOver * rightOver);</pre>

<p>} /**</p>

<pre> Uses native methods to return an object of dimension values.
 @function
...
<p>function GetDimensions(elem) {</p>

<pre>elem = elem.length ? elem[0] : elem;
...
<pre> Returns an object of top and left integer pixel values for dynamically rendered elements,
...
<p>function GetOffsets(element, anchor, position, vOffset, hOffset,
isOverflow) {</p>

<pre>console.log(&quot;NOTE: GetOffsets is deprecated in favor of GetExplicitOffsets and will be removed in 6.5&quot;);
...
<p>function GetExplicitOffsets(element, anchor, position, alignment, vOffset,
hOffset, isOverflow) {</p>
...
<pre> Runs a callback function when images are fully loaded.
 @param {Object} images - Image(s) to check if loaded.
 @param {Func} callback - Function to execute when image is fully loaded.
/</pre>

<p>function onImagesLoaded(images, callback) {</p>

<pre>var unloaded = images.length;
...
<pre>This util was created by Marius Olbertz *
...
<p>}; var commands = {}; // Functions pulled out to be referenceable from
internals</p>

<p>function findFocusable($element) {</p>
...
<p>function parseKey(event) {</p>

<pre>var key = keyCodes[event.which || event.keyCode] || String.fromCharCode(event.which).toUpperCase(); // Remove un-printable characters, e.g. for `fromCharCode` calls for CTRL only events
...
<pre> Constants for easier comparing.
 Can be used like Foundation.parseKey(event) === Foundation.keys.SPACE
/</pre>

<p>function getKeyCodes(kcs) {</p>
...
<p>var initClasses = [&#39;mui-enter&#39;, &#39;mui-leave&#39;]; var
activeClasses = [&#39;mui-enter-active&#39;, &#39;mui-leave-active&#39;];
var Motion = {</p>

<pre>animateIn: function animateIn(element, animation, cb) {
...
<p>function Move(duration, elem, fn) {</p>
...
anim = window.requestAnimationFrame(move);</pre>

<p>} /**</p>

<pre> Animates an element in or out using a CSS transition class.
 @function
 @private
...
<p>function animate(isIn, element, animation, cb) {</p>

<pre>element = $(element).eq(0);
...
<pre>Feather: function Feather(menu) {
...
<p>function Timer(elem, options, cb) {</p>
...
<p>var Touch = {}; var startPosX,</p>

<pre class="ruby"><span class="ruby-identifier">startPosY</span>,
<span class="ruby-identifier">startTime</span>,
<span class="ruby-identifier">elapsedTime</span>,
<span class="ruby-identifier">startEvent</span>,
<span class="ruby-identifier">isMoving</span> = <span class="ruby-keyword">false</span>,
<span class="ruby-identifier">didMoved</span> = <span class="ruby-keyword">false</span>;
</pre>

<p>function onTouchEnd(e) {</p>

<pre>this.removeEventListener(&#39;touchmove&#39;, onTouchMove);
...
<p>function onTouchMove(e) {</p>

<pre>if ($.spotSwipe.preventDefault) {
  e.preventDefault();
}
...
<p>function onTouchStart(e) {</p>

<pre>if (e.touches.length == 1) {
...
<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">addEventListener</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">addEventListener</span>(<span class="ruby-string">&#39;touchstart&#39;</span>, <span class="ruby-identifier">onTouchStart</span>, <span class="ruby-keyword">false</span>);
</pre>

<p>}</p>

<p>var SpotSwipe = /*#__PURE__*/ function () {</p>

<pre>function SpotSwipe($$$1) {
...
return SpotSwipe;</pre>

<p>}(); /****************************************************</p>

<pre>As far as I can tell, both setupSpotSwipe and    *
setupTouchHandler should be idempotent,          *
because they directly replace functions &amp;        *
values, and do not add event handlers directly.  *
**************************************************/</pre>

<p>Touch.setupSpotSwipe = function ($$$1) {</p>

<pre>$$$1.spotSwipe = new SpotSwipe($$$1);</pre>

<p>}; /****************************************************</p>

<pre>Method for adding pseudo drag events to elements *
*************************************************/</pre>

<p>Touch.setupTouchHandler = function ($$$1) {</p>

<pre>$$$1.fn.addTouch = function () {
  this.each(function (i, el) {
...
<p>Touch.init = function ($$$1) {</p>

<pre>if (typeof $$$1.spotSwipe === &#39;undefined&#39;) {
...
<p>var MutationObserver = function () {</p>

<pre>var prefixes = [&#39;WebKit&#39;, &#39;Moz&#39;, &#39;O&#39;, &#39;Ms&#39;, &#39;&#39;];
...
<p>var triggers = function triggers(el, type) {</p>

<pre>el.data(type).split(&#39; &#39;).forEach(function (id) {
...
<p>}; Triggers.Listeners.Basic = {</p>

<pre>openListener: function openListener() {
  triggers($(this), &#39;open&#39;);
},
...
<p>}; // Elements with [data-open] will reveal a plugin that supports it when
clicked.</p>

<p>Triggers.Initializers.addOpenListener = function ($elem) {</p>

<pre class="ruby"><span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">off</span>(<span class="ruby-string">&#39;click.zf.trigger&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">openListener</span>);
<span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;click.zf.trigger&#39;</span>, <span class="ruby-string">&#39;[data-open]&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">openListener</span>);
</pre>

<p>}; // Elements with [data-close] will close a plugin that supports it when
clicked. // If used without a value on [data-close], the event will bubble,
allowing it to close a parent component.</p>

<p>Triggers.Initializers.addCloseListener = function ($elem) {</p>

<pre class="ruby"><span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">off</span>(<span class="ruby-string">&#39;click.zf.trigger&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">closeListener</span>);
<span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;click.zf.trigger&#39;</span>, <span class="ruby-string">&#39;[data-close]&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">closeListener</span>);
</pre>

<p>}; // Elements with [data-toggle] will toggle a plugin that supports it
when clicked.</p>

<p>Triggers.Initializers.addToggleListener = function ($elem) {</p>

<pre class="ruby"><span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">off</span>(<span class="ruby-string">&#39;click.zf.trigger&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">toggleListener</span>);
<span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;click.zf.trigger&#39;</span>, <span class="ruby-string">&#39;[data-toggle]&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">toggleListener</span>);
</pre>

<p>}; // Elements with [data-closable] will respond to close.zf.trigger
events.</p>

<p>Triggers.Initializers.addCloseableListener = function ($elem) {</p>

<pre class="ruby"><span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">off</span>(<span class="ruby-string">&#39;close.zf.trigger&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">closeableListener</span>);
<span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;close.zf.trigger&#39;</span>, <span class="ruby-string">&#39;[data-closeable], [data-closable]&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">closeableListener</span>);
</pre>

<p>}; // Elements with [data-toggle-focus] will respond to coming in and out
of focus</p>

<p>Triggers.Initializers.addToggleFocusListener = function ($elem) {</p>

<pre class="ruby"><span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">off</span>(<span class="ruby-string">&#39;focus.zf.trigger blur.zf.trigger&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">toggleFocusListener</span>);
<span class="ruby-identifier">$elem</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;focus.zf.trigger blur.zf.trigger&#39;</span>, <span class="ruby-string">&#39;[data-toggle-focus]&#39;</span>, <span class="ruby-constant">Triggers</span>.<span class="ruby-constant">Listeners</span>.<span class="ruby-constant">Basic</span>.<span class="ruby-identifier">toggleFocusListener</span>);
</pre>

<p>}; // More Global/complex listeners and triggers</p>

<p>Triggers.Listeners.Global = {</p>

<pre>resizeListener: function resizeListener($nodes) {
  if (!MutationObserver) {
    //fallback for IE 9
    $nodes.each(function () {
...
} // Global, parses whole document.</pre>

<p>};</p>

<p>Triggers.Initializers.addClosemeListener = function (pluginName) {</p>

<pre>var yetiBoxes = $(&#39;[data-yeti-box]&#39;),
...
<p>function debounceGlobalListener(debounce, trigger, listener) {</p>
...
<p>Triggers.Initializers.addResizeListener = function (debounce) {</p>

<pre>var $nodes = $(&#39;[data-resize]&#39;);
...
<p>Triggers.Initializers.addScrollListener = function (debounce) {</p>

<pre>var $nodes = $(&#39;[data-scroll]&#39;);
...
<p>Triggers.Initializers.addMutationEventsListener = function ($elem) {</p>

<pre>if (!MutationObserver) {
  return false;
}
...
<p>Triggers.Initializers.addSimpleListeners = function () {</p>

<pre>var $document = $(document);
Triggers.Initializers.addOpenListener($document);
Triggers.Initializers.addCloseListener($document);
Triggers.Initializers.addToggleListener($document);
Triggers.Initializers.addCloseableListener($document);
Triggers.Initializers.addToggleFocusListener($document);</pre>

<p>};</p>

<p>Triggers.Initializers.addGlobalListeners = function () {</p>

<pre>var $document = $(document);
Triggers.Initializers.addMutationEventsListener($document);
Triggers.Initializers.addResizeListener();
Triggers.Initializers.addScrollListener();
Triggers.Initializers.addClosemeListener();</pre>

<p>};</p>

<p>Triggers.init = function ($$$1, Foundation) {</p>

<pre>onLoad($$$1(window), function () {
...
<p>// {function} _setup (replaces previous constructor), // {function}
_destroy (replaces previous destroy)</p>

<p>var Plugin = /*#__PURE__*/ function () {</p>

<pre>function Plugin(element, options) {
...
<p>function hyphenate$1(str) {</p>

<pre>return str.replace(/([a-z])([A-Z])/g, &#39;$1-$2&#39;).toLowerCase();</pre>

<p>}</p>

<p>function getPluginName(obj) {</p>

<pre>if (typeof obj.constructor.name !== &#39;undefined&#39;) {
...
<p>var Abide = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Abide, _Plugin);
...
<pre> Default settings for plugin
/</pre>
...
<pre> Accordion module.
 @module foundation.accordion
 @requires foundation.util.keyboard
/</pre>

<p>var Accordion = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Accordion, _Plugin);
...
return Accordion;</pre>

<p>}(Plugin);</p>

<p>Accordion.defaults = {</p>
...
/**
   ...
   @default false
  /
updateHistory: false</pre>

<p>};</p>

<p>/**</p>

<pre> AccordionMenu module.
 @module foundation.accordionMenu
 @requires foundation.util.keyboard
 @requires foundation.util.nest
/</pre>

<p>var AccordionMenu = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(AccordionMenu, _Plugin);
...
return AccordionMenu;</pre>

<p>}(Plugin);</p>

<p>AccordionMenu.defaults = {</p>
...
<p>var Drilldown = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Drilldown, _Plugin);
...
return Drilldown;</pre>

<p>}(Plugin);</p>

<p>Drilldown.defaults = {</p>
...
/**
   ...
   @default &#39;swing&#39;
  /
animationEasing: &#39;swing&#39; // holdOpen: false</pre>

<p>};</p>

<p>var POSITIONS = [&#39;left&#39;, &#39;right&#39;, &#39;top&#39;,
&#39;bottom&#39;]; var VERTICAL_ALIGNMENTS = [&#39;top&#39;,
&#39;bottom&#39;, &#39;center&#39;]; var HORIZONTAL_ALIGNMENTS =
[&#39;left&#39;, &#39;right&#39;, &#39;center&#39;]; var ALIGNMENTS = {</p>

<pre>&#39;left&#39;: VERTICAL_ALIGNMENTS,
&#39;right&#39;: VERTICAL_ALIGNMENTS,
&#39;top&#39;: HORIZONTAL_ALIGNMENTS,
&#39;bottom&#39;: HORIZONTAL_ALIGNMENTS</pre>

<p>};</p>

<p>function nextItem(item, array) {</p>

<pre>var currentIdx = array.indexOf(item);
...
<p>var Positionable = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Positionable, _Plugin);
...
return Positionable;</pre>

<p>}(Plugin);</p>

<p>Positionable.defaults = {</p>
...
<p>var Dropdown = /*#__PURE__*/ function (_Positionable) {</p>

<pre>_inherits(Dropdown, _Positionable);
...
/**
   ...
   @default false
  /
closeOnClick: false</pre>

<p>};</p>

<p>/**</p>

<pre> DropdownMenu module.
...
<p>var DropdownMenu = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(DropdownMenu, _Plugin);
...
/**
   ...
   @default true
  /
forceFollow: true</pre>

<p>};</p>

<p>/**</p>

<pre> Equalizer module.
 @module foundation.equalizer
 @requires foundation.util.mediaQuery
 @requires foundation.util.imageLoader if equalizer contains images
/</pre>

<p>var Equalizer = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Equalizer, _Plugin);
...
<pre> Interchange module.
 @module foundation.interchange
 @requires foundation.util.mediaQuery
/</pre>

<p>var Interchange = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Interchange, _Plugin);
...
<p>}; Interchange.SPECIAL_QUERIES = {</p>

<pre>&#39;landscape&#39;: &#39;screen and (orientation: landscape)&#39;,
&#39;portrait&#39;: &#39;screen and (orientation: portrait)&#39;,
&#39;retina&#39;: &#39;only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min--moz-device-pixel-ratio: 2), only screen and (-o-min-device-pixel-ratio: 2/1), only screen and (min-device-pixel-ratio: 2), only screen and (min-resolution: 192dpi), only screen and (min-resolution: 2dppx)&#39;</pre>

<p>};</p>

<p>/**</p>

<pre> SmoothScroll module.
 @module foundation.smooth-scroll
/</pre>

<p>var SmoothScroll = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(SmoothScroll, _Plugin);
...
<p>var Magellan = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Magellan, _Plugin);
...
<p>var OffCanvas = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(OffCanvas, _Plugin);
...
return OffCanvas;</pre>

<p>}(Plugin);</p>

<p>OffCanvas.defaults = {</p>
...
<p>var Orbit = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Orbit, _Plugin);
...
<p>}; // import “foundation.util.triggers.js”;</p>

<p>/**</p>

<pre> ResponsiveMenu module.
 @module foundation.responsiveMenu
 @requires foundation.util.triggers
 @requires foundation.util.mediaQuery
/</pre>

<p>var ResponsiveMenu = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(ResponsiveMenu, _Plugin);
...
return ResponsiveMenu;</pre>

<p>}(Plugin);</p>

<p>ResponsiveMenu.defaults = {};</p>

<p>/**</p>

<pre> ResponsiveToggle module.
 @module foundation.responsiveToggle
 @requires foundation.util.mediaQuery
 @requires foundation.util.motion
/</pre>

<p>var ResponsiveToggle = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(ResponsiveToggle, _Plugin);
...
return ResponsiveToggle;</pre>

<p>}(Plugin);</p>

<p>ResponsiveToggle.defaults = {</p>
...
<p>var Reveal = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Reveal, _Plugin);
...
<p>var Slider = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Slider, _Plugin);
...
/**
  ...
  @default &#39;linear&#39;
 /
positionValueFunction: &#39;linear&#39;</pre>

<p>};</p>

<p>function percent(frac, num) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">frac</span> <span class="ruby-operator">/</span> <span class="ruby-identifier">num</span>;
</pre>

<p>}</p>

<p>function absPosition($handle, dir, clickPos, param) {</p>

<pre>return Math.abs($handle.position()[dir] + $handle[param]() / 2 - clickPos);</pre>

<p>}</p>

<p>function baseLog(base, value) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">value</span>) <span class="ruby-operator">/</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">base</span>);
</pre>
...
<p>var Sticky = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Sticky, _Plugin);
...
<p>var Tabs = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Tabs, _Plugin);
...
/**
   ...
   @default &#39;is-active&#39;
  /
panelActiveClass: &#39;is-active&#39;</pre>
...
<p>var Toggler = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(Toggler, _Plugin);
...
<p>var Tooltip = /*#__PURE__*/ function (_Positionable) {</p>

<pre>_inherits(Tooltip, _Positionable);
...
<p>Tooltip.defaults = {</p>

<pre>disableForTouch: false,
...
<pre> ResponsiveAccordionTabs module.
...
<p>var ResponsiveAccordionTabs = /*#__PURE__*/ function (_Plugin) {</p>

<pre>_inherits(ResponsiveAccordionTabs, _Plugin);
...
return ResponsiveAccordionTabs;</pre>

<p>}(Plugin);</p>

<p>ResponsiveAccordionTabs.defaults = {};</p>

<p>Foundation.addToJquery($); // Add Foundation Utils to Foundation global
namespace for backwards // compatibility.</p>

<p>Foundation.rtl = rtl; Foundation.GetYoDigits = GetYoDigits;
Foundation.transitionend = transitionend; Foundation.RegExpEscape =
RegExpEscape; Foundation.onLoad = onLoad; Foundation.Box = Box;
Foundation.onImagesLoaded = onImagesLoaded; Foundation.Keyboard = Keyboard;
Foundation.MediaQuery = MediaQuery; Foundation.Motion = Motion;
Foundation.Move = Move; Foundation.Nest = Nest; Foundation.Timer = Timer;
// Touch and Triggers previously were almost purely sede effect driven, //
so no need to add it to Foundation, just init them.</p>

<p>Touch.init($); Triggers.init($, Foundation);</p>

<p>MediaQuery._init();</p>

<p>Foundation.plugin(Abide, &#39;Abide&#39;); Foundation.plugin(Accordion,
&#39;Accordion&#39;); Foundation.plugin(AccordionMenu,
&#39;AccordionMenu&#39;); Foundation.plugin(Drilldown,
&#39;Drilldown&#39;); Foundation.plugin(Dropdown, &#39;Dropdown&#39;);
Foundation.plugin(DropdownMenu, &#39;DropdownMenu&#39;);
Foundation.plugin(Equalizer, &#39;Equalizer&#39;);
Foundation.plugin(Interchange, &#39;Interchange&#39;);
Foundation.plugin(Magellan, &#39;Magellan&#39;);
Foundation.plugin(OffCanvas, &#39;OffCanvas&#39;); Foundation.plugin(Orbit,
&#39;Orbit&#39;); Foundation.plugin(ResponsiveMenu,
&#39;ResponsiveMenu&#39;); Foundation.plugin(ResponsiveToggle,
&#39;ResponsiveToggle&#39;); Foundation.plugin(Reveal, &#39;Reveal&#39;);
Foundation.plugin(Slider, &#39;Slider&#39;);
Foundation.plugin(SmoothScroll, &#39;SmoothScroll&#39;);
Foundation.plugin(Sticky, &#39;Sticky&#39;); Foundation.plugin(Tabs,
&#39;Tabs&#39;); Foundation.plugin(Toggler, &#39;Toggler&#39;);
Foundation.plugin(Tooltip, &#39;Tooltip&#39;);
Foundation.plugin(ResponsiveAccordionTabs,
&#39;ResponsiveAccordionTabs&#39;);</p>

<p>exports.CoreUtils = foundation_core_utils; exports.Core = Foundation;
exports.Foundation = Foundation; exports.Box = Box; exports.onImagesLoaded
= onImagesLoaded; exports.Keyboard = Keyboard; exports.MediaQuery =
MediaQuery; exports.Motion = Motion; exports.Move = Move; exports.Nest =
Nest; exports.Timer = Timer; exports.Touch = Touch; exports.Triggers =
Triggers; exports.Abide = Abide; exports.Accordion = Accordion;
exports.AccordionMenu = AccordionMenu; exports.Drilldown = Drilldown;
exports.Dropdown = Dropdown; exports.DropdownMenu = DropdownMenu;
exports.Equalizer = Equalizer; exports.Interchange = Interchange;
exports.Magellan = Magellan; exports.OffCanvas = OffCanvas; exports.Orbit =
Orbit; exports.ResponsiveMenu = ResponsiveMenu; exports.ResponsiveToggle =
ResponsiveToggle; exports.Reveal = Reveal; exports.Slider = Slider;
exports.SmoothScroll = SmoothScroll; exports.Sticky = Sticky; exports.Tabs
= Tabs; exports.Toggler = Toggler; exports.Tooltip = Tooltip;
exports.ResponsiveAccordionTabs = ResponsiveAccordionTabs; exports.default
= Foundation; //# sourceMappingURL=foundation.cjs.js.map</p>
</main>
