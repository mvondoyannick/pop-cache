...
<title>foundation.sticky.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.sticky.min.js">

<p>!function(t,e){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=e(require(“./foundation.core”),require(“./foundation.util.mediaQuery”),require(“./foundation.util.motion”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.util.mediaQuery","./foundation.util.motion","jquery"">define&&define.amd?define(</a>,e):“object”==typeof
<a
href=""foundation.sticky"">exports?exports</a>=e(require(“./foundation.core”),require(“./foundation.util.mediaQuery”),require(“./foundation.util.motion”),require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.sticky"">t.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">e(t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.mediaQuery"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.motion"">t.FOUNDATION_EXTERNAL</a>,t.jQuery))}(window,function(i,n,o,s){return
function(i){var n={};function o(t){<a href="t">if(n</a>)return <a
href="t">n</a>.exports;var <a href="t">e=n</a>={i:t,l:!1,exports:{}};return
<a href="t">i</a>.call(e.exports,e,e.exports,o),e.l=!0,e.exports}return
o.m=i,o.c=n,o.d=function(t,e,i){o.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:i})},o.r=function(t){“undefined”!=typeof
...
i=Object.create(null);if(o.r(i),Object.defineProperty(i,“default”,{enumerable:!0,value:e}),2&amp;t&amp;&amp;“string”!=typeof
e)for(var n in e)o.d(i,n,function(t){return <a
href="t">e</a>}.bind(null,n));return i},o.n=function(t){var
e=t&amp;&amp;t.__esModule?function(){return t.default}:function(){return
t};return o.d(e,“a”,e),e},o.o=function(t,e){return
Object.prototype.hasOwnProperty.call(t,e)},o.p=“”,o(o.s=17)}({“./foundation.core”:function(t,e){t.exports=i},“./foundation.util.mediaQuery”:function(t,e){t.exports=n},“./foundation.util.motion”:function(t,e){t.exports=o},“./js/entries/plugins/foundation.sticky.js”:function(t,e,i){“use
strict”;i.r(e);var
n=i(“./foundation.core”);i.d(e,“Foundation”,function(){return
n.Foundation});var
o=i(“./js/foundation.sticky.js”);i.d(e,“Sticky”,function(){return
o.Sticky}),n.Foundation.plugin(o.Sticky,“Sticky”)},“./js/foundation.sticky.js”:function(t,e,i){“use
strict”;i.r(e),i.d(e,“Sticky”,function(){return h});var
n=i(“jquery”),a=i.n(n),s=i(“./foundation.core”),c=i(“./foundation.util.mediaQuery”),r=i(“./js/foundation.util.triggers.js”);function
...
t})(t)}function u(t,e){for(var i=0;i&lt;e.length;i++){var <a
...
called”)}(t):e}function
f(t){return(f=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return
t.__proto__||Object.getPrototypeOf(t)})(t)}function
d(t,e){return(d=Object.setPrototypeOf||function(t,e){return
...
as a function”)}(this,i),l(this,f(i).apply(this,arguments))}var
e,n,o;return function(t,e){if(“function”!=typeof e&amp;&amp;null!==e)throw
new TypeError(“Super expression must either be null or a
function”);t.prototype=Object.create(e&amp;&amp;e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&amp;&amp;d(t,e)}(<a
href=""Plugin"">i,s</a>),e=i,(n=[{key:“_setup”,value:function(t,e){this.$element=t,this.options=a.a.extend({},i.defaults,this.$element.data(),e),this.className=“Sticky”,r.Triggers.init(a.a),this._init()}},{key:“_init”,value:function(){c.MediaQuery._init();var
<a href="data-sticky-container">t=this.$element.parent(“</a>”),<a
href="0">e=this.$element</a>.id||Object(s.GetYoDigits)(6,“sticky”),i=this;t.length?this.$container=t:(this.wasWrapped=!0,this.$element.wrap(this.options.container),this.$container=this.$element.parent()),this.$container.addClass(this.options.containerClass),this.$element.addClass(this.options.stickyClass).attr({“data-resize”:e,“data-mutate”:e}),“”!==this.options.anchor&amp;&amp;a()(“#”+i.options.anchor).attr({“data-mutate”:e}),this.scrollCount=this.options.checkEvery,this.isStuck=!1,this.onLoadListener=Object(s.onLoad)(a()(window),function(){<a
href="0">i.containerHeight=“none”==i.$element.css(“display”)?0:i.$element</a>.getBoundingClientRect().height,i.$container.css(“height”,i.containerHeight),i.elemHeight=i.containerHeight,“”!==i.options.anchor?i.$anchor=a()(“#”+i.options.anchor):i._parsePoints(),i._setSizes(function(){var
t=window.pageYOffset;i._calc(!1,t),i.isStuck||i._removeSticky(!(t&gt;=i.topPoint))}),i._events(e.split(“-”).reverse().join(“-”))})}},{key:“_parsePoints”,value:function(){for(var
<a
href="""==this.options.topAnchor?1:this.options.topAnchor,""==this.options.btmAnchor?document.documentElement.scrollHeight:this.options.btmAnchor">t=</a>,e={},<a
href="i">i=0,n=t.length;i<n&&t</a>;i++){var o;if(“number”==typeof <a
href="i">t</a>)<a href="i">o=t</a>;else{var <a href="i">s=t</a>.<a
href="0">split(“:”),r=a()(“#”.concat(s</a>));<a
href="1">o=r.offset().top,s</a>&amp;&amp;“<a href="1">bottom”===s</a>.<a
href="0">toLowerCase()&&(o+=r</a>.getBoundingClientRect().height)}<a
href="i">e</a>=o}this.points=e}},{key:“_events”,value:function(i){var
n=this,t=this.scrollListener=“scroll.zf.”.concat(i);this.isOn||(this.canStick&amp;&amp;(this.isOn=!0,a()(window).off(t).on(t,function(t){0===n.scrollCount?(n.scrollCount=n.options.checkEvery,n._setSizes(function(){n._calc(!1,window.pageYOffset)})):(n.scrollCount–,n._calc(!1,window.pageYOffset))})),this.$element.off(“resizeme.zf.trigger”).on(“resizeme.zf.trigger”,function(t,e){n._eventsHandler(i)}),this.$element.on(“mutateme.zf.trigger”,function(t,e){n._eventsHandler(i)}),this.$anchor&amp;&amp;this.$anchor.on(“mutateme.zf.trigger”,function(t,e){n._eventsHandler(i)}))}},{key:“_eventsHandler”,value:function(t){var
e=this,i=this.scrollListener=“scroll.zf.”.concat(t);e._setSizes(function(){e._calc(!1),e.canStick?e.isOn||e._events(t):e.isOn&amp;&amp;e._pauseListeners(i)})}},{key:“_pauseListeners”,value:function(t){this.isOn=!1,a()(window).off(t),this.$element.trigger(“pause.zf.sticky”)}},{key:“_calc”,value:function(t,e){if(t&amp;&amp;this._setSizes(),!this.canStick)return
this.isStuck&amp;&amp;this._removeSticky(!0),!1;e||(e=window.pageYOffset),e&gt;=this.topPoint?e&lt;=this.bottomPoint?this.isStuck||this._setSticky():this.isStuck&amp;&amp;this._removeSticky(!1):this.isStuck&amp;&amp;this._removeSticky(!0)}},{key:“_setSticky”,value:function(){var
t=this,e=this.options.stickTo,i=“top”===e?“marginTop”:“marginBottom”,n=“top”===e?“bottom”:“top”,o={};<a
href="i">o</a>=“”.<a href="i">concat(this.options</a>,“<a
href="e">em”),o</a>=<a
href="n">0,o</a>=“auto”,this.isStuck=!0,this.$element.removeClass(“is-anchored
is-at-”.concat(n)).addClass(“is-stuck
is-at-”.concat(e)).css(o).trigger(“sticky.zf.stuckto:”.concat(e)),this.$element.on(“transitionend
webkitTransitionEnd oTransitionEnd otransitionend
MSTransitionEnd”,function(){t._setSizes()})}},{key:“_removeSticky”,value:function(t){var
e=this.options.stickTo,i=“top”===e,n={},<a
href="1">o=(this.points?this.points</a>-<a href="0">this.points</a>:<a
href="i?"marginTop":"marginBottom"">this.anchorHeight)-this.elemHeight,s=t?“top”:“bottom”;n</a>=0,n.bottom=“auto”,n.top=t?0:o,this.isStuck=!1,this.$element.removeClass(“is-stuck
is-at-”.concat(e)).addClass(“is-anchored
is-at-”.concat(s)).css(n).trigger(“sticky.zf.unstuckfrom:”.concat(s))}},{key:“_setSizes”,value:function(t){this.canStick=c.MediaQuery.is(this.options.stickyOn),this.canStick||t&amp;&amp;“function”==typeof
t&amp;&amp;t();var <a href="0">e=this.$container</a>.<a
href="0">getBoundingClientRect().width,i=window.getComputedStyle(this.$container</a>),<a
href=""padding-left"">n=parseInt(i</a>,<a
href=""padding-right"">10),o=parseInt(i</a>,<a
href="0">10);this.$anchor&&this.$anchor.length?this.anchorHeight=this.$anchor</a>.getBoundingClientRect().height:this._parsePoints(),this.$element.css({“max-width”:“”.concat(e-n-o,“px”)});var
<a
href="0">s=this.$element</a>.getBoundingClientRect().height||this.containerHeight;if(“none”==this.$element.css(“display”)&amp;&amp;(s=0),this.containerHeight=s,this.$container.css({height:s}),this.elemHeight=s,!this.isStuck&amp;&amp;this.$element.hasClass(“is-at-bottom”)){var
<a
href="1">r=(this.points?this.points</a>-this.$container.offset().top:this.anchorHeight)-this.elemHeight;this.$element.css(“top”,r)}this._setBreakPoints(s,function(){t&amp;&amp;“function”==typeof
t&amp;&amp;t()})}},{key:“_setBreakPoints”,value:function(t,e){if(!this.canStick){if(!e||“function”!=typeof
e)return!1;e()}var <a
href="0">i=g(this.options.marginTop),n=g(this.options.marginBottom),o=this.points?this.points</a>:<a
href="1">this.$anchor.offset().top,s=this.points?this.points</a>:o+this.anchorHeight,r=window.innerHeight;“top”===this.options.stickTo?(o-=i,s-=t+i):“bottom”===this.options.stickTo&amp;&amp;(o-=r-(t+n),s-=r-n),this.topPoint=o,this.bottomPoint=s,e&amp;&amp;“function”==typeof
e&amp;&amp;e()}},{key:“_destroy”,value:function(){this._removeSticky(!0),this.$element.removeClass(“”.concat(this.options.stickyClass,“
is-anchored
is-at-top”)).css({height:“”,top:“”,bottom:“”,“max-width”:“”}).off(“resizeme.zf.trigger”).off(“mutateme.zf.trigger”),this.$anchor&amp;&amp;this.$anchor.length&amp;&amp;this.$anchor.off(“change.zf.sticky”),this.scrollListener&amp;&amp;a()(window).off(this.scrollListener),this.onLoadListener&amp;&amp;a()(window).off(this.onLoadListener),this.wasWrapped?this.$element.unwrap():this.$container.removeClass(this.options.containerClass).css({height:“”})}}])&amp;&amp;u(e.prototype,n),o&amp;&amp;u(e,o),i}();function
g(t){return
parseInt(window.getComputedStyle(document.body,null).fontSize,10)*t}h.defaults={container:“&lt;div
data-sticky-container&gt;&lt;/div&gt;”,stickTo:“top”,anchor:“”,topAnchor:“”,btmAnchor:“”,marginTop:1,marginBottom:1,stickyOn:“medium”,stickyClass:“sticky”,containerClass:“sticky-container”,checkEvery:-1}},“./js/foundation.util.triggers.js”:function(t,e,i){“use
strict”;i.r(e),i.d(e,“Triggers”,function(){return l});var
n=i(“jquery”),s=i.n(n),o=i(“./foundation.core”),r=i(“./foundation.util.motion”);function
a(t){return(a=“function”==typeof Symbol&amp;&amp;“symbol”==typeof
Symbol.iterator?function(t){return typeof t}:function(t){return
t&amp;&amp;“function”==typeof
Symbol&amp;&amp;t.constructor===Symbol&amp;&amp;t!==Symbol.prototype?“symbol”:typeof
t})(t)}var c=function(){for(var <a
...
<a
href="s()(this)">t=s()(this).data(“toggle-focus”);s()(“#”.concat(t)).triggerHandler(“toggle.zf.trigger”,</a>)}},l.Initializers.addOpenListener=function(t){<a
href="data-open">t.off(“click.zf.trigger”,l.Listeners.Basic.openListener),t.on(“click.zf.trigger”,“</a>”,l.Listeners.Basic.openListener)},l.Initializers.addCloseListener=function(t){<a
href="data-close">t.off(“click.zf.trigger”,l.Listeners.Basic.closeListener),t.on(“click.zf.trigger”,“</a>”,l.Listeners.Basic.closeListener)},l.Initializers.addToggleListener=function(t){<a
href="data-toggle">t.off(“click.zf.trigger”,l.Listeners.Basic.toggleListener),t.on(“click.zf.trigger”,“</a>”,l.Listeners.Basic.toggleListener)},l.Initializers.addCloseableListener=function(t){<a
href="data-closeable">t.off(“close.zf.trigger”,l.Listeners.Basic.closeableListener),t.on(“close.zf.trigger”,“</a>,
[data-closable]”,l.Listeners.Basic.closeableListener)},l.Initializers.addToggleFocusListener=function(t){t.off(“focus.zf.trigger
blur.zf.trigger”,l.Listeners.Basic.toggleFocusListener),t.on(“focus.zf.trigger
<a
...
href="t">t=s()(this);t.triggerHandler(“close.zf.trigger”,</a>)})}},l.Initializers.addClosemeListener=function(t){var
...
”);s()(window).off(n).on(n,l.Listeners.Global.closeMeListener)}},l.Initializers.addResizeListener=function(t){var
<a
href="data-resize">e=s()(“</a>”);e.length&amp;&amp;f(t,“resize.zf.trigger”,l.Listeners.Global.resizeListener,e)},l.Initializers.addScrollListener=function(t){var
<a
href="data-scroll">e=s()(“</a>”);e.length&amp;&amp;f(t,“scroll.zf.trigger”,l.Listeners.Global.scrollListener,e)},l.Initializers.addMutationEventsListener=function(t){if(!c)return!1;var
...
n=0;n&lt;=e.length-1;n++){new <a href="n">c(i).observe(e</a>,{<a
href=""data-events","style"">attributes:!0,childList:!0,characterData:!1,subtree:!0,attributeFilter:</a>})}},l.Initializers.addSimpleListeners=function(){var
t=s()(document);l.Initializers.addOpenListener(t),l.Initializers.addCloseListener(t),l.Initializers.addToggleListener(t),l.Initializers.addCloseableListener(t),l.Initializers.addToggleFocusListener(t)},l.Initializers.addGlobalListeners=function(){var
t=s()(document);l.Initializers.addMutationEventsListener(t),l.Initializers.addResizeListener(),l.Initializers.addScrollListener(),l.Initializers.addClosemeListener()},l.init=function(t,e){Object(o.onLoad)(t(window),function(){!0!==t.triggersInitialized&amp;&amp;(l.Initializers.addSimpleListeners(),l.Initializers.addGlobalListeners(),t.triggersInitialized=!0)}),e&amp;&amp;(e.Triggers=l,e.IHearYou=l.Initializers.addGlobalListeners)}},17:function(t,e,i){t.exports=i(“./js/entries/plugins/foundation.sticky.js”)},jquery:function(t,e){t.exports=s}})});
//# sourceMappingURL=foundation.sticky.min.js.map</p>
</main>
