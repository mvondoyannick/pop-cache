...
<title>foundation.core.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.core.min.js">

<p>!function(t,n){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=n(require(“jquery”)):“function”==typeof <a
href=""jquery"">define&&define.amd?define(</a>,n):“object”==typeof <a
href=""foundation.core"">exports?exports</a>=n(require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.core"">t.FOUNDATION_EXTERNAL</a>=n(t.jQuery))}(window,function(e){return
function(e){var o={};function r(t){<a href="t">if(o</a>)return <a
href="t">o</a>.exports;var <a href="t">n=o</a>={i:t,l:!1,exports:{}};return
<a href="t">e</a>.call(n.exports,n,n.exports,r),n.l=!0,n.exports}return
r.m=e,r.c=o,r.d=function(t,n,e){r.o(t,n)||Object.defineProperty(t,n,{enumerable:!0,get:e})},r.r=function(t){“undefined”!=typeof
Symbol&amp;&amp;Symbol.toStringTag&amp;&amp;Object.defineProperty(t,Symbol.toStringTag,{value:“Module”}),Object.defineProperty(t,“__esModule”,{value:!0})},r.t=function(n,t){if(1&amp;t&amp;&amp;(n=r(n)),8&amp;t)return
n;if(4&amp;t&amp;&amp;“object”==typeof
n&amp;&amp;n&amp;&amp;n.__esModule)return n;var
e=Object.create(null);if(r.r(e),Object.defineProperty(e,“default”,{enumerable:!0,value:n}),2&amp;t&amp;&amp;“string”!=typeof
n)for(var o in n)r.d(e,o,function(t){return <a
href="t">n</a>}.bind(null,o));return e},r.n=function(t){var
n=t&amp;&amp;t.__esModule?function(){return t.default}:function(){return
t};return r.d(n,“a”,n),n},r.o=function(t,n){return
Object.prototype.hasOwnProperty.call(t,n)},r.p=“”,r(r.s=0)}({“./js/entries/plugins/foundation.core.js”:function(t,n,e){“use
strict”;e.r(n);var
o=e(“jquery”),r=e.n(o),i=e(“./js/foundation.core.js”);e.d(n,“Foundation”,function(){return
i.Foundation});var
a=e(“./js/foundation.core.plugin.js”),u=e(“./js/foundation.core.utils.js”);e.d(n,“Plugin”,function(){return
a.Plugin}),e.d(n,“rtl”,function(){return
u.rtl}),e.d(n,“GetYoDigits”,function(){return
u.GetYoDigits}),e.d(n,“RegExpEscape”,function(){return
u.RegExpEscape}),e.d(n,“transitionend”,function(){return
u.transitionend}),e.d(n,“onLoad”,function(){return
u.onLoad}),e.d(n,“ignoreMousedisappear”,function(){return
u.ignoreMousedisappear}),i.Foundation.addToJquery(r.a),i.Foundation.Plugin=a.Plugin,i.Foundation.rtl=u.rtl,i.Foundation.GetYoDigits=u.GetYoDigits,i.Foundation.transitionend=u.transitionend,i.Foundation.RegExpEscape=u.RegExpEscape,i.Foundation.onLoad=u.onLoad,window.Foundation=i.Foundation},“./js/foundation.core.js”:function(t,n,e){“use
strict”;e.r(n),e.d(n,“Foundation”,function(){return s});var
o=e(“jquery”),i=e.n(o),r=e(“./js/foundation.core.utils.js”),a=e(“./js/foundation.util.mediaQuery.js”);function
u(t){return(u=“function”==typeof Symbol&amp;&amp;“symbol”==typeof
Symbol.iterator?function(t){return typeof t}:function(t){return
t&amp;&amp;“function”==typeof
Symbol&amp;&amp;t.constructor===Symbol&amp;&amp;t!==Symbol.prototype?“symbol”:typeof
t})(t)}var
s={version:“6.5.3”,_plugins:{},_uuids:[],plugin:function(t,n){var <a
href="o">e=n||c(t),o=d(e);this._plugins</a>=<a
href="e">this</a>=t},registerPlugin:function(t,n){var
e=n?d(n):c(t.constructor).toLowerCase();t.uuid=Object(r.GetYoDigits)(6,e),t.$element.attr(“data-”.concat(e))||t.$element.attr(“data-”.concat(e),t.uuid),t.$element.data(“zfPlugin”)||t.$element.data(“zfPlugin”,t),t.$element.trigger(“init.zf.”.concat(e)),this._uuids.push(t.uuid)},unregisterPlugin:function(t){var
n=d(c(t.$element.data(“zfPlugin”).constructor));for(var e in <a
href="e">this._uuids.splice(this._uuids.indexOf(t.uuid),1),t.$element.removeAttr(“data-”.concat(n)).removeData(“zfPlugin”).trigger(“destroyed.zf.”.concat(n)),t)t</a>=null},reInit:function(t){var
n=t instanceof
i.a;try{if(n)t.each(function(){i()(this).data(“zfPlugin”)._init()});else{var
e=u(t),o=this;({object:function(t){t.forEach(function(t){<a
href="data-"t"">t=d(t),i()(“</a>”).foundation(“_init”)})},string:function(){<a
href="data-"t"">t=d(t),i()(“</a>”).foundation(“_init”)},undefined:function(){this.object(Object.keys(o._plugins))}})[e](t)}}catch(t){console.error(t)}finally{return
t}},reflow:function(o,t){void
0===t?t=Object.keys(this._plugins):“string”==typeof <a
href="t">t&&(t=</a>);var r=this;i.a.each(t,function(t,n){var <a
href="n">e=r._plugins</a>;<a href="data-"n"">i()(o).find(“</a>”).<a
href="data-"n"">addBack(“</a>”).each(function(){var
t=i()(this),o={};if(t.data(“zfPlugin”))console.warn(“Tried to initialize
”<code>n</code>“ on an element that already has a Foundation
plugin.”);else{if(t.attr(“data-options”))t.attr(“data-options”).split(“;”).forEach(function(t,n){var
e=t.split(“:”).map(function(t){return t.trim()});<a
href="0">e</a>&amp;&amp;(<a
href="0">o[e</a>]=function(t){{if(“true”===t)return!0;if(“false”===t)return!1;if(!isNaN(1*t))return
parseFloat(t)}return t}(<a href="1">e</a>))});try{t.data(“zfPlugin”,new
e(i()(this),o))}catch(t){console.error(t)}finally{return}}})})},getFnName:c,addToJquery:function(i){return
i.fn.foundation=function(e){var
t=u(e),n=i(“.no-js”);if(n.length&amp;&amp;n.removeClass(“no-js”),“undefined”===t)a.MediaQuery._init(),s.reflow(this);else{if(“string”!==t)throw
new TypeError(“We&#39;re sorry, ”.concat(t,“ is not a valid parameter. You
must use a string representing the method you wish to invoke.”));var
o=Array.prototype.slice.call(arguments,1),r=this.data(“zfPlugin”);if(void
0===r||void <a href="e">0===r</a>)throw new ReferenceError(“We&#39;re
sorry, &#39;”<code>e</code>“&#39; is not an available method for
”+(r?c®:“this <a
href="e">element”)+“.”);1===this.length?r</a>.apply(r,o):this.each(function(t,n){<a
href="e">r</a>.apply(i(n).data(“zfPlugin”),o)})}return this},i}};function
c(t){if(void 0!==Function.prototype.name)return void
0===t.prototype?t.constructor.name:t.prototype.constructor.name;var <a
href="^(">n=/functions(</a>{1,})(/.exec(t.toString());return <a
href="1">n&&1<n.length?n</a>.trim():“”}function d(t){return <a
href="a-z">t.replace(/(</a>)([A-Z])/g,“$1-$2”).toLowerCase()}s.util={throttle:function(e,o){var
r=null;return function(){var
t=this,n=arguments;null===r&amp;&amp;(r=setTimeout(function(){e.apply(t,n),r=null},o))}}},window.Foundation=s,function(){Date.now&amp;&amp;window.Date.now||(window.Date.now=Date.now=function(){return(new
Date).getTime()});for(var <a
href=""webkit","moz"">t=</a>,n=0;n&lt;t.length&amp;&amp;!window.requestAnimationFrame;++n){var
<a href="n">e=t</a>;<a
href="e+"RequestAnimationFrame"">window.requestAnimationFrame=window</a>,<a
href="e+"CancelAnimationFrame"">window.cancelAnimationFrame=window</a>||<a
href="e+"CancelRequestAnimationFrame"">window</a>}if(/iP(ad|hone|od).*OS
...
setTimeout(function(){t(o=e)},e-n)},window.cancelAnimationFrame=clearTimeout}window.performance&amp;&amp;window.performance.now||(window.performance={start:Date.now(),now:function(){return
Date.now()-this.start}})}(),Function.prototype.bind||(Function.prototype.bind=function(t){if(“function”!=typeof
this)throw new TypeError(“Function.prototype.bind - what is trying to be
bound is not callable”);var
n=Array.prototype.slice.call(arguments,1),e=this,o=function(){},r=function(){return
e.apply(this instanceof
o?this:t,n.concat(Array.prototype.slice.call(arguments)))};return
this.prototype&amp;&amp;(o.prototype=this.prototype),r.prototype=new
o,r})},“./js/foundation.core.plugin.js”:function(t,n,e){“use
strict”;e.r(n),e.d(n,“Plugin”,function(){return o});e(“jquery”);var
r=e(“./js/foundation.core.utils.js”);function i(t,n){for(var
e=0;e&lt;n.length;e++){var <a
href="e">o=n</a>;o.enumerable=o.enumerable||!1,o.configurable=!0,“value”in
o&amp;&amp;(o.writable=!0),Object.defineProperty(t,o.key,o)}}var
o=function(){function o(t,n){!function(t,n){if(!(t instanceof n))throw new
TypeError(“Cannot call a class as a
function”)}(this,o),this._setup(t,n);var
e=u(this);this.uuid=Object(r.GetYoDigits)(6,e),this.$element.attr(“data-”.concat(e))||this.$element.attr(“data-”.concat(e),this.uuid),this.$element.data(“zfPlugin”)||this.$element.data(“zfPlugin”,this),this.$element.trigger(“init.zf.”.concat(e))}var
t,n,e;return t=o,(n=[{key:“destroy”,value:function(){this._destroy();var
t=u(this);for(var n in <a
href="n">this.$element.removeAttr(“data-”.concat(t)).removeData(“zfPlugin”).trigger(“destroyed.zf.”.concat(t)),this)this</a>=null}}])&amp;&amp;i(t.prototype,n),e&amp;&amp;i(t,e),o}();function
a(t){return <a
href="a-z">t.replace(/(</a>)([A-Z])/g,“$1-$2”).toLowerCase()}function
u(t){return void
0!==t.constructor.name?a(t.constructor.name):a(t.className)}},“./js/foundation.core.utils.js”:function(t,n,e){“use
strict”;e.r(n),e.d(n,“rtl”,function(){return
r}),e.d(n,“GetYoDigits”,function(){return
i}),e.d(n,“RegExpEscape”,function(){return
a}),e.d(n,“transitionend”,function(){return
u}),e.d(n,“onLoad”,function(){return
c}),e.d(n,“ignoreMousedisappear”,function(){return d});var
o=e(“jquery”),s=e.n(o);function
r(){return“rtl”===s()(“html”).attr(“dir”)}function i(t,n){return
t=t||6,Math.round(Math.pow(36,t+1)-Math.random()*Math.pow(36,t)).toString(36).slice(1)+(n?“-”.concat(n):“”)}function
a(t){return <a
href="\">t.replace(/[-</a>{}()*+?.,\^$|#s]/g,“\$&amp;”)}function u(t){var
n,e={transition:“transitionend”,WebkitTransition:“webkitTransitionEnd”,MozTransition:“transitionend”,OTransition:“otransitionend”},o=document.createElement(“div”);for(var
r in e)void <a href="r">0!==o.style</a>&amp;&amp;(<a
href="r">n=e</a>);return n||(n=setTimeout(function(){<a
href="t">t.triggerHandler(“transitionend”,</a>)},1),“transitionend”)}function
c(t,n){var
e=“complete”===document.readyState,o=(e?“_didLoad”:“load”)+“.zf.util.onLoad”,r=function(){return
t.triggerHandler(o)};return
t&amp;&amp;(n&amp;&amp;t.one(o,n),e?setTimeout®:s()(window).one(“load”,r)),o}function
d(i){var t=1&lt;arguments.length&amp;&amp;void <a
href="1">0!==arguments</a>?<a
href="1">arguments</a>:{},n=t.ignoreLeaveWindow,a=void
0!==n&amp;&amp;n,e=t.ignoreReappear,u=void 0!==e&amp;&amp;e;return
function(n){for(var t=arguments.length,e=new <a
href="o-1">Array(1<t?t-1:0),o=1;o<t;o++)e</a>=<a href="o">arguments</a>;var
<a
href="this,n">r=i.bind.apply(i,</a>.concat(e));if(null!==n.relatedTarget)return
r();setTimeout(function(){if(!a&amp;&amp;document.hasFocus&amp;&amp;!document.hasFocus())return
r();u||s()(document).one(“mouseenter”,function(t){s()(n.currentTarget).has(t.target).length||(n.relatedTarget=t.target,r())})},0)}}},“./js/foundation.util.mediaQuery.js”:function(t,n,e){“use
strict”;e.r(n),e.d(n,“MediaQuery”,function(){return a});var
o=e(“jquery”),i=e.n(o);function r(t){return(r=“function”==typeof
Symbol&amp;&amp;“symbol”==typeof Symbol.iterator?function(t){return typeof
t}:function(t){return t&amp;&amp;“function”==typeof
Symbol&amp;&amp;t.constructor===Symbol&amp;&amp;t!==Symbol.prototype?“symbol”:typeof
t})(t)}window.matchMedia||(window.matchMedia=function(){var
n=window.styleMedia||window.media;if(!n){var <a
href="0">e,o=document.createElement(“style”),t=document.getElementsByTagName(“script”)</a>;o.type=“text/css”,o.id=“matchmediajs-test”,t?t.parentNode.insertBefore(o,t):document.head.appendChild(o),e=“getComputedStyle”in
window&amp;&amp;window.getComputedStyle(o,null)||o.currentStyle,n={matchMedium:function(t){var
n=“@media ”<code>t</code>“{ matchmediajs-test { width: 1px; } }”;return
o.styleSheet?o.styleSheet.cssText=n:o.textContent=n,“1px”===e.width}}}return
function(t){return{matches:n.matchMedium(t||“all”),media:t||“all”}}}());var
a={queries:[],current:“”,_init:function(){i()(“meta.foundation-mq”).length||i()(&#39;&lt;meta
class=“foundation-mq”&gt;&#39;).appendTo(document.head);var
t,n,e,o=i()(“.foundation-mq”).css(“font-family”);for(var r in
e={},t=“string”==typeof(n=o)&amp;&amp;(n=n.trim().slice(1,-1))?e=n.split(“&amp;”).reduce(function(t,n){var
e=n.replace(/+/g,“ ”).<a href="0">split(“=”),o=e</a>,<a
href="1">r=e</a>;return o=decodeURIComponent(o),r=void <a
href="o">0===r?null:decodeURIComponent®,t.hasOwnProperty(o)?Array.isArray(t</a>)?<a
href="o">t</a>.<a href="o">push®:t</a>=[<a href="o">t</a>,<a
href="o">r]:t</a>=r,t},{}):e)t.hasOwnProperty®&amp;&amp;this.queries.push({name:r,value:“only
screen and (min-width: ”.<a
href="r">concat(t</a>,“)”)});this.current=this._getCurrentSize(),this._watcher()},atLeast:function(t){var
n=this.get(t);return!!n&amp;&amp;window.matchMedia(n).matches},is:function(t){return
1&lt;(t=t.trim().split(“ ”)).<a href="1">length&&“only”===t</a>?<a
href="0">t</a>===<a
href="0">this._getCurrentSize():this.atLeast(t</a>)},get:function(t){for(var
n in this.queries)if(this.queries.hasOwnProperty(n)){var <a
href="n">e=this.queries</a>;if(t===e.name)return e.value}return
null},_getCurrentSize:function(){for(var
t,n=0;n&lt;this.queries.length;n++){var <a
href="n">e=this.queries</a>;window.matchMedia(e.value).matches&amp;&amp;(t=e)}return“object”===r(t)?t.name:t},_watcher:function(){var
e=this;i()(window).off(“resize.zf.mediaquery”).on(“resize.zf.mediaquery”,function(){var
<a
href="t,n">t=e._getCurrentSize(),n=e.current;t!==n&&(e.current=t,i()(window).trigger(“changed.zf.mediaquery”,</a>))})}}},0:function(t,n,e){t.exports=e(“./js/entries/plugins/foundation.core.js”)},jquery:function(t,n){t.exports=e}})});
//# sourceMappingURL=foundation.core.min.js.map</p>
</main>
