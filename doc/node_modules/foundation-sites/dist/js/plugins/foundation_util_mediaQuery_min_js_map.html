...
<title>foundation.util.mediaQuery.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.mediaQuery.min.js.map">
...
href="name">js/entries/plugins/foundation.util.mediaQuery.js”,“webpack://FOUNDATION_EXTERNAL.</a>/<a
...
href="\"foundation.util.mediaQuery\"">object’)nttexports</a> =
factory(require(&quot;./foundation.core&quot;), <a
...
from &#39;./foundation.core&#39;;nimport { MediaQuery } from
&#39;../../foundation.util.mediaQuery&#39;;nnFoundation.MediaQuery =
MediaQuery;nFoundation.MediaQuery._init();nnexport { Foundation, MediaQuery
};n”,“&#39;use strict&#39;;nnimport $ from &#39;jquery&#39;;nn// Default
set of media queriesnconst defaultQueries = {n  &#39;default&#39; :
&#39;only screen&#39;,n  landscape : &#39;only screen and (orientation:
landscape)&#39;,n  portrait : &#39;only screen and (orientation:
portrait)&#39;,n  retina : &#39;only screen and
