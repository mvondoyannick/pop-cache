...
<title>foundation.core.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.core.js">
...
<pre>if(typeof exports === &#39;object&#39; &amp;&amp; typeof module === &#39;object&#39;)
        ...
        root[&quot;__FOUNDATION_EXTERNAL__&quot;] = root[&quot;__FOUNDATION_EXTERNAL__&quot;] || {}, root[&quot;__FOUNDATION_EXTERNAL__&quot;][&quot;foundation.core&quot;] = factory(root[&quot;jQuery&quot;]);</pre>

<p>})(window, function(<em>WEBPACK_EXTERNAL_MODULE_jquery</em>) { return      
...
<p>/***/ “./js/entries/plugins/foundation.core.js”:
/*!***********************************************!*\</p>

<pre>!*** ./js/entries/plugins/foundation.core.js ***!
\***********************************************/</pre>

<p>/*! exports provided: Foundation, Plugin, rtl, GetYoDigits, RegExpEscape,
transitionend, onLoad, ignoreMousedisappear */ /***/ (function(module,
...
<em>webpack_require</em>(/*! jquery */ “jquery”); /* harmony import */ var
jquery__WEBPACK_IMPORTED_MODULE_0___default =
/*#__PURE__*/<em>webpack_require</em>.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var
<em>foundation_core__WEBPACK_IMPORTED_MODULE_1_</em> =
<em>webpack_require</em>(/*! ../../foundation.core */
“./js/foundation.core.js”); /* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Foundation”,
function() { return <em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>;
});</p>

<p>/* harmony import */ var
<em>foundation_core_plugin__WEBPACK_IMPORTED_MODULE_2_</em> =
<em>webpack_require</em>(/*! ../../foundation.core.plugin */
“./js/foundation.core.plugin.js”); /* harmony import */ var
<em>foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</em> =
<em>webpack_require</em>(/*! ../../foundation.core.utils */
“./js/foundation.core.utils.js”); /* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Plugin”, function() {
return <em><a
href=""Plugin"">foundation_core_plugin__WEBPACK_IMPORTED_MODULE_2_</a></em>;
});</p>

<p>/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “rtl”, function() {
return <em><a
href=""rtl"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
});</p>

<p>/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “GetYoDigits”,
function() { return <em><a
href=""GetYoDigits"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
});</p>

<p>/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “RegExpEscape”,
function() { return <em><a
href=""RegExpEscape"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
});</p>

<p>/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “transitionend”,
function() { return <em><a
href=""transitionend"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
});</p>

<p>/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “onLoad”, function() {
return <em><a
href=""onLoad"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
});</p>

<p>/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>,
“ignoreMousedisappear”, function() { return <em><a
href=""ignoreMousedisappear"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
});</p>

<p>// — Foundation Core API — // Initialize Foundation and add some utilities
to its public API for backward compatibility. // Please note that every
utility do not have to be added to the core API.</p>

<p><em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.addToJquery(jquery__WEBPACK_IMPORTED_MODULE_0___default.a);
// Every plugin depends on plugin now, we can include that on the core for
the // script inclusion path.</p>

<p><em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.Plugin
= <em><a
href=""Plugin"">foundation_core_plugin__WEBPACK_IMPORTED_MODULE_2_</a></em>;
// These are now separated out, but historically were a part of this
module, // and since this is here for backwards compatibility we include
them in // this entry.</p>

<p><em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.rtl
= <em><a
href=""rtl"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
<em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.GetYoDigits
= <em><a
href=""GetYoDigits"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
<em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.transitionend
= <em><a
href=""transitionend"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
<em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.RegExpEscape
= <em><a
href=""RegExpEscape"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
<em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>.onLoad
= <em><a
href=""onLoad"">foundation_core_utils__WEBPACK_IMPORTED_MODULE_3_</a></em>;
window.Foundation = <em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_1_</a></em>;
// — Foundation Core exports — // Export “Plugin” and all core utilities,
since the `foundation.core` entry plays the role of // all core source
files.</p>

<p>/***/ }),</p>

<p>/***/ “./js/foundation.core.js”: /*!*******************************!*\</p>

<pre>!*** ./js/foundation.core.js ***!
\*******************************/</pre>

<p>/*! exports provided: Foundation */ /***/ (function(module,
<em>webpack_exports</em>, <em>webpack_require</em>) {</p>

<p>“use strict”; <em>webpack_require</em>.r(<em>webpack_exports</em>); /*
harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Foundation”,
function() { return Foundation; }); /* harmony import */ var
...
<p>/***/ “./js/foundation.core.plugin.js”:
/*!**************************************!*\</p>

<pre>!*** ./js/foundation.core.plugin.js ***!
\**************************************/</pre>

<p>/*! exports provided: Plugin */ /***/ (function(module,
<em>webpack_exports</em>, <em>webpack_require</em>) {</p>

<p>“use strict”; <em>webpack_require</em>.r(<em>webpack_exports</em>); /*
harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Plugin”, function() {
return Plugin; }); /* harmony import */ var
jquery__WEBPACK_IMPORTED_MODULE_0__ = <em>webpack_require</em>(/*! jquery
*/ “jquery”); /* harmony import */ var
jquery__WEBPACK_IMPORTED_MODULE_0___default =
/*#__PURE__*/<em>webpack_require</em>.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
<pre>// Abstract class for providing lifecycle hooks. Expect plugins to define AT LEAST</pre>
...
<p>/***/ “./js/foundation.core.utils.js”:
/*!*************************************!*\</p>

<pre>!*** ./js/foundation.core.utils.js ***!
\*************************************/</pre>

<p>/*! exports provided: rtl, GetYoDigits, RegExpEscape, transitionend,
onLoad, ignoreMousedisappear */ /***/ (function(module,
<em>webpack_exports</em>, <em>webpack_require</em>) {</p>

<p>“use strict”; <em>webpack_require</em>.r(<em>webpack_exports</em>); /*
harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “rtl”, function() {
return rtl; }); /* harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “GetYoDigits”,
function() { return GetYoDigits; }); /* harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “RegExpEscape”,
function() { return RegExpEscape; }); /* harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “transitionend”,
function() { return transitionend; }); /* harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “onLoad”, function() {
return onLoad; }); /* harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>,
“ignoreMousedisappear”, function() { return ignoreMousedisappear; }); /*
harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ =
<em>webpack_require</em>(/*! jquery */ “jquery”); /* harmony import */ var
jquery__WEBPACK_IMPORTED_MODULE_0___default =
/*#__PURE__*/<em>webpack_require</em>.n(jquery__WEBPACK_IMPORTED_MODULE_0__);</p>

<pre>// Core Foundation Utilities, utilized in a number of places.</pre>

<p>/**</p>

<pre> Returns a boolean for RTL support
/</pre>

<p>function rtl() {</p>

<pre>return jquery__WEBPACK_IMPORTED_MODULE_0___default()(&#39;html&#39;).attr(&#39;dir&#39;) === &#39;rtl&#39;;</pre>
...
<p>/***/ “./js/foundation.util.mediaQuery.js”:
/*!******************************************!*\</p>

<pre>!*** ./js/foundation.util.mediaQuery.js ***!
\******************************************/</pre>

<p>/*! exports provided: MediaQuery */ /***/ (function(module,
<em>webpack_exports</em>, <em>webpack_require</em>) {</p>

<p>“use strict”; <em>webpack_require</em>.r(<em>webpack_exports</em>); /*
harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “MediaQuery”,
function() { return MediaQuery; }); /* harmony import */ var
jquery__WEBPACK_IMPORTED_MODULE_0__ = <em>webpack_require</em>(/*! jquery
*/ “jquery”); /* harmony import */ var
jquery__WEBPACK_IMPORTED_MODULE_0___default =
/*#__PURE__*/<em>webpack_require</em>.n(jquery__WEBPACK_IMPORTED_MODULE_0__);</p>
...
<pre>// Default set of media queries</pre>

<p>var defaultQueries = {</p>

<pre>&#39;default&#39;: &#39;only screen&#39;,
...
Knight. MIT license</p>

<p>/* eslint-disable */</p>

<p>window.matchMedia || (window.matchMedia = function () {</p>

<pre>&quot;use strict&quot;; // For browsers that support matchMedium api such as IE 9 and webkit
...
<pre>!*** multi ./js/entries/plugins/foundation.core.js ***!
\*****************************************************/</pre>
...
*/“./js/entries/plugins/foundation.core.js”);</p>
...
<p>/******/ }); }); //# sourceMappingURL=foundation.core.js.map</p>
</main>
