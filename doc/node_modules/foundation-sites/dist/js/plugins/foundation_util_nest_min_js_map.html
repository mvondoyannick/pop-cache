...
<title>foundation.util.nest.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.nest.min.js.map">
...
href="\"foundation.util.nest\"">object’)nttexports</a> =
...
from &#39;./foundation.core&#39;;nnimport { Nest } from
&#39;../../foundation.util.nest&#39;;nnFoundation.Nest = Nest;nnexport {
Foundation, Nest };n”,“&#39;use strict&#39;;nnimport $ from
&#39;jquery&#39;;nnconst Nest = {n  Feather(menu, type = &#39;zf&#39;) {n  
menu.attr(&#39;role&#39;, &#39;menubar&#39;);nn    var items =
menu.find(&#39;li&#39;).attr({&#39;role&#39;: &#39;menuitem&#39;}),n       
subMenuClass = `is-${type}-submenu`,n        subItemClass =
`${subMenuClass}-item`,n        hasSubClass = `is-${type}-submenu-parent`,n
applyAria = (type !== &#39;accordion&#39;); // Accordions handle their own
ARIA attriutes.nn    items.each(function() {n      var $item = $(this),n   
$sub = $item.children(&#39;ul&#39;);nn      if ($sub.length) {n       
$item.addClass(hasSubClass);n        if(applyAria) {n         
$item.attr({n            &#39;aria-haspopup&#39;: true,n           
&#39;aria-label&#39;: $item.children(&#39;a:first&#39;).text()n         
});n          // Note:  Drilldowns behave differently in how they hide, and
so needn          // additional attributes.  We should look if this
possibly over-generalizedn          // utility (Nest) is appropriate when
we rework menus in 6.4n          if(type === &#39;drilldown&#39;) {n       
$item.attr({&#39;aria-expanded&#39;: false});n          }n        }n       
$subn          .addClass(`submenu ${subMenuClass}`)n          .attr({n     
&#39;data-submenu&#39;: &#39;&#39;,n            &#39;role&#39;:
&#39;menubar&#39;n          });n        if(type === &#39;drilldown&#39;) {n
$sub.attr({&#39;aria-hidden&#39;: true});n        }n      }nn      if ($<a
href="data-submenu">item.parent(‘</a>&#39;).length) {n       
$item.addClass(`is-submenu-item ${subItemClass}`);n      }n    });nn   
return;n  },nn  Burn(menu, type) {n    var //items =
menu.find(&#39;li&#39;),n        subMenuClass = `is-${type}-submenu`,n     
subItemClass = `${subMenuClass}-item`,n        hasSubClass =
`is-${type}-submenu-parent`;nn    menun      .find(&#39;&gt;li, &gt; li
&gt; ul, .menu, .menu &gt; li, [data-submenu] &gt; li&#39;)n     
.removeClass(`${subMenuClass} ${subItemClass} ${hasSubClass}
is-submenu-item submenu is-active`)n     
.removeAttr(&#39;data-submenu&#39;).css(&#39;display&#39;, &#39;&#39;);nn 
}n}nnexport {Nest};n”,“module.exports =
