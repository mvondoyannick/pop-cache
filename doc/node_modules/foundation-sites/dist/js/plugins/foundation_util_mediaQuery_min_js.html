...
<title>foundation.util.mediaQuery.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.mediaQuery.min.js">
...
<a
href=""./foundation.core","jquery"">define&&define.amd?define(</a>,t):“object”==typeof
<a
href=""foundation.util.mediaQuery"">exports?exports</a>=t(require(“./foundation.core”),require(“jquery”)):(e.<em>FOUNDATION_EXTERNAL</em>=e.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.util.mediaQuery"">e.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">t(e.FOUNDATION_EXTERNAL</a>,e.jQuery))}(window,function(n,r){return
...
Object.prototype.hasOwnProperty.call(e,t)},i.p=“”,i(i.s=24)}({“./foundation.core”:function(e,t){e.exports=n},“./js/entries/plugins/foundation.util.mediaQuery.js”:function(e,t,n){“use
strict”;n.r(t);var
r=n(“./foundation.core”);n.d(t,“Foundation”,function(){return
r.Foundation});var
i=n(“./js/foundation.util.mediaQuery.js”);n.d(t,“MediaQuery”,function(){return
i.MediaQuery}),r.Foundation.MediaQuery=i.MediaQuery,r.Foundation.MediaQuery._init()},“./js/foundation.util.mediaQuery.js”:function(e,t,n){“use
strict”;n.r(t),n.d(t,“MediaQuery”,function(){return u});var
r=n(“jquery”),o=n.n®;function i(e){return(i=“function”==typeof
...
e})(e)}window.matchMedia||(window.matchMedia=function(){var
t=window.styleMedia||window.media;if(!t){var <a
href="0">n,r=document.createElement(“style”),e=document.getElementsByTagName(“script”)</a>;r.type=“text/css”,r.id=“matchmediajs-test”,e?e.parentNode.insertBefore(r,e):document.head.appendChild®,n=“getComputedStyle”in
window&amp;&amp;window.getComputedStyle(r,null)||r.currentStyle,t={matchMedium:function(e){var
t=“@media ”<code>e</code>“{ matchmediajs-test { width: 1px; } }”;return
r.styleSheet?r.styleSheet.cssText=t:r.textContent=t,“1px”===n.width}}}return
function(e){return{matches:t.matchMedium(e||“all”),media:e||“all”}}}());var
u={queries:[],current:“”,_init:function(){o()(“meta.foundation-mq”).length||o()(&#39;&lt;meta
class=“foundation-mq”&gt;&#39;).appendTo(document.head);var
e,t,n,r=o()(“.foundation-mq”).css(“font-family”);for(var i in
n={},e=“string”==typeof(t=r)&amp;&amp;(t=t.trim().slice(1,-1))?n=t.split(“&amp;”).reduce(function(e,t){var
n=t.replace(/+/g,“ ”).<a href="0">split(“=”),r=n</a>,<a
href="1">i=n</a>;return r=decodeURIComponent®,i=void <a
href="r">0===i?null:decodeURIComponent(i),e.hasOwnProperty®?Array.isArray(e</a>)?<a
href="r">e</a>.<a href="r">push(i):e</a>=[<a href="r">e</a>,<a
href="r">i]:e</a>=i,e},{}):n)e.hasOwnProperty(i)&amp;&amp;this.queries.push({name:i,value:“only
screen and (min-width: ”.<a
href="i">concat(e</a>,“)”)});this.current=this._getCurrentSize(),this._watcher()},atLeast:function(e){var
t=this.get(e);return!!t&amp;&amp;window.matchMedia(t).matches},is:function(e){return
1&lt;(e=e.trim().split(“ ”)).<a href="1">length&&“only”===e</a>?<a
href="0">e</a>===<a
href="0">this._getCurrentSize():this.atLeast(e</a>)},get:function(e){for(var
t in this.queries)if(this.queries.hasOwnProperty(t)){var <a
href="t">n=this.queries</a>;if(e===n.name)return n.value}return
null},_getCurrentSize:function(){for(var
e,t=0;t&lt;this.queries.length;t++){var <a
href="t">n=this.queries</a>;window.matchMedia(n.value).matches&amp;&amp;(e=n)}return“object”===i(e)?e.name:e},_watcher:function(){var
n=this;o()(window).off(“resize.zf.mediaquery”).on(“resize.zf.mediaquery”,function(){var
<a
href="e,t">e=n._getCurrentSize(),t=n.current;e!==t&&(n.current=e,o()(window).trigger(“changed.zf.mediaquery”,</a>))})}}},24:function(e,t,n){e.exports=n(“./js/entries/plugins/foundation.util.mediaQuery.js”)},jquery:function(e,t){e.exports=r}})});
//# sourceMappingURL=foundation.util.mediaQuery.min.js.map</p>
</main>
