...
<title>foundation.responsiveAccordionTabs.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.responsiveAccordionTabs.min.js">

<p>!function(t,e){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=e(require(“./foundation.accordion”),require(“./foundation.core”),require(“./foundation.tabs”),require(“./foundation.util.mediaQuery”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.accordion","./foundation.core","./foundation.tabs","./foundation.util.mediaQuery","jquery"">define&&define.amd?define(</a>,e):“object”==typeof
<a
href=""foundation.responsiveAccordionTabs"">exports?exports</a>=e(require(“./foundation.accordion”),require(“./foundation.core”),require(“./foundation.tabs”),require(“./foundation.util.mediaQuery”),require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.responsiveAccordionTabs"">t.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.accordion"">e(t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.core"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.tabs"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.mediaQuery"">t.FOUNDATION_EXTERNAL</a>,t.jQuery))}(window,function(n,o,i,r,a){return
...
Object.prototype.hasOwnProperty.call(t,e)},i.p=“”,i(i.s=11)}({“./foundation.accordion”:function(t,e){t.exports=n},“./foundation.core”:function(t,e){t.exports=o},“./foundation.tabs”:function(t,e){t.exports=i},“./foundation.util.mediaQuery”:function(t,e){t.exports=r},“./js/entries/plugins/foundation.responsiveAccordionTabs.js”:function(t,e,n){“use
strict”;n.r(e);var
o=n(“./foundation.core”);n.d(e,“Foundation”,function(){return
o.Foundation});var
i=n(“./js/foundation.responsiveAccordionTabs.js”);n.d(e,“ResponsiveAccordionTabs”,function(){return
i.ResponsiveAccordionTabs}),o.Foundation.plugin(i.ResponsiveAccordionTabs,“ResponsiveAccordionTabs”)},“./js/foundation.responsiveAccordionTabs.js”:function(t,e,n){“use
strict”;n.r(e),n.d(e,“ResponsiveAccordionTabs”,function(){return b});var
o=n(“jquery”),l=n.n(o),a=n(“./foundation.util.mediaQuery”),d=n(“./foundation.core”),i=n(“./foundation.accordion”),r=n(“./foundation.tabs”);function
...
c(t,e){return!e||“object”!==s(e)&amp;&amp;“function”!=typeof
...
t.__proto__=e,t})(t,e)}var
h={tabs:{cssClass:“tabs”,plugin:r.Tabs},accordion:{cssClass:“accordion”,plugin:i.Accordion}},b=function(t){function
e(){return function(t,e){if(!(t instanceof e))throw new TypeError(“Cannot
call a class as a
function”)}(this,e),c(this,f(e).apply(this,arguments))}var n,o,i;return
...
href=""Plugin"">e,d</a>),n=e,(o=[{key:“_setup”,value:function(t,e){this.$element=l()(t),this.options=l.a.extend({},this.$element.data(),e),this.rules=this.$element.data(“responsive-accordion-tabs”),this.currentMq=null,this.currentPlugin=null,this.className=“ResponsiveAccordionTabs”,this.$element.attr(“id”)||this.$element.attr(“id”,Object(d.GetYoDigits)(6,“responsiveaccordiontabs”)),this._init(),this._events()}},{key:“_init”,value:function(){if(a.MediaQuery._init(),“string”==typeof
this.rules){for(var t={},e=this.rules.split(“ ”),n=0;n&lt;e.length;n++){var
<a href="n">o=e</a>.<a href="0">split(“-”),i=1<o.length?o</a>:“<a
href="1">small”,r=1<o.length?o</a>:<a href="0">o</a>;<a
href="r">null!==h</a>&amp;&amp;(<a href="i">t</a>=<a
href="r">h</a>)}this.rules=t}this._getAllOptions(),l.a.isEmptyObject(this.rules)||this._checkMediaQueries()}},{key:“_getAllOptions”,value:function(){for(var
t in this.allOptions={},h)if(h.hasOwnProperty(t)){var <a
href="t">e=h</a>;try{var n=l()(“&lt;ul&gt;&lt;/ul&gt;”),o=new
e.plugin(n,this.options);for(var i in
o.options)if(o.options.hasOwnProperty(i)&amp;&amp;“zfPlugin”!==i){var <a
href="i">r=o.options</a>;<a
href="i">this.allOptions</a>=r}o.destroy()}catch(t){}}}},{key:“_events”,value:function(){this._changedZfMediaQueryHandler=this._checkMediaQueries.bind(this),l()(window).on(“changed.zf.mediaquery”,this._changedZfMediaQueryHandler)}},{key:“_checkMediaQueries”,value:function(){var
e,n=this;l.a.each(this.rules,function(t){a.MediaQuery.atLeast(t)&amp;&amp;(e=t)}),e&amp;&amp;(this.currentPlugin
instanceof <a
href="e">this.rules</a>.plugin||(l.a.each(h,function(t,e){n.$element.removeClass(e.cssClass)}),<a
href="e">this.$element.addClass(this.rules</a>.<a
href="e">cssClass),this.currentPlugin&&(!this.currentPlugin.$element.data(“zfPlugin”)&&this.storezfData&&this.currentPlugin.$element.data(“zfPlugin”,this.storezfData),this.currentPlugin.destroy()),this._handleMarkup(this.rules</a>.cssClass),this.currentPlugin=new
<a
href="e">this.rules</a>.plugin(this.$element,{}),this.storezfData=this.currentPlugin.$element.data(“zfPlugin”)))}},{key:“_handleMarkup”,value:function(t){var
<a
href="data-tabs-content="+this.$element.attr("id")+"">n=this,e=“accordion”,o=l()(“</a>”);if(o.length&amp;&amp;(e=“tabs”),e!==t){var
i=n.allOptions.linkClass?n.allOptions.linkClass:“tabs-title”,r=n.allOptions.panelClass?n.allOptions.panelClass:“tabs-panel”;this.$element.removeAttr(“role”);var
<a href="data-accordion-item">a=this.$element.children(“.”i“,</a>”).<a
href="data-tab-content">removeClass(i).removeClass(“accordion-item”).removeAttr(“data-accordion-item”),s=a.children(“a”).removeClass(“accordion-title”);if(“tabs”===e?(o=o.children(“.”+r).removeClass®.removeAttr(“role”).removeAttr(“aria-hidden”).removeAttr(“aria-labelledby”)).children(“a”).removeAttr(“role”).removeAttr(“aria-controls”).removeAttr(“aria-selected”):o=a.children(“</a>”).removeClass(“accordion-content”),o.css({display:“”,visibility:“”}),a.css({display:“”,visibility:“”}),“accordion”===t)o.each(function(t,e){l()(e).appendTo(a.get(t)).addClass(“accordion-content”).attr(“data-tab-content”,“”).removeClass(“is-active”).css({height:“”}),<a
href="data-tabs-content="+n.$element.attr("id")+"">l()(“</a>”).after(&#39;&lt;div
id=“tabs-placeholder-&#39;+n.$element.attr(”id“)+&#39;”&gt;&lt;/div&gt;&#39;).detach(),a.addClass(“accordion-item”).attr(“data-accordion-item”,“”),s.addClass(“accordion-title”)});else
if(“tabs”===t){var <a
href="data-tabs-content="+n.$element.attr("id")+"">u=l()(“</a>”),c=l()(“#tabs-placeholder-”+n.$element.attr(“id”));c.length?(u=l()(&#39;&lt;div
class=“tabs-content”&gt;&lt;/div&gt;&#39;).insertAfter©.attr(“data-tabs-content”,n.$element.attr(“id”)),c.remove()):u=l()(&#39;&lt;div
class=“tabs-content”&gt;&lt;/div&gt;&#39;).insertAfter(n.$element).attr(“data-tabs-content”,n.$element.attr(“id”)),o.each(function(t,e){var
n=l()(e).appendTo(u).addClass®,o=s.get(t).hash.slice(1),i=l()(e).attr(“id”)||Object(d.GetYoDigits)(6,“accordion”);o!==i&amp;&amp;(“”!==o?l()(e).attr(“id”,o):(o=i,l()(e).attr(“id”,o),l()(s.get(t)).attr(“href”,l()(s.get(t)).attr(“href”).replace(“#”,“”)+“#”+o))),l()(a.get(t)).hasClass(“is-active”)&amp;&amp;n.addClass(“is-active”)}),a.addClass(i)}}}},{key:“_destroy”,value:function(){this.currentPlugin&amp;&amp;this.currentPlugin.destroy(),l()(window).off(“changed.zf.mediaquery”,this._changedZfMediaQueryHandler)}}])&amp;&amp;u(n.prototype,o),i&amp;&amp;u(n,i),e}();b.defaults={}},11:function(t,e,n){t.exports=n(“./js/entries/plugins/foundation.responsiveAccordionTabs.js”)},jquery:function(t,e){t.exports=a}})});
//# sourceMappingURL=foundation.responsiveAccordionTabs.min.js.map</p>
</main>
