...
<title>foundation.abide.min.js.map - RDoc Documentation</title>
...
ttObject.defineProperty(exports, ‘__esModule’, { value: true });n t};nn t//
create a fake namespace objectn t// mode & 1: value is a module id, require
itn t// mode & 2: merge all properties of value into the nsn t// mode & 4:
return value when already ns objectn t// mode & 8|1: behave like requiren
t__webpack_require__.t = function(value, mode) {n ttif(mode & 1) value =
webpack_require(value);n ttif(mode & 8) return value;n ttif((mode & 4) &&
typeof value === ‘object’ && value && value.__esModule) return value;n
ttvar ns = Object.create(null);n tt__webpack_require__.r(ns);n
ttObject.defineProperty(ns, ‘default’, { enumerable: true, value: value
});n ttif(mode & 2 && typeof value != ‘string’) for(var key in value)
webpack_require.d(ns, key, function(key) { return value[key]; }.bind(null,
key));n ttreturn ns;n t};nn t// getDefaultExport function for compatibility
with non-harmony modulesn t__webpack_require__.n = function(module) {n
ttvar getter = module && module.__esModule ?n tttfunction getDefault() {
return module[‘default’]; } :n tttfunction getModuleExports() { return
...
webpack_public_pathn t__webpack_require__.p = "";nnn t// Load entry module
and return exportsn treturn webpack_require(webpack_require.s =
0);n”,“module.exports = WEBPACK_EXTERNAL_MODULE__foundation_core;”,“import
{ Foundation } from ‘./foundation.core’;nnimport { Abide } from
‘../../foundation.abide’;nFoundation.plugin(Abide, ‘Abide’);nnexport {
Foundation, Abide };n”,“‘use strict’;nnimport $ from ‘jquery’;nimport {
Plugin } from ‘./foundation.core.plugin’;nimport { GetYoDigits } from
‘./foundation.core.utils’;nn   n * Abide module.n * @module
foundation.abiden   nnclass Abide extends Plugin {n     n   * Creates a new
instance of Abide.n   * @classn   * @name Abiden   * @fires Abide#initn   *
@param {Object} element - jQuery object to add the trigger to.n   * @param
{Object} options - Overrides to the default plugin settings.n     n 
_setup(element, options = {}) {n    this.$element = element;n   
this.options  = $.extend(true, {}, Abide.defaults, this.$element.data(),
options);nn    this.className = ‘Abide’; // ie9 back compatn   
this._init();n  }nn  /**n   * Initializes the Abide plugin and calls
functions to get Abide functioning on load.n   * @privaten   */n  _init()
{n    this.$inputs = $.merge(                               // Consider as
input to validate:n      this.$element.find(‘input’).not(‘[type=submit]’), 
// * all input fields expect submitn      this.$element.find(‘textarea,
select’)              // * all textareas and select fieldsn    );n    const
$globalErrors = this.$element.find(‘[data-abide-error]’);nn    // Add a11y
attributes to all fieldsn    if (this.options.a11yAttributes) {n     
...
}n}nnexport {Abide};n”,“module.exports =
