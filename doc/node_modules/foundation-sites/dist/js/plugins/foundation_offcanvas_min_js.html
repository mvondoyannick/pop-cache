...
<title>foundation.offcanvas.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.offcanvas.min.js">

<p>!function(t,e){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=e(require(“./foundation.core”),require(“./foundation.util.keyboard”),require(“./foundation.util.mediaQuery”),require(“./foundation.util.motion”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.util.keyboard","./foundation.util.mediaQuery","./foundation.util.motion","jquery"">define&&define.amd?define(</a>,e):“object”==typeof
<a
href=""foundation.offcanvas"">exports?exports</a>=e(require(“./foundation.core”),require(“./foundation.util.keyboard”),require(“./foundation.util.mediaQuery”),require(“./foundation.util.motion”),require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.offcanvas"">t.FOUNDATION_EXTERNAL</a>=<a
...
href=""foundation.util.motion"">t.FOUNDATION_EXTERNAL</a>,t.jQuery))}(window,function(n,i,o,s,r){return
function(n){var i={};function o(t){<a href="t">if(i</a>)return <a
href="t">i</a>.exports;var <a href="t">e=i</a>={i:t,l:!1,exports:{}};return
<a href="t">n</a>.call(e.exports,e,e.exports,o),e.l=!0,e.exports}return
o.m=n,o.c=i,o.d=function(t,e,n){o.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:n})},o.r=function(t){“undefined”!=typeof
...
e)for(var i in e)o.d(n,i,function(t){return <a
href="t">e</a>}.bind(null,i));return n},o.n=function(t){var
e=t&amp;&amp;t.__esModule?function(){return t.default}:function(){return
t};return o.d(e,“a”,e),e},o.o=function(t,e){return
Object.prototype.hasOwnProperty.call(t,e)},o.p=“”,o(o.s=9)}({“./foundation.core”:function(t,e){t.exports=n},“./foundation.util.keyboard”:function(t,e){t.exports=i},“./foundation.util.mediaQuery”:function(t,e){t.exports=o},“./foundation.util.motion”:function(t,e){t.exports=s},“./js/entries/plugins/foundation.offcanvas.js”:function(t,e,n){“use
strict”;n.r(e);var
i=n(“./foundation.core”);n.d(e,“Foundation”,function(){return
i.Foundation});var
o=n(“./js/foundation.offcanvas.js”);n.d(e,“OffCanvas”,function(){return
o.OffCanvas}),i.Foundation.plugin(o.OffCanvas,“OffCanvas”)},“./js/foundation.offcanvas.js”:function(t,e,n){“use
strict”;n.r(e),n.d(e,“OffCanvas”,function(){return g});var
i=n(“jquery”),s=n.n(i),r=n(“./foundation.core”),a=n(“./foundation.util.keyboard”),l=n(“./foundation.util.mediaQuery”),c=n(“./js/foundation.util.triggers.js”);function
...
t})(t)}function f(t,e){for(var n=0;n&lt;e.length;n++){var <a
...
u(t,e){return!e||“object”!==o(e)&amp;&amp;“function”!=typeof
...
h(t,e){return(h=Object.setPrototypeOf||function(t,e){return
t.__proto__=e,t})(t,e)}var g=function(t){function i(){return
...
e,n,o;return function(t,e){if(“function”!=typeof e&amp;&amp;null!==e)throw
new TypeError(“Super expression must either be null or a
function”);t.prototype=Object.create(e&amp;&amp;e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&amp;&amp;h(t,e)}(<a
href=""Plugin"">i,r</a>),e=i,(n=[{key:“_setup”,value:function(t,e){var
n=this;this.className=“OffCanvas”,this.$element=t,this.options=s.a.extend({},i.defaults,this.$element.data(),e),this.contentClasses={<a
href="">base:[],reveal:</a>},<a
href=""push","overlap"">this.$lastTrigger=s()(),this.$triggers=s()(),this.position=“left”,this.$content=s()(),this.nested=!!this.options.nested,s()(</a>).each(function(t,e){n.contentClasses.base.push(“has-transition-”+e)}),<a
href=""left","right","top","bottom"">s()(</a>).each(function(t,e){n.contentClasses.base.push(“has-position-”+e),n.contentClasses.reveal.push(“has-reveal-”+e)}),c.Triggers.init(s.a),l.MediaQuery._init(),this._init(),this._events(),a.Keyboard.register(“OffCanvas”,{ESCAPE:“close”})}},{key:“_init”,value:function(){var
<a
href="data-off-canvas-content">t=this.$element.attr(“id”);if(this.$element.attr(“aria-hidden”,“true”),this.options.contentId?this.$content=s()(“#”+this.options.contentId):this.$element.siblings(“</a>”).<a
href="data-off-canvas-content">length?this.$content=this.$element.siblings(“</a>”).<a
href="data-off-canvas-content">first():this.$content=this.$element.closest(“</a>”).first(),this.options.contentId?this.options.contentId&amp;&amp;null===this.options.nested&amp;&amp;console.warn(“Remember
to use the nested option if using the content ID <a
href="data-off-canvas-content">option!”):this.nested=0===this.$element.siblings(“</a>”).length,!0===this.nested&amp;&amp;(this.options.transition=“overlap”,this.$element.removeClass(“is-transition-push”)),this.$element.addClass(“is-transition-”.concat(this.options.transition,“
<a
href="data-open="'t'"">is-closed”)),this.$triggers=s()(document).find(‘</a>,
[data-close=“&#39;<code>t</code>&#39;”],
[data-toggle=“&#39;<code>t</code>&#39;”]&#39;).attr(“aria-expanded”,“false”).attr(“aria-controls”,t),this.position=this.$element.is(“.position-left,
.position-top, .position-right, .<a
href="1">position-bottom”)?this.$element.attr(“class”).match(/position-(left|top|right|bottom)/)</a>:this.position,!0===this.options.contentOverlay){var
e=document.createElement(“div”),n=“fixed”===s()(this.$element).css(“position”)?“is-overlay-fixed”:“is-overlay-absolute”;e.setAttribute(“class”,“js-off-canvas-overlay
”+n),this.$overlay=s()(e),“is-overlay-fixed”===n?s()(this.$overlay).insertAfter(this.$element):this.$content.append(this.$overlay)}var
i=new <a
href="^\\s">RegExp(Object(r.RegExpEscape)(this.options.revealClass)+“(</a>+)”,“<a
href="0">g”).exec(this.$element</a>.<a
href="1">className);i&&(this.options.isRevealed=!0,this.options.revealOn=this.options.revealOn||i</a>),!0===this.options.isRevealed&amp;&amp;this.options.revealOn&amp;&amp;(this.$element.first().addClass(“”.concat(this.options.revealClass).concat(this.options.revealOn)),this._setMQChecker()),this.options.transitionTime&amp;&amp;this.$element.css(“transition-duration”,this.options.transitionTime),this._removeContentClasses()}},{key:“_events”,value:function(){(this.$element.off(“.zf.trigger
.zf.offcanvas”).on({“open.zf.trigger”:this.open.bind(this),“close.zf.trigger”:this.close.bind(this),“toggle.zf.trigger”:this.toggle.bind(this),“keydown.zf.offcanvas”:this._handleKeyboard.bind(this)}),!0===this.options.closeOnClick)&amp;&amp;(this.options.contentOverlay?this.$overlay:this.$content).on({“click.zf.offcanvas”:this.close.bind(this)})}},{key:“_setMQChecker”,value:function(){var
t=this;this.onLoadListener=Object(r.onLoad)(s()(window),function(){l.MediaQuery.atLeast(t.options.revealOn)&amp;&amp;t.reveal(!0)}),s()(window).on(“changed.zf.mediaquery”,function(){l.MediaQuery.atLeast(t.options.revealOn)?t.reveal(!0):t.reveal(!1)})}},{key:“_removeContentClasses”,value:function(t){“boolean”!=typeof
t?this.$content.removeClass(this.contentClasses.base.join(“
”)):!1===t&amp;&amp;this.$content.removeClass(“has-reveal-”.concat(this.position))}},{key:“_addContentClasses”,value:function(t){this._removeContentClasses(t),“boolean”!=typeof
t?this.$content.addClass(“has-transition-”.concat(this.options.transition,“
has-position-”).concat(this.position)):!0===t&amp;&amp;this.$content.addClass(“has-reveal-”.concat(this.position))}},{key:“reveal”,value:function(t){t?(this.close(),this.isRevealed=!0,this.$element.attr(“aria-hidden”,“false”),this.$element.off(“open.zf.trigger
toggle.zf.trigger”),this.$element.removeClass(“is-closed”)):(this.isRevealed=!1,this.$element.attr(“aria-hidden”,“true”),this.$element.off(“open.zf.trigger
toggle.zf.trigger”).on({“open.zf.trigger”:this.open.bind(this),“toggle.zf.trigger”:this.toggle.bind(this)}),this.$element.addClass(“is-closed”)),this._addContentClasses(t)}},{key:“_stopScrolling”,value:function(t){return!1}},{key:“_recordScrollable”,value:function(t){var
e=this;e.scrollHeight!==e.clientHeight&amp;&amp;(0===e.scrollTop&amp;&amp;(e.scrollTop=1),e.scrollTop===e.scrollHeight-e.clientHeight&amp;&amp;(e.scrollTop=e.scrollHeight-e.clientHeight-1)),e.allowUp=0&lt;e.scrollTop,e.allowDown=e.scrollTop&lt;e.scrollHeight-e.clientHeight,e.lastY=t.originalEvent.pageY}},{key:“_stopScrollPropagation”,value:function(t){var
e=t.pageY&lt;this.lastY,n=!e;this.lastY=t.pageY,e&amp;&amp;this.allowUp||n&amp;&amp;this.allowDown?t.stopPropagation():t.preventDefault()}},{key:“open”,value:function(t,e){if(!this.$element.hasClass(“is-open”)&amp;&amp;!this.isRevealed){var
<a
href="data-off-canvas-content">n=this;e&&(this.$lastTrigger=e),“top”===this.options.forceTo?window.scrollTo(0,0):“bottom”===this.options.forceTo&&window.scrollTo(0,document.body.scrollHeight),this.options.transitionTime&&“overlap”!==this.options.transition?this.$element.siblings(“</a>”).<a
href="data-off-canvas-content">css(“transition-duration”,this.options.transitionTime):this.$element.siblings(“</a>”).css(“transition-duration”,“”),this.$element.addClass(“is-open”).removeClass(“is-closed”),this.$triggers.attr(“aria-expanded”,“true”),this.$element.attr(“aria-hidden”,“false”),this.$content.addClass(“is-open-”+this.position),!1===this.options.contentScroll&amp;&amp;(s()(“body”).addClass(“is-off-canvas-open”).on(“touchmove”,this._stopScrolling),this.$element.on(“touchstart”,this._recordScrollable),this.$element.on(“touchmove”,this._stopScrollPropagation)),!0===this.options.contentOverlay&amp;&amp;this.$overlay.addClass(“is-visible”),!0===this.options.closeOnClick&amp;&amp;!0===this.options.contentOverlay&amp;&amp;this.$overlay.addClass(“is-closable”),!0===this.options.autoFocus&amp;&amp;this.$element.one(Object(r.transitionend)(this.$element),function(){if(n.$element.hasClass(“is-open”)){var
<a
href="data-autofocus">t=n.$element.find(“</a>”);t.length?t.eq(0).focus():n.$element.find(“a,
button”).eq(0).focus()}}),!0===this.options.trapFocus&amp;&amp;(this.$content.attr(“tabindex”,“-1”),a.Keyboard.trapFocus(this.$element)),this._addContentClasses(),this.$element.trigger(“opened.zf.offcanvas”)}}},{key:“close”,value:function(t){if(this.$element.hasClass(“is-open”)&amp;&amp;!this.isRevealed){var
e=this;this.$element.removeClass(“is-open”),this.$element.attr(“aria-hidden”,“true”).trigger(“closed.zf.offcanvas”),this.$content.removeClass(“is-open-left
is-open-top is-open-right
is-open-bottom”),!1===this.options.contentScroll&amp;&amp;(s()(“body”).removeClass(“is-off-canvas-open”).off(“touchmove”,this._stopScrolling),this.$element.off(“touchstart”,this._recordScrollable),this.$element.off(“touchmove”,this._stopScrollPropagation)),!0===this.options.contentOverlay&amp;&amp;this.$overlay.removeClass(“is-visible”),!0===this.options.closeOnClick&amp;&amp;!0===this.options.contentOverlay&amp;&amp;this.$overlay.removeClass(“is-closable”),this.$triggers.attr(“aria-expanded”,“false”),!0===this.options.trapFocus&amp;&amp;(this.$content.removeAttr(“tabindex”),a.Keyboard.releaseFocus(this.$element)),this.$element.one(Object(r.transitionend)(this.$element),function(t){e.$element.addClass(“is-closed”),e._removeContentClasses()})}}},{key:“toggle”,value:function(t,e){this.$element.hasClass(“is-open”)?this.close(t,e):this.open(t,e)}},{key:“_handleKeyboard”,value:function(t){var
e=this;a.Keyboard.handleKey(t,“OffCanvas”,{close:function(){return
e.close(),e.$lastTrigger.focus(),!0},handled:function(){t.stopPropagation(),t.preventDefault()}})}},{key:“_destroy”,value:function(){this.close(),this.$element.off(“.zf.trigger
...
strict”;n.r(e),n.d(e,“Triggers”,function(){return f});var
i=n(“jquery”),s=n.n(i),o=n(“./foundation.core”),r=n(“./foundation.util.motion”);function
...
i=n.map(function(t){return“closeme.zf.”.concat(t)}).join(“
”);s()(window).off(i).on(i,f.Listeners.Global.closeMeListener)}},f.Initializers.addResizeListener=function(t){var
<a
href="data-resize">e=s()(“</a>”);e.length&amp;&amp;u(t,“resize.zf.trigger”,f.Listeners.Global.resizeListener,e)},f.Initializers.addScrollListener=function(t){var
<a
href="data-scroll">e=s()(“</a>”);e.length&amp;&amp;u(t,“scroll.zf.trigger”,f.Listeners.Global.scrollListener,e)},f.Initializers.addMutationEventsListener=function(t){if(!l)return!1;var
<a href="data-resize">e=t.find(“</a>, [data-scroll],
[data-mutate]”),n=function(t){var <a href="0">e=s()(t</a>.<a
...
i=0;i&lt;=e.length-1;i++){new <a href="i">l(n).observe(e</a>,{<a
...
t=s()(document);f.Initializers.addMutationEventsListener(t),f.Initializers.addResizeListener(),f.Initializers.addScrollListener(),f.Initializers.addClosemeListener()},f.init=function(t,e){Object(o.onLoad)(t(window),function(){!0!==t.triggersInitialized&amp;&amp;(f.Initializers.addSimpleListeners(),f.Initializers.addGlobalListeners(),t.triggersInitialized=!0)}),e&amp;&amp;(e.Triggers=f,e.IHearYou=f.Initializers.addGlobalListeners)}},9:function(t,e,n){t.exports=n(“./js/entries/plugins/foundation.offcanvas.js”)},jquery:function(t,e){t.exports=r}})});
//# sourceMappingURL=foundation.offcanvas.min.js.map</p>
</main>
