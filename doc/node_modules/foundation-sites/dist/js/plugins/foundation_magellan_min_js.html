...
<title>foundation.magellan.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.magellan.min.js">

<p>!function(t,e){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=e(require(“./foundation.core”),require(“./foundation.smoothScroll”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.smoothScroll","jquery"">define&&define.amd?define(</a>,e):“object”==typeof
<a
href=""foundation.magellan"">exports?exports</a>=e(require(“./foundation.core”),require(“./foundation.smoothScroll”),require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.magellan"">t.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">e(t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.smoothScroll"">t.FOUNDATION_EXTERNAL</a>,t.jQuery))}(window,function(n,o,i){return
...
Object.prototype.hasOwnProperty.call(t,e)},i.p=“”,i(i.s=8)}({“./foundation.core”:function(t,e){t.exports=n},“./foundation.smoothScroll”:function(t,e){t.exports=o},“./js/entries/plugins/foundation.magellan.js”:function(t,e,n){“use
strict”;n.r(e);var
o=n(“./foundation.core”);n.d(e,“Foundation”,function(){return
o.Foundation});var
i=n(“./js/foundation.magellan.js”);n.d(e,“Magellan”,function(){return
i.Magellan}),o.Foundation.plugin(i.Magellan,“Magellan”)},“./js/foundation.magellan.js”:function(t,e,n){“use
strict”;n.r(e),n.d(e,“Magellan”,function(){return h});var
o=n(“jquery”),c=n.n(o),r=n(“./foundation.core”),a=n(“./foundation.smoothScroll”);function
...
t})(t)}function s(t,e){for(var n=0;n&lt;e.length;n++){var <a
...
l(t,e){return!e||“object”!==i(e)&amp;&amp;“function”!=typeof
...
t.__proto__=e,t})(t,e)}var h=function(t){function n(){return
function(t,e){if(!(t instanceof e))throw new TypeError(“Cannot call a class
as a function”)}(this,n),l(this,u(n).apply(this,arguments))}var
...
href=""Plugin"">n,r</a>),e=n,(o=[{key:“_setup”,value:function(t,e){this.$element=t,this.options=c.a.extend({},n.defaults,this.$element.data(),e),this.className=“Magellan”,this._init(),this.calcPoints()}},{key:“_init”,value:function(){var
<a href="0">t=this.$element</a>.<a
href="data-magellan-target">id||Object(r.GetYoDigits)(6,“magellan”);this.$targets=c()(“</a>”),this.$links=this.$element.find(“a”),this.$element.attr({“data-resize”:t,“data-scroll”:t,id:t}),this.$active=c()(),this.scrollPos=parseInt(window.pageYOffset,10),this._events()}},{key:“calcPoints”,value:function(){var
n=this,t=document.body,e=document.documentElement;this.points=[],this.winHeight=Math.round(Math.max(window.innerHeight,e.clientHeight)),this.docHeight=Math.round(Math.max(t.scrollHeight,t.offsetHeight,e.clientHeight,e.scrollHeight,e.offsetHeight)),this.$targets.each(function(){var
t=c()(this),e=Math.round(t.offset().top-n.options.threshold);t.targetPoint=e,n.points.push(e)})}},{key:“_events”,value:function(){var
n=this;c()(“html,
body”),n.options.animationDuration,n.options.animationEasing;c()(window).one(“load”,function(){n.options.deepLinking&amp;&amp;location.hash&amp;&amp;n.scrollToLoc(location.hash),n.calcPoints(),n._updateActive()}),n.onLoadListener=Object(r.onLoad)(c()(window),function(){n.$element.on({“resizeme.zf.trigger”:n.reflow.bind(n),“scrollme.zf.trigger”:n._updateActive.bind(n)}).<a
href="href^="#"">on(“click.zf.magellan”,‘a</a>&#39;,function(t){t.preventDefault();var
e=this.getAttribute(“href”);n.scrollToLoc(e)})}),this._deepLinkScroll=function(t){n.options.deepLinking&amp;&amp;n.scrollToLoc(window.location.hash)},c()(window).on(“hashchange”,this._deepLinkScroll)}},{key:“scrollToLoc”,value:function(t){this._inTransition=!0;var
e=this,n={animationEasing:this.options.animationEasing,animationDuration:this.options.animationDuration,threshold:this.options.threshold,offset:this.options.offset};a.SmoothScroll.scrollToLoc(t,n,function(){e._inTransition=!1})}},{key:“reflow”,value:function(){this.calcPoints(),this._updateActive()}},{key:“_updateActive”,value:function(){var
n=this;if(!this._inTransition){var <a
href="0">t,o=parseInt(window.pageYOffset,10),i=this.scrollPos>o;if((this.scrollPos=o)<this.points</a>);else
if(o+this.winHeight===this.docHeight)t=this.points.length-1;else{var
e=this.points.filter(function(t,e){return
t-n.options.offset-(i?n.options.threshold:0)&lt;=o});t=e.length?e.length-1:0}var
r=this.$active,a=“”;void <a
href="href="#'+this.$targets.eq(t).data("magellan-target")+'"">0!==t?(this.$active=this.$links.filter(’</a>&#39;),<a
href="0">this.$active.length&&(a=this.$active</a>.getAttribute(“href”))):this.$active=c()();var
s=!(!this.$active.length&amp;&amp;!r.length||this.$active.is®),l=a!==window.location.hash;if(s&amp;&amp;(r.removeClass(this.options.activeClass),this.$active.addClass(this.options.activeClass)),this.options.deepLinking&amp;&amp;l)if(window.history.pushState){var
u=a||window.location.pathname+window.location.search;window.history.pushState(null,null,u)}else
<a
href="this.$active">window.location.hash=a;s&&this.$element.trigger(“update.zf.magellan”,</a>)}}},{key:“_destroy”,value:function(){if(this.$element.off(“.zf.trigger
.zf.magellan”).find(“.”.concat(this.options.activeClass)).removeClass(this.options.activeClass),this.options.deepLinking){var
<a
href="0">t=this.$active</a>.getAttribute(“href”);window.location.hash.replace(t,“”)}c()(window).off(“hashchange”,this._deepLinkScroll),this.onLoadListener&amp;&amp;c()(window).off(this.onLoadListener)}}])&amp;&amp;s(e.prototype,o),i&amp;&amp;s(e,i),n}();h.defaults={animationDuration:500,animationEasing:“linear”,threshold:50,activeClass:“is-active”,deepLinking:!1,offset:0}},8:function(t,e,n){t.exports=n(“./js/entries/plugins/foundation.magellan.js”)},jquery:function(t,e){t.exports=i}})});
//# sourceMappingURL=foundation.magellan.min.js.map</p>
</main>
