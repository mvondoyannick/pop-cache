...
<title>foundation.interchange.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.interchange.min.js">

<p>!function(e,t){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=t(require(“./foundation.core”),require(“./foundation.util.mediaQuery”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.util.mediaQuery","jquery"">define&&define.amd?define(</a>,t):“object”==typeof
<a
href=""foundation.interchange"">exports?exports</a>=t(require(“./foundation.core”),require(“./foundation.util.mediaQuery”),require(“jquery”)):(e.<em>FOUNDATION_EXTERNAL</em>=e.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.interchange"">e.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">t(e.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.mediaQuery"">e.FOUNDATION_EXTERNAL</a>,e.jQuery))}(window,function(n,r,i){return
function(n){var r={};function i(e){<a href="e">if(r</a>)return <a
...
t)for(var r in t)i.d(n,r,function(e){return <a
href="e">t</a>}.bind(null,r));return n},i.n=function(e){var
t=e&amp;&amp;e.__esModule?function(){return e.default}:function(){return
e};return i.d(t,“a”,t),t},i.o=function(e,t){return
Object.prototype.hasOwnProperty.call(e,t)},i.p=“”,i(i.s=7)}({“./foundation.core”:function(e,t){e.exports=n},“./foundation.util.mediaQuery”:function(e,t){e.exports=r},“./js/entries/plugins/foundation.interchange.js”:function(e,t,n){“use
strict”;n.r(t);var
r=n(“./foundation.core”);n.d(t,“Foundation”,function(){return
r.Foundation});var
i=n(“./js/foundation.interchange.js”);n.d(t,“Interchange”,function(){return
i.Interchange}),r.Foundation.plugin(i.Interchange,“Interchange”)},“./js/foundation.interchange.js”:function(e,t,n){“use
strict”;n.r(t),n.d(t,“Interchange”,function(){return d});var
r=n(“jquery”),i=n.n®,o=n(“./foundation.util.mediaQuery”),u=n(“./foundation.core”);function
...
e})(e)}function c(e,t){for(var n=0;n&lt;t.length;n++){var <a
href="n">r=t</a>;r.enumerable=r.enumerable||!1,r.configurable=!0,“value”in
r&amp;&amp;(r.writable=!0),Object.defineProperty(e,r.key,r)}}function
s(e,t){return!t||“object”!==a(t)&amp;&amp;“function”!=typeof
...
l(e,t){return(l=Object.setPrototypeOf||function(e,t){return
e.__proto__=t,e})(e,t)}var d=function(e){function a(){return
function(e,t){if(!(e instanceof t))throw new TypeError(“Cannot call a class
as a function”)}(this,a),s(this,f(a).apply(this,arguments))}var
t,n,r;return function(e,t){if(“function”!=typeof t&amp;&amp;null!==t)throw
new TypeError(“Super expression must either be null or a
function”);e.prototype=Object.create(t&amp;&amp;t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&amp;&amp;l(e,t)}(<a
href=""Plugin"">a,u</a>),<a
href="">t=a,(n=[{key:“_setup”,value:function(e,t){this.$element=e,this.options=i.a.extend({},a.defaults,t),this.rules=</a>,this.currentPath=“”,this.className=“Interchange”,this._init(),this._events()}},{key:“_init”,value:function(){o.MediaQuery._init();var
<a
href="0">e=this.$element</a>.id||Object(u.GetYoDigits)(6,“interchange”);this.$element.attr({“data-resize”:e,id:e}),this._addBreakpoints(),this._generateRules(),this._reflow()}},{key:“_events”,value:function(){var
e=this;this.$element.off(“resizeme.zf.trigger”).on(“resizeme.zf.trigger”,function(){return
e._reflow()})}},{key:“_reflow”,value:function(){var e;for(var t in
this.rules)if(this.rules.hasOwnProperty(t)){var <a
href="t">n=this.rules</a>;window.matchMedia(n.query).matches&amp;&amp;(e=n)}e&amp;&amp;this.replace(e.path)}},{key:“_addBreakpoints”,value:function(){for(var
e in o.MediaQuery.queries)if(o.MediaQuery.queries.hasOwnProperty(e)){var <a
href="e">t=o.MediaQuery.queries</a>;<a
href="t.name">a.SPECIAL_QUERIES</a>=t.value}}},{key:“_generateRules”,value:function(e){var
t,n=[];for(var r in
t=“string”==typeof(t=this.options.rules?this.options.rules:this.$element.data(“interchange”))?t.match(/[.*?,
.*?]/g):t)if(t.hasOwnProperty®){var <a
href="r">i=t</a>.slice(1,-1).split(“, ”),<a
href="i.length-1">o=i.slice(0,-1).join(“”),u=i</a>;<a
href="u">a.SPECIAL_QUERIES</a>&amp;&amp;(<a
href="u">u=a.SPECIAL_QUERIES</a>),n.push({path:o,query:u})}this.rules=n}},{key:“replace”,value:function(t){if(this.currentPath!==t){var
<a
href="0">n=this,r=“replaced.zf.interchange”;“IMG”===this.$element</a>.nodeName?this.$element.attr(“src”,t).on(“load”,function(){n.currentPath=t}).<a
href="?#">trigger®:t.match(/.(gif|jpg|jpeg|png|svg|tiff)(</a>.*)?/i)?(t=t.replace(/(/g,“%28”).replace(/)/g,“%29”),this.$element.css({“background-image”:“url(”<code>t</code>“)”}).trigger®):i.a.get(t,function(e){n.$element.html(e).trigger®,i()(e).foundation(),n.currentPath=t})}}},{key:“_destroy”,value:function(){this.$element.off(“resizeme.zf.trigger”)}}])&amp;&amp;c(t.prototype,n),r&amp;&amp;c(t,r),a}();d.defaults={rules:null},d.SPECIAL_QUERIES={landscape:“screen
and (orientation: landscape)”,portrait:“screen and (orientation:
portrait)”,retina:“only screen and (-webkit-min-device-pixel-ratio: 2),
...
(min-resolution:
2dppx)”}},7:function(e,t,n){e.exports=n(“./js/entries/plugins/foundation.interchange.js”)},jquery:function(e,t){e.exports=i}})});
//# sourceMappingURL=foundation.interchange.min.js.map</p>
</main>
