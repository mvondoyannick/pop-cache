...
<title>foundation.tabs.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.tabs.min.js">

<p>!function(t,e){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=e(require(“./foundation.core”),require(“./foundation.util.imageLoader”),require(“./foundation.util.keyboard”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.util.imageLoader","./foundation.util.keyboard","jquery"">define&&define.amd?define(</a>,e):“object”==typeof
<a
href=""foundation.tabs"">exports?exports</a>=e(require(“./foundation.core”),require(“./foundation.util.imageLoader”),require(“./foundation.util.keyboard”),require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.tabs"">t.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">e(t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.imageLoader"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.keyboard"">t.FOUNDATION_EXTERNAL</a>,t.jQuery))}(window,function(n,i,o,a){return
...
Object.prototype.hasOwnProperty.call(t,e)},o.p=“”,o(o.s=18)}({“./foundation.core”:function(t,e){t.exports=n},“./foundation.util.imageLoader”:function(t,e){t.exports=i},“./foundation.util.keyboard”:function(t,e){t.exports=o},“./js/entries/plugins/foundation.tabs.js”:function(t,e,n){“use
strict”;n.r(e);var
i=n(“./foundation.core”);n.d(e,“Foundation”,function(){return
i.Foundation});var
o=n(“./js/foundation.tabs.js”);n.d(e,“Tabs”,function(){return
o.Tabs}),i.Foundation.plugin(o.Tabs,“Tabs”)},“./js/foundation.tabs.js”:function(t,e,n){“use
strict”;n.r(e),n.d(e,“Tabs”,function(){return o});var
i=n(“jquery”),r=n.n(i),l=n(“./foundation.core”),s=n(“./foundation.util.keyboard”),c=n(“./foundation.util.imageLoader”);function
...
d(t,e){return!e||“object”!==a(e)&amp;&amp;“function”!=typeof
...
t.__proto__=e,t})(t,e)}var o=function(t){function n(){return
function(t,e){if(!(t instanceof e))throw new TypeError(“Cannot call a class
as a function”)}(this,n),d(this,f(n).apply(this,arguments))}var
e,i,o;return function(t,e){if(“function”!=typeof e&amp;&amp;null!==e)throw
...
href=""Plugin"">n,l</a>),e=n,(i=[{key:“_setup”,value:function(t,e){this.$element=t,this.options=r.a.extend({},n.defaults,this.$element.data(),e),this.className=“Tabs”,this._init(),s.Keyboard.register(“Tabs”,{ENTER:“open”,SPACE:“open”,ARROW_RIGHT:“next”,ARROW_UP:“previous”,ARROW_DOWN:“next”,ARROW_LEFT:“previous”})}},{key:“_init”,value:function(){var
a=this,s=this;if(this._isInitializing=!0,this.$element.attr({role:“tablist”}),<a
href="0">this.$tabTitles=this.$element.find(“.”.concat(this.options.linkClass)),this.$tabContent=r()(‘[data-tabs-content=“’.concat(this.$element</a>.id,&#39;”]&#39;)),this.$tabTitles.each(function(){var
<a
href="0">t=r()(this),e=t.find(“a”),n=t.hasClass(“”.concat(s.options.linkActiveClass)),i=e.attr(“data-tabs-target”)||e</a>.<a
href="0">hash.slice(1),o=e</a>.<a
href="0">id?e</a>.id:“”.concat(i,“-label”),a=r()(“#”.concat(i));t.attr({role:“presentation”}),e.attr({role:“tab”,“aria-controls”:i,“aria-selected”:n,id:o,tabindex:n?“0”:“-1”}),a.attr({role:“tabpanel”,“aria-labelledby”:o}),n&amp;&amp;(s._initialAnchor=“#”.concat(i)),n||a.attr(“aria-hidden”,“true”),n&amp;&amp;s.options.autoFocus&amp;&amp;(s.onLoadListener=Object(l.onLoad)(r()(window),function(){r()(“html,
body”).animate({scrollTop:t.offset().top},s.options.deepLinkSmudgeDelay,function(){e.focus()})}))}),this.options.matchHeight){var
t=this.$tabContent.find(“img”);t.length?Object(c.onImagesLoaded)(t,this._setHeight.bind(this)):this._setHeight()}this._checkDeepLink=function(){var
t=window.location.hash;if(!t.length){if(a._isInitializing)return;a._initialAnchor&amp;&amp;(t=a._initialAnchor)}var
<a
href="href$="'t'"">e=t&&r()(t),n=t&&a.$element.find(‘</a>&#39;),i=!(!e.length||!n.length);if(e&amp;&amp;e.length&amp;&amp;n&amp;&amp;n.length?a.selectTab(e,!0):a._collapse(),i){if(a.options.deepLinkSmudge){var
o=a.$element.offset();r()(“html,
body”).animate({scrollTop:o.top},a.options.deepLinkSmudgeDelay)}<a
href="n,e">a.$element.trigger(“deeplink.zf.tabs”,</a>)}},this.options.deepLink&amp;&amp;this._checkDeepLink(),this._events(),this._isInitializing=!1}},{key:“_events”,value:function(){this._addKeyHandler(),this._addClickHandler(),this._setHeightMqHandler=null,this.options.matchHeight&amp;&amp;(this._setHeightMqHandler=this._setHeight.bind(this),r()(window).on(“changed.zf.mediaquery”,this._setHeightMqHandler)),this.options.deepLink&amp;&amp;r()(window).on(“hashchange”,this._checkDeepLink)}},{key:“_addClickHandler”,value:function(){var
e=this;this.$element.off(“click.zf.tabs”).on(“click.zf.tabs”,“.”.concat(this.options.linkClass),function(t){t.preventDefault(),t.stopPropagation(),e._handleTabChange(r()(this))})}},{key:“_addKeyHandler”,value:function(){var
a=this;this.$tabTitles.off(“keydown.zf.tabs”).on(“keydown.zf.tabs”,function(t){if(9!==t.which){var
e,n,i=r()(this),o=i.parent(“ul”).children(“li”);o.each(function(t){r()(this).is(i)&amp;&amp;(n=a.options.wrapOnKeys?(e=0===t?o.last():o.eq(t-1),t===o.length-1?o.first():o.eq(t+1)):(e=o.eq(Math.max(0,t-1)),o.eq(Math.min(t+1,o.length-1))))}),s.Keyboard.handleKey(t,“Tabs”,{open:function(){<a
href="role="tab"">i.find(’</a>&#39;).focus(),a._handleTabChange(i)},previous:function(){<a
href="role="tab"">e.find(‘</a>&#39;).focus(),a._handleTabChange(e)},next:function(){<a
href="role="tab"">n.find(’</a>&#39;).focus(),a._handleTabChange(n)},handled:function(){t.stopPropagation(),t.preventDefault()}})}})}},{key:“_handleTabChange”,value:function(t,e){if(t.hasClass(“”.concat(this.options.linkActiveClass)))this.options.activeCollapse&amp;&amp;this._collapse();else{var
<a
href="role="tab"">n=this.$element.find(“.”.concat(this.options.linkClass,“.”).concat(this.options.linkActiveClass)),i=t.find(‘</a>&#39;),<a
href="0">o=i.attr(“data-tabs-target”),a=o&&o.length?“#”.concat(o):i</a>.hash,s=this.$tabContent.find(a);this._collapseTab(n),this._openTab(t),this.options.deepLink&amp;&amp;!e&amp;&amp;(this.options.updateHistory?history.pushState({},“”,a):history.replaceState({},“”,<a
href="t,s">a)),this.$element.trigger(“change.zf.tabs”,</a>),<a
href="data-mutate">s.find(“</a>”).trigger(“mutateme.zf.trigger”)}}},{key:“_openTab”,value:function(t){var
<a href="role="tab"">e=t.find(’</a>&#39;),<a
href="0">n=e.attr(“data-tabs-target”)||e</a>.hash.slice(1),i=this.$tabContent.find(“#”.concat(n));t.addClass(“”.concat(this.options.linkActiveClass)),e.attr({“aria-selected”:“true”,tabindex:“0”}),i.addClass(“”.concat(this.options.panelActiveClass)).removeAttr(“aria-hidden”)}},{key:“_collapseTab”,value:function(t){var
<a
href="role="tab"">e=t.removeClass(“”.concat(this.options.linkActiveClass)).find(‘</a>&#39;).attr({“aria-selected”:“false”,tabindex:-1});r()(“#”.concat(e.attr(“aria-controls”))).removeClass(“”.concat(this.options.panelActiveClass)).attr({“aria-hidden”:“true”})}},{key:“_collapse”,value:function(){var
<a
href="t">t=this.$element.find(“.”.concat(this.options.linkClass,“.”).concat(this.options.linkActiveClass));t.length&&(this._collapseTab(t),this.$element.trigger(“collapse.zf.tabs”,</a>))}},{key:“selectTab”,value:function(t,e){var
<a
href="0">n;(n=“object”===a(t)?t</a>.id:t).indexOf(“#”)&lt;0&amp;&amp;(n=“#”.concat(n));var
<a
href="href$="'.concat(n,'"">i=this.$tabTitles.has(’</a>&#39;));this._handleTabChange(i,e)}},{key:“_setHeight”,value:function(){var
i=0,o=this;this.$tabContent.find(“.”.concat(this.options.panelClass)).css(“height”,“”).each(function(){var
t=r()(this),e=t.hasClass(“”.concat(o.options.panelActiveClass));e||t.css({visibility:“hidden”,display:“block”});var
...
//# sourceMappingURL=foundation.tabs.min.js.map</p>
</main>
