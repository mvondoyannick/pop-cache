...
<title>foundation.slider.min.js.map - RDoc Documentation</title>
...
tttObject.defineProperty(exports, name, { enumerable: true, get: getter
});n tt}n t};nn t// define __esModule on exportsn t__webpack_require__.r =
function(exports) {n ttif(typeof Symbol !== &#39;undefined&#39; &amp;&amp;
Symbol.toStringTag) {n tttObject.defineProperty(exports,
Symbol.toStringTag, { value: &#39;Module&#39; });n tt}n
ttObject.defineProperty(exports, &#39;__esModule&#39;, { value: true });n
t};nn t// create a fake namespace objectn t// mode &amp; 1: value is a
module id, require itn t// mode &amp; 2: merge all properties of value into
the nsn t// mode &amp; 4: return value when already ns objectn t// mode
&amp; 8|1: behave like requiren t__webpack_require__.t = function(value,
mode) {n ttif(mode &amp; 1) value = <em>webpack_require</em>(value);n
ttif(mode &amp; 8) return value;n ttif((mode &amp; 4) &amp;&amp; typeof
value === &#39;object&#39; &amp;&amp; value &amp;&amp; value.__esModule)
return value;n ttvar ns = Object.create(null);n
tt__webpack_require__.r(ns);n ttObject.defineProperty(ns,
&#39;default&#39;, { enumerable: true, value: value });n ttif(mode &amp; 2
&amp;&amp; typeof value != &#39;string&#39;) for(var key in value)
<em>webpack_require</em>.d(ns, key, function(key) { return <a
href="key">value</a>; }.bind(null, key));n ttreturn ns;n t};nn t//
...
<em>webpack_public_path</em>n t__webpack_require__.p = "&quot;;nnn t// Load
entry module and return exportsn treturn
<em>webpack_require</em>(<em>webpack_require</em>.s =
15);n”,“module.exports =
<em>WEBPACK_EXTERNAL_MODULE__foundation_core</em>;”,“module.exports =
<em>WEBPACK_EXTERNAL_MODULE__foundation_util_keyboard</em>;”,“module.exports
=
<em>WEBPACK_EXTERNAL_MODULE__foundation_util_motion</em>;”,“module.exports
= <em>WEBPACK_EXTERNAL_MODULE__foundation_util_touch</em>;”,“import {
Foundation } from &#39;./foundation.core&#39;;nnimport { Slider } from
&#39;../../foundation.slider&#39;;nFoundation.plugin(Slider,
&#39;Slider&#39;);nnexport { Foundation, Slider };n”,“&#39;use
...
{ onLoad } from &#39;./foundation.core.utils&#39;;nimport { Motion } from
&#39;./foundation.util.motion&#39;;nnconst MutationObserver = (function ()
{n  var prefixes = [&#39;WebKit&#39;, &#39;Moz&#39;, &#39;O&#39;,
&#39;Ms&#39;, &#39;&#39;];n  for (var i=0; i &lt; prefixes.length; i++) {n 
if (`${<a href="i">prefixes</a>}MutationObserver` in window) {n      return
<a href="i">window[`${prefixes</a>}MutationObserver`];n    }n  }n  return
false;n}());nnconst triggers = (el, type) =&gt; {n 
el.data(type).split(&#39; &#39;).forEach(id =&gt; {n    $(`#${id}`)[ type
=== &#39;close&#39; ? &#39;trigger&#39; :
&#39;triggerHandler&#39;](`${type}.zf.trigger`, [el]);n  });n};nnvar
...
$(this).trigger(&#39;toggle.zf.trigger&#39;);n    }n  },n 
closeableListener: function(e) {n    e.stopPropagation();n    let animation
= $(this).data(&#39;closable&#39;);nn    if(animation !== &#39;&#39;){n    
Motion.animateOut($(this), animation, function() {n       
$(this).trigger(&#39;closed.zf&#39;);n      });n    }else{n     
$(this).fadeOut().trigger(&#39;closed.zf&#39;);n    }n  },n 
toggleFocusListener: function() {n    let id =
$(this).data(&#39;toggle-focus&#39;);n   
$(`#${id}`).triggerHandler(&#39;toggle.zf.trigger&#39;, [$(this)]);n 
}n};nn// Elements with [data-open] will reveal a plugin that supports it
when clicked.nTriggers.Initializers.addOpenListener = ($elem) =&gt; {n 
$elem.off(&#39;click.zf.trigger&#39;,
Triggers.Listeners.Basic.openListener);n 
...
$elem.off(&#39;click.zf.trigger&#39;,
Triggers.Listeners.Basic.closeListener);n 
...
$elem.off(&#39;click.zf.trigger&#39;,
Triggers.Listeners.Basic.toggleListener);n 
...
Triggers.Listeners.Basic.closeableListener);n 
$elem.on(&#39;close.zf.trigger&#39;, &#39;[data-closeable],
[data-closable]&#39;, Triggers.Listeners.Basic.closeableListener);n}nn//
Elements with [data-toggle-focus] will respond to coming in and out of
focusnTriggers.Initializers.addToggleFocusListener = ($elem) =&gt; {n 
$elem.off(&#39;focus.zf.trigger blur.zf.trigger&#39;,
Triggers.Listeners.Basic.toggleFocusListener);n 
$elem.on(&#39;focus.zf.trigger blur.zf.trigger&#39;,
&#39;[data-toggle-focus]&#39;,
...
$nodes.attr(&#39;data-events&#39;, "scroll&quot;);n  },n  closeMeListener:
function(e, pluginId){n    let plugin = <a
href="0">e.namespace.split(’.‘)</a>;n    let plugins =
$(`[data-${plugin}]`).<a
href="data-yeti-box=\"${pluginId}\"">not(`</a>`);nn   
plugins.each(function(){n      let _this = $(this);n     
_this.triggerHandler(&#39;close.zf.trigger&#39;, [_this]);n    });n 
}n}nn// Global, parses whole
document.nTriggers.Initializers.addClosemeListener = function(pluginName)
{n  var yetiBoxes = $(&#39;[data-yeti-box]&#39;),n      plugNames =
[&#39;dropdown&#39;, &#39;tooltip&#39;, &#39;reveal&#39;];nn 
if(pluginName){n    if(typeof pluginName === &#39;string&#39;){n     
plugNames.push(pluginName);n    }else if(typeof pluginName ===
&#39;object&#39; &amp;&amp; typeof <a href="0">pluginName</a> ===
&#39;string&#39;){n      plugNames = plugNames.concat(pluginName);n   
}else{n      console.error(&#39;Plugin names must be strings&#39;);n    }n 
}n  if(yetiBoxes.length){n    let listeners = plugNames.map((name) =&gt; {n
...
&#39;resize.zf.trigger&#39;, Triggers.Listeners.Global.resizeListener,
$nodes);n  }n}nnTriggers.Initializers.addScrollListener =
function(debounce){n  let $nodes = $(&#39;[data-scroll]&#39;);n 
if($nodes.length){n    debounceGlobalListener(debounce,
&#39;scroll.zf.trigger&#39;, Triggers.Listeners.Global.scrollListener,
$nodes);n  }n}nnTriggers.Initializers.addMutationEventsListener =
function($elem) {n  if(!MutationObserver){ return false; }n  let $nodes =
$<a href="data-resize">elem.find(’</a>, [data-scroll],
[data-mutate]&#39;);nn  //element callbackn  var listeningElementsMutation
= function (mutationRecordsList) {n    var $target = $(<a
href="0">mutationRecordsList</a>.target);nn    //trigger the event handler
for the element depending on typen    switch (<a
href="0">mutationRecordsList</a>.type) {n      case "attributes&quot;:n    
if ($target.attr(&quot;data-events&quot;) === "scroll&quot; &amp;&amp; <a
href="0">mutationRecordsList</a>.attributeName === "data-events&quot;) {n  
$target.triggerHandler(&#39;scrollme.zf.trigger&#39;, [$target,
window.pageYOffset]);n        }n        if
($target.attr(&quot;data-events&quot;) === "resize&quot; &amp;&amp; <a
href="0">mutationRecordsList</a>.attributeName === "data-events&quot;) {n  
$target.triggerHandler(&#39;resizeme.zf.trigger&#39;, [$target]);n        
}n        if (<a href="0">mutationRecordsList</a>.attributeName ===
"style&quot;) {n          $<a
href="data-mutate">target.closest("</a>&quot;).attr(&quot;data-events&quot;,&quot;mutate&quot;);n
$<a
href="data-mutate">target.closest("</a>&quot;).triggerHandler(&#39;mutateme.zf.trigger&#39;,
[$<a href="data-mutate">target.closest("</a>&quot;)]);n        }n       
break;nn      case "childList&quot;:n        $<a
href="data-mutate">target.closest("</a>&quot;).attr(&quot;data-events&quot;,&quot;mutate&quot;);n
$<a
href="data-mutate">target.closest("</a>&quot;).triggerHandler(&#39;mutateme.zf.trigger&#39;,
[$<a href="data-mutate">target.closest("</a>&quot;)]);n        break;nn    
default:n        return false;n      //nothingn    }n  };nn  if
($nodes.length) {n    //for each element that needs to listen for resizing,
scrolling, or mutation add a single observern    for (var i = 0; i &lt;=
$nodes.length - 1; i++) {n      var elementObserver = new
MutationObserver(listeningElementsMutation);n      <a
href="i">elementObserver.observe($nodes</a>, { attributes: true, childList:
true, characterData: false, subtree: true, attributeFilter:
[&quot;data-events&quot;, "style&quot;] });n    }n 
}n}nnTriggers.Initializers.addSimpleListeners = function() {n  let
$document = $(document);nn 
Triggers.Initializers.addOpenListener($document);n 
Triggers.Initializers.addCloseListener($document);n 
Triggers.Initializers.addToggleListener($document);n 
Triggers.Initializers.addCloseableListener($document);n 
Triggers.Initializers.addToggleFocusListener($document);nn}nnTriggers.Initializers.addGlobalListeners
= function() {n  let $document = $(document);n 
Triggers.Initializers.addMutationEventsListener($document);n 
Triggers.Initializers.addResizeListener();n 
Triggers.Initializers.addScrollListener();n 
Triggers.Initializers.addClosemeListener();n}nnnTriggers.init = function
($, Foundation) {n  onLoad($(window), function () {n    if
($.triggersInitialized !== true) {n     
Triggers.Initializers.addSimpleListeners();n     
Triggers.Initializers.addGlobalListeners();n      $.triggersInitialized =
true;n    }n  });nn  if(Foundation) {n    Foundation.Triggers = Triggers;n 
// Legacy included to be backwards compatible for now.n   
Foundation.IHearYou = Triggers.Initializers.addGlobalListenersn 
}n}nnexport {Triggers};n”,“module.exports =
<em>WEBPACK_EXTERNAL_MODULE_jquery</em>;”]}</p>
</main>
