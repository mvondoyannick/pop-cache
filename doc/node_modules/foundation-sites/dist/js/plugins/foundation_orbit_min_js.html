...
<title>foundation.orbit.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.orbit.min.js">

<p>!function(t,e){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=e(require(“./foundation.core”),require(“./foundation.util.imageLoader”),require(“./foundation.util.keyboard”),require(“./foundation.util.motion”),require(“./foundation.util.timer”),require(“./foundation.util.touch”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.util.imageLoader","./foundation.util.keyboard","./foundation.util.motion","./foundation.util.timer","./foundation.util.touch","jquery"">define&&define.amd?define(</a>,e):“object”==typeof
<a
href=""foundation.orbit"">exports?exports</a>=e(require(“./foundation.core”),require(“./foundation.util.imageLoader”),require(“./foundation.util.keyboard”),require(“./foundation.util.motion”),require(“./foundation.util.timer”),require(“./foundation.util.touch”),require(“jquery”)):(t.<em>FOUNDATION_EXTERNAL</em>=t.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.orbit"">t.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">e(t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.imageLoader"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.keyboard"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.motion"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.timer"">t.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.touch"">t.FOUNDATION_EXTERNAL</a>,t.jQuery))}(window,function(i,n,o,s,r,a,u){return
...
Object.prototype.hasOwnProperty.call(t,e)},o.p=“”,o(o.s=10)}({“./foundation.core”:function(t,e){t.exports=i},“./foundation.util.imageLoader”:function(t,e){t.exports=n},“./foundation.util.keyboard”:function(t,e){t.exports=o},“./foundation.util.motion”:function(t,e){t.exports=s},“./foundation.util.timer”:function(t,e){t.exports=r},“./foundation.util.touch”:function(t,e){t.exports=a},“./js/entries/plugins/foundation.orbit.js”:function(t,e,i){“use
strict”;i.r(e);var
n=i(“./foundation.core”);i.d(e,“Foundation”,function(){return
n.Foundation});var
o=i(“./js/foundation.orbit.js”);i.d(e,“Orbit”,function(){return
o.Orbit}),n.Foundation.plugin(o.Orbit,“Orbit”)},“./js/foundation.orbit.js”:function(t,e,i){“use
strict”;i.r(e),i.d(e,“Orbit”,function(){return m});var
n=i(“jquery”),s=i.n(n),r=i(“./foundation.util.keyboard”),f=i(“./foundation.util.motion”),a=i(“./foundation.util.timer”),u=i(“./foundation.util.imageLoader”),l=i(“./foundation.core”),c=i(“./foundation.util.touch”);function
...
t})(t)}function d(t,e){for(var i=0;i&lt;e.length;i++){var <a
...
h(t,e){return!e||“object”!==o(e)&amp;&amp;“function”!=typeof
e?function(t){if(void 0!==t)return t;throw new ReferenceError(“this
hasn&#39;t been initialised - super() hasn&#39;t been
called”)}(t):e}function
p(t){return(p=Object.setPrototypeOf?Object.getPrototypeOf:function(t){return
t.__proto__||Object.getPrototypeOf(t)})(t)}function
b(t,e){return(b=Object.setPrototypeOf||function(t,e){return
t.__proto__=e,t})(t,e)}var m=function(t){function i(){return
function(t,e){if(!(t instanceof e))throw new TypeError(“Cannot call a class
as a function”)}(this,i),h(this,p(i).apply(this,arguments))}var
e,n,o;return function(t,e){if(“function”!=typeof e&amp;&amp;null!==e)throw
new TypeError(“Super expression must either be null or a
function”);t.prototype=Object.create(e&amp;&amp;e.prototype,{constructor:{value:t,writable:!0,configurable:!0}}),e&amp;&amp;b(t,e)}(<a
href=""Plugin"">i,l</a>),e=i,(n=[{key:“_setup”,value:function(t,e){this.$element=t,this.options=s.a.extend({},i.defaults,this.$element.data(),e),this.className=“Orbit”,c.Touch.init(s.a),this._init(),r.Keyboard.register(“Orbit”,{ltr:{ARROW_RIGHT:“next”,ARROW_LEFT:“previous”},rtl:{ARROW_LEFT:“next”,ARROW_RIGHT:“previous”}})}},{key:“_init”,value:function(){this._reset(),this.$wrapper=this.$element.find(“.”.concat(this.options.containerClass)),this.$slides=this.$element.find(“.”.concat(this.options.slideClass));var
<a
href="0">t=this.$element.find(“img”),e=this.$slides.filter(“.is-active”),i=this.$element</a>.id||Object(l.GetYoDigits)(6,“orbit”);this.$element.attr({“data-resize”:i,id:i}),e.length||this.$slides.eq(0).addClass(“is-active”),this.options.useMUI||this.$slides.addClass(“no-motionui”),t.length?Object(u.onImagesLoaded)(t,this._prepareForOrbit.bind(this)):this._prepareForOrbit(),this.options.bullets&amp;&amp;this._loadBullets(),this._events(),this.options.autoPlay&amp;&amp;1&lt;this.$slides.length&amp;&amp;this.geoSync(),this.options.accessible&amp;&amp;this.$wrapper.attr(“tabindex”,0)}},{key:“_loadBullets”,value:function(){this.$bullets=this.$element.find(“.”.concat(this.options.boxOfBullets)).find(“button”)}},{key:“geoSync”,value:function(){var
t=this;this.timer=new
a.Timer(this.$element,{duration:this.options.timerDelay,infinite:!1},function(){t.changeSlide(!0)}),this.timer.start()}},{key:“_prepareForOrbit”,value:function(){this._setWrapperHeight()}},{key:“_setWrapperHeight”,value:function(t){var
e,i=0,n=0,o=this;this.$slides.each(function(){<a
href="0">e=this.getBoundingClientRect().height,s()(this).attr(“data-slide”,n),/mui/g.test(s()(this)</a>.<a
href="0">className)||o.$slides.filter(“.is-active”)</a>===<a
href="0">o.$slides.eq(n)</a>||s()(this).css({display:“none”}),i=i&lt;e?e:i,n++}),n===this.$slides.length&amp;&amp;(this.$wrapper.css({height:i}),t&amp;&amp;t(i))}},{key:“_setSlideHeight”,value:function(t){this.$slides.each(function(){s()(this).css(“max-height”,t)})}},{key:“_events”,value:function(){var
n=this;if(this.$element.off(“.resizeme.zf.trigger”).on({“resizeme.zf.trigger”:this._prepareForOrbit.bind(this)}),1&lt;this.$slides.length){if(this.options.swipe&amp;&amp;this.$slides.off(“swipeleft.zf.orbit
swiperight.zf.orbit”).on(“swipeleft.zf.orbit”,function(t){t.preventDefault(),n.changeSlide(!0)}).on(“swiperight.zf.orbit”,function(t){t.preventDefault(),n.changeSlide(!1)}),this.options.autoPlay&amp;&amp;(this.$slides.on(“click.zf.orbit”,function(){<a
href="n.$element.data("clickedOn")?"pause":"start"">n.$element.data(“clickedOn”,!n.$element.data(“clickedOn”)),n.timer</a>()}),this.options.pauseOnHover&amp;&amp;this.$element.on(“mouseenter.zf.orbit”,function(){n.timer.pause()}).on(“mouseleave.zf.orbit”,function(){n.$element.data(“clickedOn”)||n.timer.start()})),this.options.navButtons)this.$element.find(“.”.concat(this.options.nextClass,“,
.”).concat(this.options.prevClass)).attr(“tabindex”,0).on(“click.zf.orbit
touchend.zf.orbit”,function(t){t.preventDefault(),n.changeSlide(s()(this).hasClass(n.options.nextClass))});this.options.bullets&amp;&amp;this.$bullets.on(“click.zf.orbit
touchend.zf.orbit”,function(){if(/is-active/g.test(this.className))return!1;var
t=s()(this).data(“slide”),e=t&gt;n.$slides.filter(“.is-active”).data(“slide”),i=n.$slides.eq(t);n.changeSlide(e,i,t)}),this.options.accessible&amp;&amp;this.$wrapper.add(this.$bullets).on(“keydown.zf.orbit”,function(t){r.Keyboard.handleKey(t,“Orbit”,{next:function(){n.changeSlide(!0)},previous:function(){n.changeSlide(!1)},handled:function(){s()(t.target).is(n.$bullets)&amp;&amp;n.$bullets.filter(“.is-active”).focus()}})})}}},{key:“_reset”,value:function(){void
0!==this.$slides&amp;&amp;1&lt;this.$slides.length&amp;&amp;(this.$element.off(“.zf.orbit”).find(“*”).off(“.zf.orbit”),this.options.autoPlay&amp;&amp;this.timer.restart(),this.$slides.each(function(t){s()(t).removeClass(“is-active
is-active is-in”).removeAttr(“aria-live”).hide()}),<a
href="this.$slides.first()">this.$slides.first().addClass(“is-active”).show(),this.$element.trigger(“slidechange.zf.orbit”,</a>),this.options.bullets&amp;&amp;this._updateBullets(0))}},{key:“changeSlide”,value:function(t,e,i){if(this.$slides){var
<a
href="0">n=this.$slides.filter(“.is-active”).eq(0);if(/mui/g.test(n</a>.className))return!1;var
<a
href="n,o">o,s=this.$slides.first(),r=this.$slides.last(),a=t?“Right”:“Left”,u=t?“Left”:“Right”,l=this;(o=e||(t?this.options.infiniteWrap?n.next(“.”.concat(this.options.slideClass)).length?n.next(“.”.concat(this.options.slideClass)):s:n.next(“.”.concat(this.options.slideClass)):this.options.infiniteWrap?n.prev(“.”.concat(this.options.slideClass)).length?n.prev(“.”.concat(this.options.slideClass)):r:n.prev(“.”.concat(this.options.slideClass)))).length&&(this.$element.trigger(“beforeslidechange.zf.orbit”,</a>),<a
href=""animInFrom".concat(a)">this.options.bullets&&(i=i||this.$slides.index(o),this._updateBullets(i)),this.options.useMUI&&!this.$element.is(“:hidden”)?(f.Motion.animateIn(o.addClass(“is-active”),this.options</a>,function(){o.css({display:“block”}).attr(“aria-live”,“polite”)}),<a
href=""animOutTo".concat(u)">f.Motion.animateOut(n.removeClass(“is-active”),this.options</a>,function(){n.removeAttr(“aria-live”),l.options.autoPlay&amp;&amp;!l.timer.isPaused&amp;&amp;l.timer.restart()})):(n.removeClass(“is-active
is-in”).removeAttr(“aria-live”).hide(),o.addClass(“is-active <a
href="o">is-in”).attr(“aria-live”,“polite”).show(),this.options.autoPlay&&!this.timer.isPaused&&this.timer.restart()),this.$element.trigger(“slidechange.zf.orbit”,</a>))}}},{key:“_updateBullets”,value:function(t){var
e=this.$element.find(“.”.concat(this.options.boxOfBullets)).find(“.is-active”).removeClass(“is-active”).blur().find(“span:last”).detach();this.$bullets.eq(t).addClass(“is-active”).append(e)}},{key:“_destroy”,value:function(){this.$element.off(“.zf.orbit”).find(“*”).off(“.zf.orbit”).end().hide()}}])&amp;&amp;d(e.prototype,n),o&amp;&amp;d(e,o),i}();m.defaults={bullets:!0,navButtons:!0,animInFromRight:“slide-in-right”,animOutToRight:“slide-out-right”,animInFromLeft:“slide-in-left”,animOutToLeft:“slide-out-left”,autoPlay:!0,timerDelay:5e3,infiniteWrap:!0,swipe:!0,pauseOnHover:!0,accessible:!0,containerClass:“orbit-container”,slideClass:“orbit-slide”,boxOfBullets:“orbit-bullets”,nextClass:“orbit-next”,prevClass:“orbit-previous”,useMUI:!0}},10:function(t,e,i){t.exports=i(“./js/entries/plugins/foundation.orbit.js”)},jquery:function(t,e){t.exports=u}})});
//# sourceMappingURL=foundation.orbit.min.js.map</p>
</main>
