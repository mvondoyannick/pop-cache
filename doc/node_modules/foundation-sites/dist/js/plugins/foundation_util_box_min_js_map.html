...
<title>foundation.util.box.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.box.min.js.map">
...
21);n”,“module.exports =
<em>WEBPACK_EXTERNAL_MODULE__foundation_core</em>;”,“import { Foundation }
from &#39;./foundation.core&#39;;nimport { Box } from
&#39;../../foundation.util.box&#39;;nnFoundation.Box = Box;nnexport {
Foundation, Box };n”,“&#39;use strict&#39;;nnnimport { rtl as Rtl } from
...
= elem.length ? <a href="0">elem</a> : elem;nn  if (elem === window || elem
=== document) {n    throw new Error(&quot;I&#39;m sorry, Dave. I&#39;m
afraid I can&#39;t do that.&quot;);n  }nn  var rect =
elem.getBoundingClientRect(),n      parRect =
...
compatibility, and wheren * you don&#39;t know alignment, but generally
fromn * 6.4 forward you should use GetExplicitOffsets, as GetOffsets
conflates position and alignment.n * @functionn * @param {jQuery} element -
jQuery object for the element being positioned.n * @param {jQuery} anchor -
jQuery object for the element&#39;s anchor point.n * @param {String}
position - a string relating to the desired position of the element,
relative to it&#39;s anchorn * @param {Number} vOffset - integer pixel
value of desired vertical separation between anchor and element.n * @param
{Number} hOffset - integer pixel value of desired horizontal separation
between anchor and element.n * @param {Boolean} isOverflow - if a collision
event is detected, sets to true to default the element to full width - any
desired offset.n * TODO alter/rewrite to work with `em` values as
well/instead of pixelsn */nfunction GetOffsets(element, anchor, position,
vOffset, hOffset, isOverflow) {n  console.log(&quot;NOTE: GetOffsets is
deprecated in favor of GetExplicitOffsets and will be removed in
6.5&quot;);n  switch (position) {n    case &#39;top&#39;:n      return
Rtl() ?n        GetExplicitOffsets(element, anchor, &#39;top&#39;,
&#39;left&#39;, vOffset, hOffset, isOverflow) :n       
GetExplicitOffsets(element, anchor, &#39;top&#39;, &#39;right&#39;,
vOffset, hOffset, isOverflow);n    case &#39;bottom&#39;:n      return
Rtl() ?n        GetExplicitOffsets(element, anchor, &#39;bottom&#39;,
&#39;left&#39;, vOffset, hOffset, isOverflow) :n       
GetExplicitOffsets(element, anchor, &#39;bottom&#39;, &#39;right&#39;,
vOffset, hOffset, isOverflow);n    case &#39;center top&#39;:n      return
GetExplicitOffsets(element, anchor, &#39;top&#39;, &#39;center&#39;,
vOffset, hOffset, isOverflow);n    case &#39;center bottom&#39;:n     
return GetExplicitOffsets(element, anchor, &#39;bottom&#39;,
&#39;center&#39;, vOffset, hOffset, isOverflow);n    case &#39;center
left&#39;:n      return GetExplicitOffsets(element, anchor, &#39;left&#39;,
&#39;center&#39;, vOffset, hOffset, isOverflow);n    case &#39;center
right&#39;:n      return GetExplicitOffsets(element, anchor,
&#39;right&#39;, &#39;center&#39;, vOffset, hOffset, isOverflow);n    case
&#39;left bottom&#39;:n      return GetExplicitOffsets(element, anchor,
&#39;bottom&#39;, &#39;left&#39;, vOffset, hOffset, isOverflow);n    case
&#39;right bottom&#39;:n      return GetExplicitOffsets(element, anchor,
&#39;bottom&#39;, &#39;right&#39;, vOffset, hOffset, isOverflow);n    //
Backwards compatibility… this along with the reveal and reveal fulln    //
classes are the only ones that didn&#39;t reference anchorn    case
&#39;center&#39;:n      return {n        left:
...
($eleDims.height / 2 + vOffset)n      }n    case &#39;reveal&#39;:n     
return {n        left: ($eleDims.windowDims.width - $eleDims.width) / 2 +
hOffset,n        top: $eleDims.windowDims.offset.top + vOffsetn      }n   
case &#39;reveal full&#39;:n      return {n        left:
$eleDims.windowDims.offset.left,n        top:
$eleDims.windowDims.offset.topn      }n      break;n    default:n     
...
case &#39;top&#39;:n      topVal = $anchorDims.offset.top -
($eleDims.height + vOffset);n      break;n    case &#39;bottom&#39;:n     
topVal = $anchorDims.offset.top + $anchorDims.height + vOffset;n     
break;n    case &#39;left&#39;:n      leftVal = $anchorDims.offset.left -
($eleDims.width + hOffset);n      break;n    case &#39;right&#39;:n     
leftVal = $anchorDims.offset.left + $anchorDims.width + hOffset;n     
break;n  }nnn  // set alignment related attributen  switch (position) {n   
case &#39;top&#39;:n    case &#39;bottom&#39;:n      switch (alignment) {n 
case &#39;left&#39;:n          leftVal = $anchorDims.offset.left +
hOffset;n          break;n        case &#39;right&#39;:n          leftVal =
$anchorDims.offset.left - $eleDims.width + $anchorDims.width - hOffset;n   
break;n        case &#39;center&#39;:n          leftVal = isOverflow ?
hOffset : (($anchorDims.offset.left + ($anchorDims.width / 2)) -
($eleDims.width / 2)) + hOffset;n          break;n      }n      break;n   
case &#39;right&#39;:n    case &#39;left&#39;:n      switch (alignment) {n 
case &#39;bottom&#39;:n          topVal = $anchorDims.offset.top - vOffset
+ $anchorDims.height - $eleDims.height;n          break;n        case
&#39;top&#39;:n          topVal = $anchorDims.offset.top + vOffsetn        
break;n        case &#39;center&#39;:n          topVal =
($anchorDims.offset.top + vOffset + ($anchorDims.height / 2)) -
($eleDims.height / 2)n          break;n      }n      break;n  }n  return
{top: topVal, left: leftVal};n}nnexport {Box};n”]}</p>
</main>
