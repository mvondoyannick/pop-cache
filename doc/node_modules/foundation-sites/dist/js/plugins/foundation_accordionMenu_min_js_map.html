...
<title>foundation.accordionMenu.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.accordionMenu.min.js.map">
...
<em>webpack_require</em>(<em>webpack_require</em>.s = 2);n”,“module.exports
...
Foundation } from &#39;./foundation.core&#39;;nnimport { AccordionMenu }
from
&#39;../../foundation.accordionMenu&#39;;nFoundation.plugin(AccordionMenu,
&#39;AccordionMenu&#39;);nnexport { Foundation, AccordionMenu
};n”,“&#39;use strict&#39;;nnnimport $ from &#39;jquery&#39;;nimport {
...
n   * Creates a new instance of an accordion menu.n   * @classn   * @name
AccordionMenun   * @fires AccordionMenu#initn   * @param {jQuery} element -
jQuery object to make into an accordion menu.n   * @param {Object} options
- Overrides to the default plugin settings.n     n  _setup(element,
options) {n    this.$element = element;n    this.options = $.extend({},
AccordionMenu.defaults, this.$element.data(), options);n    this.className
= &#39;AccordionMenu&#39;; // ie9 back compatnn    this._init();nn   
Keyboard.register(&#39;AccordionMenu&#39;, {n      &#39;ENTER&#39;:
&#39;toggle&#39;,n      &#39;SPACE&#39;: &#39;toggle&#39;,n     
&#39;ARROW_RIGHT&#39;: &#39;open&#39;,n      &#39;ARROW_UP&#39;:
&#39;up&#39;,n      &#39;ARROW_DOWN&#39;: &#39;down&#39;,n     
&#39;ARROW_LEFT&#39;: &#39;close&#39;,n      &#39;ESCAPE&#39;:
&#39;closeAll&#39;n    });n  }nnnn  /**n   * Initializes the accordion menu
by hiding all nested menus.n   * @privaten   */n  _init() {n   
Nest.Feather(this.$element, &#39;accordion&#39;);nn    var _this = this;nn 
<a
...
{AccordionMenu};n”,“module.exports =
