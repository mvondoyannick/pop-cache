...
<title>foundation.responsiveToggle.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.responsiveToggle.min.js.map">
...
href="\"foundation.responsiveToggle\"">object’)nttexports</a> =
factory(require(&quot;./foundation.core&quot;),
require(&quot;./foundation.util.mediaQuery&quot;),
...
href="\"FOUNDATION_EXTERNAL\"">root</a>[&quot;foundation.responsiveToggle&quot;]
= <a
...
Foundation } from &#39;./foundation.core&#39;;nnimport { ResponsiveToggle }
from
&#39;../../foundation.responsiveToggle&#39;;nFoundation.plugin(ResponsiveToggle,
&#39;ResponsiveToggle&#39;);nnexport { Foundation, ResponsiveToggle
};n”,“&#39;use strict&#39;;nnimport $ from &#39;jquery&#39;;nnimport {
MediaQuery } from &#39;./foundation.util.mediaQuery&#39;;nimport { Motion }
from &#39;./foundation.util.motion&#39;;nimport { Plugin } from
...
falsen};nnexport { ResponsiveToggle };n”,“module.exports =
