...
<title>foundation.util.touch.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.touch.js">
...
<pre>if(typeof exports === &#39;object&#39; &amp;&amp; typeof module === &#39;object&#39;)
        ...
        root[&quot;__FOUNDATION_EXTERNAL__&quot;] = root[&quot;__FOUNDATION_EXTERNAL__&quot;] || {}, root[&quot;__FOUNDATION_EXTERNAL__&quot;][&quot;foundation.util.touch&quot;] = factory(root[&quot;__FOUNDATION_EXTERNAL__&quot;][&quot;foundation.core&quot;], root[&quot;jQuery&quot;]);</pre>
...
<em>webpack_require</em>(<em>webpack_require</em>.s = 28); /******/ })
/************************************************************************/
/******/ ({</p>
...
<p>/***/ “./js/entries/plugins/foundation.util.touch.js”:
/*!*****************************************************!*\</p>

<pre>!*** ./js/entries/plugins/foundation.util.touch.js ***!
\*****************************************************/</pre>

<p>/*! exports provided: Foundation, Touch */ /***/ (function(module,
...
/* harmony import */ var
<em>foundation_util_touch__WEBPACK_IMPORTED_MODULE_1_</em> =
<em>webpack_require</em>(/*! ../../foundation.util.touch */
“./js/foundation.util.touch.js”); /* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Touch”, function() {
return <em><a
href=""Touch"">foundation_util_touch__WEBPACK_IMPORTED_MODULE_1_</a></em>;
});</p>

<p>/* harmony import */ var
<em>foundation_core__WEBPACK_IMPORTED_MODULE_2_</em> =
<em>webpack_require</em>(/*! ./foundation.core */ “./foundation.core”); /*
harmony import */ var _foundation_core__WEBPACK_IMPORTED_MODULE_2___default
=
/*#__PURE__*/<em>webpack_require</em>.n(<em>foundation_core__WEBPACK_IMPORTED_MODULE_2_</em>);
/* harmony reexport (safe) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Foundation”,
function() { return <em><a
href=""Foundation"">foundation_core__WEBPACK_IMPORTED_MODULE_2_</a></em>;
});</p>

<p><em><a
href=""Touch"">foundation_util_touch__WEBPACK_IMPORTED_MODULE_1_</a></em>.init(jquery__WEBPACK_IMPORTED_MODULE_0___default.a);
window.Foundation.Touch = <em><a
href=""Touch"">foundation_util_touch__WEBPACK_IMPORTED_MODULE_1_</a></em>;</p>

<p>/***/ }),</p>

<p>/***/ “./js/foundation.util.touch.js”:
/*!*************************************!*\</p>

<pre>!*** ./js/foundation.util.touch.js ***!
\*************************************/</pre>

<p>/*! exports provided: Touch */ /***/ (function(module,
<em>webpack_exports</em>, <em>webpack_require</em>) {</p>

<p>“use strict”; <em>webpack_require</em>.r(<em>webpack_exports</em>); /*
harmony export (binding) */
<em>webpack_require</em>.d(<em>webpack_exports</em>, “Touch”, function() {
return Touch; }); /* harmony import */ var
...
<p>//************************************************** //**Work inspired by
multiple jquery swipe plugins** //**Done by Yohai Ararat
***************************
//**************************************************</p>
...
<pre>if (jquery__WEBPACK_IMPORTED_MODULE_0___default.a.spotSwipe.preventDefault) {
  e.preventDefault();
}
...
<p>function teardown() {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">removeEventListener</span>(<span class="ruby-string">&#39;touchstart&#39;</span>, <span class="ruby-identifier">onTouchStart</span>);
</pre>
...
<p>Touch.setupSpotSwipe = function ($) {</p>

<pre>$.spotSwipe = new SpotSwipe($);</pre>
...
<p>Touch.setupTouchHandler = function ($) {</p>

<pre>$.fn.addTouch = function () {
...
<p>Touch.init = function ($) {</p>

<pre>if (typeof $.spotSwipe === &#39;undefined&#39;) {
...
<pre>!*** multi ./js/entries/plugins/foundation.util.touch.js ***!
\***********************************************************/</pre>
...
*/“./js/entries/plugins/foundation.util.touch.js”);</p>
...
<p>/******/ }); }); //# sourceMappingURL=foundation.util.touch.js.map</p>
</main>
