...
<title>foundation.util.imageLoader.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.imageLoader.min.js.map">
...
href="\"foundation.util.imageLoader\"">object’)nttexports</a> =
...
from &#39;./foundation.core&#39;;nnimport { onImagesLoaded } from
&#39;../../foundation.util.imageLoader&#39;;nnFoundation.onImagesLoaded =
onImagesLoaded;nnexport { Foundation, onImagesLoaded };n”,“&#39;use
strict&#39;;nnimport $ from &#39;jquery&#39;;nn   n * Runs a callback
function when images are fully loaded.n * @param {Object} images - Image(s)
to check if loaded.n * @param {Func} callback - Function to execute when
image is fully loaded.n   nfunction onImagesLoaded(images, callback){n  var
self = this,n      unloaded = images.length;nn  if (unloaded === 0) {n   
callback();n  }nn  images.each(function(){n    // Check if image is loadedn
if (this.complete &amp;&amp; typeof this.naturalWidth !==
&#39;undefined&#39;) {n      singleImageLoaded();n    }n    else {n      //
If the above check failed, simulate loading on detached element.n      var
image = new Image();n      // Still count image as loaded if it finalizes
with an error.n      var events = "load.zf.images error.zf.images&quot;;n  
$(image).one(events, function me(event){n        // Unbind the event
listeners. We&#39;re using &#39;one&#39; but only one of the two events
will have fired.n        $(this).off(events, me);n       
singleImageLoaded();n      });n      image.src =
$(this).attr(&#39;src&#39;);n    }n  });nn  function singleImageLoaded() {n
unloaded–;n    if (unloaded === 0) {n      callback();n    }n  }n}nnexport
{ onImagesLoaded };n”,“module.exports =
