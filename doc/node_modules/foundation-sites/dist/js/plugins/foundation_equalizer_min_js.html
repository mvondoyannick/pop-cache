...
<title>foundation.equalizer.min.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.equalizer.min.js">

<p>!function(e,t){“object”==typeof exports&amp;&amp;“object”==typeof
module?module.exports=t(require(“./foundation.core”),require(“./foundation.util.imageLoader”),require(“./foundation.util.mediaQuery”),require(“jquery”)):“function”==typeof
<a
href=""./foundation.core","./foundation.util.imageLoader","./foundation.util.mediaQuery","jquery"">define&&define.amd?define(</a>,t):“object”==typeof
<a
href=""foundation.equalizer"">exports?exports</a>=t(require(“./foundation.core”),require(“./foundation.util.imageLoader”),require(“./foundation.util.mediaQuery”),require(“jquery”)):(e.<em>FOUNDATION_EXTERNAL</em>=e.<em>FOUNDATION_EXTERNAL</em>||{},<a
href=""foundation.equalizer"">e.FOUNDATION_EXTERNAL</a>=<a
href=""foundation.core"">t(e.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.imageLoader"">e.FOUNDATION_EXTERNAL</a>,<a
href=""foundation.util.mediaQuery"">e.FOUNDATION_EXTERNAL</a>,e.jQuery))}(window,function(i,n,o,r){return
...
Object.prototype.hasOwnProperty.call(e,t)},o.p=“”,o(o.s=6)}({“./foundation.core”:function(e,t){e.exports=i},“./foundation.util.imageLoader”:function(e,t){e.exports=n},“./foundation.util.mediaQuery”:function(e,t){e.exports=o},“./js/entries/plugins/foundation.equalizer.js”:function(e,t,i){“use
strict”;i.r(t);var
n=i(“./foundation.core”);i.d(t,“Foundation”,function(){return
n.Foundation});var
o=i(“./js/foundation.equalizer.js”);i.d(t,“Equalizer”,function(){return
o.Equalizer}),n.Foundation.plugin(o.Equalizer,“Equalizer”)},“./js/foundation.equalizer.js”:function(e,t,i){“use
strict”;i.r(t),i.d(t,“Equalizer”,function(){return c});var
n=i(“jquery”),h=i.n(n),r=i(“./foundation.util.mediaQuery”),u=i(“./foundation.util.imageLoader”),a=i(“./foundation.core”);function
...
e})(e)}function s(e,t){for(var i=0;i&lt;t.length;i++){var <a
...
l(e,t){return!t||“object”!==o(t)&amp;&amp;“function”!=typeof
...
d(e,t){return(d=Object.setPrototypeOf||function(e,t){return
e.__proto__=t,e})(e,t)}var c=function(e){function i(){return
...
function”);e.prototype=Object.create(t&amp;&amp;t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&amp;&amp;d(e,t)}(<a
href=""Plugin"">i,a</a>),t=i,(n=[{key:“_setup”,value:function(e,t){this.$element=e,this.options=h.a.extend({},i.defaults,this.$element.data(),t),this.className=“Equalizer”,this._init()}},{key:“_init”,value:function(){var
<a
href="data-equalizer-watch="'.concat(e,'"">e=this.$element.attr(“data-equalizer”)||“”,t=this.$element.find(‘</a>&#39;));<a
href="data-equalizer-watch">r.MediaQuery._init(),this.$watched=t.length?t:this.$element.find(“</a>”),<a
href="data-equalizer">this.$element.attr(“data-resize”,e||Object(a.GetYoDigits)(6,“eq”)),this.$element.attr(“data-mutate”,e||Object(a.GetYoDigits)(6,“eq”)),this.hasNested=0<this.$element.find("</a>“).<a
href="data-equalizer">length,this.isNested=0<this.$element.parentsUntil(document.body,"</a>”).length,this.isOn=!1,this._bindHandler={onResizeMeBound:this._onResizeMe.bind(this),onPostEqualizedBound:this._onPostEqualized.bind(this)};var
i,n=this.$element.find(“img”);this.options.equalizeOn?(i=this._checkMQ(),h()(window).on(“changed.zf.mediaquery”,this._checkMQ.bind(this))):this._events(),(void
0!==i&amp;&amp;!1===i||void
0===i)&amp;&amp;(n.length?Object(u.onImagesLoaded)(n,this._reflow.bind(this)):this._reflow())}},{key:“_pauseEvents”,value:function(){this.isOn=!1,this.$element.off({“.zf.equalizer”:this._bindHandler.onPostEqualizedBound,“resizeme.zf.trigger”:this._bindHandler.onResizeMeBound,“mutateme.zf.trigger”:this._bindHandler.onResizeMeBound})}},{key:“_onResizeMe”,value:function(e){this._reflow()}},{key:“_onPostEqualized”,value:function(e){<a
href="0">e.target!==this.$element</a>&amp;&amp;this._reflow()}},{key:“_events”,value:function(){this._pauseEvents(),this.hasNested?this.$element.on(“postequalized.zf.equalizer”,this._bindHandler.onPostEqualizedBound):(this.$element.on(“resizeme.zf.trigger”,this._bindHandler.onResizeMeBound),this.$element.on(“mutateme.zf.trigger”,this._bindHandler.onResizeMeBound)),this.isOn=!0}},{key:“_checkMQ”,value:function(){var
e=!r.MediaQuery.is(this.options.equalizeOn);return
e?this.isOn&amp;&amp;(this._pauseEvents(),this.$watched.css(“height”,“auto”)):this.isOn||this._events(),e}},{key:“_killswitch”,value:function(){}},{key:“_reflow”,value:function(){if(!this.options.equalizeOnStack&amp;&amp;this._isStacked())return
this.$watched.css(“height”,“auto”),!1;this.options.equalizeByRow?this.getHeightsByRow(this.applyHeightByRow.bind(this)):this.getHeights(this.applyHeight.bind(this))}},{key:“_isStacked”,value:function(){<a
href="0">return!this.$watched</a>||!<a href="1">this.$watched</a>||<a
href="0">this.$watched</a>.<a
href="1">getBoundingClientRect().top!==this.$watched</a>.getBoundingClientRect().top}},{key:“getHeights”,value:function(e){for(var
<a href="i">t=[],i=0,n=this.$watched.length;i<n;i++)this.$watched</a>.<a
href="i">style.height=“auto”,t.push(this.$watched</a>.offsetHeight);e(t)}},{key:“getHeightsByRow”,value:function(e){var
<a
href="n">t=this.$watched.length?this.$watched.first().offset().top:0,i=[],n=0;i</a>=[];for(var
o=0,r=this.$watched.length;o&lt;r;o++){<a
href="o">this.$watched</a>.style.height=“auto”;var <a
href="o">u=h()(this.$watched</a>).<a
href="++n">offset().top;u!=t&&(i</a>=[],<a href="n">t=u),i</a>.<a
href="o">push([this.$watched</a>,<a
href="o">this.$watched</a>.offsetHeight])}for(var
a=0,s=i.length;a&lt;s;a++){var <a
href="a">l=h()(i</a>).map(function(){return <a href="1">this</a>}).<a
href="a">get(),f=Math.max.apply(null,l);i</a>.push(f)}e(i)}},{key:“applyHeight”,value:function(e){var
t=Math.max.apply(null,e);this.$element.trigger(“preequalized.zf.equalizer”),this.$watched.css(“height”,t),this.$element.trigger(“postequalized.zf.equalizer”)}},{key:“applyHeightByRow”,value:function(e){this.$element.trigger(“preequalized.zf.equalizer”);for(var
t=0,i=e.length;t&lt;i;t++){var <a href="t">n=e</a>.<a
href="t">length,o=e</a>[<a href="t">n-1];if(n<=2)h()(e</a>[<a
href="0">0]</a>).css({height:“auto”});else{this.$element.trigger(“preequalizedrow.zf.equalizer”);for(var
<a href="t">r=0,u=n-1;r<u;r++)h()(e</a>[<a
href="0">r]</a>).css({height:o});this.$element.trigger(“postequalizedrow.zf.equalizer”)}}this.$element.trigger(“postequalized.zf.equalizer”)}},{key:“_destroy”,value:function(){this._pauseEvents(),this.$watched.css(“height”,“auto”)}}])&amp;&amp;s(t.prototype,n),o&amp;&amp;s(t,o),i}();c.defaults={equalizeOnStack:!1,equalizeByRow:!1,equalizeOn:“”}},6:function(e,t,i){e.exports=i(“./js/entries/plugins/foundation.equalizer.js”)},jquery:function(e,t){e.exports=r}})});
//# sourceMappingURL=foundation.equalizer.min.js.map</p>
</main>
