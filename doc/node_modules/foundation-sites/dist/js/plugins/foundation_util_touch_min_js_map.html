...
<title>foundation.util.touch.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.touch.min.js.map">
...
href="\"foundation.util.touch\"">object’)nttexports</a> =
...
28);n”,“module.exports =
<em>WEBPACK_EXTERNAL_MODULE__foundation_core</em>;”,“import $ from
&#39;jquery&#39;;nnimport { Touch } from
&#39;../../foundation.util.touch&#39;;nnTouch.init($);nnwindow.Foundation.Touch
= Touch;nnexport { Foundation } from &#39;./foundation.core&#39;;nexport {
Touch };n”,“/                                                   n/   Work
inspired by multiple jquery swipe plugins*<strong>n//</strong>*Done by
Yohai Ararat
**************************<strong>n//</strong>*************************************************nnimport
$ from &#39;jquery&#39;;nnvar Touch = {};nnvar startPosX,n    startPosY,n  
startTime,n    elapsedTime,n    startEvent,n    isMoving = false,n   
didMoved = false;nnfunction onTouchEnd(e) {n 
this.removeEventListener(&#39;touchmove&#39;, onTouchMove);n 
this.removeEventListener(&#39;touchend&#39;, onTouchEnd);nn  // If the
touch did not move, consider it as a "tap&quot;n  if (!didMoved) {n    var
tapEvent = $.Event(&#39;tap&#39;, startEvent || e);n   
$(this).trigger(tapEvent);n  }nn  startEvent = null;n  isMoving = false;n 
didMoved = false;n}nnfunction onTouchMove(e) {n  if
($.spotSwipe.preventDefault) { e.preventDefault(); }nn  if(isMoving) {n   
var x = <a href="0">e.touches</a>.pageX;n    var y = <a
href="0">e.touches</a>.pageY;n    var dx = startPosX - x;n    var dy =
startPosY - y;n    var dir;n    didMoved = true;n    elapsedTime = new
Date().getTime() - startTime;n    if(Math.abs(dx) &gt;=
$.spotSwipe.moveThreshold &amp;&amp; elapsedTime &lt;=
$.spotSwipe.timeThreshold) {n      dir = dx &gt; 0 ? &#39;left&#39; :
&#39;right&#39;;n    }n    // else if(Math.abs(dy) &gt;=
$.spotSwipe.moveThreshold &amp;&amp; elapsedTime &lt;=
$.spotSwipe.timeThreshold) {n    //   dir = dy &gt; 0 ? &#39;down&#39; :
&#39;up&#39;;n    // }n    if(dir) {n      e.preventDefault();n     
onTouchEnd.apply(this, arguments);n      $(this)n       
.trigger($.Event(&#39;swipe&#39;, e), dir)n       
.trigger($.Event(`swipe${dir}`, e));n    }n  }nn}nnfunction onTouchStart(e)
{nn  if (e.touches.length == 1) {n    startPosX = <a
href="0">e.touches</a>.pageX;n    startPosY = <a
href="0">e.touches</a>.pageY;n    startEvent = e;n    isMoving = true;n   
didMoved = false;n    startTime = new Date().getTime();n   
this.addEventListener(&#39;touchmove&#39;, onTouchMove, false);n   
this.addEventListener(&#39;touchend&#39;, onTouchEnd, false);n 
}n}nnfunction init() {n  this.addEventListener &amp;&amp;
this.addEventListener(&#39;touchstart&#39;, onTouchStart,
false);n}nnfunction teardown() {n 
this.removeEventListener(&#39;touchstart&#39;, onTouchStart);n}nnclass
SpotSwipe {n  constructor($) {n    this.version = &#39;1.0.0&#39;;n   
this.enabled = &#39;ontouchstart&#39; in document.documentElement;n   
...
$.event.special.tap = { setup: init };nn    $.each([&#39;left&#39;,
&#39;up&#39;, &#39;down&#39;, &#39;right&#39;], function () {n      $.<a
href="`swipe${this}`">event.special</a> = { setup: function(){n       
$(this).on(&#39;swipe&#39;, $.noop);n      } };n    });n 
}n}nn/****************************************************n * As far as I
...
nnTouch.setupSpotSwipe = function($) {n  $.spotSwipe = new
SpotSwipe($);n};nn/****************************************************n *
Method for adding pseudo drag events to elements *n                        
nTouch.setupTouchHandler = function($) {n  $.fn.addTouch = function(){n   
this.each(function(i,el){n      $(el).bind(&#39;touchstart touchmove
touchend touchcancel&#39;, function(event)  {n        //we pass the
original event object because the jQuery eventn        //object is
normalized to w3c specs and does not provide the TouchListn       
handleTouch(event);n      });n    });nn    var handleTouch =
function(event){n      var touches = event.changedTouches,n          first
= <a href="0">touches</a>,n          eventTypes = {n            touchstart:
&#39;mousedown&#39;,n            touchmove: &#39;mousemove&#39;,n          
touchend: &#39;mouseup&#39;n          },n          type = <a
href="event.type">eventTypes</a>,n          simulatedEventn        ;nn     
if(&#39;MouseEvent&#39; in window &amp;&amp; typeof window.MouseEvent ===
&#39;function&#39;) {n        simulatedEvent = new window.MouseEvent(type,
{n          &#39;bubbles&#39;: true,n          &#39;cancelable&#39;: true,n
&#39;screenX&#39;: first.screenX,n          &#39;screenY&#39;:
first.screenY,n          &#39;clientX&#39;: first.clientX,n         
&#39;clientY&#39;: first.clientYn        });n      } else {n       
simulatedEvent = document.createEvent(&#39;MouseEvent&#39;);n       
...
0/<strong>left</strong>/, null);n      }n     
first.target.dispatchEvent(simulatedEvent);n    };n  };n};nnTouch.init =
function ($) {nn  if(typeof($.spotSwipe) === &#39;undefined&#39;) {n   
Touch.setupSpotSwipe($);n    Touch.setupTouchHandler($);n  }n};nnexport
{Touch};n”,“module.exports = <em>WEBPACK_EXTERNAL_MODULE_jquery</em>;”]}</p>
</main>
