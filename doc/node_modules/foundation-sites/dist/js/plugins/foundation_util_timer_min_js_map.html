...
<title>foundation.util.timer.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/js/plugins/foundation.util.timer.min.js.map">
...
href="\"foundation.util.timer\"">object’)nttexports</a> =
...
from &#39;./foundation.core&#39;;nnimport { Timer } from
&#39;../../foundation.util.timer&#39;;nnFoundation.Timer = Timer;nnexport {
Foundation, Timer };n”,“&#39;use strict&#39;;nnimport $ from
&#39;jquery&#39;;nnfunction Timer(elem, options, cb) {n  var _this = this,n
duration = options.duration,//options is an object for easily adding
features later.n      nameSpace = <a href="0">Object.keys(elem.data())</a>
|| &#39;timer&#39;,n      remain = -1,n      start,n      timer;nn 
this.isPaused = false;nn  this.restart = function() {n    remain = -1;n   
clearTimeout(timer);n    this.start();n  }nn  this.start = function() {n   
this.isPaused = false;n    // if(!elem.data(&#39;paused&#39;)){ return
false; }//maybe implement this sanity check if used for other things.n   
clearTimeout(timer);n    remain = remain &lt;= 0 ? duration : remain;n   
elem.data(&#39;paused&#39;, false);n    start = Date.now();n    timer =
setTimeout(function(){n      if(options.infinite){n       
_this.restart();//rerun the timer.n      }n      if (cb &amp;&amp; typeof
cb === &#39;function&#39;) { cb(); }n    }, remain);n   
elem.trigger(`timerstart.zf.${nameSpace}`);n  }nn  this.pause = function()
{n    this.isPaused = true;n    //if(elem.data(&#39;paused&#39;)){ return
false; }//maybe implement this sanity check if used for other things.n   
clearTimeout(timer);n    elem.data(&#39;paused&#39;, true);n    var end =
Date.now();n    remain = remain - (end - start);n   
elem.trigger(`timerpaused.zf.${nameSpace}`);n  }n}nnexport
{Timer};n”,“module.exports = <em>WEBPACK_EXTERNAL_MODULE_jquery</em>;”]}</p>
</main>
