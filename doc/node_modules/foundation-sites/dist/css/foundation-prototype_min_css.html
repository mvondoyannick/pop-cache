...
<title>foundation-prototype.min.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/css/foundation-prototype.min.css">

<p>@charset “UTF-8”;@media print,screen and (min-width:40em)<a
href="type=button">.reveal,.reveal.large,.reveal.small,.reveal.tiny{right:auto;left:auto;margin:0
...
(min-width:00){select{background-image:url(data:image/png;base64,)}}select:focus{outline:0;border:1px
