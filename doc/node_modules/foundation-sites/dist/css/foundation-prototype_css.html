...
<title>foundation-prototype.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/dist/css/foundation-prototype.css">

<p>@charset “UTF-8”;</p>

<pre>Foundation for Sites by ZURB
Version 6.5.3
foundation.zurb.com
Licensed under MIT Open Source</pre>

<p>@media print, screen and (min-width: 40em) {</p>

<pre>.reveal, .reveal.tiny, .reveal.small, .reveal.large {
  right: auto;
  left: auto;
  margin: 0 auto; } }

! normalize.css v8.0.0 | MIT License | github.com/necolas/normalize.css</pre>
...
-webkit-text-decoration: underline dotted;
        text-decoration: underline dotted; }</pre>
...
<p>button:-moz-focusring, [type=“button”]:-moz-focusring,
[type=“reset”]:-moz-focusring, [type=“submit”]:-moz-focusring {</p>

<pre>outline: 1px dotted ButtonText; }</pre>

<p>fieldset {</p>

<pre>padding: 0.35em 0.75em 0.625em; }</pre>
...
<p>[type=“checkbox”],</p>
<dl class="rdoc-list label-list"><dt>type=“radio”
<dd>
<p>{</p>
</dd></dl>
...
<pre>-webkit-appearance: textfield;
...
<pre>font-family: &quot;small=0em&amp;medium=40em&amp;large=64em&amp;xlarge=75em&amp;xxlarge=90em&quot;; }</pre>
...
max-width: 100%;
height: auto;
-ms-interpolation-mode: bicubic; }</pre>
...
<p>.map_canvas img, .map_canvas embed, .map_canvas object, .mqa-display img,
.mqa-display embed, .mqa-display object {</p>

<pre>max-width: none !important; }</pre>
...
<p>[type=&#39;text&#39;], [type=&#39;password&#39;], [type=&#39;date&#39;],
...
textarea:focus {
  ...
  transition: border-color 0.25s ease-in-out, -webkit-box-shadow 0.5s;
  transition: box-shadow 0.5s, border-color 0.25s ease-in-out;
  transition: box-shadow 0.5s, border-color 0.25s ease-in-out, -webkit-box-shadow 0.5s; }</pre>
...
<p>input:disabled, <a href="readonly">input</a>, textarea:disabled, <a
href="readonly">textarea</a> {</p>

<pre>background-color: #e6e6e6;
cursor: not-allowed; }</pre>

<p>[type=&#39;submit&#39;],</p>
<dl class="rdoc-list label-list"><dt>type=&#39;button&#39;
<dd>
<p>{</p>
</dd></dl>
...
<p>::-webkit-input-placeholder {</p>

<pre>color: #cacaca; }</pre>

<p>:-ms-input-placeholder {</p>
...
<dl class="rdoc-list label-list"><dt>type=&#39;checkbox&#39;
<dd>
<p>+ label,</p>
</dd><dt>type=&#39;radio&#39;
<dd>
...
<p>label &gt; [type=&#39;checkbox&#39;], label &gt; [type=&#39;radio&#39;] {</p>

<pre>margin-right: 0.5rem; }</pre>
<dl class="rdoc-list label-list"><dt>type=&#39;file&#39;
<dd>
<p>{</p>
</dd></dl>
...
.input-group &gt; :last-child, .input-group &gt; :last-child.input-group-button &gt; * {
  border-radius: 0 0 0 0; }</pre>

<p>.input-group-label, .input-group-field, .input-group-button,
.input-group-button a, .input-group-button input, .input-group-button
button, .input-group-button label {</p>

<pre>margin: 0;
white-space: nowrap; }</pre>

<p>.input-group-label {</p>
...
<pre>margin: 1.125rem 0;
padding: 1.25rem;
border: 1px solid #cacaca; }
.fieldset legend {
  margin: 0;
  margin-left: -0.1875rem;
  padding: 0 0.1875rem; }</pre>

<p>select {</p>

<pre>height: 2.4375rem;
margin: 0 0 1rem;
padding: 0.5rem;
-webkit-appearance: none;
   -moz-appearance: none;
...
<p>.is-invalid-input:not(:focus) {</p>

<pre>border-color: #cc4b37;
...
<p>.is-invalid-label {</p>

<pre>color: #cc4b37; }</pre>
...
<p>div, dl, dt, dd, ul, ol, li, h1, h2, h3, h4, h5, h6, pre, form, p,
blockquote, th, td {</p>
...
font-size: inherit;
line-height: 1.6;
text-rendering: optimizeLegibility; }</pre>
...
<p>h1, .h1, h2, .h2, h3, .h3, h4, .h4, h5, .h5, h6, .h6 {</p>

<pre>font-family: &quot;Helvetica Neue&quot;, Helvetica, Roboto, Arial, sans-serif;
font-style: normal;
font-weight: normal;
color: inherit;
...
<pre>font-size: inherit; }</pre>

<p>ul {</p>

<pre>margin-left: 1.25rem;
list-style-type: disc; }</pre>
...
<p>abbr, <a href="title">abbr</a> {</p>

<pre>border-bottom: 1px dotted #0a0a0a;
cursor: help;
...
<pre>padding: 0.125rem 0.3125rem 0.0625rem;
border: 1px solid #cacaca;
background-color: #e6e6e6;
...
<pre>font-size: 2.5rem;
line-height: 1; }
p + .stat {
  margin-top: -1rem; }</pre>

<p>ul.no-bullet, ol.no-bullet {</p>
...
<p>@media print, screen and (min-width: 64em) {</p>
...
.print-break-inside {
  page-break-inside: auto; } }</pre>

<p>.grid-container {</p>

<pre>padding-right: 0.625rem;
...
-webkit-flex-flow: row wrap;
    -ms-flex-flow: row wrap;
        flex-flow: row wrap; }</pre>

<p>.cell {</p>

<pre>-webkit-box-flex: 0;
-webkit-flex: 0 0 auto;
    -ms-flex: 0 0 auto;
        flex: 0 0 auto;
min-height: 0px;
...
<p>.grid-x &gt; .small-shrink, .grid-x &gt; .small-full, .grid-x &gt;
...
.small-10, .grid-x &gt; .small-11, .grid-x &gt; .small-12 {</p>

<pre>-webkit-flex-basis: auto;
    -ms-flex-preferred-size: auto;
        flex-basis: auto; }</pre>

<p>@media print, screen and (min-width: 40em) {</p>

<pre>.grid-x &gt; .medium-shrink, .grid-x &gt; .medium-full, .grid-x &gt; .medium-1, .grid-x &gt; .medium-2, .grid-x &gt; .medium-3, .grid-x &gt; .medium-4, .grid-x &gt; .medium-5, .grid-x &gt; .medium-6, .grid-x &gt; .medium-7, .grid-x &gt; .medium-8, .grid-x &gt; .medium-9, .grid-x &gt; .medium-10, .grid-x &gt; .medium-11, .grid-x &gt; .medium-12 {
...
<pre>.grid-x &gt; .large-shrink, .grid-x &gt; .large-full, .grid-x &gt; .large-1, .grid-x &gt; .large-2, .grid-x &gt; .large-3, .grid-x &gt; .large-4, .grid-x &gt; .large-5, .grid-x &gt; .large-6, .grid-x &gt; .large-7, .grid-x &gt; .large-8, .grid-x &gt; .large-9, .grid-x &gt; .large-10, .grid-x &gt; .large-11, .grid-x &gt; .large-12 {
  -webkit-flex-basis: auto;
      -ms-flex-preferred-size: auto;
          flex-basis: auto; } }</pre>

<p>.grid-x &gt; .small-1, .grid-x &gt; .small-2, .grid-x &gt; .small-3,
.grid-x &gt; .small-4, .grid-x &gt; .small-5, .grid-x &gt; .small-6,
.grid-x &gt; .small-7, .grid-x &gt; .small-8, .grid-x &gt; .small-9,
.grid-x &gt; .small-10, .grid-x &gt; .small-11, .grid-x &gt; .small-12 {</p>
...
<pre>width: 8.33333%; }</pre>

<p>.grid-x &gt; .small-2 {</p>

<pre>width: 16.66667%; }</pre>
...
<pre>width: 33.33333%; }</pre>

<p>.grid-x &gt; .small-5 {</p>

<pre>width: 41.66667%; }</pre>
...
<pre>width: 58.33333%; }</pre>

<p>.grid-x &gt; .small-8 {</p>

<pre>width: 66.66667%; }</pre>
...
<pre>width: 83.33333%; }</pre>

<p>.grid-x &gt; .small-11 {</p>

<pre>width: 91.66667%; }</pre>
...
<p>.grid-margin-x:not(.grid-x) &gt; .cell {</p>

<pre>width: auto; }</pre>

<p>.grid-margin-y:not(.grid-y) &gt; .cell {</p>

<pre>height: auto; }</pre>

<p>.grid-margin-x {</p>

<pre>margin-left: -0.625rem;
...
@media print, screen and (min-width: 64em) {
  ...
  .grid-margin-x &gt; .large-12 {
    width: calc(100% - 1.875rem); } }</pre>

<p>.grid-padding-x .grid-padding-x {</p>
...
@media print, screen and (min-width: 40em) {
  .grid-padding-x .grid-padding-x {
    margin-right: -0.9375rem;
    margin-left: -0.9375rem; } }</pre>

<p>.grid-container:not(.full) &gt; .grid-padding-x {</p>
...
<p>.grid-margin-x.small-up-1 &gt; .cell {</p>

<pre>width: calc(100% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-2 &gt; .cell {</p>

<pre>width: calc(50% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-3 &gt; .cell {</p>

<pre>width: calc(33.33333% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-4 &gt; .cell {</p>

<pre>width: calc(25% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-5 &gt; .cell {</p>

<pre>width: calc(20% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-6 &gt; .cell {</p>

<pre>width: calc(16.66667% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-7 &gt; .cell {</p>

<pre>width: calc(14.28571% - 1.25rem); }</pre>

<p>.grid-margin-x.small-up-8 &gt; .cell {</p>

<pre>width: calc(12.5% - 1.25rem); }</pre>

<p>@media print, screen and (min-width: 40em) {</p>

<pre>.grid-margin-x.small-up-1 &gt; .cell {
  width: calc(100% - 1.875rem); }
...
.grid-margin-x.medium-up-8 &gt; .cell {
  width: calc(12.5% - 1.875rem); } }</pre>

<p>@media print, screen and (min-width: 64em) {</p>

<pre>.grid-margin-x.large-up-1 &gt; .cell {
  width: calc(100% - 1.875rem); }
...
<pre>.medium-margin-collapse &gt; .small-1 {
  width: 8.33333%; }
...
<pre>.medium-margin-collapse &gt; .medium-1 {
  width: 8.33333%; }
...
<pre>.medium-margin-collapse &gt; .large-1 {
  width: 8.33333%; }
...
<pre>.large-margin-collapse &gt; .small-1 {
  width: 8.33333%; }
...
<pre>.large-margin-collapse &gt; .medium-1 {
  width: 8.33333%; }
...
<pre>.large-margin-collapse &gt; .large-1 {
  width: 8.33333%; }
...
<p>.grid-margin-x &gt; .small-offset-0 {</p>

<pre>margin-left: calc(0% + 0.625rem); }</pre>

<p>.small-offset-1 {</p>

<pre>margin-left: 8.33333%; }</pre>

<p>.grid-margin-x &gt; .small-offset-1 {</p>

<pre>margin-left: calc(8.33333% + 0.625rem); }</pre>

<p>.small-offset-2 {</p>

<pre>margin-left: 16.66667%; }</pre>

<p>.grid-margin-x &gt; .small-offset-2 {</p>

<pre>margin-left: calc(16.66667% + 0.625rem); }</pre>

<p>.small-offset-3 {</p>

<pre>margin-left: 25%; }</pre>

<p>.grid-margin-x &gt; .small-offset-3 {</p>

<pre>margin-left: calc(25% + 0.625rem); }</pre>

<p>.small-offset-4 {</p>

<pre>margin-left: 33.33333%; }</pre>

<p>.grid-margin-x &gt; .small-offset-4 {</p>

<pre>margin-left: calc(33.33333% + 0.625rem); }</pre>

<p>.small-offset-5 {</p>

<pre>margin-left: 41.66667%; }</pre>

<p>.grid-margin-x &gt; .small-offset-5 {</p>

<pre>margin-left: calc(41.66667% + 0.625rem); }</pre>

<p>.small-offset-6 {</p>

<pre>margin-left: 50%; }</pre>

<p>.grid-margin-x &gt; .small-offset-6 {</p>

<pre>margin-left: calc(50% + 0.625rem); }</pre>

<p>.small-offset-7 {</p>

<pre>margin-left: 58.33333%; }</pre>

<p>.grid-margin-x &gt; .small-offset-7 {</p>

<pre>margin-left: calc(58.33333% + 0.625rem); }</pre>

<p>.small-offset-8 {</p>

<pre>margin-left: 66.66667%; }</pre>

<p>.grid-margin-x &gt; .small-offset-8 {</p>

<pre>margin-left: calc(66.66667% + 0.625rem); }</pre>

<p>.small-offset-9 {</p>

<pre>margin-left: 75%; }</pre>

<p>.grid-margin-x &gt; .small-offset-9 {</p>

<pre>margin-left: calc(75% + 0.625rem); }</pre>

<p>.small-offset-10 {</p>

<pre>margin-left: 83.33333%; }</pre>

<p>.grid-margin-x &gt; .small-offset-10 {</p>

<pre>margin-left: calc(83.33333% + 0.625rem); }</pre>

<p>.small-offset-11 {</p>

<pre>margin-left: 91.66667%; }</pre>

<p>.grid-margin-x &gt; .small-offset-11 {</p>

<pre>margin-left: calc(91.66667% + 0.625rem); }</pre>
...
.grid-margin-x &gt; .medium-offset-11 {
  margin-left: calc(91.66667% + 0.9375rem); } }</pre>
...
<p>.grid-padding-y .grid-padding-y {</p>

<pre>margin-top: -0.625rem;
margin-bottom: -0.625rem; }
@media print, screen and (min-width: 40em) {
  .grid-padding-y .grid-padding-y {
    margin-top: -0.9375rem;
    margin-bottom: -0.9375rem; } }</pre>

<p>.grid-padding-y &gt; .cell {</p>

<pre>padding-top: 0.625rem;
padding-bottom: 0.625rem; }
@media print, screen and (min-width: 40em) {
  .grid-padding-y &gt; .cell {
    padding-top: 0.9375rem;
    padding-bottom: 0.9375rem; } }</pre>
...
<p>.cell .grid-y.grid-frame {</p>

<pre>height: 100%; }</pre>

<p>@media print, screen and (min-width: 40em) {</p>

<pre>.cell .grid-y.medium-grid-frame {
  height: 100%; } }</pre>

<p>@media print, screen and (min-width: 64em) {</p>

<pre>.cell .grid-y.large-grid-frame {
  height: 100%; } }</pre>
...
<p>.grid-frame.grid-margin-y {</p>

<pre>height: calc(100vh + 1.25rem); }
@media print, screen and (min-width: 40em) {
  .grid-frame.grid-margin-y {
    height: calc(100vh + 1.875rem); } }
@media print, screen and (min-width: 64em) {
  .grid-frame.grid-margin-y {
    height: calc(100vh + 1.875rem); } }</pre>

<p>@media print, screen and (min-width: 40em) {</p>

<pre>.grid-margin-y.medium-grid-frame {
  height: calc(100vh + 1.875rem); } }</pre>

<p>@media print, screen and (min-width: 64em) {</p>

<pre>.grid-margin-y.large-grid-frame {
  height: calc(100vh + 1.875rem); } }</pre>
...
<p>a.button:hover, a.button:focus {</p>
...
width: 0%;
height: 100%;
background-color: #1779ba; }</pre>

<p>.progress-meter-text {</p>
...
<p>.slider.disabled, .<a href="disabled">slider</a> {</p>
...
<p>.switch-active, .switch-inactive {</p>

<pre>position: absolute;
top: 50%;
-webkit-transform: translateY(-50%);
    -ms-transform: translateY(-50%);
        transform: translateY(-50%); }</pre>
...
table.unstriped tbody {
  ...
  table.unstriped tbody tr {
    ...
    background-color: #fefefe; }</pre>

<p>@media screen and (max-width: 63.99875em) {</p>

<pre>table.stack thead {
  display: none; }
table.stack tfoot {
  display: none; }
table.stack tr,
...
<p>table.hover thead tr:hover {</p>

<pre>background-color: #f3f3f3; }</pre>

<p>table.hover tfoot tr:hover {</p>

<pre>background-color: #ececec; }</pre>

<p>table.hover tbody tr:hover {</p>

<pre>background-color: #f9f9f9; }</pre>

<p>table.hover:not(.unstriped) tr:nth-of-type(even):hover {</p>
...
<p>.dropdown-pane.tiny {</p>

<pre>width: 100px; }</pre>

<p>.dropdown-pane.small {</p>

<pre>width: 200px; }</pre>

<p>.dropdown-pane.large {</p>
...
<p>.pagination-previous a::before, .pagination-previous.disabled::before {</p>

<pre>display: inline-block;
margin-right: 0.5rem;
content: &#39;\00ab&#39;; }</pre>

<p>.pagination-next a::after, .pagination-next.disabled::after {</p>
...
<p>.accordion-item:first-child &gt; :first-child {</p>

<pre>border-radius: 0 0 0 0; }</pre>

<p>.accordion-item:last-child &gt; :last-child {</p>
...
:last-child &gt; .accordion-content:last-child {
  border-bottom: 1px solid #e6e6e6; }</pre>
...
.orbit-previous:hover, .orbit-next:hover, .orbit-previous:active, .orbit-next:active, .orbit-previous:focus, .orbit-next:focus {
  background-color: rgba(10, 10, 10, 0.5); }</pre>
...
.orbit-bullets button {
  ...
  .orbit-bullets button.is-active {
    background-color: #8a8a8a; }</pre>

<p>.responsive-embed, .flex-video {</p>
...
<p>.tabs.vertical &gt; li {</p>

<pre>display: block;
float: none;
width: auto; }</pre>

<p>.tabs.simple &gt; li &gt; a {</p>
...
<pre>background: #1779ba; }
.tabs.primary &gt; li &gt; a {
  color: #fefefe; }
  .tabs.primary &gt; li &gt; a:hover, .tabs.primary &gt; li &gt; a:focus {
    background: #1673b1; }</pre>
...
<pre>border: 1px solid #e6e6e6;
border-top: 0;
background: #fefefe;
color: #0a0a0a;
-webkit-transition: all 0.5s ease;
transition: all 0.5s ease; }</pre>

<p>.tabs-content.vertical {</p>
...
<pre>-webkit-transition: -webkit-box-shadow 200ms ease-out;
...
<p>.menu-centered &gt; .menu {</p>

<pre>-webkit-box-pack: center;
-webkit-justify-content: center;
    -ms-flex-pack: center;
        justify-content: center; }
...
<p>.no-js [data-responsive-menu] ul {</p>
...
.menu-icon:hover::after {
  ...
  -webkit-box-shadow: 0 7px 0 #cacaca, 0 14px 0 #cacaca;
          box-shadow: 0 7px 0 #cacaca, 0 14px 0 #cacaca; }</pre>
...
.menu-icon.dark:hover::after {
  ...
  -webkit-box-shadow: 0 7px 0 #8a8a8a, 0 14px 0 #8a8a8a;
          box-shadow: 0 7px 0 #8a8a8a, 0 14px 0 #8a8a8a; }</pre>

<p>.accordion-menu li {</p>

<pre>width: 100%; }</pre>

<p>.accordion-menu a {</p>

<pre>padding: 0.7rem 1rem; }</pre>

<p>.accordion-menu .is-accordion-submenu a {</p>

<pre>padding: 0.7rem 1rem; }</pre>

<p>.accordion-menu .nested.is-accordion-submenu {</p>

<pre>margin-right: 0;
margin-left: 1rem; }</pre>

<p>.accordion-menu.align-right .nested.is-accordion-submenu {</p>

<pre>margin-right: 1rem;
margin-left: 0; }</pre>

<p>.accordion-menu .is-accordion-submenu-parent:not(.has-submenu-toggle) &gt;
a {</p>
...
<p>.accordion-menu.align-left .is-accordion-submenu-parent &gt; a::after {</p>

<pre>right: 1rem;
left: auto; }</pre>

<p>.accordion-menu.align-right .is-accordion-submenu-parent &gt; a::after {</p>

<pre>right: auto;
left: 1rem; }</pre>

<p>.accordion-menu .<a
href="aria-expanded='true'">is-accordion-submenu-parent</a> &gt; a::after {</p>

<pre>-webkit-transform: rotate(180deg);
    -ms-transform: rotate(180deg);
        transform: rotate(180deg);
-webkit-transform-origin: 50% 50%;
    -ms-transform-origin: 50% 50%;
        transform-origin: 50% 50%; }</pre>

<p>.is-accordion-submenu-parent {</p>

<pre>position: relative; }</pre>

<p>.has-submenu-toggle &gt; a {</p>

<pre>margin-right: 40px; }</pre>
...
<p>.<a href="aria-expanded='true'">submenu-toggle</a>::after {</p>

<pre>-webkit-transform: scaleY(-1);
...
.is-drilldown.animate-height {
  ...
  transition: height 0.5s; }</pre>

<p>.drilldown a {</p>

<pre>padding: 0.7rem 1rem;
background: #fefefe; }</pre>

<p>.drilldown .is-drilldown-submenu {</p>
...
.drilldown .is-drilldown-submenu a {
  padding: 0.7rem 1rem; }</pre>

<p>.drilldown .nested.is-drilldown-submenu {</p>

<pre>margin-right: 0;
margin-left: 0; }</pre>

<p>.drilldown .drilldown-submenu-cover-previous {</p>

<pre>min-height: 100%; }</pre>

<p>.drilldown .is-drilldown-submenu-parent &gt; a {</p>
...
<p>.drilldown.align-left .is-drilldown-submenu-parent &gt; a::after {</p>
...
<p>.drilldown.align-right .is-drilldown-submenu-parent &gt; a::after {</p>
...
<p>.drilldown .js-drilldown-back &gt; a::before {</p>
...
<p>.dropdown.menu &gt; li.opens-left &gt; .is-dropdown-submenu {</p>

<pre>top: 100%;
right: 0;
left: auto; }</pre>

<p>.dropdown.menu &gt; li.opens-right &gt; .is-dropdown-submenu {</p>

<pre>top: 100%;
right: auto;
left: 0; }</pre>

<p>.dropdown.menu &gt; li.is-dropdown-submenu-parent &gt; a {</p>

<pre>position: relative;
padding-right: 1.5rem; }</pre>

<p>.dropdown.menu &gt; li.is-dropdown-submenu-parent &gt; a::after {</p>
...
left: auto;
margin-top: -3px; }</pre>
<dl class="rdoc-list label-list"><dt>data-whatinput=&#39;mouse&#39;
<dd>
<p>.dropdown.menu a {</p>
</dd></dl>
...
<p>.dropdown.menu &gt; li.is-active &gt; a {</p>

<pre>background: transparent;
color: #1779ba; }</pre>

<p>.no-js .dropdown.menu ul {</p>

<pre>display: none; }</pre>

<p>.dropdown.menu .nested.is-dropdown-submenu {</p>

<pre>margin-right: 0;
margin-left: 0; }</pre>

<p>.dropdown.menu.vertical &gt; li .is-dropdown-submenu {</p>

<pre>top: 0; }</pre>

<p>.dropdown.menu.vertical &gt; li.opens-left &gt; .is-dropdown-submenu {</p>

<pre>top: 0;
right: 100%;
left: auto; }</pre>

<p>.dropdown.menu.vertical &gt; li.opens-right &gt; .is-dropdown-submenu {</p>

<pre>right: auto;
left: 100%; }</pre>

<p>.dropdown.menu.vertical &gt; li &gt; a::after {</p>

<pre>right: 14px; }</pre>

<p>.dropdown.menu.vertical &gt; li.opens-left &gt; a::after {</p>
...
<p>.dropdown.menu.vertical &gt; li.opens-right &gt; a::after {</p>
...
border-right-width: 0;
border-left-style: solid;
border-color: transparent transparent transparent #1779ba; }</pre>

<p>@media print, screen and (min-width: 40em) {</p>

<pre>.dropdown.menu.medium-horizontal &gt; li.opens-left &gt; .is-dropdown-submenu {
  top: 100%;
  right: 0;
  left: auto; }
...
<pre>.dropdown.menu.large-horizontal &gt; li.opens-left &gt; .is-dropdown-submenu {
  top: 100%;
  right: 0;
  left: auto; }
...
<p>.dropdown.menu.align-right .is-dropdown-submenu.first-sub {</p>

<pre>top: 100%;
right: 0;
left: auto; }</pre>

<p>.is-dropdown-menu.vertical {</p>

<pre>width: 100px; }
.is-dropdown-menu.vertical.align-right {
  float: right; }</pre>

<p>.is-dropdown-submenu-parent {</p>
...
<p>.is-off-canvas-open {</p>

<pre>overflow: hidden; }</pre>

<p>.js-off-canvas-overlay {</p>
...
.position-left.is-transition-push {
  -webkit-box-shadow: inset -13px 0 20px -13px rgba(10, 10, 10, 0.25);
          box-shadow: inset -13px 0 20px -13px rgba(10, 10, 10, 0.25); }</pre>
...
.position-top.is-transition-push {
  -webkit-box-shadow: inset 0 -13px 20px -13px rgba(10, 10, 10, 0.25);
          box-shadow: inset 0 -13px 20px -13px rgba(10, 10, 10, 0.25); }</pre>
...
<pre>.position-left.reveal-for-medium {
...
.position-bottom.reveal-for-medium {
  ...
  .position-bottom.reveal-for-medium ~ .off-canvas-content {
    margin-bottom: 250px; } }</pre>

<p>@media print, screen and (min-width: 64em) {</p>

<pre>.position-left.reveal-for-large {
  -webkit-transform: none;
      -ms-transform: none;
          transform: none;
  z-index: 12;
...
<pre>.off-canvas.in-canvas-for-medium {
  visibility: visible;
  height: auto;
  position: static;
  background: none;
...
<pre>.off-canvas.in-canvas-for-large {
  visibility: visible;
  height: auto;
  position: static;
  background: none;
...
.title-bar .menu-icon {
  margin-left: 0.25rem;
  margin-right: 0.25rem; }</pre>

<p>.title-bar-left, .title-bar-right {</p>
...
-webkit-flex: 0 0 auto;
    -ms-flex: 0 0 auto;
        flex: 0 0 auto;
margin: 0.5rem 1rem 0.5rem 0; }</pre>

<p>.top-bar-left, .top-bar-right {</p>
...
<pre>-webkit-justify-content: space-around;
    -ms-flex-pack: distribute;
        justify-content: space-around; }</pre>

<p>.align-left.vertical.menu &gt; li &gt; a {</p>
...
<p>.align-right.vertical.menu &gt; li &gt; a {</p>
...
<p>.align-center.vertical.menu &gt; li &gt; a {</p>
...
<pre>-webkit-align-self: flex-start;
    -ms-flex-item-align: start;
        align-self: flex-start; }</pre>

<p>.align-bottom {</p>

<pre>-webkit-box-align: end;
-webkit-align-items: flex-end;
    -ms-flex-align: end;
        align-items: flex-end; }</pre>

<p>.align-self-bottom {</p>

<pre>-webkit-align-self: flex-end;
    -ms-flex-item-align: end;
        align-self: flex-end; }</pre>

<p>.align-middle {</p>

<pre>-webkit-box-align: center;
-webkit-align-items: center;
    -ms-flex-align: center;
        align-items: center; }</pre>

<p>.align-self-middle {</p>

<pre>-webkit-align-self: center;
    -ms-flex-item-align: center;
        align-self: center; }</pre>

<p>.align-stretch {</p>

<pre>-webkit-box-align: stretch;
-webkit-align-items: stretch;
    -ms-flex-align: stretch;
        align-items: stretch; }</pre>

<p>.align-self-stretch {</p>

<pre>-webkit-align-self: stretch;
    -ms-flex-item-align: stretch;
        align-self: stretch; }</pre>
...
<pre>-webkit-box-ordinal-group: 2;
-webkit-order: 1;
    -ms-flex-order: 1;
        order: 1; }</pre>
...
<pre>-webkit-box-ordinal-group: 3;
-webkit-order: 2;
    -ms-flex-order: 2;
        order: 2; }</pre>
...
<pre>-webkit-box-ordinal-group: 4;
-webkit-order: 3;
    -ms-flex-order: 3;
        order: 3; }</pre>
...
<pre>-webkit-box-ordinal-group: 5;
-webkit-order: 4;
    -ms-flex-order: 4;
        order: 4; }</pre>
...
<pre>-webkit-box-ordinal-group: 6;
-webkit-order: 5;
    -ms-flex-order: 5;
        order: 5; }</pre>
...
<pre>-webkit-box-ordinal-group: 7;
-webkit-order: 6;
    -ms-flex-order: 6;
        order: 6; }</pre>
...
<pre>-webkit-box-orient: horizontal;
-webkit-box-direction: normal;
-webkit-flex-direction: row;
    -ms-flex-direction: row;
        flex-direction: row; }</pre>

<p>.flex-dir-row-reverse {</p>
...
<pre>-webkit-box-orient: vertical;
-webkit-box-direction: normal;
-webkit-flex-direction: column;
    -ms-flex-direction: column;
        flex-direction: column; }</pre>

<p>.flex-dir-column-reverse {</p>
...
<p>@media screen and (max-width: 39.99875em) {</p>

<pre>.hide-for-small-only {
  display: none !important; } }</pre>

<p>@media screen and (max-width: 0em), screen and (min-width: 40em) {</p>

<pre>.show-for-small-only {
  display: none !important; } }</pre>
...
<p>@media screen and (min-width: 40em) and (max-width: 63.99875em) {</p>

<pre>.hide-for-medium-only {
  display: none !important; } }</pre>

<p>@media screen and (max-width: 39.99875em), screen and (min-width: 64em) {</p>

<pre>.show-for-medium-only {
  display: none !important; } }</pre>
...
<p>@media screen and (min-width: 64em) and (max-width: 74.99875em) {</p>

<pre>.hide-for-large-only {
  display: none !important; } }</pre>

<p>@media screen and (max-width: 63.99875em), screen and (min-width: 75em) {</p>

<pre>.show-for-large-only {
  display: none !important; } }</pre>

<p>.show-for-sr, .show-on-focus {</p>
...
<p>.show-on-focus:active, .show-on-focus:focus {</p>
...
<p>.show-for-landscape, .hide-for-portrait {</p>
...
<p>.hide-for-landscape, .show-for-portrait {</p>
...
<pre>font: 0/0 a !important;
color: transparent !important;
text-shadow: none !important;
background-color: transparent !important;
border: 0 !important; }</pre>
...
white-space: nowrap !important; }</pre>
...
<pre>word-wrap: break-word !important; }</pre>
...
<pre>text-decoration: overline !important; }</pre>

<p>.text-underline {</p>

<pre>text-decoration: underline !important; }</pre>

<p>.text-line-through {</p>

<pre>text-decoration: line-through !important; }</pre>

<p>.font-wide {</p>

<pre>letter-spacing: 0.25rem; }</pre>
...
<pre>list-style-type: disc !important; }</pre>

<p>ul.list-circle {</p>

<pre>list-style-type: circle !important; }</pre>

<p>ul.list-square {</p>

<pre>list-style-type: square !important; }</pre>

<p>ol.list-decimal {</p>

<pre>list-style-type: decimal !important; }</pre>

<p>ol.list-lower-alpha {</p>

<pre>list-style-type: lower-alpha !important; }</pre>

<p>ol.list-lower-latin {</p>

<pre>list-style-type: lower-latin !important; }</pre>

<p>ol.list-lower-roman {</p>

<pre>list-style-type: lower-roman !important; }</pre>

<p>ol.list-upper-alpha {</p>

<pre>list-style-type: upper-alpha !important; }</pre>

<p>ol.list-upper-latin {</p>

<pre>list-style-type: upper-latin !important; }</pre>

<p>ol.list-upper-roman {</p>

<pre>list-style-type: upper-roman !important; }</pre>

<p>.rounded {</p>

<pre>border-radius: 5000px !important; }
.rounded:after {
  border-radius: 50%; }</pre>

<p>.radius {</p>

<pre>border-radius: 0.1875rem; }</pre>

<p>.bordered {</p>

<pre>border: 0.0625rem solid #cacaca; }</pre>

<p>.shadow {</p>

<pre>-webkit-box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12);
        box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12); }</pre>
...
border-bottom-width: 0;
border-top-style: solid;
border-color: #0a0a0a transparent transparent; }</pre>
...
border-top-width: 0;
border-bottom-style: solid;
border-color: transparent transparent #0a0a0a; }</pre>
...
border-right-width: 0;
border-left-style: solid;
border-color: transparent transparent transparent #0a0a0a; }</pre>
...
border-left-width: 0;
border-right-style: solid;
border-color: transparent #0a0a0a transparent transparent; }</pre>

<p>.separator-center {</p>

<pre>text-align: center !important; }
...
.separator-left::after {
  ...
  border-bottom: 0.125rem solid #1779ba;
  margin: 1rem auto 0;
  margin-left: 0 !important; }</pre>

<p>.separator-right {</p>

<pre>text-align: right !important; }
...
.separator-right::after {
  ...
  border-bottom: 0.125rem solid #1779ba;
  margin: 1rem auto 0;
  margin-right: 0 !important; }</pre>

<p>.overflow-visible {</p>

<pre>overflow: visible !important; }</pre>

<p>.overflow-x-visible {</p>

<pre>overflow-x: visible !important; }</pre>

<p>.overflow-y-visible {</p>

<pre>overflow-y: visible !important; }</pre>
...
<pre>overflow-x: hidden !important; }</pre>

<p>.overflow-y-hidden {</p>

<pre>overflow-y: hidden !important; }</pre>

<p>.overflow-scroll {</p>

<pre>overflow: scroll !important; }</pre>

<p>.overflow-x-scroll {</p>

<pre>overflow-x: scroll !important; }</pre>

<p>.overflow-y-scroll {</p>

<pre>overflow-y: scroll !important; }</pre>
...
<p>.position-fixed-top {</p>

<pre>position: fixed !important;
top: 0rem !important;
right: 0rem !important;
left: 0rem !important;
z-index: 975; }</pre>

<p>.position-fixed-bottom {</p>
...
<pre>-webkit-box-sizing: border-box !important;
        box-sizing: border-box !important; }</pre>

<p>.border-none {</p>

<pre>border: none !important; }</pre>
...
<pre>margin-top: 0rem !important; }</pre>

<p>.margin-right-0 {</p>

<pre>margin-right: 0rem !important; }</pre>

<p>.margin-bottom-0 {</p>

<pre>margin-bottom: 0rem !important; }</pre>

<p>.margin-left-0 {</p>

<pre>margin-left: 0rem !important; }</pre>

<p>.margin-horizontal-0 {</p>

<pre>margin-right: 0rem !important;
margin-left: 0rem !important; }</pre>

<p>.margin-vertical-0 {</p>

<pre>margin-top: 0rem !important;
margin-bottom: 0rem !important; }</pre>

<p>.padding-0 {</p>

<pre>padding: 0rem; }</pre>

<p>.padding-top-0 {</p>

<pre>padding-top: 0rem !important; }</pre>

<p>.padding-right-0 {</p>

<pre>padding-right: 0rem !important; }</pre>

<p>.padding-bottom-0 {</p>

<pre>padding-bottom: 0rem !important; }</pre>

<p>.padding-left-0 {</p>

<pre>padding-left: 0rem !important; }</pre>

<p>.padding-horizontal-0 {</p>

<pre>padding-right: 0rem !important;
padding-left: 0rem !important; }</pre>

<p>.padding-vertical-0 {</p>

<pre>padding-top: 0rem !important;
padding-bottom: 0rem !important; }</pre>
...
<p>.margin-horizontal-1 {</p>

<pre>margin-right: 1rem !important;
margin-left: 1rem !important; }</pre>

<p>.margin-vertical-1 {</p>

<pre>margin-top: 1rem !important;
margin-bottom: 1rem !important; }</pre>

<p>.padding-1 {</p>

<pre>padding: 1rem; }</pre>
...
<p>.padding-horizontal-1 {</p>

<pre>padding-right: 1rem !important;
padding-left: 1rem !important; }</pre>

<p>.padding-vertical-1 {</p>

<pre>padding-top: 1rem !important;
padding-bottom: 1rem !important; }</pre>
...
<pre>margin-top: 2rem !important; }</pre>

<p>.margin-right-2 {</p>

<pre>margin-right: 2rem !important; }</pre>

<p>.margin-bottom-2 {</p>

<pre>margin-bottom: 2rem !important; }</pre>

<p>.margin-left-2 {</p>

<pre>margin-left: 2rem !important; }</pre>

<p>.margin-horizontal-2 {</p>

<pre>margin-right: 2rem !important;
margin-left: 2rem !important; }</pre>

<p>.margin-vertical-2 {</p>

<pre>margin-top: 2rem !important;
margin-bottom: 2rem !important; }</pre>

<p>.padding-2 {</p>

<pre>padding: 2rem; }</pre>

<p>.padding-top-2 {</p>

<pre>padding-top: 2rem !important; }</pre>

<p>.padding-right-2 {</p>

<pre>padding-right: 2rem !important; }</pre>

<p>.padding-bottom-2 {</p>

<pre>padding-bottom: 2rem !important; }</pre>

<p>.padding-left-2 {</p>

<pre>padding-left: 2rem !important; }</pre>

<p>.padding-horizontal-2 {</p>

<pre>padding-right: 2rem !important;
padding-left: 2rem !important; }</pre>

<p>.padding-vertical-2 {</p>

<pre>padding-top: 2rem !important;
padding-bottom: 2rem !important; }</pre>
...
<p>.margin-horizontal-3 {</p>

<pre>margin-right: 3rem !important;
margin-left: 3rem !important; }</pre>

<p>.margin-vertical-3 {</p>

<pre>margin-top: 3rem !important;
margin-bottom: 3rem !important; }</pre>

<p>.padding-3 {</p>

<pre>padding: 3rem; }</pre>
...
<p>.padding-horizontal-3 {</p>

<pre>padding-right: 3rem !important;
padding-left: 3rem !important; }</pre>

<p>.padding-vertical-3 {</p>

<pre>padding-top: 3rem !important;
padding-bottom: 3rem !important; }</pre>

<p>/*# sourceMappingURL=foundation-prototype.css.map */</p>
</main>
