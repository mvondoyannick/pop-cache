...
<title>foundation-prototype.css.map - RDoc Documentation</title>
...
!important;n  padding-bottom: 3rem !important; }n”,“/**n * Foundation for
Sites by ZURBn * Version 6.5.3n * foundation.zurb.comn * Licensed under MIT
Open Sourcen */nn// Dependenciesn@import
&#39;vendor/normalize&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/helpers/missing-dependencies&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/helpers/true&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/functions/contain&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/functions/purge&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/functions/remove&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/functions/replace&#39;;n@import
&#39;../_vendor/sassy-lists/stylesheets/functions/to-list&#39;;nn// —
Settings —n// import your own `settings` here orn// import and modify the
default settings throughn// @import &#39;settings/settings&#39;;nn// —
Components —n// Utilitiesn@import &#39;util/util&#39;;n// Global
stylesn@import &#39;global&#39;;n@import &#39;forms/forms&#39;;n@import
&#39;typography/typography&#39;;nn// Gridsn@import
&#39;grid/grid&#39;;n@import &#39;xy-grid/xy-grid&#39;;n// Generic
componentsn@import &#39;components/button&#39;;n@import
&#39;components/button-group&#39;;n@import
&#39;components/close-button&#39;;n@import
&#39;components/label&#39;;n@import
&#39;components/progress-bar&#39;;n@import
&#39;components/slider&#39;;n@import &#39;components/switch&#39;;n@import
&#39;components/table&#39;;n// Basic componentsn@import
&#39;components/badge&#39;;n@import
&#39;components/breadcrumbs&#39;;n@import
&#39;components/callout&#39;;n@import &#39;components/card&#39;;n@import
&#39;components/dropdown&#39;;n@import
&#39;components/pagination&#39;;n@import &#39;components/tooltip&#39;;nn//
Containersn@import &#39;components/accordion&#39;;n@import
&#39;components/media-object&#39;;n@import
&#39;components/orbit&#39;;n@import
&#39;components/responsive-embed&#39;;n@import
&#39;components/tabs&#39;;n@import &#39;components/thumbnail&#39;;n//
Menu-based containersn@import &#39;components/menu&#39;;n@import
&#39;components/menu-icon&#39;;n@import
&#39;components/accordion-menu&#39;;n@import
&#39;components/drilldown&#39;;n@import
&#39;components/dropdown-menu&#39;;nn// Layout componentsn@import
&#39;components/off-canvas&#39;;n@import
&#39;components/reveal&#39;;n@import &#39;components/sticky&#39;;n@import
&#39;components/title-bar&#39;;n@import &#39;components/top-bar&#39;;nn//
Helpersn@import &#39;components/float&#39;;n@import
&#39;components/flex&#39;;n@import &#39;components/visibility&#39;;n@import
&#39;prototype/prototype&#39;;nnn@mixin foundation-everything(n  $flex:
true,n  $prototype: falsen) {n  @if $flex {n    $global-flexbox: true
!global;n  }nn  // Global stylesn  @include foundation-global-styles;n 
@include foundation-forms;n  @include foundation-typography;nn  // Gridsn 
@if not $flex {n    @include foundation-grid;n  }n  @else {n    @if
$xy-grid {n      @include foundation-xy-grid-classes;n    }n    @else {n   
@include foundation-flex-grid;n    }n  }nn  // Generic componentsn 
@include foundation-button;n  @include foundation-button-group;n  @include
foundation-close-button;n  @include foundation-label;n  @include
foundation-progress-bar;n  @include foundation-slider;n  @include
foundation-switch;n  @include foundation-table;n  // Basic componentsn 
@include foundation-badge;n  @include foundation-breadcrumbs;n  @include
foundation-callout;n  @include foundation-card;n  @include
foundation-dropdown;n  @include foundation-pagination;n  @include
foundation-tooltip;nn  // Containersn  @include foundation-accordion;n 
@include foundation-media-object;n  @include foundation-orbit;n  @include
foundation-responsive-embed;n  @include foundation-tabs;n  @include
foundation-thumbnail;n  // Menu-based containersn  @include
foundation-menu;n  @include foundation-menu-icon;n  @include
foundation-accordion-menu;n  @include foundation-drilldown-menu;n  @include
foundation-dropdown-menu;nn  // Layout componentsn  @include
foundation-off-canvas;n  @include foundation-reveal;n  @include
foundation-sticky;n  @include foundation-title-bar;n  @include
foundation-top-bar;nn  // Helpersn  @include foundation-float-classes;n 
@if $flex { @include foundation-flex-classes; }n  @include
foundation-visibility-classes;n  @if $prototype { @include
foundation-prototype-classes; }n}n”,“// Foundation for Sites by ZURBn//
foundation.zurb.comn// Licensed under MIT Open Sourcenn////n/// @group
breakpointsn////nn/// A list of named breakpoints. You can use these with
the `breakpoint()` mixin to quickly create media queries.n/// @type
Mapn$breakpoints: (n  small: 0,n  medium: 640px,n  large: 1024px,n  xlarge:
1200px,n  xxlarge: 1440px,n) !default;nn/// The largest named breakpoint in
which to include print as a media typen/// @type Keywordn$print-breakpoint:
large !default;nn$-zf-zero-breakpoint: small
!default;nn$-zf-breakpoints-keys: map-to-list($breakpoints,
&#39;keys&#39;);nn@if nth(map-values($breakpoints), 1) != 0 {n  @error
&#39;The first key in the $breakpoints map must have a value of
"0&quot;.&#39;;n}n@else {n  $-zf-zero-breakpoint:
nth(map-keys($breakpoints), 1);n}nn/// All of the names in this list will
be output as classes in your CSS, like `.small-12`, `.medium-6`, and so on.
Each value in this list must also be in the `$breakpoints` map.n/// @type
Listn$breakpoint-classes: (small medium large) !default;nn/// Generates a
media query string matching the input value. Refer to the documentation for
the `breakpoint()` mixin to see what the possible inputs are.n///n///
@param {Keyword|Number} $val [small] - Breakpoint name, or px, rem, or em
value to process.n@function breakpoint($val: $-zf-zero-breakpoint) {n  //
Size or keywordn  $bp: nth($val, 1);n  // Value for max-width media
queriesn  $bp-max: 0;n  // Direction of media query (up, down, or only)n 
$dir: if(length($val) &gt; 1, nth($val, 2), up);n  // Eventual outputn 
$str: &#39;&#39;;n  // Is it a named media query?n  $named: false;nn  //
Orientation media queries have a unique syntaxn  @if $bp ==
&#39;landscape&#39; or $bp == &#39;portrait&#39; {n    @return
&#39;(orientation: #{$bp})&#39;;n  }n  @else if $bp == &#39;retina&#39; {n 
@return &#39;(-webkit-min-device-pixel-ratio: 2), (min-resolution:
192dpi)&#39;;n  }nn  // Try to pull a named breakpoint out of the
$breakpoints mapn  @if type-of($bp) == &#39;string&#39; {n    @if
map-has-key($breakpoints, $bp) {n      @if $dir == &#39;only&#39; or $dir
== &#39;down&#39; {n        $bp-max: -zf-map-next($breakpoints, $bp);n     
}nn      $bp: map-get($breakpoints, $bp);n      $named: true;n    }n   
@else {n      $bp: 0;n      @warn &#39;breakpoint(): "#{$val}&quot; is not
defined in your $breakpoints setting.&#39;;n    }n  }nn  // Convert any
pixel, rem, or unitless value to emn  $bp: -zf-bp-to-em($bp);n  // Max
value is 0.2px under the next breakpoint (0.02 / 16 = 0.00125).n  // Use a
precision under 1px to support browser zoom, but not to low to avoid
rounding.n  // See <a
href="https://github.com/zurb/foundation-sites/issues/11313\n">github.com/zurb/foundation-sites/issues/11313n</a>
@if $bp-max {n    $bp-max: -zf-bp-to-em($bp-max) - .00125;n  }nn  //
Conditions to skip media query creationn  // - It&#39;s a named breakpoint
that resolved to "0 down&quot; or "0 up&quot;n  // - It&#39;s a numeric
breakpoint that resolved to "0 " + anythingn  @if $bp &gt; 0em or $dir ==
&#39;only&#39; or $dir == &#39;down&#39; {n    // `only` ranges use the
format `(min-width: n) and (max-width: n)`n    @if $dir == &#39;only&#39;
{n      // Only named media queries can have an "only&quot; rangen      @if
$named == true {n        // Only use "min-width&quot; if the floor is
greater than 0n        @if $bp &gt; 0em {n          $str: $str +
&#39;(min-width: #{$bp})&#39;;nn          // Only add "and&quot; to the
media query if there&#39;s a ceilingn          @if $bp-max != null {n      
$str: $str + &#39; and &#39;;n          }n        }nn        // Only use
"max-width&quot; if there&#39;s a ceilingn        @if $bp-max != null {n   
$str: $str + &#39;(max-width: #{$bp-max})&#39;;n        }n      }n     
@else {n        @warn &#39;breakpoint(): Only named media queries can have
an `only` range.&#39;;n      }n    }nn    // `down` ranges use the format
`(max-width: n)`n    @else if $dir == &#39;down&#39; {n      $max:
if($named, $bp-max, $bp);nn      // Skip media query creation if input
value is exactly "0 down&quot;,n      // unless the function was called as
"small down&quot;, in which case it&#39;s just "small only&quot;n      @if
$named or $bp &gt; 0em {n        @if $max != null {n          $str: $str +
&#39;(max-width: #{$max})&#39;;n        }n      }n    }nn    // `up` ranges
use the format `(min-width: n)`n    @else if $bp &gt; 0em {n      $str:
$str + &#39;(min-width: #{$bp})&#39;;n    }n  }nn  @return $str;n}nn///
Wraps a media query around the content you put inside the mixin. This mixin
accepts a number of values:n///  - If a string is passed, the mixin will
look for it in the `$breakpoints` map, and use a media query there.n///  -
If a pixel value is passed, it will be converted to an em value using
`$global-font-size` as the base.n///  - If a rem value is passed, the unit
will be changed to em.n///  - If an em value is passed, the value will be
used as-is.n///n/// @param {Keyword|Number} $value - Breakpoint name, or
px, rem, or em value to process.n///n/// @output If the breakpoint is "0px
and larger&quot;, outputs the content as-is. Otherwise, outputs the content
wrapped in a media query.n@mixin breakpoint($value) {n  $str:
breakpoint($value);n  $bp: index($-zf-breakpoints-keys, $value);n  $pbp:
index($-zf-breakpoints-keys, $print-breakpoint);nn  $old-zf-size: null;nn 
// Make breakpoint size available as a variablen  @if
global-variable-exists(-zf-size) {n    $old-zf-size: $-zf-size;n  }n 
$-zf-size: nth($value, 1) !global; // get the first value to account for
`only` and `down` keywordsnn  // If $str is still an empty string, no media
query is neededn  @if $str == &#39;&#39; {n    @content;n  }nn  //
Otherwise, wrap the content in a media queryn  @else {n    // For named
breakpoints less than or equal to $print-breakpoint, add print to the media
typesn    @if $bp != null and $bp &lt;= $pbp {n      @media print, screen
and #{$str} {n        @content;n       }n    }n    @else {n      @media
screen and #{$str} {n        @content;n      }n    }n  }nn  $-zf-size:
$old-zf-size !global;n}nn/// Converts the breakpoints map to a URL-encoded
string, like this: `key1=value1&amp;key2=value2`. The value is then dropped
into the CSS for a special `&lt;meta&gt;` tag, which is read by the
Foundation JavaScript. This is how we transfer values from Sass to
JavaScript, so they can be defined in one place.n/// @access
privaten///n/// @param {Map} $map - Map to convert.n///n/// @returns
{String} A string containing the map&#39;s contents.n@function
-zf-bp-serialize($map) {n  $str: &#39;&#39;;n  @each $key, $value in $map
{n    $str: $str + $key + &#39;=&#39; + -zf-bp-to-em($value) +
&#39;&amp;&#39;;n  }n  $str: str-slice($str, 1, -2);nn  @return
$str;n}nn/// Find the next key in a map.n/// @access privaten///n/// @param
{Map} $map - Map to traverse.n/// @param {Mixed} $key - Key to use as a
starting point.n///n/// @returns {Mixed} The value for the key after
`$key`, if `$key` was found. If `$key` was not found, or `$key` was the
last value in the map, returns `null`.n@function -zf-map-next($map, $key)
{nn  // Store the keys of the map as a listn  $values: map-keys($map);nn 
$i: 0;nn  // If the Key Exists, Get the index of the key within the map and
add 1 to it for the next breakpoint in the mapn  @if (map-has-key($map,
$key)) {n    $i: index($values, $key) + 1;n  }nn  // If the key doesn&#39;t
exist, or it&#39;s the last key in the map, return nulln  @if ($i &gt;
length($map) or $i == 0) {n    @return null;n  }n  // Otherwise, return the
valuen  @else {n    @return map-get($map, nth($values, $i));n  }nn}nn///
Return a list of our named breakpoints less than $key. Useful for dealing
withn/// responsive gutters for the grid.n/// @access privaten///n///
@param {String} $key - Key to use as last breakpoint.n///n/// @returns
{Array} The list of breakpoints up to and. If $key is auto, returns
breakpoints above the zeron@function -zf-breakpoints-less-than($key) {n 
$list: ();n  $found_key: false;nn  @each $name in $-zf-breakpoints-keys {n 
@if ($name == $key) {n      $found_key: true;n    }n    @if not $found_key
{n      $list: append($list, $name);n    }n  }n  @return $list;n}nn///
Return a list of our named breakpoints less than $key. Useful for dealing
withn/// responsive gutters for the grid.n/// @access privaten///n///
@param {String} $breakpoint - a named or non-named breakpoint.n///n///
@returns {Array} The list of breakpoints up to and. If $key is auto,
returns breakpoints above the zeron@function
-zf-closest-named-breakpoint($breakpoint) {n  $last: $-zf-zero-breakpoint;n
$found: false;nn  $value: unitless-calc($breakpoint, 1px);n  @each $key,
$val in $breakpoints {n    @if not $found {n      @if unitless-calc($val)
&gt; $value {n        $found: true;n      } @else {n        $last: $key;n  
}n    }n  }nn  @return $last;n}nn/// Get a value for a breakpoint from a
responsive config map or single value.n/// - If the config is a single
value, return it regardless of `$value`.n/// - If the config is a map and
has the key `$value`, the exact breakpoint value is returned.n/// - If the
config is a map and does <strong>not</strong> have the breakpoint, the
value matching the next lowest breakpoint in the config map is
returned.n/// @access privaten///n/// @param {Number|Map} $map - Responsive
config map or single value.n/// @param {Keyword} $value - Breakpoint name
to use.n///n/// @return {Mixed} The corresponding breakpoint
value.n@function -zf-get-bp-val($map, $value) {n  // If the given map is a
single value, return itn  @if type-of($map) == &#39;number&#39; {n   
@return $map;n  }nnn  // Check if the breakpoint name exists globallyn  @if
not map-has-key($breakpoints, $value) {n    @if type-of($value) ==
&#39;number&#39; {n      $value: -zf-closest-named-breakpoint($value);n   
} @else {n      @return null;n    }n  }n  // Check if the breakpoint name
exists in the local config mapn  @else if map-has-key($map, $value) {n   
// If it does, just return the valuen    @return map-get($map, $value);n 
}n  // Otherwise, find the next lowest breakpoint and return that valuen 
@else {n    $anchor: null;n    $found: false;nn    @each $key, $val in
$breakpoints {n      @if not $found {n        @if map-has-key($map, $key)
{n          $anchor: $key;n        }n        @if $key == $value {n         
$found: true;n        }n      }n    }nn    @return map-get($map, $anchor);n
}n}nn$small-up: &#39;&#39;;n$small-only: &#39;&#39;;nn@if
map-has-key($breakpoints, small) {n  $small-up: screen;n  $small-only:
unquote(&#39;screen and #{breakpoint(small only)}&#39;);n}nn$medium-up:
&#39;&#39;;n$medium-only: &#39;&#39;;nn@if map-has-key($breakpoints,
medium) {n  $medium-up: unquote(&#39;screen and
#{breakpoint(medium)}&#39;);n  $medium-only: unquote(&#39;screen and
#{breakpoint(medium only)}&#39;);n}nn$large-up: &#39;&#39;;n$large-only:
&#39;&#39;;nn@if map-has-key($breakpoints, large) {n  $large-up:
unquote(&#39;screen and #{breakpoint(large)}&#39;);n  $large-only:
unquote(&#39;screen and #{breakpoint(large only)}&#39;);n}nn$xlarge-up:
&#39;&#39;;n$xlarge-only: &#39;&#39;;nn@if map-has-key($breakpoints,
xlarge) {n  $xlarge-up: unquote(&#39;screen and
#{breakpoint(xlarge)}&#39;);n  $xlarge-only: unquote(&#39;screen and
#{breakpoint(xlarge only)}&#39;);n}nn$xxlarge-up: &#39;&#39;;nn@if
map-has-key($breakpoints, xxlarge) {n  $xxlarge-up: unquote(&#39;screen and
#{breakpoint(xxlarge)}&#39;);n}n”,“// Foundation for Sites by ZURBn//
foundation.zurb.comn// Licensed under MIT Open Sourcenn////n/// @group
revealn////nn/// Default background color of a modal.n/// @type
Colorn$reveal-background: $white !default;nn/// Default width of a modal,
with no class applied.n/// @type Numbern$reveal-width: 600px !default;nn///
Default maximum width of a modal.n/// @type Numbern$reveal-max-width:
$global-width !default;nn/// Default padding inside a modal.n/// @type
Numbern$reveal-padding: $global-padding !default;nn/// Default border
around a modal.n/// @type Numbern$reveal-border: 1px solid $medium-gray
!default;nn/// Default radius for modal.n/// @type Numbern$reveal-radius:
$global-radius !default;nn/// z-index for modals. The overlay uses this
value, while the modal itself uses this value plus one.n/// @type
Numbern$reveal-zindex: 1005 !default;nn/// Background color of modal
overlays.n/// @type Colorn$reveal-overlay-background: rgba($black, 0.45)
!default;nnn// Placeholder selector for medium-and-up modalsn// Prevents
duplicate CSS when defining multiple Reveal sizesn// This should be in the
same breakpoint then `@mixin reveal-modal-width`n@include
breakpoint(medium) {n  %reveal-centered {n    right: auto;n    left: auto;n
margin: 0 auto;n  }n}nnn/// Adds styles for a modal overlay.n/// @param
{Color} $background [$reveal-overlay-background] - Background color of the
overlay.n@mixin reveal-overlay($background: $reveal-overlay-background) {n 
position: fixed;n  top: 0;n  right: 0;n  bottom: 0;n  left: 0;n  z-index:
...
breakpoint(medium) {n    min-height: 0;n  }nn  // Make sure rows don&#39;t
have a min-width on themn  .column {n    min-width: 0;n  }nn  // Strip
margins from the last item in the modaln  &gt; :last-child {n   
margin-bottom: 0;n  }n}nn/// Adjusts the width of a modal.n/// @param
{Number} $width - Width of the modal. Generally a percentage.n/// @param
{Number} $max-width [$reveal-max-width] - Maximum width of the
modal.n@mixin reveal-modal-width(n  $width: $reveal-width,n  $max-width:
...
classesn    &amp;.tiny  { @include reveal-modal-width(30%); }n   
&amp;.small { @include reveal-modal-width(50%); }n    &amp;.large {
@include reveal-modal-width(90%); }nn    // Full-screen moden    &amp;.full
{n      @include reveal-modal-fullscreen;n    }nn    @include
...
v8.0.0 | MIT <a
href="../../../admin-lte/plugins/datatables/extensions/ColReorder/License_txt.html">License</a>
| github.com/necolas/normalize.css */nn  // Documentn  //
==========================================================================nn
...
Opera, and Safari.nn  <a href="title">abbr</a> {n    border-bottom: none;
// 1n    text-decoration: underline; // 2n    text-decoration: underline
dotted; // 2n  }nn  // Add the correct font weight in Chrome, Edge, and
Safari.nn  b,n  strong {n    font-weight: bolder;n  }nn  // 1. Correct the
inheritance and scaling of font size in all browsers.n  // 2. Correct the
odd `em` font sizing in all browsers.nn  code,n  kbd,n  samp {n   
font-family: monospace, monospace; // 1n    font-size: 1em; // 2n  }nn  //
Add the correct font size in all browsers.nn  small {n    font-size: 80%;n 
}nn  // Prevent `sub` and `sup` elements from affecting the line height inn
// all browsers.nn  sub,n  sup {n    font-size: 75%;n    line-height: 0;n  
...
style clickable types in iOS and Safari.nn  button,n 
[type=&quot;button&quot;],n  [type=&quot;reset&quot;],n 
[type=&quot;submit&quot;] {n    -webkit-appearance: button;n  }nn  //
Remove the inner border and padding in Firefox.nn 
button::-moz-focus-inner,n  [type=&quot;button&quot;]::-moz-focus-inner,n 
[type=&quot;reset&quot;]::-moz-focus-inner,n 
[type=&quot;submit&quot;]::-moz-focus-inner {n    border-style: none;n   
padding: 0;n  }nn  // Restore the focus styles unset by the previous
rule.nn  button:-moz-focusring,n 
[type=&quot;button&quot;]:-moz-focusring,n 
[type=&quot;reset&quot;]:-moz-focusring,n 
[type=&quot;submit&quot;]:-moz-focusring {n    outline: 1px dotted
ButtonText;n  }nn  // Correct the padding in Firefox.nn  fieldset {n   
padding: 0.35em 0.75em 0.625em;n  }nn  // 1. Correct the text wrapping in
Edge and IE.n  // 2. Correct the color inheritance from `fieldset` elements
in IE.n  // 3. Remove the padding so developers are not caught out when
they zero outn  //    `fieldset` elements in all browsers.nn  legend {n   
box-sizing: border-box; // 1n    color: inherit; // 2n    display: table;
// 1n    max-width: 100%; // 1n    padding: 0; // 3n    white-space:
normal; // 1n  }nn  // Add the correct vertical alignment in Chrome,
Firefox, and Opera.nn  progress {n    vertical-align: baseline;n  }nn  //
Remove the default vertical scrollbar in IE 10+.nn  textarea {n   
overflow: auto;n  }nn  // 1. Add the correct box sizing in IE 10.n  // 2.
Remove the padding in IE 10.nn  [type=&quot;checkbox&quot;],n 
[type=&quot;radio&quot;] {n    box-sizing: border-box; // 1n    padding: 0;
// 2n  }nn  // Correct the cursor style of increment and decrement buttons
in Chrome.nn  [type=&quot;number&quot;]::-webkit-inner-spin-button,n 
[type=&quot;number&quot;]::-webkit-outer-spin-button {n    height: auto;n 
}nn  // 1. Correct the odd appearance in Chrome and Safari.n  // 2. Correct
the outline style in Safari.nn  [type=&quot;search&quot;] {n   
-webkit-appearance: textfield; // 1n    outline-offset: -2px; // 2n  }nn 
// Remove the inner padding in Chrome and Safari on macOS.nn 
[type=&quot;search&quot;]::-webkit-search-decoration {n   
-webkit-appearance: none;n  }nn  // 1. Correct the inability to style
clickable types in iOS and Safari.n  // 2. Change font properties to
`inherit` in Safari.nn  ::-webkit-file-upload-button {n   
-webkit-appearance: button; // 1n    font: inherit; // 2n  }nn  //
Interactiven  //
==========================================================================nn
...
under MIT Open Sourcenn// sass-lint:disable no-color-literals,
no-qualifying-elementsnn////n/// @group globaln////nn@import
&#39;util/util&#39;;nn/// Font size attribute applied to `&lt;html&gt;` and
`&lt;body&gt;`. We use 100% by default so the value is inherited from the
user&#39;s browser settings.n/// @type Numbern$global-font-size: 100%
!default;nn/// Global width of your site. Used by the grid to determine row
width.n/// @type Numbern$global-width: rem-calc(1200) !default;nn///
Default line height for all type. `$global-lineheight` is 24px while
`$global-font-size` is 16pxn/// @type Numbern$global-lineheight: 1.5
!default;nn/// Colors used for buttons, callouts, links, etc. There must
always be a color called `primary`.n/// @type Mapn$foundation-palette: (n 
primary: #1779ba,n  secondary: #767676,n  success: #3adb76,n  warning:
ffae00,n  alert: cc4b37,n) !default;nn/// Color used for light gray UI
items.n/// @type Colorn$light-gray: e6e6e6 !default;nn/// Color used for
medium gray UI items.n/// @type Colorn$medium-gray: cacaca !default;nn///
Color used for dark gray UI items.n/// @type Colorn$dark-gray: #8a8a8a
!default;nn/// Color used for black ui items.n/// @type Colorn$black:
#0a0a0a !default;nn/// Color used for white ui items.n/// @type
Colorn$white: fefefe !default;nn/// Background color of the body.n/// @type
Colorn$body-background: $white !default;nn/// Text color of the body.n///
@type Colorn$body-font-color: $black !default;nn/// Font stack of the
body.n/// @type Listn$body-font-family: &#39;Helvetica Neue&#39;,
Helvetica, Roboto, Arial, sans-serif !default;nn/// Set to `true` to enable
antialiased type, using the `-webkit-font-smoothing` and
`-moz-osx-font-smoothing` CSS properties.n/// @type
Booleann$body-antialiased: true !default;nn/// Global value used for margin
on components.n/// @type Numbern$global-margin: 1rem !default;nn/// Global
value used for padding on components.n/// @type Numbern$global-padding:
1rem !default;nn/// Global value used for positioning on components.n///
@type Numbern$global-position: 1rem !default;nn/// Global font weight used
for normal type.n/// @type Keyword | Numbern$global-weight-normal: normal
!default;nn/// Global font weight used for bold type.n/// @type Keyword |
Numbern$global-weight-bold: bold !default;nn/// Global value used for all
elements that have a border radius.n/// @type Numbern$global-radius: 0
!default;nn/// Global value used for all menu styles. Can be overwritten at
individual menu component level.n/// @type Numbern$global-menu-padding:
0.7rem 1rem !default;nn/// Global value used for all menu styles. Nested
margin for submenu.n$global-menu-nested-margin: 1rem !default;nn/// Sets
the text direction of the CSS. Can be either `ltr` or `rtl`.n/// @type
...
foundation.zurb.comn// Licensed under MIT Open Sourcenn////n/// @group
functionsn////nn$global-font-size: 100% !default;nn/// Removes the unit
(e.g. px, em, rem) from a value, returning the number only.n///n/// @param
{Number} $num - Number to strip unit from.n///n/// @returns {Number} The
same number, sans unit.n@function strip-unit($num) {n  @return $num / ($num
* 0 + 1);n}nn/// Converts one or more pixel values into matching rem
values.n///n/// @param {Number|List} $values - One or more values to
convert. Be sure to separate them with spaces and not commas. If you need
to convert a comma-separated list, wrap the list in parentheses.n/// @param
{Number} $base [null] - The base value to use when calculating the `rem`.
If you&#39;re using Foundation out of the box, this is 16px. If this
parameter is `null`, the function will reference the `$global-font-size`
variable as the base.n///n/// @returns {List} A list of converted
values.n@function rem-calc($values, $base: null) {n  $rem-values: ();n 
$count: length($values);nn  // If no base is defined, defer to the global
font sizen  @if $base == null {n    $base: $global-font-size;n  }nn  // If
the base font size is a %, then multiply it by 16pxn  // This is because
100% font size = 16px in most all browsersn  @if unit($base) == &#39;%&#39;
{n    $base: ($base / 100%) * 16px;n  }nn  // Using rem as base allows
correct scalingn  @if unit($base) == &#39;rem&#39; {n    $base:
strip-unit($base) * 16px;n  }nn  @if $count == 1 {n    @return
-zf-to-rem($values, $base);n  }nn  @for $i from 1 through $count {n   
$rem-values: append($rem-values, -zf-to-rem(nth($values, $i), $base));n 
}nn  @return $rem-values;n}nn// Converts a unitless, pixel, or rem value to
em, for use in breakpoints.n@function -zf-bp-to-em($value) {n  // Pixel and
unitless values are converted to remsn  @if unit($value) == &#39;px&#39; or
unitless($value) {n    $value: rem-calc($value, $base: 16px);n  }nn  //
Then the value is converted to emsn  @return strip-unit($value) *
1em;n}nn/// Converts a pixel value to matching rem value.
<strong>Any</strong> value passed, regardless of unit, is assumed to be a
pixel value. By default, the base pixel value used to calculate the rem
value is taken from the `$global-font-size` variable.n/// @access
privaten///n/// @param {Number} $value - Pixel value to convert.n/// @param
{Number} $base [null] - Base for pixel conversion.n///n/// @returns
{Number} A number in rems, calculated based on the given value and the base
pixel value. rem values are passed through as is.n@function
-zf-to-rem($value, $base: null) {n  // Check if the value is a numbern  @if
type-of($value) != &#39;number&#39; {n    @warn inspect($value) + &#39; was
passed to rem-calc(), which is not a number.&#39;;n    @return $value;n 
}nn  // Transform em into rem if someone hands over &#39;em&#39;sn  @if
unit($value) == &#39;em&#39; {n    $value: strip-unit($value) * 1rem;n  }nn
// Calculate rem if units for $value is not rem or emn  @if unit($value) !=
&#39;rem&#39; {n    $value: strip-unit($value) / strip-unit($base) * 1rem;n
}nn  // Turn 0rem into 0n  @if $value == 0rem {n    $value: 0;n  }nn 
@return $value;n}nn/// Converts a pixel, percentage, rem or em value to a
unitless value based on a given font size. Ideal for working out unitless
line heights.n///n/// @param {Number} $value - Value to convert to a
unitless line heightn/// @param {Number} $base - The font size to use to
work out the line height - defaults to $global-font-sizen///n/// @return
{Number} - Unitless numbern@function unitless-calc($value, $base: null) {nn
// If no base is defined, defer to the global font sizen  @if $base == null
{n    $base: $global-font-size;n  }nn  // First, lets convert our $base to
pixelsnn  // If the base font size is a %, then multiply it by 16pxn  @if
unit($base) == &#39;%&#39; {n    $base: ($base / 100%) * 16px;n  }nn  @if
unit($base) == &#39;rem&#39; {n    $base: strip-unit($base) * 16px;n  }nn 
@if unit($base) == &#39;em&#39; {n    $base: strip-unit($base) * 16px;n 
}nn  // Now let&#39;s convert our value to pixels toon  @if unit($value) ==
&#39;%&#39; {n    $value: ($value / 100%) * $base;n  }nn  @if unit($value)
== &#39;rem&#39; {n    $value: strip-unit($value) * $base;n  }nn  @if
unit($value) == &#39;em&#39; {n    $value: strip-unit($value) * $base;n 
}nn  // &#39;px&#39;n  @if unit($value) == &#39;px&#39; {n    @return
strip-unit($value) / strip-unit($base);n  }nn  // assume that line-heights
greater than 10 are meant to be absolute in &#39;px&#39;n  @if
unitless($value) and ($value &gt; 10) {n    @return $value /
strip-unit($base);n  }nn  @return $value;n}n”,“// Foundation for Sites by
ZURBn// foundation.zurb.comn// Licensed under MIT Open Sourcenn////n///
@group functionsn////nn/// Creates an inner box-shadow for only one
siden///n/// @param {Keyword} $side - Side the shadow is supposed to
appear. Can be `top`, `left`, `right` or `bottom`.n/// @param {Number}
$size - Width for the target side.n/// @param {Color} $color - Color of the
shadow.n@mixin inner-side-shadow(n  $side: bottom,n  $size: 20px,n  $color:
rgba($black, 0.25)n) {nn  $helper: round($size * 0.65);nn  @if ($side ==
top) {n    box-shadow: inset 0 $helper $size (-1)*$helper $color;n  } @else
if ($side == left) {n    box-shadow: inset $helper 0 $size (-1)*$helper
$color;n  } @else if ($side == right) {n    box-shadow: inset (-1)*$helper
0 $size (-1)*$helper $color;n  } @else if ($side == bottom) {n   
box-shadow: inset 0 (-1)*$helper $size (-1)*$helper $color;n  }n}nn///
...
selector, to attach the triangle to an existing element.n///n/// @param
{Number} $triangle-size - Width of the triangle.n/// @param {Color}
$triangle-color - Color of the triangle.n/// @param {Keyword}
$triangle-direction - Direction the triangle points. Can be `up`, `right`,
`down`, or `left`.n@mixin css-triangle(n  $triangle-size,n 
$triangle-color,n  $triangle-directionn) {n  display: block;n  width: 0;n 
height: 0;nn  border: inset $triangle-size;nn  content: &#39;&#39;;nn  @if
...
foundation.zurb.comn// Licensed under MIT Open Sourcenn////n/// @group
progress-barn////nn/// Height of a progress bar.n/// @type
Numbern$progress-height: 1rem !default;nn/// Background color of a progress
bar.n/// @type Colorn$progress-background: $medium-gray !default;nn///
Bottom margin of a progress bar.n/// @type Numbern$progress-margin-bottom:
$global-margin !default;nn/// Default color of a progress bar&#39;s
meter.n/// @type Colorn$progress-meter-background: $primary-color
!default;nn/// Default radius of a progress bar.n/// @type
Numbern$progress-radius: $global-radius !default;nn@mixin
foundation-progress-element {n  progress {n    display: block;n    width:
100%;n    height: $progress-height;n    margin-bottom:
$progress-margin-bottom;nn    appearance: none;nn    @if
has-value($progress-radius) {n      border-radius: $progress-radius;n   
}nn    // For Firefoxn    border: 0;n    background:
$progress-background;nn    &amp;::-webkit-progress-bar {n      background:
$progress-background;nn      @if has-value($progress-radius) {n       
border-radius: $progress-radius;n      }n    }nn   
&amp;::-webkit-progress-value {n      background:
$progress-meter-background;nn      @if has-value($progress-radius) {n      
border-radius: $progress-radius;n      }n    }nn   
&amp;::-moz-progress-bar {n      background: $progress-meter-background;nn 
@if has-value($progress-radius) {n        border-radius: $progress-radius;n
}n    }nn    @each $name, $color in $foundation-palette {n     
&amp;.#{$name} {n        // Internet Explorer sets the fill with colorn    
color: $color;nn        &amp;::-webkit-progress-value {n         
background: $color;n        }nn        &amp;::-moz-progress-bar {n         
background: $color;n        }n      }n    }nn    // For IE and Edgen   
&amp;::-ms-fill { // sass-lint:disable-line no-vendor-prefixesn      @if
has-value($progress-radius) {n        border-radius: $progress-radius;n    
}nn      border: 0;n    }n  }n}n”,“// Foundation for Sites by ZURBn//
...
Foundation for Sites by ZURBn// foundation.zurb.comn// Licensed under MIT
Open Sourcenn////n/// @group slidern////nn/// Default height of the
slider.n/// @type Numbern$slider-height: 0.5rem !default;nn/// Default
background color of the slider&#39;s track.n/// @type
Colorn$slider-background: $light-gray !default;nn/// Default color of the
active fill color of the slider.n/// @type Colorn$slider-fill-background:
$medium-gray !default;nn/// Default height of the handle of the slider.n///
@type Numbern$slider-handle-height: 1.4rem !default;nn/// Default width of
the handle of the slider.n/// @type Numbern$slider-handle-width: 1.4rem
!default;nn/// Default color of the handle for the slider.n/// @type
Colorn$slider-handle-background: $primary-color !default;nn/// Default fade
amount of a disabled slider.n/// @type Numbern$slider-opacity-disabled:
0.25 !default;nn/// Default radius for slider.n/// @type
Numbern$slider-radius: $global-radius !default;nn@mixin
foundation-range-input {n  <a href="type='range'">input</a> {  //
sass-lint:disable-line no-qualifying-elementsn    $margin:
($slider-handle-height - $slider-height) / 2;nn    display: block;n   
width: 100%;n    height: auto;n    margin-top: $margin;n    margin-bottom:
$margin;nn    appearance: none;n    border: 0;n    line-height: 1;n   
cursor: pointer;nn    @if has-value($slider-radius) {n      border-radius:
$slider-radius;n    }nn    &amp;:focus {n      outline: 0;n    }nn   
&amp;[disabled] {n      opacity: $slider-opacity-disabled;n    }nn    //
sass-lint:disable no-vendor-prefixnn    // Chrome/Safarin   
&amp;::-webkit-slider-runnable-track {n      height: $slider-height;n     
background: $slider-background;n    }nn    &amp;::-webkit-slider-thumb {n  
width: $slider-handle-width;n      height: $slider-handle-height;n     
margin-top: -$margin;nn      -webkit-appearance: none; //
sass-lint:disable-line no-vendor-prefixesn      background:
$slider-handle-background;nn      @if has-value($slider-radius) {n       
border-radius: $slider-radius;n      }n    }nn    // Firefoxn   
&amp;::-moz-range-track {n      height: $slider-height;n     
-moz-appearance: none; // sass-lint:disable-line no-vendor-prefixesn     
background: $slider-background;n    }nn    &amp;::-moz-range-thumb {n     
width: $slider-handle-width;n      height: $slider-handle-height;n     
margin-top: -$margin;nn      -moz-appearance: none; //
sass-lint:disable-line no-vendor-prefixesn      background:
$slider-handle-background;nn      @if has-value($slider-radius) {n       
border-radius: $slider-radius;n      }n    }nn    // Internet Explorern   
&amp;::-ms-track {n      height: $slider-height;nn      border: 0;n     
border-top: $margin solid $body-background;n      border-bottom: $margin
solid $body-background;n      background: $slider-background;nn     
overflow: visible;n      color: transparent;n    }nn    &amp;::-ms-thumb {n
width: $slider-handle-width;n      height: $slider-handle-height;n     
border: 0;n      background: $slider-handle-background;nn      @if
has-value($slider-radius) {n        border-radius: $slider-radius;n      }n
}nn    &amp;::-ms-fill-lower {n      background: $slider-fill-background;n 
}nn    &amp;::-ms-fill-upper {n      background: $slider-background;n   
}nn    @at-root {n      output {n        vertical-align: middle;n       
margin-left: 0.5em;n        line-height: $slider-handle-height;n      }n   
}n  }n}n”,“// Foundation for Sites by ZURBn// foundation.zurb.comn//
Licensed under MIT Open Sourcenn////n/// @group switchn////nn/// Background
color of a switch.n/// @type Colorn$switch-background: $medium-gray
!default;nn/// Background active color of a switch.n/// @type
...
under MIT Open Sourcenn@import &#39;math&#39;;nn$contrast-warnings: true
!default;nn////n/// @group functionsn////nn/// Checks the luminance of
`$color`.n///n/// @param {Color} $color - Color to check the luminance
of.n///n/// @returns {Number} The luminance of `$color`.n@function
color-luminance($color) {n  // Adapted from: <a
href="https://github.com/LeaVerou/contrast-ratio/blob/gh-pages/color.js\n">github.com/LeaVerou/contrast-ratio/blob/gh-pages/color.jsn</a>
// Formula: <a
href="http://www.w3.org/TR/2008/REC-WCAG20-20081211/#relativeluminancedef\n">www.w3.org/TR/2008/REC-WCAG20-20081211/#relativeluminancedefn</a>
$rgba: red($color), green($color), blue($color);n  $rgba2: ();nn  @for $i
from 1 through 3 {n    $rgb: nth($rgba, $i);n    $rgb: $rgb / 255;nn   
$rgb: if($rgb &lt; 0.03928, $rgb / 12.92, pow(($rgb + 0.055) / 1.055,
2.4));nn    $rgba2: append($rgba2, $rgb);n  }nn  @return 0.2126 *
nth($rgba2, 1) + 0.7152 * nth($rgba2, 2) + 0.0722 * nth($rgba2, 3);n}nn///
Checks the contrast ratio of two colors.n///n/// @param {Color} $color1 -
First color to compare.n/// @param {Color} $color2 - Second color to
compare.n///n/// @returns {Number} The contrast ratio of the compared
colors.n@function color-contrast($color1, $color2) {n  // Adapted from: <a
href="https://github.com/LeaVerou/contrast-ratio/blob/gh-pages/color.js\n">github.com/LeaVerou/contrast-ratio/blob/gh-pages/color.jsn</a>
// Formula: <a
href="http://www.w3.org/TR/2008/REC-WCAG20-20081211/#contrast-ratiodef\n">www.w3.org/TR/2008/REC-WCAG20-20081211/#contrast-ratiodefn</a>
$luminance1: color-luminance($color1) + 0.05;n  $luminance2:
color-luminance($color2) + 0.05;n  $ratio: $luminance1 / $luminance2;nn 
@if $luminance2 &gt; $luminance1 {n    $ratio: 1 / $ratio;n  }nn  $ratio:
round($ratio * 10) / 10;nn  @return $ratio;n}nn/// Checks the luminance of
`$base`, and returns the color from `$colors` (list of colors) that has the
most contrast.n///n/// @param {Color} $base - Color to check luminance.n///
@param {List} $colors [($white, $black)] - Colors to compare.n/// @param
{Number} $tolerance [$global-color-pick-contrast-tolerance] - Contrast
tolerance.n///n/// @returns {Color} the color from `$colors` (list of
colors) that has the most contrast.n@function color-pick-contrast($base,
$colors: ($white, $black), $tolerance:
$global-color-pick-contrast-tolerance) {n  $contrast: color-contrast($base,
nth($colors, 1));n  $best: nth($colors, 1);nn  @for $i from 2 through
length($colors) {n    $current-contrast: color-contrast($base, nth($colors,
$i));n    @if ($current-contrast - $contrast &gt; $tolerance) {n     
$contrast: color-contrast($base, nth($colors, $i));n      $best:
nth($colors, $i);n    }n  }nn  @if ($contrast-warnings and $contrast &lt;
3) {n    @warn "Contrast ratio of #{$best} on #{$base} is pretty bad, just
#{$contrast}&quot;;n  }nn  @return $best;n}nn/// Scales a color to be
darker if it&#39;s light, or lighter if it&#39;s dark. Use this function to
tint a color appropriate to its lightness.n///n/// @param {Color} $color -
Color to scale.n/// @param {Percentage} $scale [5%] - Amount to scale up or
down.n/// @param {Percentage} $threshold [40%] - Threshold of lightness to
check against.n///n/// @returns {Color} A scaled color.n@function
smart-scale($color, $scale: 5%, $threshold: 40%) {n  @if lightness($color)
&gt; $threshold {n    $scale: -$scale;n  }n  @return scale-color($color,
$lightness: $scale);n}nn/// Get color from foundation-paletten///n///
@param {key} color key from foundation-paletten///n/// @returns {Color}
color from foundation-paletten@function get-color($key) {n  @if
map-has-key($foundation-palette, $key) {n    @return
map-get($foundation-palette, $key);n  }n  @else {n    @error &#39;given
$key is not available in $foundation-palette&#39;;n  }n}nn/// Transfers the
colors in the `$foundation-palette` map into variables, such as
`$primary-color` and `$secondary-color`. Call this mixin below the Global
section of your settings file to properly migrate your codebase.n@mixin
add-foundation-colors() {n  @if map-has-key($foundation-palette, primary)
{n    $primary-color: map-get($foundation-palette, primary) !global;n  }
@else {n    $primary-color: #1779ba !global;n  }n  @if
map-has-key($foundation-palette, secondary) {n    $secondary-color:
map-get($foundation-palette, secondary) !global;n  } @else {n   
$secondary-color: #767676 !global;n  }n  @if
map-has-key($foundation-palette, success) {n    $success-color:
map-get($foundation-palette, success) !global;n  } @else {n   
$success-color: #3adb76 !global;n  }n  @if map-has-key($foundation-palette,
warning) {n    $warning-color: map-get($foundation-palette, warning)
!global;n  } @else {n    $warning-color: ffae00 !global;n  }n  @if
map-has-key($foundation-palette, alert) {n    $alert-color:
map-get($foundation-palette, alert) !global;n  } @else {n    $alert-color:
cc4b37 !global;n  }n}n”,“// Foundation for Sites by ZURBn//
foundation.zurb.comn// Licensed under MIT Open Sourcenn////n/// @group
badgen////nn/// Default background color for badges.n/// @type
Colorn$badge-background: $primary-color !default;nn/// Default text color
for badges.n/// @type Colorn$badge-color: $white !default;nn/// Alternate
text color for badges.n/// @type Colorn$badge-color-alt: $black
!default;nn/// Coloring classes. A map of classes to output in your CSS,
like `.secondary`, `.success`, and so on.n/// @type Mapn$badge-palette:
$foundation-palette !default;nn/// Default padding inside badges.n/// @type
Numbern$badge-padding: 0.3em !default;nn/// Minimum width of a badge.n///
@type Numbern$badge-minwidth: 2.1em !default;nn/// Default font size for
badges.n/// @type Numbern$badge-font-size: 0.6rem !default;nn/// Generates
the base styles for a badge.n@mixin badge {n  display: inline-block;n 
min-width: $badge-minwidth;n  padding: $badge-padding;nn  border-radius:
50%;nn  font-size: $badge-font-size;n  text-align: center;n}nn@mixin
...
by ZURBn// foundation.zurb.comn// Licensed under MIT Open Sourcenn////n///
@group functionsn////nn/// Finds the greatest common divisor of two
integers.n///n/// @param {Number} $a - First number to compare.n/// @param
{Number} $b - Second number to compare.n///n/// @returns {Number} The
greatest common divisor.n@function gcd($a, $b) {n  // From: <a
href="http://rosettacode.org/wiki/Greatest_common_divisor#JavaScript\n">rosettacode.org/wiki/Greatest_common_divisor#JavaScriptn</a>
@if ($b != 0) {n    @return gcd($b, $a % $b);n  }n  @else {n    @return
abs($a);n  }n}nn/// Handles decimal exponents by trying to convert them
into a fraction and then use a nth-root-algorithm for parts of the
calculationn///n/// @param {Number} $base - The base number.n/// @param
{Number} $exponent - The exponent.n///n/// @returns {Number} The product of
the exponentiation.n@function pow($base, $exponent, $prec: 16) {n  @if
(floor($exponent) != $exponent) {n    $prec2 : pow(10, $prec);n   
$exponent: round($exponent * $prec2);n    $denominator: gcd($exponent,
$prec2);n    @return nth-root(pow($base, $exponent / $denominator), $prec2
/ $denominator, $prec);n  }nn  $value: $base;n  @if $exponent &gt; 1 {n   
@for $i from 2 through $exponent {n      $value: $value * $base;n    }n  }n
@else if $exponent &lt; 1 {n    @for $i from 0 through -$exponent {n     
$value: $value / $base;n    }n  }nn  @return $value;n}nn@function
nth-root($num, $n: 2, $prec: 12) {n  // From: <a
href="http://rosettacode.org/wiki/Nth_root#JavaScript\n">rosettacode.org/wiki/Nth_root#JavaScriptn</a>
$x: 1;nn  @for $i from 0 through $prec {n    $x: 1 / $n * (($n - 1) * $x +
($num / pow($x, $n - 1)));n  }nn  @return $x;n}nn/// Calculates the height
as a percentage of the width for a given ratio.n/// @param {List} $ratio -
Ratio to use to calculate the height, formatted as `x by y`.n/// @return
{Number} A percentage value for the height relative to the width of a
responsive container.n@function ratio-to-percentage($ratio) {n  $w:
nth($ratio, 1);n  $h: nth($ratio, 3);n  @return $h / $w * 100%;n}n”,“//
Foundation for Sites by ZURBn// foundation.zurb.comn// Licensed under MIT
Open Sourcenn////n/// @group tabsn////nn/// Default margin of the tab
bar.n/// @type Numbern$tab-margin: 0 !default;nn/// Default background
color of a tab bar.n/// @type Colorn$tab-background: $white !default;nn///
Font color of tab item.n/// @type Colorn$tab-color: $primary-color
!default;nn/// Active background color of a tab bar.n/// @type
Colorn$tab-background-active: $light-gray !default;nn/// Active font color
of tab item.n/// @type Colorn$tab-active-color: $primary-color
!default;nn/// Font size of tab items.n/// @type
Numbern$tab-item-font-size: rem-calc(12) !default;nn/// Default background
color on hover for items in a Menu.n$tab-item-background-hover: $white
!default;nn/// Default padding of a tab item.n/// @type
Numbern$tab-item-padding: 1.25rem 1.5rem !default;nn/// Default background
color of tab content.n/// @type Colorn$tab-content-background: $white
!default;nn/// Default border color of tab content.n/// @type
Colorn$tab-content-border: $light-gray !default;nn/// Default text color of
tab content.n/// @type Colorn$tab-content-color: $body-font-color
!default;nn/// Default padding for tab content.n/// @type Number |
Listn$tab-content-padding: 1rem !default;nn/// Adds styles for a tab
container. Apply this to a `&lt;ul&gt;`.n@mixin tabs-container (n  $margin:
$tab-margin,n  $background: $tab-background,n  $border-color:
$tab-content-bordern) {n  @include clearfix;n  margin: $margin;n  border:
1px solid $border-color;n  background: $background;n  list-style-type:
none;n}nn/// Augments a tab container to have vertical tabs. Use this in
conjunction with `tabs-container()`.n@mixin tabs-container-vertical {n 
&gt; li {n    display: block;n    float: none;n    width: auto;n  }n}nn///
Adds styles for the links within a tab container. Apply this to the
`&lt;li&gt;` elements inside a tab container.n@mixin tabs-title (n 
$padding: $tab-item-padding,n  $font-size: $tab-item-font-size,n  $color:
