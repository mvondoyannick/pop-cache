...
<main role="main" aria-label="Page node_modules/foundation-sites/README.md">
<p align="center">
...
<p><a href="https://travis-ci.org/zurb/foundation-sites"><img
src="https://travis-ci.org/zurb/foundation-sites.svg?branch=develop"></a>
<a href="https://david-dm.org/zurb/foundation-sites"><img
src="https://david-dm.org/zurb/foundation-sites/status.svg"></a> <a
href="https://david-dm.org/zurb/foundation-sites?type=dev"><img
src="https://david-dm.org/zurb/foundation-sites/dev-status.svg"></a> <a
href="https://badge.fury.io/js/foundation-sites"><img
src="https://badge.fury.io/js/foundation-sites.svg"></a> <a
href="https://badge.fury.io/bo/foundation-sites"><img
src="https://badge.fury.io/bo/foundation-sites.svg"></a> <a
href="https://badge.fury.io/rb/foundation-rails"><img
src="https://badge.fury.io/rb/foundation-rails.svg"></a> <a
href="https://www.jsdelivr.com/package/npm/foundation-sites"><img
src="https://data.jsdelivr.com/v1/package/npm/foundation-sites/badge?style=rounded"></a>
<a
href="https://gitter.im/zurb/foundation-sites?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge"><img
...
work on any kind of device with Foundation. Includes a fully customizable,
responsive grid, a large library of Sass mixins, commonly used JavaScript
plugins, and full accessibility support.</p>
<hr>

<h2 id="label-Run+locally">Run locally<span><a href="#label-Run+locally">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Documentation">Documentation<span><a href="#label-Documentation">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To run the documentation locally on your machine, you need <a
href="https://nodejs.org/en/">Node.js</a> installed on your computer. (Your
Node.js version must be <strong>6.4.0</strong> or higher). Run these
commands to set up the documentation:</p>
...
<p>Foundation has three kinds of tests: JavaScript, Sass, and visual
regression. Refer to our <a
href="https://github.com/zurb/foundation-sites/wiki/Testing-Guide">testing
guide</a> for more details.</p>

<p>Run tests with: <code>bash # Sass unit tests npm run test:sass # JavaScript
unit tests npm run test:javascript:units # Visual tests npm run test:visual
</code></p>

<p>Testing Supported By&lt;br/&gt; &lt;img width=“160” src=“<a
href="http://foundation.zurb.com/sites/docs/assets/img/logos/browser-stack.svg">foundation.zurb.com/sites/docs/assets/img/logos/browser-stack.svg</a>”
alt=“BrowserStack”/&gt;</p>

<h2 id="label-Contributing">Contributing<span><a href="#label-Contributing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Check out <a href="CONTRIBUTING.md">CONTRIBUTING.md</a> to see how to
report an issue or submit a bug fix or a new feature, and our <a
href="http://foundation.zurb.com/develop/contribute.html">contributing
guide</a> to learn how you can contribute more globally to Foundation. You
can also browse the <a
href="https://github.com/zurb/foundation-sites/labels/help%20wanted">Help
Wanted</a> tag in our issue tracker to find things to do.</p>

<h2 id="label-Training">Training<span><a href="#label-Training">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Want the guided tour to Foundation from the team that built it? The ZURB
team offers comprehensive training courses for developers of all skill
levels. If you&#39;re new to Foundation, check out the <a
href="http://zurb.com/university/foundation-intro?utm_source=Github%20Repo&utm_medium=website&utm_campaign=readme&utm_content=readme%20training%20link">Introduction
to Foundation Course</a> to kickstart your skills, amplify your
productivity, and get a comprehensive overview of everything Foundation has
to offer. More advanced users should check out the <a
href="http://zurb.com/university/advanced-foundation-training?utm_source=Github%20Repo&utm_medium=website&utm_campaign=readme&utm_content=readme%20training%20link">Advanced
Foundation Course</a> to learn the Advanced skills that ZURB uses to
deliver quality client work in short timeframes.</p>

<p>Copyright © 2019 ZURB, Inc.</p>
</main>
