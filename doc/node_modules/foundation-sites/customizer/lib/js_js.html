...
<title>js.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/customizer/lib/js.js">

<p>var empty = require(&#39;is-empty-object&#39;); var unique =
require(&#39;array-uniq&#39;); var path = require(&#39;path&#39;);</p>

<p>// custom module names where needed const MODULES = {</p>

<pre>&#39;offcanvas&#39;: &#39;OffCanvas&#39;</pre>

<p>};</p>

<pre>Creates an array of file paths that can be passed to `gulp.src()`.
@param {Object} config - Customizer configuration file.
@param {String[]} modules - Modules to include in the file list.
@returns {String[]} Array of file paths.</pre>

<p>module.exports = function(config, modules) {</p>

<pre>var dir = path.resolve(__dirname, &#39;../../js/&#39;);
