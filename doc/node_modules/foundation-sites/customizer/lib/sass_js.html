...
<main role="main" aria-label="Page node_modules/foundation-sites/customizer/lib/sass.js">

<p>var empty = require(&#39;is-empty-object&#39;); var format =
require(&#39;util&#39;).format; var stripIndent =
require(&#39;strip-indent&#39;);</p>

<p>var SASS_TEMPLATE = stripIndent(`</p>
...
<pre>Generates an entry point Sass file with a custom list of CSS exports and Sass variables.
...
@returns {String} Formatted Sass file.</pre>

<p>module.exports = function(config, modules, variables) {</p>

<pre>var variableList = [];
var colorList = {};
...
<p>function createPaletteMap(colors) {</p>

<pre>var output = &#39;$foundation-palette: (%s\n);&#39;;
var keys = &#39;&#39;;
