...
<main role="main" aria-label="Page node_modules/foundation-sites/js/entries/plugins/foundation.core.js">
...
utility do not have to be added to the core API. import $ from
&#39;jquery&#39;; import { Foundation } from
&#39;../../foundation.core&#39;; import { Plugin } from
&#39;../../foundation.core.plugin&#39;; import { rtl, GetYoDigits,
transitionend, RegExpEscape, onLoad } from
&#39;../../foundation.core.utils&#39;;</p>

<p>Foundation.addToJquery($);</p>

<p>// Every plugin depends on plugin now, we can include that on the core for
the // script inclusion path. Foundation.Plugin = Plugin;</p>

<p>// These are now separated out, but historically were a part of this
module, // and since this is here for backwards compatibility we include
them in // this entry. Foundation.rtl = rtl; Foundation.GetYoDigits =
GetYoDigits; Foundation.transitionend = transitionend;
Foundation.RegExpEscape = RegExpEscape; Foundation.onLoad = onLoad;</p>

<p>window.Foundation = Foundation;</p>

<p>// — Foundation Core exports — // Export “Plugin” and all core utilities,
since the `foundation.core` entry plays the role of // all core source
files.</p>

<p>export { Foundation }; export * from
&#39;../../foundation.core.plugin&#39;; export * from
&#39;../../foundation.core.utils&#39;;</p>
</main>
