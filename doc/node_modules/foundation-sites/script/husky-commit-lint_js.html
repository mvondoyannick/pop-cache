...
<title>husky-commit-lint.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/script/husky-commit-lint.js">

<p>const chalk = require(&#39;chalk&#39;) const spawn =
require(&#39;child_process&#39;).spawn</p>

<p>const args = process.argv.splice(process.execArgv.length + 2);</p>

<p>console.log(chalk.yellow(&#39;🐶  Checking the commit message…&#39;))</p>

<p>const child = spawn(&#39;commitlint&#39;, args, { shell: true })</p>

<p>child.stdout.on(&#39;data&#39;, function (data) {</p>

<pre class="ruby"><span class="ruby-identifier">process</span>.<span class="ruby-identifier">stdout</span>.<span class="ruby-identifier">write</span>(<span class="ruby-identifier">data</span>)
</pre>

<p>})</p>

<p>child.on(&#39;error&#39;, function (err) {</p>

<pre class="ruby"><span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">chalk</span>.<span class="ruby-identifier">red</span>(<span class="ruby-identifier">err</span>))
</pre>

<p>})</p>

<p>child.on(&#39;exit&#39;, function (code) {</p>
