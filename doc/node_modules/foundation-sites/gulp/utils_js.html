...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/utils.js">

<p>function arrayClear(array) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">array</span>.<span class="ruby-identifier">filter</span>(<span class="ruby-identifier">function</span> (<span class="ruby-identifier">v</span>) { <span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-operator">!</span><span class="ruby-identifier">v</span> });
</pre>

<p>}</p>

<pre>Return the import path/name of an UMD module for the given module format.
...
@return The found import path/name for the module.</pre>

<p>function getUmdEntry(name, config, format) {</p>
...
<pre> Generate an configuration object for Webpack Externals for UMD modules.
...
<p>module.exports.umdExternals = function(externals, options) {</p>

<pre>options = Object.assign({ namespace: &#39;&#39; }, options);
