...
<title>lint.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/lint.js">

<p>var gulp = require(&#39;gulp&#39;); var sassLint =
require(&#39;gulp-sass-lint&#39;); var eslint =
require(&#39;gulp-eslint&#39;); var CONFIG =
require(&#39;../config.js&#39;);</p>

<p>// Lints Sass and JavaScript files for formatting issues
gulp.task(&#39;lint&#39;, gulp.series(&#39;lint:sass&#39;,
&#39;lint:javascript&#39;));</p>

<p>// Lints Sass and Javascript without throwing error
gulp.task(&#39;lint:graceful&#39;,
gulp.series(&#39;lint:graceful:sass&#39;,
&#39;lint:graceful:javascript&#39;));</p>

<p>function lintSass() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">SASS_LINT_FILES</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sassLint</span>({
    <span class="ruby-value">config:</span> <span class="ruby-string">&#39;./.sass-lint.yml&#39;</span>
  }))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sassLint</span>.<span class="ruby-identifier">format</span>());
</pre>

<p>}</p>

<p>function lintJavascript() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">JS_FILES</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">eslint</span>({
    <span class="ruby-value">useEslintrc:</span> <span class="ruby-keyword">true</span>,
    <span class="ruby-value">configFile:</span> <span class="ruby-string">&#39;.eslintrc&#39;</span>
  }))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">eslint</span>.<span class="ruby-identifier">format</span>());
</pre>

<p>}</p>

<p>gulp.task(&#39;lint:sass&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">lintSass</span>()
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sassLint</span>.<span class="ruby-identifier">failOnError</span>());
</pre>

<p>}); gulp.task(&#39;lint:javascript&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">lintJavascript</span>()
.<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">eslint</span>.<span class="ruby-identifier">failAfterError</span>());
</pre>

<p>});</p>

<p>gulp.task(&#39;lint:graceful:sass&#39;, lintSass);
gulp.task(&#39;lint:graceful:javascript&#39;, lintJavascript);</p>
</main>
