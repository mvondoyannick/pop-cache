...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/test.js">

<p>var gulp = require(&#39;gulp&#39;); var browser =
require(&#39;browser-sync&#39;); var concat =
require(&#39;gulp-concat&#39;); var babel = require(&#39;gulp-babel&#39;);
var onBabelError = require(&#39;./babel-error.js&#39;); var rimraf =
require(&#39;rimraf&#39;).sync;</p>

<p>var CONFIG = require(&#39;../config.js&#39;);</p>

<p>// Runs unit tests gulp.task(&#39;test&#39;,
gulp.series(&#39;sass:foundation&#39;, &#39;test:transpile-js&#39;,
gulp.parallel(&#39;watch&#39;, &#39;test:watch&#39;)));</p>

<p>gulp.task(&#39;test:watch&#39;, function () {</p>

<pre class="ruby"><span class="ruby-identifier">browser</span>.<span class="ruby-identifier">init</span>({
  <span class="ruby-value">server:</span> {
    <span class="ruby-value">baseDir:</span> <span class="ruby-string">&#39;test/visual&#39;</span>,
    <span class="ruby-value">directory:</span> <span class="ruby-keyword">true</span>,
    <span class="ruby-value">routes:</span> {
      <span class="ruby-value">&quot;/assets&quot;:</span> <span class="ruby-string">&quot;_build/assets&quot;</span>,
      <span class="ruby-value">&quot;/motion-ui&quot;:</span> <span class="ruby-string">&quot;node_modules/motion-ui&quot;</span>
    }
  }
});
<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">watch</span>([<span class="ruby-string">&#39;test/visual   /*&#39;</span>], <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">series</span>(<span class="ruby-string">&#39;test:reload&#39;</span>));
</pre>

<p>});</p>

<p>gulp.task(&#39;test:reload&#39;, function(done) {</p>
...
<p>gulp.task(&#39;test:transpile-js&#39;,
gulp.series(&#39;javascript:foundation&#39;, &#39;javascript:deps&#39;,
function () {</p>

<pre class="ruby"><span class="ruby-identifier">rimraf</span>(<span class="ruby-string">&#39;test/javascript/js-tests.js&#39;</span>);

<span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">TEST_JS_FILES</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">babel</span>()
    .<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;error&#39;</span>, <span class="ruby-identifier">onBabelError</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">concat</span>(<span class="ruby-string">&#39;js-tests.js&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;test/javascript&#39;</span>))
</pre>
