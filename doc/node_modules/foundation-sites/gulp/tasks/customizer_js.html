...
<title>customizer.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/customizer.js">

<p>var addSrc = require(&#39;gulp-add-src&#39;); var cleancss =
require(&#39;gulp-clean-css&#39;); var customizer =
require(&#39;../../customizer/lib&#39;); var Vinyl =
require(&#39;vinyl&#39;); var fs = require(&#39;fs&#39;); var gulp =
require(&#39;gulp&#39;); var If = require(&#39;gulp-if&#39;); var path =
require(&#39;path&#39;); var Readable = require(&#39;stream&#39;).Readable;
var replace = require(&#39;gulp-replace&#39;); var rename =
require(&#39;gulp-rename&#39;); var rimraf = require(&#39;rimraf&#39;); var
sass = require(&#39;gulp-sass&#39;); var touch = require(&#39;touch&#39;);
var uglify = require(&#39;gulp-uglify&#39;); var yaml =
require(&#39;js-yaml&#39;).safeLoad; var yargs = require(&#39;yargs&#39;);
var zip = require(&#39;gulp-zip&#39;); var postcss =
require(&#39;gulp-postcss&#39;); var autoprefixer =
require(&#39;autoprefixer&#39;); var webpackStream =
require(&#39;webpack-stream&#39;); var webpack =
require(&#39;webpack&#39;);</p>

<p>var utils = require(&#39;../utils.js&#39;);</p>

<p>var ARGS = yargs.argv; var FOUNDATION_VERSION =
require(&#39;../../package.json&#39;).version; var OUTPUT_DIR = ARGS.output
|| &#39;custom-build&#39;; var CUSTOMIZER_CONFIG; var MODULE_LIST; var
VARIABLE_LIST;</p>

<p>var WEBPACK_CONFIG = {</p>
...
<p>// Load the configuration file for the customizer. It&#39;s a list of
modules to load and Sass variables to override
gulp.task(&#39;customizer:loadConfig&#39;, function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">fs</span>.<span class="ruby-identifier">readFile</span>(<span class="ruby-string">&#39;customizer/config.yml&#39;</span>, <span class="ruby-identifier">function</span>(<span class="ruby-identifier">err</span>, <span class="ruby-identifier">data</span>) {
  <span class="ruby-identifier">var</span> <span class="ruby-identifier">moduleListPath</span> = <span class="ruby-constant">ARGS</span>.<span class="ruby-identifier">modules</span> <span class="ruby-operator">||</span> <span class="ruby-string">&#39;../../customizer/complete&#39;</span>;
  <span class="ruby-identifier">var</span> <span class="ruby-identifier">moduleList</span> = <span class="ruby-identifier">require</span>(<span class="ruby-identifier">moduleListPath</span>);

  <span class="ruby-constant">CUSTOMIZER_CONFIG</span> = <span class="ruby-identifier">yaml</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">toString</span>());
  <span class="ruby-constant">MODULE_LIST</span> = <span class="ruby-identifier">moduleList</span>.<span class="ruby-identifier">modules</span>;
  <span class="ruby-constant">VARIABLE_LIST</span> = <span class="ruby-identifier">moduleList</span>.<span class="ruby-identifier">variables</span> <span class="ruby-operator">||</span> {};
...
<p>// Prepare dependencies gulp.task(&#39;customizer:prepareSassDeps&#39;,
function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>([
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/helpers/missing-dependencies&#39;</span>,
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/helpers/true&#39;</span>,
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/functions/contain&#39;</span>,
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/functions/purge&#39;</span>,
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/functions/remove&#39;</span>,
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/functions/replace&#39;</span>,
    <span class="ruby-string">&#39;node_modules/@(sassy-lists)/stylesheets/functions/to-list&#39;</span>
  ])
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_vendor&#39;</span>));
</pre>

<p>});</p>

<p>// Creates a Sass file from the module/variable list and creates
foundation.css and foundation.min.css gulp.task(&#39;customizer:sass&#39;,
gulp.series(&#39;customizer:loadConfig&#39;,
&#39;customizer:prepareSassDeps&#39;, function() {</p>

<pre>var sassFile = customizer.sass(CUSTOMIZER_CONFIG, MODULE_LIST, VARIABLE_LIST);
...
return stream
  ...
  .pipe(gulp.dest(path.join(OUTPUT_DIR, &#39;css&#39;)))</pre>

<p>}));</p>

<p>// Creates a Foundation JavaScript file from the module list, and also
copies dependencies (jQuery, what-input)
gulp.task(&#39;customizer:javascript-entry&#39;,
gulp.series(&#39;customizer:loadConfig&#39;, function() {</p>

<pre>var entryFile = customizer.js(CUSTOMIZER_CONFIG, MODULE_LIST);
// Create a stream with our entry file
var stream = createStream(&#39;foundation.js&#39;, entryFile);

return stream
  .pipe(gulp.dest(path.join(OUTPUT_DIR, &#39;js/vendor&#39;)));</pre>

<p>}));</p>

<p>gulp.task(&#39;customizer:javascript&#39;,
gulp.series(&#39;customizer:javascript-entry&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;js/vendor/foundation.js&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">webpackStream</span>(<span class="ruby-constant">WEBPACK_CONFIG</span>, <span class="ruby-identifier">webpack</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">rename</span>(<span class="ruby-string">&#39;foundation.js&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;js/vendor&#39;</span>)))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">uglify</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">rename</span>(<span class="ruby-string">&#39;foundation.min.js&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">addSrc</span>([
    <span class="ruby-string">&#39;node_modules/jquery/dist/jquery.js&#39;</span>,
    <span class="ruby-string">&#39;node_modules/what-input/dist/what-input.js&#39;</span>
  ]))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;js/vendor&#39;</span>)));
</pre>
...
<p>// Copies the boilerplate index.html to the custom download folder
gulp.task(&#39;customizer:html&#39;,
gulp.series(&#39;customizer:loadConfig&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">rtlEnabled</span> = <span class="ruby-constant">VARIABLE_LIST</span>[<span class="ruby-string">&#39;global-text-direction&#39;</span>] <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-constant">VARIABLE_LIST</span>[<span class="ruby-string">&#39;global-text-direction&#39;</span>] <span class="ruby-operator">===</span> <span class="ruby-string">&#39;rtl&#39;</span>;

<span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;customizer/index.html&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-constant">If</span>(<span class="ruby-identifier">rtlEnabled</span>, <span class="ruby-identifier">replace</span>(<span class="ruby-string">&#39;ltr&#39;</span>, <span class="ruby-string">&#39;rtl&#39;</span>)))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-constant">OUTPUT_DIR</span>));
</pre>

<p>}));</p>

<p>// Add main CSS and JS files to the build directory and create a ZIP file
from it. gulp.task(&#39;customizer:zip&#39;, function (done) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">outputFolder</span> = <span class="ruby-identifier">path</span>.<span class="ruby-identifier">dirname</span>(<span class="ruby-constant">OUTPUT_DIR</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">outputFileName</span> = <span class="ruby-identifier">path</span>.<span class="ruby-identifier">basename</span>(<span class="ruby-constant">OUTPUT_DIR</span>);

<span class="ruby-identifier">touch</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;css/app.css&#39;</span>));
<span class="ruby-identifier">touch</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;js/app.js&#39;</span>));
<span class="ruby-identifier">fs</span>.<span class="ruby-identifier">writeFileSync</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;js/app.js&#39;</span>), <span class="ruby-string">&#39;$(document).foundation()\n&#39;</span>);

<span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">join</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-string">&#39;   /*&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">zip</span>(<span class="ruby-identifier">path</span>.<span class="ruby-identifier">basename</span>(<span class="ruby-identifier">outputFileName</span>) <span class="ruby-operator">+</span> <span class="ruby-string">&#39;.zip&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-identifier">outputFolder</span>));
</pre>

<p>});</p>

<p>// Clean the build directory gulp.task(&#39;customizer:clean&#39;,
function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">rimraf</span>(<span class="ruby-constant">OUTPUT_DIR</span>, <span class="ruby-identifier">done</span>);
</pre>

<p>});</p>

<p>// Creates a custom build by: //   - Generating a CSS file //   -
Generating a JS file //   - Copying the index.html file //   - Creating a
blank app.css file //   - Creating an app.js file with Foundation
initialization code gulp.task(&#39;customizer&#39;,
gulp.series(&#39;customizer:sass&#39;, &#39;customizer:javascript&#39;,
&#39;customizer:html&#39;, &#39;customizer:zip&#39;,
&#39;customizer:clean&#39;));</p>

<p>function createStream(name, content) {</p>

<pre>// Create a stream with our entry file
