...
<title>javascript.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/javascript.js">

<p>var gulp = require(&#39;gulp&#39;); var concat =
require(&#39;gulp-concat&#39;); var webpackStream =
require(&#39;webpack-stream&#39;); var webpack =
require(&#39;webpack&#39;); var named = require(&#39;vinyl-named&#39;); var
sourcemaps = require(&#39;gulp-sourcemaps&#39;);</p>

<p>var utils = require(&#39;../utils.js&#39;); var CONFIG =
require(&#39;../config.js&#39;);</p>

<p>// —– WEBPACK CONFIGURATION —– // // The following sets up all imports from
within Foundation as externals, for the purpose // of replicating the “drop
in dist file” approach of prior versions. // THIS IS NOT RECOMMENDED FOR
MOST USERS. Chances are you either want everything // (just throw in
foundation.js or foundation.min.js) or you should be using a build //
system.</p>

<p>// // Generate the webpack “Externals” configuration for UMD modules. //
This tells webpack that the modules imported with the listed paths should
not // be included in the build but will be provided later from an external
source. // // `umdExternals` is used to generate the webpack “externals”
configuration: // an object indicating to different module tools under
which name our modules // are declared. “root” is the global variable name
to use in module-less // environments (or in the namespace if given). // //
See <a
href="https://webpack.js.org/configuration/externals/#externals">webpack.js.org/configuration/externals/#externals</a>
// var webpackExternalPlugins = Object.assign(</p>

<pre>// | Module import path             | External source names and paths
utils.umdExternals({
  &#39;jquery&#39;: { root: &#39;jQuery&#39; },
}),
utils.umdExternals({
...
<p>// The webpack “output” configuration for UMD modules. // Makes the modules
being exported as UMD modules. In module-less environments, // modules will
be stored in the global variable defined by JS_BUNDLE_NAMESPACE. var
webpackOutputAsExternal = {</p>

<pre>library: [CONFIG.JS_BUNDLE_NAMESPACE, &#39;[name]&#39;],
libraryTarget: &#39;umd&#39;,</pre>

<p>};</p>

<p>var webpackConfig = {</p>
...
<p>// Compiles JavaScript into a single file gulp.task(&#39;javascript&#39;,
gulp.series(&#39;javascript:foundation&#39;, &#39;javascript:deps&#39;,
&#39;javascript:docs&#39;));</p>

<p>// Core has to be dealt with slightly differently due to bootstrapping
externals // and the dependency on foundation.core.utils //
gulp.task(&#39;javascript:plugin-core&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;js/entries/plugins/foundation.core.js&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">named</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">init</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">webpackStream</span>(<span class="ruby-constant">Object</span>.<span class="ruby-identifier">assign</span>({}, <span class="ruby-identifier">webpackConfig</span>, {
      <span class="ruby-value">output:</span> <span class="ruby-identifier">webpackOutputAsExternal</span>,
    }), <span class="ruby-identifier">webpack</span>))
  ...
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_build/assets/js/plugins&#39;</span>));
</pre>

<p>}); gulp.task(&#39;javascript:plugins&#39;,
gulp.series(&#39;javascript:plugin-core&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>([<span class="ruby-string">&#39;js/entries/plugins/*.js&#39;</span>, <span class="ruby-string">&#39;!js/entries/plugins/foundation.core.js&#39;</span>])
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">named</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">init</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">webpackStream</span>(<span class="ruby-constant">Object</span>.<span class="ruby-identifier">assign</span>({}, <span class="ruby-identifier">webpackConfig</span>, {
      <span class="ruby-value">externals:</span> <span class="ruby-identifier">webpackExternalPlugins</span>,
      <span class="ruby-value">output:</span> <span class="ruby-identifier">webpackOutputAsExternal</span>,
    }), <span class="ruby-identifier">webpack</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">write</span>(<span class="ruby-string">&#39;.&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_build/assets/js/plugins&#39;</span>));
...
<p>gulp.task(&#39;javascript:foundation&#39;,
gulp.series(&#39;javascript:plugins&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;js/entries/foundation.js&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">named</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">init</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">webpackStream</span>(<span class="ruby-identifier">webpackConfig</span>, <span class="ruby-identifier">webpack</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">write</span>(<span class="ruby-string">&#39;.&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_build/assets/js&#39;</span>));
</pre>

<p>}));</p>

<p>gulp.task(&#39;javascript:deps&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">JS_DEPS</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">concat</span>(<span class="ruby-string">&#39;vendor.js&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_build/assets/js&#39;</span>));
</pre>

<p>});</p>

<p>gulp.task(&#39;javascript:docs&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">JS_DOCS</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">concat</span>(<span class="ruby-string">&#39;docs.js&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_build/assets/js&#39;</span>));
</pre>
