...
<title>docs.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/docs.js">

<p>var cacheBust = require(&#39;gulp-cache-bust&#39;); var foundationDocs =
require(&#39;foundation-docs&#39;); var gulp = require(&#39;gulp&#39;); var
newer = require(&#39;gulp-newer&#39;); var panini =
require(&#39;panini&#39;); var supercollider =
require(&#39;supercollider&#39;);</p>

<p>var PANINI_CONFIG = {</p>

<pre>root: &#39;docs/pages/&#39;,
layouts: &#39;docs/layout/&#39;,
partials: [&#39;docs/partials/&#39;, &#39;node_modules/foundation-docs/templates/partials/&#39;],
helpers: foundationDocs.handlebarsHelpers,</pre>

<p>}</p>

<p>var SEARCH_SORT_ORDER = [&#39;page&#39;, &#39;component&#39;, &#39;sass
variable&#39;, &#39;sass mixin&#39;, &#39;sass function&#39;, &#39;js
class&#39;, &#39;js function&#39;, &#39;js plugin option&#39;, &#39;js
event&#39;];</p>

<p>var SEARCH_PAGE_TYPES = {</p>

<pre>&#39;library&#39;: function(item) {
  return !!(item.library);
}</pre>
...
<p>// Build the search entries gulp.task(&#39;docs:search&#39;, function
(done) {</p>

<pre class="ruby"><span class="ruby-identifier">supercollider</span>.<span class="ruby-identifier">buildSearch</span>(<span class="ruby-string">&#39;_build/data/search.json&#39;</span>, <span class="ruby-identifier">done</span>);
</pre>

<p>});</p>

<p>// Assembles the modified layout, pages, and partials in the docs folder
gulp.task(&#39;docs:pages&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;docs/pages   /*&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">newer</span>({
    <span class="ruby-value">dest:</span> <span class="ruby-string">&#39;_build&#39;</span>,
    <span class="ruby-value">ext:</span> <span class="ruby-string">&#39;.html&#39;</span>
  }))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">supercollider</span>.<span class="ruby-identifier">init</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">panini</span>(<span class="ruby-constant">PANINI_CONFIG</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">cacheBust</span>({
    <span class="ruby-value">basePath:</span> <span class="ruby-string">&#39;_build/&#39;</span>
  }))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;_build&#39;</span>));
</pre>

<p>});</p>

<p>// Assembles layout, pages, and partials in the docs folder, even if not
modified gulp.task(&#39;docs:pages:all&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">panini</span>.<span class="ruby-identifier">refresh</span>();

<span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;docs/pages/   *&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">supercollider</span>.<span class="ruby-identifier">init</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">panini</span>(<span class="ruby-constant">PANINI_CONFIG</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">cacheBust</span>({
    <span class="ruby-value">basePath:</span> <span class="ruby-string">&#39;_build/&#39;</span>
...
<p>gulp.task(&#39;docs:debug&#39;, gulp.series(&#39;docs:all&#39;,
function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">output</span> = <span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>(<span class="ruby-identifier">supercollider</span>.<span class="ruby-identifier">tree</span>, <span class="ruby-identifier">null</span>, <span class="ruby-string">&#39;  &#39;</span>);
<span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;fs&#39;</span>).<span class="ruby-identifier">writeFile</span>(<span class="ruby-string">&#39;./_debug.json&#39;</span>, <span class="ruby-identifier">output</span>, <span class="ruby-identifier">done</span>);
</pre>

<p>}));</p>

<p>gulp.task(&#39;docs&#39;, gulp.series(&#39;docs:pages&#39;,
&#39;docs:search&#39;)); gulp.task(&#39;docs:all&#39;,
gulp.series(&#39;docs:pages:all&#39;, &#39;docs:search&#39;));</p>
</main>
