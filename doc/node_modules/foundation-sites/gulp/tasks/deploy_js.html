...
<title>deploy.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/deploy.js">

<p>var gulp = require(&#39;gulp&#39;); var filter =
require(&#39;gulp-filter&#39;); var cleancss =
require(&#39;gulp-clean-css&#39;); var rename =
require(&#39;gulp-rename&#39;); var uglify =
require(&#39;gulp-uglify&#39;); var confirm =
require(&#39;gulp-prompt&#39;).confirm; var rsync =
require(&#39;gulp-rsync&#39;); var replace =
require(&#39;gulp-replace&#39;); var octophant =
require(&#39;octophant&#39;); var inquirer = require(&#39;inquirer&#39;);
var exec = require(&#39;child_process&#39;).execSync; var plumber =
require(&#39;gulp-plumber&#39;); var sourcemaps =
require(&#39;gulp-sourcemaps&#39;); var rollup = require(&#39;rollup&#39;);</p>

<p>var ROLLUP_CONFIG = require(&#39;../../rollup.config.js&#39;); var CONFIG =
require(&#39;../config.js&#39;); var CURRENT_VERSION =
require(&#39;../../package.json&#39;).version; var NEXT_VERSION;</p>

<p>gulp.task(&#39;deploy&#39;, gulp.series(&#39;deploy:prompt&#39;,
&#39;deploy:version&#39;, &#39;deploy:dist&#39;, &#39;deploy:plugins&#39;,
&#39;deploy:settings&#39;, &#39;deploy:commit&#39;,
&#39;deploy:templates&#39;));</p>

<p>gulp.task(&#39;deploy:prep&#39;, gulp.series(&#39;deploy:prompt&#39;,
&#39;deploy:version&#39;, &#39;deploy:dist&#39;, &#39;deploy:plugins&#39;,
&#39;deploy:settings&#39;)); gulp.task(&#39;deploy:dist&#39;,
gulp.series(&#39;sass:foundation&#39;, &#39;javascript:foundation&#39;,
&#39;deploy:dist:files&#39;, &#39;deploy:dist:bundles&#39;));
gulp.task(&#39;deploy:plugins&#39;,
gulp.series(&#39;deploy:plugins:sources&#39;,
&#39;deploy:plugins:sourcemaps&#39;));</p>

<p>gulp.task(&#39;deploy:prompt&#39;, function(cb) {</p>

<pre class="ruby"><span class="ruby-identifier">inquirer</span>.<span class="ruby-identifier">prompt</span>([{
  <span class="ruby-value">type:</span> <span class="ruby-string">&#39;input&#39;</span>,
  <span class="ruby-value">name:</span> <span class="ruby-string">&#39;version&#39;</span>,
  <span class="ruby-value">message:</span> <span class="ruby-string">&#39;What version are we moving to? (Current version is &#39;</span> <span class="ruby-operator">+</span> <span class="ruby-constant">CURRENT_VERSION</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;)&#39;</span>
}])
.<span class="ruby-identifier">then</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">res</span>) {
  <span class="ruby-constant">NEXT_VERSION</span> = <span class="ruby-identifier">res</span>.<span class="ruby-identifier">version</span>;
...
<p>// Bumps the version number in any file that has one
gulp.task(&#39;deploy:version&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">VERSIONED_FILES</span>, { <span class="ruby-value">base:</span> <span class="ruby-identifier">process</span>.<span class="ruby-identifier">cwd</span>() })
.<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">replace</span>(<span class="ruby-constant">CURRENT_VERSION</span>, <span class="ruby-constant">NEXT_VERSION</span>))
...
<p>// Generates compiled CSS and JS files and sourcemaps and puts them in the
dist/ folder gulp.task(&#39;deploy:dist:files&#39;, function() {</p>

<pre>var cssFilter = filter([&#39;**  .css&#39;], { restore: true });
...
return gulp.src(CONFIG.DIST_FILES)
  ...
  .pipe(tsFilter)
    .pipe(gulp.dest(&#39;./dist/js&#39;))
    .pipe(tsFilter.restore);</pre>

<p>});</p>

<p>// // Generates JS bundles and puts them in the dist/ folder. // // In
addition to the UMD bundle coming from the build task, the following //
formats are generated: CJS, ESM, ES6. // See “rollup.config.js” for more
information. // gulp.task(&#39;deploy:dist:bundles&#39;, gulp.series(</p>

<pre>// Create a subtask for each Rollup config
...
<p>// Copies standalone JavaScript plugins to dist/ folder
gulp.task(&#39;deploy:plugins:sources&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;_build/assets/js/plugins/*.js&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;dist/js/plugins&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">init</span>({ <span class="ruby-value">loadMaps:</span> <span class="ruby-keyword">true</span> }))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">rename</span>({ <span class="ruby-value">suffix:</span> <span class="ruby-string">&#39;.min&#39;</span> }))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">uglify</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">sourcemaps</span>.<span class="ruby-identifier">write</span>(<span class="ruby-string">&#39;.&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;dist/js/plugins&#39;</span>));
</pre>

<p>});</p>

<p>// Copies standalone JavaScript plugins sourcemaps to dist/ folder
gulp.task(&#39;deploy:plugins:sourcemaps&#39;, function () {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;_build/assets/js/plugins/*.js.map&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;dist/js/plugins&#39;</span>));
</pre>

<p>});</p>

<p>// Generates a settings file gulp.task(&#39;deploy:settings&#39;,
function(done) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">options</span> = {
  <span class="ruby-value">title:</span> <span class="ruby-string">&#39;Foundation for Sites Settings&#39;</span>,
  <span class="ruby-value">output:</span> <span class="ruby-string">&#39;./scss/settings/_settings.scss&#39;</span>,
  <span class="ruby-value">groups:</span> {
    <span class="ruby-value">&#39;grid&#39;:</span> <span class="ruby-string">&#39;The Grid&#39;</span>,
    <span class="ruby-value">&#39;off-canvas&#39;:</span> <span class="ruby-string">&#39;Off-canvas&#39;</span>,
    <span class="ruby-value">&#39;typography-base&#39;:</span> <span class="ruby-string">&#39;Base Typography&#39;</span>
  },
  <span class="ruby-value">sort:</span> [
    <span class="ruby-string">&#39;global&#39;</span>,
    <span class="ruby-string">&#39;breakpoints&#39;</span>,
    <span class="ruby-string">&#39;grid&#39;</span>,
    <span class="ruby-string">&#39;typography-base&#39;</span>,
    <span class="ruby-string">&#39;typography-helpers&#39;</span>
  ],
  <span class="ruby-value">imports:</span> [<span class="ruby-string">&#39;util/util&#39;</span>],
  <span class="ruby-value">_foundationShim:</span> <span class="ruby-keyword">true</span>
}

<span class="ruby-identifier">octophant</span>(<span class="ruby-string">&#39;./scss&#39;</span>, <span class="ruby-identifier">options</span>, <span class="ruby-identifier">done</span>);
</pre>

<p>});</p>

<p>// Writes a commit with the changes to the version numbers
gulp.task(&#39;deploy:commit&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;git commit -am &quot;Bump to version &quot;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-constant">NEXT_VERSION</span>);
<span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;git tag v&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-constant">NEXT_VERSION</span>);
<span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;git push origin develop --follow-tags&#39;</span>);
</pre>

<p>});</p>

<p>// Uploads the documentation to the live server
gulp.task(&#39;deploy:docs&#39;, gulp.series(&#39;build&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;./_build/**&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">confirm</span>(<span class="ruby-string">&#39;Make sure everything looks right before you deploy.&#39;</span>))
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">rsync</span>({
    <span class="ruby-value">root:</span> <span class="ruby-string">&#39;./_build&#39;</span>,
    <span class="ruby-value">hostname:</span> <span class="ruby-string">&#39;deployer@72.32.134.77&#39;</span>,
    <span class="ruby-value">destination:</span> <span class="ruby-string">&#39;/home/deployer/sites/foundation-sites-6-docs&#39;</span>
  }));
</pre>

<p>}));</p>

<p>// Uploads the documentation to the live server in beta env
gulp.task(&#39;deploy:beta&#39;, gulp.series(&#39;build&#39;, function() {</p>
...
<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;./_build/**&#39;</span>)
  ...
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">rsync</span>({
    <span class="ruby-value">root:</span> <span class="ruby-string">&#39;./_build&#39;</span>,
    <span class="ruby-value">hostname:</span> <span class="ruby-string">&#39;deployer@72.32.134.77&#39;</span>,
    <span class="ruby-value">destination:</span> <span class="ruby-string">&#39;/home/deployer/sites/scalingsexiness/foundation-sites-6-docs&#39;</span>
  }));
</pre>

<p>}));</p>

<p>// This part of the deploy process hasn&#39;t been tested! It should be
done manually for now gulp.task(&#39;deploy:templates&#39;, function(done)
{</p>

<pre>// exec(&#39;git clone https://github.com/zurb/foundation-sites-template&#39;);
...
<p>// The Customizer runs this function to generate files it needs
gulp.task(&#39;deploy:custom&#39;, gulp.series(&#39;sass:foundation&#39;,
&#39;javascript:foundation&#39;, gulp.parallel(</p>
