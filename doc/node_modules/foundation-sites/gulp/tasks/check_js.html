...
<title>check.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/check.js">

<p>&#39;use strict&#39;;</p>

<p>var gulp = require(&#39;gulp&#39;); var checkDeps =
require(&#39;gulp-check-deps&#39;); var postcss =
require(&#39;gulp-postcss&#39;); var doiuse = require(&#39;doiuse&#39;);
var CONFIG = require(&#39;../config.js&#39;);</p>

<p>gulp.task(&#39;check&#39;, gulp.series(&#39;check:deps&#39;,
&#39;check:browserSupport&#39;));</p>

<p>// Check npm dependencies gulp.task(&#39;check:deps&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;package.json&#39;</span>).<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">checkDeps</span>());
</pre>

<p>});</p>

<p>// Check browser support gulp.task(&#39;check:browserSupport&#39;,
function() {</p>

<pre>return gulp.src([&#39;_build/assets/css/foundation.css&#39;])
  .pipe(postcss([doiuse({
