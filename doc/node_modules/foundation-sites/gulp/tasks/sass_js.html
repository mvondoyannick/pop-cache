...
<title>sass.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/gulp/tasks/sass.js">

<p>&#39;use strict&#39;;</p>

<p>var fs = require(&#39;fs&#39;); var gulp = require(&#39;gulp&#39;); var
Parker = require(&#39;parker/lib/Parker&#39;); var prettyJSON =
require(&#39;prettyjson&#39;); var sass = require(&#39;gulp-sass&#39;); var
plumber = require(&#39;gulp-plumber&#39;); var sourcemaps =
require(&#39;gulp-sourcemaps&#39;); var sassLint =
require(&#39;gulp-sass-lint&#39;); var postcss =
require(&#39;gulp-postcss&#39;); var autoprefixer =
require(&#39;autoprefixer&#39;);</p>

<p>var CONFIG = require(&#39;../config.js&#39;);</p>

<p>// Compiles Sass files into CSS gulp.task(&#39;sass&#39;,
gulp.series(&#39;sass:foundation&#39;, &#39;sass:docs&#39;));</p>

<p>// Prepare dependencies gulp.task(&#39;sass:deps&#39;, function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-constant">CONFIG</span>.<span class="ruby-constant">SASS_DEPS_FILES</span>)
...
<p>// Compiles Foundation Sass gulp.task(&#39;sass:foundation&#39;,
gulp.series(&#39;sass:deps&#39;, function() {</p>

<pre>return gulp.src([&#39;assets/*&#39;])
  .pipe(sourcemaps.init())
  .pipe(plumber())
  .pipe(sass().on(&#39;error&#39;, sass.logError))
  .pipe(postcss([autoprefixer()])) // uses &quot;.browserslistrc&quot;
  .pipe(sourcemaps.write(&#39;.&#39;))
  .pipe(gulp.dest(&#39;_build/assets/css&#39;));</pre>

<p>}));</p>

<p>// Compiles docs Sass (includes Foundation code also)
gulp.task(&#39;sass:docs&#39;, gulp.series(&#39;sass:deps&#39;, function()
{</p>

<pre>return gulp.src(&#39;docs/assets/scss/docs.scss&#39;)
  .pipe(sourcemaps.init())
  .pipe(sass({
...
<p>// Audits CSS filesize, selector count, specificity, etc.
gulp.task(&#39;sass:audit&#39;, gulp.series(&#39;sass:foundation&#39;,
function(done) {</p>

<pre>fs.readFile(&#39;./_build/assets/css/foundation.css&#39;, function(err, data) {
