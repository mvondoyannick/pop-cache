...
<title>_purge.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/functions/_purge.scss">

<p>/// Removes all false and null values from `$list`. /// /// @ignore
Documentation: <a
href="http://at-import.github.io/SassyLists/documentation/#function-sl-purge">at-import.github.io/SassyLists/documentation/#function-sl-purge</a>
/// /// @requires sl-is-true /// @requires sl-to-list /// /// @param {List}
$list - list to purge /// /// @example /// sl-purge(null a false b) /// //
a b /// /// @return {List} ///</p>

<p>@function sl-purge($list) {</p>

<pre>$_: sl-missing-dependencies(&#39;sl-is-true&#39;, &#39;sl-to-list&#39;);
...
@return sl-to-list($result);</pre>

<p>}</p>

<p>/// /// @requires sl-purge /// @alias sl-purge ///</p>

<p>@function sl-clean($list) {</p>

<pre>@return sl-purge($list);</pre>
