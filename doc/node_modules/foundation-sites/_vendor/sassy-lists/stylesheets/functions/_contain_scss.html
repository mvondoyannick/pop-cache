...
<title>_contain.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/functions/_contain.scss">

<p>/// /// Returns whether `$list` contains `$value`. /// /// @ignore
Documentation: <a
href="http://at-import.github.io/SassyLists/documentation/#function-sl-contain">at-import.github.io/SassyLists/documentation/#function-sl-contain</a>
/// /// @param {List}    $list  - list to check /// @param {*}       $value
- value to look for /// /// @example /// sl-contain(a b c, a) /// // true
/// /// @example /// sl-contain(a b c, z) /// // false /// /// @return
{Bool} ///</p>

<p>@function sl-contain($list, $value) {</p>

<pre>@return not not index($list, $value);</pre>

<p>}</p>

<p>/// /// @requires sl-contain /// @alias sl-contain ///</p>

<p>@function sl-include($list, $value) {</p>

<pre>@return sl-contain($list, $value);</pre>
