...
<title>_replace.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/functions/_replace.scss">

<p>/// /// Replaces `$old` by `$new` in `$list`. /// /// @ignore
Documentation: <a
href="http://at-import.github.io/SassyLists/documentation/#function-sl-replace">at-import.github.io/SassyLists/documentation/#function-sl-replace</a>
/// /// @requires sl-is-true /// @requires sl-purge /// @requires
sl-to-list /// /// @param {List}    $list  - list to update /// @param {*} 
$old   - value to replace /// @param {*}       $value - new value for $old
/// /// @example /// sl-replace(a b c, b, z) /// // a z c /// /// @example
/// sl-replace(a b c, y, z) /// // a b c ///  /// @return {List} ///</p>

<p>@function sl-replace($list, $old, $value) {</p>

<pre>$_: sl-missing-dependencies(&#39;sl-is-true&#39;, &#39;sl-purge&#39;, &#39;sl-to-list&#39;);
