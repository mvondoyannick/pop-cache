...
<title>_to-list.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/functions/_to-list.scss">

<p>/// /// Casts `$value` into a list. /// /// @ignore Documentation: <a
href="http://at-import.github.io/SassyLists/documentation/#function-sl-to-list">at-import.github.io/SassyLists/documentation/#function-sl-to-list</a>
/// /// @param {*} $value - value to cast to list /// @param {String}
$separator [space] - separator to use /// /// @example /// sl-to-list(a b
c, comma) /// // a, b, c ///  /// @return {List} ///</p>

<p>@function sl-to-list($value, $separator: list-separator($value)) {</p>

<pre>@return join((), $value, $separator);</pre>

<p>}</p>

<p>/// /// @requires sl-to-list /// @alias sl-to-list ///</p>

<p>@function sl-listify($value) {</p>

<pre>@return sl-to-list($value);</pre>
