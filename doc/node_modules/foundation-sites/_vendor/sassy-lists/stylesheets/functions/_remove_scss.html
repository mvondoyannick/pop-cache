...
<title>_remove.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/functions/_remove.scss">

<p>/// /// Removes value(s) `$value` from `$list`. /// /// @ignore
Documentation: <a
href="http://at-import.github.io/SassyLists/documentation/#function-sl-remove">at-import.github.io/SassyLists/documentation/#function-sl-remove</a>
/// /// @requires sl-replace /// /// @param {List}    $list      - list to
update /// @param {*}       $value     - value to remove /// /// @example
/// sl-remove(a b c, a) /// // b c /// /// @return {List} ///</p>

<p>@function sl-remove($list, $value) {</p>

<pre>$_: sl-missing-dependencies(&#39;sl-replace&#39;);

@return sl-replace($list, $value, null);</pre>

<p>}</p>

<p>/// /// @requires sl-remove /// @alias sl-remove ///</p>

<p>@function sl-without($list, $value) {</p>

<pre>@return sl-remove($list, $value);</pre>
