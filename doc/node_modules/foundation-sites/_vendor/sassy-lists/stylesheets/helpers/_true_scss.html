...
<title>_true.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/helpers/_true.scss">

<p>/// /// Returns truthiness of `$value`. /// /// @access private /// ///
@param {*} $value - value to check /// /// @return {Bool} ///</p>

<p>@function sl-is-true($value) {</p>

<pre>@return if($value == null, false, $value and $value != null and $value != &#39;&#39; and $value != ());</pre>
