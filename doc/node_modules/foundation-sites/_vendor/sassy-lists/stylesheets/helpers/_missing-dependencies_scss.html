...
<title>_missing-dependencies.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/_vendor/sassy-lists/stylesheets/helpers/_missing-dependencies.scss">

<p>/// /// Checks whether `$functions` exist in global scope. /// /// @access
private /// /// @param {ArgList} $functions - list of functions to check
for /// /// @return {Bool} Whether or not there are missing dependencies
///</p>

<p>@function sl-missing-dependencies($functions…) {</p>

<pre>$missing-dependencies: ();
...
@return length($missing-dependencies) &gt; 0;</pre>
