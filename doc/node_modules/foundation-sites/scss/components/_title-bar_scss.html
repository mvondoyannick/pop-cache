...
<title>_title-bar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_title-bar.scss">
...
<p>/// Background color of a title bar. /// @type Color $titlebar-background:
$black !default;</p>

<p>/// Color of text inside a title bar. /// @type Color $titlebar-color:
$white !default;</p>

<p>/// Padding inside a title bar. /// @type Length $titlebar-padding: 0.5rem
!default;</p>

<p>/// Font weight of text inside a title bar. /// @type Weight
$titlebar-text-font-weight: bold !default;</p>

<p>/// Color of menu icons inside a title bar. /// @type Color
$titlebar-icon-color: $white !default;</p>

<p>/// Color of menu icons inside a title bar on hover. /// @type Color
$titlebar-icon-color-hover: $medium-gray !default;</p>

<p>/// Spacing between the menu icon and text inside a title bar. /// @type
Length $titlebar-icon-spacing: 0.25rem !default;</p>

<p>@mixin foundation-title-bar {</p>
