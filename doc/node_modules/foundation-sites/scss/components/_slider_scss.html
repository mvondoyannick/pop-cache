...
<title>_slider.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_slider.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>// [TODO] Check how plugin confirms disabled or vertical status // [TODO]
Check if transition: all; is necessary</p>

<p>//// /// @group slider ////</p>

<p>/// Default slider width of a vertical slider. (Doesn&#39;t apply to the
native slider.) /// @type Number $slider-width-vertical: 0.5rem !default;</p>

<p>/// Transition properties to apply to the slider handle and fill.
(Doesn&#39;t apply to the native slider.) /// @type Transition
$slider-transition: all 0.2s ease-in-out !default;</p>

<p>/// Adds the general styles for sliders. @mixin slider-container {</p>
...
<p>/// Adds the general styles for active fill for sliders. @mixin slider-fill
{</p>
...
<p>/// Adds the general styles for the slider handles. @mixin slider-handle {</p>
...
<p>@mixin slider-disabled {</p>

<pre>opacity: $slider-opacity-disabled;
cursor: not-allowed;</pre>

<p>}</p>

<p>@mixin slider-vertical {</p>
