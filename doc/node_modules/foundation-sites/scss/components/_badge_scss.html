...
<title>_badge.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_badge.scss">
...
<p>/// Default background color for badges. /// @type Color $badge-background:
$primary-color !default;</p>

<p>/// Default text color for badges. /// @type Color $badge-color: $white
!default;</p>

<p>/// Alternate text color for badges. /// @type Color $badge-color-alt:
$black !default;</p>

<p>/// Coloring classes. A map of classes to output in your CSS, like
`.secondary`, `.success`, and so on. /// @type Map $badge-palette:
$foundation-palette !default;</p>

<p>/// Default padding inside badges. /// @type Number $badge-padding: 0.3em
!default;</p>

<p>/// Minimum width of a badge. /// @type Number $badge-minwidth: 2.1em
!default;</p>

<p>/// Default font size for badges. /// @type Number $badge-font-size: 0.6rem
!default;</p>

<p>/// Generates the base styles for a badge. @mixin badge {</p>
