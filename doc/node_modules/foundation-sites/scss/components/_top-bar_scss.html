...
<title>_top-bar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_top-bar.scss">
...
<p>/// Padding for the top bar. /// @type Number $topbar-padding: 0.5rem
!default;</p>

<p>/// Background color for the top bar. This color also cascades to menus
within the top bar. /// @type Color $topbar-background: $light-gray
!default;</p>

<p>/// Background color submenus within the top bar. Usefull if
$topbar-background is transparent. /// @type Color
$topbar-submenu-background: $topbar-background !default;</p>

<p>/// Spacing for the top bar title. /// @type Number $topbar-title-spacing:
0.5rem 1rem 0.5rem 0 !default;</p>

<p>/// Maximum width of `&lt;input&gt;` elements inside the top bar. /// @type
Number $topbar-input-width: 200px !default;</p>

<p>/// Breakpoint at which top bar switches from mobile to desktop view. ///
@type Breakpoint $topbar-unstack-breakpoint: medium !default;</p>

<p>/// Adds styles for a top bar container. @mixin top-bar-container {</p>
...
<p>/// Makes sections of a top bar stack on top of each other. @mixin
top-bar-stacked {</p>
...
<p>/// Undoes the CSS applied by the `top-bar-stacked()` mixin. @mixin
top-bar-unstack {</p>
