...
<title>_callout.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_callout.scss">
...
<p>/// Default background color. /// @type Color $callout-background: $white
!default;</p>

<p>/// Default fade value for callout backgrounds. /// @type Number
$callout-background-fade: 85% !default;</p>

<p>/// Default border style for callouts. /// @type List $callout-border: 1px
solid rgba($black, 0.25) !default;</p>

<p>/// Default bottom margin for callouts. /// @type Number $callout-margin: 0
0 1rem 0 !default;</p>

<p>/// Default inner padding for callouts. /// @type Number $callout-padding:
1rem !default;</p>

<p>/// Default font color for callouts. /// @type Color $callout-font-color:
$body-font-color !default;</p>

<p>/// Default font color for callouts, if the callout has a dark background.
/// @type Color $callout-font-color-alt: $body-background !default;</p>

<p>/// Default border radius for callouts. /// @type Color $callout-radius:
$global-radius !default;</p>

<p>/// Amount to tint links used within colored panels. Set to `false` to
disable this feature. /// @type Number | Boolean $callout-link-tint: 30%
!default;</p>

<p>/// Adds basic styles for a callout, including padding and margin. @mixin
callout-base() {</p>
...
<p>/// Generate quick styles for a callout using a single color as a baseline.
/// @param {Color} $color [$callout-background] - Color to use. @mixin
callout-style($color: $callout-background) {</p>

<pre>$background: scale-color($color, $lightness: $callout-background-fade);

background-color: $background;
color: color-pick-contrast($background, ($callout-font-color, $callout-font-color-alt));</pre>

<p>}</p>

<p>@mixin callout-size($padding) {</p>

<pre>padding-top: $padding;
padding-right: $padding;
padding-bottom: $padding;
padding-left: $padding;</pre>

<p>}</p>

<p>/// Adds styles for a callout. /// @param {Color} $color
[$callout-background] - Color to use. @mixin callout($color:
$callout-background) {</p>

<pre>@include callout-base;
@include callout-style($color);</pre>

<p>}</p>

<p>@mixin foundation-callout {</p>
