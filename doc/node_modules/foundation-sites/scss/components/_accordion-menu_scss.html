...
<title>_accordion-menu.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_accordion-menu.scss">

<p>//// /// @group accordion-menu ////</p>

<p>/// Sets accordion menu padding. /// @type Number $accordionmenu-padding:
$global-menu-padding !default;</p>

<p>/// Sets accordion menu nested margin /// @type Number
$accordionmenu-nested-margin: $global-menu-nested-margin !default;</p>

<p>/// Sets accordion menu submenu padding. /// @type Number
$accordionmenu-submenu-padding: $accordionmenu-padding !default;</p>

<p>/// Sets if accordion menus have the default arrow styles. /// @type
Boolean $accordionmenu-arrows: true !default;</p>

<p>/// Sets accordion menu arrow color if arrow is used. /// @type Color
$accordionmenu-arrow-color: $primary-color !default;</p>

<p>/// Sets accordion menu item padding. /// @type Color
$accordionmenu-item-background: null !default;</p>

<p>/// Sets accordion menu item border. /// @type Color $accordionmenu-border:
null !default;</p>

<p>/// Sets accordion menu item padding. /// @type Color
$accordionmenu-submenu-toggle-background: null !default;</p>

<p>/// Sets accordion menu item padding. /// @type List
$accordion-submenu-toggle-border: $accordionmenu-border !default;</p>

<p>/// Sets accordion menu submenu toggle background width. /// @type Number
$accordionmenu-submenu-toggle-width: 40px !default;</p>

<p>/// Sets accordion menu submenu toggle background height. /// @type Number
$accordionmenu-submenu-toggle-height: $accordionmenu-submenu-toggle-width
!default;</p>

<p>/// Sets accordion menu arrow size if arrow is used. /// @type Length
$accordionmenu-arrow-size: 6px !default;</p>

<p>@mixin zf-accordion-menu-left-right-arrows {</p>

<pre>.is-accordion-submenu-parent:not(.has-submenu-toggle) &gt; a {
  position: relative;
...
<p>} @mixin foundation-accordion-menu {</p>
