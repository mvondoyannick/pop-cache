...
<title>_progress-bar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_progress-bar.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>/// Adds styles for a progress bar container. @mixin progress-container {</p>

<pre>height: $progress-height;
margin-bottom: $progress-margin-bottom;
border-radius: $progress-radius;
background-color: $progress-background;</pre>

<p>}</p>

<p>/// Adds styles for the inner meter of a progress bar. @mixin
progress-meter {</p>
...
<p>/// Adds styles for text in the progress meter. @mixin progress-meter-text
{</p>

<pre>@include absolute-center;
margin: 0;
font-size: 0.75rem;
font-weight: bold;
color: $white;
...
<p>@mixin foundation-progress-bar {</p>
