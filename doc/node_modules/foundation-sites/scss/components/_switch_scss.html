...
<title>_switch.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_switch.scss">
...
<p>/// Background color of a switch. /// @type Color $switch-background:
$medium-gray !default;</p>

<p>/// Background active color of a switch. /// @type Color
$switch-background-active: $primary-color !default;</p>

<p>/// Height of a switch, with no class applied. /// @type Number
$switch-height: 2rem !default;</p>

<p>/// Height of a switch with .tiny class. /// @type Number
$switch-height-tiny: 1.5rem !default;</p>

<p>/// Height of a switch with .small class. /// @type Number
$switch-height-small: 1.75rem !default;</p>

<p>/// Height of a switch with .large class. /// @type Number
$switch-height-large: 2.5rem !default;</p>

<p>/// Border radius of the switch /// @type Number $switch-radius:
$global-radius !default;</p>

<p>/// border around a modal. /// @type Number $switch-margin: $global-margin
!default;</p>

<p>/// Background color for the switch container and paddle. /// @type Color
$switch-paddle-background: $white !default;</p>

<p>/// Spacing between a switch paddle and the edge of the body. /// @type
Number $switch-paddle-offset: 0.25rem !default;</p>

<p>/// border radius of the switch paddle /// @type Number
$switch-paddle-radius: $global-radius !default;</p>

<p>/// switch transition. /// @type Number $switch-paddle-transition: all
0.25s ease-out !default;</p>

<p>// make them variables // ask about accessibility on label // change class
name for text</p>

<p>/// Adds styles for a switch container. Apply this to a container class.
@mixin switch-container {</p>
...
<p>/// Adds styles for a switch input. Apply this to an `&lt;input&gt;` within
a switch. @mixin switch-input {</p>
...
<p>/// Adds styles for the background and paddle of a switch. Apply this to a
`&lt;label&gt;` within a switch. @mixin switch-paddle {</p>

<pre>$switch-width: $switch-height * 2;
...
<p>/// Adds base styles for active/inactive text inside a switch. Apply this
to text elements inside the switch `&lt;label&gt;`. @mixin switch-text {</p>
...
<p>/// Adds styles for the active state text within a switch. @mixin
switch-text-active {</p>
...
<p>/// Adds styles for the inactive state text within a switch. @mixin
switch-text-inactive {</p>
...
<p>/// Changes the size of a switch by modifying the size of the body and
paddle. Apply this to a switch container. /// @param {Number} $font-size
[1rem] - Font size of label text within the switch. /// @param {Number}
$switch-height [2rem] - Height of the switch body. /// @param {Number}
$paddle-offset [0.25rem] - Spacing between the switch paddle and the edge
of the switch body. @mixin switch-size(</p>

<pre>$font-size: 1rem,
$switch-height: 2rem,
$paddle-offset: 0.25rem</pre>
