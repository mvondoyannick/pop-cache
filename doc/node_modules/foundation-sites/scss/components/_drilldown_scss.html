...
<title>_drilldown.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_drilldown.scss">
...
<p>/// Transition property to use for animating menus. /// @type Transition
$drilldown-transition: transform 0.15s linear !default;</p>

<p>/// Adds arrows to drilldown items with submenus, as well as the back
button. /// @type Boolean $drilldown-arrows: true !default;</p>

<p>/// Sets drilldown menu item padding. /// @type Number $drilldown-padding:
$global-menu-padding !default;</p>

<p>/// Sets drilldown menu nested margin /// @type Number
$drilldown-nested-margin: 0 !default;</p>

<p>/// Background color for drilldown top level items. /// @type Color
$drilldown-background: $white !default;</p>

<p>/// Sets drilldown menu item padding in the submenu. /// @type Number
$drilldown-submenu-padding: $drilldown-padding !default;</p>

<p>/// Background color for drilldown submenus. /// @type Color
$drilldown-submenu-background: $white !default;</p>

<p>/// Sets drilldown arrow color if arrow is used. /// @type Color
$drilldown-arrow-color: $primary-color !default;</p>

<p>/// Sets drilldown arrow size if arrow is used. /// @type Length
$drilldown-arrow-size: 6px !default;</p>

<p>@mixin zf-drilldown-left-right-arrows {</p>

<pre>.is-drilldown-submenu-parent &gt; a {
  position: relative;
...
<p>@mixin foundation-drilldown-menu {</p>

<pre>// Applied to the Menu container
.is-drilldown {
  position: relative;
  overflow: hidden;
