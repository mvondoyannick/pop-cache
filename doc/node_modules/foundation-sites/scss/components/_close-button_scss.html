...
<title>_close-button.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_close-button.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group close-button ////</p>

<p>/// Default position of the close button. The first value should be `right`
or `left`, and the second value should be `top` or `bottom`. /// @type List
$closebutton-position: right top !default;</p>

<p>/// Right (or left) offset(s) for a close button. /// @type Number|Map
$closebutton-offset-horizontal: (</p>
...
<p>/// Top (or bottom) offset(s) for a close button. /// @type Number|Map
$closebutton-offset-vertical: (</p>
...
<p>/// Default font size(s) of the close button. /// @type Number|Map
$closebutton-size: (</p>
...
<p>/// The line-height of the close button. It affects the spacing of the
element. /// @type Number $closebutton-lineheight: 1 !default;</p>

<p>/// Default color of the close button. /// @type Color $closebutton-color:
$dark-gray !default;</p>

<p>/// Default color of the close button when being hovered on. /// @type
Color $closebutton-color-hover: $black !default;</p>

<p>/// Get the size and position for a close button. If the input value is a
number, the number is returned. If the input value is a config map and the
map has the key `$size`, the value is returned. /// /// @param {Number|Map}
$value - A number or map that represents the size or position value(s) of
the close button. /// @param {Keyword} $size - The size of the close button
to use. /// /// @return {Number} The given number or the value found in the
map. @function -zf-get-size-val($value, $size) {</p>

<pre>// Check if the value is a number
...
<p>/// Sets the size and position of a close button. /// @param {Keyword}
...
will be used as the default size and position of the close button. @mixin
close-button-size($size) {</p>

<pre>$x: nth($closebutton-position, 1);
...
line-height: -zf-get-size-val($closebutton-lineheight, $size);</pre>

<p>}</p>

<p>/// Adds styles for a close button, using the styles in the settings
variables. @mixin close-button {</p>
...
<p>@mixin foundation-close-button {</p>
