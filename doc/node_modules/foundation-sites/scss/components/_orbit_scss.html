...
<title>_orbit.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_orbit.scss">
...
<p>/// Default color for Orbit&#39;s bullets. /// @type Color
$orbit-bullet-background: $medium-gray !default;</p>

<p>/// Default active color for Orbit&#39;s bullets. /// @type Color
$orbit-bullet-background-active: $dark-gray !default;</p>

<p>/// Default diameter for Orbit&#39;s bullets. /// @type Number
$orbit-bullet-diameter: 1.2rem !default;</p>

<p>/// Default margin between Orbit&#39;s bullets. /// @type Number
$orbit-bullet-margin: 0.1rem !default;</p>

<p>/// Default distance from slide region for Orbit&#39;s bullets. /// @type
Number $orbit-bullet-margin-top: 0.8rem !default;</p>

<p>/// Default bottom margin from Orbit&#39;s bullets to whatever content may
lurk below it. /// @type Number $orbit-bullet-margin-bottom: 0.8rem
!default;</p>

<p>/// Default background color for Orbit&#39;s caption. /// @type Color
$orbit-caption-background: rgba($black, 0.5) !default;</p>

<p>/// Default padding for Orbit&#39;s caption. /// @type Number
$orbit-caption-padding: 1rem !default;</p>

<p>/// Default background color for Orbit&#39;s controls when hovered. ///
@type Color $orbit-control-background-hover: rgba($black, 0.5) !default;</p>

<p>/// Default padding for Orbit&#39;s controls. /// @type Number
$orbit-control-padding: 1rem !default;</p>

<p>/// Default z-index for Orbit&#39;s controls. /// @type Number
$orbit-control-zindex: 10 !default;</p>

<p>/// Adds styles for the outer Orbit wrapper. These styles are used on the
`.orbit` class. @mixin orbit-wrapper {</p>

<pre>position: relative;</pre>

<p>}</p>

<p>/// Adds styles for the inner Orbit slide container. These styles are used
on the `.orbit-container` class. @mixin orbit-container {</p>
...
<p>/// Adds styles for the individual slides of an Orbit slider. These styles
are used on the `.orbit-slide` class. @mixin orbit-slide {</p>
...
<p>@mixin orbit-figure {</p>

<pre>margin: 0;</pre>

<p>}</p>

<p>/// Adds styles for a slide containing an image. These styles are used on
the `.orbit-image` class. @mixin orbit-image {</p>
...
<p>/// Adds styles for an orbit slide caption. These styles are used on the
`.orbit-caption` class. @mixin orbit-caption {</p>
...
color: color-pick-contrast($orbit-caption-background);</pre>

<p>}</p>

<p>/// Adds base styles for the next/previous buttons in an Orbit slider.
These styles are shared between the `.orbit-next` and `.orbit-previous`
classes in the default CSS. @mixin orbit-control {</p>
...
<p>/// Adds styles for the Orbit previous button. These styles are used on the
`.orbit-previous` class. @mixin orbit-previous {</p>

<pre class="ruby"><span class="ruby-comment">#{$global-left}: 0;</span>
</pre>

<p>}</p>

<p>/// Adds styles for the Orbit next button. These styles are used on the
`.orbit-next` class. @mixin orbit-next {</p>

<pre class="ruby"><span class="ruby-comment">#{$global-left}: auto;</span>
<span class="ruby-comment">#{$global-right}: 0;</span>
</pre>

<p>}</p>

<p>/// Adds styles for a container of Orbit bullets. /// Adds styles for the
Orbit previous button. These styles are used on the `.orbit-bullets` class.
@mixin orbit-bullets {</p>
