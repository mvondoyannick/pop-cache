...
<title>_card.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_card.scss">
...
<p>/// Default background color. /// @type Color $card-background: $white
!default;</p>

<p>/// Default font color for cards. /// @type Color $card-font-color:
$body-font-color !default;</p>

<p>/// Default background. /// @type Color $card-divider-background:
$light-gray !default;</p>

<p>/// Default border style. /// @type List $card-border: 1px solid
$light-gray !default;</p>

<p>/// Default card shadow. /// @type List $card-shadow: none !default;</p>

<p>/// Default border radius. /// @type List $card-border-radius:
$global-radius !default;</p>

<p>/// Default padding. /// @type Number $card-padding: $global-padding
!default;</p>

<p>/// Default bottom margin. /// @type number $card-margin-bottom:
$global-margin !default;</p>

<p>/// Adds styles for a card container. /// @param {Color} $background -
Background color of the card. /// @param {Color} $color - font color of the
card. /// @param {Number} $margin - Bottom margin of the card. /// @param
{List} $border - Border around the card. /// @param {List} $radius - border
radius of the card. /// @param {List} $shadow - box shadow of the card.
@mixin card-container(</p>

<pre>$background: $card-background,
$color: $card-font-color,
$margin: $card-margin-bottom,
$border: $card-border,
$radius: $card-border-radius,
$shadow: $card-shadow</pre>
...
<p>/// Adds styles for a card divider. @mixin card-divider(</p>

<pre>$background: $card-divider-background,
$padding: $card-padding</pre>
...
<p>/// Adds styles for a card section. @mixin card-section(</p>

<pre>$padding: $card-padding</pre>
