...
<title>_accordion.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_accordion.scss">
...
<p>/// Default background color of an accordion group. /// @type Color
$accordion-background: $white !default;</p>

<p>/// If `true`, adds plus and minus icons to the side of each accordion
title. /// @type Boolean $accordion-plusminus: true !default;</p>

<p>/// Font size of accordion titles. /// @type Number
$accordion-title-font-size: rem-calc(12) !default;</p>

<p>/// Default text color for items in a Menu. /// @type Color
$accordion-item-color: $primary-color !default;</p>

<p>/// Default background color on hover for items in a Menu. /// @type Color
$accordion-item-background-hover: $light-gray !default;</p>

<p>/// Default padding of an accordion item. /// @type Number | List
$accordion-item-padding: 1.25rem 1rem !default;</p>

<p>/// Default background color of tab content. /// @type Color
$accordion-content-background: $white !default;</p>

<p>/// Default border color of tab content. /// @type Color
$accordion-content-border: 1px solid $light-gray !default;</p>

<p>/// Default text color of tab content. /// @type Color
$accordion-content-color: $body-font-color !default;</p>

<p>/// Default padding for tab content. /// @type Number | List
$accordion-content-padding: 1rem !default;</p>

<p>/// Adds styles for an accordion container. Apply this to the same element
that gets `data-accordion`. @mixin accordion-container (</p>

<pre>$background: $accordion-background</pre>

<p>) {</p>

<pre>margin-#{$global-left}: 0;
...
<p>/// Adds styles for the accordion item. Apply this to the list item within
an accordion ul. @mixin accordion-item {</p>
...
<p>/// Adds styles for the title of an accordion item. Apply this to the link
within an accordion item. @mixin accordion-title (</p>

<pre>$padding: $accordion-item-padding,
$font-size: $accordion-title-font-size,
$color: $accordion-item-color,
$border: $accordion-content-border,
$background-hover: $accordion-item-background-hover</pre>
...
<p>/// Adds styles for accordion content. Apply this to the content pane below
an accordion item&#39;s title. @mixin accordion-content (</p>

<pre>$padding: $accordion-content-padding,
$border: $accordion-content-border,
$background: $accordion-content-background,
$color: $accordion-content-color</pre>
...
<p>@mixin foundation-accordion {</p>
