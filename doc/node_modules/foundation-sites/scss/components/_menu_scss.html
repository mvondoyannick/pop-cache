...
<title>_menu.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_menu.scss">
...
<p>/// Margin of a menu. /// @type Number $menu-margin: 0 !default;</p>

<p>/// Left-hand margin of a nested menu. /// @type Number
$menu-nested-margin: $global-menu-nested-margin !default;</p>

<p>/// Padding for items in a pill menu. /// @type Number $menu-items-padding:
$global-menu-padding !default;</p>

<p>/// margin for items in a simple menu. /// @type Number
$menu-simple-margin: 1rem !default;</p>

<p>/// Text color of an active menu item. /// @type Color
$menu-item-color-active: $white !default;</p>

<p>/// Background color of an active menu item. /// @type Color
$menu-item-background-active: get-color(primary) !default;</p>

<p>/// Spacing between an icon and text in a menu item. /// @type Number
$menu-icon-spacing: 0.25rem !default;</p>

<p>/// Backward compatibility for menu state. If true, this duplicate `active`
with `is-active`.  /// But please note that `active` will be removed in
upcoming versions. /// @type Boolean $menu-state-back-compat: true
!default;</p>

<p>/// Backward compatibility for menu centered. If true, this duplicate
`.menu-centered &gt; .menu` with `.menu.align-center`.  /// But please note
that `menu-centered` will be removed in upcoming versions. /// @type
Boolean $menu-centered-back-compat: true !default;</p>

<p>/// Backward compatibility for using `icon-*` classes without `.icons`
classes /// But please note that this backward compatibility will be
removed in upcoming versions. /// @type Boolean $menu-icons-back-compat:
true !default;</p>

<p>/// Creates the base styles for a Menu. @mixin menu-base {</p>
...
<p>/// Expands the items of a Menu, so each item is the same width. @mixin
menu-expand {</p>

<pre>@if $global-flexbox {
  li {
...
<p>/// Align menu items. @mixin menu-align($alignment) {</p>

<pre>@if $alignment == left {
  @if $global-flexbox {
...
<p>/// Sets the direction of a Menu. /// @param {Keyword} $dir [horizontal] -
Direction of the Menu. Can be `horizontal` or `vertical`. @mixin
menu-direction($dir: horizontal) {</p>

<pre>@if $dir == horizontal {
  @if $global-flexbox {
    flex-wrap: wrap;
    flex-direction: row;
  }
...
<p>/// Creates a simple Menu, which has no padding or hover state. /// @param
{Keyword} $dir [$global-left] - Direction of the menu. This effects the
side of the `&lt;li&gt;` that receives the margin. /// @param {Number}
$margin [$menu-simple-margin] - The margin to apply to each `&lt;li&gt;`.
@mixin menu-simple($dir: $global-left, $margin: $menu-simple-margin) {</p>
...
<p>/// Adds styles for a nested Menu, by adding `margin-left` to the menu. ///
@param {Keyword|Number} $margin [$menu-nested-margin] - Length of the
margin. /// @param {Keyword} $nested-alignment [left] - Alignment of the
nested class @mixin menu-nested(</p>

<pre>$margin: $menu-nested-margin,
$nested-alignment: left</pre>

<p>) {</p>

<pre>@if $nested-alignment == right {
...
<p>/// Adds basic styles for icons in menus. @mixin menu-icons() {</p>
...
<p>/// Adds position classes for icons within a menu. @mixin
menu-icon-position($position: left, $spacing: $menu-icon-spacing) {</p>
...
<pre>padding: $global-menu-padding;
...
<p>@mixin menu-state-active {</p>

<pre>background: $menu-item-background-active;
color: $menu-item-color-active;</pre>

<p>}</p>

<p>@mixin foundation-menu {</p>
