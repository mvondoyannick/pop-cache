...
<title>_dropdown-menu.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_dropdown-menu.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group dropdown-menu ////</p>

<p>/// Enables arrows for items with dropdown menus. /// @type Boolean
$dropdownmenu-arrows: true !default;</p>

<p>/// Sets dropdown menu arrow color if arrow is used. /// @type Color
$dropdownmenu-arrow-color: $anchor-color !default;</p>

<p>/// Sets dropdown menu arrow size if arrow is used. /// @type Length
$dropdownmenu-arrow-size: 6px !default;</p>

<p>/// Sets dropdown menu arrow padding for aligning the arrow correctly. ///
@type Length $dropdownmenu-arrow-padding: 1.5rem !default;</p>

<p>/// Minimum width of dropdown sub-menus. /// @type Length
$dropdownmenu-min-width: 200px !default;</p>

<p>/// Background color for top level items. /// @type Color
$dropdownmenu-background: null !default;</p>

<p>/// Background color for dropdowns. /// @type Color
$dropdownmenu-submenu-background: $white !default;</p>

<p>/// Padding for top level items. /// @type Number $dropdownmenu-padding:
$global-menu-padding !default;</p>

<p>/// Sets dropdown menu nested margin /// @type Number
$dropdownmenu-nested-margin: 0 !default;</p>

<p>/// Padding for sub-menu items. /// @type Number
$dropdownmenu-submenu-padding: $dropdownmenu-padding !default;</p>

<p>/// Border for dropdown sub-menus. /// @type List $dropdownmenu-border: 1px
solid $medium-gray !default;</p>

<p>// Border width for dropdown sub-menus. // Used to adjust top margin of a
sub-menu if a border is used. // @type Length $dropdownmenu-border-width:
nth($dropdownmenu-border, 1);</p>

<p>/// Text color of an active dropdown menu item. Explicit override for menu
defaults /// @type Color $dropdown-menu-item-color-active:
get-color(primary) !default;</p>

<p>/// Background color of an active dropdown menu item. Explicit override for
menu defaults /// @type Color $dropdown-menu-item-background-active:
transparent !default;</p>

<p>@mixin zf-dropdown-left-right-arrows {</p>
...
<p>@mixin dropdown-menu-direction($dir: horizontal) {</p>
...
<p>@mixin foundation-dropdown-menu {</p>
