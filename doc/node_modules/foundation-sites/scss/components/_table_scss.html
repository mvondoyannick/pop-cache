...
<title>_table.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_table.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>// sass-lint:disable no-qualifying-elements</p>

<p>//// /// @group table ////</p>

<p>/// Default color for table background. /// @type Color $table-background:
$white  !default;</p>

<p>/// Default scale for darkening the striped table rows and the table
border. /// @type Number $table-color-scale: 5% !default;</p>

<p>/// Default style for table border. /// @type List $table-border: 1px solid
smart-scale($table-background, $table-color-scale) !default;</p>

<p>/// Default padding for table. /// @type Number $table-padding: rem-calc(8
10 10) !default;</p>

<p>/// Default scale for darkening the table rows on hover. /// @type Number
$table-hover-scale: 2% !default;</p>

<p>/// Default color of standard rows on hover. /// @type List
$table-row-hover: darken($table-background, $table-hover-scale) !default;</p>

<p>/// Default color of striped rows on hover. /// @type List
$table-row-stripe-hover: darken($table-background, $table-color-scale +
$table-hover-scale) !default;</p>

<p>/// If `true`, tables are striped by default and an .unstriped class is
created. If `false`, a .striped class is created. /// @type Boolean
$table-is-striped: true !default;</p>

<p>/// Default background color for striped rows. /// @type Color
$table-striped-background: smart-scale($table-background,
$table-color-scale) !default;</p>

<p>/// Default value for showing the stripe on rows of the tables, excluding
the header and footer. If even, the even rows will have a background color.
If odd, the odd rows will have a background color. If empty, or any other
value, the table rows will have no striping. /// @type Keyword
$table-stripe: even !default;</p>

<p>/// Default color for header background. /// @type Color
$table-head-background: smart-scale($table-background, $table-color-scale /
2) !default;</p>

<p>/// Default color of header rows on hover. /// @type List
$table-head-row-hover: darken($table-head-background, $table-hover-scale)
!default;</p>

<p>/// Default color for footer background. /// @type Color
$table-foot-background: smart-scale($table-background, $table-color-scale)
!default;</p>

<p>/// Default color of footer rows on hover. /// @type List
$table-foot-row-hover: darken($table-foot-background, $table-hover-scale)
!default;</p>

<p>/// Default font color for header. /// @type Color $table-head-font-color:
$body-font-color !default;</p>

<p>/// Default font color for footer. /// @type Color $table-foot-font-color:
$body-font-color !default;</p>

<p>/// Default value for showing the header when using stacked tables. ///
@type Boolean $show-header-for-stacked: false !default;</p>

<p>/// Breakpoint at which stacked table switches from mobile to desktop view.
/// @type Breakpoint $table-stack-breakpoint: medium !default;</p>

<p>@mixin -zf-table-stripe($stripe: $table-stripe) {</p>
...
<p>@mixin -zf-table-children-styles($stripe: $table-stripe, $is-striped:
$table-is-striped) {</p>
...
<p>/// Adds the general styles for tables. /// @param {Keyword} $stripe
[$table-stripe] - Uses keywords even, odd, or none to darken rows of the
table. The default value is even. @mixin table(</p>

<pre>$stripe: $table-stripe,
$nest: false</pre>
...
<p>/// Adds the ability to horizontally scroll the table when the content
overflows horizontally. @mixin table-scroll {</p>
...
<p>/// Slightly darkens the table rows on hover. @mixin table-hover {</p>
...
<p>/// Adds styles for a stacked table. Useful for small-screen layouts. ///
@param {Boolean} $header [$show-header-for-stacked] - Show the first th of
header when stacked. @mixin table-stack($header: $show-header-for-stacked)
{</p>
...
<p>@mixin foundation-table($nest: false) {</p>
