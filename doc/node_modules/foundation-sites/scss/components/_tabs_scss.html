...
<title>_tabs.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_tabs.scss">
...
<p>/// Default margin of the tab bar. /// @type Number $tab-margin: 0
!default;</p>

<p>/// Default background color of a tab bar. /// @type Color $tab-background:
$white !default;</p>

<p>/// Font color of tab item. /// @type Color $tab-color: $primary-color
!default;</p>

<p>/// Active background color of a tab bar. /// @type Color
$tab-background-active: $light-gray !default;</p>

<p>/// Active font color of tab item. /// @type Color $tab-active-color:
$primary-color !default;</p>

<p>/// Font size of tab items. /// @type Number $tab-item-font-size:
rem-calc(12) !default;</p>

<p>/// Default background color on hover for items in a Menu.
$tab-item-background-hover: $white !default;</p>

<p>/// Default padding of a tab item. /// @type Number $tab-item-padding:
1.25rem 1.5rem !default;</p>

<p>/// Default background color of tab content. /// @type Color
$tab-content-background: $white !default;</p>

<p>/// Default border color of tab content. /// @type Color
$tab-content-border: $light-gray !default;</p>

<p>/// Default text color of tab content. /// @type Color $tab-content-color:
$body-font-color !default;</p>

<p>/// Default padding for tab content. /// @type Number | List
$tab-content-padding: 1rem !default;</p>

<p>/// Adds styles for a tab container. Apply this to a `&lt;ul&gt;`. @mixin
tabs-container (</p>

<pre>$margin: $tab-margin,
$background: $tab-background,
$border-color: $tab-content-border</pre>
...
<p>/// Augments a tab container to have vertical tabs. Use this in conjunction
with `tabs-container()`. @mixin tabs-container-vertical {</p>
...
<p>/// Adds styles for the links within a tab container. Apply this to the
`&lt;li&gt;` elements inside a tab container. @mixin tabs-title (</p>

<pre>$padding: $tab-item-padding,
$font-size: $tab-item-font-size,
$color: $tab-color,
$color-active: $tab-active-color,
$background-hover: $tab-item-background-hover,
$background-active: $tab-background-active</pre>

<p>) {</p>

<pre>float: #{$global-left};
...
<p>/// Adds styles for the wrapper that surrounds a tab group&#39;s content
panes. @mixin tabs-content (</p>

<pre>$background: $tab-content-background,
$color: $tab-content-color,
$border-color: $tab-content-border</pre>

<p>) {</p>

<pre>border: 1px solid $border-color;
border-top: 0;
background: $background;
color: $color;
...
<p>/// Augments a tab content container to have a vertical style, by shifting
the border around. Use this in conjunction with `tabs-content()`. @mixin
tabs-content-vertical (</p>

<pre>$border-color: $tab-content-border</pre>

<p>) {</p>

<pre>border: 1px solid $border-color;
border-#{$global-left}: 0;</pre>

<p>}</p>

<p>/// Adds styles for an individual tab content panel within the tab content
container. @mixin tabs-panel (</p>

<pre>$padding: $tab-content-padding</pre>
