...
<title>_thumbnail.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_thumbnail.scss">
...
<p>/// Border around thumbnail images. /// @type Border $thumbnail-border: 4px
solid $white !default;</p>

<p>/// Bottom margin for thumbnail images. /// @type Length
$thumbnail-margin-bottom: $global-margin !default;</p>

<p>/// Box shadow under thumbnail images. /// @type Shadow $thumbnail-shadow:
0 0 0 1px rgba($black, 0.2) !default;</p>

<p>/// Box shadow under thumbnail images. /// @type Shadow
$thumbnail-shadow-hover: 0 0 6px 1px rgba($primary-color, 0.5) !default;</p>

<p>/// Transition proprties for thumbnail images. /// @type Transition
$thumbnail-transition: box-shadow 200ms ease-out !default;</p>

<p>/// Default radius for thumbnail images. /// @type Number
$thumbnail-radius: $global-radius !default;</p>

<p>/// Adds thumbnail styles to an element. @mixin thumbnail {</p>
...
<p>@mixin thumbnail-link {</p>

<pre>transition: $thumbnail-transition;
...
<p>@mixin foundation-thumbnail {</p>
