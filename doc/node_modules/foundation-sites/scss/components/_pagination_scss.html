...
<title>_pagination.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_pagination.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group pagination ////</p>

<p>/// Font size of pagination items. /// @type Number $pagination-font-size:
rem-calc(14) !default;</p>

<p>/// Default bottom margin of the pagination object. /// @type Number
$pagination-margin-bottom: $global-margin !default;</p>

<p>/// Text color of pagination items. /// @type Color $pagination-item-color:
$black !default;</p>

<p>/// Padding inside of pagination items. /// @type Number
$pagination-item-padding: rem-calc(3 10) !default;</p>

<p>/// Right margin to separate pagination items. /// @type Number
$pagination-item-spacing: rem-calc(1) !default;</p>

<p>/// Default radius for pagination items. /// @type Number
$pagination-radius: $global-radius !default;</p>

<p>/// Background color of pagination items on hover. /// @type Color
$pagination-item-background-hover: $light-gray !default;</p>

<p>/// Background color of pagination item for the current page. /// @type
Color $pagination-item-background-current: $primary-color !default;</p>

<p>/// Text color of the pagination item for the current page. /// @type Color
$pagination-item-color-current: $white !default;</p>

<p>/// Text color of a disabled pagination item. /// @type Color
$pagination-item-color-disabled: $medium-gray !default;</p>

<p>/// Color of the ellipsis in a pagination menu. /// @type Color
$pagination-ellipsis-color: $black !default;</p>

<p>/// If `false`, don&#39;t display page number links on mobile, only
next/previous links /// and optionally current page number. /// @type
Boolean $pagination-mobile-items: false !default;</p>

<p>/// If `true`, display the current page number on mobile even if
`$pagination-mobile-items` is set to `false`. /// This parameter will only
override the visibility setting of the current item for
`$pagination-mobile-items: false;`, /// it will not affect the current page
number visibility when `$pagination-mobile-items` is set to `true`. ///
@type Boolean $pagination-mobile-current-item: false !default;</p>

<p>/// If `true`, arrows are added to the next and previous links of
pagination. /// @type Boolean $pagination-arrows: true !default;</p>

<p>/// Adds styles for a pagination container. Apply this to a `&lt;ul&gt;`.
@mixin pagination-container (</p>

<pre>$margin-bottom: $pagination-margin-bottom,
$font-size: $pagination-font-size,
$spacing: $pagination-item-spacing,
$radius: $pagination-radius,
$color: $pagination-item-color,
$padding: $pagination-item-padding,
$background-hover: $pagination-item-background-hover</pre>

<p>) {</p>

<pre>@include clearfix;
...
<p>/// Adds styles for the current pagination item. Apply this to an
`&lt;a&gt;`. @mixin pagination-item-current (</p>

<pre>$padding: $pagination-item-padding,
$background-current: $pagination-item-background-current,
$color-current: $pagination-item-color-current</pre>
...
<p>/// Adds styles for a disabled pagination item. Apply this to an
`&lt;a&gt;`. @mixin pagination-item-disabled (</p>

<pre>$padding: $pagination-item-padding,
$color: $pagination-item-color-disabled</pre>
...
<p>/// Adds styles for an ellipsis for use in a pagination list. @mixin
pagination-ellipsis (</p>

<pre>$padding: $pagination-item-padding,
$color: $pagination-ellipsis-color</pre>
...
<p>@mixin foundation-pagination {</p>
