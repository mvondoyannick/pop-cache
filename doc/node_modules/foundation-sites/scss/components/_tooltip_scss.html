...
<title>_tooltip.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_tooltip.scss">
...
<p>/// Default cursor of the defined term. /// @type Keyword $has-tip-cursor:
help !default;</p>

<p>/// Default font weight of the defined term. /// @type Keyword | Number
$has-tip-font-weight: $global-weight-bold !default;</p>

<p>/// Default border bottom of the defined term. /// @type List
$has-tip-border-bottom: dotted 1px $dark-gray !default;</p>

<p>/// Default color of the tooltip background. /// @type Color
$tooltip-background-color: $black !default;</p>

<p>/// Default color of the tooltip font. /// @type Color $tooltip-color:
$white !default;</p>

<p>/// Default padding of the tooltip background. /// @type Number
$tooltip-padding: 0.75rem !default;</p>

<p>/// Default max width for tooltips. /// @type Number $tooltip-max-width:
10rem !default;</p>

<p>/// Default font size of the tooltip text. By default, we recommend a
smaller font size than the body copy. /// @type Number $tooltip-font-size:
$small-font-size !default;</p>

<p>/// Default pip width for tooltips. /// @type Number $tooltip-pip-width:
0.75rem !default;</p>

<p>/// Default pip height for tooltips. This is helpful for calculating the
distance of the tooltip from the tooltip word. /// @type Number
$tooltip-pip-height: $tooltip-pip-width * 0.866 !default;</p>

<p>/// Default radius for tooltips. /// @type Number $tooltip-radius:
