...
<title>_media-object.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_media-object.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group media-object ////</p>

<p>/// Bottom margin of a media object. /// @type Number
$mediaobject-margin-bottom: $global-margin !default;</p>

<p>/// Left and right padding on sections within a media object. /// @type
Number $mediaobject-section-padding: $global-padding !default;</p>

<p>/// Width of images within a media object, when the object is stacked
vertically. Set to &#39;auto&#39; to use the image&#39;s natural width. ///
@type Number $mediaobject-image-width-stacked: 100% !default;</p>

<p>/// Adds styles for a media object container. @mixin media-object-container
{</p>

<pre>display: if($global-flexbox, flex, block);
...
<p>/// Adds styles for sections within a media object. /// @param {Number}
$padding [$mediaobject-section-padding] - Padding between sections. @mixin
media-object-section($padding: $mediaobject-section-padding) {</p>
...
<p>/// Adds styles to stack sections of a media object. Apply this to the
section elements, not the container. @mixin media-object-stack {</p>
...
<p>@mixin foundation-media-object {</p>
