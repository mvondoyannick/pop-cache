...
<title>_breadcrumbs.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_breadcrumbs.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group breadcrumbs ////</p>

<p>/// Margin around a breadcrumbs container. /// @type Number
$breadcrumbs-margin: 0 0 $global-margin 0 !default;</p>

<p>/// Font size of breadcrumb links. /// @type Number
$breadcrumbs-item-font-size: rem-calc(11) !default;</p>

<p>/// Color of breadcrumb links. /// @type Color $breadcrumbs-item-color:
$primary-color !default;</p>

<p>/// Color of the active breadcrumb link. /// @type Color
$breadcrumbs-item-color-current: $black !default;</p>

<p>/// Opacity of disabled breadcrumb links. /// @type Number
$breadcrumbs-item-color-disabled: $medium-gray !default;</p>

<p>/// Margin between breadcrumb items. /// @type Number
$breadcrumbs-item-margin: 0.75rem !default;</p>

<p>/// If `true`, makes breadcrumb links uppercase. /// @type Boolean
$breadcrumbs-item-uppercase: true !default;</p>

<p>/// If `true`, adds a seperator between breadcrumb links. /// @type Boolean
$breadcrumbs-item-separator: true !default;</p>

<p>// If it exists $breadcrumbs-item-slash is used to build
$breadcrumbs-item-separator. See the documentation. @if
variable-exists(breadcrumbs-item-slash) {</p>

<pre>$breadcrumbs-item-separator: $breadcrumbs-item-slash;</pre>

<p>}</p>

<p>/// Used character for the breadcrumb separator. /// @type Content
$breadcrumbs-item-separator-item: &#39;/&#39; !default;</p>

<p>/// Used character for the breadcrumb separator in rtl mode. /// @type
Content $breadcrumbs-item-separator-item-rtl: &#39;\&#39; !default;</p>

<p>/// Color of breadcrumb item. /// @type Color
$breadcrumbs-item-separator-color: $medium-gray !default;</p>

<p>// If it exists $breadcrumbs-item-slash-color is used to build
$breadcrumbs-item-separator-color. See the documentation. @if
variable-exists(breadcrumbs-item-slash-color) {</p>

<pre>$breadcrumbs-item-separator-color: $breadcrumbs-item-slash-color;</pre>

<p>}</p>

<p>/// Adds styles for a breadcrumbs container, along with the styles for the
`&lt;li&gt;` and `&lt;a&gt;` elements inside of it. @mixin
...
<p>@mixin foundation-breadcrumbs {</p>
