...
<title>_label.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_label.scss">
...
<p>/// Default background color for labels. /// @type Color $label-background:
$primary-color !default;</p>

<p>/// Default text color for labels. /// @type Color $label-color: $white
!default;</p>

<p>/// Alternate text color for labels. /// @type Color $label-color-alt:
$black !default;</p>

<p>/// Coloring classes. A map of classes to output in your CSS, like
`.secondary`, `.success`, and so on. /// @type Map $label-palette:
$foundation-palette !default;</p>

<p>/// Default font size for labels. /// @type Number $label-font-size: 0.8rem
!default;</p>

<p>/// Default padding inside labels. /// @type Number $label-padding:
0.33333rem 0.5rem !default;</p>

<p>/// Default radius of labels. /// @type Number $label-radius:
$global-radius !default;</p>

<p>/// Generates base styles for a label. @mixin label {</p>
