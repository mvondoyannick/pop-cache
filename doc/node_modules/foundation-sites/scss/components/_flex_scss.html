...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_flex.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group Flexbox Utilities //// // /// Default value for the count
of source ordering` /// @type Number $flex-source-ordering-count: 6
!default;</p>

<p>/// Quickly disable/enable Responsive breakpoints for Vanilla Flex Helpers.
/// @type Boolean $flexbox-responsive-breakpoints: true !default;</p>

<p>@mixin flex-helpers {</p>
...
<p>@mixin foundation-flex-classes {</p>

<pre>// Horizontal alignment using justify-content
