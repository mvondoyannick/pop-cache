...
<title>_responsive-embed.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_responsive-embed.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group responsive-embed ////</p>

<p>/// Margin below a responsive embed container. /// @type Number
$responsive-embed-margin-bottom: rem-calc(16) !default;</p>

<p>/// Aspect ratios used to determine padding-bottom of responsive embed
containers. /// @type Map $responsive-embed-ratios: (</p>
...
<p>/// Creates a responsive embed container. /// @param {String|List} $ratio
[default] - Ratio of the container. Can be a key from the
`$responsive-embed-ratios` map or a list formatted as `x by y`. @mixin
responsive-embed($ratio: default) {</p>

<pre>@if type-of($ratio) == &#39;string&#39; {
...
<p>@mixin foundation-responsive-embed {</p>
