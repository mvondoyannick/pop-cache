...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/components/_dropdown.scss">
...
<p>/// Padding for dropdown panes. /// @type List $dropdown-padding: 1rem
!default;</p>

<p>/// Background for dropdown panes. /// @type Color $dropdown-background:
$body-background !default;</p>

<p>/// Border for dropdown panes. /// @type List $dropdown-border: 1px solid
$medium-gray !default;</p>

<p>/// Font size for dropdown panes. /// @type List $dropdown-font-size: 1rem
!default;</p>

<p>/// Width for dropdown panes. /// @type Number $dropdown-width: 300px
!default;</p>

<p>/// Border radius dropdown panes. /// @type Number $dropdown-radius:
$global-radius !default;</p>

<p>/// Sizes for dropdown panes. Each size is a CSS class you can apply. ///
@type Map $dropdown-sizes: (</p>
...
<p>/// Applies styles for a basic dropdown. @mixin dropdown-container {</p>
