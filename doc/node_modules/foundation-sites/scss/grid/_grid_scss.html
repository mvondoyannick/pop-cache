...
<title>_grid.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/grid/_grid.scss">
...
<p>/// The maximum width of a row. /// @type Number $grid-row-width:
$global-width !default;</p>

<p>/// The default column count of a grid. Changing this value affects the
logic of the grid mixins, and the number of CSS classes output. /// @type
Number $grid-column-count: 12 !default;</p>

<p>/// The amount of space between columns at different screen sizes. To use
just one size, set the variable to a number instead of a map. /// @type Map
| Length /// @since 6.1.0 $grid-column-gutter: (</p>
...
<p>/// If `true`, the last column in a row will align to the opposite edge of
the row. /// @type Boolean $grid-column-align-edge: true !default;</p>

<p>/// Selector used for an alias of column (with @extend). If `false`, no
alias is created. /// @type String $grid-column-alias: &#39;columns&#39;
!default;</p>

<p>/// The highest number of `.x-up` classes available when using the block
grid CSS. /// @type Number $block-grid-max: 8 !default;</p>

<p>// Internal value to store the end column float direction $-zf-end-float:
if($grid-column-align-edge, $global-right, $global-left);</p>

<p>@import &#39;row&#39;; @import &#39;column&#39;; @import &#39;size&#39;;
@import &#39;position&#39;; @import &#39;gutter&#39;; @import
&#39;classes&#39;; @import &#39;layout&#39;;</p>

<p>@import &#39;flex-grid&#39;;</p>
</main>
