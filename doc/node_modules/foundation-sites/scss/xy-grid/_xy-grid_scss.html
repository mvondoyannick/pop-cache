...
<title>_xy-grid.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/xy-grid/_xy-grid.scss">
...
<p>/// Enables the XY grid. /// @type Boolean $xy-grid: true !default;</p>

<p>/// The maximum width of a grid container. /// @type Number
$grid-container: $global-width !default;</p>

<p>/// The number of columns used in the grid. /// @type Number $grid-columns:
12 !default;</p>

<p>/// The amount of margin between cells at different screen sizes when using
the margin grid. To use just one size, set the variable to a number instead
of a map. /// @type Map | Length $grid-margin-gutters: (</p>
...
<p>/// The amount of padding in cells at different screen sizes when using the
padding grid. To use just one size, set the variable to a number instead of
a map. /// @type Map | Length $grid-padding-gutters: $grid-margin-gutters
!default;</p>

<p>/// The amount of padding to use when padding the grid-container. /// @type
Map | Length $grid-container-padding: $grid-padding-gutters !default;</p>

<p>/// The maximum width to apply to a grid container /// @type Number
$grid-container-max: $global-width !default;</p>

<p>/// The maximum number of cells in an XY block grid. /// @type Number
$xy-block-grid-max: 8 !default;</p>

<p>@import &#39;gutters&#39;; @import &#39;grid&#39;; @import &#39;cell&#39;;
@import &#39;frame&#39;; @import &#39;position&#39;; @import
&#39;layout&#39;; @import &#39;collapse&#39;; @import &#39;classes&#39;;</p>
</main>
