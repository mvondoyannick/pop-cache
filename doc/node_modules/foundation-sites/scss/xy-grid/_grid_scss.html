...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/xy-grid/_grid.scss">
...
<p>/// Creates a max width container, designed to house your grid content. ///
/// @param {Number} $width [$grid-container] - a width to limit the
container to. /// @param {Number} $padding [$grid-container-padding] -
paddings of the container. @mixin xy-grid-container(</p>

<pre>$width: $grid-container,
$padding: $grid-container-padding</pre>

<p>) {</p>

<pre>@include xy-gutters($gutters: $padding, $gutter-type: padding);
...
<p>/// Creates a container for your flex cells. /// /// @param {Keyword}
$direction [horizontal] - Either horizontal or vertical direction of cells
within. /// @param {Boolean} $wrap [true] - If the cells within should wrap
or not. @mixin xy-grid(</p>

<pre>$direction: horizontal,
$wrap: true</pre>

<p>) {</p>

<pre>$direction: if($direction == &#39;horizontal&#39;, row, column);
$wrap: if($wrap, wrap, nowrap);

display: flex;
flex-flow: $direction $wrap;</pre>
