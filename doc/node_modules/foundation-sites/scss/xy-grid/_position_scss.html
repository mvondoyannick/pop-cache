...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/xy-grid/_position.scss">
...
<p>/// Offsets a column to the right/bottom by `$n` columns. /// /// @param
{Number|List} $n - Size to offset by. You can pass in any value accepted by
the `zf-cell()` mixin, such as `6`, `50%`, or `1 of 2`. /// @param
{Number|Map} $gutters [$grid-margin-gutters] Map of gutters or single value
to use for responsive gutters. /// @param {Keyword} $gutter-type [margin]
The type of gutter to use. Can be `margin` or `padding` /// @param
{Number|Array|Keyword} $breakpoint [$-zf-zero-breakpoint] - Single value,
breakpoint name, or list of breakpoint names to use for `$gutters`. See
`-zf-breakpoint-value()`. /// @param {Boolean} $vertical [false] Sets the
direction of the offset. If set to true will apply margin-top instead.
@mixin xy-cell-offset(</p>
...
<pre>$direction: if($vertical, &#39;top&#39;, $global-left);
