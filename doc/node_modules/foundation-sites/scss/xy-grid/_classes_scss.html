...
<title>_classes.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/xy-grid/_classes.scss">
...
<p>// Margin Grid classes @mixin xy-base-grid-classes {</p>
...
<p>@mixin -xy-breakpoint-cell-classes($class-breakpoint, $gutter-breakpoint,
$vertical) {</p>

<pre>$prefix: if($class-breakpoint == $-zf-zero-breakpoint, &#39;&#39;, &#39;#{$class-breakpoint}-&#39;);
&gt; .#{$prefix}auto {
...
<p>// Margin Grid classes @mixin xy-margin-grid-classes(</p>

<pre>$gutter-position: left right,
$vertical: false,
$wrapping-selector: &#39;.grid-margin-x&#39;</pre>

<p>){</p>

<pre>#{$wrapping-selector} {
...
<p>// Padding Grid classes @mixin xy-padding-grid-classes {</p>
...
<p>// Block Grid classes @mixin xy-block-grid-classes($margin-grid: true,
$padding-grid: true) {</p>
...
<p>// Collapse classes @mixin xy-collapse-grid-classes($margin-grid: true,
$padding-grid: true) {</p>

<pre>@each $bp in $breakpoint-classes {
  @if $margin-grid {
    .#{$bp}-margin-collapse {
...
<p>// Offset classes @mixin xy-offset-cell-classes {</p>
...
<p>// Vertical Grid classes @mixin xy-vertical-grid-classes(</p>

<pre>$margin-grid: true,
$padding-grid: true</pre>
...
<p>@mixin xy-frame-grid-classes($vertical-grid: true, $margin-grid: true) {</p>

<pre>// Framed grid styles
.grid-frame {
...
<p>// Final classes @mixin foundation-xy-grid-classes(</p>
