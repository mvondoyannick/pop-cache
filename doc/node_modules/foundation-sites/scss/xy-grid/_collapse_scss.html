...
<title>_collapse.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/xy-grid/_collapse.scss">
...
<p>/// Collapses the grid a cells within it. /// /// @param {String} $selector
[.cell] - The child element to remove the gutter from. /// @param {Keyword}
$gutter-type [margin] - The type of gutter to remove. /// @param {List}
$gutter-position [right left] - The positions to remove gutters from.
Accepts `top`, `bottom`, `left`, `right` in any combination. /// @param
{Keyword} $min-breakpoint [$-zf-zero-breakpoint] - Minimum breakpoint in
`$breakpoint-classes` for which to collapse the gutter. @mixin
xy-grid-collapse(</p>

<pre>$selector: &#39;.cell&#39;,
$gutter-type: margin,
$gutter-position: right left,
$min-breakpoint: $-zf-zero-breakpoint</pre>

<p>) {</p>

<pre>// First, lets negate any margins on the top level
