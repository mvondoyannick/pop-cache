...
<title>_frame.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/xy-grid/_frame.scss">

<p>/// Modifies a grid to give it “frame” behavior (no overflow, no wrap,
stretch behavior) /// /// @param {Boolean} $vertical [false] - Is grid
vertical or horizontal. Should match grid. /// @param {Boolean} $nested
[false] - Is grid nested or not. If nested is true this sets the frame to
100% height, otherwise will be 100vh. /// @param {Number|Map} $gutters
[null] - Map or single value for gutters. /// @param {String} $breakpoint
[null] - The name of the breakpoint size in your gutters map to get the
size from. /// @param {Boolean} $include-base [true] - Include the base
styles that don&#39;t vary per breakpoint. @mixin xy-grid-frame(</p>

<pre>$vertical: false,
$nested: false,
$gutters: null,
$breakpoint: null,
$include-base: true</pre>
...
<p>/// Modifies a cell to give it “block” behavior (overflow auto, inertial
scrolling) /// /// @param {Boolean} $vertical [false] - Is grid vertical or
horizontal. Should match grid. @mixin xy-cell-block(</p>

<pre>$vertical: false</pre>

<p>) {</p>

<pre>$property: if($vertical == true, &#39;overflow-y&#39;, &#39;overflow-x&#39;);
...
<p>/// Container for inside a grid frame containing multiple blocks. Typically
used /// as a modifier for a `.cell` to allow the cell to pass along flex
sizing /// constraints / from parents to children. @mixin
xy-cell-block-container() {</p>
