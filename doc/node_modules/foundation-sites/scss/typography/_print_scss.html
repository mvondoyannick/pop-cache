...
<title>_print.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/typography/_print.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>/// If `true`, all elements will have transparent backgrounds when printed,
to save on ink. /// @type Boolean /// @group global
$print-transparent-backgrounds: true !default;</p>

<p>/// If `true`, displays next to all links their “href” when printed. ///
@type Boolean /// @group global $print-hrefs: true !default;</p>

<p>// sass-lint:disable-all</p>

<p>@mixin foundation-print-styles {</p>

<pre>.show-for-print { display: none !important; }
