...
<title>_base.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/typography/_base.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group typography-base ////</p>

<p>// Base Typography // - - - - - - - - - - - - - - - // These are styles
applied to basic HTML tags, including: //   - Paragraphs &lt;p&gt; //   -
Bold/italics &lt;b&gt; &lt;strong&gt; &lt;i&gt; &lt;em&gt; //   - Small
text &lt;small&gt; //   - Headings &lt;h1&gt;-&lt;h6&gt; //   - Anchors
&lt;a&gt; //   - Dividers &lt;hr&gt; //   - Lists &lt;ul&gt; &lt;ol&gt;
&lt;dl&gt; //   - Blockquotes &lt;blockquote&gt; //   - Code blocks
&lt;code&gt; //   - Abbreviations &lt;abbr&gt; //   - Citations
&lt;cite&gt; //   - Keystrokes &lt;kbd&gt;</p>

<p>/// Font family for header elements. /// @type String | List
$header-font-family: $body-font-family !default;</p>

<p>/// Font weight of headers. /// @type String $header-font-weight:
$global-weight-normal !default;</p>

<p>/// Font style (e.g. italicized) of headers. /// @type String
$header-font-style: normal !default;</p>

<p>/// Font stack used for elements that use monospaced type, such as code
samples /// @type String | List $font-family-monospace: Consolas,
&#39;Liberation Mono&#39;, Courier, monospace !default;</p>

<p>/// Color of headers. /// @type Color $header-color: inherit !default;</p>

<p>/// Line height of headers. /// @type Number $header-lineheight: 1.4
!default;</p>

<p>/// Bottom margin of headers. /// @type Number $header-margin-bottom:
0.5rem !default;</p>

<p>/// Styles for headings at various screen sizes. Each key is a breakpoint,
and each value is a map of heading styles. /// @type Map $header-styles: (</p>
...
<p>// $header-styles map is built from $header-sizes in order to ensure
downward compatibility // when $header-sizes is depreciated, $header-styles
needs to get !default values like settings.scss @function
build_from_header-sizes($header-sizes) {</p>

<pre>@warn &#39;Note, that $header-sizes has been replaced with $header-styles. $header-sizes still works, but it is going to be depreciated.&#39;;
$header-styles: ();
...
@return $header-styles;</pre>

<p>}</p>

<p>// If it exists $headers-sizes is used to build $header-styles. See the
documentation. @if variable-exists(header-sizes) {</p>

<pre>$header-styles: build_from_header-sizes($header-sizes);</pre>

<p>}</p>

<p>/// Text rendering method of headers. /// @type String
$header-text-rendering: optimizeLegibility !default;</p>

<p>/// Font size of `&lt;small&gt;` elements. /// @type Number
$small-font-size: 80% !default;</p>

<p>/// Color of `&lt;small&gt;` elements when placed inside headers. /// @type
Color $header-small-font-color: $medium-gray !default;</p>

<p>/// Line height of text inside `&lt;p&gt;` elements. /// @type Number
$paragraph-lineheight: 1.6 !default;</p>

<p>/// Bottom margin of paragraphs. /// @type Number $paragraph-margin-bottom:
1rem !default;</p>

<p>/// Text rendering method for paragraph text. /// @type String
$paragraph-text-rendering: optimizeLegibility !default;</p>

<p>/// Text color of code samples. /// @type Color $code-color: $black
!default;</p>

<p>/// Font family of code samples. /// @type String | List $code-font-family:
$font-family-monospace !default;</p>

<p>/// Font weight of text in code samples. /// @type String
$code-font-weight: $global-weight-normal !default;</p>

<p>/// Background color of code samples. /// @type Color $code-background:
$light-gray !default;</p>

<p>/// Border around code samples. /// @type List $code-border: 1px solid
$medium-gray !default;</p>

<p>/// Padding around text of code samples. /// @type Number | List
$code-padding: rem-calc(2 5 1) !default;</p>

<p>/// Default color for links. /// @type Color $anchor-color: $primary-color
!default;</p>

<p>/// Default color for links on hover. /// @type Color $anchor-color-hover:
scale-color($anchor-color, $lightness: -14%) !default;</p>

<p>/// Default text decoration for links. /// @type String
$anchor-text-decoration: none !default;</p>

<p>/// Default text decoration for links on hover. /// @type String
$anchor-text-decoration-hover: none !default;</p>

<p>/// Maximum width of a divider. /// @type Number $hr-width: $global-width
!default;</p>

<p>/// Default border for a divider. /// @type List $hr-border: 1px solid
$medium-gray !default;</p>

<p>/// Default margin for a divider. /// @type Number | List $hr-margin:
rem-calc(20) auto !default;</p>

<p>/// Line height for items in a list. /// @type Number $list-lineheight:
$paragraph-lineheight !default;</p>

<p>/// Bottom margin for items in a list. /// @type Number
$list-margin-bottom: $paragraph-margin-bottom !default;</p>

<p>/// Bullet type to use for unordered lists (e.g., `square`, `circle`,
`disc`). /// @type String $list-style-type: disc !default;</p>

<p>/// Positioning for bullets on unordered list items. /// @type String
$list-style-position: outside !default;</p>

<p>/// Left (or right) margin for lists. /// @type Number $list-side-margin:
1.25rem !default;</p>

<p>/// Left (or right) margin for a list inside a list. /// @type Number
$list-nested-side-margin: 1.25rem !default;</p>

<p>/// Bottom margin for `&lt;dl&gt;` elements. /// @type Number
$defnlist-margin-bottom: 1rem !default;</p>

<p>/// Font weight for `&lt;dt&gt;` elements. /// @type String
$defnlist-term-weight: $global-weight-bold !default;</p>

<p>/// Spacing between `&lt;dt&gt;` and `&lt;dd&gt;` elements. /// @type
Number $defnlist-term-margin-bottom: 0.3rem !default;</p>

<p>/// Text color of `&lt;blockquote&gt;` elements. /// @type Color
$blockquote-color: $dark-gray !default;</p>

<p>/// Padding inside a `&lt;blockquote&gt;` element. /// @type Number | List
$blockquote-padding: rem-calc(9 20 0 19) !default;</p>

<p>/// Side border for `&lt;blockquote&gt;` elements. /// @type List
$blockquote-border: 1px solid $medium-gray !default;</p>

<p>/// Font size for `&lt;cite&gt;` elements. /// @type Number
$cite-font-size: rem-calc(13) !default;</p>

<p>/// Text color for `&lt;cite&gt;` elements. /// @type Color $cite-color:
$dark-gray !default;</p>

<p>/// Pseudo content for `&lt;cite&gt;` elements. /// @type String
$cite-pseudo-content: &#39;2014 0020&#39; !default;</p>

<p>/// Font family for `&lt;kbd&gt;` elements. /// @type String | List
$keystroke-font: $font-family-monospace !default;</p>

<p>/// Text color for `&lt;kbd&gt;` elements. /// @type Color
$keystroke-color: $black !default;</p>

<p>/// Background color for `&lt;kbd&gt;` elements. /// @type Color
$keystroke-background: $light-gray !default;</p>

<p>/// Padding for `&lt;kbd&gt;` elements. /// @type Number | List
$keystroke-padding: rem-calc(2 4 0) !default;</p>

<p>/// Border radius for `&lt;kbd&gt;` elements. /// @type Number | List
$keystroke-radius: $global-radius !default;</p>

<p>/// Bottom border style for `&lt;abbr&gt;` elements. /// @type List
$abbr-underline: 1px dotted $black !default;</p>

<p>@mixin foundation-typography-base {</p>

<pre>// Typography resets
div,
dl,
dt,
dd,
