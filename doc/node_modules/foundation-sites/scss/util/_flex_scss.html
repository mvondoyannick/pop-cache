...
<title>_flex.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/util/_flex.scss">

<p>@function -zf-flex-justify($text-direction){</p>
...
<p>$-zf-flex-direction: (</p>

<pre>&#39;row&#39;: row,
&#39;row-reverse&#39;: row-reverse,
&#39;column&#39;: column,
&#39;column-reverse&#39;: column-reverse,</pre>

<p>);</p>

<p>/// Enables flexbox by adding `display: flex` to the element. @mixin flex {</p>

<pre>display: flex;</pre>

<p>}</p>

<p>/// Horizontally or vertically aligns the items within a flex container.
/// /// @param {Keyword} $x [null] - Horizontal alignment to use. Can be
`left`, `right`, `center`, `justify`, or `spaced`. Or, set it to `null`
(the default) to not set horizontal alignment. /// @param {Keyword} $y
[null] - Vertical alignment to use. Can be `top`, `bottom`, `middle`, or
`stretch`. Or, set it to `null` (the default) to not set vertical
alignment. @mixin flex-align($x: null, $y: null) {</p>
...
<p>/// Vertically align a single column within a flex row. Apply this mixin to
a flex column. /// /// @param {Keyword} $y [null] - Vertical alignment to
use. Can be `top`, `bottom`, `middle`, or `stretch`. Or, set it to `null`
(the default) to not set vertical alignment. @mixin flex-align-self($y:
null) {</p>
...
<p>/// Changes the source order of a flex child. Children with lower numbers
appear first in the layout. /// @param {Number} $order [0] - Order number
to apply. @mixin flex-order($order: 0) {</p>

<pre>order: $order;</pre>

<p>}</p>

<p>/// Change flex-direction /// @param {Keyword} $direction [row] - Flex
direction to use. Can be ///   - row (default): same as text direction /// 
- row-reverse: opposite to text direction ///   - column: same as row but
top to bottom ///   - column-reverse: same as row-reverse top to bottom
@mixin flex-direction($direction: row) {</p>

<pre>flex-direction: $direction;</pre>
