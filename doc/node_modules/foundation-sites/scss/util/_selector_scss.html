...
<title>_selector.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/util/_selector.scss">
...
<p>/// Generates a selector with every text input type. You can also filter
the list to only output a subset of those selectors. /// /// @param
{List|Keyword} $types [()] - A list of text input types to use. Leave blank
to use all of them. /// @param {Keyword} $modifier [&#39;&#39;] - A
modifier to be applied to each text input type (e.g. a class or a
pseudo-class). Leave blank to ignore. @function text-inputs($types: (),
$modifier: &#39;&#39;) {</p>
