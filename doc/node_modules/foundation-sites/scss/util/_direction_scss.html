...
<title>_direction.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/util/_direction.scss">
...
<p>/// Returns the opposite direction of $dir /// /// @param {Keyword} $dir -
Used direction between “top”, “right”, “bottom” and “left”. /// @return
{Keyword} Opposite direction of $dir @function direction-opposite(</p>

<pre class="ruby"><span class="ruby-identifier">$dir</span>
</pre>

<p>) {</p>

<pre>$dirs: (top, right, bottom, left);
...
@return nth($dirs, $opposite-place);</pre>
