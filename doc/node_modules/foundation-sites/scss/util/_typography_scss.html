...
<title>_typography.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/util/_typography.scss">
...
<pre>&#39;georgia&#39;: (Georgia, &quot;URW Bookman L&quot;, serif),
...
&#39;verdana&#39;: (Verdana, Geneva, &quot;DejaVu Sans&quot;, sans-serif),</pre>

<p>);</p>

<p>/// Return a font stack list from a map. Equivalent to `map-safe-get($name,
$-zf-font-stack)`. /// /// @param {String} $stack - Name of the font stack.
/// @param {Map} $map [$-zf-font-stack] - Map of font stacks to retrieve a
list from. /// /// @returns {List} Found font stack. @function
font-stack($stack, $map: $-zf-font-stack) {</p>

<pre>@return map-safe-get($map, $stack);</pre>
