...
<title>_global.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/_global.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>// sass-lint:disable no-color-literals, no-qualifying-elements</p>

<p>//// /// @group global ////</p>

<p>@import &#39;util/util&#39;;</p>

<p>/// Font size attribute applied to `&lt;html&gt;` and `&lt;body&gt;`. We
use 100% by default so the value is inherited from the user&#39;s browser
settings. /// @type Number $global-font-size: 100% !default;</p>

<p>/// Global width of your site. Used by the grid to determine row width. ///
@type Number $global-width: rem-calc(1200) !default;</p>

<p>/// Default line height for all type. `$global-lineheight` is 24px while
`$global-font-size` is 16px /// @type Number $global-lineheight: 1.5
!default;</p>

<p>/// Colors used for buttons, callouts, links, etc. There must always be a
color called `primary`. /// @type Map $foundation-palette: (</p>
...
<p>/// Color used for light gray UI items. /// @type Color $light-gray: e6e6e6
!default;</p>

<p>/// Color used for medium gray UI items. /// @type Color $medium-gray:
cacaca !default;</p>

<p>/// Color used for dark gray UI items. /// @type Color $dark-gray: #8a8a8a
!default;</p>

<p>/// Color used for black ui items. /// @type Color $black: #0a0a0a
!default;</p>

<p>/// Color used for white ui items. /// @type Color $white: fefefe !default;</p>

<p>/// Background color of the body. /// @type Color $body-background: $white
!default;</p>

<p>/// Text color of the body. /// @type Color $body-font-color: $black
!default;</p>

<p>/// Font stack of the body. /// @type List $body-font-family:
&#39;Helvetica Neue&#39;, Helvetica, Roboto, Arial, sans-serif !default;</p>

<p>/// Set to `true` to enable antialiased type, using the
`-webkit-font-smoothing` and `-moz-osx-font-smoothing` CSS properties. ///
@type Boolean $body-antialiased: true !default;</p>

<p>/// Global value used for margin on components. /// @type Number
$global-margin: 1rem !default;</p>

<p>/// Global value used for padding on components. /// @type Number
$global-padding: 1rem !default;</p>

<p>/// Global value used for positioning on components. /// @type Number
$global-position: 1rem !default;</p>

<p>/// Global font weight used for normal type. /// @type Keyword | Number
$global-weight-normal: normal !default;</p>

<p>/// Global font weight used for bold type. /// @type Keyword | Number
$global-weight-bold: bold !default;</p>

<p>/// Global value used for all elements that have a border radius. /// @type
Number $global-radius: 0 !default;</p>

<p>/// Global value used for all menu styles. Can be overwritten at individual
menu component level. /// @type Number $global-menu-padding: 0.7rem 1rem
!default;</p>

<p>/// Global value used for all menu styles. Nested margin for submenu.
$global-menu-nested-margin: 1rem !default;</p>

<p>/// Sets the text direction of the CSS. Can be either `ltr` or `rtl`. ///
@type Keyword $global-text-direction: ltr !default;</p>

<p>/// Enables flexbox for components that support it. /// @type Boolean
$global-flexbox: true !default;</p>

<p>/// Enabled responsive breakpoints for prototypes if applicable /// @type
Boolean $global-prototype-breakpoints: false !default;</p>

<p>/// Button cursor&#39;s value, `auto` by default /// @type Keyword
$global-button-cursor: auto !default;</p>

<p>@if not map-has-key($foundation-palette, primary) {</p>

<pre>@error &#39;In $foundation-palette, you must have a color named &quot;primary&quot;.&#39;;</pre>

<p>}</p>

<p>// Internal variables used for text direction $global-left:
if($global-text-direction == rtl, right, left); $global-right:
if($global-text-direction == rtl, left, right);</p>

<p>// Internal variable that contains the flex justifying options
$-zf-flex-justify: -zf-flex-justify($global-text-direction);</p>

<p>/// Global tolerance for color pick contrast. /// @type Number
$global-color-pick-contrast-tolerance: 0 !default;</p>

<p>// Internal variables used for colors @include add-foundation-colors;</p>

<p>@mixin foundation-global-styles {</p>

<pre>@include foundation-normalize;
