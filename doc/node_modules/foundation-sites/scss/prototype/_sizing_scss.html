...
<title>_sizing.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_sizing.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-sizing ////</p>

<p>/// Responsive breakpoints for spacing classes (margin and padding) ///
@type Boolean $prototype-sizing-breakpoints: $global-prototype-breakpoints
!default;</p>

<p>/// Map containing all the `sizing` classes /// @type Map
$prototype-sizing: (</p>
...
<p>/// Map containing all the sizes. /// @type Map $prototype-sizes: (</p>
...
<p>/// Max Width 100 utility. @mixin max-width-100 {</p>

<pre>max-width: 100% !important;</pre>

<p>}</p>

<p>/// Max Height 100 utility. @mixin max-height-100 {</p>

<pre>max-height: 100% !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-sizing {</p>
