...
<title>_text-utilities.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_text-utilities.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-text-utilities ////</p>

<p>/// Responsive breakpoints for text utilities /// @type Boolean
$prototype-utilities-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Default Value for `text-overflow` variable /// @type String
$prototype-text-overflow: ellipsis !default;</p>

<p>/// Image Replacement utility. `text-hide` @mixin text-hide {</p>
...
<p>/// Truncating the text, elipsis by default. /// @param {String} $overflow
[$prototype-text-overflow] Text Truncate @mixin text-truncate(</p>

<pre>$overflow: $prototype-text-overflow</pre>
...
<p>/// No wrapping of the text. `text-nowrap` @mixin text-nowrap {</p>

<pre>white-space: nowrap !important;</pre>

<p>}</p>

<p>/// Wrapping of the text. `text-wrap` @mixin text-wrap {</p>

<pre>word-wrap: break-word !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-text-utilities {</p>
