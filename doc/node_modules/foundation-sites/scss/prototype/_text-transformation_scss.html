...
<title>_text-transformation.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_text-transformation.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-text-transformation ////</p>

<p>/// Responsive breakpoints for text transformation classes /// @type
Boolean $prototype-transformation-breakpoints:
$global-prototype-breakpoints !default;</p>

<p>/// Map containing all the `text-transformation` classes /// @type Map
...
<p>/// Text Transformation, by default coming through a map
`$prototype-text-transformation` /// @param {String} $transformation []
Text Transformation @mixin text-transform($transformation) {</p>

<pre>text-transform: $transformation !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-text-transformation {</p>

<pre>@each $transformation in $prototype-text-transformation {
  .text-#{$transformation} {
