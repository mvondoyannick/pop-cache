...
<title>_font-styling.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_font-styling.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-font-styling ////</p>

<p>/// Responsive breakpoints for font styling types /// @type Boolean
$prototype-font-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Letter spacing for `.font-wide` /// @type Number
$prototype-wide-letter-spacing: rem-calc(4) !default;</p>

<p>/// Default weight for `.font-normal`, defaulted to `global-weight-normal`
/// @type Number $prototype-font-normal: $global-weight-normal !default;</p>

<p>/// Default weight for `.font-bold`, defaulted to `global-weight-bold` ///
@type Number $prototype-font-bold: $global-weight-bold !default;</p>

<p>/// Font wide letter spacing! /// @param {Number} $letter-spacing
[$prototype-wide-letter-spacing] Wide letter spacing for the font @mixin
font-wide(</p>

<pre>$letter-spacing: $prototype-wide-letter-spacing</pre>

<p>) {</p>

<pre>letter-spacing: $letter-spacing;</pre>

<p>}</p>

<p>/// Font Weight Normal, default value coming through `global-weight-normal`
/// @param {Number} $weight [$prototype-font-normal] Weight of the font
(normal) @mixin font-normal(</p>

<pre>$weight: $prototype-font-normal</pre>

<p>) {</p>

<pre>font-weight: $weight;</pre>

<p>}</p>

<p>/// Font Weight Bold, default value coming through `global-weight-bold` ///
@param {Number} $weight [$prototype-font-bold] Weight of the font (bold)
@mixin font-bold(</p>

<pre>$weight: $prototype-font-bold</pre>
...
<p>/// Font Style Italic @mixin font-italic {</p>

<pre>font-style: italic !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-font-styling {</p>
