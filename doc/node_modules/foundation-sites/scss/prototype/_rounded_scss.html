...
<title>_rounded.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_rounded.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-rounded ////</p>

<p>/// Responsive breakpoints for rounded utility. /// @type Boolean
$prototype-rounded-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Default value for `prototype-border-radius` /// @type Number
$prototype-border-radius: rem-calc(3) !default;</p>

<p>/// Rounded utility (all corners): Adds radius corners (all corners) to an
element by default. /// @param {Number} $radius [$prototype-border-radius]
Border radius (all corners) @mixin border-radius(</p>

<pre>$radius: $prototype-border-radius</pre>

<p>) {</p>

<pre>border-radius: $radius;</pre>

<p>}</p>

<p>/// Rounded square utility or rectangle utility (all corners): Rounds all
corners to an element by default to make a pill shape. @mixin
border-rounded {</p>

<pre>border-radius: 5000px !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-rounded {</p>
