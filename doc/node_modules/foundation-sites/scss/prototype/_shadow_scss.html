...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_shadow.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-shadow ////</p>

<p>/// Responsive breakpoints for shadow utility. /// @type Boolean
$prototype-shadow-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Default value for `prototype-box-shadow` /// @type Number
$prototype-box-shadow: 0 2px 5px 0 rgba(0,0,0,.16),</p>

<pre>0 2px 10px 0 rgba(0,0,0,.12) !default;</pre>

<p>/// Shadow Utility: Adds a light box shadow to an element by default. ///
@param {Number} $shadow [$prototype-box-shadow] Box Shadow of a component
@mixin shadow(</p>

<pre>$shadow: $prototype-box-shadow</pre>

<p>) {</p>

<pre>box-shadow: $shadow;</pre>

<p>}</p>

<p>@mixin foundation-prototype-shadow {</p>
