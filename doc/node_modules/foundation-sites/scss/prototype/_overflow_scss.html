...
<title>_overflow.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_overflow.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-overflow ////</p>

<p>/// Responsive breakpoints for overflow helper classes /// @type Boolean
$prototype-overflow-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Map containing all the `overflow` classes /// @type Map
...
<p>/// Overflow classes, by default coming through a map `$prototype-overflow`
/// @param {String} $overflow [] Overflow classes @mixin
overflow($overflow) {</p>

<pre>overflow: $overflow !important;</pre>

<p>}</p>

<p>/// Overflow classes on horizontal axis, by default coming through a map
`$prototype-overflow` /// @param {String} $overflow [] Overflow classes
(horizontal axis) @mixin overflow-x($overflow) {</p>

<pre>overflow-x: $overflow !important;</pre>

<p>}</p>

<p>/// Overflow classes on vertical axis, by default coming through a map
`$prototype-overflow` /// @param {String} $overflow [] Overflow classes
(vertical axis) @mixin overflow-y($overflow) {</p>

<pre>overflow-y: $overflow !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-overflow {</p>

<pre>@each $overflow in $prototype-overflow {
  .overflow-#{$overflow} {
