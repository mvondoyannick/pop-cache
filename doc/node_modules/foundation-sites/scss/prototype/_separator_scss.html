...
<title>_separator.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_separator.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-separator ////</p>

<p>/// Responsive breakpoints for separator. /// @type Boolean
$prototype-separator-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Default alignment of a separator. /// @type String
$prototype-separator-align: center !default;</p>

<p>/// Height of a separator. /// @type Number $prototype-separator-height:
rem-calc(2) !default;</p>

<p>/// Width of a separator. /// @type Number $prototype-separator-width: 3rem
!default;</p>

<p>/// Default color of a separator. /// @type Color
$prototype-separator-background: $primary-color !default;</p>

<p>/// Top Margin of a separator. /// @type Number
$prototype-separator-margin-top: $global-margin !default;</p>

<p>/// Title separator Utility, mostly used to style the main heading of a
section /// @param {String} $align [$prototype-separator-align] - separator
Alignment /// @param {Number} $height [$prototype-separator-height] - Width
/// @param {Number} $width [$prototype-separator-width] - Height /// @param
{Color} $background [$prototype-separator-background] - Background ///
@param {Number} $top [$prototype-separator-margin-top] - Margin Top @mixin
separator (</p>

<pre>$align: $prototype-separator-align,
$height: $prototype-separator-height,
$width: $prototype-separator-width,
$background: $prototype-separator-background,
$top: $prototype-separator-margin-top</pre>

<p>) {</p>

<pre>text-align: $align !important;
      @include clearfix;
...
<p>@mixin foundation-prototype-separator {</p>

<pre>      .separator-center {
