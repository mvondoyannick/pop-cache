...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_rotate.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-rotate ////</p>

<p>/// Rotate Mixin: Rotate an element to a certain deg /// @param {Number}
$deg[] Degree of rotation @mixin rotate($deg) {</p>

<pre>transform:rotate($deg + deg);</pre>

<p>}</p>

<p>/// RotateX Mixin: Rotate an element to a certain deg on X-Axis /// @param
{Number} $deg[] Degree of rotation @mixin rotateX($deg) {</p>

<pre>transform:rotateX($deg + deg);</pre>

<p>}</p>

<p>/// RotateY Mixin: Rotate an element to a certain deg on Y-Axis /// @param
{Number} $deg[] Degree of rotation @mixin rotateY($deg) {</p>

<pre>transform:rotateY($deg + deg);</pre>

<p>}</p>

<p>/// RotateZ Mixin: Rotate an element to a certain deg on Z-Axis /// @param
{Number} $deg[] Degree of rotation @mixin rotateZ($deg) {</p>

<pre>transform:rotateZ($deg + deg);</pre>
