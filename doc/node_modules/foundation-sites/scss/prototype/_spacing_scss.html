...
<title>_spacing.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_spacing.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-spacing ////</p>

<p>/// Responsive breakpoints for spacing classes (margin and padding) ///
@type Boolean $prototype-spacing-breakpoints: $global-prototype-breakpoints
!default;</p>

<p>/// Default number of spacers count (margin and padding) /// @type Number
$prototype-spacers-count: 3 !default;</p>

<p>/// Margin helper mixin, all the values are multiplied by `$global-margin`
which by default is equal to `1rem` /// @param {Number} $top [null] -
Margin Top /// @param {Number} $right [null] - Margin Right /// @param
{Number} $bottom [null] - Margin Bottom /// @param {Number} $left [null] -
Margin Left @mixin margin(</p>
...
<p>/// Padding helper mixin, all the values are multiplied by
`$global-padding` which by default is equal to `1rem` /// @param {Number}
$top [null] - Padding Top /// @param {Number} $right [null] - Padding Right
/// @param {Number} $bottom [null] - Padding Bottom /// @param {Number}
$left [null] - Padding Left @mixin padding(</p>
...
<p>/// Margin classes for specific direction properties /// @param {String}
$dir [] Direction /// @param {Number} $spacer [] Spacer @mixin
margin-direction($dir, $spacer) {</p>
...
<p>/// Padding classes for specific direction properties /// @param {String}
$dir [] Direction /// @param {Number} $spacer [] Spacer @mixin
padding-direction($dir, $spacer) {</p>
...
<p>@mixin foundation-prototype-spacing {</p>

<pre>@for $spacer from 0 through $prototype-spacers-count {
