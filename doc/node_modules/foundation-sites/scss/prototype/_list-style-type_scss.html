...
<title>_list-style-type.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_list-style-type.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-list-style-type ////</p>

<p>/// Responsive breakpoints for list styling types /// @type Boolean
$prototype-list-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Map containing all the `style-type-unordered` classes /// @type Map
...
<p>/// Map containing all the `style-type-ordered` classes /// @type Map
$prototype-style-type-ordered: (</p>
...
<p>/// Style type for unordered Lists, by default coming through a map
`$prototype-style-type-unordered` /// @param {String} $style-type-unordered
[] Style type for unordered Lists @mixin
style-type-unordered($style-type-unordered) {</p>

<pre>list-style-type: $style-type-unordered !important;</pre>

<p>}</p>

<p>/// Style type for ordered Lists, by default coming through a map
`$prototype-style-type-ordered` /// @param {String} $style-type-ordered []
Style type for ordered Lists @mixin style-type-ordered($style-type-ordered)
{</p>

<pre>list-style-type: $style-type-ordered !important;</pre>

<p>}</p>

<p>@mixin list-unordered {</p>

<pre>@each $style-type-unordered in $prototype-style-type-unordered {
...
<p>@mixin list-ordered {</p>

<pre>@each $style-type-ordered in $prototype-style-type-ordered {
...
<p>@mixin foundation-prototype-list-style-type {</p>

<pre>@include list-unordered;
@include list-ordered;</pre>
