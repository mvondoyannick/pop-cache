...
<title>_arrow.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_arrow.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-arrow ////</p>

<p>/// Map containing all the `arrow` direction /// @type Map
$prototype-arrow-directions: (</p>
...
<p>/// Width of the Arrow, `0.4375rem` by default. /// @type Number
$prototype-arrow-size: 0.4375rem;</p>

<p>/// Color of the Arrow, `$black` by default. /// @type Color
$prototype-arrow-color: $black;</p>

<p>@mixin foundation-prototype-arrow {</p>

<pre>@each $prototype-arrow-direction in $prototype-arrow-directions {
