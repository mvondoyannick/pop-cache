...
<title>_text-decoration.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_text-decoration.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-text-decoration ////</p>

<p>/// Responsive breakpoints for text decoration classes /// @type Boolean
$prototype-decoration-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Map containing all the `text-decoration` classes /// @type Map
...
<p>/// Text Decoration, by default coming through a map
`$prototype-text-decoration` /// @param {String} $decoration [] Text
Decoration @mixin text-decoration($decoration) {</p>

<pre>text-decoration: $decoration !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-text-decoration {</p>

<pre>@each $decoration in $prototype-text-decoration {
  .text-#{$decoration} {
