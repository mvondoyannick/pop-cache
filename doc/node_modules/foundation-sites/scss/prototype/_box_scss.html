...
<title>_box.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_box.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-box ////</p>

<p>/// Box Mixin: Easily create a square, rectangle or a circle /// @param
{Number} $width[] Width of the box /// @param {Number} $<a
href="$width">height</a> Height of the box, defaults to `$width` to easily
make a square /// @param {Boolean} $<a href="false">circle</a> Makes the
box a circle, by default `false`. @mixin box(</p>
