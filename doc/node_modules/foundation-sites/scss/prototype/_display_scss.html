...
<title>_display.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/prototype/_display.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group prototype-display ////</p>

<p>/// Responsive breakpoints for display classes /// @type Boolean
$prototype-display-breakpoints: $global-prototype-breakpoints !default;</p>

<p>/// Map containing all the `display` classes /// @type Map
$prototype-display: (</p>
...
<p>/// Display classes, by default coming through a map `$prototype-display`
/// @param {String} $display [] Display classes @mixin display($display) {</p>

<pre>display: $display !important;</pre>

<p>}</p>

<p>@mixin foundation-prototype-display {</p>

<pre>@each $display in $prototype-display {
  .display-#{$display} {
