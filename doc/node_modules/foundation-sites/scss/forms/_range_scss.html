...
<title>_range.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_range.scss">
...
<p>/// Default height of the slider. /// @type Number $slider-height: 0.5rem
!default;</p>

<p>/// Default background color of the slider&#39;s track. /// @type Color
$slider-background: $light-gray !default;</p>

<p>/// Default color of the active fill color of the slider. /// @type Color
$slider-fill-background: $medium-gray !default;</p>

<p>/// Default height of the handle of the slider. /// @type Number
$slider-handle-height: 1.4rem !default;</p>

<p>/// Default width of the handle of the slider. /// @type Number
$slider-handle-width: 1.4rem !default;</p>

<p>/// Default color of the handle for the slider. /// @type Color
$slider-handle-background: $primary-color !default;</p>

<p>/// Default fade amount of a disabled slider. /// @type Number
$slider-opacity-disabled: 0.25 !default;</p>

<p>/// Default radius for slider. /// @type Number $slider-radius:
$global-radius !default;</p>

<p>@mixin foundation-range-input {</p>

<pre>input[type=&#39;range&#39;] {  // sass-lint:disable-line no-qualifying-elements
