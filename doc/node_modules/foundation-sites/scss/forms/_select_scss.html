...
<title>_select.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_select.scss">
...
<p>/// Background color for select menus. /// @type Color $select-background:
$white !default;</p>

<p>/// Color of the dropdown triangle inside select menus. Set to
`transparent` to remove it entirely. /// @type Color
$select-triangle-color: $dark-gray !default;</p>

<p>/// Default radius for select menus. /// @type Color $select-radius:
$global-radius !default;</p>

<p>@mixin form-select {</p>
...
<p>@mixin foundation-form-select {</p>
