...
<title>_error.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_error.scss">
...
<p>/// Sets if error styles should be added to inputs. /// @type Boolean
$abide-inputs: true !default;</p>

<p>/// Sets if error styles should be added to labels. /// @type Boolean
$abide-labels: true !default;</p>

<p>/// Background color to use for invalid text inputs. /// @type Color
$input-background-invalid: get-color(alert) !default;</p>

<p>/// Color to use for labels of invalid inputs. /// @type Color
$form-label-color-invalid: get-color(alert) !default;</p>

<p>/// Default font color for form error text. /// @type Color
$input-error-color: get-color(alert) !default;</p>

<p>/// Default font size for form error text. /// @type Number
$input-error-font-size: rem-calc(12) !default;</p>

<p>/// Default font weight for form error text. /// @type Keyword
$input-error-font-weight: $global-weight-bold !default;</p>

<p>/// Styles the background and border of an input field to have an error
state. /// /// @param {Color} $background [$alert-color] - Color to use for
the background and border. /// @param {Number} $background-lighten [10%] -
Lightness level of the background color. @mixin form-input-error(</p>

<pre>$background: $input-background-invalid,
$background-lighten: 10%</pre>
...
<p>/// Adds error styles to a form element, using the values in the settings
file. @mixin form-error {</p>
...
color: $input-error-color;</pre>

<p>}</p>

<p>@mixin foundation-form-error {</p>
