...
<title>_progress.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_progress.scss">

<p>// Foundation for Sites by ZURB // foundation.zurb.com // Licensed under
MIT Open Source</p>

<p>//// /// @group progress-bar ////</p>

<p>/// Height of a progress bar. /// @type Number $progress-height: 1rem
!default;</p>

<p>/// Background color of a progress bar. /// @type Color
$progress-background: $medium-gray !default;</p>

<p>/// Bottom margin of a progress bar. /// @type Number
$progress-margin-bottom: $global-margin !default;</p>

<p>/// Default color of a progress bar&#39;s meter. /// @type Color
$progress-meter-background: $primary-color !default;</p>

<p>/// Default radius of a progress bar. /// @type Number $progress-radius:
$global-radius !default;</p>

<p>@mixin foundation-progress-element {</p>
