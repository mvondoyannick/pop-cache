...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_label.scss">
...
<p>/// Color for form labels. /// @type Color $form-label-color: $black
!default;</p>

<p>/// Font size for form labels. /// @type Number $form-label-font-size:
rem-calc(14) !default;</p>

<p>/// Font weight for form labels. /// @type Keyword $form-label-font-weight:
$global-weight-normal !default;</p>

<p>/// Line height for form labels. The higher the number, the more space
between the label and its input field. /// @type Number
$form-label-line-height: 1.8 !default;</p>

<p>@mixin form-label {</p>
...
color: $form-label-color;</pre>

<p>}</p>

<p>@mixin form-label-middle {</p>

<pre>$input-border-width: get-border-value($input-border, width);

margin: 0 0 $form-spacing;
padding: ($form-spacing / 2 + rem-calc($input-border-width)) 0;</pre>

<p>}</p>

<p>@mixin foundation-form-label {</p>
