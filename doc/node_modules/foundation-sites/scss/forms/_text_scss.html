...
<title>_text.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_text.scss">
...
<p>/// Font color of text inputs. /// @type Color $input-color: $black
!default;</p>

<p>/// Font color of placeholder text within text inputs. /// @type Color
$input-placeholder-color: $medium-gray !default;</p>

<p>/// Font family of text inputs. /// @type Font $input-font-family: inherit
!default;</p>

<p>/// Font size of text inputs. /// @type Number $input-font-size:
rem-calc(16) !default;</p>

<p>/// Font weight of text inputs. /// @type Keyword $input-font-weight:
$global-weight-normal !default;</p>

<p>/// Line height of text inputs. /// @type Keyword $input-line-height:
$global-lineheight !default;</p>

<p>/// Background color of text inputs. /// @type Color $input-background:
$white !default;</p>

<p>/// Background color of focused of text inputs. /// @type Color
$input-background-focus: $white !default;</p>

<p>/// Background color of disabled text inputs. /// @type Color
$input-background-disabled: $light-gray !default;</p>

<p>/// Border around text inputs. /// @type Border $input-border: 1px solid
$medium-gray !default;</p>

<p>/// Border around focused text inputs. /// @type Color $input-border-focus:
1px solid $dark-gray !default;</p>

<p>/// Padding of text inputs. /// @type Color $input-padding: $form-spacing /
2 !default;</p>

<p>/// Box shadow inside text inputs when not focused. /// @type Shadow
$input-shadow: inset 0 1px 2px rgba($black, 0.1) !default;</p>

<p>/// Box shadow outside text inputs when focused. /// @type Shadow
$input-shadow-focus: 0 0 5px $medium-gray !default;</p>

<p>/// Cursor to use when hovering over a disabled text input. /// @type
Cursor $input-cursor-disabled: not-allowed !default;</p>

<p>/// Properties to transition on text inputs. /// @type Transition
$input-transition: box-shadow 0.5s, border-color 0.25s ease-in-out
!default;</p>

<p>/// Enables the up/down buttons that Chrome and Firefox add to `&lt;input
type=&#39;number&#39;&gt;` elements. /// @type Boolean
$input-number-spinners: true !default;</p>

<p>/// Radius for text inputs. /// @type Border $input-radius: $global-radius
!default;</p>

<p>/// Border radius for form buttons, defaulted to global-radius. /// @type
Number $form-button-radius: $global-radius !default;</p>

<p>@mixin form-element {</p>

<pre>$height: ($input-font-size * unitless-calc($input-line-height)) + (get-side($input-padding, &#39;top&#39;) + get-side($input-padding, &#39;bottom&#39;)) - rem-calc(1);
...
<p>@mixin foundation-form-text {</p>
