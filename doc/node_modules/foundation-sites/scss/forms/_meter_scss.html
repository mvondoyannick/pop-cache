...
<title>_meter.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_meter.scss">
...
<p>/// Height of a `&lt;meter&gt;` element. /// @type Length $meter-height:
1rem !default;</p>

<p>/// Border radius of a `&lt;meter&gt;` element. /// @type Length
$meter-radius: $global-radius !default;</p>

<p>/// Background color of a `&lt;meter&gt;` element. /// @type Color
$meter-background: $medium-gray !default;</p>

<p>/// Meter fill for an optimal value in a `&lt;meter&gt;` element. /// @type
Color $meter-fill-good: $success-color !default;</p>

<p>/// Meter fill for an average value in a `&lt;meter&gt;` element. /// @type
Color $meter-fill-medium: $warning-color !default;</p>

<p>/// Meter fill for a suboptimal value in a `&lt;meter&gt;` element. ///
@type Color $meter-fill-bad: $alert-color !default;</p>

<p>@mixin foundation-meter-element {</p>
