...
<title>_fieldset.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_fieldset.scss">
...
<p>/// Default border around custom fieldsets. /// @type Border
$fieldset-border: 1px solid $medium-gray !default;</p>

<p>/// Default padding inside custom fieldsets. /// @type Number
$fieldset-padding: rem-calc(20) !default;</p>

<p>/// Default margin around custom fieldsets. /// @type Number
$fieldset-margin: rem-calc(18 0) !default;</p>

<p>/// Default padding between the legend text and fieldset border. /// @type
Number $legend-padding: rem-calc(0 3) !default;</p>

<p>@mixin fieldset {</p>

<pre>margin: $fieldset-margin;
...
<p>@mixin foundation-form-fieldset {</p>
