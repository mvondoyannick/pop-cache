...
<main role="main" aria-label="Page node_modules/foundation-sites/scss/forms/_input-group.scss">
...
<p>/// Color of labels prefixed to an input. /// @type Color
$input-prefix-color: $black !default;</p>

<p>/// Background color of labels prefixed to an input. /// @type Color
$input-prefix-background: $light-gray !default;</p>

<p>/// Border around labels prefixed to an input. /// @type Border
$input-prefix-border: 1px solid $medium-gray !default;</p>

<p>/// Left/right padding of an pre/postfixed input label
$input-prefix-padding: 1rem !default;</p>

<p>@mixin foundation-form-prepostfix {</p>

<pre>$height: ($input-font-size * $input-line-height) + (get-side($input-padding, &#39;top&#39;) + get-side($input-padding, &#39;bottom&#39;)) - rem-calc(1);
