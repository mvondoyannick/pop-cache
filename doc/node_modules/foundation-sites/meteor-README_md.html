...
<title>meteor-README - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Foundation+for+Sites+-28v6.5.3-29"><a href="http://foundation.zurb.com">Foundation for Sites</a> (v6.5.3)</a>
    <li><a href="#label-Usage+in+Meteor">Usage in Meteor</a>
    <li><a href="#label-Scss+Guide">Scss Guide</a>
    <li><a href="#label-1.+Add+the+package">1. Add the package</a>
    <li><a href="#label-2.+In+your+main+.scss+file+-28in+your+app-29-3A">2. In your main .scss file (in your app):</a>
    <li><a href="#label-3.+Overwrite+Foundation+settings">3. Overwrite Foundation settings</a>
    <li><a href="#label-JavaScript+Guide">JavaScript Guide</a>
    <li><a href="#label-HTML+part">HTML part</a>
    <li><a href="#label-JavaScript+part">JavaScript part</a>
    <li><a href="#label-Known+problems">Known problems</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/foundation-sites/meteor-README.md">

<h1 id="label-Foundation+for+Sites+-28v6.5.3-29"><a href="http://foundation.zurb.com">Foundation for Sites</a> (v6.5.3)<span><a href="#label-Foundation+for+Sites+-28v6.5.3-29">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Foundation is the most advanced responsive front-end framework in the
world. Quickly go from prototype to production, building sites or apps that
work on any kind of device with Foundation. Includes layout constructs,
like a fully customizable, responsive grid, commonly used JavaScript
plugins, and full A11Y support.</p>

<h2 id="label-Usage+in+Meteor">Usage in Meteor<span><a href="#label-Usage+in+Meteor">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p><a href="meteor-README.md/#scss-guide">Scss guide</a></p>
</li><li>
<p><a href="meteor-README.md/#javascript-guide">JavaScript guide</a></p>
</li></ul>

<h2 id="label-Scss+Guide">Scss Guide<span><a href="#label-Scss+Guide">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-1.+Add+the+package">1. Add the package<span><a href="#label-1.+Add+the+package">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre class="ruby"><span class="ruby-identifier">meteor</span> <span class="ruby-identifier">add</span> <span class="ruby-value">zurb:</span><span class="ruby-identifier">foundation</span><span class="ruby-operator">-</span><span class="ruby-identifier">sites</span>
</pre>

<h3 id="label-2.+In+your+main+.scss+file+-28in+your+app-29-3A">2. In your main .scss file (in your app):<span><a href="#label-2.+In+your+main+.scss+file+-28in+your+app-29-3A">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Import foundation:</p>

<pre>@import &#39;{zurb:foundation-sites}/scss/foundation&#39;;</pre>

<p>Each component has an export mixin which prints out the CSS for that
component. If you&#39;re cool with having everything, you just need one
line of code:</p>

<pre>@include foundation-everything;</pre>

<p>Or you can comment out the components you don&#39;t need:</p>
...
<p>Note: For now there is a Motion-UI library added in the package (css, js
files). It is needed for some Foundation plugins. Maybe in the future it
will be separated package.</p>

<h3 id="label-3.+Overwrite+Foundation+settings">3. Overwrite Foundation settings<span><a href="#label-3.+Overwrite+Foundation+settings">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you want you can copy <code>_settings.scss</code> file into your
project. You can change settings and import it in your main .scss file (in
your app):</p>

<pre>@import &#39;settings&#39;; // example when the _settings.scss file is in the same folder as your main .scss file
@import &#39;{zurb:foundation-sites}/scss/foundation&#39;;

@include foundation-everything; // or individual ones</pre>

<p><strong>Important:</strong> In the _settings.scss (the copied one in your
app) you need to replace <code>@import &#39;util/util&#39;</code> with
<code>@import &#39;{zurb:foundation-sites}/scss/util/util&#39;</code></p>

<h2 id="label-JavaScript+Guide">JavaScript Guide<span><a href="#label-JavaScript+Guide">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>You can use <code>$(document).foundation()</code> when you want to
initialize some plugins in one Meteor Template. You could do something
like:</p>
...
<p><strong>But in Meteor it is better to have more control over it. So, you
could use Foundation plugins API.</strong></p>

<p>Let&#39;s take a look at the example with the Reveal plugin.</p>

<h4 id="label-HTML+part">HTML part<span><a href="#label-HTML+part">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;body&gt;
  {{&gt; myReveal}}
&lt;/body&gt;</pre>

<pre>&lt;template name=&quot;myReveal&quot;&gt;
...
<h4 id="label-JavaScript+part">JavaScript part<span><a href="#label-JavaScript+part">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>Template.myReveal.onRendered(function () {
...
<p>As you can see it is better to create small templates for plugins and
initiate the plugins separately in the <code>onRendered</code> lifecycle
hook. You should also remember to destroy the plugin using
<code>onDestroyed</code>lifecycle hook on its template.</p>

<p>You will find more info about particular plugins on its docs page here: <a
href="http://foundation.zurb.com/sites/docs/">foundation.zurb.com/sites/docs/</a></p>

<h4 id="label-Known+problems">Known problems<span><a href="#label-Known+problems">&para;</a> <a href="#top">&uarr;</a></span></h4>
<ol><li>
<p><strong>Conflicts with Meteor events</strong>. Solution: Try to always wrap
Foundation&#39;s DOM nodes into another ones in your Meteor templates. This
applies only to nodes on which are initialized Foundation&#39;s JS plugins
and which are the first nodes in the Meteor templates with attached custom
Meteor events. For more details read the last comments here: <a
href="https://github.com/zurb/foundation-sites/issues/7248">#7248</a></p>
</li></ol>
</main>
