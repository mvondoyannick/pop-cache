...
<title>effects.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/visual/effects/effects.js">

<p>var duration = 1000,</p>

<pre class="ruby"><span class="ruby-identifier">wait</span> = <span class="ruby-value">500</span>;
</pre>

<p>function effect( elem, name, options ) {</p>
...
<p>effect( “#blindLeft”, “blind”, { direction: “left” } ); effect( “#blindUp”,
“blind”, { direction: “up” } ); effect( “#blindRight”, “blind”, {
direction: “right” } ); effect( “#blindDown”, “blind”, { direction: “down”
} );</p>

<p>effect( “#bounce3times”, “bounce”, { times: 3 } );</p>

<p>effect( “#clipHorizontally”, “clip”, { direction: “horizontal” } ); effect(
“#clipVertically”, “clip”, { direction: “vertical” } );</p>

<p>effect( “#dropDown”, “drop”, { direction: “down” } ); effect( “#dropUp”,
“drop”, { direction: “up” } ); effect( “#dropLeft”, “drop”, { direction:
“left” } ); effect( “#dropRight”, “drop”, { direction: “right” } );</p>

<p>effect( “#explode9”, “explode”, {} ); effect( “#explode36”, “explode”, {
pieces: 36 } );</p>

<p>effect( “#fade”, “fade”, {} );</p>

<p>effect( “#fold”, “fold”, { size: 50 } );</p>

<p>effect( “#highlight”, “highlight”, {} );</p>

<p>effect( “#pulsate”, “pulsate”, { times: 2 } );</p>

<p>effect( “#puff”, “puff”, {} ); effect( “#scale”, “scale”, {} ); effect(
“#size”, “size”, {} ); $( “#sizeToggle” ).on( “click”, function() {</p>

<pre>var options = { to: { width: 300, height: 300 } };
$( this )
        .addClass( &quot;current&quot; )
...
<p>effect( “#slideDown”, “slide”, { direction: “down” } ); effect( “#slideUp”,
“slide”, { direction: “up” } ); effect( “#slideLeft”, “slide”, { direction:
“left” } ); effect( “#slideRight”, “slide”, { direction: “right” } );</p>

<p>$( “#transfer” ).on( “click”, function() {</p>
...
<p>$( “#addClass” ).on( “click”, function() {</p>

<pre>$( this ).addClass( &quot;current&quot;, duration, function() {
        $( this ).removeClass( &quot;current&quot; );
} );</pre>

<p>} ); $( “#removeClass” ).on( “click”, function() {</p>

<pre>$( this ).addClass( &quot;current&quot; ).removeClass( &quot;current&quot;, duration );</pre>

<p>} ); $( “#toggleClass” ).on( “click”, function() {</p>

<pre>$( this ).toggleClass( &quot;current&quot;, duration );</pre>
