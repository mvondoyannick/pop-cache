...
<title>clip.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/visual/effects/clip.html">
...
<p>&lt;p&gt;WHAT: A set of elements with various positions and clips, using
the clip effect.&lt;/p&gt; &lt;p&gt;EXPECTED: When clicking “Toggle” or
“Effect Toggle”, to observe the same behavior; All elements should not
change position, aside from the expected clip animation. At the end of the
animation, the animated elements should hide. Layout (i.e. the position of
other elements) should not change until the animated elements are
hidden.&lt;/p&gt; &lt;p&gt;EXPECTED: Clicking “Toggle” or “Effect Toggle” a
second time reverses the animation, first showing all elements at their
original dimensions, and restoring them to their original state.&lt;/p&gt;
&lt;p&gt;EXPECTED: Clicking “Effect Default” should always perform a “hide”
animation.&lt;/p&gt; &lt;p&gt;EXPECTED: Clicking any of the buttons in
quick succession should queue the relevant animations.&lt;/p&gt;
&lt;p&gt;EXPECTED CANTFIX: In IE8, the clip animation jumps due to a bug
that causes .css(&#39;clip&#39;) to return undefined unless the clip
property is an inline style.&lt;/p&gt;</p>

<p>&lt;div class=“container”&gt;</p>

<pre>&lt;button class=&quot;toggle&quot;&gt;Toggle&lt;/button&gt;
...
&lt;p&gt;Doner salami jowl beef ribs. Pork chop beef short loin pork, kielbasa tail andouille salami sausage meatball short ribs t-bone tri-tip ham. Meatball short ribs prosciutto flank chicken fatback frankfurter brisket turducken. Corned beef hamburger swine short ribs pancetta. Jerky bresaola pork chuck spare ribs pastrami shoulder flank chicken leberkas beef.&lt;/p&gt;</pre>
