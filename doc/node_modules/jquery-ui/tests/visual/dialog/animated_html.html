...
<title>animated.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/visual/dialog/animated.html">
...
<p>&lt;p&gt;WHAT: A animated modal dialog, using blind effect to show, explode
to hide.&lt;/p&gt; &lt;p&gt;EXPECTED: Dialog shows up on top of the overlay
and stays there during and after the animation. Focus is set to the input
inside the dialog and stays there after the animation finishes.&lt;/p&gt;</p>

<p>&lt;div id=“dialog” title=“Are you sure?”&gt;</p>
