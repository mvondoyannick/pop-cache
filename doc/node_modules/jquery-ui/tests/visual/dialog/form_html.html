...
<title>form.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/visual/dialog/form.html">
...
<p>&lt;p&gt;WHAT: A modal dialog containing form fields, with groups to
describe each section. A second modal dialog with just an input and some
text markup.&lt;/p&gt; &lt;p&gt;EXPECTED: Dialog shows up, screenreader
reads the dialog&#39;s title, the word “dialog” (or equivalent), the text
before the first input (description of the first section) and the label of
the first, focused input. When tabbing to the next group, the screenreader
should announce the description of that group, along with the label of the
focused field.&lt;/p&gt; &lt;p&gt;For the second dialog, the behaviour
should be similar, except that the whole content is read as the description
of the dialog, likely causing the input&#39;s label to be read
twice.&lt;/p&gt; &lt;p&gt;NOTE: Using <code>fieldset</code> with
<code>legend</code> seems to have the same result as using
<code>role=&quot;group&quot;</code> and <code>aria-describedby</code>. The
latter needs an id-attribute, offers more flexibilty in markup order and
has no built-in styling.&lt;/p&gt;</p>

<p>&lt;div id=“form-dialog” title=“Profile Information”&gt;</p>
...
<p>&lt;button id=“open-form”&gt;Open Form Dialog&lt;/button&gt;</p>

<p>&lt;div id=“prompt-dialog” title=“Are you sure?”&gt;</p>

<pre>&lt;p&gt;Please enter password to continue.&lt;/p&gt;
&lt;label for=&quot;password&quot;&gt;Password&lt;/label&gt;&lt;input id=&quot;password&quot;&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;button id=“open-prompt”&gt;Open Prompt Dialog&lt;/button&gt;</p>
