...
<title>complex-dialogs.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/visual/dialog/complex-dialogs.html">
...
<p>&lt;p&gt;WHAT: A modal dialog opening another modal dialog (including a
datepicker), opening a non-modal dialog (including an autocomplete with
tooltip applied). A regular link on the page, outside of the
dialogs.&lt;/p&gt; &lt;p&gt;EXPECTED: As long as a modal dialog is open,
focus stays within the dialogs. Both mouse and keyboard interactions are
captured and restricted to the dialog. When the nested modal dialog is
open, the first modal dialog can&#39;t be interacted with, until the nested
dialog is closed. When the third dialog is open (not modal), switching
between the two dialogs is possible, both can be interacted with.&lt;/p&gt;</p>

<p>&lt;button id=“open-dialog”&gt;Reopen dialog&lt;/button&gt;</p>

<p>&lt;div id=“dialog” title=“Basic dialog, but with a really long title that
doesn&#39;t quite fit.”&gt;</p>

<pre>&lt;p&gt;This is the default dialog which is useful for displaying information. The dialog window can be moved, resized and closed with the &#39;x&#39; icon.&lt;/p&gt;
&lt;p&gt;&lt;button id=&quot;open-datepicker&quot;&gt;Open another window with a datepicker.&lt;/button&gt;&lt;/p&gt;
&lt;p&gt;&lt;button id=&quot;destroy-dialog&quot;&gt;Self destruct&lt;/button&gt;&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div id=“dialog-datepicker” title=“A dialog with a datepicker”&gt;</p>

<pre>&lt;p&gt;Date: &lt;input id=&quot;datepicker&quot;&gt;&lt;/p&gt;
&lt;p&gt;&lt;button id=&quot;open-autocomplete&quot; autofocus&gt;Open another window with an autocomplete and a tooltip.&lt;/button&gt;&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div id=“dialog-autocomplete”&gt;</p>

<pre>&lt;label for=&quot;autocomplete&quot;&gt;Tags: &lt;/label&gt;
&lt;input id=&quot;autocomplete&quot; title=&quot;Try typing something!&quot;&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;a href=“#”&gt;Outside link&lt;/a&gt;</p>
