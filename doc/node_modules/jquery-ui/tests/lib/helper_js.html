...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/lib/helper.js">
...
<p>exports.forceScrollableWindow = function( appendTo ) {</p>

<pre>// The main testable area is 10000x10000 so to enforce scrolling,
...
return $( &quot;&lt;div&gt;&quot; )
        ...
        .appendTo( appendTo || &quot;#qunit-fixture&quot; );</pre>

<p>};</p>

<p>exports.onFocus = function( element, onFocus ) {</p>

<pre>var fn = function( event ) {
...
element.on( &quot;focus&quot;, fn )[ 0 ].focus();</pre>
