...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/lib/css.js">

<p>( function() {</p>

<p>function includeStyle( url ) {</p>

<pre class="ruby"><span class="ruby-identifier">document</span>.<span class="ruby-identifier">write</span>( <span class="ruby-string">&quot;&lt;link rel=&#39;stylesheet&#39; href=&#39;../../../&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">url</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;&#39;&gt;&quot;</span> );
</pre>
...
<p>// Load the modules var modules = script.getAttribute( “data-modules” ); if
( modules ) {</p>

<pre>modules = modules.split( /\s+/ );
...
<p>// Load the QUnit stylesheet includeStyle( “external/qunit/qunit.css” );</p>
