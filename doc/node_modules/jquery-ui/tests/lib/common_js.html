...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/lib/common.js">
...
<p>function testWidgetDefaults( widget, defaults ) {</p>

<pre>var pluginDefaults = $.ui[ widget ].prototype.options;
...
<p>function testWidgetOverrides( widget ) {</p>

<pre>if ( $.uiBackCompat === false ) {
...
<p>function testBasicUsage( widget ) {</p>

<pre>QUnit.test( &quot;basic usage&quot;, function( assert ) {
        assert.expect( 3 );
...
<p>exports.testWidget = function( widget, settings ) {</p>

<pre>QUnit.module( widget + &quot;: common widget&quot; );
...
<p>exports.testJshint = function( module ) {</p>

<pre>// Function.prototype.bind check is needed because JSHint doesn&#39;t work in ES3 browsers anymore
