...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/lib/bootstrap.js">
...
<p>// Create a module that disables back compat for UI modules define(
“jquery-no-back-compat”, [ “jquery” ], function( $ ) {</p>

<pre>$.uiBackCompat = false;

return $;</pre>

<p>} );</p>

<p>// Create a dummy bridge if we&#39;re not actually testing in PhantomJS if
( !/PhantomJS/.test( navigator.userAgent ) ) {</p>

<pre class="ruby"><span class="ruby-identifier">define</span>( <span class="ruby-string">&quot;phantom-bridge&quot;</span>, <span class="ruby-identifier">function</span>() {} );
</pre>

<p>}</p>

<p>// Load all modules in series function requireModules( dependencies,
callback, modules ) {</p>

<pre>if ( !dependencies.length ) {
        if ( callback ) {
...
<p>// Load a set of test file along with the required test infrastructure
function requireTests( dependencies, noBackCompat ) {</p>
...
<p>// Parse the URL into key/value pairs function parseUrl() {</p>
...
<p>function jqueryUrl() {</p>

<pre>var version = parseUrl().jquery;
var url;
...
<p>// Load test modules based on data attributes // - data-modules: list of
test modules to load // - data-widget: A widget to load test modules for //
- Automatically loads common, core, events, methods, and options // -
data-deprecated: Loads the deprecated test modules for a widget // -
data-no-back-compat: Set $.uiBackCompat to false ( function() {</p>

<pre>// Find the script element
...
requireTests( modules, noBackCompat );</pre>
