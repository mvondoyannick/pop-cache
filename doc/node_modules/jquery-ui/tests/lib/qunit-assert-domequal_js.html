...
<title>qunit-assert-domequal.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/lib/qunit-assert-domequal.js">

<pre>Experimental assertion for comparing DOM objects.

Serializes an element and some properties and attributes and its children if any,
otherwise the text. Then compares the result using deepEqual().</pre>
...
<p>var domEqual = QUnit.assert.domEqual = function( selector, modifier,
message ) {</p>
...
<p>function extract( selector, message ) {</p>

<pre>var elem = $( selector );
if ( !elem.length ) {
