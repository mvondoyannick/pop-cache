...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/widget/core.js">
...
<p>QUnit.module( “widget factory”, {</p>
...
<p>common.testJshint( “widget” );</p>

<p>QUnit.test( “widget creation”, function( assert ) {</p>
...
assert.equal( $.ui.testWidget.prototype.option, $.Widget.prototype.option,
        &quot;option method copied over from base widget&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “element normalization”, function( assert ) {</p>

<pre>assert.expect( 11 );
var elem;
...
<p>QUnit.test( “custom selector expression”, function( assert ) {</p>
...
elem.testWidget( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “jQuery usage”, function( assert ) {</p>

<pre>assert.expect( 14 );
...
assert.equal( elem.testWidget( &quot;instance&quot; ), null );</pre>

<p>} );</p>

<p>QUnit.test( “direct usage”, function( assert ) {</p>
...
assert.equal( instance.getterSetterVal, 30, &quot;getter/setter can act as setter&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “error handling”, function( assert ) {</p>
...
<p>QUnit.test( “merge multiple option arguments”, function( assert ) {</p>
...
<p>QUnit.test( “._getCreateOptions()”, function( assert ) {</p>
...
$( &quot;&lt;div&gt;&quot; ).testWidget( { option2: &quot;value2&quot; } );</pre>

<p>} );</p>

<p>QUnit.test( “._getCreateEventData()”, function( assert ) {</p>
...
<p>QUnit.test( “re-init”, function( assert ) {</p>
...
actions = [];
div.testWidget( { foo: &quot;bar&quot; } );
assert.deepEqual( actions, [ &quot;optionfoo&quot;, &quot;init&quot; ], &quot;correct methods called on re-init with options&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “redeclare”, function( assert ) {</p>
...
$.widget( &quot;ui.testWidget&quot;, {} );
assert.equal( $.ui.testWidget.prototype.widgetEventPrefix, &quot;testWidget&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “inheritance”, function( assert ) {</p>
...
delete $.fn.testWidgetExtension;</pre>

<p>} );</p>

<p>QUnit.test( “._super()”, function( assert ) {</p>
...
delete $.fn.testWidget2;</pre>

<p>} );</p>

<p>QUnit.test( “._superApply()”, function( assert ) {</p>
...
<p>QUnit.test( “mixins”, function( assert ) {</p>
...
assert.strictEqual( mixin2.bar, existingBar, &quot;Changes to a prototype don&#39;t change the mixin&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “mixins with inheritance”, function( assert ) {</p>
...
<p>QUnit.test( “.option() - getter”, function( assert ) {</p>
...
assert.deepEqual( div.testWidget( &quot;option&quot;, &quot;foo&quot; ), &quot;bar&quot;,
        &quot;modifying returned options hash does not modify plugin instance&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.option() - deep option getter”, function( assert ) {</p>
...
assert.equal( div.testWidget( &quot;option&quot;, &quot;foo.x.y&quot; ), null, &quot;one level deep - non-existent&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.option() - delegate to ._setOptions()”, function( assert ) {</p>
...
assert.deepEqual( calls, [ { bar: &quot;qux&quot;, quux: &quot;quuux&quot; } ],
        &quot;_setOptions called with multiple options&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.option() - delegate to ._setOption()”, function( assert ) {</p>
...
assert.deepEqual( calls, [
        { key: &quot;bar&quot;, val: &quot;qux&quot; },
        { key: &quot;quux&quot;, val: &quot;quuux&quot; }
], &quot;_setOption called with multiple options&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.option() - deep option setter”, function( assert ) {</p>
...
deepOption(
        ...
        &quot;add property&quot; );
div.testWidget( &quot;option&quot;, &quot;foo.qux.newOpt&quot;, &quot;newVal&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.enable()”, function( assert ) {</p>
...
$( &quot;&lt;div&gt;&quot; ).testWidget().testWidget( &quot;enable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.disable()”, function( assert ) {</p>
...
$( &quot;&lt;div&gt;&quot; ).testWidget().testWidget( &quot;disable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._setOptionDisabled()”, function( assert ) {</p>
...
widget.testWidget( &quot;option&quot;, &quot;disabled&quot;, true );</pre>

<p>} );</p>

<p>QUnit.test( “.widget() - base”, function( assert ) {</p>
...
assert.deepEqual( constructor, $.ui.testWidget, &quot;$.widget returns the constructor&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.widget() - overriden”, function( assert ) {</p>
...
assert.deepEqual( wrapper[ 0 ], $( &quot;&lt;div&gt;&quot; ).testWidget().testWidget( &quot;widget&quot; )[ 0 ] );</pre>

<p>} );</p>

<p>QUnit.test( “.instance()”, function( assert ) {</p>
...
assert.equal( $().testWidget( &quot;instance&quot; ), undefined, &quot;empty set&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._on() to element (default)”, function( assert ) {</p>
...
<p>QUnit.test( “._on() to element with suppressDisabledCheck”, function(
assert ) {</p>
...
<p>QUnit.test( “._on() to descendent”, function( assert ) {</p>
...
<p>QUnit.test( “_on() with delegate”, function( assert ) {</p>
...
<p>QUnit.test( “_on() with delegate to descendent”, function( assert ) {</p>
...
<p>QUnit.test( “_on() to common element”, function( assert ) {</p>
...
$( document ).trigger( &quot;with-dashes:and-colons&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “_off() - single event”, function( assert ) {</p>
...
element.trigger( &quot;foo&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “_off() - multiple events”, function( assert ) {</p>
...
element.trigger( &quot;foo&quot; );
element.trigger( &quot;bar&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “_off() - all events”, function( assert ) {</p>
...
<p>QUnit.test( “._hoverable()”, function( assert ) {</p>
...
div.trigger( &quot;mouseenter&quot; );
assert.lacksClasses( div, &quot;ui-state-hover&quot;, &quot;event handler removed on destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._focusable()”, function( assert ) {</p>
...
div.trigger( &quot;focusin&quot; );
assert.lacksClasses( div, &quot;ui-state-focus&quot;, &quot;event handler removed on destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._trigger() - no event, no ui”, function( assert ) {</p>
...
$( document ).off( &quot;testwidgetfoo&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._trigger() - cancelled event”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#widget&quot; ).testWidget( &quot;instance&quot; )._trigger( &quot;foo&quot; ), false,
        &quot;_trigger returns false when event is cancelled&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._trigger() - cancelled callback”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#widget&quot; ).testWidget( &quot;instance&quot; )._trigger( &quot;foo&quot; ), false,
        &quot;_trigger returns false when callback returns false&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._trigger() - provide event and ui”, function( assert ) {</p>
...
.testWidget( &quot;testEvent&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “._trigger() - array as ui”, function( assert ) {</p>

<pre>// #6795 - Widget: handle array arguments to _trigger consistently
assert.expect( 4 );
...
<p>QUnit.test( “._trigger() - instance as element”, function( assert ) {</p>
...
instance.testEvent();</pre>

<p>} );</p>

<p>( function() {</p>

<pre>function shouldDestroy( assert, expected, callback ) {
        assert.expect( 1 );
        var destroyed = false;
        $.widget( &quot;ui.testWidget&quot;, {
                _create: function() {},
...
<p>QUnit.test( “redefine”, function( assert ) {</p>
...
instance.method( &quot;foo&quot; );
assert.equal( $.ui.testWidget.foo, &quot;bar&quot;, &quot;static properties remain&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “redefine deep prototype chain”, function( assert ) {</p>
...
<p>QUnit.test( “redefine - widgetEventPrefix”, function( assert ) {</p>
...
$.widget( &quot;ui.testWidget&quot;, $.ui.testWidget, {} );
assert.equal( $.ui.testWidget.prototype.widgetEventPrefix, &quot;test&quot;,
        &quot;cusotm prefix in extension&quot; );</pre>
...
assert.equal( $( &quot;&lt;div&gt;&quot; ).testWidget2().testWidget2( &quot;method&quot; ),
        &quot;mixed testWidget2&quot;, &quot;testWidget2 mixin successful&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “_delay”, function( assert ) {</p>
...
$( &quot;#widget&quot; ).testWidget();</pre>

<p>} );</p>

<p>QUnit.test( “$.widget.bridge()”, function( assert ) {</p>
...
<p>QUnit.test( “$.widget.bridge() - widgetFullName”, function( assert ) {</p>
...
assert.equal( typeof instance, &quot;object&quot;, &quot;instance stored in .data(widgetFullName)&quot; );</pre>
