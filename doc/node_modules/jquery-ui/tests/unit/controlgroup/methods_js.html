...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/controlgroup/methods.js">
...
<p>QUnit.module( “Controlgroup: methods” );</p>
...
assert.strictEqual( element.find( &quot;.ui-state-disabled&quot; ).length, 9,
        &quot;Child widgets are disabled&quot; );</pre>
...
<pre>        &quot;checkboxradio&quot;: &quot;&lt;input type=&#39;checkbox&#39;&gt;&quot;,
...
<p>// Iterate through supported element markup $.each( tests, function(
widget, html ) {</p>

<pre>// Check in both horizontal and vertical orientations
...
<p>QUnit.test( “Child Classes Option: init”, function( assert ) {</p>
...
assert.hasClasses( selectmenu.selectmenu( &quot;widget&quot; ), &quot;test-class&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Child Classes Option: refresh”, function( assert ) {</p>
...
<p>QUnit.test( “Controlgroup Label: refresh”, function( assert ) {</p>

<pre>assert.expect( 1 );
var controlgroup = $( &quot;.controlgroup-refresh&quot; ).controlgroup();
controlgroup.controlgroup( &quot;refresh&quot; );
assert.strictEqual( controlgroup.find( &quot;.ui-controlgroup-label-contents&quot; ).length, 1,
        &quot;Controlgroup label does not re-wrap on refresh&quot; );</pre>
