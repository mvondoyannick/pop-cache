...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/controlgroup/options.js">
...
<p>QUnit.module( “Controlgroup: options” );</p>
...
assert.lacksClasses( element, &quot;ui-state-disabled&quot; );
assert.strictEqual( element.find( &quot;.ui-state-disabled&quot; ).length, 0, &quot;Child widgets are not disabled&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “items - null”, function( assert ) {</p>
...
assert.strictEqual( element.children( &quot;.ui-button&quot; ).length, 2,
        &quot;Correct child widgets are called when selector is updated&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “items: custom selector”, function( assert ) {</p>
...
assert.strictEqual( element.children( &quot;.ui-button&quot; ).length, 4,
        &quot;Correct child widgets are called when custom selector used&quot; );</pre>
...
<p>QUnit.test( “items: custom widget”, function( assert ) {</p>
...
assert.strictEqual( element.children( &quot;.ui-test&quot; ).length, 1,
        &quot;Custom widget called&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “onlyVisible”, function( assert ) {</p>
...
assert.hasClasses( buttons.eq( 1 ), &quot;ui-corner-left&quot;,
        &quot;onlyVisible: true: First button is hidden second button get corner class&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “direction”, function( assert ) {</p>
...
assert.hasClasses( buttons.last(), &quot;ui-corner-bottom&quot; );</pre>
