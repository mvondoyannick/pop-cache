...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/slider/options.js">
...
<p>QUnit.module( “slider: options” );</p>
...
handle().simulate( &quot;keydown&quot;, { keyCode: $.ui.keyCode.RIGHT } );
assert.equal( count, 2, &quot;slider did not move&quot; );</pre>
...
<p>QUnit.test( “orientation”, function( assert ) {</p>
...
// What is returned by the value method is restricted by min (&gt;=), max
(&lt;=), and step (even multiple) QUnit.test( “step”, function( assert ) {</p>
...
<p>//Test( “value”, function() { //      ok(false, “missing test - untested
code is broken code.” ); //});</p>

<p>QUnit.test( “values”, function( assert ) {</p>
...
<p>QUnit.test( “range”, function( assert ) {</p>

<pre>assert.expect( 32 );
var range;
