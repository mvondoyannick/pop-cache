...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/slider/core.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/slider&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>var element, options;</p>

<p>function handle() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">element</span>.<span class="ruby-identifier">find</span>( <span class="ruby-string">&quot;.ui-slider-handle&quot;</span> );
</pre>

<p>}</p>

<p>// Slider Tests QUnit.module( “slider: core” );</p>
...
assert.hasClasses( handle[ 1 ], &quot;ui-slider-handle&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “custom handle”, function( assert ) {</p>
...
assert.equal( customHandle.attr( &quot;tabIndex&quot; ), 0, &quot;tabIndex&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “keydown HOME on handle sets value to min”, function( assert )
{</p>
...
element.slider( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “keydown END on handle sets value to max”, function( assert ) {</p>
...
<p>QUnit.test( “keydown PAGE_UP on handle increases value by 1/5 range, not
greater than max”, function( assert ) {</p>
...
<p>QUnit.test( “keydown PAGE_DOWN on handle decreases value by 1/5 range, not
less than min”, function( assert ) {</p>
...
<p>QUnit.test( “keydown UP on handle increases value by step, not greater than
...
<p>QUnit.test( “keydown RIGHT on handle increases value by step, not greater
than max”, function( assert ) {</p>
...
<p>QUnit.test( “keydown DOWN on handle decreases value by step, not less than
...
<p>QUnit.test( “keydown LEFT on handle decreases value by step, not less than
min”, function( assert ) {</p>
