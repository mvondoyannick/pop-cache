...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/slider/methods.js">
...
<p>QUnit.module( “slider: methods” );</p>
...
assert.lacksClasses( element, &quot;ui-state-disabled ui-slider-disabled&quot; );</pre>
...
assert.hasClasses( element, &quot;ui-state-disabled ui-slider-disabled&quot; );
assert.ok( !element.attr( &quot;aria-disabled&quot; ), &quot;slider does not have aria-disabled attr after disable method call&quot; );</pre>
...
assert.equal( element.slider( &quot;value&quot; ), 460, &quot;value is restricted to maximum valid step&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “values, single step”, function( assert ) {</p>
...
<p>QUnit.test( “values, multi step”, function( assert ) {</p>
