...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/slider/events.js">
...
<p>QUnit.module( “slider: events” );</p>

<p>//Specs from <a
href="http://wiki.jqueryui.com/Slider#specs">wiki.jqueryui.com/Slider#specs</a>
//“change callback: triggers when the slider has stopped moving and has a
new // value (even if same as previous value), via mouse(mouseup) or
keyboard(keyup) // or value method/option” QUnit.test( “mouse based
interaction”, function( assert ) {</p>
...
element.find( &quot;.ui-slider-handle&quot; ).eq( 0 )
        .simulate( &quot;drag&quot;, { dx: 10, dy: 10 } );</pre>

<p>} ); QUnit.test( “keyboard based interaction”, function( assert ) {</p>
...
element.find( &quot;.ui-slider-handle&quot; ).eq( 0 )
        ...
        .simulate( &quot;keyup&quot;, { keyCode: $.ui.keyCode.LEFT } );</pre>

<p>} ); QUnit.test( “programmatic event triggers”, function( assert ) {</p>
...
element = $( &quot;&lt;div&gt;&lt;/div&gt;&quot; )
        ...
        .slider( &quot;option&quot;, &quot;values&quot;, [ 80, 90 ] );</pre>

<p>} );</p>

<p>QUnit.test( “mouse based interaction part two: when handles overlap”,
function( assert ) {</p>
...
handles.eq( 1 ).simulate( &quot;drag&quot;, { dx: 10 } );
assert.equal( element.slider( &quot;values&quot; )[ 1 ], 1, &quot;setting both values of range slider to the minimum  doesn&#39;t lock slider&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “event data”, function( assert ) {</p>
...
handles = element.find( &quot;.ui-slider-handle&quot; );
handles.eq( 0 ).simulate( &quot;drag&quot;, { dx: -10 } );</pre>
