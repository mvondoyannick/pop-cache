...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/autocomplete/events.js">
...
<p>QUnit.module( “autocomplete: events” );</p>

<p>var data = [ “Clojure”, “COBOL”, “ColdFusion”, “Java”, “JavaScript”,
“Scala”, “Scheme” ];</p>
...
<p>], function( i, settings ) {</p>

<pre>QUnit.test( &quot;all events - &quot; + settings.type, function( assert ) {
...
<p>QUnit.test( “change without selection”, function( assert ) {</p>
...
element.val( &quot;ja&quot; ).triggerHandler( &quot;blur&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “cancel search”, function( assert ) {</p>
...
<p>QUnit.test( “cancel focus”, function( assert ) {</p>
...
<p>QUnit.test( “cancel select”, function( assert ) {</p>
...
<p>QUnit.test( “blur during remote search”, function( assert ) {</p>
