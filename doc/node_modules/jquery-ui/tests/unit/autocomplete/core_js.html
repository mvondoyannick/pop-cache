...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/autocomplete/core.js">
...
<p>QUnit.module( “autocomplete: core” );</p>
...
assert.hasClasses( menu, &quot;ui-autocomplete ui-widget ui-widget-content&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “prevent form submit on enter when menu is active”, function(
assert ) {</p>
...
element.trigger( event );
assert.ok( event.isDefaultPrevented(), &quot;default action is prevented&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “allow form submit on enter when menu is not active”, function(
assert ) {</p>
...
<pre>QUnit.test( &quot;up arrow invokes search - input&quot;, function( assert ) {
...
<p>QUnit.test( “past end of menu in multiline autocomplete”, function( assert
) {</p>
...
<p>QUnit.test( “ESCAPE in multiline autocomplete”, function( assert ) {</p>
...
<p>QUnit.test( “handle race condition”, function( assert ) {</p>
...
<p>QUnit.test( “simultaneous searches (#9334)”, function( assert ) {</p>
...
element2.autocomplete( &quot;search&quot;, &quot;test&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ARIA”, function( assert ) {</p>
...
assert.equal( liveRegion.parent().length, 0,
        &quot;The liveRegion should be detached after destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ARIA, aria-label announcement”, function( assert ) {</p>
...
assert.equal( liveRegion.children().filter( &quot;:visible&quot; ).text(), &quot;People : anders andersson&quot;,
        &quot;Live region changed on keydown to announce the highlighted value&#39;s aria-label attribute&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ARIA, init on detached input”, function( assert ) {</p>
...
var element = $( &quot;&lt;input&gt;&quot; ).autocomplete( {
        ...
        liveRegion = element.autocomplete( &quot;instance&quot; ).liveRegion;
assert.equal( liveRegion.parent().length, 1, &quot;liveRegion must have a parent&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.replaceWith() (#9172)”, function( assert ) {</p>
...
assert.equal( parent.html().toLowerCase(), replacement );</pre>

<p>} );</p>

<p>QUnit.test( “Search if the user retypes the same value (#7434)”, function(
assert ) {</p>
...
<p>QUnit.test( “Close on click outside when focus remains”, function( assert )
{</p>
