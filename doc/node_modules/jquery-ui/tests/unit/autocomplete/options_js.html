...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/autocomplete/options.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/autocomplete&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “autocomplete: options” );</p>

<p>var data = [ “c++”, “java”, “php”, “coldfusion”, “javascript”, “asp”,
“ruby”,</p>

<pre>&quot;python&quot;, &quot;c&quot;, &quot;scala&quot;, &quot;groovy&quot;, &quot;haskell&quot;, &quot;perl&quot; ];</pre>

<p>QUnit.test( “appendTo: null”, function( assert ) {</p>

<pre>assert.expect( 1 );
var element = $( &quot;#autocomplete&quot; ).autocomplete();
assert.equal( element.autocomplete( &quot;widget&quot; ).parent()[ 0 ], document.body,
        &quot;defaults to body&quot; );
element.autocomplete( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “appendTo: explicit”, function( assert ) {</p>
...
<p>QUnit.test( “appendTo: ui-front”, function( assert ) {</p>
...
assert.equal( element.autocomplete( &quot;widget&quot; ).parent()[ 0 ],
        $( &quot;#autocomplete-wrap2&quot; )[ 0 ], &quot;empty jQuery object, inside .ui-front&quot; );</pre>

<p>} );</p>

<p>function autoFocusTest( assert, afValue, focusedLength ) {</p>
...
element.val( &quot;ja&quot; ).trigger( &quot;keydown&quot; );</pre>

<p>}</p>

<p>QUnit.test( “autoFocus: false”, function( assert ) {</p>
...
<span class="ruby-identifier">autoFocusTest</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-keyword">false</span>, <span class="ruby-value">0</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “autoFocus: true”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">1</span> );
<span class="ruby-identifier">autoFocusTest</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-keyword">true</span>, <span class="ruby-value">1</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “delay”, function( assert ) {</p>
...
<p>QUnit.test( “minLength”, function( assert ) {</p>
...
element.autocomplete( &quot;search&quot;, &quot;&quot; );
assert.ok( menu.is( &quot;:visible&quot; ), &quot;blank enough for minLength: 0&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “minLength, exceed then drop below”, function( assert ) {</p>
...
<p>QUnit.test( “minLength, exceed then drop below then exceed”, function(
assert ) {</p>
...
assert.ok( menu.is( &quot;:visible&quot; ), &quot;menu is visible after searches&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “source, local string array”, function( assert ) {</p>
...
assert.equal( menu.find( &quot;.ui-menu-item&quot; ).text(), &quot;javajavascript&quot; );</pre>

<p>} );</p>

<p>function sourceTest( assert, source, async ) {</p>
...
<p>QUnit.test( “source, local object array, only labels”, function( assert ) {</p>
...
<span class="ruby-identifier">sourceTest</span>( <span class="ruby-identifier">assert</span>, [
        { <span class="ruby-value">label:</span> <span class="ruby-string">&quot;java&quot;</span>, <span class="ruby-value">value:</span> <span class="ruby-identifier">null</span> },
        { <span class="ruby-value">label:</span> <span class="ruby-string">&quot;php&quot;</span>, <span class="ruby-value">value:</span> <span class="ruby-identifier">null</span> },
        { <span class="ruby-value">label:</span> <span class="ruby-string">&quot;coldfusion&quot;</span>, <span class="ruby-value">value:</span> <span class="ruby-string">&quot;&quot;</span> },
        { <span class="ruby-value">label:</span> <span class="ruby-string">&quot;javascript&quot;</span>, <span class="ruby-value">value:</span> <span class="ruby-string">&quot;&quot;</span> },
        { <span class="ruby-value">label:</span> <span class="ruby-string">&quot;clojure&quot;</span> }
] );
</pre>

<p>} );</p>

<p>QUnit.test( “source, local object array, only values”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">4</span> );
<span class="ruby-identifier">sourceTest</span>( <span class="ruby-identifier">assert</span>, [
        { <span class="ruby-value">value:</span> <span class="ruby-string">&quot;java&quot;</span>, <span class="ruby-value">label:</span> <span class="ruby-identifier">null</span> },
        { <span class="ruby-value">value:</span> <span class="ruby-string">&quot;php&quot;</span>, <span class="ruby-value">label:</span> <span class="ruby-identifier">null</span> },
        { <span class="ruby-value">value:</span> <span class="ruby-string">&quot;coldfusion&quot;</span>, <span class="ruby-value">label:</span> <span class="ruby-string">&quot;&quot;</span> },
        { <span class="ruby-value">value:</span> <span class="ruby-string">&quot;javascript&quot;</span>, <span class="ruby-value">label:</span> <span class="ruby-string">&quot;&quot;</span> },
        { <span class="ruby-value">value:</span> <span class="ruby-string">&quot;clojure&quot;</span> }
] );
</pre>

<p>} );</p>

<p>QUnit.test( “source, url string with remote json string array”, function(
assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">4</span> );
<span class="ruby-identifier">sourceTest</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-string">&quot;remote_string_array.txt&quot;</span>, <span class="ruby-keyword">true</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “source, url string with remote json object array, only value
properties”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">4</span> );
<span class="ruby-identifier">sourceTest</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-string">&quot;remote_object_array_values.txt&quot;</span>, <span class="ruby-keyword">true</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “source, url string with remote json object array, only label
properties”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">4</span> );
<span class="ruby-identifier">sourceTest</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-string">&quot;remote_object_array_labels.txt&quot;</span>, <span class="ruby-keyword">true</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “source, custom”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">5</span> );
<span class="ruby-identifier">sourceTest</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-identifier">function</span>( <span class="ruby-identifier">request</span>, <span class="ruby-identifier">response</span> ) {
        <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">request</span>.<span class="ruby-identifier">term</span>, <span class="ruby-string">&quot;j&quot;</span> );
        <span class="ruby-identifier">response</span>( [
                <span class="ruby-string">&quot;java&quot;</span>,
                { <span class="ruby-value">label:</span> <span class="ruby-string">&quot;javascript&quot;</span>, <span class="ruby-value">value:</span> <span class="ruby-identifier">null</span> },
                { <span class="ruby-value">value:</span> <span class="ruby-string">&quot;clojure&quot;</span>, <span class="ruby-value">label:</span> <span class="ruby-identifier">null</span> }
        ] );
} );
</pre>
...
<p>QUnit.test( “source, update after init”, function( assert ) {</p>
...
assert.equal( menu.find( &quot;.ui-menu-item&quot; ).text(), &quot;php&quot; );</pre>
