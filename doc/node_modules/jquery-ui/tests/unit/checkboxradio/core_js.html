...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/checkboxradio/core.js">
...
<p>QUnit.module( “Checkboxradio: core” );</p>

<p>QUnit.test( “Checkbox - Initial class structure”, function( assert ) {</p>
...
assert.hasClasses( label, &quot;ui-button ui-widget ui-checkboxradio-label ui-corner-all&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Radios - Initial class structure”, function( assert ) {</p>
...
<p>QUnit.test( “Ensure checked after single click on checkbox label button”,
function( assert ) {</p>
...
<p>QUnit.test( “Handle form association via form attribute”, function( assert
) {</p>
...
radio2Label.simulate( &quot;click&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Checkbox creation requires a label, and finds it in all
cases”, function( assert ) {</p>
...
<p>QUnit.test( “Calling checkboxradio on an unsupported element throws an
error”, function( assert ) {</p>
...
<p>QUnit.test( “Calling checkboxradio on an input with no label throws an
error”, function( assert ) {</p>
