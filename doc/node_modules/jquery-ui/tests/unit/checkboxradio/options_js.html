...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/checkboxradio/options.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/checkboxradio&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “Checkboxradio: options” );</p>

<p>function assertDisabled( checkbox, assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">hasClasses</span>( <span class="ruby-identifier">checkbox</span>.<span class="ruby-identifier">checkboxradio</span>( <span class="ruby-string">&quot;widget&quot;</span> ), <span class="ruby-string">&quot;ui-state-disabled&quot;</span>,
        <span class="ruby-string">&quot;label gets ui-state-disabled&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">strictEqual</span>( <span class="ruby-identifier">checkbox</span>.<span class="ruby-identifier">is</span>( <span class="ruby-string">&quot;:disabled&quot;</span> ), <span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;checkbox is disabled&quot;</span> );
</pre>

<p>}</p>

<p>function assertEnabled( checkbox, assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">lacksClasses</span>(  <span class="ruby-identifier">checkbox</span>.<span class="ruby-identifier">checkboxradio</span>( <span class="ruby-string">&quot;widget&quot;</span> ), <span class="ruby-string">&quot;ui-state-disabled&quot;</span>,
        <span class="ruby-string">&quot;label has ui-state-disabled removed when disabled set to false&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">strictEqual</span>( <span class="ruby-identifier">checkbox</span>.<span class="ruby-identifier">is</span>( <span class="ruby-string">&quot;:disabled&quot;</span> ), <span class="ruby-keyword">false</span>,
        <span class="ruby-string">&quot;checkbox has disabled prop removed when disabled set to false&quot;</span> );
</pre>
...
assertDisabled( checkbox, assert );</pre>

<p>} );</p>

<p>QUnit.test( “disabled - prop true on init”, function( assert ) {</p>
...
<p>QUnit.test( “disabled - explicit null value, checks the DOM”, function(
assert ) {</p>
...
<p>function assertNoIcon( assert, checkbox ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">strictEqual</span>( <span class="ruby-identifier">checkbox</span>.<span class="ruby-identifier">checkboxradio</span>( <span class="ruby-string">&quot;widget&quot;</span> ).<span class="ruby-identifier">find</span>( <span class="ruby-string">&quot;span.ui-icon&quot;</span> ).<span class="ruby-identifier">length</span>, <span class="ruby-value">0</span>,
        <span class="ruby-string">&quot;Label does not contain an icon&quot;</span> );
</pre>

<p>}</p>

<p>function assertIcon( checkbox, icon, assert ) {</p>

<pre>var iconElement = checkbox.checkboxradio( &quot;widget&quot; ).find( &quot;.ui-icon&quot; );
...
<p>QUnit.test( “icon - false on init”, function( assert ) {</p>

<pre>var checkbox = $( &quot;#checkbox-option-icon&quot; );

assert.expect( 1 );

checkbox.checkboxradio( { icon: false } );
assertNoIcon( assert, checkbox );</pre>

<p>} );</p>

<p>QUnit.test( “icon - default unchecked”, function( assert ) {</p>
...
checkbox.checkboxradio();
assertIcon( checkbox, false, assert );</pre>

<p>} );</p>

<p>QUnit.test( “icon - default checked”, function( assert ) {</p>

<pre>var checkbox = $( &quot;#checkbox-option-icon&quot; ).attr( &quot;checked&quot;, true );

assert.expect( 2 );

checkbox.checkboxradio();
assertIcon( checkbox, &quot;check ui-state-checked&quot;, assert );</pre>

<p>} );</p>

<p>QUnit.test( “icon”, function( assert ) {</p>
...
<p>QUnit.test( “label - default”, function( assert ) {</p>

<pre>var checkbox = $( &quot;#checkbox-option-label&quot; ),
        widget;
...
assert.strictEqual( $.trim( widget.text() ),
        &quot;checkbox label&quot;, &quot;When no value passed on create text from dom is used in dom&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “label - explicit value”, function( assert ) {</p>
...
assert.strictEqual( $( &quot;#checkbox-option-label&quot; ).length, 1,
        &quot;Element is preserved when label is set on init when wrapped in label&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “label - explicit null value”, function( assert ) {</p>
...
assert.strictEqual( $.trim( widget.text() ),
        &quot;checkbox label&quot;, &quot;When null is passed on create text from dom is used in dom&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “label”, function( assert ) {</p>
...
assert.strictEqual( $.trim( widget.text() ),
        &quot;bar&quot;, &quot;When null is passed text from dom is used in dom&quot; );</pre>
