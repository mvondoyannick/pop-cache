...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/checkboxradio/methods.js">
...
<p>QUnit.module( “Checkboxradio: methods” );</p>

<p>$.each( [ “checkbox”, “radio” ], function( index, value ) {</p>

<pre>QUnit.test( value + &quot;: refresh&quot;, function( assert ) {
        var widget, icon,
...
<p>QUnit.test( “Input wrapped in a label preserved on refresh”, function(
assert ) {</p>

<pre>var input = $( &quot;#label-with-no-for&quot; ).checkboxradio(),
        element = input.checkboxradio( &quot;widget&quot; );

assert.expect( 1 );

input.checkboxradio( &quot;refresh&quot; );
assert.strictEqual( input.parent()[ 0 ], element[ 0 ], &quot;Input preserved&quot; );</pre>
