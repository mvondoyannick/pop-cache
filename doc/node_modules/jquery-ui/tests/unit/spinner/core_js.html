...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/spinner/core.js">
...
<p>var simulateKeyDownUp = testHelper.simulateKeyDownUp;</p>

<p>QUnit.module( “spinner: core” );</p>

<p>QUnit.test( “markup structure”, function( assert ) {</p>
...
assert.equal( down.length, 1, &quot;Spinner contains exactly one down button&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “keydown UP on input, increases value not greater than max”,
function( assert ) {</p>
...
assert.equal( element.val(), 100 );
simulateKeyDownUp( element, $.ui.keyCode.UP );
assert.equal( element.val(), 100 );</pre>

<p>} );</p>

<p>QUnit.test( “keydown DOWN on input, decreases value not less than min”,
function( assert ) {</p>
...
assert.equal( element.val(), 20 );
simulateKeyDownUp( element, $.ui.keyCode.DOWN );
assert.equal( element.val(), 20 );</pre>

<p>} );</p>

<p>QUnit.test( “keydown PAGE_UP on input, increases value not greater than
max”, function( assert ) {</p>
...
<p>QUnit.test( “keydown PAGE_DOWN on input, decreases value not less than
min”, function( assert ) {</p>
...
<p>QUnit.test( “blur input while spinning with UP”, function( assert ) {</p>
...
element[ 0 ].focus();
setTimeout( step1 );</pre>

<p>} );</p>

<p>QUnit.test( “mouse click on up button, increases value not greater than
max”, function( assert ) {</p>
...
button.trigger( &quot;mousedown&quot; ).trigger( &quot;mouseup&quot; );
assert.equal( element.val(), 0 );</pre>

<p>} );</p>

<p>QUnit.test( “mousewheel on input”, function( assert ) {</p>
...
assert.equal( element.val(), -2 );</pre>

<p>} );</p>

<p>QUnit.test( “reading HTML5 attributes”, function( assert ) {</p>
...
assert.equal( element.spinner( &quot;option&quot;, &quot;step&quot; ), 5, &quot;stop from options&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ARIA attributes”, function( assert ) {</p>
...
assert.equal( element.attr( &quot;aria-valuemax&quot; ), undefined, &quot;aria-valuemax not set when no max&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “focus text field when pressing button”, function( assert ) {</p>
...
assert.ok( element[ 0 ] === document.activeElement, &quot;focused after&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “don&#39;t clear invalid value on blur”, function( assert ) {</p>

<pre>assert.expect( 1 );
var element = $( &quot;#spin&quot; ).spinner();
element.trigger( &quot;focus&quot; ).val( &quot;a&quot; ).trigger( &quot;blur&quot; );
assert.equal( element.val(), &quot;a&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “precision”, function( assert ) {</p>
...
assert.equal( element.val(), &quot;0.05&quot;, &quot;precision from min&quot; );</pre>
