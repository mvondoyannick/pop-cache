...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/spinner/methods.js">
...
<p>QUnit.module( “spinner: methods” );</p>
...
assert.equal( 7, element.val(), &quot;script - pageDown 1 page changes value&quot; );</pre>
...
simulateKeyDownUp( element, $.ui.keyCode.UP );
assert.equal( 2, element.val(), &quot;keyboard - value changes on key UP&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “isValid”, function( assert ) {</p>
...
element.val( &quot;1&quot; );
assert.ok( !spinner.isValid(), &quot;step mismatch is invalid&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “pageDown”, function( assert ) {</p>
...
assert.equal( element.val(), -100, &quot;value at min and pageDown 10 pages&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “pageUp”, function( assert ) {</p>
...
assert.equal( element.val(), 100, &quot;value at max and pageUp 10 pages&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “stepDown”, function( assert ) {</p>
...
element.spinner( &quot;stepDown&quot; );
assert.equal( element.val(), &quot;-15&quot;, &quot;at min and stepDown 1 step&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “stepUp”, function( assert ) {</p>
...
element.spinner( &quot;stepUp&quot; );
assert.equal( element.val(), 16, &quot;at max and stepUp 1 step&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “value”, function( assert ) {</p>
...
assert.equal( element.spinner( &quot;value&quot; ), 9, &quot;get value via value method&quot; );</pre>
...
assert.strictEqual( widgetElement[ 0 ], element.parent()[ 0 ], &quot;parent element&quot; );</pre>
