...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/spinner/options.js">
...
<p>QUnit.module( “spinner: options” );</p>

<p>// Culture is tested after numberFormat, since it depends on numberFormat</p>

<p>QUnit.test( “icons: default ”, function( assert ) {</p>
...
assert.hasClasses( element.spinner( &quot;widget&quot; ).find( &quot;.ui-icon:last&quot; ),
        &quot;ui-icon ui-icon-caret-1-s&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “icons: custom ”, function( assert ) {</p>
...
assert.hasClasses( element.find( &quot;.ui-icon:last&quot; ), &quot;ui-icon custom-down&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “incremental, false”, function( assert ) {</p>

<pre>assert.expect( 100 );
...
element.simulate( &quot;keyup&quot;, { keyCode: $.ui.keyCode.UP } );</pre>

<p>} );</p>

<p>QUnit.test( “incremental, true”, function( assert ) {</p>
...
<p>QUnit.test( “incremental, function”, function( assert ) {</p>
...
<p>QUnit.test( “numberFormat, number”, function( assert ) {</p>

<pre>assert.expect( 2 );
var element = $( &quot;#spin&quot; ).val( 0 ).spinner( { numberFormat: &quot;n&quot; } );
assert.equal( element.val(), &quot;0.00&quot;, &quot;formatted on init&quot; );
element.spinner( &quot;stepUp&quot; );
assert.equal( element.val(), &quot;1.00&quot;, &quot;formatted after step&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “numberFormat, number, simple”, function( assert ) {</p>

<pre>assert.expect( 2 );
var element = $( &quot;#spin&quot; ).val( 0 ).spinner( { numberFormat: &quot;n0&quot; } );
assert.equal( element.val(), &quot;0&quot;, &quot;formatted on init&quot; );
element.spinner( &quot;stepUp&quot; );
assert.equal( element.val(), &quot;1&quot;, &quot;formatted after step&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “numberFormat, currency”, function( assert ) {</p>
...
<p>QUnit.test( “numberFormat, change”, function( assert ) {</p>
...
assert.equal( element.val(), &quot;$5.00&quot;, &quot;formatted after change&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “culture, null”, function( assert ) {</p>
...
// Reset culture
Globalize.culture( &quot;default&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “currency, ja-JP”, function( assert ) {</p>
...
<p>QUnit.test( “currency, change”, function( assert ) {</p>
...
<p>QUnit.test( “max”, function( assert ) {</p>
...
assert.equal( element.val(), 1000, &quot;max not constrained if manual entry&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “max, string”, function( assert ) {</p>
...
element.spinner( &quot;value&quot;, 1000 );
assert.equal( element.val(), &quot;$100.00&quot;, &quot;max constrained in value method&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “min”, function( assert ) {</p>
...
element.val( -1000 ).trigger( &quot;blur&quot; );
assert.equal( element.val(), -1000, &quot;min not constrained if manual entry&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “min, string”, function( assert ) {</p>
...
element.spinner( &quot;value&quot;, -1000 );
assert.equal( element.val(), &quot;($100.00)&quot;, &quot;min constrained in value method&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “step, 2”, function( assert ) {</p>
...
element.val( &quot;4.5&quot; );
element.spinner( &quot;stepUp&quot; );
assert.equal( element.val(), &quot;6&quot;, &quot;stepUp&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “step, 0.7”, function( assert ) {</p>
...
element.spinner( &quot;stepUp&quot; );
assert.equal( element.val(), &quot;0.7&quot;, &quot;stepUp&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “step, string”, function( assert ) {</p>
...
element.spinner( &quot;stepUp&quot; );
assert.equal( element.val(), &quot;$0.70&quot;, &quot;stepUp&quot; );</pre>
