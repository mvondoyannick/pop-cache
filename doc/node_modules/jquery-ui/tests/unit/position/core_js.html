...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/position/core.js">
...
<p>], function( QUnit, $, common ) {</p>

<p>var win = $( window ),</p>

<pre class="ruby"><span class="ruby-identifier">scrollTopSupport</span> = <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">support</span> = <span class="ruby-identifier">win</span>.<span class="ruby-identifier">scrollTop</span>( <span class="ruby-value">1</span> ).<span class="ruby-identifier">scrollTop</span>() <span class="ruby-operator">===</span> <span class="ruby-value">1</span>;
        <span class="ruby-identifier">win</span>.<span class="ruby-identifier">scrollTop</span>( <span class="ruby-value">0</span> );
        <span class="ruby-identifier">scrollTopSupport</span> = <span class="ruby-identifier">function</span>() {
                <span class="ruby-keyword">return</span> <span class="ruby-identifier">support</span>;
        };
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">support</span>;
};
</pre>

<p>QUnit.module( “position”, {</p>
...
<p>common.testJshint( “position” );</p>

<p>QUnit.test( “my, at, of”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#elx&quot; ).offset(), { top: 45, left: 50 }, &quot;left foo, bar baz&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “multiple elements”, function( assert ) {</p>
...
<p>QUnit.test( “positions”, function( assert ) {</p>
...
<p>QUnit.test( “of”, function( assert ) {</p>

<pre>assert.expect( 9 + ( scrollTopSupport() ? 1 : 0 ) );
...
assert.deepEqual( $( &quot;#elx&quot; ).offset(), {
        top: 600,
        left: 400
}, &quot;event - left top, right bottom&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “offsets”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#elx&quot; ).offset(), { top: 60, left: 40 }, &quot;invalid offsets&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “using”, function( assert ) {</p>
...
<p>function collisionTest( assert, config, result, msg ) {</p>

<pre>var elem = $( &quot;#elx&quot; ).position( $.extend( {
        my: &quot;left top&quot;,
        at: &quot;right bottom&quot;,
        of: &quot;#parent&quot;
}, config ) );
assert.deepEqual( elem.offset(), result, msg );</pre>

<p>}</p>

<p>function collisionTest2( assert, config, result, msg ) {</p>

<pre>collisionTest( assert, $.extend( {
        my: &quot;right bottom&quot;,
        at: &quot;left top&quot;
}, config ), result, msg );</pre>

<p>}</p>

<p>QUnit.test( “collision: fit, no collision”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">2</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;fit&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">10</span>
}, <span class="ruby-string">&quot;no offset&quot;</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;fit&quot;</span>,
        <span class="ruby-value">at:</span> <span class="ruby-string">&quot;right+2 bottom+3&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">13</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">12</span>
}, <span class="ruby-string">&quot;with offset&quot;</span> );
</pre>

<p>} );</p>

<p>// Currently failing in IE8 due to the iframe used by TestSwarm if ( !/msie
[w.]+/.exec( navigator.userAgent.toLowerCase() ) ) { QUnit.test(
“collision: fit, collision”, function( assert ) {</p>

<pre>assert.expect( 2 + ( scrollTopSupport() ? 1 : 0 ) );
...
<p>QUnit.test( “collision: flip, no collision”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">2</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;flip&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">10</span>
}, <span class="ruby-string">&quot;no offset&quot;</span> );
...
<p>QUnit.test( “collision: flip, collision”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">2</span> );

<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;flip&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">10</span>
...
<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;flip&quot;</span>,
        <span class="ruby-value">at:</span> <span class="ruby-string">&quot;left+2 top+3&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">7</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">8</span>
}, <span class="ruby-string">&quot;with offset&quot;</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “collision: flipfit, no collision”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">2</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;flipfit&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">10</span>
}, <span class="ruby-string">&quot;no offset&quot;</span> );
...
<p>QUnit.test( “collision: flipfit, collision”, function( assert ) {</p>
...
<p>QUnit.test( “collision: none, no collision”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">2</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;none&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">10</span>
}, <span class="ruby-string">&quot;no offset&quot;</span> );
...
<p>QUnit.test( “collision: none, collision”, function( assert ) {</p>
...
<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        ...
        <span class="ruby-value">top:</span> <span class="ruby-value">-6</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">-6</span>
}, <span class="ruby-string">&quot;no offset&quot;</span> );
...
<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        ...
        <span class="ruby-value">top:</span> <span class="ruby-value">-3</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">-4</span>
}, <span class="ruby-string">&quot;with offset&quot;</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “collision: fit, with margin”, function( assert ) {</p>
...
<p>QUnit.test( “collision: flip, with margin”, function( assert ) {</p>
...
<p>QUnit.test( “within”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">7</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">within:</span> <span class="ruby-identifier">document</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">10</span>
}, <span class="ruby-string">&quot;within document&quot;</span> );

<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">within:</span> <span class="ruby-string">&quot;#within&quot;</span>,
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;fit&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">4</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">2</span>
}, <span class="ruby-string">&quot;fit - right bottom&quot;</span> );

<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        <span class="ruby-value">within:</span> <span class="ruby-string">&quot;#within&quot;</span>,
        <span class="ruby-value">collision:</span> <span class="ruby-string">&quot;fit&quot;</span>
}, {
        <span class="ruby-value">top:</span> <span class="ruby-value">2</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">0</span>
}, <span class="ruby-string">&quot;fit - left top&quot;</span> );
...
<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        ...
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">-6</span>
}, <span class="ruby-string">&quot;flip - right bottom&quot;</span> );
...
<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        ...
        <span class="ruby-value">top:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">-6</span>
}, <span class="ruby-string">&quot;flip - left top&quot;</span> );
...
<span class="ruby-identifier">collisionTest</span>( <span class="ruby-identifier">assert</span>, {
        ...
        <span class="ruby-value">top:</span> <span class="ruby-value">4</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">0</span>
}, <span class="ruby-string">&quot;flipfit - right bottom&quot;</span> );
...
<span class="ruby-identifier">collisionTest2</span>( <span class="ruby-identifier">assert</span>, {
        ...
        <span class="ruby-value">top:</span> <span class="ruby-value">4</span>,
        <span class="ruby-value">left:</span> <span class="ruby-value">0</span>
}, <span class="ruby-string">&quot;flipfit - left top&quot;</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “with scrollbars”, function( assert ) {</p>
...
collisionTest( assert, {
        ...
        top: 90 - scrollbarInfo.height,
        left: 90 - scrollbarInfo.width
}, &quot;auto, with scroll&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “fractions”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#fractions-element&quot; ).offset(), $( &quot;#fractions-parent&quot; ).offset(), &quot;left top, left top&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “bug #5280: consistent results (avoid fractional values)”,
function( assert ) {</p>
...
assert.deepEqual( offset1, offset2 );</pre>

<p>} );</p>

<p>QUnit.test( “bug #8710: flip if flipped position fits more”, function(
assert ) {</p>
