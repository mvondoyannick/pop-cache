...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/draggable/core.js">
...
<p>QUnit.module( “draggable: core” );</p>

<p>QUnit.test( “element types”, function( assert ) {</p>
...
<p>QUnit.test( “No options, relative”, function( assert ) {</p>

<pre>assert.expect( 2 );
testHelper.shouldMove( assert, $( &quot;#draggable1&quot; ).draggable(), &quot;no options, relative&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “No options, absolute”, function( assert ) {</p>

<pre>assert.expect( 2 );
testHelper.shouldMove( assert, $( &quot;#draggable2&quot; ).draggable(), &quot;no options, absolute&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resizable handle with complex markup (#8756 / #8757)”,
function( assert ) {</p>
...
// Todo: fix resizable so it doesn&#39;t require a mouseover
handle.simulate( &quot;mouseover&quot; ).simulate( &quot;drag&quot;, { dx: 50 } );
assert.equal( target.width(), 200, &quot;compare width&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#8269: Removing draggable element on drop”, function( assert )
{</p>
...
<p>// <a
href="http://bugs.jqueryui.com/ticket/7778">bugs.jqueryui.com/ticket/7778</a>
...
testHelper.shouldMove( assert, element, &quot;element is draggable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#6258: not following mouse when scrolled and using overflow-y:
scroll”, function( assert ) {</p>
...
<p>QUnit.test( “#9315: jumps down with offset of scrollbar”, function( assert
) {</p>
...
<p>QUnit.test( “scroll offset with fixed ancestors”, function( assert ) {</p>
...
<p>$( [ “hidden”, “auto”, “scroll” ] ).each( function() {</p>

<pre>var overflow = this;
...
<p>QUnit.test( “#5727: draggable from iframe”, function( assert ) {</p>
...
//testHelper.shouldMove( assert, draggable1, &quot;draggable from an iframe&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#8399: A draggable should become the active element after you
are finished interacting with it, but not before.”, function( assert ) {</p>
...
assert.strictEqual( document.activeElement, element.get( 0 ), &quot;finishing moving a draggable anchor made it the active element&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “blur behavior - handle is main element”, function( assert ) {</p>
...
<p>QUnit.test( “blur behavior - descendant of handle”, function( assert ) {</p>
...
<p>QUnit.test( “blur behavior - off handle”, function( assert ) {</p>
...
<p>QUnit.test( “ui-draggable-handle assigned to appropriate element”,
function( assert ) {</p>
...
assert.lacksClasses( element.find( &quot;p&quot; ), &quot;ui-draggable-handle&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ui-draggable-handle managed correctly in nested draggables”,
function( assert ) {</p>
...
assert.hasClasses( child, &quot;ui-draggable-handle&quot;, &quot;child retains class name on destroy&quot; );</pre>

<p>} );</p>

<p>// Support: IE 8 only // IE 8 implements DOM Level 2 Events which only has
events bubble up to the document. // We skip this test since it would be
impossible for it to pass in such an environment. QUnit[
document.documentMode === 8 ? “skip” : “test” ](</p>

<pre>&quot;does not stop propagation to window&quot;,
function( assert ) {
        assert.expect( 1 );
        var element = $( &quot;#draggable1&quot; ).draggable();
