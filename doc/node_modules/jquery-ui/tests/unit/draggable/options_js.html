...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/draggable/options.js">
...
&quot;ui/widgets/sortable&quot;</pre>

<p>], function( QUnit, $, testHelper ) {</p>

<p>QUnit.module( “draggable: options” );</p>

<p>// TODO: This doesn&#39;t actually test whether append happened, possibly
remove QUnit.test( “{ appendTo: &#39;parent&#39; }, default, no clone”,
function( assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;relative appendTo: parent&quot; );</pre>

<p>} );</p>

<p>// TODO: This doesn&#39;t actually test whether append happened, possibly
remove QUnit.test( “{ appendTo: Element }, no clone”, function( assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;relative appendTo: Element&quot; );</pre>

<p>} );</p>

<p>// TODO: This doesn&#39;t actually test whether append happened, possibly
remove QUnit.test( “{ appendTo: Selector }, no clone”, function( assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;relative appendTo: Selector&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ appendTo: &#39;parent&#39; }, default”, function( assert ) {</p>
...
assert.equal( element.data( &quot;last_dragged_parent&quot; ), $( &quot;#main&quot; )[ 0 ] );</pre>

<p>} );</p>

<p>QUnit.test( “{ appendTo: Element }”, function( assert ) {</p>
...
testHelper.move( element, 1, 1 );
assert.equal( element.data( &quot;last_dragged_parent&quot; ), appendTo );</pre>

<p>} );</p>

<p>QUnit.test( “{ appendTo: jQuery }”, function( assert ) {</p>
...
testHelper.move( element, 1, 1 );
assert.equal( element.data( &quot;last_dragged_parent&quot; ), appendTo[ 0 ] );</pre>

<p>} );</p>

<p>QUnit.test( “{ appendTo: Selector }”, function( assert ) {</p>
...
<p>QUnit.test( “appendTo, default, switching after initialization”, function(
assert ) {</p>
...
assert.equal( element.data( &quot;last_dragged_parent&quot; ), $( &quot;#qunit-fixture&quot; )[ 0 ] );</pre>

<p>} );</p>

<p>QUnit.test( “{ axis: false }, default”, function( assert ) {</p>

<pre>assert.expect( 2 );
var element = $( &quot;#draggable2&quot; ).draggable( { axis: false } );
testHelper.shouldMove( assert, element, &quot;axis: false&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ axis: &#39;x&#39; }”, function( assert ) {</p>

<pre>assert.expect( 2 );
var element = $( &quot;#draggable2&quot; ).draggable( { axis: &quot;x&quot; } );
testHelper.testDrag( assert, element, element, 50, 50, 50, 0, &quot;axis: x&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ axis: &#39;y&#39; }”, function( assert ) {</p>

<pre>assert.expect( 2 );
var element = $( &quot;#draggable2&quot; ).draggable( { axis: &quot;y&quot; } );
testHelper.testDrag( assert, element, element, 50, 50, 0, 50, &quot;axis: y&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ axis: ? }, unexpected”, function( assert ) {</p>
...
<p>QUnit.test( “axis, default, switching after initialization”, function(
assert ) {</p>
...
testHelper.testDrag( assert, element, element, 50, 50, 0, 50, &quot;axis: y as option&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ cancel: &#39;input,textarea,button,select,option&#39; },
default”, function( assert ) {</p>
...
element.draggable( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ cancel: &#39;span&#39; }”, function( assert ) {</p>
...
testHelper.shouldNotDrag( assert, element, &quot;cancel: span, span dragged&quot;, &quot;#draggable2 span&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ cancel: ? }, unexpected”, function( assert ) {</p>

<pre>assert.expect( 12 );
...
<p>Test( “{ cancel: Selectors }, matching parent selector”, function() {</p>
...
testHelper.shouldNotDrag( assert, $( &quot;#draggable2 span a&quot; ).first(), &quot;drag span a first child&quot; );</pre>

<p>});</p>

<p>QUnit.test( “cancelement, default, switching after initialization”,
function( assert ) {</p>
...
testHelper.shouldNotDrag( assert, element, &quot;cancel: input, input dragged&quot;, input );</pre>

<p>} );</p>

<p>QUnit.test( “connectToSortable, dragging out of a sortable”, function(
assert ) {</p>
...
<p>QUnit.test( “connectToSortable, dragging clone into sortable”, function(
assert ) {</p>

<pre>var ready = assert.async();
assert.expect( 3 );
...
<p>QUnit.test( “connectToSortable, dragging multiple elements in and out of
sortable”, function( assert ) {</p>
...
<p>QUnit.test( “connectToSortable, dragging through one sortable to a second”,
function( assert ) {</p>
...
element.simulate( &quot;drag&quot;, dragParams );</pre>

<p>} );</p>

<p>QUnit.test( “connectToSortable, dragging through a sortable”, function(
assert ) {</p>
...
<p>QUnit.test( “{ containment: Element }”, function( assert ) {</p>
...
assert.deepEqual( offsetAfter, expected, &quot;compare offset to parent&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ containment: Selector }”, function( assert ) {</p>
...
<p>QUnit.test( “{ containment: [x1, y1, x2, y2] }”, function( assert ) {</p>
...
testHelper.testDrag( assert, element, element, -100, -100, 0, 0, &quot;containment: [x1, y1, x2, y2]&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ containment: &#39;parent&#39; }, relative”, function( assert
) {</p>
...
<p>QUnit.test( “{ containment: &#39;parent&#39; }, absolute”, function( assert
) {</p>
...
<p>QUnit.test( “containment, account for border”, function( assert ) {</p>
...
assert.close( el.offset().left, parentRight - parentBorderRight - el.width(), 1,
        &quot;The draggable should be to the right of its parent&#39;s right border&quot; );</pre>

<p>} );</p>

<p>// <a
href="http://bugs.jqueryui.com/ticket/7016">bugs.jqueryui.com/ticket/7016</a>
// draggable can be pulled out of containment in Chrome and IE8 QUnit.test(
“containment, element cant be pulled out of container”, function( assert )
{</p>
...
assert.deepEqual( element.offset(), offsetBefore, &quot;The draggable should not move past bottom right edge&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “containment, default, switching after initialization”,
function( assert ) {</p>
...
testHelper.testDrag( assert, element, element, -100, -100, -100, -100, &quot;containment: false as option&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ cursor: &#39;auto&#39; }, default”, function( assert ) {</p>

<pre>function getCursor() {
...
assert.equal( after, before, &quot;after drag: cursor restored&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ cursor: &#39;move&#39; }”, function( assert ) {</p>
...
<p>QUnit.test( “#6889: Cursor doesn&#39;t revert to pre-dragging state after
revert action when original element is removed”, function( assert ) {</p>
...
<p>QUnit.test( “cursor, default, switching after initialization”, function(
assert ) {</p>
...
testHelper.move( element, 1, 1 );
assert.equal( element.data( &quot;last_dragged_cursor&quot; ), &quot;ns-resize&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “cursorAt”, function( assert ) {</p>

<pre>assert.expect( 24 );
...
<p>QUnit.test( “cursorAt, switching after initialization”, function( assert )
{</p>
...
<p>QUnit.test( “disabled”, function( assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;option: disabled false&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ grid: [50, 50] }, relative”, function( assert ) {</p>

<pre>assert.expect( 4 );

var element = $( &quot;#draggable1&quot; ).draggable( { grid: [ 50, 50 ] } );
testHelper.testDrag( assert, element, element, 24, 24, 0, 0, &quot;grid: [50, 50] relative&quot; );
testHelper.testDrag( assert, element, element, 26, 25, 50, 50, &quot;grid: [50, 50] relative&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ grid: [50, 50] }, absolute”, function( assert ) {</p>

<pre>assert.expect( 4 );

var element = $( &quot;#draggable2&quot; ).draggable( { grid: [ 50, 50 ] } );
testHelper.testDrag( assert, element, element, 24, 24, 0, 0, &quot;grid: [50, 50] absolute&quot; );
testHelper.testDrag( assert, element, element, 26, 25, 50, 50, &quot;grid: [50, 50] absolute&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “grid, switching after initialization”, function( assert ) {</p>
...
testHelper.testDrag( assert, element, element, 26, 25, 50, 50, &quot;grid: [50, 50] as option&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ handle: &#39;span&#39; }”, function( assert ) {</p>
...
testHelper.shouldNotDrag( assert, element, &quot;handle: span element&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “handle, default, switching after initialization”, function(
assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;handle: false as option, span dragged&quot;, &quot;#draggable2 span&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “helper, default, switching after initialization”, function(
assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;helper: original&quot; );</pre>

<p>} );</p>

<p>// <a
href="http://bugs.jqueryui.com/ticket/9446">bugs.jqueryui.com/ticket/9446</a>
// Draggable: helper function cannot emulate default behavior QUnit.test(
“helper, function returning original element”, function( assert ) {</p>
...
<p>function testHelperPosition( scrollPositions, position, helper,
scrollElements, scrollElementsTitle ) {</p>

<pre>QUnit.test( &quot;{ helper: &#39;&quot; + helper + &quot;&#39; }, &quot; + position + &quot;, with scroll offset on &quot; + scrollElementsTitle, function( assert ) {
...
<p>QUnit.test( “{ opacity: 0.5 }”, function( assert ) {</p>
...
assert.equal( opacity, 0.5, &quot;start callback: opacity is&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “opacity, default, switching after initialization”, function(
assert ) {</p>
...
assert.equal( opacity, 1 );</pre>

<p>} );</p>

<p>QUnit.test( “revert and revertDuration”, function( assert ) {</p>
...
<p>QUnit.test( “revert: valid”, function( assert ) {</p>
...
testHelper.shouldMovePositionButNotOffset( assert, element, &quot;revert: valid reverts when dropped on a droppable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “scope”, function( assert ) {</p>
...
testHelper.shouldMove( assert, element, &quot;revert: valid reverts when dropped on a droppable out of scope&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “scroll, scrollSensitivity, and scrollSpeed”, function( assert
) {</p>
...
testHelper.restoreScroll( document );</pre>

<p>} );</p>

<p>QUnit.test( “scroll ignores containers that are overflow: hidden”,
function( assert ) {</p>
...
assert.equal( scrollParent.scrollLeft(), 0, &quot;container doesn&#39;t scroll horizontally&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#6817: auto scroll goes double distance when dragging”,
function( assert ) {</p>
...
<p>QUnit.test( “snap, snapMode, and snapTolerance”, function( assert ) {</p>

<pre>assert.expect( 10 );
...
assert.deepEqual( element.offset(), { top: newY, left: newX }, &quot;doesn&#39;t snap on the inner snapTolerance area when snapMode is outer&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#8459: element can snap to an element that was removed during
drag”, function( assert ) {</p>
...
<p>QUnit.test( “#8165: Snapping large rectangles to small rectangles
doesn&#39;t snap properly”, function( assert ) {</p>
...
assert.notDeepEqual( element.offset(), { top: y, left: newX }, &quot;snaps even if only a side (not a corner) is inside the snapTolerance&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “stack”, function( assert ) {</p>
...
assert.equal( element2.css( &quot;zIndex&quot; ), &quot;3&quot;, &quot;stack increments zIndex correctly&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ zIndex: 10 }”, function( assert ) {</p>
...
assert.equal( actual, expected, &quot;start callback: zIndex is&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “zIndex, default, switching after initialization”, function(
assert ) {</p>
...
testHelper.move( element, 3, 1 );
assert.equal( zindex, 1 );</pre>

<p>} );</p>

<p>QUnit.test( “iframeFix”, function( assert ) {</p>
