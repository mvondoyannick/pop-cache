...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/draggable/events.js">
...
<p>QUnit.module( “draggable: events”, {</p>
...
<p>QUnit.test( “callbacks occurrence count”, function( assert ) {</p>
...
assert.equal( stop, 1, &quot;stop callback should happen exactly once&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “stopping the start callback”, function( assert ) {</p>
...
assert.equal( stop, 0, &quot;stop callback should not happen if there wasnt even a start&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “stopping the drag callback”, function( assert ) {</p>
...
assert.equal( start, 1, &quot;start callback should happen exactly once&quot; );
assert.equal( stop, 1, &quot;stop callback should happen, as we need to actively stop the drag&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “stopping the stop callback”, function( assert ) {</p>
...
<span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( {
        <span class="ruby-value">helper:</span> <span class="ruby-string">&quot;clone&quot;</span>,
        <span class="ruby-value">stop:</span> <span class="ruby-identifier">function</span>() {
                <span class="ruby-keyword">return</span> <span class="ruby-keyword">false</span>;
        }
} );

<span class="ruby-identifier">element</span>.<span class="ruby-identifier">simulate</span>( <span class="ruby-string">&quot;drag&quot;</span>, {
        <span class="ruby-value">dx:</span> <span class="ruby-value">10</span>,
        <span class="ruby-value">dy:</span> <span class="ruby-value">10</span>
} );

<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;instance&quot;</span> ).<span class="ruby-identifier">helper</span>, <span class="ruby-string">&quot;the clone should not be deleted if the stop callback is stopped&quot;</span> );
</pre>

<p>} );</p>

<p>// <a
href="http://bugs.jqueryui.com/ticket/6884">bugs.jqueryui.com/ticket/6884</a>
// Draggable: ui.offset.left differs between the “start” and “drag” hooks
QUnit.test( “position and offset in hash is consistent between start, drag,
and stop”, function( assert ) {</p>
...
assert.deepEqual( dragOffset, stopOffset, &quot;drag offset equals stop offset&quot; );</pre>
