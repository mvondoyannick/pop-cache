...
<title>methods.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/draggable/methods.js">
...
&quot;jquery&quot;,
&quot;./helper&quot;,
&quot;ui/widgets/draggable&quot;</pre>

<p>], function( QUnit, $, testHelper ) {</p>

<p>var element;</p>

<p>QUnit.module( “draggable: methods”, {</p>
...
<p>QUnit.test( “init”, function( assert ) {</p>
...
assert.ok( true, &quot;arbitrary option setter after init&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “destroy”, function( assert ) {</p>
...
assert.equal( actual, expected, &quot;destroy is chainable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “enable”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">11</span> );

<span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( { <span class="ruby-value">disabled:</span> <span class="ruby-keyword">true</span> } );
<span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">shouldNotDrag</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-identifier">element</span>, <span class="ruby-string">&quot;.draggable({ disabled: true })&quot;</span> );

<span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;enable&quot;</span> );
<span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">shouldMove</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-identifier">element</span>, <span class="ruby-string">&quot;.draggable(&#39;enable&#39;)&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;option&quot;</span>, <span class="ruby-string">&quot;disabled&quot;</span> ), <span class="ruby-keyword">false</span>, <span class="ruby-string">&quot;disabled option getter&quot;</span> );

<span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;destroy&quot;</span> );
<span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( { <span class="ruby-value">disabled:</span> <span class="ruby-keyword">true</span> } );
<span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">shouldNotDrag</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-identifier">element</span>, <span class="ruby-string">&quot;.draggable({ disabled: true })&quot;</span> );

<span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;option&quot;</span>, <span class="ruby-string">&quot;disabled&quot;</span>, <span class="ruby-keyword">false</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;option&quot;</span>, <span class="ruby-string">&quot;disabled&quot;</span> ), <span class="ruby-keyword">false</span>, <span class="ruby-string">&quot;disabled option setter&quot;</span> );
<span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">shouldMove</span>( <span class="ruby-identifier">assert</span>, <span class="ruby-identifier">element</span>, <span class="ruby-string">&quot;.draggable(&#39;option&#39;, &#39;disabled&#39;, false)&quot;</span> );

<span class="ruby-identifier">var</span> <span class="ruby-identifier">expected</span> = <span class="ruby-identifier">element</span>.<span class="ruby-identifier">draggable</span>(),
        <span class="ruby-identifier">actual</span> = <span class="ruby-identifier">expected</span>.<span class="ruby-identifier">draggable</span>( <span class="ruby-string">&quot;enable&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">actual</span>, <span class="ruby-identifier">expected</span>, <span class="ruby-string">&quot;enable is chainable&quot;</span> );
</pre>
...
assert.equal( actual, expected, &quot;disable is chainable&quot; );</pre>
