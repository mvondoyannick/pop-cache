...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/droppable/options.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/droppable&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “droppable: options” );</p>

<p>Test( “{ accept &#39;*&#39; }, default ”, function() {</p>
...
<p>test( “{ accept: Selector }”, function() {</p>
...
<p>test( “{ accept: function(draggable) }”, function() {</p>
...
<p>QUnit.test( “{ addClasses: true }, default”, function( assert ) {</p>

<pre>assert.expect( 1 );
var el = $( &quot;&lt;div /&gt;&quot; ).droppable( { addClasses: true } );
assert.hasClasses( el, &quot;ui-droppable&quot; );
el.droppable( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ addClasses: false }”, function( assert ) {</p>
...
assert.equal( draggableOffset.top, oldDraggableOffset.top );</pre>

<p>} ); /* Test( “greedy”, function() {</p>
...
<p>test( “tolerance, fit”, function() {</p>
...
<p>QUnit.test( “tolerance, intersect”, function( assert ) {</p>
...
<p>QUnit.test( “tolerance, pointer”, function( assert ) {</p>
...
<p>/* Test( “tolerance, touch”, function() {</p>
