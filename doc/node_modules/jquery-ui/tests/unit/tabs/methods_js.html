...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/tabs/methods.js">
...
<pre class="ruby"><span class="ruby-identifier">state</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">state</span>;
</pre>

<p>QUnit.module( “tabs: methods” );</p>
...
<p>QUnit.test( “destroy - ajax”, function( assert ) {</p>
...
<p>QUnit.test( “enable( index )”, function( assert ) {</p>
...
disabled( assert, element, [ 0, 1 ] );
element.tabs( &quot;disable&quot; );
disabled( assert, element, true );</pre>

<p>} );</p>

<p>QUnit.test( “disable( index )”, function( assert ) {</p>
...
<p>QUnit.test( “refresh - looping”, function( assert ) {</p>
...
element.tabs( &quot;refresh&quot; );
state( assert, element, 0, 1 );
disabled( assert, element, [ 0 ] );</pre>

<p>} );</p>

<p>QUnit.test( “load”, function( assert ) {</p>
