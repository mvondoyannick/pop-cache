...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/tabs/core.js">
...
<p>var state = testHelper.state;</p>

<p>QUnit.module( “tabs: core” );</p>

<p>QUnit.test( “markup structure”, function( assert ) {</p>

<pre>assert.expect( 20 );
...
assert.equal( panels.length, 3, &quot;There are exactly 3 tab panels&quot; );</pre>
...
&quot;empty list&quot;: &quot;#tabs6&quot;</pre>

<p>}, function( type, selector ) {</p>

<pre>QUnit.test( &quot;markup structure: &quot; + type, function( assert ) {
        assert.expect( 2 );
...
<p>// #5893 - Sublist in the tab list are considered as tab QUnit.test(
“nested list”, function( assert ) {</p>

<pre>assert.expect( 1 );

var element = $( &quot;#tabs6&quot; ).tabs();
assert.equal( element.tabs( &quot;instance&quot; ).anchors.length, 2, &quot;should contain 2 tab&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “disconnected from DOM”, function( assert ) {</p>

<pre>assert.expect( 2 );

var element = $( &quot;#tabs1&quot; ).remove().tabs();
assert.equal( element.find( &quot;.ui-tabs-nav&quot; ).length, 1, &quot;should initialize nav&quot; );
assert.equal( element.find( &quot;.ui-tabs-panel&quot; ).length, 3, &quot;should initialize panels&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “non-tab list items”, function( assert ) {</p>
...
assert.equal( element.find( &quot;.ui-tabs-nav li.ui-state-active&quot; ).index(), 1,
        &quot;first actual tab is active&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “aria-controls”, function( assert ) {</p>
...
assert.equal( tabs.eq( 3 ).attr( &quot;aria-controls&quot; ), &quot;custom-id&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “accessibility”, function( assert ) {</p>

<pre>assert.expect( 49 );
var element = $( &quot;#tabs1&quot; ).tabs( {
                active: 1,
                disabled: [ 2 ]
        } ),
...
assert.equal( tabs.eq( 2 ).attr( &quot;aria-disabled&quot; ), &quot;true&quot;, &quot;disabled tab has aria-disabled=true&quot; );
assert.equal( tabs.eq( 2 ).attr( &quot;aria-expanded&quot; ), &quot;false&quot;, &quot;inactive tab has aria-expanded=false&quot; );
assert.equal( panels.eq( 2 ).attr( &quot;aria-hidden&quot; ), &quot;true&quot;, &quot;inactive panel has aria-hidden=true&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “accessibility - ajax”, function( assert ) {</p>
...
<p>QUnit.test( “keyboard support - LEFT, RIGHT, UP, DOWN, HOME, END, SPACE,
ENTER”, function( assert ) {</p>
...
<p>// Navigation with CTRL and COMMAND (both behave the same) $.each( {</p>

<pre>ctrl: &quot;CTRL&quot;,
meta: &quot;COMMAND&quot;</pre>

<p>}, function( modifier, label ) {</p>

<pre>QUnit.test( &quot;keyboard support - &quot; + label + &quot; navigation&quot;, function( assert ) {
...
<p>QUnit.test( “keyboard support - CTRL+UP, ALT+PAGE_DOWN, ALT+PAGE_UP”,
function( assert ) {</p>
...
<p>QUnit.test( “#4033 - IE expands hash to full url and misinterprets tab as
ajax”, function( assert ) {</p>
