...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/tabs/options.js">
...
<p>var disabled = testHelper.disabled,</p>

<pre class="ruby"><span class="ruby-identifier">equalHeight</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">equalHeight</span>,
<span class="ruby-identifier">state</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">state</span>;
</pre>

<p>QUnit.module( “tabs: options” );</p>
...
state( assert, element, 1, 0, 0 );
assert.strictEqual( element.tabs( &quot;option&quot;, &quot;active&quot; ), 0 );</pre>
...
<p>QUnit.test( “active - mismatched tab/panel order”, function( assert ) {</p>
...
<p>QUnit.test( “collapsible”, function( assert ) {</p>
...
disabled( assert, element, false );</pre>
...
equalHeight( assert, element, 45 );</pre>
...
equalHeight( assert, element, 481 );</pre>
...
var element = $( &quot;#tabs8&quot; ).tabs( { heightStyle: &quot;fill&quot; } );
equalHeight( assert, element, 385 );</pre>
...
$( &quot;&lt;p&gt;Lorem Ipsum&lt;/p&gt;&quot; )
        ...
        .prependTo( &quot;#tabs8Wrapper&quot; );
var element = $( &quot;#tabs8&quot; ).tabs( { heightStyle: &quot;fill&quot; } );
equalHeight( assert, element, 335 );</pre>

<p>} );</p>

<p>QUnit.test( “hide and show: false”, function( assert ) {</p>
...
assert.ok( panels.eq( 1 ).is( &quot;:visible&quot; ), &quot;second panel visible&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “hide and show - animation”, function( assert ) {</p>
...
assert.ok( panels.eq( 0 ).is( &quot;:visible&quot; ), &quot;first panel visible&quot; );
element.tabs( &quot;option&quot;, &quot;active&quot;, 1 );</pre>
