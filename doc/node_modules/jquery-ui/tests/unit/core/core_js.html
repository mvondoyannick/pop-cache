...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/core/core.js">
...
<p>QUnit.module( “core - jQuery extensions” );</p>

<p>common.testJshint( “core” );</p>

<p>QUnit.test( “innerWidth - getter”, function( assert ) {</p>
...
el.hide();
assert.equal( el.innerWidth(), 122, &quot;getter passthru when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “innerWidth - setter”, function( assert ) {</p>
...
el.hide();
el.innerWidth( 100 );
assert.equal( el.width(), 78, &quot;width set properly when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “innerHeight - getter”, function( assert ) {</p>
...
el.hide();
assert.equal( el.innerHeight(), 70, &quot;getter passthru when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “innerHeight - setter”, function( assert ) {</p>
...
el.hide();
el.innerHeight( 50 );
assert.equal( el.height(), 30, &quot;height set properly when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerWidth - getter”, function( assert ) {</p>
...
el.hide();
assert.equal( el.outerWidth(), 140, &quot;getter passthru when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerWidth - setter”, function( assert ) {</p>
...
el.hide();
el.outerWidth( 120 );
assert.equal( el.width(), 80, &quot;width set properly when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerWidth(true) - getter”, function( assert ) {</p>
...
el.hide();
assert.equal( el.outerWidth( true ), 154, &quot;getter passthru w/ margin when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerWidth(true) - setter”, function( assert ) {</p>
...
assert.equal( el.width(), 66, &quot;width set properly when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerHeight - getter”, function( assert ) {</p>
...
el.hide();
assert.equal( el.outerHeight(), 86, &quot;getter passthru when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerHeight - setter”, function( assert ) {</p>
...
el.hide();
el.outerHeight( 70 );
assert.equal( el.height(), 34, &quot;height set properly when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerHeight(true) - getter”, function( assert ) {</p>
...
el.hide();
assert.equal( el.outerHeight( true ), 98, &quot;getter passthru w/ margin when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “outerHeight(true) - setter”, function( assert ) {</p>
...
assert.equal( el.height(), 32, &quot;height set properly when hidden&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “uniqueId / removeUniqueId”, function( assert ) {</p>
...
el.removeUniqueId();
assert.equal( el.attr( &quot;id&quot; ), null, &quot;unique id has been removed from element&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Labels”, function( assert ) {</p>
...
dom.detach();
testLabels( &quot;document fragments&quot; );</pre>

<p>} );</p>

<p>( function() {</p>

<pre>var domAttached = $( &quot;#form-test&quot; );
...
testForm( &quot;form: detached: &quot;, domDetached );</pre>
