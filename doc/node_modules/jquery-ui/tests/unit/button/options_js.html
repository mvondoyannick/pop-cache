...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/button/options.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/button&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “button: options” );</p>

<p>QUnit.test( “disabled, explicit value”, function( assert ) {</p>
...
assert.strictEqual( element.prop( &quot;disabled&quot; ), true, &quot;Disabled property is set&quot; );</pre>

<p>} );</p>

<p>// We are testing the default here because the default null is a special
value which means to check // the DOM. We need to make sure this happens
correctly. Checking the options should never return // null, it should
always be true or false. QUnit.test( “disabled, null”, function( assert ) {</p>
...
assert.strictEqual( elementDisabled.prop( &quot;disabled&quot; ), true, &quot;element is disabled&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “showLabel, false, without icon”, function( assert ) {</p>
...
assert.lacksClasses( button, &quot;ui-button-icon-only&quot; );
assert.strictEqual( button.button( &quot;option&quot;, &quot;showLabel&quot; ), true,
        &quot;showLabel false only allowed if icon true&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “showLabel, false, with icon”, function( assert ) {</p>
...
assert.hasClasses( button, &quot;ui-button ui-corner-all ui-widget ui-button-icon-only&quot; );</pre>
...
assert.deepEqual( button.button( &quot;option&quot;, &quot;label&quot; ), &quot;Label&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “label, with html markup”, function( assert ) {</p>
...
assert.deepEqual( button.button( &quot;option&quot;, &quot;label&quot; ).toLowerCase(), &quot;label &lt;span&gt;with span&lt;/span&gt;&quot; );</pre>
...
assert.deepEqual( button.button( &quot;option&quot;, &quot;label&quot; ), &quot;xxx&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “label, default, with input type submit”, function( assert ) {</p>
...
<p>QUnit.test( “label, explicit value, with input type submit”, function(
assert ) {</p>
...
assert.ok( button.find( &quot;.ui-icon&quot; ).length, &quot;setting icon to a value adds the icon&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “icon position”, function( assert ) {</p>

<pre>assert.expect( 22 );
...
assert.hasClasses( icon, &quot;ui-widget-icon-block&quot; );</pre>
