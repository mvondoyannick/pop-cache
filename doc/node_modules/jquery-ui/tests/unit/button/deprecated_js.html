...
<title>deprecated.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/button/deprecated.js">
...
<p>QUnit.module( “Button (deprecated): core” );</p>

<p>QUnit.test( “Calling button on a checkbox input calls checkboxradio
widget”, function( assert ) {</p>

<pre>var checkbox = $( &quot;#checkbox01&quot; );
...
assert.ok( !checkbox.checkboxradio( &quot;option&quot;, &quot;icon&quot; ),
        &quot;Calling button on a checkbox sets the checkboxradio icon option to false&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Calling buttonset calls controlgroup”, function( assert ) {</p>

<pre>var controlgroup = $( &quot;.buttonset&quot; );

assert.expect( 1 );
controlgroup.buttonset();

assert.ok( controlgroup.is( &quot;:ui-controlgroup&quot; ), &quot;Calling buttonset creates controlgroup instance&quot; );</pre>

<p>} );</p>

<p>QUnit.module( “Button (deprecated): methods” );</p>
...
<p>QUnit.test( “refresh: Ensure disabled state is preserved correctly.”,
function( assert ) {</p>
...
element = $( &quot;#radio02&quot; );
element.button( { disabled: true } ).prop( &quot;disabled&quot;, false ).button( &quot;refresh&quot; );
assert.ok( !element.button( &quot;option&quot;, &quot;disabled&quot; ), &quot;Changing a radio button&#39;s disabled property should update the state after refresh.&quot; );</pre>

<p>} );</p>

<p>QUnit.module( “button (deprecated): options” );</p>

<p>QUnit.test( “Setting items option on buttonset sets the button properties
on the items option”, function( assert ) {</p>
...
assert.equal( controlgroup.controlgroup( &quot;option&quot;, &quot;items.button&quot; ), &quot;foo&quot;,
        &quot;items.button set when setting items option on buttonset&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “disabled, null”, function( assert ) {</p>
...
assert.deepEqual( true, $( &quot;#radio02&quot; ).prop( &quot;disabled&quot; ), &quot;element is not disabled&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “text / showLabel options proxied”, function( assert ) {</p>
...
assert.equal( button.button( &quot;option&quot;, &quot;text&quot; ), false,
        &quot;Setting the showLabel option to false sets the text option to false on init&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “icon / icons options properly proxied”, function( assert ) {</p>
...
assert.equal( button.button( &quot;option&quot;, &quot;iconPosition&quot; ), &quot;end&quot;,
        &quot;Icons secondary option sets iconPosition option to end on init&quot; );</pre>
