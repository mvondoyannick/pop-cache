...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/selectable/events.js">
...
<p>], function( QUnit, $, testHelpers ) {</p>

<p>QUnit.module( “selectable: events” );</p>
...
<p>QUnit.test( “mousedown: initial position of helper”, function( assert ) {</p>
...
$( window ).scrollTop( 0 ).scrollLeft( 0 );</pre>
