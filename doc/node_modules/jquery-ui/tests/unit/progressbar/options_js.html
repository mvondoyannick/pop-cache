...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/progressbar/options.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/progressbar&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “progressbar: options” );</p>

<p>QUnit.test( “{ value: 0 }, default”, function( assert ) {</p>

<pre>assert.expect( 1 );
$( &quot;#progressbar&quot; ).progressbar();
assert.equal( $( &quot;#progressbar&quot; ).progressbar( &quot;value&quot; ), 0 );</pre>

<p>} );</p>

<p>// Ticket #7231 - valueDiv should be hidden when value is at 0% QUnit.test(
“value: visibility of valueDiv”, function( assert ) {</p>
...
assert.ok( element.children( &quot;.ui-progressbar-value&quot; ).is( &quot;:hidden&quot; ),
        &quot;valueDiv hidden when value is set to 0&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ value: 5 }”, function( assert ) {</p>

<pre>assert.expect( 1 );
$( &quot;#progressbar&quot; ).progressbar( {
        value: 5
} );
assert.equal( $( &quot;#progressbar&quot; ).progressbar( &quot;value&quot; ), 5 );</pre>
...
assert.equal( $( &quot;#progressbar&quot; ).progressbar( &quot;value&quot; ), 0,
        &quot;value constrained at min&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ value: 105 }”, function( assert ) {</p>
...
assert.equal( $( &quot;#progressbar&quot; ).progressbar( &quot;value&quot; ), 100,
        &quot;value constrained at max&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ value: 10, max: 5 }”, function( assert ) {</p>
...
<p>QUnit.test( “change max below value”, function( assert ) {</p>
