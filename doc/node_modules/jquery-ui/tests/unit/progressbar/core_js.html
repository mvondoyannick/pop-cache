...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/progressbar/core.js">
...
<p>QUnit.module( “progressbar: core” );</p>
...
assert.equal( element.children().children().length, 0, &quot;no overlay div&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “markup structure - indeterminate”, function( assert ) {</p>
...
assert.equal( children.children( &quot;.ui-progressbar-overlay&quot; ).length, 1,
        &quot;Value has class ui-progressbar-overlay&quot; );</pre>
...
assert.equal( element.attr( &quot;aria-valuemin&quot; ), 0, &quot;aria-valuemin&quot; );
assert.equal( element.attr( &quot;aria-valuemax&quot; ), 150, &quot;aria-valuemax&quot; );
assert.equal( element.attr( &quot;aria-valuenow&quot; ), null, &quot;aria-valuenow&quot; );</pre>
