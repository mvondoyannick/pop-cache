...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/sortable/options.js">
...
<p>QUnit.module( “sortable: options” );</p>

<p>Test(“{ appendTo: &#39;parent&#39; }, default”, function() {</p>

<pre class="ruby"><span class="ruby-identifier">ok</span>(<span class="ruby-keyword">false</span>, <span class="ruby-string">&quot;missing test - untested code is broken code.&quot;</span>);
</pre>

<p>});</p>

<p>test(“{ appendTo: Selector }”, function() {</p>
...
<p>QUnit.test( “#7415: Incorrect revert animation with axis: &#39;y&#39;”,
function( assert ) {</p>
...
<p>/* Test(“{ cancel: &#39;input,textarea,button,select,option&#39; },
default”, function() {</p>
...
<p>test(“{ cancel: Selector }”, function() {</p>
...
<p>QUnit.test( “#8792: issues with floated items in connected lists”,
function( assert ) {</p>
...
assert.equal( changeCount, 3, &quot;change fired once for each expected change when dragging a floated sortable to a connected container&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#8301: single axis with connected list”, function( assert ) {</p>
...
<p>/* Test(“{ connectWith: false }, default”, function() {</p>
...
<p>test(“{ connectWith: Selector }”, function() {</p>
...
<p>test(“{ containment: false }, default”, function() {</p>
...
<p>test(“{ containment: Element }”, function() {</p>
...
<p>test(“{ containment: &#39;document&#39; }”, function() {</p>
...
<p>test(“{ containment: &#39;parent&#39; }”, function() {</p>
...
<p>test(“{ containment: &#39;window&#39; }”, function() {</p>
...
<p>test(“{ containment: Selector }”, function() {</p>
...
<p>test(“{ cursor: &#39;auto&#39; }, default”, function() {</p>
...
<p>test(“{ cursorAt: false }, default”, function() {</p>
...
<p>test(“{ cursorAt: true }”, function() {</p>
...
<p>test(“{ delay: 0 }, default”, function() {</p>
...
<p>test(“{ distance: 1 }, default”, function() {</p>
...
<p>test(“{ dropOnEmpty: true }, default”, function() {</p>
...
<p>test(“{ dropOnEmpty: false }”, function() {</p>
...
<p>test(“{ forcePlaceholderSize: false }, default”, function() {</p>
...
<p>test(“{ forcePlaceholderSize: true }”, function() {</p>
...
<p>test(“{ forceHelperSize: false }, default”, function() {</p>
...
<p>test(“{ forceHelperSize: true }”, function() {</p>
...
<p>test(“{ grid: false }, default”, function() {</p>
...
<p>test(“{ handle: false }, default”, function() {</p>
...
<p>test(“{ handle: Element }”, function() {</p>
...
<p>test(“{ handle: Selector }”, function() {</p>
...
<p>test(“{ helper: &#39;original&#39; }, default”, function() {</p>
...
<p>test(“{ helper: Function }”, function() {</p>
...
<p>test(“{ items: &#39;&gt; *&#39; }, default”, function() {</p>
...
<p>test(“{ items: Selector }”, function() {</p>
...
<p>test(“{ opacity: false }, default”, function() {</p>
...
<p>test(“{ placeholder: false }, default”, function() {</p>
...
<p>QUnit.test( “{ placeholder: false } img”, function( assert ) {</p>
...
<p>QUnit.test( “{ placeholder: String }”, function( assert ) {</p>
...
<p>QUnit.test( “{ placholder: String } tr”, function( assert ) {</p>
...
<p>QUnit.test( “{ placholder: String } tbody”, function( assert ) {</p>
...
<p>/* Test(“{ revert: false }, default”, function() {</p>
...
<p>test(“{ scroll: true }, default”, function() {</p>
...
<p>test(“{ scroll: false }”, function() {</p>
...
<p>test(“{ scrollSensitivity: 20 }, default”, function() {</p>
...
<p>test(“{ scrollSensitivity: 2 }”, function() {</p>
...
<p>test(“{ scrollSensitivity: 200 }”, function() {</p>
...
<p>test(“{ scrollSpeed: 20 }, default”, function() {</p>
...
<p>test(“{ scrollSpeed: 2 }”, function() {</p>
...
<p>test(“{ scrollSpeed: 200 }”, function() {</p>
...
<p>test(“{ scope: &#39;default&#39; }, default”, function() {</p>
...
<p>test(“{ scope: ??? }, unexpected”, function() {</p>
...
<p>test(“{ tolerance: &#39;intersect&#39; }, default”, function() {</p>
...
<p>test(“{ tolerance: &#39;pointer&#39; }”, function() {</p>
...
<p>test(“{ zIndex: 1000 }, default”, function() {</p>
...
<p>test(“{ zIndex: false }”, function() {</p>
