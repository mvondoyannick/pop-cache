...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/sortable/core.js">
...
<p>QUnit.module( “sortable: core” );</p>

<p>QUnit.test( “#9314: Sortable: Items cannot be dragged directly into bottom
...
testHelper.sort( assert, $( &quot;li&quot;, el[ 1 ] )[ 0 ], 0, -12, 5, &quot;Dragging the sortable into connected sortable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ui-sortable-handle applied to appropriate element”, function(
assert ) {</p>
...
el.sortable( &quot;destroy&quot; );
assert.equal( el.find( &quot;.ui-sortable-handle&quot; ).length, 0, &quot;class name removed on destroy&quot; );</pre>
