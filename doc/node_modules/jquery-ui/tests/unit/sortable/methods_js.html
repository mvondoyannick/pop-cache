...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/sortable/methods.js">
...
<p>QUnit.module( “sortable: methods” );</p>
...
assert.equal( actual, expected, &quot;enable is chainable&quot; );</pre>
...
assert.equal( chainable, element, &quot;disable is chainable&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “refresh() should update the positions of initially empty lists
(see #7498)”, function( assert ) {</p>
...
assert.equal( changeCount, 1 );</pre>
