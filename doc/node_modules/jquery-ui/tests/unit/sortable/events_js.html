...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/sortable/events.js">
...
<p>QUnit.module( “sortable: events” );</p>

<p>QUnit.test( “start”, function( assert ) {</p>
...
assert.ok( &quot;offset&quot; in hash, &quot;UI hash includes: offset&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “sort”, function( assert ) {</p>
...
assert.ok( hash.item, &quot;UI hash includes: item&quot; );
assert.ok( !hash.sender, &quot;UI hash does not include: sender&quot; );</pre>
...
<p>QUnit.test( “beforeStop”, function( assert ) {</p>
...
<p>QUnit.test( “stop”, function( assert ) {</p>
...
<p>QUnit.test( “update”, function( assert ) {</p>
...
<p>QUnit.test( “#3019: Stop fires too early”, function( assert ) {</p>
...
assert.equal( helper, null, &quot;helper should be false&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#4752: link event firing on sortable with connect list”,
function( assert ) {</p>
...
assert.ok( !hasFired( &quot;click&quot; ), &quot;Click event should not have fired&quot; );</pre>

<p>} );</p>

<p>Test(“receive”, function() {</p>
...
<p>QUnit.test( “over”, function( assert ) {</p>
...
assert.equal( overCount, 1, &quot;over fires only once&quot; );</pre>

<p>} );</p>

<p>// <a
href="http://bugs.jqueryui.com/ticket/9335">bugs.jqueryui.com/ticket/9335</a>
// Sortable: over &amp; out events does not consistently fire QUnit.test(
“over, fires with draggable connected to sortable”, function( assert ) {</p>
...
<p>QUnit.test( “over, with connected sortable”, function( assert ) {</p>
...
<p>QUnit.test( “out, with connected sortable”, function( assert ) {</p>
...
assert.equal( outCount, 1, &quot;out fires only once&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “repeated out &amp; over between connected sortables”,
function( assert ) {</p>
...
assert.equal( overCount, 4, &quot;over fires four times&quot; );</pre>

<p>} );</p>

<p>/* Test(“activate”, function() {</p>
