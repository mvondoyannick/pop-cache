...
<title>events.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/selectmenu/events.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/selectmenu&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “selectmenu: events”, {</p>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">ready</span> = <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">async</span>();
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">3</span> );

<span class="ruby-identifier">var</span> <span class="ruby-identifier">button</span>, <span class="ruby-identifier">menu</span>, <span class="ruby-identifier">options</span>,
        <span class="ruby-identifier">optionIndex</span> = <span class="ruby-value">1</span>;

<span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( {
        <span class="ruby-value">change:</span> <span class="ruby-identifier">function</span>( <span class="ruby-identifier">event</span>, <span class="ruby-identifier">ui</span> ) {
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">ui</span>.<span class="ruby-identifier">item</span>.<span class="ruby-identifier">index</span>, <span class="ruby-identifier">optionIndex</span>, <span class="ruby-string">&quot;ui.item.index contains correct option index&quot;</span> );
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">ui</span>.<span class="ruby-identifier">item</span>.<span class="ruby-identifier">element</span>[ <span class="ruby-value">0</span> ], <span class="ruby-identifier">options</span>.<span class="ruby-identifier">eq</span>( <span class="ruby-identifier">optionIndex</span> )[ <span class="ruby-value">0</span> ],
                        <span class="ruby-string">&quot;ui.item.element contains original option element&quot;</span> );
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">ui</span>.<span class="ruby-identifier">item</span>.<span class="ruby-identifier">value</span>, <span class="ruby-identifier">options</span>.<span class="ruby-identifier">eq</span>( <span class="ruby-identifier">optionIndex</span> ).<span class="ruby-identifier">text</span>(),
                        <span class="ruby-string">&quot;ui.item.value property updated correctly&quot;</span> );
        }
} );

<span class="ruby-identifier">button</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( <span class="ruby-string">&quot;widget&quot;</span> );
<span class="ruby-identifier">menu</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( <span class="ruby-string">&quot;menuWidget&quot;</span> );
<span class="ruby-identifier">options</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">find</span>( <span class="ruby-string">&quot;option&quot;</span> );

<span class="ruby-identifier">button</span>.<span class="ruby-identifier">simulate</span>( <span class="ruby-string">&quot;focus&quot;</span> );

<span class="ruby-identifier">setTimeout</span>( <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">button</span>.<span class="ruby-identifier">trigger</span>( <span class="ruby-string">&quot;click&quot;</span> );
        <span class="ruby-identifier">menu</span>.<span class="ruby-identifier">find</span>( <span class="ruby-string">&quot;li&quot;</span> ).<span class="ruby-identifier">eq</span>( <span class="ruby-identifier">optionIndex</span> ).<span class="ruby-identifier">simulate</span>( <span class="ruby-string">&quot;mouseover&quot;</span> ).<span class="ruby-identifier">trigger</span>( <span class="ruby-string">&quot;click&quot;</span> );
...
<p>QUnit.test( “close”, function( assert ) {</p>
...
this.element.selectmenu( &quot;open&quot; );
shouldFire = true;
$( &quot;body&quot; ).trigger( &quot;mousedown&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “focus”, function( assert ) {</p>
...
<p>QUnit.test( “open”, function( assert ) {</p>
...
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( {
        <span class="ruby-value">open:</span> <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;open event fired on open&quot;</span> );
        }
} );

<span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( <span class="ruby-string">&quot;open&quot;</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “select”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">ready</span> = <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">async</span>();
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">3</span> );

<span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( {
        <span class="ruby-value">select:</span> <span class="ruby-identifier">function</span>( <span class="ruby-identifier">event</span>, <span class="ruby-identifier">ui</span> ) {
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;select event fired on item select&quot;</span> );
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">ui</span>.<span class="ruby-identifier">item</span>.<span class="ruby-identifier">index</span>, <span class="ruby-identifier">optionIndex</span>, <span class="ruby-string">&quot;ui.item.index contains correct option index&quot;</span> );
                <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>( <span class="ruby-identifier">ui</span>.<span class="ruby-identifier">item</span>.<span class="ruby-identifier">element</span>[ <span class="ruby-value">0</span> ], <span class="ruby-identifier">options</span>.<span class="ruby-identifier">eq</span>( <span class="ruby-identifier">optionIndex</span> )[ <span class="ruby-value">0</span> ],
                        <span class="ruby-string">&quot;ui.item.element contains original option element&quot;</span> );
        }
...
<span class="ruby-identifier">var</span> <span class="ruby-identifier">button</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( <span class="ruby-string">&quot;widget&quot;</span> ),
        <span class="ruby-identifier">menu</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">selectmenu</span>( <span class="ruby-string">&quot;menuWidget&quot;</span> ),
        <span class="ruby-identifier">options</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">element</span>.<span class="ruby-identifier">find</span>( <span class="ruby-string">&quot;option&quot;</span> ),
        <span class="ruby-identifier">optionIndex</span> = <span class="ruby-value">1</span>;
