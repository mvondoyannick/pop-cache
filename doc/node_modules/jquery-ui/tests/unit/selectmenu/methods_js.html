...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/selectmenu/methods.js">
...
<p>QUnit.module( “selectmenu: methods” );</p>
...
<p>QUnit.test( “open / close”, function( assert ) {</p>
...
assert.equal( menu.attr( &quot;aria-hidden&quot; ), &quot;true&quot;, &quot;close: menu aria-disabled&quot; );</pre>
...
assert.equal( menu.attr( &quot;aria-disabled&quot; ), &quot;false&quot;, &quot;enable: menu ARIA&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “refresh - structure”, function( assert ) {</p>
...
assert.equal( &quot;Changed value&quot;, menuItems.eq( 0 ).text(), &quot;changed item&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “refresh - change selected option”, function( assert ) {</p>
...
<p>QUnit.test( “refresh - disabled select”, function( assert ) {</p>
...
assert.equal( menu.attr( &quot;aria-disabled&quot; ), &quot;true&quot;, &quot;menu ARIA&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “refresh - disabled option”, function( assert ) {</p>
...
assert.hasClasses( disabledItem, &quot;ui-state-disabled&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “refresh - disabled optgroup”, function( assert ) {</p>
...
<p>QUnit.test( “refresh - remove all options”, function( assert ) {</p>
...
assert.equal( button.find( &quot;.ui-selectmenu-text&quot; ).html(), $( &quot;&lt;span&gt;&amp;#160;&lt;/span&gt;&quot; ).html(),
        &quot;Empty button text&quot; );
assert.equal( menu.children().length, 0, &quot;Empty menu&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “widget and menuWidget”, function( assert ) {</p>
...
assert.ok( menu.is( &quot;ul.ui-menu&quot; ), &quot;Menu Widget: element and class&quot; );</pre>
