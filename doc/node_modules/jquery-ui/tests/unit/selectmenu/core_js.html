...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/selectmenu/core.js">
...
<p>QUnit.module( “selectmenu: core” );</p>
...
assert.strictEqual( icon[ 0 ], button.children()[ 0 ], &quot;Icon is first child of button&quot; );</pre>
...
<p>QUnit.test( “_renderButtonItem()”, function( assert ) {</p>
...
<pre>QUnit.test( &quot;state synchronization - after keydown on button - &quot; + settings.type, function( assert ) {
...
<p>QUnit.test( “Selectmenu should reset when its parent form resets”,
function( assert ) {</p>
...
<p>QUnit.test( “Number pad input should change value”, function( assert ) {</p>
