...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/accordion/options.js">
...
&quot;jquery&quot;,
&quot;./helper&quot;,
&quot;ui/widgets/accordion&quot;</pre>

<p>], function( QUnit, $, testHelper ) {</p>

<p>var equalHeight = testHelper.equalHeight,</p>

<pre class="ruby"><span class="ruby-identifier">setupTeardown</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">setupTeardown</span>,
<span class="ruby-identifier">state</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">state</span>;
</pre>

<p>QUnit.module( “accordion: options”, setupTeardown() );</p>

<p>QUnit.test( “{ active: default }”, function( assert ) {</p>

<pre>assert.expect( 2 );
var element = $( &quot;#list1&quot; ).accordion();
assert.equal( element.accordion( &quot;option&quot;, &quot;active&quot; ), 0 );
state( assert, element, 1, 0, 0 );</pre>

<p>} );</p>

<p>QUnit.test( “{ active: null }”, function( assert ) {</p>
...
<p>QUnit.test( “{ active: false }”, function( assert ) {</p>
...
state( assert, element, 1, 0, 0 );
assert.strictEqual( element.accordion( &quot;option&quot;, &quot;active&quot; ), 0 );</pre>

<p>} );</p>

<p>// <a
href="http://bugs.jqueryui.com/ticket/11938">bugs.jqueryui.com/ticket/11938</a>
QUnit.test( “{ active: false, collapsible: true }”, function( assert ) {</p>
...
assert.equal( element.outerHeight(), height );</pre>

<p>} );</p>

<p>QUnit.test( “{ active: Number }”, function( assert ) {</p>
...
assert.equal( element.accordion( &quot;option&quot;, &quot;active&quot; ), 1 );
state( assert, element, 0, 1, 0 );</pre>
...
<p>QUnit.test( “{ animate: false }”, function( assert ) {</p>
...
$.fn.animate = animate;</pre>

<p>} );</p>

<p>QUnit.test( “{ animate: Number }”, function( assert ) {</p>
...
<p>QUnit.test( “{ animate: String }”, function( assert ) {</p>
...
<p>QUnit.test( “{ animate: {} }”, function( assert ) {</p>
...
<p>QUnit.test( “{ animate: { duration, easing } }”, function( assert ) {</p>
...
<p>QUnit.test( “{ animate: { duration, easing } }, animate down”, function(
assert ) {</p>
...
<p>QUnit.test( “{ animate: { duration, easing, down } }, animate down”,
function( assert ) {</p>
...
<p>QUnit.test( “{ collapsible: false }”, function( assert ) {</p>
...
<p>QUnit.test( “{ collapsible: true }”, function( assert ) {</p>
...
element.find( &quot;.ui-accordion-header&quot; ).eq( 1 ).trigger( &quot;click&quot; );
assert.equal( element.accordion( &quot;option&quot;, &quot;active&quot; ), false );
state( assert, element, 0, 0, 0 );</pre>

<p>} );</p>

<p>QUnit.test( “{ event: null }”, function( assert ) {</p>
...
<p>QUnit.test( “{ event: custom }”, function( assert ) {</p>
...
<p>QUnit.test( “{ header: default }”, function( assert ) {</p>
...
// &gt; li &gt; :first-child
state( assert, $( &quot;#navigation&quot; ).accordion(), 1, 0, 0 );</pre>

<p>} );</p>

<p>QUnit.test( “{ header: custom }”, function( assert ) {</p>
...
state( assert, element, 1, 0, 0 );
element.accordion( &quot;option&quot;, &quot;active&quot;, 2 );
state( assert, element, 0, 0, 1 );</pre>

<p>} );</p>

<p>QUnit.test( “{ heightStyle: &#39;auto&#39; }”, function( assert ) {</p>

<pre>assert.expect( 3 );
var element = $( &quot;#navigation&quot; ).accordion( { heightStyle: &quot;auto&quot; } );
equalHeight( assert, element, 105 );</pre>

<p>} );</p>

<p>QUnit.test( “{ heightStyle: &#39;content&#39; }”, function( assert ) {</p>
...
assert.equal( sizes[ 2 ], 45 );</pre>

<p>} );</p>

<p>QUnit.test( “{ heightStyle: &#39;fill&#39; }”, function( assert ) {</p>

<pre>assert.expect( 3 );
$( &quot;#navigationWrapper&quot; ).height( 500 );
var element = $( &quot;#navigation&quot; ).accordion( { heightStyle: &quot;fill&quot; } );
equalHeight( assert, element, 455 );</pre>

<p>} );</p>

<p>QUnit.test( “{ heightStyle: &#39;fill&#39; } with sibling”, function(
assert ) {</p>
...
var element = $( &quot;#navigation&quot; ).accordion( { heightStyle: &quot;fill&quot; } );
equalHeight( assert, element, 355 );</pre>

<p>} );</p>

<p>QUnit.test( “{ heightStyle: &#39;fill&#39; } with multiple siblings”,
function( assert ) {</p>
...
$( &quot;&lt;p&gt;Lorem Ipsum&lt;/p&gt;&quot; )
        ...
        .prependTo( &quot;#navigationWrapper&quot; );
var element = $( &quot;#navigation&quot; ).accordion( { heightStyle: &quot;fill&quot; } );
equalHeight( assert, element, 305 );</pre>

<p>} );</p>

<p>QUnit.test( “{ icons: false }”, function( assert ) {</p>
...
<p>QUnit.test( “{ icons: hash }”, function( assert ) {</p>
...
assert.hasClasses( element.find( &quot;.ui-accordion-header.ui-state-active span.ui-icon&quot; ), &quot;a2&quot; );</pre>
