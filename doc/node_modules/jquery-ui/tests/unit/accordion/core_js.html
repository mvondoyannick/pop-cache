...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/accordion/core.js">
...
<p>var setupTeardown = testHelper.setupTeardown,</p>
...
<p>QUnit.module( “accordion: core”, setupTeardown() );</p>

<p>$.each( { div: “#list1”, ul: “#navigation”, dl: “#accordion-dl” },
function( type, selector ) {</p>
...
<p>QUnit.test( “handle click on header-descendant”, function( assert ) {</p>
...
assert.equal( headers.eq( 2 ).attr( &quot;aria-selected&quot; ), &quot;false&quot;, &quot;inactive tab (2) has aria-selected=false&quot; );
assert.equal( headers.eq( 2 ).attr( &quot;aria-expanded&quot; ), &quot;false&quot;, &quot;inactive tab (2) has aria-expanded=false&quot; );
assert.equal( headers.eq( 2 ).next().attr( &quot;aria-hidden&quot; ), &quot;true&quot;, &quot;inactive tabpanel (2) has aria-hidden=true&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “keyboard support”, function( assert ) {</p>
