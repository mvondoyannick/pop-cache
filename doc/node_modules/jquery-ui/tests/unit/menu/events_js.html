...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/menu/events.js">
...
<p>var log = testHelper.log,</p>

<pre class="ruby"><span class="ruby-identifier">logOutput</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">logOutput</span>,
<span class="ruby-identifier">click</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">click</span>;
</pre>

<p>QUnit.module( “menu: events”, {</p>
...
<p>QUnit.test( “handle click on menu”, function( assert ) {</p>
...
click( element, &quot;3&quot; );
click( element, &quot;1&quot; );
assert.equal( logOutput(), &quot;click,1,afterclick,2,3,1&quot;, &quot;Click order not valid.&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “handle click on custom item menu”, function( assert ) {</p>
...
<p>QUnit.test( “handle blur”, function( assert ) {</p>
...
<p>QUnit.test( “handle blur via click outside”, function( assert ) {</p>
...
<p>QUnit.test( “handle focus of menu with active item”, function( assert ) {</p>
...
<p>QUnit.test( “handle mouseenter on nested menu item”, function( assert ) {</p>
...
setTimeout( menumouseenter1, 25 );</pre>

<p>} );</p>

<p>QUnit.test( “handle submenu auto collapse: mouseleave, default markup”,
function( assert ) {</p>
...
setTimeout( menumouseleave1, 25 );</pre>

<p>} );</p>

<p>QUnit.test( “handle submenu auto collapse: mouseleave, custom markup”,
function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation on menu without scroll and without
submenus”, function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation on menu without scroll and with
submenus”, function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation on menu with scroll and without
submenus”, function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation on menu with scroll and with
submenus”, function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation and mouse click on menu with
disabled items”, function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation and mouse click on menu with
dividers and group labels”, function( assert ) {</p>
...
<p>QUnit.test( “handle keyboard navigation with spelling of menu items”,
function( assert ) {</p>
...
<p>QUnit.test( “Keep focus on selected item (see #10644)”, function( assert )
{</p>
...
<p>QUnit.test( “#9469: Stopping propagation in a select event should not
suppress subsequent select events.”, function( assert ) {</p>
...
assert.equal( logOutput(), &quot;1,2&quot;, &quot;Both select events were not triggered.&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#10571: When typing in a menu, only menu-items should be
focused”, function( assert ) {</p>
