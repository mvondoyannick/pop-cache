...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/menu/options.js">
...
click( element, &quot;1&quot; );
log( &quot;afterclick&quot; );
assert.equal( logOutput(), &quot;click,afterclick&quot;, &quot;Click order not valid.&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “{ disabled: false }”, function( assert ) {</p>
...
click( element, &quot;1&quot; );
log( &quot;afterclick&quot; );
assert.equal( logOutput(), &quot;click,1,afterclick&quot;, &quot;Click order not valid.&quot; );</pre>
...
<p>QUnit.test( “{ icons: { submenu: &#39;custom&#39; } }”, function( assert )
{</p>
...
<p>// TODO: test menus option</p>

<p>// TODO: test position option</p>

<p>QUnit.test( “{ role: &#39;menu&#39; } ”, function( assert ) {</p>

<pre>var element = $( &quot;#menu1&quot; ).menu(),
...
<p>QUnit.test( “{ role: &#39;listbox&#39; } ”, function( assert ) {</p>
...
<p>QUnit.test( “{ role: null }”, function( assert ) {</p>
