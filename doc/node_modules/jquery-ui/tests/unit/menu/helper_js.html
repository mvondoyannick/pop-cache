...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/menu/helper.js">
...
<pre class="ruby"><span class="ruby-identifier">log</span> = [];
</pre>

<p>return $.extend( helper, {</p>

<pre>log: function( message, clear ) {
        if ( clear ) {
                log.length = 0;
        }
