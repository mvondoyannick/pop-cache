...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/menu/core.js">
...
assert.equal( items.eq( 2 ).children().length, 1, &quot;Item has exactly 1 child when it does not have a sub menu&quot; );</pre>
...
// Item roles are tested in the role option tests</pre>

<p>} );</p>

<p>QUnit.test( “#9044: Autofocus issue with dialog opened from menu widget”,
function( assert ) {</p>
...
<p>QUnit.test( “#9532: Need a way in Menu to keep ui-state-active class on
selected item for Selectmenu”, function( assert ) {</p>
...
<p>QUnit.test( “active menu item styling”, function( assert ) {</p>
