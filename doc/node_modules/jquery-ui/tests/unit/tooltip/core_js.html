...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/tooltip/core.js">
...
assert.equal( liveRegion.parent().length, 0,
        &quot;Tooltip liveregion element should be removed&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “delegated removal”, function( assert ) {</p>
...
<p>QUnit.test( “nested tooltips”, function( assert ) {</p>
...
assert.equal( $( &quot;.ui-tooltip&quot; ).text(), &quot;child&quot; );</pre>

<p>} );</p>

<p>// #8742 QUnit.test( “form containing an input with name title”, function(
assert ) {</p>
...
assert.equal( $( &quot;.ui-tooltip&quot; ).length, 0, &quot;no tooltip for form&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “tooltip on .ui-state-disabled element”, function( assert ) {</p>
...
QUnit.test( “programmatic focus with async content”, function( assert ) {</p>
...
element.trigger( &quot;focus&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “destroy during hide animation; only one close event”,
function( assert ) {</p>
...
<p>// <a
href="http://bugs.jqueryui.com/ticket/10602">bugs.jqueryui.com/ticket/10602</a>
QUnit.test( “multiple active delegated tooltips”, function( assert ) {</p>
...
<p>// <a
href="http://bugs.jqueryui.com/ticket/11272">bugs.jqueryui.com/ticket/11272</a>
QUnit.test( “remove conflicting attributes from live region”, function(
assert ) {</p>
