...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/tooltip/options.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/tooltip&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “tooltip: options” );</p>

<p>QUnit.test( “disabled: true”, function( assert ) {</p>

<pre>assert.expect( 1 );
$( &quot;#tooltipped1&quot; ).tooltip( {
        disabled: true
} ).tooltip( &quot;open&quot; );
assert.equal( $( &quot;.ui-tooltip&quot; ).length, 0 );</pre>

<p>} );</p>

<p>QUnit.test( “content: default”, function( assert ) {</p>

<pre>assert.expect( 1 );
var element = $( &quot;#tooltipped1&quot; ).tooltip().tooltip( &quot;open&quot; );
assert.deepEqual( $( &quot;#&quot; + element.data( &quot;ui-tooltip-id&quot; ) ).text(), &quot;anchortitle&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “content: default; HTML escaping”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#&quot; + element.data( &quot;ui-tooltip-id&quot; ) ).text(), scriptText,
        &quot;correct tooltip text&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “content: return string”, function( assert ) {</p>
...
assert.deepEqual( $( &quot;#&quot; + element.data( &quot;ui-tooltip-id&quot; ) ).text(), &quot;customstring&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “content: return jQuery”, function( assert ) {</p>
...
assert.equal( liveRegion.children().last().html().toLowerCase(), &quot;&lt;div&gt;cu&lt;b&gt;s&lt;/b&gt;tomstring&lt;/div&gt;&quot;,
        &quot;The accessibility live region will strip the ids but keep the structure&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “content: sync + async callback”, function( assert ) {</p>
...
<p>// <a
href="http://bugs.jqueryui.com/ticket/8740">bugs.jqueryui.com/ticket/8740</a>
QUnit.test( “content: async callback loses focus before load”, function(
assert ) {</p>
...
element.trigger( &quot;mouseover&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “content: change while open”, function( assert ) {</p>
...
element.tooltip( &quot;open&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “content: string”, function( assert ) {</p>
...
<p>QUnit.test( “content: element”, function( assert ) {</p>
...
<p>QUnit.test( “content: jQuery”, function( assert ) {</p>
...
<p>QUnit.test( “items”, function( assert ) {</p>
...
element.tooltip( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “track + show delay”, function( assert ) {</p>
...
<p>QUnit.test( “track and programmatic focus”, function( assert ) {</p>

<pre>assert.expect( 1 );
$( &quot;#qunit-fixture div input&quot; ).tooltip( {
        track: true
} ).trigger( &quot;focus&quot; );
assert.equal( &quot;inputtitle&quot;, $( &quot;.ui-tooltip&quot; ).text() );</pre>
