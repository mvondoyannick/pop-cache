...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/tooltip/methods.js">
...
<p>QUnit.module( “tooltip: methods” );</p>
...
<p>// #8626 - Calling open() without an event QUnit.test( “open/close with
tracking”, function( assert ) {</p>
...
<p>QUnit.test( “enable/disable delegated”, function( assert ) {</p>
...
<p>QUnit.test( “preserve changes to title attributes on close and destroy”,
function( assert ) {</p>
