...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/effects/core.js">
...
&quot;ui/effects/effect-transfer&quot;</pre>

<p>], function( QUnit, $, common ) {</p>

<p>QUnit.assert.present = function( value, array, message ) {</p>

<pre>this.push( jQuery.inArray( value, array ) !== -1, value, array, message );</pre>

<p>};</p>

<p>QUnit.assert.notPresent = function( value, array, message ) {</p>
...
<p>// MinDuration is used for “short” animate tests where we are only
concerned about the final var minDuration = 60,</p>

<pre>// Duration is used for &quot;long&quot; animates where we plan on testing properties during animation
duration = 200;</pre>

<p>QUnit.module( “effects.core” );</p>

<p>// TODO: test all signatures of .show(), .hide(), .toggle(). // Look at
core&#39;s signatures and UI&#39;s signatures. QUnit.test( “.hide() with
step”, function( assert ) {</p>
...
<p>QUnit.test( “Immediate Return Conditions”, function( assert ) {</p>

<pre>var hidden = $( &quot;div.hidden&quot; ),
        count = 0;
assert.expect( 3 );
...
assert.equal( ++count, 3, &quot;Both Functions worked properly&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “.hide() with hidden parent”, function( assert ) {</p>
...
<p>QUnit.test( “Parse of null for options”, function( assert ) {</p>
...
<p>QUnit.test( “removeClass”, function( assert ) {</p>
...
element.removeClass();
assert.equal( &quot;&quot;, element[ 0 ].className );</pre>

<p>} );</p>

<p>QUnit.module( “effects.core: animateClass” );</p>

<p>QUnit.test( “animateClass works with borderStyle”, function( assert ) {</p>
...
assert.equal( test.css( &quot;borderLeftStyle&quot; ), &quot;solid&quot;, &quot;Solid border immedately set&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “animateClass works with colors”, function( assert ) {</p>
...
<p>QUnit.test( “animateClass calls step option”, function( assert ) {</p>
...
<p>QUnit.test( “animateClass works with children”, function( assert ) {</p>
...
<p>QUnit.test( “animateClass clears style properties when stopped”, function(
assert ) {</p>
...
<p>QUnit.test( “animateClass: css and class changes during animation are not
lost (#7106)”, function( assert ) {</p>
...
<p>QUnit.test( “createPlaceholder: only created for static or relative
elements”, function( assert ) {</p>
...
assert.ok( !$.effects.createPlaceholder( $( &quot;.fixed&quot; ) ), &quot;placeholder not created for fixed element&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “createPlaceholder: preserves layout affecting properties”,
function( assert ) {</p>
...
assert.deepEqual( before.outerHeight, placeholder.outerHeight( true ), &quot;height preserved&quot; );</pre>

<p>} );</p>

<p>QUnit.module( “transfer” );</p>

<p>QUnit.test( “transfer() without callback”, function( assert ) {</p>
...
<p>QUnit.test( “transfer() with callback”, function( assert ) {</p>
...
<p>$.each( $.effects.effect, function( effect ) {</p>

<pre>QUnit.module( &quot;effects.&quot; + effect );
