...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/dialog/methods.js">

<p>define( [</p>

<pre>&quot;qunit&quot;,
&quot;jquery&quot;,
&quot;ui/widgets/dialog&quot;</pre>

<p>], function( QUnit, $ ) {</p>

<p>QUnit.module( “dialog: methods”, {</p>
...
assert.equal( $( document ).data( &quot;ui-dialog-overlays&quot; ), undefined, &quot;ui-dialog-overlays equals the number of open overlays&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “#9000: Dialog leaves broken event handler after close/destroy
in certain cases”, function( assert ) {</p>
...
<p>QUnit.test( “#4980: Destroy should place element back in original DOM
position”, function( assert ) {</p>
...
assert.ok( $.contains( container[ 0 ], modal[ 0 ] ), &quot;dialog(destroy) should place element back in original DOM position&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “enable/disable disabled”, function( assert ) {</p>
...
assert.ok( !element.dialog( &quot;widget&quot; ).attr( &quot;aria-disabled&quot; ), &quot;disable method doesn&#39;t add aria-disabled&quot; );</pre>
...
element.dialog( &quot;close&quot; );
assert.ok( element.dialog( &quot;widget&quot; ).is( &quot;:hidden&quot; ) &amp;&amp; !element.dialog( &quot;widget&quot; ).is( &quot;:visible&quot; ), &quot;dialog hidden after close method called&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “isOpen”, function( assert ) {</p>
...
<p>QUnit.test( “moveToTop”, function( assert ) {</p>
...
<p>QUnit.test( “moveToTop: content scroll stays intact”, function( assert ) {</p>
...
assert.equal( scrollDialog.scrollTop(), 50 );</pre>
...
element.dialog( &quot;open&quot; );
assert.ok( element.dialog( &quot;widget&quot; ).is( &quot;:visible&quot; ) &amp;&amp; !element.dialog( &quot;widget&quot; ).is( &quot;:hidden&quot; ), &quot;dialog visible after open method called&quot; );</pre>

<p>} );</p>

<p>// <a
href="http://bugs.jqueryui.com/ticket/6137">bugs.jqueryui.com/ticket/6137</a>
QUnit.test( “Ensure form elements don&#39;t reset when opening a dialog”,
function( assert ) {</p>
...
<p>QUnit.test( “#8958: dialog can be opened while opening”, function( assert )
{</p>
...
<p>QUnit.test( “#5531: dialog width should be at least minWidth on creation”,
function( assert ) {</p>
