...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/dialog/options.js">
...
&quot;ui/effects/effect-explode&quot;</pre>

<p>], function( QUnit, $, testHelper ) {</p>

<p>QUnit.module( “dialog: options” );</p>

<p>QUnit.test( “appendTo”, function( assert ) {</p>
...
element.dialog( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “autoOpen”, function( assert ) {</p>
...
<p>QUnit.test( “buttons”, function( assert ) {</p>

<pre>assert.expect( 21 );
...
<p>QUnit.test( “buttons - advanced”, function( assert ) {</p>
...
<p>QUnit.test( “#9043: buttons with Array.prototype modification”, function(
assert ) {</p>
...
assert.equal( element.dialog( &quot;widget&quot; ).find( &quot;.ui-dialog-buttonpane&quot; ).length, 0,
        &quot;no button pane&quot; );
element.remove();
delete Array.prototype.test;</pre>

<p>} );</p>

<p>QUnit.test( “closeOnEscape”, function( assert ) {</p>
...
element.simulate( &quot;keydown&quot;, { keyCode: $.ui.keyCode.ESCAPE } )
        .simulate( &quot;keypress&quot;, { keyCode: $.ui.keyCode.ESCAPE } )
        .simulate( &quot;keyup&quot;, { keyCode: $.ui.keyCode.ESCAPE } );
assert.ok( element.dialog( &quot;widget&quot; ).is( &quot;:hidden&quot; ) &amp;&amp; !element.dialog( &quot;widget&quot; ).is( &quot;:visible&quot; ), &quot;dialog is closed after ESC&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “closeText”, function( assert ) {</p>
...
<p>QUnit.test( “draggable”, function( assert ) {</p>
...
<p>QUnit.test( “height”, function( assert ) {</p>
...
<p>QUnit.test( “maxHeight”, function( assert ) {</p>
...
<p>QUnit.test( “maxWidth”, function( assert ) {</p>
...
<p>QUnit.test( “minHeight”, function( assert ) {</p>
...
<p>QUnit.test( “minWidth”, function( assert ) {</p>
...
<p>QUnit.test( “position, default center on window”, function( assert ) {</p>
...
<p>QUnit.test( “position, right bottom at right bottom via ui.position args”,
function( assert ) {</p>
...
<p>QUnit.test( “position, at another element”, function( assert ) {</p>
...
<p>QUnit.test( “resizable”, function( assert ) {</p>
...
<p>QUnit.test( “title”, function( assert ) {</p>
...
<p>QUnit.test( “width”, function( assert ) {</p>
...
<p>QUnit.test( “#4826: setting resizable false toggles resizable on dialog”,
function( assert ) {</p>
...
<p>QUnit.test( “#8051 - &#39;Explode&#39; dialog animation causes crash in IE
6, 7 and 8”, function( assert ) {</p>
...
<p>QUnit.test( “#4421 - Focus lost from dialog which uses show-effect”,
function( assert ) {</p>
...
<p>QUnit.test( “Open followed by close during show effect”, function( assert )
{</p>
