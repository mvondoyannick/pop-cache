...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/dialog/events.js">
...
<p>QUnit.module( “dialog: events” );</p>
...
element.add( other ).remove();</pre>

<p>} );</p>

<p>QUnit.test( “dragStart”, function( assert ) {</p>
...
<p>QUnit.test( “drag”, function( assert ) {</p>
...
<p>QUnit.test( “dragStop”, function( assert ) {</p>
...
<p>QUnit.test( “resizeStart”, function( assert ) {</p>
...
<p>QUnit.test( “resizeStop”, function( assert ) {</p>
...
element.dialog( &quot;close&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “beforeClose”, function( assert ) {</p>
...
<p>// #8789 and #8838 QUnit.test( “ensure dialog&#39;s container doesn&#39;t
scroll on resize and focus”, function( assert ) {</p>
...
<p>QUnit.test( “#5184: isOpen in dialogclose event is true”, function( assert
) {</p>
...
<p>QUnit.test( “ensure dialog keeps focus when clicking modal overlay”,
function( assert ) {</p>
