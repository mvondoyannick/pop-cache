...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/dialog/core.js">
...
<p>// TODO add teardown callback to remove dialogs QUnit.module( “dialog:
core” );</p>
...
assert.equal( buttons.length, 1, &quot;Buttonset contains exactly 1 button when created with 1&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “markup structure - no buttons”, function( assert ) {</p>
...
assert.equal( close.length, 1, &quot;Titlebar has exactly one close button&quot; );
assert.equal( title.length, 1, &quot;Titlebar has exactly one title&quot; );
assert.hasClasses( element, &quot;ui-dialog-content ui-widget-content&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “title id”, function( assert ) {</p>
...
<p>QUnit.test( “widget method”, function( assert ) {</p>
...
<p>QUnit.test( “focus tabbable”, function( assert ) {</p>
...
<p>QUnit.test( “#7960: resizable handles below modal overlays”, function(
assert ) {</p>
...
dialog.dialog( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Prevent tabbing out of dialogs”, function( assert ) {</p>
...
<p>QUnit.test( “#9048: multiple modal dialogs opened and closed in different
order”,</p>
...
<p>QUnit.test( “interaction between overlay and other dialogs”, function(
assert ) {</p>
