...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/datepicker/events.js">
...
&quot;jquery&quot;,
&quot;./helper&quot;,
&quot;ui/widgets/datepicker&quot;</pre>

<p>], function( QUnit, $, testHelper ) {</p>

<p>QUnit.module( “datepicker: events” );</p>

<p>var selectedThis = null, selectedDate = null, selectedInst = null;</p>

<p>function callback( date, inst ) {</p>

<pre class="ruby"><span class="ruby-identifier">selectedThis</span> = <span class="ruby-identifier">this</span>;
<span class="ruby-identifier">selectedDate</span> = <span class="ruby-identifier">date</span>;
<span class="ruby-identifier">selectedInst</span> = <span class="ruby-identifier">inst</span>;
</pre>

<p>}</p>

<p>function callback2( year, month, inst ) {</p>

<pre class="ruby"><span class="ruby-identifier">selectedThis</span> = <span class="ruby-identifier">this</span>;
<span class="ruby-identifier">selectedDate</span> = <span class="ruby-identifier">year</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;/&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">month</span>;
<span class="ruby-identifier">selectedInst</span> = <span class="ruby-identifier">inst</span>;
</pre>

<p>}</p>

<p>QUnit.test( “events”, function( assert ) {</p>
...
inp.datepicker( &quot;show&quot; );
assert.equal( selectedThis, inp2[ 0 ], &quot;Callback close this&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “beforeShowDay-getDate”, function( assert ) {</p>
