...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/datepicker/core.js">
...
&quot;ui/i18n/datepicker-he&quot;</pre>

<p>], function( QUnit, $, common, testHelper ) {</p>

<p>QUnit.module( “datepicker: core”, {</p>
...
<p>common.testJshint( “widgets/datepicker” );</p>

<p>QUnit.test( “initialization - Reinitialization after body had been
emptied.”, function( assert ) {</p>
...
$( &quot;body&quot; ).empty().append( bodyContent ); // Returning to initial state for later tests</pre>

<p>} );</p>

<p>QUnit.test( “widget method - empty collection”, function( assert ) {</p>

<pre>assert.expect( 1 );
$( &quot;#nonExist&quot; ).datepicker(); // Should create nothing
assert.ok( !$( &quot;#ui-datepicker-div&quot; ).length, &quot;Non init on empty collection&quot; );</pre>
...
assert.deepEqual( $( &quot;body &gt; #ui-datepicker-div:last-child&quot; )[ 0 ], actual );</pre>

<p>} );</p>

<p>QUnit.test( “baseStructure”, function( assert ) {</p>
...
<p>QUnit.test( “customStructure”, function( assert ) {</p>
...
<p>QUnit.test( “keystrokes”, function( assert ) {</p>
...
testHelper.equalsDate( assert, inp.datepicker( &quot;getDate&quot; ), new Date( 2008, 4 - 1, 4 ),
        &quot;Keystroke pgdn step 2&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “mouse”, function( assert ) {</p>
