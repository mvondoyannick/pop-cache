...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/datepicker/helper.js">
...
<p>], function( QUnit, $, helper ) {</p>

<p>return $.extend( helper, {</p>

<pre>addMonths: function( date, offset ) {
