...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/datepicker/methods.js">
...
<p>QUnit.module( “datepicker: methods” );</p>

<p>QUnit.test( “destroy”, function( assert ) {</p>

<pre>assert.expect( 33 );
var inl,
...
assert.ok( inl.next().length === 0 || inl.next().is( &quot;p&quot; ), &quot;Inline - button absent&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “enableDisable”, function( assert ) {</p>
