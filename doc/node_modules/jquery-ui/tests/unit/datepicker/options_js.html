...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/datepicker/options.js">
...
<p>QUnit.module( “datepicker: options” );</p>

<p>QUnit.test( “setDefaults”, function( assert ) {</p>
...
assert.equal( $.datepicker._defaults.showOn, &quot;focus&quot;, &quot;Restore showOn&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “option”, function( assert ) {</p>

<pre>assert.expect( 17 );
...
assert.deepEqual( inp.datepicker( &quot;option&quot;, &quot;defaults&quot; ), $.datepicker._defaults,
        &quot;Get default settings&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “disabled”, function( assert ) {</p>

<pre class="ruby"><span class="ruby-identifier">assert</span>.<span class="ruby-identifier">expect</span>( <span class="ruby-value">8</span> );
<span class="ruby-identifier">var</span> <span class="ruby-identifier">inp</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">init</span>( <span class="ruby-string">&quot;#inp&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-operator">!</span><span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;isDisabled&quot;</span> ), <span class="ruby-string">&quot;Initially marked as enabled&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-operator">!</span><span class="ruby-identifier">inp</span>[ <span class="ruby-value">0</span> ].<span class="ruby-identifier">disabled</span>, <span class="ruby-string">&quot;Field initially enabled&quot;</span> );
<span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;option&quot;</span>, <span class="ruby-string">&quot;disabled&quot;</span>, <span class="ruby-keyword">true</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;isDisabled&quot;</span> ), <span class="ruby-string">&quot;Marked as disabled&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-identifier">inp</span>[ <span class="ruby-value">0</span> ].<span class="ruby-identifier">disabled</span>, <span class="ruby-string">&quot;Field now disabled&quot;</span> );
<span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;option&quot;</span>, <span class="ruby-string">&quot;disabled&quot;</span>, <span class="ruby-keyword">false</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-operator">!</span><span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;isDisabled&quot;</span> ), <span class="ruby-string">&quot;Marked as enabled&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-operator">!</span><span class="ruby-identifier">inp</span>[ <span class="ruby-value">0</span> ].<span class="ruby-identifier">disabled</span>, <span class="ruby-string">&quot;Field now enabled&quot;</span> );
<span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;destroy&quot;</span> );

<span class="ruby-identifier">inp</span> = <span class="ruby-identifier">testHelper</span>.<span class="ruby-identifier">init</span>( <span class="ruby-string">&quot;#inp&quot;</span>, { <span class="ruby-value">disabled:</span> <span class="ruby-keyword">true</span> } );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-identifier">inp</span>.<span class="ruby-identifier">datepicker</span>( <span class="ruby-string">&quot;isDisabled&quot;</span> ), <span class="ruby-string">&quot;Initially marked as disabled&quot;</span> );
<span class="ruby-identifier">assert</span>.<span class="ruby-identifier">ok</span>( <span class="ruby-identifier">inp</span>[ <span class="ruby-value">0</span> ].<span class="ruby-identifier">disabled</span>, <span class="ruby-string">&quot;Field initially disabled&quot;</span> );
</pre>

<p>} );</p>

<p>QUnit.test( “change”, function( assert ) {</p>
...
assert.equal( inst.settings.showOn, null, &quot;Clear setting showOn&quot; );
assert.equal( $.datepicker._get( inst, &quot;showOn&quot; ), &quot;focus&quot;, &quot;Restore instance showOn&quot; );
assert.equal( $.datepicker._defaults.showOn, &quot;focus&quot;, &quot;Retain default showOn&quot; );</pre>

<p>} );</p>

<p>( function() {</p>

<pre>var url = window.location.search;
...
<p>QUnit.test( “otherMonths”, function( assert ) {</p>
...
assert.equal( pop.find( &quot;tbody&quot; ).text(),
        ...
        $( &quot;&lt;span&gt;\u00a0123456789101112131415161718192021222324252627282930\u00a0\u00a0\u00a0\u00a0&lt;/span&gt;&quot; ).text(),
        &quot;Other months - none&quot; );
assert.ok( pop.find( &quot;td:last *&quot; ).length === 0, &quot;Other months - no content&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “defaultDate”, function( assert ) {</p>

<pre>assert.expect( 16 );
var inp = testHelper.init( &quot;#inp&quot; ),
        date = new Date();
...
inp.datepicker( &quot;option&quot;, { dateFormat: &quot;mm/dd/yy&quot;, defaultDate: date } ).
        datepicker( &quot;hide&quot; ).val( &quot;&quot; ).datepicker( &quot;show&quot; ).
        simulate( &quot;keydown&quot;, { keyCode: $.ui.keyCode.ENTER } );
testHelper.equalsDate( assert, inp.datepicker( &quot;getDate&quot; ), date, &quot;Default date 01/26/2007&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “miscellaneous”, function( assert ) {</p>

<pre>assert.expect( 19 );
...
assert.equal( dp.find( &quot;.ui-datepicker-next&quot; ).text(),
        shortNames[ 2 ] + &quot; &gt;&quot;, &quot;Navigation next - as date format + goto current&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “minMax”, function( assert ) {</p>

<pre>assert.expect( 23 );
var date,
        inp = testHelper.init( &quot;#inp&quot; ),
        dp = $( &quot;#ui-datepicker-div&quot; ),
...
assert.ok( !dp.find( &quot;.ui-datepicker-prev&quot; ).hasClass( &quot;ui-state-disabled&quot; ), &quot;Year Range Test - absolute - prev button enabled&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “setDate”, function( assert ) {</p>
...
assert.equal( dateAndTimeToSet.getTime(), dateAndTimeClone.getTime(), &quot;Date object passed should not be changed by setDate&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “altField”, function( assert ) {</p>
...
assert.equal( alt.val(), &quot;&quot;, &quot;Alt field - alt - ctrl+end&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “autoSize”, function( assert ) {</p>
...
inp.datepicker( &quot;option&quot;, &quot;dateFormat&quot;, &quot;DD, MM dd, yy&quot; );
assert.equal( inp.prop( &quot;size&quot; ), 23, &quot;Auto size - he - DD, MM dd, yy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “daylightSaving”, function( assert ) {</p>

<pre>assert.expect( 25 );
var inp = testHelper.init( &quot;#inp&quot; ),
        dp = $( &quot;#ui-datepicker-div&quot; );
...
inp.val( &quot;11/01/2008&quot; ).datepicker( &quot;show&quot; );
$( &quot;.ui-datepicker-calendar td:eq(8) a&quot;, dp ).simulate( &quot;click&quot; );
assert.equal( inp.val(), &quot;11/03/2008&quot;, &quot;Daylight saving - US 11/03/2008&quot; );</pre>

<p>} );</p>

<p>var beforeShowThis = null,</p>

<pre class="ruby"><span class="ruby-identifier">beforeShowInput</span> = <span class="ruby-identifier">null</span>,
<span class="ruby-identifier">beforeShowInst</span> = <span class="ruby-identifier">null</span>,
<span class="ruby-identifier">beforeShowDayThis</span> = <span class="ruby-identifier">null</span>,
<span class="ruby-identifier">beforeShowDayOK</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>function beforeAll( input, inst ) {</p>

<pre class="ruby"><span class="ruby-identifier">beforeShowThis</span> = <span class="ruby-identifier">this</span>;
<span class="ruby-identifier">beforeShowInput</span> = <span class="ruby-identifier">input</span>;
<span class="ruby-identifier">beforeShowInst</span> = <span class="ruby-identifier">inst</span>;
<span class="ruby-keyword">return</span> { <span class="ruby-value">currentText:</span> <span class="ruby-string">&quot;Current&quot;</span> };
</pre>

<p>}</p>

<p>function beforeDay( date ) {</p>

<pre>beforeShowDayThis = this;
beforeShowDayOK &amp;= ( date &gt; new Date( 2008, 1 - 1, 26 ) &amp;&amp;
        date &lt; new Date( 2008, 3 - 1, 6 ) );
return [ ( date.getDate() % 2 === 0 ), ( date.getDate() % 10 === 0 ? &quot;day10&quot; : &quot;&quot; ),
        ( date.getDate() % 3 === 0 ? &quot;Divisble by 3&quot; : &quot;&quot; ) ];</pre>

<p>}</p>

<p>QUnit.test( “callbacks”, function( assert ) {</p>

<pre>assert.expect( 13 );
...
inp.datepicker( &quot;hide&quot; ).datepicker( &quot;destroy&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “beforeShowDay - tooltips with quotes”, function( assert ) {</p>
...
<p>QUnit.test( “localisation”, function( assert ) {</p>
...
assert.equal( inp.val(), $.datepicker.regional.fr.dayNames[ date.getDay() ] + &quot;, &quot; +
        ...
        &quot; &quot; + date.getFullYear(), &quot;Localisation - formatting&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “noWeekends”, function( assert ) {</p>

<pre>assert.expect( 31 );
var i, date;
for ( i = 1; i &lt;= 31; i++ ) {
...
<p>QUnit.test( “iso8601Week”, function( assert ) {</p>
...
assert.equal( $.datepicker.iso8601Week( date ), 1, &quot;ISO 8601 week &quot; + date );</pre>

<p>} );</p>

<p>QUnit.test( “parseDate”, function( assert ) {</p>

<pre>assert.expect( 26 );
testHelper.init( &quot;#inp&quot; );
...
testHelper.equalsDate( assert, $.datepicker.parseDate( &quot;yy M d&quot;, &quot;2011 十一月 22&quot;, zh ),
        new Date( 2011, 11 - 1, 22 ), &quot;Parse date yy M d with zh-CN&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “parseDateErrors”, function( assert ) {</p>

<pre>assert.expect( 18 );
testHelper.init( &quot;#inp&quot; );
var fr, settings;
...
expectError( function() { $.datepicker.parseDate( &quot;D d M y&quot;, &quot;Lun. 9 Apr 01&quot;, settings ); },
        &quot;Lun. 9 Apr 01 - D d M y&quot;, &quot;Unknown name at position 7&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “Ticket #7244: date parser does not fail when too many numbers
are passed into the date function”, function( assert ) {</p>
...
<p>QUnit.test( “formatDate”, function( assert ) {</p>
...
assert.equal( $.datepicker.formatDate( &quot;&#39;jour&#39; d &#39;de&#39; MM (&#39;&#39;DD&#39;&#39;), yy&quot;,
        ...
        &quot;Format date &#39;jour&#39; d &#39;de&#39; MM (&#39;&#39;DD&#39;&#39;), yy with settings&quot; );</pre>

<p>} );</p>

<p>// TODO: Fix this test so it isn&#39;t mysteriously flaky in Browserstack
on certain OS/Browser combos // test(“Ticket 6827: formatDate day of year
calculation is wrong during day lights savings time”, function(){ //     
expect( 1 ); //      var time = $.datepicker.formatDate(“oo”, new
Date(“2010/03/30 12:00:00 CDT”)); //      equal(time, “089”); // });</p>

<p>QUnit.test( “Ticket 7602: Stop datepicker from appearing with beforeShow
event handler”, function( assert ) {</p>
