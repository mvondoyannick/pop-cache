...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/resizable/events.js">
...
<p>QUnit.module( “resizable: events” );</p>
...
assert.equal( count, 1, &quot;start callback should happen exactly once&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resize”, function( assert ) {</p>
...
assert.equal( count, 2, &quot;resize callback should happen exactly once per size adjustment&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resize (min/max dimensions)”, function( assert ) {</p>
...
assert.equal( count, 1, &quot;resize callback should happen exactly once per size adjustment&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resize (containment)”, function( assert ) {</p>
...
<p>QUnit.test( “resize (grid)”, function( assert ) {</p>
...
assert.equal( count, 1, &quot;resize callback should happen exactly once per grid-unit size adjustment&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resize, custom adjustment”, function( assert ) {</p>
...
assert.equal( element.position().top, 400, &quot;resize event can control top&quot; );</pre>
...
assert.equal( count, 1, &quot;stop callback should happen exactly once&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resize (containment) works with parent with negative offset”,
function( assert ) {</p>
...
assert.equal( widthAfter, ( widthBefore + increaseWidthBy ), &quot;resizable width should be increased by the value dragged&quot; );</pre>
