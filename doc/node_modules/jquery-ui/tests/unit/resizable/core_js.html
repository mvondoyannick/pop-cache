...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/resizable/core.js">
...
<p>QUnit.module( “resizable: core” );</p>

<p>Test(“element types”, function() {</p>

<pre>var typeNames = (&quot;p,h1,h2,h3,h4,h5,h6,blockquote,ol,ul,dl,div,form&quot;
...
<p>QUnit.test( “n”, function( assert ) {</p>
...
assert.equal( target[ 0 ].style.width, &quot;&quot;, &quot;width should not be modified&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “s”, function( assert ) {</p>
...
<p>QUnit.test( “e”, function( assert ) {</p>
...
assert.equal( target[ 0 ].style.top, &quot;&quot;, &quot;top should not be modified&quot; );
assert.equal( target[ 0 ].style.left, &quot;&quot;, &quot;left should not be modified&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “w”, function( assert ) {</p>
...
assert.equal( target[ 0 ].style.height, &quot;&quot;, &quot;height should not be modified&quot; );
assert.equal( target[ 0 ].style.top, &quot;&quot;, &quot;top should not be modified&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ne”, function( assert ) {</p>
...
<p>QUnit.test( “se”, function( assert ) {</p>
...
<p>QUnit.test( “sw”, function( assert ) {</p>
...
<p>QUnit.test( “nw”, function( assert ) {</p>
...
<p>QUnit.test( “handle with complex markup (#8756)”, function( assert ) {</p>
...
testHelper.drag( handle, 50 );
assert.equal( target.width(), 100, &quot;compare width&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resizable accounts for scroll position correctly (#3815)”,
function( assert ) {</p>
...
assert.equal( $( handle ).position().left, handlePosition + 50, &quot;handle also moved&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “resizable stores correct size when using helper and grid
(#9547)”, function( assert ) {</p>
...
<p>QUnit.test( “nested resizable”, function( assert ) {</p>
