...
<main role="main" aria-label="Page node_modules/jquery-ui/tests/unit/resizable/options.js">
...
&quot;jquery&quot;,
&quot;./helper&quot;,
&quot;ui/widgets/resizable&quot;</pre>

<p>], function( QUnit, $, testHelper ) {</p>

<p>QUnit.module( “resizable: options” );</p>

<p>QUnit.test( “alsoResize”, function( assert ) {</p>
...
assert.equal( other.width(), 130, &quot;alsoResize width&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (e)”, function( assert ) {</p>
...
assert.equal( target.height(), 70, &quot;compare minHeight&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (w)”, function( assert ) {</p>
...
<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (n)”, function( assert ) {</p>
...
<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (s)”, function( assert ) {</p>
...
<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (se)”, function( assert ) {</p>
...
<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (sw)”, function( assert ) {</p>
...
<p>QUnit.test( “aspectRatio: &#39;preserve&#39; (ne)”, function( assert ) {</p>
...
<p>QUnit.test( “aspectRatio: Resizing can move objects”, function( assert ) {</p>
...
assert.equal( target.position().top, 0, &quot;compare top - no movement&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “containment”, function( assert ) {</p>
...
assert.equal( element.height(), 200, &quot;constrained height at containment edge&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “containment - not immediate parent”, function( assert ) {</p>
...
assert.equal( element.height(), 300, &quot;Relative with Top, contained within container height&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “containment - immediate parent”, function( assert ) {</p>
...
testHelper.drag( &quot;.ui-resizable-s&quot;, 0, 400 );
assert.equal( element.height(), 250, &quot;Relative with Top, contained within container height&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “grid”, function( assert ) {</p>
...
assert.equal( target.height(), 120, &quot;compare height&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “grid (min/max dimensions)”, function( assert ) {</p>
...
assert.equal( target.height(), 80, &quot;grid should respect minHeight&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “grid (wrapped)”, function( assert ) {</p>
...
<p>QUnit.test( “grid - Resizable: can be moved when grid option is set
(#9611)”, function( assert ) {</p>
...
assert.equal( target.position().left, oldPosition.left, &quot;compare left&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “grid - maintains grid with padding and border when approaching
no dimensions”, function( assert ) {</p>
...
assert.equal( target.outerHeight(), 52, &quot;compare height&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ui-resizable-se { handles: &#39;all&#39;, minWidth: 60,
minHeight: 60, maxWidth: 100, maxHeight: 100 }”, function( assert ) {</p>
...
assert.equal( target.height(), 100, &quot;compare maxHeight&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “ui-resizable-sw { handles: &#39;all&#39;, minWidth: 60,
minHeight: 60, maxWidth: 100, maxHeight: 100 }”, function( assert ) {</p>
...
<p>QUnit.test( “ui-resizable-ne { handles: &#39;all&#39;, minWidth: 60,
minHeight: 60, maxWidth: 100, maxHeight: 100 }”, function( assert ) {</p>
...
<p>QUnit.test( “ui-resizable-nw { handles: &#39;all&#39;, minWidth: 60,
minHeight: 60, maxWidth: 100, maxHeight: 100 }”, function( assert ) {</p>
...
<p>QUnit.test( “custom handles { handles: { &#39;s&#39;:
$(&#39;#resizer1&#39;), containment: &#39;parent&#39; }”, function( assert
) {</p>
...
testHelper.drag( handle, 0, -70 );
assert.equal( target.height(), 100, &quot;compare height&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “custom handles { handles: { &#39;s&#39;: $(&#39;#<a
href="0">resizer1’)</a>, containment: &#39;parent&#39; }”, function( assert
) {</p>
...
<p>QUnit.test( “zIndex, applied to all handles”, function( assert ) {</p>
...
<p>QUnit.test( “setOption handles”, function( assert ) {</p>
...
checkHandles( [ &quot;s&quot;, &quot;w&quot; ] );</pre>

<p>} );</p>

<p>QUnit.test( “alsoResize + containment”, function( assert ) {</p>
...
assert.equal( other.height(), 150, &quot;alsoResize constrained height at containment edge&quot; );</pre>

<p>} );</p>

<p>QUnit.test( “alsoResize + multiple selection”, function( assert ) {</p>
...
assert.equal( other2.height(), 150, &quot;alsoResize o2 constrained height at containment edge&quot; );</pre>
