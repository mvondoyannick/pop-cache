...
<main role="main" aria-label="Page node_modules/jquery-ui/Gruntfile.js">
...
<p>function mapMinFile( file ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-string">&quot;dist/&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">file</span>.<span class="ruby-identifier">replace</span>( <span class="ruby-regexp">/ui\//</span>, <span class="ruby-string">&quot;minified/&quot;</span> );
</pre>

<p>}</p>

<p>function expandFiles( files ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">grunt</span>.<span class="ruby-identifier">util</span>.<span class="ruby-identifier">_</span>.<span class="ruby-identifier">pluck</span>( <span class="ruby-identifier">grunt</span>.<span class="ruby-identifier">file</span>.<span class="ruby-identifier">expandMapping</span>( <span class="ruby-identifier">files</span> ), <span class="ruby-string">&quot;src&quot;</span> ).<span class="ruby-identifier">map</span>(<span class="ruby-identifier">function</span>( <span class="ruby-identifier">values</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">values</span>[ <span class="ruby-value">0</span> ];
});
</pre>

<p>}</p>

<p>uiFiles.concat( allI18nFiles ).forEach(function( file ) {</p>

<pre class="ruby"><span class="ruby-identifier">minify</span>[ <span class="ruby-identifier">file</span> ] = {
        <span class="ruby-value">options:</span> {
                <span class="ruby-value">banner:</span> <span class="ruby-identifier">createBanner</span>()
        },
        <span class="ruby-value">files:</span> {}
};
<span class="ruby-identifier">minify</span>[ <span class="ruby-identifier">file</span> ].<span class="ruby-identifier">files</span>[ <span class="ruby-identifier">mapMinFile</span>( <span class="ruby-identifier">file</span> ) ] = <span class="ruby-identifier">file</span>;
</pre>

<p>});</p>

<p>uiFiles.forEach(function( file ) {</p>

<pre>// TODO this doesn&#39;t do anything until https://github.com/rwldrn/grunt-compare-size/issues/13
compareFiles[ file ] = [ file, mapMinFile( file ) ];</pre>

<p>});</p>

<p>// grunt plugins require( “load-grunt-tasks” )( grunt ); // local testswarm
and build tasks grunt.loadTasks( “build/tasks” );</p>

<p>function stripDirectory( file ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">file</span>.<span class="ruby-identifier">replace</span>( <span class="ruby-regexp">/.+\/(.+?)&gt;?$/</span>, <span class="ruby-string">&quot;$1&quot;</span> );
</pre>

<p>}</p>

<p>function createBanner( files ) {</p>
...
<pre>pkg: grunt.file.readJSON( &quot;package.json&quot; ),
files: {
...
<p>grunt.registerTask( “update-authors”, function() {</p>

<pre>var getAuthors = require( &quot;grunt-git-authors&quot; ).getAuthors,
        done = this.async();
...
<p>grunt.registerTask( “default”, [ “lint”, “requirejs”, “test” ]);
grunt.registerTask( “jenkins”, [ “default”, “concat” ]);
grunt.registerTask( “lint”, [ “asciilint”, “jshint”, “jscs”, “csslint”,
“htmllint” ]); grunt.registerTask( “test”, [ “qunit” ]);
grunt.registerTask( “sizer”, [ “requirejs:js”, “uglify:main”,
“compare_size:all” ]); grunt.registerTask( “sizer_all”, [ “requirejs:js”,
“uglify”, “compare_size” ]);</p>
