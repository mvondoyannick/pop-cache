...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Contributing+to+jQuery+UI">Contributing to jQuery UI</a>
    <li><a href="#label-Getting+Involved">Getting Involved</a>
    <li><a href="#label-Weekly+Meetings">Weekly Meetings</a>
    <li><a href="#label-Tips+for+Getting+Started">Tips for Getting Started</a>
    <li><a href="#label-Environment-3A+Minimum+Required">Environment: Minimum Required</a>
    <li><a href="#label-Environment-3A+Getting+the+Source">Environment: Getting the Source</a>
    <li><a href="#label-Environment-3A+Recommended+Setup">Environment: Recommended Setup</a>
    <li><a href="#label-Running+the+Tests">Running the Tests</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/jquery-ui/CONTRIBUTING.md">

<h1 id="label-Contributing+to+jQuery+UI">Contributing to jQuery UI<span><a href="#label-Contributing+to+jQuery+UI">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Welcome! Thanks for your interest in contributing to jQuery UI. Most of our
information on how to contribute to this and all other jQuery Foundation
projects is over at <a
href="http://contribute.jquery.org">contribute.jquery.org</a>. You&#39;ll
definitely want to take a look at the articles on contributing <a
href="http://contribute.jquery.org/code">code</a>.</p>

<p>You may also want to take a look at our <a
href="http://contribute.jquery.org/commits-and-pull-requests/">commit &
pull request guide</a> and <a
href="http://contribute.jquery.org/style-guide/">style guides</a> for
instructions on how to maintain your fork and submit your code. Before we
can merge any pull request, we&#39;ll also need you to sign our <a
href="http://contribute.jquery.org/cla">contributor license agreement</a>.</p>

<p>You can find us on <a href="http://irc.jquery.org">IRC</a>, specifically in
jqueryui-dev should you have any questions. If you&#39;ve never contributed
to open source before, we&#39;ve put together <a
href="http://contribute.jquery.org/open-source/">a short guide with tips,
tricks, and ideas on getting started</a>. For other forms of discussion and
support, please see the <a href="http://jqueryui.com/support/">jQuery UI
support center</a>.</p>

<h2 id="label-Getting+Involved">Getting Involved<span><a href="#label-Getting+Involved">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>There are a number of ways to get involved with the development of jQuery
UI. Even if you&#39;ve never contributed code to an Open Source project
before, we&#39;re always looking for help identifying bugs, writing and
reducing test cases and documentation.</p>

<p>This is the best way to contribute to jQuery UI. Please read through the
full guide detailing <a
href="http://contribute.jquery.org/bug-reports/">How to Report Bugs</a>.</p>

<h3 id="label-Weekly+Meetings">Weekly Meetings<span><a href="#label-Weekly+Meetings">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Every week (unless otherwise noted) the jQuery UI team has a meeting to
discuss the progress of current work and to bring forward possible new
blockers for discussion. The meeting is held on <a
href="http://irc.jquery.org">IRC</a> in the jquery-meeting channel at <a
href="http://www.timeanddate.com/worldclock/fixedtime.html?month=1&day=17&year=2011&hour=12&min=0&sec=0&p1=43">Noon
EST</a> on Wednesdays. Meeting notes are posted on <a
href="http://meetings.jquery.org/category/ui">meetings.jquery.org/category/ui</a>/
after each meeting.</p>

<h2 id="label-Tips+for+Getting+Started">Tips for Getting Started<span><a href="#label-Tips+for+Getting+Started">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Environment-3A+Minimum+Required">Environment: Minimum Required<span><a href="#label-Environment-3A+Minimum+Required">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If you are contributing changes you will need a fork of jquery-ui (see <a
href="#environment-getting-the-source">Getting the Source</a>). If you just
want the source code you could clone jquery-ui directly:</p>

<pre>git clone git://github.com/jquery/jquery-ui.git
cd jquery-ui</pre>

<p>The tests can run in any local web server. Ideally you should test your
patch in appropriate web browsers and if possible run <code>npm test</code>
to lint the code and run automated tests (this will happen automatically
when you create a pull request). See the <a
href="#environment-recommended-setup">Recommended Setup</a> for setting up
Node.js so that the <code>npm test</code> command works.</p>

<h3 id="label-Environment-3A+Getting+the+Source">Environment: Getting the Source<span><a href="#label-Environment-3A+Getting+the+Source">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p>Create a fork of the jQuery UI repo on GitHub at <a
href="http://github.com/jquery/jquery-ui">github.com/jquery/jquery-ui</a>.
This will create a fork of jquery-ui in your Github account.</p>
</li><li>
<p>You may want to clone jquery-ui under the path to your web server. If so,
change to the required directory</p>
</li></ul>

<pre>cd /path/to/your/www/root/</pre>
<ul><li>
<p>Clone your jQuery UI git repo.</p>
</li></ul>

<pre>git clone git://github.com/[USERNAME]/jquery-ui.git
cd jquery-ui</pre>

<p><em>Note: be sure to replace <code>[USERNAME]</code> with your GitHub
username.</em></p>
<ul><li>
<p>Add the official jQuery repository as a remote. We recommend naming it
“upstream”.</p>
</li></ul>

<pre>git remote add upstream git://github.com/jquery/jquery-ui.git</pre>
<ul><li>
<p>Get in the habit of pulling in the “upstream” master to stay up to date as
jQuery UI receives new commits.</p>
</li></ul>

<pre class="ruby"><span class="ruby-identifier">git</span> <span class="ruby-identifier">pull</span> <span class="ruby-identifier">upstream</span> <span class="ruby-identifier">master</span>
</pre>

<h3 id="label-Environment-3A+Recommended+Setup">Environment: Recommended Setup<span><a href="#label-Environment-3A+Recommended+Setup">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>jQuery UI uses Node.js to automate the building and validation of source
code. Here is how to set that up:</p>
<ul><li>
<p>Get <a href="http://nodejs.org/">Node.js</a> (includes NPM, necessary for
the next step)</p>
</li><li>
<p>Install local Node.js modules</p>
</li></ul>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span>
</pre>

<p>The tests require a local web server and the samples contain some PHP, so a
PHP web server may be useful.</p>
<ul><li>
<p>Install a web server. Here are some you could use:</p>
</li><li>
<p>Windows: <a href="http://www.wampserver.com/en/">WAMP download</a></p>
</li><li>
<p>Mac: <a href="http://www.mamp.info/en/index.html">MAMP download</a></p>
</li><li>
<p>Linux: <a
href="https://www.linux.com/learn/tutorials/288158-easy-lamp-server-installation">Setting
up LAMP</a></p>
</li><li>
<p><a href="http://code.google.com/p/mongoose/">Mongoose (most platforms)</a></p>
</li><li>
<p><a href="https://www.npmjs.com/package/http-server">http-server</a></p>
</li></ul>

<h3 id="label-Running+the+Tests">Running the Tests<span><a href="#label-Running+the+Tests">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To lint the JavaScript, HTML, and CSS, as well as run a smoke test in
PhantomJS, run the full test suite through npm:</p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">test</span>
</pre>

<p>To run the tests for a specific plugin in your browser, open the
appropriate file from the <code>/tests/unit/</code> directory, for example:
<code>http://localhost/tests/unit/accordion/accordion.html</code>. The
domain will be dependent on your local server configuration; if there is a
port, be sure to include it.</p>

<p>Ideally you would test in all of our <a
href="http://jqueryui.com/browser-support/">supported browsers</a>, but if
you don&#39;t have all of these browsers available, that&#39;s ok.</p>
</main>
