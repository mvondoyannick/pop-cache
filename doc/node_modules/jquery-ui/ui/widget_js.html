...
<title>widget.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/ui/widget.js">
...
<p>//&gt;&gt;label: Widget //&gt;&gt;group: Core //&gt;&gt;description:
Provides a factory for creating stateful widgets with a common API.
//&gt;&gt;docs: <a
href="http://api.jqueryui.com/jQuery.widget">api.jqueryui.com/jQuery.widget</a>/
//&gt;&gt;demos: <a
href="http://jqueryui.com/widget">jqueryui.com/widget</a>/</p>
...
<p>var widgetUuid = 0; var widgetSlice = Array.prototype.slice;</p>

<p>$.cleanData = ( function( orig ) {</p>

<pre>return function( elems ) {
        var events, elem, i;
...
<p>$.widget = function( name, base, prototype ) {</p>

<pre>var existingConstructor, constructor, basePrototype;
...
<p>$.widget.extend = function( target ) {</p>

<pre>var input = widgetSlice.call( arguments, 1 );
var inputIndex = 0;
...
<p>$.widget.bridge = function( name, object ) {</p>

<pre>var fullName = object.prototype.widgetFullName || name;
...
<p>$.Widget = function(    options, element    ) {};
$.Widget._childConstructors = [];</p>

<p>$.Widget.prototype = {</p>

<pre>widgetName: &quot;widget&quot;,
widgetEventPrefix: &quot;&quot;,
defaultElement: &quot;&lt;div&gt;&quot;,
...
<p>$.each( { show: “fadeIn”, hide: “fadeOut” }, function( method,
defaultEffect ) {</p>

<pre>$.Widget.prototype[ &quot;_&quot; + method ] = function( element, options, callback ) {
