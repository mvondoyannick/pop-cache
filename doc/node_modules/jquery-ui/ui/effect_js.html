...
<title>effect.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/ui/effect.js">
...
<p>//&gt;&gt;label: Effects Core //&gt;&gt;group: Effects // jscs:disable
maximumLineLength //&gt;&gt;description: Extends the internal jQuery
effects. Includes morphing and easing. Required by all other effects. //
jscs:enable maximumLineLength //&gt;&gt;docs: <a
href="http://api.jqueryui.com/category/effects-core">api.jqueryui.com/category/effects-core</a>/
//&gt;&gt;demos: <a
href="http://jqueryui.com/effect">jqueryui.com/effect</a>/</p>
...
<p>var dataSpace = “ui-effects-”,</p>

<pre>dataSpaceStyle = &quot;ui-effects-style&quot;,
...
<p>( function( jQuery, undefined ) {</p>

<pre>var stepHooks = &quot;backgroundColor borderBottomColor borderLeftColor borderRightColor &quot; +
...
each = jQuery.each;</pre>

<p>// Determine rgba support immediately supportElem.style.cssText =
“background-color:rgba(1,1,1,.5)”; support.rgba =
supportElem.style.backgroundColor.indexOf( “rgba” ) &gt; -1;</p>

<p>// Define cache name and alpha properties // for rgba and hsla spaces each(
spaces, function( spaceName, space ) {</p>

<pre class="ruby"><span class="ruby-identifier">space</span>.<span class="ruby-identifier">cache</span> = <span class="ruby-string">&quot;_&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">spaceName</span>;
<span class="ruby-identifier">space</span>.<span class="ruby-identifier">props</span>.<span class="ruby-identifier">alpha</span> = {
        <span class="ruby-value">idx:</span> <span class="ruby-value">3</span>,
        <span class="ruby-value">type:</span> <span class="ruby-string">&quot;percent&quot;</span>,
        <span class="ruby-value">def:</span> <span class="ruby-value">1</span>
};
</pre>

<p>} );</p>

<p>function clamp( value, prop, allowEmpty ) {</p>

<pre>var type = propTypes[ prop.type ] || {};
...
return 0 &gt; value ? 0 : type.max &lt; value ? type.max : value;</pre>

<p>}</p>

<p>function stringParse( string ) {</p>
...
// Named colors
return colors[ string ];</pre>

<p>}</p>

<p>color.fn = jQuery.extend( color.prototype, {</p>

<pre>parse: function( red, green, blue, alpha ) {
        if ( red === undefined ) {
...
<p>} ); color.fn.parse.prototype = color.fn;</p>

<p>// Hsla conversions adapted from: // <a
href="https://code.google.com/p/maashaack/source/browse/packages/graphics/trunk/src/graphics/colors/HUE2RGB.as?r=5021">code.google.com/p/maashaack/source/browse/packages/graphics/trunk/src/graphics/colors/HUE2RGB.as?r=5021</a></p>

<p>function hue2rgb( p, q, h ) {</p>
...
<p>spaces.hsla.to = function( rgba ) {</p>

<pre>if ( rgba[ 0 ] == null || rgba[ 1 ] == null || rgba[ 2 ] == null ) {
...
return [ Math.round( h ) % 360, s, l, a == null ? 1 : a ];</pre>

<p>};</p>

<p>spaces.hsla.from = function( hsla ) {</p>

<pre>if ( hsla[ 0 ] == null || hsla[ 1 ] == null || hsla[ 2 ] == null ) {
...
<p>each( spaces, function( spaceName, space ) {</p>

<pre>var props = space.props,
        cache = space.cache,
        to = space.to,
        from = space.from;
...
<p>// Add cssHook and .fx.step function for each named hook. // accept a space
separated string of properties color.hook = function( hook ) {</p>

<pre>var hooks = hook.split( &quot; &quot; );
...
<p>color.hook( stepHooks );</p>

<p>jQuery.cssHooks.borderColor = {</p>

<pre>expand: function( value ) {
        var expanded = {};
...
<p>// Basic color names only. // Usage of any of the other color names
requires adding yourself or including // jquery.color.svg-names.js. colors
= jQuery.Color.names = {</p>

<pre>// 4.1. Basic color keywords
aqua: &quot;#00ffff&quot;,
black: &quot;#000000&quot;,
blue: &quot;#0000ff&quot;,
fuchsia: &quot;#ff00ff&quot;,
...
<p>var classAnimationActions = [ “add”, “remove”, “toggle” ],</p>

<pre class="ruby"><span class="ruby-identifier">shorthandStyles</span> = {
        <span class="ruby-value">border:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">borderBottom:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">borderColor:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">borderLeft:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">borderRight:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">borderTop:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">borderWidth:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">margin:</span> <span class="ruby-value">1</span>,
        <span class="ruby-value">padding:</span> <span class="ruby-value">1</span>
};
</pre>

<p>$.each(</p>

<pre>[ &quot;borderLeftStyle&quot;, &quot;borderRightStyle&quot;, &quot;borderBottomStyle&quot;, &quot;borderTopStyle&quot; ],
function( _, prop ) {
...
<p>function getElementStyles( elem ) {</p>
...
<p>function styleDifference( oldStyle, newStyle ) {</p>
...
<p>// Support: jQuery &lt;1.8 if ( !$.fn.addBack ) {</p>

<pre>$.fn.addBack = function( selector ) {
...
<p>$.effects.animateClass = function( value, duration, easing, callback ) {</p>

<pre>var o = $.speed( duration, easing, callback );
...
<p>if ( $.expr &amp;&amp; $.expr.filters &amp;&amp; $.expr.filters.animated )
{</p>

<pre>$.expr.filters.animated = ( function( orig ) {
        return function( elem ) {
                return !!$( elem ).data( dataSpaceAnimated ) || orig( elem );
        };
} )( $.expr.filters.animated );</pre>

<p>}</p>

<p>if ( $.uiBackCompat !== false ) {</p>
...
<p>// Return an effect options object for the given parameters: function
_normalizeArguments( effect, options, speed, callback ) {</p>

<pre>// Allow passing all options as the first parameter
...
<p>function standardAnimationOption( option ) {</p>

<pre>// Valid standard speeds (nothing, number, named speed)
...
<pre>effect: function( /* effect, options, speed, callback */ ) {
...
<p>function parseClip( str, element ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">outerWidth</span> = <span class="ruby-identifier">element</span>.<span class="ruby-identifier">outerWidth</span>(),
        <span class="ruby-identifier">outerHeight</span> = <span class="ruby-identifier">element</span>.<span class="ruby-identifier">outerHeight</span>(),
        <span class="ruby-identifier">clipRegex</span> = <span class="ruby-regexp">/^rect\((-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto)\)$/</span>,
        <span class="ruby-identifier">values</span> = <span class="ruby-identifier">clipRegex</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">str</span> ) <span class="ruby-operator">||</span> [ <span class="ruby-string">&quot;&quot;</span>, <span class="ruby-value">0</span>, <span class="ruby-identifier">outerWidth</span>, <span class="ruby-identifier">outerHeight</span>, <span class="ruby-value">0</span> ];

<span class="ruby-keyword">return</span> {
        <span class="ruby-value">top:</span> <span class="ruby-identifier">parseFloat</span>( <span class="ruby-identifier">values</span>[ <span class="ruby-value">1</span> ] ) <span class="ruby-operator">||</span> <span class="ruby-value">0</span>,
        <span class="ruby-value">right:</span> <span class="ruby-identifier">values</span>[ <span class="ruby-value">2</span> ] <span class="ruby-operator">===</span> <span class="ruby-string">&quot;auto&quot;</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">outerWidth</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">parseFloat</span>( <span class="ruby-identifier">values</span>[ <span class="ruby-value">2</span> ] ),
        <span class="ruby-value">bottom:</span> <span class="ruby-identifier">values</span>[ <span class="ruby-value">3</span> ] <span class="ruby-operator">===</span> <span class="ruby-string">&quot;auto&quot;</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">outerHeight</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">parseFloat</span>( <span class="ruby-identifier">values</span>[ <span class="ruby-value">3</span> ] ),
        <span class="ruby-value">left:</span> <span class="ruby-identifier">parseFloat</span>( <span class="ruby-identifier">values</span>[ <span class="ruby-value">4</span> ] ) <span class="ruby-operator">||</span> <span class="ruby-value">0</span>
};
</pre>

<p>}</p>

<p>$.fx.step.clip = function( fx ) {</p>
...
<p>// Based on easing equations from Robert Penner (<a
href="http://www.robertpenner.com/easing">www.robertpenner.com/easing</a>)</p>

<p>var baseEasings = {};</p>

<p>$.each( [ “Quad”, “Cubic”, “Quart”, “Quint”, “Expo” ], function( i, name )
{</p>

<pre class="ruby"><span class="ruby-identifier">baseEasings</span>[ <span class="ruby-identifier">name</span> ] = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">p</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">pow</span>( <span class="ruby-identifier">p</span>, <span class="ruby-identifier">i</span> <span class="ruby-operator">+</span> <span class="ruby-value">2</span> );
};
</pre>

<p>} );</p>

<p>$.extend( baseEasings, {</p>
...
<p>$.each( baseEasings, function( name, easeIn ) {</p>

<pre>$.easing[ &quot;easeIn&quot; + name ] = easeIn;
