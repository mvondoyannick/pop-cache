...
<title>jquery-1-7.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/ui/jquery-1-7.js">
...
<p>//&gt;&gt;label: jQuery 1.7 Support //&gt;&gt;group: Core
//&gt;&gt;description: Support version 1.7.x of jQuery core</p>
...
<p>// Support: jQuery 1.7 only // Not a great way to check versions, but since
we only support 1.7+ and only // need to detect &lt;1.8, this is a simple
check that should suffice. Checking // for “1.7.” would be a bit safer, but
the version string is 1.7, not 1.7.0 // and we&#39;ll never reach 1.70.0
(if we do, we certainly won&#39;t be supporting // 1.7 anymore). See #11197
for why we&#39;re not using feature detection. if ( $.fn.jquery.substring(
0, 3 ) === “1.7” ) {</p>

<pre>// Setters for .innerWidth(), .innerHeight(), .outerWidth(), .outerHeight()
