...
<title>focusable.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/ui/focusable.js">
...
<p>//&gt;&gt;label: :focusable Selector //&gt;&gt;group: Core
//&gt;&gt;description: Selects elements which can be focused.
//&gt;&gt;docs: <a
href="http://api.jqueryui.com/focusable-selector">api.jqueryui.com/focusable-selector</a>/</p>
...
<p>// Selectors $.ui.focusable = function( element, hasTabindex ) {</p>

<pre>var map, mapName, img, focusableIfVisible, fieldset,
...
return focusableIfVisible &amp;&amp; $( element ).is( &quot;:visible&quot; ) &amp;&amp; visible( $( element ) );</pre>

<p>};</p>

<p>// Support: IE 8 only // IE 8 doesn&#39;t resolve inherit to visible/hidden
for computed values function visible( element ) {</p>

<pre>var visibility = element.css( &quot;visibility&quot; );
while ( visibility === &quot;inherit&quot; ) {
        element = element.parent();
        visibility = element.css( &quot;visibility&quot; );
}
return visibility !== &quot;hidden&quot;;</pre>

<p>}</p>

<p>$.extend( $.expr[ “:” ], {</p>

<pre>focusable: function( element ) {
        return $.ui.focusable( element, $.attr( element, &quot;tabindex&quot; ) != null );
}</pre>

<p>} );</p>

<p>return $.ui.focusable;</p>
