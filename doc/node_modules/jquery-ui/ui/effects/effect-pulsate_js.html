...
<title>effect-pulsate.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/ui/effects/effect-pulsate.js">
...
<p>//&gt;&gt;label: Pulsate Effect //&gt;&gt;group: Effects
//&gt;&gt;description: Pulsates an element n times by changing the opacity
to zero and back. //&gt;&gt;docs: <a
href="http://api.jqueryui.com/pulsate-effect">api.jqueryui.com/pulsate-effect</a>/
//&gt;&gt;demos: <a
...
<p>return $.effects.define( “pulsate”, “show”, function( options, done ) {</p>

<pre>var element = $( this ),
        mode = options.mode,
        show = mode === &quot;show&quot;,
        hide = mode === &quot;hide&quot;,
        showhide = show || hide,
...
$.effects.unshift( element, queuelen, anims + 1 );</pre>
