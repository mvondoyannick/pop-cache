...
<title>datepicker-sl.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/ui/i18n/datepicker-sl.js">

<pre>Slovenian initialisation for the jQuery UI date picker plugin.   
Written by Jaka Jancar (jaka@kubje.org).</pre>

<p>/* c = č, s = š z = ž C = Č S = Š Z = Ž */ ( function( factory ) {</p>
...
<p>datepicker.setDefaults( datepicker.regional.sl );</p>

<p>return datepicker.regional.sl;</p>
