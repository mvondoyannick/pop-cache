...
<title>testswarm.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/build/tasks/testswarm.js">
...
<p>function submit( commit, runs, configFile, extra, done ) {</p>
...
<p>grunt.registerTask( “testswarm”, function( commit, configFile ) {</p>
...
submit( commit, latestTests, configFile, &quot;&quot;, this.async() );</pre>

<p>} );</p>

<p>grunt.registerTask( “testswarm-multi-jquery”, function( commit, configFile,
minor ) {</p>
...
submit( commit, allTests, configFile, &quot;core &quot; + minor, this.async() );</pre>
