...
<main role="main" aria-label="Page node_modules/jquery-ui/build/tasks/build.js">

<p>module.exports = function( grunt ) {</p>

<p>“use strict”;</p>

<p>grunt.registerTask( “clean”, function() {</p>

<pre class="ruby"><span class="ruby-identifier">require</span>( <span class="ruby-string">&quot;rimraf&quot;</span> ).<span class="ruby-identifier">sync</span>( <span class="ruby-string">&quot;dist&quot;</span> );
</pre>

<p>} );</p>

<p>grunt.registerTask( “asciilint”, function() {</p>
