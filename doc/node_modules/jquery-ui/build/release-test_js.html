...
<title>release-test.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/build/release-test.js">

<p>var shell = require( “shelljs” ); var Release = {</p>

<pre>define: function( props ) {
...
newVersion: require( &quot;../package&quot; ).version</pre>

<p>};</p>

<p>var script = require( “./release” ); script( Release );</p>

<p>// Ignores actual version installed, should be good enough for a test if (
shell.exec( “npm ls –depth 0 | grep download.jqueryui.com” ).code === 1 ) {</p>

<pre class="ruby"><span class="ruby-identifier">shell</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-string">&quot;npm install &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">script</span>.<span class="ruby-identifier">dependencies</span>.<span class="ruby-identifier">join</span>( <span class="ruby-string">&quot; &quot;</span> ) );
</pre>

<p>}</p>

<p>// If AUTHORS.txt is outdated, this will update it // Very annoying during
an actual release shell.exec( “grunt update-authors” );</p>

<p>Release.generateArtifacts( function() {</p>

<pre class="ruby"><span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>( <span class="ruby-string">&quot;Done generating artifacts, verify output, should be in dist/cdn&quot;</span> );
</pre>
