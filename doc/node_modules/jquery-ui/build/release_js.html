...
<title>release.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/build/release.js">

<p>module.exports = function( Release ) {</p>

<p>var crypto = require( “crypto” ); var shell = require( “shelljs” ),</p>
...
<p>function replaceAtVersion() {</p>

<pre>console.log( &quot;Replacing @VERSION...&quot; );
var matches = [];
...
<p>function removeExternals ( packager ) {</p>

<pre>Object.keys( packager.builtFiles ).forEach( function( filepath ) {
...
<p>function addManifest( packager ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">output</span> = <span class="ruby-identifier">packager</span>.<span class="ruby-identifier">builtFiles</span>;
<span class="ruby-identifier">output</span>.<span class="ruby-constant">MANIFEST</span> = <span class="ruby-constant">Object</span>.<span class="ruby-identifier">keys</span>( <span class="ruby-identifier">output</span> ).<span class="ruby-identifier">sort</span>( <span class="ruby-identifier">function</span>( <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">a</span>.<span class="ruby-identifier">localeCompare</span>( <span class="ruby-identifier">b</span> );
} ).<span class="ruby-identifier">map</span>( <span class="ruby-identifier">function</span>( <span class="ruby-identifier">filepath</span> ) {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">md5</span> = <span class="ruby-identifier">crypto</span>.<span class="ruby-identifier">createHash</span>( <span class="ruby-string">&quot;md5&quot;</span> );
        <span class="ruby-identifier">md5</span>.<span class="ruby-identifier">update</span>( <span class="ruby-identifier">output</span>[ <span class="ruby-identifier">filepath</span> ] );
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">filepath</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot; &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">md5</span>.<span class="ruby-identifier">digest</span>( <span class="ruby-string">&quot;hex&quot;</span> );
} ).<span class="ruby-identifier">join</span>( <span class="ruby-string">&quot;\n&quot;</span> );
</pre>

<p>}</p>

<p>function buildCDNPackage( callback ) {</p>

<pre>console.log( &quot;Building CDN package&quot; );
...
<p>module.exports.dependencies = [</p>

<pre>&quot;download.jqueryui.com@2.1.2&quot;,
&quot;node-packager@0.0.6&quot;,
&quot;shelljs@0.2.6&quot;</pre>
