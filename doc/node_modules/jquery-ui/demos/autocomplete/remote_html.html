...
<title>remote.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/autocomplete/remote.html">
...
<pre>&lt;label for=&quot;birds&quot;&gt;Birds: &lt;/label&gt;
&lt;input id=&quot;birds&quot;&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div class=“ui-widget” style=“margin-top:2em; font-family:Arial”&gt;</p>

<pre>Result:
&lt;div id=&quot;log&quot; style=&quot;height: 200px; width: 300px; overflow: auto;&quot; class=&quot;ui-widget-content&quot;&gt;&lt;/div&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div class=“demo-description”&gt; &lt;p&gt;The Autocomplete widgets
provides suggestions while you type into the field. Here the suggestions
are bird names, displayed when at least two characters are entered into the
field.&lt;/p&gt; &lt;p&gt;The datasource is a server-side script which
returns JSON data, specified via a simple URL for the source-option. In
addition, the minLength-option is set to 2 to avoid queries that would
return too many results and the select-event is used to display some
feedback.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
