...
<title>remote-with-cache.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/autocomplete/remote-with-cache.html">
...
field.&lt;/p&gt; &lt;p&gt;Similar to the remote datasource demo, though
this adds some local caching to improve performance. The cache here saves
just one query, and could be extended to cache multiple values, one for
each term.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
