...
<title>xml.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/autocomplete/xml.html">
...
<pre>&lt;label for=&quot;birds&quot;&gt;London matches: &lt;/label&gt;
&lt;input id=&quot;birds&quot; /&gt;</pre>
...
retrieve some XML data, parse it using jQuery&#39;s methods, then provide
it to the autocomplete as the datasource.&lt;/p&gt; &lt;p&gt;This should
also serve as a reference on how to parse a remote XML datasource - the
parsing would just happen for each request within the
source-callback.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
