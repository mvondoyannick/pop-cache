...
<title>range.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/slider/range.html">
...
<pre>&lt;label for=&quot;amount&quot;&gt;Price range:&lt;/label&gt;
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Set the <code>range</code>
option to true to capture a range of values with two drag handles.  The
space between the handles is filled with a different background color to
indicate those values are selected.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt;
&lt;/html&gt;</p>
</main>
