...
<title>hotelrooms.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/slider/hotelrooms.html">
...
<p>&lt;form id=“reservation”&gt;</p>

<pre>&lt;label for=&quot;minbeds&quot;&gt;Minimum number of beds&lt;/label&gt;
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;How to bind a slider to an
existing select element. The select stays visible to display the change.
When the select is changed, the slider is updated, too.&lt;/p&gt;
&lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
