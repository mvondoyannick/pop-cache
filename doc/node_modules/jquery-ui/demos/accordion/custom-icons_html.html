...
<title>custom-icons.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/accordion/custom-icons.html">
...
<p>&lt;button id=“toggle”&gt;Toggle icons&lt;/button&gt;</p>

<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Customize the header icons
with the <code>icons</code> option, which accepts classes for the
header&#39;s default and active (open) state.  Use any class from the UI
CSS framework, or create custom classes with background images.&lt;/p&gt;
&lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
