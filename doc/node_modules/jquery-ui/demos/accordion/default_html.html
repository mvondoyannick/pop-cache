...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/accordion/default.html">
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt; Click headers to
expand/collapse content that is broken into logical sections, much like
tabs. Optionally, toggle sections open/closed on mouseover. &lt;/p&gt;
&lt;p&gt; The underlying HTML markup is a series of headers (H3 tags) and
content divs so the content is usable without JavaScript. &lt;/p&gt;
&lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
