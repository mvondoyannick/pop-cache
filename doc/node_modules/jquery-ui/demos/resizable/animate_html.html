...
<title>animate.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/resizable/animate.html">
...
<pre>&lt;h3 class=&quot;ui-widget-header&quot;&gt;Animate&lt;/h3&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Animate the resize action
using the <code>animate</code> option (boolean). When this option is set to
true, drag the outline to the desired location; the element animates to
that size on drag stop.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
