...
<title>propagation.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/droppable/propagation.html">
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;When working with nested
droppables &amp;#8212; for example, you may have an editable directory
structure displayed as a tree, with folder and document nodes &amp;#8212;
the <code>greedy</code> option set to true prevents event propagation when
a draggable is dropped on a child node (droppable).&lt;/p&gt; &lt;/div&gt;
&lt;/body&gt; &lt;/html&gt;</p>
</main>
