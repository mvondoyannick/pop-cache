...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/draggable/events.html">
...
<p>&lt;div id=“draggable” class=“ui-widget ui-widget-content”&gt;</p>

<pre>&lt;p&gt;Drag me to trigger the chain of events.&lt;/p&gt;
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Layer functionality onto the
draggable using the <code>start</code>, <code>drag</code>, and
<code>stop</code> events.  Start is fired at the start of the drag; drag
during the drag; and stop when dragging stops.&lt;/p&gt; &lt;/div&gt;
&lt;/body&gt; &lt;/html&gt;</p>
</main>
