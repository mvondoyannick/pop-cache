...
<title>cursor-style.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/draggable/cursor-style.html">
...
<pre>&lt;p&gt;I will always stick to the center (relative to the mouse)&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div id=“draggable2” class=“ui-widget-content”&gt;</p>

<pre>&lt;p&gt;My cursor is at left -5 and top -5&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div id=“draggable3” class=“ui-widget-content”&gt;</p>

<pre>&lt;p&gt;My cursor position is only controlled for the &#39;bottom&#39; value&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Position the cursor while
dragging the object. By default the cursor appears in the center of the
dragged object; use the <code>cursorAt</code> option to specify another
location relative to the draggable (specify a pixel value from the top,
right, bottom, and/or left).  Customize the cursor&#39;s appearance by
supplying the <code>cursor</code> option with a valid CSS cursor value:
default, move, pointer, crosshair, etc.&lt;/p&gt; &lt;/div&gt;
&lt;/body&gt; &lt;/html&gt;</p>
</main>
