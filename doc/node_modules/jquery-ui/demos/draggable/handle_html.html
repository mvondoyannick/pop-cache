...
<title>handle.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/draggable/handle.html">
...
<pre>&lt;p class=&quot;ui-widget-header&quot;&gt;I can be dragged only by this handle&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div id=“draggable2” class=“ui-widget-content”&gt;</p>

<pre>&lt;p&gt;You can drag me around&amp;hellip;&lt;/p&gt;
&lt;p class=&quot;ui-widget-header&quot;&gt;&amp;hellip;but you can&#39;t drag me by this handle.&lt;/p&gt;</pre>

<p>&lt;/div&gt;</p>

<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Allow dragging only when the
cursor is over a specific part of the draggable.  Use the
<code>handle</code> option to specify the jQuery selector of an element (or
group of elements) used to drag the object.&lt;/p&gt; &lt;p&gt;Or prevent
dragging when the cursor is over a specific element (or group of elements)
within the draggable.  Use the <code>cancel</code> option to specify a
jQuery selector over which to “cancel” draggable functionality.&lt;/p&gt;
&lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
