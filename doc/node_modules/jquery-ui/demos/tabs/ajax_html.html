...
<title>ajax.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/tabs/ajax.html">
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Fetch external content via
Ajax for the tabs by setting an href value in the tab links.&lt;/p&gt;
&lt;p&gt;Tabs 3 and 4 demonstrate slow-loading and broken AJAX tabs, and
how to handle serverside errors in those cases. Note: These two require a
webserver to interpret PHP. They won&#39;t work from the
filesystem.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
