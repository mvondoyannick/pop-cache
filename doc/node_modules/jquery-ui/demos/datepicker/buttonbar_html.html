...
<title>buttonbar.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/datepicker/buttonbar.html">
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Display a button for
selecting Today&#39;s date and a Done button for closing the calendar with
the boolean <code>showButtonPanel</code> option.  Each button is enabled by
default when the bar is displayed, but can be turned off with additional
options.  Button text is customizable.&lt;/p&gt; &lt;/div&gt; &lt;/body&gt;
&lt;/html&gt;</p>
</main>
