...
<title>date-formats.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/datepicker/date-formats.html">
...
<p>&lt;p&gt;Format options:&lt;br /&gt;</p>

<pre>&lt;select id=&quot;format&quot;&gt;
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Display date feedback in a
variety of ways.  Choose a date format from the dropdown, then click on the
input and select a date to see it in that format.&lt;/p&gt; &lt;/div&gt;
&lt;/body&gt; &lt;/html&gt;</p>
</main>
