...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/datepicker/default.html">
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;The datepicker is tied to a
standard form input field.  Focus on the input (click, or use the tab key)
to open an interactive calendar in a small overlay.  Choose a date, click
elsewhere on the page (blur the input), or hit the Esc key to close. If a
date is chosen, feedback is shown as the input&#39;s value.&lt;/p&gt;
&lt;/div&gt; &lt;/body&gt; &lt;/html&gt;</p>
</main>
