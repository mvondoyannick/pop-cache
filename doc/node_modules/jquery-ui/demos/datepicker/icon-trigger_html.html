...
<title>icon-trigger.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/datepicker/icon-trigger.html">
...
<p>&lt;div class=“demo-description”&gt; &lt;p&gt;Click the icon next to the
input field to show the datepicker.  Set the datepicker to open on focus
(default behavior), on icon click, or both.&lt;/p&gt; &lt;/div&gt;
&lt;/body&gt; &lt;/html&gt;</p>
</main>
