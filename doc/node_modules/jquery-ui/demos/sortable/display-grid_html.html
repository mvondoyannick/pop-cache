...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/sortable/display-grid.html">
...
<pre>To arrange sortable items as a grid, give them identical dimensions and
float them using CSS.</pre>
