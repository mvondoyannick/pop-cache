...
<title>bootstrap.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/demos/bootstrap.js">

<pre class="ruby"><span class="ruby-identifier">globals</span> <span class="ruby-identifier">window</span>, <span class="ruby-identifier">document</span>
</pre>

<p>( function() {</p>

<p>// Find the script element var scripts = document.getElementsByTagName(
“script” ); var script = scripts[ scripts.length - 1 ];</p>

<p>// Read the modules var modules = script.getAttribute( “data-modules” );
var composite = script.getAttribute( “data-composite” ) || false; var
pathParts = window.location.pathname.split( “/” ); var effectsAll = [</p>

<pre>&quot;effects/effect-blind&quot;,
...
<p>function getPath( module ) {</p>

<pre>for ( var i = 0; i &lt; widgets.length; i++ ) {
        if ( widgets[ i ] === module ) {
...
<p>} function fixPaths( modules ) {</p>

<pre>for ( var i = 0; i &lt; modules.length; i++ ) {
...
<p>// Hide the page while things are loading to prevent a FOUC
document.documentElement.className = “demo-loading”;</p>

<p>require.config( {</p>

<pre>baseUrl: window.location.pathname.indexOf( &quot;demos/&quot; ) !== -1 ? &quot;../../ui&quot; : &quot;../../../ui&quot;,
paths: {
...
<p>// Replace effects all shortcut modules with all the effects modules if (
modules &amp;&amp; modules.indexOf( “effects-all” ) !== -1 ) {</p>

<pre class="ruby"><span class="ruby-identifier">modules</span> = <span class="ruby-identifier">modules</span>.<span class="ruby-identifier">replace</span>( <span class="ruby-regexp">/effects-all/</span>, <span class="ruby-identifier">effectsAll</span>.<span class="ruby-identifier">join</span>( <span class="ruby-string">&quot; &quot;</span> ) );
</pre>

<p>}</p>

<p>modules = modules ? modules.replace( /^s+|s+$/g, “” ).split( /s+/ ) : [];
if ( !composite ) {</p>

<pre class="ruby"><span class="ruby-identifier">modules</span>.<span class="ruby-identifier">push</span>( <span class="ruby-identifier">pathParts</span>[ <span class="ruby-identifier">pathParts</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">-</span> <span class="ruby-value">2</span> ] );
</pre>

<p>} modules = fixPaths( modules );</p>

<p>require( modules, function() {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">newScript</span> = <span class="ruby-identifier">document</span>.<span class="ruby-identifier">createElement</span>( <span class="ruby-string">&quot;script&quot;</span> );

<span class="ruby-identifier">document</span>.<span class="ruby-identifier">documentElement</span>.<span class="ruby-identifier">className</span> = <span class="ruby-string">&quot;&quot;</span>;

<span class="ruby-identifier">newScript</span>.<span class="ruby-identifier">text</span> = <span class="ruby-string">&quot;( function() { &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">script</span>.<span class="ruby-identifier">innerHTML</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot; } )();&quot;</span>;
<span class="ruby-identifier">document</span>.<span class="ruby-identifier">body</span>.<span class="ruby-identifier">appendChild</span>( <span class="ruby-identifier">newScript</span> ).<span class="ruby-identifier">parentNode</span>.<span class="ruby-identifier">removeChild</span>( <span class="ruby-identifier">newScript</span> );
</pre>
