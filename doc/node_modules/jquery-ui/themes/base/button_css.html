...
<title>button.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/themes/base/button.css">
...
<pre>!
 ...
 http://api.jqueryui.com/button/#theming</pre>
...
<p>.ui-button, .ui-button:link, .ui-button:visited, .ui-button:hover,
.ui-button:active {</p>
...
<p>/* to make room for the icon, a width needs to be set here */
.ui-button-icon-only {</p>
...
<p>/* no icon support for input elements */
input.ui-button.ui-button-icon-only {</p>

<pre>text-indent: 0;</pre>

<p>}</p>

<p>/* button icon element(s) */ .ui-button-icon-only .ui-icon {</p>
...
<p>.ui-button.ui-icon-notext .ui-icon {</p>
...
<p>input.ui-button.ui-icon-notext .ui-icon {</p>
...
<p>/* workarounds */ /* Support: Firefox 5 - 40 */
input.ui-button::-moz-focus-inner, button.ui-button::-moz-focus-inner {</p>
