...
<title>core.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/themes/base/core.css">
...
<p>} .ui-helper-clearfix:before, .ui-helper-clearfix:after {</p>

<pre>content: &quot;&quot;;
display: table;
border-collapse: collapse;</pre>

<p>} .ui-helper-clearfix:after {</p>
...
position: absolute;
opacity: 0;
filter:Alpha(Opacity=0); /* support: IE8 */</pre>
...
<p>/* Interaction Cues ———————————-*/ .ui-state-disabled {</p>

<pre>cursor: default !important;
