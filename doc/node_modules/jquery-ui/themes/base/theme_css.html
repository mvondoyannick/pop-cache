...
<title>theme.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/themes/base/theme.css">
...
<pre>!
 ...
 Component containers</pre>
<hr>

<p>.ui-widget {</p>

<pre>font-family: Arial,Helvetica,sans-serif/*{ffDefault}*/;
font-size: 1em/*{fsDefault}*/;</pre>

<p>} .ui-widget .ui-widget {</p>

<pre>font-size: 1em;</pre>

<p>} .ui-widget input, .ui-widget select, .ui-widget textarea, .ui-widget
button {</p>

<pre>font-family: Arial,Helvetica,sans-serif/*{ffDefault}*/;
font-size: 1em;</pre>

<p>} .ui-widget.ui-widget-content {</p>

<pre>border: 1px solid #c5c5c5/*{borderColorDefault}*/;</pre>

<p>} .ui-widget-content {</p>

<pre>border: 1px solid #dddddd/*{borderColorContent}*/;
background: #ffffff/*{bgColorContent}*/ /*{bgImgUrlContent}*/ /*{bgContentXPos}*/ /*{bgContentYPos}*/ /*{bgContentRepeat}*/;
color: #333333/*{fcContent}*/;</pre>

<p>} .ui-widget-content a {</p>

<pre>color: #333333/*{fcContent}*/;</pre>

<p>} .ui-widget-header {</p>

<pre>border: 1px solid #dddddd/*{borderColorHeader}*/;
background: #e9e9e9/*{bgColorHeader}*/ /*{bgImgUrlHeader}*/ /*{bgHeaderXPos}*/ /*{bgHeaderYPos}*/ /*{bgHeaderRepeat}*/;
color: #333333/*{fcHeader}*/;
font-weight: bold;</pre>

<p>} .ui-widget-header a {</p>

<pre>color: #333333/*{fcHeader}*/;</pre>

<p>}</p>

<p>/* Interaction states ———————————-*/ .ui-state-default, .ui-widget-content
.ui-state-default, .ui-widget-header .ui-state-default, .ui-button,</p>

<p>/* We use html here because we need a greater specificity to make sure
disabled works properly when clicked or hovered */ html
.ui-button.ui-state-disabled:hover, html
.ui-button.ui-state-disabled:active {</p>

<pre>border: 1px solid #c5c5c5/*{borderColorDefault}*/;
background: #f6f6f6/*{bgColorDefault}*/ /*{bgImgUrlDefault}*/ /*{bgDefaultXPos}*/ /*{bgDefaultYPos}*/ /*{bgDefaultRepeat}*/;
font-weight: normal/*{fwDefault}*/;
color: #454545/*{fcDefault}*/;</pre>

<p>} .ui-state-default a, .ui-state-default a:link, .ui-state-default
a:visited, a.ui-button, a:link.ui-button, a:visited.ui-button, .ui-button {</p>

<pre>color: #454545/*{fcDefault}*/;
text-decoration: none;</pre>

<p>} .ui-state-hover, .ui-widget-content .ui-state-hover, .ui-widget-header
.ui-state-hover, .ui-state-focus, .ui-widget-content .ui-state-focus,
.ui-widget-header .ui-state-focus, .ui-button:hover, .ui-button:focus {</p>

<pre>border: 1px solid #cccccc/*{borderColorHover}*/;
background: #ededed/*{bgColorHover}*/ /*{bgImgUrlHover}*/ /*{bgHoverXPos}*/ /*{bgHoverYPos}*/ /*{bgHoverRepeat}*/;
font-weight: normal/*{fwDefault}*/;
color: #2b2b2b/*{fcHover}*/;</pre>

<p>} .ui-state-hover a, .ui-state-hover a:hover, .ui-state-hover a:link,
.ui-state-hover a:visited, .ui-state-focus a, .ui-state-focus a:hover,
.ui-state-focus a:link, .ui-state-focus a:visited, a.ui-button:hover,
a.ui-button:focus {</p>

<pre>color: #2b2b2b/*{fcHover}*/;
text-decoration: none;</pre>
...
<pre>box-shadow: 0 0 3px 1px rgb(94, 158, 214);</pre>

<p>} .ui-state-active, .ui-widget-content .ui-state-active, .ui-widget-header
.ui-state-active, a.ui-button:active, .ui-button:active,
.ui-button.ui-state-active:hover {</p>

<pre>border: 1px solid #003eff/*{borderColorActive}*/;
background: #007fff/*{bgColorActive}*/ /*{bgImgUrlActive}*/ /*{bgActiveXPos}*/ /*{bgActiveYPos}*/ /*{bgActiveRepeat}*/;
font-weight: normal/*{fwDefault}*/;
color: #ffffff/*{fcActive}*/;</pre>

<p>} .ui-icon-background, .ui-state-active .ui-icon-background {</p>

<pre>border: #003eff/*{borderColorActive}*/;
background-color: #ffffff/*{fcActive}*/;</pre>

<p>} .ui-state-active a, .ui-state-active a:link, .ui-state-active a:visited {</p>

<pre>color: #ffffff/*{fcActive}*/;
text-decoration: none;</pre>

<p>}</p>

<p>/* Interaction Cues ———————————-*/ .ui-state-highlight, .ui-widget-content
.ui-state-highlight, .ui-widget-header .ui-state-highlight {</p>

<pre>border: 1px solid #dad55e/*{borderColorHighlight}*/;
background: #fffa90/*{bgColorHighlight}*/ /*{bgImgUrlHighlight}*/ /*{bgHighlightXPos}*/ /*{bgHighlightYPos}*/ /*{bgHighlightRepeat}*/;
color: #777620/*{fcHighlight}*/;</pre>

<p>} .ui-state-checked {</p>

<pre>border: 1px solid #dad55e/*{borderColorHighlight}*/;
background: #fffa90/*{bgColorHighlight}*/;</pre>

<p>} .ui-state-highlight a, .ui-widget-content .ui-state-highlight a,
.ui-widget-header .ui-state-highlight a {</p>

<pre>color: #777620/*{fcHighlight}*/;</pre>

<p>} .ui-state-error, .ui-widget-content .ui-state-error, .ui-widget-header
.ui-state-error {</p>

<pre>border: 1px solid #f1a899/*{borderColorError}*/;
background: #fddfdf/*{bgColorError}*/ /*{bgImgUrlError}*/ /*{bgErrorXPos}*/ /*{bgErrorYPos}*/ /*{bgErrorRepeat}*/;
color: #5f3f3f/*{fcError}*/;</pre>

<p>} .ui-state-error a, .ui-widget-content .ui-state-error a,
.ui-widget-header .ui-state-error a {</p>

<pre>color: #5f3f3f/*{fcError}*/;</pre>

<p>} .ui-state-error-text, .ui-widget-content .ui-state-error-text,
.ui-widget-header .ui-state-error-text {</p>

<pre>color: #5f3f3f/*{fcError}*/;</pre>

<p>} .ui-priority-primary, .ui-widget-content .ui-priority-primary,
.ui-widget-header .ui-priority-primary {</p>

<pre>font-weight: bold;</pre>

<p>} .ui-priority-secondary, .ui-widget-content .ui-priority-secondary,
.ui-widget-header .ui-priority-secondary {</p>

<pre>opacity: .7;
filter:Alpha(Opacity=70); /* support: IE8 */
font-weight: normal;</pre>

<p>} .ui-state-disabled, .ui-widget-content .ui-state-disabled,
.ui-widget-header .ui-state-disabled {</p>

<pre>opacity: .35;
filter:Alpha(Opacity=35); /* support: IE8 */
background-image: none;</pre>

<p>} .ui-state-disabled .ui-icon {</p>

<pre>filter:Alpha(Opacity=35); /* support: IE8 - See #6059 */</pre>

<p>}</p>

<p>/* Icons ———————————-*/</p>

<p>/* states and images */ .ui-icon {</p>

<pre>width: 16px;
height: 16px;</pre>

<p>} .ui-icon, .ui-widget-content .ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_444444_256x240.png&quot;)/*{iconsContent}*/;</pre>

<p>} .ui-widget-header .ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_444444_256x240.png&quot;)/*{iconsHeader}*/;</pre>

<p>} .ui-state-hover .ui-icon, .ui-state-focus .ui-icon, .ui-button:hover
.ui-icon, .ui-button:focus .ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_555555_256x240.png&quot;)/*{iconsHover}*/;</pre>

<p>} .ui-state-active .ui-icon, .ui-button:active .ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_ffffff_256x240.png&quot;)/*{iconsActive}*/;</pre>

<p>} .ui-state-highlight .ui-icon, .ui-button .ui-state-highlight.ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_777620_256x240.png&quot;)/*{iconsHighlight}*/;</pre>

<p>} .ui-state-error .ui-icon, .ui-state-error-text .ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_cc0000_256x240.png&quot;)/*{iconsError}*/;</pre>

<p>} .ui-button .ui-icon {</p>

<pre>background-image: url(&quot;images/ui-icons_777777_256x240.png&quot;)/*{iconsDefault}*/;</pre>

<p>}</p>

<p>/* positioning */ .ui-icon-blank { background-position: 16px 16px; }
.ui-icon-caret-1-n { background-position: 0 0; } .ui-icon-caret-1-ne {
background-position: -16px 0; } .ui-icon-caret-1-e { background-position:
-32px 0; } .ui-icon-caret-1-se { background-position: -48px 0; }
.ui-icon-caret-1-s { background-position: -65px 0; } .ui-icon-caret-1-sw {
background-position: -80px 0; } .ui-icon-caret-1-w { background-position:
-96px 0; } .ui-icon-caret-1-nw { background-position: -112px 0; }
...
.ui-icon-arrow-1-n { background-position: 0 -32px; } .ui-icon-arrow-1-ne {
...
background-position: -16px -80px; } .ui-icon-extlink { background-position:
-32px -80px; } .ui-icon-newwin { background-position: -48px -80px; }
.ui-icon-refresh { background-position: -64px -80px; } .ui-icon-shuffle {
...
background-position: 0 -96px; } .ui-icon-folder-open { background-position:
-16px -96px; } .ui-icon-document { background-position: -32px -96px; }
.ui-icon-document-b { background-position: -48px -96px; } .ui-icon-note {
...
background-position: -128px -96px; } .ui-icon-person { background-position:
-144px -96px; } .ui-icon-print { background-position: -160px -96px; }
.ui-icon-trash { background-position: -176px -96px; } .ui-icon-locked {
background-position: -192px -96px; } .ui-icon-unlocked {
background-position: -208px -96px; } .ui-icon-bookmark {
background-position: -224px -96px; } .ui-icon-tag { background-position:
-240px -96px; } .ui-icon-home { background-position: 0 -112px; }
.ui-icon-flag { background-position: -16px -112px; } .ui-icon-calendar {
background-position: -32px -112px; } .ui-icon-cart { background-position:
-48px -112px; } .ui-icon-pencil { background-position: -64px -112px; }
.ui-icon-clock { background-position: -80px -112px; } .ui-icon-disk {
...
background-position: -176px -112px; } .ui-icon-gear { background-position:
-192px -112px; } .ui-icon-heart { background-position: -208px -112px; }
.ui-icon-star { background-position: -224px -112px; } .ui-icon-link {
background-position: -240px -112px; } .ui-icon-cancel {
background-position: 0 -128px; } .ui-icon-plus { background-position: -16px
-128px; } .ui-icon-plusthick { background-position: -32px -128px; }
.ui-icon-minus { background-position: -48px -128px; } .ui-icon-minusthick {
background-position: -64px -128px; } .ui-icon-close { background-position:
-80px -128px; } .ui-icon-closethick { background-position: -96px -128px; }
.ui-icon-key { background-position: -112px -128px; } .ui-icon-lightbulb {
background-position: -128px -128px; } .ui-icon-scissors {
background-position: -144px -128px; } .ui-icon-clipboard {
background-position: -160px -128px; } .ui-icon-copy { background-position:
-176px -128px; } .ui-icon-contact { background-position: -192px -128px; }
.ui-icon-image { background-position: -208px -128px; } .ui-icon-video {
background-position: -224px -128px; } .ui-icon-script {
background-position: -240px -128px; } .ui-icon-alert { background-position:
0 -144px; } .ui-icon-info { background-position: -16px -144px; }
.ui-icon-notice { background-position: -32px -144px; } .ui-icon-help {
background-position: -48px -144px; } .ui-icon-check { background-position:
-64px -144px; } .ui-icon-bullet { background-position: -80px -144px; }
.ui-icon-radio-on { background-position: -96px -144px; } .ui-icon-radio-off
{ background-position: -112px -144px; } .ui-icon-pin-w {
background-position: -128px -144px; } .ui-icon-pin-s { background-position:
-144px -144px; } .ui-icon-play { background-position: 0 -160px; }
...
background-position: -80px -160px; } /* ui-icon-seek-first is deprecated,
use ui-icon-seek-start instead */ .ui-icon-seek-first {
background-position: -80px -160px; } .ui-icon-stop { background-position:
-96px -160px; } .ui-icon-eject { background-position: -112px -160px; }
.ui-icon-volume-off { background-position: -128px -160px; }
.ui-icon-volume-on { background-position: -144px -160px; } .ui-icon-power {
background-position: 0 -176px; } .ui-icon-signal-diag {
background-position: -16px -176px; } .ui-icon-signal { background-position:
-32px -176px; } .ui-icon-battery-0 { background-position: -48px -176px; }
...
.ui-icon-grip-diagonal-se { background-position: -80px -224px; }</p>

<p>/* Misc visuals ———————————-*/</p>

<p>/* Corner radius */ .ui-corner-all, .ui-corner-top, .ui-corner-left,
.ui-corner-tl {</p>

<pre>border-top-left-radius: 3px/*{cornerRadius}*/;</pre>

<p>} .ui-corner-all, .ui-corner-top, .ui-corner-right, .ui-corner-tr {</p>

<pre>border-top-right-radius: 3px/*{cornerRadius}*/;</pre>

<p>} .ui-corner-all, .ui-corner-bottom, .ui-corner-left, .ui-corner-bl {</p>

<pre>border-bottom-left-radius: 3px/*{cornerRadius}*/;</pre>

<p>} .ui-corner-all, .ui-corner-bottom, .ui-corner-right, .ui-corner-br {</p>

<pre>border-bottom-right-radius: 3px/*{cornerRadius}*/;</pre>

<p>}</p>

<p>/* Overlays */ .ui-widget-overlay {</p>

<pre>background: #aaaaaa/*{bgColorOverlay}*/ /*{bgImgUrlOverlay}*/ /*{bgOverlayXPos}*/ /*{bgOverlayYPos}*/ /*{bgOverlayRepeat}*/;
opacity: .3/*{opacityOverlay}*/;
filter: Alpha(Opacity=30)/*{opacityFilterOverlay}*/; /* support: IE8 */</pre>

<p>} .ui-widget-shadow {</p>

<pre>-webkit-box-shadow: 0/*{offsetLeftShadow}*/ 0/*{offsetTopShadow}*/ 5px/*{thicknessShadow}*/ #666666/*{bgColorShadow}*/;
box-shadow: 0/*{offsetLeftShadow}*/ 0/*{offsetTopShadow}*/ 5px/*{thicknessShadow}*/ #666666/*{bgColorShadow}*/;</pre>
