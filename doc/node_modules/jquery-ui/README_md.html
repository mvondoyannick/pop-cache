...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-jQuery+UI+-+Interactions+and+Widgets+for+the+web"><a href="http://jqueryui.com/">jQuery UI</a> - Interactions and Widgets for the web</a>
    <li><a href="#label-For+Contributors">For Contributors</a>
    <li><a href="#label-Running+the+Unit+Tests">Running the Unit Tests</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/jquery-ui/README.md">

<h1 id="label-jQuery+UI+-+Interactions+and+Widgets+for+the+web"><a href="http://jqueryui.com/">jQuery UI</a> - Interactions and Widgets for the web<span><a href="#label-jQuery+UI+-+Interactions+and+Widgets+for+the+web">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>jQuery UI is a curated set of user interface interactions, effects,
widgets, and themes built on top of jQuery. Whether you&#39;re building
highly interactive web applications, or you just need to add a date picker
to a form control, jQuery UI is the perfect choice.</p>

<p>If you want to use jQuery UI, go to <a
href="http://jqueryui.com">jqueryui.com</a> to get started, <a
href="http://jqueryui.com/demos/">jqueryui.com/demos/</a> for demos, <a
href="http://api.jqueryui.com/">api.jqueryui.com</a> for API documentation,
or the <a href="http://forum.jquery.com/using-jquery-ui">Using jQuery UI
Forum</a> for discussions and questions.</p>

<p>If you want to report a bug/issue, please visit <a
href="http://bugs.jqueryui.com">bugs.jqueryui.com</a>.</p>

<p>If you are interested in helping develop jQuery UI, you are in the right
place. To discuss development with team members and the community, visit
the <a href="http://forum.jquery.com/developing-jquery-ui">Developing
jQuery UI Forum</a> or <a href="http://irc.jquery.org/">#jqueryui-dev on
irc.freenode.net</a>.</p>

<h2 id="label-For+Contributors">For Contributors<span><a href="#label-For+Contributors">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you want to help and provide a patch for a bugfix or new feature, please
take a few minutes and look at <a
href="http://wiki.jqueryui.com/w/page/35263114/Getting-Involved">our
Getting Involved guide</a>. In particular check out the <a
href="http://wiki.jqueryui.com/w/page/12137737/Coding-standards">Coding
standards</a> and <a
href="http://contribute.jquery.org/commits-and-pull-requests/#commit-guidelines">Commit
Message Style Guide</a>.</p>

<p>In general, fork the project, create a branch for a specific change and
send a pull request for that branch. Don&#39;t mix unrelated changes. You
can use the commit message as the description for the pull request.</p>

<p>For more information, see the <a href="CONTRIBUTING.md">contributing
page</a>.</p>

<h2 id="label-Running+the+Unit+Tests">Running the Unit Tests<span><a href="#label-Running+the+Unit+Tests">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Run the unit tests manually with appropriate browsers and any local web
server. See our <a
href="CONTRIBUTING.md#environment-minimum-required">environment setup</a>
and <a href="CONTRIBUTING.md#running-the-tests">information on running
tests</a>.</p>

<p>You can also run the unit tests inside phantomjs by <a
href="CONTRIBUTING.md#user-content-environment-recommended-setup">setting
up your environment</a>.</p>
</main>
