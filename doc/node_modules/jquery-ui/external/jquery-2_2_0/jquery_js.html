...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-2.2.0/jquery.js">
...
<p>// Support: Firefox 18+ // Can&#39;t be in strict mode, several libs
including ASP.NET trace // the stack via arguments.caller.callee and
Firefox dies if // you try to trace through “use strict” call chains.
(#13335) //“use strict”; var arr = [];</p>
...
<pre>// Support: iOS 8.2 (not reproducible in simulator)
...
<pre> Sizzle CSS Selector Engine v2.2.1
 http://sizzlejs.com/
...
<pre>var m, i, elem, nid, nidselect, match, groups, newSelector,
...
<pre class="ruby"><span class="ruby-identifier">div</span>.<span class="ruby-identifier">innerHTML</span> = <span class="ruby-string">&quot;&lt;a href=&#39;#&#39;&gt;&lt;/a&gt;&quot;</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">div</span>.<span class="ruby-identifier">firstChild</span>.<span class="ruby-identifier">getAttribute</span>(<span class="ruby-string">&quot;href&quot;</span>) <span class="ruby-operator">===</span> <span class="ruby-string">&quot;#&quot;</span> ;
</pre>
...
<p>jQuery.find = Sizzle; jQuery.expr = Sizzle.selectors; jQuery.expr[ “:” ] =
jQuery.expr.pseudos; jQuery.uniqueSort = jQuery.unique = Sizzle.uniqueSort;
...
<p>// Kick off the DOM ready check even if the user does not
jQuery.ready.promise();</p>
...
<pre>register: function( owner, initial ) {
        var value = initial || {};
...
<p>// Support: IE9 wrapMap.optgroup = wrapMap.option;</p>
...
<p>// Support: IE9 // See #13393 for more info function safeActiveElement() {</p>
...
href="https://code.google.com/p/chromium/issues/detail?id=470258">code.google.com/p/chromium/issues/detail?id=470258</a>
...
<pre>rxhtmlTag = /&lt;(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^&gt;]*)\/&gt;/gi,
...
<pre>// Keep domManip exposed until 3.0 (gh-2225)
domManip: domManip,
...
<pre>var elem = jQuery( doc.createElement( name ) ).appendTo( doc.body ),
...
<pre>        // Support: IE&lt;=11+, Firefox&lt;=30+ (#15098, #14150)
...
<pre>var pixelPositionVal, boxSizingReliableVal, pixelMarginRightVal, reliableMarginLeftVal,
...
<p>// Support: Android 2.3 jQuery.cssHooks.marginRight = addGetHookIf(
support.reliableMarginRight,</p>
...
<p>// Support: IE9 // Panic based approach to setting things on disconnected
nodes Tween.propHooks.scrollTop = Tween.propHooks.scrollLeft = {</p>
...
<pre class="ruby"><span class="ruby-identifier">window</span>.<span class="ruby-identifier">clearInterval</span>( <span class="ruby-identifier">timerId</span> );
...
href="http://web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay">web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/jquery-delay</a>/
...
// Related ticket - <a
href="https://code.google.com/p/chromium/issues/detail?id=449857">code.google.com/p/chromium/issues/detail?id=449857</a>
...
<p>// Support: Android 2.3 // Workaround failure to string-cast null input
jQuery.parseJSON = function( data ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">JSON</span>.<span class="ruby-identifier">parse</span>( <span class="ruby-identifier">data</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;&quot;</span> );
</pre>
...
<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">expr</span>.<span class="ruby-identifier">filters</span>.<span class="ruby-identifier">visible</span>( <span class="ruby-identifier">elem</span> );
</pre>
...
return elem.offsetWidth &gt; 0 || elem.offsetHeight &gt; 0 || elem.getClientRects().length &gt; 0;</pre>
...
<p>// Support: Safari 8+ // In Safari 8 documents created via
...
<p>// Support: Safari&lt;7-8+, Chrome&lt;37-44+ // Add the top/left cssHooks
using jQuery.fn.position // Webkit bug: <a
href="https://bugs.webkit.org/show_bug.cgi?id=29084">bugs.webkit.org/show_bug.cgi?id=29084</a>
// Blink bug: <a
href="https://code.google.com/p/chromium/issues/detail?id=229280">code.google.com/p/chromium/issues/detail?id=229280</a>
