...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.7.0/jquery.js">
...
<pre>!
 ...
 Date: Thu Nov 3 16:18:21 2011 -0400</pre>
...
lowercase file name. if ( typeof define === “function” &amp;&amp;
define.amd &amp;&amp; define.amd.jQuery ) {</p>
...
<p>// Keep track of boxModel jQuery.boxModel = jQuery.support.boxModel;</p>
...
<pre>rformElems = /^(?:textarea|input|select)$/i,
rperiod = /\./g,
rspaces = / /g,
rescape = /[^\w\s.|`]/g,
rtypenamespace = /^([^\.]*)?(?:\.(.+))?$/,
...
<pre>jQuery.event.special[ orig ] = jQuery.event.special[ fix ] = {
        delegateType: fix,
        bindType: fix,
...
<pre class="ruby"><span class="ruby-identifier">throw</span> <span class="ruby-string">&quot;Syntax error, unrecognized expression: &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">msg</span>;
</pre>
...
<p>var nodeNames = “abbr article aside audio canvas datalist details
figcaption figure footer ” +</p>
...
<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">fn</span>[ <span class="ruby-identifier">o</span> ] = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">f</span> ){
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">bind</span>( <span class="ruby-identifier">o</span>, <span class="ruby-identifier">f</span> );
};
</pre>
...
<p>// Expose jQuery to the global object window.jQuery = window.$ = jQuery;
})( window );</p>
</main>
