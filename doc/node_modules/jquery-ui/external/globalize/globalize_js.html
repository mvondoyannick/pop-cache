...
<title>globalize.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/external/globalize/globalize.js">
...
<pre>!
 ...
 http://jquery.org/license</pre>

<p>(function( window, undefined ) {</p>

<p>var Globalize,</p>

<pre>// private variables
regexHex,
regexInfinity,
regexParseFloat,
regexTrim,
...
getEraYear,
parseExact,
parseNegativePattern;</pre>

<p>// Global variable (Globalize) or CommonJS module (globalize) Globalize =
function( cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">new</span> <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">prototype</span>.<span class="ruby-identifier">init</span>( <span class="ruby-identifier">cultureSelector</span> );
</pre>

<p>};</p>

<p>if ( typeof require !== “undefined” &amp;&amp;</p>

<pre>typeof exports !== &quot;undefined&quot; &amp;&amp;
typeof module !== &quot;undefined&quot; ) {
// Assume CommonJS
module.exports = Globalize;</pre>

<p>} else {</p>

<pre>// Export as global variable
window.Globalize = Globalize;</pre>

<p>}</p>

<p>Globalize.cultures = {};</p>

<p>Globalize.prototype = {</p>

<pre>constructor: Globalize,
...
<p>}; Globalize.prototype.init.prototype = Globalize.prototype;</p>

<p>// 1. When defining a culture, all fields are required except the ones
stated as optional. // 2. Each culture should have a “.calendars” object
with at least one calendar named “standard” //    which serves as the
default calendar in use by that culture. // 3. Each culture should have a
“.calendar” object which is the current calendar being used, //    it may
be dynamically changed at any time to one of the calendars in “.calendars”.
Globalize.cultures[ “default” ] = {</p>

<pre>    // A unique name for the culture in the form &lt;language code&gt;-&lt;country/region code&gt;
    name: &quot;en&quot;,
...
<p>Globalize.cultures[ “default” ].calendar = Globalize.cultures[ “default”
].calendars.standard;</p>

<p>Globalize.cultures.en = Globalize.cultures[ “default” ];</p>

<p>Globalize.cultureSelector = “en”;</p>

<p>// // private variables //</p>

<p>regexHex = /^<a href="a-f0-9">0x</a>+$/i; regexInfinity =
/^[+-]?infinity$/i; regexParseFloat = /^[+-]?<a
href=“+-”>d*.?d*(e</a>?d+)?$/; regexTrim = /^s+|s+$/g;</p>

<p>// // private JavaScript utility functions //</p>

<p>arrayIndexOf = function( array, item ) {</p>
...
<p>endsWith = function( value, pattern ) {</p>
...
<p>isObject = function( obj ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Object</span>.<span class="ruby-identifier">prototype</span>.<span class="ruby-identifier">toString</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">obj</span> ) <span class="ruby-operator">===</span> <span class="ruby-string">&quot;[object Object]&quot;</span>;
</pre>

<p>};</p>

<p>startsWith = function( value, pattern ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">value</span>.<span class="ruby-identifier">indexOf</span>( <span class="ruby-identifier">pattern</span> ) <span class="ruby-operator">===</span> <span class="ruby-value">0</span>;
</pre>

<p>};</p>

<p>trim = function( value ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> ( <span class="ruby-identifier">value</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;&quot;</span> ).<span class="ruby-identifier">replace</span>( <span class="ruby-identifier">regexTrim</span>, <span class="ruby-string">&quot;&quot;</span> );
</pre>

<p>};</p>

<p>truncate = function( value ) {</p>

<pre>if ( isNaN( value ) ) {
        return NaN;
}
return Math[ value &lt; 0 ? &quot;ceil&quot; : &quot;floor&quot; ]( value );</pre>

<p>};</p>

<p>zeroPad = function( str, count, left ) {</p>
...
<p>// // private Globalization utility functions //</p>

<p>appendPreOrPostMatch = function( preMatch, strings ) {</p>

<pre>// appends pre- and post- token match strings while removing escaped characters.
...
return quoteCount;</pre>

<p>};</p>

<p>expandFormat = function( cal, format ) {</p>

<pre>// expands unspecified or single character date formats into the full pattern.
format = format || &quot;F&quot;;
var pattern,
...
<p>formatDate = function( value, format, culture ) {</p>

<pre>var cal = culture.calendar,
        convert = cal.convert,
        ret;
...
<p>// formatNumber (function() {</p>

<pre>var expandNumber;
...
<p>getTokenRegExp = function() {</p>

<pre>// regular expression for matching date and time tokens in format strings.
return (/\/|dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|y|hh|h|HH|H|mm|m|ss|s|tt|t|fff|ff|f|zzz|zz|z|gg|g/g);</pre>

<p>};</p>

<p>getEra = function( date, eras ) {</p>

<pre>if ( !eras ) return 0;
...
<p>getEraYear = function( date, cal, era, sortable ) {</p>

<pre>var year = date.getFullYear();
...
<p>parseNegativePattern = function( value, nf, negativePattern ) {</p>
...
return ret || [ &quot;&quot;, value ];</pre>

<p>};</p>

<p>// // public instance functions //</p>

<p>Globalize.prototype.findClosestCulture = function( cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">findClosestCulture</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">this</span>, <span class="ruby-identifier">cultureSelector</span> );
</pre>

<p>};</p>

<p>Globalize.prototype.format = function( value, format, cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">format</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">this</span>, <span class="ruby-identifier">value</span>, <span class="ruby-identifier">format</span>, <span class="ruby-identifier">cultureSelector</span> );
</pre>

<p>};</p>

<p>Globalize.prototype.localize = function( key, cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">localize</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">this</span>, <span class="ruby-identifier">key</span>, <span class="ruby-identifier">cultureSelector</span> );
</pre>

<p>};</p>

<p>Globalize.prototype.parseInt = function( value, radix, cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">parseInt</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">this</span>, <span class="ruby-identifier">value</span>, <span class="ruby-identifier">radix</span>, <span class="ruby-identifier">cultureSelector</span> );
</pre>

<p>};</p>

<p>Globalize.prototype.parseFloat = function( value, radix, cultureSelector )
{</p>
...
<p>Globalize.prototype.culture = function( cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">culture</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">this</span>, <span class="ruby-identifier">cultureSelector</span> );
</pre>

<p>};</p>

<p>// // public singleton functions //</p>

<p>Globalize.addCultureInfo = function( cultureName, baseCultureName, info ) {</p>
...
<p>Globalize.findClosestCulture = function( name ) {</p>
...
return match || null;</pre>

<p>};</p>

<p>Globalize.format = function( value, format, cultureSelector ) {</p>

<pre>var culture = this.findClosestCulture( cultureSelector );
...
<p>Globalize.localize = function( key, cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">findClosestCulture</span>( <span class="ruby-identifier">cultureSelector</span> ).<span class="ruby-identifier">messages</span>[ <span class="ruby-identifier">key</span> ] <span class="ruby-operator">||</span>
        <span class="ruby-identifier">this</span>.<span class="ruby-identifier">cultures</span>[ <span class="ruby-string">&quot;default&quot;</span> ].<span class="ruby-identifier">messages</span>[ <span class="ruby-identifier">key</span> ];
</pre>

<p>};</p>

<p>Globalize.parseDate = function( value, formats, culture ) {</p>

<pre>culture = this.findClosestCulture( culture );
...
return date || null;</pre>

<p>};</p>

<p>Globalize.parseInt = function( value, radix, cultureSelector ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">truncate</span>( <span class="ruby-constant">Globalize</span>.<span class="ruby-identifier">parseFloat</span>(<span class="ruby-identifier">value</span>, <span class="ruby-identifier">radix</span>, <span class="ruby-identifier">cultureSelector</span>) );
</pre>

<p>};</p>

<p>Globalize.parseFloat = function( value, radix, cultureSelector ) {</p>

<pre>// radix argument is optional
...
<p>Globalize.culture = function( cultureSelector ) {</p>
...
// getter
return this.findClosestCulture( cultureSelector ) || this.cultures[ &quot;default&quot; ];</pre>
