...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.11.0/jquery.js">
...
<pre> Sizzle CSS Selector Engine v1.10.16
 http://sizzlejs.com/
...
<pre>// We need to execute this one support test ASAP because we need to know
...
<pre>var a, reliableHiddenOffsetsVal, boxSizingVal, boxSizingReliableVal,
...
// Null elements to avoid leaks in IE.
a = input = select = opt = div = null;</pre>
