...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.9.0/jquery.js">
...
<p>(function( window, undefined ) { “use strict”; var</p>
...
<pre>var support, all, a, select, opt, input, fragment, eventName, isSupported, i,
...
<p>function internalRemoveData( elem, name, pvt /* For internal use only */ ){</p>
...
getSetInput = jQuery.support.input;</pre>
...
<p>// fix oldIE value attroperty if ( !getSetInput || !getSetAttribute ) {</p>
...
if ( !jQuery.support.hrefNormalized ) {</p>

<pre>jQuery.each([ &quot;href&quot;, &quot;src&quot;, &quot;width&quot;, &quot;height&quot; ], function( i, name ) {
        jQuery.attrHooks[ name ] = jQuery.extend( jQuery.attrHooks[ name ], {
                get: function( elem ) {
...
<p>// Use a stripped-down slice if we can&#39;t use a native one try {</p>
...
return ( (val = elem.getAttributeNode( name )) || elem.getAttribute( name ) ) &amp;&amp; elem[ name ] === true ?
        name :
        val &amp;&amp; val.specified ? val.value : null;</pre>
...
Expr.filters = setFilters.prototype = Expr.pseudos; Expr.setFilters = new
setFilters();</p>

<p>// Initialize with the default document setDocument();</p>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">attr</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getAttributeNode</span>(<span class="ruby-string">&quot;type&quot;</span>);
...
<pre>if ( manipulation_rcheckableType.test( elem.type ) ) {
...
<p>}); var curCSS, getStyles, iframe,</p>
...
<p>}); var xhrCallbacks, xhrSupported,</p>
...
<p>// Determine support properties xhrSupported = jQuery.ajaxSettings.xhr();
jQuery.support.cors = !!xhrSupported &amp;&amp; ( “withCredentials” in
xhrSupported ); xhrSupported = jQuery.support.ajax = !!xhrSupported;</p>
