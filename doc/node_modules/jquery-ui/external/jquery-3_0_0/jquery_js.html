...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-3.0.0/jquery.js">
...
<pre class="ruby"><span class="ruby-identifier">function</span> <span class="ruby-constant">DOMEval</span>( <span class="ruby-identifier">code</span>, <span class="ruby-identifier">doc</span> ) {
        <span class="ruby-identifier">doc</span> = <span class="ruby-identifier">doc</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">document</span>;

        <span class="ruby-identifier">var</span> <span class="ruby-identifier">script</span> = <span class="ruby-identifier">doc</span>.<span class="ruby-identifier">createElement</span>( <span class="ruby-string">&quot;script&quot;</span> );

        <span class="ruby-identifier">script</span>.<span class="ruby-identifier">text</span> = <span class="ruby-identifier">code</span>;
        <span class="ruby-identifier">doc</span>.<span class="ruby-identifier">head</span>.<span class="ruby-identifier">appendChild</span>( <span class="ruby-identifier">script</span> ).<span class="ruby-identifier">parentNode</span>.<span class="ruby-identifier">removeChild</span>( <span class="ruby-identifier">script</span> );
}
</pre>
...
<p>// JSHint would error on this code due to the Symbol not being defined in
ES5. // Defining this global in .jshintrc would create a danger of using
the global // unguarded in another place, it seems safer to just disable
JSHint for these // three lines.</p>

<pre class="ruby"><span class="ruby-identifier">jshint</span> <span class="ruby-value">ignore:</span> <span class="ruby-identifier">start</span>
</pre>
...
<pre> Sizzle CSS Selector Engine v2.3.0
 https://sizzlejs.com/
...
<pre>// Known :disabled false positives:
...
<p>function adoptValue( value, resolve, reject ) {</p>
...
<pre class="ruby"><span class="ruby-identifier">readyList</span>.<span class="ruby-identifier">then</span>( <span class="ruby-identifier">fn</span> );
...
return chainable ?
        ...
        bulk ?
                fn.call( elems ) :
                len ? fn( elems[ 0 ], key ) : emptyGet;</pre>
...
<p>var rscriptType = ( /^$|/(?:java|ecma)script/i );</p>
...
<pre>rxhtmlTag = /&lt;(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0&gt;\x20\t\r\n\f]*)[^&gt;]*)\/&gt;/gi,
...
<p>function manipulationTarget( elem, content ) {</p>

<pre>if ( jQuery.nodeName( elem, &quot;table&quot; ) &amp;&amp;
...
<pre class="ruby"><span class="ruby-identifier">fxNow</span>, <span class="ruby-identifier">timerId</span>,
...
getter ensures a default option is selected // when in an optgroup if (
...
<p>jQuery.parseJSON = JSON.parse;</p>
