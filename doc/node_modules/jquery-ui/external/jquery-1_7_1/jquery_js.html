...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.7.1/jquery.js">
...
<pre>!
 ...
 Date: Mon Nov 21 21:11:03 2011 -0500</pre>

<p>(function( window, undefined ) {</p>

<p>// Use the correct document accordingly with window argument (sandbox) var
document = window.document,</p>

<pre class="ruby"><span class="ruby-identifier">navigator</span> = <span class="ruby-identifier">window</span>.<span class="ruby-identifier">navigator</span>,
<span class="ruby-identifier">location</span> = <span class="ruby-identifier">window</span>.<span class="ruby-identifier">location</span>;
</pre>

<p>var jQuery = (function() {</p>

<p>// Define a local copy of jQuery var jQuery = function( selector, context )
{</p>

<pre>        // The jQuery object is actually just the init constructor &#39;enhanced&#39;
...
Array Date RegExp Object”.split(“ ”), function(i, name) {</p>
...
<p>browserMatch = jQuery.uaMatch( userAgent ); if ( browserMatch.browser ) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">browser</span>[ <span class="ruby-identifier">browserMatch</span>.<span class="ruby-identifier">browser</span> ] = <span class="ruby-keyword">true</span>;
<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">browser</span>.<span class="ruby-identifier">version</span> = <span class="ruby-identifier">browserMatch</span>.<span class="ruby-identifier">version</span>;
</pre>

<p>}</p>

<p>// Deprecated, use jQuery.browser.webkit instead if ( jQuery.browser.webkit
) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">browser</span>.<span class="ruby-identifier">safari</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>}</p>

<p>// IE doesn&#39;t match non-breaking spaces with s if ( rnotwhite.test(
“xA0” ) ) {</p>
...
<p>// All jQuery objects should point back to these rootjQuery =
jQuery(document);</p>

<p>// Cleanup functions for the document ready method if (
document.addEventListener ) {</p>

<pre class="ruby"><span class="ruby-constant">DOMContentLoaded</span> = <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">document</span>.<span class="ruby-identifier">removeEventListener</span>( <span class="ruby-string">&quot;DOMContentLoaded&quot;</span>, <span class="ruby-constant">DOMContentLoaded</span>, <span class="ruby-keyword">false</span> );
        <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">ready</span>();
};
</pre>

<p>} else if ( document.attachEvent ) {</p>

<pre>DOMContentLoaded = function() {
        // Make sure body exists, at least, in case IE gets a little overzealous (ticket #5443).
        if ( document.readyState === &quot;complete&quot; ) {
...
<p>// The DOM ready check for Internet Explorer function doScrollCheck() {</p>

<pre>if ( jQuery.isReady ) {
        return;
}
...
<p>// String to <a href="../../../../Object.html">Object</a> flags format
cache var flagsCache = {};</p>

<p>// Convert String-formatted flags into Object-formatted ones and store in
cache function createFlags( flags ) {</p>

<pre>var object = flagsCache[ flags ] = {},
        i, length;
flags = flags.split( /\s+/ );
...
<p>jQuery.Callbacks = function( flags ) {</p>

<pre>// Convert flags from String-formatted to Object-formatted
...
<p>var // Static reference to slice</p>

<pre class="ruby"><span class="ruby-identifier">sliceDeferred</span> = [].<span class="ruby-identifier">slice</span>;
</pre>
...
<p>function handleQueueMarkDefer( elem, type, src ) {</p>

<pre>var deferDataKey = type + &quot;defer&quot;,
...
nodeHook, boolHook, fixSpecified;</pre>
...
<p>// Add the tabIndex propHook to attrHooks for back-compat (different case
is intentional) jQuery.attrHooks.tabindex = jQuery.propHooks.tabIndex;</p>

<p>// Hook for boolean attributes boolHook = {</p>

<pre>get: function( elem, name ) {
...
<p>// Some attributes require a special call on IE if (
!jQuery.support.hrefNormalized ) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">each</span>([ <span class="ruby-string">&quot;href&quot;</span>, <span class="ruby-string">&quot;src&quot;</span>, <span class="ruby-string">&quot;width&quot;</span>, <span class="ruby-string">&quot;height&quot;</span> ], <span class="ruby-identifier">function</span>( <span class="ruby-identifier">i</span>, <span class="ruby-identifier">name</span> ) {
        <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">attrHooks</span>[ <span class="ruby-identifier">name</span> ] = <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">extend</span>( <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">attrHooks</span>[ <span class="ruby-identifier">name</span> ], {
                <span class="ruby-value">get:</span> <span class="ruby-identifier">function</span>( <span class="ruby-identifier">elem</span> ) {
                        <span class="ruby-identifier">var</span> <span class="ruby-identifier">ret</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getAttribute</span>( <span class="ruby-identifier">name</span>, <span class="ruby-value">2</span> );
                        <span class="ruby-keyword">return</span> <span class="ruby-identifier">ret</span> <span class="ruby-operator">===</span> <span class="ruby-identifier">null</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">undefined</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">ret</span>;
                }
        });
});
</pre>
...
Accessing the parent&#39;s selectedIndex property fixes it if (
!jQuery.support.optSelected ) {</p>

<pre>jQuery.propHooks.selected = jQuery.extend( jQuery.propHooks.selected, {
        get: function( elem ) {
...
<p>// IE6/7 call enctype encoding if ( !jQuery.support.enctype ) {</p>
...
<p>// Radios and checkboxes getter/setter if ( !jQuery.support.checkOn ) {</p>

<pre>jQuery.each([ &quot;radio&quot;, &quot;checkbox&quot; ], function() {
...
<p>} jQuery.each([ “radio”, “checkbox” ], function() {</p>

<pre>jQuery.valHooks[ this ] = jQuery.extend( jQuery.valHooks[ this ], {
        set: function( elem, value ) {
...
<p>var rformElems = /^(?:textarea|input|select)$/i,</p>
...
<pre>add: function( elem, types, handler, data, selector ) {
...
<p>// Some plugins are using, but it&#39;s undocumented/deprecated and will be
removed. // The 1.7 special event interface should provide all the hooks
needed now. jQuery.event.handle = jQuery.event.dispatch;</p>
...
isImmediatePropagationStopped: returnFalse</pre>
...
<p>// IE submit delegation if ( !jQuery.support.submitBubbles ) {</p>
...
<p>// IE change delegation and checkbox/radio fix if (
!jQuery.support.changeBubbles ) {</p>
...
<p>// Create “bubbling” focus and blur events if (
!jQuery.support.focusinBubbles ) {</p>
...
<pre> Sizzle CSS Selector Engine
  Copyright 2011, The Dojo Foundation
  Released under the MIT, BSD, and GPL Licenses.
...
<pre>expando = &quot;sizcache&quot; + (Math.random() + &#39;&#39;).replace(&#39;.&#39;, &#39;&#39;),
done = 0,
toString = Object.prototype.toString,
hasDuplicate = false,
...
optimization where it does not always call our comparision // function. If
that is the case, discard the hasDuplicate value. //   Thus far that
includes Google Chrome. [0, 0].sort(function() {</p>
...
<p>Sizzle.matchesSelector = function( node, expr ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Sizzle</span>( <span class="ruby-identifier">expr</span>, <span class="ruby-identifier">null</span>, <span class="ruby-identifier">null</span>, [<span class="ruby-identifier">node</span>] ).<span class="ruby-identifier">length</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0</span>;
</pre>
...
<pre>var set, i, len, match, type, left;
...
<pre> Utility function for retreiving the text value of an array of DOM nodes
 @param {Array|Element} elem
/</pre>

<p>var getText = Sizzle.getText = function( elem ) {</p>
...
<pre class="ruby"><span class="ruby-identifier">fescape</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">all</span>, <span class="ruby-identifier">num</span>){
        <span class="ruby-keyword">return</span> <span class="ruby-string">&quot;\\&quot;</span> <span class="ruby-operator">+</span> (<span class="ruby-identifier">num</span> <span class="ruby-operator">-</span> <span class="ruby-value">0</span> <span class="ruby-operator">+</span> <span class="ruby-value">1</span>);
};
</pre>
...
Expr.leftMatch[ type ] = new RegExp( /(^(?:.|\r|\n)*?)/.source + Expr.match[ type ].source.replace(/\\(\d+)/g, fescape) );</pre>
...
converting a NodeList to an array using builtin methods. // Also verifies
that the returned array holds DOM nodes // (which is not the case in the
Blackberry browser) try {</p>

<pre class="ruby"><span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>.<span class="ruby-identifier">slice</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">document</span>.<span class="ruby-identifier">documentElement</span>.<span class="ruby-identifier">childNodes</span>, <span class="ruby-value">0</span> )[<span class="ruby-value">0</span>].<span class="ruby-identifier">nodeType</span>;
</pre>

<p>// Provide a fallback method if it does not work } catch( e ) {</p>
...
<p>// Check to see if the browser returns elements by name when // querying by
getElementById (and provide a workaround) (function(){</p>

<pre>// We&#39;re going to inject a fake input element with a specified name
...
<pre>// Check to see if the browser returns only elements
...
<p>if ( document.querySelectorAll ) {</p>
...
<pre>var html = document.documentElement,
...
<p>if ( document.documentElement.contains ) {</p>

<pre>Sizzle.contains = function( a, b ) {
        return a !== b &amp;&amp; (a.contains ? a.contains(b) : true);
};</pre>

<p>} else if ( document.documentElement.compareDocumentPosition ) {</p>

<pre class="ruby"><span class="ruby-constant">Sizzle</span>.<span class="ruby-identifier">contains</span> = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-operator">!</span>(<span class="ruby-identifier">a</span>.<span class="ruby-identifier">compareDocumentPosition</span>(<span class="ruby-identifier">b</span>) <span class="ruby-operator">&amp;</span> <span class="ruby-value">16</span>);
};
</pre>

<p>} else {</p>

<pre class="ruby"><span class="ruby-constant">Sizzle</span>.<span class="ruby-identifier">contains</span> = <span class="ruby-identifier">function</span>() {
...
<p>Sizzle.isXML = function( elem ) {</p>
...
<p>var posProcess = function( selector, context, seed ) {</p>
...
<p>// EXPOSE // Override sizzle attribute retrieval Sizzle.attr = jQuery.attr;
Sizzle.selectors.attrMap = {}; jQuery.find = Sizzle; jQuery.expr =
Sizzle.selectors; <a href="":"">jQuery.expr</a> = jQuery.expr.filters;
jQuery.unique = Sizzle.uniqueSort; jQuery.text = Sizzle.getText;
jQuery.isXMLDoc = Sizzle.isXML; jQuery.contains = Sizzle.contains;</p>

<p>})();</p>

<p>var runtil = /Until$/,</p>

<pre>rparentsprev = /^(?:parents|prevUntil|prevAll)/,
...
<p>// A painfully simple check to see if an element is disconnected // from a
document (should be improved, where feasible). function isDisconnected(
node ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-identifier">node</span> <span class="ruby-operator">||</span> <span class="ruby-operator">!</span><span class="ruby-identifier">node</span>.<span class="ruby-identifier">parentNode</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">node</span>.<span class="ruby-identifier">parentNode</span>.<span class="ruby-identifier">nodeType</span> <span class="ruby-operator">===</span> <span class="ruby-value">11</span>;
</pre>
...
<pre>filter: function( expr, elems, not ) {
        if ( not ) {
                expr = &quot;:not(&quot; + expr + &quot;)&quot;;
        }
...
winnow( elements, qualifier, keep ) {</p>

<pre>// Can&#39;t pass null or undefined to indexOf in Firefox 4
...
safeFragment = createSafeFragment( document );</pre>

<p>wrapMap.optgroup = wrapMap.option; wrapMap.tbody = wrapMap.tfoot =
wrapMap.colgroup = wrapMap.caption = wrapMap.thead; wrapMap.th =
wrapMap.td;</p>

<p>// IE can&#39;t serialize &lt;link&gt; and &lt;script&gt; tags normally if
( !jQuery.support.htmlSerialize ) {</p>

<pre class="ruby"><span class="ruby-identifier">wrapMap</span>.<span class="ruby-identifier">_default</span> = [ <span class="ruby-value">1</span>, <span class="ruby-string">&quot;div&lt;div&gt;&quot;</span>, <span class="ruby-string">&quot;&lt;/div&gt;&quot;</span> ];
</pre>
...
<p>function root( elem, cur ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">nodeName</span>(<span class="ruby-identifier">elem</span>, <span class="ruby-string">&quot;table&quot;</span>) <span class="ruby-operator">?</span>
        (<span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getElementsByTagName</span>(<span class="ruby-string">&quot;tbody&quot;</span>)[<span class="ruby-value">0</span>] <span class="ruby-operator">||</span>
        <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">appendChild</span>(<span class="ruby-identifier">elem</span>.<span class="ruby-identifier">ownerDocument</span>.<span class="ruby-identifier">createElement</span>(<span class="ruby-string">&quot;tbody&quot;</span>))) <span class="ruby-operator">:</span>
...
<p>function cloneFixAttributes( src, dest ) {</p>
...
// gets copied too
dest.removeAttribute( jQuery.expando );</pre>

<p>}</p>

<p>jQuery.buildFragment = function( args, nodes, scripts ) {</p>

<pre>var fragment, cacheable, cacheresults, doc,
first = args[ 0 ];
...
return { fragment: fragment, cacheable: cacheable };</pre>
...
<p>function getAll( elem ) {</p>

<pre>if ( typeof elem.getElementsByTagName !== &quot;undefined&quot; ) {
...
<p>// Used in clean, fixes the defaultChecked property function
fixDefaultChecked( elem ) {</p>

<pre>if ( elem.type === &quot;checkbox&quot; || elem.type === &quot;radio&quot; ) {
        elem.defaultChecked = elem.checked;
}</pre>

<p>} // Finds all inputs and passes them to fixDefaultChecked function
findInputs( elem ) {</p>

<pre>var nodeName = ( elem.nodeName || &quot;&quot; ).toLowerCase();
if ( nodeName === &quot;input&quot; ) {
...
<p>// Derived From: <a
href="http://www.iecss.com/shimprove/javascript/shimprove.1-0-1.js">www.iecss.com/shimprove/javascript/shimprove.1-0-1.js</a>
function shimCloneNode( elem ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">div</span> = <span class="ruby-identifier">document</span>.<span class="ruby-identifier">createElement</span>( <span class="ruby-string">&quot;div&quot;</span> );
<span class="ruby-identifier">safeFragment</span>.<span class="ruby-identifier">appendChild</span>( <span class="ruby-identifier">div</span> );

<span class="ruby-identifier">div</span>.<span class="ruby-identifier">innerHTML</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">outerHTML</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">div</span>.<span class="ruby-identifier">firstChild</span>;
</pre>
...
<p>function evalScript( i, elem ) {</p>
...
<p>var ralpha = /<a href="^)">alpha(</a>*)/i,</p>

<pre>ropacity = /opacity=([^)]*)/,
...
<p>jQuery.fn.css = function( name, value ) {</p>

<pre>// Setting &#39;undefined&#39; is a no-op
...
<p>// DEPRECATED, Use jQuery.css() instead jQuery.curCSS = jQuery.css;</p>
...
<pre>// This hook cannot be added until DOM ready because the support test
...
<p>if ( document.defaultView &amp;&amp; document.defaultView.getComputedStyle
) {</p>

<pre>getComputedStyle = function( elem, name ) {
...
<p>if ( document.documentElement.currentStyle ) {</p>

<pre>currentStyle = function( elem, name ) {
...
<pre>// Start with offset property
...
<p>if ( jQuery.expr &amp;&amp; jQuery.expr.filters ) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">expr</span>.<span class="ruby-identifier">filters</span>.<span class="ruby-identifier">hidden</span> = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">elem</span> ) {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">width</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">offsetWidth</span>,
                <span class="ruby-identifier">height</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">offsetHeight</span>;

        <span class="ruby-keyword">return</span> ( <span class="ruby-identifier">width</span> <span class="ruby-operator">===</span> <span class="ruby-value">0</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">height</span> <span class="ruby-operator">===</span> <span class="ruby-value">0</span> ) <span class="ruby-operator">||</span> (<span class="ruby-operator">!</span><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">support</span>.<span class="ruby-identifier">reliableHiddenOffsets</span> <span class="ruby-operator">&amp;&amp;</span> ((<span class="ruby-identifier">elem</span>.<span class="ruby-identifier">style</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">style</span>.<span class="ruby-identifier">display</span>) <span class="ruby-operator">||</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">css</span>( <span class="ruby-identifier">elem</span>, <span class="ruby-string">&quot;display&quot;</span> )) <span class="ruby-operator">===</span> <span class="ruby-string">&quot;none&quot;</span>);
};

<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">expr</span>.<span class="ruby-identifier">filters</span>.<span class="ruby-identifier">visible</span> = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">elem</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-operator">!</span><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">expr</span>.<span class="ruby-identifier">filters</span>.<span class="ruby-identifier">hidden</span>( <span class="ruby-identifier">elem</span> );
};
</pre>
...
inspectPrefiltersOrTransports( structure, options, originalOptions, jqXHR,</p>

<pre>        dataType /* internal */, inspected /* internal */ ) {
...
<pre>load: function( url, params, callback ) {
...
<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">fn</span>[ <span class="ruby-identifier">o</span> ] = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">f</span> ){
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>( <span class="ruby-identifier">o</span>, <span class="ruby-identifier">f</span> );
};
</pre>
...
<pre>     getScript: function( url, callback ) {
...
<p>// This is still on the jQuery object… for now // Want to move this to
jQuery.ajax some day jQuery.extend({</p>
...
<pre> - sets all responseXXX fields accordingly
...
<p>// Chain conversions given the request and the original response function
ajaxConvert( s, response ) {</p>

<pre>// Apply the dataFilter if provided
if ( s.dataFilter ) {
...
<p>var jsc = jQuery.now(),</p>

<pre class="ruby"><span class="ruby-identifier">jsre</span> = <span class="ruby-regexp">/(\=)\?(&amp;|$)|\?\?/i</span>;
</pre>
...
<pre>var inspectData = s.contentType === &quot;application/x-www-form-urlencoded&quot; &amp;&amp;
...
<p>var // #5280: Internet Explorer will keep connections alive if we don&#39;t
abort on unload</p>

<pre>xhrOnUnloadAbort = window.ActiveXObject ? function() {
...
backward compatibility) jQuery.ajaxSettings.xhr = window.ActiveXObject ?</p>

<pre>     /* Microsoft failed to properly
...
<p>// Determine support properties (function( xhr ) {</p>

<pre>jQuery.extend( jQuery.support, {
        ajax: !!xhr,
        cors: !!xhr &amp;&amp; ( &quot;withCredentials&quot; in xhr )
});</pre>

<p>})( jQuery.ajaxSettings.xhr() );</p>

<p>// Create transport if the browser can provide an xhr if (
jQuery.support.ajax ) {</p>

<pre>jQuery.ajaxTransport(function( s ) {
...
<pre>show: function( speed, easing, callback ) {
        var elem, display;
...
<pre class="ruby"><span class="ruby-identifier">setTimeout</span>( <span class="ruby-identifier">clearFxNow</span>, <span class="ruby-value">0</span> );
...
<p>function clearFxNow() {</p>

<pre class="ruby"><span class="ruby-identifier">fxNow</span> = <span class="ruby-identifier">undefined</span>;
</pre>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">obj</span> = {};

<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">each</span>( <span class="ruby-identifier">fxAttrs</span>.<span class="ruby-identifier">concat</span>.<span class="ruby-identifier">apply</span>([], <span class="ruby-identifier">fxAttrs</span>.<span class="ruby-identifier">slice</span>( <span class="ruby-value">0</span>, <span class="ruby-identifier">num</span> )), <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">obj</span>[ <span class="ruby-identifier">this</span> ] = <span class="ruby-identifier">type</span>;
});
...
<pre>speed: function( speed, easing, fn ) {
...
<p>jQuery.fx.prototype = {</p>

<pre>// Simple function for setting a style value
update: function() {
...
<p>// Adds width/height step functions // Do not set anything below 0
jQuery.each([ “width”, “height” ], function( i, prop ) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">fx</span>.<span class="ruby-identifier">step</span>[ <span class="ruby-identifier">prop</span> ] = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">fx</span> ) {
        <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">style</span>( <span class="ruby-identifier">fx</span>.<span class="ruby-identifier">elem</span>, <span class="ruby-identifier">prop</span>, <span class="ruby-constant">Math</span>.<span class="ruby-identifier">max</span>(<span class="ruby-value">0</span>, <span class="ruby-identifier">fx</span>.<span class="ruby-identifier">now</span>) <span class="ruby-operator">+</span> <span class="ruby-identifier">fx</span>.<span class="ruby-identifier">unit</span> );
};
</pre>
...
<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">expr</span>.<span class="ruby-identifier">filters</span>.<span class="ruby-identifier">animated</span> = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">elem</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">grep</span>(<span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">timers</span>, <span class="ruby-identifier">function</span>( <span class="ruby-identifier">fn</span> ) {
...
<p>// Try to restore the default display value of an element function
defaultDisplay( nodeName ) {</p>

<pre>if ( !elemdisplay[ nodeName ] ) {
...
return elemdisplay[ nodeName ];</pre>

<p>}</p>

<p>var rtable = /^t(?:able|d|h)$/i,</p>

<pre class="ruby"><span class="ruby-identifier">rroot</span> = <span class="ruby-regexp">/^(?:body|html)$/i</span>;
</pre>

<p>if ( “getBoundingClientRect” in document.documentElement ) {</p>

<pre>jQuery.fn.offset = function( options ) {
        var elem = this[0], box;
...
<p>// Create scrollLeft and scrollTop methods jQuery.each( [“Left”, “Top”],
function( i, name ) {</p>

<pre>var method = &quot;scroll&quot; + name;
...
<p>// Create width, height, innerHeight, innerWidth, outerHeight and
outerWidth methods jQuery.each([ “Height”, “Width” ], function( i, name ) {</p>

<pre>var type = name.toLowerCase();
...
<p>// Expose jQuery to the global object window.jQuery = window.$ = jQuery;</p>

<p>// Expose jQuery as an AMD module, but only for AMD loaders that //
understand the issues with loading multiple versions of jQuery // in a page
that all might call define(). The loader will indicate // they have special
allowances for multiple jQuery versions by // specifying define.amd.jQuery
= true. Register as a named module, // since jQuery can be concatenated
with other files that may use define, // but not use a proper concatenation
...
work. if ( typeof define === “function” &amp;&amp; define.amd &amp;&amp;
define.amd.jQuery ) {</p>

<pre>define( &quot;jquery&quot;, [], function () { return jQuery; } );</pre>
