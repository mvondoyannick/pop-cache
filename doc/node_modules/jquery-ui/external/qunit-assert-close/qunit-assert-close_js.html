...
<title>qunit-assert-close.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/external/qunit-assert-close/qunit-assert-close.js">

<pre>Checks that the first two arguments are equal, or are numbers close enough to be considered equal
...
@param String message (optional)</pre>

<p>function close(actual, expected, maxDifference, message) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">actualDiff</span> = (<span class="ruby-identifier">actual</span> <span class="ruby-operator">===</span> <span class="ruby-identifier">expected</span>) <span class="ruby-operator">?</span> <span class="ruby-value">0</span> <span class="ruby-operator">:</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">abs</span>(<span class="ruby-identifier">actual</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">expected</span>),
    <span class="ruby-identifier">result</span> = <span class="ruby-identifier">actualDiff</span> <span class="ruby-operator">&lt;=</span> <span class="ruby-identifier">maxDifference</span>;
<span class="ruby-identifier">message</span> = <span class="ruby-identifier">message</span> <span class="ruby-operator">||</span> (<span class="ruby-identifier">actual</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot; should be within &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">maxDifference</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot; (inclusive) of &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">expected</span> <span class="ruby-operator">+</span> (<span class="ruby-identifier">result</span> <span class="ruby-operator">?</span> <span class="ruby-string">&quot;&quot;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&quot;. Actual: &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">actualDiff</span>));
<span class="ruby-constant">QUnit</span>.<span class="ruby-identifier">push</span>(<span class="ruby-identifier">result</span>, <span class="ruby-identifier">actual</span>, <span class="ruby-identifier">expected</span>, <span class="ruby-identifier">message</span>);
</pre>
...
<p>close.percent = function closePercent(actual, expected,
maxPercentDifference, message) {</p>

<pre>var actualDiff, result;
if (actual === expected) {
  actualDiff = 0;
...
QUnit.push(result, actual, expected, message);</pre>

<p>};</p>

<p>/**</p>

<pre> Checks that the first two arguments are numbers with differences greater than the specified
 minimum difference.
...
<p>function notClose(actual, expected, minDifference, message) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">actualDiff</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">abs</span>(<span class="ruby-identifier">actual</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">expected</span>),
    <span class="ruby-identifier">result</span> = <span class="ruby-identifier">actualDiff</span> <span class="ruby-operator">&gt;</span> <span class="ruby-identifier">minDifference</span>;
<span class="ruby-identifier">message</span> = <span class="ruby-identifier">message</span> <span class="ruby-operator">||</span> (<span class="ruby-identifier">actual</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot; should not be within &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">minDifference</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot; (exclusive) of &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">expected</span> <span class="ruby-operator">+</span> (<span class="ruby-identifier">result</span> <span class="ruby-operator">?</span> <span class="ruby-string">&quot;&quot;</span> <span class="ruby-operator">:</span> <span class="ruby-string">&quot;. Actual: &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">actualDiff</span>));
<span class="ruby-constant">QUnit</span>.<span class="ruby-identifier">push</span>(<span class="ruby-identifier">result</span>, <span class="ruby-identifier">actual</span>, <span class="ruby-identifier">expected</span>, <span class="ruby-identifier">message</span>);
</pre>
...
<p>notClose.percent = function notClosePercent(actual, expected,
minPercentDifference, message) {</p>
...
<p>QUnit.extend(QUnit.assert, {</p>

<pre>close: close,
notClose: notClose</pre>
