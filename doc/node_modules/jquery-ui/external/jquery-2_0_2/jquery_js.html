...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-2.0.2/jquery.js">
...
<p>function addHandle( attrs, handler, test ) {</p>

<pre>attrs = attrs.split(&quot;|&quot;);
var current,
        i = attrs.length,
...
<pre> Fetches boolean attributes by node
 @param {Element} elem
 @param {String} name
/</pre>

<p>function boolHandler( elem, name ) {</p>

<pre>// XML does not need to be checked as this will not be assigned for XML documents
var val = elem.getAttributeNode( name );
return val &amp;&amp; val.specified ?
        val.value :
        elem[ name ] === true ? name.toLowerCase() : null;</pre>

<p>}</p>

<p>/**</p>

<pre> Fetches attributes without interpolation
 http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx
 @param {Element} elem
 @param {String} name
/</pre>

<p>function interpolationHandler( elem, name ) {</p>

<pre>// XML does not need to be checked as this will not be assigned for XML documents
return elem.getAttribute( name, name.toLowerCase() === &quot;type&quot; ? 1 : 2 );</pre>

<p>}</p>

<p>/**</p>

<pre> Uses defaultValue to retrieve value in IE6/7
 @param {Element} elem
 @param {String} name
/</pre>

<p>function valueHandler( elem ) {</p>

<pre>// Ignore the value *property* on inputs by using defaultValue
...
<p>// })(); if ( typeof module === “object” &amp;&amp; module &amp;&amp;
typeof module.exports === “object” ) {</p>
