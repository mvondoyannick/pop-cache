...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-2.1.0/jquery.js">
...
Safari if ( !support.focusinBubbles ) {</p>
...
<pre>        return elem.ownerDocument.defaultView.getComputedStyle( elem, null );
};</pre>
...
inaccurate if ( !support.optSelected ) {</p>
...
work. if ( typeof define === “function” &amp;&amp; define.amd ) {</p>
