...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-2.1.4/jquery.js">
...
<p>// String to <a href="../../../../Object.html">Object</a> options format
cache var optionsCache = {};</p>
...
<pre class="ruby"><span class="ruby-identifier">document</span>.<span class="ruby-identifier">removeEventListener</span>( <span class="ruby-string">&quot;DOMContentLoaded&quot;</span>, <span class="ruby-identifier">completed</span>, <span class="ruby-keyword">false</span> );
<span class="ruby-identifier">window</span>.<span class="ruby-identifier">removeEventListener</span>( <span class="ruby-string">&quot;load&quot;</span>, <span class="ruby-identifier">completed</span>, <span class="ruby-keyword">false</span> );
...
<p>jQuery.acceptData = function( owner ) {</p>
...
this.expando = jQuery.expando + Data.uid++;</pre>

<p>}</p>

<p>Data.uid = 1; Data.accepts = jQuery.acceptData;</p>
...
<p>}; var data_priv = new Data();</p>

<p>var data_user = new Data();</p>
...
<p>support.focusinBubbles = “onfocusin” in window;</p>
...
<p>// Support: Firefox, Chrome, Safari // Create “bubbling” focus and blur
events if ( !support.focusinBubbles ) {</p>
...
<pre>var pixelPositionVal, boxSizingReliableVal,
...
<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">ajax</span>({
        <span class="ruby-value">url:</span> <span class="ruby-identifier">url</span>,
        <span class="ruby-value">type:</span> <span class="ruby-string">&quot;GET&quot;</span>,
        <span class="ruby-value">dataType:</span> <span class="ruby-string">&quot;script&quot;</span>,
        <span class="ruby-value">async:</span> <span class="ruby-keyword">false</span>,
        <span class="ruby-value">global:</span> <span class="ruby-keyword">false</span>,
        <span class="ruby-value">&quot;throws&quot;:</span> <span class="ruby-keyword">true</span>
});
</pre>
...
return elem.offsetWidth &lt;= 0 &amp;&amp; elem.offsetHeight &lt;= 0;</pre>
...
<p>// Support: IE9 // Open requests must be manually aborted on unload (#5280)
// See <a
...
<p>// Support: Safari&lt;7+, Chrome&lt;37+ // Add the top/left cssHooks using
jQuery.fn.position // Webkit bug: <a
