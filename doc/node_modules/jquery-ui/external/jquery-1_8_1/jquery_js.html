...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.8.1/jquery.js">
...
<pre>!
 ...
 Date: Thu Aug 30 2012 17:17:22 GMT-0400 (Eastern Daylight Time)</pre>

<p>(function( window, undefined ) { var</p>

<pre>// A central reference to the root jQuery(document)
rootjQuery,
...
jQuery(document); // String to <a href="../../../../Object.html">Object</a>
options format cache var optionsCache = {};</p>
...
<p>}); var nodeHook, boolHook, fixSpecified,</p>
...
getSetAttribute = jQuery.support.getSetAttribute;</pre>
...
<pre class="ruby"><span class="ruby-identifier">rtypenamespace</span> = <span class="ruby-regexp">/^([^\.]*|)(?:\.(.+)|)$/</span>,
<span class="ruby-identifier">rhoverHack</span> = <span class="ruby-regexp">/(?:^|\s)hover(\.\S+|)\b/</span>,
<span class="ruby-identifier">rkeyEvent</span> = <span class="ruby-regexp">/^key/</span>,
<span class="ruby-identifier">rmouseEvent</span> = <span class="ruby-regexp">/^(?:mouse|contextmenu)|click/</span>,
<span class="ruby-identifier">rfocusMorph</span> = <span class="ruby-regexp">/^(?:focusinfocus|focusoutblur)$/</span>,
<span class="ruby-identifier">hoverHack</span> = <span class="ruby-identifier">function</span>( <span class="ruby-identifier">events</span> ) {
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">event</span>.<span class="ruby-identifier">special</span>.<span class="ruby-identifier">hover</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">events</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">events</span>.<span class="ruby-identifier">replace</span>( <span class="ruby-identifier">rhoverHack</span>, <span class="ruby-string">&quot;mouseenter$1 mouseleave$1&quot;</span> );
};
</pre>
...
<p>// If slice is not available, provide a backup try {</p>

<pre class="ruby"><span class="ruby-identifier">slice</span>.<span class="ruby-identifier">call</span>( <span class="ruby-identifier">docElem</span>.<span class="ruby-identifier">childNodes</span>, <span class="ruby-value">0</span> )[<span class="ruby-value">0</span>].<span class="ruby-identifier">nodeType</span>;
</pre>

<p>} catch ( e ) {</p>

<pre>slice = function( i ) {
        var elem, results = [];
        for ( ; (elem = this[i]); i++ ) {
                results.push( elem );
        }
...
// All others
return select( selector, context, results, seed, xml );</pre>
...
<p>// Returns a function to use in pseudos for input types function
createInputPseudo( type ) {</p>
...
<p>// Returns a function to use in pseudos for buttons function
createButtonPseudo( type ) {</p>
...
<p>isXML = Sizzle.isXML = function isXML( elem ) {</p>
...
<p>// Element contains another contains = Sizzle.contains = docElem.contains ?</p>
...
<p>function siblingCheck( a, b, ret ) {</p>
...
<p>sortOrder = docElem.compareDocumentPosition ?</p>
...
<p>// Always assume the presence of duplicates if sort doesn&#39;t // pass
them to our comparison function (as in Google Chrome). [0, 0].sort(
sortOrder ); baseHasDuplicate = !hasDuplicate;</p>

<p>// Document sorting and removing duplicates Sizzle.uniqueSort = function(
results ) {</p>
...
<p>function tokenize( selector, context, xml, parseOnly ) {</p>
...
return parseOnly ?
        ...
        soFar ?
                ...
                // Cache the tokens
                slice.call( tokenCache(key, groups), 0 );</pre>

<p>}</p>

<p>function addCombinator( matcher, combinator, context, xml ) {</p>
...
<p>function addMatcher( higher, deeper ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">higher</span> <span class="ruby-operator">?</span>
        <span class="ruby-identifier">function</span>( <span class="ruby-identifier">elem</span> ) {
                <span class="ruby-identifier">var</span> <span class="ruby-identifier">result</span> = <span class="ruby-identifier">deeper</span>( <span class="ruby-identifier">elem</span> );
                <span class="ruby-keyword">return</span> <span class="ruby-identifier">result</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">higher</span>( <span class="ruby-identifier">result</span> <span class="ruby-operator">===</span> <span class="ruby-keyword">true</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">elem</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">result</span> );
        } <span class="ruby-operator">:</span>
        <span class="ruby-identifier">deeper</span>;
</pre>

<p>}</p>

<p>// [“TAG”, “&gt;”, “ID”, “ ”, “CLASS”] function matcherFromTokens( tokens,
context, xml ) {</p>

<pre>var token, matcher,
        i = 0;
...
<p>function matcherFromGroupMatchers( matchers ) {</p>

<pre>return function( elem ) {
        var matcher,
                j = 0;
...
<p>compile = Sizzle.compile = function( selector, context, xml ) {</p>
...
<p>function multipleContexts( selector, contexts, results, seed ) {</p>
...
<p>function handlePOSGroup( selector, posfilter, argument, contexts, seed, not
) {</p>
...
return results.length &gt; 0 ? fn( results, argument, not ) : [];</pre>

<p>}</p>

<p>function handlePOS( groups, context, results, seed ) {</p>

<pre>var group, part, j, groupLen, token, selector,
...
return len === 1 ? results : Sizzle.uniqueSort( results );</pre>

<p>}</p>

<p>function select( selector, context, results, seed, xml ) {</p>

<pre>// Remove excessive whitespace
...
<p>// Deprecated <a href=""nth"">Expr.setFilters</a> = <a
href=""eq"">Expr.setFilters</a>;</p>

<p>// Back-compat Expr.filters = Expr.pseudos;</p>

<p>// Override sizzle attribute retrieval Sizzle.attr = jQuery.attr;
jQuery.find = Sizzle; jQuery.expr = Sizzle.selectors; <a
...
<p>})( window ); var runtil = /Until$/,</p>

<pre>rparentsprev = /^(?:parents|prev(?:Until|All))/,
isSimple = /^.[^:#\[\.,]*$/,
...
<p>// IE6-8 can&#39;t serialize link, script, style, or any html5 (NoScope)
tags, // unless wrapped in a div with non-breaking characters in front of
it. if ( !jQuery.support.htmlSerialize ) {</p>

<pre class="ruby"><span class="ruby-identifier">wrapMap</span>.<span class="ruby-identifier">_default</span> = [ <span class="ruby-value">1</span>, <span class="ruby-string">&quot;X&lt;div&gt;&quot;</span>, <span class="ruby-string">&quot;&lt;/div&gt;&quot;</span> ];
</pre>
...
<p>function findOrAppend( elem, tag ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getElementsByTagName</span>( <span class="ruby-identifier">tag</span> )[<span class="ruby-value">0</span>] <span class="ruby-operator">||</span> <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">appendChild</span>( <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">ownerDocument</span>.<span class="ruby-identifier">createElement</span>( <span class="ruby-identifier">tag</span> ) );
</pre>
...
<p>jQuery.buildFragment = function( args, context, scripts ) {</p>

<pre>var fragment, cacheable, cachehit,
        first = args[ 0 ];
...
<p>}); // Limit scope pollution from any deprecated API (function() {</p>

<p>var matched, browser;</p>

<p>// Use of jQuery.browser is frowned upon. // More details: <a
href="http://api.jquery.com/jQuery.browser">api.jquery.com/jQuery.browser</a>
// jQuery.uaMatch maintained for back-compat jQuery.uaMatch = function( ua
) {</p>

<pre class="ruby"><span class="ruby-identifier">ua</span> = <span class="ruby-identifier">ua</span>.<span class="ruby-identifier">toLowerCase</span>();

<span class="ruby-identifier">var</span> <span class="ruby-identifier">match</span> = <span class="ruby-regexp">/(chrome)[ \/]([\w.]+)/</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">ua</span> ) <span class="ruby-operator">||</span>
        <span class="ruby-regexp">/(webkit)[ \/]([\w.]+)/</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">ua</span> ) <span class="ruby-operator">||</span>
        <span class="ruby-regexp">/(opera)(?:.*version|)[ \/]([\w.]+)/</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">ua</span> ) <span class="ruby-operator">||</span>
        <span class="ruby-regexp">/(msie) ([\w.]+)/</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">ua</span> ) <span class="ruby-operator">||</span>
        <span class="ruby-identifier">ua</span>.<span class="ruby-identifier">indexOf</span>(<span class="ruby-string">&quot;compatible&quot;</span>) <span class="ruby-operator">&lt;</span> <span class="ruby-value">0</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-regexp">/(mozilla)(?:.*? rv:([\w.]+)|)/</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">ua</span> ) <span class="ruby-operator">||</span>
        [];

<span class="ruby-keyword">return</span> {
        <span class="ruby-value">browser:</span> <span class="ruby-identifier">match</span>[ <span class="ruby-value">1</span> ] <span class="ruby-operator">||</span> <span class="ruby-string">&quot;&quot;</span>,
        <span class="ruby-value">version:</span> <span class="ruby-identifier">match</span>[ <span class="ruby-value">2</span> ] <span class="ruby-operator">||</span> <span class="ruby-string">&quot;0&quot;</span>
};
</pre>

<p>};</p>

<p>matched = jQuery.uaMatch( navigator.userAgent ); browser = {};</p>

<p>if ( matched.browser ) {</p>

<pre class="ruby"><span class="ruby-identifier">browser</span>[ <span class="ruby-identifier">matched</span>.<span class="ruby-identifier">browser</span> ] = <span class="ruby-keyword">true</span>;
<span class="ruby-identifier">browser</span>.<span class="ruby-identifier">version</span> = <span class="ruby-identifier">matched</span>.<span class="ruby-identifier">version</span>;
</pre>

<p>}</p>

<p>// Chrome is Webkit, but Webkit is also Safari. if ( browser.chrome ) {</p>

<pre class="ruby"><span class="ruby-identifier">browser</span>.<span class="ruby-identifier">webkit</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>} else if ( browser.webkit ) {</p>

<pre class="ruby"><span class="ruby-identifier">browser</span>.<span class="ruby-identifier">safari</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>}</p>

<p>jQuery.browser = browser;</p>

<p>jQuery.sub = function() {</p>

<pre>function jQuerySub( selector, context ) {
...
return jQuerySub;</pre>

<p>};</p>

<p>})(); var curCSS, iframe, iframeDoc,</p>
...
eventsToggle = jQuery.fn.toggle;</pre>
...
<p>function isHidden( elem, el ) {</p>

<pre class="ruby"><span class="ruby-identifier">elem</span> = <span class="ruby-identifier">el</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">elem</span>;
...
<p>// NOTE: To any future maintainer, we&#39;ve window.getComputedStyle //
because jsdom on node.js will break without it. if (
window.getComputedStyle ) {</p>

<pre>curCSS = function( elem, name ) {
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">matches</span> = <span class="ruby-identifier">rnumsplit</span>.<span class="ruby-identifier">exec</span>( <span class="ruby-identifier">value</span> );
<span class="ruby-keyword">return</span> <span class="ruby-identifier">matches</span> <span class="ruby-operator">?</span>
                <span class="ruby-constant">Math</span>.<span class="ruby-identifier">max</span>( <span class="ruby-value">0</span>, <span class="ruby-identifier">matches</span>[ <span class="ruby-value">1</span> ] <span class="ruby-operator">-</span> ( <span class="ruby-identifier">subtract</span> <span class="ruby-operator">||</span> <span class="ruby-value">0</span> ) ) <span class="ruby-operator">+</span> ( <span class="ruby-identifier">matches</span>[ <span class="ruby-value">2</span> ] <span class="ruby-operator">||</span> <span class="ruby-string">&quot;px&quot;</span> ) <span class="ruby-operator">:</span>
                <span class="ruby-identifier">value</span>;
</pre>

<p>}</p>

<p>function augmentWidthOrHeight( elem, name, extra, isBorderBox ) {</p>
...
<p>// Try to determine the default display value of an element function
css_defaultDisplay( nodeName ) {</p>
...
<p>// These hooks cannot be added until DOM ready because the support test //
for it is not run until after DOM ready jQuery(function() {</p>

<pre>if ( !jQuery.support.reliableMarginRight ) {
...
rselectTextarea = /^(?:select|textarea)/i;</pre>
...
<p>//Serialize an array of form elements or a set of //key/values into a query
string jQuery.param = function( a, traditional ) {</p>
...
<pre>var conv, conv2, current, tmp,
...
<pre class="ruby"><span class="ruby-identifier">rquestion</span> = <span class="ruby-regexp">/\?/</span>,
<span class="ruby-identifier">rjsonp</span> = <span class="ruby-regexp">/(=)\?(?=&amp;|$)|\?\?/</span>,
<span class="ruby-identifier">nonce</span> = <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">now</span>();
</pre>
...
<p>}); var xhrCallbacks,</p>

<pre>// #5280: Internet Explorer will keep connections alive if we don&#39;t abort on unload
...
<p>} var fxNow, timerId,</p>

<pre>rfxtypes = /^(?:toggle|show|hide)$/,
...
<p>function createTweens( animation, props ) {</p>

<pre>jQuery.each( props, function( prop, value ) {
...
<pre>var index, prop, value, length, dataShow, tween, hooks, oldfire,
        anim = this,
        style = elem.style,
        orig = {},
        handled = [],
...
<p>// Remove in 2.0 - this supports IE8&#39;s panic based approach // to
setting things on disconnected nodes</p>
...
<p>jQuery.timers = []; jQuery.fx = Tween.prototype.init; jQuery.fx.tick =
function() {</p>
...
<pre>if ( timer() &amp;&amp; jQuery.timers.push( timer ) &amp;&amp; !timerId ) {
...
<p>} var rroot = /^(?:body|html)$/i;</p>

<p>jQuery.fn.offset = function( options ) {</p>

<pre>if ( arguments.length ) {
...
<p>}); // Expose jQuery to the global object window.jQuery = window.$ =
jQuery;</p>
