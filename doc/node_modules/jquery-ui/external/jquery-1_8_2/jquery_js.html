...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.8.2/jquery.js">
...
<pre>!
 ...
 Date: Thu Sep 20 2012 21:13:05 GMT-0400 (Eastern Daylight Time)</pre>
...
// All others
return select( selector.replace( rtrim, &quot;$1&quot; ), context, results, seed, xml );</pre>
...
<p>// Returns a function to use in pseudos for positionals function
createPositionalPseudo( fn ) {</p>
...
<p>function tokenize( selector, parseOnly ) {</p>

<pre>var matched, match, tokens, type, soFar, groups, preFilters,
...
<p>compile = Sizzle.compile = function( selector, group /* Internal Use Only
*/ ) {</p>
...
<p>// Deprecated <a href=""nth"">Expr.pseudos</a> = <a
href=""eq"">Expr.pseudos</a>;</p>

<p>// Back-compat function setFilters() {} Expr.filters = setFilters.prototype
= Expr.pseudos; Expr.setFilters = new setFilters();</p>
