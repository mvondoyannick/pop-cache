...
<title>qunit-composite.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/external/qunit-composite/qunit-composite.js">

<pre>QUnit Composite v1.0.5-pre

https://github.com/JamesMGreene/qunit-composite

Copyright jQuery Foundation and other contributors
Released under the MIT license.
https://jquery.org/license/</pre>
...
<p>}(function( QUnit ) { var iframe, hasBound,</p>

<pre class="ruby"><span class="ruby-identifier">modules</span> = <span class="ruby-value">1</span>,
<span class="ruby-identifier">executingComposite</span> = <span class="ruby-keyword">false</span>;
</pre>

<p>function hasClass( elem, name ) {</p>
...
<p>function addClass( elem, name ) {</p>

<pre>if ( !hasClass( elem, name ) ) {
        elem.className += ( elem.className ? &quot; &quot; : &quot;&quot; ) + name;
}</pre>

<p>}</p>

<p>function addEvent( elem, type, fn ) {</p>

<pre>if ( elem.addEventListener ) {
...
iframeWin = iframe.contentWindow;</pre>

<p>}</p>

<p>/**</p>

<pre> @param {string} [name] Module name to group these test suites.
...
<p>QUnit.testSuites = function( name, suites ) {</p>
...
<p>QUnit.testDone(function( data ) {</p>

<pre>if ( !executingComposite ) {
        return;
}
...
current.getElementsByTagName( &quot;a&quot; )[ 0 ].href = src;</pre>
