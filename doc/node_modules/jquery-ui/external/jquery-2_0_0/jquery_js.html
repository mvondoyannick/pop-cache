...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-2.0.0/jquery.js">
...
through “use strict” call chains. (#13335) // Support: Firefox 18+ //“use
strict”; var</p>
...
<pre> For feature detection
 @param {Function} fn The function to test for native support
/</pre>

<p>function isNative( fn ) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rnative</span>.<span class="ruby-identifier">test</span>( <span class="ruby-identifier">fn</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;&quot;</span> );
</pre>
...
<pre>var doc = node ? node.ownerDocument || node : preferredDoc;
...
<p>// Fetches boolean attributes by node function boolHandler( elem, name,
isXML ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">val</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">isXML</span> <span class="ruby-operator">?</span>
        <span class="ruby-identifier">undefined</span> <span class="ruby-operator">:</span>
        (<span class="ruby-identifier">val</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getAttributeNode</span>( <span class="ruby-identifier">name</span> )) <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">val</span>.<span class="ruby-identifier">specified</span> <span class="ruby-operator">?</span>
                <span class="ruby-identifier">val</span>.<span class="ruby-identifier">value</span> <span class="ruby-operator">:</span>
                <span class="ruby-identifier">elem</span>[ <span class="ruby-identifier">name</span> ] <span class="ruby-operator">===</span> <span class="ruby-keyword">true</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">name</span>.<span class="ruby-identifier">toLowerCase</span>() <span class="ruby-operator">:</span> <span class="ruby-identifier">null</span>;
</pre>

<p>}</p>

<p>// Fetches attributes without interpolation // <a
...
function interpolationHandler( elem, name, isXML ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">val</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">isXML</span> <span class="ruby-operator">?</span>
        <span class="ruby-identifier">undefined</span> <span class="ruby-operator">:</span>
        (<span class="ruby-identifier">val</span> = <span class="ruby-identifier">elem</span>.<span class="ruby-identifier">getAttribute</span>( <span class="ruby-identifier">name</span>, <span class="ruby-identifier">name</span>.<span class="ruby-identifier">toLowerCase</span>() <span class="ruby-operator">===</span> <span class="ruby-string">&quot;type&quot;</span> <span class="ruby-operator">?</span> <span class="ruby-value">1</span> <span class="ruby-operator">:</span> <span class="ruby-value">2</span> ));
</pre>
...
<pre>// A counter to specify which element is currently being matched
...
<p>function select( selector, context, results, seed ) {</p>
...
passed to the comparison function [0, 0].sort( sortOrder );
support.detectDuplicates = hasDuplicate;</p>

<p>// Support: IE&lt;8 // Prevent attribute/property “interpolation”
assert(function( div ) {</p>
...
getAttribute lies assert(function( div ) {</p>

<pre>if ( div.getAttribute(&quot;disabled&quot;) != null ) {
...
<p>})( window ); // String to <a href="../../../../Object.html">Object</a>
...
<p>}); jQuery.support = (function( support ) {</p>
...
<p>var data_user, data_priv,</p>

<pre>rbrace = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
rmultiDash = /([A-Z])/g;</pre>

<p>function Data() {</p>

<pre>// Support: Android &lt; 4,
...
this.expando = jQuery.expando + Math.random();</pre>

<p>}</p>

<p>Data.uid = 1;</p>

<p>Data.accepts = function( owner ) {</p>
...
return owner.nodeType ?
        owner.nodeType === 1 || owner.nodeType === 9 : true;</pre>

<p>};</p>

<p>Data.prototype = {</p>

<pre>key: function( owner ) {
...
<p>// These may be used throughout the jQuery core codebase data_user = new
Data(); data_priv = new Data();</p>

<p>jQuery.extend({</p>

<pre>acceptData: Data.accepts,
...
<pre>rclass = /[\t\r\n]/g,
rreturn = /\r/g,
rfocusable = /^(?:input|select|textarea|button)$/i;</pre>
...
<p>}; jQuery.each( jQuery.expr.match.boolean.source.match( /w+/g ), function(
i, name ) {</p>

<pre>var getter = jQuery.expr.attrHandle[ name ] || jQuery.find.attr;
...
<p>// Support: IE9+ // Selectedness for an option in an optgroup can be
inaccurate if ( !jQuery.support.optSelected ) {</p>
...
<pre class="ruby"><span class="ruby-identifier">rmouseEvent</span> = <span class="ruby-regexp">/^(?:mouse|contextmenu)|click/</span>,
...
<pre>if ( elem.removeEventListener ) {
...
// Support: Chrome 15+ jQuery.each({</p>
...
<p>// Create “bubbling” focus and blur events // Support: Firefox, Chrome,
Safari if ( !jQuery.support.focusinBubbles ) {</p>
...
<pre>rneedsContext = jQuery.expr.match.needsContext,
...
<p>} var rxhtmlTag = /&lt;(?!<a
href="\w:">area|br|col|embed|hr|img|input|link|meta|param)((</a>+)[^&gt;]*)/&gt;/gi,</p>
...
<p>// Support: IE 9 wrapMap.optgroup = wrapMap.option;</p>

<p>wrapMap.tbody = wrapMap.tfoot = wrapMap.colgroup = wrapMap.caption =
wrapMap.col = wrapMap.thead; wrapMap.th = wrapMap.td;</p>
...
<p>// Support: 1.x compatibility // Manipulating tables requires a tbody
function manipulationTarget( elem, content ) {</p>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">ret</span> = <span class="ruby-identifier">context</span>.<span class="ruby-identifier">getElementsByTagName</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">context</span>.<span class="ruby-identifier">getElementsByTagName</span>( <span class="ruby-identifier">tag</span> <span class="ruby-operator">||</span> <span class="ruby-string">&quot;*&quot;</span> ) <span class="ruby-operator">:</span>
                <span class="ruby-identifier">context</span>.<span class="ruby-identifier">querySelectorAll</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">context</span>.<span class="ruby-identifier">querySelectorAll</span>( <span class="ruby-identifier">tag</span> <span class="ruby-operator">||</span> <span class="ruby-string">&quot;*&quot;</span> ) <span class="ruby-operator">:</span>
                [];

<span class="ruby-keyword">return</span> <span class="ruby-identifier">tag</span> <span class="ruby-operator">===</span> <span class="ruby-identifier">undefined</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">tag</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">nodeName</span>( <span class="ruby-identifier">context</span>, <span class="ruby-identifier">tag</span> ) <span class="ruby-operator">?</span>
        <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">merge</span>( [ <span class="ruby-identifier">context</span> ], <span class="ruby-identifier">ret</span> ) <span class="ruby-operator">:</span>
        <span class="ruby-identifier">ret</span>;
</pre>

<p>}</p>

<p>// Support: IE &gt;= 9 function fixInput( src, dest ) {</p>
...
<p>}); var curCSS, iframe,</p>

<pre>// swappable if display is none or starts with table except &quot;table&quot;, &quot;table-cell&quot;, or &quot;table-caption&quot;
...
elem = el || elem;
return jQuery.css( elem, &quot;display&quot; ) === &quot;none&quot; || !jQuery.contains( elem.ownerDocument, elem );</pre>

<p>}</p>

<p>// NOTE: we&#39;ve included the “window” in window.getComputedStyle //
because jsdom on node.js will break without it. function getStyles( elem )
{</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">window</span>.<span class="ruby-identifier">getComputedStyle</span>( <span class="ruby-identifier">elem</span>, <span class="ruby-identifier">null</span> );
</pre>
...
<p>curCSS = function( elem, name, _computed ) {</p>

<pre>var width, minWidth, maxWidth,
...
<p>// Called ONLY from within css_defaultDisplay function actualDisplay( name,
doc ) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">elem</span> = <span class="ruby-identifier">jQuery</span>( <span class="ruby-identifier">doc</span>.<span class="ruby-identifier">createElement</span>( <span class="ruby-identifier">name</span> ) ).<span class="ruby-identifier">appendTo</span>( <span class="ruby-identifier">doc</span>.<span class="ruby-identifier">body</span> ),
        <span class="ruby-identifier">display</span> = <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">css</span>( <span class="ruby-identifier">elem</span>[<span class="ruby-value">0</span>], <span class="ruby-string">&quot;display&quot;</span> );
<span class="ruby-identifier">elem</span>.<span class="ruby-identifier">remove</span>();
<span class="ruby-keyword">return</span> <span class="ruby-identifier">display</span>;
</pre>
...
<pre>jQuery.expr.filters.hidden = function( elem ) {
        // Support: Opera &lt;= 12.12
...
<p>} jQuery.each( (“blur focus focusin focusout load resize scroll unload
click dblclick ” +</p>
...
<p>var xhrSupported = jQuery.ajaxSettings.xhr(),</p>

<pre>xhrSuccessStatus = {
...
<p>jQuery.support.cors = !!xhrSupported &amp;&amp; ( “withCredentials” in
xhrSupported ); jQuery.support.ajax = xhrSupported = !!xhrSupported;</p>
...
<pre>if ( timer() &amp;&amp; jQuery.timers.push( timer ) ) {
        jQuery.fx.start();
}</pre>
...
<p>// })(); if ( typeof module === “object” &amp;&amp; typeof module.exports
=== “object” ) {</p>

<pre>// Expose jQuery as module.exports in loaders that implement the Node
// module pattern (including browserify). Do not create the global, since
// the user will be storing it themselves locally, and globals are frowned
// upon in the Node module world.
module.exports = jQuery;</pre>

<p>} else {</p>

<pre>// Register as a named AMD module, since jQuery can be concatenated with other
...
<p>// If there is a window object, that at least has a document property, //
define jQuery and $ identifiers if ( typeof window === “object” &amp;&amp;
typeof window.document === “object” ) {</p>
