...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-1.12.0/jquery.js">
...
(#13335) //“use strict”; var deletedIds = [];</p>
...
JSHint for these // three lines. /* jshint ignore: start */ if ( typeof
Symbol === “function” ) {</p>

<pre class="ruby"><span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">fn</span>[ <span class="ruby-constant">Symbol</span>.<span class="ruby-identifier">iterator</span> ] = <span class="ruby-identifier">deletedIds</span>[ <span class="ruby-constant">Symbol</span>.<span class="ruby-identifier">iterator</span> ];
</pre>
...
<p>} )(); var acceptData = function( elem ) {</p>
...
<p>var nodeNames = “abbr|article|aside|audio|bdi|canvas|data|datalist|” +</p>

<pre class="ruby"><span class="ruby-string">&quot;details|dialog|figcaption|figure|footer|header|hgroup|main|&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot;mark|meter|nav|output|picture|progress|section|summary|template|time|video&quot;</span>;
</pre>
...
support.attributes = !div.getAttribute( jQuery.expando );</pre>

<p>} )();</p>

<p>// We have to close these tags to support XHTML (#13200) var wrapMap = {</p>

<pre>option: [ 1, &quot;&lt;select multiple=&#39;multiple&#39;&gt;&quot;, &quot;&lt;/select&gt;&quot; ],
...
_default: support.htmlSerialize ? [ 0, &quot;&quot;, &quot;&quot; ] : [ 1, &quot;X&lt;div&gt;&quot;, &quot;&lt;/div&gt;&quot; ]</pre>

<p>};</p>

<p>// Support: IE8-IE9 wrapMap.optgroup = wrapMap.option;</p>
...
<pre class="ruby"><span class="ruby-identifier">rtbody</span> = <span class="ruby-regexp">/&lt;tbody/i</span>;
</pre>

<p>function fixDefaultChecked( elem ) {</p>
...
<p>// IE submit delegation if ( !support.submit ) {</p>
...
<p>// IE change delegation and checkbox/radio fix if ( !support.change ) {</p>
...
<p>var rinlinejQuery = / jQueryd+=“(?:null|d+)”/g,</p>

<pre>rnoshimcache = new RegExp( &quot;&lt;(?:&quot; + nodeNames + &quot;)[\\s/&gt;]&quot;, &quot;i&quot; ),
...
<pre>var pixelPositionVal, pixelMarginRightVal, boxSizingReliableVal,
...
<p>} else if ( documentElement.currentStyle ) {</p>
...
<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">jQuery</span>.<span class="ruby-identifier">attr</span>( <span class="ruby-identifier">elem</span>, <span class="ruby-string">&quot;class&quot;</span> ) <span class="ruby-operator">||</span> <span class="ruby-string">&quot;&quot;</span>;
</pre>
...
/
     ...
     ajaxLocParts = rurl.exec( ajaxLocation.toLowerCase() ) || [];</pre>
...
(#5280) // See <a
href="https://support.microsoft.com/kb/2856746">support.microsoft.com/kb/2856746</a>
for more info if ( window.attachEvent ) {</p>

<pre>window.attachEvent( &quot;onunload&quot;, function() {
...
<pre>if ( !document.implementation.createHTMLDocument ) {
        return false;
}
var doc = document.implementation.createHTMLDocument( &quot;&quot; );
doc.body.innerHTML = &quot;&lt;form&gt;&lt;/form&gt;&lt;form&gt;&lt;/form&gt;&quot;;
return doc.body.childNodes.length === 2;</pre>
