...
<title>jquery.simulate.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery-ui/external/jquery-simulate/jquery.simulate.js">
...
<p>$.fn.simulate = function( type, options ) {</p>
...
<p>$.simulate = function( elem, type, options ) {</p>

<pre>var method = $.camelCase( &quot;simulate-&quot; + type );
...
<p>$.extend( $.simulate.prototype, {</p>

<pre>simulateEvent: function( elem, type, options ) {
...
<pre class="ruby"><span class="ruby-identifier">complex</span> <span class="ruby-identifier">events</span>
</pre>

<p>function findCenter( elem ) {</p>
