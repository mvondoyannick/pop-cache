...
<title>gulpfile.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/gulpfile.js">

<p>var gulp = require(&#39;gulp&#39;); var concat =
require(&#39;gulp-concat&#39;); var connect =
require(&#39;gulp-connect&#39;); var eslint =
require(&#39;gulp-eslint&#39;); var file = require(&#39;gulp-file&#39;);
var insert = require(&#39;gulp-insert&#39;); var replace =
require(&#39;gulp-replace&#39;); var size = require(&#39;gulp-size&#39;);
var streamify = require(&#39;gulp-streamify&#39;); var uglify =
require(&#39;gulp-uglify&#39;); var util = require(&#39;gulp-util&#39;);
var zip = require(&#39;gulp-zip&#39;); var exec =
require(&#39;child-process-promise&#39;).exec; var karma =
require(&#39;karma&#39;); var browserify = require(&#39;browserify&#39;);
var source = require(&#39;vinyl-source-stream&#39;); var merge =
require(&#39;merge-stream&#39;); var collapse =
require(&#39;bundle-collapser/plugin&#39;); var yargs =
require(&#39;yargs&#39;); var path = require(&#39;path&#39;); var fs =
require(&#39;fs&#39;); var htmllint = require(&#39;gulp-htmllint&#39;); var
pkg = require(&#39;./package.json&#39;);</p>

<p>var argv = yargs</p>

<pre>.option(&#39;force-output&#39;, {default: false})
.option(&#39;silent-errors&#39;, {default: false})
.option(&#39;verbose&#39;, {default: false})
.argv</pre>

<p>var srcDir = &#39;./src/&#39;; var outDir = &#39;./dist/&#39;;</p>

<p>var header = “  !n” +</p>

<pre class="ruby"><span class="ruby-string">&quot; * Chart.js\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot; * http://chartjs.org/\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot; * Version: {{ version }}\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot; *\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot; * Copyright &quot;</span> <span class="ruby-operator">+</span> (<span class="ruby-identifier">new</span> <span class="ruby-constant">Date</span>().<span class="ruby-identifier">getFullYear</span>()) <span class="ruby-operator">+</span> <span class="ruby-string">&quot; Chart.js Contributors\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot; * Released under the MIT license\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot; * https://github.com/chartjs/Chart.js/blob/master/LICENSE.md\n&quot;</span> <span class="ruby-operator">+</span>
<span class="ruby-string">&quot;   \n&quot;</span>;
</pre>

<p>if (argv.verbose) {</p>

<pre class="ruby"><span class="ruby-identifier">util</span>.<span class="ruby-identifier">log</span>(<span class="ruby-string">&quot;Gulp running with options: &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>(<span class="ruby-identifier">argv</span>, <span class="ruby-identifier">null</span>, <span class="ruby-value">2</span>));
</pre>

<p>}</p>

<p>gulp.task(&#39;bower&#39;, bowerTask); gulp.task(&#39;build&#39;,
buildTask); gulp.task(&#39;package&#39;, packageTask);
gulp.task(&#39;watch&#39;, watchTask); gulp.task(&#39;lint&#39;,
[&#39;lint-html&#39;, &#39;lint-js&#39;]); gulp.task(&#39;lint-html&#39;,
lintHtmlTask); gulp.task(&#39;lint-js&#39;, lintJsTask);
gulp.task(&#39;docs&#39;, docsTask); gulp.task(&#39;test&#39;,
[&#39;lint&#39;, &#39;unittest&#39;]); gulp.task(&#39;size&#39;,
[&#39;library-size&#39;, &#39;module-sizes&#39;]);
gulp.task(&#39;server&#39;, serverTask); gulp.task(&#39;unittest&#39;,
unittestTask); gulp.task(&#39;library-size&#39;, librarySizeTask);
gulp.task(&#39;module-sizes&#39;, moduleSizesTask);
gulp.task(&#39;_open&#39;, _openTask); gulp.task(&#39;dev&#39;,
[&#39;server&#39;, &#39;default&#39;]); gulp.task(&#39;default&#39;,
[&#39;build&#39;, &#39;watch&#39;]);</p>

<pre> Generates the bower.json manifest file which will be pushed along release tags.
 Specs: https://github.com/bower/spec/blob/master/json.md
/</pre>

<p>function bowerTask() {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">json</span> = <span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>({
    <span class="ruby-value">name:</span> <span class="ruby-identifier">pkg</span>.<span class="ruby-identifier">name</span>,
    <span class="ruby-value">description:</span> <span class="ruby-identifier">pkg</span>.<span class="ruby-identifier">description</span>,
    <span class="ruby-value">homepage:</span> <span class="ruby-identifier">pkg</span>.<span class="ruby-identifier">homepage</span>,
    <span class="ruby-value">license:</span> <span class="ruby-identifier">pkg</span>.<span class="ruby-identifier">license</span>,
    <span class="ruby-value">version:</span> <span class="ruby-identifier">pkg</span>.<span class="ruby-identifier">version</span>,
    <span class="ruby-value">main:</span> <span class="ruby-identifier">outDir</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;Chart.js&quot;</span>,
    <span class="ruby-value">ignore:</span> [
      <span class="ruby-string">&#39;.github&#39;</span>,
      <span class="ruby-string">&#39;.codeclimate.yml&#39;</span>,
      <span class="ruby-string">&#39;.gitignore&#39;</span>,
      <span class="ruby-string">&#39;.npmignore&#39;</span>,
      <span class="ruby-string">&#39;.travis.yml&#39;</span>,
      <span class="ruby-string">&#39;scripts&#39;</span>
    ]
  }, <span class="ruby-identifier">null</span>, <span class="ruby-value">2</span>);

<span class="ruby-keyword">return</span> <span class="ruby-identifier">file</span>(<span class="ruby-string">&#39;bower.json&#39;</span>, <span class="ruby-identifier">json</span>, { <span class="ruby-value">src:</span> <span class="ruby-keyword">true</span> })
...
<p>function buildTask() {</p>

<pre>var errorHandler = function (err) {
  if(argv.forceOutput) {
...
return merge(bundled, nonBundled);</pre>

<p>}</p>

<p>function packageTask() {</p>
...
.pipe(gulp.dest(outDir));</pre>

<p>}</p>

<p>function lintJsTask() {</p>
...
return gulp.src(files)
  .pipe(eslint(options))
  .pipe(eslint.format())
  .pipe(eslint.failAfterError());</pre>

<p>}</p>

<p>function lintHtmlTask() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;samples/**/*.html&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">htmllint</span>({
    <span class="ruby-value">failOnError:</span> <span class="ruby-keyword">true</span>,
  }));
</pre>

<p>}</p>

<p>function docsTask(done) {</p>

<pre>const script = require.resolve(&#39;gitbook-cli/bin/gitbook.js&#39;);
...
<pre class="ruby"><span class="ruby-keyword">return</span> [
  {<span class="ruby-value">pattern:</span> <span class="ruby-string">&#39;./test/fixtures/**/*.json&#39;</span>, <span class="ruby-value">included:</span> <span class="ruby-keyword">false</span>},
  {<span class="ruby-value">pattern:</span> <span class="ruby-string">&#39;./test/fixtures/**/*.png&#39;</span>, <span class="ruby-value">included:</span> <span class="ruby-keyword">false</span>},
  <span class="ruby-string">&#39;./node_modules/moment/min/moment.min.js&#39;</span>,
  <span class="ruby-string">&#39;./test/jasmine.index.js&#39;</span>,
  <span class="ruby-string">&#39;./src/**/*.js&#39;</span>,
].<span class="ruby-identifier">concat</span>(
  <span class="ruby-identifier">argv</span>.<span class="ruby-identifier">inputs</span> <span class="ruby-operator">?</span>
    <span class="ruby-identifier">argv</span>.<span class="ruby-identifier">inputs</span>.<span class="ruby-identifier">split</span>(<span class="ruby-string">&#39;;&#39;</span>) <span class="ruby-operator">:</span>
    [<span class="ruby-string">&#39;./test/specs/**/*.js&#39;</span>]
);
</pre>

<p>}</p>

<p>function unittestTask(done) {</p>

<pre>new karma.Server({
...
<p>function librarySizeTask() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-string">&#39;dist/Chart.bundle.min.js&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">size</span>({
    <span class="ruby-value">gzip:</span> <span class="ruby-keyword">true</span>
  }));
</pre>

<p>}</p>

<p>function moduleSizesTask() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>(<span class="ruby-identifier">srcDir</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;**/*.js&#39;</span>)
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">uglify</span>())
  .<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">size</span>({
    <span class="ruby-value">showFiles:</span> <span class="ruby-keyword">true</span>,
    <span class="ruby-value">gzip:</span> <span class="ruby-keyword">true</span>
  }));
</pre>
...
<p>function watchTask() {</p>

<pre>if (util.env.test) {
  return gulp.watch(&#39;./src/**&#39;, [&#39;build&#39;, &#39;unittest&#39;, &#39;unittestWatch&#39;]);
}
return gulp.watch(&#39;./src/**&#39;, [&#39;build&#39;]);</pre>

<p>}</p>

<p>function serverTask() {</p>

<pre class="ruby"><span class="ruby-identifier">connect</span>.<span class="ruby-identifier">server</span>({
  <span class="ruby-value">port:</span> <span class="ruby-value">8000</span>
});
</pre>

<p>}</p>

<p>// Convenience task for opening the project straight from the command line</p>

<p>function _openTask() {</p>

<pre class="ruby"><span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;open http://localhost:8000&#39;</span>);
<span class="ruby-identifier">exec</span>(<span class="ruby-string">&#39;subl .&#39;</span>);
</pre>
