...
<title>MAINTAINING - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Maintaining">Maintaining</a>
    <li><a href="#label-Release+Process">Release Process</a>
    <li><a href="#label-Releasing+a+New+Version">Releasing a New Version</a>
    <li><a href="#label-Automated+Tasks">Automated Tasks</a>
...
<main role="main" aria-label="Page node_modules/chart.js/MAINTAINING.md">

<h1 id="label-Maintaining">Maintaining<span><a href="#label-Maintaining">&para;</a> <a href="#top">&uarr;</a></span></h1>

<h2 id="label-Release+Process">Release Process<span><a href="#label-Release+Process">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Chart.js relies on <a href="https://travis-ci.org/">Travis CI</a> to
automate the library <a
href="https://github.com/chartjs/Chart.js/releases">releases</a>.</p>

<h3 id="label-Releasing+a+New+Version">Releasing a New Version<span><a href="#label-Releasing+a+New+Version">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ol><li>
<p>draft release notes on <a
href="https://github.com/chartjs/Chart.js/releases/new">GitHub</a> for the
upcoming tag</p>
</li><li>
<p>update <code>master</code> <code>package.json</code> version using <a
href="http://semver.org/">semver</a> semantic</p>
</li><li>
<p>merge <code>master</code> into the <code>release</code> branch</p>
</li><li>
<p>follow the build process on <a
href="https://travis-ci.org/chartjs/Chart.js">Travis CI</a></p>
</li></ol>

<blockquote>
<p><strong>Note:</strong> if <code>master</code> is merged in
<code>release</code> with a <code>package.json</code> version that already
exists, the tag creation fails and the release process is aborted.</p>
</blockquote>

<h3 id="label-Automated+Tasks">Automated Tasks<span><a href="#label-Automated+Tasks">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Merging into the <code>release</code> branch kicks off the automated
release process:</p>
<ul><li>
<p>build of the <code>dist/*.js</code> files</p>
</li><li>
<p><code>bower.json</code> is generated from <code>package.json</code></p>
</li><li>
<p><code>dist/*.js</code> and <code>bower.json</code> are added to a detached
branch</p>
</li><li>
<p>a tag is created from the <code>package.json</code> version</p>
</li><li>
<p>tag (with dist files) is pushed to GitHub</p>
</li></ul>

<p>Creation of this tag triggers a new build:</p>
<ul><li>
<p><code>Chart.js.zip</code> package is generated, containing dist files and
examples</p>
</li><li>
<p><code>dist/*.js</code> and <code>Chart.js.zip</code> are attached to the
GitHub release (downloads)</p>
</li><li>
<p>a new npm package is published on <a
href="https://www.npmjs.com/package/chart.js">npmjs</a></p>
</li></ul>

<p>Finally, <a href="https://cdnjs.com/libraries/Chart.js">cdnjs</a> is
automatically updated from the npm release.</p>

<h3 id="label-Further+Reading">Further Reading<span><a href="#label-Further+Reading">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><a href="https://github.com/chartjs/Chart.js/pull/2555">Travis GitHub
releases</a></p>
</li><li>
<p><a href="https://github.com/chartjs/Chart.js/issues/3033">Bower support and
dist/* files</a></p>
</li><li>
<p><a href="https://github.com/cdnjs/cdnjs/pull/8401">cdnjs npm auto
update</a></p>
</li></ul>
</main>
