...
<title>bubble - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/bubble.md">

<h1 id="label-Bubble+Chart">Bubble Chart<span><a href="#label-Bubble+Chart">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>A bubble chart is used to display three dimensions of data at the same
...
<p>{% chartjs %} {  “type”: “bubble”,  “data”: {  “datasets”: [{ “label”:
“First Dataset”, “data”: [{ “x”: 20, “y”: 30, “r”: 15 }, { “x”: 40, “y”:
10, “r”: 10 }], “backgroundColor”: “rgb(255, 99, 132)” }]  }, } {%
endchartjs %}</p>

<h2 id="label-Example+Usage">Example Usage<span><a href="#label-Example+Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>// For a bubble chart
...
<p>The bubble chart allows a number of properties to be specified for each
dataset. These are used to set display properties for a specific dataset.
For example, the colour of the bubbles is generally set this way.</p>

<p>| Name | Type | <a
href="../general/options.md#scriptable-options">Scriptable</a> | <a
href="../general/options.md#indexable-options">Indexable</a> | Default | —-
| —- | :—-: | :—-: | —- | <a href="#styling">backgroundColor</a> | <a
href="../general/colors.md">Color</a> | Yes | Yes |
<code>&#39;rgba(0,0,0,0.1)&#39;</code> | <a href="#styling">borderColor</a>
| <a href="../general/colors.md">Color</a> | Yes | Yes |
<code>&#39;rgba(0,0,0,0.1)&#39;</code> | <a href="#styling">borderWidth</a>
| <code>Number</code> | Yes | Yes | <code>3</code> | <a
href="#data-structure">data</a> | <code>Object[]</code> | - | - |
<strong>required</strong> | <a
href="#interactions">hoverBackgroundColor</a> | <a
href="../general/colors.md">Color</a> | Yes | Yes | <code>undefined</code>
| <a href="#interactions">hoverBorderColor</a> | <a
href="../general/colors.md">Color</a> | Yes | Yes | <code>undefined</code>
| <a href="#interactions">hoverBorderWidth</a> | <code>Number</code> | Yes
| Yes | <code>1</code> | <a href="#interactions">hoverRadius</a> |
<code>Number</code> | Yes | Yes | <code>4</code> | <a
href="#interactions">hitRadius</a> | <code>Number</code> | Yes | Yes |
<code>1</code> | <a href="#labeling">label</a> | <code>String</code> | - |
- | <code>undefined</code> | <a href="#styling">pointStyle</a> |
<code>String</code> | Yes | Yes | <code>circle</code> | <a
href="#styling">rotation</a> | <code>Number</code> | Yes | Yes |
<code>0</code> | <a href="#styling">radius</a> | <code>Number</code> | Yes
| Yes | <code>3</code></p>

<h3 id="label-Labeling">Labeling<span><a href="#label-Labeling">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p><code>label</code> defines the text associated to the dataset and which
appears in the legend and tooltips.</p>

<h3 id="label-Styling">Styling<span><a href="#label-Styling">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The style of each bubble can be controlled with the following properties:</p>

<p>| Name | Description | —- | —- | <code>backgroundColor</code> | bubble
background color | <code>borderColor</code> | bubble border color |
<code>borderWidth</code> | bubble border width (in pixels) |
<code>pointStyle</code> | bubble <a
href="../configuration/elements#point-styles">shape style</a> |
<code>rotation</code> | bubble rotation (in degrees) | <code>radius</code>
| bubble radius (in pixels)</p>

<p>All these values, if <code>undefined</code>, fallback to the associated <a
href="../configuration/elements.md#point-configuration">elements.point.*</a>
options.</p>

<h3 id="label-Interactions">Interactions<span><a href="#label-Interactions">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The interaction with each bubble can be controlled with the following
properties:</p>

<p>| Name | Description | —- | ———– | <code>hoverBackgroundColor</code> |
bubble background color when hovered | <code>hoverBorderColor</code> |
bubble border color hovered | <code>hoverBorderWidth</code> | bubble border
width when hovered (in pixels) | <code>hoverRadius</code> | bubble
<strong>additional</strong> radius when hovered (in pixels) |
<code>hitRadius</code> | bubble <strong>additional</strong> radius for hit
detection (in pixels)</p>
...
<p>We can also change the default values for the Bubble chart type. Doing so
will give all bubble charts created after this point the new defaults. The
default configuration for the bubble chart can be accessed at
<code>Chart.defaults.bubble</code>.</p>

<h2 id="label-Data+Structure">Data Structure<span><a href="#label-Data+Structure">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Bubble chart datasets need to contain a <code>data</code> array of points,
each points represented by an object containing the following properties:</p>
...
<strong>not</strong> scaled by the chart, it is the raw radius in pixels of
the bubble that is drawn on the canvas.</p>
</main>
