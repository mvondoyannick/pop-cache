...
<title>doughnut - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Doughnut+and+Pie">Doughnut and Pie</a>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/doughnut.md">

<h1 id="label-Doughnut+and+Pie">Doughnut and Pie<span><a href="#label-Doughnut+and+Pie">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Pie and doughnut charts are probably the most commonly used charts. They
are divided into segments, the arc of each segment shows the proportional
value of each piece of data.</p>
...
have one different default value - their <code>cutoutPercentage</code>.
This equates what percentage of the inner should be cut out. This defaults
to <code>0</code> for pie charts, and <code>50</code> for doughnuts.</p>

<p>They are also registered under two aliases in the <code>Chart</code> core.
Other than their different default value, and different alias, they are
exactly the same.</p>

<p>{% chartjs %} {  “type”: “doughnut”,  “data”: {  “labels”: [ “Red”, “Blue”,
“Yellow”, ],  “datasets”: [{ “label”: “My First Dataset”, “data”: [300, 50,
100], “backgroundColor”: [ “rgb(255, 99, 132)”, “rgb(54, 162, 235)”,
“rgb(255, 205, 86)”, ] }]  }, } {% endchartjs %}</p>
...
<p>The doughnut/pie chart allows a number of properties to be specified for
each dataset. These are used to set display properties for a specific
dataset. For example, the colour of a the dataset&#39;s arc are generally
set this way.</p>

<p>| Name | Type | Description | —- | —- | ———– | <code>backgroundColor</code>
| <code>Color[]</code> | The fill color of the arcs in the dataset. See <a
href="../general/colors.md#colors">Colors</a> | <code>borderColor</code> |
<code>Color[]</code> | The border color of the arcs in the dataset. See <a
href="../general/colors.md#colors">Colors</a> | <code>borderWidth</code> |
<code>Number[]</code> | The border width of the arcs in the dataset. |
<code>hoverBackgroundColor</code> | <code>Color[]</code> | The fill colour
of the arcs when hovered. | <code>hoverBorderColor</code> |
<code>Color[]</code> | The stroke colour of the arcs when hovered. |
<code>hoverBorderWidth</code> | <code>Number[]</code> | The stroke width of
the arcs when hovered.</p>

<h2 id="label-Config+Options">Config Options<span><a href="#label-Config+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>These are the customisation options specific to Pie &amp; Doughnut charts.
These options are merged with the global chart configuration options, and
form the options of the chart.</p>

<p>| Name | Type | Default | Description | —- | —- | ——- | ———– |
<code>cutoutPercentage</code> | <code>Number</code> | <code>50</code> - for
doughnut, <code>0</code> - for pie | The percentage of the chart that is
cut out of the middle. | <code>rotation</code> | <code>Number</code> |
<code>-0.5 * Math.PI</code> | Starting angle to draw arcs from. |
<code>circumference</code> | <code>Number</code> | <code>2 * Math.PI</code>
| Sweep to allow arcs to cover | <code>animation.animateRotate</code> |
<code>Boolean</code> | <code>true</code> | If true, the chart will animate
in with a rotation animation. This property is in the
<code>options.animation</code> object. |
<code>animation.animateScale</code> | <code>Boolean</code> |
<code>false</code> | If true, will animate scaling the chart from the
center outwards.</p>

<h2 id="label-Default+Options">Default Options<span><a href="#label-Default+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>We can also change these default values for each Doughnut type that is
created, this object is available at <code>Chart.defaults.doughnut</code>.
Pie charts also have a clone of these defaults available to change at
<code>Chart.defaults.pie</code>, with the only difference being
<code>cutoutPercentage</code> being set to 0.</p>

<h2 id="label-Data+Structure">Data Structure<span><a href="#label-Data+Structure">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>For a pie chart, datasets need to contain an array of data points. The data
points should be a number, Chart.js will total all of the numbers and
calculate the relative proportion of each.</p>

<p>You also need to specify an array of labels so that tooltips appear
correctly</p>
