...
<title>area - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Area+Charts">Area Charts</a>
    <li><a href="#label-Filling+modes">Filling modes</a>
    <li><a href="#label-Configuration">Configuration</a>
    <li><a href="#label-propagate">propagate</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/area.md">

<h1 id="label-Area+Charts">Area Charts<span><a href="#label-Area+Charts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Both <a href="line.md">line</a> and <a href="radar.md">radar</a> charts
support a <code>fill</code> option on the dataset object which can be used
to create area between two datasets or a dataset and a boundary, i.e. the
scale <code>origin</code>, <code>start</code> or <code>end</code> (see <a
href="#filling-modes">filling modes</a>).</p>

<blockquote>
<p><strong>Note:</strong> this feature is implemented by the <a
href="https://github.com/chartjs/Chart.js/blob/master/src/plugins/plugin.filler.js">filler
plugin</a>.</p>
</blockquote>

<h2 id="label-Filling+modes">Filling modes<span><a href="#label-Filling+modes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>| Mode | Type | Values | | :— | :— | :— | | Absolute dataset index
&lt;sup&gt;1&lt;/sup&gt; | <code>Number</code> | <code>1</code>,
<code>2</code>, <code>3</code>, … | | Relative dataset index
&lt;sup&gt;1&lt;/sup&gt; | <code>String</code> | <code>&#39;-1&#39;</code>,
<code>&#39;-2&#39;</code>, <code>&#39;+1&#39;</code>, … | | Boundary
&lt;sup&gt;2&lt;/sup&gt; | <code>String</code> |
<code>&#39;start&#39;</code>, <code>&#39;end&#39;</code>,
<code>&#39;origin&#39;</code> | | Disabled &lt;sup&gt;3&lt;/sup&gt; |
<code>Boolean</code> | <code>false</code> |</p>

<blockquote>
<p>&lt;sup&gt;1&lt;/sup&gt; dataset filling modes have been introduced in
version 2.6.0<br> &lt;sup&gt;2&lt;/sup&gt; prior version 2.6.0, boundary
values was <code>&#39;zero&#39;</code>, <code>&#39;top&#39;</code>,
<code>&#39;bottom&#39;</code> (deprecated)<br> &lt;sup&gt;3&lt;/sup&gt; for
backward compatibility, <code>fill: true</code> (default) is equivalent to
<code>fill: &#39;origin&#39;</code><br></p>
</blockquote>

<p><strong>Example</strong> <code>javascript new Chart(ctx, {     data: {     
datasets: [             {fill: &#39;origin&#39;},      // 0: fill to
&#39;origin&#39;             {fill: &#39;+2&#39;},          // 1: fill to
dataset 3             {fill: 1},             // 2: fill to dataset 1       
{fill: false},         // 3: no fill             {fill: &#39;-2&#39;}      
// 4: fill to dataset 2         ]     } }) </code></p>

<h2 id="label-Configuration">Configuration<span><a href="#label-Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>| Option | Type | Default | Description | | :— | :— | :— | :— | | <a
href="#propagate">plugins.filler.propagate</a> | <code>Boolean</code> |
<code>true</code> | Fill propagation when target is hidden</p>

<h3 id="label-propagate">propagate<span><a href="#label-propagate">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Boolean (default: <code>true</code>)</p>

<p>If <code>true</code>, the fill area will be recursively extended to the
visible target defined by the <code>fill</code> value of hidden dataset
targets:</p>

<p><strong>Example</strong> <code>javascript new Chart(ctx, {     data: {     
datasets: [             {fill: &#39;origin&#39;},   // 0: fill to
&#39;origin&#39;             {fill: &#39;-1&#39;},       // 1: fill to
dataset 0             {fill: 1},          // 2: fill to dataset 1          
{fill: false},      // 3: no fill             {fill: &#39;-2&#39;}       
// 4: fill to dataset 2         ]     },     options: {         plugins: { 
filler: {                 propagate: true             }         }     } })
</code></p>

<p><code>propagate: true</code>: - if dataset 2 is hidden, dataset 4 will fill
to dataset 1 - if dataset 2 and 1 are hidden, dataset 4 will fill to
<code>&#39;origin&#39;</code></p>

<p><code>propagate: false</code>: - if dataset 2 and/or 4 are hidden, dataset
4 will not be filled</p>
</main>
