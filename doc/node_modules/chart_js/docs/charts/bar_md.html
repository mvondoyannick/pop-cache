...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Bar">Bar</a>
    <li><a href="#label-Example+Usage">Example Usage</a>
    <li><a href="#label-Dataset+Properties">Dataset Properties</a>
    <li><a href="#label-borderSkipped">borderSkipped</a>
    <li><a href="#label-Configuration+Options">Configuration Options</a>
    <li><a href="#label-barThickness">barThickness</a>
    <li><a href="#label-offsetGridLines">offsetGridLines</a>
    <li><a href="#label-Default+Options">Default Options</a>
    <li><a href="#label-barPercentage+vs+categoryPercentage">barPercentage vs categoryPercentage</a>
    <li><a href="#label-Data+Structure">Data Structure</a>
    <li><a href="#label-Stacked+Bar+Chart">Stacked Bar Chart</a>
    <li><a href="#label-Dataset+Properties">Dataset Properties</a>
    <li><a href="#label-Horizontal+Bar+Chart">Horizontal Bar Chart</a>
    <li><a href="#label-Example">Example</a>
    <li><a href="#label-Config+Options">Config Options</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/bar.md">

<h1 id="label-Bar">Bar<span><a href="#label-Bar">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>A bar chart provides a way of showing data values represented as vertical
bars. It is sometimes used to show trend data, and the comparison of
multiple data sets side by side.</p>

<p>{% chartjs %} {  “type”: “bar”,  “data”: {  “labels”: [ “January”,
“February”, “March”, “April”, “May”, “June”, “July” ],  “datasets”: [{
“label”: “My First Dataset”, “data”: [65, 59, 80, 81, 56, 55, 40], “fill”:
false, “backgroundColor”: [ “rgba(255, 99, 132, 0.2)”, “rgba(255, 159, 64,
0.2)”, “rgba(255, 205, 86, 0.2)”, “rgba(75, 192, 192, 0.2)”, “rgba(54, 162,
235, 0.2)”, “rgba(153, 102, 255, 0.2)”, “rgba(201, 203, 207, 0.2)” ],
“borderColor”: [ “rgb(255, 99, 132)”, “rgb(255, 159, 64)”, “rgb(255, 205,
86)”, “rgb(75, 192, 192)”, “rgb(54, 162, 235)”, “rgb(153, 102, 255)”,
“rgb(201, 203, 207)” ], “borderWidth”: 1 }]  },  “options”: {  “scales”: { 
“yAxes”: [{ “ticks”: { “beginAtZero”: true } }]  }  } } {% endchartjs %}</p>

<h2 id="label-Example+Usage">Example Usage<span><a href="#label-Example+Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre>var myBarChart = new Chart(ctx, {
    type: &#39;bar&#39;,
    data: data,
    options: options
});</pre>
...
<p>The bar chart allows a number of properties to be specified for each
dataset. These are used to set display properties for a specific dataset.
For example, the colour of the bars is generally set this way.</p>

<p>Some properties can be specified as an array. If these are set to an array
value, the first value applies to the first bar, the second value to the
...
<code>backgroundColor</code> | <code>Color/Color[]</code> | The fill color
of the bar. See <a href="../general/colors.md#colors">Colors</a> |
<code>borderColor</code> | <code>Color/Color[]</code> | The color of the
bar border. See <a href="../general/colors.md#colors">Colors</a> |
<code>borderWidth</code> | <code>Number/Number[]</code> | The stroke width
of the bar in pixels. | <code>borderSkipped</code> | <code>String</code> |
Which edge to skip drawing the border for. <a
href="#borderskipped">more…</a> | <code>hoverBackgroundColor</code> |
<code>Color/Color[]</code> | The fill colour of the bars when hovered. |
<code>hoverBorderColor</code> | <code>Color/Color[]</code> | The stroke
colour of the bars when hovered. | <code>hoverBorderWidth</code> |
<code>Number/Number[]</code> | The stroke width of the bars when hovered.</p>

<h3 id="label-borderSkipped">borderSkipped<span><a href="#label-borderSkipped">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>This setting is used to avoid drawing the bar stroke at the base of the
fill. In general, this does not need to be changed except when creating
chart types that derive from a bar chart.</p>

<p>Options are: * &#39;bottom&#39; * &#39;left&#39; * &#39;top&#39; *
&#39;right&#39;</p>
...
<p>The bar chart defines the following configuration options. These options
...
<code>barPercentage</code> | <code>Number</code> | <code>0.9</code> |
Percent (0-1) of the available width each bar should be within the category
width. 1.0 will take the whole category width and put the bars right next
to each other. <a href="#barpercentage-vs-categorypercentage">more…</a> |
<code>categoryPercentage</code> | <code>Number</code> | <code>0.8</code> |
Percent (0-1) of the available width each category should be within the
sample width. <a href="#barpercentage-vs-categorypercentage">more…</a> |
<code>barThickness</code> | <code>Number/String</code> | | Manually set
width of each bar in pixels. If set to <code>&#39;flex&#39;</code>, it
computes “optimal” sample widths that globally arrange bars side by side.
If not set (default), bars are equally sized based on the smallest
interval. <a href="#barthickness">more…</a> | <code>maxBarThickness</code>
| <code>Number</code> | | Set this to ensure that bars are not sized
thicker than this. | <code>gridLines.offsetGridLines</code> |
<code>Boolean</code> | <code>true</code> | If true, the bars for a
...
go right down the middle of the bars. <a href="#offsetgridlines">more…</a></p>

<h3 id="label-barThickness">barThickness<span><a href="#label-barThickness">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If this value is a number, it is applied to the width of each bar, in
pixels. When this is enforced, <code>barPercentage</code> and
<code>categoryPercentage</code> are ignored.</p>

<p>If set to <code>&#39;flex&#39;</code>, the base sample widths are
...
<p>If not set (default), the base sample widths are calculated using the
smallest interval that prevents bar overlapping, and bars are sized using
<code>barPercentage</code> and <code>categoryPercentage</code>. This mode
always generates bars equally sized.</p>

<h3 id="label-offsetGridLines">offsetGridLines<span><a href="#label-offsetGridLines">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If true, the bars for a particular data point fall between the grid lines.
The grid line will move to the left by one half of the tick interval, which
is the space between the grid lines. If false, the grid line will go right
down the middle of the bars. This is set to true for a category scale in a
bar chart while false for other scales or chart types by default.</p>

<p>This setting applies to the axis configuration. If axes are added to the
chart, this setting will need to be set for each new axis.</p>

<pre class="ruby"><span class="ruby-identifier">options</span> = {
    <span class="ruby-value">scales:</span> {
        <span class="ruby-value">xAxes:</span> [{
            <span class="ruby-value">gridLines:</span> {
                <span class="ruby-value">offsetGridLines:</span> <span class="ruby-keyword">true</span>
            }
        }]
    }
}
...
<p>It is common to want to apply a configuration setting to all created bar
charts. The global bar chart settings are stored in
<code>Chart.defaults.bar</code>. Changing the global options only affects
charts created after the change. Existing charts are not changed.</p>

<h2 id="label-barPercentage+vs+categoryPercentage">barPercentage vs categoryPercentage<span><a href="#label-barPercentage+vs+categoryPercentage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following shows the relationship between the bar percentage option and
the category percentage option.</p>

<pre>// categoryPercentage: 1.0
// barPercentage: 1.0
Bar:        | 1.0 | 1.0 |
Category:   |    1.0    |
Sample:     |===========|
...
<p>The <code>data</code> property of a dataset for a bar chart is specified as
a an array of numbers. Each point in the data array corresponds to the
label at the same index on the x axis.</p>

<pre>data: [20, 10]</pre>

<p>You can also specify the dataset as x/y coordinates when using the <a
href="../axes/cartesian/time.md#time-cartesian-axis">time scale</a>.</p>

<pre>data: [{x:&#39;2016-12-25&#39;, y:20}, {x:&#39;2016-12-26&#39;, y:10}]</pre>

<h1 id="label-Stacked+Bar+Chart">Stacked Bar Chart<span><a href="#label-Stacked+Bar+Chart">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Bar charts can be configured into stacked bar charts by changing the
settings on the X and Y axes to enable stacking. Stacked bar charts can be
used to show how one data series is made up of a number of smaller pieces.</p>

<pre>var stackedBar = new Chart(ctx, {
    type: &#39;bar&#39;,
    data: data,
    options: {
        scales: {
...
<p>| Name | Type | Description | —- | —- | ———– | <code>stack</code> |
<code>String</code> | The ID of the group to which this dataset belongs to
(when stacked, each group will be a separate stack)</p>

<h1 id="label-Horizontal+Bar+Chart">Horizontal Bar Chart<span><a href="#label-Horizontal+Bar+Chart">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>A horizontal bar chart is a variation on a vertical bar chart. It is
sometimes used to show trend data, and the comparison of multiple data sets
side by side. {% chartjs %} {  “type”: “horizontalBar”,  “data”: { 
“labels”: [“January”, “February”, “March”, “April”, “May”, “June”, “July”],
“datasets”: [{ “label”: “My First Dataset”, “data”: [65, 59, 80, 81, 56,
55, 40], “fill”: false, “backgroundColor”: [ “rgba(255, 99, 132, 0.2)”,
“rgba(255, 159, 64, 0.2)”, “rgba(255, 205, 86, 0.2)”, “rgba(75, 192, 192,
0.2)”, “rgba(54, 162, 235, 0.2)”, “rgba(153, 102, 255, 0.2)”, “rgba(201,
203, 207, 0.2)” ], “borderColor”: [ “rgb(255, 99, 132)”, “rgb(255, 159,
64)”, “rgb(255, 205, 86)”, “rgb(75, 192, 192)”, “rgb(54, 162, 235)”,
...
<h2 id="label-Config+Options">Config Options<span><a href="#label-Config+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The configuration options for the horizontal bar chart are the same as for
the <a href="#configuration-options">bar chart</a>. However, any options
specified on the x axis in a bar chart, are applied to the y axis in a
horizontal bar chart.</p>

<p>The default horizontal bar configuration is specified in
<code>Chart.defaults.horizontalBar</code>.</p>
</main>
