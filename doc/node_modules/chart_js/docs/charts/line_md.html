...
<title>line - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Line">Line</a>
    <li><a href="#label-Example+Usage">Example Usage</a>
    <li><a href="#label-Dataset+Properties">Dataset Properties</a>
    <li><a href="#label-cubicInterpolationMode">cubicInterpolationMode</a>
    <li><a href="#label-Stepped+Line">Stepped Line</a>
    <li><a href="#label-Configuration+Options">Configuration Options</a>
    <li><a href="#label-Default+Options">Default Options</a>
    <li><a href="#label-Data+Structure">Data Structure</a>
    <li><a href="#label-Number-5B-5D">Number[]</a>
    <li><a href="#label-Point-5B-5D">Point[]</a>
    <li><a href="#label-Stacked+Area+Chart">Stacked Area Chart</a>
    <li><a href="#label-High+Performance+Line+Charts">High Performance Line Charts</a>
    <li><a href="#label-Data+Decimation">Data Decimation</a>
    <li><a href="#label-Disable+Bezier+Curves">Disable Bezier Curves</a>
    <li><a href="#label-Disable+Line+Drawing">Disable Line Drawing</a>
    <li><a href="#label-Disable+Animations">Disable Animations</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/line.md">

<h1 id="label-Line">Line<span><a href="#label-Line">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>A line chart is a way of plotting data points on a line. Often, it is used
to show trend data, or the comparison of two data sets.</p>

<p>{% chartjs %} {  “type”: “line”,  “data”: {  “labels”: [ “January”,
“February”, “March”, “April”, “May”, “June”, “July” ],  “datasets”: [{
“label”: “My First Dataset”, “data”: [65, 59, 80, 81, 56, 55, 40], “fill”:
false, “borderColor”: “rgb(75, 192, 192)”, “lineTension”: 0.1 }]  }, 
“options”: {</p>
...
<pre>var myLineChart = new Chart(ctx, {
    type: &#39;line&#39;,
    data: data,
    options: options
});</pre>

<h2 id="label-Dataset+Properties">Dataset Properties<span><a href="#label-Dataset+Properties">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The line chart allows a number of properties to be specified for each
dataset. These are used to set display properties for a specific dataset.
For example, the colour of a line is generally set this way.</p>

<p>All point* properties can be specified as an array. If these are set to an
array value, the first value applies to the first point, the second value
to the second point, and so on.</p>

<p>| Name | Type | Description | —- | —- | ———– | <code>label</code> |
<code>String</code> | The label for the dataset which appears in the legend
and tooltips. | <code>xAxisID</code> | <code>String</code> | The ID of the
x axis to plot this dataset on. If not specified, this defaults to the ID
of the first found x axis | <code>yAxisID</code> | <code>String</code> |
The ID of the y axis to plot this dataset on. If not specified, this
defaults to the ID of the first found y axis. |
<code>backgroundColor</code> | <code>Color</code> | The fill color under
the line. See <a href="../general/colors.md#colors">Colors</a> |
<code>borderColor</code> | <code>Color</code> | The color of the line. See
<a href="../general/colors.md#colors">Colors</a> | <code>borderWidth</code>
| <code>Number</code> | The width of the line in pixels. |
<code>borderDash</code> | <code>Number[]</code> | Length and spacing of
dashes. See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/setLineDash">MDN</a>
| <code>borderDashOffset</code> | <code>Number</code> | Offset for line
dashes. See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset">MDN</a>
| <code>borderCapStyle</code> | <code>String</code> | Cap style of the
line. See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineCap">MDN</a>
| <code>borderJoinStyle</code> | <code>String</code> | Line joint style.
See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineJoin">MDN</a>
| <code>cubicInterpolationMode</code> | <code>String</code> | Algorithm
used to interpolate a smooth curve from the discrete data points. <a
href="#cubicinterpolationmode">more…</a> | <code>fill</code> |
<code>Boolean/String</code> | How to fill the area under the line. See <a
href="area.md">area charts</a> | <code>lineTension</code> |
<code>Number</code> | Bezier curve tension of the line. Set to 0 to draw
straightlines. This option is ignored if monotone cubic interpolation is
used. | <code>pointBackgroundColor</code> | <code>Color/Color[]</code> |
The fill color for points. | <code>pointBorderColor</code> |
<code>Color/Color[]</code> | The border color for points. |
<code>pointBorderWidth</code> | <code>Number/Number[]</code> | The width of
the point border in pixels. | <code>pointRadius</code> |
<code>Number/Number[]</code> | The radius of the point shape. If set to 0,
the point is not rendered. | <code>pointStyle</code> |
<code>String/String[]/Image/Image[]</code> | Style of the point. <a
href="../configuration/elements#point-styles">more…</a> |
<code>pointRotation</code> | <code>Number/Number[]</code> | The rotation of
the point in degrees. | <code>pointHitRadius</code> |
<code>Number/Number[]</code> | The pixel size of the non-displayed point
that reacts to mouse events. | <code>pointHoverBackgroundColor</code> |
<code>Color/Color[]</code> | Point background color when hovered. |
<code>pointHoverBorderColor</code> | <code>Color/Color[]</code> | Point
border color when hovered. | <code>pointHoverBorderWidth</code> |
<code>Number/Number[]</code> | Border width of point when hovered. |
<code>pointHoverRadius</code> | <code>Number/Number[]</code> | The radius
of the point when hovered. | <code>showLine</code> | <code>Boolean</code> |
If false, the line is not drawn for this dataset. | <code>spanGaps</code> |
<code>Boolean</code> | If true, lines will be drawn between points with no
or null data. If false, points with <code>NaN</code> data will create a
break in the line | <code>steppedLine</code> | <code>Boolean/String</code>
| If the line is shown as a stepped line. <a href="#stepped-line">more…</a></p>

<h3 id="label-cubicInterpolationMode">cubicInterpolationMode<span><a href="#label-cubicInterpolationMode">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The following interpolation modes are supported: * &#39;default&#39; *
&#39;monotone&#39;.</p>

<p>The &#39;default&#39; algorithm uses a custom weighted cubic interpolation,
which produces pleasant curves for all types of datasets.</p>

<p>The &#39;monotone&#39; algorithm is more suited to <code>y = f(x)</code>
datasets : it preserves monotonicity (or piecewise monotonicity) of the
dataset being interpolated, and ensures local extremums (if any) stay at
input data points.</p>

<p>If left untouched (<code>undefined</code>), the global
<code>options.elements.line.cubicInterpolationMode</code> property is used.</p>

<h3 id="label-Stepped+Line">Stepped Line<span><a href="#label-Stepped+Line">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The following values are supported for <code>steppedLine</code>: *
<code>false</code>: No Step Interpolation (default) * <code>true</code>:
Step-before Interpolation (eq. &#39;before&#39;) *
<code>&#39;before&#39;</code>: Step-before Interpolation *
<code>&#39;after&#39;</code>: Step-after Interpolation</p>

<p>If the <code>steppedLine</code> value is set to anything other than false,
<code>lineTension</code> will be ignored.</p>
...
<p>The line chart defines the following configuration options. These options
are merged with the global chart configuration options,
<code>Chart.defaults.global</code>, to form the options passed to the
chart.</p>

<p>| Name | Type | Default | Description | —- | —- | ——- | ———– |
<code>showLines</code> | <code>Boolean</code> | <code>true</code> | If
false, the lines between points are not drawn. | <code>spanGaps</code> |
<code>Boolean</code> | <code>false</code> | If false, NaN data causes a
break in the line.</p>

<h2 id="label-Default+Options">Default Options<span><a href="#label-Default+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>It is common to want to apply a configuration setting to all created line
charts. The global line chart settings are stored in
...
<p>For example, to configure all line charts with <code>spanGaps = true</code>
you would do: <code>javascript Chart.defaults.line.spanGaps = true; </code></p>

<h2 id="label-Data+Structure">Data Structure<span><a href="#label-Data+Structure">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The <code>data</code> property of a dataset for a line chart can be passed
in two formats.</p>

<h3 id="label-Number-5B-5D">Number[]<span><a href="#label-Number-5B-5D">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>data: [20, 10]</pre>

<p>When the <code>data</code> array is an array of numbers, the x axis is
generally a <a
href="../axes/cartesian/category.md#category-cartesian-axis">category</a>.
...
property of the data object must be specified.</p>

<h3 id="label-Point-5B-5D">Point[]<span><a href="#label-Point-5B-5D">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
<p>This alternate is used for sparse datasets, such as those in <a
href="./scatter.md#scatter-chart">scatter charts</a>. Each data point is
specified using an object containing <code>x</code> and <code>y</code>
properties.</p>

<h1 id="label-Stacked+Area+Chart">Stacked Area Chart<span><a href="#label-Stacked+Area+Chart">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Line charts can be configured into stacked area charts by changing the
settings on the y axis to enable stacking. Stacked area charts can be used
to show how one data trend is made up of a number of smaller pieces.</p>

<pre>var stackedLine = new Chart(ctx, {
    type: &#39;line&#39;,
    data: data,
    options: {
        scales: {
...
<h1 id="label-High+Performance+Line+Charts">High Performance Line Charts<span><a href="#label-High+Performance+Line+Charts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>When charting a lot of data, the chart render time may start to get quite
large. In that case, the following strategies can be used to improve
performance.</p>

<h2 id="label-Data+Decimation">Data Decimation<span><a href="#label-Data+Decimation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Decimating your data will achieve the best results. When there is a lot of
data to display on the graph, it doesn&#39;t make sense to show tens of
thousands of data points on a graph that is only a few hundred pixels wide.</p>

<p>There are many approaches to data decimation and selection of an algorithm
will depend on your data and the results you want to achieve. For instance,
<a
href="http://digital.ni.com/public.nsf/allkb/F694FFEEA0ACF282862576020075F784">min/max</a>
decimation will preserve peaks in your data but could require up to 4
points for each pixel. This type of decimation would work well for a very
noisy signal where you need to see data peaks.</p>

<h2 id="label-Disable+Bezier+Curves">Disable Bezier Curves<span><a href="#label-Disable+Bezier+Curves">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you are drawing lines on your chart, disabling bezier curves will
improve render times since drawing a straight line is more performant than
a bezier curve.</p>
...
<h2 id="label-Disable+Line+Drawing">Disable Line Drawing<span><a href="#label-Disable+Line+Drawing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you have a lot of data points, it can be more performant to disable
rendering of the line for a dataset and only draw points. Doing this means
that there is less to draw on the canvas which will improve render
performance.</p>
...
<h2 id="label-Disable+Animations">Disable Animations<span><a href="#label-Disable+Animations">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If your charts have long render times, it is a good idea to disable
animations. Doing so will mean that the chart needs to only be rendered
once during an update instead of multiple times. This will have the effect
of reducing CPU usage and improving general page performance.</p>
