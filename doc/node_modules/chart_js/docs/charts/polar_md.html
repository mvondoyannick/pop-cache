...
<title>polar - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Polar+Area">Polar Area</a>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/polar.md">

<h1 id="label-Polar+Area">Polar Area<span><a href="#label-Polar+Area">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Polar area charts are similar to pie charts, but each segment has the same
angle - the radius of the segment differs depending on the value.</p>

<p>This type of chart is often useful when we want to show a comparison data
similar to a pie chart, but also show a scale of values for context.</p>

<p>{% chartjs %} {  “type”: “polarArea”,  “data”: {  “labels”: [ “Red”,
“Green”, “Yellow”, “Grey”, “Blue” ],  “datasets”: [{ “label”: “My First
Dataset”, “data”: [11, 16, 7, 3, 14], “backgroundColor”: [ “rgb(255, 99,
132)”, “rgb(75, 192, 192)”, “rgb(255, 205, 86)”, “rgb(201, 203, 207)”,
“rgb(54, 162, 235)” ] }]  }, } {% endchartjs %}</p>

<h2 id="label-Example+Usage">Example Usage<span><a href="#label-Example+Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">new</span> <span class="ruby-constant">Chart</span>(<span class="ruby-identifier">ctx</span>, {
    <span class="ruby-value">data:</span> <span class="ruby-identifier">data</span>,
    <span class="ruby-value">type:</span> <span class="ruby-string">&#39;polarArea&#39;</span>,
...
<p>The following options can be included in a polar area chart dataset to
configure options for that specific dataset.</p>
...
<p>These are the customisation options specific to Polar Area charts. These
options are merged with the <a href="#default-options">global chart default
options</a>, and form the options of the chart.</p>

<p>| Name | Type | Default | Description | —- | —- | ——- | ———– |
<code>startAngle</code> | <code>Number</code> | <code>-0.5 * Math.PI</code>
| Starting angle to draw arcs for the first item in a dataset. |
<code>animation.animateRotate</code> | <code>Boolean</code> |
<code>true</code> | If true, the chart will animate in with a rotation
animation. This property is in the <code>options.animation</code> object. |
<code>animation.animateScale</code> | <code>Boolean</code> |
<code>true</code> | If true, will animate scaling the chart from the center
outwards.</p>
...
Existing charts are not changed.</p>

<p>For example, to configure all new polar area charts with <code>animateScale
= false</code> you would do: <code>javascript
Chart.defaults.polarArea.animation.animateScale = false; </code></p>

<h2 id="label-Data+Structure">Data Structure<span><a href="#label-Data+Structure">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>For a polar area chart, datasets need to contain an array of data points.
The data points should be a number, Chart.js will total all of the numbers
and calculate the relative proportion of each.</p>

<p>You also need to specify an array of labels so that tooltips appear
correctly for each slice.</p>
