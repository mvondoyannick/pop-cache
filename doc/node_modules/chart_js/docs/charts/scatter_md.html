...
<title>scatter - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Scatter+Chart">Scatter Chart</a>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/scatter.md">

<h1 id="label-Scatter+Chart">Scatter Chart<span><a href="#label-Scatter+Chart">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Scatter charts are based on basic line charts with the x axis changed to a
...
<pre>var scatterChart = new Chart(ctx, {
    type: &#39;scatter&#39;,
    data: {
        datasets: [{
...
<p>The scatter chart supports all of the same properties as the <a
href="./line.md#dataset-properties">line chart</a>.</p>

<h2 id="label-Data+Structure">Data Structure<span><a href="#label-Data+Structure">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Unlike the line chart where data can be supplied in two different formats,
the scatter chart only accepts data in a point format.</p>
