...
<title>mixed - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/charts/mixed.md">

<h1 id="label-Mixed+Chart+Types">Mixed Chart Types<span><a href="#label-Mixed+Chart+Types">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>With Chart.js, it is possible to create mixed charts that are a combination
of two or more different chart types. A common example is a bar chart that
also includes a line dataset.</p>
...
<p>At this point we have a standard bar chart. Now we need to convert one of
the datasets to a line dataset.</p>

<pre>var mixedChart = new Chart(ctx, {
  type: &#39;bar&#39;,
  data: {
    datasets: [{
          label: &#39;Bar Dataset&#39;,
...
<p>At this point we have a chart rendering how we&#39;d like. It&#39;s
important to note that the default options for a line chart are not merged
in this case. Only the options for the default type are merged in. In this
case, that means that the default options for a bar chart are merged
because that is the type specified by the <code>type</code> field.</p>

<p>{% chartjs %} {  “type”: “bar”,  “data”: {  “labels”: [ “January”,
“February”, “March”, “April” ],  “datasets”: [{ “label”: “Bar Dataset”,
“data”: [10, 20, 30, 40], “borderColor”: “rgb(255, 99, 132)”,
“backgroundColor”: “rgba(255, 99, 132, 0.2)” }, { “label”: “Line Dataset”,
“data”: [50, 50, 50, 50], “type”: “line”, “fill”: false, “borderColor”:
“rgb(54, 162, 235)” }]  },  “options”: {  “scales”: {  “yAxes”: [{ “ticks”:
{ “beginAtZero”: true } }]  }  } } {% endchartjs %}</p>
</main>
