...
<title>linear - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Linear+Radial+Axis">Linear Radial Axis</a>
    <li><a href="#label-Configuration+Options">Configuration Options</a>
    <li><a href="#label-Tick+Options">Tick Options</a>
    <li><a href="#label-Axis+Range+Settings">Axis Range Settings</a>
    <li><a href="#label-Step+Size">Step Size</a>
    <li><a href="#label-Angle+Line+Options">Angle Line Options</a>
    <li><a href="#label-Point+Label+Options">Point Label Options</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/radial/linear.md">

<h1 id="label-Linear+Radial+Axis">Linear Radial Axis<span><a href="#label-Linear+Radial+Axis">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The linear scale is use to chart numerical data. As the name suggests,
linear interpolation is used to determine where a value lies in relation
the center of the axis.</p>

<p>The following additional configuration options are provided by the radial
linear scale.</p>
...
<p>The axis has configuration properties for ticks, angle lines (line that
appear in a radar chart outward from the center), pointLabels (labels
around the edge in a radar chart). The following sections define each of
the properties in those sections.</p>

<p>| Name | Type | Description | —- | —- | ———– | <code>angleLines</code> |
<code>Object</code> | Angle line configuration. <a
href="#angle-line-options">more…</a> | <code>gridLines</code> |
<code>Object</code> | Grid line configuration. <a
href="../styling.md#grid-line-configuration">more…</a> |
<code>pointLabels</code> | <code>Object</code> | Point label configuration.
<a href="#point-label-options">more…</a> | <code>ticks</code> |
<code>Object</code> | Tick configuration. <a href="#tick-options">more…</a></p>

<h2 id="label-Tick+Options">Tick Options<span><a href="#label-Tick+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following options are provided by the linear scale. They are all
located in the <code>ticks</code> sub options. The <a
href="../styling.md#tick-configuration">common tick configuration</a>
options are supported by this axis.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>backdropColor</code> | <code>Color</code> | <code>&#39;rgba(255, 255,
255, 0.75)&#39;</code> | Color of label backdrops |
<code>backdropPaddingX</code> | <code>Number</code> | <code>2</code> |
Horizontal padding of label backdrop. | <code>backdropPaddingY</code> |
<code>Number</code> | <code>2</code> | Vertical padding of label backdrop.
| <code>beginAtZero</code> | <code>Boolean</code> | <code>false</code> | if
true, scale will include 0 if it is not already included. |
<code>min</code> | <code>Number</code> | | <a
href="../../../../../User.html">User</a> defined minimum number for the
scale, overrides minimum value from data. <a
href="#axis-range-settings">more…</a> | <code>max</code> |
<code>Number</code> | | <a href="../../../../../User.html">User</a> defined
maximum number for the scale, overrides maximum value from data. <a
href="#axis-range-settings">more…</a> | <code>maxTicksLimit</code> |
<code>Number</code> | <code>11</code> | Maximum number of ticks and
gridlines to show. | <code>precision</code> | <code>Number</code> | | if
defined and <code>stepSize</code> is not specified, the step size will be
rounded to this many decimal places. | <code>stepSize</code> |
<code>Number</code> | | <a href="../../../../../User.html">User</a> defined
fixed step size for the scale. <a href="#step-size">more…</a> |
<code>suggestedMax</code> | <code>Number</code> | | Adjustment used when
calculating the maximum data value. <a
href="#axis-range-settings">more…</a> | <code>suggestedMin</code> |
<code>Number</code> | | Adjustment used when calculating the minimum data
value. <a href="#axis-range-settings">more…</a> |
<code>showLabelBackdrop</code> | <code>Boolean</code> | <code>true</code> |
If true, draw a background behind the tick labels</p>

<h2 id="label-Axis+Range+Settings">Axis Range Settings<span><a href="#label-Axis+Range+Settings">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Given the number of axis range settings, it is important to understand how
they all interact with each other.</p>

<p>The <code>suggestedMax</code> and <code>suggestedMin</code> settings only
...
<pre class="ruby"><span class="ruby-identifier">let</span> <span class="ruby-identifier">minDataValue</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">min</span>(<span class="ruby-identifier">mostNegativeValue</span>, <span class="ruby-identifier">options</span>.<span class="ruby-identifier">ticks</span>.<span class="ruby-identifier">suggestedMin</span>);
<span class="ruby-identifier">let</span> <span class="ruby-identifier">maxDataValue</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">max</span>(<span class="ruby-identifier">mostPositiveValue</span>, <span class="ruby-identifier">options</span>.<span class="ruby-identifier">ticks</span>.<span class="ruby-identifier">suggestedMax</span>);
</pre>

<p>In this example, the largest positive value is 50, but the data maximum is
expanded out to 100. However, because the lowest data value is below the
<code>suggestedMin</code> setting, it is ignored.</p>

<pre>let chart = new Chart(ctx, {
    type: &#39;radar&#39;,
    data: {
        datasets: [{
            label: &#39;First dataset&#39;,
...
<p>In contrast to the <code>suggested*</code> settings, the <code>min</code>
and <code>max</code> settings set explicit ends to the axes. When these are
set, some data points may not be visible.</p>

<h2 id="label-Step+Size">Step Size<span><a href="#label-Step+Size">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If set, the scale ticks will be enumerated by multiple of stepSize, having
one tick per increment. If not set, the ticks are labeled automatically
using the nice numbers algorithm.</p>

<p>This example sets up a chart with a y axis that creates ticks at <code>0,
0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5</code>.</p>

<pre class="ruby"><span class="ruby-identifier">let</span> <span class="ruby-identifier">options</span> = {
    <span class="ruby-value">scale:</span> {
        <span class="ruby-value">ticks:</span> {
            <span class="ruby-value">max:</span> <span class="ruby-value">5</span>,
            <span class="ruby-value">min:</span> <span class="ruby-value">0</span>,
            <span class="ruby-value">stepSize:</span> <span class="ruby-value">0.5</span>
        }
    }
};
</pre>

<h2 id="label-Angle+Line+Options">Angle Line Options<span><a href="#label-Angle+Line+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following options are used to configure angled lines that radiate from
the center of the chart to the point labels. They can be found in the
<code>angleLines</code> sub options. Note that these options only apply if
<code>angleLines.display</code> is true.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>display</code> | <code>Boolean</code> | <code>true</code> | if true,
angle lines are shown | <code>color</code> | <code>Color</code> |
<code>rgba(0, 0, 0, 0.1)</code> | Color of angled lines |
<code>lineWidth</code> | <code>Number</code> | <code>1</code> | Width of
angled lines</p>

<h2 id="label-Point+Label+Options">Point Label Options<span><a href="#label-Point+Label+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following options are used to configure the point labels that are shown
on the perimeter of the scale. They can be found in the
<code>pointLabels</code> sub options. Note that these options only apply if
<code>pointLabels.display</code> is true.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>callback</code> | <code>Function</code> | | Callback function to
transform data labels to point labels. The default implementation simply
returns the current string. | <code>fontColor</code> |
<code>Color/Color[]</code> | <code>&#39;#666&#39;</code> | Font color for
point labels. | <code>fontFamily</code> | <code>String</code> |
<code>&quot;&#39;Helvetica Neue&#39;, &#39;Helvetica&#39;, &#39;Arial&#39;,
sans-serif&quot;</code> | Font family to use when rendering labels. |
<code>fontSize</code> | <code>Number</code> | 10 | font size in pixels |
<code>fontStyle</code> | <code>String</code> |
<code>&#39;normal&#39;</code> | Font style to use when rendering point
labels.</p>
</main>
