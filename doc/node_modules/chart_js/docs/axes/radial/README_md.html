...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/radial/README.md">

<h1 id="label-Radial+Axes">Radial Axes<span><a href="#label-Radial+Axes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Radial axes are used specifically for the radar and polar area chart types.
These axes overlay the chart area, rather than being positioned on one of
the edges. One radial axis is included by default in Chart.js.</p>
<ul><li>
<p><a href="./linear.md#linear-radial-axis">linear</a></p>
</li></ul>
</main>
