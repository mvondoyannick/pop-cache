...
<title>styling - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Grid+Line+Configuration">Grid Line Configuration</a>
    <li><a href="#label-Tick+Configuration">Tick Configuration</a>
    <li><a href="#label-Minor+Tick+Configuration">Minor Tick Configuration</a>
    <li><a href="#label-Major+Tick+Configuration">Major Tick Configuration</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/styling.md">

<h1 id="label-Styling">Styling<span><a href="#label-Styling">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>There are a number of options to allow styling an axis. There are settings
to control <a href="#grid-line-configuration">grid lines</a> and <a
href="#tick-configuration">ticks</a>.</p>

<h2 id="label-Grid+Line+Configuration">Grid Line Configuration<span><a href="#label-Grid+Line+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The grid line configuration is nested under the scale configuration in the
<code>gridLines</code> key. It defines options for the grid lines that run
perpendicular to the axis.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>display</code> | <code>Boolean</code> | <code>true</code> | If false,
do not display grid lines for this axis. | <code>circular</code> |
<code>Boolean</code> | <code>false</code> | If true, gridlines are circular
(on radar chart only) | <code>color</code> | <code>Color/Color[]</code> |
<code>&#39;rgba(0, 0, 0, 0.1)&#39;</code> | The color of the grid lines. If
specified as an array, the first color applies to the first grid line, the
second to the second grid line and so on. | <code>borderDash</code> |
<code>Number[]</code> | <code>[]</code> | Length and spacing of dashes on
grid lines. See <a
...
Offset for line dashes. See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset">MDN</a>
| <code>lineWidth</code> | <code>Number/Number[]</code> | <code>1</code> |
Stroke width of grid lines. | <code>drawBorder</code> |
<code>Boolean</code> | <code>true</code> | If true, draw border at the edge
between the axis and the chart area. | <code>drawOnChartArea</code> |
<code>Boolean</code> | <code>true</code> | If true, draw lines on the chart
area inside the axis lines. This is useful when there are multiple axes and
you need to control which grid lines are drawn. | <code>drawTicks</code> |
<code>Boolean</code> | <code>true</code> | If true, draw lines beside the
ticks in the axis area beside the chart. | <code>tickMarkLength</code> |
<code>Number</code> | <code>10</code> | Length in pixels that the grid
lines will draw into the axis area. | <code>zeroLineWidth</code> |
<code>Number</code> | <code>1</code> | Stroke width of the grid line for
the first index (index 0). | <code>zeroLineColor</code> | Color |
<code>&#39;rgba(0, 0, 0, 0.25)&#39;</code> | Stroke color of the grid line
for the first index (index 0). | <code>zeroLineBorderDash</code> |
<code>Number[]</code> | <code>[]</code> | Length and spacing of dashes of
the grid line for the first index (index 0). See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/setLineDash">MDN</a>
| <code>zeroLineBorderDashOffset</code> | <code>Number</code> |
<code>0</code> | Offset for line dashes of the grid line for the first
index (index 0). See <a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset">MDN</a>
| <code>offsetGridLines</code> | <code>Boolean</code> | <code>false</code>
| If true, grid lines will be shifted to be between labels. This is set to
<code>true</code> for a category scale in a bar chart by default.</p>

<h2 id="label-Tick+Configuration">Tick Configuration<span><a href="#label-Tick+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The tick configuration is nested under the scale configuration in the
<code>ticks</code> key. It defines options for the tick marks that are
generated by the axis.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>callback</code> | <code>Function</code> | | Returns the string
representation of the tick value as it should be displayed on the chart.
See <a
href="../axes/labelling.md#creating-custom-tick-formats">callback</a>. |
<code>display</code> | <code>Boolean</code> | <code>true</code> | If true,
show tick marks | <code>fontColor</code> | <code>Color</code> |
<code>&#39;#666&#39;</code> | Font color for tick labels. |
<code>fontFamily</code> | <code>String</code> | <code>&quot;&#39;Helvetica
Neue&#39;, &#39;Helvetica&#39;, &#39;Arial&#39;, sans-serif&quot;</code> |
Font family for the tick labels, follows CSS font-family options. |
<code>fontSize</code> | <code>Number</code> | <code>12</code> | Font size
for the tick labels. | <code>fontStyle</code> | <code>String</code> |
<code>&#39;normal&#39;</code> | Font style for the tick labels, follows CSS
font-style options (i.e. normal, italic, oblique, initial, inherit). |
<code>reverse</code> | <code>Boolean</code> | <code>false</code> | Reverses
order of tick labels. | <code>minor</code> | <code>object</code> |
<code>{}</code> | Minor ticks configuration. Omitted options are inherited
from options above. | <code>major</code> | <code>object</code> |
<code>{}</code> | Major ticks configuration. Omitted options are inherited
from options above.</p>

<h2 id="label-Minor+Tick+Configuration">Minor Tick Configuration<span><a href="#label-Minor+Tick+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The minorTick configuration is nested under the ticks configuration in the
<code>minor</code> key. It defines options for the minor tick marks that
are generated by the axis. Omitted options are inherited from
<code>ticks</code> configuration.</p>
...
See <a
href="../axes/labelling.md#creating-custom-tick-formats">callback</a>. |
<code>fontColor</code> | <code>Color</code> | <code>&#39;#666&#39;</code> |
Font color for tick labels. | <code>fontFamily</code> | <code>String</code>
| <code>&quot;&#39;Helvetica Neue&#39;, &#39;Helvetica&#39;,
&#39;Arial&#39;, sans-serif&quot;</code> | Font family for the tick labels,
follows CSS font-family options. | <code>fontSize</code> |
<code>Number</code> | <code>12</code> | Font size for the tick labels. |
<code>fontStyle</code> | <code>String</code> |
<code>&#39;normal&#39;</code> | Font style for the tick labels, follows CSS
font-style options (i.e. normal, italic, oblique, initial, inherit).</p>

<h2 id="label-Major+Tick+Configuration">Major Tick Configuration<span><a href="#label-Major+Tick+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The majorTick configuration is nested under the ticks configuration in the
<code>major</code> key. It defines options for the major tick marks that
are generated by the axis. Omitted options are inherited from
<code>ticks</code> configuration.</p>
