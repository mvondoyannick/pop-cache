...
<title>labelling - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Labeling+Axes">Labeling Axes</a>
    <li><a href="#label-Scale+Title+Configuration">Scale Title Configuration</a>
    <li><a href="#label-Creating+Custom+Tick+Formats">Creating Custom Tick Formats</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/labelling.md">

<h1 id="label-Labeling+Axes">Labeling Axes<span><a href="#label-Labeling+Axes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>When creating a chart, you want to tell the viewer what data they are
viewing. To do this, you need to label the axis.</p>

<h2 id="label-Scale+Title+Configuration">Scale Title Configuration<span><a href="#label-Scale+Title+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The scale label configuration is nested under the scale configuration in
the <code>scaleLabel</code> key. It defines options for the scale title.
Note that this only applies to cartesian axes.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>display</code> | <code>Boolean</code> | <code>false</code> | If true,
display the axis title. | <code>labelString</code> | <code>String</code> |
<code>&#39;&#39;</code> | The text for the title. (i.e. “# of People” or
“Response Choices”). | <code>lineHeight</code> | <code>Number/String</code>
| <code>1.2</code> | Height of an individual line of text (see <a
href="https://developer.mozilla.org/en-US/docs/Web/CSS/line-height">MDN</a>)
| <code>fontColor</code> | <code>Color</code> | <code>&#39;#666&#39;</code>
| Font color for scale title. | <code>fontFamily</code> |
<code>String</code> | <code>&quot;&#39;Helvetica Neue&#39;,
&#39;Helvetica&#39;, &#39;Arial&#39;, sans-serif&quot;</code> | Font family
for the scale title, follows CSS font-family options. |
<code>fontSize</code> | <code>Number</code> | <code>12</code> | Font size
for scale title. | <code>fontStyle</code> | <code>String</code> |
<code>&#39;normal&#39;</code> | Font style for the scale title, follows CSS
font-style options (i.e. normal, italic, oblique, initial, inherit). |
<code>padding</code> | <code>Number/Object</code> | <code>4</code> |
Padding to apply around scale labels. Only <code>top</code> and
<code>bottom</code> are implemented.</p>

<h2 id="label-Creating+Custom+Tick+Formats">Creating Custom Tick Formats<span><a href="#label-Creating+Custom+Tick+Formats">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>It is also common to want to change the tick marks to include information
about the data type. For example, adding a dollar sign (&#39;$&#39;). To do
this, you need to override the <code>ticks.callback</code> method in the
axis configuration. In the following example, every label of the Y axis
would be displayed with a dollar sign at the front..</p>
