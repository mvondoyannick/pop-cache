...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Linear+Cartesian+Axis">Linear Cartesian Axis</a>
    <li><a href="#label-Tick+Configuration+Options">Tick Configuration Options</a>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/cartesian/linear.md">

<h1 id="label-Linear+Cartesian+Axis">Linear Cartesian Axis<span><a href="#label-Linear+Cartesian+Axis">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The linear scale is use to chart numerical data. It can be placed on either
the x or y axis. The scatter chart type automatically configures a line
chart to use one of these scales for the x axis. As the name suggests,
linear interpolation is used to determine where a value lies on the axis.</p>

<h2 id="label-Tick+Configuration+Options">Tick Configuration Options<span><a href="#label-Tick+Configuration+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following options are provided by the linear scale. They are all
located in the <code>ticks</code> sub options. These options extend the <a
href="README.md#tick-configuration">common tick configuration</a>.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>beginAtZero</code> | <code>Boolean</code> | | if true, scale will
include 0 if it is not already included. | <code>min</code> |
<code>Number</code> | | <a href="../../../../../User.html">User</a> defined
minimum number for the scale, overrides minimum value from data. <a
...
value. <a href="#axis-range-settings">more…</a></p>
...
<pre class="ruby"><span class="ruby-identifier">let</span> <span class="ruby-identifier">options</span> = {
    <span class="ruby-value">scales:</span> {
        <span class="ruby-value">yAxes:</span> [{
