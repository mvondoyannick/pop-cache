...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Cartesian+Axes">Cartesian Axes</a>
    <li><a href="#label-Common+Configuration">Common Configuration</a>
    <li><a href="#label-Tick+Configuration">Tick Configuration</a>
    <li><a href="#label-Axis+ID">Axis ID</a>
    <li><a href="#label-Creating+Multiple+Axes">Creating Multiple Axes</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/cartesian/README.md">

<h1 id="label-Cartesian+Axes">Cartesian Axes<span><a href="#label-Cartesian+Axes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Axes that follow a cartesian grid are known as &#39;Cartesian Axes&#39;.
Cartesian axes are used for line, bar, and bubble charts. Four cartesian
axes are included in Chart.js by default.</p>
<ul><li>
<p><a href="./linear.md#linear-cartesian-axis">linear</a></p>
</li><li>
<p><a href="./logarithmic.md#logarithmic-cartesian-axis">logarithmic</a></p>
</li><li>
<p><a href="./category.md#category-cartesian-axis">category</a></p>
</li><li>
<p><a href="./time.md#time-cartesian-axis">time</a></p>
</li></ul>
...
<code>type</code> | <code>String</code> | | Type of scale being employed.
Custom scales can be created and registered with a string key. This allows
changing the type of an axis for a chart. | <code>position</code> |
<code>String</code> | | Position of the axis in the chart. Possible values
are: <code>&#39;top&#39;</code>, <code>&#39;left&#39;</code>,
<code>&#39;bottom&#39;</code>, <code>&#39;right&#39;</code> |
<code>offset</code> | <code>Boolean</code> | <code>false</code> | If true,
extra space is added to the both edges and the axis is scaled to fit into
the chart area. This is set to <code>true</code> for a category scale in a
bar chart by default. | <code>id</code> | <code>String</code> | | The ID is
used to link datasets and scale axes together. <a href="#axis-id">more…</a>
| <code>gridLines</code> | <code>Object</code> | | Grid line configuration.
<a href="../styling.md#grid-line-configuration">more…</a> |
<code>scaleLabel</code> | <code>Object</code> | | Scale title
configuration. <a
href="../labelling.md#scale-title-configuration">more…</a> |
<code>ticks</code> | <code>Object</code> | | Tick configuration. <a
href="#tick-configuration">more…</a></p>

<h2 id="label-Tick+Configuration">Tick Configuration<span><a href="#label-Tick+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following options are common to all cartesian axes but do not apply to
other axes.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>autoSkip</code> | <code>Boolean</code> | <code>true</code> | If true,
automatically calculates how many labels that can be shown and hides labels
accordingly. Turn it off to show all labels no matter what |
<code>autoSkipPadding</code> | <code>Number</code> | <code>0</code> |
Padding between the ticks on the horizontal axis when <code>autoSkip</code>
is enabled. <em>Note: Only applicable to horizontal scales.</em> |
<code>labelOffset</code> | <code>Number</code> | <code>0</code> | Distance
in pixels to offset the label from the centre point of the tick (in the y
direction for the x axis, and the x direction for the y axis). <em>Note:
this can cause labels at the edges to be cropped by the edge of the
canvas</em> | <code>maxRotation</code> | <code>Number</code> |
<code>90</code> | Maximum rotation for tick labels when rotating to
condense labels. Note: Rotation doesn&#39;t occur until necessary.
<em>Note: Only applicable to horizontal scales.</em> |
<code>minRotation</code> | <code>Number</code> | <code>0</code> | Minimum
rotation for tick labels. <em>Note: Only applicable to horizontal
scales.</em> | <code>mirror</code> | <code>Boolean</code> |
<code>false</code> | Flips tick labels around axis, displaying the labels
inside the chart instead of outside. <em>Note: Only applicable to vertical
scales.</em> | <code>padding</code> | <code>Number</code> | <code>10</code>
...
axis, this applies in the vertical (Y) direction.</p>

<h2 id="label-Axis+ID">Axis ID<span><a href="#label-Axis+ID">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The properties <code>dataset.xAxisID</code> or <code>dataset.yAxisID</code>
...
<h1 id="label-Creating+Multiple+Axes">Creating Multiple Axes<span><a href="#label-Creating+Multiple+Axes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>With cartesian axes, it is possible to create multiple X and Y axes. To do
so, you can add multiple configuration objects to the <code>xAxes</code>
and <code>yAxes</code> properties. When adding new axes, it is important to
ensure that you specify the type of the new axes as default types are
<strong>not</strong> used in this case.</p>

<p>In the example below, we are creating two Y axes. We then use the
<code>yAxisID</code> property to map the datasets to their correct axes.</p>
