...
<title>time - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Time+Cartesian+Axis">Time Cartesian Axis</a>
    <li><a href="#label-Data+Sets">Data Sets</a>
    <li><a href="#label-Input+Data">Input Data</a>
    <li><a href="#label-Date+Formats">Date Formats</a>
    <li><a href="#label-Configuration+Options">Configuration Options</a>
    <li><a href="#label-Time+Units">Time Units</a>
    <li><a href="#label-Display+Formats">Display Formats</a>
    <li><a href="#label-Scale+Distribution">Scale Distribution</a>
    <li><a href="#label-Scale+Bounds">Scale Bounds</a>
    <li><a href="#label-Ticks+Source">Ticks Source</a>
    <li><a href="#label-Parser">Parser</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/cartesian/time.md">

<h1 id="label-Time+Cartesian+Axis">Time Cartesian Axis<span><a href="#label-Time+Cartesian+Axis">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The time scale is used to display times and dates. When building its ticks,
it will automatically calculate the most comfortable unit base on the size
of the scale.</p>

<h2 id="label-Data+Sets">Data Sets<span><a href="#label-Data+Sets">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Input+Data">Input Data<span><a href="#label-Input+Data">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The x-axis data points may additionally be specified via the <code>t</code>
or <code>x</code> attribute when using the time scale.</p>
...
<h3 id="label-Date+Formats">Date Formats<span><a href="#label-Date+Formats">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>When providing data for the time scale, Chart.js supports all of the
formats that Moment.js accepts. See <a
href="http://momentjs.com/docs/#/parsing/">Moment.js docs</a> for details.</p>
...
<p>The following options are provided by the time scale. You may also set
options provided by the <a href="README.md#tick-configuration">common tick
configuration</a>.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>distribution</code> | <code>String</code> | <code>linear</code> | How
data is plotted. <a href="#scale-distribution">more…</a> |
<code>bounds</code> | <code>String</code> | <code>data</code> | Determines
the scale bounds. <a href="#scale-bounds">more…</a> |
<code>ticks.source</code> | <code>String</code> | <code>auto</code> | How
ticks are generated. <a href="#ticks-source">more…</a> |
<code>time.displayFormats</code> | <code>Object</code> | | Sets how
different time units are displayed. <a href="#display-formats">more…</a> |
<code>time.isoWeekday</code> | <code>Boolean</code> | <code>false</code> |
If true and the unit is set to &#39;week&#39;, then the first day of the
week will be Monday. Otherwise, it will be Sunday. | <code>time.max</code>
| <a href="#date-formats">Time</a> | | If defined, this will override the
data maximum | <code>time.min</code> | <a href="#date-formats">Time</a> | |
If defined, this will override the data minimum | <code>time.parser</code>
| <code>String/Function</code> | | Custom parser for dates. <a
href="#parser">more…</a> | <code>time.round</code> | <code>String</code> |
<code>false</code> | If defined, dates will be rounded to the start of this
unit. See <a href="#time-units">Time Units</a> below for the allowed units.
| <code>time.tooltipFormat</code> | <code>String</code> | | The moment js
format string to use for the tooltip. | <code>time.unit</code> |
<code>String</code> | <code>false</code> | If defined, will force the unit
to be a certain type. See <a href="#time-units">Time Units</a> section
below for details. | <code>time.stepSize</code> | <code>Number</code> |
<code>1</code> | The number of units between grid lines. |
<code>time.minUnit</code> | <code>String</code> |
<code>&#39;millisecond&#39;</code> | The minimum display format to be used
for a time unit.</p>

<h3 id="label-Time+Units">Time Units<span><a href="#label-Time+Units">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The following time measurements are supported. The names can be passed as
strings to the <code>time.unit</code> config option to force a certain
unit.</p>
<ul><li>
<p>millisecond</p>
</li><li>
...
<p>For example, to create a chart with a time scale that always displayed
units per month, the following config could be used.</p>
...
<h3 id="label-Display+Formats">Display Formats<span><a href="#label-Display+Formats">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The following display formats are used to configure how different time
units are formed into strings for the axis tick marks. See <a
href="http://momentjs.com/docs/#/displaying/format/">moment.js</a> for the
allowable format strings.</p>

<p>Name | Default | Example — | — | — millisecond | &#39;h:mm:ss.SSS a&#39; |
11:20:01.123 AM second | &#39;h:mm:ss a&#39; | 11:20:01 AM minute |
&#39;h:mm a&#39; | 11:20 AM hour | &#39;hA&#39; | 11AM day | &#39;MMM
D&#39; | Sep 4 week | &#39;ll&#39; | Sep 4 2015 month | &#39;MMM YYYY&#39;
| Sep 2015 quarter | &#39;[Q]Q - YYYY&#39; | Q3 - 2015 year |
&#39;YYYY&#39; | 2015</p>

<p>For example, to set the display format for the &#39;quarter&#39; unit to
show the month and year, the following config would be passed to the chart
constructor.</p>
...
<h3 id="label-Scale+Distribution">Scale Distribution<span><a href="#label-Scale+Distribution">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The <code>distribution</code> property controls the data distribution along
the scale:</p>
<ul><li>
<p><code>&#39;linear&#39;</code>: data are spread according to their time
(distances can vary)</p>
</li><li>
<p><code>&#39;series&#39;</code>: data are spread at the same distance from
each other</p>
</li></ul>
...
<h3 id="label-Scale+Bounds">Scale Bounds<span><a href="#label-Scale+Bounds">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The <code>bounds</code> property controls the scale boundary strategy
(bypassed by min/max time options)</p>
<ul><li>
<p><code>&#39;data&#39;</code>: make sure data are fully visible, labels
outside are removed</p>
</li><li>
<p><code>&#39;ticks&#39;</code>: make sure ticks are fully visible, data
outside are truncated</p>
</li></ul>

<h3 id="label-Ticks+Source">Ticks Source<span><a href="#label-Ticks+Source">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The <code>ticks.source</code> property controls the ticks generation</p>
<ul><li>
<p><code>&#39;auto&#39;</code>: generates “optimal” ticks based on scale size
and time options.</p>
</li><li>
<p><code>&#39;data&#39;</code>: generates ticks from data (including labels
from data <code>{t|x|y}</code> objects)</p>
</li><li>
<p><code>&#39;labels&#39;</code>: generates ticks from user given
<code>data.labels</code> values ONLY</p>
</li></ul>

<h3 id="label-Parser">Parser<span><a href="#label-Parser">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>If this property is defined as a string, it is interpreted as a custom
format to be used by moment to parse the date.</p>

<p>If this is a function, it must return a moment.js object given the
appropriate data value.</p>
</main>
