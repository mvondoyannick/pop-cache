...
<title>logarithmic - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Logarithmic+Cartesian+Axis">Logarithmic Cartesian Axis</a>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/cartesian/logarithmic.md">

<h1 id="label-Logarithmic+Cartesian+Axis">Logarithmic Cartesian Axis<span><a href="#label-Logarithmic+Cartesian+Axis">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The logarithmic scale is use to chart numerical data. It can be placed on
either the x or y axis. As the name suggests, logarithmic interpolation is
used to determine where a value lies on the axis.</p>
...
<p>The following options are provided by the logarithmic scale. They are all
...
scale, overrides minimum value from data. | <code>max</code> |
<code>Number</code> | | <a href="../../../../../User.html">User</a> defined
maximum number for the scale, overrides maximum value from data.</p>
</main>
