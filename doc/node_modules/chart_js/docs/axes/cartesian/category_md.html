...
<title>category - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Category+Cartesian+Axis">Category Cartesian Axis</a>
    <li><a href="#label-Category+Axis+Definition">Category Axis Definition</a>
    <li><a href="#label-Tick+Configuration+Options">Tick Configuration Options</a>
    <li><a href="#label-Min+Max+Configuration">Min Max Configuration</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/cartesian/category.md">

<h1 id="label-Category+Cartesian+Axis">Category Cartesian Axis<span><a href="#label-Category+Cartesian+Axis">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>If global configuration is used, labels are drawn from one of the label
arrays included in the chart data. If only <code>data.labels</code> is
defined, this will be used. If <code>data.xLabels</code> is defined and the
axis is horizontal, this will be used. Similarly, if
...
<p>Specifying any of the settings above defines the x axis as <code>type:
category</code> if not defined otherwise. For more fine-grained control of
category labels it is also possible to add <code>labels</code> as part of
the category axis definition. Doing so does not apply the global defaults.</p>

<h2 id="label-Category+Axis+Definition">Category Axis Definition<span><a href="#label-Category+Axis+Definition">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>The category scale provides the following options for configuring tick
marks. They are nested in the <code>ticks</code> sub object. These options
extend the <a href="README.md#tick-configuration">common tick
configuration</a>.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>labels</code> | <code>Array[String]</code> | - | An array of labels
to display. | <code>min</code> | <code>String</code> | | The minimum item
to display. <a href="#min-max-configuration">more…</a> | <code>max</code> |
<code>String</code> | | The maximum item to display. <a
href="#min-max-configuration">more…</a></p>

<h2 id="label-Min+Max+Configuration">Min Max Configuration<span><a href="#label-Min+Max+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>For both the <code>min</code> and <code>max</code> properties, the value
must be in the <code>labels</code> array. In the example below, the x axis
would only display “March” through “June”.</p>
