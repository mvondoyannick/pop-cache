...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Axes">Axes</a>
    <li><a href="#label-Common+Configuration">Common Configuration</a>
    <li><a href="#label-Callbacks">Callbacks</a>
    <li><a href="#label-Updating+Axis+Defaults">Updating Axis Defaults</a>
    <li><a href="#label-Creating+New+Axes">Creating New Axes</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/axes/README.md">

<h1 id="label-Axes">Axes<span><a href="#label-Axes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Axes are an integral part of a chart. They are used to determine how data
maps to a pixel value on the chart. In a cartesian chart, there is 1 or
more X axis and 1 or more Y axis to map points onto the 2 dimensional
canvas. These axes are know as <a
href="./cartesian/README.md#cartesian-axes">‘cartesian axes’</a>.</p>

<p>In a radial chart, such as a radar chart or a polar area chart, there is a
single axis that maps points in the angular and radial directions. These
are known as <a href="./radial/README.md#radial-axes">‘radial axes’</a>.</p>

<p>Scales in Chart.js &gt;V2.0 are significantly more powerful, but also
different than those of v1.0. * Multiple X &amp; Y axes are supported. * A
...
Scale titles are supported * New scale types can be extended without
writing an entirely new chart type</p>

<h1 id="label-Common+Configuration">Common Configuration<span><a href="#label-Common+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The following properties are common to all axes provided by Chart.js</p>

<p>| Name | Type | Default | Description | —- | —- | ——- | ———– |
<code>display</code> | <code>Boolean</code> | <code>true</code> | If set to
<code>false</code> the axis is hidden from view. Overrides
<em>gridLines.display</em>, <em>scaleLabel.display</em>, and
<em>ticks.display</em>. | <code>callbacks</code> | <code>Object</code> | |
Callback functions to hook into the axis lifecycle. <a
href="#callbacks">more…</a> | <code>weight</code> | <code>Number</code> |
<code>0</code> | The weight used to sort the axis. Higher weights are
further away from the chart area.</p>

<h2 id="label-Callbacks">Callbacks<span><a href="#label-Callbacks">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>There are a number of config callbacks that can be used to change
parameters in the scale at different points in the update process.</p>

<p>| Name | Arguments | Description | —- | ——— | ———– |
<code>beforeUpdate</code> | <code>axis</code> | Callback called before the
update process starts. | <code>beforeSetDimensions</code> |
<code>axis</code> | Callback that runs before dimensions are set. |
<code>afterSetDimensions</code> | <code>axis</code> | Callback that runs
after dimensions are set. | <code>beforeDataLimits</code> |
<code>axis</code> | Callback that runs before data limits are determined. |
<code>afterDataLimits</code> | <code>axis</code> | Callback that runs after
data limits are determined. | <code>beforeBuildTicks</code> |
<code>axis</code> | Callback that runs before ticks are created. |
<code>afterBuildTicks</code> | <code>axis</code> | Callback that runs after
ticks are created. Useful for filtering ticks. |
<code>beforeTickToLabelConversion</code> | <code>axis</code> | Callback
that runs before ticks are converted into strings. |
<code>afterTickToLabelConversion</code> | <code>axis</code> | Callback that
runs after ticks are converted into strings. |
<code>beforeCalculateTickRotation</code> | <code>axis</code> | Callback
that runs before tick rotation is determined. |
<code>afterCalculateTickRotation</code> | <code>axis</code> | Callback that
runs after tick rotation is determined. | <code>beforeFit</code> |
<code>axis</code> | Callback that runs before the scale fits to the canvas.
| <code>afterFit</code> | <code>axis</code> | Callback that runs after the
scale fits to the canvas. | <code>afterUpdate</code> | <code>axis</code> |
Callback that runs at the end of the update process.</p>

<h2 id="label-Updating+Axis+Defaults">Updating Axis Defaults<span><a href="#label-Updating+Axis+Defaults">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The default configuration for a scale can be easily changed using the scale
...
<p>For example, to set the minimum value of 0 for all linear scales, you would
do the following. Any linear scales created after this time would now have
a minimum of 0.</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-identifier">scaleService</span>.<span class="ruby-identifier">updateScaleDefaults</span>(<span class="ruby-string">&#39;linear&#39;</span>, {
...
<h2 id="label-Creating+New+Axes">Creating New Axes<span><a href="#label-Creating+New+Axes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To create a new axis, see the <a href="../developers/axes.md">developer
docs</a>.</p>
</main>
