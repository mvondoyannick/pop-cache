...
<title>charts - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-New+Charts">New Charts</a>
    <li><a href="#label-Dataset+Controller+Interface">Dataset Controller Interface</a>
    <li><a href="#label-Extending+Existing+Chart+Types">Extending Existing Chart Types</a>
    <li><a href="#label-Bar+Controller">Bar Controller</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/charts.md">

<h1 id="label-New+Charts">New Charts<span><a href="#label-New+Charts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Chart.js 2.0 introduces the concept of controllers for each dataset. Like
scales, new controllers can be written as needed.</p>

<pre>Chart.controllers.MyType = Chart.DatasetController.extend({
...
<h2 id="label-Dataset+Controller+Interface">Dataset Controller Interface<span><a href="#label-Dataset+Controller+Interface">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<p>The following methods may optionally be overridden by derived dataset
controllers “`javascript {  // Initializes the controller  initialize:
function(chart, datasetIndex) {},</p>

<pre>// Ensures that the dataset represented by this controller is linked to a scale. Overridden to helpers.noop in the polar area and doughnut controllers as these
// chart types using a single scale
linkScales: function() {},

// Called by the main chart controller when an update is triggered. The default implementation handles the number of data points changing and creating elements appropriately.
buildOrUpdateElements: function() {}</pre>

<p>} “`</p>

<h2 id="label-Extending+Existing+Chart+Types">Extending Existing Chart Types<span><a href="#label-Extending+Existing+Chart+Types">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Extending or replacing an existing controller type is easy. Simply replace
the constructor for one of the built in types with your own.</p>

<p>The built in controller types are: * <code>Chart.controllers.line</code> *
<code>Chart.controllers.bar</code> * <code>Chart.controllers.radar</code> *
<code>Chart.controllers.doughnut</code> *
<code>Chart.controllers.polarArea</code> *
<code>Chart.controllers.bubble</code></p>

<p>For example, to derive a new chart type that extends from a bubble chart,
you would do the following.</p>

<pre>// Sets the default config for &#39;derivedBubble&#39; to be the same as the bubble defaults.
...
<h3 id="label-Bar+Controller">Bar Controller<span><a href="#label-Bar+Controller">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The bar controller has a special property that you should be aware of. To
correctly calculate the width of a bar, the controller must determine the
number of datasets that map to bars. To do this, the bar controller
attaches a property <code>bar</code> to the dataset during initialization.
If you are creating a replacement or updated bar controller, you should do
the same. This will ensure that charts with regular bars and your new
derived bars will work seamlessly.</p>
</main>
