...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Developers">Developers</a>
    <li><a href="#label-Latest+resources">Latest resources</a>
    <li><a href="#label-Development+releases">Development releases</a>
    <li><a href="#label-Browser+support">Browser support</a>
    <li><a href="#label-Previous+versions">Previous versions</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/README.md">

<h1 id="label-Developers">Developers<span><a href="#label-Developers">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Developer features allow extending and enhancing Chart.js in many different
ways.</p>

<h1 id="label-Latest+resources">Latest resources<span><a href="#label-Latest+resources">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Latest documentation and samples, including unreleased features, are
available at:</p>
<ul><li>
<p><a
href="http://www.chartjs.org/docs/master">www.chartjs.org/docs/master</a>/</p>
</li><li>
<p><a
href="http://www.chartjs.org/samples/master">www.chartjs.org/samples/master</a>/</p>
</li></ul>

<h1 id="label-Development+releases">Development releases<span><a href="#label-Development+releases">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Latest builds are available for testing at:</p>
<ul><li>
<p><a
href="http://www.chartjs.org/dist/master/Chart.min.js">www.chartjs.org/dist/master/Chart.min.js</a></p>
</li><li>
<p><a
href="http://www.chartjs.org/dist/master/Chart.bundle.min.js">www.chartjs.org/dist/master/Chart.bundle.min.js</a></p>
</li></ul>

<blockquote>
<p>Note: Development builds are currently only available via HTTP, so in order
to include them in <a href="http://jsfiddle.net">JSFiddle</a> or <a
href="http://codepen.io">CodePen</a>, you need to access these tools via
HTTP as well.</p>
</blockquote>

<p><strong>WARNING: Development builds MUST not be used for production
purposes or as replacement for CDN.</strong></p>

<h1 id="label-Browser+support">Browser support<span><a href="#label-Browser+support">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Chart.js offers support for the following browsers: * Chrome 50+ * Firefox
45+ * Internet Explorer 11 * Edge 14+ * Safari 9+</p>

<p>Browser support for the canvas element is available in all modern &amp;
major mobile browsers. <a
href="http://caniuse.com/#feat=canvas">CanIUse</a></p>

<p>Thanks to <a href="https://browserstack.com">BrowserStack</a> for allowing
our team to test on thousands of browsers.</p>

<h1 id="label-Previous+versions">Previous versions<span><a href="#label-Previous+versions">&para;</a> <a href="#top">&uarr;</a></span></h1>
...
<p>Please use the documentation that is available on <a
href="http://www.chartjs.org/docs/">chartjs.org</a> for the current version
of Chart.js.</p>

<p>Please note - documentation for previous versions are available on the
GitHub repo.</p>
<ul><li>
<p><a href="https://github.com/chartjs/Chart.js/tree/v1.1.1/docs">1.x
Documentation</a></p>
</li></ul>
</main>
