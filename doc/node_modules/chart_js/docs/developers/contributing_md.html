...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Joining+the+project">Joining the project</a>
    <li><a href="#label-Building+and+Testing">Building and Testing</a>
    <li><a href="#label-Bugs+and+Issues">Bugs and Issues</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/contributing.md">

<h1 id="label-Contributing">Contributing<span><a href="#label-Contributing">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>New contributions to the library are welcome, but we ask that you please
follow these guidelines:</p>
<ul><li>
<p>Use tabs for indentation, not spaces.</p>
</li><li>
<p>Only change the individual files in <code>/src</code>.</p>
</li><li>
<p>Check that your code will pass <code>eslint</code> code standards,
<code>gulp lint</code> will run this for you.</p>
</li><li>
<p>Check that your code will pass tests, <code>gulp test</code> will run tests
for you.</p>
</li><li>
<p>Keep pull requests concise, and document new functionality in the relevant
<code>.md</code> file.</p>
</li><li>
<p>Consider whether your changes are useful for all users, or if creating a
Chart.js <a href="plugins.md">plugin</a> would be more appropriate.</p>
</li><li>
<p>Avoid breaking changes unless there is an upcoming major release, which are
infrequent. We encourage people to write plugins for most new advanced
features, so care a lot about backwards compatibility.</p>
</li></ul>

<h1 id="label-Joining+the+project">Joining the project<span><a href="#label-Joining+the+project">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Active committers and contributors are invited to introduce yourself and
request commit access to this project. We have a very active Slack
community that you can join <a
href="https://chartjs-slack.herokuapp.com/">here</a>. If you think you can
help, we&#39;d love to have you!</p>

<h1 id="label-Building+and+Testing">Building and Testing<span><a href="#label-Building+and+Testing">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Chart.js uses &lt;a href=“<a href="http://gulpjs.com">gulpjs.com</a>/”
target=“_blank”&gt;gulp&lt;/a&gt; to build the library into a single
JavaScript file.</p>

<p>Firstly, we need to ensure development dependencies are installed. With
node and npm installed, after cloning the Chart.js repo to a local
...
with a CLI for the JavaScript task runner &lt;a href=“<a
href="http://gulpjs.com">gulpjs.com</a>/”
target=“_blank”&gt;gulp&lt;/a&gt;.</p>

<p>The following commands are now available from the repository root:</p>

<pre>&gt; gulp build                // build Chart.js in ./dist
...
&gt; gulp docs --watch         // starts the gitbook live reloaded server</pre>

<p>More information can be found in <a
href="https://github.com/chartjs/Chart.js/blob/master/gulpfile.js">gulpfile.js</a>.</p>

<h1 id="label-Bugs+and+Issues">Bugs and Issues<span><a href="#label-Bugs+and+Issues">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Please report these on the GitHub page - at &lt;a href=“<a
...
the <a href="http://stackoverflow.com/questions/tagged/chartjs">chartjs</a>
...
<ul><li>
<p>Check the issue search to see if it has already been reported</p>
</li><li>
<p>Isolate the problem to a simple test case</p>
</li><li>
<p>Please include a demonstration of the bug on a website such as <a
href="http://jsbin.com/">JS Bin</a>, <a href="http://jsfiddle.net/">JS
Fiddle</a>, or <a href="http://codepen.io/pen/">Codepen</a>. (<a
href="http://codepen.io/pen?template=JXVYzq">Template</a>)</p>
</li></ul>

<p>Please provide any additional details associated with the bug, if it&#39;s
browser or screen density specific, or only happens with a certain
configuration or data.</p>
</main>
