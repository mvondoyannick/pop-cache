...
<title>axes - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-New+Axes">New Axes</a>
    <li><a href="#label-Scale+Properties">Scale Properties</a>
    <li><a href="#label-Scale+Interface">Scale Interface</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/axes.md">

<h1 id="label-New+Axes">New Axes<span><a href="#label-New+Axes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Axes in Chart.js can be individually extended. Axes should always derive
from Chart.Scale but this is not a mandatory requirement.</p>

<pre>let MyScale = Chart.Scale.extend({
       extensions ...   
});

// MyScale is now derived from Chart.Scale</pre>
...
may be provided when registering the constructor. The first parameter to
the register function is a string key that is used later to identify which
scale type to use for a chart.</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-identifier">scaleService</span>.<span class="ruby-identifier">registerScaleType</span>(<span class="ruby-string">&#39;myScale&#39;</span>, <span class="ruby-constant">MyScale</span>, <span class="ruby-identifier">defaultConfigObject</span>);
</pre>

<p>To use the new scale, simply pass in the string key to the config when
creating a chart.</p>

<pre>var lineChart = new Chart(ctx, {
    data: data,
    type: &#39;line&#39;,
    options: {
        scales: {
...
<h2 id="label-Scale+Properties">Scale Properties<span><a href="#label-Scale+Properties">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Scale instances are given the following properties during the fitting
process.</p>
...
<h2 id="label-Scale+Interface">Scale Interface<span><a href="#label-Scale+Interface">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To work with Chart.js, custom scale types must implement the following
interface.</p>
...
<p>Optionally, the following methods may also be overwritten, but an
implementation is already provided by the <code>Chart.Scale</code> base
class.</p>

<pre>// Transform the ticks array of the scale instance into strings. The default implementation simply calls this.options.ticks.callback(numericalTick, index, ticks);
    ...
    draw: function(chartArea) {},</pre>

<p>The Core.Scale base class also has some utility functions that you may find
useful. “`javascript {  // Returns true if the scale instance is horizontal
isHorizontal: function() {},</p>

<pre>// Get the correct value from the value from this.chart.data.datasets[x].data[]
...
getRightValue: function(dataValue) {},</pre>
