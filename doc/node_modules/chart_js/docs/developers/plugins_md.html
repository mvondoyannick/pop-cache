...
<title>plugins - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Global+plugins">Global plugins</a>
    <li><a href="#label-Configuration">Configuration</a>
    <li><a href="#label-Plugin+ID">Plugin ID</a>
    <li><a href="#label-Plugin+options">Plugin options</a>
    <li><a href="#label-Disable+plugins">Disable plugins</a>
    <li><a href="#label-Plugin+Core+API">Plugin Core API</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/plugins.md">

<h1 id="label-Plugins">Plugins<span><a href="#label-Plugins">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Plugins are the most efficient way to customize or change the default
behavior of a chart. They have been introduced at <a
href="https://github.com/chartjs/Chart.js/releases/tag/2.1.0">version
2.1.0</a> (global plugins only) and extended at <a
href="https://github.com/chartjs/Chart.js/releases/tag/v2.5.0">version
2.5.0</a> (per chart plugins and options).</p>
...
<pre>var plugin = {    plugin implementation    };
...
var chart3 = new Chart(ctx, {});</pre>

<p>Plugins can also be defined directly in the chart <code>plugins</code>
config (a.k.a. <em>inline plugins</em>):</p>
...
<p>However, this approach is not ideal when the customization needs to apply
to many charts.</p>

<h2 id="label-Global+plugins">Global plugins<span><a href="#label-Global+plugins">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Plugins can be registered globally to be applied on all charts (a.k.a.
<em>global plugins</em>):</p>

<pre>Chart.plugins.register({
...
<h3 id="label-Plugin+ID">Plugin ID<span><a href="#label-Plugin+ID">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Plugins must define a unique id in order to be configurable.</p>

<p>This id should follow the <a
href="https://docs.npmjs.com/files/package.json#name">npm package name
convention</a>:</p>
<ul><li>
<p>can&#39;t start with a dot or an underscore</p>
</li><li>
<p>can&#39;t contain any non-URL-safe characters</p>
</li><li>
<p>can&#39;t contain uppercase letters</p>
</li><li>
<p>should be something short, but also reasonably descriptive</p>
</li></ul>

<p>If a plugin is intended to be released publicly, you may want to check the
<a href="https://www.npmjs.com/search?q=chartjs-plugin-">registry</a> to
see if there&#39;s something by that name already. Note that in this case,
the package name should be prefixed by <code>chartjs-plugin-</code> to
appear in Chart.js plugin registry.</p>

<h3 id="label-Plugin+options">Plugin options<span><a href="#label-Plugin+options">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Plugin options are located under the <code>options.plugins</code> config
and are scoped by the plugin ID: <code>options.plugins.{plugin-id}</code>.</p>
...
<h4 id="label-Disable+plugins">Disable plugins<span><a href="#label-Disable+plugins">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>To disable a global plugin for a specific chart instance, the plugin
options must be set to <code>false</code>:</p>
...
<h2 id="label-Plugin+Core+API">Plugin Core API<span><a href="#label-Plugin+Core+API">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Available hooks (as of version 2.6):</p>

<p>beforeInit  afterInit  beforeUpdate <em>(cancellable)</em>  afterUpdate 
beforeLayout <em>(cancellable)</em>  afterLayout  beforeDatasetsUpdate
<em>(cancellable)</em>  afterDatasetsUpdate  beforeDatasetUpdate
<em>(cancellable)</em>  afterDatasetUpdate  beforeRender
<em>(cancellable)</em>  afterRender  beforeDraw <em>(cancellable)</em> 
afterDraw  beforeDatasetsDraw <em>(cancellable)</em>  afterDatasetsDraw 
beforeDatasetDraw <em>(cancellable)</em>  afterDatasetDraw  beforeEvent
<em>(cancellable)</em>  afterEvent  resize  destroy</p>
</main>
