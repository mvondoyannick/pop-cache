...
<title>updates - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Updating+Charts">Updating Charts</a>
    <li><a href="#label-Adding+or+Removing+Data">Adding or Removing Data</a>
    <li><a href="#label-Updating+Options">Updating Options</a>
    <li><a href="#label-Preventing+Animations">Preventing Animations</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/updates.md">

<h1 id="label-Updating+Charts">Updating Charts<span><a href="#label-Updating+Charts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>It&#39;s pretty common to want to update charts after they&#39;ve been
created. When the chart data or options are changed, Chart.js will animate
to the new data values and options.</p>

<h2 id="label-Adding+or+Removing+Data">Adding or Removing Data<span><a href="#label-Adding+or+Removing+Data">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Adding and removing data is supported by changing the data array. To add
data, just add data into the data array as seen in this example.</p>

<pre>function addData(chart, label, data) {
...
<h2 id="label-Updating+Options">Updating Options<span><a href="#label-Updating+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>To update the options, mutating the options property in place or passing in
a new options object are supported.</p>
<ul><li>
<p>If the options are mutated in place, other option properties would be
preserved, including those calculated by Chart.js.</p>
</li><li>
<p>If created as a new object, it would be like creating a new chart with the
options - old options would be discarded.</p>
</li></ul>

<pre class="ruby"><span class="ruby-identifier">function</span> <span class="ruby-identifier">updateConfigByMutating</span>(<span class="ruby-identifier">chart</span>) {
    <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">options</span>.<span class="ruby-identifier">title</span>.<span class="ruby-identifier">text</span> = <span class="ruby-string">&#39;new title&#39;</span>;
    <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();
}

<span class="ruby-identifier">function</span> <span class="ruby-identifier">updateConfigAsNewObject</span>(<span class="ruby-identifier">chart</span>) {
    <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">options</span> = {
        <span class="ruby-value">responsive:</span> <span class="ruby-keyword">true</span>,
        <span class="ruby-value">title:</span>{
            <span class="ruby-value">display:</span><span class="ruby-keyword">true</span>,
            <span class="ruby-value">text:</span> <span class="ruby-string">&#39;Chart.js&#39;</span>
        },
...
<p>Scales can be updated separately without changing other options. To update
the scales, pass in an object containing all the customization including
those unchanged ones.</p>

<p>Variables referencing any one from <code>chart.scales</code> would be lost
after updating scales with a new <code>id</code> or the changed
<code>type</code>.</p>

<pre>function updateScales(chart) {
...
<pre class="ruby"><span class="ruby-identifier">function</span> <span class="ruby-identifier">updateScale</span>(<span class="ruby-identifier">chart</span>) {
    <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">options</span>.<span class="ruby-identifier">scales</span>.<span class="ruby-identifier">yAxes</span>[<span class="ruby-value">0</span>] = {
        <span class="ruby-value">type:</span> <span class="ruby-string">&#39;logarithmic&#39;</span>
    }
    <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();
}
</pre>

<p>Code sample for updating options can be found in <a
href="../../samples/scales/toggle-scale-type.html">toggle-scale-type.html</a>.</p>

<h2 id="label-Preventing+Animations">Preventing Animations<span><a href="#label-Preventing+Animations">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Sometimes when a chart updates, you may not want an animation. To achieve
this you can call <code>update</code> with a duration of <code>0</code>.
This will render the chart synchronously and without an animation.</p>
</main>
