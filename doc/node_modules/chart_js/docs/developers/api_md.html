...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Chart+Prototype+Methods">Chart Prototype Methods</a>
    <li><a href="#label-.destroy-28-29">.destroy()</a>
    <li><a href="#label-.update-28config-29">.update(config)</a>
    <li><a href="#label-.reset-28-29">.reset()</a>
    <li><a href="#label-.render-28config-29">.render(config)</a>
    <li><a href="#label-.stop-28-29">.stop()</a>
    <li><a href="#label-.resize-28-29">.resize()</a>
    <li><a href="#label-.clear-28-29">.clear()</a>
    <li><a href="#label-.toBase64Image-28-29">.toBase64Image()</a>
    <li><a href="#label-.generateLegend-28-29">.generateLegend()</a>
    <li><a href="#label-.getElementAtEvent-28e-29">.getElementAtEvent(e)</a>
    <li><a href="#label-.getElementsAtEvent-28e-29">.getElementsAtEvent(e)</a>
    <li><a href="#label-.getDatasetAtEvent-28e-29">.getDatasetAtEvent(e)</a>
    <li><a href="#label-.getDatasetMeta-28index-29">.getDatasetMeta(index)</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/developers/api.md">

<h1 id="label-Chart+Prototype+Methods">Chart Prototype Methods<span><a href="#label-Chart+Prototype+Methods">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>For each chart, there are a set of global prototype methods on the shared
<code>ChartType</code> which you may find useful. These are available on
all charts created with Chart.js, but for the examples, let&#39;s use a
line chart we&#39;ve made.</p>

<pre>// For example:
var myLineChart = new Chart(ctx, config);</pre>

<h2 id="label-.destroy-28-29">.destroy()<span><a href="#label-.destroy-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Use this to destroy any chart instances that are created. This will clean
...
before the canvas is reused for a new chart.</p>

<pre>// Destroys a specific chart instance
myLineChart.destroy();</pre>

<h2 id="label-.update-28config-29">.update(config)<span><a href="#label-.update-28config-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Triggers an update of the chart. This can be safely called after updating
the data object. This will update all scales, legends, and then re-render
the chart.</p>

<pre>// duration is the time for the animation of the redraw in milliseconds
// lazy is a boolean. if true, the animation can be interrupted by other animations
myLineChart.data.datasets[0].data[2] = 50; // Would update the first dataset&#39;s value of &#39;March&#39; to be 50
myLineChart.update(); // Calling update now animates the position of March from 90 to 50.</pre>

<blockquote>
<p><strong>Note:</strong> replacing the data reference (e.g.
<code>myLineChart.data = {datasets: [...]}</code> only works starting
<strong>version 2.6</strong>. Prior that, replacing the entire data object
could be achieved with the following workaround:
<code>myLineChart.config.data = {datasets: [...]}</code>.</p>
</blockquote>

<p>A <code>config</code> object can be provided with additional configuration
for the update process. This is useful when <code>update</code> is manually
called inside an event handler and some different animation is desired.</p>

<p>The following properties are supported: * <strong>duration</strong>
(number): Time for the animation of the redraw in milliseconds *
<strong>lazy</strong> (boolean): If true, the animation can be interrupted
by other animations * <strong>easing</strong> (string): The animation
easing function. See <a href="../configuration/animations.md">Animation
Easing</a> for possible values.</p>

<p>Example: <code>javascript myChart.update({     duration: 800,     easing:
&#39;easeOutBounce&#39; }) </code></p>

<p>See <a href="updates.md">Updating Charts</a> for more details.</p>

<h2 id="label-.reset-28-29">.reset()<span><a href="#label-.reset-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Reset the chart to it&#39;s state before the initial animation. A new
animation can then be triggered using <code>update</code>.</p>

<pre class="ruby"><span class="ruby-identifier">myLineChart</span>.<span class="ruby-identifier">reset</span>();
</pre>

<h2 id="label-.render-28config-29">.render(config)<span><a href="#label-.render-28config-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Triggers a redraw of all chart elements. Note, this does not update
elements for new data. Use <code>.update()</code> in that case.</p>
...
<h2 id="label-.stop-28-29">.stop()<span><a href="#label-.stop-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Use this to stop any current animation loop. This will pause the chart
during any current animation frame. Call <code>.render()</code> to
re-animate.</p>

<pre>// Stops the charts animation loop at its current frame
myLineChart.stop();
// =&gt; returns &#39;this&#39; for chainability</pre>

<h2 id="label-.resize-28-29">.resize()<span><a href="#label-.resize-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Use this to manually resize the canvas element. This is run each time the
canvas container is resized, but you can call this method manually if you
change the size of the canvas nodes container element.</p>

<pre>// Resizes &amp; redraws to fill its container element
myLineChart.resize();
// =&gt; returns &#39;this&#39; for chainability</pre>

<h2 id="label-.clear-28-29">.clear()<span><a href="#label-.clear-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Will clear the chart canvas. Used extensively internally between animation
frames, but you might find it useful.</p>

<pre>// Will clear the canvas that myLineChart is drawn on
myLineChart.clear();
// =&gt; returns &#39;this&#39; for chainability</pre>

<h2 id="label-.toBase64Image-28-29">.toBase64Image()<span><a href="#label-.toBase64Image-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>This returns a base 64 encoded string of the chart in it&#39;s current
state.</p>

<pre>myLineChart.toBase64Image();
// =&gt; returns png data url of the image on the canvas</pre>

<h2 id="label-.generateLegend-28-29">.generateLegend()<span><a href="#label-.generateLegend-28-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Returns an HTML string of a legend for that chart. The legend is generated
from the <code>legendCallback</code> in the options.</p>

<pre>myLineChart.generateLegend();
// =&gt; returns HTML string of a legend for this chart</pre>

<h2 id="label-.getElementAtEvent-28e-29">.getElementAtEvent(e)<span><a href="#label-.getElementAtEvent-28e-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Calling <code>getElementAtEvent(event)</code> on your Chart instance
passing an argument of an event, or jQuery event, will return the single
element at the event position. If there are multiple items within range,
only the first is returned. The value returned from this method is an array
with a single parameter. An array is used to keep a consistent API between
the <code>get*AtEvent</code> methods.</p>

<pre>myLineChart.getElementAtEvent(e);
// =&gt; returns the first element at the event point.</pre>

<p>To get an item that was clicked on, <code>getElementAtEvent</code> can be
used.</p>

<pre>function clickHandler(evt) {
...
<h2 id="label-.getElementsAtEvent-28e-29">.getElementsAtEvent(e)<span><a href="#label-.getElementsAtEvent-28e-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Looks for the element under the event point, then returns all elements at
the same data index. This is used internally for &#39;label&#39; mode
highlighting.</p>

<p>Calling <code>getElementsAtEvent(event)</code> on your Chart instance
passing an argument of an event, or jQuery event, will return the point
elements that are at that the same position of that event.</p>

<pre>canvas.onclick = function(evt){
...
<h2 id="label-.getDatasetAtEvent-28e-29">.getDatasetAtEvent(e)<span><a href="#label-.getDatasetAtEvent-28e-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Looks for the element under the event point, then returns all elements from
that dataset. This is used internally for &#39;dataset&#39; mode
highlighting</p>

<pre>myLineChart.getDatasetAtEvent(e);
// =&gt; returns an array of elements</pre>

<h2 id="label-.getDatasetMeta-28index-29">.getDatasetMeta(index)<span><a href="#label-.getDatasetMeta-28index-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Looks for the dataset that matches the current index and returns that
metadata. This returned data has all of the metadata that is used to
construct the chart.</p>

<p>The <code>data</code> property of the metadata will contain information
about each point, rectangle, etc. depending on the chart type.</p>

<p>Extensive examples of usage are available in the <a
href="https://github.com/chartjs/Chart.js/tree/master/test">Chart.js
tests</a>.</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">meta</span> = <span class="ruby-identifier">myChart</span>.<span class="ruby-identifier">getDatasetMeta</span>(<span class="ruby-value">0</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">x</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>].<span class="ruby-identifier">_model</span>.<span class="ruby-identifier">x</span>
</pre>
</main>
