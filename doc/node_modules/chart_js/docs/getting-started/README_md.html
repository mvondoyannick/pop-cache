...
<main role="main" aria-label="Page node_modules/chart.js/docs/getting-started/README.md">
...
<pre>&lt;canvas id=&quot;myChart&quot;&gt;&lt;/canvas&gt;</pre>

<p>Now that we have a canvas we can use, we need to include Chart.js in our
page.</p>

<pre>&lt;script src=&quot;https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.4.0/Chart.min.js&quot;&gt;&lt;/script&gt;</pre>

<p>Now, we can create a chart. We add a script to our page:</p>

<pre>var ctx = document.getElementById(&#39;myChart&#39;).getContext(&#39;2d&#39;);
...
the many options that can help you customise your charts with scales,
tooltips, labels, colors, custom actions, and much more.</p>

<p>There are many examples of Chart.js that are available in the
<code>/samples</code> folder of <code>Chart.js.zip</code> that is attached
to every <a
href="https://github.com/chartjs/Chart.js/releases">release</a>.</p>
</main>
