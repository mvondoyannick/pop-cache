...
<title>legend - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Legend+Configuration">Legend Configuration</a>
    <li><a href="#label-Configuration+options">Configuration options</a>
    <li><a href="#label-Position">Position</a>
    <li><a href="#label-Legend+Label+Configuration">Legend Label Configuration</a>
    <li><a href="#label-Legend+Item+Interface">Legend Item Interface</a>
    <li><a href="#label-Example">Example</a>
    <li><a href="#label-Custom+On+Click+Actions">Custom On Click Actions</a>
    <li><a href="#label-HTML+Legends">HTML Legends</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/configuration/legend.md">

<h1 id="label-Legend+Configuration">Legend Configuration<span><a href="#label-Legend+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The chart legend displays data about the datasets that are appearing on the
chart.</p>
...
<p>The legend configuration is passed into the <code>options.legend</code>
namespace. The global options for the chart legend is defined in
<code>Chart.defaults.global.legend</code>.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>display</code> | <code>Boolean</code> | <code>true</code> | is the
legend shown | <code>position</code> | <code>String</code> |
<code>&#39;top&#39;</code> | Position of the legend. <a
href="#position">more…</a> | <code>fullWidth</code> | <code>Boolean</code>
| <code>true</code> | Marks that this box should take the full width of the
canvas (pushing down other boxes). This is unlikely to need to be changed
in day-to-day use. | <code>onClick</code> | <code>Function</code> | | A
callback that is called when a click event is registered on a label item |
<code>onHover</code> | <code>Function</code> | | A callback that is called
when a &#39;mousemove&#39; event is registered on top of a label item |
<code>reverse</code> | <code>Boolean</code> | <code>false</code> | Legend
will show datasets in reverse order. | <code>labels</code> |
<code>Object</code> | | See the <a
href="#legend-label-configuration">Legend Label Configuration</a> section
below.</p>

<h2 id="label-Position">Position<span><a href="#label-Position">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Position of the legend. Options are: * <code>&#39;top&#39;</code> *
<code>&#39;left&#39;</code> * <code>&#39;bottom&#39;</code> *
<code>&#39;right&#39;</code></p>

<h2 id="label-Legend+Label+Configuration">Legend Label Configuration<span><a href="#label-Legend+Label+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The legend label configuration is nested below the legend configuration
using the <code>labels</code> key.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>boxWidth</code> | <code>Number</code> | <code>40</code> | width of
coloured box | <code>fontSize</code> | <code>Number</code> |
<code>12</code> | font size of text | <code>fontStyle</code> |
<code>String</code> | <code>&#39;normal&#39;</code> | font style of text |
<code>fontColor</code> | <code>Color</code> | <code>&#39;#666&#39;</code> |
Color of text | <code>fontFamily</code> | <code>String</code> |
<code>&quot;&#39;Helvetica Neue&#39;, &#39;Helvetica&#39;, &#39;Arial&#39;,
sans-serif&quot;</code> | Font family of legend text. |
<code>padding</code> | <code>Number</code> | <code>10</code> | Padding
between rows of colored boxes. | <code>generateLabels</code> |
<code>Function</code> | | Generates legend items for each thing in the
legend. Default implementation returns the text + styling for the color
box. See <a href="#legend-item-interface">Legend Item</a> for details. |
<code>filter</code> | <code>Function</code> | <code>null</code> | Filters
legend items out of the legend. Receives 2 parameters, a <a
href="#legend-item-interface">Legend Item</a> and the chart data. |
<code>usePointStyle</code> | <code>Boolean</code> | <code>false</code> |
Label style will match corresponding point style (size is based on
fontSize, boxWidth is not used in this case).</p>

<h2 id="label-Legend+Item+Interface">Legend Item Interface<span><a href="#label-Legend+Item+Interface">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Items passed to the legend <code>onClick</code> function are the ones
returned from <code>labels.generateLabels</code>. These items must
...
<p>The following example will create a chart with the legend enabled and turn
all of the text red in color.</p>
...
<h2 id="label-Custom+On+Click+Actions">Custom On Click Actions<span><a href="#label-Custom+On+Click+Actions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>It can be common to want to trigger different behaviour when clicking an
item in the legend. This can be easily achieved using a callback in the
config object.</p>

<p>The default legend click handler is: “`javascript function(e, legendItem) {
var index = legendItem.datasetIndex;  var ci = this.chart;  var meta =
ci.getDatasetMeta(index);</p>

<pre>// See controller.isDatasetVisible comment
...
<p>Lets say we wanted instead to link the display of the first two datasets.
We could change the click handler accordingly.</p>

<pre>var defaultLegendClickHandler = Chart.defaults.global.legend.onClick;
...
<p>Now when you click the legend in this chart, the visibility of the first
two datasets will be linked together.</p>

<h2 id="label-HTML+Legends">HTML Legends<span><a href="#label-HTML+Legends">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Sometimes you need a very complex legend. In these cases, it makes sense to
generate an HTML legend. Charts provide a <code>generateLegend()</code>
method on their prototype that returns an HTML string for the legend.</p>

<p>To configure how this legend is generated, you can change the
<code>legendCallback</code> config property.</p>
...
<p>Note that legendCallback is not called automatically and you must call
<code>generateLegend()</code> yourself in code when creating a legend using
this method.</p>
</main>
