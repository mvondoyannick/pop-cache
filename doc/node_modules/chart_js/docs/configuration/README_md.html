...
<main role="main" aria-label="Page node_modules/chart.js/docs/configuration/README.md">

<h1 id="label-Configuration">Configuration<span><a href="#label-Configuration">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The configuration is used to change how the chart behaves. There are
properties to control styling, fonts, the legend, etc.</p>
...
<p>This concept was introduced in Chart.js 1.0 to keep configuration <a
href="https://en.wikipedia.org/wiki/Don%27t_repeat_yourself">DRY</a>, and
...
<p>Chart.js merges the options object passed to the chart with the global
configuration using chart type defaults and scales defaults appropriately.
This way you can be as specific as you would like in your individual chart
...
discussed in the documentation for that chart type.</p>

<p>The following example would set the hover mode to &#39;nearest&#39; for all
charts where this was not overridden by the chart type defaults or the
options passed to the constructor on creation.</p>

<pre>Chart.defaults.global.hover.mode = &#39;nearest&#39;;
