...
<title>layout - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Layout+Configuration">Layout Configuration</a>
    <li><a href="#label-Padding">Padding</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/configuration/layout.md">

<h1 id="label-Layout+Configuration">Layout Configuration<span><a href="#label-Layout+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>The layout configuration is passed into the <code>options.layout</code>
namespace. The global options for the chart layout is defined in
<code>Chart.defaults.global.layout</code>.</p>

<p>| Name | Type | Default | Description | —–| —- | ——–| ———– |
<code>padding</code> | <code>Number</code> or <code>Object</code> |
<code>0</code> | The padding to add inside the chart. <a
href="#padding">more…</a></p>

<h2 id="label-Padding">Padding<span><a href="#label-Padding">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If this value is a number, it is applied to all sides of the chart (left,
top, right, bottom). If this value is an object, the <code>left</code>
property defines the left padding. Similarly the <code>right</code>,
<code>top</code>, and <code>bottom</code> properties can also be specified.</p>

<p>Lets say you wanted to add 50px of padding to the left side of the chart
canvas, you would do:</p>
