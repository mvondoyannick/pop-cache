...
<title>fonts - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Non-Existant+Fonts">Non-Existant Fonts</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/general/fonts.md">

<h1 id="label-Fonts">Fonts<span><a href="#label-Fonts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>There are 4 special global settings that can change all of the fonts on the
chart. These options are in <code>Chart.defaults.global</code>. The global
font settings only apply when more specific options are not included in the
config.</p>

<p>For example, in this chart the text will all be red except for the labels
in the legend.</p>

<pre>Chart.defaults.global.defaultFontColor = &#39;red&#39;;
...
<code>defaultFontColor</code> | <code>Color</code> |
<code>&#39;#666&#39;</code> | Default font color for all text. |
<code>defaultFontFamily</code> | <code>String</code> |
<code>&quot;&#39;Helvetica Neue&#39;, &#39;Helvetica&#39;, &#39;Arial&#39;,
sans-serif&quot;</code> | Default font family for all text. |
<code>defaultFontSize</code> | <code>Number</code> | <code>12</code> |
Default font size (in px) for text. Does not apply to radialLinear scale
point labels. | <code>defaultFontStyle</code> | <code>String</code> |
<code>&#39;normal&#39;</code> | Default font style. Does not apply to
tooltip title or footer. Does not apply to chart title.</p>

<h2 id="label-Non-Existant+Fonts">Non-Existant Fonts<span><a href="#label-Non-Existant+Fonts">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If a font is specified for a chart that does exist on the system, the
browser will not apply the font when it is set. If you notice odd fonts
appearing in your charts, check that the font you are applying exists on
your system. See <a
href="https://github.com/chartjs/Chart.js/issues/3318">issue 3318</a> for
more details.</p>
</main>
