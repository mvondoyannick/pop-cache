...
<main role="main" aria-label="Page node_modules/chart.js/docs/general/README.md">

<h1 id="label-General+Configuration">General Configuration<span><a href="#label-General+Configuration">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>These sections describe general configuration options that can apply
elsewhere in the documentation.</p>
<ul><li>
<p><a href="./responsive.md">Responsive</a> defines responsive chart options
that apply to all charts.</p>
</li><li>
<p><a href="./device-pixel-ratio.md">Device Pixel Ratio</a> defines the ratio
between display pixels and rendered pixels.</p>
</li><li>
<p><a href="./interactions/README.md">Interactions</a> defines options that
reflect how hovering chart elements works.</p>
</li><li>
<p><a href="./options.md">Options</a> scriptable and indexable options syntax.</p>
</li><li>
<p><a href="./colors.md">Colors</a> defines acceptable color values.</p>
</li><li>
<p><a href="./fonts.md">Font</a> defines various font options.</p>
</li></ul>
</main>
