...
<title>options - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Scriptable+Options">Scriptable Options</a>
    <li><a href="#label-Indexable+Options">Indexable Options</a>
    <li><a href="#label-Option+Context">Option Context</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/general/options.md">

<h1 id="label-Options">Options<span><a href="#label-Options">&para;</a> <a href="#top">&uarr;</a></span></h1>

<h2 id="label-Scriptable+Options">Scriptable Options<span><a href="#label-Scriptable+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Scriptable options also accept a function which is called for each data and
that takes the unique argument <code>context</code> representing contextual
information (see <a href="options.md#option-context">option context</a>).</p>

<p>Example:</p>

<pre>color: function(context) {
...
<blockquote>
<p><strong>Note:</strong> scriptable options are only supported by a few
bubble chart options.</p>
</blockquote>

<h2 id="label-Indexable+Options">Indexable Options<span><a href="#label-Indexable+Options">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Indexable options also accept an array in which each item corresponds to
the element at the same index. Note that this method requires to provide as
many items as data, so, in most cases, using a <a
href="#scriptable-options">function</a> is more appropriated if supported.</p>
...
<h2 id="label-Option+Context">Option Context<span><a href="#label-Option+Context">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The option context is used to give contextual information when resolving
options and currently only applies to <a
href="#scriptable-options">scriptable options</a>.</p>

<p>The context object contains the following properties:</p>
<ul><li>
<p><code>chart</code>: the associated chart</p>
</li><li>
<p><code>dataIndex</code>: index of the current data</p>
</li><li>
<p><code>dataset</code>: dataset at index <code>datasetIndex</code></p>
</li><li>
<p><code>datasetIndex</code>: index of the current dataset</p>
</li></ul>

<p><strong>Important</strong>: since the context can represent different types
of entities (dataset, data, etc.), some properties may be
<code>undefined</code> so be sure to test any context property before using
it.</p>
</main>
