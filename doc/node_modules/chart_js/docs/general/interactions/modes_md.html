...
<title>modes - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Interaction+Modes">Interaction Modes</a>
    <li><a href="#label-point">point</a>
    <li><a href="#label-nearest">nearest</a>
    <li><a href="#label-single+-28deprecated-29">single (deprecated)</a>
    <li><a href="#label-label+-28deprecated-29">label (deprecated)</a>
    <li><a href="#label-index">index</a>
    <li><a href="#label-x-axis+-28deprecated-29">x-axis (deprecated)</a>
    <li><a href="#label-dataset">dataset</a>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/general/interactions/modes.md">

<h1 id="label-Interaction+Modes">Interaction Modes<span><a href="#label-Interaction+Modes">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>When configuring interaction with the graph via hover or tooltips, a number
of different modes are available.</p>

<p>The modes are detailed below and how they behave in conjunction with the
<code>intersect</code> setting.</p>

<h2 id="label-point">point<span><a href="#label-point">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h2 id="label-nearest">nearest<span><a href="#label-nearest">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Gets the item that is nearest to the point. The nearest item is determined
based on the distance to the center of the chart item (point, bar). If 2 or
more items are at the same distance, the one with the smallest area is
used. If <code>intersect</code> is true, this is only triggered when the
mouse position intersects an item in the graph. This is very useful for
combo charts where points are hidden behind bars.</p>
...
<h2 id="label-single+-28deprecated-29">single (deprecated)<span><a href="#label-single+-28deprecated-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Finds the first item that intersects the point and returns it. Behaves like
&#39;nearest&#39; mode with intersect = true.</p>

<h2 id="label-label+-28deprecated-29">label (deprecated)<span><a href="#label-label+-28deprecated-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>See <code>&#39;index&#39;</code> mode</p>

<h2 id="label-index">index<span><a href="#label-index">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Finds item at the same index. If the <code>intersect</code> setting is
true, the first intersecting item is used to determine the index in the
data. If <code>intersect</code> false the nearest item, in the x direction,
is used to determine the index.</p>
...
<p>To use index mode in a chart like the horizontal bar chart, where we search
along the y direction, you can use the <code>axis</code> setting introduced
in v2.7.0. By setting this value to <code>&#39;y&#39;</code> on the y
direction is used.</p>
...
<h2 id="label-x-axis+-28deprecated-29">x-axis (deprecated)<span><a href="#label-x-axis+-28deprecated-29">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Behaves like <code>&#39;index&#39;</code> mode with <code>intersect =
false</code>.</p>

<h2 id="label-dataset">dataset<span><a href="#label-dataset">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Finds items in the same dataset. If the <code>intersect</code> setting is
true, the first intersecting item is used to determine the index in the
data. If <code>intersect</code> false the nearest item is used to determine
the index.</p>
...
<p>Returns all items that would intersect based on the <code>X</code>
coordinate of the position only. Would be useful for a vertical cursor
implementation. Note that this only applies to cartesian charts</p>
...
<p>Returns all items that would intersect based on the <code>Y</code>
