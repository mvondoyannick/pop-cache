...
<title>events - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Event+Option">Event Option</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/general/interactions/events.md">
...
<code>events</code> | <code>String[]</code> | <code>[&quot;mousemove&quot;,
&quot;mouseout&quot;, &quot;click&quot;, &quot;touchstart&quot;,
&quot;touchmove&quot;, &quot;touchend&quot;]</code> | The
<code>events</code> option defines the browser events that the chart should
listen to for tooltips and hovering. <a href="#event-option">more…</a> |
<code>onHover</code> | <code>Function</code> | <code>null</code> | Called
when any of the events fire. Called in the context of the chart and passed
the event and an array of active elements (bars, points, etc). |
<code>onClick</code> | <code>Function</code> | <code>null</code> | Called
if the event is of type &#39;mouseup&#39; or &#39;click&#39;. Called in the
context of the chart and passed the event and an array of active elements</p>

<h2 id="label-Event+Option">Event Option<span><a href="#label-Event+Option">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>For example, to have the chart only respond to click events, you could do
<code>javascript var chart = new Chart(ctx, {     type: &#39;line&#39;,    
data: data,     options: {         // This chart will not respond to
mousemove, etc         events: [&#39;click&#39;]     } }); </code></p>
</main>
