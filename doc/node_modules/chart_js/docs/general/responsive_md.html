...
<title>responsive - RDoc Documentation</title>
...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Responsive+Charts">Responsive Charts</a>
    <li><a href="#label-Configuration+Options">Configuration Options</a>
    <li><a href="#label-Important+Note">Important Note</a>
    <li><a href="#label-Printing+Resizeable+Charts">Printing Resizeable Charts</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/chart.js/docs/general/responsive.md">

<h1 id="label-Responsive+Charts">Responsive Charts<span><a href="#label-Responsive+Charts">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>When it comes to change the chart size based on the window size, a major
limitation is that the canvas <em>render</em> size
(<code>canvas.width</code> and <code>.height</code>) can
<strong>not</strong> be expressed with relative values, contrary to the
<em>display</em> size (<code>canvas.style.width</code> and
...
<ul><li>
<p><code>&lt;canvas height=&quot;40vh&quot; width=&quot;80vw&quot;&gt;</code>:
<strong>invalid</strong> values, the canvas doesn&#39;t resize (<a
href="https://codepen.io/chartjs/pen/oWLZaR">example</a>)</p>
</li><li>
<p><code>&lt;canvas style=&quot;height:40vh; width:80vw&quot;&gt;</code>:
<strong>invalid</strong> behavior, the canvas is resized but becomes blurry
(<a href="https://codepen.io/chartjs/pen/WjxpmO">example</a>)</p>
</li></ul>

<p>Chart.js provides a <a href="#configuration-options">few options</a> to
enable responsiveness and control the resize behavior of charts by
detecting when the canvas <em>display</em> size changes and update the
<em>render</em> size accordingly.</p>
...
<code>responsive</code> | <code>Boolean</code> | <code>true</code> |
Resizes the chart canvas when its container does (<a
href="#important-note">important note…</a>). |
<code>responsiveAnimationDuration</code> | <code>Number</code> |
<code>0</code> | Duration in milliseconds it takes to animate to new size
after a resize event. | <code>maintainAspectRatio</code> |
<code>Boolean</code> | <code>true</code> | Maintain the original canvas
aspect ratio <code>(width / height)</code> when resizing. |
<code>aspectRatio</code> | <code>Number</code> | <code>2</code> | Canvas
aspect ratio (i.e. <code>width / height</code>, a value of 1 representing a
square canvas). Note that this option is ignored if the height is
explicitly defined either as attribute or via the style. |
<code>onResize</code> | <code>Function</code> | <code>null</code> | Called
when a resize occurs. Gets passed two arguments: the chart instance and the
new size.</p>

<h2 id="label-Important+Note">Important Note<span><a href="#label-Important+Note">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Detecting when the canvas size changes can not be done directly from the
...
requires the container to be <strong>relatively positioned</strong> and
<strong>dedicated to the chart canvas only</strong>. Responsiveness can
then be achieved by setting relative values for the container size (<a
href="https://codepen.io/chartjs/pen/YVWZbz">example</a>):</p>

<pre>&lt;div class=&quot;chart-container&quot; style=&quot;position: relative; height:40vh; width:80vw&quot;&gt;
    &lt;canvas id=&quot;chart&quot;&gt;&lt;/canvas&gt;
&lt;/div&gt;</pre>

<p>The chart can also be programmatically resized by modifying the container
size:</p>

<pre class="ruby"><span class="ruby-identifier">chart</span>.<span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">parentNode</span>.<span class="ruby-identifier">style</span>.<span class="ruby-identifier">height</span> = <span class="ruby-string">&#39;128px&#39;</span>;
</pre>

<h2 id="label-Printing+Resizeable+Charts">Printing Resizeable Charts<span><a href="#label-Printing+Resizeable+Charts">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>CSS media queries allow changing styles when printing a page. The CSS
applied from these media queries may cause charts to need to resize.
However, the resize won&#39;t happen automatically. To support resizing
charts when printing, one needs to hook the <a
href="https://developer.mozilla.org/en-US/docs/Web/API/WindowEventHandlers/onbeforeprint">onbeforeprint</a>
event and manually trigger resizing of each chart.</p>

<pre>function beforePrintHandler () {
