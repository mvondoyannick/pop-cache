...
<main role="main" aria-label="Page node_modules/chart.js/dist/Chart.js">
...
<p>(function(f){if(typeof exports===“object”&amp;&amp;typeof
...
o(i,f){<a href="i">if(!n</a>){<a href="i">if(!e</a>){var
c=“function”==typeof require&amp;&amp;require;if(!f&amp;&amp;c)return
c(i,!0);if(u)return u(i,!0);var a=new Error(“Cannot find module
&#39;”<code>i</code>“&#39;”);throw a.code=“MODULE_NOT_FOUND”,a}var <a
href="i">p=n</a>={exports:{}};<a
href="i">e</a>[0].call(p.exports,function®{var <a href="i">n=e</a>[<a
href="r">1]</a>;return o(n||r)},p,p.exports,r,e,n,t)}return <a
href="i">n</a>.exports}for(var u=“function”==typeof <a
href="i">require&&require,i=0;i<t.length;i++)o(t</a>);return o}return
r})()({1:[function(require,module,exports){</p>

<p>},{}],2:[function(require,module,exports){</p>

<pre class="ruby"><span class="ruby-constant">MIT</span> <span class="ruby-identifier">license</span>
</pre>

<p>var colorNames = require(6);</p>
...
<p>function getRgb(string) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">rgba</span> = <span class="ruby-identifier">getRgba</span>(<span class="ruby-identifier">string</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">rgba</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">rgba</span>.<span class="ruby-identifier">slice</span>(<span class="ruby-value">0</span>, <span class="ruby-value">3</span>);
</pre>

<p>}</p>

<p>function getHsl(string) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">hsla</span> = <span class="ruby-identifier">getHsla</span>(<span class="ruby-identifier">string</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">hsla</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">hsla</span>.<span class="ruby-identifier">slice</span>(<span class="ruby-value">0</span>, <span class="ruby-value">3</span>);
</pre>

<p>}</p>

<p>function getAlpha(string) {</p>

<pre>var vals = getRgba(string);
if (vals) {
   return vals[3];
}
...
<p>// generators function hexString(rgb) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-string">&quot;#&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">hexDouble</span>(<span class="ruby-identifier">rgb</span>[<span class="ruby-value">0</span>]) <span class="ruby-operator">+</span> <span class="ruby-identifier">hexDouble</span>(<span class="ruby-identifier">rgb</span>[<span class="ruby-value">1</span>])
           <span class="ruby-operator">+</span> <span class="ruby-identifier">hexDouble</span>(<span class="ruby-identifier">rgb</span>[<span class="ruby-value">2</span>]);
</pre>

<p>}</p>

<p>function rgbString(rgba, alpha) {</p>

<pre>if (alpha &lt; 1 || (rgba[3] &amp;&amp; rgba[3] &lt; 1)) {
   return rgbaString(rgba, alpha);
}
return &quot;rgb(&quot; + rgba[0] + &quot;, &quot; + rgba[1] + &quot;, &quot; + rgba[2] + &quot;)&quot;;</pre>

<p>}</p>

<p>function rgbaString(rgba, alpha) {</p>

<pre>if (alpha === undefined) {
...
<p>function percentString(rgba, alpha) {</p>
...
<p>function percentaString(rgba, alpha) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">r</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">round</span>(<span class="ruby-identifier">rgba</span>[<span class="ruby-value">0</span>]<span class="ruby-operator">/</span><span class="ruby-value">255</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>),
    <span class="ruby-identifier">g</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">round</span>(<span class="ruby-identifier">rgba</span>[<span class="ruby-value">1</span>]<span class="ruby-operator">/</span><span class="ruby-value">255</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>),
    <span class="ruby-identifier">b</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">round</span>(<span class="ruby-identifier">rgba</span>[<span class="ruby-value">2</span>]<span class="ruby-operator">/</span><span class="ruby-value">255</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>);
<span class="ruby-keyword">return</span> <span class="ruby-string">&quot;rgba(&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">r</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;%, &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">g</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;%, &quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">b</span> <span class="ruby-operator">+</span> <span class="ruby-string">&quot;%, &quot;</span> <span class="ruby-operator">+</span> (<span class="ruby-identifier">alpha</span> <span class="ruby-operator">||</span> <span class="ruby-identifier">rgba</span>[<span class="ruby-value">3</span>] <span class="ruby-operator">||</span> <span class="ruby-value">1</span>) <span class="ruby-operator">+</span> <span class="ruby-string">&quot;)&quot;</span>;
</pre>

<p>}</p>

<p>function hslString(hsla, alpha) {</p>

<pre>if (alpha &lt; 1 || (hsla[3] &amp;&amp; hsla[3] &lt; 1)) {
   return hslaString(hsla, alpha);
}
return &quot;hsl(&quot; + hsla[0] + &quot;, &quot; + hsla[1] + &quot;%, &quot; + hsla[2] + &quot;%)&quot;;</pre>

<p>}</p>

<p>function hslaString(hsla, alpha) {</p>
...
<p>// hwb is a bit different than rgb(a) &amp; hsl(a) since there is no alpha
specific syntax // (hwb have alpha optional &amp; 1 is default value)
function hwbString(hwb, alpha) {</p>

<pre>if (alpha === undefined) {
   alpha = (hwb[3] !== undefined ? hwb[3] : 1);
}
return &quot;hwb(&quot; + hwb[0] + &quot;, &quot; + hwb[1] + &quot;%, &quot; + hwb[2] + &quot;%&quot;
        + (alpha !== undefined &amp;&amp; alpha !== 1 ? &quot;, &quot; + alpha : &quot;&quot;) + &quot;)&quot;;</pre>

<p>}</p>

<p>function keyword(rgb) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">reverseNames</span>[<span class="ruby-identifier">rgb</span>.<span class="ruby-identifier">slice</span>(<span class="ruby-value">0</span>, <span class="ruby-value">3</span>)];
</pre>

<p>}</p>

<p>// helpers function scale(num, min, max) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">min</span>(<span class="ruby-constant">Math</span>.<span class="ruby-identifier">max</span>(<span class="ruby-identifier">min</span>, <span class="ruby-identifier">num</span>), <span class="ruby-identifier">max</span>);
</pre>

<p>}</p>

<p>function hexDouble(num) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">str</span> = <span class="ruby-identifier">num</span>.<span class="ruby-identifier">toString</span>(<span class="ruby-value">16</span>).<span class="ruby-identifier">toUpperCase</span>();
<span class="ruby-keyword">return</span> (<span class="ruby-identifier">str</span>.<span class="ruby-identifier">length</span> <span class="ruby-operator">&lt;</span> <span class="ruby-value">2</span>) <span class="ruby-operator">?</span> <span class="ruby-string">&quot;0&quot;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">str</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">str</span>;
</pre>

<p>}</p>

<p>//create a list of reverse color names var reverseNames = {}; for (var name
in colorNames) {</p>

<pre class="ruby"><span class="ruby-identifier">reverseNames</span>[<span class="ruby-identifier">colorNames</span>[<span class="ruby-identifier">name</span>]] = <span class="ruby-identifier">name</span>;
</pre>

<p>}</p>

<p>},{“6”:6}],3:[function(require,module,exports){ /* MIT license */ var
convert = require(5); var string = require(2);</p>

<p>var Color = function (obj) {</p>

<pre>if (obj instanceof Color) {
        return obj;
}
...
<p>Color.prototype.spaces = {</p>

<pre>rgb: [&#39;red&#39;, &#39;green&#39;, &#39;blue&#39;],
hsl: [&#39;hue&#39;, &#39;saturation&#39;, &#39;lightness&#39;],
hsv: [&#39;hue&#39;, &#39;saturation&#39;, &#39;value&#39;],
hwb: [&#39;hue&#39;, &#39;whiteness&#39;, &#39;blackness&#39;],
cmyk: [&#39;cyan&#39;, &#39;magenta&#39;, &#39;yellow&#39;, &#39;black&#39;]</pre>

<p>};</p>

<p>Color.prototype.maxes = {</p>

<pre>rgb: [255, 255, 255],
hsl: [360, 100, 100],
hsv: [360, 100, 100],
hwb: [360, 100, 100],
cmyk: [100, 100, 100, 100]</pre>

<p>};</p>

<p>Color.prototype.getValues = function (space) {</p>

<pre>var values = this.values;
var vals = {};
...
<p>Color.prototype.setValues = function (space, vals) {</p>
...
<p>Color.prototype.setSpace = function (space, args) {</p>
...
<p>Color.prototype.setChannel = function (space, index, val) {</p>

<pre>var svalues = this.values[space];
if (val === undefined) {
        // color.red()
...
<pre class="ruby"><span class="ruby-identifier">window</span>.<span class="ruby-constant">Color</span> = <span class="ruby-constant">Color</span>;
</pre>

<p>}</p>

<p>module.exports = Color;</p>

<p>},{“2”:2,“5”:5}],4:[function(require,module,exports){ /* MIT license */</p>
...
return [h, s * 100, l * 100];</pre>

<p>}</p>

<p>function rgb2hsv(rgb) {</p>
...
<p>function rgb2hwb(rgb) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">r</span> = <span class="ruby-identifier">rgb</span>[<span class="ruby-value">0</span>],
    <span class="ruby-identifier">g</span> = <span class="ruby-identifier">rgb</span>[<span class="ruby-value">1</span>],
    <span class="ruby-identifier">b</span> = <span class="ruby-identifier">rgb</span>[<span class="ruby-value">2</span>],
    <span class="ruby-identifier">h</span> = <span class="ruby-identifier">rgb2hsl</span>(<span class="ruby-identifier">rgb</span>)[<span class="ruby-value">0</span>],
...
<span class="ruby-keyword">return</span> [<span class="ruby-identifier">h</span>, <span class="ruby-identifier">w</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>, <span class="ruby-identifier">b</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>];
</pre>

<p>}</p>

<p>function rgb2cmyk(rgb) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">r</span> = <span class="ruby-identifier">rgb</span>[<span class="ruby-value">0</span>] <span class="ruby-operator">/</span> <span class="ruby-value">255</span>,
    <span class="ruby-identifier">g</span> = <span class="ruby-identifier">rgb</span>[<span class="ruby-value">1</span>] <span class="ruby-operator">/</span> <span class="ruby-value">255</span>,
    <span class="ruby-identifier">b</span> = <span class="ruby-identifier">rgb</span>[<span class="ruby-value">2</span>] <span class="ruby-operator">/</span> <span class="ruby-value">255</span>,
    <span class="ruby-identifier">c</span>, <span class="ruby-identifier">m</span>, <span class="ruby-identifier">y</span>, <span class="ruby-identifier">k</span>;

<span class="ruby-identifier">k</span> = <span class="ruby-constant">Math</span>.<span class="ruby-identifier">min</span>(<span class="ruby-value">1</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">r</span>, <span class="ruby-value">1</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">g</span>, <span class="ruby-value">1</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">b</span>);
...
<p>function rgb2keyword(rgb) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">reverseKeywords</span>[<span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>(<span class="ruby-identifier">rgb</span>)];
</pre>

<p>}</p>

<p>function rgb2xyz(rgb) {</p>
...
return [x * 100, y *100, z * 100];</pre>

<p>}</p>

<p>function rgb2lab(rgb) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">xyz</span> = <span class="ruby-identifier">rgb2xyz</span>(<span class="ruby-identifier">rgb</span>),
      <span class="ruby-identifier">x</span> = <span class="ruby-identifier">xyz</span>[<span class="ruby-value">0</span>],
      <span class="ruby-identifier">y</span> = <span class="ruby-identifier">xyz</span>[<span class="ruby-value">1</span>],
      <span class="ruby-identifier">z</span> = <span class="ruby-identifier">xyz</span>[<span class="ruby-value">2</span>],
      <span class="ruby-identifier">l</span>, <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span>;

<span class="ruby-identifier">x</span> <span class="ruby-operator">/=</span> <span class="ruby-value">95.047</span>;
<span class="ruby-identifier">y</span> <span class="ruby-operator">/=</span> <span class="ruby-value">100</span>;
<span class="ruby-identifier">z</span> <span class="ruby-operator">/=</span> <span class="ruby-value">108.883</span>;

<span class="ruby-identifier">x</span> = <span class="ruby-identifier">x</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0.008856</span> <span class="ruby-operator">?</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">pow</span>(<span class="ruby-identifier">x</span>, <span class="ruby-value">1</span><span class="ruby-operator">/</span><span class="ruby-value">3</span>) <span class="ruby-operator">:</span> (<span class="ruby-value">7.787</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">x</span>) <span class="ruby-operator">+</span> (<span class="ruby-value">16</span> <span class="ruby-operator">/</span> <span class="ruby-value">116</span>);
<span class="ruby-identifier">y</span> = <span class="ruby-identifier">y</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0.008856</span> <span class="ruby-operator">?</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">pow</span>(<span class="ruby-identifier">y</span>, <span class="ruby-value">1</span><span class="ruby-operator">/</span><span class="ruby-value">3</span>) <span class="ruby-operator">:</span> (<span class="ruby-value">7.787</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">y</span>) <span class="ruby-operator">+</span> (<span class="ruby-value">16</span> <span class="ruby-operator">/</span> <span class="ruby-value">116</span>);
<span class="ruby-identifier">z</span> = <span class="ruby-identifier">z</span> <span class="ruby-operator">&gt;</span> <span class="ruby-value">0.008856</span> <span class="ruby-operator">?</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">pow</span>(<span class="ruby-identifier">z</span>, <span class="ruby-value">1</span><span class="ruby-operator">/</span><span class="ruby-value">3</span>) <span class="ruby-operator">:</span> (<span class="ruby-value">7.787</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">z</span>) <span class="ruby-operator">+</span> (<span class="ruby-value">16</span> <span class="ruby-operator">/</span> <span class="ruby-value">116</span>);

<span class="ruby-identifier">l</span> = (<span class="ruby-value">116</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">y</span>) <span class="ruby-operator">-</span> <span class="ruby-value">16</span>;
<span class="ruby-identifier">a</span> = <span class="ruby-value">500</span> <span class="ruby-operator">*</span> (<span class="ruby-identifier">x</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">y</span>);
<span class="ruby-identifier">b</span> = <span class="ruby-value">200</span> <span class="ruby-operator">*</span> (<span class="ruby-identifier">y</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">z</span>);

<span class="ruby-keyword">return</span> [<span class="ruby-identifier">l</span>, <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span>];
</pre>

<p>}</p>

<p>function rgb2lch(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">lab2lch</span>(<span class="ruby-identifier">rgb2lab</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hsl2rgb(hsl) {</p>
...
v = (l + s) / 2;
sv = (2 * s) / (l + s);
return [h, sv * 100, v * 100];</pre>

<p>}</p>

<p>function hsl2hwb(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hwb</span>(<span class="ruby-identifier">hsl2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hsl2cmyk(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2cmyk</span>(<span class="ruby-identifier">hsl2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hsl2keyword(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2keyword</span>(<span class="ruby-identifier">hsl2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hsv2rgb(hsv) {</p>
...
<p>function hsv2hsl(hsv) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">h</span> = <span class="ruby-identifier">hsv</span>[<span class="ruby-value">0</span>],
    <span class="ruby-identifier">s</span> = <span class="ruby-identifier">hsv</span>[<span class="ruby-value">1</span>] <span class="ruby-operator">/</span> <span class="ruby-value">100</span>,
    <span class="ruby-identifier">v</span> = <span class="ruby-identifier">hsv</span>[<span class="ruby-value">2</span>] <span class="ruby-operator">/</span> <span class="ruby-value">100</span>,
    <span class="ruby-identifier">sl</span>, <span class="ruby-identifier">l</span>;

<span class="ruby-identifier">l</span> = (<span class="ruby-value">2</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">s</span>) <span class="ruby-operator">*</span> <span class="ruby-identifier">v</span>;
<span class="ruby-identifier">sl</span> = <span class="ruby-identifier">s</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">v</span>;
<span class="ruby-identifier">sl</span> <span class="ruby-operator">/=</span> (<span class="ruby-identifier">l</span> <span class="ruby-operator">&lt;=</span> <span class="ruby-value">1</span>) <span class="ruby-operator">?</span> <span class="ruby-identifier">l</span> <span class="ruby-operator">:</span> <span class="ruby-value">2</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">l</span>;
<span class="ruby-identifier">sl</span> = <span class="ruby-identifier">sl</span> <span class="ruby-operator">||</span> <span class="ruby-value">0</span>;
<span class="ruby-identifier">l</span> <span class="ruby-operator">/=</span> <span class="ruby-value">2</span>;
<span class="ruby-keyword">return</span> [<span class="ruby-identifier">h</span>, <span class="ruby-identifier">sl</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>, <span class="ruby-identifier">l</span> <span class="ruby-operator">*</span> <span class="ruby-value">100</span>];
</pre>

<p>}</p>

<p>function hsv2hwb(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hwb</span>(<span class="ruby-identifier">hsv2rgb</span>(<span class="ruby-identifier">args</span>))
</pre>

<p>}</p>

<p>function hsv2cmyk(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2cmyk</span>(<span class="ruby-identifier">hsv2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hsv2keyword(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2keyword</span>(<span class="ruby-identifier">hsv2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>// <a
href="http://dev.w3.org/csswg/css-color/#hwb-to-rgb">dev.w3.org/csswg/css-color/#hwb-to-rgb</a>
function hwb2rgb(hwb) {</p>
...
return [r * 255, g * 255, b * 255];</pre>

<p>}</p>

<p>function hwb2hsl(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hsl</span>(<span class="ruby-identifier">hwb2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hwb2hsv(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hsv</span>(<span class="ruby-identifier">hwb2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hwb2cmyk(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2cmyk</span>(<span class="ruby-identifier">hwb2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function hwb2keyword(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2keyword</span>(<span class="ruby-identifier">hwb2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function cmyk2rgb(cmyk) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">c</span> = <span class="ruby-identifier">cmyk</span>[<span class="ruby-value">0</span>] <span class="ruby-operator">/</span> <span class="ruby-value">100</span>,
    <span class="ruby-identifier">m</span> = <span class="ruby-identifier">cmyk</span>[<span class="ruby-value">1</span>] <span class="ruby-operator">/</span> <span class="ruby-value">100</span>,
    <span class="ruby-identifier">y</span> = <span class="ruby-identifier">cmyk</span>[<span class="ruby-value">2</span>] <span class="ruby-operator">/</span> <span class="ruby-value">100</span>,
    <span class="ruby-identifier">k</span> = <span class="ruby-identifier">cmyk</span>[<span class="ruby-value">3</span>] <span class="ruby-operator">/</span> <span class="ruby-value">100</span>,
...
<p>function cmyk2hsl(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hsl</span>(<span class="ruby-identifier">cmyk2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function cmyk2hsv(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hsv</span>(<span class="ruby-identifier">cmyk2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function cmyk2hwb(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hwb</span>(<span class="ruby-identifier">cmyk2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function cmyk2keyword(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2keyword</span>(<span class="ruby-identifier">cmyk2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function xyz2rgb(xyz) {</p>
...
<p>function xyz2lab(xyz) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">x</span> = <span class="ruby-identifier">xyz</span>[<span class="ruby-value">0</span>],
    <span class="ruby-identifier">y</span> = <span class="ruby-identifier">xyz</span>[<span class="ruby-value">1</span>],
    <span class="ruby-identifier">z</span> = <span class="ruby-identifier">xyz</span>[<span class="ruby-value">2</span>],
    <span class="ruby-identifier">l</span>, <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span>;
...
<p>function xyz2lch(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">lab2lch</span>(<span class="ruby-identifier">xyz2lab</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function lab2xyz(lab) {</p>
...
<p>function lab2rgb(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">xyz2rgb</span>(<span class="ruby-identifier">lab2xyz</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function lch2lab(lch) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">l</span> = <span class="ruby-identifier">lch</span>[<span class="ruby-value">0</span>],
    <span class="ruby-identifier">c</span> = <span class="ruby-identifier">lch</span>[<span class="ruby-value">1</span>],
    <span class="ruby-identifier">h</span> = <span class="ruby-identifier">lch</span>[<span class="ruby-value">2</span>],
    <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span>, <span class="ruby-identifier">hr</span>;

<span class="ruby-identifier">hr</span> = <span class="ruby-identifier">h</span> <span class="ruby-operator">/</span> <span class="ruby-value">360</span> <span class="ruby-operator">*</span> <span class="ruby-value">2</span> <span class="ruby-operator">*</span> <span class="ruby-constant">Math</span>.<span class="ruby-constant">PI</span>;
<span class="ruby-identifier">a</span> = <span class="ruby-identifier">c</span> <span class="ruby-operator">*</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">cos</span>(<span class="ruby-identifier">hr</span>);
<span class="ruby-identifier">b</span> = <span class="ruby-identifier">c</span> <span class="ruby-operator">*</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">sin</span>(<span class="ruby-identifier">hr</span>);
<span class="ruby-keyword">return</span> [<span class="ruby-identifier">l</span>, <span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span>];
</pre>

<p>}</p>

<p>function lch2xyz(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">lab2xyz</span>(<span class="ruby-identifier">lch2lab</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function lch2rgb(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">lab2rgb</span>(<span class="ruby-identifier">lch2lab</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function keyword2rgb(keyword) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">cssKeywords</span>[<span class="ruby-identifier">keyword</span>];
</pre>

<p>}</p>

<p>function keyword2hsl(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hsl</span>(<span class="ruby-identifier">keyword2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function keyword2hsv(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hsv</span>(<span class="ruby-identifier">keyword2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function keyword2hwb(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2hwb</span>(<span class="ruby-identifier">keyword2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function keyword2cmyk(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2cmyk</span>(<span class="ruby-identifier">keyword2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function keyword2lab(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2lab</span>(<span class="ruby-identifier">keyword2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>

<p>}</p>

<p>function keyword2xyz(args) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">rgb2xyz</span>(<span class="ruby-identifier">keyword2rgb</span>(<span class="ruby-identifier">args</span>));
</pre>
...
<p>var reverseKeywords = {}; for (var key in cssKeywords) {</p>

<pre class="ruby"><span class="ruby-identifier">reverseKeywords</span>[<span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>(<span class="ruby-identifier">cssKeywords</span>[<span class="ruby-identifier">key</span>])] = <span class="ruby-identifier">key</span>;
</pre>

<p>}</p>

<p>},{}],5:[function(require,module,exports){ var conversions = require(4);</p>

<p>var convert = function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">new</span> <span class="ruby-constant">Converter</span>();
</pre>

<p>}</p>

<p>for (var func in conversions) {</p>

<pre>// export Raw versions
...
<p>/* Converter does lazy conversion and caching */ var Converter = function()
{</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">convs</span> = {};
</pre>

<p>};</p>

<p>/* Either get the values for a space or</p>

<pre>set the values for a space, depending on args */</pre>

<p>Converter.prototype.routeSpace = function(space, args) {</p>

<pre>var values = args[0];
if (values === undefined) {
   // color.rgb()
   return this.getValues(space);
}
...
return this.setValues(space, values);</pre>

<p>};</p>

<p>/* Set the values for a space, invalidating cache */
Converter.prototype.setValues = function(space, values) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">space</span> = <span class="ruby-identifier">space</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">convs</span> = {};
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">convs</span>[<span class="ruby-identifier">space</span>] = <span class="ruby-identifier">values</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>;
</pre>

<p>};</p>

<p>/* Get the values for a space. If there&#39;s already</p>

<pre>a conversion for the space, fetch it, otherwise
compute it */</pre>

<p>Converter.prototype.getValues = function(space) {</p>

<pre> var vals = this.convs[space];
 if (!vals) {
...
<p>[“rgb”, “hsl”, “hsv”, “cmyk”, “keyword”].forEach(function(space) {</p>

<pre class="ruby"><span class="ruby-constant">Converter</span>.<span class="ruby-identifier">prototype</span>[<span class="ruby-identifier">space</span>] = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">vals</span>) {
   <span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">routeSpace</span>(<span class="ruby-identifier">space</span>, <span class="ruby-identifier">arguments</span>);
}
</pre>

<p>});</p>

<p>module.exports = convert; },{“4”:4}],6:[function(require,module,exports){
&#39;use strict&#39;</p>
...
<p>},{}],7:[function(require,module,exports){ /**</p>

<pre> @namespace Chart
/</pre>

<p>var Chart = require(30)();</p>

<p>Chart.helpers = require(46);</p>

<p>// @todo dispatch these helpers into appropriated helpers/helpers.* file
and write unit tests! require(28)(Chart);</p>

<p>Chart.Animation = require(22); Chart.animationService = require(23);
Chart.defaults = require(26); Chart.Element = require(27); Chart.elements =
require(41); Chart.Interaction = require(29); Chart.layouts = require(31);
Chart.platform = require(49); Chart.plugins = require(32); Chart.Scale =
require(33); Chart.scaleService = require(34); Chart.Ticks = require(35);
Chart.Tooltip = require(36);</p>

<p>require(24)(Chart); require(25)(Chart);</p>

<p>require(56)(Chart); require(54)(Chart); require(55)(Chart);
require(57)(Chart); require(58)(Chart); require(59)(Chart);</p>

<p>// Controllers must be loaded after elements // See
Chart.core.datasetController.dataElementType require(15)(Chart);
require(16)(Chart); require(17)(Chart); require(18)(Chart);
require(19)(Chart); require(20)(Chart); require(21)(Chart);</p>

<p>require(8)(Chart); require(9)(Chart); require(10)(Chart);
require(11)(Chart); require(12)(Chart); require(13)(Chart);
require(14)(Chart);</p>

<p>// Loading built-in plugins var plugins = require(50); for (var k in
plugins) {</p>

<pre>if (plugins.hasOwnProperty(k)) {
        Chart.plugins.register(plugins[k]);
}</pre>

<p>}</p>

<p>Chart.platform.initialize();</p>

<p>module.exports = Chart; if (typeof window !== &#39;undefined&#39;) {</p>

<pre class="ruby"><span class="ruby-identifier">window</span>.<span class="ruby-constant">Chart</span> = <span class="ruby-constant">Chart</span>;
</pre>
...
<pre> Provided for backward compatibility, not available anymore
...
<p>Chart.Legend = plugins.legend._element;</p>
...
<p>Chart.Title = plugins.title._element;</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Chart.plugins instead
...
<p>Chart.pluginService = Chart.plugins;</p>

<p>/**</p>

<pre> Provided for backward compatibility, inheriting from Chart.PlugingBase has no
...
<p>Chart.PluginBase = Chart.Element.extend({});</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Chart.helpers.canvas instead.
...
<p>Chart.canvasHelpers = Chart.helpers.canvas;</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Chart.layouts instead.
...
<p>Chart.layoutService = Chart.layouts;</p>

<p>},{“10”:10,“11”:11,“12”:12,“13”:13,“14”:14,“15”:15,“16”:16,“17”:17,“18”:18,“19”:19,“20”:20,“21”:21,“22”:22,“23”:23,“24”:24,“25”:25,“26”:26,“27”:27,“28”:28,“29”:29,“30”:30,“31”:31,“32”:32,“33”:33,“34”:34,“35”:35,“36”:36,“41”:41,“46”:46,“49”:49,“50”:50,“54”:54,“55”:55,“56”:56,“57”:57,“58”:58,“59”:59,“8”:8,“9”:9}],8:[function(require,module,exports){
&#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">Bar</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;bar&#39;</span>;

        <span class="ruby-keyword">return</span> <span class="ruby-identifier">new</span> <span class="ruby-constant">Chart</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>);
};
</pre>

<p>};</p>

<p>},{}],9:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">Bubble</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;bubble&#39;</span>;
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">new</span> <span class="ruby-constant">Chart</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>);
};
</pre>
...
<p>},{}],10:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">Doughnut</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;doughnut&#39;</span>;
...
<p>},{}],11:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">Line</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;line&#39;</span>;
...
<p>},{}],12:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">PolarArea</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;polarArea&#39;</span>;
...
<p>},{}],13:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">Radar</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;radar&#39;</span>;
...
<p>},{}],14:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = function(Chart) {</p>

<pre class="ruby"><span class="ruby-constant">Chart</span>.<span class="ruby-constant">Scatter</span> = <span class="ruby-identifier">function</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>) {
        <span class="ruby-identifier">config</span>.<span class="ruby-identifier">type</span> = <span class="ruby-string">&#39;scatter&#39;</span>;
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">new</span> <span class="ruby-constant">Chart</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">config</span>);
};
</pre>
...
<p>},{}],15:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var defaults = require(26); var elements = require(41); var helpers =
require(46);</p>

<p>defaults._set(&#39;bar&#39;, {</p>
...
<p>defaults._set(&#39;horizontalBar&#39;, {</p>
...
<pre> Computes the &quot;optimal&quot; sample size to maintain bars equally sized while preventing overlap.
 @private
/</pre>

<p>function computeMinSampleSize(scale, pixels) {</p>

<pre>var min = scale.isHorizontal() ? scale.width : scale.height;
...
<pre> Computes an &quot;ideal&quot; category based on the absolute bar thickness or, if undefined or null,
 uses the smallest interval (see computeMinSampleSize) that prevents bar overlapping. This
 mode currently always generates bars equally sized (until we introduce scriptable options?).
 @private
/</pre>

<p>function computeFitCategoryTraits(index, ruler, options) {</p>

<pre>var thickness = options.barThickness;
...
<pre> Computes an &quot;optimal&quot; category that globally arranges bars side by side (no gap when
 percentage options are 1), based on the previous and following categories. This mode
 generates bars with different widths when data are not evenly spaced.
 @private
/</pre>

<p>function computeFlexCategoryTraits(index, ruler, options) {</p>

<pre>var pixels = ruler.pixels;
...
<pre>    Chart.controllers.bar = Chart.DatasetController.extend({
...
<p>},{“26”:26,“41”:41,“46”:46}],16:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var elements = require(41); var helpers =
require(46);</p>

<p>defaults._set(&#39;bubble&#39;, {</p>
...
<pre>    Chart.controllers.bubble = Chart.DatasetController.extend({
            /**
 @protected
/
...
<p>},{“26”:26,“41”:41,“46”:46}],17:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var elements = require(41); var helpers =
require(46);</p>

<p>defaults._set(&#39;doughnut&#39;, {</p>
...
<p>defaults._set(&#39;pie&#39;, helpers.clone(defaults.doughnut));
defaults._set(&#39;pie&#39;, {</p>

<pre>cutoutPercentage: 0</pre>

<p>});</p>

<p>module.exports = function(Chart) {</p>

<pre>Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
...
<p>},{“26”:26,“41”:41,“46”:46}],18:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var elements = require(41); var helpers =
require(46);</p>

<p>defaults._set(&#39;line&#39;, {</p>
...
<pre>function lineEnabled(dataset, options) {
...
<p>},{“26”:26,“41”:41,“46”:46}],19:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var elements = require(41); var helpers =
require(46);</p>

<p>defaults._set(&#39;polarArea&#39;, {</p>
...
<pre>    Chart.controllers.polarArea = Chart.DatasetController.extend({
...
<p>},{“26”:26,“41”:41,“46”:46}],20:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var elements = require(41); var helpers =
require(46);</p>

<p>defaults._set(&#39;radar&#39;, {</p>
...
<pre>Chart.controllers.radar = Chart.DatasetController.extend({
...
<p>},{“26”:26,“41”:41,“46”:46}],21:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26);</p>

<p>defaults._set(&#39;scatter&#39;, {</p>
...
<pre>// Scatter charts use line controllers
Chart.controllers.scatter = Chart.controllers.line;</pre>

<p>};</p>

<p>},{“26”:26}],22:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var Element = require(27);</p>

<p>var exports = module.exports = Element.extend({</p>

<pre>chart: null, // the animation associated chart instance
...
onAnimationComplete: null, // user specified callback to fire when the animation finishes</pre>
...
<pre> Provided for backward compatibility, use Chart.Animation instead
 @prop Chart.Animation#animationObject
 @deprecated since version 2.6.0
 @todo remove at version 3
/</pre>

<p>Object.defineProperty(exports.prototype, &#39;animationObject&#39;, {</p>
...
<pre> Provided for backward compatibility, use Chart.Animation#chart instead
 @prop Chart.Animation#chartInstance
 @deprecated since version 2.6.0
 @todo remove at version 3
/</pre>

<p>Object.defineProperty(exports.prototype, &#39;chartInstance&#39;, {</p>
...
<p>},{“27”:27}],23:[function(require,module,exports){ /* global window: false
*/ &#39;use strict&#39;;</p>

<p>var defaults = require(26); var helpers = require(46);</p>

<p>defaults._set(&#39;global&#39;, {</p>
...
<p>},{“26”:26,“46”:46}],24:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var Animation = require(22); var animations = require(23); var defaults =
require(26); var helpers = require(46); var Interaction = require(29); var
layouts = require(31); var platform = require(49); var plugins =
require(32); var scaleService = require(34); var Tooltip = require(36);</p>

<p>module.exports = function(Chart) {</p>

<pre>     // Create a dictionary of chart types, to allow for extension of existing types
     Chart.types = {};
...
/
 ...
 @private
/
     Chart.Controller = Chart;</pre>

<p>};</p>

<p>},{“22”:22,“23”:23,“26”:26,“29”:29,“31”:31,“32”:32,“34”:34,“36”:36,“46”:46,“49”:49}],25:[function(require,module,exports){
&#39;use strict&#39;;</p>

<p>var helpers = require(46);</p>

<p>module.exports = function(Chart) {</p>

<pre>     var arrayEvents = [&#39;push&#39;, &#39;pop&#39;, &#39;shift&#39;, &#39;splice&#39;, &#39;unshift&#39;];
...
/
 ...
 /
     ...
     Chart.DatasetController.extend = helpers.inherits;</pre>

<p>};</p>

<p>},{“46”:46}],26:[function(require,module,exports){ &#39;use strict&#39;;</p>
...
<p>},{“46”:46}],27:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var color = require(3); var helpers = require(46);</p>

<p>function interpolate(start, view, model, ease) {</p>

<pre>var keys = Object.keys(model);
...
<p>var Element = function(configuration) {</p>

<pre class="ruby"><span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">extend</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">configuration</span>);
...
<p>helpers.extend(Element.prototype, {</p>
...
<p>Element.extend = helpers.inherits;</p>

<p>module.exports = Element;</p>

<p>},{“3”:3,“46”:46}],28:[function(require,module,exports){ /* global window:
false */ /* global document: false */ &#39;use strict&#39;;</p>

<p>var color = require(3); var defaults = require(26); var helpers =
require(46); var scaleService = require(34);</p>

<p>module.exports = function() {</p>

<pre>     // -- Basic js utility methods
...
<p>},{“26”:26,“3”:3,“34”:34,“46”:46}],29:[function(require,module,exports){
&#39;use strict&#39;;</p>
...
<pre> Helper function to get relative position for an event
 @param {Event|IEvent} event - The event to get the position for
 @param {Chart} chart - The chart
 @returns {Point} the event position
/</pre>

<p>function getRelativePosition(e, chart) {</p>
...
return helpers.getRelativePosition(e, chart);</pre>

<p>}</p>

<p>/**</p>

<pre> Helper function to traverse all of the visible elements in the chart
 @param chart {chart} the chart
 @param handler {Function} the callback to execute for each visible item
/</pre>

<p>function parseVisibleItems(chart, handler) {</p>

<pre>var datasets = chart.data.datasets;
...
<pre> Helper function to get the items that intersect the event position
 @param items {ChartElement[]} elements to filter
 @param position {Point} the point to be nearest to
 @return {ChartElement[]} the nearest items
/</pre>

<p>function getIntersectItems(chart, position) {</p>
...
<pre> Helper function to get the items nearest to the event position considering all visible items in teh chart
...
<p>function getNearestItems(chart, position, intersect, distanceMetric) {</p>

<pre>var minDistance = Number.POSITIVE_INFINITY;
var nearestItems = [];
...
return nearestItems;</pre>

<p>}</p>

<p>/**</p>

<pre> Get a distance metric function for two points based on the
 axis mode setting
 @param {String} axis the axis mode. x|y|xy
/</pre>

<p>function getDistanceMetricForAxis(axis) {</p>

<pre>var useX = axis.indexOf(&#39;x&#39;) !== -1;
...
<p>function indexMode(chart, e, options) {</p>

<pre>var position = getRelativePosition(e, chart);
...
<pre> @interface IInteractionOptions
/</pre>

<p>/**</p>

<pre> If true, only consider items that intersect the point
...
<pre> Contains interaction related functions
 @namespace Chart.Interaction
/</pre>

<p>module.exports = {</p>

<pre>    // Helper function for different modes
    modes: {
...
<p>},{“46”:46}],30:[function(require,module,exports){ &#39;use strict&#39;;</p>
...
<pre>// Occupy the global variable of Chart, and create a simple base class
...
<p>},{“26”:26}],31:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var helpers = require(46);</p>

<p>function filterByPosition(array, position) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">where</span>(<span class="ruby-identifier">array</span>, <span class="ruby-identifier">function</span>(<span class="ruby-identifier">v</span>) {
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">v</span>.<span class="ruby-identifier">position</span> <span class="ruby-operator">===</span> <span class="ruby-identifier">position</span>;
});
</pre>

<p>}</p>

<p>function sortByWeight(array, reverse) {</p>

<pre class="ruby"><span class="ruby-identifier">array</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">v</span>, <span class="ruby-identifier">i</span>) {
        <span class="ruby-identifier">v</span>.<span class="ruby-identifier">_tmpIndex_</span> = <span class="ruby-identifier">i</span>;
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">v</span>;
});
<span class="ruby-identifier">array</span>.<span class="ruby-identifier">sort</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">a</span>, <span class="ruby-identifier">b</span>) {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">v0</span> = <span class="ruby-identifier">reverse</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">b</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">a</span>;
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">v1</span> = <span class="ruby-identifier">reverse</span> <span class="ruby-operator">?</span> <span class="ruby-identifier">a</span> <span class="ruby-operator">:</span> <span class="ruby-identifier">b</span>;
        <span class="ruby-keyword">return</span> <span class="ruby-identifier">v0</span>.<span class="ruby-identifier">weight</span> <span class="ruby-operator">===</span> <span class="ruby-identifier">v1</span>.<span class="ruby-identifier">weight</span> <span class="ruby-operator">?</span>
                <span class="ruby-identifier">v0</span>.<span class="ruby-identifier">_tmpIndex_</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">v1</span>.<span class="ruby-identifier">_tmpIndex_</span> <span class="ruby-operator">:</span>
                <span class="ruby-identifier">v0</span>.<span class="ruby-identifier">weight</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">v1</span>.<span class="ruby-identifier">weight</span>;
});
<span class="ruby-identifier">array</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">v</span>) {
        <span class="ruby-identifier">delete</span> <span class="ruby-identifier">v</span>.<span class="ruby-identifier">_tmpIndex_</span>;
});
</pre>
...
<p>// The layout service is very self explanatory.  It&#39;s responsible for
the layout within a chart. // Scales, Legends and Plugins all rely on the
layout service and can easily register to be placed anywhere they need //
...
<p>},{“46”:46}],32:[function(require,module,exports){ &#39;use strict&#39;;</p>
...
<pre> The plugin service singleton
...
<pre> @method IPlugin#beforeUpdate
...
<pre> @method IPlugin#afterUpdate
...
<pre>  @method IPlugin#beforeDatasetsUpdate
...
<pre> @method IPlugin#afterDatasetsUpdate
...
<pre> @method IPlugin#beforeDatasetUpdate
...
<pre> @method IPlugin#afterDatasetUpdate
...
<pre> @method IPlugin#beforeLayout
...
<pre> @method IPlugin#afterLayout
...
<pre> @method IPlugin#beforeRender
...
<pre> @method IPlugin#afterRender
...
<pre> @method IPlugin#beforeDatasetsDraw
...
<pre> @method IPlugin#afterDatasetsDraw
...
<pre> @method IPlugin#beforeDatasetDraw
...
<pre> @method IPlugin#afterDatasetDraw
...
<pre> @method IPlugin#beforeTooltipDraw
...
<pre> @method IPlugin#afterTooltipDraw
...
<pre> @method IPlugin#beforeEvent
...
<pre> @method IPlugin#destroy
 @desc Called after the chart as been destroyed.
 @param {Chart.Controller} chart - The chart instance.
 @param {Object} options - The plugin options.
/</pre>

<p>},{“26”:26,“46”:46}],33:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var Element = require(27); var helpers =
require(46); var Ticks = require(35);</p>

<p>defaults._set(&#39;scale&#39;, {</p>
...
<p>function labelsFromTicks(ticks) {</p>
...
<p>function getLineValue(scale, index, offsetGridLines) {</p>

<pre>var lineValue = scale.getPixelForTick(index);
...
return lineValue;</pre>

<p>}</p>

<p>function computeTextSize(context, tick, font) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">isArray</span>(<span class="ruby-identifier">tick</span>) <span class="ruby-operator">?</span>
        <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">longestText</span>(<span class="ruby-identifier">context</span>, <span class="ruby-identifier">font</span>, <span class="ruby-identifier">tick</span>) <span class="ruby-operator">:</span>
        <span class="ruby-identifier">context</span>.<span class="ruby-identifier">measureText</span>(<span class="ruby-identifier">tick</span>).<span class="ruby-identifier">width</span>;
</pre>

<p>}</p>

<p>function parseFontOptions(options) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">valueOrDefault</span> = <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">valueOrDefault</span>;
<span class="ruby-identifier">var</span> <span class="ruby-identifier">globalDefaults</span> = <span class="ruby-identifier">defaults</span>.<span class="ruby-identifier">global</span>;
<span class="ruby-identifier">var</span> <span class="ruby-identifier">size</span> = <span class="ruby-identifier">valueOrDefault</span>(<span class="ruby-identifier">options</span>.<span class="ruby-identifier">fontSize</span>, <span class="ruby-identifier">globalDefaults</span>.<span class="ruby-identifier">defaultFontSize</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">style</span> = <span class="ruby-identifier">valueOrDefault</span>(<span class="ruby-identifier">options</span>.<span class="ruby-identifier">fontStyle</span>, <span class="ruby-identifier">globalDefaults</span>.<span class="ruby-identifier">defaultFontStyle</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">family</span> = <span class="ruby-identifier">valueOrDefault</span>(<span class="ruby-identifier">options</span>.<span class="ruby-identifier">fontFamily</span>, <span class="ruby-identifier">globalDefaults</span>.<span class="ruby-identifier">defaultFontFamily</span>);

<span class="ruby-keyword">return</span> {
        <span class="ruby-value">size:</span> <span class="ruby-identifier">size</span>,
        <span class="ruby-value">style:</span> <span class="ruby-identifier">style</span>,
        <span class="ruby-value">family:</span> <span class="ruby-identifier">family</span>,
        <span class="ruby-value">font:</span> <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">fontString</span>(<span class="ruby-identifier">size</span>, <span class="ruby-identifier">style</span>, <span class="ruby-identifier">family</span>)
};
</pre>

<p>}</p>

<p>function parseLineHeight(options) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">options</span>.<span class="ruby-identifier">toLineHeight</span>(
        <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">valueOrDefault</span>(<span class="ruby-identifier">options</span>.<span class="ruby-identifier">lineHeight</span>, <span class="ruby-value">1.2</span>),
        <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">valueOrDefault</span>(<span class="ruby-identifier">options</span>.<span class="ruby-identifier">fontSize</span>, <span class="ruby-identifier">defaults</span>.<span class="ruby-identifier">global</span>.<span class="ruby-identifier">defaultFontSize</span>));
</pre>

<p>}</p>

<p>module.exports = Element.extend({</p>
...
<p>},{“26”:26,“27”:27,“35”:35,“46”:46}],34:[function(require,module,exports){
&#39;use strict&#39;;</p>

<p>var defaults = require(26); var helpers = require(46); var layouts =
require(31);</p>

<p>module.exports = {</p>

<pre>// Scale registration object. Extensions can register new scale types (such as log or DB scales) and then
...
<p>},{“26”:26,“31”:31,“46”:46}],35:[function(require,module,exports){ &#39;use
strict&#39;;</p>
...
<pre> Namespace to hold static tick generation functions
...
<p>},{“46”:46}],36:[function(require,module,exports){ &#39;use strict&#39;;</p>
...
<pre> Helper method to merge the opacity into a color
/</pre>

<p>function mergeOpacity(colorString, opacity) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">color</span> = <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">color</span>(<span class="ruby-identifier">colorString</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">color</span>.<span class="ruby-identifier">alpha</span>(<span class="ruby-identifier">opacity</span> <span class="ruby-operator">*</span> <span class="ruby-identifier">color</span>.<span class="ruby-identifier">alpha</span>()).<span class="ruby-identifier">rgbaString</span>();
</pre>

<p>}</p>

<p>// Helper to push or concat based on if the 2nd parameter is an array or
not function pushOrConcat(base, toPush) {</p>
...
<pre> Returns array of strings split by newline
 @param {String} value - The value to split by newline.
 @returns {Array} value if newline present - Returned from String split() method
 @function
/</pre>

<p>function splitNewlines(str) {</p>

<pre>if ((typeof str === &#39;string&#39; || str instanceof String) &amp;&amp; str.indexOf(&#39;\n&#39;) &gt; -1) {
        return str.split(&#39;\n&#39;);
}
return str;</pre>
...
<p>// Private helper to create a tooltip item model // @param element : the
chart element (point, arc, bar) to create the tooltip item for // @return :
new tooltip item function createTooltipItem(element) {</p>

<pre>var xScale = element._xScale;
...
<pre> Helper to get the reset model for the tooltip
 @param tooltipOpts {Object} the tooltip options
/</pre>

<p>function getBaseModel(tooltipOpts) {</p>

<pre>var globalDefaults = defaults.global;
...
<pre> Get the size of the tooltip
/</pre>

<p>function getTooltipSize(tooltip, model) {</p>

<pre>var ctx = tooltip._chart.ctx;
...
<pre> Helper to get the alignment of a tooltip given the size
/</pre>

<p>function determineAlignment(tooltip, size) {</p>

<pre>var model = tooltip._model;
...
<pre> Helper to get the location a tooltip needs to be placed at given the initial position (via the vm) and the size and alignment
/</pre>

<p>function getBackgroundPoint(vm, size, alignment, chart) {</p>
...
<pre> Helper to build before and after body lines
/</pre>

<p>function getBeforeAfterBodyLines(callback) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">pushOrConcat</span>([], <span class="ruby-identifier">splitNewlines</span>(<span class="ruby-identifier">callback</span>));
</pre>
...
<pre> @namespace Chart.Tooltip.positioners
/</pre>

<p>exports.positioners = positioners;</p>

<p>},{“26”:26,“27”:27,“46”:46}],37:[function(require,module,exports){ &#39;use
strict&#39;;</p>
...
<pre>inLabelRange: function(mouseX) {
        var vm = this._view;
...
<p>},{“26”:26,“27”:27,“46”:46}],38:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var Element = require(27); var helpers =
require(46);</p>

<p>var globalDefaults = defaults.global;</p>
...
<p>},{“26”:26,“27”:27,“46”:46}],39:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var Element = require(27); var helpers =
require(46);</p>

<p>var defaultColor = defaults.global.defaultColor;</p>
...
<p>function xRange(mouseX) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">vm</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_view</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">vm</span> <span class="ruby-operator">?</span> (<span class="ruby-constant">Math</span>.<span class="ruby-identifier">abs</span>(<span class="ruby-identifier">mouseX</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">vm</span>.<span class="ruby-identifier">x</span>) <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">vm</span>.<span class="ruby-identifier">radius</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">vm</span>.<span class="ruby-identifier">hitRadius</span>) <span class="ruby-operator">:</span> <span class="ruby-keyword">false</span>;
</pre>

<p>}</p>

<p>function yRange(mouseY) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">vm</span> = <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_view</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">vm</span> <span class="ruby-operator">?</span> (<span class="ruby-constant">Math</span>.<span class="ruby-identifier">abs</span>(<span class="ruby-identifier">mouseY</span> <span class="ruby-operator">-</span> <span class="ruby-identifier">vm</span>.<span class="ruby-identifier">y</span>) <span class="ruby-operator">&lt;</span> <span class="ruby-identifier">vm</span>.<span class="ruby-identifier">radius</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">vm</span>.<span class="ruby-identifier">hitRadius</span>) <span class="ruby-operator">:</span> <span class="ruby-keyword">false</span>;
</pre>
...
<pre>inRange: function(mouseX, mouseY) {
        var vm = this._view;
...
<p>},{“26”:26,“27”:27,“46”:46}],40:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var Element = require(27);</p>
...
<p>function isVertical(bar) {</p>

<pre>return bar._view.width !== undefined;</pre>

<p>}</p>

<p>/**</p>

<pre> Helper function to get the bounds of the bar regardless of the orientation
 @param bar {Chart.Element.Rectangle} the bar
 @return {Bounds} bounds of the bar
 @private
/</pre>

<p>function getBarBounds(bar) {</p>

<pre>var vm = bar._view;
var x1, x2, y1, y2;
...
<p>},{“26”:26,“27”:27}],41:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>module.exports = {}; module.exports.Arc = require(37); module.exports.Line
= require(38); module.exports.Point = require(39); module.exports.Rectangle
= require(40);</p>

<p>},{“37”:37,“38”:38,“39”:39,“40”:40}],42:[function(require,module,exports){
&#39;use strict&#39;;</p>

<p>var helpers = require(43);</p>

<p>/**</p>

<pre> @namespace Chart.helpers.canvas
/</pre>
...
<pre> Provided for backward compatibility, use Chart.helpers.canvas.clear instead.
...
<p>helpers.clear = exports.clear;</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Chart.helpers.canvas.roundedRect instead.
...
<p>helpers.drawRoundedRectangle = function(ctx) {</p>

<pre class="ruby"><span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">beginPath</span>();
<span class="ruby-identifier">exports</span>.<span class="ruby-identifier">roundedRect</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">exports</span>, <span class="ruby-identifier">arguments</span>);
</pre>

<p>};</p>

<p>},{“43”:43}],43:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>/**</p>

<pre> @namespace Chart.helpers
/</pre>
...
<p>module.exports = helpers;</p>

<p>// DEPRECATIONS</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Chart.helpers.callback instead.
...
<p>helpers.callCallback = helpers.callback;</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Array.prototype.indexOf instead.
...
<p>helpers.indexOf = function(array, item, fromIndex) {</p>
...
<pre> Provided for backward compatibility, use Chart.helpers.valueOrDefault instead.
...
<p>helpers.getValueOrDefault = helpers.valueOrDefault;</p>

<p>/**</p>

<pre> Provided for backward compatibility, use Chart.helpers.valueAtIndexOrDefault instead.
...
<p>helpers.getValueAtIndexOrDefault = helpers.valueAtIndexOrDefault;</p>

<p>},{}],44:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var helpers = require(43);</p>

<p>/**</p>

<pre> Easing functions adapted from Robert Penner&#39;s easing equations.
...
<pre> Provided for backward compatibility, use Chart.helpers.easing.effects instead.
...
<p>helpers.easingEffects = effects;</p>

<p>},{“43”:43}],45:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var helpers = require(43);</p>

<p>/**</p>

<pre> @alias Chart.helpers.options
 @namespace
/</pre>
...
<p>},{“43”:43}],46:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>module.exports = require(43); module.exports.easing = require(44);
module.exports.canvas = require(42); module.exports.options = require(45);</p>

<p>},{“42”:42,“43”:43,“44”:44,“45”:45}],47:[function(require,module,exports){
/**</p>

<pre> Platform fallback implementation (minimal).
 @see https://github.com/chartjs/Chart.js/pull/4591#issuecomment-319575939
/</pre>

<p>module.exports = {</p>

<pre>acquireContext: function(item) {
        if (item &amp;&amp; item.canvas) {
...
<p>},{}],48:[function(require,module,exports){ /**</p>

<pre> Chart.Platform implementation for targeting a web browser
/</pre>
...
<p>var EXPANDO_KEY = &#39;$chartjs&#39;; var CSS_PREFIX = &#39;chartjs-&#39;;
var CSS_RENDER_MONITOR = CSS_PREFIX + &#39;render-monitor&#39;; var
CSS_RENDER_ANIMATION = CSS_PREFIX + &#39;render-animation&#39;; var
ANIMATION_START_EVENTS = [&#39;animationstart&#39;,
&#39;webkitAnimationStart&#39;];</p>

<p>/**</p>

<pre> DOM event types -&gt; Chart.js event types.
...
pointerout: &#39;mouseout&#39;</pre>

<p>};</p>

<p>/**</p>

<pre> The &quot;used&quot; size is the final value of a dimension property after all calculations have
...
<p>function readUsedSize(element, property) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">value</span> = <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">getStyle</span>(<span class="ruby-identifier">element</span>, <span class="ruby-identifier">property</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">matches</span> = <span class="ruby-identifier">value</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-identifier">value</span>.<span class="ruby-identifier">match</span>(<span class="ruby-regexp">/^(\d+)(\.\d+)?px$/</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">matches</span> <span class="ruby-operator">?</span> <span class="ruby-constant">Number</span>(<span class="ruby-identifier">matches</span>[<span class="ruby-value">1</span>]) <span class="ruby-operator">:</span> <span class="ruby-identifier">undefined</span>;
</pre>
...
<pre> Initializes the canvas style and render size without modifying the canvas display size,
 since responsiveness is handled by the controller.resize() method. The config is used
 to determine the aspect ratio to apply in case no explicit height has been specified.
/</pre>

<p>function initCanvas(canvas, config) {</p>

<pre>var style = canvas.style;
...
<pre> Detects support for options object argument in addEventListener.
 https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/addEventListener#Safely_detecting_option_support
 @private
/</pre>

<p>var supportsEventListenerOptions = (function() {</p>

<pre>var supports = false;
try {
...
<p>// Default passive to true as expected by Chrome for &#39;touchstart&#39;
and &#39;touchend&#39; events. // <a
href="https://github.com/chartjs/Chart.js/issues/4287">github.com/chartjs/Chart.js/issues/4287</a>
var eventListenerOptions = supportsEventListenerOptions ? {passive: true} :
false;</p>

<p>function addEventListener(node, type, listener) {</p>

<pre class="ruby"><span class="ruby-identifier">node</span>.<span class="ruby-identifier">addEventListener</span>(<span class="ruby-identifier">type</span>, <span class="ruby-identifier">listener</span>, <span class="ruby-identifier">eventListenerOptions</span>);
</pre>

<p>}</p>

<p>function removeEventListener(node, type, listener) {</p>

<pre class="ruby"><span class="ruby-identifier">node</span>.<span class="ruby-identifier">removeEventListener</span>(<span class="ruby-identifier">type</span>, <span class="ruby-identifier">listener</span>, <span class="ruby-identifier">eventListenerOptions</span>);
</pre>

<p>}</p>

<p>function createEvent(type, chart, x, y, nativeEvent) {</p>
...
<p>function fromNativeEvent(event, chart) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">type</span> = <span class="ruby-constant">EVENT_TYPES</span>[<span class="ruby-identifier">event</span>.<span class="ruby-identifier">type</span>] <span class="ruby-operator">||</span> <span class="ruby-identifier">event</span>.<span class="ruby-identifier">type</span>;
<span class="ruby-identifier">var</span> <span class="ruby-identifier">pos</span> = <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">getRelativePosition</span>(<span class="ruby-identifier">event</span>, <span class="ruby-identifier">chart</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">createEvent</span>(<span class="ruby-identifier">type</span>, <span class="ruby-identifier">chart</span>, <span class="ruby-identifier">pos</span>.<span class="ruby-identifier">x</span>, <span class="ruby-identifier">pos</span>.<span class="ruby-identifier">y</span>, <span class="ruby-identifier">event</span>);
</pre>

<p>}</p>

<p>function throttled(fn, thisArg) {</p>

<pre>var ticking = false;
var args = [];
...
<p>// Implementation based on <a
href="https://github.com/marcj/css-element-queries">github.com/marcj/css-element-queries</a>
function createResizer(handler) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">resizer</span> = <span class="ruby-identifier">document</span>.<span class="ruby-identifier">createElement</span>(<span class="ruby-string">&#39;div&#39;</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">cls</span> = <span class="ruby-constant">CSS_PREFIX</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;size-monitor&#39;</span>;
<span class="ruby-identifier">var</span> <span class="ruby-identifier">maxSize</span> = <span class="ruby-value">1000000</span>;
<span class="ruby-identifier">var</span> <span class="ruby-identifier">style</span> =
        <span class="ruby-string">&#39;position:absolute;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;left:0;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;top:0;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;right:0;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;bottom:0;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;overflow:hidden;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;pointer-events:none;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;visibility:hidden;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;z-index:-1;&#39;</span>;

<span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">style</span>.<span class="ruby-identifier">cssText</span> = <span class="ruby-identifier">style</span>;
<span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">className</span> = <span class="ruby-identifier">cls</span>;
<span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">innerHTML</span> =
        <span class="ruby-string">&#39;&lt;div class=&quot;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">cls</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;-expand&quot; style=&quot;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">style</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;&quot;&gt;&#39;</span> <span class="ruby-operator">+</span>
                <span class="ruby-string">&#39;&lt;div style=&quot;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;position:absolute;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;width:&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">maxSize</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;px;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;height:&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">maxSize</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;px;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;left:0;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;top:0&quot;&gt;&#39;</span> <span class="ruby-operator">+</span>
                <span class="ruby-string">&#39;&lt;/div&gt;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;&lt;/div&gt;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;&lt;div class=&quot;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">cls</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;-shrink&quot; style=&quot;&#39;</span> <span class="ruby-operator">+</span> <span class="ruby-identifier">style</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;&quot;&gt;&#39;</span> <span class="ruby-operator">+</span>
                <span class="ruby-string">&#39;&lt;div style=&quot;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;position:absolute;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;width:200%;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;height:200%;&#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;left:0; &#39;</span> <span class="ruby-operator">+</span>
                        <span class="ruby-string">&#39;top:0&quot;&gt;&#39;</span> <span class="ruby-operator">+</span>
                <span class="ruby-string">&#39;&lt;/div&gt;&#39;</span> <span class="ruby-operator">+</span>
        <span class="ruby-string">&#39;&lt;/div&gt;&#39;</span>;

<span class="ruby-identifier">var</span> <span class="ruby-identifier">expand</span> = <span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">childNodes</span>[<span class="ruby-value">0</span>];
<span class="ruby-identifier">var</span> <span class="ruby-identifier">shrink</span> = <span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">childNodes</span>[<span class="ruby-value">1</span>];

<span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">_reset</span> = <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">expand</span>.<span class="ruby-identifier">scrollLeft</span> = <span class="ruby-identifier">maxSize</span>;
        <span class="ruby-identifier">expand</span>.<span class="ruby-identifier">scrollTop</span> = <span class="ruby-identifier">maxSize</span>;
        <span class="ruby-identifier">shrink</span>.<span class="ruby-identifier">scrollLeft</span> = <span class="ruby-identifier">maxSize</span>;
        <span class="ruby-identifier">shrink</span>.<span class="ruby-identifier">scrollTop</span> = <span class="ruby-identifier">maxSize</span>;
};
<span class="ruby-identifier">var</span> <span class="ruby-identifier">onScroll</span> = <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">resizer</span>.<span class="ruby-identifier">_reset</span>();
        <span class="ruby-identifier">handler</span>();
};

<span class="ruby-identifier">addEventListener</span>(<span class="ruby-identifier">expand</span>, <span class="ruby-string">&#39;scroll&#39;</span>, <span class="ruby-identifier">onScroll</span>.<span class="ruby-identifier">bind</span>(<span class="ruby-identifier">expand</span>, <span class="ruby-string">&#39;expand&#39;</span>));
<span class="ruby-identifier">addEventListener</span>(<span class="ruby-identifier">shrink</span>, <span class="ruby-string">&#39;scroll&#39;</span>, <span class="ruby-identifier">onScroll</span>.<span class="ruby-identifier">bind</span>(<span class="ruby-identifier">shrink</span>, <span class="ruby-string">&#39;shrink&#39;</span>));

<span class="ruby-keyword">return</span> <span class="ruby-identifier">resizer</span>;
</pre>

<p>}</p>

<p>// <a
href="https://davidwalsh.name/detect-node-insertion">davidwalsh.name/detect-node-insertion</a>
function watchForRender(node, handler) {</p>

<pre>var expando = node[EXPANDO_KEY] || (node[EXPANDO_KEY] = {});
...
node.classList.add(CSS_RENDER_MONITOR);</pre>

<p>}</p>

<p>function unwatchForRender(node) {</p>

<pre>var expando = node[EXPANDO_KEY] || {};
...
node.classList.remove(CSS_RENDER_MONITOR);</pre>

<p>}</p>

<p>function addResizeListener(node, listener, chart) {</p>
...
<p>function removeResizeListener(node) {</p>
...
<p>function injectCSS(platform, css) {</p>

<pre>// http://stackoverflow.com/q/3922139
...
style.appendChild(document.createTextNode(css));</pre>
...
<pre> Provided for backward compatibility, use EventTarget.addEventListener instead.
...
<p>helpers.addEvent = addEventListener;</p>

<p>/**</p>

<pre> Provided for backward compatibility, use EventTarget.removeEventListener instead.
...
<p>helpers.removeEvent = removeEventListener;</p>

<p>},{“46”:46}],49:[function(require,module,exports){ &#39;use strict&#39;;</p>

<p>var helpers = require(46); var basic = require(47); var dom = require(48);</p>

<p>// @TODO Make possible to select another platform at build time. var
implementation = dom._enabled ? dom : basic;</p>

<p>/**</p>

<pre> @namespace Chart.platform
 @see https://chartjs.gitbooks.io/proposals/content/Platform.html
 @since 2.4.0
/</pre>

<p>module.exports = helpers.extend({</p>
...
/
     removeEventListener: function() {}</pre>

<p>}, implementation);</p>

<p>/**</p>

<pre> @interface IPlatform
...
<p>},{“46”:46,“47”:47,“48”:48}],50:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>module.exports = {}; module.exports.filler = require(51);
module.exports.legend = require(52); module.exports.title = require(53);</p>

<p>},{“51”:51,“52”:52,“53”:53}],51:[function(require,module,exports){ /**</p>

<pre> Plugin based on discussion from the following Chart.js issues:
...
<p>// @todo if (<a href="0">fill</a> === &#39;#&#39;) function decodeFill(el,
index, count) {</p>

<pre>var model = el._model || {};
var fill = model.fill;
var target;
...
<p>function computeBoundary(source) {</p>

<pre>var model = source.el._model || {};
...
<p>function resolveTarget(sources, index, propagate) {</p>

<pre>var source = sources[index];
var fill = source.fill;
var visited = [index];
var target;
...
<p>function createMapper(source) {</p>

<pre>var fill = source.fill;
var type = &#39;dataset&#39;;
...
return mappers[type](source);</pre>

<p>}</p>

<p>function isDrawable(point) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">point</span> <span class="ruby-operator">&amp;&amp;</span> <span class="ruby-operator">!</span><span class="ruby-identifier">point</span>.<span class="ruby-identifier">skip</span>;
</pre>

<p>}</p>

<p>function drawArea(ctx, curve0, curve1, len0, len1) {</p>
...
<p>function doFill(ctx, points, mapper, view, color, loop) {</p>

<pre>var count = points.length;
...
<p>},{“26”:26,“41”:41,“46”:46}],52:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var Element = require(27); var helpers =
require(46); var layouts = require(31);</p>

<p>var noop = helpers.noop;</p>
...
<pre> Helper function to get the box width based on the usePointStyle option
 @param labelopts {Object} the label options on the legend
 @param fontSize {Number} the label font size
 @return {Number} width of the color box area
/</pre>

<p>function getBoxWidth(labelOpts, fontSize) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">labelOpts</span>.<span class="ruby-identifier">usePointStyle</span> <span class="ruby-operator">?</span>
        <span class="ruby-identifier">fontSize</span> <span class="ruby-operator">*</span> <span class="ruby-constant">Math</span>.<span class="ruby-constant">SQRT2</span> <span class="ruby-operator">:</span>
        <span class="ruby-identifier">labelOpts</span>.<span class="ruby-identifier">boxWidth</span>;
</pre>
...
<pre> IMPORTANT: this class is exposed publicly as Chart.Legend, backward compatibility required!
/</pre>

<p>var Legend = Element.extend({</p>

<pre>     initialize: function(config) {
...
<p>function createNewLegendAndAttach(chart, legendOpts) {</p>

<pre>var legend = new Legend({
        ctx: chart.ctx,
        options: legendOpts,
        chart: chart
});
...
<p>},{“26”:26,“27”:27,“31”:31,“46”:46}],53:[function(require,module,exports){
&#39;use strict&#39;;</p>
...
<p>function createNewTitleBlockAndAttach(chart, titleOpts) {</p>

<pre>var title = new Title({
        ctx: chart.ctx,
        options: titleOpts,
        chart: chart
});
...
<p>},{“26”:26,“27”:27,“31”:31,“46”:46}],54:[function(require,module,exports){
&#39;use strict&#39;;</p>

<p>var Scale = require(33); var scaleService = require(34);</p>

<p>module.exports = function() {</p>

<pre>     // Default config for a category scale
     var defaultConfig = {
             position: &#39;bottom&#39;
     };
...
/
     ...
     scaleService.registerScaleType(&#39;category&#39;, DatasetScale, defaultConfig);</pre>

<p>};</p>

<p>},{“33”:33,“34”:34}],55:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var defaults = require(26); var helpers = require(46); var scaleService =
require(34); var Ticks = require(35);</p>

<p>module.exports = function(Chart) {</p>

<pre>var defaultConfig = {
        position: &#39;left&#39;,
        ticks: {
...
scaleService.registerScaleType(&#39;linear&#39;, LinearScale, defaultConfig);</pre>

<p>};</p>

<p>},{“26”:26,“34”:34,“35”:35,“46”:46}],56:[function(require,module,exports){
&#39;use strict&#39;;</p>

<p>var helpers = require(46); var Scale = require(33);</p>

<p>/**</p>

<pre> Generate a set of linear ticks
 @param generationOptions the options used to generate the ticks
 @param dataRange the range of the data
 @returns {Array&lt;Number&gt;} array of tick values
/</pre>

<p>function generateTicks(generationOptions, dataRange) {</p>
...
<p>},{“33”:33,“46”:46}],57:[function(require,module,exports){ &#39;use
strict&#39;;</p>

<p>var helpers = require(46); var Scale = require(33); var scaleService =
require(34); var Ticks = require(35);</p>

<p>/**</p>

<pre> Generate a set of logarithmic ticks
 @param generationOptions the options used to generate the ticks
 @param dataRange the range of the data
 @returns {Array&lt;Number&gt;} array of tick values
/</pre>
...
/
    ...
    scaleService.registerScaleType(&#39;logarithmic&#39;, LogarithmicScale, defaultConfig);</pre>

<p>};</p>

<p>},{“33”:33,“34”:34,“35”:35,“46”:46}],58:[function(require,module,exports){
&#39;use strict&#39;;</p>
...
/
 ...
 /
     ...
     scaleService.registerScaleType(&#39;radialLinear&#39;, LinearRadialScale, defaultConfig);</pre>

<p>};</p>

<p>},{“26”:26,“34”:34,“35”:35,“46”:46}],59:[function(require,module,exports){
/* global window: false */ &#39;use strict&#39;;</p>

<p>var moment = require(1); moment = typeof moment === &#39;function&#39; ?
moment : window.moment;</p>

<p>var defaults = require(26); var helpers = require(46); var Scale =
require(33); var scaleService = require(34);</p>

<p>// Integer constants are from the ES6 spec. var MIN_INTEGER =
Number.MIN_SAFE_INTEGER || -9007199254740991; var MAX_INTEGER =
...
<p>var UNITS = Object.keys(INTERVALS);</p>
...
<p>function arrayUnique(items) {</p>
...
<pre> Returns an array of {time, pos} objects used to interpolate a specific `time` or position
...
<p>function buildLookupTable(timestamps, min, max, distribution) {</p>

<pre>if (distribution === &#39;linear&#39; || !timestamps.length) {
        return [
                {time: min, pos: 0},
                {time: max, pos: 1}
        ];
...
<p>// @see adapted from <a
href="http://www.anujgakhar.com/2014/03/01/binary-search-in-javascript">www.anujgakhar.com/2014/03/01/binary-search-in-javascript</a>/
function lookup(table, key, value) {</p>
...
return {lo: i1, hi: null};</pre>

<p>}</p>

<p>/**</p>

<pre> Linearly interpolates the given source `value` using the table items `skey` values and
 returns the associated `tkey` value. For example, interpolate(table, &#39;time&#39;, 42, &#39;pos&#39;)
 returns the position for a timestamp equal to 42. If value is out of bounds, values at
 index [0, 1] or [n - 1, n] are used for the interpolation.
/</pre>

<p>function interpolate(table, skey, sval, tkey) {</p>

<pre>var range = lookup(table, skey, sval);
...
return prev[tkey] + offset;</pre>

<p>}</p>

<p>/**</p>

<pre> Convert the given value to a moment object using the given time options.
 @see http://momentjs.com/docs/#/parsing/
/</pre>

<p>function momentify(value, options) {</p>

<pre>var parser = options.parser;
...
<p>function parse(input, scale) {</p>

<pre>if (helpers.isNullOrUndef(input)) {
        return null;
}
...
return value.valueOf();</pre>

<p>}</p>

<p>/**</p>

<pre> Returns the number of unit to skip to be able to display up to `capacity` number of ticks
 in `unit` for the given `min` / `max` range and respecting the interval steps constraints.
/</pre>

<p>function determineStepSize(min, max, unit, capacity) {</p>

<pre>var range = max - min;
...
<pre> Figures out what unit results in an appropriate number of auto-generated ticks
/</pre>

<p>function determineUnitForAutoTicks(minUnit, min, max, capacity) {</p>

<pre>var ilen = UNITS.length;
...
return UNITS[ilen - 1];</pre>

<p>}</p>

<p>/**</p>

<pre> Figures out what unit to format a set of ticks with
/</pre>

<p>function determineUnitForFormatting(ticks, minUnit, min, max) {</p>

<pre>var duration = moment.duration(moment(max).diff(moment(min)));
...
return UNITS[minUnit ? UNITS.indexOf(minUnit) : 0];</pre>

<p>}</p>

<p>function determineMajorUnit(unit) {</p>

<pre>for (var i = UNITS.indexOf(unit) + 1, ilen = UNITS.length; i &lt; ilen; ++i) {
...
<pre> Generates a maximum of `capacity` timestamps between min and max, rounded to the
 `minor` unit, aligned on the `major` unit and using the given scale time `options`.
 Important: this method can return ticks outside the min and max range, it&#39;s the
 responsibility of the calling code to clamp values if needed.
/</pre>

<p>function generate(min, max, capacity, options) {</p>

<pre>var timeOpts = options.time;
...
<pre> Returns the right and left offsets from edges in the form of {left, right}.
 Offsets are added when the `offset` option is true.
/</pre>

<p>function computeOffsets(table, ticks, min, max, options) {</p>
...
return {left: left, right: right};</pre>

<p>}</p>

<p>function ticksFromTimestamps(values, majorUnit) {</p>
...
<p>function determineLabelFormat(data, timeOpts) {</p>

<pre>var i, momentDate, hasTime;
...
/
    ...
    scaleService.registerScaleType(&#39;time&#39;, TimeScale, defaultConfig);</pre>

<p>};</p>

<p>},{“1”:1,“26”:26,“33”:33,“34”:34,“46”:46}]},{},[7])(7) });</p>
</main>
