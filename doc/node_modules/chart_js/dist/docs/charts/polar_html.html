...
<title>polar.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/charts/polar.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;polar-area&quot;&gt;Polar Area&lt;/h1&gt;</pre>

<p>&lt;p&gt;Polar area charts are similar to pie charts, but each segment has
the same angle - the radius of the segment differs depending on the
value.&lt;/p&gt; &lt;p&gt;This type of chart is often useful when we want
to show a comparison data similar to a pie chart, but also show a scale of
values for context.&lt;/p&gt; &lt;p&gt;&lt;div
class=“chartjs-wrapper”&gt;&lt;canvas id=“chartjs-5” class=“chartjs”
...
First <a
href="11,16,7,3,14">Dataset”,“data”:</a>,“backgroundColor”:[“rgb(255, 99,
132)”,“rgb(75, 192, 192)”,“rgb(255, 205, 86)”,“rgb(201, 203, 207)”,“rgb(54,
162, 235)”]}]}});&lt;/script&gt;&lt;/div&gt;&lt;/p&gt; &lt;h2
...
Properties&lt;/h2&gt; &lt;p&gt;The following options can be included in a
polar area chart dataset to configure options for that specific
dataset.&lt;/p&gt; &lt;table&gt; &lt;thead&gt; &lt;tr&gt;
...
the customisation options specific to Polar Area charts. These options are
merged with the &lt;a href=“#default-options”&gt;global chart default
options&lt;/a&gt;, and form the options of the chart.&lt;/p&gt;
&lt;table&gt; &lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Type&lt;/th&gt; &lt;th&gt;Default&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>startAngle</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;<code>-0.5 *
Math.PI</code>&lt;/td&gt; &lt;td&gt;Starting angle to draw arcs for the
first item in a dataset.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
...
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;If true, will animate
scaling the chart from the center outwards.&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt; &lt;h2 id=“default-options”&gt;Default
Options&lt;/h2&gt; &lt;p&gt;We can also change these defaults values for
each PolarArea type that is created, this object is available at
<code>Chart.defaults.polarArea</code>. Changing the global options only
affects charts created after the change. Existing charts are not
changed.&lt;/p&gt; &lt;p&gt;For example, to configure all new polar area
charts with <code>animateScale = false</code> you would do:&lt;/p&gt;
&lt;pre&gt;&lt;code
class=“lang-javascript”&gt;Chart.defaults.polarArea.animation.animateScale
= &lt;span class=“hljs-literal”&gt;false&lt;/span&gt;;
&lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“data-structure”&gt;Data
Structure&lt;/h2&gt; &lt;p&gt;For a polar area chart, datasets need to
contain an array of data points. The data points should be a number,
Chart.js will total all of the numbers and calculate the relative
proportion of each.&lt;/p&gt; &lt;p&gt;You also need to specify an array of
labels so that tooltips appear correctly for each slice.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;data = {</p>
