...
<title>scatter.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/charts/scatter.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;scatter-chart&quot;&gt;Scatter Chart&lt;/h1&gt;</pre>

<p>&lt;p&gt;Scatter charts are based on basic line charts with the x axis
changed to a linear axis. To use a scatter chart, data must be passed as
objects containing X and Y properties. The example below creates a scatter
chart with 3 points.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; scatterChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>

<pre>type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;scatter&amp;apos;&lt;/span&gt;,
data: {
    datasets: [{
...
Properties&lt;/h2&gt; &lt;p&gt;The scatter chart supports all of the same
properties as the &lt;a href=“line.html#dataset-properties”&gt;line
chart&lt;/a&gt;.&lt;/p&gt; &lt;h2 id=“data-structure”&gt;Data
Structure&lt;/h2&gt; &lt;p&gt;Unlike the line chart where data can be
supplied in two different formats, the scatter chart only accepts data in a
point format.&lt;/p&gt; &lt;pre&gt;&lt;code
