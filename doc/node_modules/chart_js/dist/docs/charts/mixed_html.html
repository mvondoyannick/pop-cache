...
<title>mixed.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/charts/mixed.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;mixed-chart-types&quot;&gt;Mixed Chart Types&lt;/h1&gt;</pre>

<p>&lt;p&gt;With Chart.js, it is possible to create mixed charts that are a
combination of two or more different chart types. A common example is a bar
chart that also includes a line dataset.&lt;/p&gt; &lt;p&gt;Creating a
mixed chart starts with the initialization of a basic chart.&lt;/p&gt;
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;At this point we have a standard bar
chart. Now we need to convert one of the datasets to a line
dataset.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; mixedChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;At this point we have a chart
rendering how we&amp;apos;d like. It&amp;apos;s important to note that the
default options for a line chart are not merged in this case. Only the
options for the default type are merged in. In this case, that means that
the default options for a bar chart are merged because that is the type
specified by the <code>type</code> field.&lt;/p&gt; &lt;p&gt;&lt;div
class=“chartjs-wrapper”&gt;&lt;canvas id=“chartjs-7” class=“chartjs”
...
<a href="10,20,30,40">Dataset”,“data”:</a>,“borderColor”:“rgb(255, 99,
132)”,“backgroundColor”:“rgba(255, 99, 132, 0.2)”},{“label”:“Line <a
href="50,50,50,50">Dataset”,“data”:</a>,“type”:“line”,“fill”:false,“borderColor”:“rgb(54,
162, 235)”}]},“options”:{“scales”:{“<a
href="{"ticks":{"beginAtZero":true}}">yAxes”:</a>}}});&lt;/script&gt;&lt;/div&gt;&lt;/p&gt;</p>
