...
<title>bar.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/charts/bar.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;bar&quot;&gt;Bar&lt;/h1&gt;</pre>

<p>&lt;p&gt;A bar chart provides a way of showing data values represented as
vertical bars. It is sometimes used to show trend data, and the comparison
of multiple data sets side by side.&lt;/p&gt; &lt;p&gt;&lt;div
class=“chartjs-wrapper”&gt;&lt;canvas id=“chartjs-1” class=“chartjs”
width=“undefined” height=“undefined”&gt;&lt;/canvas&gt;&lt;script&gt;new
...
99, 132, 0.2)”,“rgba(255, 159, 64, 0.2)”,“rgba(255, 205, 86,
0.2)”,“rgba(75, 192, 192, 0.2)”,“rgba(54, 162, 235, 0.2)”,“rgba(153, 102,
255, 0.2)”,“rgba(201, 203, 207, 0.2)”],“borderColor”:[“rgb(255, 99,
132)”,“rgb(255, 159, 64)”,“rgb(255, 205, 86)”,“rgb(75, 192, 192)”,“rgb(54,
162, 235)”,“rgb(153, 102, 255)”,“rgb(201, 203,
207)”],“borderWidth”:1}]},“options”:{“scales”:{“<a
href="{"ticks":{"beginAtZero":true}}">yAxes”:</a>}}});&lt;/script&gt;&lt;/div&gt;&lt;/p&gt;
&lt;h2 id=“example-usage”&gt;Example Usage&lt;/h2&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; myBarChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>

<pre>type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;bar&amp;apos;&lt;/span&gt;,
data: data,
options: options</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“dataset-properties”&gt;Dataset
Properties&lt;/h2&gt; &lt;p&gt;The bar chart allows a number of properties
...
set this way.&lt;/p&gt; &lt;p&gt;Some properties can be specified as an
...
&lt;td&gt;<code>Color/Color[]</code>&lt;/td&gt; &lt;td&gt;The fill color of
the bar. See &lt;a
href=“../general/colors.html#colors”&gt;Colors&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>borderColor</code>&lt;/td&gt;
&lt;td&gt;<code>Color/Color[]</code>&lt;/td&gt; &lt;td&gt;The color of the
bar border. See &lt;a
href=“../general/colors.html#colors”&gt;Colors&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>borderWidth</code>&lt;/td&gt;
&lt;td&gt;<code>Number/Number[]</code>&lt;/td&gt; &lt;td&gt;The stroke
width of the bar in pixels.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>borderSkipped</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;Which edge to skip
drawing the border for. &lt;a
href=“#borderskipped”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>hoverBackgroundColor</code>&lt;/td&gt;
&lt;td&gt;<code>Color/Color[]</code>&lt;/td&gt; &lt;td&gt;The fill colour
of the bars when hovered.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>hoverBorderColor</code>&lt;/td&gt;
&lt;td&gt;<code>Color/Color[]</code>&lt;/td&gt; &lt;td&gt;The stroke colour
of the bars when hovered.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>hoverBorderWidth</code>&lt;/td&gt;
&lt;td&gt;<code>Number/Number[]</code>&lt;/td&gt; &lt;td&gt;The stroke
width of the bars when hovered.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;
&lt;/table&gt; &lt;h3 id=“borderskipped”&gt;borderSkipped&lt;/h3&gt;
&lt;p&gt;This setting is used to avoid drawing the bar stroke at the base
of the fill. In general, this does not need to be changed except when
creating chart types that derive from a bar chart.&lt;/p&gt;
&lt;p&gt;Options are:&lt;/p&gt; &lt;ul&gt;
&lt;li&gt;&amp;apos;bottom&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;left&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;top&amp;apos;&lt;/li&gt;
...
bar chart defines the following configuration options. These options are
...
&lt;td&gt;<code>0.9</code>&lt;/td&gt; &lt;td&gt;Percent (0-1) of the
available width each bar should be within the category width. 1.0 will take
the whole category width and put the bars right next to each other. &lt;a
href=“#barpercentage-vs-categorypercentage”&gt;more…&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>categoryPercentage</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>0.8</code>&lt;/td&gt; &lt;td&gt;Percent (0-1) of the
available width each category should be within the sample width. &lt;a
href=“#barpercentage-vs-categorypercentage”&gt;more…&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>barThickness</code>&lt;/td&gt;
&lt;td&gt;<code>Number/String</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Manually set width of each bar in pixels. If set to
<code>&amp;apos;flex&amp;apos;</code>, it computes
&amp;quot;optimal&amp;quot; sample widths that globally arrange bars side
by side. If not set (default), bars are equally sized based on the smallest
interval. &lt;a href=“#barthickness”&gt;more…&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>maxBarThickness</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Set this to ensure that bars are not sized thicker than
this.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>gridLines.offsetGridLines</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;If true, the bars for a
particular data point fall between the grid lines. The grid line will move
to the left by one half of the tick interval. If false, the grid line will
go right down the middle of the bars. &lt;a
href=“#offsetgridlines”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt; &lt;h3
id=“barthickness”&gt;barThickness&lt;/h3&gt; &lt;p&gt;If this value is a
number, it is applied to the width of each bar, in pixels. When this is
enforced, <code>barPercentage</code> and <code>categoryPercentage</code>
are ignored.&lt;/p&gt; &lt;p&gt;If set to
<code>&amp;apos;flex&amp;apos;</code>, the base sample widths are
calculated automatically based on the previous and following samples so
that they take the full available widths without overlap. Then, bars are
sized using <code>barPercentage</code> and <code>categoryPercentage</code>.
There is no gap when the percentage options are 1. This mode generates bars
with different widths when data are not evenly spaced.&lt;/p&gt;
&lt;p&gt;If not set (default), the base sample widths are calculated using
the smallest interval that prevents bar overlapping, and bars are sized
using <code>barPercentage</code> and <code>categoryPercentage</code>. This
mode always generates bars equally sized.&lt;/p&gt; &lt;h3
id=“offsetgridlines”&gt;offsetGridLines&lt;/h3&gt; &lt;p&gt;If true, the
...
while false for other scales or chart types by default.&lt;/p&gt;
&lt;p&gt;This setting applies to the axis configuration. If axes are added
to the chart, this setting will need to be set for each new axis.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;options = {</p>
...
<p>} &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“default-options”&gt;Default
Options&lt;/h2&gt; &lt;p&gt;It is common to want to apply a configuration
setting to all created bar charts. The global bar chart settings are stored
in <code>Chart.defaults.bar</code>. Changing the global options only
affects charts created after the change. Existing charts are not
changed.&lt;/p&gt; &lt;h2
id=“barpercentage-vs-categorypercentage”&gt;barPercentage vs
categoryPercentage&lt;/h2&gt; &lt;p&gt;The following shows the relationship
between the bar percentage option and the category percentage
option.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-text”&gt;//
categoryPercentage: 1.0 // barPercentage: 1.0 Bar:        | 1.0 | 1.0 |
Category:   |    1.0    | Sample:     |===========|</p>

<p>// categoryPercentage: 1.0 // barPercentage: 0.5 Bar:          |.5|  |.5|
Category:  |      1.0     | Sample:    |==============|</p>

<p>// categoryPercentage: 0.5 // barPercentage: 1.0 Bar:            |1.||1.|
Category:       |  .5  | Sample:     |==============|
&lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“data-structure”&gt;Data
Structure&lt;/h2&gt; &lt;p&gt;The <code>data</code> property of a dataset
for a bar chart is specified as a an array of numbers. Each point in the
data array corresponds to the label at the same index on the x
axis.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-javascript”&gt;data:
[&lt;span class=“hljs-number”&gt;20&lt;/span&gt;, &lt;span
class=“hljs-number”&gt;10&lt;/span&gt;] &lt;/code&gt;&lt;/pre&gt;
&lt;p&gt;You can also specify the dataset as x/y coordinates when using the
&lt;a href=“../axes/cartesian/time.html#time-cartesian-axis”&gt;time
scale&lt;/a&gt;.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;data: [{x:&lt;span
class=“hljs-string”&gt;&amp;apos;2016-12-25&amp;apos;&lt;/span&gt;,
y:&lt;span class=“hljs-number”&gt;20&lt;/span&gt;}, {x:&lt;span
class=“hljs-string”&gt;&amp;apos;2016-12-26&amp;apos;&lt;/span&gt;,
y:&lt;span class=“hljs-number”&gt;10&lt;/span&gt;}]
&lt;/code&gt;&lt;/pre&gt; &lt;h1 id=“stacked-bar-chart”&gt;Stacked Bar
Chart&lt;/h1&gt; &lt;p&gt;Bar charts can be configured into stacked bar
charts by changing the settings on the X and Y axes to enable stacking.
Stacked bar charts can be used to show how one data series is made up of a
number of smaller pieces.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; stackedBar = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“dataset-properties”&gt;Dataset
Properties&lt;/h2&gt; &lt;p&gt;The following dataset properties are
specific to stacked bar charts.&lt;/p&gt; &lt;table&gt; &lt;thead&gt;
&lt;tr&gt; &lt;th&gt;Name&lt;/th&gt; &lt;th&gt;Type&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>stack</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;The ID of the group to
which this dataset belongs to (when stacked, each group will be a separate
stack)&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt; &lt;/table&gt; &lt;h1
id=“horizontal-bar-chart”&gt;Horizontal Bar Chart&lt;/h1&gt; &lt;p&gt;A
horizontal bar chart is a variation on a vertical bar chart. It is
sometimes used to show trend data, and the comparison of multiple data sets
side by side. &lt;div class=“chartjs-wrapper”&gt;&lt;canvas id=“chartjs-2”
...
162, 235)”,“rgb(153, 102, 255)”,“rgb(201, 203,
207)”],“borderWidth”:1}]},“options”:{“scales”:{“<a
href="{"ticks":{"beginAtZero":true}}">xAxes”:</a>}}});&lt;/script&gt;&lt;/div&gt;&lt;/p&gt;
&lt;h2 id=“example”&gt;Example&lt;/h2&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; myBarChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>

<pre>type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;horizontalBar&amp;apos;&lt;/span&gt;,
data: data,
options: options</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“config-options”&gt;Config
Options&lt;/h2&gt; &lt;p&gt;The configuration options for the horizontal
bar chart are the same as for the &lt;a
href=“#configuration-options”&gt;bar chart&lt;/a&gt;. However, any options
specified on the x axis in a bar chart, are applied to the y axis in a
horizontal bar chart.&lt;/p&gt; &lt;p&gt;The default horizontal bar
configuration is specified in
<code>Chart.defaults.horizontalBar</code>.&lt;/p&gt;</p>
