...
<title>radar.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/charts/radar.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;radar&quot;&gt;Radar&lt;/h1&gt;</pre>

<p>&lt;p&gt;A radar chart is a way of showing multiple data points and the
variation between them.&lt;/p&gt; &lt;p&gt;They are often useful for
comparing the points of two or more different data sets.&lt;/p&gt;
&lt;p&gt;&lt;div class=“chartjs-wrapper”&gt;&lt;canvas id=“chartjs-3”
...
162,
235)”}]},“options”:{“elements”:{“line”:{“tension”:0,“borderWidth”:3}}}});&lt;/script&gt;&lt;/div&gt;&lt;/p&gt;
&lt;h2 id=“example-usage”&gt;Example Usage&lt;/h2&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; myRadarChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>

<pre>type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;radar&amp;apos;&lt;/span&gt;,
data: data,
options: options</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“dataset-properties”&gt;Dataset
Properties&lt;/h2&gt; &lt;p&gt;The radar chart allows a number of
properties to be specified for each dataset. These are used to set display
properties for a specific dataset. For example, the colour of a line is
generally set this way.&lt;/p&gt; &lt;p&gt;All point* properties can be
specified as an array. If these are set to an array value, the first value
applies to the first point, the second value to the second point, and so
on.&lt;/p&gt; &lt;table&gt; &lt;thead&gt; &lt;tr&gt;
...
the line. Set to 0 to draw straightlines.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
...
&lt;td&gt;<code>pointStyle</code>&lt;/td&gt; &lt;<a
href="">td>String/String[]/Image/Image</a>&lt;/td&gt; &lt;td&gt;Style of
the point. &lt;a href=“#pointstyle”&gt;more…&lt;/a&gt;&lt;/td&gt;
...
&lt;td&gt;<code>Number/Number[]</code>&lt;/td&gt; &lt;td&gt;The radius of
the point when hovered.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;
&lt;/table&gt; &lt;h3 id=“pointstyle”&gt;pointStyle&lt;/h3&gt; &lt;p&gt;The
style of point. Options are:&lt;/p&gt; &lt;ul&gt;
&lt;li&gt;&amp;apos;circle&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;cross&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;crossRot&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;dash&amp;apos;.&lt;/li&gt;
...
&lt;li&gt;&amp;apos;rectRot&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;star&amp;apos;&lt;/li&gt;
&lt;li&gt;&amp;apos;triangle&amp;apos;&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;If
the option is an image, that image is drawn on the canvas using &lt;a
href=“<a
href="https://developer.mozilla.org/en/docs/Web/API/CanvasRenderingContext2D/drawImage">developer.mozilla.org/en/docs/Web/API/CanvasRenderingContext2D/drawImage</a>”
target=“_blank”&gt;drawImage&lt;/a&gt;.&lt;/p&gt; &lt;h2
id=“configuration-options”&gt;Configuration Options&lt;/h2&gt;
&lt;p&gt;Unlike other charts, the radar chart has no chart specific
options.&lt;/p&gt; &lt;h2 id=“scale-options”&gt;Scale Options&lt;/h2&gt;
&lt;p&gt;The radar chart supports only a single scale. The options for this
scale are defined in the <code>scale</code> property.&lt;/p&gt;
...
setting to all created radar charts. The global radar chart settings are
stored in <code>Chart.defaults.radar</code>. Changing the global options
only affects charts created after the change. Existing charts are not
changed.&lt;/p&gt; &lt;h2 id=“data-structure”&gt;Data Structure&lt;/h2&gt;
&lt;p&gt;The <code>data</code> property of a dataset for a radar chart is
specified as a an array of numbers. Each point in the data array
corresponds to the label at the same index on the x axis.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;data: [&lt;span
class=“hljs-number”&gt;20&lt;/span&gt;, &lt;span
class=“hljs-number”&gt;10&lt;/span&gt;] &lt;/code&gt;&lt;/pre&gt;
&lt;p&gt;For a radar chart, to provide context of what each point means, we
include an array of strings that show around each point in the
chart.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-javascript”&gt;data: {</p>

<pre>labels: [&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Running&amp;apos;&lt;/span&gt;, &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Swimming&amp;apos;&lt;/span&gt;, &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Eating&amp;apos;&lt;/span&gt;, &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Cycling&amp;apos;&lt;/span&gt;],
datasets: [{
