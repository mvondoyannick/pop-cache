...
<title>responsive.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/general/responsive.html">
...
&lt;link rel=&quot;prev&quot; href=&quot;accessibility.html&quot; /&gt;
...
<pre>    &lt;li class=&quot;chapter &quot; data-level=&quot;1.1&quot; data-path=&quot;../&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.1&quot; data-path=&quot;accessibility.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter active&quot; data-level=&quot;1.3.2&quot; data-path=&quot;responsive.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.3&quot; data-path=&quot;device-pixel-ratio.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.4&quot; data-path=&quot;interactions/&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.4.1&quot; data-path=&quot;interactions/events.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.4.2&quot; data-path=&quot;interactions/modes.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.6&quot; data-path=&quot;colors.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.7&quot; data-path=&quot;fonts.html&quot;&gt;
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;responsive-charts&quot;&gt;Responsive Charts&lt;/h1&gt;</pre>

<p>&lt;p&gt;When it comes to change the chart size based on the window size, a
major limitation is that the canvas <em>render</em> size
(<code>canvas.width</code> and <code>.height</code>) can
&lt;strong&gt;not&lt;/strong&gt; be expressed with relative values,
contrary to the <em>display</em> size (<code>canvas.style.width</code> and
<code>.height</code>). Furthermore, these sizes are independent from each
other and thus the canvas <em>render</em> size does not adjust
automatically based on the <em>display</em> size, making the rendering
inaccurate.&lt;/p&gt; &lt;p&gt;The following examples &lt;strong&gt;do not
work&lt;/strong&gt;:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;<code>&amp;lt;canvas
height=&amp;quot;40vh&amp;quot;
width=&amp;quot;80vw&amp;quot;&amp;gt;</code>:
&lt;strong&gt;invalid&lt;/strong&gt; values, the canvas doesn&amp;apos;t
resize (&lt;a href=“<a
href="https://codepen.io/chartjs/pen/oWLZaR">codepen.io/chartjs/pen/oWLZaR</a>”
target=“_blank”&gt;example&lt;/a&gt;)&lt;/li&gt;
&lt;li&gt;<code>&amp;lt;canvas style=&amp;quot;height:40vh;
width:80vw&amp;quot;&amp;gt;</code>: &lt;strong&gt;invalid&lt;/strong&gt;
behavior, the canvas is resized but becomes blurry (&lt;a href=“<a
href="https://codepen.io/chartjs/pen/WjxpmO">codepen.io/chartjs/pen/WjxpmO</a>”
target=“_blank”&gt;example&lt;/a&gt;)&lt;/li&gt; &lt;/ul&gt;
&lt;p&gt;Chart.js provides a &lt;a href=“#configuration-options”&gt;few
options&lt;/a&gt; to enable responsiveness and control the resize behavior
of charts by detecting when the canvas <em>display</em> size changes and
update the <em>render</em> size accordingly.&lt;/p&gt; &lt;h2
id=“configuration-options”&gt;Configuration Options&lt;/h2&gt;
&lt;table&gt; &lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Type&lt;/th&gt; &lt;th&gt;Default&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>responsive</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;Resizes the chart canvas
when its container does (&lt;a href=“#important-note”&gt;important
note…&lt;/a&gt;).&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>responsiveAnimationDuration</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>0</code>&lt;/td&gt; &lt;td&gt;Duration in milliseconds it
takes to animate to new size after a resize event.&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>maintainAspectRatio</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;Maintain the original
canvas aspect ratio <code>(width / height)</code> when resizing.&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>aspectRatio</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>2</code>&lt;/td&gt; &lt;td&gt;Canvas aspect ratio (i.e.
<code>width / height</code>, a value of 1 representing a square canvas).
Note that this option is ignored if the height is explicitly defined either
as attribute or via the style.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>onResize</code>&lt;/td&gt;
&lt;td&gt;<code>Function</code>&lt;/td&gt;
&lt;td&gt;<code>null</code>&lt;/td&gt; &lt;td&gt;Called when a resize
occurs. Gets passed two arguments: the chart instance and the new
size.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt; &lt;/table&gt; &lt;h2
id=“important-note”&gt;Important Note&lt;/h2&gt; &lt;p&gt;Detecting when
the canvas size changes can not be done directly from the
<code>CANVAS</code> element. Chart.js uses its parent container to update
the canvas <em>render</em> and <em>display</em> sizes. However, this method
requires the container to be &lt;strong&gt;relatively
positioned&lt;/strong&gt; and &lt;strong&gt;dedicated to the chart canvas
only&lt;/strong&gt;. Responsiveness can then be achieved by setting
relative values for the container size (&lt;a href=“<a
href="https://codepen.io/chartjs/pen/YVWZbz">codepen.io/chartjs/pen/YVWZbz</a>”
target=“_blank”&gt;example&lt;/a&gt;):&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-html”&gt;&lt;span class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;div&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;class&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;chart-container&amp;quot;&lt;/span&gt;
&lt;span class=“hljs-attr”&gt;style&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;position: relative; height:40vh;
width:80vw&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;</p>

<pre>&lt;span class=&quot;hljs-tag&quot;&gt;&amp;lt;&lt;span class=&quot;hljs-name&quot;&gt;canvas&lt;/span&gt; &lt;span class=&quot;hljs-attr&quot;&gt;id&lt;/span&gt;=&lt;span class=&quot;hljs-string&quot;&gt;&amp;quot;chart&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;&lt;span class=&quot;hljs-tag&quot;&gt;&amp;lt;/&lt;span class=&quot;hljs-name&quot;&gt;canvas&lt;/span&gt;&amp;gt;&lt;/span&gt;</pre>

<p>&lt;span class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;div&lt;/span&gt;&amp;gt;&lt;/span&gt;
&lt;/code&gt;&lt;/pre&gt; &lt;p&gt;The chart can also be programmatically
resized by modifying the container size:&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;chart.canvas.parentNode.style.height = &lt;span
class=“hljs-string”&gt;&amp;apos;128px&amp;apos;&lt;/span&gt;;
&lt;/code&gt;&lt;/pre&gt; &lt;h2
id=“printing-resizeable-charts”&gt;Printing Resizeable Charts&lt;/h2&gt;
&lt;p&gt;CSS media queries allow changing styles when printing a page. The
CSS applied from these media queries may cause charts to need to resize.
However, the resize won&amp;apos;t happen automatically. To support
resizing charts when printing, one needs to hook the &lt;a href=“<a
href="https://developer.mozilla.org/en-US/docs/Web/API/WindowEventHandlers/onbeforeprint">developer.mozilla.org/en-US/docs/Web/API/WindowEventHandlers/onbeforeprint</a>”
target=“_blank”&gt;onbeforeprint&lt;/a&gt; event and manually trigger
resizing of each chart.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;beforePrintHandler&lt;/span&gt; (&lt;span
class=“hljs-params”&gt;&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>&lt;span class=&quot;hljs-keyword&quot;&gt;for&lt;/span&gt; (&lt;span class=&quot;hljs-keyword&quot;&gt;var&lt;/span&gt; id &lt;span class=&quot;hljs-keyword&quot;&gt;in&lt;/span&gt; Chart.instances) {
...
<pre>                    &lt;/div&gt;
        ...
        &lt;/div&gt;
            ...
            &lt;a href=&quot;accessibility.html&quot; class=&quot;navigation navigation-prev &quot; aria-label=&quot;Previous page: Accessibility&quot;&gt;
