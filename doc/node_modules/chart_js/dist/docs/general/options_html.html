...
<title>options.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/general/options.html">
...
<pre>&lt;head&gt;
    ...
    &lt;title&gt;Options · Chart.js documentation&lt;/title&gt;
...
<pre>    &lt;li class=&quot;chapter &quot; data-level=&quot;1.1&quot; data-path=&quot;../&quot;&gt;
    ...
    &lt;li class=&quot;chapter active&quot; data-level=&quot;1.3.5&quot; data-path=&quot;options.html&quot;&gt;
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;options&quot;&gt;Options&lt;/h1&gt;</pre>

<p>&lt;h2 id=“scriptable-options”&gt;Scriptable Options&lt;/h2&gt;
&lt;p&gt;Scriptable options also accept a function which is called for each
data and that takes the unique argument <code>context</code> representing
contextual information (see &lt;a
href=“options.html#option-context”&gt;option context&lt;/a&gt;).&lt;/p&gt;
&lt;p&gt;Example:&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;color: &lt;span
class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;context&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>&lt;span class=&quot;hljs-keyword&quot;&gt;var&lt;/span&gt; index = context.dataIndex;
...
&lt;span class=&quot;hljs-keyword&quot;&gt;return&lt;/span&gt; value &amp;lt; &lt;span class=&quot;hljs-number&quot;&gt;0&lt;/span&gt; ? &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;red&amp;apos;&lt;/span&gt; :  &lt;span class=&quot;hljs-comment&quot;&gt;// draw negative values in red&lt;/span&gt;
    ...
    &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;green&amp;apos;&lt;/span&gt;;</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;blockquote&gt;
&lt;p&gt;&lt;strong&gt;Note:&lt;/strong&gt; scriptable options are only
supported by a few bubble chart options.&lt;/p&gt; &lt;/blockquote&gt;
&lt;h2 id=“indexable-options”&gt;Indexable Options&lt;/h2&gt;
&lt;p&gt;Indexable options also accept an array in which each item
corresponds to the element at the same index. Note that this method
requires to provide as many items as data, so, in most cases, using a &lt;a
href=“#scriptable-options”&gt;function&lt;/a&gt; is more appropriated if
supported.&lt;/p&gt; &lt;p&gt;Example:&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;color: [</p>

<pre>&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;red&amp;apos;&lt;/span&gt;,    &lt;span class=&quot;hljs-comment&quot;&gt;// color for data at index 0&lt;/span&gt;
...
<p>] &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“option-context”&gt;Option
Context&lt;/h2&gt; &lt;p&gt;The option context is used to give contextual
information when resolving options and currently only applies to &lt;a
href=“#scriptable-options”&gt;scriptable options&lt;/a&gt;.&lt;/p&gt;
&lt;p&gt;The context object contains the following properties:&lt;/p&gt;
&lt;ul&gt; &lt;li&gt;<code>chart</code>: the associated chart&lt;/li&gt;
&lt;li&gt;<code>dataIndex</code>: index of the current data&lt;/li&gt;
&lt;li&gt;<code>dataset</code>: dataset at index
<code>datasetIndex</code>&lt;/li&gt; &lt;li&gt;<code>datasetIndex</code>:
index of the current dataset&lt;/li&gt; &lt;/ul&gt;
&lt;p&gt;&lt;strong&gt;Important&lt;/strong&gt;: since the context can
represent different types of entities (dataset, data, etc.), some
properties may be <code>undefined</code> so be sure to test any context
property before using it.&lt;/p&gt;</p>
