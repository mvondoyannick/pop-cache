...
<title>modes.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/general/interactions/modes.html">
...
<pre>&lt;head&gt;
    ...
    &lt;title&gt;Modes · Chart.js documentation&lt;/title&gt;
...
<pre>    &lt;li class=&quot;chapter &quot; data-level=&quot;1.1&quot; data-path=&quot;../../&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.4.1&quot; data-path=&quot;events.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter active&quot; data-level=&quot;1.3.4.2&quot; data-path=&quot;modes.html&quot;&gt;
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;interaction-modes&quot;&gt;Interaction Modes&lt;/h1&gt;</pre>

<p>&lt;p&gt;When configuring interaction with the graph via hover or tooltips,
a number of different modes are available.&lt;/p&gt; &lt;p&gt;The modes are
detailed below and how they behave in conjunction with the
<code>intersect</code> setting.&lt;/p&gt; &lt;h2
id=“point”&gt;point&lt;/h2&gt; &lt;p&gt;Finds all of the items that
intersect the point.&lt;/p&gt; &lt;pre&gt;&lt;code
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“nearest”&gt;nearest&lt;/h2&gt;
&lt;p&gt;Gets the item that is nearest to the point. The nearest item is
determined based on the distance to the center of the chart item (point,
bar). If 2 or more items are at the same distance, the one with the
smallest area is used. If <code>intersect</code> is true, this is only
triggered when the mouse position intersects an item in the graph. This is
very useful for combo charts where points are hidden behind bars.&lt;/p&gt;
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“single-deprecated”&gt;single
(deprecated)&lt;/h2&gt; &lt;p&gt;Finds the first item that intersects the
point and returns it. Behaves like &amp;apos;nearest&amp;apos; mode with
intersect = true.&lt;/p&gt; &lt;h2 id=“label-deprecated”&gt;label
(deprecated)&lt;/h2&gt; &lt;p&gt;See <code>&amp;apos;index&amp;apos;</code>
mode&lt;/p&gt; &lt;h2 id=“index”&gt;index&lt;/h2&gt; &lt;p&gt;Finds item at
the same index. If the <code>intersect</code> setting is true, the first
intersecting item is used to determine the index in the data. If
<code>intersect</code> false the nearest item, in the x direction, is used
to determine the index.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;To use index mode in a chart like the
horizontal bar chart, where we search along the y direction, you can use
the <code>axis</code> setting introduced in v2.7.0. By setting this value
to <code>&amp;apos;y&amp;apos;</code> on the y direction is used.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“x-axis-deprecated”&gt;x-axis
(deprecated)&lt;/h2&gt; &lt;p&gt;Behaves like
<code>&amp;apos;index&amp;apos;</code> mode with <code>intersect =
false</code>.&lt;/p&gt; &lt;h2 id=“dataset”&gt;dataset&lt;/h2&gt;
&lt;p&gt;Finds items in the same dataset. If the <code>intersect</code>
setting is true, the first intersecting item is used to determine the index
in the data. If <code>intersect</code> false the nearest item is used to
determine the index.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“x”&gt;x&lt;/h2&gt; &lt;p&gt;Returns
all items that would intersect based on the <code>X</code> coordinate of
the position only. Would be useful for a vertical cursor implementation.
Note that this only applies to cartesian charts&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“y”&gt;y&lt;/h2&gt; &lt;p&gt;Returns
all items that would intersect based on the <code>Y</code> coordinate of
