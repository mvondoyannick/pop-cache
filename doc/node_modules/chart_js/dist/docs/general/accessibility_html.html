...
<title>accessibility.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/general/accessibility.html">
...
<pre>&lt;head&gt;
    ...
    &lt;title&gt;Accessibility · Chart.js documentation&lt;/title&gt;
...
<pre>    &lt;li class=&quot;chapter &quot; data-level=&quot;1.1&quot; data-path=&quot;../&quot;&gt;
    ...
    &lt;li class=&quot;chapter active&quot; data-level=&quot;1.3.1&quot; data-path=&quot;accessibility.html&quot;&gt;
    ...
    &lt;li class=&quot;chapter &quot; data-level=&quot;1.3.2&quot; data-path=&quot;responsive.html&quot;&gt;
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;accessible-charts&quot;&gt;Accessible Charts&lt;/h1&gt;</pre>

<p>&lt;p&gt;Chart.js charts are rendered on user provided <code>canvas</code>
elements. Thus, it is up to the user to create the <code>canvas</code>
element in a way that is accessible. The <code>canvas</code> element has
support in all browsers and will render on screen but the
<code>canvas</code> content will not be accessible to screen
readers.&lt;/p&gt; &lt;p&gt;With <code>canvas</code>, the accessibility has
to be added with <code>ARIA</code> attributes on the <code>canvas</code>
element or added using internal fallback content placed within the opening
and closing canvas tags.&lt;/p&gt; &lt;p&gt;This &lt;a href=“<a
href="http://pauljadam.com/demos/canvas.html">pauljadam.com/demos/canvas.html</a>”
target=“_blank”&gt;website&lt;/a&gt; has a more detailed explanation of
<code>canvas</code> accessibility as well as in depth examples.&lt;/p&gt;
&lt;h2 id=“examples”&gt;Examples&lt;/h2&gt; &lt;p&gt;These are some
examples of &lt;strong&gt;accessible&lt;/strong&gt; <code>canvas</code>
elements.&lt;/p&gt; &lt;p&gt;By setting the <code>role</code> and
<code>aria-label</code>, this <code>canvas</code> now has an accessible
name.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-html”&gt;&lt;span
class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;id&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;goodCanvas1&amp;quot;&lt;/span&gt;
&lt;span class=“hljs-attr”&gt;width&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;400&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;height&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;100&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;aria-label&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;Hello ARIA World&amp;quot;&lt;/span&gt;
&lt;span class=“hljs-attr”&gt;role&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;img&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;&lt;span
class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt;&amp;gt;&lt;/span&gt;
&lt;/code&gt;&lt;/pre&gt; &lt;p&gt;This <code>canvas</code> element has a
text alternative via fallback content.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-html”&gt;&lt;span class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;id&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;okCanvas2&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;width&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;400&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;height&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;100&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;</p>

<pre>&lt;span class=&quot;hljs-tag&quot;&gt;&amp;lt;&lt;span class=&quot;hljs-name&quot;&gt;p&lt;/span&gt;&amp;gt;&lt;/span&gt;Hello Fallback World&lt;span class=&quot;hljs-tag&quot;&gt;&amp;lt;/&lt;span class=&quot;hljs-name&quot;&gt;p&lt;/span&gt;&amp;gt;&lt;/span&gt;</pre>

<p>&lt;span class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt;&amp;gt;&lt;/span&gt;
&lt;/code&gt;&lt;/pre&gt; &lt;p&gt;These are some bad examples of
&lt;strong&gt;inaccessible&lt;/strong&gt; <code>canvas</code>
elements.&lt;/p&gt; &lt;p&gt;This <code>canvas</code> element does not have
an accessible name or role.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-html”&gt;&lt;span class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;id&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;badCanvas1&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;width&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;400&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;height&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;100&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;&lt;span
class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt;&amp;gt;&lt;/span&gt;
&lt;/code&gt;&lt;/pre&gt; &lt;p&gt;This <code>canvas</code> element has
inaccessible fallback content.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-html”&gt;&lt;span class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;id&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;badCanvas2&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;width&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;400&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;height&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;100&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;Your
browser does not support the canvas element.&lt;span
class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;canvas&lt;/span&gt;&amp;gt;&lt;/span&gt;
&lt;/code&gt;&lt;/pre&gt;</p>
...
&lt;script&gt;
    ...
    gitbook.push(function() {
        gitbook.page.hasChanged({&quot;page&quot;:{&quot;title&quot;:&quot;Accessibility&quot;,&quot;level&quot;:&quot;1.3.1&quot;,&quot;depth&quot;:2,&quot;next&quot;:{&quot;title&quot;:&quot;Responsive&quot;,&quot;level&quot;:&quot;1.3.2&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/responsive.md&quot;,&quot;ref&quot;:&quot;general/responsive.md&quot;,&quot;articles&quot;:[]},&quot;previous&quot;:{&quot;title&quot;:&quot;General&quot;,&quot;level&quot;:&quot;1.3&quot;,&quot;depth&quot;:1,&quot;path&quot;:&quot;general/README.md&quot;,&quot;ref&quot;:&quot;general/README.md&quot;,&quot;articles&quot;:[{&quot;title&quot;:&quot;Accessibility&quot;,&quot;level&quot;:&quot;1.3.1&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/accessibility.md&quot;,&quot;ref&quot;:&quot;general/accessibility.md&quot;,&quot;articles&quot;:[]},{&quot;title&quot;:&quot;Responsive&quot;,&quot;level&quot;:&quot;1.3.2&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/responsive.md&quot;,&quot;ref&quot;:&quot;general/responsive.md&quot;,&quot;articles&quot;:[]},{&quot;title&quot;:&quot;Pixel Ratio&quot;,&quot;level&quot;:&quot;1.3.3&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/device-pixel-ratio.md&quot;,&quot;ref&quot;:&quot;general/device-pixel-ratio.md&quot;,&quot;articles&quot;:[]},{&quot;title&quot;:&quot;Interactions&quot;,&quot;level&quot;:&quot;1.3.4&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/interactions/README.md&quot;,&quot;ref&quot;:&quot;general/interactions/README.md&quot;,&quot;articles&quot;:[{&quot;title&quot;:&quot;Events&quot;,&quot;level&quot;:&quot;1.3.4.1&quot;,&quot;depth&quot;:3,&quot;path&quot;:&quot;general/interactions/events.md&quot;,&quot;ref&quot;:&quot;general/interactions/events.md&quot;,&quot;articles&quot;:[]},{&quot;title&quot;:&quot;Modes&quot;,&quot;level&quot;:&quot;1.3.4.2&quot;,&quot;depth&quot;:3,&quot;path&quot;:&quot;general/interactions/modes.md&quot;,&quot;ref&quot;:&quot;general/interactions/modes.md&quot;,&quot;articles&quot;:[]}]},{&quot;title&quot;:&quot;Options&quot;,&quot;level&quot;:&quot;1.3.5&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/options.md&quot;,&quot;ref&quot;:&quot;general/options.md&quot;,&quot;articles&quot;:[]},{&quot;title&quot;:&quot;Colors&quot;,&quot;level&quot;:&quot;1.3.6&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/colors.md&quot;,&quot;ref&quot;:&quot;general/colors.md&quot;,&quot;articles&quot;:[]},{&quot;title&quot;:&quot;Fonts&quot;,&quot;level&quot;:&quot;1.3.7&quot;,&quot;depth&quot;:2,&quot;path&quot;:&quot;general/fonts.md&quot;,&quot;ref&quot;:&quot;general/fonts.md&quot;,&quot;articles&quot;:[]}]},&quot;dir&quot;:&quot;ltr&quot;},&quot;config&quot;:{&quot;plugins&quot;:[&quot;-lunr&quot;,&quot;-search&quot;,&quot;search-plus&quot;,&quot;anchorjs&quot;,&quot;chartjs&quot;,&quot;ga&quot;],&quot;root&quot;:&quot;./docs&quot;,&quot;styles&quot;:{&quot;website&quot;:&quot;style.css&quot;,&quot;pdf&quot;:&quot;styles/pdf.css&quot;,&quot;epub&quot;:&quot;styles/epub.css&quot;,&quot;mobi&quot;:&quot;styles/mobi.css&quot;,&quot;ebook&quot;:&quot;styles/ebook.css&quot;,&quot;print&quot;:&quot;styles/print.css&quot;},&quot;pluginsConfig&quot;:{&quot;anchorjs&quot;:{&quot;icon&quot;:&quot;#&quot;,&quot;placement&quot;:&quot;left&quot;,&quot;visible&quot;:&quot;always&quot;},&quot;ga&quot;:{&quot;configuration&quot;:&quot;auto&quot;,&quot;token&quot;:&quot;UA-28909194-3&quot;},&quot;theme-default&quot;:{&quot;styles&quot;:{&quot;website&quot;:&quot;style.css&quot;,&quot;pdf&quot;:&quot;styles/pdf.css&quot;,&quot;epub&quot;:&quot;styles/epub.css&quot;,&quot;mobi&quot;:&quot;styles/mobi.css&quot;,&quot;ebook&quot;:&quot;styles/ebook.css&quot;,&quot;print&quot;:&quot;styles/print.css&quot;},&quot;showLevel&quot;:false},&quot;search-plus&quot;:{},&quot;chartjs&quot;:{&quot;defaults&quot;:null},&quot;highlight&quot;:{},&quot;sharing&quot;:{&quot;facebook&quot;:true,&quot;twitter&quot;:true,&quot;google&quot;:false,&quot;weibo&quot;:false,&quot;instapaper&quot;:false,&quot;vk&quot;:false,&quot;all&quot;:[&quot;facebook&quot;,&quot;google&quot;,&quot;twitter&quot;,&quot;weibo&quot;,&quot;instapaper&quot;]},&quot;fontsettings&quot;:{&quot;theme&quot;:&quot;white&quot;,&quot;family&quot;:&quot;sans&quot;,&quot;size&quot;:2}},&quot;theme&quot;:&quot;default&quot;,&quot;author&quot;:&quot;chartjs&quot;,&quot;pdf&quot;:{&quot;pageNumbers&quot;:true,&quot;fontSize&quot;:12,&quot;fontFamily&quot;:&quot;Arial&quot;,&quot;paperSize&quot;:&quot;a4&quot;,&quot;chapterMark&quot;:&quot;pagebreak&quot;,&quot;pageBreaksBefore&quot;:&quot;/&quot;,&quot;margin&quot;:{&quot;right&quot;:62,&quot;left&quot;:62,&quot;top&quot;:56,&quot;bottom&quot;:56}},&quot;structure&quot;:{&quot;langs&quot;:&quot;LANGS.md&quot;,&quot;readme&quot;:&quot;README.md&quot;,&quot;glossary&quot;:&quot;GLOSSARY.md&quot;,&quot;summary&quot;:&quot;SUMMARY.md&quot;},&quot;variables&quot;:{},&quot;title&quot;:&quot;Chart.js documentation&quot;,&quot;gitbook&quot;:&quot;3.2.2&quot;},&quot;file&quot;:{&quot;path&quot;:&quot;general/accessibility.md&quot;,&quot;mtime&quot;:&quot;2018-10-15T17:16:01.588Z&quot;,&quot;type&quot;:&quot;markdown&quot;},&quot;gitbook&quot;:{&quot;version&quot;:&quot;3.2.2&quot;,&quot;time&quot;:&quot;2018-10-15T17:20:29.518Z&quot;},&quot;basePath&quot;:&quot;..&quot;,&quot;book&quot;:{&quot;language&quot;:&quot;&quot;}});
    });
&lt;/script&gt;</pre>
