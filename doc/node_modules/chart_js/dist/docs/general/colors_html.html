...
<title>colors.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/general/colors.html">
...
<pre>    &lt;li class=&quot;chapter &quot; data-level=&quot;1.1&quot; data-path=&quot;../&quot;&gt;
    ...
    &lt;li class=&quot;chapter active&quot; data-level=&quot;1.3.6&quot; data-path=&quot;colors.html&quot;&gt;
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;colors&quot;&gt;Colors&lt;/h1&gt;</pre>

<p>&lt;p&gt;When supplying colors to Chart options, you can use a number of
formats. You can specify the color as a string in hexadecimal, RGB, or HSL
notations. If a color is needed, but not specified, Chart.js will use the
global default color. This color is stored at
<code>Chart.defaults.global.defaultColor</code>. It is initially set to
<code>&amp;apos;rgba(0, 0, 0, 0.1)&amp;apos;</code>&lt;/p&gt; &lt;p&gt;You
can also pass a &lt;a href=“<a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasGradient">developer.mozilla.org/en-US/docs/Web/API/CanvasGradient</a>”
target=“_blank”&gt;CanvasGradient&lt;/a&gt; object. You will need to create
this before passing to the chart, but using it you can achieve some
interesting effects.&lt;/p&gt; &lt;h2
id=“patterns-and-gradients”&gt;Patterns and Gradients&lt;/h2&gt;
&lt;p&gt;An alternative option is to pass a &lt;a href=“<a
href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasPattern">developer.mozilla.org/en-US/docs/Web/API/CanvasPattern</a>”
target=“_blank”&gt;CanvasPattern&lt;/a&gt; or &lt;a href=“<a
href="https://developer.mozilla.org/en/docs/Web/API/CanvasGradient">developer.mozilla.org/en/docs/Web/API/CanvasGradient</a>”
target=“_blank”&gt;CanvasGradient&lt;/a&gt; object instead of a string
colour.&lt;/p&gt; &lt;p&gt;For example, if you wanted to fill a dataset
with a pattern from an image you could do the following.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; img = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Image(); img.src = &lt;span
class=“hljs-string”&gt;&amp;apos;<a
href="https://example.com/my_image.png&apos;</span">example.com/my_image.png&apos;</span</a>&gt;;
img.onload = &lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>&lt;span class=&quot;hljs-keyword&quot;&gt;var&lt;/span&gt; ctx = &lt;span class=&quot;hljs-built_in&quot;&gt;document&lt;/span&gt;.getElementById(&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;canvas&amp;apos;&lt;/span&gt;).getContext(&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;2d&amp;apos;&lt;/span&gt;);
...
<p>} &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;Using pattern fills for data graphics
can help viewers with vision deficiencies (e.g. color-blindness or partial
sight) to &lt;a href=“<a
href="http://betweentwobrackets.com/data-graphics-and-colour-vision">betweentwobrackets.com/data-graphics-and-colour-vision</a>/”
target=“_blank”&gt;more easily understand your data&lt;/a&gt;.&lt;/p&gt;
&lt;p&gt;Using the &lt;a href=“<a
href="https://github.com/ashiguruma/patternomaly">github.com/ashiguruma/patternomaly</a>”
target=“_blank”&gt;Patternomaly&lt;/a&gt; library you can generate patterns
to fill datasets.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chartData = {</p>
...
labels: [&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Red&amp;apos;&lt;/span&gt;, &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Blue&amp;apos;&lt;/span&gt;, &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Purple&amp;apos;&lt;/span&gt;, &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;Yellow&amp;apos;&lt;/span&gt;]</pre>
