...
<title>integration.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/getting-started/integration.html">
...
<pre>&lt;head&gt;
    ...
    &lt;title&gt;Integration · Chart.js documentation&lt;/title&gt;
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;integration&quot;&gt;Integration&lt;/h1&gt;</pre>

<p>&lt;p&gt;Chart.js can be integrated with plain JavaScript or with different
module loaders. The examples below show how to load Chart.js in different
systems.&lt;/p&gt; &lt;h2 id=“script-tag”&gt;Script Tag&lt;/h2&gt;
&lt;pre&gt;&lt;code class=“lang-html”&gt;&lt;span
class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;script&lt;/span&gt; &lt;span
class=“hljs-attr”&gt;src&lt;/span&gt;=&lt;span
class=“hljs-string”&gt;&amp;quot;path/to/chartjs/dist/Chart.js&amp;quot;&lt;/span&gt;&amp;gt;&lt;/span&gt;&lt;span
class=“undefined”&gt;&lt;/span&gt;&lt;span
class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;script&lt;/span&gt;&amp;gt;&lt;/span&gt; &lt;span
class=“hljs-tag”&gt;&amp;lt;&lt;span
class=“hljs-name”&gt;script&lt;/span&gt;&amp;gt;&lt;/span&gt;&lt;span
class=“actionscript”&gt;</p>

<pre>&lt;span class=&quot;hljs-keyword&quot;&gt;var&lt;/span&gt; myChart = &lt;span class=&quot;hljs-keyword&quot;&gt;new&lt;/span&gt; Chart(ctx, {...});</pre>

<p>&lt;/span&gt;&lt;span class=“hljs-tag”&gt;&amp;lt;/&lt;span
class=“hljs-name”&gt;script&lt;/span&gt;&amp;gt;&lt;/span&gt;
&lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“webpack”&gt;Webpack&lt;/h2&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;import&lt;/span&gt; Chart &lt;span
class=“hljs-keyword”&gt;from&lt;/span&gt; &lt;span
class=“hljs-string”&gt;&amp;apos;chart.js&amp;apos;&lt;/span&gt;; &lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; myChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {…});
&lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“common-js”&gt;Common JS&lt;/h2&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
...
class=“hljs-keyword”&gt;var&lt;/span&gt; myChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {…});
&lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“require-js”&gt;Require JS&lt;/h2&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-built_in”&gt;require&lt;/span&gt;([&lt;span
class=“hljs-string”&gt;&amp;apos;path/to/chartjs/dist/Chart.js&amp;apos;&lt;/span&gt;],
...
&lt;p&gt;&lt;strong&gt;Important:&lt;/strong&gt; RequireJS &lt;a href=“<a
href="http://www.requirejs.org/docs/commonjs.html#intro">www.requirejs.org/docs/commonjs.html#intro</a>”
target=“_blank”&gt;can &lt;strong&gt;not&lt;/strong&gt; load CommonJS
module as is&lt;/a&gt;, so be sure to require one of the built UMD files
instead (i.e. <code>dist/Chart.js</code>, <code>dist/Chart.min.js</code>,
etc.).&lt;/p&gt; &lt;/blockquote&gt;</p>
