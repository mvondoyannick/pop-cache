...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/axes/index.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;axes&quot;&gt;Axes&lt;/h1&gt;</pre>

<p>&lt;p&gt;Axes are an integral part of a chart. They are used to determine
how data maps to a pixel value on the chart. In a cartesian chart, there is
1 or more X axis and 1 or more Y axis to map points onto the 2 dimensional
canvas. These axes are know as &lt;a
href=“cartesian/#cartesian-axes”&gt;&amp;apos;cartesian
axes&amp;apos;&lt;/a&gt;.&lt;/p&gt; &lt;p&gt;In a radial chart, such as a
radar chart or a polar area chart, there is a single axis that maps points
in the angular and radial directions. These are known as &lt;a
href=“radial/#radial-axes”&gt;&amp;apos;radial
axes&amp;apos;&lt;/a&gt;.&lt;/p&gt; &lt;p&gt;Scales in Chart.js
&amp;gt;V2.0 are significantly more powerful, but also different than those
of v1.0.&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Multiple X &amp;amp; Y axes are
supported.&lt;/li&gt; &lt;li&gt;A built-in label auto-skip feature detects
would-be overlapping ticks and labels and removes every nth label to keep
things displaying normally.&lt;/li&gt; &lt;li&gt;Scale titles are
supported&lt;/li&gt; &lt;li&gt;New scale types can be extended without
writing an entirely new chart type&lt;/li&gt; &lt;/ul&gt; &lt;h1
id=“common-configuration”&gt;Common Configuration&lt;/h1&gt; &lt;p&gt;The
following properties are common to all axes provided by Chart.js&lt;/p&gt;
&lt;table&gt; &lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Type&lt;/th&gt; &lt;th&gt;Default&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>display</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;If set to
<code>false</code> the axis is hidden from view. Overrides
<em>gridLines.display</em>, <em>scaleLabel.display</em>, and
<em>ticks.display</em>.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>callbacks</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Callback functions to hook into the axis lifecycle. &lt;a
href=“#callbacks”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>weight</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>0</code>&lt;/td&gt; &lt;td&gt;The weight used to sort the
axis. Higher weights are further away from the chart area.&lt;/td&gt;
&lt;/tr&gt; &lt;/tbody&gt; &lt;/table&gt; &lt;h2
id=“callbacks”&gt;Callbacks&lt;/h2&gt; &lt;p&gt;There are a number of
config callbacks that can be used to change parameters in the scale at
different points in the update process.&lt;/p&gt; &lt;table&gt;
&lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Arguments&lt;/th&gt; &lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt;
&lt;/thead&gt; &lt;tbody&gt; &lt;tr&gt;
&lt;td&gt;<code>beforeUpdate</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback called before the
update process starts.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>beforeSetDimensions</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs before
dimensions are set.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterSetDimensions</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs after
dimensions are set.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>beforeDataLimits</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs before
data limits are determined.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterDataLimits</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs after
data limits are determined.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>beforeBuildTicks</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs before
ticks are created.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterBuildTicks</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs after
ticks are created. Useful for filtering ticks.&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>beforeTickToLabelConversion</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs before
ticks are converted into strings.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterTickToLabelConversion</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs after
ticks are converted into strings.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>beforeCalculateTickRotation</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs before
tick rotation is determined.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterCalculateTickRotation</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs after
tick rotation is determined.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>beforeFit</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs before
the scale fits to the canvas.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterFit</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs after
the scale fits to the canvas.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>afterUpdate</code>&lt;/td&gt;
&lt;td&gt;<code>axis</code>&lt;/td&gt; &lt;td&gt;Callback that runs at the
end of the update process.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;
&lt;/table&gt; &lt;h2 id=“updating-axis-defaults”&gt;Updating Axis
Defaults&lt;/h2&gt; &lt;p&gt;The default configuration for a scale can be
easily changed using the scale service. All you need to do is to pass in a
partial configuration that will be merged with the current scale default
configuration to form the new default.&lt;/p&gt; &lt;p&gt;For example, to
set the minimum value of 0 for all linear scales, you would do the
following. Any linear scales created after this time would now have a
minimum of 0.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;Chart.scaleService.updateScaleDefaults(&lt;span
class=“hljs-string”&gt;&amp;apos;linear&amp;apos;&lt;/span&gt;, {</p>

<pre>ticks: {
    min: &lt;span class=&quot;hljs-number&quot;&gt;0&lt;/span&gt;
}</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“creating-new-axes”&gt;Creating New
Axes&lt;/h2&gt; &lt;p&gt;To create a new axis, see the &lt;a
href=“../developers/axes.html”&gt;developer docs&lt;/a&gt;.&lt;/p&gt;</p>
