...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/axes/cartesian/linear.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;linear-cartesian-axis&quot;&gt;Linear Cartesian Axis&lt;/h1&gt;</pre>

<p>&lt;p&gt;The linear scale is use to chart numerical data. It can be placed
on either the x or y axis. The scatter chart type automatically configures
a line chart to use one of these scales for the x axis. As the name
suggests, linear interpolation is used to determine where a value lies on
the axis.&lt;/p&gt; &lt;h2 id=“tick-configuration-options”&gt;Tick
Configuration Options&lt;/h2&gt; &lt;p&gt;The following options are
provided by the linear scale. They are all located in the
<code>ticks</code> sub options. These options extend the &lt;a
href=“./#tick-configuration”&gt;common tick
...
&lt;td&gt;if true, scale will include 0 if it is not already
included.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>min</code>&lt;/td&gt;
...
href=“#axis-range-settings”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt; &lt;h2 id=“axis-range-settings”&gt;Axis Range
Settings&lt;/h2&gt; &lt;p&gt;Given the number of axis range settings, it is
important to understand how they all interact with each other.&lt;/p&gt;
&lt;p&gt;The <code>suggestedMax</code> and <code>suggestedMin</code>
settings only change the data values that are used to scale the axis. These
are useful for extending the range of the axis while maintaining the auto
fit behaviour.&lt;/p&gt; &lt;pre&gt;&lt;code
