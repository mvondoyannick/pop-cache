...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/axes/cartesian/index.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;cartesian-axes&quot;&gt;Cartesian Axes&lt;/h1&gt;</pre>

<p>&lt;p&gt;Axes that follow a cartesian grid are known as &amp;apos;Cartesian
Axes&amp;apos;. Cartesian axes are used for line, bar, and bubble charts.
Four cartesian axes are included in Chart.js by default.&lt;/p&gt;
&lt;ul&gt; &lt;li&gt;&lt;a
href=“linear.html#linear-cartesian-axis”&gt;linear&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a
href=“logarithmic.html#logarithmic-cartesian-axis”&gt;logarithmic&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a
href=“category.html#category-cartesian-axis”&gt;category&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a
href=“time.html#time-cartesian-axis”&gt;time&lt;/a&gt;&lt;/li&gt;
&lt;/ul&gt; &lt;h1 id=“common-configuration”&gt;Common
Configuration&lt;/h1&gt; &lt;p&gt;All of the included cartesian axes
support a number of common options.&lt;/p&gt; &lt;table&gt; &lt;thead&gt;
&lt;tr&gt; &lt;th&gt;Name&lt;/th&gt; &lt;th&gt;Type&lt;/th&gt;
&lt;th&gt;Default&lt;/th&gt; &lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt;
&lt;/thead&gt; &lt;tbody&gt; &lt;tr&gt;
&lt;td&gt;<code>type</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Type of scale being employed. Custom scales can be created and
registered with a string key. This allows changing the type of an axis for
a chart.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>position</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Position of the axis in the chart. Possible values are:
<code>&amp;apos;top&amp;apos;</code>,
<code>&amp;apos;left&amp;apos;</code>,
<code>&amp;apos;bottom&amp;apos;</code>,
<code>&amp;apos;right&amp;apos;</code>&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>offset</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>false</code>&lt;/td&gt; &lt;td&gt;If true, extra space is
added to the both edges and the axis is scaled to fit into the chart area.
This is set to <code>true</code> for a category scale in a bar chart by
default.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>id</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;The ID is used to link datasets and scale axes together. &lt;a
href=“#axis-id”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>gridLines</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Grid line configuration. &lt;a
href=“../styling.html#grid-line-configuration”&gt;more…&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>scaleLabel</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Scale title configuration. &lt;a
href=“../labelling.html#scale-title-configuration”&gt;more…&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>ticks</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Tick configuration. &lt;a
href=“#tick-configuration”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt; &lt;h2 id=“tick-configuration”&gt;Tick
Configuration&lt;/h2&gt; &lt;p&gt;The following options are common to all
cartesian axes but do not apply to other axes.&lt;/p&gt; &lt;table&gt;
&lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Type&lt;/th&gt; &lt;th&gt;Default&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>autoSkip</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;If true, automatically
calculates how many labels that can be shown and hides labels accordingly.
Turn it off to show all labels no matter what&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>autoSkipPadding</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>0</code>&lt;/td&gt; &lt;td&gt;Padding between the ticks on
the horizontal axis when <code>autoSkip</code> is enabled. <em>Note: Only
applicable to horizontal scales.</em>&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>labelOffset</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>0</code>&lt;/td&gt; &lt;td&gt;Distance in pixels to offset
the label from the centre point of the tick (in the y direction for the x
axis, and the x direction for the y axis). <em>Note: this can cause labels
at the edges to be cropped by the edge of the canvas</em>&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>maxRotation</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>90</code>&lt;/td&gt; &lt;td&gt;Maximum rotation for tick
labels when rotating to condense labels. Note: Rotation doesn&amp;apos;t
occur until necessary. <em>Note: Only applicable to horizontal
scales.</em>&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>minRotation</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>0</code>&lt;/td&gt; &lt;td&gt;Minimum rotation for tick
labels. <em>Note: Only applicable to horizontal scales.</em>&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>mirror</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>false</code>&lt;/td&gt; &lt;td&gt;Flips tick labels around
axis, displaying the labels inside the chart instead of outside. <em>Note:
Only applicable to vertical scales.</em>&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>padding</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>10</code>&lt;/td&gt; &lt;td&gt;Padding between the tick
label and the axis. When set on a vertical axis, this applies in the
horizontal (X) direction. When set on a horizontal axis, this applies in
the vertical (Y) direction.&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt;
&lt;/table&gt; &lt;h2 id=“axis-id”&gt;Axis ID&lt;/h2&gt; &lt;p&gt;The
properties <code>dataset.xAxisID</code> or <code>dataset.yAxisID</code>
have to match the scale properties <code>scales.xAxes.id</code> or
<code>scales.yAxes.id</code>. This is especially needed if multi-axes
charts are used.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; myChart = &lt;span
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h1
id=“creating-multiple-axes”&gt;Creating Multiple Axes&lt;/h1&gt;
&lt;p&gt;With cartesian axes, it is possible to create multiple X and Y
axes. To do so, you can add multiple configuration objects to the
<code>xAxes</code> and <code>yAxes</code> properties. When adding new axes,
it is important to ensure that you specify the type of the new axes as
default types are &lt;strong&gt;not&lt;/strong&gt; used in this
case.&lt;/p&gt; &lt;p&gt;In the example below, we are creating two Y axes.
We then use the <code>yAxisID</code> property to map the datasets to their
correct axes.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; myChart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
