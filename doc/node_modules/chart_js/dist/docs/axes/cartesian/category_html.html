...
<title>category.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/axes/cartesian/category.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;category-cartesian-axis&quot;&gt;Category Cartesian Axis&lt;/h1&gt;</pre>

<p>&lt;p&gt;If global configuration is used, labels are drawn from one of the
label arrays included in the chart data. If only <code>data.labels</code>
is defined, this will be used. If <code>data.xLabels</code> is defined and
the axis is horizontal, this will be used. Similarly, if
<code>data.yLabels</code> is defined and the axis is vertical, this
property will be used. Using both <code>xLabels</code> and
<code>yLabels</code> together can create a chart that uses strings for both
the X and Y axes.&lt;/p&gt; &lt;p&gt;Specifying any of the settings above
defines the x axis as <code>type: category</code> if not defined otherwise.
For more fine-grained control of category labels it is also possible to add
<code>labels</code> as part of the category axis definition. Doing so does
not apply the global defaults.&lt;/p&gt; &lt;h2
id=“category-axis-definition”&gt;Category Axis Definition&lt;/h2&gt;
&lt;p&gt;Globally:&lt;/p&gt; &lt;pre&gt;&lt;code
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2
id=“tick-configuration-options”&gt;Tick Configuration Options&lt;/h2&gt;
&lt;p&gt;The category scale provides the following options for configuring
tick marks. They are nested in the <code>ticks</code> sub object. These
options extend the &lt;a href=“./#tick-configuration”&gt;common tick
configuration&lt;/a&gt;.&lt;/p&gt; &lt;table&gt; &lt;thead&gt; &lt;tr&gt;
&lt;th&gt;Name&lt;/th&gt; &lt;th&gt;Type&lt;/th&gt;
&lt;th&gt;Default&lt;/th&gt; &lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt;
&lt;/thead&gt; &lt;tbody&gt; &lt;tr&gt;
&lt;td&gt;<code>labels</code>&lt;/td&gt; &lt;<a
href="String">td>Array</a>&lt;/td&gt; &lt;td&gt;-&lt;/td&gt; &lt;td&gt;An
array of labels to display.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>min</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;The minimum item to display. &lt;a
href=“#min-max-configuration”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>max</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;The maximum item to display. &lt;a
href=“#min-max-configuration”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt; &lt;h2 id=“min-max-configuration”&gt;Min Max
Configuration&lt;/h2&gt; &lt;p&gt;For both the <code>min</code> and
<code>max</code> properties, the value must be in the <code>labels</code>
array. In the example below, the x axis would only display
