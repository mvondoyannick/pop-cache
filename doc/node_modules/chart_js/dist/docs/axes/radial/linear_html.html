...
<title>linear.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/axes/radial/linear.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;linear-radial-axis&quot;&gt;Linear Radial Axis&lt;/h1&gt;</pre>

<p>&lt;p&gt;The linear scale is use to chart numerical data. As the name
suggests, linear interpolation is used to determine where a value lies in
relation the center of the axis.&lt;/p&gt; &lt;p&gt;The following
additional configuration options are provided by the radial linear
scale.&lt;/p&gt; &lt;h2 id=“configuration-options”&gt;Configuration
Options&lt;/h2&gt; &lt;p&gt;The axis has configuration properties for
ticks, angle lines (line that appear in a radar chart outward from the
center), pointLabels (labels around the edge in a radar chart). The
following sections define each of the properties in those
sections.&lt;/p&gt; &lt;table&gt; &lt;thead&gt; &lt;tr&gt;
&lt;th&gt;Name&lt;/th&gt; &lt;th&gt;Type&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>angleLines</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;Angle line
configuration. &lt;a
href=“#angle-line-options”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>gridLines</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;Grid line configuration.
&lt;a
href=“../styling.html#grid-line-configuration”&gt;more…&lt;/a&gt;&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>pointLabels</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;Point label
configuration. &lt;a
href=“#point-label-options”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>ticks</code>&lt;/td&gt;
&lt;td&gt;<code>Object</code>&lt;/td&gt; &lt;td&gt;Tick configuration.
&lt;a href=“#tick-options”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt; &lt;h2 id=“tick-options”&gt;Tick
Options&lt;/h2&gt; &lt;p&gt;The following options are provided by the
linear scale. They are all located in the <code>ticks</code> sub options.
The &lt;a href=“../styling.html#tick-configuration”&gt;common tick
configuration&lt;/a&gt; options are supported by this axis.&lt;/p&gt;
&lt;table&gt; &lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Type&lt;/th&gt; &lt;th&gt;Default&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>backdropColor</code>&lt;/td&gt;
&lt;td&gt;<code>Color</code>&lt;/td&gt; &lt;td&gt;<code>&amp;apos;rgba(255,
255, 255, 0.75)&amp;apos;</code>&lt;/td&gt; &lt;td&gt;Color of label
backdrops&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>backdropPaddingX</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>2</code>&lt;/td&gt; &lt;td&gt;Horizontal padding of label
backdrop.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>backdropPaddingY</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>2</code>&lt;/td&gt; &lt;td&gt;Vertical padding of label
backdrop.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>beginAtZero</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>false</code>&lt;/td&gt; &lt;td&gt;if true, scale will
include 0 if it is not already included.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>min</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;User defined minimum number for the scale, overrides minimum
value from data. &lt;a
href=“#axis-range-settings”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>max</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;User defined maximum number for the scale, overrides maximum
value from data. &lt;a
href=“#axis-range-settings”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>maxTicksLimit</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>11</code>&lt;/td&gt; &lt;td&gt;Maximum number of ticks and
gridlines to show.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>precision</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt; &lt;td&gt;if
defined and <code>stepSize</code> is not specified, the step size will be
rounded to this many decimal places.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>stepSize</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;User defined fixed step size for the scale. &lt;a
href=“#step-size”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>suggestedMax</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Adjustment used when calculating the maximum data value. &lt;a
href=“#axis-range-settings”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>suggestedMin</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Adjustment used when calculating the minimum data value. &lt;a
href=“#axis-range-settings”&gt;more…&lt;/a&gt;&lt;/td&gt; &lt;/tr&gt;
&lt;tr&gt; &lt;td&gt;<code>showLabelBackdrop</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;If true, draw a background
behind the tick labels&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt; &lt;/table&gt;
&lt;h2 id=“axis-range-settings”&gt;Axis Range Settings&lt;/h2&gt;
&lt;p&gt;Given the number of axis range settings, it is important to
understand how they all interact with each other.&lt;/p&gt; &lt;p&gt;The
<code>suggestedMax</code> and <code>suggestedMin</code> settings only
...
behaviour.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;let&lt;/span&gt; minDataValue = &lt;span
class=“hljs-built_in”&gt;Math&lt;/span&gt;.min(mostNegativeValue,
options.ticks.suggestedMin); &lt;span
class=“hljs-keyword”&gt;let&lt;/span&gt; maxDataValue = &lt;span
class=“hljs-built_in”&gt;Math&lt;/span&gt;.max(mostPositiveValue,
options.ticks.suggestedMax); &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;In this
example, the largest positive value is 50, but the data maximum is expanded
out to 100. However, because the lowest data value is below the
<code>suggestedMin</code> setting, it is ignored.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;let&lt;/span&gt; chart = &lt;span
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;In contrast to the
<code>suggested*</code> settings, the <code>min</code> and <code>max</code>
settings set explicit ends to the axes. When these are set, some data
points may not be visible.&lt;/p&gt; &lt;h2 id=“step-size”&gt;Step
Size&lt;/h2&gt; &lt;p&gt; If set, the scale ticks will be enumerated by
multiple of stepSize, having one tick per increment. If not set, the ticks
are labeled automatically using the nice numbers algorithm.&lt;/p&gt;
&lt;p&gt;This example sets up a chart with a y axis that creates ticks at
<code>0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5</code>.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;let&lt;/span&gt; options = {</p>
...
<p>}; &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“angle-line-options”&gt;Angle Line
Options&lt;/h2&gt; &lt;p&gt;The following options are used to configure
angled lines that radiate from the center of the chart to the point labels.
They can be found in the <code>angleLines</code> sub options. Note that
these options only apply if <code>angleLines.display</code> is
true.&lt;/p&gt; &lt;table&gt; &lt;thead&gt; &lt;tr&gt;
&lt;th&gt;Name&lt;/th&gt; &lt;th&gt;Type&lt;/th&gt;
&lt;th&gt;Default&lt;/th&gt; &lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt;
&lt;/thead&gt; &lt;tbody&gt; &lt;tr&gt;
&lt;td&gt;<code>display</code>&lt;/td&gt;
&lt;td&gt;<code>Boolean</code>&lt;/td&gt;
&lt;td&gt;<code>true</code>&lt;/td&gt; &lt;td&gt;if true, angle lines are
shown&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>color</code>&lt;/td&gt;
&lt;td&gt;<code>Color</code>&lt;/td&gt; &lt;td&gt;<code>rgba(0, 0, 0,
0.1)</code>&lt;/td&gt; &lt;td&gt;Color of angled lines&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>lineWidth</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt;
&lt;td&gt;<code>1</code>&lt;/td&gt; &lt;td&gt;Width of angled
lines&lt;/td&gt; &lt;/tr&gt; &lt;/tbody&gt; &lt;/table&gt; &lt;h2
id=“point-label-options”&gt;Point Label Options&lt;/h2&gt; &lt;p&gt;The
following options are used to configure the point labels that are shown on
the perimeter of the scale. They can be found in the
<code>pointLabels</code> sub options. Note that these options only apply if
<code>pointLabels.display</code> is true.&lt;/p&gt; &lt;table&gt;
&lt;thead&gt; &lt;tr&gt; &lt;th&gt;Name&lt;/th&gt;
&lt;th&gt;Type&lt;/th&gt; &lt;th&gt;Default&lt;/th&gt;
&lt;th&gt;Description&lt;/th&gt; &lt;/tr&gt; &lt;/thead&gt; &lt;tbody&gt;
&lt;tr&gt; &lt;td&gt;<code>callback</code>&lt;/td&gt;
&lt;td&gt;<code>Function</code>&lt;/td&gt; &lt;td&gt;&lt;/td&gt;
&lt;td&gt;Callback function to transform data labels to point labels. The
default implementation simply returns the current string.&lt;/td&gt;
&lt;/tr&gt; &lt;tr&gt; &lt;td&gt;<code>fontColor</code>&lt;/td&gt;
&lt;td&gt;<code>Color/Color[]</code>&lt;/td&gt;
&lt;td&gt;<code>&amp;apos;#666&amp;apos;</code>&lt;/td&gt; &lt;td&gt;Font
color for point labels.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>fontFamily</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt;
&lt;td&gt;<code>&amp;quot;&amp;apos;Helvetica Neue&amp;apos;,
&amp;apos;Helvetica&amp;apos;, &amp;apos;Arial&amp;apos;,
sans-serif&amp;quot;</code>&lt;/td&gt; &lt;td&gt;Font family to use when
rendering labels.&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>fontSize</code>&lt;/td&gt;
&lt;td&gt;<code>Number</code>&lt;/td&gt; &lt;td&gt;10&lt;/td&gt;
&lt;td&gt;font size in pixels&lt;/td&gt; &lt;/tr&gt; &lt;tr&gt;
&lt;td&gt;<code>fontStyle</code>&lt;/td&gt;
&lt;td&gt;<code>String</code>&lt;/td&gt;
&lt;td&gt;<code>&amp;apos;normal&amp;apos;</code>&lt;/td&gt; &lt;td&gt;Font
style to use when rendering point labels.&lt;/td&gt; &lt;/tr&gt;
&lt;/tbody&gt; &lt;/table&gt;</p>
