...
<title>axes.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/developers/axes.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;new-axes&quot;&gt;New Axes&lt;/h1&gt;</pre>

<p>&lt;p&gt;Axes in Chart.js can be individually extended. Axes should always
derive from Chart.Scale but this is not a mandatory requirement.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;let&lt;/span&gt; MyScale = Chart.Scale.extend({</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;   extensions ...   &lt;/span&gt;</pre>

<p>});</p>

<p>&lt;span class=“hljs-comment”&gt;// MyScale is now derived from
Chart.Scale&lt;/span&gt; &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;Once you have
created your scale class, you need to register it with the global chart
object so that it can be used. A default config for the scale may be
provided when registering the constructor. The first parameter to the
register function is a string key that is used later to identify which
scale type to use for a chart.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;Chart.scaleService.registerScaleType(&lt;span
class=“hljs-string”&gt;&amp;apos;myScale&amp;apos;&lt;/span&gt;, MyScale,
defaultConfigObject); &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;To use the new
scale, simply pass in the string key to the config when creating a
chart.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; lineChart = &lt;span
...
<p>}) &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“scale-properties”&gt;Scale
Properties&lt;/h2&gt; &lt;p&gt;Scale instances are given the following
properties during the fitting process.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;{</p>

<pre>left: &lt;span class=&quot;hljs-built_in&quot;&gt;Number&lt;/span&gt;, &lt;span class=&quot;hljs-comment&quot;&gt;// left edge of the scale bounding box&lt;/span&gt;
...
paddingBottom: &lt;span class=&quot;hljs-built_in&quot;&gt;Number&lt;/span&gt;,</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“scale-interface”&gt;Scale
Interface&lt;/h2&gt; &lt;p&gt;To work with Chart.js, custom scale types
must implement the following interface.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;{</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;// Determines the data limits. Should set this.min and this.max to be the data max/min&lt;/span&gt;
...
getValueForPixel: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;pixel&lt;/span&gt;) &lt;/span&gt;{}</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;Optionally, the following methods may
also be overwritten, but an implementation is already provided by the
<code>Chart.Scale</code> base class.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;    &lt;span class=“hljs-comment”&gt;//
...
<pre>convertTicksToLabels: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;&lt;/span&gt;) &lt;/span&gt;{},
...
draw: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;chartArea&lt;/span&gt;) &lt;/span&gt;{},</pre>

<p>&lt;/code&gt;&lt;/pre&gt; &lt;p&gt;The Core.Scale base class also has some
utility functions that you may find useful.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;{</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;// Returns true if the scale instance is horizontal&lt;/span&gt;
...
getRightValue: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;dataValue&lt;/span&gt;) &lt;/span&gt;{},</pre>
