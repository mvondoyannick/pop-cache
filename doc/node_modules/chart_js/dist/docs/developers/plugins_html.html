...
<title>plugins.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/developers/plugins.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;plugins&quot;&gt;Plugins&lt;/h1&gt;</pre>

<p>&lt;p&gt;Plugins are the most efficient way to customize or change the
default behavior of a chart. They have been introduced at &lt;a href=“<a
href="https://github.com/chartjs/Chart.js/releases/tag/2.1.0">github.com/chartjs/Chart.js/releases/tag/2.1.0</a>”
target=“_blank”&gt;version 2.1.0&lt;/a&gt; (global plugins only) and
extended at &lt;a href=“<a
href="https://github.com/chartjs/Chart.js/releases/tag/v2.5.0">github.com/chartjs/Chart.js/releases/tag/v2.5.0</a>”
target=“_blank”&gt;version 2.5.0&lt;/a&gt; (per chart plugins and
options).&lt;/p&gt; &lt;h2 id=“using-plugins”&gt;Using plugins&lt;/h2&gt;
&lt;p&gt;Plugins can be shared between chart instances:&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; plugin = { &lt;span
class=“hljs-comment”&gt;   plugin implementation   &lt;/span&gt; };</p>

<p>&lt;span class=“hljs-comment”&gt;// chart1 and chart2 use
&amp;quot;plugin&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart1 = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>

<pre>plugins: [plugin]</pre>

<p>});</p>

<p>&lt;span class=“hljs-keyword”&gt;var&lt;/span&gt; chart2 = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>&lt;span class=“hljs-comment”&gt;// chart3 doesn&amp;apos;t use
&amp;quot;plugin&amp;quot;&lt;/span&gt; &lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart3 = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {});
&lt;/code&gt;&lt;/pre&gt; &lt;p&gt;Plugins can also be defined directly in
the chart <code>plugins</code> config (a.k.a. <em>inline
plugins</em>):&lt;/p&gt; &lt;pre&gt;&lt;code
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;However, this approach is not ideal
when the customization needs to apply to many charts.&lt;/p&gt; &lt;h2
id=“global-plugins”&gt;Global plugins&lt;/h2&gt; &lt;p&gt;Plugins can be
registered globally to be applied on all charts (a.k.a. <em>global
plugins</em>):&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;Chart.plugins.register({</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;// plugin implementation&lt;/span&gt;</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;blockquote&gt; &lt;p&gt;Note:
<em>inline</em> plugins can&amp;apos;t be registered globally.&lt;/p&gt;
&lt;/blockquote&gt; &lt;h2 id=“configuration”&gt;Configuration&lt;/h2&gt;
&lt;h3 id=“plugin-id”&gt;Plugin ID&lt;/h3&gt; &lt;p&gt;Plugins must define
a unique id in order to be configurable.&lt;/p&gt; &lt;p&gt;This id should
follow the &lt;a href=“<a
href="https://docs.npmjs.com/files/package.json#name">docs.npmjs.com/files/package.json#name</a>”
target=“_blank”&gt;npm package name convention&lt;/a&gt;:&lt;/p&gt;
&lt;ul&gt; &lt;li&gt;can&amp;apos;t start with a dot or an
underscore&lt;/li&gt; &lt;li&gt;can&amp;apos;t contain any non-URL-safe
characters&lt;/li&gt; &lt;li&gt;can&amp;apos;t contain uppercase
letters&lt;/li&gt; &lt;li&gt;should be something short, but also reasonably
descriptive&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;If a plugin is intended to be
released publicly, you may want to check the &lt;a href=“<a
href="https://www.npmjs.com/search?q=chartjs-plugin">www.npmjs.com/search?q=chartjs-plugin</a>-”
target=“_blank”&gt;registry&lt;/a&gt; to see if there&amp;apos;s something
by that name already. Note that in this case, the package name should be
prefixed by <code>chartjs-plugin-</code> to appear in Chart.js plugin
registry.&lt;/p&gt; &lt;h3 id=“plugin-options”&gt;Plugin options&lt;/h3&gt;
&lt;p&gt;Plugin options are located under the <code>options.plugins</code>
config and are scoped by the plugin ID:
<code>options.plugins.{plugin-id}</code>.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chart = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h4 id=“disable-plugins”&gt;Disable
plugins&lt;/h4&gt; &lt;p&gt;To disable a global plugin for a specific chart
instance, the plugin options must be set to <code>false</code>:&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;Chart.plugins.register({</p>

<pre>id: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;p1&amp;apos;&lt;/span&gt;,
...
<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“plugin-core-api”&gt;Plugin Core
API&lt;/h2&gt; &lt;p&gt;Available hooks (as of version 2.6):&lt;/p&gt;
&lt;ul&gt; &lt;li&gt;beforeInit&lt;/li&gt; &lt;li&gt;afterInit&lt;/li&gt;
&lt;li&gt;beforeUpdate <em>(cancellable)</em>&lt;/li&gt;
&lt;li&gt;afterUpdate&lt;/li&gt; &lt;li&gt;beforeLayout
<em>(cancellable)</em>&lt;/li&gt; &lt;li&gt;afterLayout&lt;/li&gt;
&lt;li&gt;beforeDatasetsUpdate <em>(cancellable)</em>&lt;/li&gt;
&lt;li&gt;afterDatasetsUpdate&lt;/li&gt; &lt;li&gt;beforeDatasetUpdate
<em>(cancellable)</em>&lt;/li&gt; &lt;li&gt;afterDatasetUpdate&lt;/li&gt;
&lt;li&gt;beforeRender <em>(cancellable)</em>&lt;/li&gt;
&lt;li&gt;afterRender&lt;/li&gt; &lt;li&gt;beforeDraw
<em>(cancellable)</em>&lt;/li&gt; &lt;li&gt;afterDraw&lt;/li&gt;
&lt;li&gt;beforeDatasetsDraw <em>(cancellable)</em>&lt;/li&gt;
&lt;li&gt;afterDatasetsDraw&lt;/li&gt; &lt;li&gt;beforeDatasetDraw
<em>(cancellable)</em>&lt;/li&gt; &lt;li&gt;afterDatasetDraw&lt;/li&gt;
&lt;li&gt;beforeEvent <em>(cancellable)</em>&lt;/li&gt;
&lt;li&gt;afterEvent&lt;/li&gt; &lt;li&gt;resize&lt;/li&gt;
&lt;li&gt;destroy&lt;/li&gt; &lt;/ul&gt;</p>
