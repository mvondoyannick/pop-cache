...
<title>charts.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/developers/charts.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;new-charts&quot;&gt;New Charts&lt;/h1&gt;</pre>

<p>&lt;p&gt;Chart.js 2.0 introduces the concept of controllers for each
dataset. Like scales, new controllers can be written as needed.&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-javascript”&gt;Chart.controllers.MyType =
Chart.DatasetController.extend({</p>

<p>});</p>

<p>&lt;span class=“hljs-comment”&gt;// Now we can create a new instance of our
chart, using the Chart.js API&lt;/span&gt; &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;// this is the string the constructor was registered at, ie Chart.controllers.MyType&lt;/span&gt;
type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;MyType&amp;apos;&lt;/span&gt;,
data: data,
options: options</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h2
id=“dataset-controller-interface”&gt;Dataset Controller
Interface&lt;/h2&gt; &lt;p&gt;Dataset controllers must implement the
following interface.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;{</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;// Create elements for each piece of data in the dataset. Store elements in an array on the dataset as dataset.metaData&lt;/span&gt;
...
update: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;reset&lt;/span&gt;) &lt;/span&gt;{},</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;The following methods may optionally
be overridden by derived dataset controllers&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;{</p>

<pre>&lt;span class=&quot;hljs-comment&quot;&gt;// Initializes the controller&lt;/span&gt;
...
buildOrUpdateElements: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;&lt;/span&gt;) &lt;/span&gt;{}</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;h2
id=“extending-existing-chart-types”&gt;Extending Existing Chart
Types&lt;/h2&gt; &lt;p&gt;Extending or replacing an existing controller
type is easy. Simply replace the constructor for one of the built in types
with your own.&lt;/p&gt; &lt;p&gt;The built in controller types
are:&lt;/p&gt; &lt;ul&gt;
...
&lt;li&gt;<code>Chart.controllers.bubble</code>&lt;/li&gt; &lt;/ul&gt;
&lt;p&gt;For example, to derive a new chart type that extends from a bubble
chart, you would do the following.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span class=“hljs-comment”&gt;// Sets the
default config for &amp;apos;derivedBubble&amp;apos; to be the same as the
bubble defaults.&lt;/span&gt; &lt;span class=“hljs-comment”&gt;// We look
for the defaults by doing <a
href="chartType">Chart.defaults</a>&lt;/span&gt; &lt;span
class=“hljs-comment”&gt;// It looks like a bug exists when the defaults
don&amp;apos;t exist&lt;/span&gt; Chart.defaults.derivedBubble =
Chart.defaults.bubble;</p>

<p>&lt;span class=“hljs-comment”&gt;// I think the recommend using
Chart.controllers.bubble.extend({ extensions here });&lt;/span&gt; &lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; custom =
Chart.controllers.bubble.extend({</p>

<pre>draw: &lt;span class=&quot;hljs-function&quot;&gt;&lt;span class=&quot;hljs-keyword&quot;&gt;function&lt;/span&gt;(&lt;span class=&quot;hljs-params&quot;&gt;ease&lt;/span&gt;) &lt;/span&gt;{
...
<p>&lt;span class=“hljs-comment”&gt;// Stores the controller so that the chart
initialization routine can look it up with&lt;/span&gt; &lt;span
class=“hljs-comment”&gt;// <a
href="type">Chart.controllers</a>&lt;/span&gt;
Chart.controllers.derivedBubble = custom;</p>

<p>&lt;span class=“hljs-comment”&gt;// Now we can create and use our new chart
type&lt;/span&gt; &lt;span class=“hljs-keyword”&gt;new&lt;/span&gt;
Chart(ctx, {</p>

<pre>type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;derivedBubble&amp;apos;&lt;/span&gt;,
data: data,
options: options,</pre>

<p>}); &lt;/code&gt;&lt;/pre&gt; &lt;h3 id=“bar-controller”&gt;Bar
Controller&lt;/h3&gt; &lt;p&gt;The bar controller has a special property
that you should be aware of. To correctly calculate the width of a bar, the
controller must determine the number of datasets that map to bars. To do
this, the bar controller attaches a property <code>bar</code> to the
dataset during initialization. If you are creating a replacement or updated
bar controller, you should do the same. This will ensure that charts with
regular bars and your new derived bars will work seamlessly.&lt;/p&gt;</p>
