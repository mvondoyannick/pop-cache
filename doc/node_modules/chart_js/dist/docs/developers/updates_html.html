...
<title>updates.html - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/developers/updates.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;updating-charts&quot;&gt;Updating Charts&lt;/h1&gt;</pre>

<p>&lt;p&gt;It&amp;apos;s pretty common to want to update charts after
they&amp;apos;ve been created. When the chart data or options are changed,
Chart.js will animate to the new data values and options.&lt;/p&gt; &lt;h2
id=“adding-or-removing-data”&gt;Adding or Removing Data&lt;/h2&gt;
&lt;p&gt;Adding and removing data is supported by changing the data array.
To add data, just add data into the data array as seen in this
example.&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-javascript”&gt;&lt;span
class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;addData&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;chart, label, data&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>chart.data.labels.push(label);
...
<p>&lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;removeData&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;chart&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>chart.data.labels.pop();
chart.data.datasets.forEach((dataset) =&amp;gt; {
    dataset.data.pop();
});
chart.update();</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;h2 id=“updating-options”&gt;Updating
Options&lt;/h2&gt; &lt;p&gt;To update the options, mutating the options
property in place or passing in a new options object are
supported.&lt;/p&gt; &lt;ul&gt; &lt;li&gt;If the options are mutated in
place, other option properties would be preserved, including those
calculated by Chart.js.&lt;/li&gt; &lt;li&gt;If created as a new object, it
would be like creating a new chart with the options - old options would be
discarded.&lt;/li&gt; &lt;/ul&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;updateConfigByMutating&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;chart&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>chart.options.title.text = &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;new title&amp;apos;&lt;/span&gt;;
chart.update();</pre>
...
<p>&lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;updateConfigAsNewObject&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;chart&lt;/span&gt;) &lt;/span&gt;{</p>
...
<p>} &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;Scales can be updated separately
without changing other options. To update the scales, pass in an object
containing all the customization including those unchanged ones.&lt;/p&gt;
&lt;p&gt;Variables referencing any one from <code>chart.scales</code> would
be lost after updating scales with a new <code>id</code> or the changed
<code>type</code>.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;updateScales&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;chart&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>&lt;span class=&quot;hljs-keyword&quot;&gt;var&lt;/span&gt; xScale = chart.scales[&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;x-axis-0&amp;apos;&lt;/span&gt;];
...
yScale = chart.scales[&lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;y-axis-0&amp;apos;&lt;/span&gt;];</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;You can also update a specific scale
either by specifying its index or id.&lt;/p&gt; &lt;pre&gt;&lt;code
class=“lang-javascript”&gt;&lt;span class=“hljs-function”&gt;&lt;span
class=“hljs-keyword”&gt;function&lt;/span&gt; &lt;span
class=“hljs-title”&gt;updateScale&lt;/span&gt;(&lt;span
class=“hljs-params”&gt;chart&lt;/span&gt;) &lt;/span&gt;{</p>

<pre>chart.options.scales.yAxes[&lt;span class=&quot;hljs-number&quot;&gt;0&lt;/span&gt;] = {
    type: &lt;span class=&quot;hljs-string&quot;&gt;&amp;apos;logarithmic&amp;apos;&lt;/span&gt;
}
chart.update();</pre>

<p>} &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;Code sample for updating options can
be found in &lt;a
href=“../../samples/scales/toggle-scale-type.html”&gt;toggle-scale-type.html&lt;/a&gt;.&lt;/p&gt;
&lt;h2 id=“preventing-animations”&gt;Preventing Animations&lt;/h2&gt;
&lt;p&gt;Sometimes when a chart updates, you may not want an animation. To
achieve this you can call <code>update</code> with a duration of
<code>0</code>. This will render the chart synchronously and without an
animation.&lt;/p&gt;</p>
