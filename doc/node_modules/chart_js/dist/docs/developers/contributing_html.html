...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/developers/contributing.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;contributing&quot;&gt;Contributing&lt;/h1&gt;</pre>

<p>&lt;p&gt;New contributions to the library are welcome, but we ask that you
please follow these guidelines:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Use tabs for
indentation, not spaces.&lt;/li&gt; &lt;li&gt;Only change the individual
files in <code>/src</code>.&lt;/li&gt; &lt;li&gt;Check that your code will
pass <code>eslint</code> code standards, <code>gulp lint</code> will run
this for you.&lt;/li&gt; &lt;li&gt;Check that your code will pass tests,
<code>gulp test</code> will run tests for you.&lt;/li&gt; &lt;li&gt;Keep
pull requests concise, and document new functionality in the relevant
<code>.md</code> file.&lt;/li&gt; &lt;li&gt;Consider whether your changes
are useful for all users, or if creating a Chart.js &lt;a
href=“plugins.html”&gt;plugin&lt;/a&gt; would be more
appropriate.&lt;/li&gt; &lt;li&gt;Avoid breaking changes unless there is an
upcoming major release, which are infrequent. We encourage people to write
plugins for most new advanced features, so care a lot about backwards
compatibility.&lt;/li&gt; &lt;/ul&gt; &lt;h1
id=“joining-the-project”&gt;Joining the project&lt;/h1&gt; &lt;p&gt; Active
committers and contributors are invited to introduce yourself and request
commit access to this project. We have a very active Slack community that
you can join &lt;a href=“<a
href="https://chartjs-slack.herokuapp.com">chartjs-slack.herokuapp.com</a>/”
target=“_blank”&gt;here&lt;/a&gt;. If you think you can help, we&amp;apos;d
love to have you!&lt;/p&gt; &lt;h1 id=“building-and-testing”&gt;Building
and Testing&lt;/h1&gt; &lt;p&gt;Chart.js uses &lt;a href=“<a
href="http://gulpjs.com">gulpjs.com</a>/” target=“_blank”&gt;gulp&lt;/a&gt;
to build the library into a single JavaScript file.&lt;/p&gt;
&lt;p&gt;Firstly, we need to ensure development dependencies are installed.
With node and npm installed, after cloning the Chart.js repo to a local
directory, and navigating to that directory in the command line, we can run
the following:&lt;/p&gt; &lt;pre&gt;&lt;code class=“lang-bash”&gt;&amp;gt;
npm install &amp;gt; npm install -g gulp &lt;/code&gt;&lt;/pre&gt;
&lt;p&gt;This will install the local development dependencies for Chart.js,
along with a CLI for the JavaScript task runner &lt;a href=“<a
href="http://gulpjs.com">gulpjs.com</a>/”
target=“_blank”&gt;gulp&lt;/a&gt;.&lt;/p&gt; &lt;p&gt;The following
commands are now available from the repository root:&lt;/p&gt;
&lt;pre&gt;&lt;code class=“lang-bash”&gt;&amp;gt; gulp build               
// build Chart.js &lt;span class=“hljs-keyword”&gt;in&lt;/span&gt; ./dist
&amp;gt; gulp unittest             // run tests from ./&lt;span
class=“hljs-built_in”&gt;test&lt;/span&gt;/specs &amp;gt; gulp unittest
–watch     // run tests and watch &lt;span
class=“hljs-keyword”&gt;for&lt;/span&gt; &lt;span
class=“hljs-built_in”&gt;source&lt;/span&gt; changes &amp;gt; gulp unittest
–coverage  // run tests and generate coverage reports &lt;span
class=“hljs-keyword”&gt;in&lt;/span&gt; ./coverage &amp;gt; gulp lint      
// perform code linting (ESLint) &amp;gt; gulp &lt;span
class=“hljs-built_in”&gt;test&lt;/span&gt;                 // perform code
linting and run unit tests &amp;gt; gulp docs                 // build the
documentation &lt;span class=“hljs-keyword”&gt;in&lt;/span&gt; ./dist/docs
&amp;gt; gulp docs –watch         // starts the gitbook live reloaded
server &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;More information can be found in
&lt;a href=“<a
href="https://github.com/chartjs/Chart.js/blob/master/gulpfile.js">github.com/chartjs/Chart.js/blob/master/gulpfile.js</a>”
target=“_blank”&gt;gulpfile.js&lt;/a&gt;.&lt;/p&gt; &lt;h1
id=“bugs-and-issues”&gt;Bugs and Issues&lt;/h1&gt; &lt;p&gt;Please report
these on the GitHub page - at &lt;a href=“<a
href="https://github.com/chartjs/Chart.js">github.com/chartjs/Chart.js</a>”
target=“_blank”&gt;github.com/chartjs/Chart.js&lt;/a&gt;. Please do not use
issues for support requests. For help using Chart.js, please take a look at
the &lt;a href=“<a
href="http://stackoverflow.com/questions/tagged/chartjs">stackoverflow.com/questions/tagged/chartjs</a>”
target=“_blank”&gt;<code>chartjs</code>&lt;/a&gt; tag on Stack
Overflow.&lt;/p&gt; &lt;p&gt;Well structured, detailed bug reports are
hugely valuable for the project.&lt;/p&gt; &lt;p&gt;Guidelines for
reporting bugs:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Check the issue search to
see if it has already been reported&lt;/li&gt; &lt;li&gt;Isolate the
problem to a simple test case&lt;/li&gt; &lt;li&gt;Please include a
demonstration of the bug on a website such as &lt;a href=“<a
href="http://jsbin.com">jsbin.com</a>/” target=“_blank”&gt;JS
Bin&lt;/a&gt;, &lt;a href=“<a href="http://jsfiddle.net">jsfiddle.net</a>/”
target=“_blank”&gt;JS Fiddle&lt;/a&gt;, or &lt;a href=“<a
href="http://codepen.io/pen">codepen.io/pen</a>/”
target=“_blank”&gt;Codepen&lt;/a&gt;. (&lt;a href=“<a
href="http://codepen.io/pen?template=JXVYzq">codepen.io/pen?template=JXVYzq</a>”
target=“_blank”&gt;Template&lt;/a&gt;)&lt;/li&gt; &lt;/ul&gt;
&lt;p&gt;Please provide any additional details associated with the bug, if
it&amp;apos;s browser or screen density specific, or only happens with a
certain configuration or data.&lt;/p&gt;</p>
