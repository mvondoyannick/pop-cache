...
<main role="main" aria-label="Page node_modules/chart.js/dist/docs/configuration/index.html">
...
<pre>&lt;div class=&quot;search-noresults&quot;&gt;
                            ...
                            &lt;h1 id=&quot;configuration&quot;&gt;Configuration&lt;/h1&gt;</pre>

<p>&lt;p&gt;The configuration is used to change how the chart behaves. There
are properties to control styling, fonts, the legend, etc.&lt;/p&gt; &lt;h2
id=“global-configuration”&gt;Global Configuration&lt;/h2&gt; &lt;p&gt;This
concept was introduced in Chart.js 1.0 to keep configuration &lt;a href=“<a
href="https://en.wikipedia.org/wiki/Don%27t_repeat_yourself">en.wikipedia.org/wiki/Don%27t_repeat_yourself</a>”
target=“_blank”&gt;DRY&lt;/a&gt;, and allow for changing options globally
across chart types, avoiding the need to specify options for each instance,
or the default for a particular chart type.&lt;/p&gt; &lt;p&gt;Chart.js
merges the options object passed to the chart with the global configuration
using chart type defaults and scales defaults appropriately. This way you
can be as specific as you would like in your individual chart
configuration, while still changing the defaults for all chart types where
applicable. The global general options are defined in
<code>Chart.defaults.global</code>. The defaults for each chart type are
discussed in the documentation for that chart type.&lt;/p&gt; &lt;p&gt;The
following example would set the hover mode to &amp;apos;nearest&amp;apos;
for all charts where this was not overridden by the chart type defaults or
the options passed to the constructor on creation.&lt;/p&gt;
&lt;pre&gt;&lt;code
class=“lang-javascript”&gt;Chart.defaults.global.hover.mode = &lt;span
class=“hljs-string”&gt;&amp;apos;nearest&amp;apos;&lt;/span&gt;;</p>

<p>&lt;span class=“hljs-comment”&gt;// Hover mode is set to nearest because it
was not overridden here&lt;/span&gt; &lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chartHoverModeNearest  = &lt;span
...
<p>&lt;span class=“hljs-comment”&gt;// This chart would have the hover mode
that was passed in&lt;/span&gt; &lt;span
class=“hljs-keyword”&gt;var&lt;/span&gt; chartDifferentHoverMode = &lt;span
class=“hljs-keyword”&gt;new&lt;/span&gt; Chart(ctx, {</p>
