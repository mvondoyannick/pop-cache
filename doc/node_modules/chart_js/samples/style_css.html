...
<main role="main" aria-label="Page node_modules/chart.js/samples/style.css">

<p>@import url(&#39;<a
href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css</a>&#39;);
@import url(&#39;<a
href="https://fonts.googleapis.com/css?family=Lato:100,300,400,700,900">fonts.googleapis.com/css?family=Lato:100,300,400,700,900</a>&#39;);</p>
...
<pre>-moz-user-select: none;
-webkit-user-select: none;
-ms-user-select: none;</pre>
...
<p>.btn-chartjs { background-color: f27173; } .btn-chartjs:hover {
background-color: e25f5f; } .btn-docs:hover { background-color: #2793db; }
.btn-docs { background-color: #36A2EB; } .btn-docs:hover {
background-color: #2793db; } .btn-gh { background-color: #444; }
.btn-gh:hover { background-color: #333; }</p>

<p>.btn-on {</p>

<pre>border-style: inset;</pre>
...
<p>.chartjs-title::before {</p>

<pre>background-image: url(logo.svg);
...
<p>.chartjs-links .fa:before {</p>

<pre>margin-right: 0.5em;</pre>

<p>}</p>

<p>.samples-category {</p>
...
<p>.samples-category:hover &gt; .title {</p>

<pre>color: black;</pre>

<p>}</p>

<p>.samples-category &gt; .items {</p>

<pre>padding: 8px 0;</pre>

<p>}</p>

<p>.samples-entry {</p>

<pre>padding: 0 0 4px 0;</pre>

<p>}</p>

<p>.samples-entry &gt; .title {</p>
...
<pre>.samples-category { width: 33%; }</pre>

<p>}</p>

<p>@media (max-width: 512px) {</p>

<pre>.samples-category { width: 50%; }</pre>

<p>}</p>

<p>@media (max-width: 420px) {</p>

<pre>.chartjs-caption { font-size: 1.05rem; }
.chartjs-title::before { content: &#39;&#39;; }
.chartjs-links a { flex-direction: column; }
.chartjs-links .fa { margin: 0 }
.samples-category { width: 100%; }</pre>
