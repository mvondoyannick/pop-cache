...
<title>jasmine.utils.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/jasmine.utils.js">

<pre class="ruby"><span class="ruby-identifier">global</span> <span class="ruby-identifier">__karma__</span>
</pre>

<p>function loadJSON(url, callback) {</p>
...
<p>function createCanvas(w, h) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">canvas</span> = <span class="ruby-identifier">document</span>.<span class="ruby-identifier">createElement</span>(<span class="ruby-string">&#39;canvas&#39;</span>);
<span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">width</span> = <span class="ruby-identifier">w</span>;
<span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">height</span> = <span class="ruby-identifier">h</span>;
<span class="ruby-keyword">return</span> <span class="ruby-identifier">canvas</span>;
</pre>

<p>}</p>

<p>function readImageData(url, callback) {</p>
...
<pre> Injects a new canvas (and div wrapper) and creates teh associated Chart instance
...
<p>function acquireChart(config, options) {</p>
...
<p>function releaseChart(chart) {</p>
...
<p>function specFromFixture(description, inputs) {</p>

<pre>it(inputs.json, function(done) {
...
<p>function specsFromFixtures(path) {</p>

<pre>var regex = new RegExp(&#39;(^/base/test/fixtures/&#39; + path + &#39;.+)\\.(png|json)&#39;);
var inputs = {};
...
<p>function waitForResize(chart, callback) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">override</span> = <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">resize</span>;
<span class="ruby-identifier">chart</span>.<span class="ruby-identifier">resize</span> = <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">resize</span> = <span class="ruby-identifier">override</span>;
        <span class="ruby-identifier">override</span>.<span class="ruby-identifier">apply</span>(<span class="ruby-identifier">this</span>, <span class="ruby-identifier">arguments</span>);
...
<p>function triggerMouseEvent(chart, type, el) {</p>

<pre>var node = chart.canvas;
...
node.dispatchEvent(event);</pre>

<p>}</p>

<p>module.exports = {</p>

<pre>injectCSS: injectCSS,
createCanvas: createCanvas,
acquireChart: acquireChart,
releaseChart: releaseChart,
specsFromFixtures: specsFromFixtures,
triggerMouseEvent: triggerMouseEvent,
waitForResize: waitForResize</pre>
