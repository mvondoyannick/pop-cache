...
<title>jasmine.matchers.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/jasmine.matchers.js">

<p>&#39;use strict&#39;;</p>

<p>var pixelmatch = require(&#39;pixelmatch&#39;); var utils =
require(&#39;./jasmine.utils&#39;);</p>

<p>function toPercent(value) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Math</span>.<span class="ruby-identifier">round</span>(<span class="ruby-identifier">value</span> <span class="ruby-operator">*</span> <span class="ruby-value">10000</span>) <span class="ruby-operator">/</span> <span class="ruby-value">100</span>;
</pre>

<p>}</p>

<p>function createImageData(w, h) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">canvas</span> = <span class="ruby-identifier">utils</span>.<span class="ruby-identifier">createCanvas</span>(<span class="ruby-identifier">w</span>, <span class="ruby-identifier">h</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">context</span> = <span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">getContext</span>(<span class="ruby-string">&#39;2d&#39;</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">context</span>.<span class="ruby-identifier">getImageData</span>(<span class="ruby-value">0</span>, <span class="ruby-value">0</span>, <span class="ruby-identifier">w</span>, <span class="ruby-identifier">h</span>);
</pre>

<p>}</p>

<p>function canvasFromImageData(data) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">canvas</span> = <span class="ruby-identifier">utils</span>.<span class="ruby-identifier">createCanvas</span>(<span class="ruby-identifier">data</span>.<span class="ruby-identifier">width</span>, <span class="ruby-identifier">data</span>.<span class="ruby-identifier">height</span>);
<span class="ruby-identifier">var</span> <span class="ruby-identifier">context</span> = <span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">getContext</span>(<span class="ruby-string">&#39;2d&#39;</span>);
<span class="ruby-identifier">context</span>.<span class="ruby-identifier">putImageData</span>(<span class="ruby-identifier">data</span>, <span class="ruby-value">0</span>, <span class="ruby-value">0</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">canvas</span>;
</pre>

<p>}</p>

<p>function buildPixelMatchPreview(actual, expected, diff, threshold,
tolerance, count) {</p>

<pre>var ratio = count / (actual.width * actual.height);
