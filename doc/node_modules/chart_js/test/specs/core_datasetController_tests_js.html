...
<title>core.datasetController.tests.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/specs/core.datasetController.tests.js">

<p>describe(&#39;Chart.DatasetController&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should listen for dataset data insertions or removals&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data</span> = [<span class="ruby-value">0</span>, <span class="ruby-value">1</span>, <span class="ruby-value">2</span>, <span class="ruby-value">3</span>, <span class="ruby-value">4</span>, <span class="ruby-value">5</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">acquireChart</span>({
                <span class="ruby-value">type:</span> <span class="ruby-string">&#39;line&#39;</span>,
                <span class="ruby-value">data:</span> {
                        <span class="ruby-value">datasets:</span> [{
                                <span class="ruby-value">data:</span> <span class="ruby-identifier">data</span>
                        }]
                }
        });

        <span class="ruby-identifier">var</span> <span class="ruby-identifier">controller</span> = <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">getDatasetMeta</span>(<span class="ruby-value">0</span>).<span class="ruby-identifier">controller</span>;
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">methods</span> = [
                <span class="ruby-string">&#39;onDataPush&#39;</span>,
                <span class="ruby-string">&#39;onDataPop&#39;</span>,
                <span class="ruby-string">&#39;onDataShift&#39;</span>,
                <span class="ruby-string">&#39;onDataSplice&#39;</span>,
                <span class="ruby-string">&#39;onDataUnshift&#39;</span>
        ];

        <span class="ruby-identifier">methods</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">method</span>) {
                <span class="ruby-identifier">spyOn</span>(<span class="ruby-identifier">controller</span>, <span class="ruby-identifier">method</span>);
        });

        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">push</span>(<span class="ruby-value">6</span>, <span class="ruby-value">7</span>, <span class="ruby-value">8</span>);
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">push</span>(<span class="ruby-value">9</span>);
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">pop</span>();
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">shift</span>();
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">shift</span>();
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">shift</span>();
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">splice</span>(<span class="ruby-value">1</span>, <span class="ruby-value">4</span>, <span class="ruby-value">10</span>, <span class="ruby-value">11</span>);
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">unshift</span>(<span class="ruby-value">12</span>, <span class="ruby-value">13</span>, <span class="ruby-value">14</span>, <span class="ruby-value">15</span>);
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">unshift</span>(<span class="ruby-value">16</span>, <span class="ruby-value">17</span>);

        [<span class="ruby-value">2</span>, <span class="ruby-value">1</span>, <span class="ruby-value">3</span>, <span class="ruby-value">1</span>, <span class="ruby-value">2</span>].<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">expected</span>, <span class="ruby-identifier">index</span>) {
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">controller</span>[<span class="ruby-identifier">methods</span>[<span class="ruby-identifier">index</span>]].<span class="ruby-identifier">calls</span>.<span class="ruby-identifier">count</span>()).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">expected</span>);
        });
});

<span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should synchronize metadata when data are inserted or removed&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data</span> = [<span class="ruby-value">0</span>, <span class="ruby-value">1</span>, <span class="ruby-value">2</span>, <span class="ruby-value">3</span>, <span class="ruby-value">4</span>, <span class="ruby-value">5</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">acquireChart</span>({
                <span class="ruby-value">type:</span> <span class="ruby-string">&#39;line&#39;</span>,
                <span class="ruby-value">data:</span> {
        ...
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">meta</span> = <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">getDatasetMeta</span>(<span class="ruby-value">0</span>);
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">first</span>, <span class="ruby-identifier">second</span>, <span class="ruby-identifier">last</span>;

        <span class="ruby-identifier">first</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>];
        <span class="ruby-identifier">last</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">5</span>];
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">push</span>(<span class="ruby-value">6</span>, <span class="ruby-value">7</span>, <span class="ruby-value">8</span>);
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">push</span>(<span class="ruby-value">9</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">10</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">first</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">5</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">last</span>);

        <span class="ruby-identifier">last</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">9</span>];
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">pop</span>();
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">9</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">first</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">indexOf</span>(<span class="ruby-identifier">last</span>)).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">-1</span>);

        <span class="ruby-identifier">last</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">8</span>];
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">shift</span>();
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">shift</span>();
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">shift</span>();
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">6</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">indexOf</span>(<span class="ruby-identifier">first</span>)).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">-1</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">5</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">last</span>);

        <span class="ruby-identifier">first</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>];
        <span class="ruby-identifier">second</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">1</span>];
        <span class="ruby-identifier">last</span> = <span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">5</span>];
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">splice</span>(<span class="ruby-value">1</span>, <span class="ruby-value">4</span>, <span class="ruby-value">10</span>, <span class="ruby-value">11</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">4</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">first</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">3</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">last</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">indexOf</span>(<span class="ruby-identifier">second</span>)).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">-1</span>);

        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">unshift</span>(<span class="ruby-value">12</span>, <span class="ruby-value">13</span>, <span class="ruby-value">14</span>, <span class="ruby-value">15</span>);
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">unshift</span>(<span class="ruby-value">16</span>, <span class="ruby-value">17</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">10</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">6</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">first</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">9</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">last</span>);
});

<span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should re-synchronize metadata when the data object reference changes&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data0</span> = [<span class="ruby-value">0</span>, <span class="ruby-value">1</span>, <span class="ruby-value">2</span>, <span class="ruby-value">3</span>, <span class="ruby-value">4</span>, <span class="ruby-value">5</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data1</span> = [<span class="ruby-value">6</span>, <span class="ruby-value">7</span>, <span class="ruby-value">8</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">acquireChart</span>({
                <span class="ruby-value">type:</span> <span class="ruby-string">&#39;line&#39;</span>,
                <span class="ruby-value">data:</span> {
                        <span class="ruby-value">datasets:</span> [{
                                <span class="ruby-value">data:</span> <span class="ruby-identifier">data0</span>
                        }]
                }
        });
        ...
        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">datasets</span>[<span class="ruby-value">0</span>].<span class="ruby-identifier">data</span> = <span class="ruby-identifier">data1</span>;
        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">3</span>);

        <span class="ruby-identifier">data1</span>.<span class="ruby-identifier">push</span>(<span class="ruby-value">9</span>, <span class="ruby-value">10</span>, <span class="ruby-value">11</span>);
        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">6</span>);
});

<span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should re-synchronize metadata when data are unusually altered&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data</span> = [<span class="ruby-value">0</span>, <span class="ruby-value">1</span>, <span class="ruby-value">2</span>, <span class="ruby-value">3</span>, <span class="ruby-value">4</span>, <span class="ruby-value">5</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">acquireChart</span>({
                <span class="ruby-value">type:</span> <span class="ruby-string">&#39;line&#39;</span>,
                <span class="ruby-value">data:</span> {
        ...
        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span> = <span class="ruby-value">2</span>;
        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">2</span>);

        <span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span> = <span class="ruby-value">42</span>;
        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">42</span>);
});

<span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should cleanup attached properties when the reference changes or when the chart is destroyed&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data0</span> = [<span class="ruby-value">0</span>, <span class="ruby-value">1</span>, <span class="ruby-value">2</span>, <span class="ruby-value">3</span>, <span class="ruby-value">4</span>, <span class="ruby-value">5</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">data1</span> = [<span class="ruby-value">6</span>, <span class="ruby-value">7</span>, <span class="ruby-value">8</span>];
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">acquireChart</span>({
                <span class="ruby-value">type:</span> <span class="ruby-string">&#39;line&#39;</span>,
        ...
        <span class="ruby-identifier">var</span> <span class="ruby-identifier">hooks</span> = [<span class="ruby-string">&#39;push&#39;</span>, <span class="ruby-string">&#39;pop&#39;</span>, <span class="ruby-string">&#39;shift&#39;</span>, <span class="ruby-string">&#39;splice&#39;</span>, <span class="ruby-string">&#39;unshift&#39;</span>];

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data0</span>.<span class="ruby-identifier">_chartjs</span>).<span class="ruby-identifier">toBeDefined</span>();
        <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">hook</span>) {
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data0</span>[<span class="ruby-identifier">hook</span>]).<span class="ruby-identifier">not</span>.<span class="ruby-identifier">toBe</span>(<span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>[<span class="ruby-identifier">hook</span>]);
        });

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data1</span>.<span class="ruby-identifier">_chartjs</span>).<span class="ruby-identifier">not</span>.<span class="ruby-identifier">toBeDefined</span>();
        <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">hook</span>) {
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data1</span>[<span class="ruby-identifier">hook</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>[<span class="ruby-identifier">hook</span>]);
        });

        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">datasets</span>[<span class="ruby-value">0</span>].<span class="ruby-identifier">data</span> = <span class="ruby-identifier">data1</span>;
        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data0</span>.<span class="ruby-identifier">_chartjs</span>).<span class="ruby-identifier">not</span>.<span class="ruby-identifier">toBeDefined</span>();
        <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">hook</span>) {
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data0</span>[<span class="ruby-identifier">hook</span>]).<span class="ruby-identifier">toBe</span>(<span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>[<span class="ruby-identifier">hook</span>]);
        });

        <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data1</span>.<span class="ruby-identifier">_chartjs</span>).<span class="ruby-identifier">toBeDefined</span>();
        <span class="ruby-identifier">hooks</span>.<span class="ruby-identifier">forEach</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">hook</span>) {
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">data1</span>[<span class="ruby-identifier">hook</span>]).<span class="ruby-identifier">not</span>.<span class="ruby-identifier">toBe</span>(<span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>[<span class="ruby-identifier">hook</span>]);
        });

        <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">destroy</span>();
