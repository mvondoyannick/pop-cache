...
<title>helpers.canvas.tests.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/specs/helpers.canvas.tests.js">

<p>&#39;use strict&#39;;</p>

<p>describe(&#39;Chart.helpers.canvas&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">helpers</span> = <span class="ruby-constant">Chart</span>.<span class="ruby-identifier">helpers</span>;

<span class="ruby-identifier">describe</span>(<span class="ruby-string">&#39;clear&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should clear the chart canvas&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">acquireChart</span>({}, {
                        <span class="ruby-value">canvas:</span> {
                                <span class="ruby-value">style:</span> <span class="ruby-string">&#39;width: 150px; height: 245px&#39;</span>
                        }
                });

                <span class="ruby-identifier">spyOn</span>(<span class="ruby-identifier">chart</span>.<span class="ruby-identifier">ctx</span>, <span class="ruby-string">&#39;clearRect&#39;</span>);

                <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">clear</span>(<span class="ruby-identifier">chart</span>);

                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">chart</span>.<span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">clearRect</span>.<span class="ruby-identifier">calls</span>.<span class="ruby-identifier">count</span>()).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">1</span>);
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">chart</span>.<span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">clearRect</span>.<span class="ruby-identifier">calls</span>.<span class="ruby-identifier">first</span>().<span class="ruby-identifier">object</span>).<span class="ruby-identifier">toBe</span>(<span class="ruby-identifier">chart</span>.<span class="ruby-identifier">ctx</span>);
                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">chart</span>.<span class="ruby-identifier">ctx</span>.<span class="ruby-identifier">clearRect</span>.<span class="ruby-identifier">calls</span>.<span class="ruby-identifier">first</span>().<span class="ruby-identifier">args</span>).<span class="ruby-identifier">toEqual</span>([<span class="ruby-value">0</span>, <span class="ruby-value">0</span>, <span class="ruby-value">150</span>, <span class="ruby-value">245</span>]);
        });
});

<span class="ruby-identifier">describe</span>(<span class="ruby-string">&#39;roundedRect&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should create a rounded rectangle path&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">var</span> <span class="ruby-identifier">context</span> = <span class="ruby-identifier">window</span>.<span class="ruby-identifier">createMockContext</span>();

                <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">roundedRect</span>(<span class="ruby-identifier">context</span>, <span class="ruby-value">10</span>, <span class="ruby-value">20</span>, <span class="ruby-value">30</span>, <span class="ruby-value">40</span>, <span class="ruby-value">5</span>);

                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">context</span>.<span class="ruby-identifier">getCalls</span>()).<span class="ruby-identifier">toEqual</span>([
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;moveTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">15</span>, <span class="ruby-value">20</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;lineTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">35</span>, <span class="ruby-value">20</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;arcTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">40</span>, <span class="ruby-value">20</span>, <span class="ruby-value">40</span>, <span class="ruby-value">25</span>, <span class="ruby-value">5</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;lineTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">40</span>, <span class="ruby-value">55</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;arcTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">40</span>, <span class="ruby-value">60</span>, <span class="ruby-value">35</span>, <span class="ruby-value">60</span>, <span class="ruby-value">5</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;lineTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">15</span>, <span class="ruby-value">60</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;arcTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">10</span>, <span class="ruby-value">60</span>, <span class="ruby-value">10</span>, <span class="ruby-value">55</span>, <span class="ruby-value">5</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;lineTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">10</span>, <span class="ruby-value">25</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;arcTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">10</span>, <span class="ruby-value">20</span>, <span class="ruby-value">15</span>, <span class="ruby-value">20</span>, <span class="ruby-value">5</span>]},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;closePath&#39;</span>, <span class="ruby-value">args:</span> []},
                        {<span class="ruby-value">name:</span> <span class="ruby-string">&#39;moveTo&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">10</span>, <span class="ruby-value">20</span>]}
                ]);
        });
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should optimize path if radius is 0&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">var</span> <span class="ruby-identifier">context</span> = <span class="ruby-identifier">window</span>.<span class="ruby-identifier">createMockContext</span>();

                <span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">canvas</span>.<span class="ruby-identifier">roundedRect</span>(<span class="ruby-identifier">context</span>, <span class="ruby-value">10</span>, <span class="ruby-value">20</span>, <span class="ruby-value">30</span>, <span class="ruby-value">40</span>, <span class="ruby-value">0</span>);

                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">context</span>.<span class="ruby-identifier">getCalls</span>()).<span class="ruby-identifier">toEqual</span>([{<span class="ruby-value">name:</span> <span class="ruby-string">&#39;rect&#39;</span>, <span class="ruby-value">args:</span> [<span class="ruby-value">10</span>, <span class="ruby-value">20</span>, <span class="ruby-value">30</span>, <span class="ruby-value">40</span>]}]);
        });
});
</pre>
