...
<title>controller.scatter.test.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/specs/controller.scatter.test.js">

<p>describe(&#39;Chart.controllers.scatter&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">describe</span>(<span class="ruby-string">&#39;showLines option&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should not draw a line if undefined&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">var</span> <span class="ruby-identifier">chart</span> = <span class="ruby-identifier">window</span>.<span class="ruby-identifier">acquireChart</span>({
                        <span class="ruby-value">type:</span> <span class="ruby-string">&#39;scatter&#39;</span>,
                        <span class="ruby-value">data:</span> {
                                <span class="ruby-value">datasets:</span> [{
                                        <span class="ruby-value">data:</span> [{<span class="ruby-value">x:</span> <span class="ruby-value">10</span>, <span class="ruby-value">y:</span> <span class="ruby-value">15</span>}],
                                        <span class="ruby-value">label:</span> <span class="ruby-string">&#39;dataset1&#39;</span>
                                }],
                        },
                ...
                <span class="ruby-identifier">spyOn</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">dataset</span>, <span class="ruby-string">&#39;draw&#39;</span>);
                <span class="ruby-identifier">spyOn</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">data</span>[<span class="ruby-value">0</span>], <span class="ruby-string">&#39;draw&#39;</span>);

                <span class="ruby-identifier">chart</span>.<span class="ruby-identifier">update</span>();

                <span class="ruby-identifier">expect</span>(<span class="ruby-identifier">meta</span>.<span class="ruby-identifier">dataset</span>.<span class="ruby-identifier">draw</span>.<span class="ruby-identifier">calls</span>.<span class="ruby-identifier">count</span>()).<span class="ruby-identifier">toBe</span>(<span class="ruby-value">0</span>);
