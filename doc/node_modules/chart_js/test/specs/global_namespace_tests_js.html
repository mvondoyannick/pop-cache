...
<title>global.namespace.tests.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/specs/global.namespace.tests.js">

<p>describe(&#39;Chart namespace&#39;, function() {</p>

<pre class="ruby"><span class="ruby-identifier">describe</span>(<span class="ruby-string">&#39;Chart&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should a function (constructor)&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Function</span>).<span class="ruby-identifier">toBeTruthy</span>();
        });
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should define &quot;core&quot; properties&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Function</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Animation</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">animationService</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">defaults</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Element</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Interaction</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">layouts</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">plugins</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">platform</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Scale</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">scaleService</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Ticks</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Tooltip</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-constant">Tooltip</span>.<span class="ruby-identifier">positioners</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
        });
});

<span class="ruby-identifier">describe</span>(<span class="ruby-string">&#39;Chart.elements&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should be an object&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">elements</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
        });
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should contains &quot;elements&quot; classes&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">elements</span>.<span class="ruby-constant">Arc</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Function</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">elements</span>.<span class="ruby-constant">Line</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Function</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">elements</span>.<span class="ruby-constant">Point</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Function</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">elements</span>.<span class="ruby-constant">Rectangle</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Function</span>).<span class="ruby-identifier">toBeTruthy</span>();
        });
});

<span class="ruby-identifier">describe</span>(<span class="ruby-string">&#39;Chart.helpers&#39;</span>, <span class="ruby-identifier">function</span>() {
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should be an object&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">helpers</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
        });
        <span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;should contains &quot;helpers&quot; namespaces&#39;</span>, <span class="ruby-identifier">function</span>() {
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">easing</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">canvas</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
                <span class="ruby-identifier">expect</span>(<span class="ruby-constant">Chart</span>.<span class="ruby-identifier">helpers</span>.<span class="ruby-identifier">options</span> <span class="ruby-identifier">instanceof</span> <span class="ruby-constant">Object</span>).<span class="ruby-identifier">toBeTruthy</span>();
        });
});
</pre>
