...
<title>jasmine.context.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/chart.js/test/jasmine.context.js">

<p>// Code from <a
href="http://stackoverflow.com/questions/4406864/html-canvas-unit-testing">stackoverflow.com/questions/4406864/html-canvas-unit-testing</a>
var Context = function() {</p>

<pre>this._calls = []; // names/args of recorded calls
this._initMethods();
...
<p>Context.prototype._initMethods = function() {</p>

<pre>// define methods to test here
...
<p>Context.prototype.record = function(methodName, args) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">_calls</span>.<span class="ruby-identifier">push</span>({
        <span class="ruby-value">name:</span> <span class="ruby-identifier">methodName</span>,
        <span class="ruby-value">args:</span> <span class="ruby-constant">Array</span>.<span class="ruby-identifier">prototype</span>.<span class="ruby-identifier">slice</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">args</span>)
});
</pre>

<p>};</p>

<p>Context.prototype.getCalls = function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">_calls</span>;
</pre>

<p>};</p>

<p>Context.prototype.resetCalls = function() {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">_calls</span> = [];
</pre>

<p>};</p>

<p>module.exports = Context;</p>
</main>
