...
<title>bootstrap.css - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/dist/css/bootstrap.css">
...
<p>article, aside, figcaption, figure, footer, header, hgroup, main, nav,
section {</p>
...
<pre>word-wrap: normal;</pre>

<p>}</p>

<p>button, [type=“button”], [type=“reset”],</p>
...
<p>button:not(:disabled), [type=“button”]:not(:disabled),
[type=“reset”]:not(:disabled), [type=“submit”]:not(:disabled) {</p>
...
<p>[type=“search”]::-webkit-search-decoration {</p>
...
<pre>color: #212529;
background-color: rgba(0, 0, 0, 0.075);</pre>
...
<p>.table-primary th, .table-primary td, .table-primary thead th,
.table-primary tbody + tbody {</p>

<pre>border-color: #7abaff;</pre>
...
<p>.table-secondary th, .table-secondary td, .table-secondary thead th,
.table-secondary tbody + tbody {</p>

<pre>border-color: #b3b7bb;</pre>
...
<p>.table-success th, .table-success td, .table-success thead th,
.table-success tbody + tbody {</p>

<pre>border-color: #8fd19e;</pre>
...
<p>.table-info th, .table-info td, .table-info thead th, .table-info tbody +
tbody {</p>

<pre>border-color: #86cfda;</pre>
...
<p>.table-warning th, .table-warning td, .table-warning thead th,
.table-warning tbody + tbody {</p>

<pre>border-color: #ffdf7e;</pre>
...
<p>.table-danger th, .table-danger td, .table-danger thead th, .table-danger
tbody + tbody {</p>

<pre>border-color: #ed969e;</pre>
...
<p>.table-light th, .table-light td, .table-light thead th, .table-light tbody
+ tbody {</p>

<pre>border-color: #fbfcfc;</pre>
...
<p>.table-dark th, .table-dark td, .table-dark thead th, .table-dark tbody +
tbody {</p>

<pre>border-color: #95999c;</pre>
...
<pre>color: #fff;
background-color: rgba(255, 255, 255, 0.075);</pre>
...
<p>.form-control-plaintext.form-control-sm,
.form-control-plaintext.form-control-lg {</p>
...
<pre>height: calc(1.5em + 0.5rem + 2px);
...
<pre>height: calc(1.5em + 1rem + 2px);
padding: 0.5rem 1rem;
font-size: 1.25rem;
line-height: 1.5;
...
<p><a href="size">select.form-control</a>, <a
href="multiple">select.form-control</a> {</p>
...
<p>.was-validated .form-control:valid, .form-control.is-valid {</p>
...
background-size: calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);</pre>

<p>}</p>

<p>.was-validated .form-control:valid:focus, .form-control.is-valid:focus {</p>
...
.valid-feedback, .form-control.is-valid ~ .valid-tooltip {</p>

<pre>display: block;</pre>

<p>}</p>

<p>.was-validated textarea.form-control:valid, textarea.form-control.is-valid
{</p>

<pre>padding-right: calc(1.5em + 0.75rem);
background-position: top calc(0.375em + 0.1875rem) right calc(0.375em + 0.1875rem);</pre>

<p>}</p>

<p>.was-validated .custom-select:valid, .custom-select.is-valid {</p>

<pre>border-color: #28a745;
padding-right: calc((1em + 0.75rem) * 3 / 4 + 1.75rem);
background: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; viewBox=&#39;0 0 4 5&#39;%3e%3cpath fill=&#39;%23343a40&#39; d=&#39;M2 0L0 2h4zm0 5L0 3h4z&#39;/%3e%3c/svg%3e&quot;) no-repeat right 0.75rem center/8px 10px, url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; viewBox=&#39;0 0 8 8&#39;%3e%3cpath fill=&#39;%2328a745&#39; d=&#39;M2.3 6.73L.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z&#39;/%3e%3c/svg%3e&quot;) #fff no-repeat center right 1.75rem/calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);</pre>

<p>}</p>

<p>.was-validated .custom-select:valid:focus, .custom-select.is-valid:focus {</p>
...
<p>.was-validated .custom-select:valid ~ .valid-feedback, .was-validated
.custom-select:valid ~ .valid-tooltip, .custom-select.is-valid ~
.valid-feedback, .custom-select.is-valid ~ .valid-tooltip {</p>

<pre>display: block;</pre>

<p>}</p>

<p>.was-validated .form-control-file:valid ~ .valid-feedback, .was-validated
.form-control-file:valid ~ .valid-tooltip, .form-control-file.is-valid ~
.valid-feedback, .form-control-file.is-valid ~ .valid-tooltip {</p>
...
<pre>border-color: #34ce57;
background-color: #34ce57;</pre>
...
<p>.was-validated .custom-control-input:valid:focus:not(:checked) ~
...
<p>.was-validated .form-control:invalid, .form-control.is-invalid {</p>
...
.invalid-feedback, .form-control.is-invalid ~ .invalid-tooltip {</p>

<pre>display: block;</pre>

<p>}</p>

<p>.was-validated textarea.form-control:invalid,
textarea.form-control.is-invalid {</p>
...
<p>.was-validated .custom-select:invalid, .custom-select.is-invalid {</p>

<pre>border-color: #dc3545;
padding-right: calc((1em + 0.75rem) * 3 / 4 + 1.75rem);
background: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; viewBox=&#39;0 0 4 5&#39;%3e%3cpath fill=&#39;%23343a40&#39; d=&#39;M2 0L0 2h4zm0 5L0 3h4z&#39;/%3e%3c/svg%3e&quot;) no-repeat right 0.75rem center/8px 10px, url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; fill=&#39;%23dc3545&#39; viewBox=&#39;-2 -2 7 7&#39;%3e%3cpath stroke=&#39;%23dc3545&#39; d=&#39;M0 0l3 3m0-3L0 3&#39;/%3e%3ccircle r=&#39;.5&#39;/%3e%3ccircle cx=&#39;3&#39; r=&#39;.5&#39;/%3e%3ccircle cy=&#39;3&#39; r=&#39;.5&#39;/%3e%3ccircle cx=&#39;3&#39; cy=&#39;3&#39; r=&#39;.5&#39;/%3e%3c/svg%3E&quot;) #fff no-repeat center right 1.75rem/calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);</pre>

<p>}</p>

<p>.was-validated .custom-select:invalid:focus,
...
<p>.was-validated .custom-select:invalid ~ .invalid-feedback, .was-validated
...
<p>.was-validated .form-control-file:invalid ~ .invalid-feedback,
.was-validated .form-control-file:invalid ~ .invalid-tooltip,
.form-control-file.is-invalid ~ .invalid-feedback,
.form-control-file.is-invalid ~ .invalid-tooltip {</p>
...
<pre>border-color: #e4606d;
background-color: #e4606d;</pre>
...
<p>.was-validated .custom-control-input:invalid:focus:not(:checked) ~
.custom-control-label::before,
...
<pre>box-shadow: 0 0 0 0.2rem rgba(38, 143, 255, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(130, 138, 145, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(72, 180, 97, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(58, 176, 195, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(222, 170, 12, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(225, 83, 97, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(216, 217, 219, 0.5);</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(82, 88, 93, 0.5);</pre>
...
<p>.input-group &gt; .form-control, .input-group &gt; .form-control-plaintext,
.input-group &gt; .custom-select, .input-group &gt; .custom-file {</p>
...
.custom-file, .input-group &gt; .form-control-plaintext + .form-control,
.input-group &gt; .form-control-plaintext + .custom-select, .input-group
&gt; .form-control-plaintext + .custom-file, .input-group &gt;
.custom-select + .form-control, .input-group &gt; .custom-select +
.custom-select, .input-group &gt; .custom-select + .custom-file,
.input-group &gt; .custom-file + .form-control, .input-group &gt;
.custom-file + .custom-select, .input-group &gt; .custom-file +
.custom-file {</p>
...
.custom-select:focus, .input-group &gt; .custom-file
.custom-file-input:focus ~ .custom-file-label {</p>

<pre>z-index: 3;</pre>

<p>}</p>

<p>.input-group &gt; .custom-file .custom-file-input:focus {</p>
...
<p>.input-group &gt; .custom-file:not(:first-child) .custom-file-label {</p>
...
<p>.input-group-prepend .btn:focus, .input-group-append .btn:focus {</p>
...
<p>.input-group-lg &gt; .form-control:not(textarea), .input-group-lg &gt;
.custom-select {</p>

<pre>height: calc(1.5em + 1rem + 2px);</pre>

<p>}</p>

<p>.input-group-lg &gt; .form-control, .input-group-lg &gt; .custom-select,
.input-group-lg &gt; .input-group-prepend &gt; .input-group-text,
.input-group-lg &gt; .input-group-append &gt; .input-group-text,
.input-group-lg &gt; .input-group-prepend &gt; .btn, .input-group-lg &gt;
.input-group-append &gt; .btn {</p>
...
<p>.input-group-sm &gt; .form-control:not(textarea), .input-group-sm &gt;
.custom-select {</p>

<pre>height: calc(1.5em + 0.5rem + 2px);</pre>

<p>}</p>

<p>.input-group-sm &gt; .form-control, .input-group-sm &gt; .custom-select,
.input-group-sm &gt; .input-group-prepend &gt; .input-group-text,
.input-group-sm &gt; .input-group-append &gt; .input-group-text,
.input-group-sm &gt; .input-group-prepend &gt; .btn, .input-group-sm &gt;
.input-group-append &gt; .btn {</p>
...
<p>.input-group-lg &gt; .custom-select, .input-group-sm &gt; .custom-select {</p>

<pre>padding-right: 1.75rem;</pre>
...
<pre>box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25);</pre>

<p>}</p>

<p>.custom-control-input:focus:not(:checked) ~ .custom-control-label::before {</p>

<pre>border-color: #80bdff;</pre>

<p>}</p>

<p>.custom-control-input:not(:disabled):active ~ .custom-control-label::before
{</p>

<pre>color: #fff;
background-color: #b3d7ff;
border-color: #b3d7ff;</pre>
...
height: 1rem;
content: &quot;&quot;;
background: no-repeat 50% / 50% 50%;</pre>
...
<pre>background-image: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; viewBox=&#39;0 0 8 8&#39;%3e%3cpath fill=&#39;%23fff&#39; d=&#39;M6.564.75l-3.59 3.612-1.538-1.55L0 4.26 2.974 7.25 8 2.193z&#39;/%3e%3c/svg%3e&quot;);</pre>
...
<pre>background-image: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; viewBox=&#39;0 0 4 4&#39;%3e%3cpath stroke=&#39;%23fff&#39; d=&#39;M0 2h4&#39;/%3e%3c/svg%3e&quot;);</pre>
...
<pre>background-image: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; viewBox=&#39;-4 -4 8 8&#39;%3e%3ccircle r=&#39;3&#39; fill=&#39;%23fff&#39;/%3e%3c/svg%3e&quot;);</pre>
...
<pre>padding-left: 2.25rem;</pre>

<p>}</p>

<p>.custom-switch .custom-control-label::before {</p>

<pre>left: -2.25rem;
width: 1.75rem;
pointer-events: all;
border-radius: 0.5rem;</pre>

<p>}</p>

<p>.custom-switch .custom-control-label::after {</p>

<pre>top: calc(0.25rem + 2px);
...
transition: transform 0.15s ease-in-out, background-color 0.15s ease-in-out, border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out, -webkit-transform 0.15s ease-in-out;</pre>

<p>}</p>

<p>@media (prefers-reduced-motion: reduce) {</p>

<pre>.custom-switch .custom-control-label::after {
  transition: none;
}</pre>

<p>}</p>

<p>.custom-switch .custom-control-input:checked ~ .custom-control-label::after
{</p>

<pre>background-color: #fff;
-webkit-transform: translateX(0.75rem);
transform: translateX(0.75rem);</pre>

<p>}</p>

<p>.custom-switch .custom-control-input:disabled:checked ~
.custom-control-label::before {</p>
...
<p>.custom-file-input:disabled ~ .custom-file-label {</p>
...
<p>.custom-file-input ~ .<a href="data-browse">custom-file-label</a>::after {</p>

<pre>content: attr(data-browse);</pre>
...
<p>.custom-range:focus::-webkit-slider-thumb {</p>

<pre>box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(0, 123, 255, 0.25);</pre>

<p>}</p>

<p>.custom-range:focus::-moz-range-thumb {</p>

<pre>box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(0, 123, 255, 0.25);</pre>

<p>}</p>

<p>.custom-range:focus::-ms-thumb {</p>
...
<pre>.custom-range::-webkit-slider-thumb {
  transition: none;
}</pre>
...
<pre>.custom-range::-moz-range-thumb {
  transition: none;
}</pre>
...
<p>.custom-range:disabled::-webkit-slider-thumb {</p>

<pre>background-color: #adb5bd;</pre>

<p>}</p>

<p>.custom-range:disabled::-webkit-slider-runnable-track {</p>

<pre>cursor: default;</pre>

<p>}</p>

<p>.custom-range:disabled::-moz-range-thumb {</p>

<pre>background-color: #adb5bd;</pre>

<p>}</p>

<p>.custom-range:disabled::-moz-range-track {</p>

<pre>cursor: default;</pre>

<p>}</p>

<p>.custom-range:disabled::-ms-thumb {</p>

<pre>background-color: #adb5bd;</pre>

<p>}</p>

<p>.custom-control-label::before, .custom-file-label, .custom-select {</p>

<pre>transition: background-color 0.15s ease-in-out, border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;</pre>

<p>}</p>

<p>@media (prefers-reduced-motion: reduce) {</p>

<pre>.custom-control-label::before,
.custom-file-label,
.custom-select {
  transition: none;
}</pre>
...
<pre>color: #495057;
background-color: #fff;
border-color: #dee2e6 #dee2e6 #fff;</pre>
...
<pre>-ms-flex-preferred-size: 100%;
flex-basis: 100%;
-ms-flex-positive: 1;
flex-grow: 1;
-ms-flex-align: center;
...
<pre>padding-right: 0.5rem;
padding-left: 0.5rem;</pre>

<p>}</p>

<p>.navbar-expand &gt; .container, .navbar-expand &gt; .container-fluid {</p>

<pre>-ms-flex-wrap: nowrap;
flex-wrap: nowrap;</pre>

<p>}</p>

<p>.navbar-expand .navbar-collapse {</p>

<pre>display: -ms-flexbox !important;
display: flex !important;
-ms-flex-preferred-size: auto;
flex-basis: auto;</pre>
...
<pre>background-image: url(&quot;data:image/svg+xml,%3csvg viewBox=&#39;0 0 30 30&#39; xmlns=&#39;http://www.w3.org/2000/svg&#39;%3e%3cpath stroke=&#39;rgba(0, 0, 0, 0.5)&#39; stroke-width=&#39;2&#39; stroke-linecap=&#39;round&#39; stroke-miterlimit=&#39;10&#39; d=&#39;M4 7h22M4 15h22M4 23h22&#39;/%3e%3c/svg%3e&quot;);</pre>
...
<pre>color: rgba(255, 255, 255, 0.5);</pre>
...
<pre>background-image: url(&quot;data:image/svg+xml,%3csvg viewBox=&#39;0 0 30 30&#39; xmlns=&#39;http://www.w3.org/2000/svg&#39;%3e%3cpath stroke=&#39;rgba(255, 255, 255, 0.5)&#39; stroke-width=&#39;2&#39; stroke-linecap=&#39;round&#39; stroke-miterlimit=&#39;10&#39; d=&#39;M4 7h22M4 15h22M4 23h22&#39;/%3e%3c/svg%3e&quot;);</pre>
...
<pre>border-radius: calc(0.25rem - 1px) calc(0.25rem - 1px) 0 0;</pre>
...
<pre>padding: 0.75rem 1.25rem;
background-color: rgba(0, 0, 0, 0.03);
border-top: 1px solid rgba(0, 0, 0, 0.125);</pre>

<p>}</p>

<p>.card-footer:last-child {</p>

<pre>border-radius: 0 0 calc(0.25rem - 1px) calc(0.25rem - 1px);</pre>
...
<pre>width: 100%;
border-radius: calc(0.25rem - 1px);</pre>
...
border-top-right-radius: calc(0.25rem - 1px);</pre>
...
border-bottom-left-radius: calc(0.25rem - 1px);</pre>
...
<p>.accordion &gt; .card .card-header {</p>
...
<p>a.badge-primary:hover, a.badge-primary:focus {</p>
...
<p>a.badge-primary:focus, a.badge-primary.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.5);</pre>
...
<p>a.badge-secondary:hover, a.badge-secondary:focus {</p>
...
<p>a.badge-secondary:focus, a.badge-secondary.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(108, 117, 125, 0.5);</pre>
...
<p>a.badge-success:hover, a.badge-success:focus {</p>
...
<p>a.badge-success:focus, a.badge-success.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(40, 167, 69, 0.5);</pre>
...
<p>a.badge-info:hover, a.badge-info:focus {</p>
...
<p>a.badge-info:focus, a.badge-info.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(23, 162, 184, 0.5);</pre>
...
<p>a.badge-warning:hover, a.badge-warning:focus {</p>
...
<p>a.badge-warning:focus, a.badge-warning.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(255, 193, 7, 0.5);</pre>
...
<p>a.badge-danger:hover, a.badge-danger:focus {</p>
...
<p>a.badge-danger:focus, a.badge-danger.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(220, 53, 69, 0.5);</pre>
...
<p>a.badge-light:hover, a.badge-light:focus {</p>
...
<p>a.badge-light:focus, a.badge-light.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(248, 249, 250, 0.5);</pre>
...
<p>a.badge-dark:hover, a.badge-dark:focus {</p>
...
<p>a.badge-dark:focus, a.badge-dark.focus {</p>

<pre>outline: 0;
box-shadow: 0 0 0 0.2rem rgba(52, 58, 64, 0.5);</pre>
...
<pre>-webkit-animation: progress-bar-stripes 1s linear infinite;
animation: progress-bar-stripes 1s linear infinite;</pre>

<p>}</p>

<p>@media (prefers-reduced-motion: reduce) {</p>

<pre>.progress-bar-animated {
...
<p>.list-group-horizontal .list-group-item {</p>

<pre>margin-right: -1px;
margin-bottom: 0;</pre>

<p>}</p>

<p>.list-group-horizontal .list-group-item:first-child {</p>
...
<p>.list-group-horizontal .list-group-item:last-child {</p>
...
<p>.list-group-flush .list-group-item:last-child {</p>
...
<p>.close:not(:disabled):not(.disabled):hover,
.close:not(:disabled):not(.disabled):focus {</p>
...
background-color: rgba(255, 255, 255, 0.85);
background-clip: padding-box;
border-bottom: 1px solid rgba(0, 0, 0, 0.05);</pre>

<p>}</p>

<p>.toast-body {</p>

<pre>padding: 0.75rem;</pre>
...
<pre>transition: -webkit-transform 0.3s ease-out;
transition: transform 0.3s ease-out;
transition: transform 0.3s ease-out, -webkit-transform 0.3s ease-out;
-webkit-transform: translate(0, -50px);
transform: translate(0, -50px);</pre>
...
<pre>-webkit-transform: none;
transform: none;</pre>

<p>}</p>

<p>.modal-dialog-scrollable {</p>

<pre>display: -ms-flexbox;
display: flex;
max-height: calc(100% - 1rem);</pre>

<p>}</p>

<p>.modal-dialog-scrollable .modal-content {</p>

<pre>max-height: calc(100vh - 1rem);
overflow: hidden;</pre>

<p>}</p>

<p>.modal-dialog-scrollable .modal-header, .modal-dialog-scrollable
.modal-footer {</p>

<pre>-ms-flex-negative: 0;
flex-shrink: 0;</pre>

<p>}</p>

<p>.modal-dialog-scrollable .modal-body {</p>
...
-ms-flex-align: center;
align-items: center;
min-height: calc(100% - 1rem);</pre>

<p>}</p>

<p>.modal-dialog-centered::before {</p>
...
<p>.modal-dialog-centered.modal-dialog-scrollable {</p>
...
<p>.modal-dialog-centered.modal-dialog-scrollable .modal-content {</p>

<pre>max-height: none;</pre>

<p>}</p>

<p>.modal-dialog-centered.modal-dialog-scrollable::before {</p>
...
<p>.bs-popover-top &gt; .arrow, .<a
href="x-placement^="top"">bs-popover-auto</a> &gt; .arrow {</p>
...
<p>.bs-popover-left &gt; .arrow, .<a
href="x-placement^="left"">bs-popover-auto</a> &gt; .arrow {</p>
...
<p>.carousel.pointer-event {</p>

<pre>-ms-touch-action: pan-y;
touch-action: pan-y;</pre>
...
transition: transform 0.6s ease-in-out, -webkit-transform 0.6s ease-in-out;</pre>
...
<p>.carousel-item-next:not(.carousel-item-left), .active.carousel-item-right {</p>

<pre>-webkit-transform: translateX(100%);
transform: translateX(100%);</pre>

<p>}</p>

<p>.carousel-item-prev:not(.carousel-item-right), .active.carousel-item-left {</p>
...
<pre>z-index: 0;
opacity: 0;
transition: 0s 0.6s opacity;</pre>

<p>}</p>

<p>@media (prefers-reduced-motion: reduce) {</p>

<pre>.carousel-fade .active.carousel-item-left,
...
text-align: center;
opacity: 0.5;
transition: opacity 0.15s ease;</pre>

<p>}</p>

<p>@media (prefers-reduced-motion: reduce) {</p>

<pre>.carousel-control-prev,
...
width: 20px;
height: 20px;
background: no-repeat 50% / 100% 100%;</pre>

<p>}</p>

<p>.carousel-control-prev-icon {</p>

<pre>background-image: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; fill=&#39;%23fff&#39; viewBox=&#39;0 0 8 8&#39;%3e%3cpath d=&#39;M5.25 0l-4 4 4 4 1.5-1.5-2.5-2.5 2.5-2.5-1.5-1.5z&#39;/%3e%3c/svg%3e&quot;);</pre>

<p>}</p>

<p>.carousel-control-next-icon {</p>

<pre>background-image: url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;http://www.w3.org/2000/svg&#39; fill=&#39;%23fff&#39; viewBox=&#39;0 0 8 8&#39;%3e%3cpath d=&#39;M2.75 0l-1.5 1.5 2.5 2.5-2.5 2.5 1.5 1.5 4-4-4-4z&#39;/%3e%3c/svg%3e&quot;);</pre>
...
opacity: .5;
transition: opacity 0.6s ease;</pre>
...
<p>@-webkit-keyframes spinner-border {</p>
...
<p>.spinner-border-sm {</p>

<pre>width: 1rem;
height: 1rem;
border-width: 0.2em;</pre>

<p>}</p>

<p>@-webkit-keyframes spinner-grow {</p>
...
animation: spinner-grow .75s linear infinite;</pre>
...
<p>a.bg-primary:hover, a.bg-primary:focus, button.bg-primary:hover,
button.bg-primary:focus {</p>
...
<p>a.bg-success:hover, a.bg-success:focus, button.bg-success:hover,
button.bg-success:focus {</p>
...
<p>a.bg-info:hover, a.bg-info:focus, button.bg-info:hover,
button.bg-info:focus {</p>
...
<p>a.bg-warning:hover, a.bg-warning:focus, button.bg-warning:hover,
button.bg-warning:focus {</p>
...
<p>a.bg-danger:hover, a.bg-danger:focus, button.bg-danger:hover,
button.bg-danger:focus {</p>
...
<pre>background-color: #fff !important;</pre>
...
<pre>border-color: #fff !important;</pre>

<p>}</p>

<p>.rounded-sm {</p>

<pre>border-radius: 0.2rem !important;</pre>
...
<pre>border-radius: 0.3rem !important;</pre>
...
<pre>border-radius: 50rem !important;</pre>
...
<pre>display: -ms-flexbox !important;
display: flex !important;</pre>

<p>}</p>

<p>.d-inline-flex {</p>

<pre>display: -ms-inline-flexbox !important;
display: inline-flex !important;</pre>
...
<pre>-ms-flex-direction: row !important;
flex-direction: row !important;</pre>

<p>}</p>

<p>.flex-column {</p>

<pre>-ms-flex-direction: column !important;
flex-direction: column !important;</pre>

<p>}</p>

<p>.flex-row-reverse {</p>

<pre>-ms-flex-direction: row-reverse !important;
flex-direction: row-reverse !important;</pre>

<p>}</p>

<p>.flex-column-reverse {</p>

<pre>-ms-flex-direction: column-reverse !important;
flex-direction: column-reverse !important;</pre>

<p>}</p>

<p>.flex-wrap {</p>

<pre>-ms-flex-wrap: wrap !important;
flex-wrap: wrap !important;</pre>

<p>}</p>

<p>.flex-nowrap {</p>

<pre>-ms-flex-wrap: nowrap !important;
flex-wrap: nowrap !important;</pre>

<p>}</p>

<p>.flex-wrap-reverse {</p>

<pre>-ms-flex-wrap: wrap-reverse !important;
flex-wrap: wrap-reverse !important;</pre>

<p>}</p>

<p>.flex-fill {</p>

<pre>-ms-flex: 1 1 auto !important;
flex: 1 1 auto !important;</pre>

<p>}</p>

<p>.flex-grow-0 {</p>

<pre>-ms-flex-positive: 0 !important;
flex-grow: 0 !important;</pre>

<p>}</p>

<p>.flex-grow-1 {</p>

<pre>-ms-flex-positive: 1 !important;
flex-grow: 1 !important;</pre>

<p>}</p>

<p>.flex-shrink-0 {</p>

<pre>-ms-flex-negative: 0 !important;
flex-shrink: 0 !important;</pre>

<p>}</p>

<p>.flex-shrink-1 {</p>

<pre>-ms-flex-negative: 1 !important;
flex-shrink: 1 !important;</pre>

<p>}</p>

<p>.justify-content-start {</p>

<pre>-ms-flex-pack: start !important;
justify-content: flex-start !important;</pre>

<p>}</p>

<p>.justify-content-end {</p>

<pre>-ms-flex-pack: end !important;
justify-content: flex-end !important;</pre>

<p>}</p>

<p>.justify-content-center {</p>

<pre>-ms-flex-pack: center !important;
justify-content: center !important;</pre>

<p>}</p>

<p>.justify-content-between {</p>

<pre>-ms-flex-pack: justify !important;
justify-content: space-between !important;</pre>

<p>}</p>

<p>.justify-content-around {</p>

<pre>-ms-flex-pack: distribute !important;
justify-content: space-around !important;</pre>

<p>}</p>

<p>.align-items-start {</p>

<pre>-ms-flex-align: start !important;
align-items: flex-start !important;</pre>

<p>}</p>

<p>.align-items-end {</p>

<pre>-ms-flex-align: end !important;
align-items: flex-end !important;</pre>

<p>}</p>

<p>.align-items-center {</p>

<pre>-ms-flex-align: center !important;
align-items: center !important;</pre>

<p>}</p>

<p>.align-items-baseline {</p>

<pre>-ms-flex-align: baseline !important;
align-items: baseline !important;</pre>

<p>}</p>

<p>.align-items-stretch {</p>

<pre>-ms-flex-align: stretch !important;
align-items: stretch !important;</pre>

<p>}</p>

<p>.align-content-start {</p>

<pre>-ms-flex-line-pack: start !important;
align-content: flex-start !important;</pre>

<p>}</p>

<p>.align-content-end {</p>

<pre>-ms-flex-line-pack: end !important;
align-content: flex-end !important;</pre>

<p>}</p>

<p>.align-content-center {</p>

<pre>-ms-flex-line-pack: center !important;
align-content: center !important;</pre>

<p>}</p>

<p>.align-content-between {</p>

<pre>-ms-flex-line-pack: justify !important;
align-content: space-between !important;</pre>

<p>}</p>

<p>.align-content-around {</p>

<pre>-ms-flex-line-pack: distribute !important;
align-content: space-around !important;</pre>

<p>}</p>

<p>.align-content-stretch {</p>

<pre>-ms-flex-line-pack: stretch !important;
align-content: stretch !important;</pre>

<p>}</p>

<p>.align-self-auto {</p>

<pre>-ms-flex-item-align: auto !important;
align-self: auto !important;</pre>

<p>}</p>

<p>.align-self-start {</p>

<pre>-ms-flex-item-align: start !important;
align-self: flex-start !important;</pre>

<p>}</p>

<p>.align-self-end {</p>

<pre>-ms-flex-item-align: end !important;
align-self: flex-end !important;</pre>

<p>}</p>

<p>.align-self-center {</p>

<pre>-ms-flex-item-align: center !important;
align-self: center !important;</pre>

<p>}</p>

<p>.align-self-baseline {</p>

<pre>-ms-flex-item-align: baseline !important;
align-self: baseline !important;</pre>

<p>}</p>

<p>.align-self-stretch {</p>

<pre>-ms-flex-item-align: stretch !important;
align-self: stretch !important;</pre>
...
<pre>overflow: auto !important;</pre>

<p>}</p>

<p>.overflow-hidden {</p>

<pre>overflow: hidden !important;</pre>
...
<pre>position: -webkit-sticky !important;
position: sticky !important;</pre>
...
<p>@supports ((position: -webkit-sticky) or (position: sticky)) {</p>
...
<pre>min-width: 100vw !important;</pre>

<p>}</p>

<p>.min-vh-100 {</p>

<pre>min-height: 100vh !important;</pre>

<p>}</p>

<p>.vw-100 {</p>

<pre>width: 100vw !important;</pre>

<p>}</p>

<p>.vh-100 {</p>

<pre>height: 100vh !important;</pre>

<p>}</p>

<p>.stretched-<a href="../../../../">:after</a> {</p>
...
pointer-events: auto;
content: &quot;&quot;;
background-color: rgba(0, 0, 0, 0);</pre>
...
<pre>font-family: SFMono-Regular, Menlo, Monaco, Consolas, &quot;Liberation Mono&quot;, &quot;Courier New&quot;, monospace !important;</pre>
...
<pre>white-space: normal !important;</pre>
...
<pre>font-weight: lighter !important;</pre>
...
<pre>font-weight: bolder !important;</pre>
...
<pre>color: #0056b3 !important;</pre>
...
<pre>color: #494f54 !important;</pre>
...
<pre>color: #19692c !important;</pre>
...
<pre>color: #0f6674 !important;</pre>
...
<pre>color: #ba8b00 !important;</pre>
...
<pre>color: #a71d2a !important;</pre>
...
<pre>color: #cbd3da !important;</pre>
...
<pre>color: #121416 !important;</pre>
...
<pre>text-decoration: none !important;</pre>
...
overflow-wrap: break-word !important;</pre>

<p>}</p>

<p>.text-reset {</p>

<pre>color: inherit !important;</pre>
...
<pre class="ruby"><span class="ruby-comment"># sourceMappingURL=bootstrap.css.map</span>
</pre>
</main>
