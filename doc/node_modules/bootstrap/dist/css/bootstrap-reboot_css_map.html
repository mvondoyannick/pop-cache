...
<title>bootstrap-reboot.css.map - RDoc Documentation</title>
...
* Forked from Normalize.css, licensed MIT (<a
href="https://github.com/necolas/normalize.css/blob/master/LICENSE.md)\n">github.com/necolas/normalize.css/blob/master/LICENSE.md)n</a>
nn@import "functions&quot;;n@import "variables&quot;;n@import
"mixins&quot;;n@import "reboot&quot;;n”,“  !n * Bootstrap Reboot v4.3.1 (<a
href="https://getbootstrap.com/)\n">getbootstrap.com/)n</a> * Copyright
2011-2019 The Bootstrap Authorsn * Copyright 2011-2019 Twitter, Inc.n *
Licensed under MIT (<a
href="https://github.com/twbs/bootstrap/blob/master/LICENSE)\n">github.com/twbs/bootstrap/blob/master/LICENSE)n</a>
* Forked from Normalize.css, licensed MIT (<a
href="https://github.com/necolas/normalize.css/blob/master/LICENSE.md)\n">github.com/necolas/normalize.css/blob/master/LICENSE.md)n</a>
n*,n*::before,n*::after {n  box-sizing: border-box;n}nnhtml {n 
...
display: none !important;n}nn/*# sourceMappingURL=bootstrap-reboot.css.map
*/”,“// stylelint-disable at-rule-no-vendor-prefix,
declaration-no-important, selector-no-qualifying-type,
property-no-vendor-prefixnn// Rebootn//n// Normalization of HTML elements,
manually forked from Normalize.css to removen// styles targeting irrelevant
browsers while applying new styles.n//n// Normalize is licensed MIT. <a
...
display: none !important;n}n”,“// Variablesn//n// Variables should follow
the `$component-state-property-size` formula forn// consistent naming. Ex:
$nav-link-disabled-color and $modal-content-box-shadow-xs.nn// Color
systemnn$white:    fff !default;n$gray-100: f8f9fa !default;n$gray-200:
e9ecef !default;n$gray-300: dee2e6 !default;n$gray-400: ced4da
!default;n$gray-500: adb5bd !default;n$gray-600: #6c757d
!default;n$gray-700: #495057 !default;n$gray-800: #343a40
!default;n$gray-900: #212529 !default;n$black:    #000 !default;nn$grays:
() !default;n// stylelint-disable-next-line
scss/dollar-variable-defaultn$grays: map-merge(n  (n    "100&quot;:
$gray-100,n    "200&quot;: $gray-200,n    "300&quot;: $gray-300,n   
"400&quot;: $gray-400,n    "500&quot;: $gray-500,n    "600&quot;:
$gray-600,n    "700&quot;: $gray-700,n    "800&quot;: $gray-800,n   
"900&quot;: $gray-900n  ),n  $graysn);nn$blue:    #007bff
!default;n$indigo:  #6610f2 !default;n$purple:  #6f42c1 !default;n$pink:   
e83e8c !default;n$red:     dc3545 !default;n$orange:  fd7e14
!default;n$yellow:  ffc107 !default;n$green:   #28a745 !default;n$teal:   
#20c997 !default;n$cyan:    #17a2b8 !default;nn$colors: () !default;n//
stylelint-disable-next-line scss/dollar-variable-defaultn$colors:
map-merge(n  (n    "blue&quot;:       $blue,n    "indigo&quot;:    
$indigo,n    "purple&quot;:     $purple,n    "pink&quot;:       $pink,n   
"red&quot;:        $red,n    "orange&quot;:     $orange,n    "yellow&quot;:
$yellow,n    "green&quot;:      $green,n    "teal&quot;:       $teal,n   
"cyan&quot;:       $cyan,n    "white&quot;:      $white,n    "gray&quot;:  
$gray-600,n    "gray-dark&quot;:  $gray-800n  ),n  $colorsn);nn$primary:   
$blue !default;n$secondary:     $gray-600 !default;n$success:       $green
!default;n$info:          $cyan !default;n$warning:       $yellow
!default;n$danger:        $red !default;n$light:         $gray-100
!default;n$dark:          $gray-800 !default;nn$theme-colors: ()
!default;n// stylelint-disable-next-line
scss/dollar-variable-defaultn$theme-colors: map-merge(n  (n   
"primary&quot;:    $primary,n    "secondary&quot;:  $secondary,n   
"success&quot;:    $success,n    "info&quot;:       $info,n   
"warning&quot;:    $warning,n    "danger&quot;:     $danger,n   
"light&quot;:      $light,n    "dark&quot;:       $darkn  ),n 
$theme-colorsn);nn// Set a specific jump point for requesting color
jumpsn$theme-color-interval:      8% !default;nn// The yiq lightness value
that determines when the lightness of color changes from "dark&quot; to
"light&quot;. Acceptable values are between 0 and
255.n$yiq-contrasted-threshold:  150 !default;nn// Customize the light and
dark text colors for use in our YIQ color contrast
function.n$yiq-text-dark:             $gray-900 !default;n$yiq-text-light: 
$white !default;nnn// Optionsn//n// Quickly modify global styling by
enabling or disabling optional features.nn$enable-caret:                   
true !default;n$enable-rounded:                              true
!default;n$enable-shadows:                              false
!default;n$enable-gradients:                            false
!default;n$enable-transitions:                          true
!default;n$enable-prefers-reduced-motion-media-query:   true
!default;n$enable-hover-media-query:                    false !default; //
Deprecated, no longer affects any compiled CSSn$enable-grid-classes:       
true !default;n$enable-pointer-cursor-for-buttons:           true
!default;n$enable-print-styles:                         true
!default;n$enable-responsive-font-sizes:                false
!default;n$enable-validation-icons:                     true
!default;n$enable-deprecation-messages:                 true !default;nnn//
Spacingn//n// Control the default styling of most Bootstrap elements by
modifying thesen// variables. Mostly focused on spacing.n// You can add
more entries to the $spacers map, should you need more variation.nn$spacer:
1rem !default;n$spacers: () !default;n// stylelint-disable-next-line
scss/dollar-variable-defaultn$spacers: map-merge(n  (n    0: 0,n    1:
($spacer * .25),n    2: ($spacer * .5),n    3: $spacer,n    4: ($spacer *
1.5),n    5: ($spacer * 3)n  ),n  $spacersn);nn// This variable affects the
`.h-*` and `.w-*` classes.n$sizes: () !default;n//
stylelint-disable-next-line scss/dollar-variable-defaultn$sizes:
map-merge(n  (n    25: 25%,n    50: 50%,n    75: 75%,n    100: 100%,n   
auto: auton  ),n  $sizesn);nnn// Bodyn//n// Settings for the `&lt;body&gt;`
element.nn$body-bg:                   $white !default;n$body-color:        
$gray-900 !default;nnn// Linksn//n// Style anchor elements.nn$link-color:  
theme-color(&quot;primary&quot;) !default;n$link-decoration:               
none !default;n$link-hover-color:                       
darken($link-color, 15%) !default;n$link-hover-decoration:                 
underline !default;n// Darken percentage for links with `.text-*` class
(e.g. `.text-success`)n$emphasized-link-hover-darken-percentage: 15%
!default;nn// Paragraphsn//n// Style p element.nn$paragraph-margin-bottom: 
1rem !default;nnn// Grid breakpointsn//n// Define the minimum dimensions at
...
_assert-starts-at-zero($grid-breakpoints, "$grid-breakpoints&quot;);nnn//
Grid containersn//n// Define the maximum width of `.container` for
different screen sizes.nn$container-max-widths: (n  sm: 540px,n  md:
720px,n  lg: 960px,n  xl: 1140pxn) !default;nn@include
...
12 !default;n$grid-gutter-width:           30px !default;nnn//
...
.2rem !default;nn$rounded-pill:                50rem
!default;nn$box-shadow-sm:               0 .125rem .25rem rgba($black,
.075) !default;n$box-shadow:                  0 .5rem 1rem rgba($black,
.15) !default;n$box-shadow-lg:               0 1rem 3rem rgba($black, .175)
!default;nn$component-active-color:      $white
!default;n$component-active-bg:         theme-color(&quot;primary&quot;)
!default;nn$caret-width:                 .3em
!default;n$caret-vertical-align:        $caret-width * .85
!default;n$caret-spacing:               $caret-width * .85
!default;nn$transition-base:             all .2s ease-in-out
!default;n$transition-fade:             opacity .15s linear
!default;n$transition-collapse:         height .35s ease
!default;nn$embed-responsive-aspect-ratios: () !default;n//
stylelint-disable-next-line
scss/dollar-variable-defaultn$embed-responsive-aspect-ratios: join(n  (n   
(21 9),n    (16 9),n    (4 3),n    (1 1),n  ),n 
$embed-responsive-aspect-ratiosn);nn// Typographyn//n// Font, line-height,
and color for body text, headings, and more.nn// stylelint-disable
value-keyword-casen$font-family-sans-serif:      -apple-system,
BlinkMacSystemFont, "Segoe UI&quot;, Roboto, "Helvetica Neue&quot;, Arial,
"Noto Sans&quot;, sans-serif, "Apple Color Emoji&quot;, "Segoe UI
Emoji&quot;, "Segoe UI Symbol&quot;, "Noto Color Emoji&quot;
!default;n$font-family-monospace:       SFMono-Regular, Menlo, Monaco,
...
!default;nn$font-weight-lighter:         lighter
!default;n$font-weight-light:           300 !default;n$font-weight-normal: 
400 !default;n$font-weight-bold:            700
!default;n$font-weight-bolder:          bolder
...
!default;n$blockquote-small-font-size:  $small-font-size
...
!default;n$table-cell-padding-sm:       .3rem !default;nn$table-color:     
$body-color !default;n$table-bg:                    null
!default;n$table-accent-bg:             rgba($black, .05)
!default;n$table-hover-color:           $table-color
...
!default;n$table-border-color:          $border-color
!default;nn$table-head-bg:               $gray-200
!default;n$table-head-color:            $gray-700
!default;nn$table-dark-color:            $white !default;n$table-dark-bg:  
$gray-800 !default;n$table-dark-accent-bg:        rgba($white, .05)
!default;n$table-dark-hover-color:      $table-dark-color
!default;n$table-dark-hover-bg:         rgba($white, .075)
!default;n$table-dark-border-color:     lighten($table-dark-bg, 7.5%)
!default;n$table-dark-color:            $white
!default;nn$table-striped-order:         odd
!default;nn$table-caption-color:         $text-muted
!default;nn$table-bg-level:              -9 !default;n$table-border-level: 
-6 !default;nnn// Buttons + Formsn//n// Shared variables that are
reassigned to `$input-` and `$btn-` specific
variables.nn$input-btn-padding-y:         .375rem
!default;n$input-btn-padding-x:         .75rem
!default;n$input-btn-font-family:       null
!default;n$input-btn-font-size:         $font-size-base
...
!default;n$input-btn-font-size-sm:      $font-size-sm
...
!default;n$input-btn-font-size-lg:      $font-size-lg
...
!default;n$btn-font-family:             $input-btn-font-family
!default;n$btn-font-size:               $input-btn-font-size
...
!default;n$btn-font-size-sm:            $input-btn-font-size-sm
...
!default;n$btn-font-size-lg:            $input-btn-font-size-lg
...
$input-btn-padding-x !default;n$input-font-family:                    
$input-btn-font-family !default;n$input-font-size:                      
$input-btn-font-size !default;n$input-font-weight:                    
$font-weight-base !default;n$input-line-height:                    
$input-btn-line-height !default;nn$input-padding-y-sm:                   
$input-btn-padding-y-sm !default;n$input-padding-x-sm:                   
$input-btn-padding-x-sm !default;n$input-font-size-sm:                   
$input-btn-font-size-sm !default;n$input-line-height-sm:                 
$input-btn-line-height-sm !default;nn$input-padding-y-lg:                  
$input-btn-padding-y-lg !default;n$input-padding-x-lg:                   
$input-btn-padding-x-lg !default;n$input-font-size-lg:                   
$input-btn-font-size-lg !default;n$input-line-height-lg:                 
...
!default;nn$input-height-inner:                   
calc(#{$input-line-height * 1em} + #{$input-padding-y * 2})
!default;n$input-height-inner-half:               calc(#{$input-line-height
* .5em} + #{$input-padding-y}) !default;n$input-height-inner-quarter:      
calc(#{$input-line-height * .25em} + #{$input-padding-y / 2})
!default;nn$input-height:                         
calc(#{$input-line-height * 1em} + #{$input-padding-y * 2} +
#{$input-height-border}) !default;n$input-height-sm:                      
calc(#{$input-line-height-sm * 1em} + #{$input-btn-padding-y-sm * 2} +
#{$input-height-border}) !default;n$input-height-lg:                      
calc(#{$input-line-height-lg * 1em} + #{$input-btn-padding-y-lg * 2} +
#{$input-height-border}) !default;nn$input-transition:                     
border-color .15s ease-in-out, box-shadow .15s ease-in-out
!default;nn$form-text-margin-top:                  .25rem
!default;nn$form-check-input-gutter:               1.25rem
...
!default;nn$form-grid-gutter-width:                10px
!default;n$form-group-margin-bottom:              1rem
...
!default;nn$custom-forms-transition:               background-color .15s
ease-in-out, border-color .15s ease-in-out, box-shadow .15s ease-in-out
!default;nn$custom-control-gutter:                 .5rem
!default;n$custom-control-spacer-x:               1rem
!default;nn$custom-control-indicator-size:         1rem
!default;n$custom-control-indicator-bg:           $input-bg
!default;nn$custom-control-indicator-bg-size:      50% 50%
!default;n$custom-control-indicator-box-shadow:   $input-box-shadow
!default;n$custom-control-indicator-border-color: $gray-500
!default;n$custom-control-indicator-border-width: $input-border-width
!default;nn$custom-control-indicator-disabled-bg:         
$input-disabled-bg !default;n$custom-control-label-disabled-color:         
...
!default;n$custom-control-indicator-checked-border-color:
$custom-control-indicator-checked-bg
!default;nn$custom-control-indicator-focus-box-shadow:    
$input-focus-box-shadow
!default;n$custom-control-indicator-focus-border-color:  
...
!default;n$custom-control-indicator-active-border-color: 
...
str-replace(url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;<a
...
!default;n$custom-checkbox-indicator-indeterminate-border-color:
...
"#&quot;, "%23&quot;) !default;nn$custom-switch-width:                     
$custom-control-indicator-size * 1.75
!default;n$custom-switch-indicator-border-radius:        
$custom-control-indicator-size / 2 !default;n$custom-switch-indicator-size:
calc(#{$custom-control-indicator-size} -
#{$custom-control-indicator-border-width * 4})
!default;nn$custom-select-padding-y:           $input-padding-y
!default;n$custom-select-padding-x:           $input-padding-x
!default;n$custom-select-font-family:         $input-font-family
!default;n$custom-select-font-size:           $input-font-size
...
indicatorn$custom-select-font-weight:         $input-font-weight
!default;n$custom-select-line-height:         $input-line-height
...
!default;n$custom-select-background:          $custom-select-indicator
no-repeat right $custom-select-padding-x center / $custom-select-bg-size
!default; // Used so we can have multiple background elements (e.g., arrow
and feedback icon)nn$custom-select-feedback-icon-padding-right: calc((1em +
#{2 * $custom-select-padding-y}) * 3 / 4 + #{$custom-select-padding-x +
$custom-select-indicator-padding})
!default;n$custom-select-feedback-icon-position:      center right
($custom-select-padding-x + $custom-select-indicator-padding)
!default;n$custom-select-feedback-icon-size:         
$input-height-inner-half $input-height-inner-half
!default;nn$custom-select-border-width:        $input-border-width
!default;n$custom-select-border-color:        $input-border-color
!default;n$custom-select-border-radius:       $border-radius
!default;n$custom-select-box-shadow:          inset 0 1px 2px rgba($black,
.075) !default;nn$custom-select-focus-border-color: 
$input-focus-border-color !default;n$custom-select-focus-width:        
$input-focus-width !default;n$custom-select-focus-box-shadow:    0 0 0
$custom-select-focus-width $input-btn-focus-color
!default;nn$custom-select-padding-y-sm:        $input-padding-y-sm
!default;n$custom-select-padding-x-sm:        $input-padding-x-sm
!default;n$custom-select-font-size-sm:        $input-font-size-sm
!default;n$custom-select-height-sm:           $input-height-sm
!default;nn$custom-select-padding-y-lg:        $input-padding-y-lg
!default;n$custom-select-padding-x-lg:        $input-padding-x-lg
!default;n$custom-select-font-size-lg:        $input-font-size-lg
...
rgba($black, .1) !default;nn$custom-range-thumb-width:                  
1rem !default;n$custom-range-thumb-height:                 
$custom-range-thumb-width !default;n$custom-range-thumb-bg:                
$component-active-bg !default;n$custom-range-thumb-border:                 
0 !default;n$custom-range-thumb-border-radius:           1rem
!default;n$custom-range-thumb-box-shadow:              0 .1rem .25rem
rgba($black, .1) !default;n$custom-range-thumb-focus-box-shadow:        0 0
0 1px $body-bg, $input-focus-box-shadow
!default;n$custom-range-thumb-focus-box-shadow-width:  $input-focus-width
!default; // For focus box shadow issue in
IE/Edgen$custom-range-thumb-active-bg:              
lighten($component-active-bg, 35%)
!default;n$custom-range-thumb-disabled-bg:             $gray-500
!default;nn$custom-file-height:                $input-height
!default;n$custom-file-height-inner:          $input-height-inner
!default;n$custom-file-focus-border-color:    $input-focus-border-color
!default;n$custom-file-focus-box-shadow:      $input-focus-box-shadow
!default;n$custom-file-disabled-bg:           $input-disabled-bg
!default;nn$custom-file-padding-y:             $input-padding-y
!default;n$custom-file-padding-x:             $input-padding-x
!default;n$custom-file-line-height:           $input-line-height
!default;n$custom-file-font-family:           $input-font-family
!default;n$custom-file-font-weight:           $input-font-weight
!default;n$custom-file-color:                 $input-color
!default;n$custom-file-bg:                    $input-bg
!default;n$custom-file-border-width:          $input-border-width
...
validationnn$form-feedback-margin-top:          $form-text-margin-top
...
theme-color(&quot;danger&quot;) !default;nn$form-feedback-icon-valid-color:
$form-feedback-valid-color !default;n$form-feedback-icon-valid:         
str-replace(url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;<a
href="http://www.w3.org/2000/svg">www.w3.org/2000/svg</a>&#39;
viewBox=&#39;0 0 8 8&#39;%3e%3cpath
fill=&#39;#{$form-feedback-icon-valid-color}&#39; d=&#39;M2.3 6.73L.6
4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4
4.6c-.43.5-.8.4-1.1.1z&#39;/%3e%3c/svg%3e&quot;), "#&quot;, "%23&quot;)
!default;n$form-feedback-icon-invalid-color:  $form-feedback-invalid-color
!default;n$form-feedback-icon-invalid:       
str-replace(url(&quot;data:image/svg+xml,%3csvg xmlns=&#39;<a
href="http://www.w3.org/2000/svg">www.w3.org/2000/svg</a>&#39;
fill=&#39;#{$form-feedback-icon-invalid-color}&#39; viewBox=&#39;-2 -2 7
7&#39;%3e%3cpath stroke=&#39;#{$form-feedback-icon-invalid-color}&#39;
d=&#39;M0 0l3 3m0-3L0 3&#39;/%3e%3ccircle r=&#39;.5&#39;/%3e%3ccircle
cx=&#39;3&#39; r=&#39;.5&#39;/%3e%3ccircle cy=&#39;3&#39;
r=&#39;.5&#39;/%3e%3ccircle cx=&#39;3&#39; cy=&#39;3&#39;
r=&#39;.5&#39;/%3e%3c/svg%3E&quot;), "#&quot;, "%23&quot;)
!default;nn$form-validation-states: () !default;n//
stylelint-disable-next-line
scss/dollar-variable-defaultn$form-validation-states: map-merge(n  (n   
"valid&quot;: (n      "color&quot;: $form-feedback-valid-color,n     
"icon&quot;: $form-feedback-icon-validn    ),n    "invalid&quot;: (n     
"color&quot;: $form-feedback-invalid-color,n      "icon&quot;:
$form-feedback-icon-invalidn    ),n  ),n  $form-validation-statesn);nn//
...
!default;n$zindex-tooltip:                    1070 !default;nnn//
...
!default;nnn// Navbarnn$navbar-padding-y:                  $spacer / 2
...
str-replace(url(&quot;data:image/svg+xml,%3csvg viewBox=&#39;0 0 30 30&#39;
xmlns=&#39;<a
...
!default;nn$navbar-light-brand-color:               
$navbar-light-active-color !default;n$navbar-light-brand-hover-color:      
$navbar-light-active-color !default;n$navbar-dark-brand-color:             
$navbar-dark-active-color !default;n$navbar-dark-brand-hover-color:        
$navbar-dark-active-color !default;nnn// Dropdownsn//n// Dropdown menu
container and contents.nn$dropdown-min-width:                10rem
!default;n$dropdown-padding-y:                .5rem
!default;n$dropdown-spacer:                   .125rem
!default;n$dropdown-font-size:                $font-size-base
!default;n$dropdown-color:                    $body-color
...
!default;n$dropdown-inner-border-radius:     
calc(#{$dropdown-border-radius} - #{$dropdown-border-width})
!default;n$dropdown-divider-bg:               $gray-200
!default;n$dropdown-divider-margin-y:         $nav-divider-margin-y
...
Paginationnn$pagination-padding-y:              .5rem
...
!default;n$jumbotron-color:                   null !default;n$jumbotron-bg:
$gray-200 !default;nnn// Cardsnn$card-spacer-y:                     .75rem
!default;n$card-spacer-x:                     1.25rem
!default;n$card-border-width:                 $border-width
...
rgba($black, .03) !default;n$card-cap-color:                    null
!default;n$card-color:                        null !default;n$card-bg:     
$white !default;nn$card-img-overlay-padding:          1.25rem
...
!default;n$tooltip-arrow-color:               $tooltip-bg !default;nn//
Form tooltips must come after regular
tooltipsn$form-feedback-tooltip-padding-y:     $tooltip-padding-y
!default;n$form-feedback-tooltip-padding-x:     $tooltip-padding-x
!default;n$form-feedback-tooltip-font-size:     $tooltip-font-size
!default;n$form-feedback-tooltip-line-height:   $line-height-base
!default;n$form-feedback-tooltip-opacity:       $tooltip-opacity
!default;n$form-feedback-tooltip-border-radius: $tooltip-border-radius
!default;nnn// Popoversnn$popover-font-size:                 $font-size-sm
...
Toastsnn$toast-max-width:                   350px
!default;n$toast-padding-x:                   .75rem
!default;n$toast-padding-y:                   .25rem
!default;n$toast-font-size:                   .875rem
!default;n$toast-color:                       null
!default;n$toast-background-color:            rgba($white, .85)
!default;n$toast-border-width:                1px
!default;n$toast-border-color:                rgba(0, 0, 0, .1)
!default;n$toast-border-radius:               .25rem
!default;n$toast-box-shadow:                  0 .25rem .75rem rgba($black,
.1) !default;nn$toast-header-color:                $gray-600
!default;n$toast-header-background-color:     rgba($white, .85)
!default;n$toast-header-border-color:         rgba(0, 0, 0, .05)
!default;nnn// Badgesnn$badge-font-size:                   75%
...
!default;nn$badge-transition:                  $btn-transition
!default;n$badge-focus-width:                 $input-btn-focus-width
...
!default;nn$modal-content-color:               null
!default;n$modal-content-bg:                  $white
...
!default;n$modal-header-border-color:         $border-color
...
!default;n$modal-header-padding-y:            1rem
!default;n$modal-header-padding-x:            1rem
!default;n$modal-header-padding:              $modal-header-padding-y
$modal-header-padding-x !default; // Keep this for backwards
compatibilitynn$modal-xl:                          1140px
!default;n$modal-lg:                          800px !default;n$modal-md:   
500px !default;n$modal-sm:                          300px
!default;nn$modal-fade-transform:              translate(0, -50px)
!default;n$modal-show-transform:              none
!default;n$modal-transition:                  transform .3s ease-out
...
ease !default;nnn// List groupnn$list-group-color:                  null
!default;n$list-group-bg:                     $white
...
!default;n$carousel-control-hover-opacity:     .9
!default;n$carousel-control-transition:        opacity .15s ease
!default;nn$carousel-indicator-width:           30px
!default;n$carousel-indicator-height:          3px
!default;n$carousel-indicator-hit-area-height: 10px
!default;n$carousel-indicator-spacer:          3px
!default;n$carousel-indicator-active-bg:       $white
!default;n$carousel-indicator-transition:      opacity .6s ease
...
!default;nn$carousel-transition-duration:       .6s
!default;n$carousel-transition:                transform
$carousel-transition-duration ease-in-out !default; // Define transform
transition first if using multiple transitions (e.g., `transform 2s ease,
opacity .5s ease-out`)nnn// Spinnersnn$spinner-width:         2rem
!default;n$spinner-height:        $spinner-width
!default;n$spinner-border-width:  .25em !default;nn$spinner-width-sm:      
1rem !default;n$spinner-height-sm:       $spinner-width-sm
!default;n$spinner-border-width-sm: .2em !default;nnn//
Closenn$close-font-size:                   $font-size-base * 1.5
!default;n$close-font-weight:                 $font-weight-bold
!default;n$close-color:                       $black
!default;n$close-text-shadow:                 0 1px 0 $white !default;nnn//
...
Utilitiesnn$displays: none, inline, inline-block, block, table, table-row,
table-cell, flex, inline-flex !default;n$overflows: auto, hidden
!default;n$positions: static, relative, absolute, fixed, sticky
!default;nnn// Printingnn$print-page-size:                   a3
!default;n$print-body-min-width:              map-get($grid-breakpoints,
"lg&quot;) !default;n”,“// stylelint-disable property-blacklist,
scss/dollar-variable-defaultnn// SCSS RFS mixinn//n// Automated
font-resizingn//n// See <a
...
@include rfs($fs, $important);n}n”,“// Hover mixin and
...
{n  &amp;:hover,n  &amp;:focus,n  &amp;:active {n    @content;n  }n}n”]}</p>
</main>
