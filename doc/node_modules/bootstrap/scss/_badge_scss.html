...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_badge.scss">

<p>// Base class // // Requires one of the contextual, color modifier classes
for `color` and // `background-color`.</p>
...
<p>// Quick fix for badges in buttons .btn .badge {</p>
...
<p>// Pill badges // // Make them extra rounded with a modifier to replace
v3&#39;s badges.</p>

<p>.badge-pill {</p>

<pre>padding-right: $badge-pill-padding-x;
padding-left: $badge-pill-padding-x;
@include border-radius($badge-pill-border-radius);</pre>

<p>}</p>

<p>// Colors // // Contextual variations (linked badges get darker on :hover).</p>
