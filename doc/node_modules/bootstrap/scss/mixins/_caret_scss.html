...
<title>_caret.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_caret.scss">

<p>@mixin caret-down {</p>

<pre>border-top: $caret-width solid;
border-right: $caret-width solid transparent;
border-bottom: 0;
border-left: $caret-width solid transparent;</pre>
...
<p>@mixin caret-right {</p>

<pre>border-top: $caret-width solid transparent;
border-right: 0;
border-bottom: $caret-width solid transparent;
border-left: $caret-width solid;</pre>

<p>}</p>

<p>@mixin caret-left {</p>

<pre>border-top: $caret-width solid transparent;
border-right: $caret-width solid;
border-bottom: $caret-width solid transparent;</pre>

<p>}</p>

<p>@mixin caret($direction: down) {</p>
