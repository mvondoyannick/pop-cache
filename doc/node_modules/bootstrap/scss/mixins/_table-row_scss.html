...
<title>_table-row.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_table-row.scss">

<p>// Tables</p>

<p>@mixin table-row-variant($state, $background, $border: null) {</p>

<pre>// Exact selectors below required to override `.table-striped` and prevent
