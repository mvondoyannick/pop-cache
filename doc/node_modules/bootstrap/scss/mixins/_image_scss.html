...
<title>_image.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_image.scss">

<p>// Image Mixins // - Responsive image // - Retina image</p>

<p>// Responsive image // // Keep images from scaling beyond the width of
their parents.</p>

<p>@mixin img-fluid {</p>

<pre>// Part 1: Set a maximum relative to the parent
max-width: 100%;
...
<p>// Retina image // // Short retina mixin for setting background-image and
-size.</p>

<p>@mixin img-retina($file-1x, $file-2x, $width-1x, $height-1x) {</p>

<pre>background-image: url($file-1x);
...
@include deprecate(&quot;`img-retina()`&quot;, &quot;v4.3.0&quot;, &quot;v5&quot;);</pre>
