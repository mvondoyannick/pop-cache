...
<title>_text-hide.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_text-hide.scss">

<p>// CSS image replacement @mixin text-hide($ignore-warning: false) {</p>

<pre>// stylelint-disable-next-line font-family-no-missing-generic-family-keyword
font: 0/0 a;
color: transparent;
text-shadow: none;
...
@include deprecate(&quot;`text-hide()`&quot;, &quot;v4.1.0&quot;, &quot;v5&quot;, $ignore-warning);</pre>
