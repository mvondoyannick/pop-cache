...
<title>_transition.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_transition.scss">

<p>// stylelint-disable property-blacklist @mixin transition($transition…) {</p>

<pre>@if $enable-transitions {
