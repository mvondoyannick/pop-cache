...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_list-group.scss">

<p>// List Groups</p>

<p>@mixin list-group-item-variant($state, $background, $color) {</p>

<pre>.list-group-item-#{$state} {
  color: $color;
