...
<title>_resize.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_resize.scss">

<p>// Resize anything</p>

<p>@mixin resizable($direction) {</p>

<pre>overflow: auto; // Per CSS3 UI, `resize` only applies when `overflow` isn&#39;t `visible`
resize: $direction; // Options: horizontal, vertical, both</pre>
