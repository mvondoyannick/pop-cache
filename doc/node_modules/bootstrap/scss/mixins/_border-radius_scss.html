...
<title>_border-radius.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_border-radius.scss">

<p>// stylelint-disable property-blacklist // Single side border-radius</p>

<p>@mixin border-radius($radius: $border-radius, $fallback-border-radius:
false) {</p>
...
<p>@mixin border-top-radius($radius) {</p>
...
<p>@mixin border-right-radius($radius) {</p>
...
<p>@mixin border-bottom-radius($radius) {</p>
...
<p>@mixin border-left-radius($radius) {</p>
...
<p>@mixin border-top-left-radius($radius) {</p>
...
<p>@mixin border-top-right-radius($radius) {</p>
...
<p>@mixin border-bottom-right-radius($radius) {</p>
...
<p>@mixin border-bottom-left-radius($radius) {</p>
