...
<title>_nav-divider.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_nav-divider.scss">

<p>// Horizontal dividers // // Dividers (basically an hr) within dropdowns
and nav lists</p>

<p>@mixin nav-divider($color: $nav-divider-color, $margin-y:
$nav-divider-margin-y) {</p>

<pre>height: 0;
margin: $margin-y 0;
overflow: hidden;
border-top: 1px solid $color;</pre>
