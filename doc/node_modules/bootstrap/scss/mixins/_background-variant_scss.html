...
<title>_background-variant.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_background-variant.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>// Contextual backgrounds</p>

<p>@mixin bg-variant($parent, $color) {</p>
...
<p>@mixin bg-gradient-variant($parent, $color) {</p>
