...
<title>_box-shadow.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/mixins/_box-shadow.scss">

<p>@mixin box-shadow($shadow…) {</p>

<pre>@if $enable-shadows {
  $result: ();
