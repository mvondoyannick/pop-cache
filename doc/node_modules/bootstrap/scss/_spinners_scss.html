...
<title>_spinners.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_spinners.scss">

<p>// // Rotating border //</p>

<p>@keyframes spinner-border {</p>

<pre>to { transform: rotate(360deg); }</pre>
...
<pre>width: $spinner-width-sm;
height: $spinner-height-sm;
border-width: $spinner-border-width-sm;</pre>
