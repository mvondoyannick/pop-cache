...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_grid.scss">

<p>// Container widths // // Set the container width, and override it for
fixed navbars in media queries.</p>

<p>@if $enable-grid-classes {</p>
...
<p>// Fluid container // // Utilizes the mixin meant for fixed width
containers, but with 100% width for // fluid, full width layouts.</p>
...
<p>// Row // // Rows contain and clear the floats of your columns.</p>
...
<p>// Columns // // Common styles for small and large grid columns</p>

<p>@if $enable-grid-classes {</p>

<pre>@include make-grid-columns();</pre>
