...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_progress.scss">

<p>// Disable animation if transitions are disabled @if $enable-transitions {</p>

<pre>@keyframes progress-bar-stripes {
...
@include box-shadow($progress-box-shadow);</pre>
...
@include transition($progress-bar-transition);</pre>

<p>}</p>

<p>.progress-bar-striped {</p>

<pre>@include gradient-striped();
background-size: $progress-height $progress-height;</pre>

<p>}</p>

<p>@if $enable-transitions {</p>
