...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_card.scss">
...
<pre>// Enable `flex-grow: 1` for decks and groups so that card blocks take up
// as much space as possible, ensuring footers are aligned to the bottom.
flex: 1 1 auto;
padding: $card-spacer-x;
color: $card-color;</pre>

<p>}</p>

<p>.card-title {</p>

<pre>margin-bottom: $card-spacer-y;</pre>

<p>}</p>

<p>.card-subtitle {</p>

<pre>margin-top: -$card-spacer-y / 2;
margin-bottom: 0;</pre>
...
<p>// // Optional textual caps //</p>

<p>.card-header {</p>

<pre>padding: $card-spacer-y $card-spacer-x;
...
<pre>margin-right: -$card-spacer-x / 2;
...
<pre>margin-right: -$card-spacer-x / 2;
margin-left: -$card-spacer-x / 2;</pre>

<p>}</p>

<p>// Card image .card-img-overlay {</p>
...
bottom: 0;
left: 0;
padding: $card-img-overlay-padding;</pre>

<p>}</p>

<p>.card-img {</p>

<pre>width: 100%; // Required because we use flexbox and this inherently applies align-self: stretch
@include border-radius($card-inner-border-radius);</pre>

<p>}</p>

<p>// Card image caps .card-img-top {</p>

<pre>width: 100%; // Required because we use flexbox and this inherently applies align-self: stretch
@include border-top-radius($card-inner-border-radius);</pre>
...
<pre>width: 100%; // Required because we use flexbox and this inherently applies align-self: stretch
@include border-bottom-radius($card-inner-border-radius);</pre>
