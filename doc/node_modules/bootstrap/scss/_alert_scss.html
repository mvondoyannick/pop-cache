...
<title>_alert.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_alert.scss">
...
@include border-radius($alert-border-radius);</pre>

<p>}</p>

<p>// Headings for larger alerts .alert-heading {</p>

<pre>// Specified to prevent conflicts of changing $headings-color
color: inherit;</pre>

<p>}</p>

<p>// Provide class for links that match alerts .alert-link {</p>

<pre>font-weight: $alert-link-font-weight;</pre>

<p>}</p>

<p>// Dismissible alerts // // Expand the right padding and account for the
close button&#39;s positioning.</p>

<p>.alert-dismissible {</p>

<pre>padding-right: $close-font-size + $alert-padding-x * 2;
...
<p>// Alternate styles // // Generate contextual modifier classes for
colorizing the alert.</p>
