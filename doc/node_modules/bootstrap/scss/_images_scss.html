...
<title>_images.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_images.scss">

<p>// Responsive images (ensure images don&#39;t scale beyond their parents)
// // This is purposefully opt-in via an explicit class rather than being
the default for all `&lt;img&gt;`s. // We previously tried the “images are
responsive by default” approach in Bootstrap v2, // and abandoned it in
Bootstrap v3 because it breaks lots of third-party widgets (including
Google Maps) // which weren&#39;t expecting the images within themselves to
be involuntarily resized. // See also <a
href="https://github.com/twbs/bootstrap/issues/18178">github.com/twbs/bootstrap/issues/18178</a>
.img-fluid {</p>

<pre>@include img-fluid;</pre>

<p>}</p>

<p>// Image thumbnails .img-thumbnail {</p>

<pre>padding: $thumbnail-padding;
...
<pre>// Ensures the caption&#39;s text aligns with the image.
...
<pre>@include font-size($figure-caption-font-size);
color: $figure-caption-color;</pre>
