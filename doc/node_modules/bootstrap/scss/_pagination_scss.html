...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_pagination.scss">
...
<pre>@include pagination-size($pagination-padding-y-lg, $pagination-padding-x-lg, $font-size-lg, $line-height-lg, $border-radius-lg);</pre>

<p>}</p>

<p>.pagination-sm {</p>

<pre>@include pagination-size($pagination-padding-y-sm, $pagination-padding-x-sm, $font-size-sm, $line-height-sm, $border-radius-sm);</pre>
