...
<title>_root.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_root.scss">

<p>:root {</p>

<pre>// Custom variable values only support SassScript inside `#{}`.
...
--font-family-monospace: #{inspect($font-family-monospace)};</pre>
