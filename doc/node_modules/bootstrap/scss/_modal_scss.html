...
<title>_modal.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_modal.scss">

<p>// .modal-open      - body class for killing the scroll // .modal          
- container to scroll within // .modal-dialog    - positioning shell for
the actual modal // .modal-content   - actual modal w/ bg and corners and
stuff</p>

<p>.modal-open {</p>

<pre>// Kill the scroll on the body
overflow: hidden;
...
<p>// Container that the modal scrolls within .modal {</p>
...
// See also https://github.com/twbs/bootstrap/issues/17695</pre>

<p>}</p>

<p>// Shell div to position the modal with bottom padding .modal-dialog {</p>
...
<p>// Actual modal .modal-content {</p>
...
<p>// Modal background .modal-backdrop {</p>
...
// Fade for backdrop
&amp;.fade { opacity: 0; }
&amp;.show { opacity: $modal-backdrop-opacity; }</pre>

<p>}</p>

<p>// Modal header // Top section of the modal w/ title and dismiss
.modal-header {</p>
...
<p>// Title text within header .modal-title {</p>

<pre>margin-bottom: 0;
line-height: $modal-title-line-height;</pre>

<p>}</p>

<p>// Modal body // Where all modal content resides (sibling of .modal-header
and .modal-footer) .modal-body {</p>

<pre>position: relative;
// Enable `flex-grow: 1` so that the body take up as much space as possible
// when should there be a fixed height on `.modal-dialog`.
flex: 1 1 auto;
padding: $modal-inner-padding;</pre>

<p>}</p>

<p>// Footer (for actions) .modal-footer {</p>
...
&gt; :not(:last-child) { margin-right: .25rem; }</pre>

<p>}</p>

<p>// Measure scrollbar width for padding body during modal show/hide
...
<p>// Scale up the modal @include media-breakpoint-up(sm) {</p>

<pre>// Automatically set modal&#39;s width for larger viewports
.modal-dialog {
  max-width: $modal-md;
...
.modal-sm { max-width: $modal-sm; }</pre>

<p>}</p>

<p>@include media-breakpoint-up(lg) {</p>
...
<p>@include media-breakpoint-up(xl) {</p>

<pre>.modal-xl { max-width: $modal-xl; }</pre>
