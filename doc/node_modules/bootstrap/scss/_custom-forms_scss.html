...
<title>_custom-forms.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_custom-forms.scss">

<p>// Embedded icons from Open Iconic. // Released under MIT and copyright
2014 Waybury. // <a
href="https://useiconic.com/open">useiconic.com/open</a></p>

<p>// Checkboxes and radios // // Base class takes care of all the key
...
padding-left: $custom-control-gutter + $custom-control-indicator-size;</pre>
...
margin-right: $custom-control-spacer-x;</pre>
...
<p>// Custom control indicators // // Build the custom controls out of
pseudo-elements.</p>
...
<p>// Checkboxes // // Tweak just a few things for checkboxes.</p>
...
<p>// Radios // // Tweak just a few things for radios.</p>
...
<p>// switches // // Tweak a few things for switches</p>

<p>.custom-switch {</p>

<pre>padding-left: $custom-switch-width + $custom-control-gutter;
...
<p>// Select // // Replaces the browser default select with a custom one,
mostly pulled from // <a
href="https://primer.github.io">primer.github.io</a>/. //</p>
...
<pre>height: $custom-select-height-sm;
padding-top: $custom-select-padding-y-sm;
padding-bottom: $custom-select-padding-y-sm;
padding-left: $custom-select-padding-x-sm;
@include font-size($custom-select-font-size-sm);</pre>

<p>}</p>

<p>.custom-select-lg {</p>

<pre>height: $custom-select-height-lg;
padding-top: $custom-select-padding-y-lg;
padding-bottom: $custom-select-padding-y-lg;
padding-left: $custom-select-padding-x-lg;
@include font-size($custom-select-font-size-lg);</pre>

<p>}</p>

<p>// File // // Custom file input.</p>
...
<p>// Range // // Style range inputs the same across browsers. Vendor-specific
rules for pseudo // elements cannot be mixed. As such, there are no shared
styles for focus or // active states on prefixed selectors.</p>
...
<pre>@include transition($custom-forms-transition);</pre>
