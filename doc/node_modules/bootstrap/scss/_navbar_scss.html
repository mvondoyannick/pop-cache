...
<title>_navbar.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_navbar.scss">

<p>// Contents // // Navbar // Navbar brand // Navbar nav // Navbar text //
Navbar divider // Responsive navbar // Navbar position // Navbar themes</p>

<p>// Navbar // // Provide a static navbar from which we expand to create
full-width, fixed, and // other navbar variations.</p>
...
<p>// Navbar brand // // Used for brand, project, or site names.</p>
...
<p>// Navbar nav // // Custom navbar navigation (doesn&#39;t require `.nav`,
but does make use of `.nav-link`).</p>
...
padding-bottom: $nav-link-padding-y;</pre>

<p>}</p>

<p>// Responsive navbar // // Custom styles for responsive collapsing and
toggling of navbar contents. // Powered by the collapse Bootstrap
JavaScript plugin.</p>

<p>// When collapsed, prevent the toggleable navbar contents from appearing in
// the default flexbox row orientation. Requires the use of `flex-wrap:
wrap` // on the `.navbar` parent. .navbar-collapse {</p>
...
<p>// Button for toggling the navbar when in its collapsed state
.navbar-toggler {</p>

<pre>padding: $navbar-toggler-padding-y $navbar-toggler-padding-x;
...
<p>// Keep as a separate element so folks can easily override it with another
icon // or image file as needed. .navbar-toggler-icon {</p>
...
<p>// Generate series of `.navbar-expand-*` responsive classes for configuring
// where your navbar collapses. .navbar-expand {</p>

<pre>@each $breakpoint in map-keys($grid-breakpoints) {
...
<p>// Navbar themes // // Styles for switching between navbars with light or
dark background.</p>

<p>// Dark links against a light background .navbar-light {</p>
...
<p>// White links against a dark background .navbar-dark {</p>
