...
<title>_transitions.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_transitions.scss">

<p>.fade {</p>

<pre>@include transition($transition-fade);
...
height: 0;
overflow: hidden;
@include transition($transition-collapse);</pre>
