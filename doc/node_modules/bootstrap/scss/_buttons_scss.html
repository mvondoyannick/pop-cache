...
<title>_buttons.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_buttons.scss">
...
<p>// Future-proof disabling of clicks on `&lt;a&gt;` elements a.btn.disabled,
fieldset:disabled a.btn {</p>

<pre>pointer-events: none;</pre>

<p>}</p>

<p>// // Alternate buttons //</p>
...
<p>// Make a button look and behave like a link .btn-link {</p>

<pre>font-weight: $font-weight-normal;
color: $link-color;
...
// No need for an active state here</pre>
...
<pre>@include button-size($btn-padding-y-lg, $btn-padding-x-lg, $btn-font-size-lg, $btn-line-height-lg, $btn-border-radius-lg);</pre>

<p>}</p>

<p>.btn-sm {</p>

<pre>@include button-size($btn-padding-y-sm, $btn-padding-x-sm, $btn-font-size-sm, $btn-line-height-sm, $btn-border-radius-sm);</pre>
...
<p>// Specificity overrides <a href="type="submit"">input</a>, <a
href="type="reset"">input</a>, <a href="type="button"">input</a> {</p>
