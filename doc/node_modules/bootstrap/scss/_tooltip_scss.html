...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_tooltip.scss">

<p>// Base class .tooltip {</p>
...
<pre>padding: $tooltip-arrow-height 0;
...
<p>.bs-tooltip-right {</p>

<pre>padding: 0 $tooltip-arrow-height;
...
<p>// Wrapper for the tooltip content .tooltip-inner {</p>

<pre>max-width: $tooltip-max-width;
padding: $tooltip-padding-y $tooltip-padding-x;
color: $tooltip-color;
text-align: center;
background-color: $tooltip-bg;
@include border-radius($tooltip-border-radius);</pre>
