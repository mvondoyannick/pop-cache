...
<title>_close.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_close.scss">
...
<p>// Additional properties for button version // iOS requires the button
element instead of an anchor tag. // If you want the anchor version, it
requires `href=“#”`. // See <a
href="https://developer.mozilla.org/en-US/docs/Web/Events/click#Safari_Mobile">developer.mozilla.org/en-US/docs/Web/Events/click#Safari_Mobile</a></p>

<p>// stylelint-disable-next-line selector-no-qualifying-type button.close {</p>
...
<p>// Future-proof disabling of clicks on `&lt;a&gt;` elements</p>

<p>// stylelint-disable-next-line selector-no-qualifying-type a.close.disabled
{</p>
