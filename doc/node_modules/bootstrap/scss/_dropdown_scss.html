...
<title>_dropdown.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_dropdown.scss">

<p>// The dropdown wrapper (`&lt;div&gt;`) .dropup, .dropright, .dropdown,
.dropleft {</p>
...
<p>// The dropdown menu .dropdown-menu {</p>
...
@include box-shadow($dropdown-box-shadow);</pre>
...
<p>// Allow for dropdowns to go bottom up (aka, dropup-menu) // Just add
.dropup after the standard .dropdown class and you&#39;re set. .dropup {</p>
...
<p>// When enabled Popper.js, reset basic dropdown position //
stylelint-disable-next-line no-duplicate-selectors .dropdown-menu {</p>
...
<p>// Dividers (basically an `&lt;hr&gt;`) within the dropdown
.dropdown-divider {</p>

<pre>@include nav-divider($dropdown-divider-bg, $dropdown-divider-margin-y);</pre>

<p>}</p>

<p>// Links, buttons, and more within the dropdown menu // //
...
<p>// Dropdown section headers .dropdown-header {</p>
...
white-space: nowrap; // as with &gt; li &gt; a</pre>

<p>}</p>

<p>// Dropdown text .dropdown-item-text {</p>

<pre>display: block;
padding: $dropdown-item-padding-y $dropdown-item-padding-x;
color: $dropdown-link-color;</pre>
