...
<title>_toasts.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_toasts.scss">

<p>.toast {</p>

<pre>max-width: $toast-max-width;
...
background-clip: padding-box;
border-bottom: $toast-border-width solid $toast-header-border-color;</pre>

<p>}</p>

<p>.toast-body {</p>

<pre>padding: $toast-padding-x; // apply to both vertical and horizontal</pre>
