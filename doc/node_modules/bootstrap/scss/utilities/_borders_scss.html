...
<title>_borders.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_borders.scss">

<p>// stylelint-disable property-blacklist, declaration-no-important</p>

<p>// // Border //</p>

<p>.border         { border: $border-width solid $border-color !important; }
.border-top     { border-top: $border-width solid $border-color !important;
} .border-right   { border-right: $border-width solid $border-color
!important; } .border-bottom  { border-bottom: $border-width solid
$border-color !important; } .border-left    { border-left: $border-width
solid $border-color !important; }</p>

<p>.border-0        { border: 0 !important; } .border-top-0    { border-top: 0
!important; } .border-right-0  { border-right: 0 !important; }
.border-bottom-0 { border-bottom: 0 !important; } .border-left-0   {
border-left: 0 !important; }</p>

<p>@each $color, $value in $theme-colors {</p>
...
<pre>border-color: $white !important;</pre>
...
<pre>border-radius: $border-radius-sm !important;</pre>

<p>}</p>

<p>.rounded {</p>

<pre>border-radius: $border-radius !important;</pre>

<p>}</p>

<p>.rounded-top {</p>

<pre>border-top-left-radius: $border-radius !important;
border-top-right-radius: $border-radius !important;</pre>

<p>}</p>

<p>.rounded-right {</p>

<pre>border-top-right-radius: $border-radius !important;
border-bottom-right-radius: $border-radius !important;</pre>

<p>}</p>

<p>.rounded-bottom {</p>

<pre>border-bottom-right-radius: $border-radius !important;
border-bottom-left-radius: $border-radius !important;</pre>
...
<pre>border-radius: $border-radius-lg !important;</pre>
...
<pre>border-radius: $rounded-pill !important;</pre>
