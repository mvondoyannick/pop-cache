...
<title>_embed.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_embed.scss">

<p>// Credit: Nicolas Gallagher and SUIT CSS.</p>
...
<p>@each $embed-responsive-aspect-ratio in $embed-responsive-aspect-ratios {</p>

<pre>$embed-responsive-aspect-ratio-x: nth($embed-responsive-aspect-ratio, 1);
