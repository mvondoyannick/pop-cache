...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_overflow.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>@each $value in $overflows {</p>

<pre>.overflow-#{$value} { overflow: $value !important; }</pre>
