...
<title>_screenreaders.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_screenreaders.scss">

<p>// // Screenreaders //</p>

<p>.sr-only {</p>

<pre>@include sr-only();</pre>

<p>}</p>

<p>.sr-only-focusable {</p>

<pre>@include sr-only-focusable();</pre>
