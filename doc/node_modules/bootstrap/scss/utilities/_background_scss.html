...
<title>_background.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_background.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>@each $color, $value in $theme-colors {</p>

<pre>@include bg-variant(&quot;.bg-#{$color}&quot;, $value);</pre>

<p>}</p>

<p>@if $enable-gradients {</p>

<pre>@each $color, $value in $theme-colors {
...
<pre>background-color: $white !important;</pre>
