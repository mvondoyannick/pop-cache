...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_text.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>// // Text //</p>

<p>.text-monospace { font-family: $font-family-monospace !important; }</p>

<p>// Alignment</p>

<p>.text-justify  { text-align: justify !important; } .text-wrap     {
white-space: normal !important; } .text-nowrap   { white-space: nowrap
!important; } .text-truncate { @include text-truncate; }</p>

<p>// Responsive alignment</p>

<p>@each $breakpoint in map-keys($grid-breakpoints) {</p>

<pre>@include media-breakpoint-up($breakpoint) {
...
<p>.text-lowercase  { text-transform: lowercase !important; } .text-uppercase 
{ text-transform: uppercase !important; } .text-capitalize {
text-transform: capitalize !important; }</p>

<p>// Weight and italics</p>

<p>.font-weight-light   { font-weight: $font-weight-light !important; }
.font-weight-lighter { font-weight: $font-weight-lighter !important; }
.font-weight-normal  { font-weight: $font-weight-normal !important; }
.font-weight-bold    { font-weight: $font-weight-bold !important; }
.font-weight-bolder  { font-weight: $font-weight-bolder !important; }
.font-italic         { font-style: italic !important; }</p>

<p>// Contextual colors</p>

<p>.text-white { color: $white !important; }</p>

<p>@each $color, $value in $theme-colors {</p>

<pre>@include text-emphasis-variant(&quot;.text-#{$color}&quot;, $value);</pre>

<p>}</p>

<p>.text-body { color: $body-color !important; } .text-muted { color:
$text-muted !important; }</p>

<p>.text-black-50 { color: rgba($black, .5) !important; } .text-white-50 {
color: rgba($white, .5) !important; }</p>

<p>// Misc</p>

<p>.text-hide {</p>

<pre>@include text-hide($ignore-warning: true);</pre>

<p>}</p>

<p>.text-decoration-none { text-decoration: none !important; }</p>

<p>.text-break {</p>

<pre>word-break: break-word !important; // IE &amp; &lt; Edge 18
...
<p>.text-reset { color: inherit !important; }</p>
</main>
