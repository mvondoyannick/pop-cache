...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_position.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>// Common values @each $position in $positions {</p>

<pre>.position-#{$position} { position: $position !important; }</pre>
