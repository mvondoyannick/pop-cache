...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_display.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>// // Utilities for common `display` values //</p>
...
<p>// // Utilities for toggling `display` in print //</p>

<p>@media print {</p>

<pre>@each $value in $displays {
