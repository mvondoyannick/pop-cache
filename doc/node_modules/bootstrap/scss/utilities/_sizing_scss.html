...
<main role="main" aria-label="Page node_modules/bootstrap/scss/utilities/_sizing.scss">

<p>// stylelint-disable declaration-no-important</p>

<p>// Width and height</p>

<p>@each $prop, $abbrev in (width: w, height: h) {</p>

<pre>@each $size, $length in $sizes {
  .#{$abbrev}-#{$size} { #{$prop}: $length !important; }
}</pre>

<p>}</p>

<p>.mw-100 { max-width: 100% !important; } .mh-100 { max-height: 100%
!important; }</p>

<p>// Viewport additional helpers</p>

<p>.min-vw-100 { min-width: 100vw !important; } .min-vh-100 { min-height:
100vh !important; }</p>

<p>.vw-100 { width: 100vw !important; } .vh-100 { height: 100vh !important; }</p>
</main>
