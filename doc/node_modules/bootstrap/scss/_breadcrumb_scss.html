...
<title>_breadcrumb.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_breadcrumb.scss">
...
@include border-radius($breadcrumb-border-radius);</pre>

<p>}</p>

<p>.breadcrumb-item {</p>

<pre>// The separator between breadcrumbs (by default, a forward-slash: &quot;/&quot;)
+ .breadcrumb-item {
