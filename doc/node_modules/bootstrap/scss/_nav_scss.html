...
<title>_nav.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_nav.scss">

<p>// Base class // // Kickstart any navigation component with a set of style
resets. Works with // `&lt;nav&gt;`s or `&lt;ul&gt;`s.</p>
...
<pre>border-bottom: $nav-tabs-border-width solid $nav-tabs-border-color;
...
<p>// Tabbable tabs // // Hide tabbable panes to start, show them when
`.active`</p>
