...
<title>_type.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_type.scss">

<p>// stylelint-disable declaration-no-important,
selector-list-comma-newline-after</p>

<p>// // Headings //</p>

<p>h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6 {</p>

<pre>margin-bottom: $headings-margin-bottom;
font-family: $headings-font-family;
font-weight: $headings-font-weight;
line-height: $headings-line-height;
color: $headings-color;</pre>

<p>}</p>

<p>h1, .h1 { @include font-size($h1-font-size); } h2, .h2 { @include
font-size($h2-font-size); } h3, .h3 { @include font-size($h3-font-size); }
h4, .h4 { @include font-size($h4-font-size); } h5, .h5 { @include
font-size($h5-font-size); } h6, .h6 { @include font-size($h6-font-size); }</p>

<p>.lead {</p>

<pre>@include font-size($lead-font-size);
font-weight: $lead-font-weight;</pre>

<p>}</p>

<p>// Type display classes .display-1 {</p>

<pre>@include font-size($display1-size);
font-weight: $display1-weight;
line-height: $display-line-height;</pre>

<p>} .display-2 {</p>

<pre>@include font-size($display2-size);
font-weight: $display2-weight;
line-height: $display-line-height;</pre>

<p>} .display-3 {</p>

<pre>@include font-size($display3-size);
font-weight: $display3-weight;
line-height: $display-line-height;</pre>

<p>} .display-4 {</p>

<pre>@include font-size($display4-size);
...
<pre>margin-top: $hr-margin-y;
margin-bottom: $hr-margin-y;
border: 0;
border-top: $hr-border-width solid $hr-border-color;</pre>
...
<pre>@include font-size($small-font-size);
font-weight: $font-weight-normal;</pre>

<p>}</p>

<p>mark, .mark {</p>

<pre>padding: $mark-padding;
background-color: $mark-bg;</pre>
...
<pre>@include list-unstyled;</pre>

<p>}</p>

<p>// Inline turns list items into inline-block .list-inline {</p>
...
<p>// Builds on `abbr` .initialism {</p>

<pre>@include font-size(90%);
text-transform: uppercase;</pre>

<p>}</p>

<p>// Blockquotes .blockquote {</p>

<pre>margin-bottom: $spacer;
@include font-size($blockquote-font-size);</pre>
