...
<title>_code.scss - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/scss/_code.scss">

<p>// Inline code code {</p>

<pre>@include font-size($code-font-size);
color: $code-color;
...
<p>// <a href="../../../User.html">User</a> input typically entered via
keyboard kbd {</p>

<pre>padding: $kbd-padding-y $kbd-padding-x;
...
<p>// Enable scrollable blocks of code .pre-scrollable {</p>

<pre>max-height: $pre-scrollable-max-height;
