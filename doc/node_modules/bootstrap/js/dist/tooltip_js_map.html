...
<title>tooltip.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/tooltip.js.map">

<p>{“<a
href=""../src/tools/sanitizer.js","../src/tooltip.js"">version”:3,“file”:“tooltip.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): tools/sanitizer.jsn *
...
* ————————————————————————–n   nnconst uriAttrs = [n 
&#39;background&#39;,n  &#39;cite&#39;,n  &#39;href&#39;,n 
&#39;itemtype&#39;,n  &#39;longdesc&#39;,n  &#39;poster&#39;,n 
&#39;src&#39;,n  &#39;x<a
href="../../../../href'\n]\n/nconst">href’n]nnconst</a>
ARIA_ATTRIBUTE_PATTERN = /^<a href="\\w-">aria-</a>*$/innexport const
DefaultWhitelist = {n  // Global attributes allowed on any supplied element
below.n  &#39;*&#39;: [&#39;class&#39;, &#39;dir&#39;, &#39;id&#39;,
&#39;lang&#39;, &#39;role&#39;, ARIA_ATTRIBUTE_PATTERN],n  a:
[&#39;target&#39;, &#39;href&#39;, &#39;title&#39;, &#39;rel&#39;],n  area:
[],n  b: [],n  br: [],n  col: [],n  code: [],n  div: [],n  em: [],n  hr:
[],n  h1: [],n  h2: [],n  h3: [],n  h4: [],n  h5: [],n  h6: [],n  i: [],n 
img: [&#39;src&#39;, &#39;alt&#39;, &#39;title&#39;, &#39;width&#39;,
&#39;height&#39;],n  li: [],n  ol: [],n  p: [],n  pre: [],n  s: [],n 
small: [],n  span: [],n  sub: [],n  sup: [],n  strong: [],n  u: [],n  ul:
[]n}nn   n * A pattern that recognizes a commonly useful subset of URLs
that are safe.n *n * Shoutout to Angular 7 <a
href="https://github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.ts\n">github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.tsn</a>
nconst SAFE_URL_PATTERN = /^(?:(?:<a
href="^&:/?#">https?|mailto|ftp|tel|file):|</a>*(?:[/?#]|$))/ginn/**n * A
pattern that matches safe data URLs. Only matches image, video and audio
types.n *n * Shoutout to Angular 7 <a
href="https://github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.ts\n">github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.tsn</a>
*/nconst DATA_URL_PATTERN = /^<a
href="a-z0-9+/">data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,</a>+=*$/innfunction
...
(let i = 0, l = regExp.length; i &lt; l; i++) {n    if (<a
href="i">attrName.match(regExp</a>)) {n      return truen    }n  }nn 
return falsen}nnexport function sanitizeHtml(unsafeHtml, whiteList,
sanitizeFn) {n  if (unsafeHtml.length === 0) {n    return unsafeHtmln  }nn 
if (sanitizeFn &amp;&amp; typeof sanitizeFn === &#39;function&#39;) {n   
return sanitizeFn(unsafeHtml)n  }nn  const domParser = new
window.DOMParser()n  const createdDocument =
domParser.parseFromString(unsafeHtml, &#39;text/html&#39;)n  const
whitelistKeys = Object.keys(whiteList)n  const elements =
[].slice.call(createdDocument.body.querySelectorAll(&#39;*&#39;))nn  for
(let i = 0, len = elements.length; i &lt; len; i++) {n    const el = <a
href="i">elements</a>n    const elName = el.nodeName.toLowerCase()nn    if
(whitelistKeys.indexOf(el.nodeName.toLowerCase()) === -1) {n     
el.parentNode.removeChild(el)nn      continuen    }nn    const
attributeList = [].slice.call(el.attributes)n    const
whitelistedAttributes = [].<a href="'*'">concat(whiteList</a> || [], <a
href="elName">whiteList</a> || [])nn    attributeList.forEach((attr) =&gt;
{n      if (!allowedAttribute(attr, whitelistedAttributes)) {n       
el.removeAttribute(attr.nodeName)n      }n    })n  }nn  return
createdDocument.body.innerHTMLn}n”,“/**n * ————————————————————————–n *
Bootstrap (v4.3.1): tooltip.jsn * Licensed under MIT (<a
href="https://github.com/twbs/bootstrap/blob/master/LICENSE)\n">github.com/twbs/bootstrap/blob/master/LICENSE)n</a>
* ————————————————————————–n */nnimport {n  DefaultWhitelist,n 
sanitizeHtmln} from &#39;./tools/sanitizer&#39;nimport $ from
&#39;jquery&#39;nimport Popper from &#39;popper.js&#39;nimport Util from
&#39;./util&#39;nn/**n * ————————————————————————n * Constantsn *
————————————————————————n */nnconst NAME                  =
&#39;tooltip&#39;nconst VERSION               = &#39;4.3.1&#39;nconst
DATA_KEY              = &#39;bs.tooltip&#39;nconst EVENT_KEY             =
`.${DATA_KEY}`nconst JQUERY_NO_CONFLICT    = $.<a href="NAME">fn</a>nconst
CLASS_PREFIX          = &#39;bs-tooltip&#39;nconst BSCLS_PREFIX_REGEX    =
new RegExp(`(^|\\s)${CLASS_PREFIX}\\S+`, &#39;g&#39;)nconst
DISALLOWED_ATTRIBUTES = [&#39;sanitize&#39;, &#39;whiteList&#39;,
&#39;sanitizeFn&#39;]nnconst DefaultType = {n  animation         :
&#39;boolean&#39;,n  template          : &#39;string&#39;,n  title         
: &#39;(string|element|function)&#39;,n  trigger           :
&#39;string&#39;,n  delay             : &#39;(number|object)&#39;,n  html  
: &#39;boolean&#39;,n  selector          : &#39;(string|boolean)&#39;,n 
placement         : &#39;(string|function)&#39;,n  offset            :
&#39;(number|string|function)&#39;,n  container         :
&#39;(string|element|boolean)&#39;,n  fallbackPlacement :
&#39;(string|array)&#39;,n  boundary          :
&#39;(string|element)&#39;,n  sanitize          : &#39;boolean&#39;,n 
sanitizeFn        : &#39;(null|function)&#39;,n  whiteList         :
&#39;object&#39;n}nnconst AttachmentMap = {n  AUTO   : &#39;auto&#39;,n 
TOP    : &#39;top&#39;,n  RIGHT  : &#39;right&#39;,n  BOTTOM :
&#39;bottom&#39;,n  LEFT   : &#39;left&#39;n}nnconst Default = {n 
animation         : true,n  template          : &#39;&lt;div
class=&quot;tooltip&quot; role=&quot;tooltip&quot;&gt;&#39; +n             
&#39;&lt;div class=&quot;arrow&quot;&gt;&lt;/div&gt;&#39; +n               
&#39;&lt;div
class=&quot;tooltip-inner&quot;&gt;&lt;/div&gt;&lt;/div&gt;&#39;,n  trigger
: &#39;hover focus&#39;,n  title             : &#39;&#39;,n  delay         
: 0,n  html              : false,n  selector          : false,n  placement 
: &#39;top&#39;,n  offset            : 0,n  container         : false,n 
fallbackPlacement : &#39;flip&#39;,n  boundary          :
&#39;scrollParent&#39;,n  sanitize          : true,n  sanitizeFn        :
null,n  whiteList         : DefaultWhitelistn}nnconst HoverState = {n  SHOW
...
`mouseleave${EVENT_KEY}`n}nnconst ClassName = {n  FADE : &#39;fade&#39;,n 
SHOW : &#39;show&#39;n}nnconst Selector = {n  TOOLTIP       :
&#39;.tooltip&#39;,n  TOOLTIP_INNER : &#39;.tooltip-inner&#39;,n  ARROW    
: &#39;.arrow&#39;n}nnconst Trigger = {n  HOVER  : &#39;hover&#39;,n  FOCUS
: &#39;focus&#39;,n  CLICK  : &#39;click&#39;,n  MANUAL :
&#39;manual&#39;n}nnn/**n * ————————————————————————n * Class Definitionn *
————————————————————————n */nnclass Tooltip {n  constructor(element,
config) {n    /**n     * Check for Popper dependencyn     * Popper - <a
href="https://popper.js.org\n">popper.js.orgn</a>     */n    if (typeof
Popper === &#39;undefined&#39;) {n      throw new
TypeError(&#39;Bootstrap\&#39;s tooltips require Popper.js (<a
href="https://popper.js.org/)')\n">popper.js.org/)‘)n</a>    }nn    //
privaten    this._isEnabled     = truen    this._timeout       = 0n   
this._hoverState    = &#39;&#39;n    this._activeTrigger = {}n   
this._popper        = nullnn    // Protectedn    this.element = elementn   
this.config  = this._getConfig(config)n    this.tip     = nullnn   
this._setListeners()n  }nn  // Gettersnn  static get VERSION() {n    return
VERSIONn  }nn  static get Default() {n    return Defaultn  }nn  static get
NAME() {n    return NAMEn  }nn  static get DATA_KEY() {n    return
DATA_KEYn  }nn  static get Event() {n    return Eventn  }nn  static get
EVENT_KEY() {n    return EVENT_KEYn  }nn  static get DefaultType() {n   
return DefaultTypen  }nn  // Publicnn  enable() {n    this._isEnabled =
truen  }nn  disable() {n    this._isEnabled = falsen  }nn  toggleEnabled()
{n    this._isEnabled = !this._isEnabledn  }nn  toggle(event) {n    if
(!this._isEnabled) {n      returnn    }nn    if (event) {n      const
dataKey = this.constructor.DATA_KEYn      let context =
...
$(this.element).closest(&#39;.modal&#39;).off(&#39;hide.bs.modal&#39;)nn   
if (this.tip) {n      $(this.tip).remove()n    }nn    this._isEnabled     =
nulln    this._timeout       = nulln    this._hoverState    = nulln   
...
($(this.element).css(&#39;display&#39;) === &#39;none&#39;) {n      throw
new Error(&#39;Please use show on visible elements&#39;)n    }nn    const
showEvent = $.Event(this.constructor.Event.SHOW)n    if
(this.isWithContent() &amp;&amp; this._isEnabled) {n     
$(this.element).trigger(showEvent)nn      const shadowRoot =
Util.findShadowRoot(this.element)n      const isInTheDom = $.contains(n    
...
Util.getUID(this.constructor.NAME)nn      tip.setAttribute(&#39;id&#39;,
...
// <a
href="https://www.quirksmode.org/blog/archives/2014/02/mouse_event_bub.html\n">www.quirksmode.org/blog/archives/2014/02/mouse_event_bub.htmln</a>
...
<a href="Trigger.CLICK">this._activeTrigger</a> = falsen    <a
href="Trigger.FOCUS">this._activeTrigger</a> = falsen    <a
href="Trigger.HOVER">this._activeTrigger</a> = falsenn    if
...
getTipElement() {n    this.tip = this.tip || $(<a
href="0">this.config.template)</a>n    return this.tipn  }nn  setContent()
{n    const tip = this.getTipElement()n   
...
(typeof content === &#39;object&#39; &amp;&amp; (content.nodeType ||
content.jquery)) {n      // Content is a DOM node or a jQueryn      if
(this.config.html) {n        if (!$(content).parent().is($element)) {n     
...
this.element.getAttribute(&#39;data-original-title&#39;)nn    if (!title)
{n      title = typeof this.config.title === &#39;function&#39;n        ?
this.config.title.call(this.element)n        : this.config.titlen    }nn   
return titlen  }nn  // Privatenn  _getOffset() {n    const offset = {}nn   
if (typeof this.config.offset === &#39;function&#39;) {n      offset.fn =
...
return <a href="placement.toUpperCase()">AttachmentMap</a>n  }nn 
_setListeners() {n    const triggers = this.config.trigger.split(&#39;
&#39;)nn    triggers.forEach((trigger) =&gt; {n      if (trigger ===
&#39;click&#39;) {n        $(this.element).on(n         
this.constructor.Event.CLICK,n          this.config.selector,n         
(event) =&gt; this.toggle(event)n        )n      } else if (trigger !==
Trigger.MANUAL) {n        const eventIn = trigger === Trigger.HOVERn       
...
(this.element.getAttribute(&#39;title&#39;) || titleType !==
&#39;string&#39;) {n      this.element.setAttribute(n       
&#39;data-original-title&#39;,n       
this.element.getAttribute(&#39;title&#39;) || &#39;&#39;n      )nn     
this.element.setAttribute(&#39;title&#39;, &#39;&#39;)n    }n  }nn 
_enter(event, context) {n    const dataKey = this.constructor.DATA_KEYn   
context = context || $(event.currentTarget).data(dataKey)nn    if
(!context) {n      context = new this.constructor(n       
event.currentTarget,n        this._getDelegateConfig()n      )n     
$(event.currentTarget).data(dataKey, context)n    }nn    if (event) {n     
context._activeTrigger[n        event.type === &#39;focusin&#39; ?
Trigger.FOCUS : Trigger.HOVERn      ] = truen    }nn    if
...
this._getDelegateConfig()n      )n     
$(event.currentTarget).data(dataKey, context)n    }nn    if (event) {n     
context._activeTrigger[n        event.type === &#39;focusout&#39; ?
Trigger.FOCUS : Trigger.HOVERn      ] = falsen    }nn    if
...
if (<a href="trigger">this._activeTrigger</a>) {n        return truen     
}n    }nn    return falsen  }nn  _getConfig(config) {n    const
dataAttributes = $(this.element).data()nn    Object.keys(dataAttributes)n  
.forEach((dataAttr) =&gt; {n        if
(DISALLOWED_ATTRIBUTES.indexOf(dataAttr) !== -1) {n          delete <a
href="dataAttr">dataAttributes</a>n        }n      })nn    config = {n     
…this.constructor.Default,n      …dataAttributes,n      …typeof config ===
&#39;object&#39; &amp;&amp; config ? config : {}n    }nn    if (typeof
config.delay === &#39;number&#39;) {n      config.delay = {n        show:
config.delay,n        hide: config.delayn      }n    }nn    if (typeof
config.title === &#39;number&#39;) {n      config.title =
config.title.toString()n    }nn    if (typeof config.content ===
&#39;number&#39;) {n      config.content = config.content.toString()n   
}nn    Util.typeCheckConfig(n      NAME,n      config,n     
this.constructor.DefaultTypen    )nn    if (config.sanitize) {n     
...
this.config) {n        if (<a href="key">this.constructor.Default</a> !==
<a href="key">this.config</a>) {n          <a href="key">config</a> = <a
href="key">this.config</a>n        }n      }n    }nn    return confign  }nn
_cleanTipClass() {n    const $tip = $(this.getTipElement())n    const
tabClass = $tip.attr(&#39;class&#39;).match(BSCLS_PREFIX_REGEX)n    if
(tabClass !== null &amp;&amp; tabClass.length) {n     
$tip.removeClass(tabClass.join(&#39;&#39;))n    }n  }nn 
...
if (!data &amp;&amp; /dispose|hide/.test(config)) {n        returnn     
}nn      if (!data) {n        data = new Tooltip(this, _config)n       
