...
<title>modal.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/modal.js.map">

<p>{“<a
href=""../src/modal.js"">version”:3,“file”:“modal.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): modal.jsn * Licensed
under MIT (<a
...
————————————————————————n   nnconst NAME               =
&#39;modal&#39;nconst VERSION            = &#39;4.3.1&#39;nconst DATA_KEY  
= &#39;bs.modal&#39;nconst EVENT_KEY          = `.${DATA_KEY}`nconst
DATA_API_KEY       = &#39;.data-api&#39;nconst JQUERY_NO_CONFLICT = $.<a
href="NAME">fn</a>nconst ESCAPE_KEYCODE     = 27 // KeyboardEvent.which
value for Escape (Esc) keynnconst Default = {n  backdrop : true,n  keyboard
: true,n  focus    : true,n  show     : truen}nnconst DefaultType = {n 
backdrop : &#39;(boolean|string)&#39;,n  keyboard : &#39;boolean&#39;,n 
focus    : &#39;boolean&#39;,n  show     : &#39;boolean&#39;n}nnconst Event
...
&#39;modal-scrollbar-measure&#39;,n  BACKDROP           :
&#39;modal-backdrop&#39;,n  OPEN               : &#39;modal-open&#39;,n 
FADE               : &#39;fade&#39;,n  SHOW               :
&#39;show&#39;n}nnconst Selector = {n  DIALOG         :
&#39;.modal-dialog&#39;,n  MODAL_BODY     : &#39;.modal-body&#39;,n 
DATA_TOGGLE    : &#39;[data-toggle=&quot;modal&quot;]&#39;,n  DATA_DISMISS 
: &#39;[data-dismiss=&quot;modal&quot;]&#39;,n  FIXED_CONTENT  :
&#39;.fixed-top, .fixed-bottom, .is-fixed, .sticky-top&#39;,n 
STICKY_CONTENT : &#39;.sticky-top&#39;n}nn/**n * ————————————————————————n
* Class Definitionn * ————————————————————————n */nnclass Modal {n 
...
.on(Event.FOCUSIN, (event) =&gt; {n        if (document !== event.target
&amp;&amp;n            this._element !== event.target &amp;&amp;n          
...
this._element.removeAttribute(&#39;aria-modal&#39;)n   
this._isTransitioning = falsen    this._showBackdrop(() =&gt; {n     
...
$(this._element).hasClass(ClassName.FADE)n      ? ClassName.FADE :
&#39;&#39;nn    if (this._isShown &amp;&amp; this._config.backdrop) {n     
this._backdrop = document.createElement(&#39;div&#39;)n     
this._backdrop.className = ClassName.BACKDROPnn      if (animate) {n       
...
this._element.style.paddingLeft = &#39;&#39;n   
this._element.style.paddingRight = &#39;&#39;n  }nn  _checkScrollbar() {n  
const rect = document.body.getBoundingClientRect()n   
this._isBodyOverflowing = rect.left + rect.right &lt; window.innerWidthn   
this._scrollbarWidth = this._getScrollbarWidth()n  }nn  _setScrollbar() {n 
if (this._isBodyOverflowing) {n      // Note: DOMNode.style.paddingRight
returns the actual value or &#39;&#39; if not setn      //   while
$(DOMNode).css(&#39;padding-right&#39;) returns the calculated value or 0
if not setn      const fixedContent =
[].slice.call(document.querySelectorAll(Selector.FIXED_CONTENT))n     
const stickyContent =
[].slice.call(document.querySelectorAll(Selector.STICKY_CONTENT))nn      //
Adjust fixed content paddingn      $(fixedContent).each((index, element)
=&gt; {n        const actualPadding = element.style.paddingRightn       
...
.data(&#39;margin-right&#39;, actualMargin)n         
.css(&#39;margin-right&#39;, `${parseFloat(calculatedMargin) -
this._scrollbarWidth}px`)n      })nn      // Adjust body paddingn     
const actualPadding = document.body.style.paddingRightn      const
calculatedPadding = $(document.body).css(&#39;padding-right&#39;)n     
$(document.body)n        .data(&#39;padding-right&#39;, actualPadding)n    
.css(&#39;padding-right&#39;, `${parseFloat(calculatedPadding) +
this._scrollbarWidth}px`)n    }nn   
...
$(element).removeData(&#39;padding-right&#39;)n     
element.style.paddingRight = padding ? padding : &#39;&#39;n    })nn    //
Restore sticky contentn    const elements =
[].slice.call(document.querySelectorAll(`${Selector.STICKY_CONTENT}`))n   
$(elements).each((index, element) =&gt; {n      const margin =
$(element).data(&#39;margin-right&#39;)n      if (typeof margin !==
&#39;undefined&#39;) {n        $(element).css(&#39;margin-right&#39;,
margin).removeData(&#39;margin-right&#39;)n      }n    })nn    // Restore
body paddingn    const padding =
...
…$(this).data(),n        …typeof config === &#39;object&#39; &amp;&amp;
config ? config : {}n      }nn      if (!data) {n        data = new
Modal(this, _config)n        $(this).data(DATA_KEY, data)n      }nn      if
(typeof config === &#39;string&#39;) {n        if (typeof <a
href="config">data</a> === &#39;undefined&#39;) {n          throw new
TypeError(`No method named "${config}&quot;`)n        }n        <a
href="config">data</a>(relatedTarget)n      } else if (_config.show) {n    
