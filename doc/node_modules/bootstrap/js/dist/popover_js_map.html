...
<title>popover.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/popover.js.map">

<p>{“<a
href=""../src/popover.js"">version”:3,“file”:“popover.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): popover.jsn * Licensed
under MIT (<a
...
Tooltip from &#39;./tooltip&#39;nn   n * ————————————————————————n *
Constantsn * ————————————————————————n   nnconst NAME                =
&#39;popover&#39;nconst VERSION             = &#39;4.3.1&#39;nconst
DATA_KEY            = &#39;bs.popover&#39;nconst EVENT_KEY           =
`.${DATA_KEY}`nconst JQUERY_NO_CONFLICT  = $.<a href="NAME">fn</a>nconst
CLASS_PREFIX        = &#39;bs-popover&#39;nconst BSCLS_PREFIX_REGEX  = new
RegExp(`(^|\\s)${CLASS_PREFIX}\\S+`, &#39;g&#39;)nnconst Default = {n 
…Tooltip.Default,n  placement : &#39;right&#39;,n  trigger   :
&#39;click&#39;,n  content   : &#39;&#39;,n  template  : &#39;&lt;div
class=&quot;popover&quot; role=&quot;tooltip&quot;&gt;&#39; +n             
&#39;&lt;div class=&quot;arrow&quot;&gt;&lt;/div&gt;&#39; +n             
&#39;&lt;h3 class=&quot;popover-header&quot;&gt;&lt;/h3&gt;&#39; +n        
&#39;&lt;div
class=&quot;popover-body&quot;&gt;&lt;/div&gt;&lt;/div&gt;&#39;n}nnconst
DefaultType = {n  …Tooltip.DefaultType,n  content :
&#39;(string|element|function)&#39;n}nnconst ClassName = {n  FADE :
&#39;fade&#39;,n  SHOW : &#39;show&#39;n}nnconst Selector = {n  TITLE   :
&#39;.popover-header&#39;,n  CONTENT : &#39;.popover-body&#39;n}nnconst
...
MOUSELEAVE : `mouseleave${EVENT_KEY}`n}nn/**n * ————————————————————————n *
Class Definitionn * ————————————————————————n */nnclass Popover extends
Tooltip {n  // Gettersnn  static get VERSION() {n    return VERSIONn  }nn 
static get Default() {n    return Defaultn  }nn  static get NAME() {n   
return NAMEn  }nn  static get DATA_KEY() {n    return DATA_KEYn  }nn 
static get Event() {n    return Eventn  }nn  static get EVENT_KEY() {n   
return EVENT_KEYn  }nn  static get DefaultType() {n    return DefaultTypen 
}nn  // Overridesnn  isWithContent() {n    return this.getTitle() ||
...
{n    const $tip = $(this.getTipElement())nn    // We use append for html
objects to maintain js eventsn   
this.setElementContent($tip.find(Selector.TITLE), this.getTitle())n    let
content = this._getContent()n    if (typeof content === &#39;function&#39;)
{n      content = content.call(this.element)n    }n   
this.setElementContent($tip.find(Selector.CONTENT), content)nn   
$tip.removeClass(`${ClassName.FADE} ${ClassName.SHOW}`)n  }nn  // Privatenn
_getContent() {n    return
this.element.getAttribute(&#39;data-content&#39;) ||n     
this.config.contentn  }nn  _cleanTipClass() {n    const $tip =
$(this.getTipElement())n    const tabClass =
$tip.attr(&#39;class&#39;).match(BSCLS_PREFIX_REGEX)n    if (tabClass !==
null &amp;&amp; tabClass.length &gt; 0) {n     
$tip.removeClass(tabClass.join(&#39;&#39;))n    }n  }nn  // Staticnn 
static _jQueryInterface(config) {n    return this.each(function () {n     
let data = $(this).data(DATA_KEY)n      const _config = typeof config ===
&#39;object&#39; ? config : nullnn      if (!data &amp;&amp;
