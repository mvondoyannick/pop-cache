...
<title>collapse.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/collapse.js.map">

<p>{“<a
href=""../src/collapse.js"">version”:3,“file”:“collapse.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): collapse.jsn *
...
————————————————————————n   nnconst NAME                =
&#39;collapse&#39;nconst VERSION             = &#39;4.3.1&#39;nconst
DATA_KEY            = &#39;bs.collapse&#39;nconst EVENT_KEY           =
`.${DATA_KEY}`nconst DATA_API_KEY        = &#39;.data-api&#39;nconst
JQUERY_NO_CONFLICT  = $.<a href="NAME">fn</a>nnconst Default = {n  toggle :
true,n  parent : &#39;&#39;n}nnconst DefaultType = {n  toggle :
&#39;boolean&#39;,n  parent : &#39;(string|element)&#39;n}nnconst Event =
{n  SHOW           : `show${EVENT_KEY}`,n  SHOWN          :
`shown${EVENT_KEY}`,n  HIDE           : `hide${EVENT_KEY}`,n  HIDDEN       
: `hidden${EVENT_KEY}`,n  CLICK_DATA_API :
`click${EVENT_KEY}${DATA_API_KEY}`n}nnconst ClassName = {n  SHOW       :
&#39;show&#39;,n  COLLAPSE   : &#39;collapse&#39;,n  COLLAPSING :
&#39;collapsing&#39;,n  COLLAPSED  : &#39;collapsed&#39;n}nnconst Dimension
= {n  WIDTH  : &#39;width&#39;,n  HEIGHT : &#39;height&#39;n}nnconst
Selector = {n  ACTIVES     : &#39;.show, .collapsing&#39;,n  DATA_TOGGLE :
&#39;[data-toggle=&quot;collapse&quot;]&#39;n}nn/**n *
...
[].slice.call(document.querySelectorAll(n      `[<a
href="href=\"#${element.id}\"">data-toggle="collapse"]</a>,` +n      `[<a
href="data-target=\"#${element.id}\"">data-toggle="collapse"]</a>`n    ))nn
const toggleList =
[].slice.call(document.querySelectorAll(Selector.DATA_TOGGLE))n    for (let
i = 0, len = toggleList.length; i &lt; len; i++) {n      const elem = <a
href="i">toggleList</a>n      const selector =
Util.getSelectorFromElement(elem)n      const filterElement =
[].slice.call(document.querySelectorAll(selector))n       
.filter((foundElem) =&gt; foundElem === element)nn      if (selector !==
null &amp;&amp; filterElement.length &gt; 0) {n        this._selector =
selectorn        this._triggerArray.push(elem)n      }n    }nn   
this._parent = this._config.parent ? this._getParent() : nullnn    if
...
.filter((elem) =&gt; {n          if (typeof this._config.parent ===
&#39;string&#39;) {n            return
elem.getAttribute(&#39;data-parent&#39;) === this._config.parentn         
}nn          return elem.classList.contains(ClassName.COLLAPSE)n       
})nn      if (actives.length === 0) {n        actives = nulln      }n   
}nn    if (actives) {n      activesData =
...
(startEvent.isDefaultPrevented()) {n      returnn    }nn    if (actives) {n
Collapse._jQueryInterface.call($(actives).not(this._selector),
&#39;hide&#39;)n      if (!activesData) {n        $(actives).data(DATA_KEY,
null)n      }n    }nn    const dimension = this._getDimension()nn   
$(this._element)n      .removeClass(ClassName.COLLAPSE)n     
.addClass(ClassName.COLLAPSING)nn    <a
href="dimension">this._element.style</a> = 0nn    if
(this._triggerArray.length) {n      $(this._triggerArray)n       
.removeClass(ClassName.COLLAPSED)n        .attr(&#39;aria-expanded&#39;,
true)n    }nn    this.setTransitioning(true)nn    const complete = () =&gt;
{n      $(this._element)n        .removeClass(ClassName.COLLAPSING)n       
.addClass(ClassName.COLLAPSE)n        .addClass(ClassName.SHOW)nn      <a
href="dimension">this._element.style</a> = &#39;&#39;nn     
this.setTransitioning(false)nn      $(this._element).trigger(Event.SHOWN)n 
}nn    const capitalizedDimension = <a href="0">dimension</a>.toUpperCase()
+ dimension.slice(1)n    const scrollSize =
`scroll${capitalizedDimension}`n    const transitionDuration =
Util.getTransitionDurationFromElement(this._element)nn    $(this._element)n
.one(Util.TRANSITION_END, complete)n     
.emulateTransitionEnd(transitionDuration)nn    <a
href="dimension">this._element.style</a> = `${<a
href="scrollSize">this._element</a>}px`n  }nn  hide() {n    if
(this._isTransitioning ||n      !$(this._element).hasClass(ClassName.SHOW))
{n      returnn    }nn    const startEvent = $.Event(Event.HIDE)n   
$(this._element).trigger(startEvent)n    if
(startEvent.isDefaultPrevented()) {n      returnn    }nn    const dimension
= this._getDimension()nn    <a href="dimension">this._element.style</a> =
`${<a href="dimension">this._element.getBoundingClientRect()</a>}px`nn   
...
this._triggerArray.lengthn    if (triggerArrayLength &gt; 0) {n      for
(let i = 0; i &lt; triggerArrayLength; i++) {n        const trigger = <a
href="i">this._triggerArray</a>n        const selector =
Util.getSelectorFromElement(trigger)nn        if (selector !== null) {n    
const $elem = $([].slice.call(document.querySelectorAll(selector)))n       
if (!$elem.hasClass(ClassName.SHOW)) {n           
$(trigger).addClass(ClassName.COLLAPSED)n             
.attr(&#39;aria-expanded&#39;, false)n          }n        }n      }n    }nn
this.setTransitioning(true)nn    const complete = () =&gt; {n     
this.setTransitioning(false)n      $(this._element)n       
.removeClass(ClassName.COLLAPSING)n        .addClass(ClassName.COLLAPSE)n  
.trigger(Event.HIDDEN)n    }nn    <a
href="dimension">this._element.style</a> = &#39;&#39;n    const
...
this._config.parent.jquery !== &#39;undefined&#39;) {n        parent = <a
href="0">this._config.parent</a>n      }n    } else {n      parent =
document.querySelector(this._config.parent)n    }nn    const selector =n   
`[<a
href="data-parent=\"${this._config.parent}\"">data-toggle="collapse"]</a>`nn
const children = [].slice.call(parent.querySelectorAll(selector))n   
$(children).each((i, element) =&gt; {n     
...
.toggleClass(ClassName.COLLAPSED, !isOpen)n       
.attr(&#39;aria-expanded&#39;, isOpen)n    }n  }nn  // Staticnn  static
_getTargetFromElement(element) {n    const selector =
Util.getSelectorFromElement(element)n    return selector ?
...
=== &#39;object&#39; &amp;&amp; config ? config : {}n      }nn      if
(!data &amp;&amp; _config.toggle &amp;&amp; /show|hide/.test(config)) {n   
_config.toggle = falsen      }nn      if (!data) {n        data = new
Collapse(this, _config)n        $this.data(DATA_KEY, data)n      }nn     
...
(event) {n  // preventDefault only for &lt;a&gt; elements (which change the
URL) not inside the collapsible elementn  if (event.currentTarget.tagName
=== &#39;A&#39;) {n    event.preventDefault()n  }nn  const $trigger =
$(this)n  const selector = Util.getSelectorFromElement(this)n  const
selectors = [].slice.call(document.querySelectorAll(selector))nn 
