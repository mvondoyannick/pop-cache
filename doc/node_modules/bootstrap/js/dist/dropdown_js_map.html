...
<title>dropdown.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/dropdown.js.map">

<p>{“<a
href=""../src/dropdown.js"">version”:3,“file”:“dropdown.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): dropdown.jsn *
...
* ————————————————————————–n   nnimport $ from &#39;jquery&#39;nimport
Popper from &#39;popper.js&#39;nimport Util from &#39;./util&#39;nn   n *
————————————————————————n * Constantsn * ————————————————————————n  
nnconst NAME                     = &#39;dropdown&#39;nconst VERSION        
= &#39;4.3.1&#39;nconst DATA_KEY                 =
&#39;bs.dropdown&#39;nconst EVENT_KEY                = `.${DATA_KEY}`nconst
DATA_API_KEY             = &#39;.data-api&#39;nconst JQUERY_NO_CONFLICT    
= $.<a href="NAME">fn</a>nconst ESCAPE_KEYCODE           = 27 //
KeyboardEvent.which value for Escape (Esc) keynconst SPACE_KEYCODE         
= 32 // KeyboardEvent.which value for space keynconst TAB_KEYCODE          
= 9 // KeyboardEvent.which value for tab keynconst ARROW_UP_KEYCODE        
...
: &#39;disabled&#39;,n  SHOW            : &#39;show&#39;,n  DROPUP         
: &#39;dropup&#39;,n  DROPRIGHT       : &#39;dropright&#39;,n  DROPLEFT    
: &#39;dropleft&#39;,n  MENURIGHT       : &#39;dropdown-menu-right&#39;,n 
MENULEFT        : &#39;dropdown-menu-left&#39;,n  POSITION_STATIC :
&#39;position-static&#39;n}nnconst Selector = {n  DATA_TOGGLE   :
&#39;[data-toggle=&quot;dropdown&quot;]&#39;,n  FORM_CHILD    :
&#39;.dropdown form&#39;,n  MENU          : &#39;.dropdown-menu&#39;,n 
NAVBAR_NAV    : &#39;.navbar-nav&#39;,n  VISIBLE_ITEMS :
&#39;.dropdown-menu
.dropdown-item:not(.disabled):not(:disabled)&#39;n}nnconst AttachmentMap =
{n  TOP       : &#39;top-start&#39;,n  TOPEND    : &#39;top-end&#39;,n 
BOTTOM    : &#39;bottom-start&#39;,n  BOTTOMEND : &#39;bottom-end&#39;,n 
RIGHT     : &#39;right-start&#39;,n  RIGHTEND  : &#39;right-end&#39;,n 
LEFT      : &#39;left-start&#39;,n  LEFTEND   : &#39;left-end&#39;n}nnconst
Default = {n  offset    : 0,n  flip      : true,n  boundary  :
&#39;scrollParent&#39;,n  reference : &#39;toggle&#39;,n  display   :
&#39;dynamic&#39;n}nnconst DefaultType = {n  offset    :
&#39;(number|string|function)&#39;,n  flip      : &#39;boolean&#39;,n 
boundary  : &#39;(string|element)&#39;,n  reference :
&#39;(string|element)&#39;,n  display   : &#39;string&#39;n}nn/**n *
————————————————————————n * Class Definitionn * ————————————————————————n
*/nnclass Dropdown {n  constructor(element, config) {n    this._element  =
elementn    this._popper   = nulln    this._config   =
this._getConfig(config)n    this._menu     = this._getMenuElement()n   
this._inNavbar = this._detectNavbar()nn    this._addEventListeners()n  }nn 
// Gettersnn  static get VERSION() {n    return VERSIONn  }nn  static get
Default() {n    return Defaultn  }nn  static get DefaultType() {n    return
DefaultTypen  }nn  // Publicnn  toggle() {n    if (this._element.disabled
...
* Popper - <a href="https://popper.js.org\n">popper.js.orgn</a>       */n  
if (typeof Popper === &#39;undefined&#39;) {n        throw new
TypeError(&#39;Bootstrap\&#39;s dropdowns require Popper.js (<a
href="https://popper.js.org/)')\n">popper.js.org/)‘)n</a>      }nn      let
referenceElement = this._elementnn      if (this._config.reference ===
&#39;parent&#39;) {n        referenceElement = parentn      } else if
...
referenceElement = <a href="0">this._config.reference</a>n        }n     
}nn      // If boundary is not `scrollParent`, then set position to
`static`n      // to allow the menu to "escape&quot; the scroll
parent&#39;s boundariesn      // <a
href="https://github.com/twbs/bootstrap/issues/24251\n">github.com/twbs/bootstrap/issues/24251n</a>
if (this._config.boundary !== &#39;scrollParent&#39;) {n       
...
listeners to the body&#39;s immediate children;n    // only needed because
of broken event delegation on iOSn    // <a
...
this._element.focus()n   
this._element.setAttribute(&#39;aria-expanded&#39;, true)nn   
$(this._menu).toggleClass(ClassName.SHOW)n    $(parent)n     
...
_addEventListeners() {n    $(this._element).on(Event.CLICK, (event) =&gt;
{n      event.preventDefault()n      event.stopPropagation()n     
...
{n    return $(this._element).closest(&#39;.navbar&#39;).length &gt; 0n 
}nn  _getOffset() {n    const offset = {}nn    if (typeof
this._config.offset === &#39;function&#39;) {n      offset.fn = (data)
=&gt; {n        data.offsets = {n          …data.offsets,n         
…this._config.offset(data.offsets, this._element) || {}n        }nn       
return datan      }n    } else {n      offset.offset = this._config.offsetn
}nn    return offsetn  }nn  _getPopperConfig() {n    const popperConfig =
{n      placement: this._getPlacement(),n      modifiers: {n        offset:
...
we have a static displayn    if (this._config.display === &#39;static&#39;)
{n      popperConfig.modifiers.applyStyle = {n        enabled: falsen     
}n    }nn    return popperConfign  }nn  // Staticnn  static
...
href="config">data</a>()n      }n    })n  }nn  static _clearMenus(event) {n
if (event &amp;&amp; (event.which === RIGHT_MOUSE_BUTTON_WHICH ||n     
event.type === &#39;keyup&#39; &amp;&amp; event.which !== TAB_KEYCODE)) {n 
returnn    }nn    const toggles =
[].slice.call(document.querySelectorAll(Selector.DATA_TOGGLE))nn    for
(let i = 0, len = toggles.length; i &lt; len; i++) {n      const parent =
<a href="i">Dropdown._getParentFromElement(toggles</a>)n      const context
= $(<a href="i">toggles</a>).data(DATA_KEY)n      const relatedTarget = {n 
relatedTarget: <a href="i">toggles</a>n      }nn      if (event &amp;&amp;
event.type === &#39;click&#39;) {n        relatedTarget.clickEvent = eventn
}nn      if (!context) {n        continuen      }nn      const dropdownMenu
= context._menun      if (!$(parent).hasClass(ClassName.SHOW)) {n       
continuen      }nn      if (event &amp;&amp; (event.type ===
&#39;click&#39; &amp;&amp;n         
/input|textarea/i.test(event.target.tagName) || event.type ===
&#39;keyup&#39; &amp;&amp; event.which === TAB_KEYCODE) &amp;&amp;n        
$.contains(parent, event.target)) {n        continuen      }nn      const
hideEvent = $.Event(Event.HIDE, relatedTarget)n     
$(parent).trigger(hideEvent)n      if (hideEvent.isDefaultPrevented()) {n  
continuen      }nn      // If this is a touch-enabled device we remove the
extran      // empty mouseover listeners we added for iOS supportn      if
(&#39;ontouchstart&#39; in document.documentElement) {n       
$(document.body).children().off(&#39;mouseover&#39;, null, $.noop)n     
}nn      <a href="i">toggles</a>.setAttribute(&#39;aria-expanded&#39;,
&#39;false&#39;)nn      $(dropdownMenu).removeClass(ClassName.SHOW)n     
$(parent)n        .removeClass(ClassName.SHOW)n       
.trigger($.Event(Event.HIDDEN, relatedTarget))n    }n  }nn  static
_getParentFromElement(element) {n    let parentn    const selector =
Util.getSelectorFromElement(element)nn    if (selector) {n      parent =
document.querySelector(selector)n    }nn    return parent ||
element.parentNoden  }nn  // eslint-disable-next-line complexityn  static
_dataApiKeydownHandler(event) {n    // If not input/textarea:n    //  - And
not a key in REGEXP_KEYDOWN =&gt; not a dropdown commandn    // If
input/textarea:n    //  - If space key =&gt; not a dropdown commandn    // 
- If key is other than escapen    //    - If key is not up or down =&gt;
not a dropdown commandn    //    - If trigger inside the menu =&gt; not a
dropdown commandn    if (/input|textarea/i.test(event.target.tagName)n     
? event.which === SPACE_KEYCODE || event.which !== ESCAPE_KEYCODE
&amp;&amp;n      (event.which !== ARROW_DOWN_KEYCODE &amp;&amp; event.which
!== ARROW_UP_KEYCODE ||n       
...
SPACE_KEYCODE)) {n      if (event.which === ESCAPE_KEYCODE) {n        const
toggle = parent.querySelector(Selector.DATA_TOGGLE)n       
$(toggle).trigger(&#39;focus&#39;)n      }nn     
$(this).trigger(&#39;click&#39;)n      returnn    }nn    const items =
