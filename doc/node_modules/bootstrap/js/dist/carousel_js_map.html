...
<title>carousel.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/carousel.js.map">

<p>{“<a
href=""../src/carousel.js"">version”:3,“file”:“carousel.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): carousel.jsn *
...
————————————————————————n   nnconst NAME                   =
&#39;carousel&#39;nconst VERSION                = &#39;4.3.1&#39;nconst
DATA_KEY               = &#39;bs.carousel&#39;nconst EVENT_KEY             
= `.${DATA_KEY}`nconst DATA_API_KEY           = &#39;.data-api&#39;nconst
JQUERY_NO_CONFLICT     = $.<a href="NAME">fn</a>nconst ARROW_LEFT_KEYCODE  
= 37 // KeyboardEvent.which value for left arrow keynconst
ARROW_RIGHT_KEYCODE    = 39 // KeyboardEvent.which value for right arrow
keynconst TOUCHEVENT_COMPAT_WAIT = 500 // Time for mouse compat events to
fire after touchnconst SWIPE_THRESHOLD        = 40nnconst Default = {n 
interval : 5000,n  keyboard : true,n  slide    : false,n  pause    :
&#39;hover&#39;,n  wrap     : true,n  touch    : truen}nnconst DefaultType
= {n  interval : &#39;(number|boolean)&#39;,n  keyboard :
&#39;boolean&#39;,n  slide    : &#39;(boolean|string)&#39;,n  pause    :
&#39;(string|boolean)&#39;,n  wrap     : &#39;boolean&#39;,n  touch    :
&#39;boolean&#39;n}nnconst Direction = {n  NEXT     : &#39;next&#39;,n 
PREV     : &#39;prev&#39;,n  LEFT     : &#39;left&#39;,n  RIGHT    :
&#39;right&#39;n}nnconst Event = {n  SLIDE          : `slide${EVENT_KEY}`,n
SLID           : `slid${EVENT_KEY}`,n  KEYDOWN        :
`keydown${EVENT_KEY}`,n  MOUSEENTER     : `mouseenter${EVENT_KEY}`,n 
MOUSELEAVE     : `mouseleave${EVENT_KEY}`,n  TOUCHSTART     :
`touchstart${EVENT_KEY}`,n  TOUCHMOVE      : `touchmove${EVENT_KEY}`,n 
TOUCHEND       : `touchend${EVENT_KEY}`,n  POINTERDOWN    :
`pointerdown${EVENT_KEY}`,n  POINTERUP      : `pointerup${EVENT_KEY}`,n 
DRAG_START     : `dragstart${EVENT_KEY}`,n  LOAD_DATA_API  :
`load${EVENT_KEY}${DATA_API_KEY}`,n  CLICK_DATA_API :
`click${EVENT_KEY}${DATA_API_KEY}`n}nnconst ClassName = {n  CAROUSEL      :
&#39;carousel&#39;,n  ACTIVE        : &#39;active&#39;,n  SLIDE         :
&#39;slide&#39;,n  RIGHT         : &#39;carousel-item-right&#39;,n  LEFT   
: &#39;carousel-item-left&#39;,n  NEXT          :
&#39;carousel-item-next&#39;,n  PREV          :
&#39;carousel-item-prev&#39;,n  ITEM          : &#39;carousel-item&#39;,n 
POINTER_EVENT : &#39;pointer-event&#39;n}nnconst Selector = {n  ACTIVE     
: &#39;.active&#39;,n  ACTIVE_ITEM : &#39;.active.carousel-item&#39;,n 
ITEM        : &#39;.carousel-item&#39;,n  ITEM_IMG    : &#39;.carousel-item
img&#39;,n  NEXT_PREV   : &#39;.carousel-item-next,
.carousel-item-prev&#39;,n  INDICATORS  : &#39;.carousel-indicators&#39;,n 
DATA_SLIDE  : &#39;[data-slide], [data-slide-to]&#39;,n  DATA_RIDE   :
&#39;[data-ride=&quot;carousel&quot;]&#39;n}nnconst PointerType = {n  TOUCH
: &#39;touch&#39;,n  PEN   : &#39;pen&#39;n}nn/**n *
————————————————————————n * Class Definitionn * ————————————————————————n
*/nclass Carousel {n  constructor(element, config) {n    this._items       
= nulln    this._interval      = nulln    this._activeElement = nulln   
...
navigator.maxTouchPoints &gt; 0n    this._pointerEvent      =
Boolean(window.PointerEvent || window.MSPointerEvent)nn   
this._addEventListeners()n  }nn  // Gettersnn  static get VERSION() {n   
return VERSIONn  }nn  static get Default() {n    return Defaultn  }nn  //
Publicnn  next() {n    if (!this._isSliding) {n     
this._slide(Direction.NEXT)n    }n  }nn  nextWhenVisible() {n    //
Don&#39;t call next when the page isn&#39;t visiblen    // or the carousel
or its parent isn&#39;t visiblen    if (!document.hidden &amp;&amp;n     
($(this._element).is(&#39;:visible&#39;) &amp;&amp;
$(this._element).css(&#39;visibility&#39;) !== &#39;hidden&#39;)) {n     
this.next()n    }n  }nn  prev() {n    if (!this._isSliding) {n     
this._slide(Direction.PREV)n    }n  }nn  pause(event) {n    if (!event) {n 
this._isPaused = truen    }nn    if
...
&gt; this._items.length - 1 || index &lt; 0) {n      returnn    }nn    if
(this._isSliding) {n      $(this._element).one(Event.SLID, () =&gt;
...
this._slide(direction, <a href="index">this._items</a>)n  }nn  dispose() {n
...
Math.abs(this.touchDeltaX)nn    if (absDeltax &lt;= SWIPE_THRESHOLD) {n    
returnn    }nn    const direction = absDeltax / this.touchDeltaXnn    //
swipe leftn    if (direction &gt; 0) {n      this.prev()n    }nn    //
swipe rightn    if (direction &lt; 0) {n      this.next()n    }n  }nn 
_addEventListeners() {n    if (this._config.keyboard) {n     
$(this._element)n        .on(Event.KEYDOWN, (event) =&gt;
this._keydown(event))n    }nn    if (this._config.pause ===
&#39;hover&#39;) {n      $(this._element)n        .on(Event.MOUSEENTER,
(event) =&gt; this.pause(event))n        .on(Event.MOUSELEAVE, (event)
...
=&gt; {n      if (this._pointerEvent &amp;&amp; <a
href="event.originalEvent.pointerType.toUpperCase()">PointerType</a>) {n   
this.touchStartX = event.originalEvent.clientXn      } else if
(!this._pointerEvent) {n        this.touchStartX = <a
href="0">event.originalEvent.touches</a>.clientXn      }n    }nn    const
move = (event) =&gt; {n      // ensure swiping with one touch and not
pinchingn      if (event.originalEvent.touches &amp;&amp;
event.originalEvent.touches.length &gt; 1) {n        this.touchDeltaX = 0n 
} else {n        this.touchDeltaX = <a
href="0">event.originalEvent.touches</a>.clientX - this.touchStartXn     
}n    }nn    const end = (event) =&gt; {n      if (this._pointerEvent
&amp;&amp; <a
href="event.originalEvent.pointerType.toUpperCase()">PointerType</a>) {n   
...
listen for touchend, explicitly pause the carouseln        // (as if
it&#39;s the second time we tap on it, mouseenter compat eventn        //
...
&amp;&amp; activeIndex === lastItemIndexnn    if (isGoingToWrap &amp;&amp;
!this._config.wrap) {n      return activeElementn    }nn    const delta    
= direction === Direction.PREV ? -1 : 1n    const itemIndex = (activeIndex
+ delta) % this._items.lengthnn    return itemIndex === -1n      ?
this._items[this._items.length - 1] : <a href="itemIndex">this._items</a>n 
}nn  _triggerSlideEvent(relatedTarget, eventDirectionName) {n    const
...
nextElementInterval =
parseInt(nextElement.getAttribute(&#39;data-interval&#39;), 10)n      if
(nextElementInterval) {n        this._config.defaultInterval =
...
(typeof config === &#39;object&#39;) {n        _config = {n         
…_config,n          …confign        }n      }nn      const action = typeof
config === &#39;string&#39; ? config : _config.slidenn      if (!data) {n  
data = new Carousel(this, _config)n        $(this).data(DATA_KEY, data)n   
}nn      if (typeof config === &#39;number&#39;) {n        data.to(config)n
} else if (typeof action === &#39;string&#39;) {n        if (typeof <a
href="action">data</a> === &#39;undefined&#39;) {n          throw new
TypeError(`No method named "${action}&quot;`)n        }n        <a
href="action">data</a>()n      } else if (_config.interval &amp;&amp;
_config.ride) {n        data.pause()n        data.cycle()n      }n    })n 
}nn  static _dataApiClickHandler(event) {n    const selector =
Util.getSelectorFromElement(this)nn    if (!selector) {n      returnn   
}nn    const target = $(<a href="0">selector)</a>nn    if (!target ||
!$(target).hasClass(ClassName.CAROUSEL)) {n      returnn    }nn    const
config = {n      …$(target).data(),n      …$(this).data()n    }n    const
slideIndex = this.getAttribute(&#39;data-slide-to&#39;)nn    if
