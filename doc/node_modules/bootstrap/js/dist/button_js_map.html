...
<title>button.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/button.js.map">

<p>{“<a
href=""../src/button.js"">version”:3,“file”:“button.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): button.jsn * Licensed
under MIT (<a
...
&#39;4.3.1&#39;nconst DATA_KEY            = &#39;bs.button&#39;nconst
EVENT_KEY           = `.${DATA_KEY}`nconst DATA_API_KEY        =
&#39;.data-api&#39;nconst JQUERY_NO_CONFLICT  = $.<a
href="NAME">fn</a>nnconst ClassName = {n  ACTIVE : &#39;active&#39;,n 
BUTTON : &#39;btn&#39;,n  FOCUS  : &#39;focus&#39;n}nnconst Selector = {n 
DATA_TOGGLE_CARROT : &#39;[data-toggle^=&quot;button&quot;]&#39;,n 
DATA_TOGGLE        : &#39;[data-toggle=&quot;buttons&quot;]&#39;,n  INPUT  
: &#39;<a href="type=\"hidden\"">input:not(</a>)&#39;,n  ACTIVE            
: &#39;.active&#39;,n  BUTTON             : &#39;.btn&#39;n}nnconst Event =
{n  CLICK_DATA_API      : `click${EVENT_KEY}${DATA_API_KEY}`,n 
...
if (config === &#39;toggle&#39;) {n        <a href="config">data</a>()n    
}n    })n  }n}nn/**n * ————————————————————————n * Data <a
