...
<title>util.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/util.js.map">

<p>{“<a
href=""../src/util.js"">version”:3,“file”:“util.js”,“sources”:</a>,“sourcesContent”:[“
...
————————————————————————n   nnconst TRANSITION_END =
&#39;transitionend&#39;nconst MAX_UID = 1000000nconst
MILLISECONDS_MULTIPLIER = 1000nn// Shoutout AngusCroll (<a
href="https://goo.gl/pxwQGp)\nfunction">goo.gl/pxwQGp)nfunction</a>
toType(obj) {n  return {}.<a
href="a-z">toString.call(obj).match(/\s(</a>+)/<a
href="1">i)</a>.toLowerCase()n}nnfunction getSpecialTransitionEndEvent() {n
return {n    bindType: TRANSITION_END,n    delegateType: TRANSITION_END,n  
handle(event) {n      if ($(event.target).is(this)) {n        return
...
transitionEndEmulatorn  $.<a href="Util.TRANSITION_END">event.special</a> =
...
=== &#39;#&#39;) {n      const hrefAttr =
element.getAttribute(&#39;href&#39;)n      selector = hrefAttr &amp;&amp;
hrefAttr !== &#39;#&#39; ? hrefAttr.trim() : &#39;&#39;n    }nn    try {n  
