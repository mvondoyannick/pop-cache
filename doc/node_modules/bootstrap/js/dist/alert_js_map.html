...
<title>alert.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/dist/alert.js.map">

<p>{“<a
href=""../src/alert.js"">version”:3,“file”:“alert.js”,“sources”:</a>,“sourcesContent”:[“
n * ————————————————————————–n * Bootstrap (v4.3.1): alert.jsn * Licensed
under MIT (<a
...
————————————————————————n   nnconst NAME                =
&#39;alert&#39;nconst VERSION             = &#39;4.3.1&#39;nconst DATA_KEY 
= &#39;bs.alert&#39;nconst EVENT_KEY           = `.${DATA_KEY}`nconst
DATA_API_KEY        = &#39;.data-api&#39;nconst JQUERY_NO_CONFLICT  = $.<a
href="NAME">fn</a>nnconst Selector = {n  DISMISS :
&#39;[data-dismiss=&quot;alert&quot;]&#39;n}nnconst Event = {n  CLOSE      
: `close${EVENT_KEY}`,n  CLOSED         : `closed${EVENT_KEY}`,n 
CLICK_DATA_API : `click${EVENT_KEY}${DATA_API_KEY}`n}nnconst ClassName = {n
ALERT : &#39;alert&#39;,n  FADE  : &#39;fade&#39;,n  SHOW  :
&#39;show&#39;n}nn/**n * ————————————————————————n * Class Definitionn *
————————————————————————n */nnclass Alert {n  constructor(element) {n   
this._element = elementn  }nn  // Gettersnn  static get VERSION() {n   
return VERSIONn  }nn  // Publicnn  close(element) {n    let rootElement =
this._elementn    if (element) {n      rootElement =
this._getRootElement(element)n    }nn    const customEvent =
