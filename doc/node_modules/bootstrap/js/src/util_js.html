...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/util.js">
...
<p>const TRANSITION_END = &#39;transitionend&#39; const MAX_UID = 1000000
const MILLISECONDS_MULTIPLIER = 1000</p>

<p>// Shoutout AngusCroll (<a href="https://goo.gl/pxwQGp">goo.gl/pxwQGp</a>)
function toType(obj) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> {}.<span class="ruby-identifier">toString</span>.<span class="ruby-identifier">call</span>(<span class="ruby-identifier">obj</span>).<span class="ruby-identifier">match</span>(<span class="ruby-regexp">/\s([a-z]+)/i</span>)[<span class="ruby-value">1</span>].<span class="ruby-identifier">toLowerCase</span>()
</pre>

<p>}</p>

<p>function getSpecialTransitionEndEvent() {</p>
...
<p>function transitionEndEmulator(duration) {</p>
...
<p>function setTransitionEndSupport() {</p>

<pre>$.fn.emulateTransitionEnd = transitionEndEmulator
$.event.special[Util.TRANSITION_END] = getSpecialTransitionEndEvent()</pre>
...
<pre>TRANSITION_END: &#39;bsTransitionEnd&#39;,
