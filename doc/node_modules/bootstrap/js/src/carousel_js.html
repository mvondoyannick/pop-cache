...
<title>carousel.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/carousel.js">
...
<p>import $ from &#39;jquery&#39; import Util from &#39;./util&#39;</p>
...
<p>const NAME                   = &#39;carousel&#39; const VERSION            
= &#39;4.3.1&#39; const DATA_KEY               = &#39;bs.carousel&#39;
const EVENT_KEY              = `.${DATA_KEY}` const DATA_API_KEY          
= &#39;.data-api&#39; const JQUERY_NO_CONFLICT     = $.<a
href="NAME">fn</a> const ARROW_LEFT_KEYCODE     = 37 // KeyboardEvent.which
value for left arrow key const ARROW_RIGHT_KEYCODE    = 39 //
KeyboardEvent.which value for right arrow key const TOUCHEVENT_COMPAT_WAIT
= 500 // Time for mouse compat events to fire after touch const
SWIPE_THRESHOLD        = 40</p>
...
CLICK_DATA_API : `click${EVENT_KEY}${DATA_API_KEY}`</pre>

<p>}</p>

<p>const ClassName = {</p>

<pre>CAROUSEL      : &#39;carousel&#39;,
ACTIVE        : &#39;active&#39;,
SLIDE         : &#39;slide&#39;,
...
ITEM          : &#39;carousel-item&#39;,
POINTER_EVENT : &#39;pointer-event&#39;</pre>
...
DATA_RIDE   : &#39;[data-ride=&quot;carousel&quot;]&#39;</pre>

<p>}</p>

<p>const PointerType = {</p>
...
<pre>.on(Event.CLICK_DATA_API, Selector.DATA_SLIDE, Carousel._dataApiClickHandler)</pre>

<p>$(window).on(Event.LOAD_DATA_API, () =&gt; {</p>

<pre>const carousels = [].slice.call(document.querySelectorAll(Selector.DATA_RIDE))
...
<p>$.<a href="NAME">fn</a> = Carousel._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Carousel $.<a
href="NAME">fn</a>.noConflict = () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Carousel._jQueryInterface</pre>
