...
<title>collapse.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/collapse.js">
...
<p>const NAME                = &#39;collapse&#39; const VERSION             =
&#39;4.3.1&#39; const DATA_KEY            = &#39;bs.collapse&#39; const
EVENT_KEY           = `.${DATA_KEY}` const DATA_API_KEY        =
&#39;.data-api&#39; const JQUERY_NO_CONFLICT  = $.<a href="NAME">fn</a></p>
...
<pre>toggle : &#39;boolean&#39;,
parent : &#39;(string|element)&#39;</pre>

<p>}</p>

<p>const Event = {</p>

<pre>SHOW           : `show${EVENT_KEY}`,
...
<pre>ACTIVES     : &#39;.show, .collapsing&#39;,
DATA_TOGGLE : &#39;[data-toggle=&quot;collapse&quot;]&#39;</pre>
...
<p>$(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event)
{</p>

<pre>// preventDefault only for &lt;a&gt; elements (which change the URL) not inside the collapsible element
...
<p>$.<a href="NAME">fn</a> = Collapse._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Collapse $.<a
href="NAME">fn</a>.noConflict = () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Collapse._jQueryInterface</pre>

<p>}</p>

<p>export default Collapse</p>
</main>
