...
<title>scrollspy.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/scrollspy.js">
...
<p>const NAME               = &#39;scrollspy&#39; const VERSION            =
&#39;4.3.1&#39; const DATA_KEY           = &#39;bs.scrollspy&#39; const
...
<pre>offset : &#39;number&#39;,
method : &#39;string&#39;,
target : &#39;(string|element)&#39;</pre>

<p>}</p>

<p>const Event = {</p>

<pre>ACTIVATE      : `activate${EVENT_KEY}`,
SCROLL        : `scroll${EVENT_KEY}`,
LOAD_DATA_API : `load${EVENT_KEY}${DATA_API_KEY}`</pre>

<p>}</p>

<p>const ClassName = {</p>

<pre>DROPDOWN_ITEM : &#39;dropdown-item&#39;,
...
DROPDOWN_TOGGLE : &#39;.dropdown-toggle&#39;</pre>

<p>}</p>

<p>const OffsetMethod = {</p>
...
<pre>const scrollSpys = [].slice.call(document.querySelectorAll(Selector.DATA_SPY))
...
<p>$.<a href="NAME">fn</a> = ScrollSpy._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = ScrollSpy $.<a
href="NAME">fn</a>.noConflict = () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return ScrollSpy._jQueryInterface</pre>

<p>}</p>

<p>export default ScrollSpy</p>
</main>
