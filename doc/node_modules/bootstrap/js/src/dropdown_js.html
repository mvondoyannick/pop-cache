...
<title>dropdown.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/dropdown.js">
...
<p>import $ from &#39;jquery&#39; import Popper from &#39;popper.js&#39;
...
<p>const NAME                     = &#39;dropdown&#39; const VERSION          
= &#39;4.3.1&#39; const DATA_KEY                 = &#39;bs.dropdown&#39;
const EVENT_KEY                = `.${DATA_KEY}` const DATA_API_KEY         
= &#39;.data-api&#39; const JQUERY_NO_CONFLICT       = $.<a
href="NAME">fn</a> const ESCAPE_KEYCODE           = 27 //
KeyboardEvent.which value for Escape (Esc) key const SPACE_KEYCODE         
= 32 // KeyboardEvent.which value for space key const TAB_KEYCODE          
= 9 // KeyboardEvent.which value for tab key const ARROW_UP_KEYCODE        
= 38 // KeyboardEvent.which value for up arrow key const ARROW_DOWN_KEYCODE
= 40 // KeyboardEvent.which value for down arrow key const
RIGHT_MOUSE_BUTTON_WHICH = 3 // MouseEvent.which value for the right button
(assuming a right-handed mouse) const REGEXP_KEYDOWN           = new
RegExp(`${ARROW_UP_KEYCODE}|${ARROW_DOWN_KEYCODE}|${ESCAPE_KEYCODE}`)</p>

<p>const Event = {</p>

<pre>HIDE             : `hide${EVENT_KEY}`,
...
KEYUP_DATA_API   : `keyup${EVENT_KEY}${DATA_API_KEY}`</pre>
...
POSITION_STATIC : &#39;position-static&#39;</pre>

<p>}</p>

<p>const Selector = {</p>

<pre>DATA_TOGGLE   : &#39;[data-toggle=&quot;dropdown&quot;]&#39;,
FORM_CHILD    : &#39;.dropdown form&#39;,
MENU          : &#39;.dropdown-menu&#39;,
NAVBAR_NAV    : &#39;.navbar-nav&#39;,
VISIBLE_ITEMS : &#39;.dropdown-menu .dropdown-item:not(.disabled):not(:disabled)&#39;</pre>

<p>}</p>

<p>const AttachmentMap = {</p>
...
<p>const DefaultType = {</p>

<pre>offset    : &#39;(number|string|function)&#39;,
flip      : &#39;boolean&#39;,
...
<pre>constructor(element, config) {
...
<pre>.on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Dropdown._dataApiKeydownHandler)
...
<p>$.<a href="NAME">fn</a> = Dropdown._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Dropdown $.<a
href="NAME">fn</a>.noConflict = () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Dropdown._jQueryInterface</pre>
