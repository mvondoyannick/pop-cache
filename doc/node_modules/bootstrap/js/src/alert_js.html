...
<title>alert.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/alert.js">
...
<p>const NAME                = &#39;alert&#39; const VERSION             =
&#39;4.3.1&#39; const DATA_KEY            = &#39;bs.alert&#39; const
EVENT_KEY           = `.${DATA_KEY}` const DATA_API_KEY        =
&#39;.data-api&#39; const JQUERY_NO_CONFLICT  = $.<a href="NAME">fn</a></p>

<p>const Selector = {</p>

<pre>DISMISS : &#39;[data-dismiss=&quot;alert&quot;]&#39;</pre>

<p>}</p>

<p>const Event = {</p>

<pre>CLOSE          : `close${EVENT_KEY}`,
...
<pre>Event.CLICK_DATA_API,
Selector.DISMISS,
Alert._handleDismiss(new Alert())</pre>
...
<p>$.<a href="NAME">fn</a>             = Alert._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Alert $.<a href="NAME">fn</a>.noConflict 
= () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Alert._jQueryInterface</pre>

<p>}</p>

<p>export default Alert</p>
</main>
