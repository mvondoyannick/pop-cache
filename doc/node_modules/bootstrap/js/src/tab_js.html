...
<title>tab.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/tab.js">
...
<p>const NAME               = &#39;tab&#39; const VERSION            =
&#39;4.3.1&#39; const DATA_KEY           = &#39;bs.tab&#39; const EVENT_KEY
= `.${DATA_KEY}` const DATA_API_KEY       = &#39;.data-api&#39; const
JQUERY_NO_CONFLICT = $.<a href="NAME">fn</a></p>
...
<pre>DROPDOWN_MENU : &#39;dropdown-menu&#39;,
ACTIVE        : &#39;active&#39;,
DISABLED      : &#39;disabled&#39;,
FADE          : &#39;fade&#39;,
SHOW          : &#39;show&#39;</pre>
...
DROPDOWN_ACTIVE_CHILD : &#39;&gt; .dropdown-menu .active&#39;</pre>
...
<pre>.on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
...
<p>$.<a href="NAME">fn</a> = Tab._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Tab $.<a href="NAME">fn</a>.noConflict =
() =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Tab._jQueryInterface</pre>
