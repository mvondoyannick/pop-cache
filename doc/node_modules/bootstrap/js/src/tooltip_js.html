...
<title>tooltip.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/tooltip.js">
...
<pre>DefaultWhitelist,
sanitizeHtml</pre>

<p>} from &#39;./tools/sanitizer&#39; import $ from &#39;jquery&#39; import
Popper from &#39;popper.js&#39; import Util from &#39;./util&#39;</p>
...
<p>const NAME                  = &#39;tooltip&#39; const VERSION              
= &#39;4.3.1&#39; const DATA_KEY              = &#39;bs.tooltip&#39; const
EVENT_KEY             = `.${DATA_KEY}` const JQUERY_NO_CONFLICT    = $.<a
href="NAME">fn</a> const CLASS_PREFIX          = &#39;bs-tooltip&#39; const
BSCLS_PREFIX_REGEX    = new RegExp(`(^|\s)${CLASS_PREFIX}\S+`, &#39;g&#39;)
const DISALLOWED_ATTRIBUTES = [&#39;sanitize&#39;, &#39;whiteList&#39;,
&#39;sanitizeFn&#39;]</p>

<p>const DefaultType = {</p>

<pre>animation         : &#39;boolean&#39;,
template          : &#39;string&#39;,
...
sanitize          : true,
sanitizeFn        : null,
whiteList         : DefaultWhitelist</pre>

<p>}</p>

<p>const HoverState = {</p>
...
MOUSELEAVE : `mouseleave${EVENT_KEY}`</pre>
...
<p>$.<a href="NAME">fn</a> = Tooltip._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Tooltip $.<a href="NAME">fn</a>.noConflict
= () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Tooltip._jQueryInterface</pre>

<p>}</p>

<p>export default Tooltip</p>
</main>
