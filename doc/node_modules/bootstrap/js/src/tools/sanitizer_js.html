...
<title>sanitizer.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/tools/sanitizer.js">
...
<p>const ARIA_ATTRIBUTE_PATTERN = /^<a href="\w-">aria-</a>*$/i</p>

<p>export const DefaultWhitelist = {</p>

<pre>// Global attributes allowed on any supplied element below.
...
<pre> A pattern that recognizes a commonly useful subset of URLs that are safe.

 Shoutout to Angular 7 https://github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.ts
/</pre>

<p>const SAFE_URL_PATTERN = /^(?:(?:<a
href="^&:/?#">https?|mailto|ftp|tel|file):|</a>*(?:[/?#]|$))/gi</p>

<p>/**</p>

<pre> A pattern that matches safe data URLs. Only matches image, video and audio types.

 Shoutout to Angular 7 https://github.com/angular/angular/blob/7.2.4/packages/core/src/sanitization/url_sanitizer.ts
/</pre>

<p>const DATA_URL_PATTERN = /^<a
href="a-z0-9+/">data:(?:image/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video/(?:mpeg|mp4|ogg|webm)|audio/(?:mp3|oga|ogg|opus));base64,</a>+=*$/i</p>

<p>function allowedAttribute(attr, allowedAttributeList) {</p>

<pre>const attrName = attr.nodeName.toLowerCase()
...
<p>export function sanitizeHtml(unsafeHtml, whiteList, sanitizeFn) {</p>

<pre>if (unsafeHtml.length === 0) {
  return unsafeHtml
}
...
return createdDocument.body.innerHTML</pre>
