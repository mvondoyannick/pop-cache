...
<title>popover.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bootstrap/js/src/popover.js">
...
<p>import $ from &#39;jquery&#39; import Tooltip from &#39;./tooltip&#39;</p>
...
<p>const NAME                = &#39;popover&#39; const VERSION             =
&#39;4.3.1&#39; const DATA_KEY            = &#39;bs.popover&#39; const
EVENT_KEY           = `.${DATA_KEY}` const JQUERY_NO_CONFLICT  = $.<a
href="NAME">fn</a> const CLASS_PREFIX        = &#39;bs-popover&#39; const
BSCLS_PREFIX_REGEX  = new RegExp(`(^|\s)${CLASS_PREFIX}\S+`, &#39;g&#39;)</p>
...
template  : &#39;&lt;div class=&quot;popover&quot; role=&quot;tooltip&quot;&gt;&#39; +
            ...
            &#39;&lt;div class=&quot;popover-body&quot;&gt;&lt;/div&gt;&lt;/div&gt;&#39;</pre>

<p>}</p>

<p>const DefaultType = {</p>

<pre>...Tooltip.DefaultType,
content : &#39;(string|element|function)&#39;</pre>
...
<pre>TITLE   : &#39;.popover-header&#39;,
CONTENT : &#39;.popover-body&#39;</pre>
...
<p>class Popover extends Tooltip {</p>
...
<p>$.<a href="NAME">fn</a> = Popover._jQueryInterface $.<a
href="NAME">fn</a>.Constructor = Popover $.<a href="NAME">fn</a>.noConflict
= () =&gt; {</p>

<pre>$.fn[NAME] = JQUERY_NO_CONFLICT
return Popover._jQueryInterface</pre>

<p>}</p>

<p>export default Popover</p>
</main>
