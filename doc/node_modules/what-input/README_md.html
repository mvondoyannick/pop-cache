...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-What+Input-3F">What Input?</a>
    <li><a href="#label-What+Input+is+now+v5">What Input is now v5</a>
    <li><a href="#label-How+it+works">How it works</a>
    <li><a href="#label-Demo">Demo</a>
    <li><a href="#label-Interacting+with+Forms">Interacting with Forms</a>
    <li><a href="#label-Installing">Installing</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-Basic+Styling">Basic Styling</a>
    <li><a href="#label-Scripting">Scripting</a>
    <li><a href="#label-Current+Input">Current Input</a>
    <li><a href="#label-Current+Element">Current Element</a>
    <li><a href="#label-Ignore+Keys">Ignore Keys</a>
    <li><a href="#label-Specific+Keys">Specific Keys</a>
    <li><a href="#label-Custom+Callbacks">Custom Callbacks</a>
    <li><a href="#label-Compatibility">Compatibility</a>
    <li><a href="#label-Changelog">Changelog</a>
    <li><a href="#label-v5.1.3">v5.1.3</a>
    <li><a href="#label-v5.1.2">v5.1.2</a>
    <li><a href="#label-v5.1.1">v5.1.1</a>
    <li><a href="#label-v5.1.0">v5.1.0</a>
    <li><a href="#label-v5.0.7">v5.0.7</a>
    <li><a href="#label-v5.0.5">v5.0.5</a>
    <li><a href="#label-v5.0.3">v5.0.3</a>
    <li><a href="#label-Changes+from+v4">Changes from v4</a>
...
<main role="main" aria-label="Page node_modules/what-input/README.md">

<h1 id="label-What+Input-3F">What Input?<span><a href="#label-What+Input-3F">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>A global utility for tracking the current input method (mouse, keyboard or
touch).**</p>

<h2 id="label-What+Input+is+now+v5">What Input is now v5<span><a href="#label-What+Input+is+now+v5">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Now with more information and less opinion!</p>

<p>What Input adds data attributes to the <code>window</code> based on the
type of input being used. It also exposes a simple API that can be used for
scripting interactions.</p>

<h2 id="label-How+it+works">How it works<span><a href="#label-How+it+works">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>What Input uses event bubbling on the <code>window</code> to watch for
mouse, keyboard and touch events (via <code>mousedown</code>,
<code>keydown</code> and <code>touchstart</code>). It then sets or updates
a <code>data-whatinput</code> attribute.</p>

<p>Pointer Events are supported but note that <code>pen</code> inputs are
remapped to <code>touch</code>.</p>

<p>What Input also exposes a tiny API that allows the developer to ask for the
current input, set custom ignore keys, and set and remove custom callback
functions.</p>

<p><em>What Input does not make assumptions about the input environment before
the page is interacted with.</em> However, the <code>mousemove</code> and
<code>pointermove</code> events are used to set a
<code>data-whatintent=&quot;mouse&quot;</code> attribute to indicate that a
mouse is being used <em>indirectly</em>.</p>

<h2 id="label-Demo">Demo<span><a href="#label-Demo">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Check out the demo to see What Input in action.</p>

<p><a
href="https://ten1seven.github.io/what-input">ten1seven.github.io/what-input</a></p>

<h3 id="label-Interacting+with+Forms">Interacting with Forms<span><a href="#label-Interacting+with+Forms">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Since interacting with a form <em>always</em> requires use of the keyboard,
What Input uses the <code>data-whatintent</code> attribute to display a
“buffered” version of input events while form <code>&lt;input&gt;</code>s,
<code>&lt;select&gt;</code>s, and <code>&lt;textarea&gt;</code>s are being
interacted with (i.e. mouse user&#39;s <code>data-whatintent</code> will be
preserved as <code>mouse</code> while typing).</p>
...
<pre class="ruby"><span class="ruby-identifier">yarn</span> <span class="ruby-identifier">add</span> <span class="ruby-identifier">what</span><span class="ruby-operator">-</span><span class="ruby-identifier">input</span>
</pre>

<p>Install via NPM:</p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">what</span><span class="ruby-operator">-</span><span class="ruby-identifier">input</span>
</pre>
...
<pre>&lt;script src=&quot;path/to/what-input.js&quot;&gt;&lt;/script&gt;</pre>

<p>Or require with a script loader.</p>

<pre class="ruby"><span class="ruby-identifier">import</span> <span class="ruby-string">&#39;what-input&#39;</span>

<span class="ruby-regexp">//</span> <span class="ruby-keyword">or</span>

<span class="ruby-identifier">import</span> <span class="ruby-identifier">whatInput</span> <span class="ruby-identifier">from</span> <span class="ruby-string">&#39;what-input&#39;</span>

<span class="ruby-regexp">//</span> <span class="ruby-keyword">or</span>

<span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;what-input&#39;</span>)

<span class="ruby-regexp">//</span> <span class="ruby-keyword">or</span>

<span class="ruby-identifier">var</span> <span class="ruby-identifier">whatInput</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;what-input&#39;</span>)

<span class="ruby-regexp">//</span> <span class="ruby-keyword">or</span>

<span class="ruby-identifier">requirejs</span>.<span class="ruby-identifier">config</span>({
  <span class="ruby-value">paths:</span> {
    <span class="ruby-value">whatInput:</span> <span class="ruby-string">&#39;path/to/what-input&#39;</span>
  }
})

<span class="ruby-identifier">require</span>([<span class="ruby-string">&#39;whatInput&#39;</span>], <span class="ruby-identifier">function</span>() {})
</pre>

<p>What Input will start doing its thing while you do yours.</p>

<h3 id="label-Basic+Styling">Basic Styling<span><a href="#label-Basic+Styling">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
<p>Note:** If you remove outlines with <code>outline: none;</code>, be sure to
provide clear visual <code>:focus</code> styles so the user can see which
element they are on at any time for greater accessibility. Visit <a
href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/navigation-mechanisms-focus-visible.html">W3C’s
WCAG 2.0 2.4.7 Guideline</a> to learn more.</p>

<h3 id="label-Scripting">Scripting<span><a href="#label-Scripting">&para;</a> <a href="#top">&uarr;</a></span></h3>

<h4 id="label-Current+Input">Current Input<span><a href="#label-Current+Input">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Ask What Input what the current input method is. This works best if asked
after the events What Input is bound to (<code>mousedown</code>,
<code>keydown</code> and <code>touchstart</code>).</p>

<pre>whatInput.ask() // returns `mouse`, `keyboard` or `touch`
...
<p>If it&#39;s necessary to know if <code>mousemove</code> is being used, use
the <code>&#39;intent&#39;</code> option. For example:</p>
...
whatInput.ask(&#39;intent&#39;) // returns `mouse` because mouse movement was the most recent action detected</pre>

<h3 id="label-Current+Element">Current Element<span><a href="#label-Current+Element">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Ask What Input the currently focused DOM element.</p>

<pre>whatInput.element() // returns a string, like `input` or null</pre>

<h4 id="label-Ignore+Keys">Ignore Keys<span><a href="#label-Ignore+Keys">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Set a custom array of <a href="http://keycode.info/">keycodes</a> that will
be ignored (will not switch over to <code>keyboard</code>) when pressed.
<em>A custom list will overwrite the default values.</em></p>
...
whatInput.ignoreKeys([1, 2, 3])</pre>

<h4 id="label-Specific+Keys">Specific Keys<span><a href="#label-Specific+Keys">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Set a custom array of <a href="http://keycode.info/">keycodes</a> that will
trigger the keyboard pressed intent (will not switch to
<code>keyboard</code> unless these keys are pressed). <em>This overrides
ignoreKeys.</em></p>

<pre>// only listen to tab keyboard press
whatInput.specificKeys([9])</pre>

<h4 id="label-Custom+Callbacks">Custom Callbacks<span><a href="#label-Custom+Callbacks">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>Fire a function when the input or intent changes.</p>

<pre>// create a function to be fired
...
// remove custom event
whatInput.unRegisterOnChange(myFunction)</pre>

<h2 id="label-Compatibility">Compatibility<span><a href="#label-Compatibility">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>What Input works in all modern browsers.</p>

<h2 id="label-Changelog">Changelog<span><a href="#label-Changelog">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-v5.1.3">v5.1.3<span><a href="#label-v5.1.3">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Added:</strong> Sourcemap for the minified version.</p>
</li></ul>

<h3 id="label-v5.1.2">v5.1.2<span><a href="#label-v5.1.2">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Added:</strong> <code>specificKeys</code> functionality to allow
overriding of keyboard keys list. Fix via <a
href="https://github.com/bk3">bk3</a>.</p>
</li></ul>

<h3 id="label-v5.1.1">v5.1.1<span><a href="#label-v5.1.1">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Fixed:</strong> Browsers with cookies turned off would throw an
error with session storage. Fix via <a
href="https://github.com/yuheiy">yuheiy</a>.</p>
</li></ul>

<h3 id="label-v5.1.0">v5.1.0<span><a href="#label-v5.1.0">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Added:</strong> Session variable stores last used input and intent
so subsiquent page loads don&#39;t have to wait for interactions to set the
correct input and intent state.</p>
</li><li>
<p><strong>Removed:</strong> IE8 support.</p>
</li></ul>

<h3 id="label-v5.0.7">v5.0.7<span><a href="#label-v5.0.7">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Fixed:</strong> <code>unRegisterOnChange</code> failed to
unregister items at index 0.</p>
</li></ul>

<h3 id="label-v5.0.5">v5.0.5<span><a href="#label-v5.0.5">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Fixed:</strong> Fail gracefully in non-DOM environments.</p>
</li></ul>

<h3 id="label-v5.0.3">v5.0.3<span><a href="#label-v5.0.3">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Fixed:</strong> Event buffer for touch was not working correctly.</p>
</li></ul>

<h3 id="label-Changes+from+v4">Changes from v4<span><a href="#label-Changes+from+v4">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><strong>Added:</strong> A the ability to add and remove custom callback
function when the input or intent changes with
<code>whatInput.registerOnChange</code> and
<code>whatInput.unRegisterOnChange</code>.</p>
</li><li>
<p><strong>Added:</strong> A <code>data-whatelement</code> attribute exposes
any currently focused DOM element (i.e.
<code>data-whatelement=&quot;a&quot;</code> or
<code>data-whatelement=&quot;input&quot;</code>).</p>
</li><li>
<p><strong>Added:</strong> A <code>data-whatclasses</code> attribute exposes
any currently focused element&#39;s classes as a comma-separated list (i.e.
<code>data-whatclasses=&quot;class1,class2&quot;</code>).</p>
</li><li>
<p><strong>Added:</strong> An API option to provide a custom array of keycodes
that will be ignored.</p>
</li><li>
<p><strong>Changed:</strong> Typing in form fields is no longer filtered out.
The <code>data-whatinput</code> attribute immediately reflects the current
input. The <code>data-whatintent</code> attribute now takes on the role of
remembering mouse input prior to typing in or clicking on a form field.</p>
</li><li>
<p><strong>Changed:</strong> If you use the Tab key to move from one input to
another one - the <code>data-whatinput</code> attribute reflects the
current input (switches to “keyboard”).</p>
</li><li>
<p><strong>Removed:</strong> <code>whatInput.types()</code> API option.</p>
</li><li>
<p><strong>Removed:</strong> Bower support.</p>
</li><li>
<p><strong>Fixed:</strong> Using mouse modifier keys (<code>shift</code>,
<code>control</code>, <code>alt</code>, <code>cmd</code>) no longer toggles
back to keyboard.</p>
</li></ul>

<h2 id="label-Acknowledgments">Acknowledgments<span><a href="#label-Acknowledgments">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Special thanks to <a href="http://viget.com/">Viget</a> for their
encouragement and commitment to open source projects. Visit <a
href="http://code.viget.com/">code.viget.com</a> to see more projects from
<a href="http://viget.com">Viget</a>.</p>

<p>Thanks to <a href="https://github.com/mAAdhaTTah">mAAdhaTTah</a> for the
initial conversion to Webpack.</p>

<p>What Input is written and maintained by <a
href="https://github.com/ten1seven">@ten1seven</a>.</p>

<h2 id="label-License"><a href="../admin-lte/plugins/datatables/extensions/ColReorder/License_txt.html">License</a><span><a href="#label-License">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>What Input is freely available under the <a
