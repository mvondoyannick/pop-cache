...
<main role="main" aria-label="Page node_modules/what-input/Gulpfile.js">

<pre class="ruby"><span class="ruby-identifier">load</span> <span class="ruby-identifier">plugins</span>
</pre>

<p>const pkg = require(&#39;./package.json&#39;)</p>
...
<p>// gulp const gulp = require(&#39;gulp&#39;)</p>

<p>// load all plugins in “devDependencies” into the letiable $ const $ =
require(&#39;gulp-load-plugins&#39;)({</p>

<pre>pattern: [&#39;*&#39;],
scope: [&#39;devDependencies&#39;]</pre>
...
<pre>return $.del([&#39;**/.DS_Store&#39;, &#39;./build/*&#39;, &#39;./dist/*&#39;])</pre>
...
<pre>return gulp
  ...
  .pipe(gulp.dest(&#39;./dist/&#39;))
  .pipe($.notify(&#39;Build complete&#39;))</pre>
...
return gulp
  ...
  .pipe($.notify(&#39;Styles task complete&#39;))</pre>
...
<p>gulp.task(&#39;markup&#39;, () =&gt; {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">src</span>([<span class="ruby-string">&#39;./src/markup/*&#39;</span>]).<span class="ruby-identifier">pipe</span>(<span class="ruby-identifier">gulp</span>.<span class="ruby-identifier">dest</span>(<span class="ruby-string">&#39;./build&#39;</span>))
</pre>
...
<p>gulp.task(&#39;deploy&#39;, () =&gt; {</p>

<pre>return gulp.src(&#39;./build/**/*&#39;).pipe($.ghPages())</pre>
...
<p>gulp.task(&#39;default&#39;, () =&gt; {</p>

<pre>$.runSequence(&#39;clean&#39;, [&#39;markup&#39;, &#39;scripts&#39;, &#39;styles&#39;, &#39;images&#39;], () =&gt; {
  $.browserSync.init({
    server: {
      baseDir: &#39;./build/&#39;
    }
