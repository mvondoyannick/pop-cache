...
<title>what-input.min.js.map - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/what-input/dist/maps/what-input.min.js.map">

<p>{“<a
href=""what-input.min.js","what-input.js"">version”:3,“sources”:</a>,“<a
href=""root","factory","exports","module","define","amd","this","modules","installedModules","webpack_require","moduleId","id","loaded","call","m","c","p","document","window","ask","element","ignoreKeys","specificKeys","registerOnChange","unRegisterOnChange","docElem","documentElement","currentElement","currentInput","currentIntent","sessionStorage","getItem","e","eventTimer","formInputs","functionList","ignoreMap","specificMap","inputMap","keydown","keyup","mousedown","mousemove","MSPointerDown","MSPointerMove","pointerdown","pointermove","touchstart","isBuffering","isScrolling","mousePos","x","y","pointerMap","2","3","4","supportsPassive","opts","Object","defineProperty","get","addEventListener","addListeners","options","passive","PointerEvent","setInput","setIntent","MSPointerEvent","eventBuffer","detectWheel","setElement","clearElement","event","eventKey","which","value","type","pointerType","ignoreMatch","length","indexOf","specificMatch","shouldUpdate","setItem","doUpdate","activeElem","activeElement","nodeName","toLowerCase","setAttribute","fireFunctions","detectScrolling","target","classList","toString","replace","removeAttribute","clearTimeout","setTimeout","createElement","undefined","onmousewheel","i","len","fn","screenX","screenY","Array","prototype","opt","arr","eventType","push","position","match","objPos","splice"">names”:</a>,“mappings”:“AAAA;AACA;AACA;AACA;AACA;AACA;AACA,CCNA,SAAAA,EAAAC,GACA,iBAAAC,SAAA,iBAAAC,OACAA,OAAAD,QAAAD,IACA,mBAAAG,QAAAA,OAAAC,IACAD,OAAA,YAAA,GAAAH,GACA,iBAAAC,QALAA,QAAA,UAAAD,IAEAD,EAAA,UAAAC,IAFA,CAGAK,KAAA,WACA,OAAA,SAAAC,GAEA,IAAAC,EAAA,GAGA,SAAAC,EAAAC,GAGA,GAAAF,EAAAE,GACA,OAAAF,EAAAE,GAAAR,QAGA,IAAAC,EAAAK,EAAAE,GAAA,CACAR,QAAA,GACAS,GAAAD,EACAE,QAAA,GAUA,OANAL,EAAAG,GAAAG,KAAAV,EAAAD,QAAAC,EAAAA,EAAAD,QAAAO,GAGAN,EAAAS,QAAA,EAGAT,EAAAD,QAcA,OATAO,EAAAK,EAAAP,EAGAE,EAAAM,EAAAP,EAGAC,EAAAO,EAAA,GAGAP,EAAA,GAvCA,CA0CA,CAEA,SAAAN,EAAAD,GAEA,aAEAC,EAAAD,QAAA,WAOA,GAAA,oBAAAe,UAAA,oBAAAC,OACA,MAAA,CAEAC,IAAA,WACA,MAAA,WAIAC,QAAA,WACA,OAAA,MAIAC,WAAA,aAGAC,aAAA,aAGAC,iBAAA,aAGAC,mBAAA,cASA,IAAAC,EAAAR,SAAAS,gBAGAC,EAAA,KAGAC,EAAA,UAGAC,EAAAD,EAIA,IACAV,OAAAY,eAAAC,QAAA,gBACAH,EAAAV,OAAAY,eAAAC,QAAA,eAGAb,OAAAY,eAAAC,QAAA,iBACAF,EAAAX,OAAAY,eAAAC,QAAA,gBAEA,MAAAC,IAGA,IAAAC,EAAA,KAGAC,EAAA,CAAA,QAAA,SAAA,YAGAC,EAAA,GAIAC,EAAA,CAAA,GACA,GACA,GACA,GACA,IAGAC,EAAA,GAGAC,EAAA,CACAC,QAAA,WACAC,MAAA,WACAC,UAAA,QACAC,UAAA,QACAC,cAAA,UACAC,cAAA,UACAC,YAAA,UACAC,YAAA,UACAC,WAAA,SAGAC,GAAA,EAGAC,GAAA,EAGAC,EAAA,CACAC,EAAA,KACAC,EAAA,MAGAC,EAAA,CACAC,EAAA,QACAC,EAAA,QACAC,EAAA,SAGAC,GAAA,EAEA,IACA,IAAAC,EAAAC,OAAAC,eAAA,GAAA,UAAA,CACAC,IAAA,WACAJ,GAAA,KAIAvC,OAAA4C,iBAAA,OAAA,KAAAJ,GACA,MAAA1B,IAMA,IAaA+B,EAAA,WAIA,IAAAC,IAAAP,GAAA,CAAAQ,SAAA,GAGA/C,OAAAgD,cACAhD,OAAA4C,iBAAA,cAAAK,GACAjD,OAAA4C,iBAAA,cAAAM,IACAlD,OAAAmD,gBACAnD,OAAA4C,iBAAA,gBAAAK,GACAjD,OAAA4C,iBAAA,gBAAAM,KAGAlD,OAAA4C,iBAAA,YAAAK,GACAjD,OAAA4C,iBAAA,YAAAM,GAGA,iBAAAlD,SACAA,OAAA4C,iBAAA,aAAAQ,EAAAN,GACA9C,OAAA4C,iBAAA,WAAAK,KAKAjD,OAAA4C,iBAAAS,IAAAH,EAAAJ,GAGA9C,OAAA4C,iBAAA,UAAAQ,GACApD,OAAA4C,iBAAA,QAAAQ,GAGApD,OAAA4C,iBAAA,UAAAU,GACAtD,OAAA4C,iBAAA,WAAAW,IAIAN,EAAA,SAAAO,GAEA,IAAA1B,EAAA,CACA,IAAA2B,EAAAD,EAAAE,MACAC,EAAAvC,EAAAoC,EAAAI,MAEA,YAAAD,IACAA,EAAAE,EAAAL,IAGA,IAAAM,GAAA3C,EAAA4C,SAAA,IAAA7C,EAAA8C,QAAAP,GAEAQ,EAAA9C,EAAA4C,SAAA,IAAA5C,EAAA6C,QAAAP,GAEAS,EAAA,aAAAP,GAAAF,IAAAK,GAAAG,IAAA,UAAAN,GAAA,UAAAA,EAEA,GAAAjD,IAAAiD,GAAAO,EAAA,CACAxD,EAAAiD,EAEA,IACA3D,OAAAY,eAAAuD,QAAA,aAAAzD,GACA,MAAAI,IAEAsD,EAAA,SAGA,GAAAzD,IAAAgD,GAAAO,EAAA,CAEA,IAAAG,EAAAtE,SAAAuE,cAGA,GAFAD,GAAAA,EAAAE,WAAA,IAAAvD,EAAAgD,QAAAK,EAAAE,SAAAC,eAEA,CACA7D,EAAAgD,EAEA,IACA3D,OAAAY,eAAAuD,QAAA,cAAAxD,GACA,MAAAG,IAEAsD,EAAA,cAOAA,EAAA,SAAAV,GACAnD,EAAAkE,aAAA,YAAAf,EAAA,UAAAA,EAAAhD,EAAAC,GAEA+D,EAAAhB,IAIAR,EAAA,SAAAM,GAMA,GAJAmB,EAAAnB,IAIA1B,IAAAC,EAAA,CACA,IAAA4B,EAAAvC,EAAAoC,EAAAI,MAKA,GAJA,YAAAD,IACAA,EAAAE,EAAAL,IAGA7C,IAAAgD,EAAA,CACAhD,EAAAgD,EAEA,IACA3D,OAAAY,eAAAuD,QAAA,cAAAxD,GACA,MAAAG,IAEAsD,EAAA,aAKAd,EAAA,SAAAE,GACAA,EAAAoB,OAAAL,UAOA9D,EAAA+C,EAAAoB,OAAAL,SAAAC,cACAjE,EAAAkE,aAAA,mBAAAhE,GAEA+C,EAAAoB,OAAAC,WAAArB,EAAAoB,OAAAC,UAAAd,QACAxD,EAAAkE,aAAA,mBAAAjB,EAAAoB,OAAAC,UAAAC,WAAAC,QAAA,IAAA,OARAxB,KAYAA,EAAA,WACA9C,EAAA,KAEAF,EAAAyE,gBAAA,oBACAzE,EAAAyE,gBAAA,qBAIA5B,EAAA,SAAAI,GAEAP,EAAAO,GAGAxD,OAAAiF,aAAAlE,GAGAe,GAAA,EAGAf,EAAAf,OAAAkF,WAAA,WAEApD,GAAA,GACA,MAOA+B,EAAA,SAAAL,GACA,MAAA,iBAAAA,EAAAK,YACA1B,EAAAqB,EAAAK,aAGA,QAAAL,EAAAK,YAAA,QAAAL,EAAAK,aAMAR,EAAA,WAYA,MARA,YAAAtD,SAAAoF,cAAA,OACA,aAIAC,IAAArF,SAAAsF,aAAA,aAAA,kBAOAX,EAAA,SAAAd,GACA,IAAA,IAAA0B,EAAA,EAAAC,EAAAtE,EAAA8C,OAAAuB,EAAAC,EAAAD,IACArE,EAAAqE,GAAA1B,OAAAA,GACA3C,EAAAqE,GAAAE,GAAA7F,UAAAyF,EAAA,UAAAxB,EAAAlD,EAAAC,IAcAgE,EAAA,SAAAnB,GACAxB,EAAA,IAAAwB,EAAAiC,SAAAzD,EAAA,IAAAwB,EAAAkC,SACA3D,GAAA,EAEAC,EAAA,EAAAwB,EAAAiC,QACAzD,EAAA,EAAAwB,EAAAkC,SAEA3D,GAAA,GAkBA,MARA,qBAAA/B,QAAA2F,MAAAC,UAAA5B,UAvOA5C,EAAAiC,KAAA,QAEAR,IACAuB,EAAA,SACAA,EAAA,WA2OA,CAKAnE,IAAA,SAAA4F,GACA,MAAA,WAAAA,EAAAlF,EAAAD,GAIAR,QAAA,WACA,OAAAO,GAIAN,WAAA,SAAA2F,GACA5E,EAAA4E,GAIA1F,aAAA,SAAA0F,GACA3E,EAAA2E,GAMAzF,iBAAA,SAAAmF,EAAAO,GACA9E,EAAA+E,KAAA,CACAR,GAAAA,EACA5B,KAAAmC,GAAA,WAIAzF,mBAAA,SAAAkF,GACA,IAAAS,EApEA,SAAAC,GACA,IAAA,IAAAZ,EAAA,EAAAC,EAAAtE,EAAA8C,OAAAuB,EAAAC,EAAAD,IACA,GAAArE,EAAAqE,GAAAE,KAAAU,EACA,OAAAZ,EAiEAa,CAAAX,IAEAS,GAAA,IAAAA,IACAhF,EAAAmF,OAAAH,EAAA,KAtZA”,“file”:“../what-input.min.js”,“sourcesContent”:[null,“
n * what-input - A global utility for tracking the current input method
(mouse, keyboard or touch).n * @version v5.1.3n * @link <a
href="https://github.com/ten1seven/what-input\n">github.com/ten1seven/what-inputn</a>
* @license MITn   n(function webpackUniversalModuleDefinition(root,
factory) {ntif(typeof exports === &#39;object&#39; &amp;&amp; typeof module
=== &#39;object&#39;)nttmodule.exports = factory();ntelse if(typeof define
=== &#39;function&#39; &amp;&amp;
define.amd)nttdefine(&quot;whatInput&quot;, [], factory);ntelse if(typeof
exports === &#39;<a href="\"whatInput\"">object’)nttexports</a> = <a
href="\"whatInput\"">factory();ntelsenttroot</a> = factory();n})(this,
function() {nreturn        / (function(modules) { // webpackBootstrapn/    
t// The module cachen/******/ tvar installedModules = {};nn/******/ t// The
require functionn/******/ tfunction <em>webpack_require</em>(moduleId)
{nn/******/ tt// Check if module is in cachen/******/
ttif(installedModules[moduleId])n/******/ tttreturn <a
href="moduleId">installedModules</a>.exports;nn/******/ tt// Create a new
module (and put it into the cache)n/******/ ttvar module = <a
href="moduleId">installedModules</a> = {n/******/ tttexports: {},n/******/
tttid: moduleId,n/******/ tttloaded: falsen/******/ tt};nn/******/ tt//
Execute the module functionn/******/
ttmodules[moduleId].call(module.exports, module, module.exports,
<em>webpack_require</em>);nn/******/ tt// Flag the module as
loadedn/******/ ttmodule.loaded = true;nn/******/ tt// Return the exports
of the modulen/******/ ttreturn module.exports;n/******/ t}nnn/******/ t//
expose the modules object (<em>webpack_modules</em>)n/******/
t__webpack_require__.m = modules;nn/******/ t// expose the module
cachen/******/ t__webpack_require__.c = installedModules;nn/******/ t//
<em>webpack_public_path</em>n/******/ t__webpack_require__.p =
"&quot;;nn/******/ t// Load entry module and return exportsn/******/
treturn <em>webpack_require</em>(0);n/******/
})n/************************************************************************/n/******/
([n/* 0 */n/***/ (function(module, exports) {nnt&#39;use
strict&#39;;nntmodule.exports = function () {nt  /*nt   * bail out if there
is no document or windownt   * (i.e. in a node/non-DOM environment)nt   *nt
* Return a stubbed API insteadnt   */nt  if (typeof document ===
&#39;undefined&#39; || typeof window === &#39;undefined&#39;) {nt    return
{nt      // always return "initial&quot; because no interaction will ever
be detectednt      ask: function ask() {nt        return
&#39;initial&#39;;nt      },nnt      // always return nullnt      element:
function element() {nt        return null;nt      },nnt      // no-opnt    
ignoreKeys: function ignoreKeys() {},nnt      // no-opnt      specificKeys:
function specificKeys() {},nnt      // no-opnt      registerOnChange:
function registerOnChange() {},nnt      // no-opnt      unRegisterOnChange:
function unRegisterOnChange() {}nt    };nt  }nnt  /*nt   * variablesnt  
*/nnt  // cache document.documentElementnt  var docElem =
document.documentElement;nnt  // currently focused dom elementnt  var
currentElement = null;nnt  // last used input typent  var currentInput =
&#39;initial&#39;;nnt  // last used input intentnt  var currentIntent =
currentInput;nnt  // check for sessionStorage supportnt  // then check for
session variables and use if availablent  try {nt    if
(window.sessionStorage.getItem(&#39;what-input&#39;)) {nt      currentInput
= window.sessionStorage.getItem(&#39;what-input&#39;);nt    }nnt    if
(window.sessionStorage.getItem(&#39;what-intent&#39;)) {nt     
currentIntent = window.sessionStorage.getItem(&#39;what-intent&#39;);nt   
}nt  } catch (e) {}nnt  // event buffer timernt  var eventTimer = null;nnt 
// form input typesnt  var formInputs = [&#39;input&#39;, &#39;select&#39;,
&#39;textarea&#39;];nnt  // empty array for holding callback functionsnt 
var functionList = [];nnt  // list of modifier keys commonly used with the
mouse andnt  // can be safely ignored to prevent false keyboard detectionnt
var ignoreMap = [16, // shiftnt  17, // controlnt  18, // altnt  91, //
Windows key / left Apple cmdnt  93 // Windows menu / right Apple cmdnt 
];nnt  var specificMap = [];nnt  // mapping of events to input typesnt  var
inputMap = {nt    keydown: &#39;keyboard&#39;,nt    keyup:
&#39;keyboard&#39;,nt    mousedown: &#39;mouse&#39;,nt    mousemove:
&#39;mouse&#39;,nt    MSPointerDown: &#39;pointer&#39;,nt    MSPointerMove:
&#39;pointer&#39;,nt    pointerdown: &#39;pointer&#39;,nt    pointermove:
&#39;pointer&#39;,nt    touchstart: &#39;touch&#39;nnt    // boolean: true
if touch buffer is activent  };var isBuffering = false;nnt  // boolean:
true if the page is being scrollednt  var isScrolling = false;nnt  // store
current mouse positionnt  var mousePos = {nt    x: null,nt    y: nullnnt   
// map of IE 10 pointer eventsnt  };var pointerMap = {nt    2:
&#39;touch&#39;,nt    3: &#39;touch&#39;, // treat pen like touchnt    4:
&#39;mouse&#39;nnt    // check support for passive event listenersnt  };var
supportsPassive = false;nnt  try {nt    var opts =
Object.defineProperty({}, &#39;passive&#39;, {nt      get: function get()
{nt        supportsPassive = true;nt      }nt    });nnt   
window.addEventListener(&#39;test&#39;, null, opts);nt  } catch (e) {}nnt 
/*nt   * set upnt   */nnt  var setUp = function setUp() {nt    // add
correct mouse wheel event mapping to `inputMap`nt    <a
href="detectWheel()">inputMap</a> = &#39;mouse&#39;;nnt   
addListeners();nt    doUpdate(&#39;input&#39;);nt   
doUpdate(&#39;intent&#39;);nt  };nnt  /*nt   * eventsnt   */nnt  var
addListeners = function addListeners() {nt    // `pointermove`,
`MSPointerMove`, `mousemove` and mouse wheel event bindingnt    // can only
demonstrate potential, but not actual, interactionnt    // and are treated
separatelynt    var options = supportsPassive ? { passive: true } :
false;nnt    // pointer events (mouse, pen, touch)nt    if
(window.PointerEvent) {nt     
window.addEventListener(&#39;pointerdown&#39;, setInput);nt     
window.addEventListener(&#39;pointermove&#39;, setIntent);nt    } else if
(window.MSPointerEvent) {nt     
window.addEventListener(&#39;MSPointerDown&#39;, setInput);nt     
window.addEventListener(&#39;MSPointerMove&#39;, setIntent);nt    } else
{nt      // mouse eventsnt     
window.addEventListener(&#39;mousedown&#39;, setInput);nt     
window.addEventListener(&#39;mousemove&#39;, setIntent);nnt      // touch
eventsnt      if (&#39;ontouchstart&#39; in window) {nt       
window.addEventListener(&#39;touchstart&#39;, eventBuffer, options);nt     
window.addEventListener(&#39;touchend&#39;, setInput);nt      }nt    }nnt  
// mouse wheelnt    window.addEventListener(detectWheel(), setIntent,
options);nnt    // keyboard eventsnt   
window.addEventListener(&#39;keydown&#39;, eventBuffer);nt   
window.addEventListener(&#39;keyup&#39;, eventBuffer);nnt    // focus
eventsnt    window.addEventListener(&#39;focusin&#39;, setElement);nt   
window.addEventListener(&#39;focusout&#39;, clearElement);nt  };nnt  //
checks conditions before updating new inputnt  var setInput = function
setInput(event) {nt    // only execute if the event buffer timer isn&#39;t
runningnt    if (!isBuffering) {nt      var eventKey = event.which;nt     
var value = <a href="event.type">inputMap</a>;nnt      if (value ===
&#39;pointer&#39;) {nt        value = pointerType(event);nt      }nnt     
var ignoreMatch = !specificMap.length &amp;&amp;
ignoreMap.indexOf(eventKey) === -1;nnt      var specificMatch =
specificMap.length &amp;&amp; specificMap.indexOf(eventKey) !== -1;nnt     
var shouldUpdate = value === &#39;keyboard&#39; &amp;&amp; eventKey
&amp;&amp; (ignoreMatch || specificMatch) || value === &#39;mouse&#39; ||
value === &#39;touch&#39;;nnt      if (currentInput !== value &amp;&amp;
shouldUpdate) {nt        currentInput = value;nnt        try {nt         
window.sessionStorage.setItem(&#39;what-input&#39;, currentInput);nt       
} catch (e) {}nnt        doUpdate(&#39;input&#39;);nt      }nnt      if
(currentIntent !== value &amp;&amp; shouldUpdate) {nt        // preserve
intent for keyboard typing in form fieldsnt        var activeElem =
document.activeElement;nt        var notFormInput = activeElem &amp;&amp;
activeElem.nodeName &amp;&amp;
formInputs.indexOf(activeElem.nodeName.toLowerCase()) === -1;nnt        if
(notFormInput) {nt          currentIntent = value;nnt          try {nt     
window.sessionStorage.setItem(&#39;what-intent&#39;, currentIntent);nt     
} catch (e) {}nnt          doUpdate(&#39;intent&#39;);nt        }nt     
}nt    }nt  };nnt  // updates the doc and `inputTypes` array with new
inputnt  var doUpdate = function doUpdate(which) {nt   
docElem.setAttribute(&#39;data-what&#39; + which, which === &#39;input&#39;
? currentInput : currentIntent);nnt    fireFunctions(which);nt  };nnt  //
updates input intent for `mousemove` and `pointermove`nt  var setIntent =
function setIntent(event) {nt    // test to see if `mousemove` happened
relative to the screen to detect scrolling versus mousemovent   
detectScrolling(event);nnt    // only execute if the event buffer timer
isn&#39;t runningnt    // or scrolling isn&#39;t happeningnt    if
(!isBuffering &amp;&amp; !isScrolling) {nt      var value = <a
href="event.type">inputMap</a>;nt      if (value === &#39;pointer&#39;) {nt
value = pointerType(event);nt      }nnt      if (currentIntent !== value)
{nt        currentIntent = value;nnt        try {nt         
window.sessionStorage.setItem(&#39;what-intent&#39;, currentIntent);nt     
} catch (e) {}nnt        doUpdate(&#39;intent&#39;);nt      }nt    }nt 
};nnt  var setElement = function setElement(event) {nt    if
(!event.target.nodeName) {nt      // If nodeName is undefined, clear the
elementnt      // This can happen if click inside an &lt;svg&gt; element.nt
clearElement();nt      return;nt    }nnt    currentElement =
event.target.nodeName.toLowerCase();nt   
docElem.setAttribute(&#39;data-whatelement&#39;, currentElement);nnt    if
(event.target.classList &amp;&amp; event.target.classList.length) {nt     
docElem.setAttribute(&#39;data-whatclasses&#39;,
event.target.classList.toString().replace(&#39; &#39;, &#39;,&#39;));nt   
}nt  };nnt  var clearElement = function clearElement() {nt   
currentElement = null;nnt   
docElem.removeAttribute(&#39;data-whatelement&#39;);nt   
docElem.removeAttribute(&#39;data-whatclasses&#39;);nt  };nnt  // buffers
events that frequently also fire mouse eventsnt  var eventBuffer = function
eventBuffer(event) {nt    // set the current inputnt    setInput(event);nnt
// clear the timer if it happens to be runningnt   
window.clearTimeout(eventTimer);nnt    // set the isBuffering to `true`nt  
isBuffering = true;nnt    // run the timernt    eventTimer =
window.setTimeout(function () {nt      // if the timer runs out, set
isBuffering back to `false`nt      isBuffering = false;nt    }, 100);nt 
};nnt  /*nt   * utilitiesnt   */nnt  var pointerType = function
pointerType(event) {nt    if (typeof event.pointerType ===
&#39;number&#39;) {nt      return <a
href="event.pointerType">pointerMap</a>;nt    } else {nt      // treat pen
like touchnt      return event.pointerType === &#39;pen&#39; ?
&#39;touch&#39; : event.pointerType;nt    }nt  };nnt  // detect version of
mouse wheel event to usent  // via <a
href="https://developer.mozilla.org/en-US/docs/Web/Events/wheel\n\t">developer.mozilla.org/en-US/docs/Web/Events/wheelnt</a>
var detectWheel = function detectWheel() {nt    var wheelType = void 0;nnt 
// Modern browsers support "wheel&quot;nt    if (&#39;onwheel&#39; in
document.createElement(&#39;div&#39;)) {nt      wheelType =
&#39;wheel&#39;;nt    } else {nt      // Webkit and IE support at least
"mousewheel&quot;nt      // or assume that remaining browsers are older
Firefoxnt      wheelType = document.onmousewheel !== undefined ?
&#39;mousewheel&#39; : &#39;DOMMouseScroll&#39;;nt    }nnt    return
wheelType;nt  };nnt  // runs callback functionsnt  var fireFunctions =
function fireFunctions(type) {nt    for (var i = 0, len =
functionList.length; i &lt; len; i++) {nt      if (<a
href="i">functionList</a>.type === type) {nt        <a
href="i">functionList</a>.fn.call(undefined, type === &#39;input&#39; ?
currentInput : currentIntent);nt      }nt    }nt  };nnt  // finds matching
element in an objectnt  var objPos = function objPos(match) {nt    for (var
i = 0, len = functionList.length; i &lt; len; i++) {nt      if (<a
href="i">functionList</a>.fn === match) {nt        return i;nt      }nt   
}nt  };nnt  var detectScrolling = function detectScrolling(event) {nt    if
(<a href="'x'">mousePos</a> !== event.screenX || <a href="'y'">mousePos</a>
!== event.screenY) {nt      isScrolling = false;nnt      <a
href="'x'">mousePos</a> = event.screenX;nt      <a href="'y'">mousePos</a>
= event.screenY;nt    } else {nt      isScrolling = true;nt    }nt  };nnt 
/*nt   * initnt   */nnt  // don&#39;t start script unless browser cuts the
mustardnt  // (also passes if polyfills are used)nt  if
(&#39;addEventListener&#39; in window &amp;&amp; Array.prototype.indexOf)
{nt    setUp();nt  }nnt  /*nt   * apint   */nnt  return {nt    // returns
string: the current input typent    // opt:
&#39;intent&#39;|&#39;input&#39;nt    // &#39;input&#39; (default): returns
the same value as the `data-whatinput` attributent    // &#39;intent&#39;:
includes `data-whatintent` value if it&#39;s different than
`data-whatinput`nt    ask: function ask(opt) {nt      return opt ===
&#39;intent&#39; ? currentIntent : currentInput;nt    },nnt    // returns
string: the currently focused element or nullnt    element: function
element() {nt      return currentElement;nt    },nnt    // overwrites
ignored keys with provided arraynt    ignoreKeys: function ignoreKeys(arr)
{nt      ignoreMap = arr;nt    },nnt    // overwrites specific char keys to
update onnt    specificKeys: function specificKeys(arr) {nt     
specificMap = arr;nt    },nnt    // attach functions to input and intent
"events&quot;nt    // funct: function to fire on changent    // eventType:
&#39;input&#39;|&#39;intent&#39;nt    registerOnChange: function
registerOnChange(fn, eventType) {nt      functionList.push({nt        fn:
fn,nt        type: eventType || &#39;input&#39;nt      });nt    },nnt   
unRegisterOnChange: function unRegisterOnChange(fn) {nt      var position =
objPos(fn);nnt      if (position || position === 0) {nt       
functionList.splice(position, 1);nt      }nt    }nt  };nt}();nn/***/
})n/******/ ])n});n;”]}</p>
</main>
