...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Wut-3F+Poppers-3F">Wut? Poppers?</a>
    <li><a href="#label-So-2C+yet+another+tooltip+library-3F">So, yet another tooltip library?</a>
    <li><a href="#label-Popper.js">Popper.js</a>
    <li><a href="#label-Tooltip.js">Tooltip.js</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-Dist+targets">Dist targets</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-Callbacks">Callbacks</a>
    <li><a href="#label-Writing+your+own+modifiers">Writing your own modifiers</a>
    <li><a href="#label-React-2C+Vue.js-2C+Angular-2C+AngularJS-2C+Ember.js+-28etc...-29+integration">React, Vue.js, Angular, AngularJS, Ember.js (etc…) integration</a>
    <li><a href="#label-Migration+from+Popper.js+v0">Migration from Popper.js v0</a>
    <li><a href="#label-Performances">Performances</a>
    <li><a href="#label-Notes">Notes</a>
    <li><a href="#label-Libraries+using+Popper.js">Libraries using Popper.js</a>
...
<main role="main" aria-label="Page node_modules/popper.js/README.md">
<!-- IGNORE THE HTML BLOCK BELOW, THE INTERESTING PART IS AFTER IT --><h1 align="center">Popper.js</h1><p align="center">
...
<p>&lt;img src=“<img
src="https://raw.githubusercontent.com/FezVrasta/popper.js/master/popperjs.png"
/>” align=“right” width=250 /&gt;</p>
<!-- 🚨 HEY! HERE BEGINS THE INTERESTING STUFF 🚨 -->
<h2 id="label-Wut-3F+Poppers-3F">Wut? Poppers?<span><a href="#label-Wut-3F+Poppers-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>A popper is an element on the screen which “pops out” from the natural flow
of your application.<br> Common examples of poppers are tooltips, popovers
and drop-downs.</p>

<h2 id="label-So-2C+yet+another+tooltip+library-3F">So, yet another tooltip library?<span><a href="#label-So-2C+yet+another+tooltip+library-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Well, basically, <strong>no</strong>.<br> Popper.js is a
<strong>positioning engine</strong>, its purpose is to calculate the
position of an element to make it possible to position it near a given
reference element.</p>

<p>The engine is completely modular and most of its features are implemented
as <strong>modifiers</strong> (similar to middlewares or plugins).<br> The
whole code base is written in ES2015 and its features are automatically
tested on real browsers thanks to <a
href="https://saucelabs.com/">SauceLabs</a> and <a
href="https://travis-ci.org/">TravisCI</a>.</p>

<p>Popper.js has zero dependencies. No jQuery, no LoDash, nothing.<br>
It&#39;s used by big companies like <a
href="https://getbootstrap.com/">Twitter in Bootstrap v4</a>, <a
href="https://github.com/OneNoteDev/WebClipper">Microsoft in WebClipper</a>
and <a href="https://aui-cdn.atlassian.com/atlaskit/registry/">Atlassian in
AtlasKit</a>.</p>

<h3 id="label-Popper.js">Popper.js<span><a href="#label-Popper.js">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>This is the engine, the library that computes and, optionally, applies the
styles to the poppers.</p>

<p>Some of the key points are:</p>
<ul><li>
<p>Position elements keeping them in their original DOM context (doesn&#39;t
mess with your DOM!);</p>
</li><li>
<p>Allows to export the computed informations to integrate with React and
other view libraries;</p>
</li><li>
<p>Supports Shadow DOM elements;</p>
</li><li>
<p>Completely customizable thanks to the modifiers based structure;</p>
</li></ul>

<p>Visit our <a href="https://fezvrasta.github.io/popper.js">project page</a>
to see a lot of examples of what you can do with Popper.js!</p>

<p>Find <a href="/docs/_includes/popper-documentation.md">the documentation
here</a>.</p>

<h3 id="label-Tooltip.js">Tooltip.js<span><a href="#label-Tooltip.js">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Since lots of users just need a simple way to integrate powerful tooltips
in their projects, we created <strong>Tooltip.js</strong>.<br> It&#39;s a
small library that makes it easy to automatically create tooltips using as
engine Popper.js.<br> Its API is almost identical to the famous tooltip
system of Bootstrap, in this way it will be easy to integrate it in your
projects.<br> The tooltips generated by Tooltip.js are accessible thanks to
the <code>aria</code> tags.</p>

<p>Find <a href="/docs/_includes/tooltip-documentation.md">the documentation
here</a>.</p>
...
<p>| Source | | |:——-|:———————————————————————————| | npm | <code>npm install
popper.js --save</code> | | yarn | <code>yarn add popper.js</code> | |
NuGet | <code>PM&gt; Install-Package popper.js</code> | | Bower |
<code>bower install popper.js --save</code> | | unpkg | <a
href="https://unpkg.com/popper.js">unpkg.com/popper.js</a> | | cdnjs | <a
href="https://cdnjs.com/libraries/popper.js">cdnjs.com/libraries/popper.js</a>
|</p>

<p>Tooltip.js as well:</p>

<p>| Source | | |:——-|:———————————————————————————| | npm | <code>npm install
tooltip.js --save</code> | | yarn | <code>yarn add tooltip.js</code> | |
Bower* | <code>bower install tooltip.js=https://unpkg.com/tooltip.js
--save</code> | | unpkg | <a
href="https://unpkg.com/tooltip.js">unpkg.com/tooltip.js</a> | | cdnjs | <a
href="https://cdnjs.com/libraries/popper.js">cdnjs.com/libraries/popper.js</a>
|</p>

<p>*: Bower isn&#39;t officially supported, it can be used to install
Tooltip.js only trough the unpkg.com CDN. This method has the limitation of
not being able to define a specific version of the library. Bower and
Popper.js suggests to use npm or Yarn for your projects.<br> For more info,
<a href="https://github.com/FezVrasta/popper.js/issues/390">read the
related issue</a>.</p>

<h3 id="label-Dist+targets">Dist targets<span><a href="#label-Dist+targets">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Popper.js is currently shipped with 3 targets in mind: UMD, ESM and ESNext.</p>
<ul><li>
<p>UMD - Universal Module Definition: AMD, RequireJS and globals;</p>
</li><li>
<p>ESM - ES Modules: For webpack/Rollup or browser supporting the spec;</p>
</li><li>
<p>ESNext: Available in <code>dist/</code>, can be used with webpack and
<code>babel-preset-env</code>;</p>
</li></ul>

<p>Make sure to use the right one for your needs. If you want to import it
with a <code>&lt;script&gt;</code> tag, use UMD.</p>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Given an existing popper DOM node, ask Popper.js to position it near its
button</p>

<pre>var reference = document.querySelector(&#39;.my-button&#39;);
...
<p>Popper.js supports two kinds of callbacks, the <code>onCreate</code>
callback is called after the popper has been initialized. The
<code>onUpdate</code> one is called on any subsequent update.</p>

<pre>const reference = document.querySelector(&#39;.my-button&#39;);
...
<h3 id="label-Writing+your+own+modifiers">Writing your own modifiers<span><a href="#label-Writing+your+own+modifiers">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Popper.js is based on a “plugin-like” architecture, most of its features
are fully encapsulated “modifiers”.<br> A modifier is a function that is
called each time Popper.js needs to compute the position of the popper. For
this reason, modifiers should be very performant to avoid bottlenecks.</p>

<p>To learn how to create a modifier, <a
href="docs/_includes/popper-documentation.md#modifiers--object">read the
modifiers documentation</a></p>

<h3 id="label-React-2C+Vue.js-2C+Angular-2C+AngularJS-2C+Ember.js+-28etc...-29+integration">React, Vue.js, Angular, AngularJS, Ember.js (etc…) integration<span><a href="#label-React-2C+Vue.js-2C+Angular-2C+AngularJS-2C+Ember.js+-28etc...-29+integration">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Integrating 3rd party libraries in React or other libraries can be a pain
because they usually alter the DOM and drive the libraries crazy.<br>
Popper.js limits all its DOM modifications inside the
<code>applyStyle</code> modifier, you can simply disable it and manually
apply the popper coordinates using your library of choice.</p>

<p>For a comprehensive list of libraries that let you use Popper.js into
existing frameworks, visit the <a href="/MENTIONS.md">MENTIONS</a> page.</p>

<p>Alternatively, you may even override your own <code>applyStyles</code> with
your custom one and integrate Popper.js by yourself!</p>

<pre>function applyReactStyle(data) {
...
<h3 id="label-Migration+from+Popper.js+v0">Migration from Popper.js v0<span><a href="#label-Migration+from+Popper.js+v0">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Since the API changed, we prepared some migration instructions to make it
easy to upgrade to Popper.js v1.</p>

<p><a
href="https://github.com/FezVrasta/popper.js/issues/62">github.com/FezVrasta/popper.js/issues/62</a></p>

<p>Feel free to comment inside the issue if you have any questions.</p>

<h3 id="label-Performances">Performances<span><a href="#label-Performances">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Popper.js is very performant. It usually takes 0.5ms to compute a
popper&#39;s position (on an iMac with 3.5G GHz Intel Core i5).<br> This
means that it will not cause any <a
href="https://www.chromium.org/developers/how-tos/trace-event-profiling-tool/anatomy-of-jank">jank</a>,
leading to a smooth user experience.</p>

<h2 id="label-Notes">Notes<span><a href="#label-Notes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-Libraries+using+Popper.js">Libraries using Popper.js<span><a href="#label-Libraries+using+Popper.js">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The aim of Popper.js is to provide a stable and powerful positioning engine
ready to be used in 3rd party libraries.</p>

<p>Visit the <a href="/MENTIONS.md">MENTIONS</a> page for an updated list of
projects.</p>

<h3 id="label-Credits">Credits<span><a href="#label-Credits">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>I want to thank some friends and projects for the work they did:</p>
<ul><li>
<p><a href="https://github.com/AndreaScn">@AndreaScn</a> for his work on the
GitHub Page and the manual testing he did during the development;</p>
</li><li>
<p><a href="https://github.com/vampolo">@vampolo</a> for the original idea and
for the name of the library;</p>
</li><li>
<p><a href="https://github.com/Draios">Sysdig</a> for all the awesome things I
learned during these years that made it possible for me to write this
library;</p>
</li><li>
<p><a href="http://github.hubspot.com/tether/">Tether.js</a> for having
inspired me in writing a positioning library ready for the real world;</p>
</li><li>
<p><a href="https://github.com/FezVrasta/popper.js/graphs/contributors">The
Contributors</a> for their much appreciated Pull Requests and bug reports;</p>
</li><li>
<p><strong>you</strong> for the star you&#39;ll give to this project and for
being so awesome to give this project a try 🙂</p>
</li></ul>

<h3 id="label-Copyright+and+license">Copyright and license<span><a href="#label-Copyright+and+license">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Code and documentation copyright 2016 <strong>Federico Zivolo</strong>.
Code released under the <a href="LICENSE.md">MIT license</a>. Docs released
