...
const window = element.ownerDocument.defaultView;n  const css =
...
&#39;HTML&#39;) {n    const { width, height } =
getWindowSizes(element.ownerDocument);n    elementRect = {n      width,n   
height,n      left: 0,n      top: 0,n    };n  } else {n    elementRect = {n
width: element.offsetWidth,n      height: element.offsetHeight,n      left:
element.offsetLeft,n      top: element.offsetTop,n    };n  }nn  //
positionn  return getClientRect(elementRect);n}n”,“/**n * Get the outer
sizes of the given element (offset size + margins)n * @methodn * @memberof
Popper.Utilsn * @argument {Element} elementn * @returns {Object} object
containing width and height propertiesn */nexport default function
getOuterSizes(element) {n  const window =
element.ownerDocument.defaultView;n  const styles =
