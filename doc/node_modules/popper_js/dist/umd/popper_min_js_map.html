...
element.removeAttribute(prop);n    }n  });n}n”,“/**n * @functionn *
@memberof Popper.Utilsn * @argument {Object} data - The data object
generated by `update` methodn * @argument {Boolean} shouldRound - If the
offsets should be rounded at alln * @returns {Object} The popper&#39;s
position offsets roundedn *n * The tale of pixel-perfect positioning.
It&#39;s still not 100% perfect, but asn * good as it can be within
reason.n * Discussion here: <a
...
horizontalToInteger(popper.right),n  };n}n”,“import find from
...
data;n}n”,“export default typeof window !== &#39;undefined&#39; &amp;&amp;
typeof document !== &#39;undefined&#39;;n”,“import getSupportedPropertyName
from &#39;../utils/getSupportedPropertyName&#39;;nimport find from
...
…data.offsets.arrow, …data.arrowStyles };nn  return data;n}n”,“import
getOppositePlacement from &#39;../utils/getOppositePlacement&#39;;nimport
getOppositeVariation from &#39;../utils/getOppositeVariation&#39;;nimport
getPopperOffsets from &#39;../utils/getPopperOffsets&#39;;nimport
runModifiers from &#39;../utils/runModifiers&#39;;nimport getBoundaries
from &#39;../utils/getBoundaries&#39;;nimport isModifierEnabled from
...
be overridden using the `options` argument of Popper.js.&lt;br /&gt;n * To
override an option, simply pass an object with the samen * structure of the
`options` object, as the 3rd argument. For example:n * “`n * new
Popper(ref, pop, {n *   modifiers: {n *     preventOverflow: { enabled:
false }n *   }n * })n * “`n * @type {Object}n * @staticn * @memberof
Poppern */nexport default {n  /**n   * Popper&#39;s placement.n   * @prop
{Popper.placements} placement=&#39;bottom&#39;n   */n  placement:
