...
<main role="main" aria-label="Page node_modules/popper.js/index.d.ts">

<pre>@fileoverview This file only declares the public portions of the API.
It should not define internal pieces such as utils or modifier details.

Original definitions by: edcarroll &lt;https://github.com/edcarroll&gt;, ggray &lt;https://github.com/giladgray&gt;, rhysd &lt;https://rhysd.github.io&gt;, joscha &lt;https://github.com/joscha&gt;, seckardt &lt;https://github.com/seckardt&gt;, marcfallows &lt;https://github.com/marcfallows&gt;</pre>

<p>/**</p>

<pre> This kind of namespace declaration is not necessary, but is kept here for backwards-compatibility with
...
<p>declare namespace Popper {</p>

<pre>export type Position = &#39;top&#39; | &#39;right&#39; | &#39;bottom&#39; | &#39;left&#39;;
...
<p>// Re-export types in the Popper namespace so that they can be accessed as
top-level named exports. // These re-exports should be removed in 2.x when
the “declare namespace Popper” syntax is removed. export type Position =
Popper.Position; export type Placement = Popper.Placement; export type
Boundary = Popper.Boundary; export type Behavior = Popper.Behavior; export
type ModifierFn = Popper.ModifierFn; export type BaseModifier =
Popper.BaseModifier; export type Modifiers = Popper.Modifiers; export type
Offset = Popper.Offset; export type Data = Popper.Data; export type
PopperOptions = Popper.PopperOptions; export type ReferenceObject =
Popper.ReferenceObject;</p>

<p>declare class Popper {</p>

<pre>static modifiers: (BaseModifier &amp; { name: string })[];
...
disableEventListeners(): void;</pre>

<p>}</p>

<p>export default Popper;</p>
</main>
