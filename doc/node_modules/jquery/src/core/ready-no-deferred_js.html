...
<title>ready-no-deferred.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery/src/core/ready-no-deferred.js">
...
<p>], function( jQuery, document, isFunction ) {</p>

<p>“use strict”;</p>

<p>var readyCallbacks = [],</p>

<pre>whenReady = function( fn ) {
...
<pre class="ruby"><span class="ruby-identifier">whenReady</span>( <span class="ruby-identifier">fn</span> );
...
<p>// Make jQuery.ready Promise consumable (gh-1778) jQuery.ready.then =
jQuery.fn.ready;</p>

<pre>The ready event handler and self cleanup method</pre>
...
event has already occurred. // Support: IE9-10 only // Older IE sometimes
signals “interactive” too soon if ( document.readyState === “complete” ||</p>
