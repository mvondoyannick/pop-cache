...
<title>pnum.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery/src/var/pnum.js">

<p>define( function() {</p>

<pre class="ruby"><span class="ruby-string">&quot;use strict&quot;</span>;

<span class="ruby-keyword">return</span> ( <span class="ruby-regexp">/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/</span> ).<span class="ruby-identifier">source</span>;
</pre>
