...
<title>selector-native.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery/src/selector-native.js">
...
<p>], function( jQuery, document, documentElement, hasOwn, indexOf ) {</p>

<p>“use strict”;</p>

<pre>Optional (non-Sizzle) selector module for custom builds.
...
customize this stub for the project&#39;s specific needs.</pre>

<p>var hasDuplicate, sortInput,</p>

<pre>sortStable = jQuery.expando.split( &quot;&quot; ).sort( sortOrder ).join( &quot;&quot; ) === jQuery.expando,
...
<p>function sortOrder( a, b ) {</p>

<pre>// Flag for duplicate removal
if ( a === b ) {
        hasDuplicate = true;
        return 0;
}
...
return compare &amp; 4 ? -1 : 1;</pre>

<p>}</p>

<p>function uniqueSort( results ) {</p>
...
<p>jQuery.extend( jQuery.find, {</p>

<pre>matches: function( expr, elements ) {
