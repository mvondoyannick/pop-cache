...
<title>sizzle.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/jquery/external/sizzle/dist/sizzle.js">
...
<p>// EXPOSE var _sizzle = window.Sizzle;</p>

<p>Sizzle.noConflict = function() {</p>

<pre>if ( window.Sizzle === Sizzle ) {
...
<pre class="ruby"><span class="ruby-identifier">define</span>(<span class="ruby-identifier">function</span>() { <span class="ruby-keyword">return</span> <span class="ruby-constant">Sizzle</span>; });
</pre>

<p>// Sizzle requires that there be a global window in Common-JS like
environments } else if ( typeof module !== “undefined” &amp;&amp;
module.exports ) {</p>

<pre>module.exports = Sizzle;</pre>

<p>} else {</p>

<pre class="ruby"><span class="ruby-identifier">window</span>.<span class="ruby-constant">Sizzle</span> = <span class="ruby-constant">Sizzle</span>;
</pre>
