...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-jQuery">jQuery</a>
    <li><a href="#label-Including+jQuery">Including jQuery</a>
    <li><a href="#label-Browser">Browser</a>
    <li><a href="#label-Script+tag">Script tag</a>
    <li><a href="#label-Babel">Babel</a>
    <li><a href="#label-Browserify-2FWebpack">Browserify/Webpack</a>
    <li><a href="#label-AMD+-28Asynchronous+Module+Definition-29">AMD (Asynchronous Module Definition)</a>
...
<main role="main" aria-label="Page node_modules/jquery/README.md">

<h1 id="label-jQuery">jQuery<span><a href="#label-jQuery">&para;</a> <a href="#top">&uarr;</a></span></h1>

<blockquote>
<p>jQuery is a fast, small, and feature-rich JavaScript library.</p>
</blockquote>

<p>For information on how to get started and how to use jQuery, please see <a
href="http://api.jquery.com/">jQuery’s documentation</a>. For source files
and issues, please visit the <a
href="https://github.com/jquery/jquery">jQuery repo</a>.</p>

<p>If upgrading, please see the <a
href="https://blog.jquery.com/2017/03/20/jquery-3.3.1-now-available/">blog
post for 3.3.1</a>. This includes notable differences from the previous
version and a more readable changelog.</p>

<h2 id="label-Including+jQuery">Including jQuery<span><a href="#label-Including+jQuery">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<h4 id="label-Script+tag">Script tag<span><a href="#label-Script+tag">&para;</a> <a href="#top">&uarr;</a></span></h4>

<pre>&lt;script src=&quot;https://code.jquery.com/jquery-3.3.1.min.js&quot;&gt;&lt;/script&gt;</pre>

<h4 id="label-Babel">Babel<span><a href="#label-Babel">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p><a href="http://babeljs.io/">Babel</a> is a next generation JavaScript
compiler. One of the features is the ability to use ES6/ES2015 modules now,
even though browsers do not yet support this feature natively.</p>

<pre>import $ from &quot;jquery&quot;;</pre>

<h4 id="label-Browserify-2FWebpack">Browserify/Webpack<span><a href="#label-Browserify-2FWebpack">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>There are several ways to use <a
href="http://browserify.org/">Browserify</a> and <a
href="https://webpack.github.io/">Webpack</a>. For more information on
using these tools, please refer to the corresponding project&#39;s
documention. In the script, including jQuery will usually look like this…</p>

<pre>var $ = require(&quot;jquery&quot;);</pre>

<h4 id="label-AMD+-28Asynchronous+Module+Definition-29">AMD (Asynchronous Module Definition)<span><a href="#label-AMD+-28Asynchronous+Module+Definition-29">&para;</a> <a href="#top">&uarr;</a></span></h4>

<p>AMD is a module format built for the browser. For more information, we
recommend <a href="http://requirejs.org/docs/whyamd.html">require.js’
documentation</a>.</p>
...
<h3 id="label-Node">Node<span><a href="#label-Node">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>To include jQuery in <a href="nodejs.org">Node</a>, first install with npm.</p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">jquery</span>
</pre>

<p>For jQuery to work in Node, a window with a document is required. Since no
such window exists natively in Node, one can be mocked by tools such as <a
href="https://github.com/tmpvar/jsdom">jsdom</a>. This can be useful for
testing purposes.</p>

<pre>require(&quot;jsdom&quot;).env(&quot;&quot;, function(err, window) {
        if (err) {
                console.error(err);
                return;
        }
