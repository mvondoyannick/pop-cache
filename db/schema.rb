...
ActiveRecord::Schema.define(version: 2020_01_13_161856) do
  ...
  create_table "fc_accounts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "account_code"
    t.float "amount"
    t.bigint "customer_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["customer_id"], name: "index_fc_accounts_on_customer_id"
  end

  create_table "fc_coupons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.float "amount"
    t.integer "coupon_code"
    t.string "receiver_phone"
    t.string "receiver_name"
    t.integer "auth_coupon_code"
    t.bigint "fc_account_id", null: false
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "customer_id"
    t.index ["customer_id"], name: "index_fc_coupons_on_customer_id"
    t.index ["fc_account_id"], name: "index_fc_coupons_on_fc_account_id"
  end
  ...
  create_table "sos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.float "montant"
    t.string "delais"
    t.string "code"
    t.boolean "use"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "close"
    t.index ["customer_id"], name: "index_sos_on_customer_id"
  end

  create_table "sospayments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.float "amount"
    t.integer "payer"
    t.datetime "payment_date"
    t.boolean "pret"
    t.bigint "so_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["so_id"], name: "index_sospayments_on_so_id"
  end
  ...
  add_foreign_key "fc_accounts", "customers"
  add_foreign_key "fc_coupons", "customers"
  add_foreign_key "fc_coupons", "fc_accounts"
  ...
  add_foreign_key "sos", "customers"
  add_foreign_key "sospayments", "sos"
end
